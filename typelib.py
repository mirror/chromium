...
i = 0
while off < strtablen:
  u0, u1, n, u2, u3 = struct.unpack_from('<IIBBH', tlb, offset=strtaboff+off)
  print 'str %d (@%x):' % (i, off), tlb[strtaboff+off+12:strtaboff+off+12+n],
