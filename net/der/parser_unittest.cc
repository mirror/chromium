...
TEST(ParserTest, ParseTags) {
  {
    ...
    const uint8_t der[] = {0x04, 0x01, 0x00};
    Parser parser((Input(der)));
...

  {
    ...
    const uint8_t der[] = {0x30, 0x01, 0x00};
    Parser parser((Input(der)));
...

  {
    ...
    const uint8_t der[] = {0x41, 0x01, 0x00};
    Parser parser((Input(der)));
...

  {
    ...
    const uint8_t der[] = {0xbe, 0x01, 0x00};
    Parser parser((Input(der)));
...

  {
    ...
    const uint8_t der[] = {0xcf, 0x01, 0x00};
    Parser parser((Input(der)));
