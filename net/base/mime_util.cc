...
static bool GetPreferredExtesionFromMimeInfoArray(
...
bool MimeUtil::GetPreferredExtensionForMimeType(
  ...
  return GetPlatformPreferredExtensionForMimeType(mime_type, extension) ||
         GetPreferredExtesionFromMimeInfoArray(kPrimaryMappings,
                                               arraysize(kPrimaryMappings),
                                               mime_type, extension) ||
         GetPreferredExtesionFromMimeInfoArray(kSecondaryMappings,
