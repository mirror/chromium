...
TEST(UrlUtilTest, IsLocalhost) {
  EXPECT_TRUE(UrlHostIsLocalhost("localhost"));
  EXPECT_TRUE(UrlHostIsLocalhost("localHosT"));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost."));
  EXPECT_TRUE(UrlHostIsLocalhost("localHost."));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost.localdomain"));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost.localDOMain"));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost.localdomain."));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost6"));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost6."));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost6.localdomain6"));
  EXPECT_TRUE(UrlHostIsLocalhost("localhost6.localdomain6."));
  EXPECT_TRUE(UrlHostIsLocalhost("127.0.0.1"));
  EXPECT_TRUE(UrlHostIsLocalhost("127.0.1.0"));
  EXPECT_TRUE(UrlHostIsLocalhost("127.1.0.0"));
  EXPECT_TRUE(UrlHostIsLocalhost("127.0.0.255"));
  EXPECT_TRUE(UrlHostIsLocalhost("127.0.255.0"));
  EXPECT_TRUE(UrlHostIsLocalhost("127.255.0.0"));
  EXPECT_TRUE(UrlHostIsLocalhost("::1"));
  EXPECT_TRUE(UrlHostIsLocalhost("0:0:0:0:0:0:0:1"));
  EXPECT_TRUE(UrlHostIsLocalhost("foo.localhost"));
  EXPECT_TRUE(UrlHostIsLocalhost("foo.localhost."));
  EXPECT_TRUE(UrlHostIsLocalhost("foo.localhoST"));
  EXPECT_TRUE(UrlHostIsLocalhost("foo.localhoST."));

  EXPECT_FALSE(UrlHostIsLocalhost("localhostx"));
  EXPECT_FALSE(UrlHostIsLocalhost("localhost.x"));
  EXPECT_FALSE(UrlHostIsLocalhost("foo.localdomain"));
  EXPECT_FALSE(UrlHostIsLocalhost("foo.localdomain.x"));
  EXPECT_FALSE(UrlHostIsLocalhost("localhost6x"));
  EXPECT_FALSE(UrlHostIsLocalhost("localhost.localdomain6"));
  EXPECT_FALSE(UrlHostIsLocalhost("localhost6.localdomain"));
  EXPECT_FALSE(UrlHostIsLocalhost("127.0.0.1.1"));
  EXPECT_FALSE(UrlHostIsLocalhost(".127.0.0.255"));
  EXPECT_FALSE(UrlHostIsLocalhost("::2"));
  EXPECT_FALSE(UrlHostIsLocalhost("::1:1"));
  EXPECT_FALSE(UrlHostIsLocalhost("0:0:0:0:1:0:0:1"));
  EXPECT_FALSE(UrlHostIsLocalhost("::1:1"));
  EXPECT_FALSE(UrlHostIsLocalhost("0:0:0:0:0:0:0:0:1"));
  EXPECT_FALSE(UrlHostIsLocalhost("foo.localhost.com"));
  EXPECT_FALSE(UrlHostIsLocalhost("foo.localhoste"));
  EXPECT_FALSE(UrlHostIsLocalhost("foo.localhos"));
  EXPECT_FALSE(UrlHostIsLocalhost("[::1]"));
