...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  // Do nothing if input is too long. This is before the GURL line to prevent
  // the fuzzer from exploring GURL space with inputs long enough that
  // SniffMimeType is not called.
