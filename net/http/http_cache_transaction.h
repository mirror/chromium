...
class NET_EXPORT_PRIVATE HttpCache::Transaction : public HttpTransaction {
 public:
  ...
  // Virtual so it can be extended for testing. It will also set entry_ to
  // nullptr as this transaction is removed from writers.
  ...
  void AboutToBeRemovedFromWriters();
