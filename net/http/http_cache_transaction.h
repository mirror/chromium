...
class NET_EXPORT_PRIVATE HttpCache::Transaction : public HttpTransaction {
 public:
  ...
  void ReadyToBeRemovedFromWriters();
 ...
 private:
  ...
  // DoneWritingToEntry will be invoked.
  ...
  // Remove the transaction from entry_ and impact other queued transactions
  // via DoneWritingToEntry.
  // If |keep_entry| is false, entry will also be doomed.
  void DoneWritingToEntry(bool keep_entry);
