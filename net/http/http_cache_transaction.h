...
class NET_EXPORT_PRIVATE HttpCache::Transaction : public HttpTransaction {
 public:
  ...
  // Invoked when this transaction is about to become a reader.
 ...
 private:
  ...
  const HttpTransaction* network_transaction_for_info_retrieval() const;
  ...
  // statistics.
  bool moved_owned_network_transaction_to_writers_;
