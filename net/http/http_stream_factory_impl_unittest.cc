...
class CapturePreconnectsSocketPool : public ParentPool {
 public:
  ...
  HttpRequestInfo::RequestMotivation last_motivation() const {
 ...
 private:
  ...
  HttpRequestInfo::RequestMotivation last_motivation_;
};
...
CapturePreconnectsSocketPool<ParentPool>::CapturePreconnectsSocketPool(
    ...
    : ParentPool(0, 0, host_resolver, nullptr, nullptr, nullptr),
      last_num_streams_(-1),
      last_motivation_(HttpRequestInfo::NORMAL_MOTIVATION) {}
