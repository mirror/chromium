...
void SetTrafficAnnotation(HttpRequestInfo* request) {
...
TEST_F(HttpNetworkTransactionTest, SimpleGETNoReadDestroyRequestInfo) {
...

  {
    ...
    request->method = "GET";
    request->url = GURL("http://www.example.org/");
    SetTrafficAnnotation(request.get());
...
TEST_F(HttpNetworkTransactionTest, ResendRequestOnWriteBodyError) {
  ...
  SetTrafficAnnotation(&request[0]);
  ...
  SetTrafficAnnotation(&request[1]);
...
TEST_F(HttpNetworkTransactionTest, CrossOriginSPDYProxyPush) {
  ...
  SetTrafficAnnotation(&push_request);
...
void HttpNetworkTransactionTest::BypassHostCacheOnRefreshHelper(
  ...
  SetTrafficAnnotation(&request_info);
...
TEST_F(HttpNetworkTransactionTest, AlternateProtocolPortRestrictedBlocked) {
  ...
  SetTrafficAnnotation(&restricted_port_request);
...
TEST_F(HttpNetworkTransactionTest, AlternateProtocolPortUnrestrictedAllowed1) {
  ...
  SetTrafficAnnotation(&unrestricted_port_request);
...
TEST_F(HttpNetworkTransactionTest, CloseSSLSocketOnIdleForHttpRequest) {
  ...
  SetTrafficAnnotation(&ssl_request);
  ...
  SetTrafficAnnotation(&http_request);
