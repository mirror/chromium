...
class NET_EXPORT HttpCache : public HttpTransactionFactory {
 ...
 private:
  ...
  // |entry| is the owner of writers and |transaction| if not-null, is the
  // currently active transaction that led to this call.
  //
  // Removes |transaction| from writers and might also impact the queued
