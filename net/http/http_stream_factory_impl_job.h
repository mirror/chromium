...
class HttpStreamFactoryImpl::Job {
 ...
 private:
  ...
  // If this is a QUIC alt job, then this function is called only when host
  // resolution succeeds but |quic_request_| gets ERR_IO_PENDING afterwards.
  void OnQuicHostResolutionSuccess();
