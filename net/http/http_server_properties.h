...
// Store at most 1000 MRU RecentlyBrokenAlternativeServices in memory and disk.
// TODO (wangyix): update this value after looking at histograms.
const int kMaxRecentlyBrokenAlternativeServiceEntries = 1000;
