...
class NET_EXPORT_PRIVATE HttpNetworkTransaction
 ...
 private:
  ...
  // Max number of |retry_attempts| (including the initial request)
  // after which we give up and show an error page.
  const size_t kMaxRetryAttempts = 3;
