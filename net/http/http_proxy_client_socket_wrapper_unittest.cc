...
#include "net/quic/chromium/quic_http_utils.cc"
...
TEST_P(HttpProxyClientSocketWrapperTest, QuicProxy) {
  ...
  client_socket_wrapper_.reset(new HttpProxyClientSocketWrapper(
      ...
      /*quic_proxy_server=*/proxy_host_port_, quic_version_, privacy_mode_,
      /*cert_verify_flags=*/0, kUserAgent, endpoint_host_port_,
      &http_auth_cache_, http_auth_handler_factory_.get(),
