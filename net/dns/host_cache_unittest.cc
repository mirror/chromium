...
TEST(HostCacheTest, Basic) {
  ...
  HostCache::Entry entry =
      HostCache::Entry(HostCache::Entry::SOURCE_UNKNOWN, OK, AddressList());
...
TEST(HostCacheTest, SerializeAndDeserialize) {
  ...
  HostCache::Entry entry1 = HostCache::Entry(HostCache::Entry::SOURCE_UNKNOWN,
                                             OK, AddressList(endpoint_ipv4));
  AddressList addresses2 = AddressList(endpoint_ipv6);
  addresses2.push_back(endpoint_ipv4);
  HostCache::Entry entry2 =
      HostCache::Entry(HostCache::Entry::SOURCE_DNS, OK, addresses2);
  HostCache::Entry entry3 = HostCache::Entry(HostCache::Entry::SOURCE_HOSTS, OK,
                                             AddressList(endpoint_ipv6));
  HostCache::Entry entry4 = HostCache::Entry(HostCache::Entry::SOURCE_HOSTS, OK,
                                             AddressList(endpoint_ipv4));
  ...
  EXPECT_EQ(1, stale.network_changes);
  EXPECT_EQ(HostCache::Entry::SOURCE_UNKNOWN, result1->source());
  ...
  EXPECT_EQ(1, stale.network_changes);
  EXPECT_EQ(HostCache::Entry::SOURCE_DNS, result2->source());
  EXPECT_GT(base::TimeDelta::FromMilliseconds(100),
  ...
  EXPECT_EQ(HostCache::Entry::SOURCE_UNKNOWN, result3->source());
  ...
  EXPECT_EQ(HostCache::Entry::SOURCE_HOSTS, result4->source());
...
TEST(HostCacheTest, PersistenceDelegate) {
  ...
  addresses2.push_back(endpoint_ipv4);
  HostCache::Entry entry2 =
      HostCache::Entry(HostCache::Entry::SOURCE_UNKNOWN, OK, addresses2);
  HostCache::Entry entry3 = HostCache::Entry(
      HostCache::Entry::SOURCE_UNKNOWN, ERR_NAME_NOT_RESOLVED, AddressList());
