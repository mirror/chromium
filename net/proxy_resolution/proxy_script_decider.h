...
#ifndef NET_PROXY_RESOLUTION_PROXY_SCRIPT_DECIDER_H_
#define NET_PROXY_RESOLUTION_PROXY_SCRIPT_DECIDER_H_
...
#endif  // NET_PROXY_RESOLUTION_PROXY_SCRIPT_DECIDER_H_
