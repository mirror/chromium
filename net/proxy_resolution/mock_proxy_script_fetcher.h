...
#ifndef NET_PROXY_RESOLUTION_MOCK_PROXY_SCRIPT_FETCHER_H_
#define NET_PROXY_RESOLUTION_MOCK_PROXY_SCRIPT_FETCHER_H_
...
#endif  // NET_PROXY_RESOLUTION_MOCK_PROXY_SCRIPT_FETCHER_H_
