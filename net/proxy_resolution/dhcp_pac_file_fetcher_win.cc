...
void DhcpProxyScriptFetcherWin::OnGetCandidateAdapterNamesDone(
  ...
  //   OS bug (?), probably the cause of http://crbug.com/240034). Note that it
  //   is expected that TaskScheduler will maintain a reasonable number of
  //   threads in the process even if hundreds of fetch tasks are posted
  //   concurrently.
