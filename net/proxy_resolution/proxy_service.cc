...
LoadState ProxyResolutionService::Request::GetLoadState() const {
  if (service_->current_state_ == STATE_WAITING_FOR_INIT_PROXY_RESOLVER)
...
int ProxyResolutionService::ResolveProxy(const GURL& raw_url,
                                         ...
                                         ProxyInfo* result,
                                         const CompletionCallback& callback,
                                         std::unique_ptr<Request>* pac_request,
                                         ProxyDelegate* proxy_delegate,
                                         const NetLogWithSource& net_log) {
...
int ProxyResolutionService::ResolveProxyHelper(
  ...
  std::unique_ptr<Request> req(new Request(this, url, method, proxy_delegate,
