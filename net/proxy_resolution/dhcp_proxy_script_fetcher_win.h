...
#ifndef NET_PROXY_RESOLUTION_DHCP_PROXY_SCRIPT_FETCHER_WIN_H_
#define NET_PROXY_RESOLUTION_DHCP_PROXY_SCRIPT_FETCHER_WIN_H_
...
#endif  // NET_PROXY_RESOLUTION_DHCP_PROXY_SCRIPT_FETCHER_WIN_H_
