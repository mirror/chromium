...
public class X509Util {
    ...
    /**
     * KeyStore backed up by a custom certificate store. This is used to inject
     * the test root CA to in testing.
     */
     ...
     * fields except sVerifier are immutable once ensureInitialized completes successfully.
     */
    ...
    private static final class CertificateVerifier {
        ...
        /**
         * X509TrustManager wrapping sTestKeyStore.
         */
        ...
        public CertificateVerifier()
            ...
            if (sTestKeyStore != null) {
                mTestTrustManager = createTrustManager(sTestKeyStore);
            }
