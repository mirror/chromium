...
public class X509Util {
    ...
    private static void ensureInitializedLocked()
        ...
        if (!sLoadedSystemKeyStore) {
            ...
            if (!sDisableNativeCodeForTest && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                // Only record the histogram for 4.2 and up. Before 4.2, the platform doesn't
                // return the certificate chain anyway.
                RecordHistogram.recordBooleanHistogram("Net.FoundSystemTrustRootsAndroid",
                        sSystemKeyStore != null);
            }
