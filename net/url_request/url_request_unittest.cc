...
std::string MakeSubjectFromCommonName(const std::string& common_name) {
...
TEST_F(HTTPSCRLSetTest, CRLSetRevokedBySubject) {
  ...
  {
    ScopedSetCRLSet set_crlset(CRLSet::ForTesting(
        false, nullptr, "", MakeSubjectFromCommonName(kCommonName), {}));
