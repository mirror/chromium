...
class NET_EXPORT URLRequestContextBuilder {
 public:
  ...
  // default behavior.
  void set_proxy_service(std::unique_ptr<ProxyResolutionService> proxy_service) {
 ...
 protected:
  // Lets subclasses override ProxyResolutionService creation, using a ProxyResolutionService that
