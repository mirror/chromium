...
class FrameParts : public Http2FrameDecoderListener {
 public:
  ...
  base::Optional<Http2PriorityFields> GetOptPriority() { return opt_priority_; }
  base::Optional<Http2ErrorCode> GetOptRstStreamErrorCode() {
    return opt_rst_stream_error_code_;
  }
  base::Optional<Http2PushPromiseFields> GetOptPushPromise() {
    return opt_push_promise_;
  }
  base::Optional<Http2PingFields> GetOptPing() { return opt_ping_; }
  base::Optional<Http2GoAwayFields> GetOptGoaway() { return opt_goaway_; }
  base::Optional<size_t> GetOptPadLength() { return opt_pad_length_; }
  base::Optional<size_t> GetOptPayloadLength() { return opt_payload_length_; }
  base::Optional<size_t> GetOptMissingLength() const {
    return opt_missing_length_;
  }
  base::Optional<size_t> GetOptAltsvcOriginLength() {
    return opt_altsvc_origin_length_;
  }
  base::Optional<size_t> GetOptAltsvcValueLength() {
    return opt_altsvc_value_length_;
  }
  base::Optional<size_t> GetOptWindowUpdateIncrement() {
    return opt_window_update_increment_;
  }

  std::vector<Http2SettingFields>& GetSettings() { return settings_; }
