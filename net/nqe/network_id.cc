...
// Deprecated algorithm for deserializing network ID. Returns a nullopt if it
// fails to parse |network_id|.
// TODO(tbansal): https://crbug.com/787994: This method should be removed once
// pref for most of the users has switched from the deprecated format to the new
// proto based format.
