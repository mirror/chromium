...
TEST(ThroughputAnalyzerTest, TestHangingRequests) {
  static const struct {
    size_t hanging_request_duration_http_rtt_multiplier;
    ...
    bool expect_throughput_observation;
      ...
      },
      {
          ...
          5, base::TimeDelta::FromMilliseconds(100),
  ...
  for (const auto& test : tests) {
    ...
    EXPECT_EQ(num_requests, throughput_analyzer.count_in_flight_requests());
