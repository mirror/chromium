...
base::Optional<uint64_t> CalculateSubnetID(const AddressList& address_list) {
  ...
  if (ip_addr.IsIPv4()) {
    ...
    // inside the subnet.
    return ((static_cast<uint64_t>(bytes[0]) << 16) & 0x0000000000FF0000U) |
           ((static_cast<uint64_t>(bytes[1]) << 8) & 0x000000000000FF00U) |
           (static_cast<uint64_t>(bytes[2]) & 0x00000000000000FFU);
  }
  ...
  if (ip_addr.IsIPv4MappedIPv6()) {
    ...
    return ((static_cast<uint64_t>(bytes[12]) << 16) & 0x0000000000FF0000U) |
           ((static_cast<uint64_t>(bytes[13]) << 8) & 0x000000000000FF00U) |
           (static_cast<uint64_t>(bytes[14]) & 0x00000000000000FFU);
  }
  ...
  return ((static_cast<uint64_t>(bytes[0]) << 40) & 0x0000FF0000000000U) |
         ((static_cast<uint64_t>(bytes[1]) << 32) & 0x000000FF00000000U) |
         ((static_cast<uint64_t>(bytes[2]) << 24) & 0x00000000FF000000U) |
         ((static_cast<uint64_t>(bytes[3]) << 16) & 0x0000000000FF0000U) |
         ((static_cast<uint64_t>(bytes[4]) << 8) & 0x000000000000FF00U) |
         (static_cast<uint64_t>(bytes[5]) & 0x00000000000000FFU);
}
