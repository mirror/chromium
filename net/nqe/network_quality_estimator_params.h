...
class NET_EXPORT NetworkQualityEstimatorParams {
 public:
  ...
  int hanging_request_upper_bound_http_rtt_transport_rtt_multiplier() const {
    return hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_;
  }

  // For the purpose of estimating the HTTP RTT, a request is marked as hanging
  // only if its RTT is at least this times the HTTP RTT estimate.
  int hanging_request_upper_bound_http_rtt_http_rtt_multiplier() const {
    return hanging_request_upper_bound_http_rtt_http_rtt_multiplier_;
  }
 ...
 private:
  ...
  const int hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_;
  const int hanging_request_upper_bound_http_rtt_http_rtt_multiplier_;
