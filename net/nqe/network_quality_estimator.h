...
class NET_EXPORT NetworkQualityEstimator
 ...
 protected:
  ...
  // If |transport_rtt_observation_count| is not
  // null, then it is set to the number of transport RTT observations that were
  // available when computing the effective connection type.
