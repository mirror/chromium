...
typedef nqe::internal::IPHash IPHash;
...
class NET_EXPORT NetworkQualityEstimator
 ...
 private:
  ...
  // mile. The baseline is computed using
  // the transport RTT observations in the past 60 seconds. The current RTT is
  // computed using the observations in the past 5 seconds.
