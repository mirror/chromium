...
bool NetworkQualityEstimator::IsHangingRequest(
  ...
  if (transport_rtt_observation_count_last_ect_computation_ >=
      ...
      (params_->hanging_request_upper_bound_http_rtt_transport_rtt_multiplier() <=
           0 ||
       observed_http_rtt <
           params_->hanging_request_upper_bound_http_rtt_transport_rtt_multiplier() *
  ...
  if (params_->hanging_request_upper_bound_http_rtt_http_rtt_multiplier() <=
          0 ||
      observed_http_rtt <
          params_->hanging_request_upper_bound_http_rtt_http_rtt_multiplier() *
