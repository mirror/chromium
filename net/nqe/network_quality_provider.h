...
class NET_EXPORT NetworkQualityProvider {
 public:
  ...
  // Returns the current bandwidth delay product estimate (in bits). If the
  // estimate is not available, the returned optional value is null.
  virtual base::Optional<int64_t> GetBandwidthDelayProductKBits() const;
