...
NetworkQualityEstimatorParams::NetworkQualityEstimatorParams(
    ...
    : params_(params),
      ...
      upper_bound_http_rtt_transport_rtt_multiplier_(
          GetDoubleValueForVariationParamWithDefaultValue(
              ...
              -1)),
      hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_(
          GetValueForVariationParam(
              params_,
              "hanging_request_upper_bound_http_rtt_transport_rtt_multiplier",
              -1)),
      hanging_request_upper_bound_http_rtt_http_rtt_multiplier_(
          GetValueForVariationParam(
              params_,
              "hanging_request_upper_bound_http_rtt_http_rtt_multiplier",
              -1)),
  ...
  DCHECK(hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_ == -1 ||
         hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_ > 0);
  DCHECK(hanging_request_upper_bound_http_rtt_http_rtt_multiplier_ == -1 ||
         hanging_request_upper_bound_http_rtt_http_rtt_multiplier_ > 0);
  DCHECK(hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_ == -1 ||
         hanging_request_upper_bound_http_rtt_http_rtt_multiplier_ == -1 ||
         hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_ >=
             hanging_request_upper_bound_http_rtt_http_rtt_multiplier_);

  DCHECK(upper_bound_http_rtt_transport_rtt_multiplier_ == -1 ||
         hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_ == -1 ||
         upper_bound_http_rtt_transport_rtt_multiplier_ <
             hanging_request_upper_bound_http_rtt_transport_rtt_multiplier_);
