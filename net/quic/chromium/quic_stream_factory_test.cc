...
TEST_P(QuicStreamFactoryTest, GetHostResolutionResultAsync) {
  ...
  EXPECT_EQ(ERR_IO_PENDING, request.GetHostResolutionResult(
...
TEST_P(QuicStreamFactoryTest, GetHostResolutionResultSync) {
  Initialize();
  ProofVerifyDetailsChromium verify_details = DefaultProofVerifyDetails();
  crypto_client_stream_factory_.AddProofVerifyDetails(&verify_details);
...
TEST_P(QuicStreamFactoryTest, GetHostResolutionResultSyncAsync) {
  Initialize();
  ProofVerifyDetailsChromium verify_details = DefaultProofVerifyDetails();
  crypto_client_stream_factory_.AddProofVerifyDetails(&verify_details);
  ...
  // synchronously. Therefore, GetHostResolutionResult() should return OK.
  TestCompletionCallback host_resolution_callback;
  EXPECT_THAT(
      request.GetHostResolutionResult(host_resolution_callback.callback()),
      IsOk());
...
TEST_P(QuicStreamFactoryTest, GetHostResolutionResultSyncFail) {
  Initialize();
  ProofVerifyDetailsChromium verify_details = DefaultProofVerifyDetails();
  crypto_client_stream_factory_.AddProofVerifyDetails(&verify_details);
  ...
  TestCompletionCallback host_resolution_callback;
  EXPECT_EQ(ERR_NAME_NOT_RESOLVED, request.GetHostResolutionResult(
                                       host_resolution_callback.callback()));
}

TEST_P(QuicStreamFactoryTest, GetHostResolutionResultAsyncFail) {
  Initialize();
  ProofVerifyDetailsChromium verify_details = DefaultProofVerifyDetails();
  crypto_client_stream_factory_.AddProofVerifyDetails(&verify_details);
