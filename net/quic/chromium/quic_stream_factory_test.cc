...
TEST_P(QuicStreamFactoryTest, ResultAfterHostResolutionCallbackAsyncSync) {
  ...
  EXPECT_TRUE(request.WaitForResultAfterHostResolution(
  ...
  // Calling WaitForResultAfterHostResolution() a second time should return
  // false since host resolution has finished already.
  EXPECT_FALSE(request.WaitForResultAfterHostResolution(
      host_resolution_callback.callback()));
...
TEST_P(QuicStreamFactoryTest, ResultAfterHostResolutionCallbackSyncSync) {
  ...
  // WaitForResultAfterHostResolution() should return false since host
