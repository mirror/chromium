...
class NET_EXPORT_PRIVATE QuicStreamRequest {
 public:
  ...
  // This function must be called after Request(). If Request() requires host
  // resolution and it hasn't completed yet
 ...
 private:
  ...
  // Callback passed to GetResultAfterHostResolution().
