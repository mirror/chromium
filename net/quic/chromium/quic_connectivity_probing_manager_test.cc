...
class QuicConnectivityProbingManagerPeer {
 public:
  static void SetTaskRunnerForTimer(QuicConnectivityProbingManager* manager,
                                    base::SequencedTaskRunner* task_runner) {
    manager->retransmit_timer_.SetTaskRunner(task_runner);
  }
};
...
class QuicConnectivityProbingManagerTest : public ::testing::Test {
 public:
  QuicConnectivityProbingManagerTest()
      : test_task_runner_(new base::TestMockTimeTaskRunner()),
        ...
        probing_manager_(new QuicConnectivityProbingManager(&session_)),
 ...
 protected:
  void SetUp() override {
    ...
    QuicConnectivityProbingManagerPeer::SetTaskRunnerForTimer(
        probing_manager_.get(), test_task_runner_.get());
  }
