...
class QUIC_EXPORT_PRIVATE PacketNumberQueue {
 public:
  ...
  class QUIC_EXPORT_PRIVATE const_iterator {
   ...
   private:
    ...
    typename QuicCircularDeque<Interval<QuicPacketNumber>>::const_iterator deque_it_;
  ...
  class QUIC_EXPORT_PRIVATE const_reverse_iterator {
   ...
   private:
    typename QuicIntervalSet<QuicPacketNumber>::const_reverse_iterator
        vector_it_;
    typename QuicCircularDeque<Interval<QuicPacketNumber>>::const_reverse_iterator
        deque_it_;
    const bool use_deque_it_;
  };
 ...
 private:
  ...
  QuicCircularDeque<Interval<QuicPacketNumber>> packet_number_deque_;
  bool use_deque_;
};
