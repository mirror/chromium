...
class QUIC_EXPORT_PRIVATE PacketNumberQueue {
 public:
  ...
  class const_iterator
      : public std::iterator<std::forward_iterator_tag, QuicPacketNumber> {
   public:
    ...
    typedef QuicPacketNumber value_type;
    typedef QuicPacketNumber& reference;
    typedef QuicPacketNumber* pointer;
    typedef typename std::vector<QuicPacketNumber>::iterator::difference_type
        difference_type;
