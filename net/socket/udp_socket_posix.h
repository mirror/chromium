...
class NET_EXPORT UDPSocketPosix {
 public:
  ...
  void enable_experimental_optimization() {
    DCHECK_EQ(kInvalidSocket, socket_);
    experimental_optimization_enabled_ = true;
  };
 ...
 private:
  ...
  // enable_experimental_optimization() method.
  bool experimental_optimization_enabled_;
