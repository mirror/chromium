...
// implemented for Android, it facilitates assigning a TrafficStats tag and UID
// to a socket so that future network data usage by the socket is attributed to
// the tag and UID that the socket is tagged with.
//
...
class NET_EXPORT SocketTag {
 public:
  ...
  // Create a SocketTag with given UID |uid| and |tag|.
