...
// TODO(rhalavati): To be updated, traffic annotation for SOCKS5ClientSocket
// internals.
...
int SOCKS5ClientSocket::DoGreetWrite() {
  ...
  return transport_->socket()->Write(kTrafficAnnotation, handshake_buf_.get(),
                                     handshake_buf_len, io_callback_);
}
