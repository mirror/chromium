...
class SSLServerContextImpl::SocketImpl : public SSLServerSocket,
 ...
 private:
  ...
  base::WeakPtrFactory<SSLServerContextImpl::SocketImpl> weak_factory_;
...
class SSLServerContextImpl::Handshaker {
 ...
 private:
  ...
  base::WeakPtrFactory<Handshaker> weak_factory_;
};
...
SSLServerContextImpl::SocketImpl::PrivateKeySignCallback(uint8_t* out,
  ...
  context_->private_key_->Sign(
      ...
      base::Bind(&SSLServerContextImpl::SocketImpl::OnPrivateKeyComplete,
...
int SSLServerContextImpl::SocketImpl::Init() {
  ...
  if (!ssl_ ||
      !SSLServerContextImpl::Handshaker::GetInstance()->SetServerSocketForSSL(
          ssl_.get(), this))
