  ...
  if (using_ssl) {
    ...
    if (num_preconnect_streams) {
      RequestSocketsForPool(ssl_pool, connection_group, ssl_params,
                            num_preconnect_streams, net_log, use_callback);
      return OK;
    }
...
int InitSocketHandleForHttpRequest(
  ...
  return InitSocketPoolHelper(
      ...
      resolution_callback, callback, StreamSocket::SocketUseCallback());
}
...
int InitSocketHandleForRawConnect(const HostPortPair& host_port_pair,
  ...
  return InitSocketPoolHelper(
      ...
      callback, StreamSocket::SocketUseCallback());
}
...
int PreconnectSocketsForHttpRequest(
    ...
    const NetLogWithSource& net_log,
    int num_preconnect_streams,
    const StreamSocket::SocketUseCallback& callback) {
  return InitSocketPoolHelper(
      group_type, endpoint, request_extra_headers, request_load_flags,
      request_priority, session, proxy_info, expect_spdy, ssl_config_for_origin,
      ...
      OnHostResolutionCallback(), CompletionCallback(), callback);
}
