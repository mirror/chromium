...
class FastOpenProbe {
 public:
  ...
  // not detected, or the probe has not yet been run.
 ...
 private:
  ...
  FastOpenProbe() {
    base::PostTaskWithTraits(
        ...
        base::Bind(&FastOpenProbe::SystemSupportsTCPFastOpen,
...
base::LazyInstanceInstance<FastOpenProbe>::Leaky g_fast_open_probe =
    LAZY_INSTANCE_INITIALIZER;

bool IsTCPFastOpenSupported() {
  g_fast_open_probe.Get()->IsTCPFastOpenSupported();
}
