...
// TODO(zstein): DscpManager test cases:
// Preparing multiple addresses for sending.
...
class DscpManager {
 ...
 private:
  ...
  // TODO(zstein): Managing these might be less annoying with a nested class
  // or just additional members in UDPSocketWin.
  SOCKET socket_;
  HANDLE qos_handle_;
};
