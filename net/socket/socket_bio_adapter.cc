    ...
    net::DefineNetworkTrafficAnnotation("socket_bio_adapter", R"(
      semantics {
        ...
        data:
          ...
          "cookies, request headers, and the response body. In case of "
          "handshake, user's IP, host name, data related to previous "
          "handshake, client certificates, and channel id, may be sent.""
        destination: OTHER
        destination_other:
