...
class ToDafsaTest(unittest.TestCase):
  def testEmptyInput(self):
    ...
    words = ()
    self.assertRaises(dafsa_utils.InputError, dafsa_utils.to_dafsa, words)

  def testNonASCII(self):
    """Tests exception is thrown if illegal characters are used."""
    words1 = ( chr(0x1F) + 'a1', )
    self.assertRaises(dafsa_utils.InputError, dafsa_utils.to_dafsa, words1)

    words2 = ( 'a' + chr(0x1F) + '1', )
    self.assertRaises(dafsa_utils.InputError, dafsa_utils.to_dafsa, words2)

    words3 = ( chr(0x80) + 'a1', )
    self.assertRaises(dafsa_utils.InputError, dafsa_utils.to_dafsa, words3)

    words4 = ( 'a' + chr(0x80) + '1', )
    self.assertRaises(dafsa_utils.InputError, dafsa_utils.to_dafsa, words4)
  ...
  def testChar(self):
    ...
    node1 = ( 'a', [ node2 ] )
    source = [ node1 ]
    self.assertEqual(dafsa_utils.to_dafsa(words), source)
...
class ToWordsTest(unittest.TestCase):
  def testSink(self):
    ...
    node1 = None
    words = [ '' ]
    self.assertEqual(dafsa_utils.to_words(node1), words)
...
class JoinLabelsTest(unittest.TestCase):
  def testLabel(self):
    ...
    node1 = ( 'a', [ None ] )
    source = [ node1 ]
    self.assertEqual(dafsa_utils.join_labels(source), source)
  ...
  def testLabels(self):
    ...
    node3 = ( 'ab', [ None ] )
    source2 = [ node3 ]
    self.assertEqual(dafsa_utils.join_labels(source1), source2)
...
class JoinSuffixesTest(unittest.TestCase):
  def testSingleLabel(self):
    ...
    node1 = ( 'a', [ None ] )
    source = [ node1 ]
    self.assertEqual(dafsa_utils.join_suffixes(source), source)
  ...
  def testJoinTwoHeads(self):
    ...
    source2 = dafsa_utils.join_suffixes(source1)
...
class ReverseTest(unittest.TestCase):
  def testAtomicLabel(self):
    ...
    node1 = ( 'a', [ None ] )
    source = [ node1 ]
    self.assertEqual(dafsa_utils.reverse(source), source)
  ...
  def testLabel(self):
    ...
    node2 = ( 'ba', [ None ] )
    source2 = [ node2 ]
    self.assertEqual(dafsa_utils.reverse(source1), source2)
...
class TopSortTest(unittest.TestCase):
  def testNode(self):
    ...
    source = [ node1 ]
    nodes = [ node1 ]
    self.assertEqual(dafsa_utils.top_sort(source), nodes)
  ...
  def testDiamond(self):
    ...
    node1 = ( 'a', [ node2, node3 ] )
    source = [ node1 ]
    nodes = dafsa_utils.top_sort(source)
...
class EncodePrefixTest(unittest.TestCase):
  def testChar(self):
    ...
    label = 'a'
    bytes = [ ord('a') ]
    self.assertEqual(dafsa_utils.encode_prefix(label), bytes)
...
class EncodeLabelTest(unittest.TestCase):
  def testChar(self):
    ...
    label = 'a'
    bytes = [ ord('a') + 0x80 ]
    self.assertEqual(dafsa_utils.encode_label(label), bytes)
...
class EncodeLinksTest(unittest.TestCase):
  def testEndLabel(self):
    ...
    bytes = 0
    output = []
    self.assertEqual(dafsa_utils.encode_links(children, offsets, bytes),
                      output)
