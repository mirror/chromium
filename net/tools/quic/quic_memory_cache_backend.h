...
#ifndef NET_TOOLS_QUIC_QUIC_MEMORY_CACHE_BACKEND_H_
#define NET_TOOLS_QUIC_QUIC_MEMORY_CACHE_BACKEND_H_
...
class QuicMemoryCacheBackend : public QuicSimpleServerBackend {
 public:
  ...
  void FetchResponseFromBackend(
      QuicSimpleServerBackend::QuicServerStreamDelegate* quic_server_stream,
...
#endif  // NET_TOOLS_QUIC_QUIC_MEMORY_CACHE_BACKEND_H_
