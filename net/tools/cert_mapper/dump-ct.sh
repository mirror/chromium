...
if [ $# -ne 2 ] ; then
  echo "This tool will extract all of the certificates in a"
  echo "CertificateTransparency database and write their raw DER to a"
  echo "directory using a simpler binary format"
  echo ""
