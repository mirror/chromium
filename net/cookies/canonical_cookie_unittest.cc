...
// Confirm that various combinations of CreateSanitizedCookie() inputs
// do and don't create actual cookies.
...
TEST(CanonicalCookieTest, CreateSanitizedCookie_Whitebox) {
  // Good cookie.
