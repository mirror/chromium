...
void InitializeReporingPolicy(
  ...
  policy.delivery_interval = base::TimeDelta::FromMicroseconds(
      policy_data.delivery_interval_us());
  policy.persistence_interval = base::TimeDelta::FromMicroseconds(
      policy_data.persistence_interval_us());
  ...
  policy.max_report_age = base::TimeDelta::FromMicroseconds(
      policy_data.max_report_age_us());
...
DEFINE_BINARY_PROTO_FUZZER(
  ...
  net::ReportingPolicy policy;
  InitializeReporingPolicy(policy, input.policy());
