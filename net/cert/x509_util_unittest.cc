...
TEST(X509UtilTest, IsUnrelatedCertSymantecLegacyCert) {
  ...
  EXPECT_FALSE(x509_util::IsLegacySymantecCert(unrelated_hashes));
}

// Tests that IsLegacySymantecCert() works correctly for excluded and
// non-excluded Symantec roots.
TEST(X509UtilTest, IsLegacySymantecCert) {
