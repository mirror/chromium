...
#include "net/cert/x509_certificate.h"
    ...
    defined(OS_FUCHSIA)
// When PLATFORM_HAS_EV_ROOT_CA_METADATA is false, the EVRootCAMetadata
// singleton is a placeholder implementation that will fail all EV lookup
// operations.
...
class NET_EXPORT_PRIVATE EVRootCAMetadata {
 public:
  ...
  // platform-specific CertVerifyProcs for these platforms when doing EV
  // verification.
...
#elif defined(PLATFORM_HAS_EV_ROOT_CA_METADATA)
  using PolicyOIDMap = std::
