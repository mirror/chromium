...
bool IsAnyCertificateInRootList(const HashValueVector& public_key_hashes,
...
bool IsLegacySymantecCert(const HashValueVector& public_key_hashes) {
  return IsAnyCertificateInRootList(public_key_hashes, kSymantecRoots,
                                    kSymantecRootsLength) &&
         !IsAnyCertificateInRootList(public_key_hashes, kSymantecExceptions,
