...
TEST_P(CertVerifyProcInternalTest, EVVerificationOfComodo) {
  if (!SupportsEV()) {
  ...
  if (error == ERR_CERT_DATE_INVALID) {
    ADD_FAILURE() << "The test data net/data/ssl/certificates/comodo.chain.pem "
                     "has expired and needs to be re-generated by running "
                     "net/data/ssl/scripts/fetch-live-certs.sh. Please "
                     "file a bug against "
                     "component:Internals>Network>Certificate and disable this "
