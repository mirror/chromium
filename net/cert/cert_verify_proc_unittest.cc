...
// A server provides a GOST-using certificate as an intermediate. The
// certificate isn't needed to verify the chain.
TEST_P(CertVerifyProcInternalTest, GOSTIntermediate) {
