...
NET_EXPORT extern CertErrorId kSignatureAlgorithmsDifferentEncoding;
...
NET_EXPORT extern CertErrorId kEkuLacksServerAuth;
...
NET_EXPORT extern CertErrorId kEkuLacksClientAuth;

// The root certificate in a chain is not trusted.
NET_EXPORT extern CertErrorId kCertIsNotTrustAnchor;
...
NET_EXPORT extern CertErrorId kNoValidPolicy;

// The certificate is trying to map to, or from, anyPolicy.
NET_EXPORT extern CertErrorId kPolicyMappingAnyPolicy;

// The public key in this certificate could not be parsed.
NET_EXPORT extern CertErrorId kFailedParsingSpki;
...
NET_EXPORT extern CertErrorId kUnacceptableSignatureAlgorithm;
...
NET_EXPORT extern CertErrorId kUnacceptablePublicKey;
