...
class NET_EXPORT CertPathBuilderDelegate
 ...
 public:
  ...
  // been run through RFC 5280 verification. The path may already have errors
  // and warnings set on it. This delegate can be used to do things like
  // revocation checking, and add additional errors to the path.
