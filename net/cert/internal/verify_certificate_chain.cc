...
class PathVerifier {
 ...
 private:
  ...
  // by |delegate_|. On failure returns nullptr, and adds a high-severity error
  // to |errors|.
...
void PathVerifier::BasicCertificateProcessing(
  ...
  // Parse the key from SPKI, and check whether it is acceptable (if either
  // fails, an error will have been added to |errors|).
