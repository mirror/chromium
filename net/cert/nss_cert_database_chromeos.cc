...
std::vector<ScopedCERTCertificate> NSSCertDatabaseChromeOS::ListCertsSync() {
...
std::vector<ScopedCERTCertificate> NSSCertDatabaseChromeOS::ListCertsImpl(
    const NSSProfileFilterChromeOS& profile_filter) {
  std::vector<ScopedCERTCertificate> certs(
