...
// kBlockedSPKICRLSet contains a single blocked subject hash.
static const uint8_t kBlockedSubjectCRLSet[] = {
    0x91, 0x00, 0x7b, 0x22, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22,
    ...
    0x63, 0x6b, 0x65, 0x64, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73,
    0x22, 0x3a, 0x5b, 0x22, 0x72, 0x42, 0x65, 0x52, 0x75, 0x54, 0x36, 0x31,
...
TEST(CRLSetTest, BlockedSubjects) {
  ...
  EXPECT_EQ(CRLSet::GOOD, set->CheckSubject(""));
  EXPECT_EQ(CRLSet::REVOKED,
            set->CheckSubject(reinterpret_cast<const char*>(subject)));
}
