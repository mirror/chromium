...
class NET_EXPORT NSSCertDatabase {
 public:
  ...
  typedef base::Callback<void(std::vector<ScopedCERTCertificate> certs)>
      ListCertsCallback;
  ...
  virtual std::vector<ScopedCERTCertificate> ListCertsSync();
  ...
  int ImportFromPKCS12(PK11SlotInfo* slot_info,
                       ...
                       bool is_extractable,
                       std::vector<ScopedCERTCertificate>* imported_certs);
  ...
  int ExportToPKCS12(const ScopedCERTCertificateVector& certs,
                     const base::string16& password,
  ...
  CERTCertificate* FindRootInList(
      const std::vector<ScopedCERTCertificate>& certificates) const;
  ...
  // imported.
  bool ImportCACerts(const ScopedCERTCertificateVector& certificates,
  ...
  // |not_imported| should be checked for any certificates that were not
  // imported.
  bool ImportServerCert(const ScopedCERTCertificateVector& certificates,
                        TrustBits trust_bits,
                        ImportCertFailureList* not_imported);
 ...
 protected:
  ...
  // |slot|.
  static std::vector<ScopedCERTCertificate> ListCertsImpl(
