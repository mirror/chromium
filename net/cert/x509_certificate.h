...
class NET_EXPORT X509Certificate
 ...
 public:
  ...
  static bool GetPEMEncoded(const CRYPTO_BUFFER* cert_handle,
                            std::string* pem_encoded);
  ...
  static void GetPublicKeyInfo(const CRYPTO_BUFFER* cert_handle,
                               size_t* size_bits,
                               PublicKeyType* type);
  ...
  // object.
  CRYPTO_BUFFER* cert_buffer() const { return cert_handle_.get(); }
  ...
  static SHA256HashValue CalculateFingerprint256(
      const CRYPTO_BUFFER* cert_handle);
  ...
  static bool IsSelfSigned(const CRYPTO_BUFFER* cert_handle);
 ...
 private:
  ...
  X509Certificate(bssl::UniquePtr<CRYPTO_BUFFER> cert_handle,
                  std::vector<bssl::UniquePtr<CRYPTO_BUFFER>> intermediates);
  X509Certificate(bssl::UniquePtr<CRYPTO_BUFFER> cert_handle,
                  std::vector<bssl::UniquePtr<CRYPTO_BUFFER>> intermediates,
                  UnsafeCreateOptions options);
  ...
  bssl::UniquePtr<CRYPTO_BUFFER> cert_handle_;
