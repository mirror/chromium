...
class TcpSocketProxy {
 public:
  ...
  // Starts the proxy for the specified |remote_address|. Must be called after
  // a successful Initialize() calls and before any incoming connection on
  // local_port() are initiated.
