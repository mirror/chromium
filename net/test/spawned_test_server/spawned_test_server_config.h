...
#ifndef NET_TEST_SPAWNED_TEST_SERVER_SPAWNED_TEST_SERVER_CONFIG_H_
#define NET_TEST_SPAWNED_TEST_SERVER_SPAWNED_TEST_SERVER_CONFIG_H_
...
// SpawnedTestServerConfig is responsible for loading test server configuration
...
class SpawnedTestServerConfig {
 public:
  SpawnedTestServerConfig();
  ~SpawnedTestServerConfig();

  SpawnedTestServerConfig(const SpawnedTestServerConfig& other);
  SpawnedTestServerConfig& operator=(const SpawnedTestServerConfig&);

  // Returns current test server configuration, loading it from a file if the
  // file exists.
  static SpawnedTestServerConfig Load();
...
#endif  // NET_TEST_SPAWNED_TEST_SERVER_SPAWNED_TEST_SERVER_CONFIG_H_
