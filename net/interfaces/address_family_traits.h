...
#ifndef NET_INTERFACES_ADDRESS_FAMILY_STRUCT_TRAITS_H_
#define NET_INTERFACES_ADDRESS_FAMILY_STRUCT_TRAITS_H_
...
#endif  // NET_INTERFACES_ADDRESS_FAMILY_STRUCT_TRAITS_H_
