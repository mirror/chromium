...
TEST_F(DiskCacheBackendTest, CreateBackendDouble) {
  // The test fixture will do an integrity check at teardown; this makes its
  // expectations match the block backends for DISK_CACHE
  SetNewEviction();
...
TEST_F(DiskCacheBackendTest, CreateBackendDoubleOpenEntry) {
  ...
  // with Simple since block basically cancels all I/O on destruction
  // and blocks for what it can't cancel.
