...
class BackendCleanupTracker : public base::RefCounted<BackendCleanupTracker> {
 public:
  ...
  static BackendCleanupTracker* TryCreate(const base::FilePath& path,
 ...
 private:
  ...
  BackendCleanupTracker(const base::FilePath& path);
