...
using ContextMap = std::unordered_map<base::FilePath, CleanupContext*>;
struct AllContexts {
  ContextMap map;
...
void CleanupContext::AddPostCleanupCallback(base::OnceClosure cb) {
...
void CleanupContext::AddPostCleanupCallbackImpl(base::OnceClosure cb) {
