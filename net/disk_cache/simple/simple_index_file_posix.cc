...
bool SimpleIndexFile::TraverseCacheDirectory(
  ...
  // Some implementations (older versions of Android Bionic) of readdir() may
  // leave errno set to EINTR even after they handle this case internally. It's
  // safe to ignore EINTR in that case.
