    ...
    SimpleFileTracker /*: public base::RefCountedThreadSafe<SimpleFileTracker>*/
{
 public:
  ...
  void Register(SimpleSynchronousEntry* owner,
  ...
  base::File* Acquire(SimpleSynchronousEntry* owner, SubFile subfile);
  void Release(SimpleSynchronousEntry* owner, SubFile subfile);
  ...
  void Close(SimpleSynchronousEntry* owner, SubFile file);
 ...
 private:
  ...
  std::unordered_map<SimpleSynchronousEntry*, std::unique_ptr<TrackedFiles>>
      tracked_files_;
