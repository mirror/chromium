...
std::unique_ptr<base::Value> ElideNetLogHeaderCallback(
  ...
  std::string elided_value = ElideHeaderValueForNetLog(
      capture_mode, header_name.as_string(), header_value.as_string());
  dict->SetString("header_name", base::IsStringUTF8(header_name)
                                     ? header_name
                                     : "*** non-UTF8 string ***");
  dict->SetString("header_value", base::IsStringUTF8(elided_value)
                                      ? elided_value
                                      : "*** non-UTF8 string ***");
