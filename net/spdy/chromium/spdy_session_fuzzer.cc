...
#include "net/data/ssl/certificates/spdy_pooling.inc"
  ...
  net::X509Certificate::OSCertHandle handle =
      net::X509Certificate::CreateOSCertHandleFromBytes(kCertData,
                                                        arraysize(kCertData));
  ssl_provider.cert = net::X509Certificate::CreateFromHandle(
      handle, net::X509Certificate::OSCertHandles());
