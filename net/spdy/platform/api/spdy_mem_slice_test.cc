...
#ifndef NET_SPDY_PLATFORM_API_SPDY_MEM_SLICE_TEST_H_
#define NET_SPDY_PLATFORM_API_SPDY_MEM_SLICE_TEST_H_

#include "net/spdy/platform/api/spdy_mem_slice.h"

#include <utility>

#include "net/spdy/platform/api/spdy_test.h"

namespace net {
namespace test {
namespace {

class SpdyMemSliceTest : public SpdyTest {
 public:
  SpdyMemSliceTest() {
    size_t length = 1024;
    auto* buffer = new char[length];
    slice_ = SpdyMemSlice(SpdyMemSliceImpl(buffer, length));
...
#endif  // NET_SPDY_PLATFORM_API_SPDY_MEM_SLICE_TEST_H_
