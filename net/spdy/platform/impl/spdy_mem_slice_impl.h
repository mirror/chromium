...
class SPDY_EXPORT_PRIVATE SpdyMemSliceImpl {
 public:
  // Constructs an empty SpdyMemSliceImpl which contains an empty MemSlice.
  SpdyMemSliceImpl();

  // Constructs a reference-counted MemSlice by copying |data|.
  SpdyMemSliceImpl(const char* data, const int length);
