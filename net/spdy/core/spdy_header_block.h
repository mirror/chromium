...
class SPDY_EXPORT_PRIVATE SpdyHeaderBlock {
 private:
  ...
  class SPDY_EXPORT_PRIVATE HeaderValue {
   public:
    ...
    // SpdyHeaderBlock.
    int64_t SizeEstimate() const { return size_; }
 ...
 public:
  ...
  class SPDY_EXPORT_PRIVATE ValueProxy {
   ...
   private:
    ...
    ValueProxy(SpdyHeaderBlock::MapType* block,
               ...
               int64_t* spdy_header_block_value_size);
    ...
    int64_t* spdy_header_block_value_size_;
    bool valid_;
  };
  ...
  int64_t TotalBytesUsed() const { return key_size_ + value_size_; }
