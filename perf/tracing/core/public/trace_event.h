...
inline const unsigned char* GetCategoryGroupEnabledCached(
  ...
  if (TRACE_UNLIKELY(!category_group_enabled)) {
    category_group_enabled =
        ::tracing::internal::TracingCoreInterface::instance()
...
inline TraceEventHandle AddTraceEvent(
    ...
    uint32_t flags,
    uint64_t bind_id) {
  ::tracing::internal::TracingCoreInterface::instance()->AddEvent(
      phase, category_group_enabled, name, scope, id, bind_id,
      ::tracing::internal::TracingCoreInterface::instance()
          ->GetCurrentThreadId(),
      ::tracing::internal::TracingCoreInterface::instance()->GetWallTime(),
