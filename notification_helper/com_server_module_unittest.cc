...
TEST(ComServerModule, CreateInstanceObjectTest) {
  ...
  // The waitable event is unsignaled.
  EXPECT_FALSE(server_module.IsEventSignaled());

  // Create a class instance.
  // We could use Microsoft::WRL::ComPtr, which requires including
  // <wrl/client.h>. However, this violates checkdeps rules.
