...
# FIXME(backer): Move this documentation to there it is used...
...
class GLGenerator(object):
  ...
  def __init__(self, verbose, func_info):
  ...
  def GetFunctionInfo(self, name):
    ...
    if name in self.func_info:
      func_info = self.func_info[name].copy()
    else:
      func_info = {}
