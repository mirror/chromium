...
struct BeginRasterCHROMIUM {
  ...
  void* Set(void* cmd,
            ...
            GLboolean _use_distance_field_text,
            GLint _pixel_config) {
    static_cast<ValueType*>(cmd)->Init(_target, _texture_id, _width, _height,
...
static_assert(sizeof(BeginRasterCHROMIUM) == 36,
              "size of BeginRasterCHROMIUM should be 36");
static_assert(offsetof(BeginRasterCHROMIUM, header) == 0,
              "offset of BeginRasterCHROMIUM header should be 0");
static_assert(offsetof(BeginRasterCHROMIUM, target) == 4,
              "offset of BeginRasterCHROMIUM target should be 4");
static_assert(offsetof(BeginRasterCHROMIUM, texture_id) == 8,
              "offset of BeginRasterCHROMIUM texture_id should be 8");
static_assert(offsetof(BeginRasterCHROMIUM, width) == 12,
              "offset of BeginRasterCHROMIUM width should be 12");
static_assert(offsetof(BeginRasterCHROMIUM, height) == 16,
              "offset of BeginRasterCHROMIUM height should be 16");
static_assert(offsetof(BeginRasterCHROMIUM, msaa_sample_count) == 20,
              "offset of BeginRasterCHROMIUM msaa_sample_count should be 20");
static_assert(offsetof(BeginRasterCHROMIUM, can_use_lcd_text) == 24,
              "offset of BeginRasterCHROMIUM can_use_lcd_text should be 24");
static_assert(
    offsetof(BeginRasterCHROMIUM, use_distance_field_text) == 28,
    "offset of BeginRasterCHROMIUM use_distance_field_text should be 28");
static_assert(offsetof(BeginRasterCHROMIUM, pixel_config) == 32,
              "offset of BeginRasterCHROMIUM pixel_config should be 32");
