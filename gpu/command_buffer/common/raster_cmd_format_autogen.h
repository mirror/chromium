...
struct WaitSyncTokenCHROMIUM {
  ...
  void Init(GLint _namespace_id,
    ...
    RasterUtil::MapUint64ToTwoUint32(static_cast<uint64_t>(_command_buffer_id),
                                     &command_buffer_id_0,
                                     &command_buffer_id_1);
    RasterUtil::MapUint64ToTwoUint32(static_cast<uint64_t>(_release_count),
  ...
  GLuint64 command_buffer_id() const volatile {
    return static_cast<GLuint64>(RasterUtil::MapTwoUint32ToUint64(
        command_buffer_id_0, command_buffer_id_1));
  }

  GLuint64 release_count() const volatile {
    return static_cast<GLuint64>(
        RasterUtil::MapTwoUint32ToUint64(release_count_0, release_count_1));
  }
