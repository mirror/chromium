...
#ifndef GPU_COMMAND_BUFFER_COMMON_CONTEXT_CREATION_ATTRIB_HELPER_H_
#define GPU_COMMAND_BUFFER_COMMON_CONTEXT_CREATION_ATTRIB_HELPER_H_
...
#endif  // GPU_COMMAND_BUFFER_COMMON_CONTEXT_CREATION_ATTRIB_HELPER_H_
