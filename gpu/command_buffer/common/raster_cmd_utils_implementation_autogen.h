...
#ifndef GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_IMPLEMENTATION_AUTOGEN_H_
#define GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_IMPLEMENTATION_AUTOGEN_H_

static const RasterUtil::EnumToString enum_to_string_table[] = {
    {
        0, "GL_FALSE",
    },
    {
...
const RasterUtil::EnumToString* const RasterUtil::enum_to_string_table_ =
    enum_to_string_table;
const size_t RasterUtil::enum_to_string_table_len_ =
    sizeof(enum_to_string_table) / sizeof(enum_to_string_table[0]);

std::string RasterUtil::GetStringBufferUsage(uint32_t value) {
...
std::string RasterUtil::GetStringClientBufferUsage(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringCompressedTextureFormat(uint32_t value) {
  return RasterUtil::GetQualifiedEnumString(NULL, 0, value);
}

std::string RasterUtil::GetStringGLState(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringPixelStore(uint32_t value) {
  static const EnumToString string_table[] = {
      {GL_PACK_ALIGNMENT, "GL_PACK_ALIGNMENT"},
      {GL_UNPACK_ALIGNMENT, "GL_UNPACK_ALIGNMENT"},
      {GL_PACK_ROW_LENGTH, "GL_PACK_ROW_LENGTH"},
...
std::string RasterUtil::GetStringPixelType(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringQueryObjectParameter(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringQueryTarget(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringResetStatus(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringTextureBindTarget(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringTextureFormat(uint32_t value) {
  static const EnumToString string_table[] = {
      {GL_ALPHA, "GL_ALPHA"},
...
std::string RasterUtil::GetStringTextureInternalFormat(uint32_t value) {
  static const EnumToString string_table[] = {
      {GL_ALPHA, "GL_ALPHA"},
      {GL_LUMINANCE, "GL_LUMINANCE"},
      {GL_LUMINANCE_ALPHA, "GL_LUMINANCE_ALPHA"},
...
std::string RasterUtil::GetStringTextureInternalFormatStorage(uint32_t value) {
  static const EnumToString string_table[] = {
      {GL_RGB565, "GL_RGB565"},
      {GL_RGBA4, "GL_RGBA4"},
      {GL_RGB5_A1, "GL_RGB5_A1"},
...
std::string RasterUtil::GetStringTextureParameter(uint32_t value) {
  static const EnumToString string_table[] = {
...
std::string RasterUtil::GetStringTextureTarget(uint32_t value) {
  static const EnumToString string_table[] = {
      {GL_TEXTURE_2D, "GL_TEXTURE_2D"},
...
#endif  // GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_IMPLEMENTATION_AUTOGEN_H_
