...
#ifndef GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_H_
#define GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_H_
...
#include "gpu/command_buffer/common/raster_utils_export.h"
...
struct RASTER_UTILS_EXPORT PixelStoreParams {
  PixelStoreParams()
      : alignment(4),
        row_length(0),
        image_height(0),
...
// Utilties for RASTER support.
class RASTER_UTILS_EXPORT RasterUtil {
 public:
  ...
  RasterUtil()
      : num_compressed_texture_formats_(0), num_shader_binary_formats_(0) {}
  ...
  static bool ComputeImagePaddedRowSize(int width,
                                        int format,
                                        int type,
                                        int alignment,
  ...
  static bool ComputeImageDataSizes(int width,
                                    int height,
                                    int depth,
                                    int format,
                                    int type,
  ...
  static bool ComputeImageDataSizesES3(int width,
                                       int height,
                                       int depth,
                                       int format,
                                       int type,
  ...
  static uint32_t GetGLReadPixelsImplementationType(uint32_t internal_format,
                                                    uint32_t texture_type);
  ...
  static void MapUint64ToTwoUint32(uint64_t v64,
                                   uint32_t* v32_0,
                                   uint32_t* v32_1);
  ...
  static void GetColorFormatComponentSizes(uint32_t internal_format,
                                           uint32_t type,
                                           int* r,
                                           int* g,
                                           int* b,
...
#include "gpu/command_buffer/common/raster_cmd_utils_autogen.h"

 private:
  static std::string GetQualifiedEnumString(const EnumToString* table,
                                            size_t count,
                                            uint32_t value);
...
class RASTER_UTILS_EXPORT GLSLArrayName {
 public:
...
#endif  // GPU_COMMAND_BUFFER_COMMON_RASTER_CMD_UTILS_H_
