...
#ifndef GPU_COMMAND_BUFFER_SERVICE_DECODER_INTERFACE_H_
#define GPU_COMMAND_BUFFER_SERVICE_DECODER_INTERFACE_H_
...
class GPU_EXPORT DecoderInterface : public AsyncAPIInterface {
 public:
  DecoderInterface() = default;
  ~DecoderInterface() override = default;
  ...
  //
  // Required by GpuVideoDecodeAccelerator.
  //
  ...
  virtual base::WeakPtr<DecoderInterface> AsWeakPtr() = 0;
...
#endif  // GPU_COMMAND_BUFFER_SERVICE_DECODER_INTERFACE_H_
