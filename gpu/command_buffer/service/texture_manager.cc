 ...
 public:
  FormatTypeValidator() {
    static const FormatType kSupportedFormatTypes[] = {
        ...
        std::make_tuple(GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA,
                        GL_UNSIGNED_BYTE),
        ...
        std::make_tuple(GL_R11F_G11F_B10F, GL_RGB,
        ...
        std::make_tuple(GL_RGB10_A2UI, GL_RGBA_INTEGER,
        ...
        std::make_tuple(GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT,
                        GL_UNSIGNED_SHORT),
        std::make_tuple(GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT,
                        GL_UNSIGNED_INT),
        std::make_tuple(GL_DEPTH_COMPONENT24, GL_DEPTH_COMPONENT,
                        GL_UNSIGNED_INT),
        std::make_tuple(GL_DEPTH_COMPONENT32F, GL_DEPTH_COMPONENT, GL_FLOAT),
        std::make_tuple(GL_DEPTH24_STENCIL8, GL_DEPTH_STENCIL,
    ...
    static const FormatType kSupportedFormatTypesES2Only[] = {
        ...
        std::make_tuple(GL_DEPTH_COMPONENT, GL_DEPTH_COMPONENT,
                        GL_UNSIGNED_SHORT),
        std::make_tuple(GL_DEPTH_COMPONENT, GL_DEPTH_COMPONENT,
                        GL_UNSIGNED_INT),
        std::make_tuple(GL_DEPTH_STENCIL, GL_DEPTH_STENCIL,
                        GL_UNSIGNED_INT_24_8),
