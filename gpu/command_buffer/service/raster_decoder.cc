...
gpu::ContextResult RasterDecoder::Initialize(
  ...
  if (!updated_command_info) {
    ...
    command_info[106].cmd_handler = &RasterDecoder::HandleGetString;
    command_info[269].cmd_handler = &RasterDecoder::HandleTraceBeginCHROMIUM;
    command_info[270].cmd_handler = &RasterDecoder::HandleTraceEndCHROMIUM;
    command_info[273].cmd_handler =
        &RasterDecoder::HandleInsertFenceSyncCHROMIUM;
    command_info[274].cmd_handler = &RasterDecoder::HandleWaitSyncTokenCHROMIUM;
  }
