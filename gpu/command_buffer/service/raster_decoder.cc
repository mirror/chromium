...
class RasterDecoderImpl : public RasterDecoder {
 public:
 ...
 private:
  ...
  void DoTraceEndCHROMIUM() { debug_marker_manager_.PopGroup(); }
...
#undef RASTER_CMD_OP
  ...
  typedef gpu::gles2::GLES2Decoder::Error (RasterDecoderImpl::*CmdHandler)(
