...
#ifndef GPU_COMMAND_BUFFER_SERVICE_RASTER_CMD_DECODER_MOCK_H_
#define GPU_COMMAND_BUFFER_SERVICE_RASTER_CMD_DECODER_MOCK_H_
...
#endif  // GPU_COMMAND_BUFFER_SERVICE_RASTER_CMD_DECODER_MOCK_H_
