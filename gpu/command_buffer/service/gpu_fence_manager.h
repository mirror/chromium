...
class GPU_EXPORT GpuFenceManager {
 ...
 public:
  ...
  bool CreateNewGpuFence(uint32_t client_id);

  bool CreateDuplicateGpuFence(uint32_t client_id,
  ...
  void AddCallback(uint32_t client_id, base::OnceClosure callback);

  bool WaitGpuFence(uint32_t client_id);
