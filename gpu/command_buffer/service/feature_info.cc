...
void FeatureInfo::InitializeFeatures() {
  ...
  // When WebGL contexts, BRGA is used for chromium image optimization and
  // WebGL2 needs glTexStorage2D. WebGL never use both BGRA and glTexStorage2D
  // together because WebGL API doesn't expose BGRA. So allow both.
