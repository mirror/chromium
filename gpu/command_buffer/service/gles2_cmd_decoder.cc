...
void GLES2DecoderImpl::DoCreateGpuFenceINTERNAL(GLuint gpu_fence_id,
                                                bool from_external) {
  if (from_external) {
    // Nothing to do here other than sanity check that the fence was created
    // via gpu_control as expected. See DuplicateGpuFenceCHROMIUM in
    // GLES2Implementation for more information.
