...
void GLES2DecoderImpl::DoCopyTextureCHROMIUM(
  ...
  if (!dest_level_defined || dest_width != source_width ||
    ...
    if (error != GL_NO_ERROR) {
      ...
      LOG(ERROR) << "dest_level_defined: " << dest_level_defined <<
          "dest_width: " << dest_width <<
          " source_width: " << source_width <<
          " dest_height: " << dest_height <<
          " source_height: " << source_height <<
          " dest_internal_format: " << GLES2Util::GetStringEnum(dest_internal_format) <<
          " internal_format: " << GLES2Util::GetStringEnum(internal_format) <<
          " dest_type_previous: " << GLES2Util::GetStringEnum(dest_type_previous) <<
          " dest_type: " << GLES2Util::GetStringEnum(dest_type) <<
          " source_type: " << GLES2Util::GetStringEnum(source_type) <<
          " source_internal_format: " << GLES2Util::GetStringEnum(source_internal_format);
