...
TEST_F(GLOOBAttribTest, DrawUsingOOBDisabledArrays) {
  static const char* v_shader_str =
      ...
      "void main () {\n"
      "  color = vec4(1.0,\n"
      "      att3[0][0] + att3[0][1] + att3[0][2] +\n"
      "      att3[1][0] + att3[1][1] + att3[1][2] +\n"
      "      att3[2][0] + att3[2][1] + att3[2][2],\n"
      "      att4[0][0] + att4[0][1] + att4[0][2] + att4[0][3] +\n"
      "      att4[1][0] + att4[1][1] + att4[1][2] + att4[1][3] +\n"
      "      att4[2][0] + att4[2][1] + att4[2][2] + att4[2][3] +\n"
      "      att4[3][0] + att4[3][1] + att4[3][2] + att4[3][3],\n"
      "      1.0);\n"
      "}\n";
