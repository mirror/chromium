...
TEST_F(GLCopyTextureCHROMIUMTest, UnpremultiplyAndDitherCopy) {
  ...
  GLTestHelper::CheckPixels(0, 0, 1, 1, 8, pixel_0_0, nullptr);
  EXPECT_TRUE(GL_NO_ERROR == glGetError());

  uint8_t pixel_1_0[4] = {0u, 127u, 0u, 255u};
  GLTestHelper::CheckPixels(1, 0, 1, 1, 8, pixel_1_0, nullptr);
  EXPECT_TRUE(GL_NO_ERROR == glGetError());

  uint8_t pixel_0_1[4] = {4u, 4u, 68u, 255u};
  GLTestHelper::CheckPixels(0, 1, 1, 1, 8, pixel_0_1, nullptr);
  EXPECT_TRUE(GL_NO_ERROR == glGetError());

  uint8_t pixel_1_1[4] = {0u, 0u, 0u, 123u};
  GLTestHelper::CheckPixels(1, 1, 1, 1, 8, pixel_1_1, nullptr);
  EXPECT_TRUE(GL_NO_ERROR == glGetError());
