...
// Tests that enabling a vertex array for a location that matches a column of a
// matrix attribute but is not the base location correctly triggers
...
TEST_F(GLOOBAttribTest, DrawUsingOOBMatrixAttrib) {
  ...
  glVertexAttribPointer(location + 1, 4, GL_UNSIGNED_BYTE, false, 0, nullptr);
