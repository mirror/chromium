...
class GLEXTWindowRectanglesTest : public testing::Test {
 protected:
  ...
  void CheckPixel(int x, int y, uint8_t r, uint8_t g, uint8_t b, uint8_t a) {
    uint8_t pixel[4];
...
TEST_F(GLEXTWindowRectanglesTest, OneRectangle) {
  ...
  ClearTo(0, 255, 0, 255);
  // Inside rectangle
  CheckPixel(8, 4, 255, 0, 0, 255);
  // Outside rectangle
  CheckPixel(4, 8, 0, 255, 0, 255);
  ...
  ClearTo(0, 255, 0, 255);
  // Inside rectangle
  CheckPixel(8, 4, 0, 255, 0, 255);
  // Outside rectangle
  CheckPixel(4, 8, 255, 0, 0, 255);
}
...
TEST_F(GLEXTWindowRectanglesTest, TwoRectangles) {
  ...
  // Inside rectangles
  CheckPixel(8, 4, 255, 0, 0, 255);
  CheckPixel(2, 5, 255, 0, 0, 255);
  // Outside rectangles
  CheckPixel(4, 8, 0, 255, 0, 255);
  CheckPixel(5, 2, 0, 255, 0, 255);
  ...
  // Inside rectangles
  CheckPixel(8, 4, 0, 255, 0, 255);
  CheckPixel(2, 5, 0, 255, 0, 255);
  // Outside rectangles
  CheckPixel(4, 8, 255, 0, 0, 255);
  CheckPixel(5, 2, 255, 0, 0, 255);
}
