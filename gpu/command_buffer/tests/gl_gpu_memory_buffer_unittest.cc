...
class GpuMemoryBufferTestEGL : public GpuMemoryBufferTest {
 public:
  GpuMemoryBufferTestEGL() : gl_reinitialized_(false), skip_test_(true) {}
 ...
 protected:
  ...
  void TearDown() override {
    ...
    gfx::ClientNativePixmapFactory* client_factory =
        gfx::ClientNativePixmapFactory::GetInstance();
    ASSERT_TRUE(client_factory);
    delete client_factory;
