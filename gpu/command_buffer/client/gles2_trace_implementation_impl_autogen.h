...
GLuint GLES2TraceImplementation::DuplicateGpuFenceCHROMIUM(
    ClientGpuFence source) {
  TRACE_EVENT_BINARY_EFFICIENT0("gpu", "GLES2Trace::DuplicateGpuFenceCHROMIUM");
  return gl_->DuplicateGpuFenceCHROMIUM(source);
}
