...
void GLES2Implementation::UnpremultiplyAndDitherCopyCHROMIUM(GLuint src_texture,
                                                             GLuint dst_texture,
                                                             GLint x,
                                                             GLint y,
                                                             GLsizei width,
  ...
  GPU_CLIENT_SINGLE_THREAD_CHECK();
  GPU_CLIENT_LOG("[" << GetLogPrefix()
                     << "] glUnpremultiplyAndDitherCopyCHROMIUM(" << src_texture
                     << ", " << dst_texture << ", " << x << ", " << y << ", "
                     << width << ", " << height << ")");
  if (width < 0) {
  ...
  helper_->UnpremultiplyAndDitherCopyCHROMIUM(src_texture, dst_texture, x, y,
                                              width, height);
  CheckGLError();
}
