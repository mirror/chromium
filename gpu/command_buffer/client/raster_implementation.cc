...
void RasterImplementation::GenSyncTokenCHROMIUM(GLuint64 fence_sync,
                                                GLbyte* sync_token) {
...
void RasterImplementation::CreateTransferCacheEntryCHROMIUM(
    GLuint64 handle_id,
...
void RasterImplementation::DeleteTransferCacheEntryCHROMIUM(
    GLuint64 handle_id) {
  gl_->DeleteTransferCacheEntryCHROMIUM(handle_id);
}

void RasterImplementation::UnlockTransferCacheEntryCHROMIUM(
    GLuint64 handle_id) {
