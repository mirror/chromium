...
virtual void CreateTransferCacheEntryINTERNAL(GLuint64 handle_id,
                                              ...
                                              GLuint data_size) = 0;
virtual void DeleteTransferCacheEntryINTERNAL(GLuint64 handle_id) = 0;
virtual void UnlockTransferCacheEntryINTERNAL(GLuint64 handle_id) = 0;
