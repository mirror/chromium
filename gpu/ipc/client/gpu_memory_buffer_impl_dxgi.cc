...
base::win::ScopedComPtr<ID3D11Device> (
    *GpuMemoryBufferImplDXGI::CreateDeviceTestHook)() = nullptr;
...
base::Closure GpuMemoryBufferImplDXGI::AllocateForTesting(
  ...
  base::win::ScopedComPtr<ID3D11Device> d3d11_device = CreateDeviceTestHook();
