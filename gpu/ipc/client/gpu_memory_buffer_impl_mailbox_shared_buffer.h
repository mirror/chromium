...
class GPU_EXPORT GpuMemoryBufferImplMailboxSharedBuffer
    : public GpuMemoryBufferImpl {
 public:
  ~GpuMemoryBufferImplMailboxSharedBuffer() override;

  static std::unique_ptr<GpuMemoryBufferImplMailboxSharedBuffer>
  ...
  static gfx::GpuMemoryBufferHandle GetHandleForMailbox(const Mailbox&,
                                                        gfx::GpuMemoryBufferId);

 private:
  GpuMemoryBufferImplMailboxSharedBuffer(gfx::GpuMemoryBufferId id,
                                         const gfx::Size& size,
                                         gfx::BufferFormat format,
                                         const DestructionCallback& callback,
