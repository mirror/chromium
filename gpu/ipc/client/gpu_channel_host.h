...
class GPU_EXPORT GpuChannelHost
 ...
 public:
  ...
  // Verify that the given flush and all prior flushes have reached the service.
  // Pass UINT32_MAX to force all pending flushes to be verified. Returns true
  // on success.
  bool VerifyFlush(uint32_t flush_id);
