...
struct GpuCommandBufferMsg_FetchGpuFence_Return;
class GURL;
...
class GPU_EXPORT CommandBufferProxyImpl : public gpu::CommandBuffer,
 ...
 private:
  ...
  typedef base::hash_map<uint32_t, base::Callback<void(const gfx::GpuFenceHandle&)>>
      FetchGpuFenceTaskMap;
  FetchGpuFenceTaskMap fetch_gpu_fence_tasks_;
  uint32_t next_fetch_gpu_fence_task_id_ = 0;
