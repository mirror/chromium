...
PassThroughImageTransportSurface::PassThroughImageTransportSurface(
    ...
    : GLSurfaceAdapter(surface),
      delegate_(delegate),
      multiswap_force_swap_interval_zero_(multiswap_force_swap_interval_zero),
...
void PassThroughImageTransportSurface::UpdateSwapInterval() {
  ...
  if (multiswap_force_swap_interval_zero_) {
    ...
    if (g_current_swap_generation_ == swap_generation_) {
      ...
      if (g_num_swaps_in_current_swap_generation_ > 1)
        g_last_multiswap_generation_ = g_current_swap_generation_;
    ...
    bool should_override_vsync =
        ...
        (g_current_swap_generation_ - g_last_multiswap_generation_ <
         kMultiswapEnableVSyncDelay);
