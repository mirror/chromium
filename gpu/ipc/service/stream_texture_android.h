...
class StreamTexture : public gpu::gles2::GLStreamTextureImage,
                      public IPC::Listener,
                      public CommandBufferStubCommon::DestructionObserver {
 public:
  static bool Create(CommandBufferStubCommon* owner_stub,
                     uint32_t client_texture_id,
                     int stream_id);

 private:
  StreamTexture(CommandBufferStubCommon* owner_stub,
                int32_t route_id,
                uint32_t texture_id);
  ...
  // CommandBufferStubCommon::DestructionObserver implementation.
  ...
  CommandBufferStubCommon* owner_stub_;
  int32_t route_id_;
  bool has_listener_;
