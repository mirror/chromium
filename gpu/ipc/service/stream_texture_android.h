...
class StreamTexture : public gpu::gles2::GLStreamTextureImage,
                      public IPC::Listener,
                      public GLES2CommandBufferStub::DestructionObserver {
 public:
  static bool Create(GLES2CommandBufferStub* owner_stub,
                     uint32_t client_texture_id,
                     int stream_id);

 private:
  StreamTexture(GLES2CommandBufferStub* owner_stub,
                int32_t route_id,
                uint32_t texture_id);
  ...
  // GLES2CommandBufferStub::DestructionObserver implementation.
  ...
  GLES2CommandBufferStub* owner_stub_;
  int32_t route_id_;
  bool has_listener_;
