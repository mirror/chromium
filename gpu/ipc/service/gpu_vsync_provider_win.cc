...
// Ocassionally DWM stops advancing qpcVBlank timestamp. The existing
...
// error, any DWM values that are more than the threshold number intervals
...
class GpuVSyncWorker : public base::Thread,
 ...
 private:
  ...
  class TimeDeltaRingBuffer {
   ...
   private:
    static const size_t kMaxSize = 60;
