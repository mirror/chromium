...
#include "gpu/command_buffer/service/decoder_interface.h"
...
class GPU_EXPORT CommandBufferStub
 ...
 public:
  ...
  DecoderInterface* decoder() const { return decoder_; }
 ...
 protected:
  ...
  // FIXME(backer): nix this and just own the DecoderInterface?
  void set_decoder(DecoderInterface* decoder) { decoder_ = decoder; }
 ...
 private:
  ...
  // Real decoder inplementation owned by subclasses.
