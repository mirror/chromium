...
void CheckGpuPreferencesEqual(GpuPreferences left, GpuPreferences right) {
  ...
  EXPECT_EQ(left.disable_vaapi_accelerated_video_encode,
            right.disable_vaapi_accelerated_video_encode);
  EXPECT_EQ(left.disable_web_rtc_hw_encoding,
            right.disable_web_rtc_hw_encoding);
