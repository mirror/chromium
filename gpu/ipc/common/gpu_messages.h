...
IPC_SYNC_MESSAGE_ROUTED0_1(GpuCommandBufferMsg_GetNativeSyncPointFd,
                           GpuCommandBufferMsg_SyncPointFd_Return)
IPC_MESSAGE_ROUTED1(GpuCommandBufferMsg_CreateNativeSyncPoint,
                    uint64_t /* fence */);
IPC_MESSAGE_ROUTED1(GpuCommandBufferMsg_FetchNativeSyncPointFd, gpu::SyncToken);
...
IPC_MESSAGE_ROUTED2(GpuCommandBufferMsg_SetSharedBufferHandle,
                    gpu::Mailbox,
