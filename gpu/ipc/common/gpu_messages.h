...
IPC_STRUCT_BEGIN(GpuCommandBufferMsg_CreateGpuFence_Return)
...
IPC_MESSAGE_ROUTED1(GpuCommandBufferMsg_CreateGpuFence, uint32_t /* fetch_id */);

// Response to FetchGpuFence
IPC_MESSAGE_ROUTED2(GpuCommandBufferMsg_CreateGpuFenceComplete,
                    uint32_t /* fetch_id */,
                    GpuCommandBufferMsg_CreateGpuFence_Return);
