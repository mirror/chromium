...
struct StructTraits<gpu::mojom::GpuPreferencesDataView, gpu::GpuPreferences> {
  static bool Read(gpu::mojom::GpuPreferencesDataView prefs,
    ...
    out->disable_multiplanar_gpu_memory_buffers_for_video_frames =
        prefs.disable_multiplanar_gpu_memory_buffers_for_video_frames();
    return true;
  }
  ...
  static bool disable_multiplanar_gpu_memory_buffers_for_video_frames(
      const gpu::GpuPreferences& prefs) {
    return prefs.disable_multiplanar_gpu_memory_buffers_for_video_frames;
  }
};
