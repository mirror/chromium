...
struct StructTraits<gpu::mojom::GpuPreferencesDataView, gpu::GpuPreferences> {
  static bool Read(gpu::mojom::GpuPreferencesDataView prefs,
    ...
    out->disable_v4l2_accelerated_video_encode =
        prefs.disable_v4l2_accelerated_video_encode();
  ...
  static bool disable_v4l2_accelerated_video_encode(
      const gpu::GpuPreferences& prefs) {
    return prefs.disable_v4l2_accelerated_video_encode;
  }
