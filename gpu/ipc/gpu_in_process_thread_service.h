...
class GPU_EXPORT GpuInProcessThreadService
 ...
 public:
  ...
  gpu::gles2::ShaderTranslatorCache* shader_translator_cache() override;
 ...
 private:
  ...
  gpu::gles2::ShaderTranslatorCache shader_translator_cache_;
  gpu::gles2::FramebufferCompletenessCache framebuffer_completeness_cache_;
