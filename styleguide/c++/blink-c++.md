...
> Note: Something about Google style prohibiting mutable references here.
...
> Like Google style, remember that giving sensible names to types and variables
is much better than obscure names that must be explained through comments!
