...
// Note that flattenable_visited should be defined false in a context
...
// Bound the points making up a rectanlge so that the returned tuple is a valid
// rectangle.
...
// Writes a NULL (0-index) to indicate that a field was not set (used by
// VISIT_OPT_OR_NULL).
...
void Converter::Visit(const Paint& paint) {
  ...
  // typeface code. Can they even be with SkValidatingDeserializeImageFilter?
