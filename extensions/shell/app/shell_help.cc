...
// word-wrapped.
const CommandLineOption kHelpTextOptions[] = {
    ...
    {::switches::kLogFile, "<FILE>", "Location for log output."},
};

const char kUsageLineFormat[] = "Usage: %s [options] [<file>]\n";

// Usage and option notes.
const char kHelpTextUsageNotes[] =
...
// Trailing text.
const char kHelpTextFooter[] =
    "Author: The Chromium team - <http://www.chromium.org>\n"
    "\n"
    "Bug tracker: <http://crbug.com> (Component: Platform>App>Shell)\n";
