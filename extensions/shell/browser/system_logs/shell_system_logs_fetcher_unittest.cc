...
class ShellSystemLogsFetcherTest : public ExtensionsTest {
 public:
  ...
  ~ShellSystemLogsFetcherTest() override {}

  void SetUp() override { ExtensionsTest::SetUp(); }
...
TEST_F(ShellSystemLogsFetcherTest, TestLogSources) {
  ...
  fetcher->Fetch(
      base::Bind(&ShellSystemLogsFetcherTest::VerifySystemLogsResponse,
