...
int EventBookkeeper::IncrementEventListenerCount(
  ...
  return ++listener_counts_lazy()[GetKeyForScriptContext(script_context)]
                                 [event_name];
}
...
EventBookkeeper::FilteredEventListenerCounts&
EventBookkeeper::filtered_listener_counts_lazy() {
...
EventBookkeeper::UnmanagedListenerMap&
EventBookkeeper::unmanaged_listeners_lazy() {
...
bool EventBookkeeper::AddFilter(const std::string& event_name,
  ...
  FilteredEventListenerCounts& all_counts = filtered_listener_counts_lazy();
