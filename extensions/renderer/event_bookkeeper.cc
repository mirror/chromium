...
// static
EventBookkeeper* EventBookkeeper::GetForContext(ScriptContext* script_context) {
  if (script_context->context_type() != Feature::SERVICE_WORKER_CONTEXT)
