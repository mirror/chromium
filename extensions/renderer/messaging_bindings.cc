...
void MessagingBindings::PostMessage(
  ...
  static const int kMaxUmaLength = 1024 * 1024 * 512;
  static const int kMinUmaLength = 1;
  static const int kBucketCount = 50;
  ...
  static const size_t kMaxMessageLength = 1024 * 1024 * 64;
