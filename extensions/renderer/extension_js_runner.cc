...
// TODO(devlin): Should we hoist this up somewhere higher?
...
void ExtensionJSRunner::RunJSFunction(v8::Local<v8::Function> function,
  ...
  // TODO(devlin): Move ScriptContext::SafeCallFunction() into here? There's
  // no reason to depend on ScriptContext.
