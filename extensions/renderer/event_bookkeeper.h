...
// Contains thread (main or worker) specific event global data.
// All of the containers in this class is lazy constructed, and some
...
class EventBookkeeper {
 ...
 private:
  ...
  // Lazily constructs and returns |listener_counts_|.
  ...
  // for which events.  We notify the browser about filtered event listeners
  // when we transition between 0 and 1.
