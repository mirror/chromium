...
class TestIPCMessageSender : public IPCMessageSender {
 public:
  ...
  MOCK_METHOD2(SendOpenMessagePort, void(int routing_id, const PortId& port_id));
  MOCK_METHOD3(SendCloseMessagePort, void(int routing_id,
                            const PortId& port_id,
                            bool close_channel));
  MOCK_METHOD3(SendPostMessageToPort, void(int routing_id,
                             const PortId& port_id,
...
using StrictTestIPCMessageSender = testing::StrictMock<TestIPCMessageSender>;
