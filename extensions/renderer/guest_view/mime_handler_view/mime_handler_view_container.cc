      ...
      if (post_message_function_template_.IsEmpty()) {
        post_message_function_template_.Reset(
            ...
            gin::CreateFunctionTemplate(
                isolate,
                base::Bind(&MimeHandlerViewContainer::PostMessageToWorker,
                           container_, isolate)));
      }
...
void MimeHandlerViewContainer::PostMessageToWorker(
    v8::Isolate* isolate,
...
void MimeHandlerViewContainer::PostMessageFromValue(
  ...
  PostMessageToWorker(isolate, content::V8ValueConverter::Create()->ToV8Value(
