      ...
      if (post_message_function_template_.IsEmpty()) {
        post_message_function_template_.Reset(
            ...
            gin::CreateFunctionTemplate(
                isolate,
                base::Bind(&MimeHandlerViewContainer::PostMessageToPopup,
                           container_, isolate)));
      }
...
void MimeHandlerViewContainer::PostMessageToPopup(
    v8::Isolate* isolate,
...
void MimeHandlerViewContainer::PostMessageFromValue(
  ...
  PostMessageToPopup(isolate, content::V8ValueConverter::Create()->ToV8Value(
