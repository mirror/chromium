...
// Temporary enum corresponding to ExtensionViewTypeIsBackground enum
// in tools/metrics/histograms/enums.xml.
// TODO(lukasza): http://crbug.com/718489: Probably okay to remove in M66,
// after we've gathered sufficient UMA data in M65.
enum ViewTypeIsBackground {
  VIEW_TYPE_IS_NOT_BACKGROUND = 0,
  VIEW_TYPE_IS_BACKGROUND = 1,
