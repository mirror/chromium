...
extern const char kRulesFileIsNotList[];
extern const char kRulesFileDuplicateID[];
extern const char kRulesFileDuplicateResourceType[];
extern const char kRulesFileErrorPersisting[];
extern const char kRulesFileRedirectRuleKeyEmpty[];
extern const char kRulesFileInvalidKey[];
extern const char kRulesFileJSONParseError[];
extern const char kRulesFileRuleNotMeaningful[];
extern const char kRulesetLocationNotString[];
extern const char kRulesetLocationRefersParent[];
extern const char kRulesetLocationNotJSON[];
extern const char kRulesetLocationIsAbsolutePath[];
extern const char kRulesetLocationIsInvalidPath[];
