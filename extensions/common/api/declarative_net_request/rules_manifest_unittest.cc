...
constexpr char kDefaultRulesFileName[] = "rules_file.json";
...
std::unique_ptr<base::DictionaryValue> GetGenericManifest() {
  return DictionaryBuilder()
      ...
      .Set(keys::kDeclarativeNetRequestRulesetLocation, kDefaultRulesFileName)
...
class RulesManifestTest : public testing::Test {
 ...
 private:
  ...
  base::FilePath rules_file_path_ =
      base::FilePath(FILE_PATH_LITERAL(kDefaultRulesFileName));
