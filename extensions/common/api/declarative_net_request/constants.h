...
// An alias for an extension declarative rule.
using ParsedRule = extensions::api::declarative_net_request::Rule;

// Aliases to refer to url_pattern_index types.
using UrlPatternType = url_pattern_index::flat::UrlPatternType;
using AnchorType = url_pattern_index::flat::AnchorType;
using ActivationType = url_pattern_index::flat::ActivationType;
using OptionFlag = url_pattern_index::flat::OptionFlag;
using ElementType = url_pattern_index::flat::ElementType;
