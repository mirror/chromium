...
// Parses the "hosts" key from the kDeclarativeNetRequestKey manifest key
// dictionary. Returns false in case of an error.
bool ParseHostsList(const base::DictionaryValue* dnr_dict,
