...
class SimpleFeature : public Feature {
 public:
  ...
  bool IsIdInBlacklist(const std::string& hashed_extension_id) const override;
  bool IsIdInWhitelist(const std::string& hashed_extension_id) const override;
 ...
 private:
  ...
  static bool IsIdInList(const std::string& hashed_extension_id,
  ...
  static bool IsValidHashedExtensionId(const std::string& hashed_extension_id);
  ...
  // properties.
  Availability GetManifestAvailability(const std::string& hashed_extension_id,
                                       Manifest::Type type,
                                       Manifest::Location location,
