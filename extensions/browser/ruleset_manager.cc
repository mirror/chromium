...
ElementType GetElementType(content::ResourceType type) {
  switch (type) {
...
bool RulesetManager::ShouldBlockRequest(bool is_incognito_context,
  ...
  // Might be worthwhile hooking in the browser context here through info map
  // and checking it is equal to the passed browser context.
