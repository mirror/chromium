...
class AppWindow : public content::WebContentsDelegate,
 ...
 public:
  ...
  // the later.
  using FirstCommitCallback = base::OnceCallback<void(bool ready_to_commit)>;
  void SetOnFirstCommitCallback(FirstCommitCallback callback);
 ...
 private:
  ...
  FirstCommitCallback on_first_commit_callback_;
