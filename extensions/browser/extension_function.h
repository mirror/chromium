...
class ExtensionFunction
 ...
 protected:
  ...
  enum class State {
    ...
    kRunning,    // Running has started, but no response has been sent yet.
    kResponded,  // The response has been sent. Note that this can happen
                 // without being in |kRunning| at all.
  };
