...
class ExtensionRegistrar {
 public:
  ...
  class Delegate {
   public:
    ...
    // Provides the delegate an opportunity to apply rules to the extension
    // befcore it's added it's added. E.g., if an upgrading extension requests
    // new permissions, Chrome could grant them or disable the extension.
    virtual void CheckExtensionBeforeAdding(const Extension* extension,
  ...
  */
  ...
  base::FilePath PrepareExtensionForReload(
