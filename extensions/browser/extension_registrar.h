...
class ExtensionRegistrar {
 public:
  ...
  // disabled_extensions().
  // TODO(michaelpg): Move other steps and checks for disabling the extension
  // from ExtensionService::DisableExtension into here.
  ...
  // removing references to it from the ExtensionRegistry's enabled or disabled
  // sets.
