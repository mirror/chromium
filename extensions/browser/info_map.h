...
class InfoMap : public base::RefCountedThreadSafe<InfoMap> {
 ...
 private:
  ...
  // Manages rulesets for the Declarative Net Request API. COMMENT: Its possible
  // for this to be owned by RulesMonitorService but this would slightly
  // increase complexity, (UI thread obj owning IO thread obj,
