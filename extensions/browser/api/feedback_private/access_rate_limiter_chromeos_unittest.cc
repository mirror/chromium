...
TEST_F(AccessRateLimiterTest, MaxAccessCountOfZero) {
  limiter_.reset(
      new AccessRateLimiter(0, TimeDelta::FromMilliseconds(100)));
...
TEST_F(AccessRateLimiterTest, NormalRepeatedAccess) {
  limiter_.reset(
      new AccessRateLimiter(5, TimeDelta::FromMilliseconds(100)));
  limiter_->SetTickClockForTesting(test_clock_.get());
...
TEST_F(AccessRateLimiterTest, RechargeTimeOfZero) {
  limiter_.reset(
      new AccessRateLimiter(5, TimeDelta::FromMilliseconds(0)));
  limiter_->SetTickClockForTesting(test_clock_.get());
