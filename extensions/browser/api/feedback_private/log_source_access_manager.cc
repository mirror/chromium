...
constexpr int kMaxReadersPerSource = 10;
...
bool LogSourceAccessManager::FetchFromSource(
  ...
  ResourceId resource_id = requested_resource_id != kInvalidResourceId
...
LogSourceAccessManager::ResourceId LogSourceAccessManager::CreateResource(
  ...
  // Now that |resource_id| has been determined to be valid, release the
  // LogSourceResource.
