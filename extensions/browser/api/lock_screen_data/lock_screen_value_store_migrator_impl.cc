...
void LockScreenValueStoreMigratorImpl::Run(
    const std::set<std::string>& extensions_to_migrate,
...
void LockScreenValueStoreMigratorImpl::ClearDataForExtension(
  ...
  DataItem::DeleteAllItemsForExtension(
      ...
      base::Bind(&LockScreenValueStoreMigratorImpl::DeleteAllDeprecatedItems,
...
bool LockScreenValueStoreMigratorImpl::MigratingExtensionData(
...
void LockScreenValueStoreMigratorImpl::DeleteAllDeprecatedItems(
    const std::string& extension_id,
    const base::Closure& callback) {
  DataItem::DeleteAllItemsForExtension(
      context_, source_store_cache_, task_runner_, extension_id,
