...
// Implements the chrome.networking.onc.getProperties method.
class NetworkingOncGetPropertiesFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetPropertiesFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getProperties",
...
// Implements the chrome.networking.onc.getManagedProperties method.
class NetworkingOncGetManagedPropertiesFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetManagedPropertiesFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getManagedProperties",
...
// Implements the chrome.networking.onc.getState method.
class NetworkingOncGetStateFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetStateFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getState",
...
// Implements the chrome.networking.onc.setProperties method.
class NetworkingOncSetPropertiesFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncSetPropertiesFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.setProperties",
...
// Implements the chrome.networking.onc.createNetwork method.
class NetworkingOncCreateNetworkFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncCreateNetworkFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.createNetwork",
...
class NetworkingOncForgetNetworkFunction : public UIThreadExtensionFunction {
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.forgetNetwork",
...
// Implements the chrome.networking.onc.getNetworks method.
class NetworkingOncGetNetworksFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetNetworksFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getNetworks",
...
// Implements the chrome.networking.onc.getVisibleNetworks method.
class NetworkingOncGetVisibleNetworksFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetVisibleNetworksFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getVisibleNetworks",
...
// Implements the chrome.networking.onc.getEnabledNetworkTypes method.
class NetworkingOncGetEnabledNetworkTypesFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetEnabledNetworkTypesFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getEnabledNetworkTypes",
...
// Implements the chrome.networking.onc.getDeviceStates method.
class NetworkingOncGetDeviceStatesFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetDeviceStatesFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getDeviceStates",
...
// Implements the chrome.networking.onc.enableNetworkType method.
class NetworkingOncEnableNetworkTypeFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncEnableNetworkTypeFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.enableNetworkType",
...
// Implements the chrome.networking.onc.disableNetworkType method.
class NetworkingOncDisableNetworkTypeFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncDisableNetworkTypeFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.disableNetworkType",
...
// Implements the chrome.networking.onc.requestNetworkScan method.
class NetworkingOncRequestNetworkScanFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncRequestNetworkScanFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.requestNetworkScan",
...
// Implements the chrome.networking.onc.startConnect method.
class NetworkingOncStartConnectFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncStartConnectFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.startConnect",
...
// Implements the chrome.networking.onc.startDisconnect method.
class NetworkingOncStartDisconnectFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncStartDisconnectFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.startDisconnect",
...
// Implements the chrome.networking.onc.startActivate method.
class NetworkingOncStartActivateFunction : public UIThreadExtensionFunction {
 public:
  NetworkingOncStartActivateFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.startActivate",
...
// Implements the chrome.networking.onc.verifyDestination method.
class NetworkingOncVerifyDestinationFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncVerifyDestinationFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.verifyDestination",
...
// Implements the chrome.networking.onc.verifyAndEncryptCredentials method.
class NetworkingOncVerifyAndEncryptCredentialsFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncVerifyAndEncryptCredentialsFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.verifyAndEncryptCredentials",
...
// Implements the chrome.networking.onc.verifyAndEncryptData method.
class NetworkingOncVerifyAndEncryptDataFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncVerifyAndEncryptDataFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.verifyAndEncryptData",
...
// Implements the chrome.networking.onc.setWifiTDLSEnabledState method.
class NetworkingOncSetWifiTDLSEnabledStateFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncSetWifiTDLSEnabledStateFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.setWifiTDLSEnabledState",
...
// Implements the chrome.networking.onc.getWifiTDLSStatus method.
class NetworkingOncGetWifiTDLSStatusFunction
    : public UIThreadExtensionFunction {
 public:
  NetworkingOncGetWifiTDLSStatusFunction() {}
  DECLARE_EXTENSION_FUNCTION("networking.onc.getWifiTDLSStatus",
...
class NetworkingOncGetCaptivePortalStatusFunction
 ...
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.getCaptivePortalStatus",
...
class NetworkingOncUnlockCellularSimFunction
 ...
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.unlockCellularSim",
...
class NetworkingOncSetCellularSimStateFunction
 ...
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.setCellularSimState",
...
class NetworkingOncGetGlobalPolicyFunction : public UIThreadExtensionFunction {
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.getGlobalPolicy",
...
class NetworkingOncGetCertificateListsFunction
 ...
 public:
  ...
  DECLARE_EXTENSION_FUNCTION("networking.onc.getCertificateLists",
