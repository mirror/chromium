...
class HidDeviceManager : public BrowserContextKeyedAPI,
 ...
 public:
  ...
  // Returns a cloned device::mojom::HidDeviceInfo object by given resouce_id.
  device::mojom::HidDeviceInfoPtr GetDeviceInfo(int resource_id);
  ...
  bool HasPermission(const Extension* extension,
                     const device::mojom::HidDeviceInfoPtr& device_info,
