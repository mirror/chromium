...
// COMMENT: I think most existing BrowserContextKeyedAPIs use DestructionAtExit.
// LazyInstance recommends using Leaky (probably for faster shutdown). Any
// reason we should use DestructionAtExit?
