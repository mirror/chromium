...
int GetChecksum(const FlatRulesetIndexer::SerializedData& data) {
  // COMMENT: Alternatively, an MD5 checksum could have been used. Though it
  // will have fewer collisions, it will also be slower. Since our security
  // model is not meant to protect against on-disk manipulation, PersistentHash
  // suffices.
