...
// COMMENT: Both the incognito and normal contexts will share the same ruleset.
// Assuming this is ok? Hence any dynamic rules added while in incognito will be
// persisted for even the normal context. chrome.storage behaves the same -
