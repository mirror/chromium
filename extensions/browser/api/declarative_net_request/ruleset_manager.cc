...
flat_rule::ElementType GetElementType(content::ResourceType type) {
  switch (type) {
    ...
    // TODO(crbug.com/696822): Add support for CSP_REPORT to url_pattern_index.
    // This is supported by the Web Request API.
    ...
    // TODO(crbug.com/696822): Add support for MAIN_FRAME to url_pattern_index.
    // This is supported by the Web Request API.
