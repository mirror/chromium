...
class SerialConnection : public ApiResource,
 ...
 private:
  ...
  device::mojom::SerialIoHandlerPtr io_handler_mojo_;
  // Closure which is set by client and will be called when |io_handler_mojo_|
