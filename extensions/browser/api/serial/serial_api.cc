...
void BindInterfaceOnUI(device::mojom::SerialDeviceEnumeratorRequest request) {
...
void SerialGetDevicesFunction::AsyncWorkStart() {
  ...
  device::mojom::SerialDeviceEnumeratorPtr enumerator;
  BrowserThread::PostTask(
      BrowserThread::UI, FROM_HERE,
      base::BindOnce(&BindInterfaceOnUI, mojo::MakeRequest(&enumerator)));
