...
class DevicePermissionEntry : public base::RefCounted<DevicePermissionEntry> {
 public:
  ...
  DevicePermissionEntry(device::mojom::HidDeviceInfoPtr device);
 ...
 private:
  ...
  // The HID device tracked by this entry. DevicePermissionEntry takes the
  // ownership of the passed device::mojom::HidDeviceInfoPtr.
  device::mojom::HidDeviceInfoPtr hid_device_;
...
class DevicePermissionsManager : public KeyedService,
 ...
 public:
  ...
  void RemoveEntryByHidDeviceGUID(std::string& guid);
