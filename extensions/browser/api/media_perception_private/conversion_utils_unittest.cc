...
void InitializeFakeFramePerception(const int index,
  ...
  packet_latency_one->set_label("packet1");
  ...
  mri::PacketLatency* packet_latency_three =
      frame_perception->add_packet_latency();
  packet_latency_three->set_label("packet3");
  ...
  entity_three->set_label("Region3");
}
...
void ValidateFramePerceptionResult(
  ...
  EXPECT_EQ(*packet_latency_one.string_label, "packet1");
  ...
  EXPECT_EQ(*packet_latency_three.string_label, "packet3");
  ...
  const media_perception::Entity& entity_result_three =
      frame_perception_result.entities->at(3);
  ASSERT_TRUE(entity_result_three.string_label);
  EXPECT_EQ(*entity_result_three.string_label, "Region3");
