...
void ValidateFramePerceptionResult(
  ...
  EXPECT_EQ(*packet_latency_one.tag, "packet1");
  ...
  EXPECT_EQ(*packet_latency_three.tag, "packet3");
  ...
  ASSERT_TRUE(entity_result_three.tag);
  EXPECT_EQ(*entity_result_three.tag, "Region3");
