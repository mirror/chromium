...
void ValidateFramePerceptionResult(
  ...
  EXPECT_EQ(*packet_latency_one.packet_label, "packet1");
  ...
  EXPECT_EQ(*packet_latency_three.packet_label, "packet3");
  ...
  EXPECT_EQ(*entity_result_three.entity_label, "Region3");
