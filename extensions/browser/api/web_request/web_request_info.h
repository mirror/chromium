...
struct WebRequestInfo {
  ...
  // Indicates whether this request was initiated by a <webview> instance. Only
  // meaningful when |is_browser_side_navigation| is |true|. Otherise
  // WebViewRendererState should be used with |render_process_id| and
  // |routing_id|.
  bool is_web_view = false;

  // If |is_web_view| is true, the instance ID and rules registry ID pertaining
  // to the webview instance. Only meaningful when |is_browser_side_navigation|
  // is |true|. Otherwise WebViewRendererState should be used with
  // |render_process_id| and |routing_id|.
