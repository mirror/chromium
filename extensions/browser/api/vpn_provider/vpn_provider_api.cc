...
void ConvertParameters(const api_vpn::Parameters& parameters,
  ...
  parameter_value->SetKey(
      ...
      base::JoinString(parameters.exclusion_list, base::Value(ip_delimiter)));

  parameter_value->SetKey(
      shill::kInclusionListParameterThirdPartyVpn,
      base::JoinString(parameters.inclusion_list, base::Value(ip_delimiter)));
  ...
  if (parameters.domain_search) {
    parameter_value->SetKey(shill::kDomainSearchParameterThirdPartyVpn,
                            base::JoinString(*parameters.domain_search,
                                             base::Value(non_ip_delimiter)));
  }

  parameter_value->SetKey(
      shill::kDnsServersParameterThirdPartyVpn,
      base::JoinString(parameters.dns_servers, base::Value(ip_delimiter)));
