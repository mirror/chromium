...
TEST_F(UpdateServiceTest, BasicUpdateOperations) {
  ...
  UpdateService::UpdateCheckParams update_check_params;
  UpdateService::ExtensionUpdateInfo update_info;
  update_info.extension_id = extension1->id();
  update_check_params.update_info.push_back(update_info);
