...
enum HistogramValue {
  ...
  PASSWORDSPRIVATE_UNDOREMOVESAVEDPASSWORD,
  PASSWORDSPRIVATE_REDOREMOVESAVEDPASSWORD,
  PASSWORDSPRIVATE_UNDOREMOVEPASSWORDEXCEPTION,
  PASSWORDSPRIVATE_REDOREMOVEPASSWORDEXCEPTION,
