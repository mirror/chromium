...
void ExtensionRegistrar::AddExtension(const Extension* extension) {
  ...
  delegate_->CheckExtensionBeforeAdding(extension, is_extension_loaded);
  // TODO: CheckExtensionBeforeAdding has to call
  // extension_prefs_->SetExtensionEnabled/Disabled
...
base::FilePath ExtensionRegistrar::PrepareExtensionForReload(
