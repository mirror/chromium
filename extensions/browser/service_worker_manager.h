...
#ifndef EXTENSIONS_BROWSER_SERVICE_WORKVER_MANAGER_H_
#define EXTENSIONS_BROWSER_SERVICE_WORKVER_MANAGER_H_
...
#endif  // EXTENSIONS_BROWSER_SERVICE_WORKVER_MANAGER_H_
