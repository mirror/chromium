...
static const gchar* ax_platform_node_auralinux_get_description(
  ...
  return obj->GetStringAttribute(ax::mojom::StringAttribute::DESCRIPTION)
      .c_str();
}
...
static const gchar* ax_platform_node_auralinux_get_action_keybinding(
  ...
  return obj->GetStringAttribute(ax::mojom::StringAttribute::ACCESS_KEY)
      .c_str();
}
...
static void ax_platform_node_auralinux_get_current_value(AtkValue* atk_value,
  ...
  obj->GetFloatAttributeInGValue(ax::mojom::FloatAttribute::VALUE_FOR_RANGE,
                                 value);
}
...
static void ax_platform_node_auralinux_get_minimum_value(AtkValue* atk_value,
  ...
  obj->GetFloatAttributeInGValue(ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE,
                                 value);
}
...
static void ax_platform_node_auralinux_get_maximum_value(AtkValue* atk_value,
  ...
  obj->GetFloatAttributeInGValue(ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE,
                                 value);
}
...
static void ax_platform_node_auralinux_get_minimum_increment(
  ...
  obj->GetFloatAttributeInGValue(
      ax::mojom::FloatAttribute::STEP_VALUE_FOR_RANGE, value);
}
