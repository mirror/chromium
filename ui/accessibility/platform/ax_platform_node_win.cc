...
int AXPlatformNodeWin::MSAAState() {
  ...
  const auto restrictions = static_cast<ui::AXRestrictions>(
      GetIntAttribute(ui::AX_ATTR_RESTRICTIONS));
  switch (restrictions) {
    case ui::AX_RESTRICTIONS_DISABLED:
      msaa_state |= STATE_SYSTEM_UNAVAILABLE;
      break;
    case ui::AX_RESTRICTIONS_READ_ONLY:
      msaa_state |= STATE_SYSTEM_READONLY;
      break;
    default:
