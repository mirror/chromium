...
AXTreeUpdate AXPlatformNodeTest::BuildTextField() {
  ...
  text_field_node.role = ax::mojom::Role::TEXT_FIELD;
  text_field_node.AddState(ax::mojom::State::EDITABLE);
...
AXTreeUpdate AXPlatformNodeTest::BuildTextFieldWithSelectionRange(
  ...
  text_field_node.role = ax::mojom::Role::TEXT_FIELD;
  text_field_node.AddState(ax::mojom::State::EDITABLE);
  text_field_node.AddState(ax::mojom::State::SELECTED);
  text_field_node.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START, start);
  text_field_node.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_END, stop);
  text_field_node.SetValue("How now brown cow.");
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditable() {
  ...
  content_editable_node.role = ax::mojom::Role::GROUP;
  content_editable_node.AddState(ax::mojom::State::RICHLY_EDITABLE);
  content_editable_node.AddBoolAttribute(ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditableWithSelectionRange(
  ...
  content_editable_node.role = ax::mojom::Role::GROUP;
  content_editable_node.AddState(ax::mojom::State::RICHLY_EDITABLE);
  content_editable_node.AddState(ax::mojom::State::SELECTED);
  content_editable_node.AddBoolAttribute(ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
  content_editable_node.SetValue("How now brown cow.");
...
AXTreeUpdate AXPlatformNodeTest::AXPlatformNodeTest::Build3X3Table() {
  ...
  */
  ...
  AXNodeData table;
  table.id = 0;
  table.role = ax::mojom::Role::TABLE;

  table.AddIntAttribute(ax::mojom::IntAttribute::TABLE_ROW_COUNT, 3);
  table.AddIntAttribute(ax::mojom::IntAttribute::TABLE_COLUMN_COUNT, 3);
  ...
  table.AddIntListAttribute(ax::mojom::IntListAttribute::CELL_IDS, ids);
  table.AddIntListAttribute(ax::mojom::IntListAttribute::UNIQUE_CELL_IDS, ids);
  ...
  table_row_header.role = ax::mojom::Role::ROW;
  ...
  table_column_header_1.role = ax::mojom::Role::COLUMN_HEADER;

  AXNodeData table_column_header_2;
  table_column_header_2.id = 52;
  table_column_header_2.role = ax::mojom::Role::COLUMN_HEADER;
  table_column_header_2.SetName("column header 1");

  AXNodeData table_column_header_3;
  table_column_header_3.id = 53;
  table_column_header_3.role = ax::mojom::Role::COLUMN_HEADER;
  // Either ax::mojom::StringAttribute::NAME -or- ax::mojom::StringAttribute::DESCRIPTION is acceptable for a
  // description
  table_column_header_3.AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
                                           "column header 2");

  // Row 1
  AXNodeData table_row_1;
  table_row_1.id = 1;
  table_row_1.role = ax::mojom::Role::ROW;
  ...
  table_row_header_1.role = ax::mojom::Role::ROW_HEADER;
  table_row_header_1.SetName("row header 1");

  AXNodeData table_cell_1;
  table_cell_1.id = 3;
  table_cell_1.role = ax::mojom::Role::CELL;
  table_cell_1.SetName("1");

  AXNodeData table_cell_2;
  table_cell_2.id = 4;
  table_cell_2.role = ax::mojom::Role::CELL;
  table_cell_2.SetName("2");

  // Row 2
  AXNodeData table_row_2;
  table_row_2.id = 10;
  table_row_2.role = ax::mojom::Role::ROW;
  ...
  table_row_header_2.role = ax::mojom::Role::ROW_HEADER;
  // Either ax::mojom::StringAttribute::NAME -or- ax::mojom::StringAttribute::DESCRIPTION is acceptable for a
  // description
  table_row_header_2.AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION, "row header 2");

  AXNodeData table_cell_3;
  table_cell_3.id = 12;
  table_cell_3.role = ax::mojom::Role::CELL;
  table_cell_3.SetName("3");

  AXNodeData table_cell_4;
  table_cell_4.id = 13;
  table_cell_4.role = ax::mojom::Role::CELL;
