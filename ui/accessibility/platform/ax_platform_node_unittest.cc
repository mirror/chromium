...
AXTreeUpdate AXPlatformNodeTest::BuildTextFieldWithSelectionRange(
  ...
  text_field_node.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START,
                                  start);
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditable() {
  ...
  content_editable_node.AddBoolAttribute(
      ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
...
AXTreeUpdate AXPlatformNodeTest::AXPlatformNodeTest::Build3X3Table() {
  ...
  */
  ...
  // Either ax::mojom::StringAttribute::NAME -or-
  // ax::mojom::StringAttribute::DESCRIPTION is acceptable for a description
  table_column_header_3.AddStringAttribute(
      ax::mojom::StringAttribute::DESCRIPTION, "column header 2");
  ...
  // Either ax::mojom::StringAttribute::NAME -or-
  // ax::mojom::StringAttribute::DESCRIPTION is acceptable for a description
  table_row_header_2.AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
                                        "row header 2");
