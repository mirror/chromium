...
RoleMap BuildRoleMap() {
  const RoleMap::value_type roles[] = {
      ...
      {ax::mojom::Role::PROGRESS_INDICATOR,
...
bool HasImplicitAction(const ui::AXNodeData& data, ax::mojom::Action action) {
  return action == ax::mojom::Action::DO_DEFAULT &&
...
- (void)accessibilitySetValue:(id)value forAttribute:(NSString*)attribute {
  ...
  if ([attribute isEqualToString:NSAccessibilityValueAttribute]) {
    ...
    if ([value isKindOfClass:[NSNumber class]]) {
      data.action = [value boolValue] ? ax::mojom::Action::FOCUS
                                      : ax::mojom::Action::BLUR;
    }
  }
...
- (NSString*)AXHelp {
  ...
  NSString* desc =
      [self getStringAttribute:ax::mojom::StringAttribute::DESCRIPTION];
  NSString* key =
      [self getStringAttribute:ax::mojom::StringAttribute::KEY_SHORTCUTS];
  if (!desc.length)
...
- (NSNumber*)AXEnabled {
  return
      @(node_->GetData().GetRestriction() != ax::mojom::Restriction::DISABLED);
}
