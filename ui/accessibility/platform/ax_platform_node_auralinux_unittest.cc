...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkObjectRole) {
  ...
  child.role = ax::mojom::Role::CANVAS;
  child_node->SetData(child);
  child_obj = AtkObjectFromNode(child_node);
  ASSERT_TRUE(ATK_IS_OBJECT(child_obj));
  g_object_ref(child_obj);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkObjectState) {
  AXNodeData root;
  root.id = 1;
  root.AddState(ax::mojom::State::DEFAULT);
  root.AddState(ax::mojom::State::EXPANDED);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkComponentsGetExtentsPositionSize) {
  AXNodeData root;
  root.id = 1;
  root.role = ax::mojom::Role::WINDOW;
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkValueGetCurrentValue) {
  AXNodeData root;
  root.id = 1;
  root.role = ax::mojom::Role::SLIDER;
  root.AddFloatAttribute(ax::mojom::FloatAttribute::VALUE_FOR_RANGE, 5.0);
  Init(root);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkValueGetMaximumValue) {
  ...
  root.id = 1;
  root.role = ax::mojom::Role::SLIDER;
  root.AddFloatAttribute(ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE, 5.0);
  Init(root);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkValueGetMinimumValue) {
  ...
  root.id = 1;
  root.role = ax::mojom::Role::SLIDER;
  root.AddFloatAttribute(ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE, 5.0);
  Init(root);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkValueGetMinimumIncrement) {
  ...
  root.id = 1;
  root.role = ax::mojom::Role::SLIDER;
  root.AddFloatAttribute(ax::mojom::FloatAttribute::STEP_VALUE_FOR_RANGE, 5.0);
  Init(root);
...
TEST_F(AXPlatformNodeAuraLinuxTest, TestAtkHyperlink) {
  AXNodeData root;
  root.id = 1;
  root.role = ax::mojom::Role::LINK;
  root.AddStringAttribute(ax::mojom::StringAttribute::URL, "http://foo.com");
  Init(root);
