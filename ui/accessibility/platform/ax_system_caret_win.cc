...
AXSystemCaretWin::AXSystemCaretWin(gfx::AcceleratedWidget event_target)
  ...
  // via |unique_id|.
  data_.id = -1;
  data_.role = ax::mojom::Role::CARET;
...
std::set<int32_t> AXSystemCaretWin::GetReverseRelations(ax::mojom::IntAttribute attr,
                                                        int32_t dst_id) {
  return std::set<int32_t>();
}

std::set<int32_t> AXSystemCaretWin::GetReverseRelations(ax::mojom::IntListAttribute attr,
                                                        int32_t dst_id) {
  return std::set<int32_t>();
}
