...
TEST_F(AXPlatformNodeWinTest, TestIAccessibleTextTextFieldGetCaretOffset) {
  Init(BuildTextField());
...
TEST_F(AXPlatformNodeWinTest,
       TestIAccessibleTextTextFieldGetCaretOffsetSelected) {
  Init(BuildTextFieldWithSelectionRange(1, 2));
...
TEST_F(AXPlatformNodeWinTest,
       TestIAccessibleTextContextEditableGetCaretOffset) {
  Init(BuildContentEditable());
...
TEST_F(AXPlatformNodeWinTest,
       TestIAccessibleTextContentEditableGetCaretOffsetSelected) {
  Init(BuildContentEditableWithSelectionRange(1, 2));
