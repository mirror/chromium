...
TEST_F(AXPlatformNodeWinTest, TestIAccessibleDescription) {
  AXNodeData root;
  root.id = 1;
  root.AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
                          "Description");
  Init(root);
...
TEST_F(AXPlatformNodeWinTest, TestIAccessibleShortcut) {
  AXNodeData root;
  root.id = 1;
  root.AddStringAttribute(ax::mojom::StringAttribute::KEY_SHORTCUTS,
                          "Shortcut");
  Init(root);
...
TEST_F(AXPlatformNodeWinTest, TestIAccessibleTableCellGetRowHeaderCells) {
  ...
  // Since we do not have ax::mojom::IntAttribute::TABLE_CELL_ROW_INDEX set, the
...
TEST_F(AXPlatformNodeWinTest, TestIAccessible2GetNRelations) {
  ...
  root.AddIntListAttribute(ax::mojom::IntListAttribute::DESCRIBEDBY_IDS,
                           describedby_ids);
...
TEST_F(AXPlatformNodeWinTest, TestRelationTargetsOfType) {
  ...
  child2.AddIntListAttribute(ax::mojom::IntListAttribute::LABELLEDBY_IDS,
                             labelledby_ids);
...
TEST_F(AXPlatformNodeWinTest, TestIAccessible2GetLocalizedExtendedRole) {
  AXNodeData root;
  root.id = 1;
  root.AddStringAttribute(ax::mojom::StringAttribute::ROLE_DESCRIPTION,
                          "extended role");
  Init(root);
