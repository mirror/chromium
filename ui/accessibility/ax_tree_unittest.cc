...
TEST(AXTreeTest, RoleAndStateChangeCallbacks) {
  ...
  initial_state.nodes[0].SetCheckedState(ax::mojom::CheckedState::TRUE_VALUE);
  ...
  update.nodes[0].SetCheckedState(ax::mojom::CheckedState::FALSE_VALUE);
...
TEST(AXTreeTest, AttributeChangeCallbacks) {
  ...
  initial_state.nodes.resize(1);
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].AddStringAttribute(ax::mojom::StringAttribute::NAME,
                                            "N1");
  initial_state.nodes[0].AddStringAttribute(
      ax::mojom::StringAttribute::DESCRIPTION, "D1");
  initial_state.nodes[0].AddBoolAttribute(ax::mojom::BoolAttribute::LIVE_ATOMIC,
                                          true);
  initial_state.nodes[0].AddBoolAttribute(ax::mojom::BoolAttribute::BUSY,
                                          false);
  initial_state.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE, 1.0);
  initial_state.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE, 10.0);
  initial_state.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::STEP_VALUE_FOR_RANGE, 3.0);
  initial_state.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::SCROLL_X, 5);
  initial_state.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::SCROLL_X_MIN,
                                         1);
  AXTree tree(initial_state);
  ...
  update0.nodes[0].AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
                                      "D2");
  update0.nodes[0].AddBoolAttribute(ax::mojom::BoolAttribute::LIVE_ATOMIC,
                                    false);
  update0.nodes[0].AddBoolAttribute(ax::mojom::BoolAttribute::BUSY, true);
  update0.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE, 2.0);
  update0.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE, 9.0);
  update0.nodes[0].AddFloatAttribute(
      ax::mojom::FloatAttribute::STEP_VALUE_FOR_RANGE, 0.5);
  ...
  update1.nodes[0].AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
                                      "D3");
  ...
  update1.nodes[0].AddFloatAttribute(ax::mojom::FloatAttribute::VALUE_FOR_RANGE,
                                     5.0);
...
TEST(AXTreeTest, IntListChangeCallbacks) {
  ...
  initial_state.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::CONTROLS_IDS, one);
  initial_state.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::RADIO_GROUP_IDS, two);
  AXTree tree(initial_state);
  ...
  update0.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::CONTROLS_IDS, two);
  update0.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::RADIO_GROUP_IDS, three);
  EXPECT_TRUE(tree.Unserialize(update0));
  ...
  update1.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::RADIO_GROUP_IDS, two);
  update1.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::FLOWTO_IDS,
                                       three);
  EXPECT_TRUE(tree.Unserialize(update1));
...
TEST(AXTreeTest, EmptyNodeNotOffscreenEvenIfAllChildrenOffscreen) {
  ...
  tree_update.nodes[0].AddBoolAttribute(
      ax::mojom::BoolAttribute::CLIPS_CHILDREN, true);
  tree_update.nodes[0].child_ids.push_back(2);
  tree_update.nodes[1].id = 2;
  tree_update.nodes[1].location = gfx::RectF();  // Deliberately empty.
  tree_update.nodes[1].child_ids.push_back(3);
...
TEST(AXTreeTest, IntReverseRelations) {
  ...
  initial_state.nodes[1].id = 2;
  initial_state.nodes[2].id = 3;
  initial_state.nodes[2].AddIntAttribute(ax::mojom::IntAttribute::MEMBER_OF_ID,
                                         1);
  initial_state.nodes[3].id = 4;
  initial_state.nodes[3].AddIntAttribute(ax::mojom::IntAttribute::MEMBER_OF_ID,
                                         1);
  AXTree tree(initial_state);
...
TEST(AXTreeTest, IntListReverseRelations) {
  ...
  initial_state.nodes[0].id = 1;
  initial_state.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::LABELLEDBY_IDS, node_two);
  initial_state.nodes[0].child_ids.push_back(2);
  initial_state.nodes[0].child_ids.push_back(3);
  initial_state.nodes[1].id = 2;
  initial_state.nodes[2].id = 3;
  ...
  reverse_labelled_by =
      tree.GetReverseRelations(ax::mojom::IntListAttribute::LABELLEDBY_IDS, 3);
  ...
  update.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::LABELLEDBY_IDS, nodes_two_three);
  EXPECT_TRUE(tree.Unserialize(update));
