...
void AXPositionTest::SetUp() {
  ...
  button_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                              std::vector<int32_t>{0});
  button_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS,
                              std::vector<int32_t>{6});
  button_.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID,
                          check_box_.id);
  root_.child_ids.push_back(button_.id);

  check_box_.role = ax::mojom::Role::CHECK_BOX;
  check_box_.SetCheckedState(ax::mojom::CheckedState::TRUE_VALUE);
  ...
  check_box_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS,
                                 std::vector<int32_t>{5, 9});
  check_box_.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID,
                             button_.id);
  ...
  text_field_.AddIntListAttribute(
      ax::mojom::IntListAttribute::CACHED_LINE_STARTS,
  ...
  inline_box1_.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID,
                               line_break_.id);

  line_break_.role = ax::mojom::Role::LINE_BREAK;
  line_break_.AddState(ax::mojom::State::EDITABLE);
  line_break_.SetName("\n");
  line_break_.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID,
                              inline_box1_.id);
