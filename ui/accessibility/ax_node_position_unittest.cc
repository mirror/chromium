...
void AXPositionTest::SetUp() {
  ...
  root_.role = ax::mojom::Role::DIALOG;
  root_.AddState(ax::mojom::State::FOCUSABLE);
  root_.SetName(std::string("ButtonCheck box") + TEXT_VALUE);
  root_.location = gfx::RectF(0, 0, 800, 600);

  button_.role = ax::mojom::Role::BUTTON;
  button_.AddState(ax::mojom::State::HASPOPUP);
  button_.SetName("Button");
  button_.location = gfx::RectF(20, 20, 200, 30);
  button_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS, std::vector<int32_t>{0});
  button_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS, std::vector<int32_t>{6});
  button_.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID, check_box_.id);
  root_.child_ids.push_back(button_.id);

  check_box_.role = ax::mojom::Role::CHECK_BOX;
  check_box_.AddIntAttribute(ax::mojom::IntAttribute::CHECKED_STATE,
  ...
  check_box_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                 std::vector<int32_t>{0, 6});
  check_box_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS, std::vector<int32_t>{5, 9});
  check_box_.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID, button_.id);
  root_.child_ids.push_back(check_box_.id);

  text_field_.role = ax::mojom::Role::TEXT_FIELD;
  text_field_.AddState(ax::mojom::State::EDITABLE);
  text_field_.SetValue(TEXT_VALUE);
  text_field_.AddIntListAttribute(ax::mojom::IntListAttribute::CACHED_LINE_STARTS,
  ...
  static_text1_.role = ax::mojom::Role::STATIC_TEXT;
  static_text1_.AddState(ax::mojom::State::EDITABLE);
  static_text1_.SetName("Line 1");
  static_text1_.child_ids.push_back(inline_box1_.id);

  inline_box1_.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_box1_.AddState(ax::mojom::State::EDITABLE);
  inline_box1_.SetName("Line 1");
  inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                   std::vector<int32_t>{0, 5});
  inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS,
                                   std::vector<int32_t>{4, 6});
  inline_box1_.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID, line_break_.id);

  line_break_.role = ax::mojom::Role::LINE_BREAK;
  line_break_.AddState(ax::mojom::State::EDITABLE);
  line_break_.SetName("\n");
  line_break_.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID, inline_box1_.id);

  static_text2_.role = ax::mojom::Role::STATIC_TEXT;
  static_text2_.AddState(ax::mojom::State::EDITABLE);
  static_text2_.SetName("Line 2");
  static_text2_.child_ids.push_back(inline_box2_.id);

  inline_box2_.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_box2_.AddState(ax::mojom::State::EDITABLE);
  inline_box2_.SetName("Line 2");
  inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                   std::vector<int32_t>{0, 5});
  inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS,
                                   std::vector<int32_t>{4, 6});
...
TEST_F(AXPositionTest, Clone) {
  ...
  EXPECT_EQ(ax::mojom::TextAffinity::UPSTREAM, copy_position->affinity());
  ...
  EXPECT_EQ(text_field_.id, copy_position->anchor_id());
  EXPECT_EQ(1, copy_position->text_offset());
  EXPECT_EQ(ax::mojom::TextAffinity::DOWNSTREAM, copy_position->affinity());
...
TEST_F(AXPositionTest, AsTextPositionWithTextPosition) {
  ...
  EXPECT_EQ(text_field_.id, test_position->anchor_id());
  EXPECT_EQ(0, test_position->text_offset());
  EXPECT_EQ(ax::mojom::TextAffinity::DOWNSTREAM, test_position->affinity());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPosition) {
  ...
  EXPECT_EQ(ax::mojom::TextAffinity::UPSTREAM, test_position->affinity());
