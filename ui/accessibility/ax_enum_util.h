...
AX_EXPORT const char* ToString(ax::mojom::DefaultActionVerb default_action_verb);
AX_EXPORT ax::mojom::DefaultActionVerb ParseDefaultActionVerb(const char *default_action_verb);
...
AX_EXPORT ax::mojom::StringAttribute ParseStringAttribute(const char *string_attribute);
...
AX_EXPORT ax::mojom::FloatAttribute ParseFloatAttribute(const char *float_attribute);

// ax::mojom::BoolAttribute
AX_EXPORT const char* ToString(ax::mojom::BoolAttribute bool_attribute);
AX_EXPORT ax::mojom::BoolAttribute ParseBoolAttribute(const char *bool_attribute);

// ax::mojom::IntListAttribute
AX_EXPORT const char* ToString(ax::mojom::IntListAttribute int_list_attribute);
AX_EXPORT ax::mojom::IntListAttribute ParseIntListAttribute(const char *int_list_attribute);

// ax::mojom::StringListAttribute
AX_EXPORT const char* ToString(ax::mojom::StringListAttribute string_list_attribute);
AX_EXPORT ax::mojom::StringListAttribute ParseStringListAttribute(const char *string_list_attribute);
...
AX_EXPORT ax::mojom::TextDirection ParseTextDirection(const char *text_direction);
...
AX_EXPORT ax::mojom::AriaCurrentState ParseAriaCurrentState(const char *aria_current_state);
...
AX_EXPORT ax::mojom::SortDirection ParseSortDirection(const char *sort_direction);
...
AX_EXPORT ax::mojom::DescriptionFrom ParseDescriptionFrom(const char *description_from);
