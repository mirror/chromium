...
TEST(CombineAXTreesTest, EmbedChildTree) {
  ...
  parent_tree.nodes[2].AddIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID,
                                       2);
...
TEST(CombineAXTreesTest, MapAllIdAttributes) {
  ...
  tree.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::TABLE_ROW_HEADER_ID,
                                22);
  tree.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::TABLE_COLUMN_HEADER_ID,
                                22);
  tree.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::ACTIVEDESCENDANT_ID,
                                22);
  std::vector<int32_t> ids { 22 };
  tree.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::INDIRECT_CHILD_IDS, ids);
  tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::CONTROLS_IDS,
                                    ids);
  tree.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::DESCRIBEDBY_IDS, ids);
  tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::FLOWTO_IDS,
                                    ids);
  tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::LABELLEDBY_IDS,
                                    ids);
  tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::CELL_IDS, ids);
  tree.nodes[0].AddIntListAttribute(
      ax::mojom::IntListAttribute::UNIQUE_CELL_IDS, ids);
  tree.nodes[1].id = 22;
  ...
  EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(
                   ax::mojom::IntAttribute::TABLE_HEADER_ID));
  EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(
                   ax::mojom::IntAttribute::TABLE_ROW_HEADER_ID));
  EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(
                   ax::mojom::IntAttribute::TABLE_COLUMN_HEADER_ID));
  EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(
                   ax::mojom::IntAttribute::ACTIVEDESCENDANT_ID));
