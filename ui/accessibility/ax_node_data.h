...
struct AX_EXPORT AXNodeData {
  ...
  ax::mojom::CheckedState GetCheckedState() const {
    return static_cast<ax::mojom::CheckedState>(
        GetIntAttribute(ax::mojom::IntAttribute::CHECKED_STATE));
  }
