...
class AXPosition {
 ...
 private:
  ...
  // internally since inline text objects don't span lines and since text fields
  // always have soft line breaks between lines which make it clear on what line
  // the position is on.
