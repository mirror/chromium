...
class VIEWS_EXPORT StyledLabel : public View, public LinkListener {
 public:
  ...
  struct VIEWS_EXPORT RangeStyleInfo {
    ...
    // Whether keep underlines on links in old UI, otherwise they are removed.
    // This has no effect with --secondary-ui-md, which never has underlines.
    // TODO(tapted): Remove this.
    bool underline_links_in_old_ui = false;
