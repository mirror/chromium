...
class WEBVIEW_EXPORT WebView : public View,
 ...
 public:
  ...
  // when the web contents is in a crashed state. Does not delete the old
  // view if it's replaced with another View, later - the caller is expected
  // to retain ownership of the View.
