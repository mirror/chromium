...
class VIEWS_EXPORT ScrollView : public View, public ScrollBarController {
 public:
  ...
  //   called the background color comes from the theme.
  // . By way of setting an explicit color, e.g. SetBackgroundColor(). Use
 ...
 private:
  ...
  // Force |contents_viewport_| to have a Layer().
