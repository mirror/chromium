...
TEST_F(TextfieldModelTest, CompositionTextTest) {
  ...
  composition.text_composition_data.composition_underlines.push_back(
      ui::CompositionUnderline(0, 3, 0, false));
  ...
  composition.text_composition_data.composition_underlines.clear();
  composition.text_composition_data.composition_underlines.push_back(
      ui::CompositionUnderline(0, 2, 0, true));
  composition.text_composition_data.composition_underlines.push_back(
      ui::CompositionUnderline(2, 3, 0, false));
  model.SetCompositionText(composition);
  EXPECT_TRUE(model.HasCompositionText());
