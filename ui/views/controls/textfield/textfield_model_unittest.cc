...
TEST_F(TextfieldModelTest, CompositionTextTest) {
  ...
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(0, 3, 0, blink::kWebImeTextSpanThicknessThin));
  ...
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(0, 2, 0, blink::kWebImeTextSpanThicknessThick));
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(2, 3, 0, blink::kWebImeTextSpanThicknessThin));
  model.SetCompositionText(composition);
  EXPECT_TRUE(model.HasCompositionText());
