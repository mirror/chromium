...
TEST_F(TextfieldModelTest, CompositionTextTest) {
  ...
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(0, 3, 0, ui::IME_TEXT_SPAN_THICKNESS_THIN));
  ...
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(0, 2, 0, ui::IME_TEXT_SPAN_THICKNESS_THICK));
  composition.ime_text_spans.push_back(
      ui::ImeTextSpan(2, 3, 0, ui::IME_TEXT_SPAN_THICKNESS_THIN));
  model.SetCompositionText(composition);
  EXPECT_TRUE(model.HasCompositionText());
