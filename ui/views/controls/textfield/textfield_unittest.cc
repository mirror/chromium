...
// Check if the text cursor always locates at the end of the textfield after the
...
TEST_F(TextfieldTest, TextfieldBoundsChangeTest) {
  ...
  // Insert chars in |textfield_| to make it overflows.
  SendKeyEvent('a');
  SendKeyEvent('a');
  SendKeyEvent('a');
  SendKeyEvent('a');
  ...
  // Check if the cursor continue pointing to the end of the textfield.
