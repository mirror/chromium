...
void Textfield::GetAccessibleNodeData(ui::AXNodeData* node_data) {
  ...
  if (enabled()) {
    node_data->SetDefaultActionVerb(ax::mojom::DefaultActionVerb::ACTIVATE);
  ...
  node_data->AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START,
                             range.start());
  node_data->AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_END,
                             range.end());
}
