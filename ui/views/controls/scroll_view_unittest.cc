...
TEST_F(ScrollViewTest, Header) {
  ...
  header->UpdatePreferredSize(gfx::Size(10, 20));
...
TEST_F(ScrollViewTest, HeaderScrollsWithContent) {
  ...
  scroll_view_.SetContents(contents);
  contents->UpdatePreferredSize(gfx::Size(500, 500));

  CustomView* header = new CustomView;
  scroll_view_.SetHeader(header);
  header->UpdatePreferredSize(gfx::Size(500, 20));
...
TEST_F(ScrollViewTest, ScrollRectToVisible) {
  ...
  CustomView* contents = new CustomView;
  scroll_view_.SetContents(contents);
  contents->UpdatePreferredSize(gfx::Size(500, 1000));
...
TEST_F(ScrollViewTest, ContentScrollNotResetOnLayout) {
  ...
  CustomView* contents = new CustomView;
  contents->UpdatePreferredSize(gfx::Size(300, 300));
  scroll_view_.SetContents(contents);
  ...
  // position.
  contents->UpdatePreferredSize(gfx::Size(300, 500));
  ...
  contents->UpdatePreferredSize(gfx::Size(300, 50));
  scroll_view_.Layout();
