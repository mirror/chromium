...
class VIEWS_EXPORT HoverButton : public LabelButton {
 public:
  ...
  // Overrides the main label associated with this button. If unset, label()
  // will be used instead. |label| should be drawn over this button, but it is
  // not necessary that it be a child view.
  // void set_title(Label* label) { title_ = label; }

  // Sets a secondary label associated with this button. |label| should be drawn
  // over this button, but it is not necessary that it be a child view.
  // void set_subtitle(Label* label) { subtitle_ = label; }
