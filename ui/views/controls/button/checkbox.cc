...
const char Checkbox::IconFocusRing::kViewClassName[] = "IconFocusRing";
...
void Checkbox::IconFocusRing::Install(Checkbox* check_box) {
  IconFocusRing* ring =
      static_cast<IconFocusRing*>(GetFocusRing(check_box, kViewClassName));
  if (!ring) {
...
void Checkbox::IconFocusRing::Uninstall(Checkbox* check_box) {
  delete GetFocusRing(check_box, kViewClassName);
}

const char* Checkbox::IconFocusRing::GetClassName() const {
  return kViewClassName;
}
