...
void Checkbox::PaintFocusRing(View* view, gfx::Canvas* canvas) {
  ...
  PaintFocusRing(view, canvas, focus_flags);
}
...
Checkbox::IconFocusRing::IconFocusRing(Checkbox* checkbox)
    : checkbox_(checkbox) {}

Checkbox::IconFocusRing::~IconFocusRing() {}

// static
void Checkbox::IconFocusRing::Show(Checkbox* checkbox) {
  IconFocusRing* ring = checkbox->focus_ring_;
  if (!ring) {
    ring = new IconFocusRing(checkbox);
    checkbox->AddChildView(ring);
    checkbox->focus_ring_ = ring;
  }
...
// static
void Checkbox::IconFocusRing::Hide(Checkbox* checkbox) {
  if (checkbox->focus_ring_)
    checkbox->focus_ring_->SetVisible(false);
}
...
void Checkbox::IconFocusRing::OnPaint(gfx::Canvas* canvas) {
  checkbox_->PaintFocusRing(this, canvas);
}
