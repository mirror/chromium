...
#ifndef UI_VIEWS_BUTTON_BACKGROUND_PAINTER_DELEGATE_H_
#define UI_VIEWS_BUTTON_BACKGROUND_PAINTER_DELEGATE_H_
...
#endif  // UI_VIEWS_BUTTON_BACKGROUND_PAINTER_DELEGATE_H_
