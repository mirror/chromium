...
class LayoutOnAddView : public View {
 public:
  LayoutOnAddView() { set_preferred_size(gfx::Size(10, 10)); }
  ...
  void ViewHierarchyChanged(
    ...
    set_preferred_size(target_size_);
...
class GridLayoutAlignmentTest : public testing::Test {
 public:
  GridLayoutAlignmentTest() : layout(&host) {
    v1.set_preferred_size(gfx::Size(10, 20));
  }
...
TEST_F(GridLayoutTest, TwoColumns) {
  ...
  v1.set_preferred_size(gfx::Size(10, 20));
  View v2;
  v2.set_preferred_size(gfx::Size(20, 20));
  ColumnSet* c1 = layout.AddColumnSet(0);
...
TEST_F(GridLayoutTest, LinkedSizes) {
  ...
  v2.set_preferred_size(gfx::Size(20, 20));
  View v3;
  v3.set_preferred_size(gfx::Size(0, 20));
  ColumnSet* c1 = layout.AddColumnSet(0);
  ...
  v1.set_preferred_size(gfx::Size(35, 20));
  GetPreferredSize();
  ...
  v1.set_preferred_size(gfx::Size(45, 20));
  GetPreferredSize();
...
TEST_F(GridLayoutTest, ColSpan1) {
  View v1;
  v1.set_preferred_size(gfx::Size(100, 20));
  View v2;
  v2.set_preferred_size(gfx::Size(10, 40));
  ColumnSet* c1 = layout.AddColumnSet(0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
                0, GridLayout::USE_PREF, 0, 0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
...
TEST_F(GridLayoutTest, ColSpan2) {
  ...
  v1.set_preferred_size(gfx::Size(100, 20));
  View v2;
  v2.set_preferred_size(gfx::Size(10, 20));
  ColumnSet* c1 = layout.AddColumnSet(0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
                1, GridLayout::USE_PREF, 0, 0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
...
TEST_F(GridLayoutTest, ColSpan3) {
  ...
  v2.set_preferred_size(gfx::Size(10, 20));
  View v3;
  v3.set_preferred_size(gfx::Size(10, 20));
  ColumnSet* c1 = layout.AddColumnSet(0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
                0, GridLayout::USE_PREF, 0, 0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
...
TEST_F(GridLayoutTest, ColSpan4) {
  ...
  View v1;
  v1.set_preferred_size(gfx::Size(10, 10));
  View v2;
  v2.set_preferred_size(gfx::Size(10, 10));
  View v3;
  v3.set_preferred_size(gfx::Size(25, 20));
  layout.StartRow(0, 0);
  layout.AddView(&v1);
  layout.AddView(&v2);
  layout.StartRow(0, 0);
...
TEST_F(GridLayoutTest, ColSpanStartSecondColumn) {
  ...
  v1.set_preferred_size(gfx::Size(10, 10));
  View v2;
  v2.set_preferred_size(gfx::Size(20, 10));
...
TEST_F(GridLayoutTest, SameSizeColumns) {
  View v1;
  v1.set_preferred_size(gfx::Size(50, 20));
  View v2;
  v2.set_preferred_size(gfx::Size(10, 10));
  ColumnSet* c1 = layout.AddColumnSet(0);
  c1->AddColumn(GridLayout::LEADING, GridLayout::LEADING,
...
TEST_F(GridLayoutTest, HorizontalResizeTest3) {
  ...
  v2.set_preferred_size(gfx::Size(10, 10));
  View v3;
  v3.set_preferred_size(gfx::Size(10, 10));
  ColumnSet* c1 = layout.AddColumnSet(0);
  c1->AddColumn(GridLayout::FILL, GridLayout::LEADING,
                1, GridLayout::USE_PREF, 0, 0);
  c1->AddColumn(GridLayout::FILL, GridLayout::LEADING,
