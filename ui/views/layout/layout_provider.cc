...
gfx::Insets LayoutProvider::GetInsetsForContentType(
  ...
  switch (leading) {
    case LeadingContentType::TEXT:
      top_margin =
          GetDistanceMetric(views::DISTANCE_DIALOG_TITLE_TO_TEXT_CONTENT);
      break;
    case LeadingContentType::CONTROL:
      top_margin =
          GetDistanceMetric(views::DISTANCE_DIALOG_TITLE_TO_CONTROL_CONTENT);
      break;
  ...
  switch (trailing) {
    case TrailingContentType::TEXT:
      bottom_margin =
          GetDistanceMetric(views::DISTANCE_DIALOG_TEXT_CONTENT_TO_BUTTONS);
      break;
    case TrailingContentType::CONTROL:
      bottom_margin =
          GetDistanceMetric(views::DISTANCE_DIALOG_CONTROL_CONTENT_TO_BUTTONS);
      break;
    default:
      NOTREACHED();
  }
