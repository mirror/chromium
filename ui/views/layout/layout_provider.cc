...
gfx::Insets LayoutProvider::GetInsetsMetric(int metric) const {
  ...
  switch (metric) {
    ...
    case InsetsMetric::INSETS_DIALOG_CONTENTS: {
      const gfx::Insets& dialog_insets = GetInsetsMetric(INSETS_DIALOG);
      return gfx::Insets(
          GetDistanceMetric(DISTANCE_DIALOG_TITLE_CONTENT_MARGIN),
          dialog_insets.left(),
          GetDistanceMetric(DISTANCE_DIALOG_BUTTON_CONTENT_MARGIN),
          dialog_insets.right());
    }
...
int LayoutProvider::GetDistanceMetric(int metric) const {
  ...
  switch (metric) {
    ...
    case DistanceMetric::DISTANCE_CLOSE_BUTTON_MARGIN:
      return 7;
    case DistanceMetric::DISTANCE_DIALOG_BUTTON_CONTENT_MARGIN:
      return 13;
    case DistanceMetric::DISTANCE_DIALOG_TITLE_CONTENT_MARGIN:
      return 13;
