...
class VIEWS_EXPORT ViewAccessibility {
 public:
  ...
  ViewAccessibility(View* view) {}
  virtual ~ViewAccessibility() {}

  // Retrieve the accessible properties of the associated View,
  // taking any custom overrides into account (see SetRole, etc. below).
  ui::AXNodeData GetAccessibleNodeData();
