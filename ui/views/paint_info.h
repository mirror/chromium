...
class VIEWS_EXPORT PaintInfo {
 public:
  enum class ScaleType {
    // Scale the recordings by the default device scale factor mainting the
    // aspect ratio. Use this to prevent any form of distortion during scaling.
    kUniformScaling = 0,
    ...
    // distortion and not recommended to be used with views that contain images.
