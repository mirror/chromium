...
class VIEWS_EXPORT FloodFillInkDropRipple : public InkDropRipple {
 public:
  ...
  void set_use_trasform_duration_for_hide_fade_out(bool value) {
    use_transform_duration_for_hide_fade_out_ = value;
  }
 ...
 private:
  ...
  // Whether the fade out animation duration to hidden state should have the
  // same duration as the associated scale transform animation.
  bool use_transform_duration_for_hide_fade_out_;
