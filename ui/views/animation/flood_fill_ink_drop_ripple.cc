...
FloodFillInkDropRipple::FloodFillInkDropRipple(const gfx::Size& host_size,
    ...
    : clip_insets_(clip_insets),
      ...
      default_opacity_(kHiddenOpacity),
      duration_factor_(1),
  ...
  switch (new_ink_drop_state) {
    case InkDropState::HIDDEN:
      if (!IsVisible()) {
        ...
        AnimateToOpacity(
            default_opacity_,
            GetAnimationDuration(HIDDEN_FADE_OUT, duration_factor_),
    ...
    case InkDropState::ALTERNATE_ACTION_TRIGGERED:
      ...
      AnimateToOpacity(default_opacity_,
...
void FloodFillInkDropRipple::SetStateToHidden() {
  ...
  root_layer_.SetOpacity(default_opacity_);
