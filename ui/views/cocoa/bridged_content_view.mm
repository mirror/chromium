...
- (void)setMarkedText:(id)text
  ...
  // Add a thin underline with the text color and a transparent background to
  // the composition text. TODO(karandeepb): On Cocoa textfields, the target
  // clause of the composition has a thick underlines. The composition text also
  // has discontinous underlines for different clauses. This is also supported
  // in the Chrome renderer. Add code to extract underlines from |text| once our
  ...
  composition.underlines.push_back(ui::CompositionUnderline(
      0, [text length], SK_ColorTRANSPARENT,
