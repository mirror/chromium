...
LRESULT HWNDMessageHandler::GenerateTouchEventFromPointerEvent(
  ...
  // We send pointer events when the pen is hovering in the range of tablet
  // but not pressing the tablet, otherwise sending touch events when the pen
  // is pressing the tablet.
  if (is_pointer_event) {
