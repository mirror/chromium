...
class VIEWS_EXPORT HWNDMessageHandler : public gfx::WindowImpl,
 ...
 private:
  ...
  LRESULT HandleDManipScroll(float delta_x, float delta_y) override;

  void HandleDManipBeginMessage(float delta_x,
                                float delta_y,
                                ui::EventType event_type) override;

  void HandleDManipEndMessage(ui::EventType event_type) override;

  LRESULT HandleDManipPinch(float scale, ui::EventType event_type) override;
