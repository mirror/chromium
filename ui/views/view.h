...
class VIEWS_EXPORT View : public ui::LayerDelegate,
 ...
 public:
  ...
  static void TurnOnConstructorStackTracking() {
    isConstructorStackTrackingOn = true;
  }
  base::debug::StackTrace* GetConstructorStackForDebugging() {
    return isConstructorStackTrackingOn ? constructor_stack_for_debugging_.get()
                                        : nullptr;
  }
#endif
 ...
 private:
...
#if defined(AX_CHECKS)
  static bool isConstructorStackTrackingOn;
  ...
  const std::unique_ptr<base::debug::StackTrace>
      constructor_stack_for_debugging_ =
          View::isConstructorStackTrackingOn
