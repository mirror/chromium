...
// Creates the paint info for the view's layer. Views uses the corner
// scaling logic to compute the pixel bounds of a view and
// paint_recording_bounds_ should be scaled using the same logic,
// except when a view touches the right/bottom edges of the parent,
// and its layer has to be able to paint to these edges. Such cases
// should be handled case by case basis.
