...
VIEWS_EXPORT const gfx::FontList& GetFont(const View& view,
                                          int context,
                                          int style);
VIEWS_EXPORT SkColor GetColor(const View& view, int context, int style);
VIEWS_EXPORT int GetLineHeight(const View& view, int context, int style);
