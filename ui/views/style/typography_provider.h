...
class VIEWS_EXPORT TypographyProvider {
 public:
  ...
  // |view| which can provide customized NativeTheme or ThemeProvider.
  virtual SkColor GetColor(int context, int style, const View& view) const = 0;
...
class VIEWS_EXPORT DefaultTypographyProvider : public TypographyProvider {
 public:
  ...
  SkColor GetColor(int context, int style, const View& view) const override;
