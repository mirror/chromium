...
#endif
{
 public:
  ...
  const std::set<int64_t>& stored_mirror_modes() const {
    return stored_mirror_modes_;
  }

  void set_stored_mirror_modes(const std::set<int64_t>& stored_mirror_modes) {
...
// SoftwareMirroringController override:
 ...
 private:
  ...
  PreviousMirrorMode previous_mirror_mode_ = PreviousMirrorMode::kNotSet;
  ...
  std::set<int64_t> stored_mirror_modes_;
