...
#endif
{
 public:
  ...
  // Turn on/off the mirror mode. If |enabled| is false, |mixed_params| will be
  // ignored and mirror mode will be turned off. The default mirror mode will be
  // turned on if |mixed_params| is not specified. The mixed mirror mode will be
  // turned on otherwise. In default mirror mode, default source display will be
  // selected and mirrored to all other displays. In mixed mirror mode, the
  // specified source and destination displays in |mixed_params| will be used.
