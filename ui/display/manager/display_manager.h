...
#endif
{
 public:
  ...
  const CustomSoftwareMirroringParam* custom_software_mirroring_param() const {
  ...
  void set_custom_software_mirroring_param(
      std::unique_ptr<CustomSoftwareMirroringParam> mirroring_param) {
  ...
  void SetMirrorMode(
      bool mirrored,
      std::unique_ptr<CustomSoftwareMirroringParam> mirroring_param = nullptr);
...
// SoftwareMirroringController override:
 ...
 private:
  ...
  std::unique_ptr<CustomSoftwareMirroringParam>
