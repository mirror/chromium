...
void DisplayManager::UpdateDisplaysWith(
  ...
  if (num_connected_displays_ > 1) {
    previous_mirror_mode_ = mirror_mode ? PreviousMirrorMode::kMirrorOn
                                        : PreviousMirrorMode::kMirrorOff;
  } else {
    previous_mirror_mode_ = PreviousMirrorMode::kNotSet;
  }
...
bool DisplayManager::ShouldTurnOnMirrorMode(
  ...
  if (previous_mirror_mode_ == PreviousMirrorMode::kNotSet) {
    // Mirror mode should be on if one of the external display was in mirror
    // mode before.
  ...
  // configuration.
  return previous_mirror_mode_ == PreviousMirrorMode::kMirrorOn;
}
