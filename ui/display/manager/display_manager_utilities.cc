...
const ManagedDisplayMode* GetDisplayModeForResolution(
...
const ManagedDisplayMode* GetDisplayModeForNextUIScale(
    const ManagedDisplayInfo& info,
    bool up) {
  const ManagedDisplayInfo::ManagedDisplayModeList& modes =
      info.display_modes();
...
const ManagedDisplayMode* GetDisplayModeForNextResolution(
    const ManagedDisplayInfo& info,
    bool up) {
  if (Display::IsInternalDisplayId(info.id()))
    return nullptr;
