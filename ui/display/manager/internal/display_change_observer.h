...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_DISPLAY_CHANGE_OBSERVER_H_
#define UI_DISPLAY_MANAGER_INTERNAL_DISPLAY_CHANGE_OBSERVER_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_DISPLAY_CHANGE_OBSERVER_H_
