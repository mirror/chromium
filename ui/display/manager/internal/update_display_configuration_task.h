...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_UPDATE_DISPLAY_CONFIGURATION_TASK_H_
#define UI_DISPLAY_MANAGER_INTERNAL_UPDATE_DISPLAY_CONFIGURATION_TASK_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_UPDATE_DISPLAY_CONFIGURATION_TASK_H_
