...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_DEFAULT_TOUCH_TRANSFORM_SETTER_H_
#define UI_DISPLAY_MANAGER_INTERNAL_DEFAULT_TOUCH_TRANSFORM_SETTER_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_DEFAULT_TOUCH_TRANSFORM_SETTER_H_
