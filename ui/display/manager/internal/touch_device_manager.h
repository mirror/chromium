...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_TOUCH_DEVICE_MANAGER_H_
#define UI_DISPLAY_MANAGER_INTERNAL_TOUCH_DEVICE_MANAGER_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_TOUCH_DEVICE_MANAGER_H_
