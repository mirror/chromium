...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_APPLY_CONTENT_PROTECTION_TASK_H_
#define UI_DISPLAY_MANAGER_INTERNAL_APPLY_CONTENT_PROTECTION_TASK_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_APPLY_CONTENT_PROTECTION_TASK_H_
