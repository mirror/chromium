...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_TEST_ACTION_LOGGER_UTIL_H_
#define UI_DISPLAY_MANAGER_INTERNAL_TEST_ACTION_LOGGER_UTIL_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_TEST_ACTION_LOGGER_UTIL_H_
