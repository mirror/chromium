...
#ifndef UI_DISPLAY_MANAGER_INTERNAL_CONFIGURE_DISPLAYS_TASK_H_
#define UI_DISPLAY_MANAGER_INTERNAL_CONFIGURE_DISPLAYS_TASK_H_
...
#endif  // UI_DISPLAY_MANAGER_INTERNAL_CONFIGURE_DISPLAYS_TASK_H_
