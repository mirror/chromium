...
TEST_F(TouchTransformControllerTest, MirrorModeLetterboxing) {
  ...
  internal_modes.push_back(base::WrapRefCounted(
...
TEST_F(TouchTransformControllerTest, SoftwareMirrorMode) {
  ...
  display1_modes.push_back(base::WrapRefCounted(
  ...
  display2_modes.push_back(base::WrapRefCounted(
...
TEST_F(TouchTransformControllerTest, LetterboxingUserTouchCalibration) {
  ...
  internal_modes.push_back(base::WrapRefCounted(new ManagedDisplayMode(
