...
struct DISPLAY_MANAGER_EXPORT CustomSoftwareMirroringParam {
  CustomSoftwareMirroringParam(int64_t src_id, const DisplayIdList& dst_ids);
  ~CustomSoftwareMirroringParam();
...
ValidateParamsForCustomSoftwareMirroring(
    ...
    const CustomSoftwareMirroringParam& mixed_mode_param);
