...
struct DISPLAY_MANAGER_EXPORT MixedMirrorModeParams {
  ...
  explicit MixedMirrorModeParams(const MixedMirrorModeParams& mixed_params);
...
enum DISPLAY_MANAGER_EXPORT class MirrorMode {
  kOff = 0,
  kNormal,
  kMixed,
};
...
enum DISPLAY_MANAGER_EXPORT class MixedMirrorModeParamsErrors {
  kSuccess = 0,
  kErrorSingleDisplay,
