...
TEST_F(DisplayInfoTest, CopyTouchCalibrationMap) {
  const int64_t kDisplayId = 10;
  const uint32_t kTouchDeviceIdentifier1 = 123;
  const uint32_t kTouchDeviceIdentifier2 = 234;
  const uint32_t kTouchDeviceIdentifier3 = 345;
  const uint32_t kTouchDeviceIdentifier4 = 456;
