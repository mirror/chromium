...
class DISPLAY_MANAGER_EXPORT ManagedDisplayMode {
 public:
  ...
  ~ManagedDisplayMode() = default;
  ManagedDisplayMode(ManagedDisplayMode& other) = default;
  ManagedDisplayMode(const ManagedDisplayMode& other) = default;
  ManagedDisplayMode& operator=(const ManagedDisplayMode& other) = default;
  ManagedDisplayMode& operator=(ManagedDisplayMode& other) = default;
