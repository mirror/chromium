...
#ifndef UI_DISPLAY_TEST_TOUCH_DEVICE_MANAGER_TEST_API_H_
#define UI_DISPLAY_TEST_TOUCH_DEVICE_MANAGER_TEST_API_H_
...
class DISPLAY_MANAGER_EXPORT TouchDeviceManagerTestApi {
 public:
  ...
  const TouchDeviceManager::TouchAssociationMap touch_associations() const;
...
#endif  // UI_DISPLAY_TEST_TOUCH_DEVICE_MANAGER_TEST_API_H_
