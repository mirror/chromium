...
TEST(EDIDParserTest, ParseBitsPerChannel) {
  ...
  EXPECT_TRUE(ParseBitsPerChannel(edid_internal_display,
                                  &edid_internal_display_bits_per_channel));
  EXPECT_EQ(10, edid_internal_display_bits_per_channel);
