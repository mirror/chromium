...
void ViewAndroid::OnSizeChanged(int width, int height) {
  // Match-parent View should keep its size in sync with its parent, ignoring
  // the size change event.
  // TODO(jinsukkim): Should not get the events in the first place. Use
  //     assert instead.
