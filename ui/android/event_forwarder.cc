...
jboolean EventForwarder::OnTouchEvent(JNIEnv* env,
  ...
  ui::MotionEventAndroid event(
      ...
      raw_pos_x - pos_x_0, raw_pos_y - pos_y_0, &pointer0, &pointer1, false);
...
void EventForwarder::OnMouseEvent(JNIEnv* env,
  ...
  ui::MotionEventAndroid event(
      ...
      0 /* raw_offset_y_pixels */, &pointer, nullptr, is_hover);
...
void EventForwarder::OnMouseWheelEvent(JNIEnv* env,
  ...
  ui::MotionEventAndroid event(
      ...
      0 /* raw_offset_x_pixels */, 0 /* raw_offset_y_pixels */, &pointer,
      nullptr, false);
