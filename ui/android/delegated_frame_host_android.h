...
class UI_ANDROID_EXPORT DelegatedFrameHostAndroid
 ...
 private:
  ...
  // A variable indicating whether this frame has ever shown content. We only
  // lock the compositor if we are re-attaching a view that has previously
  // had content (to prevent flickering). We're OK showing placeholder
  // content for new views.
  bool has_ever_had_content_ = false;
