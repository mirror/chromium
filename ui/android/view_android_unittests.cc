...
class ViewAndroidBoundsTest : public testing::Test {
 public:
  ViewAndroidBoundsTest()
    ...
    root_.SetLayoutType(ViewAndroid::LayoutParams::MATCH_PARENT);
  }
...
TEST_F(ViewAndroidBoundsTest, MatchesViewSizeOfkMatchParent) {
  ...
  view3_.SetLayoutType(ViewAndroid::LayoutParams::MATCH_PARENT);
...
TEST_F(ViewAndroidBoundsTest, OnSizeChanged) {
  ...
  view2_.SetLayoutType(ViewAndroid::LayoutParams::MATCH_PARENT);
