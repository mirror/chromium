...
#ifndef UI_BASE_CLIPBOARD_MOJO_CLIPBOARD_STRUCT_TRAITS_H_
#define UI_BASE_CLIPBOARD_MOJO_CLIPBOARD_STRUCT_TRAITS_H_
...
struct EnumTraits<ui::mojom::ClipboardType, ui::ClipboardType> {
  static ui::mojom::ClipboardType ToMojom(
...
#endif  // UI_BASE_CLIPBOARD_MOJO_CLIPBOARD_STRUCT_TRAITS_H_
