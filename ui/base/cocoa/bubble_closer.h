...
class UI_BASE_EXPORT BubbleCloser {
 public:
  ...
  // any of its child windows. Invokes |on_click_outside| on the first event.
  BubbleCloser(gfx::NativeWindow window, base::OnceClosure on_click_outside);
  ~BubbleCloser();
 ...
 private:
  ...
  base::OnceClosure on_click_outside_;
