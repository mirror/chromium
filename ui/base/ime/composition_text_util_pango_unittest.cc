...
const TestData kTestData[] = {
    ...
    {"One Two Three",
     {{PANGO_ATTR_UNDERLINE, PANGO_UNDERLINE_SINGLE, 0, 3},
      ...
      {0, 0, 0, 0}},
     {{0, 3, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {4, 7, 0, blink::kWebImeTextSpanThicknessThick, SK_ColorTRANSPARENT},
      {8, 13, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {0, 0, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT}}},
    ...
    {"One Two Three",
     {{PANGO_ATTR_UNDERLINE, PANGO_UNDERLINE_SINGLE, 0, 3},
      ...
      {0, 0, 0, 0}},
     {{0, 3, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {4, 7, SK_ColorRED, blink::kWebImeTextSpanThicknessThin,
       SK_ColorTRANSPARENT},
      {8, 13, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {0, 0, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT}}},
    ...
    {"One Two Three",
     {{0, 0, 0, 0}},
     {{0, 13, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {0, 0, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT}}},
    ...
    {"123\xE4\xBD\xA0\xE5\xA5\xBD\xF0\xA0\x80\x80\xF0\xA0\x80\x81\xE4\xB8\x80"
     ...
     {{PANGO_ATTR_UNDERLINE, PANGO_UNDERLINE_SINGLE, 0, 3},
      ...
      {0, 0, 0, 0}},
     {{0, 3, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {3, 5, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {5, 9, 0, blink::kWebImeTextSpanThicknessThick, SK_ColorTRANSPARENT},
      {9, 15, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT},
      {0, 0, 0, blink::kWebImeTextSpanThicknessThin, SK_ColorTRANSPARENT}}},
};
