...
class UI_BASE_IME_EXPORT TextInputClient {
 public:
  ...
  // Retrieves text range, text within text range, selection range, and
  // composition bounds and sends them back to |callback| function.
  virtual void GetTextInputClientInfo(
