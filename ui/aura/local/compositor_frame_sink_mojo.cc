...
void CompositorFrameSinkMojo::SubmitCompositorFrame(
  ...
  bool local_surface_id_changed = local_surface_id_ != local_surface_id;
  auto frame_size = frame.render_pass_list.back()->output_rect.size();
  bool result =
...
void CompositorFrameSinkMojo::EvictCurrentSurface() {
