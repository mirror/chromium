...
int g_num_scoped_no_window_occlusion_computations = 0;
...
WindowOcclusionTracker::ScopedNoWindowOcclusionComputations::
  ...
  ++g_num_scoped_no_window_occlusion_computations;
}

WindowOcclusionTracker::ScopedNoWindowOcclusionComputations::
    ~ScopedNoWindowOcclusionComputations() {
  --g_num_scoped_no_window_occlusion_computations;
  if (g_tracker && !g_num_scoped_no_window_occlusion_computations)
    g_tracker->RecomputeWindowOcclusionStates();
}
...
void WindowOcclusionTracker::MaybeRecomputeWindowOcclusionStates(
    Window* root_window) {
  if (g_num_scoped_no_window_occlusion_computations) {
