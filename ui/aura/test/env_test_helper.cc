...
WindowTreeClientSetter::WindowTreeClientSetter(WindowTreeClient* client)
...
WindowTreeClientSetter::~WindowTreeClientSetter() {
...
void WindowTreeClientSetter::SetWindowTreeClient(WindowTreeClient* client) {
