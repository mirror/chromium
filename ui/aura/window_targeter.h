...
class AURA_EXPORT WindowTargeter : public ui::EventTargeter {
 public:
  ...
  // If the event is actionable for |target| then returns true and
  // |hit_test_rect_mouse| and / or |hit_test_rect_touch| return the bounds that
  // can be used for hit testing. // Otherwise returns false.
 ...
 protected:
  ...
  virtual void SetInsets(const gfx::Insets& mouse_extend,
