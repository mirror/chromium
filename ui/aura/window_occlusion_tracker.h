...
class AURA_EXPORT WindowOcclusionTracker : public WindowObserver {
 public:
  ...
  // of a ScopedNoWindowOcclusionComputations, window occlusion state
  // computations are delayed until all ScopedNoWindowOcclusionComputations
  // objects have been destroyed.
  class ScopedNoWindowOcclusionComputations {
   public:
    ScopedNoWindowOcclusionComputations();
    ~ScopedNoWindowOcclusionComputations();

   private:
    DISALLOW_COPY_AND_ASSIGN(ScopedNoWindowOcclusionComputations);
  };
 ...
 private:
  ...
  // there are no active ScopedNoWindowOcclusionComputations instances.
