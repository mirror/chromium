...
class AURA_EXPORT WindowObserver {
 public:
  ...
  // layer won't be automatically attached to the new layer. Use
  // window->layer()->GetAnimator()->
  // (is_animating|IsAnimatingProperty|IsAnimatingOnePropertyOf)() to determine
  // whether the new layer is animated.
