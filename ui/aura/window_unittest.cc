...
class WindowObserverTest : public WindowTest,
 ...
 public:
  ...
  int window_target_transform_changed_count() const {
    return window_target_transform_changed_count_;
  }
 ...
 private:
  ...
  void OnWindowTargetTransformChanged(Window* window) override {
    ++window_target_transform_changed_count_;
  }
  ...
  int window_target_transform_changed_count_ = 0;
...
// OnWindowTargetTransformChanging() and OnWindowTargetTransformChanged() are
// called synchronously from SetTransform().
TEST_P(WindowObserverTest, SetTransform) {
  ...
  EXPECT_EQ(1, window_target_transform_changed_count());
}
