...
void WindowTreeClient::WmPerformWindowManagementAction(
    Id window_id,
...
void WindowTreeClient::OnWindowTreeHostPerformWindowManagementAction(
    WindowTreeHostMus* window_tree_host,
    const std::string& action) {
  WindowMus* window = WindowMus::Get(window_tree_host->window());
  tree_->PerformWindowManagementAction(window->server_id(), action);
}
