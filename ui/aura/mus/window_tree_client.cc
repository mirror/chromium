...
void WindowTreeClient::OnMouseEventsEnabledChanged(bool enabled) {
  if (window_manager_client_)
...
void WindowTreeClient::SetMouseEventsEnabled(bool enabled) {
  if (window_manager_client_)
    window_manager_client_->WmSetMouseEventsEnabled(enabled);
}
