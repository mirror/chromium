...
TEST_F(WindowTreeClientWmTest, SwapDisplayRoots) {
  ...
  window_tree_host1->OverrideAcceleratedWidget(111);
  window_tree_host2->OverrideAcceleratedWidget(222);
  EXPECT_EQ(111, window_tree_host1->GetAcceleratedWidget());
  EXPECT_EQ(222, window_tree_host2->GetAcceleratedWidget());
  ...
  EXPECT_EQ(222, window_tree_host1->GetAcceleratedWidget());
  EXPECT_EQ(111, window_tree_host2->GetAcceleratedWidget());
}
