...
// Replaces hit-test area on a window with a frame rectaangle and a hole in the
// middle 1/3.
//  ----------------------
// |   hit     hit        |
// |      ----------      |
...
class TestHoleWindowTargeter : public aura::WindowTargeter {
 ...
 private:
  ...
  bool GetHitTestRects(aura::Window* window,
    ...
    *hit_test_rect_mouse = gfx::Rect();
    *hit_test_rect_touch = gfx::Rect();
    return true;
  }

  std::unique_ptr<aura::WindowTargeter::ShapeRects> GetHitTestShapeRects(
