...
class TestInputMethod : public ui::mojom::InputMethod {
 public:
  TestInputMethod()
      : was_on_text_input_type_changed_called_(false),
  ...
  void CancelComposition() override {
    was_cancel_composition_called_ = true;
  }
 ...
 private:
  bool was_on_text_input_type_changed_called_;
  bool was_on_caret_bounds_changed_called_;
  bool was_cancel_composition_called_;
