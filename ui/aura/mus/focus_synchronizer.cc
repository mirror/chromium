...
void FocusSynchronizer::SetFocusFromServer(WindowMus* window) {
  LOG(ERROR) << "MSW FocusSynchronizer::SetFocusFromServer " << focused_window_ << " -> " << window;
...
void FocusSynchronizer::SetFocusedWindow(WindowMus* window) {
  LOG(ERROR) << "MSW FocusSynchronizer::SetFocusedWindow A " << focused_window_ << " -> " << window;
...
void FocusSynchronizer::OnWindowFocused(Window* gained_focus,
                                        Window* lost_focus) {
  LOG(ERROR) << "MSW FocusSynchronizer::OnWindowFocused " << lost_focus << " -> " << gained_focus;
