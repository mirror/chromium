...
filelist.focusParentList = function(event) {
  ...
  // TODO(yamaguchi): Use FileGrid instead of cr.ui.Grid after resolving the
  // potential cyclic dependency between file_table_list and file_grid targets.
  while (element &&
         !(element instanceof FileTableList || element instanceof cr.ui.Grid)) {
