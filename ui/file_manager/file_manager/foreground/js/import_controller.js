...
importer.RuntimeCommandWidget.prototype.update = function(
  ...
  if (opt_scan.getFileEntries().length) {
    var photos_text = strf('CLOUD_IMPORT_ONE_FILE');
  } else {
    var photos_text =
  ...
  switch(activityState) {
    ...
    case importer.ActivityState.IMPORTING:
      ...
      this.mainButton_.setAttribute(
          'aria-label', strf('CLOUD_IMPORT_TOOLTIP_IMPORTING', photos_text));
      this.statusContent_.innerHTML =
          strf('CLOUD_IMPORT_STATUS_IMPORTING', photos_text);
    ...
    case importer.ActivityState.READY:
      ...
      this.mainButton_.setAttribute(
          'aria-label', strf('CLOUD_IMPORT_TOOLTIP_READY', photos_text));
      this.statusContent_.innerHTML =
          strf('CLOUD_IMPORT_STATUS_READY', photos_text);
    ...
    case importer.ActivityState.SCANNING:
      ...
      this.statusContent_.innerHTML =
          strf('CLOUD_IMPORT_STATUS_SCANNING', photos_text);
