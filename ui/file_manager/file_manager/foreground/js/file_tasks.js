...
FileTasks.prototype.executeDefaultInternal_ = function(opt_callback) {
  ...
  // If there is only one non-generic task, it should be executed as a default
  // task. If there are multiple non-generic tasks and none of them is
  // considered as default, we show a task picker to ask ther user to choose
  // one.
