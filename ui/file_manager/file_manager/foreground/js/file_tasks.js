...
FileTasks.prototype.executeDefaultInternal_ = function(opt_callback) {
  ...
  // nonGenericTasks.length == 1 is covered by this.defaultTask_ above.
...
FileTasks.getDefaultTask = function(tasks, taskHistory) {
  ...
  // TODO(yamaguchi): return special value to indiacate task picker,
  // instead of detecting this case's condition in extcuteDefault().
