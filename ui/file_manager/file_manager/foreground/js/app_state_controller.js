...
function AppStateController(dialogType) {
  ...
  /**
   * Preferred sort filed of file list. This will be ignored on Recent folder,
   * since it always uses descendant order of date-mofidied.
   * @private {string}
   */
  this.fileListSortField_ = AppStateController.DEFAULT_SORT_FIELD;

  /**
   * Preferred sort direction of file list. This will be ignored on Recent
