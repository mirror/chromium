...
/**
 * Returns true if the board of the device matches the given prefix. Use with
 * caution because there are cases in which the name of one board is a prefix
 * for a different (only slightly related) board: E.g. daisy and daisy-spring,
 * peach-pi and peach-pit, and maybe others.
