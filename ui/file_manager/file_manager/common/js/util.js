 ...
 *
 * @param {!function(boolean)} callback to be called when resolved. The
 *     parameter is true if the touch-specific UI mode is enabled.
 */
util.getTouchModeEnabled = function(callback) {
