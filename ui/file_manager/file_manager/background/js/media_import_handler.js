...
importer.MediaImportHandler.prototype.importFromScanResult = function(
  ...
  var task = new importer.MediaImportHandler.ImportTask(
      ...
      this.onRetriesComplete_.bind(this));
 ...
 * @private
 */
importer.MediaImportHandler.prototype.onRetriesComplete_ = function(
    id, entries) {
  // Display all errors.
...
importer.MediaImportHandler.ImportTask = function(
  ...
  /** @private {function()} For cleaning up the retries. */
  this.onRetriesComplete_ = onRetriesComplete;
};
...
importer.MediaImportHandler.ImportTask.prototype.importScanEntries_ =
  ...
  this.directoryPromise_.then(function(resolver, destinationDirectory) {
    ...
    this.retryImportScanEntries_(resolver, destinationDirectory);
  }.bind(this, resolver));
...
importer.MediaImportHandler.ImportTask.prototype.retryImportScanEntries_ =
  ...
  var sourceEntries =
      /** @type {Array<FileEntry>} */ (this.importEntries_.slice());
  this.importEntries_ = [];
  AsyncUtil.forEach(
      ...
      function(resolver) {
        ...
        if (this.importEntries_.length !== 0 &&
          ...
          this.onRetriesComplete_(this.taskId_, this.importEntries_);
          resolver.resolve();
        }
      }.bind(this, resolver));
};
