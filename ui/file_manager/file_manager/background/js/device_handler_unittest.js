...
loadTimeData.data = {
  ...
  RENAMING_FINISHED_SUCCESS_MESSAGE: 'RENAMING_FINISHED_SUCCESS',
  RENAMING_OF_DEVICE_FAILED_TITLE: 'RENAMING_OF_DEVICE_FAILED_TITLE',
  RENAMING_FINISHED_FAILURE_MESSAGE: 'RENAMING_FINISHED_FAILURE',
};
