...
#ifndef UI_EVENTS_TEST_SCOPED_TEST_TICK_CLOCK_H_
#define UI_EVENTS_TEST_SCOPED_TEST_TICK_CLOCK_H_
...
// On construction it registers a simple test tick clock of events. Upon
// destruction , it clears the test clock.
// Example:
//   TEST_F(SomeFixture, TestingTime) {
//        ScopedEventTestTickClock clock;
//        clock.SetTimeSeconds(1200);
//   }
class ScopedEventTestTickClock {
 public:
  ScopedEventTestTickClock() {
    test_clock_ = new base::SimpleTestTickClock();
    // Give up the ownership of test clock.
...
#endif  // UI_EVENTS_TEST_SCOPED_TEST_TICK_CLOCK_H_