...
class AltGraphEventTest : public testing::TestWithParam<
                              std::tr1::tuple<int, AltGraphEventTestCase>> {
 public:
  AltGraphEventTest() : msg_({NULL, message_type(), test_case().key_code}) {
 ...
 protected:
  int message_type() const { return std::tr1::get<0>(GetParam()); }
  ...
  HKL original_keyboard_layout_ = NULL;
};
