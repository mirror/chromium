...
// http://www.w3.org/TR/DOM-Level-3-Events-key/#keys-device
    ...
    {DomKey::LAUNCH_ASSISTANT_VOICE_COMMAND, VKEY_ASSISTANT_VOICE_COMMAND},
...
#if defined(OS_POSIX)
    {DomCode::LAUNCH_ASSISTANT, VKEY_ASSISTANT},  // 0x000017 Launch Assistant
    {DomCode::LAUNCH_ASSISTANT_VOICE_COMMAND,
     VKEY_ASSISTANT_VOICE_COMMAND},  // 0x000018 Launch Assistant
#endif
