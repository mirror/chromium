...
namespace ui {
FlingBooster::FlingBooster(gfx::Vector2dF fling_velocity,
...
bool FlingBooster::FilterInputEventForFlingBoosting(
  ...
  *out_cancel_current_fling = false;
  ...
  switch (gesture_event.GetType()) {
    ...
    case WebInputEvent::kGestureFlingStart: {
      ...
      bool fling_boosted_ = ShouldBoostFling(gesture_event);
      if (fling_boosted_)
