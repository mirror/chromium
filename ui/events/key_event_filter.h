...
#ifndef UI_EVENTS_KEY_EVENT_FILTER_H_
#define UI_EVENTS_KEY_EVENT_FILTER_H_
...
class KeyEventFilter {
 public:
  ...
  // to the OS.
  // On Windows, the LowLevelKeyboardProc calls this function. If the |event| is
  // reserved by web page, it will be consumed by web page directly. Otherwise
  // LowLevelKeyboardProc returns false, and OS will send the same keyboard
  // event to the regular input pipeline again, i.e. WinWindow will receive it
  // from OS.
...
#endif  // UI_EVENTS_KEY_EVENT_FILTER_H_
