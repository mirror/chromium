...
void SurfacelessGlRenderer::OverlayChecker(int z_order,
  ...
  // The size of the candidate overlay buffer.
  overlay_candidate.buffer_size = buffer_size;
  ...
  TRACE_EVENT1("ozone", "SurfacelessGlRenderer::OverlayChecker", "overlay use",
               list[0].overlay_handled);
}
...
void SurfacelessGlRenderer::RenderFrame() {
  ...
  if (overlay_buffer_) {
    ...
    OverlayChecker(1, overlay_buffer_->size(), overlay_rect,
                   gfx::RectF(0, 0, 1, 1));
