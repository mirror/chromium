...
scoped_refptr<GbmBuffer> DrmThreadProxy::CreateBuffer(
  ...
  scoped_refptr<GbmBuffer> buffer;
    ...
    LOG(ERROR) << "DrmThreadProxy::CreateBuffer prior to DCHECK\n";
  DCHECK(drm_thread_.task_runner()) << "no task runner! in CreateBuffer";
    LOG(ERROR) << "DrmThreadProxy::CreateBuffer after DCHECK\n";


// TODO(rjk):
// I vaguely recall this. PostSyncTask...  the thread  isn't running yet?
