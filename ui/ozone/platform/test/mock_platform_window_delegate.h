...
#ifndef UI_OZONE_PLATFORM_TEST_MOCK_PLATFORM_WINDOW_DELEGATE_H_
#define UI_OZONE_PLATFORM_TEST_MOCK_PLATFORM_WINDOW_DELEGATE_H_
...
#endif  // UI_OZONE_PLATFORM_TEST_MOCK_PLATFORM_WINDOW_DELEGATE_H_
