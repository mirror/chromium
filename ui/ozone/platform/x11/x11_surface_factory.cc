...
class GLOzoneOSMesaX11 : public GLOzoneOSMesa {
 public:
  GLOzoneOSMesaX11() = default;
  ~GLOzoneOSMesaX11() override = default;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(GLOzoneOSMesaX11);
};
...
X11SurfaceFactory::X11SurfaceFactory()
    : glx_implementation_(std::make_unique<GLOzoneGLX>()),
      ...
      osmesa_implementation_(std::make_unique<GLOzoneOSMesaX11>()) {}
