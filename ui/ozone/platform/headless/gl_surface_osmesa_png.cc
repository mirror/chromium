...
void GLSurfaceOSMesaPng::WriteBufferToPng() {
  // TODO(kylechar): Writing the PNG to a file won't work with the GPU sandbox.
  // This will produce no output unless --no-sandbox, --single-process or
  // --in-process-gpu is used. Make this work with a file handle passed from
  // browser process and possibly change output to be video.
