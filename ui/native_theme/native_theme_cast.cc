...
class NativeThemeCast : public NativeThemeAura {
 public:
  NativeThemeCast() : NativeThemeAura(false /* use_overlay_scrollbars */) {}

  SkColor GetSystemColor(ColorId color_id) const override {
    // Colors that Cast uses as part of its native UI.
    switch (color_id) {
      // Also used for progress bars.
      case ui::NativeTheme::kColorId_ProgressBarForeground:
        return gfx::kGoogleBlue500;
      case ui::NativeTheme::kColorId_ProgressBarBackground:
