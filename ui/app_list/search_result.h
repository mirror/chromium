...
class APP_LIST_EXPORT SearchResult {
 public:
  ...
  bool is_omnibox_url() const { return is_omnibox_url_; }
  void set_is_omnibox_url(bool is_omnibox_url) {
    is_omnibox_url_ = is_omnibox_url;
  }
 ...
 private:
  ...
  // Indicates whether result is an omnibox search result. Set by OmniboxResult
  // subclass.
  bool is_omnibox_search_ = false;

  // Indicates whether result is an omnibox url result. Set by OmniboxResult
  // subclass.
  bool is_omnibox_url_ = false;
