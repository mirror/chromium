...
class TestAppListPresenter : public app_list::mojom::AppListPresenter {
 public:
  ...
  void UpdateBoundsOnYPosition(int64_t y_position_in_screen) override;
  ...
  size_t update_bounds_count() const { return update_bounds_count_; }
 ...
 private:
  ...
  size_t update_bounds_count_ = 0u;
