...
bool ProcessLeftRightKeyTraversalForTextfield(views::Textfield* textfield,
  ...
  bool move_focus_reverse = base::i18n::IsRTL()
  ...
  bool text_rtl = textfield->GetTextDirection() == base::i18n::RIGHT_TO_LEFT;
  bool cursor_at_beginning = textfield->GetCursorPosition() == 0;
  bool move_cursor_reverse =
