...
const base::Feature kEnableAnswerCardDefaultOff{"EnableAnswerCard",
                                      base::FEATURE_DISABLED_BY_DEFAULT};
const base::Feature kEnableAnswerCardDefaultOn{"EnableAnswerCard",
...
bool IsAnswerCardEnabled() {
  static const bool enabled = base::FeatureList::IsEnabled(
      IsDeviceEve() ? kEnableAnswerCardDefaultOn : kEnableAnswerCardDefaultOff);
  return enabled;
}
...
bool IsPlayStoreAppSearchEnabled() {
  ...
  return base::FeatureList::IsEnabled(
      IsDeviceEve() ? kEnablePlayStoreAppSearchDefaultOn : kEnablePlayStoreAppSearchDefaultOff);
}

std::string AnswerServerUrl() {
  const std::string experiment_url =
      base::GetFieldTrialParamValueByFeature(kEnableAnswerCardDefaultOn, "ServerUrl");
...
std::string AnswerServerQuerySuffix() {
  return base::GetFieldTrialParamValueByFeature(kEnableAnswerCardDefaultOff,
                                                "QuerySuffix");
}
