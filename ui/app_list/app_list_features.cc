...
const base::Feature& GetAnswerCardFeature() {
    return IsDeviceEve() ? kEnableAnswerCardDefaultOn : kEnableAnswerCardDefaultOff;
}

const base::Feature& GetPlaystoreAppSearchFeature() {
    return IsDeviceEve() ? kEnablePlayStoreAppSearchDefaultOn : kEnablePlayStoreAppSearchDefaultOff;
}
