...
// Subclass of search_box::SearchBoxView. SearchBoxModel is its data model that
// controls what icon to display, what placeholder text to use for Textfield.
// The text and selection model part could be set to change the contents and
// selection model of the Textfield.
class APP_LIST_EXPORT SearchBoxView : public search_box::SearchBoxView,
 ...
 public:
  ...
  // Overridden from search_box::SearchBoxView:
  void SetBackButton() override;
  void SetCloseButton() override;
  void ModelChanged() override;
  void ClearSearch() override;
  void HandleSearchBoxEvent(ui::LocatedEvent* located_event) override;
  views::View* GetSelectedViewInContentsView() const override;
