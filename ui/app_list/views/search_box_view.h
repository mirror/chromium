...
class APP_LIST_EXPORT SearchBoxView : public views::View,
 ...
 public:
  ...
  // Updates the opacity of the searchbox, which is based on the distance
  // between centroid of the search box bounds and |baseline|.
  float UpdateOpacity(int baseline, bool is_end_gesture);
