...
void AppsContainerView::Layout() {
  ...
  switch (show_state_) {
    ...
    case SHOW_ACTIVE_FOLDER: {
      if (is_fullscreen_app_list_enabled_) {
        gfx::Rect item_bounds_in_container =
            apps_grid_view_->ConvertRectToParent(
        ...
        folder_bounds_in_container +=
            (item_bounds_in_container.CenterPoint() -
  ...
  if (is_fullscreen_app_list_enabled_) {
    switch (show_state_) {
      case SHOW_APPS:
        ...
        apps_grid_view_->SetAllTilesEnabled(true);
        ...
        break;
      case SHOW_ACTIVE_FOLDER:
        apps_grid_view_->SetAllTilesEnabled(false);
