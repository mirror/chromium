...
gfx::Rect AppsContainerView::DraggingLayout(AppListModel::State state,
  ...
  apps_grid_view_->DraggingLayout(height_above_screen, screen_bottom,
                                  is_end_gesture, search_box_opacity);
