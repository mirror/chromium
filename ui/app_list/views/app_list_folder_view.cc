...
class TopIconAnimation : public AppListFolderView::Animation,
 ...
 public:
  ...
  ~TopIconAnimation() override { top_icon_views_.clear(); }
...
bool AppListFolderView::IsAnimationRunning() const {
  return (background_animation_ && background_animation_->is_animating()) ||
         (folder_item_title_animation_ &&
          folder_item_title_animation_->is_animating()) ||
         (top_icon_animation_ && top_icon_animation_->IsAnimationRunning()) ||
         (contents_container_animation_ &&
          contents_container_animation_->IsAnimationRunning());
}
