...
PageSwitcherFullscreen::PageSwitcherFullscreen(PaginationModel* model,
                                               bool vertical)
...
PageSwitcherFullscreen::~PageSwitcherFullscreen() {
  if (model_)
    model_->RemoveObserver(this);
}

gfx::Size PageSwitcherFullscreen::CalculatePreferredSize() const {
...
void PageSwitcherFullscreen::Layout() {
  gfx::Rect rect(GetContentsBounds());
...
void PageSwitcherFullscreen::ButtonPressed(views::Button* sender,
...
void PageSwitcherFullscreen::TotalPagesChanged() {
  if (!model_)
    return;
...
void PageSwitcherFullscreen::SelectedPageChanged(int old_selected,
                                                 int new_selected) {
...
void PageSwitcherFullscreen::TransitionStarted() {}

void PageSwitcherFullscreen::TransitionChanged() {}

void PageSwitcherFullscreen::TransitionEnded() {}
