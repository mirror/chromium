...
void AppListItemView::OnGetContextMenuModel(
  ...
  ash::menu_utils::GetMenuItemsFromMojo(context_menu_model_.get(), this, menu,
                                        &sub_context_menu_items_);
...
void AppListItemView::ShowContextMenuForView(views::View* source,
  ...
  delegate_->GetContextMenuModel(
      item_weak_->id(),
      base::BindOnce(&AppListItemView::OnGetContextMenuModel,
