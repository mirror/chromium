...
void SearchResultTileItemView::GetAccessibleNodeData(
  ...
  // Specify |ui::AX_ATTR_DESCRIPTION| with an empty string, so that
  // long truncated names are not read twice.
  ...
  //   |AXNodeData|, |AXViewObjWrapper::Serialize| use the tooltip text as
  //   its description.
  // - We're customizing this view's accessible name and when it get focused,
