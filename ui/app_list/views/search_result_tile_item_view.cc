...
void SearchResultTileItemView::GetAccessibleNodeData(
  ...
  // Specify |ax::mojom::StringAttribute::DESCRIPTION| with an empty string, so that long
  ...
  // - If a view doesn't have |ax::mojom::StringAttribute::DESCRIPTION| defined in the
  ...
  node_data->AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION, "");
}
