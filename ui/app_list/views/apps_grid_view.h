...
class APP_LIST_EXPORT AppsGridView : public views::View,
 ...
 public:
  ...
  // dragging. The ratio is between the Y distance from apps grid view to the
  // top of app list and the current height of app list.
  static constexpr float kInsetYChangeRatioDuringDragging = 0.3f;
