...
class APP_LIST_EXPORT AppsGridView : public views::View,
 ...
 public:
  ...
  SuggestionsContainerView* suggestions_container_view() const {
 ...
 private:
  ...
  // Create indicator based on the indicator text message id.
  IndicatorChipView* CreateIndicator(int indicator_text_message_id);

  // Update suggestions from app list model.
  void UpdateSuggestions();

  // Helper method for layouting |indicator| based on the given bounds |rect|.
  void LayoutIndicator(IndicatorChipView* indicator, gfx::Rect* rect);
