...
class APP_LIST_EXPORT AppListItemView : public views::CustomButton,
 ...
 private:
  ...
  base::OneShotTimer touch_long_press_timer_;
  
  base::TimeTicks et_gesture_tap_down_start_;
  base::TimeTicks et_gesture_long_press_start_;
