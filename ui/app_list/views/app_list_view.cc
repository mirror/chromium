...
AppsContainerView* AppListView::GetAppsContainerView() const {
  return app_list_main_view_->contents_view()->apps_container_view();
}

AppsGridView* AppListView::GetRootAppsGridView() const {
  return GetAppsContainerView()->apps_grid_view();
}

AppsGridView* AppListView::GetFolderAppsGridView() const {
