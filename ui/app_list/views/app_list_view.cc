...
void AppListView::EndDrag(const gfx::Point& location) {
  ...
  DraggingLayout(kAppListOpacity, true /* is_end_gesture */,
...
void AppListView::UpdateYPositionAndOpacity(int y_position_in_screen,
  ...
  DraggingLayout(background_opacity, is_end_gesture, y_position_in_screen);
}
...
void AppListView::DraggingLayout(float background_opacity,
                                 bool is_end_gesture,
  ...
  app_list_main_view_->contents_view()->DraggingLayout(
