...
TEST_F(AppListViewFullscreenTest, SearchBoxCornerRadiusDuringDragging) {
  ...
  // Sends SCROLL_START and SCROLL_UPDATE events, simulating to drag the
  // launcher.
  ...
  ASSERT_EQ(search_box_view()->GetSearchBoxBorderCornerRadiusForState(
