...
void SearchBoxView::WallpaperProminentColorsChanged() {
  ...
  const SkColor color_for_mixing = SkColorSetA(SK_ColorWHITE, 0xB3);
  const SkColor light_vibrant_mixed =
      color_utils::AlphaBlend(light_vibrant, color_for_mixing, 0x80);
