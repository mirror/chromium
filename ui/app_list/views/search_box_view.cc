...
bool SearchBoxView::MoveArrowFocus(const ui::KeyEvent& event) {
  ...
  // Arrow left and right should work in the same way as SHIFT+TAB and TAB.
  ...
  bool move_up = event.key_code() == ui::VKEY_UP;
...
bool SearchBoxView::IsArrowKey(const ui::KeyEvent& event) const {
