...
SearchBoxView::SearchBoxView(search_box::SearchBoxViewDelegate* delegate,
    ...
    : search_box::SearchBoxView(delegate),
...
void SearchBoxView::SetBackButton() {
...
void SearchBoxView::SetCloseButton() {
...
void SearchBoxView::ClearSearch() {
  search_box::SearchBoxView::ClearSearch();
...
void SearchBoxView::HandleSearchBoxEvent(ui::LocatedEvent* located_event) {
  ...
  search_box::SearchBoxView::HandleSearchBoxEvent(located_event);
}
...
void SearchBoxView::UpdateOpacity() {
  ...
  views::View* view = contents_view();
  ContentsView* contents_view = static_cast<ContentsView*>(view);
...
void SearchBoxView::ContentsChanged(views::Textfield* sender,
  ...
  search_box::SearchBoxView::ContentsChanged(sender, new_contents);
...
bool SearchBoxView::HandleMouseEvent(views::Textfield* sender,
  ...
  return search_box::SearchBoxView::HandleMouseEvent(sender, mouse_event);
}
