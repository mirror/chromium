...
void SearchBoxView::UpdateBackgroundColor(SkColor color) {
  search_box_background()->set_color(color);
...
void SearchBoxView::UpdateBackground(double progress,
  ...
  search_box_background()->set_corner_radius(gfx::Tween::LinearIntValueBetween(
...
SearchBoxBackground* SearchBoxView::search_box_background() const {
