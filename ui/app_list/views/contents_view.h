...
class APP_LIST_EXPORT ContentsView : public views::View,
 ...
 public:
  ...
  gfx::Rect GetSearchBoxBoundsForState(ash::mojom::AppListState state) const;
 ...
 private:
  ...
  int AddLauncherPage(AppListPage* view, ash::mojom::AppListState state);
  ...
  std::map<ash::mojom::AppListState, int> state_to_view_;

  // Maps |view_model_| indices onto State.
  std::map<int, ash::mojom::AppListState> view_to_state_;
