...
class SearchResultPageViewTest : public views::ViewsTestBase,
 ...
 public:
  ...
  void SetUp() override {
    ...
    if (test_with_fullscreen_) {
      if (test_with_answer_card_) {
        enabled_features = {features::kEnableFullscreenAppList,
                            features::kEnableAnswerCard};
        disabled_features = {};
      } else {
        enabled_features = {features::kEnableFullscreenAppList};
        disabled_features = {features::kEnableAnswerCard};
      }
    } else {
      if (test_with_answer_card_) {
        enabled_features = {features::kEnableAnswerCard};
        disabled_features = {features::kEnableFullscreenAppList};
      } else {
        enabled_features = {};
        disabled_features = {features::kEnableFullscreenAppList,
                             features::kEnableAnswerCard};
    ...
    EXPECT_EQ(test_with_fullscreen_, features::IsFullscreenAppListEnabled());
    EXPECT_EQ(test_with_answer_card_, features::IsAnswerCardEnabled());
 ...
 protected:
  ...
  bool test_with_answer_card() const { return test_with_answer_card_; }
 ...
 private:
  ...
  bool test_with_answer_card_ = true;
...
TEST_P(SearchResultPageViewTest, UpdateWithSelection) {
  const int kCardResultNum = test_with_answer_card_result();
  {
    std::vector<std::pair<SearchResult::DisplayType, int>> result_types;
