...
// Padding offset required to make visual 2px padding due to the fact that all
// apps tile has 6px top padding.
constexpr int kAllAppsIndicatorPaddingOffset = 4;
...
int AppsGridView::GetHeightOnTopOfAllAppsTiles(int page) const {
  ...
  if (page == 0) {
    ...
    return kSearchBoxFullscreenBottomPadding +
           ...
           kAllAppsIndicatorPaddingOffset;
  }
