...
// Bottom padding of all apps indicator, set to -4px due to 6px top padding of
// app tile to make final 2px visual padding.
constexpr int kAllAppsIndicatorBottomPadding = -4;
