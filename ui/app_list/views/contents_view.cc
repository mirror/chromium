...
void ContentsView::DraggingLayout(int app_list_y_position_in_screen,
  ...
  for (AppListPage* page : app_list_pages_) {
    is_for_dragging
        ? page->SetBoundsRect(page->DraggingLayout(
...
void ContentsView::Layout() {
  DraggingLayout(0, 0, false /* is_end_gesture */, false /*is_for_dragging*/);
}
