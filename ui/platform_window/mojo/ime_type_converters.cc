...
#define TEXT_INPUT_TYPE_ASSERT(NAME)                                          \
  static_assert(static_cast<int32_t>(ui::text::mojom::TextInputType::NAME) == \
...
#define TEXT_INPUT_FLAG_ASSERT(NAME)                                          \
  static_assert(static_cast<int32_t>(ui::text::mojom::TextInputFlag::NAME) == \
...
// static
ui::text::mojom::TextInputType
TypeConverter<ui::text::mojom::TextInputType, ui::TextInputType>::Convert(
    const ui::TextInputType& input) {
  return static_cast<ui::text::mojom::TextInputType>(input);
}

// static
ui::TextInputType
TypeConverter<ui::TextInputType, ui::text::mojom::TextInputType>::Convert(
    const ui::text::mojom::TextInputType& input) {
  return static_cast<ui::TextInputType>(input);
}

// static
ui::TextInputState
TypeConverter<ui::TextInputState, ui::text::mojom::TextInputStatePtr>::Convert(
