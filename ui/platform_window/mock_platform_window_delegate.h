...
#ifndef UI_PLATFORM_WINDOW_MOCK_PLATFORM_WINDOW_DELEGATE_H_
#define UI_PLATFORM_WINDOW_MOCK_PLATFORM_WINDOW_DELEGATE_H_
...
#endif  // UI_PLATFORM_WINDOW_MOCK_PLATFORM_WINDOW_DELEGATE_H_
