...
#if XFIXES_MAJOR >= 5
  // Shrink the barrier so the user can escape from the corners. Ozone X11 is
  // used for developers so it's useful to be able to move outside the window.
  constexpr int kBarrierShrinkSize = 10;
