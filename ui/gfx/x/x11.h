...
extern "C" {
// Xlib.h defines base types so it must be defined before the
#include <X11/Xlib.h>

// TODO(bratell): ui/gl headers sometimes indirectly include XLib and
// then undef Bool and then the include above did nothing and Bool
// will be missing for the rest of the includes. This will be fixed
// when ui/gl uses ui/gfx/x/x11.h (this file) but it's not 100%
// trivial.
#define Bool int

// And the rest so that nobody need to include them manually...
#include <X11/Xatom.h>
