...
void ParamTraits<gfx::GpuMemoryBufferHandle::MailboxName>::Write(base::Pickle* m, const param_type& p) {
  m->WriteBytes(&p, sizeof(p));
}

bool ParamTraits<gfx::GpuMemoryBufferHandle::MailboxName>::Read(const base::Pickle* m,
                                     base::PickleIterator* iter,
                                     param_type* p) {
...
void ParamTraits<gfx::GpuMemoryBufferHandle::MailboxName>::Log(const param_type& p, std::string* l) {
