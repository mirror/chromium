...
bool LoadCloudStorageSyncedFontIntoFontConfig(const std::string& fontfilename) {
  ...
  content_shell_test_fonts_path = content_shell_test_fonts_path.Append(
      FILE_PATH_LITERAL("content_shell_test_fonts/"));
  base::FilePath font_file_path(content_shell_test_fonts_path);
  font_file_path =
      content_shell_test_fonts_path.Append(FILE_PATH_LITERAL(fontfilename));
