...
TEST(ColorSpace, ToSkColorSpace) {
  ...
  primary_matrix.set3x3(0.205276, 0.149185, 0.609741, 0.625671, 0.063217,
                        0.311111, 0.060867, 0.744553, 0.019470);
  SkColorSpaceTransferFn transfer_fn = {2.100000, 1.000000, 0.000000, 0.000000,
