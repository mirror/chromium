  ...
  static gfx::mojom::BufferUsage ToMojom(gfx::BufferUsage usage) {
    switch (usage) {
      ...
      case gfx::BufferUsage::CAMERA_WRITE_CPU_READ_WRITE:
        return gfx::mojom::BufferUsage::CAMERA_WRITE_CPU_READ_WRITE;
    }
    NOTREACHED();
    ...
    switch (input) {
      ...
      case gfx::mojom::BufferUsage::GPU_READ_CPU_READ_WRITE_PERSISTENT:
        *out = gfx::BufferUsage::GPU_READ_CPU_READ_WRITE_PERSISTENT;
        return true;
      case gfx::mojom::BufferUsage::CAMERA_WRITE_CPU_READ_WRITE:
        *out = gfx::BufferUsage::CAMERA_WRITE_CPU_READ_WRITE;
        return true;
    }
    NOTREACHED();
    return false;
