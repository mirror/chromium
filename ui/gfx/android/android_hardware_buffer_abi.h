...
#ifndef UI_GFX_ANDROID_ANDROID_HARDWARE_BUFFER_ABI_H_
#define UI_GFX_ANDROID_ANDROID_HARDWARE_BUFFER_ABI_H_
...
// Minimal binary interface definitions based on
// include/android/hardware_buffer.h from the Android NDK for platform level
// 26+. This is only intended for use from the ScopedAndroidHardwareBuffer
...
// These are usable as global "C" linkage functions.
extern PFAHardwareBuffer_allocate AHardwareBuffer_allocate;
extern PFAHardwareBuffer_acquire AHardwareBuffer_acquire;
extern PFAHardwareBuffer_describe AHardwareBuffer_describe;
extern PFAHardwareBuffer_sendHandleToUnixSocket AHardwareBuffer_sendHandleToUnixSocket;
extern PFAHardwareBuffer_recvHandleFromUnixSocket
    AHardwareBuffer_recvHandleFromUnixSocket;
extern PFAHardwareBuffer_release AHardwareBuffer_release;

}  // extern "C"

#endif  // UI_GFX_ANDROID_ANDROID_HARDWARE_BUFFER_ABI_H_
