...
// The character used for displaying obscured text. Use a bullet character.
  ...
  // On ChromeOS' system font the bullet operator glyph looks better.
  // TODO(pbos): Consider replacing the font glyph with a vector glyph.
  static constexpr base::char16 kPasswordReplacementChar = 0x2219;
#else
