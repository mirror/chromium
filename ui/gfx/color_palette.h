...
constexpr SkColor kGoogleBlue300 = SkColorSetRGB(0x7B, 0xAA, 0xF7);  // TODO
...
constexpr SkColor kGoogleRed300 = SkColorSetRGB(0xE6, 0x7C, 0x73);  // TODO
...
constexpr SkColor kGoogleGreen300 = SkColorSetRGB(0x57, 0xBB, 0x8A);  // TODO
constexpr SkColor kGoogleGreen700 = SkColorSetRGB(0x18, 0x80, 0x38);
constexpr SkColor kGoogleYellow300 = SkColorSetRGB(0xF7, 0xCB, 0x4D);  // TODO
