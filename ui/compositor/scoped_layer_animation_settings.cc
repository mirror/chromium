...
class ScopedLayerAnimationObserver : public ui::ImplicitAnimationObserver,
 ...
 public:
  ...
  void OnImplicitAnimationsCompleted() override {
    ...
    // trait applied on the layer and remove |this| from the |layer_|
  ...
  void LayerDestroyed(ui::Layer* layer) override {
    ...
    // layer to keep being applied the trait until the animation has finished.
    // We will defer deleting |this| until the animation finishes.
    layer_->RemoveObserver(this);
    layer_ = nullptr;
  }
