...
class COMPOSITOR_EXPORT ContextFactoryPrivate {
 public:
  ...
  // Sets the color matrix used to transform the output colors of the device
  // this compositor is being displayed on.
...
class COMPOSITOR_EXPORT Compositor : public cc::LayerTreeHostClient,
 ...
 public:
  ...
  // Gets and sets the color matrix used to transform the output colors of the
  // device this compositor is being displayed on.
