...
class TestFocusObserver : public exo::WMHelper::FocusObserver {
 public:
  TestFocusObserver() = default;
  ~TestFocusObserver() override = default;
  ...
  aura::Window* focused_window() const { return focused_window_; }

 private:
  aura::Window* focused_window_ = nullptr;

  DISALLOW_COPY_AND_ASSIGN(TestFocusObserver);
};
...
class ArcNotificationContentViewTest : public ash::AshTestBase {
 public:
  ...
  void SetUp() override {
    ...
    exo::WMHelper::GetInstance()->AddFocusObserver(&focus_observer_);
  ...
  void TearDown() override {
    ...
    exo::WMHelper::GetInstance()->RemoveFocusObserver(&focus_observer_);
    DCHECK(exo::WMHelper::HasInstance());
  ...
  aura::Window* GetFocusedWindow() const {
    return focus_observer_.focused_window();
  }
 ...
 private:
  ...
  TestFocusObserver focus_observer_;
...
TEST_F(ArcNotificationContentViewTest, AcceptInputTextWithActivate) {
  ...
  std::unique_ptr<exo::Keyboard> keyboard(new exo::Keyboard(&delegate));
...
TEST_F(ArcNotificationContentViewTest, TraversalFocusReverseByTab) {
