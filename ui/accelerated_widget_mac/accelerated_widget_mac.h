...
class ACCELERATED_WIDGET_MAC_EXPORT AcceleratedWidgetMac
 ...
 private:
  // For ui::CALayerEmbedder::FromAcceleratedWidget to access Get.
  friend class ui::CALayerEmbedder;
  ...
  // gfx::CALayerEmbedder implementation:
