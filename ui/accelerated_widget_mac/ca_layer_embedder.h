...
#ifndef UI_ACCELERATED_WIDGET_MAC_CA_LAYER_EMBEDDER_H_
#define UI_ACCELERATED_WIDGET_MAC_CA_LAYER_EMBEDDER_H_
...
// in its heirarchy.
class ACCELERATED_WIDGET_MAC_EXPORT CALayerEmbedder {
 public:
  // Translate from a gfx::AcceleratedWidget to the gfx::CALayerEmbedder
  // interface through which frames may be submitted. This may return nullptr.
  static CALayerEmbedder* FromAcceleratedWidget(gfx::AcceleratedWidget widget);
...
#endif  // UI_ACCELERATED_WIDGET_MAC_CA_LAYER_EMBEDDER_H_
