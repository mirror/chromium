...
{ 'return_type': 'void',
  ...
  'arguments': 'void', },
{ 'return_type': 'void',
  'versions': [{ 'name': 'glErrorCallbackANGLE',
                 'extensions': ['GL_ANGLE_error_callback'] }],
  'arguments': 'GLERRORCALLBACKPROCANGLE callback, const void* userParam', },
{ 'return_type': 'GLsync',
