...
// GL_CHROMIUM_resize
#define GL_COLOR_SPACE_UNSPECIFIED_CHROMIUM 0x8AF0
#define GL_COLOR_SPACE_SCRGB_LINEAR_CHROMIUM 0x8AF1
#define GL_COLOR_SPACE_SRGB_CHROMIUM 0x8AF2
#define GL_COLOR_SPACE_DISPLAY_P3_CHROMIUM 0x8AF3
