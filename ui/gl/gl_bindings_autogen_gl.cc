...
__attribute__((no_sanitize("cfi-icall"))) void
GLApiBase::glGetMultisamplefvFn(GLenum pname, GLuint index, GLfloat* val) {
...
__attribute__((no_sanitize("cfi-icall"))) void GLApiBase::glPolygonModeFn(
    GLenum face,
    GLenum mode) {
...
__attribute__((no_sanitize("cfi-icall"))) void
GLApiBase::glTexBufferFn(GLenum target, GLenum internalformat, GLuint buffer) {
  driver_->fn.glTexBufferFn(target, internalformat, buffer);
}

__attribute__((no_sanitize("cfi-icall"))) void GLApiBase::glTexBufferRangeFn(
    GLenum target,
    GLenum internalformat,
    GLuint buffer,
    GLintptr offset,
...
__attribute__((no_sanitize("cfi-icall"))) void
GLApiBase::glWindowRectanglesEXTFn(GLenum mode, GLsizei n, const GLint* box) {
