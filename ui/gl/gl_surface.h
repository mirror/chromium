...
class GL_EXPORT GLSurface : public base::RefCounted<GLSurface> {
 public:
  ...
  // Indicate a color space to set before the first call to Resize, to avoid
  // unnecessarily recreating resources.
  virtual void SetInitialColorSpace(gl::GLSurface::ColorSpace color_space);
