...
bool NativeViewGLSurfaceEGL::Initialize(GLSurfaceFormat format) {
  ...
  switch (format_.GetColorSpace()) {
    ...
    case GLSurfaceFormat::COLOR_SPACE_DISPLAY_P3:
      ...
      //   EGL_GL_COLORSPACE_SRGB_KHR is to EGL_GL_COLORSPACE_LINEAR_KHR
      // as
      //   EGL_GL_COLORSPACE_DISPLAY_P3_EXT is to
      //       EGL_GL_COLORSPACE_DISPLAY_P3_LINEAR_EXT
      // In particular, EGL_GL_COLORSPACE_DISPLAY_P3_EXT is equivalent to
      // EGL_GL_COLORSPACE_LINEAR_KHR, except with the P3 gamut instead of the
      // the sRGB gamut.
