 ...
 public:
  ...
  scoped_refptr<GLImage> CreateSolidColorImage(const gfx::Size& size,
    ...
    if (format == gfx::BufferFormat::RGBA_8888) {
      ...
      // nVidia drivers swap B and R channels when reading pixels from a drwan
      // GL_RGB10_A2 texture, so unswizzle the values here for test purposes,
      // see https://crbug.com/803473.
