...
WM_EXPORT void SetActivationClient(aura::Window* root_window,
                                   ActivationClient* client);
WM_EXPORT ActivationClient* GetActivationClient(aura::Window* root_window);
WM_EXPORT const ActivationClient* GetActivationClient(
...
WM_EXPORT void SetHideOnDeactivate(aura::Window* window,
                                   bool hide_on_deactivate);
WM_EXPORT bool GetHideOnDeactivate(aura::Window* window);
