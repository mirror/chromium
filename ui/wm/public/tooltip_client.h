...
WM_EXPORT void SetTooltipClient(aura::Window* root_window,
                                TooltipClient* client);
WM_EXPORT TooltipClient* GetTooltipClient(aura::Window* root_window);
...
WM_EXPORT void SetTooltipText(aura::Window* window,
                              base::string16* tooltip_text);
WM_EXPORT void SetTooltipId(aura::Window* window, void* id);
WM_EXPORT const base::string16 GetTooltipText(aura::Window* window);
WM_EXPORT const void* GetTooltipId(aura::Window* window);

WM_EXPORT extern const aura::WindowProperty<void*>* const kTooltipIdKey;
WM_EXPORT extern const aura::WindowProperty<base::string16*>* const
    kTooltipTextKey;
