...
Polymer({
  ...
  /**
   * Connects to a bluetooth device. May be called while the dialog is closed,
   * in which case this will complete without opening the dialogn, unless there
   * is an error, in which case the dialog will be opened to show the error.
