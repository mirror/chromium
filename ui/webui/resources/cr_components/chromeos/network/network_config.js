...
Polymer({
  ...
  properties: {
    ...
    eapOuterItems_: {
      type: Array,
      readOnly: true,
      computed: 'computeEapOuterItems_(shareAllowEnable, shareDefault)',
    },
   ...
   * @private
   */
  computeEapOuterItems_: function(shareAllowEnable, shareDefault) {
    if (!shareAllowEnable && shareDefault) {
