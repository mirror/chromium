...
Polymer({
  ...
  properties: {
    ...
    /**
     * True if the user configuring the network is a guest, or no user is
     * logged in.
     */
    isGuest: {
      type: Boolean,
  ...
  computeEapOuterItems_: function() {
    if (this.isGuest) {
      // Hide the TLS option when not logged in since user certs are not
      // available and are required for TLS.
