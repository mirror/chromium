...
var CrPolicyIndicatorBehavior = {
  ...
  properties: {
    ...
    indicatorTooltip: {
      type: String,
      computed:
          'getIndicatorTooltip(indicatorType, indicatorSourceName, tooltipText)',
    },
  ...
  getIndicatorIcon_: function(type) {
    switch (type) {
      ...
      case CrPolicyIndicatorType.SUPERVISED_USER_CUSTODIAN:
        ...
        // TODO(scottchen): Commenting out the below check for now. Uncomment
        // once
        //     we pull this fix: https://github.com/Polymer/polymer/issues/2712
        // default:
        //   assertNotReached();
    }
  },
