...
constexpr int kAnimationDurationMs = 10000;
...
KeyboardController::~KeyboardController() {
  if (container_) {
    DCHECK(state_ != keyboard::KeyboardControllerState::SHOWN &&
           state_ != keyboard::KeyboardControllerState::SHOWING &&
           state_ != keyboard::KeyboardControllerState::WILL_HIDE &&
           state_ != keyboard::KeyboardControllerState::HIDING);
