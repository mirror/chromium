...
class KEYBOARD_EXPORT KeyboardController : public ui::InputMethodObserver,
 ...
 public:
  ...
  KeyboardControllerState GetStateForTest() { return state_; }
 ...
 private:
  ...
  // Checks validity of the state transition. Called from ChangeState.
  void CheckStateTransition(KeyboardControllerState prev,
                            KeyboardControllerState next);
  // Changes the current state with checking validity of the transition..
