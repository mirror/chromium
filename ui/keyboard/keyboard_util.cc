...
bool UpdateKeyboardConfig(const KeyboardConfig& keyboard_config) {
  LOG(ERROR) << "keyboard::UpdateKeyboardConfig: "
             << "auto_correct: " << keyboard_config.auto_correct
             << "voice_input: " << keyboard_config.voice_input;
  LOG(ERROR) << ">>> " << base::debug::StackTrace(15).ToString() << " <<<";
...
KeyboardConfig GetKeyboardConfig() {
  LOG(ERROR) << "GetKeyboardConfig";
  LOG(ERROR) << "keyboard::GetKeyboardConfig: "
             << "auto_correct: " << g_keyboard_config.auto_correct
             << "voice_input: " << g_keyboard_config.voice_input;
  LOG(ERROR) << ">>> " << base::debug::StackTrace(15).ToString() << " <<<";
