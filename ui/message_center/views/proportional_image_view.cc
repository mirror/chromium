...
void ProportionalImageView::SetImage(const gfx::ImageSkia& image,
  ...
  switch (type_) {
    case Type::FIT_WIDTH: {
      gfx::Rect crop_rect;
      gfx::Size draw_size;
      CalcCropRectAndDrawSize(max_image_size_, &crop_rect, &draw_size);
...
void ProportionalImageView::OnPaint(gfx::Canvas* canvas) {
  ...
  gfx::Rect crop_rect;
  gfx::Size draw_size;
  CalcCropRectAndDrawSize(GetContentsBounds().size(), &crop_rect, &draw_size);
...
void ProportionalImageView::CalcCropRectAndDrawSize(
