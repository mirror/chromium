...
void MESSAGE_CENTER_PUBLIC_EXPORT
RegisterVectorIcon(const gfx::VectorIcon& vector_icon);

const gfx::VectorIcon* MESSAGE_CENTER_PUBLIC_EXPORT
GetRegisteredVectorIcon(const std::string& id);
