...
const SkColor kSystemNotificationColorNormal = gfx::kGoogleBlue700;
const SkColor kSystemNotificationColorWarning = gfx::kGoogleYellow900;
const SkColor kSystemNotificationColorCriticalWarning = gfx::kGoogleRed700;
