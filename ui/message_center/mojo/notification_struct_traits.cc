...
typedef StructTraits<RichNotificationDataDataView, RichNotificationData>
    RichNotificationDataStructTraits;
typedef StructTraits<NotificationDataView, Notification>
    NotificationStructTraits;
