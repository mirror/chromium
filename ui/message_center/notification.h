...
struct MESSAGE_CENTER_EXPORT ButtonInfo {
  ...
  // Icon that should be displayed on the notification button. Optional. May be
  // altered with a mask to match the visual requirements of the notification.
  gfx::Image icon;
...
class MESSAGE_CENTER_EXPORT RichNotificationData {
 public:
  ...
  // an odd number of entries in this pattern when it's set: number of
  // milliseconds to vibrate separated by number of milliseconds to pause.
...
class MESSAGE_CENTER_EXPORT Notification {
 public:
  ...
  // |optional_fields|: Optional, rich data that can be used to assign more
  //                    elaborate features to notifications.
