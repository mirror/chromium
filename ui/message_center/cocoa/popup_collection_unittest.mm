...
class PopupCollectionTest : public ui::CocoaTest {
 public:
  ...
  bool CheckSpacingBetween(MCPopupController* upper, MCPopupController* lower) {
    ...
    EXPECT_EQ(message_center::kMarginBetweenItemsWithShadow, delta);
    return delta == message_center::kMarginBetweenItemsWithShadow;
  }
...
TEST_F(PopupCollectionTest, LayoutSpacing) {
  ...
  EXPECT_EQ(message_center::kMarginBetweenItemsWithShadow,
