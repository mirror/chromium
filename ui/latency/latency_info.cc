...
#define CASE_TYPE(t) case ui::t:  return #t
  switch (type) {
    ...
    CASE_TYPE(DISPLAY_EVENT_REQUESTED_PRESENT);
    CASE_TYPE(DISPLAY_EVENT_RENDERING_COMPLETE);
    CASE_TYPE(DISPLAY_EVENT_COMPOSITION_LATCH);
    CASE_TYPE(DISPLAY_EVENT_FIRST_COMPOSITION_START);
    CASE_TYPE(DISPLAY_EVENT_LAST_COMPOSITION_START);
    CASE_TYPE(DISPLAY_EVENT_FIRST_COMPOSITION_GPU_FINISHED);
    CASE_TYPE(DISPLAY_EVENT_DISPLAY_PRESENT);
    CASE_TYPE(DISPLAY_EVENT_DEQUEUE_READY);
    CASE_TYPE(DISPLAY_EVENT_READS_DONE);
