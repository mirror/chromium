...
class LatencyTracker {
 ...
 private:
  ...
  // The i'th member of this array has keeps the sampling rate for the i'th
  // input metric event. Initializing SamplingScheme with number X means that
  // from every X events one will be reported. Note that the first event to
  // report is also randomized.
