...
#ifndef UI_CHROMEOS_KSV_KEYBOARD_SHORTCUT_VIEWER_EXPORT_H_
#define UI_CHROMEOS_KSV_KEYBOARD_SHORTCUT_VIEWER_EXPORT_H_
...
#endif  // UI_CHROMEOS_KSV_KEYBOARD_SHORTCUT_VIEWER_EXPORT_H_
