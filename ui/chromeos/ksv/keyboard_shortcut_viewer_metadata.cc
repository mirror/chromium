...
// Provides I18n string for a given |key_code| without a mapping to a meaningful
// description or a |key_code| requiring special description. For example,
...
base::string16 GetStringForKeyboardCode(ui::KeyboardCode key_code) {
  base::Optional<base::string16> key_label;
  if ((key_label = GetSpecialStringForKeyboardCode(key_code)))
