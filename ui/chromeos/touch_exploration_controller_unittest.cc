...
class MockTouchExplorationControllerDelegate
 ...
 private:
  ...
  ax::mojom::Gesture last_gesture_ = ax::mojom::Gesture::NONE;
};
...
TEST_F(TouchExplorationTest, DoubleTapTiming) {
  ...
  std::vector<ui::LocatedEvent*> captured_events = GetCapturedLocatedEvents();
  ASSERT_EQ(0U, captured_events.size());
  EXPECT_EQ(ax::mojom::Gesture::CLICK, delegate_.GetLastGesture());
}
...
TEST_F(TouchExplorationTest, GestureSwipe) {
  ...
  struct GestureInfo {
    ...
    ax::mojom::Gesture expected_gesture;
      ...
      {-1, 0, 1, ax::mojom::Gesture::SWIPE_LEFT_1},
      {0, -1, 1, ax::mojom::Gesture::SWIPE_UP_1},
      {1, 0, 1, ax::mojom::Gesture::SWIPE_RIGHT_1},
      {0, 1, 1, ax::mojom::Gesture::SWIPE_DOWN_1},
      {-1, 0, 2, ax::mojom::Gesture::SWIPE_LEFT_2},
      {0, -1, 2, ax::mojom::Gesture::SWIPE_UP_2},
      {1, 0, 2, ax::mojom::Gesture::SWIPE_RIGHT_2},
      {0, 1, 2, ax::mojom::Gesture::SWIPE_DOWN_2},
      {-1, 0, 3, ax::mojom::Gesture::SWIPE_LEFT_3},
      {0, -1, 3, ax::mojom::Gesture::SWIPE_UP_3},
      {1, 0, 3, ax::mojom::Gesture::SWIPE_RIGHT_3},
      {0, 1, 3, ax::mojom::Gesture::SWIPE_DOWN_3},
      {-1, 0, 4, ax::mojom::Gesture::SWIPE_LEFT_4},
      {0, -1, 4, ax::mojom::Gesture::SWIPE_UP_4},
      {1, 0, 4, ax::mojom::Gesture::SWIPE_RIGHT_4},
      {0, 1, 4, ax::mojom::Gesture::SWIPE_DOWN_4},
  };
...
TEST_F(TouchExplorationTest, TwoFingerTap) {
  ...
  ASSERT_EQ(ax::mojom::Gesture::TAP_2, delegate_.GetLastGesture());
}
