...
#ifndef UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_H_
#define UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_H_
...
class SEARCH_BOX_EXPORT SearchBoxView : public views::WidgetDelegateView,
 ...
 public:
  ...
  virtual void SetCloseButton() = 0;
  virtual void SetBackButton() = 0;
  ...
  virtual views::View* GetSelectedViewInContentsView() const;
...
#endif  // UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_H_
