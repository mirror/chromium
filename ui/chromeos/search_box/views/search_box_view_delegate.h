...
#ifndef UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_DELEGATE_H_
#define UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_DELEGATE_H_
...
#endif  // UI_CHOMEOS_SEARCH_BOX_VIEWS_SEARCH_BOX_VIEW_DELEGATE_H_
