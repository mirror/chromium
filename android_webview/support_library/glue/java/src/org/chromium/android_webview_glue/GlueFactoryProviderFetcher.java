...
public class GlueFactoryProviderFetcher {
    ...
    /**
     * Returns a duplicate version of {@param method} declared in the current classloader.
     */
    ...
    // TODO javadoc
    public static InvocationHandler createInvocationHandlerFor(final Object passedObject) {
        return new InvocationHandler() {
            @Override
            public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
                return dupeMethod(method).invoke(passedObject, objects);
            }
        };
    }
}
