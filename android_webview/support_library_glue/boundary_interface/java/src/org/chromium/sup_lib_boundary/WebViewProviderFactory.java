...
public interface WebViewProviderFactory {
    ...
    // here.
    InvocationHandler /* support_lib.WebViewProvider */ createWebView(
            Object /* android.webkit.WebViewProvider */ webviewProvider);

    // TODO could put this getter in a separate class - e.g. CompatFetcher.
    InvocationHandler getSupLibWebSettings(WebSettings webSettings);
}
