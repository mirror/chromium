...
public class AwVariationsUtils {
    ...
    public static void copyFileToVariationsDirectory(ParcelFileDescriptor fileDescriptor,
        ...
        try {
            ...
            tempFile.setWritable(false /* writable */, false /* ownerOnly */);
    ...
    public static class SeedPreference {
        ...
        // Dummy field so that calls to toArrayList and fromList won't fail the FIELD_COUNT check.
        public final String gzipDummy = "";
