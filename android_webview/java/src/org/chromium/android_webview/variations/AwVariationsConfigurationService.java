...
public class AwVariationsConfigurationService extends Service {
    ...
    // Protect the seed request handling logic from executing while a pending job is being
    // scheduled.
    ...
    private static void handleSeedTransfer(Message msg) {
        ...
        try {
            ...
            storeSeedPrefToFile(AwVariationsUtils.SeedPreference.fromList(seedPrefAsList),
                    webViewVariationsDir);
    ...
    private static void handleSeedRequest(Message msg) {
        ...
        try {
            synchronized (sScheduleLock) {
                File webViewVariationsDir = getOrCreateVariationsDirectory();
                if (AwVariationsUtils.isSeedExpired(webViewVariationsDir) && !pendingJobExists()) {
    ...
    public static void storeSeedDataToFile(byte[] seedData, File variationsDir) throws IOException {
        ...
        try {
            AwVariationsUtils.sSeedDataLock.writeLock().lock();
            ...
            AwVariationsUtils.sSeedDataLock.writeLock().unlock();
        }
    }
    ...
    public static void storeSeedPrefToFile(
        ...
        BufferedWriter writer = null;
        try {
            AwVariationsUtils.sSeedPrefLock.writeLock().lock();
            ...
            AwVariationsUtils.sSeedPrefLock.writeLock().unlock();
            AwVariationsUtils.closeStream(writer);
        }
    }
    ...
    public static File getOrCreateVariationsDirectory() throws IOException {
        ...
        File dir = new File(webViewFileDir, AwVariationsUtils.WEBVIEW_VARIATIONS_DIR);
