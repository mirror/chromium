...
public class AwVariationsConfigurationService extends Service {
    ...
    public static boolean sBoundBySeedHandler = false;
    ...
    private static class OnBindHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            // Check that this message is actually from the AwVariationsSeedFetchService.
            if (!sBoundBySeedHandler) {
                return;
            }
    ...
    private static void scheduleSeedFetchJob() {
        ...
        JobInfo.Builder builder =
                new JobInfo.Builder(TaskIds.WEBVIEW_VARIATIONS_SEED_FETCH_JOB_ID, componentName)
                        .setMinimumLatency(0) /* Specify that this job should be delayed by 0ms. */
                        .setOverrideDeadline(
                                0) /* Specify that this job should be run immediately. */
