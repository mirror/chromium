...
public class AwSafeBrowsingConfigHelper implements AwSafeBrowsingOptInPreferenceFetcher {
    ...
    public void maybeEnableSafeBrowsingFromManifest(final Context appContext) {
        ...
        AwSafeBrowsingApiHandler awSafeBrowsingApiHandler =
                PrivateFactory.createAwSafeBrowsingApiHandler();

        awSafeBrowsingApiHandler.getUserOptInPreference(appContext,
                (Callback<Boolean>)
