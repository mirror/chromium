...
public class AutofillActionModeCallback implements ActionMode.Callback {
    ...
    public AutofillActionModeCallback(Context context, AwContents awContents) {
        ...
        // TODO(michaelbai): Add autofill menu item to
        // content/public/android/java/res/menu/select_action_menu.xml, and use show/hide menu
        // item after sdk roll to Android O MR1.
    ...
    public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
        if (mAutofillMenuItemTitle != 0 && mAwContents.shouldQueryAutofillSuggestion()) {
