...
public final class AwCookieManager {
     ...
     * invokeBooleanCookieCallback to call CookieCallback#onResult which posts a Runnable
     * on the handler of the original thread which in turn calls Callback#onReceiveValue.
     */
