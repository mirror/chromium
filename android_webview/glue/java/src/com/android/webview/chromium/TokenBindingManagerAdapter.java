...
public class TokenBindingManagerAdapter extends TokenBindingService {
    ...
    public void getKey(Uri origin,
        ...
        mTokenBindingManager.getKey(origin, null, Converters.toAwValueCallback(newCallback));
    }
    ...
    public void deleteKey(Uri origin,
        ...
        startChromiumEngine();
        mTokenBindingManager.deleteKey(origin, Converters.toAwValueCallback(callback));
    }

    @Override
    public void deleteAllKeys(ValueCallback<Boolean> callback) {
        startChromiumEngine();
        mTokenBindingManager.deleteAllKeys(Converters.toAwValueCallback(callback));
    }
