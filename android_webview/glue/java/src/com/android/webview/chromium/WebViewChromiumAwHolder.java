...
class WebViewChromiumAwHolder {
    private static final String TAG = "WebViewChromiumAwHolder";

    private static final String HTTP_AUTH_DATABASE_FILE = "http_auth.db";

    // TODO store aw-objects instead of adapters here!
    ...
    // TODO we don't really need a WebViewChromiumFactoryProvider here (to pass to various adapters)
    // - what we need is something // to post tasks to, i.e. WebViewChromiumRunQueue.
    WebViewChromiumFactoryProvider mFactory;

    WebViewChromiumAwHolder(WebViewChromiumFactoryProvider factory, WebViewDelegate webViewDelegate) {
        mFactory = factory;
    ...
    /* package */ void ensureChromiumStartedLocked(boolean onMainThread) {
        ...
        if (ThreadUtils.runningOnUiThread()) {
            // TODO ensures startChromiumLocked is called through WebViewChromiumFactoryProviderForP.
            mFactory.startChromiumLocked();
            return;
        }
    ...
    AwBrowserContext getBrowserContextOnUiThread() {
        ...
        if (mBrowserContext == null) {
            mBrowserContext =
                    new AwBrowserContext(mFactory.mWebViewPrefs, ContextUtils.getApplicationContext());
        }
        return mBrowserContext;
    }

    // TODO I'm not sure how to deal with Statics - it's not represented by one specific Aw-class.
            ...
            if (mStaticMethods == null) {
                ...
                mStaticMethods = new WebViewFactoryProvider.Statics() {
                    ...
                    public void setWebContentsDebuggingEnabled(boolean enable) {
                        ...
                        if (!CommandLineUtil.isBuildDebuggable()) {
                            WebViewChromiumAwHolder.this.setWebContentsDebuggingEnabled(
                                    enable);
                        }
                    }
