...
final class Converters {
    ...
    public static org.chromium.android_webview.AwSettings.LayoutAlgorithm toAwLayoutAlgorithm(
    ...
    public static org.chromium.android_webview.AwConsoleMessage toAwConsoleMessage(
            android.webkit.ConsoleMessage value) {
        if (value == null) {
            return null;
        }
        return new org.chromium.android_webview.AwConsoleMessage(value.message(), value.sourceId(),
                value.lineNumber(), toAwMessageLevel(value.messageLevel()));
    }
    ...
    public static org.chromium.android_webview.AwConsoleMessage.MessageLevel toAwMessageLevel(
    ...
    public static android.webkit.ConsoleMessage.MessageLevel fromAwMessageLevel(
    ...
    public static org.chromium.android_webview.AwGeolocationPermissions.Callback
            toAwGeolocationPermissionsCallback(
    ...
    public static org.chromium.android_webview.AwContentsClient.CustomViewCallback
            toAwCustomViewCallback(final android.webkit.WebChromeClient.CustomViewCallback
                callback) {
        if (callback == null) {
            return null;
        }
    ...
    public static org.chromium.android_webview.AwContentsClient.FileChooserParams
            toAwCustomViewCallback(final android.webkit.WebChromeClient.FileChooserParams value) {
        if (value == null) {
            return null;
        }
    ...
    public static android.webkit.WebChromeClient.FileChooserParams fromAwCustomViewCallback(
