...
class AwCookieAccessPolicy {
 public:
  ...
  // |render_process_id| and |render_frame_id| must be valid. The request may
  // not be associated with a renderer process yet. That happens for navigation
  // request. In this case, |frame_tree_node_id| must be valid instead.
