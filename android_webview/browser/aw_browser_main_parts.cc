...
void AwBrowserMainParts::SetupFieldTrials() {
  ...
  variations::VariationsSeedStore seed_store(local_state);
  ...
  std::unique_ptr<const base::FieldTrial::EntropyProvider>
      low_entropy_provider = GetEntropyProvider();

  // SetupFieldTrialsCommon(field_trial_list_, &feature_list, variation_ids,
  // seed, &low_entropy_provider, local_state, nullptr, nullptr, nullptr);
}
