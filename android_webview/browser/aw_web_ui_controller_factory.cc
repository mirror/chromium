...
content::WebUI::TypeID AwWebUIControllerFactory::GetWebUIType(
...
bool AwWebUIControllerFactory::UseWebUIBindingsForURL(
    content::BrowserContext* browser_context,
    const GURL& url) const {
  bool ret = UseWebUIForURL(browser_context, url);
  return ret;
}

content::WebUIController* AwWebUIControllerFactory::CreateWebUIControllerForURL(
