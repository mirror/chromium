...
#include "android_webview/browser/net/aw_url_request_context_getter_unittest.h"
...
#include "testing/gtest/include/gtest.h"
...
class AwURLRequestContextGetterTest : public ::testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    getter_ = base::MakeRefCounted<AwURLRequestContextGetter>(
        temp_dir_.GetPath(),
