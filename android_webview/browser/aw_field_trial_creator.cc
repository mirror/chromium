...
bool ReadVariationsSeedDataFromFile(PrefService* local_state) {
  // TODO(kmilka): The data is read being moved to java and the data will be
  // passed in via JNI.
  return false;
}
...
AwFieldTrialCreator::AwFieldTrialCreator()
    : webview_field_trials_(base::MakeUnique<AndroidWebViewFieldTrials>()) {}
...
void AwFieldTrialCreator::SetUpFieldTrials() {
  ...
  variations_field_trial_creator_->SetupFieldTrials(
      ...
      &variation_ids, webview_field_trials_.get());
}
