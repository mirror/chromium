...
@SuppressLint("NewApi")
public class AwAutofillActivityTestRule extends AwActivityTestRule {
     ...
     * @param url
     */
    public void loadAutofillUrlSync(String url) throws Exception {
    ...
    public void verifyEventArray(Integer[] expectedEventArray) {
        Object[] objectArray = mEventQueue.toArray();
        Integer[] resultArray = Arrays.copyOf(objectArray, objectArray.length, Integer[].class);
        Assert.assertArrayEquals(expectedEventArray, resultArray);
    }

    public void resetEventArray() {
        mEventQueue.clear();
    }
