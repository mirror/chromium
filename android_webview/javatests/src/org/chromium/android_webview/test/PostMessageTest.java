...
public class PostMessageTest {
    ...
    // that is initialized can be transferred to JS and full communication can
    // happen on it. Do this by sending a message to JS and let it echo'ing the
    // message with some text prepended to it.
    @Test
    @SmallTest
    @Feature({"AndroidWebView", "Android-PostMessage"})
