...
public class AwJavaBridgeTest {
    ...
    private AwTestContainerView[] mGcContainerViewss;
    ...
    public void testGcAfterUsingJavascriptObject() throws Throwable {
        ...
        mGcContainerViewss = new AwTestContainerView[MAX_IDLE_INSTANCES + 1];

        for (int i = 0; i < MAX_IDLE_INSTANCES + 1; ++i) {
            mGcContainerViewss[i] =
                    mActivityTestRule.createAwTestContainerViewOnMainSync(mContentsClient);
            mActivityTestRule.enableJavaScriptOnUiThread(mGcContainerViewss[i].getAwContents());
            final AwContents awContents = mGcContainerViewss[i].getAwContents();
        ...
        mGcContainerViewss[0] = null;
        mGcContainerViewss[1] = null;
        mGcContainerViewss = null;
        removeAllViews();
