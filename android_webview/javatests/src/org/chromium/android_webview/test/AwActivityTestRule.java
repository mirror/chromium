...
public class AwActivityTestRule
    ...
    @Override
    public AwBrowserContext createAwBrowserContextOnUiThreadForTestCommon(
            InMemorySharedPreferences prefs, Context appContext) {
        return createAwBrowserContextOnUiThread(prefs, appContext);
    }
    ...
    @Override
    public TestDependencyFactory createTestDependencyFactoryForTestCommon() {
        return createTestDependencyFactory();
    }
     ...
     */
    @Override
    public boolean needsAwBrowserContextCreatedForTestCommon() {
        return needsAwBrowserContextCreated();
    }
     ...
     */
    @Override
    public boolean needsBrowserProcessStartedForTestCommon() {
        return needsBrowserProcessStarted();
    }
