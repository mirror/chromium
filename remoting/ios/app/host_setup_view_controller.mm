...
- (instancetype)initWithCollectionViewLayout:(UICollectionViewLayout*)layout {
  ...
  if (self) {
    ...
    NSString* setupInstructions =
        l10n_util::GetNSString(IDS_HOST_SETUP_INSTRUCTIONS);
    setupSteps = [setupInstructions componentsSeparatedByString:@"\n"];
  }
  return self;
}
...
- (UICollectionViewCell*)collectionView:(UICollectionView*)collectionView
  ...
  [cell setContentText:setupSteps[indexPath.item] number:indexPath.item + 1];
  return cell;
}
