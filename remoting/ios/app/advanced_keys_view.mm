...
static const int kViewHeight = 35.f;
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    // TODO(yuweih): Keys should be OS dependent. e.g. Win key on Windows and
    // Cmd key on Mac, separate keys for alt-left and alt-right.
