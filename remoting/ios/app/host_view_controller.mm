...
- (void)viewDidLoad {
  ...
  _fabLeftConstraints =
      [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(inset)-[fab]"
                                              options:0
                                              metrics:metrics
                                                views:views];

  _fabRightConstraints =
      [NSLayoutConstraint constraintsWithVisualFormat:@"H:[fab]-(inset)-|"
                                              options:0
                                              metrics:metrics
                                                views:views];
