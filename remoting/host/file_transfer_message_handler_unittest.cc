...
class FileTransferMessageHandlerTest : public testing::Test {
 ...
 protected:
  static const std::string kTestDataOne;
  static const std::string kTestDataTwo;
...
const std::string FileTransferMessageHandlerTest::kTestDataOne =
    "this is the first test string";
const std::string FileTransferMessageHandlerTest::kTestDataTwo =
