...
class FileProxyWrapper {
 public:
  // If an error occured while writing the file, state() will return kFailed and
  // the Optional will contain the error which occured. If the file was written
  // to and closed successfully, state() will return kClosed and the Optional
  // will be empty.
