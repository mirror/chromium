...
#if defined(OS_WIN)
  // base::Unretained() is safe here because |desktop_proxess| always outlives
  // the RunLoop.
  auto inject_sas_closure =
      base::Bind(&DesktopProcess::InjectSas, base::Unretained(desktop_process));
  auto lock_workstation_closure = base::Bind(&DesktopProcess::LockWorkstation,
