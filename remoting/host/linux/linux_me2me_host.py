...
Web Store: https://chrome.google.com/remotedesktop"""
  ...
  # configuration.
  already_running = get_daemon_proc(config_file) is not None

  if not already_running:
    # Reexecute ourself if needed, but only if an instance isn't already
    # running. This must happen before initializing ParentProcessLogger.
