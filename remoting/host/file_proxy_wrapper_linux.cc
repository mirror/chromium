...
class FileProxyWrapperLinux : public FileProxyWrapper {
 ...
 private:
  ...
  void WriteCallback(int expected_bytes_written,
                     base::File::Error error,
                     int bytes_written);
...
void FileProxyWrapperLinux::WriteCallback(int expected_bytes_written,
                                          base::File::Error error,
                                          int bytes_written) {
  if (expected_bytes_written != bytes_written || error) {
    if (!error) {
