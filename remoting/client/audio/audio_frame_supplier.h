...
class AudioFrameSupplier {
 public:
  ...
  virtual AudioPacket::SamplingRate buffered_sampling_rate() = 0;
  virtual AudioPacket::Channels buffered_channels() = 0;
  virtual AudioPacket::BytesPerSample buffered_byes_per_sample() = 0;
  virtual uint32_t bytes_per_frame() = 0;
