...
AudioFrameRequest::AudioFrameRequest(const void* samples,
...
void AudioPlayerBuffer::AsyncGetAudioFrame(uint32_t buffer_size,
  ...
  AudioFrameRequest* audioFrameRequest =
      new AudioFrameRequest(buffer, callback, buffer_size);
...
// static
void AudioPlayerBuffer::AudioPlayerCallback(void* buffer,
                                            uint32_t buffer_size,
                                            void* data) {
  AudioPlayerBuffer* audio_buffer = static_cast<AudioPlayerBuffer*>(data);
  audio_buffer->GetAudioFrame(buffer_size, buffer);
}
