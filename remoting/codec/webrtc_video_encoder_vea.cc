...
void WebrtcVideoEncoderVea::RequireBitstreamBuffers(
  ...
  DVLOG(3) << "WebrtcVideoEncoderVea::RequireBitstreamBuffers(): "
...
bool WebrtcVideoEncoderVea::Initialize() {
  ...
  // TODO(gusss) Should we just use media::VideoCodecProfile instead of creating
  // our own Codec enum that will essentially just map to VideoCodecProfile?
