...
CastSoftwareVideoEncoderAdapter::CreateVideoFrame(
  ...
  // TODO(zijiehe): This does not work now,
  // media::VideoFrame::WrapExternalData() accepts only I420 or Y16.
  return media::VideoFrame::WrapExternalData(
      ...
      base::Time::Now() - start_timestamp_);
}
...
CastSoftwareVideoEncoderAdapter::CreateEncodedFrame(
  ...
  result->key_frame = (
      ...
      media_frame.dependency == media::cast::EncodedFrame::INDEPENDENT
  );
