...
class WebrtcVideoEncoderSelector final {
 public:
  ...
  // Extracts information from |frame| and set |profile_|. This function
  // also resets |last_codec_|, so next CreateEncoder() function call returns
  // the first codec which supports the |frame|.
