...
TEST(LibyuvBugTest, TheseDimensionsDoNotWork) {
...
TEST(LibyuvBugTest, These32BitAlignedDimensionsWork) {
  gfx::Size input_coded_size_(1440,928);
  scoped_refptr<media::VideoFrame> video_frame = media::VideoFrame::CreateFrame(
      media::VideoPixelFormat::PIXEL_FORMAT_I420, input_coded_size_,
      gfx::Rect(input_coded_size_), input_coded_size_, base::TimeDelta());
...
TEST(LibyuvBugTest, TheseDimensionsAlsoWork) {
  gfx::Size input_coded_size_(800,600);
  scoped_refptr<media::VideoFrame> video_frame = media::VideoFrame::CreateFrame(
      media::VideoPixelFormat::PIXEL_FORMAT_I420, input_coded_size_,
      gfx::Rect(input_coded_size_), input_coded_size_, base::TimeDelta());
