...
#ifndef ASH_PUBLIC_CPP_APP_LIST_SEARCH_RESULT_OBSERVER_H_
#define ASH_PUBLIC_CPP_APP_LIST_SEARCH_RESULT_OBSERVER_H_

#include "ash/public/cpp/ash_public_export.h"

namespace app_list {

class ASH_PUBLIC_EXPORT SearchResultObserver {
 public:
...
#endif  // ASH_PUBLIC_CPP_APP_LIST_SEARCH_RESULT_OBSERVER_H_
