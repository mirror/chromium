...
#ifndef ASH_PUBLIC_CPP_APP_LIST_SEARCH_TERM_BREAK_ITERATOR_H_
#define ASH_PUBLIC_CPP_APP_LIST_SEARCH_TERM_BREAK_ITERATOR_H_
...
#endif  // ASH_PUBLIC_CPP_APP_LIST_SEARCH_TERM_BREAK_ITERATOR_H_
