...
#ifndef ASH_PUBLIC_CPP_APP_LIST_SEARCH_TOKENIZED_STRING_MATCH_H_
#define ASH_PUBLIC_CPP_APP_LIST_SEARCH_TOKENIZED_STRING_MATCH_H_
...
#endif  // ASH_PUBLIC_CPP_APP_LIST_SEARCH_TOKENIZED_STRING_MATCH_H_
