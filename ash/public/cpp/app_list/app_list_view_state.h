...
#ifndef ASH_PUBLIC_CPP_APP_LIST_APP_LIST_VIEW_STATE_H_
#define ASH_PUBLIC_CPP_APP_LIST_APP_LIST_VIEW_STATE_H_
...
#endif  // ASH_PUBLIC_CPP_APP_LIST_APP_LIST_VIEW_STATE_H_
