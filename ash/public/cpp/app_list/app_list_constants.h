...
ASH_PUBLIC_EXPORT extern const SkColor kSearchBoxBackgroundDefault;

ASH_PUBLIC_EXPORT extern const SkColor kSearchTextColor;

ASH_PUBLIC_EXPORT extern const SkColor kLabelBackgroundColor;
ASH_PUBLIC_EXPORT extern const SkColor kBottomSeparatorColor;
ASH_PUBLIC_EXPORT extern const SkColor kBottomSeparatorColorFullScreen;

ASH_PUBLIC_EXPORT extern const SkColor kDialogSeparatorColor;

ASH_PUBLIC_EXPORT extern const SkColor kHighlightedColor;
ASH_PUBLIC_EXPORT extern const SkColor kSelectedColor;
...
ASH_PUBLIC_EXPORT extern const SkColor kFolderBubbleColor;
ASH_PUBLIC_EXPORT extern const SkColor kFolderShadowColor;
ASH_PUBLIC_EXPORT extern const float kFolderBubbleOpacity;
ASH_PUBLIC_EXPORT extern const float kFolderBubbleRadius;
ASH_PUBLIC_EXPORT extern const float kFolderBubbleOffsetY;

ASH_PUBLIC_EXPORT extern const int kFolderBackgroundBubbleRadius;

ASH_PUBLIC_EXPORT extern const SkColor kCardBackgroundColor;
ASH_PUBLIC_EXPORT extern const SkColor kCardBackgroundColorFullscreen;
...
ASH_PUBLIC_EXPORT extern const int kPreferredColsFullscreen;
ASH_PUBLIC_EXPORT extern const int kPreferredRows;
ASH_PUBLIC_EXPORT extern const int kPreferredRowsFullscreen;
...
ASH_PUBLIC_EXPORT extern const int kListIconSizeFullscreen;
ASH_PUBLIC_EXPORT extern const int kListBadgeIconSize;
ASH_PUBLIC_EXPORT extern const int kListBadgeIconSizeFullscreen;
...
ASH_PUBLIC_EXPORT extern const int kAppsGridLeftRightPaddingFullscreen;
ASH_PUBLIC_EXPORT extern const int kBottomSeparatorLeftRightPaddingFullScreen;
ASH_PUBLIC_EXPORT extern const int kBottomSeparatorBottomPaddingFullScreen;
...
ASH_PUBLIC_EXPORT extern const int kSearchBoxFullscreenBottomPadding;
ASH_PUBLIC_EXPORT extern const int kSearchBoxBorderCornerRadiusFullscreen;
ASH_PUBLIC_EXPORT extern const int kSearchBoxPreferredHeight;

ASH_PUBLIC_EXPORT extern const int kPeekingAppListHeight;
ASH_PUBLIC_EXPORT extern const int kShelfSize;

ASH_PUBLIC_EXPORT extern const size_t kMaxFolderItems;
ASH_PUBLIC_EXPORT extern const size_t kMaxFolderItemsFullscreen;
ASH_PUBLIC_EXPORT extern const size_t kNumFolderTopItems;
...
ASH_PUBLIC_EXPORT extern const int kSearchIconSize;
ASH_PUBLIC_EXPORT extern const SkColor kDefaultSearchboxColor;
