  ...
  static ash::mojom::AppListState ToMojom(ash::AppListState input) {
    switch (input) {
      ...
      case ash::AppListState::STATE_CUSTOM_LAUNCHER_PAGE_DEPRECATED:
        return ash::mojom::AppListState::STATE_CUSTOM_LAUNCHER_PAGE_DEPRECATED;
      case ash::AppListState::INVALID_STATE:
        return ash::mojom::AppListState::INVALID_STATE;
    }
    NOTREACHED();
    return ash::mojom::INVALID_STATE;
  }
  ...
  static bool FromMojom(ash::mojom::AppListState input,
    ...
    switch (input) {
      ...
      case ash::mojom::AppListState::STATE_CUSTOM_LAUNCHER_PAGE_DEPRECATED:
        *out = ash::AppListState::STATE_CUSTOM_LAUNCHER_PAGE_DEPRECATED;
        return true;
      case ash::mojom::AppListState::INVALID_STATE:
        *out = ash::AppListState::INVALID_STATE;
        return true;
    }
    NOTREACHED();
    return false;
