...
ASH_PUBLIC_EXPORT MenuItemList GetMenuItemsForMojo(ui::MenuModel* model);

// Populates a simple menu model with a list of mojo menu items. This can be
// considered as an inverse operation of |GetMenuItemsForMojo|.
ASH_PUBLIC_EXPORT void GetMenuItemsFromMojo(
