...
enum ShellWindowId {
  ...
  // lock-screen-related windows (which are displayed while the screen is
  // locked, effectively containers stacked above
  // kShellWindowId_LockSystemModalContainer). Used by login shelf and
