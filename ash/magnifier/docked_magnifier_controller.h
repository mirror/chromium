...
// (which follows the cursorr location, text input caret location, or focus
// changes).
class ASH_EXPORT DockedMagnifierController
 ...
 public:
  ...
  void NonEditableNodeFocusChangedInPage(
      mojom::PointPtr center_point_in_screen) override;
