...
#ifndef ASH_DISPLAY_DISPLAY_PREFERENCES_H_
#define ASH_DISPLAY_DISPLAY_PREFERENCES_H_
...
class ASH_EXPORT DisplayPrefs : public ShellObserver {
 ...
 protected:
  friend class DisplayPreferencesTest;
...
#endif  // ASH_DISPLAY_DISPLAY_PREFERENCES_H_
