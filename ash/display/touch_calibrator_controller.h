...
class ASH_EXPORT TouchCalibratorController
 ...
 public:
  ...
  void StartCalibration(
      ...
      const TouchCalibrationCallback& callback = TouchCalibrationCallback());
 ...
 private:
  ...
  CalibrationState state_ = CalibrationState::kInavtive;
  ...
  base::Optional<TouchCalibrationCallback> callback_;
