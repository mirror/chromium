...
TEST_F(DisplayManagerTest, UnifiedDesktopVerticalLayout2x1) {
  ...
  ASSERT_EQ(2u, list.size());
  {
    ...
    EXPECT_EQ(1, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[1]));
    EXPECT_EQ(500, display_manager()->GetRowMaxHeight(0));
    EXPECT_EQ(400 * 200 / 300, display_manager()->GetRowMaxHeight(1));
  }

  {
    ...
    EXPECT_EQ(0, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[1]));
    EXPECT_EQ(199, display_manager()->GetRowMaxHeight(0));
    // 300 * 500 / 400.
    EXPECT_EQ(374, display_manager()->GetRowMaxHeight(1));
  }

  {
    ...
    EXPECT_EQ(1, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[1]));
    // 300 * 500 / 400.
    EXPECT_EQ(374, display_manager()->GetRowMaxHeight(0));
    EXPECT_EQ(199, display_manager()->GetRowMaxHeight(1));
  }
}
...
TEST_F(DisplayManagerTest, UnifiedDesktopVerticalLayout3x1) {
  ...
  ASSERT_EQ(3u, list.size());
  {
    ...
    EXPECT_EQ(2, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[2]));
    EXPECT_EQ(300, display_manager()->GetRowMaxHeight(0));
    // 500 * 500 / 400 = 625.
    EXPECT_EQ(625, display_manager()->GetRowMaxHeight(1));
    EXPECT_EQ(300, display_manager()->GetRowMaxHeight(2));
  }

  {
    ...
    EXPECT_EQ(500, display_manager()->GetRowMaxHeight(0));
    // 400 * 300 / 500 = 240.
    EXPECT_EQ(240, display_manager()->GetRowMaxHeight(1));
    EXPECT_EQ(240, display_manager()->GetRowMaxHeight(2));
  }
}
...
TEST_F(DisplayManagerTest, UnifiedDesktopGridLayout2x2) {
  ...
  EXPECT_EQ(1, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                   list[3]));
  EXPECT_EQ(299, display_manager()->GetRowMaxHeight(0));
  EXPECT_EQ(633, display_manager()->GetRowMaxHeight(1));
}
...
TEST_F(DisplayManagerTest, UnifiedDesktopGridLayout3x2) {
  ...
  EXPECT_EQ(299, display_manager()->GetRowMaxHeight(0));
  EXPECT_EQ(633, display_manager()->GetRowMaxHeight(1));
  EXPECT_EQ(174, display_manager()->GetRowMaxHeight(2));
}
