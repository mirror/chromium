...
TEST_F(DisplayManagerTest, TouchCalibrationTest) {
  ...
  display::TouchDeviceManagerTestApi tdm_test_api(touch_device_manager);
  ...
  const display::TouchDeviceIdentifier touch_device_identifier_2(touchdevice);
  ...
  ui::TouchscreenDevice touchdevice_2(
      12, ui::InputDeviceType::INPUT_DEVICE_EXTERNAL,
      std::string("test touch device 2"), gfx::Size(234, 567), 1);
  display::TouchDeviceIdentifier touch_device_identifier_2_2(touchdevice_2);
