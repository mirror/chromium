...
TEST_F(MultiMirroringTest, CustomMirrorModeBasics) {
  ...
  auto mirroring_param =
      std::make_unique<display::MixedMirrorModeParams>(id_list[0], dst_ids);
...
TEST_F(MultiMirroringTest, MixedMirrorModeToMirrorMode) {
  UpdateDisplay("300x400,400x500,500x600");
  display::DisplayIdList id_list = display_manager()->GetCurrentDisplayIdList();
...
TEST_F(MultiMirroringTest, MixedMirrorModeRestore) {
  const int64_t internal_display_id =
      display::test::DisplayManagerTestApi(display_manager())
          .SetFirstDisplayAsInternalDisplay();
  constexpr int64_t first_display_id = 210000001;
  ...
  auto mixed_params = std::make_unique<display::MixedMirrorModeParams>(
