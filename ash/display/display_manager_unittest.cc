...
TEST_F(DisplayManagerTest, UnifiedDesktopVerticalLayout2x1) {
...

  {
    ...
    EXPECT_EQ(0, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[1]));
    EXPECT_EQ(200, display_manager()->GetRowMaxHeight(0));
    // 300 * 500 / 400.
    EXPECT_EQ(375, display_manager()->GetRowMaxHeight(1));
  }

  {
    ...
    EXPECT_EQ(1, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                     list[1]));
    // 300 * 500 / 400.
    EXPECT_EQ(375, display_manager()->GetRowMaxHeight(0));
    EXPECT_EQ(200, display_manager()->GetRowMaxHeight(1));
  }
}
...
TEST_F(DisplayManagerTest, UnifiedDesktopGridLayout2x2) {
  ...
  EXPECT_EQ(1, display_manager()->GetMirroringDisplayRowIndexInUnifiedMatrix(
                   list[3]));
  EXPECT_EQ(300, display_manager()->GetRowMaxHeight(0));
  EXPECT_EQ(634, display_manager()->GetRowMaxHeight(1));
}
...
TEST_F(DisplayManagerTest, UnifiedDesktopGridLayout3x2) {
  ...
  EXPECT_EQ(300, display_manager()->GetRowMaxHeight(0));
  EXPECT_EQ(634, display_manager()->GetRowMaxHeight(1));
  EXPECT_EQ(175, display_manager()->GetRowMaxHeight(2));
}
