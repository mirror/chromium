...
#ifndef ASH_DISPLAY_DISPLAY_SHUTDOWN_OBSERVER_CHROMEOS_H_
#define ASH_DISPLAY_DISPLAY_SHUTDOWN_OBSERVER_CHROMEOS_H_
...
#endif  // ASH_DISPLAY_DISPLAY_SHUTDOWN_OBSERVER_CHROMEOS_H_
