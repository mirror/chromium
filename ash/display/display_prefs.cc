...
void LoadDisplayMixedMirrorModeParams(PrefService* local_state) {
  ...
  for (const auto& entry : mirroring_destination_ids_value->GetList()) {
    ...
    int64_t id;
    DCHECK(base::StringToInt64(entry.GetString(), &id));
