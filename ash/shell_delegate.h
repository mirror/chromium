...
class ASH_EXPORT ShellDelegate {
 public:
  ...
  virtual bool GetTouchscreenStatus(TouchscreenStatusSource source) const = 0;
  ...
  virtual void SetTouchscreenStatus(bool enabled,
                                    TouchscreenStatusSource source) = 0;
