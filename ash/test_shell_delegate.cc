...
bool TestShellDelegate::GetTouchscreenStatus(
    TouchscreenStatusSource source) const {
  return source == TouchscreenStatusSource::GLOBAL ? touchscreen_enabled_
                                                   : true;
}

void TestShellDelegate::SetTouchscreenStatus(bool enabled,
                                             TouchscreenStatusSource source) {
  if (source == TouchscreenStatusSource::GLOBAL)
