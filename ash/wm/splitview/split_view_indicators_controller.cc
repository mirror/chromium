...
class SplitViewOverviewOverlay::SplitViewOverviewOverlayView
 ...
 public:
  ...
  void SetLeftHightlightVisiblity(bool visible) {
    left_hightlight_view_->SetVisible(visible);
  }

  void SetRightHightlightVisiblity(bool visible) {
...
SplitViewOverviewOverlay::SplitViewOverviewOverlay(
  ...
  split_view_indicator_view_ = new SplitViewOverviewOverlayView();
  widget_ = CreateWidget(root_window, split_view_indicator_view_);

  split_view_indicator_view_->SetLeftHightlightVisiblity(false);
  split_view_indicator_view_->SetRightHightlightVisiblity(false);
  widget_->Show();
}
...
void SplitViewOverviewOverlay::SetVisible(bool visible) {
  switch (Shell::Get()->split_view_controller()->state()) {
    case SplitViewController::NO_SNAP:
      split_view_indicator_view_->SetLeftHightlightVisiblity(visible);
      split_view_indicator_view_->SetRightHightlightVisiblity(visible);
      return;
