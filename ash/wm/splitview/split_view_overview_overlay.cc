...
constexpr int kRotatedViewVerticalRoundRectRadius = 10;
...
class SplitViewOverviewOverlay::RotatedImageLabelView : public views::View {
 public:
  ...
  void OnPaint(gfx::Canvas* canvas) override {
    ...
    SkScalar radius = SkIntToScalar(kRotatedViewVerticalRoundRectRadius);
    ...
    canvas->DrawColor(SkColorSetA(SK_ColorBLACK, kRotatedViewBackgroundAlpha));
  }
