...
TEST_F(SplitViewControllerTest, DividerPositionWithWindowMinimumSizeTest) {
  ...
  generator.DragMouseTo(gfx::Point(
      display_bounds.width() * SplitViewController::kFixedPositionRatios[1],
      0));
  EXPECT_GT(divider_position(), SplitViewController::kFixedPositionRatios[1] *
                                    display_bounds.width());
  EXPECT_LE(divider_position(), SplitViewController::kFixedPositionRatios[2] *
                                    display_bounds.width());
  ...
  generator.set_current_location(divider_bounds.CenterPoint());
  generator.DragMouseTo(gfx::Point(
      display_bounds.width() * SplitViewController::kFixedPositionRatios[3],
      0));
  EXPECT_GT(divider_position(), SplitViewController::kFixedPositionRatios[2] *
                                    display_bounds.width());
  EXPECT_LE(divider_position(), SplitViewController::kFixedPositionRatios[3] *
                                    display_bounds.width());
  EndSplitView();
  ...
  EXPECT_LE(divider_position(), SplitViewController::kFixedPositionRatios[1] *
                                    display_bounds.width());
  EndSplitView();
