...
TEST_F(SplitViewControllerTest, SnapWindowBoundsWithMinimumSizeTest) {
  ...
  gfx::Point resize_start_point(divider_bounds.CenterPoint());
  split_view_controller()->StartResize(resize_start_point);
  ...
  resize_start_point = gfx::Point(divider_bounds.CenterPoint());
  split_view_controller()->StartResize(resize_start_point);
  resize_point = gfx::Point(0, display_bounds.height() * 0.33f);
  split_view_controller()->Resize(resize_point);
  ...
  resize_start_point = gfx::Point(divider_bounds.CenterPoint());
  split_view_controller()->StartResize(resize_start_point);
  resize_point = gfx::Point(display_bounds.width() * 0.33f, 0);
  split_view_controller()->Resize(resize_point);
