...
// Enum of the different splitview mode animations.
enum SplitviewAnimationType {
  ...
  // the item cannot be snapped.
  SPLITVIEW_ANIMATION_SELECTOR_ITEM_FADE_IN,
  SPLITVIEW_ANIMATION_SELECTOR_ITEM_FADE_OUT,
  // Used to fade in and out the labels on either side which indicate where to
  // drag, or if an item cannot be snapped.
  ...
  SPLITVIEW_ANIMATION_OTHER_FADE_IN,
  ...
  SPLITVIEW_ANIMATION_OTHER_SLIDE_IN,
  SPLITVIEW_ANIMATION_OTHER_SLIDE_OUT,
};
