 ...
 public:
  ...
  void OnPaint(gfx::Canvas* canvas) override {
    ...
    if (controller_->is_resizing()) {
      ...
      const display::Display::Rotation rotation = controller_->rotation();
      ...
      return is_dragging
                 ? gfx::Rect(work_area_bounds_in_screen.x(),
                             work_area_bounds_in_screen.y() +
                                 ...
                                 divider_position - divider_size.height() +
                                 dragging_diff,
                             divider_size.width(), divider_size.height())
                 : gfx::Rect(work_area_bounds_in_screen.x(),
                             work_area_bounds_in_screen.y() +
    ...
    case display::Display::ROTATE_180:
      return is_dragging
                 ? gfx::Rect(work_area_bounds_in_screen.x() +
                                 ...
                                 divider_position - divider_size.width() +
                                 dragging_diff,
                             work_area_bounds_in_screen.y(),
                             divider_size.width(), divider_size.height())
                 : gfx::Rect(work_area_bounds_in_screen.x() +
