...
SplitViewController::GetAvailableSnapPositionFromSnapState(
    SplitViewController::State snap_state) {
  switch (snap_state) {
    case SplitViewController::LEFT_SNAPPED:
      return SplitViewController::RIGHT;
    case SplitViewController::RIGHT_SNAPPED:
      return SplitViewController::LEFT;
    case SplitViewController::TOP_SNAPPED:
      return SplitViewController::BOTTOM;
    case SplitViewController::BOTTOM_SNAPPED:
      return SplitViewController::TOP;
