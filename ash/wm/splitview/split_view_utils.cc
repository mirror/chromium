...
const float kPhantomHighlightOpacity = 0.18f;
  ...
  switch (type) {
    ...
    case SPLITVIEW_ANIMATION_TEXT_FADE_OUT:
      ...
      *out_tween_type = gfx::Tween::FAST_OUT_SLOW_IN;
      return;
    case SPLITVIEW_ANIMATION_OTHER_FADE_IN:
    case SPLITVIEW_ANIMATION_OTHER_SLIDE_IN:
      *out_duration = kOtherFadeInOutMs;
      *out_tween_type = gfx::Tween::LINEAR_OUT_SLOW_IN;
      return;
    case SPLITVIEW_ANIMATION_OTHER_FADE_OUT:
    case SPLITVIEW_ANIMATION_OTHER_SLIDE_OUT:
      *out_duration = kOtherFadeInOutMs;
      *out_tween_type = gfx::Tween::LINEAR_OUT_SLOW_IN;
...
void DoSplitviewTransformAnimation(ui::Layer* layer,
  ...
  switch (type) {
    ...
    case SPLITVIEW_ANIMATION_OTHER_SLIDE_OUT:
      break;
    default:
      NOTREACHED() << "Not a valid split view fade animation type.";
      return;
  }
