...
void SplitViewController::SetLeftWindow(aura::Window* left_window) {
  StopObservingAndRestore(left_window_, left_window_original_bounds_, false);
  ...
  NotifySplitViewStateChanged(previous_state_, state_, left_window_);
}

void SplitViewController::SetRightWindow(aura::Window* right_window) {
  StopObservingAndRestore(right_window_, right_window_original_bounds_, false);
  ...
  NotifySplitViewStateChanged(previous_state_, state_, right_window_);
}
...
void SplitViewController::OnWindowDestroying(aura::Window* window) {
  // Close one of the snapped windows will end the split view mode. The behavior
...
void SplitViewController::OnPostWindowStateTypeChange(
  ...
  // exit the split view mode. The behavior might change in the future.
...
void SplitViewController::EndSplitView(bool animate) {
  ...
  NotifySplitViewStateChanged(previous_state_, state_, nullptr);
}
