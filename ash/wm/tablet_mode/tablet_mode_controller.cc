...
void TabletModeController::OnChromeTerminating() {
  ...
  UMA_HISTOGRAM_CUSTOM_COUNTS("Ash.TouchView.TouchViewActiveLandscapeTotal",
                              total_landscape_time_.InMinutes(), 1,
                              base::TimeDelta::FromDays(7).InMinutes(), 50);
  UMA_HISTOGRAM_CUSTOM_COUNTS("Ash.TouchView.TouchViewActivePortraitTotal",
                              total_portrait_time_.InMinutes(), 1,
                              base::TimeDelta::FromDays(7).InMinutes(), 50);
}
