...
const char kTabletModeInitiallyDisabled[] = "Touchview_Initially_Disabled";
const char kTabletModeEnabled[] = "Touchview_Enabled";
const char kTabletModeDisabled[] = "Touchview_Disabled";
...
TEST_F(TabletModeControllerTest, ForceTabletModeModeTest) {
  base::CommandLine::ForCurrentProcess()->AppendSwitchASCII(
      switches::kAshForceTabletMode, switches::kAshForceTabletModeTabletMode);
  tablet_mode_controller()->OnShellInitialized();
