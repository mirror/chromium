...
bool ToplevelWindowEventHandler::AttemptToStartDrag(
  ...
  aura::Window* gesture_target = wm_toplevel_window_event_handler_.last_gesture_target();
  ::wm::WindowMoveSource source =
        gesture_target ? ::wm::WINDOW_MOVE_SOURCE_TOUCH : ::wm::WINDOW_MOVE_SOURCE_MOUSE;
  if (gesture_target) {
