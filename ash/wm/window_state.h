...
class ASH_EXPORT WindowState : public aura::WindowObserver {
 public:
  ...
  base::Optional<gfx::Rect> pre_move_display_bounds() const {
    return pre_move_display_bounds_;
  }
  void SetPreMoveDisplayBounds(const gfx::Rect* bounds);
 ...
 private:
  ...
  base::Optional<gfx::Rect> pre_move_display_bounds_;
