...
#ifndef ASH_WM_MAXIMIZE_MODE_MAXIMIZE_MODE_OBSERVER_H_
#define ASH_WM_MAXIMIZE_MODE_MAXIMIZE_MODE_OBSERVER_H_
...
#endif  // ASH_WM_MAXIMIZE_MODE_MAXIMIZE_MODE_OBSERVER_H_
