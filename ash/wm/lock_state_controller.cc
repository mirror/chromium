...
void LockStateController::MaybePlayShutdownSound() {
  // PlayShutdownSound will call into chrome to get shutdown sound duration
  // asynchronously in OnGetShutdownSoundDuration.
