...
class SplitViewWindowSelectorTest : public WindowSelectorTest {
 ...
 protected:
  ...
  void DragWindowTo(WindowSelectorItem* item,
                    const gfx::Point& start_location,
...
TEST_F(SplitViewWindowSelectorTest, DragOverviewWindowToSnap) {
  ...
  DragWindowTo(selector_item1, start_location1, end_location1);
  ...
  DragWindowTo(selector_item2, start_location2, end_location2);
  ...
  DragWindowTo(selector_item3, start_location3, end_location3);
