...
TEST_F(WindowSelectorTest, TransformingLetteredRect) {
  ...
  EXPECT_NEAR(original_bounds.height() / scale, transformed_rect.height(), 1);
  ...
  EXPECT_EQ(overview_bounds.width(), transformed_rect.width());
  EXPECT_NEAR(original_bounds.height() / scale,
...
TEST_F(WindowSelectorTest, TransformingPillaredRect) {
  ...
  EXPECT_NEAR(original_bounds.width() / scale, transformed_rect.width(), 1);
