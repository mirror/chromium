...
constexpr int kHorizontalLabelPadding = 8;
...
// Values for the new overview ui.
// TODO(crbug.com/782320): Replace the orignal values with these when the old ui
// becomes obsolete.
constexpr int kNewHeaderHeightDp = 40;
constexpr int kNewHorizontalLabelPaddingDp = 12;
...
WindowSelectorItem::OverviewCloseButton::OverviewCloseButton(
  ...
  const int length = IsNewOverviewUi() ? kNewHeaderHeightDp : kHeaderHeight;
...
class WindowSelectorItem::CaptionContainerView : public views::View {
 ...
 protected:
  ...
  void Layout() override {
    ...
    const int label_padding = IsNewOverviewUi() ? kNewHorizontalLabelPaddingDp
