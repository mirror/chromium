...
class OverviewWindowMask : public ui::LayerDelegate {
 public:
  OverviewWindowMask(const gfx::Vector2dF& scale, bool is_inside_mask);
 ...
 private:
  ...
  // masked.
  int top_inset_ = 0;
  // Specifies the area where to apply the rounded rect mask. If this is empty,
  ...
  bool is_inside_mask_;
  // The amount of scale the layer this mask masks is subject to.
