...
class ASH_EXPORT ScopedTransformOverviewWindow : public ui::EventHandler {
 public:
  ...
  // |title_height| tall in the transformed window. If the type of
  // |transform_window| is not normal, write the |window_selector_bounds_| of
  // |transform_window|, which would differ than the return bounds.
  // |transform_window| may be null in tests.
 ...
 private:
  ...
  // Specifies if the window is too wide, too tall or normal.
