...
void Shell::RegisterProfilePrefs(PrefRegistrySimple* registry,
  ...
  LogoutButtonTray::RegisterProfilePrefs(registry, mode);
  NightLightController::RegisterProfilePrefs(registry, mode);
  ShelfController::RegisterProfilePrefs(registry, mode);
  TrayCapsLock::RegisterProfilePrefs(registry, mode);
}
