...
bool ShellDelegateImpl::GetTouchscreenStatus(bool use_user_pref) const {
  return true;
}

void ShellDelegateImpl::SetTouchscreenStatus(bool enabled, bool use_user_pref) {
}

void ShellDelegateImpl::UpdateTouchscreenStatus() {}
