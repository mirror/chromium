...
class APP_LIST_MODEL_EXPORT AppListModel : public AppListItemListObserver {
 public:
  ...
  void SetState(ash::mojom::AppListState state);
  ash::mojom::AppListState state() const { return state_; }
 ...
 private:
  ...
  ash::mojom::AppListState state_ = ash::mojom::AppListState::INVALID_STATE;
