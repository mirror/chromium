...
bool ShellDelegateMus::GetTouchscreenStatus(
    TouchscreenStatusSource source) const {
  NOTIMPLEMENTED();
  return true;
}

void ShellDelegateMus::SetTouchscreenStatus(bool enabled,
                                            TouchscreenStatusSource source) {
  NOTIMPLEMENTED();
}
