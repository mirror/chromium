...
constexpr float kBackgroundOpacityWithBlur = 0.8f;
constexpr float kBackgroundOpacity = 0.95f;
}
...
ContentsView::ContentsView(MessageCenterBubble* bubble, views::View* contents)
  ...
  background->layer()->SetOpacity(app_list::features::IsBackgroundBlurEnabled()
