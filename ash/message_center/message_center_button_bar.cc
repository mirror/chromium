...
void SetDefaultButtonStyle(views::Button* button) {
  ...
  button->SetFocusPainter(views::Painter::CreateSolidFocusPainter(
      message_center::kFocusBorderColor, gfx::Insets(1, 2, 2, 2)));
  button->SetBorder(views::CreateEmptyBorder(kVectorIconPadding));
...
MessageCenterButtonBar::MessageCenterButtonBar(
  ...
  notification_label_->SetFontList(
      GetFontListForSizeAndWeight(kTextFontSize, gfx::Font::Weight::MEDIUM));
  ...
  close_all_button_->SetImage(
      ...
      gfx::CreateVectorIcon(kNotificationCenterClearAllIcon, kVectorIconSize,
                            kActiveButtonColor));
  close_all_button_->SetImage(
  ...
  settings_button_->SetImage(
      views::Button::STATE_NORMAL,
      gfx::CreateVectorIcon(kNotificationCenterSettingsIcon, kVectorIconSize,
                            kActiveButtonColor));
