...
void SetDefaultButtonStyle(views::Button* button) {
  ...
  button->SetFocusPainter(views::Painter::CreateSolidFocusPainter(
      message_center::kFocusBorderColor, gfx::Insets(1, 2, 2, 2)));
  button->SetBorder(
      views::CreateEmptyBorder(message_center::kVectorIconPadding));
...
MessageCenterButtonBar::MessageCenterButtonBar(
  ...
  SetPaintToLayer();
  SetBackground(views::CreateSolidBackground(message_center::kBackgroundColor));
  ...
  notification_label_->SetFontList(message_center::GetFontListForSizeAndWeight(
  ...
  close_all_button_->SetImage(
      ...
      gfx::CreateVectorIcon(kNotificationCenterClearAllIcon,
                            message_center::kVectorIconSize,
                            kActiveButtonColor));
  close_all_button_->SetImage(
  ...
  gfx::ImageSkia quiet_mode_toggle_icon = gfx::CreateVectorIcon(
      kNotificationCenterDoNotDisturbOnIcon, message_center::kVectorIconSize,
      kActiveButtonColor);
