...
gfx::Size MessageCenterButtonBar::CalculatePreferredSize() const {
  gfx::Size preferred_size = button_container_->GetPreferredSize();
  preferred_size.SetToMax(collapse_button_->GetPreferredSize());
  preferred_size.Enlarge(notification_label_->GetPreferredSize().width(), 0);
