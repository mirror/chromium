...
NotifierSettingsView::NotifierSettingsView(NotifierSettingsProvider* provider)
  ...
  quiet_mode_label->SetFontList(GetDefaultFontList());
  ...
  top_label->SetFontList(GetDefaultFontList().Derive(
...
void NotifierSettingsView::OnQuietModeChanged(bool is_quiet_mode) {
