...
// The view to guarantee the 48px height and place the NotifierButton in the
// middle. It also guarantees the left margin.
...
void NotifierSettingsView::SetNotifierList(
  ...
  for (size_t i = 0; i < notifier_count; ++i) {
    ...
    NotifierButtonWrapperView* entry = new NotifierButtonWrapperView(button);
