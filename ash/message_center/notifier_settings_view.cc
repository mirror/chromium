...
NotifierSettingsView::NotifierSettingsView(NotifierSettingsProvider* provider)
  ...
  quiet_mode_icon->SetImage(
      gfx::CreateVectorIcon(kNotificationCenterDoNotDisturbOffIcon,
                            kVectorIconSize, kQuietModeIconColor));
  ...
  quiet_mode_label->SetFontList(
      GetFontListForSizeAndWeight(kLabelFontSize, gfx::Font::Weight::NORMAL));
  ...
  top_label->SetFontList(
      GetFontListForSizeAndWeight(kLabelFontSize, gfx::Font::Weight::MEDIUM));
