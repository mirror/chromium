...
class EmptyNotifierView : public views::View {
 public:
  EmptyNotifierView() {
    ...
    label->SetFontList(
        gfx::FontList().Derive(message_center_style::kEmptyLabelSizeDelta,
...
NotifierSettingsView::NotifierButton::NotifierButton(
  ...
  name_view_->SetFontList(gfx::FontList().Derive(
...
NotifierSettingsView::NotifierSettingsView()
  ...
  // "Roboto-Regular, 13sp" is specified in the mock.
  quiet_mode_label->SetFontList(gfx::FontList().Derive(
      kLabelFontSizeDelta, gfx::Font::NORMAL, gfx::Font::Weight::NORMAL));
