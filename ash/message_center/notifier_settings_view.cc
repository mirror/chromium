...
NotifierSettingsView::NotifierSettingsView(NotifierSettingsProvider* provider)
  ...
  quiet_mode_icon->SetImage(gfx::CreateVectorIcon(
      kNotificationCenterDoNotDisturbOffIcon, message_center::kVectorIconSize,
      kQuietModeIconColor));
  ...
  quiet_mode_label->SetFontList(message_center::GetFontListForSizeAndWeight(
  ...
  top_label->SetFontList(message_center::GetFontListForSizeAndWeight(
  ...
  scroller_->SetBackgroundColor(message_center::kBackgroundColor);
