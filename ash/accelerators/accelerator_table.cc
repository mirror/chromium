...
const AcceleratorData kAcceleratorData[] = {
    ...
    {true, ui::VKEY_LEFT, ui::EF_COMMAND_DOWN, MOVE_WINDOW_TO_LEFT_DISPLAY},
    {true, ui::VKEY_RIGHT, ui::EF_COMMAND_DOWN, MOVE_WINDOW_TO_RIGHT_DISPLAY},
    {true, ui::VKEY_UP, ui::EF_COMMAND_DOWN, MOVE_WINDOW_TO_UP_DISPLAY},
    {true, ui::VKEY_DOWN, ui::EF_COMMAND_DOWN, MOVE_WINDOW_TO_DOWN_DISPLAY},
