...
class ASH_EXPORT KeyboardShortcutViewerController
 ...
 private:
  ...
  // Cannot cache the returned result direcly because KSVItemInfoPtrList is
  // vector<mojo::StructPtr<KeyboardShortcutItemInfo>>. mojo::StructPtr has a
  // unique_ptr of KeyboardShortcutItemInfo and it will be moved in
  // ShowKeyboardShortcutViewer().
  keyboard_shortcut_viewer::KSVItemInfoPtrList GetAshShortcutsMetadata();
  ...
  keyboard_shortcut_viewer::KSVItemInfoList ash_shortcuts_metadata_;
