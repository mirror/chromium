...
void HandleStartVoiceInteraction(const ui::Accelerator& accelerator,
  ...
  } else if (accelerator.key_code() == ui::VKEY_VOICE_COMMAND) {
    base::RecordAction(base::UserMetricsAction(
        "VoiceInteraction.Started.VoiceCommandKey"));
  }
...
bool AcceleratorController::CanPerformAction(
  ...
  switch (action) {
    ...
    case START_ASSISTANT_TEXT_COMMAND:
    case START_ASSISTANT_VOICE_COMMAND:
...
void AcceleratorController::PerformAction(AcceleratorAction action,
  ...
  switch (action) {
    ...
    case SHOW_TASK_MANAGER:
      ...
      break;
    case START_ASSISTANT_TEXT_COMMAND:
      HandleStartVoiceInteraction(accelerator, false);
      break;
    case START_ASSISTANT_VOICE_COMMAND:
      HandleStartVoiceInteraction(accelerator, true);
      break;
    case SUSPEND:
      HandleSuspend();
      break;
