  ...
  switch (key_code) {
    case ui::VKEY_LEFT:
      controller->HandleMoveWindowToDisplay(
          DisplayMoveWindowController::Direction::LEFT);
      break;
    case ui::VKEY_UP:
      controller->HandleMoveWindowToDisplay(
          DisplayMoveWindowController::Direction::UP);
      break;
    case ui::VKEY_RIGHT:
      controller->HandleMoveWindowToDisplay(
          DisplayMoveWindowController::Direction::RIGHT);
      break;
    case ui::VKEY_DOWN:
      controller->HandleMoveWindowToDisplay(
          DisplayMoveWindowController::Direction::DOWN);
      break;
    default:
      NOTREACHED();
  }
