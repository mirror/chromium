...
class TestPowerManagerObserver : public chromeos::PowerManagerClient::Observer {
 public:
  TestPowerManagerObserver() = default;
  ~TestPowerManagerObserver() override = default;
...
class LockScreenNoteDisplayStateHandlerTest : public AshTestBase {
 public:
  ...
  void SetUp() override {
    ...
    power_manager_client_->SetScreenBrightnessPercent(kVisibleBrightnessPercent,
                                                      false /*gradual*/);
    power_manager_client_->AddObserver(&power_manager_observer_);
  ...
  void TearDown() override {
    ...
    power_manager_client_->RemoveObserver(&power_manager_observer_);
 ...
 protected:
  ...
  TestPowerManagerObserver power_manager_observer_;
