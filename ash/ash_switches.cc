...
const char kAshForceUiMode[] = "force-tablet-mode";

// Values for the kAshForceUiMode flag.
const char kAshForceUiModeAuto[] = "auto";
const char kAshForceUiModeClamshell[] = "clamshell";
const char kAshForceUiModeTabletMode[] = "touch_view";
