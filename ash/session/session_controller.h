...
class ASH_EXPORT SessionController : public mojom::SessionController {
 public:
  ...
  // Set "OffHours" policy session end time.
  void SetOffHoursEndTime(base::TimeTicks off_hours_end_time) override;
  // Update "OffHours" policy mode.
 ...
 private:
  ...
  // "OffHours" policy mode end time.
  base::TimeTicks off_hours_end_time_;

  // "OffHours" policy mode.
