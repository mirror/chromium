...
class SessionControllerTest : public AshTestBase {
 public:
...
class TrySwitchingUserTest : public SessionControllerTest {
 public:
  ...
  void TearDown() override {
    ...
    SessionControllerTest::TearDown();
  }
  ...
  void SwitchUser(ActionType action) {
    ...
    controller()->CanSwitchActiveUser(base::Bind(
        &TrySwitchingUserTest::SwitchCallback, base::Unretained(this)));
