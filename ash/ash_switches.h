...
ASH_EXPORT extern const char kAshForceUiMode[];
ASH_EXPORT extern const char kAshForceUiModeAuto[];
ASH_EXPORT extern const char kAshForceUiModeClamshell[];
ASH_EXPORT extern const char kAshForceUiModeTabletMode[];
