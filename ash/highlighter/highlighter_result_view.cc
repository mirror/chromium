...
constexpr int kInnerFillColor = SkColorSetRGB(0x00, 0x00, 0x00);

constexpr int kStrokeFillOpacity = 0xFF;
constexpr int kStrokeFillColor = SkColorSetRGB(0xFF, 0xFF, 0xFF);

constexpr int kStrokeOutlineOpacity = 0x14;
constexpr int kStrokeOutlineColor = SkColorSetRGB(0x00, 0x00, 0x00);

constexpr int kCornerCircleOpacity = 0xFF;
constexpr int kCornerCircleColorLT = SkColorSetRGB(0x42, 0x85, 0xF4);
constexpr int kCornerCircleColorRT = SkColorSetRGB(0xEA, 0x43, 0x35);
constexpr int kCornerCircleColorLB = SkColorSetRGB(0x34, 0xA8, 0x53);
constexpr int kCornerCircleColorRB = SkColorSetRGB(0xFB, 0xBC, 0x05);
