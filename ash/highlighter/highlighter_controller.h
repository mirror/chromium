...
// Controller for the highlighter functionality. Enables/disables highlighter
// as well as receives points and passes them off to be rendered.
class ASH_EXPORT HighlighterController : public ui::EventHandler,
 ...
 public:
  ...
  void EnableHighlighter(HighlighterDelegate* delegate);
 ...
 private:
  ...
  HighlighterDelegate* highlighter_delegate_;
