...
//}
//
// gfx::SizeF HighlighterView::GetPenTipSize() const {
//  return gfx::SizeF(kPenTipWidth, kPenTipHeight);
//}
...
void HighlighterView::AnimateInPlace(const gfx::PointF& pivot) {
  Animate(pivot, 1 /* scale */);
}

void HighlighterView::AnimateInflate(const gfx::PointF& pivot) {
  Animate(pivot, kStrokeScale);
}

void HighlighterView::AnimateDeflate(const gfx::PointF& pivot) {
  Animate(pivot, 1 / kStrokeScale);
}

void HighlighterView::Animate(const gfx::PointF& pivot, float scale) {
...
void HighlighterView::FadeOut(const gfx::PointF& pivot, float scale) {
