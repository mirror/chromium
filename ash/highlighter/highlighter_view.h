...
class HighlighterView : public views::View {
 public:
  ...
  void AnimateInPlace(const gfx::PointF& pivot);
  void AnimateInflate(const gfx::PointF& pivot);
  void AnimateDeflate(const gfx::PointF& pivot);
 ...
 private:
  ...
  void Animate(const gfx::PointF& pivot, float scale);
  void FadeOut(const gfx::PointF& pivot, float scale);
