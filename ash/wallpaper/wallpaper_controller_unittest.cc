...
TEST_F(WallpaperControllerTest, ShowCustomWallpaperWithCorrectResolution) {
  ...
  // expected. A second decode request with empty file path is also expected,
  // because unit tests don't support actual wallpaper decoding, it falls back
  // to a solid color default wallpaper.
