...
base::Optional<int> WallpaperController::kDirUserDataPathId =
    base::Optional<int>();
base::Optional<int> WallpaperController::kDirChromeOsWallpapersPathId =
    base::Optional<int>();
base::Optional<int> WallpaperController::kDirChromeOsCustomWallpapersPathId =
    base::Optional<int>();
...
base::FilePath WallpaperController::GetCustomWallpaperDir(const char* sub_dir) {
  ...
  DCHECK(kDirChromeOsCustomWallpapersPathId.has_value());
  CHECK(PathService::Get(kDirChromeOsCustomWallpapersPathId.value(),
...
void WallpaperController::SetPathIds(int user_data_path_id,
                                     int chromeos_wallpapers_path_id,
                                     int chromeos_custom_wallpapers_path_id) {
  DCHECK(!kDirUserDataPathId.has_value());
  kDirUserDataPathId = user_data_path_id;
  DCHECK(!kDirChromeOsWallpapersPathId.has_value());
  kDirChromeOsWallpapersPathId = chromeos_wallpapers_path_id;
  DCHECK(!kDirChromeOsCustomWallpapersPathId.has_value());
  kDirChromeOsCustomWallpapersPathId = chromeos_custom_wallpapers_path_id;
}
