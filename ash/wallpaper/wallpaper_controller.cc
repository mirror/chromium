...
void WallpaperController::DecodeWallpaperIfApplicable(
    ...
    bool data_is_ready) {
  // The connector for the mojo service manager is null in tests.
...
int WallpaperController::GetDecodeRequestCountsForTesting() {
  return decode_requests_for_testing_.size();
}
