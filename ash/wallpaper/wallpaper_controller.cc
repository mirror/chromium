...
base::FilePath WallpaperController::kDirUserDataPath = base::FilePath();
base::FilePath WallpaperController::kDirChromeOsWallpapersPath =
    base::FilePath();
base::FilePath WallpaperController::kDirChromeOsCustomWallpapersPath =
    base::FilePath();
...
base::FilePath WallpaperController::GetCustomWallpaperDir(
  ...
  DCHECK(!kDirChromeOsCustomWallpapersPath.empty());
  return kDirChromeOsCustomWallpapersPath.Append(sub_dir);
}
...
void WallpaperController::SetFilePaths(
    const base::FilePath& user_data_path,
    const base::FilePath& chromeos_wallpapers_path,
    const base::FilePath& chromeos_custom_wallpapers_path) {
  kDirUserDataPath = user_data_path;
  kDirChromeOsWallpapersPath = chromeos_wallpapers_path;
  kDirChromeOsCustomWallpapersPath = chromeos_custom_wallpapers_path;
}
