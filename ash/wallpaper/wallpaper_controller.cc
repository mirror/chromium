...
int WallpaperController::kDirUserDataPathId = -1;
int WallpaperController::kDirChromeOsWallpapersPathId = -1;
int WallpaperController::kDirChromeOsCustomWallpapersPathId = -1;
...
base::FilePath WallpaperController::GetCustomWallpaperDir(const char* sub_dir) {
  ...
  DCHECK(kDirChromeOsCustomWallpapersPathId != -1);
  CHECK(PathService::Get(kDirChromeOsCustomWallpapersPathId,
