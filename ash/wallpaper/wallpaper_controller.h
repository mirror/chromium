...
class ASH_EXPORT WallpaperController
 ...
 public:
  ...
  // The file paths of wallpaper directories.
  ...
  static base::FilePath kDirUserDataPath;
  static base::FilePath kDirChromeOsWallpapersPath;
  static base::FilePath kDirChromeOsCustomWallpapersPath;
