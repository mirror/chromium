...
class ASH_EXPORT WallpaperController
 ...
 public:
  ...
  static base::Optional<int> kDirUserDataPathId;
  static base::Optional<int> kDirChromeOsWallpapersPathId;
  static base::Optional<int> kDirChromeOsCustomWallpapersPathId;
  ...
  void SetPathIds(int user_data_path_id,
