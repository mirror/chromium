...
#ifndef ASH_LOGIN_LOGIN_METRICS_RECORDER_H_
#define ASH_LOGIN_LOGIN_METRICS_RECORDER_H_
...
class ASH_EXPORT LoginMetricsRecorder {
 public:
  ...
  void RecordNumAttempt(int num_attempt, bool eventual_success);
...
#endif  // ASH_LOGIN_LOGIN_METRICS_RECORDER_H_
