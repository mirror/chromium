...
const int kVerticalSpacingBetweenEntriesDp = 32;
// Horizontal spacing between username label and the dropdown icon.
const int kDistanceBetweenUsernameAndDropdownDp = 12;
// Distance from the top of the user view to the user icon.
const int kDistanceFromTopOfBigUserViewToUserIconDp = 54;
// Distance between user icon and the user label in small/extra-small layouts.
const int kSmallManyDistanceFromUserIconToUserLabelDp = 16;

const int kDropdownIconSizeDp = 20;

// Width/height of the user view. Ensures proper centering.
const int kLargeUserViewWidthDp = 306;
const int kLargeUserViewHeightDp = 346;
const int kSmallUserViewWidthDp = 304;
const int kExtraSmallUserViewWidthDp = 282;

// Width/height of the user image.
const int kLargeUserImageSizeDp = 96;
const int kSmallUserImageSizeDp = 74;
const int kExtraSmallUserImageSizeDp = 60;

const char* kUserViewClassName = "UserView";
const char* kLoginUserImageClassName = "LoginUserImage";
const char* kLoginUserLabelClassName = "LoginUserLabel";
...
void LoginUserView::SetFewLayout() {
  auto* root_layout =
...
void LoginUserView::SetSomeOrManyLayout() {
  auto* root_layout =
      new views::BoxLayout(views::BoxLayout::kHorizontal, gfx::Insets(),
