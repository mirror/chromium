...
void MakeSectionBold(views::StyledLabel* label,
                     ...
                     int bold_length) {
  auto create_style = [&label](bool is_bold) {
    views::StyledLabel::RangeStyleInfo style;
    style.custom_font = label->GetDefaultFontList().Derive(
        0, gfx::Font::FontStyle::NORMAL,
  ...
  views::StyledLabel::RangeStyleInfo regular_style = create_style(false);
  views::StyledLabel::RangeStyleInfo bold_style = create_style(true);
