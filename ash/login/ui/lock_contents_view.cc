...
LockContentsView::LockContentsView(LoginDataDispatcher* data_dispatcher)
  ...
  // switch to the shelf or status area. LockContentsView should otherwise not
  // be focusable.
...
void LockContentsView::OnFocusAboutToLeaveStatusArea() {
  // This function is called when the status area is losing focus. We want to
  // focus the first child in this view.
  FindFirstOrLastFocusableChild(this, false /*reverse*/)->RequestFocus();
}

void LockContentsView::OnFocusAboutToLeaveShelf() {
  // This function is called when the shelf is losing focus. We want to focus
  // the last child in this view.
  FindFirstOrLastFocusableChild(this, true /*reverse*/)->RequestFocus();
}
