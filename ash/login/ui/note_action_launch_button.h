...
class ASH_EXPORT NoteActionLaunchButton : public NonAccessibleView,
 ...
 public:
  explicit NoteActionLaunchButton(LoginDataDispatcher* login_data_dispatcher);
  ~NoteActionLaunchButton() override;

  // LoginDataDispatcher::Observer
  void OnLockScreenNoteStateChanged(mojom::TrayActionState state) override;

  const views::View* ForegroundViewForTesting() const;
  const views::View* BackgroundViewForTesting() const;
