...
// static
LoginBubble* LoginBubble::CreateErrorBubble() {
  return new LoginBubble(LoginBubbleType::kErrorBubble, nullptr /*button_view*/,
                         false /*show_remove_user*/);
}

// static
LoginBubble* LoginBubble::CreateUserMenu(views::View* button_view,
                                         bool show_remove_user) {
  return new LoginBubble(LoginBubbleType::kUserMenu, button_view,
                         show_remove_user);
}

LoginBubble::LoginBubble(LoginBubbleType type,
                         views::View* button_view,
                         bool show_remove_user)
    : type_(type),
      button_view_(button_view),
      show_remove_user_(show_remove_user) {
...
void LoginBubble::Show(const base::string16& message,
                       const base::string16& sub_message,
                       views::View* anchor_view) {
  DCHECK_EQ(nullptr, bubble_view_);
