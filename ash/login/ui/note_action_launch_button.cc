...
NoteActionLaunchButton::NoteActionLaunchButton(
  ...
  UpdateVisibility(login_data_dispatcher_->lock_screen_note_state());
}
...
const views::View* NoteActionLaunchButton::ForegroundViewForTesting() const {
  return action_button_;
}

const views::View* NoteActionLaunchButton::BackgroundViewForTesting() const {
  return background_;
}
