...
LoginShelfView::LoginShelfView()
  ...
  AddButton(kShutdown, base::string16(), gfx::ImageSkia());
  AddButton(kRestart, base::string16(), gfx::ImageSkia());
  AddButton(kSignOut, base::string16(), gfx::ImageSkia());
  AddButton(kCloseNote, base::string16(), gfx::ImageSkia());
  AddButton(kCancel, base::string16(), gfx::ImageSkia());
...
views::LabelButton* LoginShelfView::AddButton(ButtonId button_id,
