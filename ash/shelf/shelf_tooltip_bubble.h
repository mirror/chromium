...
// The implementation of tooltip bubble of the shelf. It is used by
// ShelfTooltipManager and StatusAreaTooltipManager to show the tooltip bubbles
// for shelf buttons and status area trays.
