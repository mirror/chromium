...
namespace ash {
namespace {
const int kFullExpandDurationMs = 650;
const int kFullRetractDurationMs = 300;
const int kFullBurstDurationMs = 200;

const float kRippleCircleInitRadiusDp = 40.f;
const float kRippleCircleStartRadiusDp = 1.f;
const float kRippleCircleRadiusDp = 77.f;
const float kRippleCircleBurstRadiusDp = 96.f;
const SkColor kRippleColor = SK_ColorWHITE;
const int kRippleExpandDurationMs = 400;
const int kRippleOpacityDurationMs = 100;
const int kRippleOpacityRetractDurationMs = 200;
const float kRippleOpacity = 0.1f;

const float kIconInitSizeDp = 24.f;
const float kIconStartSizeDp = 4.f;
const float kIconSizeDp = 24.f;
const float kIconOffsetDp = 56.f;
const float kIconOpacity = 1.f;
const int kIconBurstDurationMs = 100;

const float kBackgroundInitSizeDp = 48.f;
const float kBackgroundStartSizeDp = 10.f;
const float kBackgroundSizeDp = 48.f;
const int kBackgroundStartDelayMs = 100;
const int kBackgroundOpacityDurationMs = 200;
const float kBackgroundShadowSizeDp = 12;
}  // namespace

class CircleImageSource : public gfx::CanvasImageSource {
 public:
  CircleImageSource(float radius, float padding)
      : CanvasImageSource({(radius + padding) * 2, (radius + padding) * 2},
                          false),
        radius_(radius),
        padding_(padding) {}
 ...
 public:
  VoiceInteractionIconBackground() : Layer(ui::LAYER_NOT_DRAWN) {
    ...
    const gfx::ShadowValue kShadows[] = {
        gfx::ShadowValue(gfx::Vector2d(0, 0), kBackgroundShadowSizeDp,
                         SkColorSetARGB(0x54, 0, 0, 0)),
    };
    shadow_values_.assign(kShadows, kShadows + arraysize(kShadows));
  }
