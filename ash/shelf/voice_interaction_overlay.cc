 ...
 public:
  VoiceInteractionIconBackground()
      : Layer(ui::LAYER_NOT_DRAWN),
        shadow_values_(1,
                       gfx::ShadowValue(gfx::Vector2d(0, 0),
                                        kBackgroundShadowSizeDp,
                                        SkColorSetARGB(0x54, 0, 0, 0))) {
    set_name("VoiceInteractionOverlay:BACKGROUND_LAYER");
    SetBounds(gfx::Rect(0, 0, kBackgroundInitSizeDp, kBackgroundInitSizeDp));
    ...
    shadow_layer_->SetBounds(
        gfx::Rect(-kBackgroundShadowSizeDp, -kBackgroundShadowSizeDp,
...
class VoiceInteractionIcon : public ui::Layer, public ui::LayerDelegate {
 public:
  VoiceInteractionIcon() {
    ...
    SetBounds(gfx::Rect(0, 0, kIconInitSizeDp, kIconInitSizeDp));
    SetFillsBoundsOpaquely(false);
    SetMasksToBounds(false);
    set_delegate(this);
  }
...
void VoiceInteractionOverlay::StartAnimation() {
  ...
  // Setup ripple animations.
  {
    ...
    transform.Translate(center.x() - kRippleCircleRadiusDp,
                        center.y() - kRippleCircleRadiusDp);
    transform.Scale(scale_factor, scale_factor);
