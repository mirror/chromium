...
class ShelfTooltipManagerTest : public AshTestBase {
 public:
  ...
  void set_tooltip_manager(ShelfTooltipManager* tooltip_manager) {
...
class ShelfViewTooltipManagerTest : public ShelfTooltipManagerTest {
 public:
...
class StatusAreaTooltipManagerTest : public ShelfTooltipManagerTest {
 public:
