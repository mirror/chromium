...
class ASH_EXPORT Shelf : public ShelfLayoutManagerObserver {
 public:
  ...
  void set_is_tablet_mode_animation_running(
      bool is_tablet_mode_animation_running) {
    is_tablet_mode_animation_running_ = is_tablet_mode_animation_running;
  }
 ...
 private:
  ...
  // enter/exit tablet mode but the animation is not started until a
