...
void ShelfController::OnShellDestroyed() {
  LOG(ERROR) << "MSW ShelfController::OnShellDestroyed()";
...
void ShelfController::OnActiveUserPrefServiceChanged(
  ...
  LOG(ERROR) << "MSW ShelfController::OnActiveUserPrefServiceChanged A " << pref_service;
  prefs_observer_.reset();
  pref_change_registrar_.reset();
