...
void AddLocalMenuItems(MenuItemList* menu, int64_t display_id) {
  ...
  if (CanUserModifyShelfAutoHide(prefs) && !IsFullScreenMode(display_id)) {
    ...
    auto_hide->type = mojom::MenuItem::Type::CHECK;
  ...
  alignment_menu->type = mojom::MenuItem::Type::SUBMENU;
  ...
  left->type = mojom::MenuItem::Type::RADIO;
  ...
  bottom->type = mojom::MenuItem::Type::RADIO;
  ...
  right->type = mojom::MenuItem::Type::RADIO;
