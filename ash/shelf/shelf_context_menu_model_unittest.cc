...
class ShelfContextMenuModelTest : public AshTestBase {
 public:
  ...
  void SetUp() override {
    ...
    // TODO(msw): Update after https://chromium-review.googlesource.com/c/605027
...
TEST_F(ShelfContextMenuModelTest, Basic) {
  ...
  EXPECT_EQ(Shell::GetAshConfig() == Config::MASH,
...
TEST_F(ShelfContextMenuModelTest, CustomItems) {
  ...
  radio->type = mojom::MenuItem::Type::RADIO;
...
TEST_F(ShelfContextMenuModelTest, CustomSubmenu) {
  ...
  submenu_item->type = mojom::MenuItem::Type::SUBMENU;
