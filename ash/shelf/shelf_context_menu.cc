...
ShelfContextMenu::ShelfContextMenu(Shelf* shelf, const ShelfItem& item)
...
ShelfContextMenu::~ShelfContextMenu() {}

bool ShelfContextMenu::IsItemForCommandIdDynamic(int command_id) const {
  return false;
}

base::string16 ShelfContextMenu::GetLabelForCommandId(int command_id) const {
  NOTREACHED();
...
void ShelfContextMenu::AddPinMenu() {
...
void ShelfContextMenu::AddShelfOptionsMenu() {
