...
TEST_F(ShelfLayoutManagerTest, SwipingUpOnShelfForFullscreenAppList) {
  ...
  // Swiping up more than |kAppListSanpToFullScreenThreshold| should show the
  // app list.
  delta.set_y(ShelfLayoutManager::kAppListSnapToFullScreenThreshold + 10);
  ...
  // Swiping up less or equal to |kAppListSanpToFullScreenThreshold| should
  // dismiss the app list.
  delta.set_y(ShelfLayoutManager::kAppListSnapToFullScreenThreshold);
  end = start - delta;
