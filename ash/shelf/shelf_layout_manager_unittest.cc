...
class ShelfLayoutManagerKeyboardTest : public AshTestBase {
 public:
  ...
  void SendKeyboardNotifications(ShelfLayoutManager* layout_manager,
                                 bool is_locked,
...
TEST_F(ShelfLayoutManagerKeyboardTest, ShelfNotMoveOnKeyboardOpen) {
  ...
  SendKeyboardNotifications(layout_manager, false, keyboard_bounds());
  layout_manager->LayoutShelf();
...
TEST_F(ShelfLayoutManagerKeyboardTest,
  ...
  SendKeyboardNotifications(layout_manager, false, gfx::Rect());
  layout_manager->LayoutShelf();
  EXPECT_EQ(orig_work_area,
            display::Screen::GetScreen()->GetPrimaryDisplay().work_area());
}
...
TEST_F(ShelfLayoutManagerKeyboardTest, ShelfShouldChangeWorkAreaInStickyMode) {
  ...
  SendKeyboardNotifications(layout_manager, true, keyboard_bounds());
  layout_manager->LayoutShelf();
