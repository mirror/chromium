 ...
 protected:
  ...
  void SetupForDragTest(std::vector<std::pair<ShelfID, views::View*>>* id_map) {
    ...
    for (int i = 0; i < 5; ++i) {
      ...
      // Back button is located at index 0, app icon is located at index 1, and
      // browser shortcut is located at index 2. So we should start to add app
      // shortcut at index 3.
...
TEST_F(ShelfViewTest, AddButtonQuickly) {
  ...
  // Verifies non-overflow buttons are visible. The back button which is at
  // index 0 is not visible.
