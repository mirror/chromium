...
class ShelfTouchableContextMenuTest : public ShelfViewTest {
 public:
  ShelfTouchableContextMenuTest() = default;
  ~ShelfTouchableContextMenuTest() override = default;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ShelfTouchableContextMenuTest);
};
...
// notification.
TEST_F(ShelfTouchableContextMenuTest, AddedItemHasNotificationIndicator) {
...
// been removed.
TEST_F(ShelfTouchableContextMenuTest,
