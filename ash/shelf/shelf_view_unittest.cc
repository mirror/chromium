...
TEST_F(ShelfViewTouchableContextMenuTest, AddedItemHasNotificationIndicator) {
  ...
  EXPECT_FALSE(button_0->IsShowingNotificationIndicator());
  ...
  EXPECT_TRUE(button_0->IsShowingNotificationIndicator());
  ...
  EXPECT_TRUE(button_1->IsShowingNotificationIndicator());
  ...
  EXPECT_FALSE(button_1->IsShowingNotificationIndicator());
}
...
TEST_F(ShelfViewTouchableContextMenuTest,
  ...
  EXPECT_TRUE(button->IsShowingNotificationIndicator());
  ...
  EXPECT_FALSE(button->IsShowingNotificationIndicator());
}
