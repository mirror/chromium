...
TEST_F(ShelfViewTest, MouseWheelScrollTransitionsAppList) {
  ...
  RunAllPendingInMessageLoop();
  ASSERT_EQ(1u, test_app_list_presenter.process_mouse_wheel_event_count());
  ...
  generator.MoveMouseWheel(0, -1);
  RunAllPendingInMessageLoop();
  ASSERT_EQ(2u, test_app_list_presenter.process_mouse_wheel_event_count());

  // Add an app button and Mousewheel scroll on it.
  ...
  generator.MoveMouseWheel(0, -1);
  RunAllPendingInMessageLoop();
  ASSERT_EQ(3u, test_app_list_presenter.process_mouse_wheel_event_count());
}
