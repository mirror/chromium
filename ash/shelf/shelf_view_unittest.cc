...
class ShelfButtonNotificationIndicatorTest
    : public ShelfViewTest,
      public testing::WithParamInterface<bool> {
 public:
  ShelfButtonNotificationIndicatorTest() = default;
  ~ShelfButtonNotificationIndicatorTest() override = default;
...
// notification.
TEST_P(ShelfButtonNotificationIndicatorTest,
