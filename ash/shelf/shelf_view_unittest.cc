...
// Tests that a notification indicator is added to the ShelfItem when a
// notification is posted that matches the items app id.
...
// Tests that dismissing a notification removes the ShelfItems notification
// indicator.
