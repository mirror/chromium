...
LockScreenActionBackgroundControllerImpl::TestApi::TestApi(
    LockScreenActionBackgroundControllerImpl* controller)
    : controller_(controller) {}

LockScreenActionBackgroundControllerImpl::TestApi::~TestApi() = default;

LockScreenActionBackgroundView*
LockScreenActionBackgroundControllerImpl::TestApi::GetContentsView() {
  return controller_->contents_view_;
}

views::Widget* LockScreenActionBackgroundControllerImpl::TestApi::GetWidget() {
