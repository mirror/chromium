...
// PowerButtonMenuScreenView is the top-level view of power button menu UI. It creates
// a PowerButtonMenuBackgroundView to display the fullscreen background and a
// PowerButtonMenuView to display the menu.
class ASH_EXPORT PowerButtonMenuScreenView : public views::View,
 ...
 public:
  ...
  PowerButtonMenuView* power_button_menu_view() { return power_button_menu_view_; }
 ...
 private:
  ...
  PowerButtonMenuBackgroundView* power_button_screen_background_shield_ = nullptr;
