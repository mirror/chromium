...
constexpr gfx::Vector3dF TabletPowerButtonControllerTest::kUpVector;
constexpr gfx::Vector3dF TabletPowerButtonControllerTest::kDownVector;
constexpr gfx::Vector3dF TabletPowerButtonControllerTest::kSidewaysVector;
