...
class TabletPowerButtonControllerTest : public AshTestBase {
 ...
 protected:
  ...
  void InitPowerButtonControllerMembers(bool send_accelerometer_update) {
    ...
    // Resets PowerButtonDisplayController to let |tick_clock_| take effect.
    power_button_controller_->ResetPowerButtonDisplayControllerForTesting();
...
TEST_F(TabletPowerButtonControllerTest,
  ...
  // Advance |tick_clock_| to a state that display is actually turned on.
