...
gfx::Size PowerButtonMenuView::CalculatePreferredSize() const {
  ...
  if (power_off_item_ && sign_out_item_) {
    menu_size = gfx::Size(2 * PowerButtonMenuItemView::kMenuItemWidth +
                              2 * kMenuItemHorizontalPadding,
                          PowerButtonMenuItemView::kMenuItemHeight +
                              2 * kMenuItemVerticalPadding);
  } else {
    DCHECK(power_off_item_);
    DCHECK(!sign_out_item_);
    menu_size = gfx::Size(PowerButtonMenuItemView::kMenuItemWidth +
                              2 * kMenuItemHorizontalPadding,
                          PowerButtonMenuItemView::kMenuItemHeight +
                              2 * kMenuItemVerticalPadding);
  }
