...
class ASH_EXPORT PowerButtonController
 ...
 public:
  ...
  // TODO(minch): Remove the override here after all the
  // convertible/slate/detachable devices have the tablet mode switch. Note,
  // convertible devices like Minnie, Clapper and Glimmer which is pre-date the
  // tablet mode switch being introduced has no this switch currently.
