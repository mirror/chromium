...
// perform tablet power button behavior, except forced clamshell set by command
// line. For clamshell devices, power button acts locking or shutdown. On tablet
// mode, power button may also be consumed to take a screenshot.
