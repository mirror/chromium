...
// Utility class for keeping request to force backlights off active.
// An instance of this class is returned by
// BacklightsForcedOffSetter::ForceBacklightsOff - backlights will be kept in
// forced off state until the returned object goes out of scope or is |Reset|.
