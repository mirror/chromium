...
class PowerButtonTestBase : public AshTestBase {
 ...
 protected:
  ...
  // objects owned by it. If |is_tablet_mode_switch_set| is true, tablet mode
  // switch will be set and PowerButtonController will create
  // TabletPowerButtonController and PowerButtonScreenshotController after gets
  // the switch.
  void InitPowerButtonControllerMembers(bool is_tablet_mode_switch_set);

  // Sets the tablet mode switch. And then PowerButtonController will initialize
  // |tablet_controlelr_| and |screenshot_controller_| after gets the switch.
