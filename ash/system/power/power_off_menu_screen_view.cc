...
class PowerOffMenuScreenView::PowerOffMenuBackgroundView
 ...
 public:
  explicit PowerOffMenuBackgroundView(TabletPowerButtonController* controller)
...
PowerOffMenuScreenView::PowerOffMenuScreenView(
  ...
  power_off_screen_background_shield_ =
      new PowerOffMenuBackgroundView(controller);
