...
class PowerOffMenuScreenView::PowerOffMenuBackgroundView
 ...
 public:
  ...
  void ScheduleShowHideAnimation(bool show) {
    ...
    layer()->SetOpacity(show ? 0.f : 0.6f);
    ...
    layer()->SetOpacity(show ? 0.6f : 0.f);
  }
