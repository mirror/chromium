...
// a PowerOffMenuBackgroundView to display the fullscreen background of the
// menu. And a PowerOffMenuView to display the menu.
class ASH_EXPORT PowerOffMenuScreenView : public views::View,
                                          public display::DisplayObserver {
 public:
  explicit PowerOffMenuScreenView(TabletPowerButtonController* controller);
