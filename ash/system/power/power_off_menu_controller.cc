...
PowerOffMenuController::PowerOffMenuController(
    PowerButtonDisplayController* display_controller)
    : display_controller_(display_controller) {}

PowerOffMenuController::~PowerOffMenuController() = default;

void PowerOffMenuController::OnPowerButtonEvent(
    bool down,
  ...
  if (down) {
    ...
    power_off_menu_timer_.Start(FROM_HERE, kPowerOffMenuTimeout, this,
                                &PowerOffMenuController::OnPowerOffMenuTimeout);
  } else {
...
bool PowerOffMenuController::IsMenuOpened() const {
  return fullscreen_widget_ &&
         fullscreen_widget_->GetLayer()->GetTargetVisibility();
}

void PowerOffMenuController::DismissMenu() {
  if (IsMenuOpened())
    fullscreen_widget_->Hide();
}

void PowerOffMenuController::OnPowerOffMenuTimeout() {
...
PowerOffMenuController::CreateFullscreenWidget() {
