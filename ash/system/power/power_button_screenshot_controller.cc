...
constexpr base::TimeDelta PowerButtonScreenshotController::kScreenshotChordDelay;
...
bool PowerButtonScreenshotController::OnPowerButtonEvent(
  ...
  // As far as volume key is pressed, set power button as consumed to stop power
  // button event propagation. This will invalidate other power button's
  // behavior when user tries to operate screenshot.
