...
class ASH_EXPORT ConvertiblePowerButtonController
 ...
 private:
  ...
  // Called by |power_button_menu_timer_| to start showing the power off menu.
  ...
  // When |show_power_button_menu_| is true. Started when the power button is
  // pressed and stopped when it's released. Runs OnPowerButtonMenuTimeout() to
  ...
  // If true, start the |power_button_menu_timer_| to show the menu.
