...
class PowerButtonMenuScreenView::PowerButtonMenuBackgroundView
 ...
 public:
  explicit PowerButtonMenuBackgroundView(TabletPowerButtonController* controller)
...
void PowerButtonMenuScreenView::ScheduleShowHideAnimation(bool show) {
  DCHECK(power_button_screen_background_shield_);
  DCHECK(power_button_menu_view_);
