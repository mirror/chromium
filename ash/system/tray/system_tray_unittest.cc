...
TEST_F(SystemTrayTest, KeyboardNavigationWithOtherWindow) {
  ...
  // Send tab key event to the other window.
  ui::KeyEvent tab_key_event(ui::ET_KEY_PRESSED, ui::VKEY_TAB, ui::EF_NONE);
  widget->GetFocusManager()->OnKeyEvent(tab_key_event);
