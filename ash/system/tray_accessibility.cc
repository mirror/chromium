...
uint32_t GetAccessibilityState() {
  ...
  if (delegate->IsSelectToSpeakEnabled()) {
...
void AccessibilityDetailedView::OnAccessibilityStatusChanged() {
  ...
  select_to_speak_enabled_ = delegate->IsSelectToSpeakEnabled();
