...
void ApplyTemperatureToCompositors(float temperature) {
  ...
  if (temperature) {
    const float blue_scale =
        NightLightController::TemperatureToBlueColorScale(temperature);
    const float green_scale =
        NightLightController::TemperatureToGreenColorScale(temperature);
...
// static
float NightLightController::TemperatureToBlueColorScale(float temperature) {
  return 1.0f - temperature;
}

// static
float NightLightController::TemperatureToGreenColorScale(float temperature) {
...
// static
float NightLightController::BlueColorScaleToTemperature(float blue_scale) {
  return 1.0f - blue_scale;
}

// static
float NightLightController::GreenColorScaleToTemperature(float green_scale) {
  return 2.5f * (1 - green_scale);
}
...
void NightLightController::OnDisplayConfigurationChanged() {
  ...
  // switch to Unified Mode, we need to apply the current temperature
