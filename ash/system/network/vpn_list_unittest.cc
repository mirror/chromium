...
TEST_F(VpnListTest, ArcProviders) {
  ...
  VPNProvider arc_provider1("package.name.foo1", "ArcVPNMonster1",
                            "arc_app_id1", launchTime1);
  ...
  VPNProvider arc_provider2("package.name.foo2", "ArcVPNMonster2",
                            "arc_app_id2", base::Time::Now());
