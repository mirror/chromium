...
class ASH_EXPORT NetworkRowTitleView : public views::View {
 public:
  NetworkRowTitleView(int title_message_id, int subtitle_message_id = 0);
  ~NetworkRowTitleView() override;

  // Updates the subtitle. If |message_id| is 0, no subtitle will be shown.
  void UpdateSubtitle(int subtitle_message_id);
