...
int GetMobileUninitializedMsg() {
  ...
  // Never show messages if the list of Mobile networks in non-empty.
  ...
  // Do not show any messages if Cellular is not available on this device
  // (except for the 'Enable Bluetooth' message for Tether above).
  ...
  if (handler->GetScanningByType(NetworkTypePattern::Mobile())) {
