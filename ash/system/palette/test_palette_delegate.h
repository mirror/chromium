...
class TestPaletteDelegate : public PaletteDelegate {
 public:
  ...
  bool fake_has_seen_stylus_pref() const { return fake_has_seen_stylus_pref_; }

  void set_fake_has_seen_stylus_pref(bool has_seen_stylus);
 ...
 private:
  ...
  bool fake_has_seen_stylus_pref_ = false;
