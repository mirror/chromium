...
class PaletteWelcomeBubble::WelcomeBubbleView
 ...
 public:
  WelcomeBubbleView(views::View* anchor,
...
void PaletteWelcomeBubble::OnWidgetClosing(views::Widget* widget) {
  ...
  bubble_close_button_ = nullptr;
  tray_->OnWelcomeBubbleWidgetClosedDestroyed();
}
...
void PaletteWelcomeBubble::Show() {
  if (!bubble_view_) {
    DCHECK(tray_);
    bubble_view_ = new WelcomeBubbleView(tray_, bubble_close_button_,
