...
// that wants to control bluetooth power should set user pref setting instead.
class ASH_EXPORT BluetoothPowerController
 ...
 private:
  ...
  // no value otherwise.
  base::Optional<bool> bluetooth_power_to_be_set_;
  std::queue<base::Callback<void(device::BluetoothAdapter*)>>
