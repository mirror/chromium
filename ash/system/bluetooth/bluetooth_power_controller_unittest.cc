...
class BluetoothPowerControllerTest : public NoSessionAshTestBase {
 public:
  ...
  void SetUp() override {
    ...
    GetController()->RegisterProfilePrefs(active_user_prefs_.registry());
    GetController()->RegisterLocalStatePrefs(local_state_prefs_.registry());
  ...
  void AddUserSessionAndStartWatchingPrefsChanges(
    ...
    GetSessionControllerClient()->AddUserSession(display_email, user_type,
