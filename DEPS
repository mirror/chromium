...
vars = {
  ...
  'checkout_google_internal': 'checkout_src_internal',
...
deps = {
  ...
  'src/ios_internal': {
      'url': 'https://chrome-internal.googlesource.com/chrome/ios_internal.git' + '@' + '8e15a84e62dbc9bd35ca872385c8ddc05d2af522',
