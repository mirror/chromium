...
hooks_os = {
  'android': [
    ...
    },
    {
      ...
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/accessibility_test_framework/cipd.ensure',
                 '--root', 'src/third_party/accessibility_test_framework',
      ],
    },
    {
      ...
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/android_support_test_runner/cipd.ensure',
                 '--root', 'src/third_party/android_support_test_runner',
      ],
    },
    {
      ...
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/apk-patch-size-estimator/cipd.ensure',
                 '--root', 'src/third_party/apk-patch-size-estimator',
      ],
    },
    {
      'name': 'bouncycastle',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/bouncycastle/cipd.ensure',
                 '--root', 'src/third_party/bouncycastle',
      ],
    },
    {
      'name': 'byte_buddy',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/byte_buddy/cipd.ensure',
                 '--root', 'src/third_party/byte_buddy',
      ],
    },
    {
      'name': 'espresso',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/espresso/cipd.ensure',
                 '--root', 'src/third_party/espresso',
      ],
    },
    {
      'name': 'guava',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/guava/cipd.ensure',
                 '--root', 'src/third_party/guava',
      ],
    },
    {
      'name': 'hamcrest',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/hamcrest/cipd.ensure',
                 '--root', 'src/third_party/hamcrest,
      ],
    },
    {
      'name': 'icu4j',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/icu4j/cipd.ensure',
                 '--root', 'src/third_party/icu4j',
      ],
    },
    {
      'name': 'intellij',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/intellij/cipd.ensure',
                 '--root', 'src/third_party/intellij',
      ],
    },
    {
      'name': 'javax_inject',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/javax_inject/cipd.ensure',
                 '--root', 'src/third_party/javax_inject',
      ],
    },
    {
      'name': 'objenesis',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/objenesis/cipd.ensure',
                 '--root', 'src/third_party/objenesis',
      ],
    },
    {
      'name': 'ow2_asm',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/ow2_asm/cipd.ensure',
                 '--root', 'src/third_party/ow2_asm',
      ],
    },
    {
      'name': 'retrolambda',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/retrolambda/cipd.ensure',
                 '--root', 'src/third_party/retrolambda',
      ],
    },
    {
      'name': 'robolectric',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/robolectric/cipd.ensure',
                 '--root', 'src/third_party/robolectric',
      ],
    },
    {
      'name': 'sqlite4java',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/sqlite4java/cipd.ensure',
                 '--root', 'src/third_party/sqlite4java',
      ],
    },
    {
      'name': 'xstream',
      'pattern': '.',
      'action': ['src/build/cipd_wrapper.py',
                 '--ensure-file', 'src/third_party/xstream/cipd.ensure',
                 '--root', 'src/third_party/xstream',
      ],
    },
    {
