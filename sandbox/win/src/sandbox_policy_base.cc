...
HDESK PolicyBase::alternate_desktop_local_winstation_handle_ = NULL;
...
base::string16 PolicyBase::GetAlternateDesktop() const {
  ...
  if (use_alternate_winstation_) {
    ...
    return GetFullDesktopName(NULL, alternate_desktop_local_winstation_handle_);
  }
}
...
ResultCode PolicyBase::CreateAlternateDesktop(bool alternate_winstation) {
  if (alternate_winstation) {
    ...
    // Create the destkop.
    ResultCode result =
        CreateAltDesktop(NULL, &alternate_desktop_local_winstation_handle_);
    if (SBOX_ALL_OK != result)
      return result;
...
void PolicyBase::DestroyAlternateDesktop() {
  if (use_alternate_winstation_) {
    ...
    if (alternate_desktop_local_winstation_handle_) {
      ...
      alternate_desktop_local_winstation_handle_ = NULL;
    }
  }
}
...
ResultCode PolicyBase::MakeTokens(base::win::ScopedHandle* initial,
  ...
  if (use_alternate_desktop_ &&
      ((use_alternate_winstation_ && alternate_desktop_handle_) ||
    ...
    result = SetObjectIntegrityLabel(desktop_handle, SE_WINDOW_OBJECT, L"",
