...
class AppContainerProfile {
 public:
  ...
  virtual PSID package_sid() const = 0;
  ...
  virtual bool AddCapability(const Sid& capability_sid) = 0;

  // Enable Low Privilege AC.
  virtual void set_enable_low_privilege_app_container(bool enable) = 0;
