...
TEST(BrokerProcess, StatFile) {
  ...
  }
  {
    ...
    EXPECT_NE(0u, sb.st_dev);
    EXPECT_NE(0u, sb.st_ino);
    EXPECT_NE(0u, sb.st_mode);
    EXPECT_NE(0u, sb.st_uid);
    EXPECT_NE(0u, sb.st_gid);
    EXPECT_NE(0u, sb.st_blksize);
    EXPECT_NE(0u, sb.st_blocks);
    ...
    EXPECT_LT(1500000000, sb.st_atime);
    EXPECT_LT(1500000000, sb.st_mtime);
    EXPECT_LT(1500000000, sb.st_ctime);
  }
}
