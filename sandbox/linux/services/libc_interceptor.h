...
// to the parent over the sandbox IPC
...
// IPC back-channel to the parent process already established. This is exposed
// so other layers can put additional methods onto this channel.
SANDBOX_EXPORT int GetBackChannelFD();
