...
// This helper class can be used to start a Seccomp-BPF on Android. It helps by
// doing compile- and run-time checks to see if Seccomp should be supported on
// the given device.
