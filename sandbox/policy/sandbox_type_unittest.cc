...
TEST(SandboxTypeTest, ToString) {
  ...
  EXPECT_EQ("none", SandboxTypeFromString(SANDBOX_TYPE_NO_SANDBOX));
  EXPECT_EQ("network", SandboxTypeFromString(SANDBOX_TYPE_NETWORK));
  EXPECT_EQ("ppapi", SandboxTypeFromString(SANDBOX_TYPE_PPAPI));
  EXPECT_EQ("widevine", SandboxTypeFromString(SANDBOX_TYPE_WIDEVINE));
  EXPECT_EQ("utility", SandboxTypeFromString(SANDBOX_TYPE_UTILITY));
}
