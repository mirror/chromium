...
TEST(PrintedPageTest, GetCenteredPageContentRect) {
  ...
  // No centering.
  page = new PrintedPage(1, nullptr, gfx::Size(1200, 1200),
  ...
  // X centered.
  page = new PrintedPage(1, nullptr, gfx::Size(500, 1200),
                         gfx::Rect(0, 0, 400, 1100));
  page->GetCenteredPageContentRect(gfx::Size(1000, 1000), &page_content);
  ...
  // Y centered.
  page = new PrintedPage(1, nullptr, gfx::Size(1200, 500),
                         gfx::Rect(0, 0, 400, 1100));
  page->GetCenteredPageContentRect(gfx::Size(1000, 1000), &page_content);
  EXPECT_EQ(0, page_content.x());
  ...
  page = new PrintedPage(1, nullptr, gfx::Size(500, 500),
                         gfx::Rect(0, 0, 400, 1100));
  page->GetCenteredPageContentRect(gfx::Size(1000, 1000), &page_content);
  EXPECT_EQ(250, page_content.x());
  EXPECT_EQ(250, page_content.y());
...
TEST(PrintedPageTest, Shrink) {
  scoped_refptr<PrintedPage> page = new PrintedPage(
      1, nullptr, gfx::Size(1200, 1200), gfx::Rect(0, 0, 400, 1100));
