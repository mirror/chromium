...
#else
  // Sets the document data. Takes metafile ownership.
  // Note: locks for a short amount of time.
...
// Note: locks for a short amount of time in debug only.
  ...
  // Draws the document in the context.
  void Render(printing::NativeDrawingContext context);
#elif defined(OS_POSIX)
  // Draws the document in the context.
  void Render(PrintingContext* context);
#endif
