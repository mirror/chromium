...
// TODO(pmalani): Move these to system_api
...
class ArcMidisClientImpl : public ArcMidisClient {
 ...
 protected:
  void Init(dbus::Bus* bus) override {
    proxy_ = bus->GetObjectProxy(kMidisServiceName,
...
// static
ArcMidisClient* ArcMidisClient::Create() {
  return new ArcMidisClientImpl();
}
