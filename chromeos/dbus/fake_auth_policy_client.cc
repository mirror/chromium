...
void FakeAuthPolicyClient::JoinAdDomain(
  ...
  if (auth_error_ == authpolicy::ERROR_NONE)
    auth_error_ = authpolicy::ERROR_OU_DOES_NOT_EXIST;
  else if (auth_error_ == authpolicy::ERROR_OU_DOES_NOT_EXIST)
    auth_error_ = authpolicy::ERROR_INVALID_OU;
  else if (auth_error_ == authpolicy::ERROR_INVALID_OU)
    auth_error_ = authpolicy::ERROR_OU_ACCESS_DENIED;
  else if (auth_error_ == authpolicy::ERROR_OU_ACCESS_DENIED)
    auth_error_ = authpolicy::ERROR_SETTING_OU_FAILED;
  else if (auth_error_ == authpolicy::ERROR_SETTING_OU_FAILED)
    auth_error_ = authpolicy::ERROR_NONE;
