 ...
 public:
  ...
  class Observer {
   public:
    ...
    // Called when the user's one time permission has been set in Update Engine.
    virtual void OnUpdateOverCellularOneTimePermissionSet(bool success) {}
  };
  ...
  // Sets an one time permission on a certain update in Update Engine which then
