...
FakeSessionManagerClient::FakeSessionManagerClient(bool use_host_device_policy)
    : start_device_wipe_call_count_(0),
      ...
      delegate_(nullptr),
      use_host_device_policy_(use_host_device_policy),
      weak_ptr_factory_(this) {}

FakeSessionManagerClient::FakeSessionManagerClient()
    : FakeSessionManagerClient(false) {}
