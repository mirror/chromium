...
void FakeVirtualFileProviderClient::SetReadRequestHandler(
    const ReadRequestHandler& handler) {}

void FakeVirtualFileProviderClient::SetReleaseIDHandler(
    const ReleaseIDHandler& handler) {}
