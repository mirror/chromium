...
TEST(CrosDisksClientTest, DiskInfo) {
  ...
  const std::string kDiskFileSystemType = "exfat";
  ...
  std::unique_ptr<dbus::Response> response(dbus::Response::CreateEmpty());
  {
    ...
    AppendStringDictEntry(&array_writer, cros_disks::kDiskFileSystemType,
                          kDiskFileSystemType);
  ...
  EXPECT_EQ(kDiskFileSystemType, result.disk_file_system_type());
}
