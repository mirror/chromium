...
class CHROMEOS_EXPORT FakeCryptohomeClient : public CryptohomeClient {
 public:
  ...
  void set_tpm_attestation_does_key_exist_success(bool success) {
    tpm_attestation_does_key_exist_success_ = success;
  }
 ...
 private:
  ...
  bool tpm_attestation_does_key_exist_success_ = true;
