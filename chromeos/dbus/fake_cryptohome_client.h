...
class CHROMEOS_EXPORT FakeCryptohomeClient : public CryptohomeClient {
 public:
  ...
  void AsyncAddKey(const cryptohome::Identification& cryptohome_id,
                   ...
                   DBusMethodCallback<int> callback) override;
  void AsyncMountGuest(DBusMethodCallback<int> callback) override;
 ...
 private:
  ...
  void ReturnAsyncMethodResult(DBusMethodCallback<int> callback);

  // Posts tasks which return fake data to the UI thread.
  void ReturnAsyncMethodData(DBusMethodCallback<int> callback,
                             const std::string& data);

  // This method is used to implement ReturnAsyncMethodResult without data.
  void ReturnAsyncMethodResultInternal(DBusMethodCallback<int> callback);

  // This method is used to implement ReturnAsyncMethodResult with data.
  void ReturnAsyncMethodDataInternal(DBusMethodCallback<int> callback,
                                     const std::string& data);
