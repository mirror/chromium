...
class CHROMEOS_EXPORT AuthPolicyClient : public DBusClient {
 public:
  ...
  // Calls JoinADDomain. with serialized |request| and |password_fd| as
  // arguments. |password_fd| should be a file descriptor. |callback| is called
  ...
  // Calls AuthenticateUser with serialized |request| and |password_fd| as
  // arguments. |password_fd| should be a file descriptor. |callback| is called
  // after getting (or failing to get) D-BUS response.
