...
// TODO(pmalani): Reference these from system_api once the names are finalized.
constexpr char kMidisInterface[] = "org.chromium.Midis";
...
class MidisClientImpl : public MidisClient {
 public:
  ...
  base::ScopedFD BootstrapMojoConnection(
    ...
    // Create a socket pair, for setting up the Mojo channel.
    int sock_fd[2];
