...
bool IsVoiceInteractionLocalesSupported() {
  // Make sure the locale value does not change.
  static const std::string kLocale = icu::Locale::getDefault().getName();
  DCHECK_EQ(kLocale, icu::Locale::getDefault().getName());
