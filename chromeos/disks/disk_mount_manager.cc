...
class DiskMountManagerImpl : public DiskMountManager {
 ...
 private:
  ...
  // Stores new volume name and files system type for a device on which
  // formatting is invoked and set it back to a disk of the device to
  // synchronize changes in OnRenameCompleted.
  // The key is a device_path and the value is a FormatChange.
