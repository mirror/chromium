...
class DiskMountManagerImpl : public DiskMountManager {
 ...
 private:
  // Stores new volume name for a device on which formatting is invoked on, so
  // that OnRenameCompleted can set it back to |disks_|.
  // The key is a device_path and the value is new volume_name.
