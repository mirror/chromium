...
// A boolean pref that matches enable-fine-graned-time-zone-detection chrome://flags value.
const char kFineGrainedTimeZoneResolveEnabled[] = "cros.flags.fine-grained-time-zone-detection-enabled";
