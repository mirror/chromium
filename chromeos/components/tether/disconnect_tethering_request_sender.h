...
// Sends a DisconnectTetheringRequest to the formerly active host. Used when the
// Tether network is disconnected or when a connection to the active host is
// lost. Supports multiple concurrent messages if there is more than one device
// available.
