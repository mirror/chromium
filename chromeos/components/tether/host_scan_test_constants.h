...
#ifndef CHROMEOS_COMPONENTS_TETHER_HOST_SCAN_TEST_CONSTANTS_H_
#define CHROMEOS_COMPONENTS_TETHER_HOST_SCAN_TEST_CONSTANTS_H_

namespace chromeos {

namespace tether {

namespace host_scan_constants {
...
#endif  // CHROMEOS_COMPONENTS_TETHER_HOST_SCAN_TEST_CONSTANTS_H_
