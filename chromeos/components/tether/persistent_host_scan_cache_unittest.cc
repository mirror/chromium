...
#include "chromeos/components/tether/host_scan_test_constants.h"
...
std::unordered_map<std::string, HostScanCacheEntry> CreateTestEntries() {
  ...
  entries.emplace(
      host_scan_constants::kTetherGuid0,
      *HostScanCacheEntry::Builder()
           .SetTetherNetworkGuid(host_scan_constants::kTetherGuid0)
           .SetDeviceName(host_scan_constants::kTetherDeviceName0)
           .SetCarrier(host_scan_constants::kTetherCarrier0)
           .SetBatteryPercentage(host_scan_constants::kTetherBatteryPercentage0)
           .SetSignalStrength(host_scan_constants::kTetherSignalStrength0)
           .SetSetupRequired(host_scan_constants::kTetherSetupRequired0)
           .Build());

  entries.emplace(
      host_scan_constants::kTetherGuid1,
      *HostScanCacheEntry::Builder()
           .SetTetherNetworkGuid(host_scan_constants::kTetherGuid1)
           .SetDeviceName(host_scan_constants::kTetherDeviceName1)
           .SetCarrier(host_scan_constants::kTetherCarrier1)
           .SetBatteryPercentage(host_scan_constants::kTetherBatteryPercentage1)
           .SetSignalStrength(host_scan_constants::kTetherSignalStrength1)
           .SetSetupRequired(host_scan_constants::kTetherSetupRequired1)
           .Build());

  entries.emplace(
      host_scan_constants::kTetherGuid2,
      *HostScanCacheEntry::Builder()
           .SetTetherNetworkGuid(host_scan_constants::kTetherGuid2)
           .SetDeviceName(host_scan_constants::kTetherDeviceName2)
           .SetCarrier(host_scan_constants::kTetherCarrier2)
           .SetBatteryPercentage(host_scan_constants::kTetherBatteryPercentage2)
           .SetSignalStrength(host_scan_constants::kTetherSignalStrength2)
           .SetSetupRequired(host_scan_constants::kTetherSetupRequired2)
           .Build());

  entries.emplace(
      host_scan_constants::kTetherGuid3,
      *HostScanCacheEntry::Builder()
           .SetTetherNetworkGuid(host_scan_constants::kTetherGuid3)
           .SetDeviceName(host_scan_constants::kTetherDeviceName3)
           .SetCarrier(host_scan_constants::kTetherCarrier3)
           .SetBatteryPercentage(host_scan_constants::kTetherBatteryPercentage3)
           .SetSignalStrength(host_scan_constants::kTetherSignalStrength3)
           .SetSetupRequired(host_scan_constants::kTetherSetupRequired3)
           .Build());
...
TEST_F(PersistentHostScanCacheTest, TestSetAndRemove) {
  SetHostScanResult(test_entries_.at(host_scan_constants::kTetherGuid0));
  VerifyPersistentCacheMatchesInMemoryCache(1u /* expected_size */);

  SetHostScanResult(test_entries_.at(host_scan_constants::kTetherGuid1));
  VerifyPersistentCacheMatchesInMemoryCache(2u /* expected_size */);

  SetHostScanResult(test_entries_.at(host_scan_constants::kTetherGuid2));
  VerifyPersistentCacheMatchesInMemoryCache(3u /* expected_size */);

  SetHostScanResult(test_entries_.at(host_scan_constants::kTetherGuid3));
  VerifyPersistentCacheMatchesInMemoryCache(4u /* expected_size */);

  RemoveHostScanResult(host_scan_constants::kTetherGuid0);
  VerifyPersistentCacheMatchesInMemoryCache(3u /* expected_size */);

  RemoveHostScanResult(host_scan_constants::kTetherGuid1);
  VerifyPersistentCacheMatchesInMemoryCache(2u /* expected_size */);

  RemoveHostScanResult(host_scan_constants::kTetherGuid2);
  VerifyPersistentCacheMatchesInMemoryCache(1u /* expected_size */);

  RemoveHostScanResult(host_scan_constants::kTetherGuid3);
...
TEST_F(PersistentHostScanCacheTest, TestUpdate) {
  SetHostScanResult(test_entries_.at(host_scan_constants::kTetherGuid0));
  VerifyPersistentCacheMatchesInMemoryCache(1u /* expected_size */);
  EXPECT_EQ(host_scan_constants::kTetherSetupRequired0,
  ...
  SetHostScanResult(
      *HostScanCacheEntry::Builder()
           ...
           .Build());
  VerifyPersistentCacheMatchesInMemoryCache(1u /* expected_size */);
  EXPECT_EQ(host_scan_constants::kTetherSetupRequired1,
            host_scan_cache_->DoesHostRequireSetup(
                host_scan_constants::kTetherGuid0));
}
