 ...
 public:
  ...
  void SetUp() override {
    ...
    fake_tether_host_fetcher_ =
        base::MakeUnique<FakeTetherHostFetcher>(test_devices_, true);
  ...
  void TearDown() override { disconnect_tethering_request_sender_.reset(); }
...
TEST_F(DisconnectTetheringRequestSenderTest,
       SendMultipleRequests_Concurrent_DifferentDeviceId) {
...
TEST_F(DisconnectTetheringRequestSenderTest,
       SendMultipleRequests_Concurrent_SameDeviceId) {
