...
class DisconnectTetheringRequestSenderTest : public testing::Test {
 public:
  ...
  void ConcurrentRequestAttemptsToTwoDevices(bool first_operation_successful,
  ...
  void ConcurrentRequestAttemptsToOneDevice(bool operation_successful) {
    disconnect_tethering_request_sender_->SendDisconnectRequestToDevice(
        test_devices_[0].GetDeviceId());
    disconnect_tethering_request_sender_->SendDisconnectRequestToDevice(
        test_devices_[0].GetDeviceId());
...
TEST_F(
  ...
  ConcurrentRequestAttemptsToTwoDevices(true /* first_operation_successful */,
...
TEST_F(
  ...
  ConcurrentRequestAttemptsToTwoDevices(
      false /* first_operation_successful */,
...
TEST_F(
  ...
  ConcurrentRequestAttemptsToTwoDevices(
      true /* first_operation_successful */,
      false /* second_operation_successful */);
}
...
TEST_F(
  ...
  ConcurrentRequestAttemptsToTwoDevices(false /* first_operation_successful */,
                                        true /* second_operation_successful */);
}

TEST_F(DisconnectTetheringRequestSenderTest,
       MultipleRequestAttempts_Concurrent_SameDeviceId_OperationSuccessful) {
  ConcurrentRequestAttemptsToOneDevice(true /* operation_successful */);
}

TEST_F(DisconnectTetheringRequestSenderTest,
       MultipleRequestAttempts_Concurrent_SameDeviceId_OperationFailed) {
  ConcurrentRequestAttemptsToOneDevice(false /* operation_successful */);
}
