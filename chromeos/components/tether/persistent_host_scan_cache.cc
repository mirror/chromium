...
const char PersistentHostScanCache::kTetherNetworkGuidKey[] =
    "tether_network_guid";
const char PersistentHostScanCache::kDeviceNameKey[] = "device_name";
const char PersistentHostScanCache::kCarrierKey[] = "carrier";
const char PersistentHostScanCache::kBatteryPercentageKey[] =
    "battery_percentage";
const char PersistentHostScanCache::kSignalStrengthKey[] = "signal_strength";
const char PersistentHostScanCache::kSetupRequiredKey[] = "setup_required";
...
PersistentHostScanCache::HostScanCacheEntryToDictionary(
...
// static
std::unique_ptr<HostScanCacheEntry>
PersistentHostScanCache::DictionaryToHostScanCacheEntry(
