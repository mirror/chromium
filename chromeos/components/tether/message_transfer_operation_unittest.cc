...
class MessageTransferOperationTest : public testing::Test {
 protected:
  ...
  void VerifyConnectionMetrics(
    ...
    if (num_expected_successful_effective_gatt_connections) {
      histogram_tester_.ExpectBucketCount(
    ...
    if (num_expected_failed_effective_gatt_connections) {
      histogram_tester_.ExpectBucketCount(
          "InstantTethering.GattConnectionAttempt."
          "EffectiveSuccessRateWithRetries",
    ...
    if (!num_expected_successful_effective_gatt_connections &&
        !num_expected_failed_effective_gatt_connections) {
      histogram_tester_.ExpectTotalCount(
          "InstantTethering.GattConnectionAttempt."
          "EffectiveSuccessRateWithRetries",
          0u);
