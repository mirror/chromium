...
class WifiHotspotConnectorTest : public NetworkStateTest {
 public:
  ...
  base::TimeDelta connection_to_hotspot_time_ =
...
TEST_F(WifiHotspotConnectorTest, TestConnect_NetworkDoesNotBecomeConnectable) {
  ...
  VerifyConnectionToHotspotDurationRecorded(false);
}
...
TEST_F(WifiHotspotConnectorTest, TestConnect_Success) {
  ...
  test_clock_->Advance(connection_to_hotspot_time_);
  ...
  VerifyTimerStopped();
  VerifyConnectionToHotspotDurationRecorded(true);
}
