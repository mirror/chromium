...
TEST_F(HostScanDevicePrioritizerImplTest,
  ...
  test_devices_[6].last_update_time_millis = 60000L;
  ...
  EXPECT_EQ((std::vector<cryptauth::RemoteDevice>{
                test_devices_[2], test_devices_[4], test_devices_[3],
                test_devices_[0], test_devices_[1], test_devices_[5],
                test_devices_[6]}),
            test_vector);
}
...
TEST_F(HostScanDevicePrioritizerImplTest,
  ...
  EXPECT_EQ((std::vector<cryptauth::RemoteDevice>{
                test_devices_[1], test_devices_[3], test_devices_[4],
                test_devices_[2], test_devices_[0], test_devices_[6],
                test_devices_[9], test_devices_[7], test_devices_[8],
                test_devices_[5]}),
            test_vector);
}
