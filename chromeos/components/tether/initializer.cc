...
ble_scanner_ = base::MakeUnique<BleScanner>(adapter, local_device_data_provider_.get());
cryptauth::RemoteDevice remote_device = cryptauth::RemoteDevice("uid", "name", "", "abc", "key", "blah");
ble_scanner_->RegisterScanFilterForDevice(remote_device);
