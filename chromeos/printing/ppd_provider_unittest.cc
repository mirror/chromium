...
TEST_F(PpdProviderTest, ResolvePrinters) {
  ...
  EXPECT_EQ("printer_a_ref", capture0[0].ppdRef.effective_make_and_model);
  ...
  EXPECT_EQ("printer_b_ref", capture0[1].ppdRef.effective_make_and_model);
  ...
  EXPECT_EQ("printer_c_ref", capture1[0].ppdRef.effective_make_and_model);
}
