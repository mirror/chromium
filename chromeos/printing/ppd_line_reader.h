...
class PpdLineReader {
 public:
  // Create a new PpdLineReader based on the ppd contents in contents.  The
  // max allowed line length in the ppd is also parameterized.
  //
  // |contents| may or may not be gzip-compressed, and must remain
  // valid and unchanged while the Created PpdReader exists.
