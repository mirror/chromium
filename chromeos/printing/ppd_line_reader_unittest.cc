...
// Test ppd contents.  This is an excerpt from a hplip ppd.
...
// Same as SimplePpd test, but gzip the contents first.  Since we don't
// have a convenient way to do this in the API, this was done with
// gzip and hex-encoded here.
