...
class CHROMEOS_EXPORT NetworkStateHandler
 ...
 public:
  ...
  // Path for default Cellular service, see EnsureCellularNetwork.
  static const char kDefaultCellularNetworkPath[];
 ...
 private:
  ...
  // a dummy Cellular network may need to be created. If a Cellular Device
  // exists |cellular_networks| will be modified to contain exactly one network.
