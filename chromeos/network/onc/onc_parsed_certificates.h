...
class CHROMEOS_EXPORT OncParsedCertificates {
 public:
  ...
  // Base class for a certificate parsed from ONC.
  class Certificate {
   public:
  ...
  // Returns true if this OncParsedCertificates instances has the same server
  // and authority certificates. Order matters.
  bool HasSameServerOrAuthorityCertificates(OncParsedCertificates* other) const;

  // Returns true if this OncParsedCertificates instances has the same client
  // certificates. Order matters.
