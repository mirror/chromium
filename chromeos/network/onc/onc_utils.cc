...
bool ParseAndValidateOncForImport(const std::string& onc_blob,
  ...
  // Note this processing is performed even if |network_configs| is nullptr,
  // because ResolveServerCertRefsInNetworks could affect the return value of
  // the function (which is supposed to aggregate validation issues in all
  // segments of the ONC blob).
