...
void SetClientCertPkcs11Id(client_cert::ConfigType config_type,
...
void LocalTranslator::TranslateOpenVPN() {
  ...
  SetClientCertPkcs11Id(client_cert::CONFIG_TYPE_OPENVPN, onc_object_,
                        shill_dictionary_);
...
void LocalTranslator::TranslateIPsec() {
  SetClientCertPkcs11Id(client_cert::CONFIG_TYPE_IPSEC, onc_object_,
                        shill_dictionary_);
...
void LocalTranslator::TranslateEAP() {
  ...
  SetClientCertPkcs11Id(client_cert::CONFIG_TYPE_EAP, onc_object_,
                        shill_dictionary_);
