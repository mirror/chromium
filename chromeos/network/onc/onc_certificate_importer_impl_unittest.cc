...
class ONCCertificateImporterImplTest : public testing::Test {
 ...
 protected:
  ...
  net::ScopedCERTCertificateVector public_list_;
  // List of certs in the nssdb's "private" slot.
  net::ScopedCERTCertificateVector private_list_;
  net::ScopedCERTCertificateVector web_trust_certificates_;

 private:
  net::ScopedCERTCertificateVector ListCertsInPublicSlot() {
    return ListCertsInSlot(public_nssdb_.slot());
  }

  net::ScopedCERTCertificateVector ListCertsInPrivateSlot() {
    return ListCertsInSlot(private_nssdb_.slot());
  }

  net::ScopedCERTCertificateVector ListCertsInSlot(PK11SlotInfo* slot) {
    net::ScopedCERTCertificateVector result;
