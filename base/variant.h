...
struct VariantHelper<N> {
  ...
  static constexpr void Copy(size_t idx, void* from, void* to) noexcept {}
};
...
class Variant {
 public:
  ...
  constexpr explicit Variant(Arg&& a) noexcept {
    ...
    index_ = VarArgIndexHelper<Arg, Ts...>::kIndex;
  ...
  Variant& operator=(Variant& other) noexcept {
    VariantHelper<0, Ts...>::Destruct(index_, &other.union_[0]);
    index_ = other.index_;
    VariantHelper<0, Ts...>::Copy(index_, &other.union_[0], &union_[0]);
    return *this;
  }
