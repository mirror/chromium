...
std::string CountryCodeForCurrentTimezone() {
  ...
  // only for Etc/GMT while leaving alone Etc/UTC and Etc/UCT because
  // they're less likely to be chosen by mistake in UK in place of
  // Europe/London (Briitish Time).
