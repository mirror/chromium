...
bool InitializeICUWithFileDescriptorInternal(
  ...
  if (err != U_ZERO_ERROR) {
    ...
    // Australia/Sydney, Asia/Seoul, Europe/Paris ). Retrieve the OS timezone
    // and set the ICU default timezone accordingly in advance of actual use.
    // See crbug.com/722821 and https://ssl.icu-project.org/trac/ticket/13208 .
    icu::TimeZone::adoptDefault(icu::TimeZone::createTimeZone(
        icu::UnicodeString(SysInfo::GetTimeZoneID().c_str(), -1, US_INV)));
  }
#endif
