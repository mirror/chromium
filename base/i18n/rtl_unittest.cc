...
TEST_F(RTLTest, SanitizeUserSuppliedString) {
  struct {
    ...
    const wchar_t* formatted_text;
      ...
      {L"\x202eكبير Google التطبيق\x202c",
       L"\x200e\x202b\x202eكبير Google التطبيق\x202c\x202c\x200e"},
      // Tests RTL string with over-terminated dir-formatting characters.
      {L"\x202eكبير Google\x202cالتطبيق\x202c",
       L"\x200e\x202b\x202eكبير Google\x202cالتطبيق\x202c\x202c\x200e"},
      // Tests RTL string that over-terminates then re-opens.
      {L"\x202eكبير Google\x202c\x202cالتطبيق\x202e",
       L"\x200e\x202b\x202eكبير "
       L"Google\x202c\x202cالتطبيق\x202e\x202c\x202c\x200e"},
      // Tests RTL string with multiple dir-formatting characters.
      {L"\x202eك\x202eبير Google الت\x202eطبيق",
       L"\x200e\x202b\x202eك\x202eبير Google "
       L"الت\x202eطبيق\x202c\x202c\x202c\x202c\x200e"},
      // Test the other dir-formatting characters (U+202A, U+202B, and U+202D).
      {L"\x202aكبير Google التطبيق",
       L"\x200e\x202b\x202aكبير Google التطبيق\x202c\x202c\x200e"},
      {L"\x202bكبير Google التطبيق",
       L"\x200e\x202b\x202bكبير Google التطبيق\x202c\x202c\x200e"},
      {L"\x202dكبير Google التطبيق",
       L"\x200e\x202b\x202dكبير Google التطبيق\x202c\x202c\x200e"},
