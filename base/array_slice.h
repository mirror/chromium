...
class ArraySlice {
 public:
  ...
  constexpr ArraySlice(
      ElementType (&arr)[N]) noexcept;  // NOLINT(runtime/explicit)
  template <class Container>
  constexpr ArraySlice(
      const Container& cont) noexcept;  // NOLINT(runtime/explicit)
  constexpr ArraySlice(std::initializer_list<ElementType>
                           ilist) noexcept;  // NOLINT(runtime/explicit)
  // --------------------------------------------------------------------------
  // Subslices.
  //
  ...
  //
  // NOTE: These are in-member friend functions to support implicit conversions
  // from templated container types, e.g. std::vector.
  constexpr friend bool operator==(ArraySlice<ElementType> lhs,
                                   ArraySlice<ElementType> rhs) noexcept {
...
template <class ElementType>
template <size_t N>
constexpr ArraySlice<ElementType>::ArraySlice(ElementType (&arr)[N]) noexcept
    : ArraySlice(arr, N) {}
...
constexpr ArraySlice<ElementType>::ArraySlice(
    std::initializer_list<ElementType> ilist) noexcept
...
template <class ElementType>
constexpr typename ArraySlice<ElementType>::reference
ArraySlice<ElementType>::front() const noexcept {
  return data_[0];
}
template <class ElementType>
constexpr typename ArraySlice<ElementType>::reference
ArraySlice<ElementType>::back() const noexcept {
