...
class ArraySlice {
 public:
  ...
  template <size_t N>
  constexpr ArraySlice(ElementType (&arr)[N]) noexcept;
  template <class Container>
  constexpr ArraySlice(const Container& cont) noexcept;
  constexpr ArraySlice(std::initializer_list<ElementType> ilist) noexcept;
...
//
template <class ElementType>
constexpr bool operator==(ArraySlice<ElementType> lhs,
