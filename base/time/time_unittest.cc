...
TEST_F(TimeTest, NowOverride) {
  ...
  {
    // Set override.
    ScopedTimeClockOverrides overrides(&TimeOverride::Now, nullptr, nullptr);
...
TEST(TimeTicks, NowOverride) {
  ...
  {
    // Set override.
    ScopedTimeClockOverrides overrides(nullptr, &TimeTicksOverride::Now,
                                       nullptr);
...
TEST(ThreadTicks, MAYBE_NowOverride) {
  ...
  {
    // Set override.
    ScopedTimeClockOverrides overrides(nullptr, nullptr,
