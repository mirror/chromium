...
// be set before the first call to Now() to avoid inconsistencies in returned
// values.
//
// This is for headless (virtual time) and base_unittests use only. DO NOT call
// these for other use cases without first discussing with //base/time OWNERS.
...
// Set overrides for individual Now() functions, not to be used outside //base.
// The methods return a pointer to the previously set override or platform
// default Now() function if no override was in place.
