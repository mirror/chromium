...
// limit year.
 ...
 private:
  ...
  friend Time TimeNowIgnoringOverride();
  friend Time TimeNowFromSystemTimeIgnoringOverride();
...
class BASE_EXPORT TimeTicks : public time_internal::TimeBase<TimeTicks> {
 ...
 private:
  ...
  friend TimeTicks TimeTicksNowIgnoringOverride();
...
class BASE_EXPORT ThreadTicks : public time_internal::TimeBase<ThreadTicks> {
 ...
 private:
  ...
  friend ThreadTicks ThreadTicksNowIgnoringOverride();
