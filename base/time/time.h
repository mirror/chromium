...
class TimeBase {
 public:
  ...
  // Time::ToMicrosecondsSinceWindowsEpoch(). http://crbug.com/634507
  ...
  // Time::FromMicrosecondsSinceWindowsEpoch(). http://crbug.com/634507
...
// limit year.
  ...
  //   SaveToDatabase(last_updated.ToMicrosecondsSinceWindowsEpoch());
  //
  //   // Deserialization:
  //   base::Time last_updated =
  //       base::Time::FromMicrosecondsSinceWindowsEpoch(LoadFromDatabase());
  static Time FromMicrosecondsSinceWindowsEpoch(int64_t us);
  int64_t ToMicrosecondsSinceWindowsEpoch() const;
