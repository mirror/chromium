...
using base::ThreadTicksNowIgnoringOverride;
using base::Time;
using base::TimeDelta;
using base::TimeNowFunction;
using base::TimeNowFromSystemTimeIgnoringOverride;
using base::TimeNowIgnoringOverride;
using base::TimeTicks;
using base::TimeTicksNowFunction;
using base::TimeTicksNowIgnoringOverride;
...
TimeNowFunction SetTimeClockOverride(TimeNowFunction func_ptr) {
  ...
  if (func_ptr == &TimeNowIgnoringOverride) {
