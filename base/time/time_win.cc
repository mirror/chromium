...
// static
TimeNowFunction base::ScopedTimeClockOverrides::SetTimeClockOverride(
...
// static
TimeTicksNowFunction base::ScopedTimeClockOverrides::SetTimeTicksClockOverride(
...
base::ScopedTimeClockOverrides::SetThreadTicksClockOverride(
