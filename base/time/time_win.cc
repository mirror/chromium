...
TimeNowFunction base::SetTimeClockOverride(TimeNowFunction func_ptr) {
...
Time base::TimeNowIgnoringOverride() {
  ...
  while (true) {
    ...
    return Time() + TimeDelta::FromMicroseconds(elapsed + g_initial_time);
  }
}
...
void InitializeNowFunctionPointer() {
  ...
  // g_time_ticks_now_function may already be overridden.
...
TimeTicksNowFunction base::SetTimeTicksClockOverride(
...
ThreadTicksNowFunction base::SetThreadTicksClockOverride(
