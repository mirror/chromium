...
SamplingHeapProfiler::Sample::Sample(const Sample& other) = default;
...
void SamplingHeapProfiler::MaybeRecordAlloc(void* address,
  ...
  size_t accumulated = base::subtle::NoBarrier_AtomicExchange(
...
void SamplingHeapProfiler::RecordAlloc(size_t total_allocated,
  ...
  base::subtle::Acquire_Load(&g_operations_in_flight);
