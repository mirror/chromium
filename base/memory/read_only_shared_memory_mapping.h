...
class BASE_EXPORT ReadOnlySharedMemoryMapping {
 public:
  ...
  ReadOnlySharedMemoryMapping(ReadOnlySharedMemoryMapping&& mapping);
  ReadOnlySharedMemoryMapping& operator=(ReadOnlySharedMemoryMapping&& mapping);
