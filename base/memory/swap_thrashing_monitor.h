...
using SwapThrashingMonitorDelegate = SwapThrashingMonitorDelegateInterface;

// For unittesting.
class TestSwapThrashingMonitor;
...
class BASE_EXPORT SwapThrashingMonitor {
 public:
  using SwapThrashingLevel = SwapThrashingMonitorDelegate::SwapThrashingLevel;
 ...
 private:
  // For unittesting.
  friend class TestSwapThrashingMonitor;
