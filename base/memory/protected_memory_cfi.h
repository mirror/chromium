...
// CFI-icall. These routines allow those symbols to be called safely by
// ensuring they're placed in protected memory.
...
// should only be used by the unsanitizedCfiCall() functions below.
