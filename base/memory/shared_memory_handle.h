...
class BASE_EXPORT SharedMemoryHandle {
 public:
  ...
  SharedMemoryHandle(struct AHardwareBuffer* buffer,
                     size_t size,
                     const base::UnguessableToken& guid);
  // File descriptor constructor needs a type since POSIX and AHardwareBuffer
  // are both transported this way for IPC. The generic file descriptor
  // constructor below assumes type POSIX.
...
// Common constructor for generic POSIX handle.
