...
#ifndef BASE_MEMORY_WRITABLE_SHARED_MEMORY_MAPPING_H_
#define BASE_MEMORY_WRITABLE_SHARED_MEMORY_MAPPING_H_
...
class BASE_EXPORT WritableSharedMemoryMapping {
 public:
  ...
  WritableSharedMemoryMapping(WritableSharedMemoryMapping&& mapping);
  WritableSharedMemoryMapping& operator=(WritableSharedMemoryMapping&& mapping);
 ...
 private:
  ...
  // This constructor shall only be used by SharedMemoryRegion methods.
...
#endif  // BASE_MEMORY_WRITABLE_SHARED_MEMORY_MAPPING_H_
