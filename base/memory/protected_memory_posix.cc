...
// Component builds can include multiple DSOs with protected memory sections and
// there is not a good way to define a writers variable in the global scope for
// each of those DSO in component builds. Instead, just leave writers writable
// by default for component builds.
#if !defined(COMPONENT_BUILD)
PROTECTED_MEMORY_SECTION
#endif  // !defined(COMPONENT_BUILD)
BASE_EXPORT int AutoWritableMemory::writers = 0;
BASE_EXPORT base::LazyInstance<Lock>::Leaky AutoWritableMemory::writers_lock =
