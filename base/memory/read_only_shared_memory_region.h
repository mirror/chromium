...
class BASE_EXPORT ReadOnlySharedMemoryRegion {
 public:
  ...
  // Returns ReadOnlySharedMemoryRegion built from a platform-specific handle
  // that was taken from another ReadOnlySharedMemoryRegion instance. This
  // should be used only by the code passing handles across process boundaries.
  static ReadOnlySharedMemoryRegion Deserialize(SharedMemoryHandle handle);
  ...
  ReadOnlySharedMemoryRegion Clone();
