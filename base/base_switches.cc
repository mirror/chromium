...
// GUIDs for shared components. Also, clients create new ownership edges between
...
//
// This feature is implemented behind the flag until base::SharedMemory's GUID
// works regarding Mojo (crbug/713763).
