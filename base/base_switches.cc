...
// are usually created at each client.
//
// When this flag is on, base::SharedMemory clients create memory dumps and
// ownership edges with customized GUIDs for base::SharedMemory instead of
// current general GUIDs of shared components. As a result, tracing
// memory-infra dumps will be able to show base::SharedMemory usages correctly.
//
