...
// #00 0x00000000018bda00 app:/system/base_unittests
// #01 0x0000000001587b5c app:/system/base_unittests
// #02 0x0000000000779ece app:/system/base_unittests
// #03 0x000000000151cb9e app:/system/base_unittests
// ...
// #08 0x00000000015058d7 app:/system/base_unittests
// #22 0x000000000001c3de libc.so
// #23 end
void StackTrace::OutputToStream(std::ostream* os) const {
  ...
  for (; (i < count_) && os->good(); ++i) {
    ...
    if (entry) {
      ...
      // name is not emitted.
      (*os) << "#" << std::setw(2) << std::setfill('0') << i << std::setw(0)
            << " 0x" << std::hex << std::setw(16) << trace_[i] << "\n";
    }
  }
