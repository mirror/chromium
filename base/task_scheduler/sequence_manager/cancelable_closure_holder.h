...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_CANCELABLE_CLOSURE_HOLDER_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_CANCELABLE_CLOSURE_HOLDER_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_CANCELABLE_CLOSURE_HOLDER_H_
