...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_MOVEABLE_AUTO_LOCK_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_MOVEABLE_AUTO_LOCK_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_MOVEABLE_AUTO_LOCK_H_
