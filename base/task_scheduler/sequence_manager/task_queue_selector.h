...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_SELECTOR_H_
