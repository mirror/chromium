...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_POLLABLE_THREAD_SAFE_FLAG_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_POLLABLE_THREAD_SAFE_FLAG_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_POLLABLE_THREAD_SAFE_FLAG_H_
