...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_H_
...
#include "base/task_scheduler/sequence_manager/moveable_auto_lock.h"
...
class BASE_EXPORT TaskQueue : public base::SingleThreadTaskRunner {
 public:
  ...
  struct BASE_EXPORT PostedTask {
    PostedTask(base::OnceClosure callback,
               ...
               base::Optional<int> task_type = base::nullopt);

    base::OnceClosure callback;
    base::Location posted_from;
    base::TimeDelta delay;
    base::Nestable nestable;
    base::Optional<int> task_type;
  };
  ...
  class BASE_EXPORT Task : public base::PendingTask {
   public:
    Task(PostedTask posted_task, base::TimeTicks desired_run_time);

    base::Optional<int> task_type() const { return task_type_; }

   private:
    base::Optional<int> task_type_;
  };
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TASK_QUEUE_H_
