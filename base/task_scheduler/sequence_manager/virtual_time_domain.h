...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_VIRTUAL_TIME_DOMAIN_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_VIRTUAL_TIME_DOMAIN_H_
...
class BASE_EXPORT VirtualTimeDomain : public TimeDomain {
 public:
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_VIRTUAL_TIME_DOMAIN_H_
