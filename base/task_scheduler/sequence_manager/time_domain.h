...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TIME_DOMAIN_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TIME_DOMAIN_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TIME_DOMAIN_H_
