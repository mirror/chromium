...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_INTRUSIVE_HEAP_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_INTRUSIVE_HEAP_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_INTRUSIVE_HEAP_H_
