...
#ifndef BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TEST_TIME_SOURCE_H_
#define BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TEST_TIME_SOURCE_H_
...
#endif  // BASE_TASK_SCHEDULER_SEQUENCE_MANAGER_TEST_TIME_SOURCE_H_
