...
class BASE_EXPORT SchedulerWorker
 ...
 public:
  ...
  // OnCanDispatchSequence() are called from the thread managed by the
  // SchedulerWorker instance.
  class BASE_EXPORT Delegate : public CanDispatchSequenceObserver {
   public:
    ...
    //
    // TODO(fdoray): Rename to RedispatchSequence() to match TaskTracker
    // terminology.
