...
class TaskSchedulerWorkerPoolTestBeforeStart
    : public TaskSchedulerWorkerPoolTest {
 protected:
  TaskSchedulerWorkerPoolTestBeforeStart() = default;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(TaskSchedulerWorkerPoolTestBeforeStart);
};
...
TEST_P(TaskSchedulerWorkerPoolTestBeforeStart, PostBeforeStart) {
...
INSTANTIATE_TEST_CASE_P(GenericParallel,
                        TaskSchedulerWorkerPoolTestBeforeStart,
                        ::testing::Values(PoolExecutionType{
                            PoolType::GENERIC, test::ExecutionMode::PARALLEL}));
INSTANTIATE_TEST_CASE_P(GenericSequenced,
                        TaskSchedulerWorkerPoolTestBeforeStart,
