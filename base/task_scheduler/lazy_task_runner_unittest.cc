...
LazySequencedTaskRunner g_sequenced_task_runner_user_visible =
    LazySequencedTaskRunner(TaskTraits(TaskPriority::USER_VISIBLE));
LazySequencedTaskRunner g_sequenced_task_runner_user_blocking =
    LazySequencedTaskRunner(TaskTraits(TaskPriority::USER_BLOCKING));

LazySingleThreadTaskRunner g_single_thread_task_runner_user_visible =
    LazySingleThreadTaskRunner(TaskTraits(TaskPriority::USER_VISIBLE));
LazySingleThreadTaskRunner g_single_thread_task_runner_user_blocking =
    LazySingleThreadTaskRunner(TaskTraits(TaskPriority::USER_BLOCKING));

#if defined(OS_WIN)
LazyCOMSTATaskRunner g_com_sta_task_runner_user_visible =
    LazyCOMSTATaskRunner(TaskTraits(TaskPriority::USER_VISIBLE));
LazyCOMSTATaskRunner g_com_sta_task_runner_user_blocking =
    LazyCOMSTATaskRunner(TaskTraits(TaskPriority::USER_BLOCKING));
