...
class BASE_EXPORT TaskTracker {
 public:
  ...
  // |sequence| if it can be rescheduled immediately. If |sequence| is non-
  // empty after popping a task from it but it can't be rescheduled immediately,
  // it will be handed back to |observer| when it can be rescheduled.
