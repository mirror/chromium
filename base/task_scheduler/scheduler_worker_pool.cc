...
void SchedulerWorkerPool::SetCurrentWorkerPool(
    const SchedulerWorkerPool* scheduler_worker_pool) {
  tls_current_worker_pool.Get().Set(scheduler_worker_pool);
}

const SchedulerWorkerPool* SchedulerWorkerPool::GetCurrentWorkerPool() {
...
class SchedulerParallelTaskRunner : public TaskRunner {
 public:
  ...
  bool RunsTasksInCurrentSequence() const override {
    return SchedulerWorkerPool::GetCurrentWorkerPool() == worker_pool_;
  }
