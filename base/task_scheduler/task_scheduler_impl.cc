...
void TaskSchedulerImpl::Start(const TaskScheduler::InitParams& init_params) {
  ...
  // BACKGROUND task when a USER_BLOCKING or USER_VISIBLE task is posted, its
  ...
  // manual inspection of traces show that the number of BACKGROUND tasks posted
  // in parallel is usually low.
