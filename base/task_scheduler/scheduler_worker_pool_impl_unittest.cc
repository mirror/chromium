...
class TaskSchedulerWorkerPoolBlockedUnblockedTest
 ...
 public:
  ...
  // threads may rely on) do not go out of scope before worker threads
  // terminate.
  void TearDown() override {}
...
// suspended workers do not do work.
TEST_F(TaskSchedulerWorkerPoolBlockedUnblockedTest,
  ...
  // Give time for suspended workers to erroneously pick up and begin work.
  PlatformThread::Sleep(TestTimeouts::tiny_timeout());
