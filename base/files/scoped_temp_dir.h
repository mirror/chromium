...
// this class.  (Note, however, that by default CreateUniqueTempDir creates the
// directory in a location that is automatically cleaned up by the system on
// reboot, or at other appropriate times.)
//
