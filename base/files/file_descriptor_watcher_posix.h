 ...
 public:
  ...
  class Controller {
   ...
   private:
    ...
    // Set in ~Controller. Allows |watcher_| to know that its associated
  ...
  // sequence). |fd| must not be closed before the returned Controller is
  // deleted. To call these methods, a FileDescriptorWatcher must have been
