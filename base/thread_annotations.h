...
//
// E.g. we use EXCLUSIVE_LOCKS_REQUIRED where the Clang docs use REQUIRES.
//
...
#if defined(__clang__) && __has_attribute(unlock_function)
#define THREAD_ANNOTATION_ATTRIBUTE__(x) __attribute__((x))
#else
#define THREAD_ANNOTATION_ATTRIBUTE__(x)  // no-op
#endif  // defined(__clang__) && __has_attribute(unlock_function)
