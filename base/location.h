...
class BASE_EXPORT Location {
 public:
  ...
  // TODO(brettw) remove file name from this constructor.
  ...
  // names are disabled (most release builds).
  ...
  // are disabled (most release builds).
...
// TODO(brettw) remove the __FILE__ argument from these calls.
#define FROM_HERE \
