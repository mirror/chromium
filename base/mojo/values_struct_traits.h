...
#ifndef BASE_MOJO_VALUES_STRUCT_TRAITS_H_
#define BASE_MOJO_VALUES_STRUCT_TRAITS_H_

#include <vector>

#include "base/mojo/values.mojom.h"
...
struct UnionTraits<base::mojom::ValueDataView, base::Value> {
  static bool IsNull(const base::Value& value) {
    return value.type() == base::Value::Type::NONE;
  }

  static void SetToNull(base::Value* value) { *value = base::Value(); }
...
#endif  // BASE_MOJO_VALUES_STRUCT_TRAITS_H_
