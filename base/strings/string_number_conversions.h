...
// This ridiculousness is needed because compilers disagree on whether long and
// long long match any of the explictly sized standard integer types. So
// instead, use SFINAE to select the right function depending on the width and
// signedness of the parameter.
template <typename T,
