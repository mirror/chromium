...
// "long long" has the same problem as size_t above except on more compilers.
// In this case we can forward to the 64-bit versions.
/*
 * TODO(brettw) previous definition. This caught everything but Windows.
 * MSVC needs it removed, Clang ones need it added.
...
static_assert(sizeof(unsigned long long) <= sizeof(uint64_t),
              "Expecting unsigne dlong long == uint64_t");
