...
// These functions (in particular the "double" variant) converts to a string
// format that ignores the locale. If you want to use locale specific
// formatting, use ICU.
BASE_EXPORT std::string NumberToString(int value);
BASE_EXPORT std::string NumberToString(unsigned value);
...
BASE_EXPORT base::string16 NumberToString16(int value);
BASE_EXPORT base::string16 NumberToString16(unsigned value);
