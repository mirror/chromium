...
// "long long" and "unsigned long long" are different types as int64_t and
// uint64_t on 64-bit platforms, but they're the same on 32-bit ones. Provide
// overrides for these that forward so callers don't have to cast.
