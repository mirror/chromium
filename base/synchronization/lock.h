...
//
// Other POSIX platforms can mitigate priority inversion the same way as Mac,
...
// variable is signaled. This is not an issue since Chrome does not support
// versions of glibc prior to 2.17.
