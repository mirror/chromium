...
struct AssertConstructible<true, i, Arg, Unwrapped, Param> {
 private:
...
template <size_t i, typename Arg, typename Unwrapped, typename Param>
struct AssertConstructible<false, i, Arg, Unwrapped, Param> {
 private:
...
struct AssertBindArgsValidity<is_once,
                              ...
                              TypeList<Unwrapped...>,
                              TypeList<Params...>>
    : AssertConstructible<is_once, Ns, Args, Unwrapped, Params>... {
