...
class BASE_EXPORT ProcessMemoryTotals {
 public:
  ...
  //
  // TODO(ajwong): Make this into a union so we don't have random uninitialized
  // fields that are semantically confusing.
  ...
  // TODO(ajwong): Remove this information hiding leak.
