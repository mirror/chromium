...
#elif defined(NCTEST_BINDONCE_MOVEONLY_TYPE_BY_VALUE)  // [r"fatal error: static_assert failed \"Bound argument \|i\| is move-only, but is being passed by copy\. Did you forget std::move\(\)\?\""]
...
#elif defined(NCTEST_BIND_MOVEONLY_TYPE_BY_VALUE)  // [r"fatal error: static_assert failed \"Bound argument \|i\| is move-only, but is being passed by copy\. Are you using std::move\(\) instead of base::Passed\(\)\?\""]
...
#elif defined(NCTEST_BIND_MOVEONLY_TYPE_WITH_STDMOVE)  // [r"fatal error: static_assert failed \"Bound argument \|i\| is move-only, but is being passed by copy\. Are you using std::move\(\) instead of base::Passed\(\)\?\""]
