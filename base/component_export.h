...
// Expands to a comma (,) iff |x| expands to |1|. Used in conjunction with
// |COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_()|, as the presence or absense of an
// extra comma can be used to conditionally shift subsequent argument positions
// and thus influence which argument is selected.
...
// |COMPONENT_MACRO_CONDITIONAL_VALUE_()| above to implement conditional macro
// expansion.
