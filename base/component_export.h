...
// argument if given; otherwise expands to |0|. Used in conjunction with
...
// a sequence of tokens |"", 1|, and turns any other value into
...
#define COMPONENT_MACRO_TEST_VALUE_RESULT_1_ "", 1
