...
dict_iterator::pointer::pointer(const pointer& ptr) : ref_(ptr.ref_) {}

dict_iterator::dict_iterator(DictStorage::iterator dict_iter)
    : dict_iter_(dict_iter) {}

dict_iterator::dict_iterator(const dict_iterator& dict_iter) {
...
const_dict_iterator::pointer::pointer(const pointer& ptr) : ref_(ptr.ref_) {}
