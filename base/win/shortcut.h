...
struct BASE_EXPORT ShortcutProperties {
  enum IndividualProperties {
    ...
    PROPERTIES_ALL = PROPERTIES_TARGET | PROPERTIES_WORKING_DIR |
                     ...
                     PROPERTIES_DUAL_MODE | PROPERTIES_CLSID
  };
  ...
  void set_clsid(CLSID clsid_in) {
    clsid = clsid_in;
    options |= PROPERTIES_CLSID;
  }
  ...
  bool dual_mode;
  // CLSID of the COM object registered with the OS via the shortcut (Win10
  // version 1607, build 14393, and beyond).
  CLSID clsid;
