...
#define CHROME_DECLARE_HANDLE(name) struct name##__; typedef struct name##__ *name
...
WINBASEAPI _Releases_exclusive_lock_(*SRWLock)
...
WINBASEAPI _Check_return_ _Post_equals_last_error_
