...
//
// However, LLD will place custom sections names after the main .text section,
// meaning that the code below will be in the same segment as .text, only after
// it. In this case, lld will also provide a __start_[section name], but the
// section must not be empty, so we can use the same function.
