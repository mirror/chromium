...
def GetPkgAndClassName(fully_qualified_class):
  """Returns a string of the Java package and class."""
...
def GetRegistrationFunctionName(fully_qualified_class):
  ...
  return 'RegisterNative' + GetPkgAndClassName(fully_qualified_class)
...
""")
  ...
  def SubstituteNativeMethods(self, template):
    ...
    for clazz in all_classes:
      ...
      namespace_str = ''
      namespace_template = Template('${NAMESPACE}::')
      if self.namespace:
        value = {'NAMESPACE': self.namespace}
        namespace_str = namespace_template.substitute(value)
      if kmethods:
...
""")
  ...
  # TODO: Remove this function when deleting original registers.
  ...
  def GetOriginalRegisterNativesString(self):
    ...
    return """
// TODO: Remove these empty registration functions and functions calling them.
// https://crbug.com/683256.
...
""")
  ...
  def GetStubName(self, native):
    ...
    java_name = GetPkgAndClassName(self.fully_qualified_class)
