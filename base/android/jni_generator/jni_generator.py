...
class HeaderFileGeneratorHelper(object):
  ...
  def GetClassPathDefinitions(self, classes, declare_only=False):
...
extern const char kClassPath_${JAVA_CLASS}[];""")
      ...
      template = Template("""\
JNI_REGISTRATION_EXPORT const char kClassPath_${JAVA_CLASS}[] = \
"${JNI_CLASS_PATH}";""")
...
""")
  ...
  def GetClassPathDefinitionsString(self):
    ...
    ret = [self.helper.GetClassPathDefinitions(classes)]
    return '\n'.join(ret)
