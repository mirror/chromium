...
public class ApiCompatibilityUtils {
    ...
    public static void setStatusBarColor(Window window, int statusBarColor) {
        ...
        // This benefits battery usage on L and M, however this no longer provides a battery benefit
        // as of N and starts to cause flicker bugs on O, so don't bother on O and up.
