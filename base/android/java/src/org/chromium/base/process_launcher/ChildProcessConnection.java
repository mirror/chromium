...
public class ChildProcessConnection {
    ...
    private static class ConnectionParams {
        ...
        final List<IBinder> mCallbacks;

        ConnectionParams(Bundle connectionBundle, List<IBinder> callbacks) {
     ...
     * @param callbacks optional client specified callbacks that the child can use to communicate
     *                 with the parent process
     * @param connectionCallback will be called exactly once after the connection is set up or the
     *                           setup fails
     */
    public void setupConnection(Bundle connectionBundle, @Nullable List<IBinder> callbacks,
        ...
        try {
            ...
            mConnectionParams = new ConnectionParams(connectionBundle, callbacks);
