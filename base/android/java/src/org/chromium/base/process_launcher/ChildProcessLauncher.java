...
public class ChildProcessLauncher {
    ...
    // The IBinder instances provided to the created service.
    private final List<IBinder> mIBinderCallbacks;
     ...
     * @param binderCallbacks the callbacks that should be passed to the started process.
     */
    ...
    public ChildProcessLauncher(Handler launcherHandler, Delegate delegate, String[] commandLine,
        ...
        mIBinderCallbacks = binderCallbacks;
    }
    ...
    private void setupConnection() {
        ...
        mConnection.setupConnection(connectionBundle, getIBinderCallbacks(), connectionCallback);
    }
    ...
    public List<IBinder> getIBinderCallbacks() {
        return mIBinderCallbacks;
    }
