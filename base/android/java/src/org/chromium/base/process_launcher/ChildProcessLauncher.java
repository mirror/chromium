...
public class ChildProcessLauncher {
    ...
    public abstract static class Delegate {
         ...
         * already bound connection if it has one. (allowing to have warm-up connections:
         * connections that were already bound, to speed up child process start-up time).
         ...
         * connection should be allocated and bound.
         */
