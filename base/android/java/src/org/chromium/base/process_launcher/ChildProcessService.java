...
public abstract class ChildProcessService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        // Otherwise the system may keep it around and available for a econnect. The child processes
        // do not currently support reconnect; they must be initialized from scratch every time.
        stopSelf();
