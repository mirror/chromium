...
public class ChildProcessServiceImpl {
    ...
    private final Handler mApplicationThreadHandler = new Handler(Looper.getMainLooper());
    ...
    public IBinder bind(Intent intent, int authorizedCallerUid) {
        ...
        // Don't block bind() with any extra work, post it to happen later.
        mApplicationThreadHandler.post(new Runnable() {
            @Override
            public void run() {
