...
void RunCallbackAndroid(const JavaRef<jobject>& callback,
  ...
  Java_Callback_onResultFromNativeV_OCBC_JLO(
      base::android::AttachCurrentThread(), callback, arg);
}

void RunCallbackAndroid(const JavaRef<jobject>& callback, bool arg) {
  Java_Callback_onResultFromNativeV_OCBC_Z(base::android::AttachCurrentThread(),
                                           callback,
                                           static_cast<jboolean>(arg));
}

void RunCallbackAndroid(const JavaRef<jobject>& callback, int arg) {
  Java_Callback_onResultFromNativeV_OCBC_I(base::android::AttachCurrentThread(),
                                           callback, arg);
}
...
void RunCallbackAndroid(const JavaRef<jobject>& callback,
  ...
  Java_Callback_onResultFromNativeV_OCBC_AB(env, callback, j_bytes);
}
