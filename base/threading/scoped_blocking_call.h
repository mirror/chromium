...
class BASE_EXPORT ScopedBlockingCall {
 ...
 private:
  ...
  // Previous ScopedBlockingCall instantiated on this thread that caused
  // BlockingObserver::BlockingScopeEntered() to be called.
  ScopedBlockingCall* const previous_scoped_blocking_call_to_notify_observer_;
