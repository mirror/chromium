...
void PlatformThread::SetName(const std::string& name) {
  // TODO(fuchsia): There's not yet an available API to set the thread name for
  // the debugger. See https://crbug.com/725726.
  return ThreadIdNameManager::GetInstance()->SetName(pthread_self(), name);
}
