...
#define EMPTY_BODY_IS_DCHECK_IS_OFF
#else
...
INLINE_IF_DCHECK_IS_OFF void AssertBlockingAllowed()
    EMPTY_BODY_IS_DCHECK_IS_OFF;

// Disallows blocking on the current thread.
INLINE_IF_DCHECK_IS_OFF void DisallowBlocking();

// Disallows blocking calls within its scope.
class BASE_EXPORT ScopedDisallowBlocking {
 public:
  ScopedDisallowBlocking() EMPTY_BODY_IS_DCHECK_IS_OFF;
  ~ScopedDisallowBlocking() EMPTY_BODY_IS_DCHECK_IS_OFF;
...
class BASE_EXPORT ScopedAllowBlocking {
 private:
  ...
  // in unit tests instead to avoid the friend requirement.
  FRIEND_TEST_ALL_PREFIXES(ThreadRestrictionsTest, ScopedAllowBlocking);
  friend class ScopedAllowBlockingForTesting;

  ScopedAllowBlocking() EMPTY_BODY_IS_DCHECK_IS_OFF;
  ~ScopedAllowBlocking() EMPTY_BODY_IS_DCHECK_IS_OFF;
...
class BASE_EXPORT ScopedAllowBaseSyncPrimitives {
 private:
  ...
  ScopedAllowBaseSyncPrimitives() EMPTY_BODY_IS_DCHECK_IS_OFF;
  ~ScopedAllowBaseSyncPrimitives() EMPTY_BODY_IS_DCHECK_IS_OFF;
...
class BASE_EXPORT ScopedAllowBaseSyncPrimitivesForTesting {
 public:
  ScopedAllowBaseSyncPrimitivesForTesting() EMPTY_BODY_IS_DCHECK_IS_OFF;
  ~ScopedAllowBaseSyncPrimitivesForTesting() EMPTY_BODY_IS_DCHECK_IS_OFF;
