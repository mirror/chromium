...
//
// Style tip: where should you put AssertBlockingAllowed() checks? It's best if
// you put them as close to the blocking call as possible. For example:
//   One()
//     Two()
//       ReadFile()
//         fopen()
//     Three()
// AssertBlockingAllowed() should be in ReadFile() just before the fopen() call.
