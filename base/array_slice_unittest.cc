...
TEST(ArraySliceTest, SubSlice) {
  ...
  EXPECT_EQ(suffix, slice.subslice(4));
}
...
TEST(ArraySliceTest, OperatorEQ) {
  ...
  EXPECT_EQ(vec3, ArraySlice<int>(vec3));
}

TEST(ArraySliceTest, OperatorNE) {
  std::vector<int> vec3 = {0, 1, 2};
  std::vector<int> vec4 = {0, 1, 2, 3};
  EXPECT_NE(vec3, ArraySlice<int>(vec4));
}

TEST(ArraySliceTest, OperatorLT) {
  std::vector<int> vec3 = {0, 1, 2};
  std::vector<int> vec4 = {0, 1, 2, 3};
  EXPECT_LT(vec3, ArraySlice<int>(vec4));
}

TEST(ArraySliceTest, OperatorGT) {
  std::vector<int> vec3 = {0, 1, 2};
  std::vector<int> vec4 = {0, 1, 2, 3};
  EXPECT_GT(vec4, ArraySlice<int>(vec3));
}

TEST(ArraySliceTest, OperatorLE) {
  std::vector<int> vec3 = {0, 1, 2};
  std::vector<int> vec4 = {0, 1, 2, 3};
  EXPECT_LE(vec3, ArraySlice<int>(vec3));
  EXPECT_LE(vec3, ArraySlice<int>(vec4));
}

TEST(ArraySliceTest, OperatorGE) {
  std::vector<int> vec3 = {0, 1, 2};
  std::vector<int> vec4 = {0, 1, 2, 3};
  EXPECT_GE(vec3, ArraySlice<int>(vec3));
  EXPECT_GE(vec4, ArraySlice<int>(vec3));
}
