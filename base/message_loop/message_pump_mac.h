...
// Returns an opaque object that, while in scope, permits posted tasks to be
// run in private AppKit run loop modes that would otherwise make the UI
// unresponsive. E.g., menu fade out.
