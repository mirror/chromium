...
class BASE_EXPORT IncomingTaskQueue
 ...
 private:
  ...
  class InitialTaskQueuePolicy : public RemoveOnlyQueue {
   public:
    InitialTaskQueuePolicy(IncomingTaskQueue* outer);
    ~InitialTaskQueuePolicy() override;
  ...
  class DelayedTaskQueuePolicy : public Queue {
   public:
    DelayedTaskQueuePolicy(IncomingTaskQueue* outer);
    ~DelayedTaskQueuePolicy() override;
  ...
  class DeferredTaskQueuePolicy : public Queue {
   public:
    DeferredTaskQueuePolicy(IncomingTaskQueue* outer);
    ~DeferredTaskQueuePolicy() override;
  ...
  InitialTaskQueuePolicy initial_tasks_;
  DelayedTaskQueuePolicy delayed_tasks_;
  DeferredTaskQueuePolicy deferred_tasks_;
