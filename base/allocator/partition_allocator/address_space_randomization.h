...
constexpr uintptr_t kASLRMask = AslrAddress(0x007fffffffffUL);
constexpr uintptr_t kASLROffset = AslrAddress(0x7e8000000000UL);
#elif defined(OS_WIN)
...
constexpr uintptr_t kASLROffset = AslrAddress(0x1000000000UL);
...
constexpr uintptr_t kASLROffset = AslrAddress(0x400000000000UL);
...
constexpr uintptr_t kASLROffset = AslrAddress(0x80000000UL);
#elif defined(OS_AIX)
// The range 0x30000000 - 0xD0000000 is available on AIX;
// choose the upper range.
constexpr uintptr_t kASLROffset = AslrAddress(0x90000000UL);
#else   // !defined(OS_SOLARIS) && !defined(OS_AIX)
// The range 0x20000000 - 0x60000000 is relatively unpopulated across a
// variety of ASLR modes (PAE kernel, NX compat mode, etc) and on macos
// 10.6 and 10.7.
constexpr uintptr_t kASLROffset = AslrAddress(0x20000000UL);
