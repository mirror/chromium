...
#define ASLR_MASK(bits) \
  ((1UL << static_cast<size_t>(bits)) - 1) & kPageAllocationGranularityBaseMask

#if defined(ARCH_CPU_64_BITS)
#if defined(MEMORY_TOOL_REPLACES_ALLOCATOR)
// This range is copied from the TSan source, but works for all tools.
static const size_t kASLRMask =
    0x007fffffffffUL & kPageAllocationGranularityBaseMask;
static const size_t kASLROffset =
    0x7e8000000000UL & kPageAllocationGranularityBaseMask;
#elif defined(OS_WIN)
static const size_t kASLRMask = ASLR_MASK(48);
static const size_t kASLRMaskBefore8_10 = ASLR_MASK(44);
