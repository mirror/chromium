...
// Reserves address space equal to 'size' bytes. This can be used to make it
// more likely that large allocations will succeed. Returns true if the
// reservation succeeded, false if the reservation failed or a reservation was
// already made.
