...
// Calls the global handler for a memory allocation failure. This may release
// reserved address space, allowing a retry of the allocation to succeed.
BASE_EXPORT void OnAllocFailure(size_t size);
