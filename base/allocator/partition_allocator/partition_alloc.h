...
struct PartitionPage {
  ...
  // Pointer maniupulation functions. These must be static as the input |page|
  ...
  ALWAYS_INLINE static bool PartitionPage::IsPointerValid(PartitionPage* page);
