...
class LinearHistogram::Factory : public Histogram::Factory {
 ...
 protected:
  ...
  void FillHistogram(HistogramBase* base_histogram) override {
    ...
    // Normally, |histogram| should have type LINEAR_HISTOGRAM or be inherited
    // from it. However, if it's expired, it will actually be a DUMMY_HISTOGRAM.
    // Skip filling in that case.
