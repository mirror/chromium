...
TEST_P(StatisticsRecorderTest, ToJSON) {
  ...
  std::string json(StatisticsRecorder::ToJSON(base::JSONVerbosityLevel::kFull));
  ...
  json = StatisticsRecorder::ToJSON(base::JSONVerbosityLevel::kSkipBuckets);
  ...
  // Bucket information should be skipped.
