...
TEST_P(StatisticsRecorderTest, WithName) {
  ...
  EXPECT_THAT(WithName(histograms, ""), SizeIs(3));
  EXPECT_THAT(WithName(histograms, "Test"), SizeIs(3));
  EXPECT_THAT(WithName(histograms, "1"), SizeIs(1));
  EXPECT_THAT(WithName(histograms, "hello"), IsEmpty());
}
