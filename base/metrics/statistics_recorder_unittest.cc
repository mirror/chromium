...
TEST_P(StatisticsRecorderTest, NotInitialized) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetBucketRanges(),
              testing::UnorderedElementsAre(ranges));
}
...
TEST_P(StatisticsRecorderTest, RegisterBucketRanges) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetBucketRanges(),
              testing::UnorderedElementsAre(ranges1, ranges2));
...
TEST_P(StatisticsRecorderTest, RegisterHistogram) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetHistograms(), testing::ElementsAre());

  // Register the Histogram.
  EXPECT_EQ(histogram1,
            StatisticsRecorder::RegisterOrDeleteDuplicate(histogram1));
  EXPECT_THAT(StatisticsRecorder::GetHistograms(),
              testing::ElementsAre(histogram1));
  ...
  EXPECT_THAT(StatisticsRecorder::GetHistograms(),
              testing::ElementsAre(histogram3, histogram1));
}
...
TEST_P(StatisticsRecorderTest, GetSnapshot) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetSnapshot("Test"), testing::SizeIs(3));
  EXPECT_THAT(StatisticsRecorder::GetSnapshot("1"), testing::SizeIs(1));
  EXPECT_THAT(StatisticsRecorder::GetSnapshot("hello"), testing::SizeIs(0));
}
...
TEST_P(StatisticsRecorderTest, RegisterHistogramWithFactoryGet) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetHistograms(),
              testing::ElementsAre(histogram1, histogram3));
  ...
  EXPECT_THAT(StatisticsRecorder::GetHistograms(),
              testing::ElementsAre(histogram4, histogram1, histogram3));
  ...
  EXPECT_THAT(
      ...
      testing::ElementsAre(histogram4, histogram5, histogram1, histogram3));
}
...
TEST_P(StatisticsRecorderTest, RegisterHistogramWithMacros) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetHistograms(), testing::SizeIs(3));
}

TEST_P(StatisticsRecorderTest, BucketRangesSharing) {
  EXPECT_THAT(StatisticsRecorder::GetBucketRanges(), testing::SizeIs(0));
  ...
  EXPECT_THAT(StatisticsRecorder::GetBucketRanges(), testing::SizeIs(1));

  Histogram::FactoryGet("Histogram3", 1, 64, 16, HistogramBase::kNoFlags);
  EXPECT_THAT(StatisticsRecorder::GetBucketRanges(), testing::SizeIs(2));
}
...
TEST_P(StatisticsRecorderTest, IterationTest) {
  ...
  EXPECT_THAT(StatisticsRecorder::GetKnownHistograms(true), testing::SizeIs(2));
  EXPECT_THAT(StatisticsRecorder::GetKnownHistograms(false),
              testing::SizeIs(use_persistent_histogram_allocator_ ? 0 : 2));
  ...
  EXPECT_THAT(StatisticsRecorder::GetKnownHistograms(true),
              testing::SizeIs(use_persistent_histogram_allocator_ ? 2 : 0));
