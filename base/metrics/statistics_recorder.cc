...
StatisticsRecorder::Histograms Sort(StatisticsRecorder::Histograms histograms) {
  std::sort(histograms.begin(), histograms.end(), &HistogramNameLesser);
  return histograms;
}

StatisticsRecorder::Histograms WithName(
...
StatisticsRecorder::Histograms NonPersistent(
    StatisticsRecorder::Histograms histograms) {
  histograms.erase(
