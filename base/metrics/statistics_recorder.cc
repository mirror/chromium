...
void StatisticsRecorder::PrepareDeltas(
  ...
  auto known = KnownHistograms(include_persistent);
...
void StatisticsRecorder::ValidateAllHistograms() {
  ...
  auto known = KnownHistograms(/*include_persistent=*/true);
...
// static
std::vector<HistogramBase*> StatisticsRecorder::KnownHistograms(
    bool include_persistent) {
