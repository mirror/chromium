...
class BASE_EXPORT StatisticsRecorder {
 public:
  ...
  // Returns the histograms with |query| as a substring as JSON text. The method
  // may serialize only a subset of histograms to reduce memory pressure.
  static std::string ToJSON(bool lossy);
