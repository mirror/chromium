...
class BASE_EXPORT StatisticsRecorder {
 public:
  ...
  // method must be called before any threads have started.
  // Record checker methods can be called on any thread, so they shouldn't
  // mutate any state.
  // TODO(iburak): describe a way to use this functionality.
  ...
  // If the record checker is not set, returns false.
