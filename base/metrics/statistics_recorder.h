...
class BASE_EXPORT StatisticsRecorder {
 public:
  ...
  // Must be deleted in reverse order of creation.
  ~StatisticsRecorder();
  ...
  // Finds a histogram by name. It matches the exact name. Returns a null
  ...
  // Copies some of the pointers to registered histograms into the caller
  // supplied Histograms. Only histograms which have |query| as a substring are
  // copied. An empty query will copy all registered histograms.
  //
  // This method is thread safe.
 ...
 private:
  ...
  // Constructs a new StatisticsRecorder and sets it as the current recorder.
  ...
  // Previous StatisticsRecorder that existed when this one was created.
