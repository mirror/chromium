...
// In-memory repository of Chrome Metrics.
//
// Most of the methods of this class are static and act on a global
// StatisticsRecorder. This global recorder must first be initialized using
// StatisticsRecorder::Initialize() before being used. This global recorder is
// internally synchronized and all the static methods are thread safe.
class BASE_EXPORT StatisticsRecorder {
 public:
  ...
  // Must be deleted in reverse order of creation. Restores the previous global
  // recorder.
  //
 ...
 private:
  ...
  //
  // Precondition: The global lock is already acquired.
  static void InitLogOnShutdownWithoutLock();
