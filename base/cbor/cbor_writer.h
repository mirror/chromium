...
class BASE_EXPORT CBORWriter {
 ...
 private:
  // Encodes the type of the data being added into the initial byte.
  void InitialByteSetType(CborMajorType type);

  // Encodes the additional information for the data.
  void InitialByteSetAdditionalInformation(uint8_t additional_information);
