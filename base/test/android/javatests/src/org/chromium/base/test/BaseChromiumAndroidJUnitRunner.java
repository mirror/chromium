...
public class BaseChromiumAndroidJUnitRunner extends AndroidJUnitRunner {
    ...
    /**
     * The following argument are corresponding to AndroidJUnitRunner command line arguments.
     * `annotation`: run with only the argument annotation
     * `notAnnotation`: run all exception the argument annotation
    ...
    private void listTests() {
        ...
        try {
            ...
            //
            // Test logging and execution will be handled by BaseJUnit4ClassRunner,
            // having log only argument here would cause parent JUnit runner to use its
            // own log-only class runner instead of BaseJUnit4ClassRunner.
