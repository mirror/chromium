...
public class ScreenShooter extends TestWatcher {
    ...
    public ScreenShooter() {
        ...
        if (mModel.toUpperCase(Locale.ROOT).contains("SDK")) {
            ...
            if (InstrumentationRegistry.getContext().getResources().getConfiguration().orientation
                ...
                mModel = "Emulator_" + mDevice.getDisplayHeight() + '_' + mDevice.getDisplayWidth();
            } else {
                mModel = "Emulator_" + mDevice.getDisplayWidth() + '_' + mDevice.getDisplayHeight();
            }
        }
    }
