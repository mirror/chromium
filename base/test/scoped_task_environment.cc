...
void ScopedTaskEnvironment::RunUntilIdle() {
  for (;;) {
    ...
    // external code exited the RunLoop and that the MessageLoop and
    // TaskScheduler queues might not be empty. Run the loop again to make sure
    // that no task remains.
