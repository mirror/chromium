...
HistogramTester::HistogramTester() {
  ...
  backup_record_checker_.reset(StatisticsRecorder::GetRecordChecker());
  StatisticsRecorder::SetRecordChecker(
      std::make_unique<const DummyRecordChecker>());
}

HistogramTester::~HistogramTester() {
  StatisticsRecorder::SetRecordChecker(std::move(backup_record_checker_));
}
