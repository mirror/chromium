...
struct ComputeThenPromise {
  ...
  using Promise = Promise<ThenResolve, ThenReject>;
  using ConstructWith = AbstractPromise::ConstructWith<ThenResolve, ThenReject>;
};
...
// Helper used to determine the return type of a promise::All
template <typename... Promises>
struct AllPromiseHelper {
  using ThenResolve = std::tuple<ToNonVoidT<typename Promises::ResolveT>...>;
  using ThenReject =
      typename UnionOfVarArgTypes<typename Promises::RejectT...>::type;
  using ThenPromise = Promise<ThenResolve, ThenReject>;
};

// Helper used to determine the return type of a promise::Race
template <typename... Promises>
