...
struct BASE_EXPORT AssignHelper<PromiseResult<Resolve, Reject>, RejectStorage> {
...
template <typename Resolve, typename Reject, typename RejectStorage>
struct BASE_EXPORT AssignHelper<Promise<Resolve, Reject>, RejectStorage> {
...
template <typename ResolveOnceCallback,
          ...
          typename ArgReject,
          typename RejectStorage>
class BASE_EXPORT AbstractPromiseExecutor : public AbstractPromise::Executor {
 public:
