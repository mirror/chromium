...
//    std::tuple<base::Variant<Resolve<T>, RejectValue>...>
//
...
class Promise {
 ...
 public:
  ...
  template <typename R>
  Promise<R> Catch(OnceCallback<Promise<R>(const RejectValue&)> on_reject);
  ...
  template <typename R>
  Promise<R> Catch(OnceCallback<R(const RejectValue&)> on_reject);
 ...
 public:
  ...
  Promise<R> Catch(
    ...
    return Promise<R>(new ChainedPromise<R, void>(
        nullopt, nullptr, {internal_promise_},
        OnceCallback<PromiseResult<R>()>(), std::move(on_reject)));
  }
  ...
  Promise<R> Catch(
      ...
      OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject) {
    return Promise<R>(new ChainedPromise<R, void>(
        from_here, nullptr, {internal_promise_},
        OnceCallback<PromiseResult<R>()>(), std::move(on_reject)));
  }
  ...
  Promise<R> Catch(
      ...
      OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject) {
    return Promise<R>(new ChainedPromise<R, void>(
        from_here, task_runner, {internal_promise_},
        OnceCallback<PromiseResult<R>()>(), std::move(on_reject)));
  }
  ...
  Promise<R> Catch(OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
    return Promise<R>(new CurringPromise<R, void>(
        nullopt, nullptr, {internal_promise_}, OnceCallback<Promise<R>()>(),
        std::move(on_reject)));
  }
  ...
  Promise<R> Catch(const Location& from_here,
                   OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
    return Promise<R>(new CurringPromise<R, void>(
        from_here, nullptr, {internal_promise_}, OnceCallback<Promise<R>()>(),
        std::move(on_reject)));
  }
  ...
  Promise<R> Catch(const Location& from_here,
    ...
    return Promise<R>(new CurringPromise<R, void>(
        from_here, task_runner, {internal_promise_},
        OnceCallback<Promise<R>()>(), std::move(on_reject)));
  }
  ...
  Promise<R> Catch(OnceCallback<R(const RejectValue&)> on_reject) {
    return Promise<R>(new NoRejectChainedPromise<R, void>(
        nullopt, nullptr, {internal_promise_}, OnceCallback<R()>(),
        std::move(on_reject)));
  }
  ...
  Promise<R> Catch(const Location& from_here,
                   OnceCallback<R(const RejectValue&)> on_reject) {
    return Promise<R>(new NoRejectChainedPromise<R, void>(
        from_here, nullptr, {internal_promise_}, OnceCallback<R()>(),
        std::move(on_reject)));
  }
  ...
  Promise<R> Catch(const Location& from_here,
                   ...
                   OnceCallback<R(const RejectValue&)> on_reject) {
    return Promise<R>(new NoRejectChainedPromise<R, void>(
        from_here, task_runner, {internal_promise_}, OnceCallback<R()>(),
        std::move(on_reject)));
  }
  ...
  Promise<R> Then(OnceCallback<PromiseResult<R>()> on_resolve,
                  OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject =
                      OnceCallback<PromiseResult<R>(const RejectValue&)>()) {
    return Promise<R>(new ChainedPromise<R, void>(
        nullopt, nullptr, {internal_promise_}, std::move(on_resolve),
        std::move(on_reject)));
  }
  ...
  Promise<R> Then(const Location& from_here,
                  ...
                  OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject =
                      OnceCallback<PromiseResult<R>(const RejectValue&)>()) {
    return Promise<R>(new ChainedPromise<R, void>(
        from_here, nullptr, {internal_promise_}, std::move(on_resolve),
        std::move(on_reject)));
  }
  ...
  // parent promise is resolved or rejected.  |on_resolve| cant reject.
  void Finally(OnceClosure finally_callback) {
    new FinallyPromise(nullopt, nullptr, {internal_promise_},
  ...
  // resolved or rejected and all Thens have executed.
  void Finally(const Location& from_here, OnceClosure finally_callback) {
    new FinallyPromise(from_here, nullptr, {internal_promise_},
                       std::move(finally_callback));
  }
  ...
  void Finally(const Location& from_here,
               OnceClosure finally_callback,
               scoped_refptr<SequencedTaskRunner>& task_runner) {
    new FinallyPromise(from_here, std::move(task_runner), {internal_promise_},
                       std::move(finally_callback));
  }
...
Promise<R> Promise<T>::Catch(
  ...
  return Promise<R>(new ChainedPromise<R, T>(
      nullopt, nullptr, {internal_promise_},
      OnceCallback<PromiseResult<R>(T)>(), std::move(on_reject)));
}
...
template <typename T>
template <typename R>
Promise<R> Promise<T>::Catch(OnceCallback<R(const RejectValue&)> on_reject) {
  return Promise<R>(new NoRejectChainedPromise<R, T>(
      nullopt, nullptr, {internal_promise_}, OnceCallback<R(T)>(),
      std::move(on_reject)));
}
...
Promise<R> Promise<T>::Catch(const Location& from_here,
                             OnceCallback<R(const RejectValue&)> on_reject) {
  return Promise<R>(new NoRejectChainedPromise<R, T>(
      from_here, nullptr, {internal_promise_}, OnceCallback<R(T)>(),
      std::move(on_reject)));
}
...
Promise<R> Promise<T>::Catch(const Location& from_here,
                             ...
                             OnceCallback<R(const RejectValue&)> on_reject) {
  return Promise<R>(new NoRejectChainedPromise<R, T>(
      from_here, task_runner, {internal_promise_}, OnceCallback<R(T)>(),
      std::move(on_reject)));
}
...
Promise<R> Promise<T>::Catch(
    OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
  return Promise<R>(new CurringPromise<R, T>(
      nullopt, nullptr, {internal_promise_}, OnceCallback<Promise<R>()>(),
      std::move(on_reject)));
}
...
Promise<R> Promise<T>::Catch(
    ...
    OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
  return Promise<R>(new CurringPromise<R, T>(
      from_here, task_runner, {internal_promise_}, OnceCallback<Promise<R>()>(),
      std::move(on_reject)));
}
...
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new ChainedPromise<R, T>(nullopt, nullptr, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
...
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new ChainedPromise<R, T>(from_here, nullptr, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
template <typename T>
template <typename R>
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<PromiseResult<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new ChainedPromise<R, T>(from_here, task_runner, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
...
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new CurringPromise<R, T>(nullopt, nullptr, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
...
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new CurringPromise<R, T>(from_here, nullptr, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
...
Promise<R> Promise<T>::Then(
    ...
    OnceCallback<Promise<R>(const RejectValue&)> on_reject) {
  return Promise<R>(
      new CurringPromise<R, T>(from_here, task_runner, {internal_promise_},
                               std::move(on_resolve), std::move(on_reject)));
}
...
struct promise {
 ...
 public:
  ...
  static auto All(Promises... promises) {
    using ReturnType =
        std::tuple<Variant<typename UnwrapPromise<Promises>::non_void_type,
                           RejectValue>...>;
