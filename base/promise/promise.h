...
class Promise {
 public:
  ...
  auto Catch(OnceCallback<Result(const RejectValue&)> on_reject) {
    return ThenInternal(nullopt, nullptr, OnceCallback<Result(NonVoidT)>(),
                        std::move(on_reject));
  }
  ...
  auto Then(OnceCallback<Result()> on_resolve,
    ...
    return ThenInternalVoidT(nullopt, nullptr, std::move(on_resolve),
                             std::move(on_reject));
  }
  template <typename Result>
  ...
  auto Then(const Location& from_here,
            ...
            OnceCallback<Result(const RejectValue&)> on_reject =
                OnceCallback<Result(const RejectValue&)>()) {
    return ThenInternalVoidT(from_here, nullptr, std::move(on_resolve),
                             std::move(on_reject));
  }
  template <typename Result>
  auto Then(const Location& from_here,
  ...
  auto Then(const Location& from_here,
            ...
            OnceCallback<Result(const RejectValue&)> on_reject =
                OnceCallback<Result(const RejectValue&)>()) {
    return ThenInternalVoidT(from_here, task_runner, std::move(on_resolve),
                             std::move(on_reject));
  }
  template <typename Result>
  auto Then(const Location& from_here,
 ...
 private:
  ...
  Promise<R> ThenInternal(
    ...
    return Promise<R>(new ChainedPromise<R, NonVoidT>(
  ...
  Promise<R> ThenInternal(
    ...
    return Promise<R>(new CurringPromise<R, NonVoidT>(
        from_here, task_runner, {internal_promise_}, std::move(on_resolve),
        std::move(on_reject)));
  }
  ...
  Promise<R> ThenInternal(Optional<Location> from_here,
    ...
    return Promise<R>(new NoRejectChainedPromise<R, NonVoidT>(
        from_here, task_runner, {internal_promise_}, std::move(on_resolve),
        std::move(on_reject)));
  }
