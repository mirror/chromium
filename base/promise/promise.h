...
class BASE_EXPORT promise {
 public:
   ...
   */
  template <typename P1, typename P2, typename... Promises>
  static typename internal::AllPromiseHelper<P1, P2, Promises...>::ThenPromise
  All(P1 p1, P2 p2, Promises... promises) {
    using ThenResolve =
        typename internal::AllPromiseHelper<P1, P2, Promises...>::ThenResolve;
    using ThenReject =
        typename internal::AllPromiseHelper<P1, P2, Promises...>::ThenReject;
    using ThenPromise =
        typename internal::AllPromiseHelper<P1, P2, Promises...>::ThenPromise;
    ...
    scoped_refptr<internal::AbstractPromise> promise(subtle::AdoptRefIfNeeded(
        new internal::AbstractPromise(
            ...
            internal::AbstractPromise::PrerequisitePolicy::ALL,
            std::vector<scoped_refptr<internal::AbstractPromise>>{
                p1.abstract_promise_, p2.abstract_promise_,
   ...
   */
  template <typename P1, typename P2, typename... Promises>
  static typename internal::RacePromiseHelper<P1, P2, Promises...>::ThenPromise
  Race(P1 p1, P2 p2, Promises... promises) {
    using ThenResolve =
        typename internal::RacePromiseHelper<P1, P2, Promises...>::ThenResolve;
    using ThenReject =
        typename internal::RacePromiseHelper<P1, P2, Promises...>::ThenReject;
    using ThenPromise =
        typename internal::RacePromiseHelper<P1, P2, Promises...>::ThenPromise;
