...
class BASE_EXPORT Promise {
 public:
  ...
  auto Catch(const Location& from_here, OnceCallback<RejectCb> on_reject) {
    DCHECK(abstract_promise_);
    using RejectReturnT = typename CbArgs<RejectCb>::ReturnT;
    using RejectArgT = typename CbArgs<RejectCb>::ArgT;
    ...
    using ThenResolve =
        typename ComputeThenPromise<RejectReturnT, RejectType>::ThenResolve;
    using ThenReject =
        typename ComputeThenPromise<RejectReturnT, RejectType>::ThenReject;

    auto promise = Promise<ThenResolve, ThenReject>(subtle::AdoptRefIfNeeded(
        new internal::AbstractPromise(
            ...
            std::make_unique<internal::AbstractPromiseExecutor<
                RejectReturnT, Variant<void, RejectArgT>,
                Rejected<ThenReject>>>(OnceCallback<RejectReturnT()>(),
                                       std::move(on_reject))),
        internal::AbstractPromise::kRefCountPreference));
    promise.abstract_promise_->ExecuteIfPossible();
    return promise;
  }
  ...
  auto Then(const Location& from_here, OnceCallback<ResolveCb> on_resolve) {
    DCHECK(abstract_promise_);
    using ResolveReturnT = typename CbArgs<ResolveCb>::ReturnT;
    using ResolveArgT = typename CbArgs<ResolveCb>::ArgT;
    ...
    using ThenResolve =
        typename ComputeThenPromise<ResolveReturnT, RejectType>::ThenResolve;
    using ThenReject =
        typename ComputeThenPromise<ResolveReturnT, RejectType>::ThenReject;
    ...
    auto promise = Promise<ThenResolve, ThenReject>(subtle::AdoptRefIfNeeded(
        new internal::AbstractPromise(
            ...
            std::vector<scoped_refptr<internal::AbstractPromise>>{
                abstract_promise_},
            std::make_unique<internal::AbstractPromiseExecutor<
                ResolveReturnT, Variant<ResolveArgT, void>,
                Rejected<ThenReject>>>(std::move(on_resolve),
                                       OnceCallback<ResolveReturnT()>())),
        internal::AbstractPromise::kRefCountPreference));
    promise.abstract_promise_->ExecuteIfPossible();
    return promise;
  }
    ...
    auto promise = Promise<ThenResolve, ThenReject>(subtle::AdoptRefIfNeeded(
        new internal::AbstractPromise(
            ...
            std::vector<scoped_refptr<internal::AbstractPromise>>{
                abstract_promise_},
            std::make_unique<internal::AbstractPromiseExecutor<
                ResolveReturnT, Variant<ResolveArgT, RejectArgT>,
                Rejected<ThenReject>>>(std::move(on_resolve),
                                       std::move(on_reject))),
        internal::AbstractPromise::kRefCountPreference));
    promise.abstract_promise_->ExecuteIfPossible();
 ...
 private:
  ...
  template <typename A, typename B>
  friend struct internal::CurryingExecutorHelper;
  ...
  template <typename CurriedPromiseResolve,
            ...
            typename RejectT>
  struct ComputeThenPromise<
      Promise<CurriedPromiseResolve, CurriedPromiseReject>,
      RejectT> {
  ...
  struct ComputeThenPromise<PromiseResult<ResolveResult, RejectResult>,
                            RejectT> {
    using ThenResolve = ResolveResult;
    using ThenReject =
        typename internal::UnionOfTypes<RejectT, RejectResult>::type;
  };
...
class BASE_EXPORT promise {
 public:
  ...
  static auto All(Promises... promises) {
    using ThenResolve =
        std::tuple<internal::ToNonVoidT<typename Promises::ResolveT>...>;
    using ThenReject = typename internal::UnionOfVarArgTypes<
        typename Promises::RejectT...>::type;
    ...
    return Promise<ThenResolve, ThenReject>(promise);
  }
  ...
  static auto All(const Container& promises) {
    ...
    return ContainerHelper<Container, ContainerT>::AllContainer(promises);
  }
  ...
  static auto Race(Promises... promises) {
    using ThenResolve = typename internal::UnionOfVarArgTypes<
        typename Promises::ResolveT...>::type;
    using ThenReject = typename internal::UnionOfVarArgTypes<
        typename Promises::RejectT...>::type;
  ...
  static auto Race(const Container& promises) {
    using ContainerT = typename Container::value_type;
    return ContainerHelper<Container, ContainerT>::RaceContainer(promises);
  }
  ...
  static Promise<ResolveType, RejectType> Reject(RejectType&& rejected) {
    ...
    DCHECK(success);
    return Promise<ResolveType, RejectType>(promise);
  }
  ...
  static Promise<ResolveType, void> Reject() {
    ...
    DCHECK(success);
    return Promise<ResolveType, void>(promise);
  }
  ...
  static Promise<void, RejectType> Resolve() {
    ...
    DCHECK(success);
    return Promise<void, RejectType>(promise);
  }

 private:
  template <typename Container, typename Resolve, typename Reject>
  struct ContainerHelper<Container, Promise<Resolve, Reject>> {
    static auto RaceContainer(const Container& promises) {
      std::vector<scoped_refptr<internal::AbstractPromise>> prerequistes;
      ...
      auto promise = subtle::AdoptRefIfNeeded(
          new internal::AbstractPromise(
              internal::AbstractPromise::ConstructWith<Resolve, Reject>(),
              nullopt, nullptr, internal::AbstractPromise::State::UNRESOLVED,
              internal::AbstractPromise::PrerequisitePolicy::ANY,
              std::move(prerequistes),
              std::make_unique<internal::RacePromiseExecutor>()),
          internal::AbstractPromise::kRefCountPreference);
      promise->ExecuteIfPossible();
      return Promise<Resolve, Reject>(promise);
    }

    static auto AllContainer(const Container& promises) {
      using ThenResolve = std::vector<internal::ToNonVoidT<Resolve>>;
      std::vector<scoped_refptr<internal::AbstractPromise>> prerequistes;
      prerequistes.reserve(promises.size());
      for (typename Container::const_iterator it = promises.begin();
           it != promises.end(); ++it) {
      ...
      auto promise = subtle::AdoptRefIfNeeded(
          new internal::AbstractPromise(
              internal::AbstractPromise::ConstructWith<ThenResolve, Reject>(),
              nullopt, nullptr, internal::AbstractPromise::State::UNRESOLVED,
              internal::AbstractPromise::PrerequisitePolicy::ALL,
              std::move(prerequistes),
              std::make_unique<
                  internal::AllContainerPromiseExecutor<Resolve>>()),
          internal::AbstractPromise::kRefCountPreference);
      promise->ExecuteIfPossible();
      return Promise<ThenResolve, Reject>(promise);
    }
  };
  ...
  struct ContainerHelper<Container, Variant<Promises...>> {
    static auto RaceContainer(const Container& promises) {
      using ThenResolve = typename internal::UnionOfVarArgTypes<
          typename Promises::ResolveT...>::type;
      using ThenReject = typename internal::UnionOfVarArgTypes<
      ...
      auto promise = subtle::AdoptRefIfNeeded(
          new internal::AbstractPromise(
              internal::AbstractPromise::ConstructWith<ThenResolve,
                                                       ThenReject>(),
              nullopt, nullptr, internal::AbstractPromise::State::UNRESOLVED,
              internal::AbstractPromise::PrerequisitePolicy::ANY,
              std::move(prerequistes),
    ...
    static auto AllContainer(const Container& promises) {
      using ThenResolve = std::vector<typename internal::UnionOfVarArgTypes<
          typename Promises::ResolveT...>::type>;
      using ThenReject = typename internal::UnionOfVarArgTypes<
          typename Promises::RejectT...>::type;
      std::vector<scoped_refptr<internal::AbstractPromise>> prerequistes;
      ...
      auto promise = subtle::AdoptRefIfNeeded(
          new internal::AbstractPromise(
              ...
              std::move(prerequistes),
              std::make_unique<
                  internal::AllVariantContainerPromiseExecutor<ThenResolve>>()),
          internal::AbstractPromise::kRefCountPreference);
      promise->ExecuteIfPossible();
      return Promise<ThenResolve, ThenReject>(promise);
    }
