...
// Implement conditional constexpr copy and move constructors.
// These are constexpr if is_trivially_{copy,move}_constructible<T>::value is
// true respectively.
// If each is true, corresponding constructor is defined as "= default;",
// which inherits constexpr-ness from base class.
// Note that placement-new is prohibited in constexpr.
template <typename T,
          bool = std::is_trivially_copy_constructible<T>::value,
          bool = std::is_trivially_move_constructible<T>::value>
struct OptionalStorage : OptionalStorageBase<T> {
  // This is no-copy/no-move constructible case. Other cases are defined below
  // as spericialization.
