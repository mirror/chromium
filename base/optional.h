...
class OptionalBase {
 ...
 protected:
  ...
  template <class... Args>
  constexpr explicit OptionalBase(base::in_place_t, Args&&... args)
...
class Optional : public internal::OptionalBase<T> {
 public:
  ...
  constexpr Optional(const T& value)
      : internal::OptionalBase<T>(base::in_place, value) {}

  constexpr Optional(T&& value)
      : internal::OptionalBase<T>(base::in_place, std::move(value)) {}
