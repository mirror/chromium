...
void HeadlessShell::OnScreenshotCaptured(
  ...
  DecodeDataAndWriteFile(switches::kScreenshot, kDefaultScreenshotFileName,
                         result->GetData());
}
...
void HeadlessShell::OnPDFCreated(
  ...
  DecodeDataAndWriteFile(switches::kPrintToPDF, kDefaultPDFFileName,
                         result->GetData());
}

void HeadlessShell::DecodeDataAndWriteFile(const std::string& file_path_switch,
