...
class DisableResourceSchedulerTest : public ResourceSchedulerTest {
 public:
  void CustomizeHeadlessBrowserContext(
    ...
    builder.SetUseResourceScheduler(false);
  }
...
class EnableResourceSchedulerTest : public ResourceSchedulerTest {
 public:
  void CustomizeHeadlessBrowserContext(
      HeadlessBrowserContext::Builder& builder) override {
    builder.SetUseResourceScheduler(true);  // The default value.
  }
  ...
  std::vector<std::string> GetExpectedUrls() override {
    std::vector<std::string> expected_urls = {
        ...
        "http://foo.com/frame9",     "http://foo.com/img6",
        "http://foo.com/img10",      "http://foo.com/img11",
