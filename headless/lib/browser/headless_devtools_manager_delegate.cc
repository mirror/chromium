...
void HeadlessDevToolsManagerDelegate::BeginFrame(
  ...
  if (const base::Value* no_update_display_value =
          params->FindKey("noUpdateDisplay")) {
    no_update_display = no_update_display_value->GetBool();
  }
  ...
  headless_contents->BeginFrame(frame_timeticks, deadline, interval,
                                no_update_display, capture_screenshot,
