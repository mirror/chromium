...
std::unique_ptr<base::DictionaryValue> ParsePrintSettings(
  ...
  {
    const base::Value* landscape_value = params->FindKey("landscape");
    if (landscape_value)
      settings->landscape = landscape_value->GetBool();
  }
  {
    const base::Value* display_header_footer_value =
  ...
  {
    const base::Value* should_print_backgrounds_value =
        params->FindKey("printBackground");
    if (should_print_backgrounds_value)
      settings->should_print_backgrounds =
          should_print_backgrounds_value->GetBool();
  }
  {
    const base::Value* scale_value = params->FindKey("scale");
    if (scale_value)
  ...
  {
    const base::Value* page_ranges_value = params->FindKey("pageRanges");
    if (page_ranges_value)
      settings->page_ranges = page_ranges_value->GetString();
  }
  {
    const base::Value* ignore_invalid_page_ranges_value =
  ...
  {
    const base::Value* paper_width_value = params->FindKey("paperWidth");
  ...
  {
    const base::Value* paper_height_value = params->FindKey("paperHeight");
  ...
  {
    const base::Value* margin_top_value = params->FindKey("marginTop");
    if (margin_top_value)
      margin_top_in_inch = margin_top_value->GetDouble();
  }
  {
    const base::Value* margin_bottom_value = params->FindKey("marginBottom");
    if (margin_bottom_value)
      margin_bottom_in_inch = margin_bottom_value->GetDouble();
  }
  {
    const base::Value* margin_left_value = params->FindKey("marginLeft");
    if (margin_left_value)
      margin_left_in_inch = margin_left_value->GetDouble();
  }
  {
    const base::Value* margin_right_value = params->FindKey("marginRight");
...
HeadlessDevToolsManagerDelegate::CreateTarget(
  ...
  {
    const base::Value* url_value = params->FindKey("url");
    if (url_value) {
  ...
  {
    const base::Value* width_value = params->FindKey("width");
    if (width_value)
  ...
  {
    const base::Value* height_value = params->FindKey("height");
    if (height_value)
  ...
  {
    const base::Value* enable_begin_frame_control_value =
...
HeadlessDevToolsManagerDelegate::SetWindowBounds(
  ...
  {
    const base::Value* window_state_value =
  ...
  gfx::Rect bounds = web_contents->web_contents()->GetContainerBounds();
  {
    const base::Value* left_value = bounds_value->FindKey("left");
    if (left_value) {
  ...
  {
    const base::Value* top_value = bounds_value->FindKey("top");
    if (top_value) {
  ...
  {
    const base::Value* width_value = bounds_value->FindKey("width");
    if (width_value) {
  ...
  {
    const base::Value* height_value = bounds_value->FindKey("height");
    if (height_value) {
...
void HeadlessDevToolsManagerDelegate::BeginFrame(
  ...
  const base::Value* frame_time_value = params->FindKey("frameTime");
  if (frame_time_value) {
  ...
  const base::Value* interval_value = params->FindKey("interval");
  if (interval_value) {
  ...
  const base::Value* deadline_value = params->FindKey("deadline");
  if (deadline_value) {
  ...
  if (params->Get("screenshot", &value)) {
    ...
    const base::Value* format_value = screenshot_dict->FindKey("format");
    if (format_value) {
    ...
    const base::Value* quality_value = screenshot_dict->FindKey("quality");
    if (quality_value) {
