...
class VirtualTimeBrowserTest : public HeadlessAsyncDevTooledBrowserTest,
 ...
 public:
  ...
  void RunDevTooledTest() override {
    ...
    devtools_client_->GetRuntime()->Enable(base::BindOnce(
  ...
  virtual void MaybeSetVirtualTimePolicy() {
    ...
    devtools_client_->GetEmulation()->GetExperimental()->SetVirtualTimePolicy(
        emulation::SetVirtualTimePolicyParams::Builder()
            ...
            .Build(),
        base::BindOnce(&VirtualTimeBrowserTest::SetVirtualTimePolicyDone,
  ...
  void OnRequest(const GURL& url, base::Closure complete_request) override {
    ...
    if (url.spec() == "http://test.com/style.css") {
      ...
      browser()->BrowserMainThread()->PostTask(
          FROM_HERE,
          base::BindOnce(&FrameDetatchWithPendingResourceLoadVirtualTimeTest::
                             DetatchIFrame,
                         base::Unretained(this)));
    } else {
  ...
  void OnVirtualTimeBudgetExpired(
    ...
    if (step_ < test_commands_.size()) {
      devtools_client_->GetRuntime()->Evaluate(
          ...
          base::BindOnce(&VirtualTimeAndHistoryNavigationTest::OnEvaluateResult,
                         base::Unretained(this)));
    } else {
      FinishAsynchronousTest();
    }
...
class PendingScriptVirtualTimeTest : public VirtualTimeBrowserTest {
 public:
  ...
  void OnVirtualTimeBudgetExpired(
    ...
    devtools_client_->GetRuntime()->Evaluate(
        "document.title",
        base::BindOnce(&PendingScriptVirtualTimeTest::OnEvaluateResult,
                       base::Unretained(this)));
  }
