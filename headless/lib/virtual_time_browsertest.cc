...
class DeferedLoadDoesntBlockVirtualTimeTest : public VirtualTimeBrowserTest {
 public:
  DeferedLoadDoesntBlockVirtualTimeTest() {
    EXPECT_TRUE(embedded_test_server()->Start());
...
HEADLESS_ASYNC_DEVTOOLED_TEST_F(DeferedLoadDoesntBlockVirtualTimeTest);
