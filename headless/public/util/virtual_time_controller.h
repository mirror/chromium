 ...
 public:
  ...
  class RepeatingTask {
   public:
    ...
    // with true if it wants virtual time to continue advancing, or false
    // otherwise.  Virtual time will continue to advance until all
    // RepeatingTasks want it to stop.
