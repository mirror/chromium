...
class CompositorController::AnimationBeginFrameTask
 ...
 public:
  ...
  void IntervalElapsed(base::TimeDelta virtual_time,
  ...
  void BudgetRequested(base::TimeDelta virtual_time,
...
void CompositorController::BeginFrame(
  ...
  if (needs_begin_frames_ || screenshot) {
    ...
    base::Time frame_time = virtual_time_controller_->GetVirtualTime();
