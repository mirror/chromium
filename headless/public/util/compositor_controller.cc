...
class CompositorController::AnimationBeginFrameTask
 ...
 public:
  ...
  void IntervalElapsed(const base::TimeDelta& virtual_time,
    ...
    // sends a screenshotting BeginFrame first, or if the budget was exhaused.
...
void CompositorController::EnsureIdle(const base::Closure& idle_callback) {
  TRACE_EVENT_INSTANT1("headless", "CompositorController::EnsureIdle",
...
void CompositorController::CaptureScreenshotBeginFrameComplete(
  ...
  TRACE_EVENT1("headless",
               "CompositorController::CaptureScreenshotBeginFrameComplete",
               "hasScreenshotData", result->HasScreenshotData());
  DCHECK(screenshot_captured_callback_);
