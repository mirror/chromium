...
class HeadlessJsBindingsTest
 ...
 public:
  ...
  void OnInstalledHeadlessTabSocket(int v8_exection_context_id) {
    main_world_exection_context_id_ = v8_exection_context_id;
  ...
  void OnMessageFromContext(const std::string& json_message,
    ...
    EXPECT_EQ(main_world_exection_context_id_, v8_execution_context_id);
  ...
  bool OnProtocolMessage(const std::string& devtools_agent_host_id,
    ...
    if (parsed_message.GetInteger("id", &id)) {
      ...
      headless_tab_socket_->SendMessageToContext(
          json_message, main_world_exection_context_id_);
      return true;
    }
    ...
    headless_tab_socket_->SendMessageToContext(json_message,
                                               main_world_exection_context_id_);
 ...
 private:
  ...
  int main_world_exection_context_id_;
};
