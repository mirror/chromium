...
class HeadlessJsBindingsTest
 ...
 public:
  ...
  void RunDevTooledTest() override {
    ...
    base::Optional<GURL> initial_url = GetInititialUrl();
    if (initial_url) {
  ...
  virtual base::Optional<GURL> GetInititialUrl() { return base::nullopt; }
...
class ExperimentalCommandJsBindingsTest : public HeadlessJsBindingsTest {
 public:
  base::Optional<GURL> GetInititialUrl() override {
