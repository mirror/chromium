...
bool ImageCompare(const SkBitmap* lhs,
  ...
  rhs->readPixels(info, &buffer2[0], bytesPerRow, rhs_rect.left(),
                  rhs_rect.top());
  return memcmp(&buffer1[0], &buffer2[0], buffer1.size()) == 0;
}
...
<html>
 ...
 <body>
  ...
  void VerifyDom(GetSnapshotResult* dom_snapshot) override {
    ...
    ASSERT_THAT(screenshots_[0].Width(), Ge(200));
    ASSERT_THAT(screenshots_[0].Height(), Ge(200));
    EXPECT_THAT(screenshots_[1].Width(), Eq(100));
    EXPECT_THAT(screenshots_[1].Height(), Eq(100));
    EXPECT_THAT(screenshots_[2].Width(), Eq(100));
    EXPECT_THAT(screenshots_[2].Height(), Eq(100));
    EXPECT_THAT(screenshots_[3].Width(), Eq(100));
    EXPECT_THAT(screenshots_[3].Height(), Eq(100));
    EXPECT_THAT(screenshots_[4].Width(), Eq(100));
    EXPECT_THAT(screenshots_[4].Height(), Eq(100));
