...
<html><head><script>
 document.location="http://example.com/frameB/1"
    ...
    GetProtocolHandler()->InsertResponse("http://example.com/frameB/1",
                                         HttpOk(R"|(
<html><body>FRAME B 1
 <iframe src="http://example.com/iframe/" id="iframe"></iframe>
</body></html>
)|"));

    GetProtocolHandler()->InsertResponse("http://example.com/iframe/",
                                         HttpOk(R"|(
<html><head><script>
 document.location="http://example.com/iframe/1"
</script></head></html>
)|"));

    GetProtocolHandler()->InsertResponse(
        "http://example.com/iframe/1",
  ...
  void VerifyDom(GetSnapshotResult* dom_snapshot) override {
    ...
    EXPECT_THAT(urls, UnorderedElementsAre("http://example.com/1",
    ...
    EXPECT_THAT(urls, UnorderedElementsAre("http://example.com/frameA/1",
