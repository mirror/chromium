...
class WindowEnumerator {
 public:
  WindowEnumerator(RunType run_type, const base::CommandLine* command_line);
  void Run();
 ...
 private:
  ...
  const base::CommandLine* const command_line_;
  const bool log_details_;
...
void KillAlwaysOnTopWindows(RunType run_type,
                            const base::CommandLine* command_line) {
  WindowEnumerator(run_type, command_line).Run();
}
