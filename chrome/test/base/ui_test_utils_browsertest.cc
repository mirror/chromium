...
void UiTestUtilsTest::TestInCurrentTab() {
  ...
  ASSERT_TRUE(content::ExecuteScriptAndExtractString(
      ...
      "window.domAutomationController.send("
          "(document.webkitFullscreenElement == null).toString());",
      &result));
...
IN_PROC_BROWSER_TEST_F(UiTestUtilsTest,
    NavigateToURLShouldSynchronouslyLoadDataHtml) {
  TestInCurrentTab();
}

IN_PROC_BROWSER_TEST_F(UiTestUtilsTest,
    NavigateToURLShouldSynchronouslyLoadDataHtmlInNewTab) {
...
IN_PROC_BROWSER_TEST_F(UiTestUtilsTest,
    NavigateToURLShouldSynchronouslyLoadDataHtmlInNewWindow) {
