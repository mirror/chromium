...
var allTests = [
  function testSimplePage() {
    ...
    assertEq(
        ...
        state);
    assertEq(undefined, rootNode.restrictions);
    ...
    assertEq({}, state);
    assertEq(undefined, body.restrictions);
    ...
    assertEq(undefined, okButton.restrictions);
    var userNameInput = contentChildren[1];
    assertEq(undefined, userNameInput.restrictions);
