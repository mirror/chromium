...
var allTests = [
  function testSimplePage() {
    ...
    assertEq(
        ...
        state);
    assertEq(undefined, rootNode.controlMode);
    ...
    assertEq({}, state);
    assertEq(undefined, body.controlMode);
    ...
    assertEq(undefined, okButton.controlMode);
    var userNameInput = contentChildren[1];
    assertEq(undefined, userNameInput.controlMode);
