...
// Similar to getURL without the path. Browser initiated navigation will have no
// initiator. The |navigationType| specifies if the navigation was performed by
// the browser or the renderer.
...
// Similar to getServerURL without the path. Browser initiated navigation will
// have no initiator. The |navigationType| specifies if the navigation was
