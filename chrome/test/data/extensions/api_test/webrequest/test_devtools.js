...
runTests([
  ...
  function testDevToolsCustomFrontendRequest() {
    ...
    navigateAndWait('chrome-devtools://devtools/custom/fakedevtools.html#' +
      getCompletionURL());
  },
  ...
  function testNonDevToolsCustomFrontendRequest() {
    ...
    var customFrontendUrl =
      getServerURL('devtoolsfrontend/fakedevtools.html',
        'customfrontend.example.com');
