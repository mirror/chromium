...
const error_msg = 'Cannot lock window to fullscreen or close a locked fullscreen window without lockWindowFullscreenPrivate manifest permission';
...
updateWindowToLockedFullscreen = function() {
  chrome.windows.getCurrent(null, function(window) {
    chrome.windows.update(window.id, {state: 'locked'},
      chrome.test.callbackFail(error_msg))});
};
