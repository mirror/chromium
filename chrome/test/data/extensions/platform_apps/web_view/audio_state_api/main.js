...
function audioTests() {
  ...
  webview.isAudioMuted(function (audible) {
    ...
    window.console.log('start playing audio');
    webview.executeScript({ code: audioCode });
  });
}

function startTest() {
  window.console.log('webview initializing');
  var webview = document.querySelector('webview');
