...
function trackSwitchingStream() {
  ...
  let stream2 = null;
  pc.ontrack = (e) => {
    console.log('ontrack1: ' + trackEventToString(e));
    track1 = e.track;
    stream1 = e.streams[0];
    if (stream1.getTracks()[0] != track1)
      throw failTest('stream1 does not contain track1.');
    pc.ontrack = (e) => {
      console.log('ontrack2: ' + trackEventToString(e));
...
function trackEventToString(e) {
  let str = '{ track:' + e.track.id + ', streams: { ';
