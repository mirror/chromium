  ...
  function testParamsParser() {
    ...
    paramsParser.getViewportFromUrlParams(
        url + "#view=Fit", function(viewportPosition) {
          chrome.test.assertEq('fit', viewportPosition.view);
    });
    // Checking #view=FitH.
    paramsParser.getViewportFromUrlParams(
        url + "#view=FitH", function(viewportPosition) {
          chrome.test.assertEq('fith', viewportPosition.view);
    });
    // Checking #view=FitV.
    paramsParser.getViewportFromUrlParams(
        url + "#view=FitV", function(viewportPosition) {
          chrome.test.assertEq('fitv', viewportPosition.view);
    });
    // Checking #view=FitZ.
    paramsParser.getViewportFromUrlParams(
        url + "#view=FitZ", function(viewportPosition) {
