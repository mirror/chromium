...
var tests = [
  ...
  function testZoomToolbarToggle() {
    ...
    var lastEvent = null;
    var lastFittingType = null;
    var logEvent = function(e) {
      lastEvent = e.type;
      lastFittingType = e.detail.fittingType;
    }
    var assertEvent = function(fittingType) {
      chrome.test.assertEq('fit-to-changed', lastEvent);
      chrome.test.assertEq(fittingType, lastFittingType);
      lastEvent = null;
      fittingType = null;
    }
  ...
  function testZoomToolbarForceFitToPage() {
    ...
    zoomToolbar.forceFit(Viewport.FittingType.FIT_TO_PAGE);
    assertEvent(Viewport.FittingType.FIT_TO_PAGE);
    chrome.test.assertTrue(fab.icon.endsWith(fitWidthIcon));
  ...
  function testZoomToolbarForceFitToWidth() {
    ...
    zoomToolbar.forceFit(Viewport.FittingType.FIT_TO_WIDTH);
    assertEvent(Viewport.FittingType.FIT_TO_WIDTH);
    chrome.test.assertTrue(fab.icon.endsWith(fitPageIcon));
