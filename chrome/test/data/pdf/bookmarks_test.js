...
var tests = [
  ...
  function testFollowBookmark() {
    ...
    testTapTarget(rootBookmarks[0].$.item, {page: 0, x: undefined, y: 166})
    testTapTarget(subBookmarks[0].$.item, {page: 1, x: undefined, y: 166})
    testTapTarget(rootBookmarks[1].$.item, {page: 2, x: undefined, y: 166})
