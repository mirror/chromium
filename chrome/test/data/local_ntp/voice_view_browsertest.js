...
test.view.testTextUpdateWithWorkingViews = function() {
  view.show();
  view.setReadyForSpeech();
  // The |onspeechstart| event might not necessarily have fired.
 ...
 * has been shown retries voice search without submitting the query.
 */
...
/**
 * Test that clicking on the microphone with results present does not retry
 * voice search and submits the query.
 */
 ...
 * into a "Didn't get that" error retries voice search and does not submit
 * the query.
 */
...
/**
 * Test that clicking on the background with results present does not retry
 * voice search or submit the query.
 */
...
/**
 * Test that clicking the help link does not retry voice search or submit
 * the query.
 */
test.view.testClickHelpLinkWithError = function() {
  view.show();
