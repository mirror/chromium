...
/*
 * @fileoverview Suite of accessibility tests for the Manage Profile
 * route.
 */

suite('MANAGE_PROFILE', function() {
  setup(function() {
    ...
    window.history.pushState('object or string', 'Test', '/manageProfile');
