...
suite('CategoryDefaultSetting', function() {
  ...
  // Verifies that for |category| and |prefs|, the widget works as expected.
  // Test with |enabled| true
  function testCategoryEnabled(testElement, category, prefs, expectedEnabled) {
    browserProxy.reset();
