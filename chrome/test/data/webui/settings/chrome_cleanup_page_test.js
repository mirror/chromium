...
function validateVisibleItemsList(
  ...
  if (!listCanBeShortened ||
      originalItems.length <= settings.NUM_ITEMS_TO_SHOW) {
    assertEquals(visibleItemsList.length, originalItems.length);
    assertTrue(showMoreItems.hidden);
  } else {
    assertEquals(visibleItemsList.length, settings.NUM_ITEMS_TO_SHOW - 1);
...
function startCleanupFromInfected(
  ...
  validateVisibleItemsList(
      ...
      /*listCanBeShortened=*/userInitiatedCleanupsEnabled);
...
suite('ChromeCleanupHandler_UserInitiatedCleanupsDisabled', function() {
  setup(function() {
    initParametrizedTest(/*userInitiatedCleanupsEnabled=*/false);
  });

  test('startCleanupFromInfected_FewFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/false, shortFileList, []);
  });
  ...
  test('startCleanupFromInfected_ExactSizeFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/false, exactSizeFileList, []);
  });
  ...
  test('startCleanupFromInfected_ManyFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/false, longFileList, []);
  });
  ...
  test('cleanupFailure', function() {
    return cleanupFailure(/*userInitiatedCleanupsEnabled=*/false);
  });

  test('cleanupSuccess', function() {
    return cleanupSuccess(/*userInitiatedCleanupsEnabled=*/false);
  });

  test('logsUploadingOnInfected', function() {
    return testLogsUploading(/*testingScanOffered=*/false);
  });
});

suite('ChromeCleanupHandler_UserInitiatedCleanupsEnabled', function() {
  setup(function() {
    initParametrizedTest(/*userInitiatedCleanupsEnabled=*/true);
  });
  ...
  test('startCleanupFromInfected_FewFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/true, shortFileList, []);
  });
  ...
  test('startCleanupFromInfected_ExactSizeFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/true, exactSizeFileList, []);
  });
  ...
  test('startCleanupFromInfected_ManyFilesNoRegistryKeys', function() {
    return startCleanupFromInfected(
        /*userInitiatedCleanupsEnabled=*/true, longFileList, []);
  });
  ...
  test('cleanupFailure', function() {
    return cleanupFailure(/*userInitiatedCleanupsEnabled=*/true);
  });

  test('cleanupSuccess', function() {
    return cleanupSuccess(/*userInitiatedCleanupsEnabled=*/true);
  });

  test('logsUploadingOnScanOffered', function() {
    return testLogsUploading(/*testingScanOffered=*/true);
  });
