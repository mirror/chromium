...
suite('CupsAddPrinterDialogTests', function() {
  ...
  /**
   * Test that dialog canellation is logged from the manufacturer screen for IPP
   * printers.
   */
  ...
  /**
   * Test that dialog canellation is logged from the manufacturer screen for USB
   * printers.
   */
