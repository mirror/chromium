...
cr.define('settings_toggle_button', function() {
  suite('SettingsToggleButton', function() {
    ...
    test('fires a change event for action-target', function(done) {
    ...
    test('fires a change event for label', function(done) {
      testElement.addEventListener('change', function() {
        assertFalse(testElement.checked);
        done();
      });
    ...
    test('fires a change event for toggle', function(done) {
      testElement.addEventListener('change', function() {
        assertFalse(testElement.checked);
        done();
      });
    ...
    test('fires a single change event per tap', function() {
      counter = 0
      testElement.addEventListener('change', function() {
        ++counter;
      });
    ...
    test('numerical pref with unknown initial value', function() {
      var prefNum = {
        key: 'test',
        type: chrome.settingsPrivate.PrefType.NUMBER,
        value: 3
