...
class TestSiteSettingsPrefsBrowserProxy extends TestBrowserProxy {
  constructor() {
    ...
    this.prefs_ = {defaults: {}, exceptions: {}};
    for (let type in settings.ContentSettingsTypes) {
      this.prefs_.defaults[settings.ContentSettingsTypes[type]] = {
        setting: settings.ContentSetting.ASK,
      };
    }
    this.prefs_.defaults[settings.ContentSettingsTypes.COOKIES] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.IMAGES] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.JAVASCRIPT] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.SOUND] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.POPUPS] = {
      setting: settings.ContentSetting.BLOCK,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.PROTOCOL_HANDLERS] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.BACKGROUND_SYNC] = {
      setting: settings.ContentSetting.ALLOW,
    };
    this.prefs_.defaults[settings.ContentSettingsTypes.ADS] = {
      setting: settings.ContentSetting.BLOCK,
    };
    for (let type in settings.ContentSettingsTypes) {
