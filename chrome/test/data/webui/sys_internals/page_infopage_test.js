...
PageTest.InfoPage = function() {
  suite('Info page integration test', function() {
    test('check cpu info', function() {
      ...
      assertEquals(getTextById('sys-internals-infopage-cpu-kernel'), '0.00%');
      ...
      assertEquals(
          getTextById('sys-internals-infopage-zram-compr-ratio'), 'NaN%');
      ...
      assertEquals(getTextById('sys-internals-infopage-cpu-kernel'), '20.00%');
      ...
      handleUpdateData(
          ...
          2876);
      assertEquals(getTextById('sys-internals-infopage-cpu-usage'), '66.67%');
      assertEquals(getTextById('sys-internals-infopage-cpu-kernel'), '33.33%');
