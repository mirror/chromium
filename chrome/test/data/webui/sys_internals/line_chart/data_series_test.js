...
LineChartTest.DataSeries = function() {
  suite('LineChart DataSeries unit test', function() {
    test('linerInterpolation', function() {
      ...
      const result2 =
          LineChart.DataSeries.linearInterpolation(42, 15, 142, 32, 65);
      TestUtil.assertCloseTo(result2, 18.91, 1e-2);
      const result3 = LineChart.DataSeries.linearInterpolation(
    ...
    test('dataPointLinerInterpolation', function() {
      ...
      const result1 =
          dataSeries.dataPointLinearInterpolation(pointA, pointB, 118);
      ...
      const result21 =
          dataSeries.dataPointLinearInterpolation(pointC, pointD, 65);
      TestUtil.assertCloseTo(result21, 15, 1e-2);
      const result22 =
          dataSeries.dataPointLinearInterpolation(pointC, pointD, 135);
