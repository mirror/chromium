    ...
    test(assert(TestNames.Basic), function() {
      ...
      return input.delegate.whenCalled('setShortcutHandlingSuspended')
          .then((arg) => {
            ...
            expectEquals('', field.value);
            expectEquals('Include either Ctrl or Alt', field.errorMessage);
            // Add shift to letter.
            ...
            expectEquals('Need a letter', field.errorMessage);
            // Add shift.
            ...
            expectEquals('Ctrl', field.value);
            expectEquals('Either, not both Ctrl and Alt', field.errorMessage);
            // Remove alt.
