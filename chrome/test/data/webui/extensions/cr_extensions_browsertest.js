...
TEST_F('CrExtensionsManagerTestWithMultipleExtensionTypesInstalled',
...
TEST_F('CrExtensionsShortcutTest', 'ExtensionKeyboardShortcutsLayoutTest',
       function() {
...
TEST_F('CrExtensionsPackDialogTest', 'ExtensionPackDialogInteractionTest',
       function() {
...
TEST_F('CrExtensionsOptionsDialogTest', 'ExtensionOptionsDialogInteractionTest',
       function() {
...
TEST_F('CrExtensionsErrorPageTest', 'ExtensionErrorPageLayoutTest',
       function() {
  mocha.grep(assert(extension_error_page_tests.TestNames.Layout)).run();
});

TEST_F('CrExtensionsErrorPageTest', 'ExtensionErrorPageCodeSectionTest',
       function() {
  mocha.grep(assert(extension_error_page_tests.TestNames.CodeSection)).run();
});

TEST_F('CrExtensionsErrorPageTest', 'ExtensionErrorPageErrorSelectionTest',
       function() {
...
TEST_F('CrExtensionsCodeSectionTest', 'ExtensionCodeSectionLayoutTest',
       function() {
