...
TEST_F('CrExtensionsDetailViewTest', 'IndicatorTest', function() {
  this.runMochaTest(extension_detail_view_tests.TestNames.IndicatorTest);
});
...
TEST_F('CrExtensionsShortcutTest', 'Util', function() {
  this.runMochaTest(extension_shortcut_tests.TestNames.ShortcutUtil);
});

TEST_F('CrExtensionsShortcutTest', 'Basic', function() {
  this.runMochaTest(extension_shortcut_tests.TestNames.Basic);
});
...
var CrExtensionsOptionsDialogTest = class extends CrExtensionsBrowserTest {
  ...
  /** @override */
  get suiteName() {
    return extension_options_dialog_test.suiteName;
  }
};

TEST_F('CrExtensionsOptionsDialogTest', 'Layout', function() {
  this.runMochaTest(extension_options_dialog_test.TestNames.Layout);
});
...
TEST_F('CrExtensionsCodeSectionTest', 'Layout', function() {
  this.runMochaTest(extension_code_section_test.TestNames.Layout);
});
