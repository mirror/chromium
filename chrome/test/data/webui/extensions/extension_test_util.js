...
cr.define('extension_test_util', function() {
   ...
   * corresponding non-empty svg element, and all the paper-icon-button-lights
   * have a valid CSS-class to apply an icon as background.
   * @param {HTMLElement} e The element to check the iron icons in.
   */
  function testIconsValid(e) {
