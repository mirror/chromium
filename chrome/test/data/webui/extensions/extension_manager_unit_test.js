...
cr.define('extension_manager_tests', function() {
  ...
  class TestService extends TestBrowserProxy {
    ...
    getItemStateChangedTarget() {
      this.methodCalled('getItemStateChangedTarget');
      return this.itemStateChangedTarget;
    }

    getProfileStateChangedTarget() {
      this.methodCalled('getProfileStateChangedTarget');
  ...
  suite('ExtensionManagerUnitTest', function() {
    ...
    setup(function() {
      ...
      // Ensure that Manager calls the following four methods upon
      // initialization.
      return Promise.all([
        service.whenCalled('getExtensionsInfo'),
        service.whenCalled('getItemStateChangedTarget'),
        service.whenCalled('getProfileConfiguration'),
        service.whenCalled('getProfileStateChangedTarget'),
      ]);
    });
