 ...
 * @extends {PolymerTest}
 */
function ExtensionsAccessibilityTest() {}

// Default accessibility audit options. Specify in test definition to use.
ExtensionsAccessibilityTest.axeOptions = {
  'rules': {
...
// Default accessibility audit options. Specify in test definition to use.
ExtensionsAccessibilityTest.violationFilter = {
...
ExtensionsAccessibilityTest.prototype = {
