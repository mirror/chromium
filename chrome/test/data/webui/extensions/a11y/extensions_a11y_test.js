...
var CrExtensionsShortcurA11yTestWithExtensions =
...
AccessibilityTest.define('CrExtensionsShortcurA11yTestWithExtensions', {
  /** @override */
...
var CrExtensionsErrorConsoleA11yTest =
  ...
  /** @override */
  testGenPostamble() {
    GEN('  EnableDevMode(false);');  // Return this to default.
  }
};
