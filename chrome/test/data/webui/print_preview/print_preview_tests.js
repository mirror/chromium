  ...
  suite('PrintPreview', function() {
    ...
    setup(function() {
      initialSettings = {
        ...
        decimalDelimeter: '.',
        unitType: 1,
        isDocumentModifiable: true,
        documentTitle: 'title',
        documentHasSelection: true,
        selectionOnly: false,
        systemDefaultDestinationId: 'FooDevice',
    ...
    test('PrintToPDFSelectedCapabilities', function() {
      ...
      initialSettings.isDocumentModifiable = false;
      initialSettings.systemDefaultDestinationId = 'Save as PDF';
    ...
    if (cr.isMac) {
      ...
      test('MacOpenPDFInPreview', function() {
        ...
        initialSettings.systemDefaultDestinationId = device.printer.deviceName;
        return setupSettingsAndDestinationsWithCapabilities(device).
            then(function() {
              assertEquals(
