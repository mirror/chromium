...
cr.define('restore_state_test', function() {
  ...
  suite(suiteName, function() {
     ...
     *     to verify.
     */
    verifyStickySettingsApplied = function(stickySettings) {
     ...
     */
    initializeWithStickySettings = function(stickySettings) {
    ...
    test(assert(TestNames.Restore1), function() {
      ...
      return initializeWithStickySettings(stickySettings);
    });

    test(assert(TestNames.Restore2), function() {
      const stickySettings = {
        version: 2,
        recentDestinations: [],
