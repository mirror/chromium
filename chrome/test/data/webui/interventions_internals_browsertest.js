...
TEST_F(
    ...
    function() {
      ...
      test('EnabledStatusTest', function() {
        ...
        return window.testPageHandler.whenCalled('finishJob').then(function() {
          let message = document.querySelector('#' + AMP_REDIRECTION_PREVIEW);
          expectEquals(
...
TEST_F(
    ...
    function() {
      ...
      test('DisabledStatusTest', function() {
        ...
        return window.testPageHandler.whenCalled('finishJob').then(function() {
          let message = document.querySelector('#' + OFFLINE_PREVIEWS);
          expectEquals(message.textContent, OFFLINE_PREVIEWS + ': Disabled');
        });
      });
