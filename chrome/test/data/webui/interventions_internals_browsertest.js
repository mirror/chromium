...
InterventionsInternalsUITest.prototype = {
  ...
  preLoad: function() {
    ...
    class TestPageHandler extends TestBrowserProxy {
      constructor() {
        super(['getPreviewsEnabled', 'getPreviewsFlagsStatuses']);
      ...
      getPreviewsFlagsStatuses() {
        this.methodCalled('getPreviewsFlagsStatuses');
        return Promise.resolve({
          statuses: this.previewsFlagsStatuses_,
        });
      }
    }
...
TEST_F('InterventionsInternalsUITest', 'PreviewsModeStatuses', function() {
...
TEST_F('InterventionsInternalsUITest', 'PreviewsFlagsStatuses', function() {
  let setupFnResolver = this.setupFnResolver;
  ...
  test('DisplayCorrectStatuses', () => {
    ...
    return setupFnResolver.promise
        .then(() => {
          return window.testPageHandler.whenCalled('getPreviewsFlagsStatuses');
        })
        .then(() => {
          testMap.forEach((value, key) => {
