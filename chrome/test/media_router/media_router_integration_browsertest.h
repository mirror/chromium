...
class MediaRouterIntegrationBrowserTest : public MediaRouterBaseBrowserTest {
 ...
 protected:
  ...
  // Simulate user action to choose one cast mode in the popup dialog. This will
  // not work unless in the choose cast mode view. |dialog_contents|: The web
  // contents of the popup dialog. |cast_mode_text|: The cast mode's dialog
  // name.
  void ChooseCastMode(content::WebContents* dialog_contents,
  ...
  // This is needed to bypass potential issues that may arrise when trying to
