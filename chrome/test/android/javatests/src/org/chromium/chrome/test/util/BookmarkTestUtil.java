...
public class BookmarkTestUtil {
    ...
    public static void waitForBookmarkModelLoaded() throws InterruptedException {
        final BookmarkModel bookmarkModel =
                ThreadUtils.runOnUiThreadBlockingNoException(() -> { return new BookmarkModel(); });

        CriteriaHelper.pollUiThread(() -> { return bookmarkModel.isBookmarkModelLoaded(); });

        ThreadUtils.runOnUiThreadBlocking((Runnable) () -> { return bookmarkModel.destroy(); });
    }
}
