...
public @interface ChromeHome {
     ...
     * used by explicitly calling methods ({@link #setState(boolean)} and {@link #clearTestState()})
     * or by using the {@link ChromeHome} annotation on tests.
     */
    class Processor extends AnnotationProcessor<ChromeHome> {
        private static final String CHROME_HOME_FEATURES =
        ...
        private void updateCommandLine() {
            ...
            if (TextUtils.equals(existingFeatures, CHROME_HOME_FEATURES)) return;
            ...
            commandLine.appendSwitch("enable-features=" + CHROME_HOME_FEATURES);
        }
