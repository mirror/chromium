...
// A dictionary pref that stores the customized software mirroring parameters.
const char kDisplayCustomSoftwareMirroringParam[] =
    "settings.display.custom_software_mirroring_param";
