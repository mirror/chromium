...
// TODO(xhwang): This pref was used as a WebPreference which is why the string
// is prefixed with "webkit.webprefs". Now this is used in RendererPreferences
// and we should migrate the pref to use a new non-webkit-prefixed string.
