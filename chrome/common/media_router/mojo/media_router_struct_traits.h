...
struct EnumTraits<media_router::mojom::RouteControllerType,
  ...
  static media_router::mojom::RouteControllerType ToMojom(
    ...
    switch (controller_type) {
      ...
      case media_router::RouteControllerType::HANGOUT:
        return media_router::mojom::RouteControllerType::HANGOUT;
    }
    ...
    switch (input) {
      ...
      case media_router::mojom::RouteControllerType::GENERIC:
        *output = media_router::RouteControllerType::GENERIC;
        return true;
      case media_router::mojom::RouteControllerType::HANGOUT:
        *output = media_router::RouteControllerType::HANGOUT;
        return true;
    }
    return false;
  }
