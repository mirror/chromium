...
// list. The class uses a Timer to throttle invocations of the callback when
...
class MediaSinkServiceBase {
 ...
 protected:
  ...
  // Helper function to restart |discovery_timer|. No-op if timer does not exist
  // or timer is currently running. Can be called any time after |StartTimer| is
  // called.
  void RestartTimer();
