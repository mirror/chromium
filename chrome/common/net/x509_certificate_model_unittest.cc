...
TEST(X509CertificateModelTest, GetCMSString) {
  net::ScopedCERTCertificateVector certs = CreateCERTCertificateListFromFile(
...

  {
    ...
    net::ScopedCERTCertificateVector decoded_certs =
        net::x509_util::CreateCertificateListFromBytes(
