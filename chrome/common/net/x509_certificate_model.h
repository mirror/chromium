...
// TODO: rename this to chrome/common/net/x509_certificate_model_nss.h ?
...
// XXX docs (also in certificate_helper.h)
...
std::string GetCMSString(const net::ScopedCERTCertificateVector& cert_chain,
                         size_t start,
                         size_t end);
