...
static_assert(static_cast<int>(content::RESULT_CODE_LAST_CODE) <=
                  static_cast<int>(RESULT_CODE_CHROME_START),
              "content ResultCodes are overlapping with chrome ResultCodes");
static_assert(RESULT_CODE_CHROME_LAST_CODE == 81,
