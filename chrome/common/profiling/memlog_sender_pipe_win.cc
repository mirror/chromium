...
MemlogSenderPipe::Pipes MemlogSenderPipe::CreatePipes() {
  Pipes pipes;
  std::wstring pipe_name = base::StringPrintf(L"\\\\.\\pipe\\profiling.%u.%u.%I64u",
  ...
  pipes.sender.reset(
      mojo::edk::PlatformHandle(CreateFileW(pipe_name.c_str(), kDesiredAccess,
                                 0,  // No sharing.
