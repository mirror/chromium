...
public class WebApkHelper {
    ...
    public static Context getRemoteContext(Context context, String packageName, int flags) {
        try {
            return context.getApplicationContext().createPackageContext(packageName, flags);
