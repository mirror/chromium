...
public final class MainActivityTest {
    ...
    public void testIncludeStartUrlWhenRewrite() {
        final String intentStartUrl = "https://www.google.com/search_results?q=eh#countryCA";
        final String manifestStartUrl = "http://www.some-domain.com/page?first=aa&second=bb#abc";
        final String expectedRewrittenStartUrl =
                "https://www.google.com/search_results?q=eh&originalUrl=http%253A%252F%252Fwww.some-domain.com%252Fpage%253Ffirst%253Daa%2526second%253Dbb%2523abc#countryCA";
        final String manifestScope = "https://www.google.com/";
        final String browserPackageName = "com.android.chrome";
