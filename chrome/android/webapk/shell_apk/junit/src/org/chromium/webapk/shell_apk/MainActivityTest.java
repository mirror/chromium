...
public final class MainActivityTest {
    ...
    /**
     * Tests that the intent URL is rewritten as long as |LoggedIntentUrlParam| is set, even though
     * the intent URL is inside the scope specified in the Android Manifest.
     */
    @Test
