 ...
 *
 * Note: In real word, |loggedIntentUrlParam| is set to be nonempty iff intent url is outside the
 * scope specified in manifest, so in the tests we always have these two confidtions come together.
 */
