...
public class WebApkUtilsTest {
    ...
    /**
     * Tests that {@link WebApkUtils#isInstalledAndEnabled} returns false for an installed but
     * disabled app.
     */
    @Test
    public void testReturnFalseForInstalledButDisabledApp() {
        ...
        Assert.assertFalse(
                WebApkUtils.isInstalledAndEnabled((PackageManager) mPackageManager, packageName));
    }
