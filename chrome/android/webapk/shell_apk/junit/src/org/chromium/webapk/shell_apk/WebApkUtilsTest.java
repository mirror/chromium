...
public class WebApkUtilsTest {
    ...
    /**
     * Tests that a WebAPK should be launched as a tab in Chrome when Chrome's version number is
     * lower than {@link WebApkUtils#MINMUM_REQUIRED_CHROME_VERSION}.
     */
    @Test
    ...
    /**
     * Tests that a WebAPK should not be launched as a Tab if Chrome's version is higher than
     * {@link WebApkUtils#MINMUM_REQUIRED_CHROME_VERSION}.
     */
    @Test
