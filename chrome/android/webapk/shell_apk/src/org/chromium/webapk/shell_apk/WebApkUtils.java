...
public class WebApkUtils {
    ...
    /**
     * Returns the new startUrl, rewrite with scope's scheme, host name and append orginal intent
     * url if necessary.
     * The WebAPK may have been launched as a result of an intent filter for a
     * different scheme or top level domain.
     */
