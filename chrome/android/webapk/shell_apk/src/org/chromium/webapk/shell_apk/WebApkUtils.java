...
public class WebApkUtils {
    ...
    public static final int LIST_COLUMN_PADDING = 16;
    ...
    private static final int DIALOG_CONTENT_TOP_PADDING = 12;
    ...
    public static void applyAlertDialogContentStyle(
        ...
        setPadding(titleView, context, DIALOG_CONTENT_PADDING, DIALOG_CONTENT_PADDING,
                DIALOG_CONTENT_PADDING, 0);

        setPadding(contentView, context, DIALOG_CONTENT_PADDING, DIALOG_CONTENT_TOP_PADDING,
                DIALOG_CONTENT_PADDING, DIALOG_CONTENT_PADDING);
    }
}
