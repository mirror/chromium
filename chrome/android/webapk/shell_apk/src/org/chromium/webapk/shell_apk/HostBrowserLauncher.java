...
class HostBrowserLauncher {
    ...
    private void launchInCCT(String runtimeHost) {
        ...
        intent.setPackage(runtimeHost);
        // Ideally a custom tab session should be created when launching a CCT. It is fine to leave
        // the session empty for WebAPKs, since they are NOT real custom tab clients who create
        // sessions to post message to Chrome.
