...
public class WebApkInfo extends WebappInfo {
    ...
    private String mShareUrlTemplate;
    ...
    public static WebApkInfo create(
        ...
        for (ActivityInfo activityInfo : activityInfos) {
            ...
            String template = IntentUtils.safeGetString(
        ...
        return create(WebApkConstants.WEBAPK_ID_PREFIX + webApkPackageName, url, scope,
                new Icon(primaryIcon), new Icon(badgeIcon), name, shortName, shareUrlTemplate,
     ...
     * @param shareUrlTemplate        URL template that contains placeholder to be replaced with
     *                                shared data.
    ...
    public static WebApkInfo create(String id, String url, String scope, Icon primaryIcon,
            Icon badgeIcon, String name, String shortName, String shareUrlTemplate,
        ...
        return new WebApkInfo(id, url, scope, primaryIcon, badgeIcon, name, shortName,
                shareUrlTemplate, displayMode, orientation, source, themeColor, backgroundColor,
    ...
    protected WebApkInfo(String id, String url, String scope, Icon primaryIcon, Icon badgeIcon,
            String name, String shortName, String shareUrlTemplate, @WebDisplayMode int displayMode,
        ...
        mShareUrlTemplate = shareUrlTemplate;
