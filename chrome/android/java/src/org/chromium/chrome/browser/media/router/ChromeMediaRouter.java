...
import org.chromium.chrome.browser.media.router.cast.flinging.FlingingMediaRouteProvider;
    ...
    private static MediaRouteProvider.Factory sRouteProviderFactory =
            new MediaRouteProvider.Factory() {
                public void addProviders(MediaRouteManager manager) {
                    ...
                    MediaRouteProvider flingingProvider =
                            FlingingMediaRouteProvider.create(manager);
                    if (flingingProvider != null) manager.addMediaRouteProvider(flingingProvider);
                }
            };
