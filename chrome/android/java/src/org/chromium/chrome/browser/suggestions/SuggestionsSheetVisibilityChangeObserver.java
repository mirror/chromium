...
public abstract class SuggestionsSheetVisibilityChangeObserver
    ...
    private void onStateChange() {
        ...
        // boolean isSuggestionsActiveContent = mBottomSheet.getCurrentSheetContent() != null
        //        && mBottomSheet.getCurrentSheetContent().getType() ==
        //        BottomSheetContentController.TYPE_SUGGESTIONS;
        boolean newVisibility = isActivityVisible && mBottomSheet.isSheetOpen()
                && isObservedContentCurrent(); // && isSuggestionsActiveContent;
