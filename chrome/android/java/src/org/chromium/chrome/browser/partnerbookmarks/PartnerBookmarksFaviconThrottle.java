...
public class PartnerBookmarksFaviconThrottle {
     ...
     * in our {@link SharedPreferences}. This overwrites previously stored entries.
     */
    public void commit() {
    ...
    public void onFaviconFetched(String url, @FaviconFetchResult int result) {
        ...
        if (result == FaviconFetchResult.FAILURE_SERVER_ERROR) {
        ...
        } else if (result != FaviconFetchResult.SUCCESS && mCurrentEntries.containsKey(url)
            ...
            // response.
            mNewEntries.put(url, getExpiryOf(url));
        }
    }
