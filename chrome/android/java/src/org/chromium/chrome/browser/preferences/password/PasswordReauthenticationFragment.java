...
public class PasswordReauthenticationFragment extends Fragment {
    // The key for the description argument, which is used to retireve an explanation of the
    ...
    private void lockDevice() {
        ...
        assert resourceId != 0; // Forgetting to set the DESCRIPTION_ID is an error on the callsite.
