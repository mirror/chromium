...
public class ContextualSearchTabHelper
     ...
     *
     * @param webContents The content view core to attach the gesture state listener to.
     */
     ...
     * @param webContents The content view core to detach the gesture state listener from.
     */
