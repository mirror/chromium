...
public class SignInPromo extends OptionalLeaf
    ...
    /**
     * Whether personalised suggestions can be shown. If it's not the case, we have no reason to
     * offer the user to sign in.
     */
    private boolean mCanShowPersonalisedSuggestions;
    ...
    public SignInPromo(SuggestionsUiDelegate uiDelegate) {
        ...
        if (mDismissed) {
            ...
            mSigninObserver = new SigninObserver(signinManager, uiDelegate.getSuggestionsSource());
        ...
        mCanShowPersonalisedSuggestions = SnippetsBridge.areRemoteSuggestionsEnabled();
        updateVisibility();
    }
    ...
    public void setVisible(boolean visible) {
        assert false : "Use #updateVisibility instead";
        super.setVisible(computeVisibility()); // We still need this because of @CallSuper
    }

    private void updateVisibility() {
        super.setVisible(computeVisibility());
    }

    private boolean computeVisibility() {
        return !mDismissed && mCanSignIn && mCanShowPersonalisedSuggestions;
    }
    ...
    class SigninObserver extends SuggestionsSource.EmptyObserver
        ...
        public void onCategoryStatusChanged(
            ...
            mCanShowPersonalisedSuggestions = SnippetsBridge.isCategoryEnabled(category)
                    || SnippetsBridge.areRemoteSuggestionsEnabled();
            updateVisibility();
        }
    }
