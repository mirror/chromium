...
public class VrInputConnection extends BaseInputConnection
    ...
    @Override
    public void onWebInputEdited(String text, int selectionStart, int selectionEnd,
        ...
        TextInputState state = new TextInputState(text, new Range(selectionStart, selectionEnd),
                new Range(compositionStart, compositionEnd), false, false);
        if (DEBUG_LOGS) Log.i(TAG, "onWebInputEdited: %s", state.toString());
    ...
    @Override
    public void onWebInputCommitted(String text, int selectionStart, int selectionEnd,
            int compositionStart, int compositionEnd) {
        if (DEBUG_LOGS) Log.i(TAG, "onWebInputCommitted");
