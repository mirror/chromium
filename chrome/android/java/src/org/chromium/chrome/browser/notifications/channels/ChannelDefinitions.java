...
/**
 * Contains the properties of pre-definable notification channels on Android O+. In practice this
 * includes all channels except for site channels, which are defined dynamically by the
...
public class ChannelDefinitions {
    ...
    private static class PredefinedChannels {
        ...
        static {
            ...
            // so that it doesn't clutter the list for people who never use this feature.
