...
public class LoadingStateDelegate {
    ...
    private @DownloadFilter.Index int mPendingFilter = DownloadFilter.FILTER_ALL;
    ...
    public void setPendingFilter(@DownloadFilter.Index int filter) {
        mPendingFilter = filter;
    }

    /** @return The cached filter, or {@link DownloadFilter#FILTER_ALL} if none was set. */
    public @DownloadFilter.Index int getPendingFilter() {
