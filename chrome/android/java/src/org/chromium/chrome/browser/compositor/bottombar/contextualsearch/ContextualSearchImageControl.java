...
public class ContextualSearchImageControl {
    ...
    public ContextualSearchImageControl(Context context) {
        mContext = context;
    }
    ...
    private void animateCustomImageVisibility(boolean visible) {
        ...
        final float endValue = visible ? 1.f : 0.f;
        final float startValue = mCustomImageVisibilityPercentage;

        mImageVisibilityAnimator = new CompositorAnimator(mContext);
        ...
        mImageVisibilityAnimator.addUpdateListener(new CompositorAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(CompositorAnimator animator) {
                float val = startValue + animator.getAnimatedFraction() * (endValue - startValue);
