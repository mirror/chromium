...
import org.chromium.chrome.browser.vr.WebVrPresentationActivity;
...
public class ChromeLauncherActivity extends Activity
        ...
        if ((newIntent.getFlags() & Intent.FLAG_ACTIVITY_NEW_TASK) != 0
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (VrIntentUtils.isVrIntent(intent)) {
                    newIntent.setClassName(context, WebVrPresentationActivity.class.getName());
                } else {
    ...
    private void launchCustomTabActivity() {
        ...
        if (VrIntentUtils.isVrIntent(getIntent())) {
            // VR intents will open a VR-specific CCT {@link WebVrPresentationActivity} which
