...
public class VrAlertDialog extends VrDialog {
    ...
    public boolean show() {
            ...
            public void onClick(int buttonType) {
                switch (buttonType) {
                    ...
                    case ModalDialogView.BUTTON_NEGATIVE:
                        ...
                        VrShellDelegate.setDialogView(null, null);
                        mDialog.dismiss();
                        break;
                    default:
        ...
        params.positiveButtonText = mButtons.get(ModalDialogView.BUTTON_POSITIVE).getText();
        params.negativeButtonText = mButtons.get(ModalDialogView.BUTTON_NEGATIVE).getText();
        params.customView = mView;
        mModalDialogView = new ModalDialogView(controller, params);
        ...
        VrShellDelegate.setDialogView(this, getLayout());
        initVrDialog();
