...
public class PhotoPickerDialog extends AlertDialog {
    ...
    /**
     * A wrapper around {@link PhotoPickerListener} that listens for external extens being launched.
     */
    private class PhotoPickerListenerWrapper implements PhotoPickerListener {
