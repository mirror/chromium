    ...
    protected void attachBaseContext(Context newBase) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            if (config.smallestScreenWidthDp != targetSmallestScreenWidthDp) {
                Log.d(TAG, "activity's smallestScreenWidthDp %d -> %d",
            ...
            // onConfigurationUpdated() will never change its value (ensures that resources
            // always match our values of mIsTablet).
