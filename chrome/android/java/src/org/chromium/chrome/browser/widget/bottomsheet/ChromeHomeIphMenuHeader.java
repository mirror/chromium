...
public class ChromeHomeIphMenuHeader extends LinearLayout implements OnClickListener {
    ...
    public static interface ChromeHomeIphMenuHeaderObserver {
        void menuItemClicked();
        void menuDismissed(boolean dimissIph);
    }

    private static ChromeHomeIphMenuHeaderObserver sTestObserver;
    ...
    public void onClick(View v) {
        ...
        if (sTestObserver != null) sTestObserver.menuItemClicked();
    }
    ...
    public void onMenuDismissed() {
        if (sTestObserver != null)
            sTestObserver.menuDismissed(mDismissChromeHomeIPHOnMenuDismissed);
    ...
    /** An observer to be notified about events related to the menu header. Used for testing. */
    @VisibleForTesting
    public static void setObserverForTests(ChromeHomeIphMenuHeaderObserver observer) {
