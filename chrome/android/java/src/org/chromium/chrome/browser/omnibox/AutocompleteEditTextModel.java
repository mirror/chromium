...
public class AutocompleteEditTextModel implements AutocompleteEditTextModelBase {
    ...
    private void onPostEndBatchEdit() {
        ...
        mBeforeBatchEditFullText = null;
        updateSelectionForTesting(mLastUpdateSelStart, mLastUpdateSelEnd);
    }
    ...
    public void onSelectionChanged(int selStart, int selEnd) {
        ...
        if (mBatchEditNestCount == 0) {
            ...
            updateSelectionForTesting(selStart, selEnd);
        } else {
    ...
    @Override
    public void updateSelectionForTesting(int selStart, int selEnd) {
