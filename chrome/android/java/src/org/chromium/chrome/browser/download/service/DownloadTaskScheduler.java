...
public class DownloadTaskScheduler {
    ...
    // public static final int CLEANUP_TASK = 1;
    ...
    @CalledByNative
    private static void scheduleTask(@DownloadTaskType int taskType, boolean overwrite,
            boolean requiresCharging, boolean requiresUnmeteredNetwork, long windowStartTimeSeconds,
            long windowEndTimeSeconds, boolean incognito) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(EXTRA_IS_INCOGNITO, incognito);
    ...
    private static void cancelTask(@DownloadTaskType int taskType) {
        ...
        // TODO(shaktisahu): Fix it, since it cancels both normal and incognito mode tasks.
    }
