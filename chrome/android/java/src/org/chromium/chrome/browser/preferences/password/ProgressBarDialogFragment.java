...
public class ProgressBarDialogFragment extends DialogFragment {
    ...
    /**
     * Opens the dialog with the progress bar and sets the cancel button listener to a fragment
     * identified by ID passed in arguments.
     */
    @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // If there is savedInstanceState, then the dialog is being recreated
