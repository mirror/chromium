...
public class WebappActivity extends SingleTabActivity {
    ...
    public void finishNativeInitialization() {
        ...
        getToolbarManager().initializeWithNative(getTabModelSelector(),
                ...
                null, layoutDriver, null, null, null, view -> onToolbarCloseClicked());
    ...
    protected WebappScopePolicy scopePolicy() {
        return WebappScopePolicy.WEB_APP;
    }

    private void updateToolbarCloseVisibility() {
     ...
     */
    private void onToolbarCloseClicked() {
