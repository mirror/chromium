...
public class TranslateTabLayout extends TabLayout {
    ...
    /** We defines the keyframes of the scrolling animation in this object. */
    ...
    public void startScrollingAnimationIfNeeded() {
        ...
        mScrollToEndAnimator = ObjectAnimator.ofInt(this, "scrollX", isRtl ? 0 : maxScrollDistance);
        mScrollToEndAnimator.setStartDelay(START_POSITION_WAIT_DURATION_MS);
        mScrollToEndAnimator.setDuration(SCROLL_DURATION_MS);
        mScrollToEndAnimator.setInterpolator(easeOutInterpolator);
