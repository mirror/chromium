...
public class JavascriptTabModalDialog implements ModalDialogView.Controller {
    ...
    private JavascriptModalDialogView mDialog;
    ...
    private void showDialog(WindowAndroid window, long nativeDialogPointer) {
        ...
        mDialog = JavascriptModalDialogView.create(this, mTitle, mMessage, mDefaultPromptText,
                false, mPositiveButtonTextId, mNegativeButtonTextId);
        mModalDialogManager.showDialog(mDialog, ModalDialogManager.TAB_MODAL);
    }
    ...
    /**
     * Returns the {@link ModalDialogView} associated with this JavascriptTabModalDialog.
     */
    @VisibleForTesting
    public JavascriptModalDialogView getDialogForTest() {
        return mDialog;
    }
