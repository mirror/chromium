...
public class ChromePreferenceManager {
    ...
    /**
     * @return The number of times that bookmarks, history, or downloads was triggered from the
     *         overflow menu while Chrome Home is enabled.
     */
    ...
    /**
     * Increment the count for the number of times bookmarks, history, or downloads was triggered
     * from the overflow menu while Chrome Home is enabled.
     */
    ...
    /**
     * Remove the count for number of times bookmarks, history, or downloads is clicked while Chrome
     * Home is enabled.
     */
