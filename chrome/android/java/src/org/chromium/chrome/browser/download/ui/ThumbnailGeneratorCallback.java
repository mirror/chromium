...
public interface ThumbnailGeneratorCallback {
     ...
     * @param shouldCache Whether the thumbnail should be disk-cached.
     * @param contentId Content ID of the thumbnail.
     * @param bitmap The thumbnail.
     * @param iconSize The requested size of the (square) thumbnail.
     */
    void onThumbnailRetrieved(boolean shouldCache, String contentId, Bitmap bitmap, int iconSize);
}
