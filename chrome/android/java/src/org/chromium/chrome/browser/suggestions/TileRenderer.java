...
public class TileRenderer {
    ...
    private int getLayout() {
        if (mStyle == TileView.Style.CLASSIC) return R.layout.tile_view_classic;
        if (mStyle == TileView.Style.CLASSIC_CONDENSED) return R.layout.tile_view_classic_condensed;
        if (mStyle == TileView.Style.MODERN) return R.layout.tile_view_modern;
