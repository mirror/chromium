...
public class NewTabPageLayout extends LinearLayout {
    ...
    private void calculateVerticalSpacing(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        } else if (SuggestionsConfig.useSitesExplorationUi()) {
            layoutResult = NewTabPageUma.SITE_EXPLORE;
        ...
        // In the Site Explore UI, the site section will always have a child - the TabLayout,
