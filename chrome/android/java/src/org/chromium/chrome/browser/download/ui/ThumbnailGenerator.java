...
public class ThumbnailGenerator {
     ...
     * @param requestedIconSize Requested size (maximum required dimension (pixel) of the smaller
    ...
    @CalledByNative
    @VisibleForTesting
    void onThumbnailRetrieved(@NonNull String contentId, int requestedIconSize,
