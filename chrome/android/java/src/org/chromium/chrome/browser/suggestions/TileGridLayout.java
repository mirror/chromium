...
public class TileGridLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        List<View> orderedChildren = getCorrectTileViewOrder(numColumns);
    ...
    private List getCorrectTileViewOrder(int numColumns) {
        List orderedChildren = new ArrayList(getChildCount());
