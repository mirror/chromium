...
public class TileGridLayout extends FrameLayout {
    static final int sPaddingStart = 0;
    static final int sPaddingEnd = 0;

    private static final int sMarginStart = 12;
    private static final int sMarginEnd = 12;

    private static final int sDisplayMargin = 9;
    ...
    public static int calculateNumColumns() {
        ...
        int totalWidth = Math.min(
                maxWidth, Math.min(metrics.widthPixels, metrics.heightPixels) - 2 * sDisplayMargin);

        // Determine the number of columns that will fit.
        int gridWidth = totalWidth - sPaddingStart - sPaddingEnd - sMarginStart - sMarginEnd;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Determine the number of columns that will fit.
        int gridWidth = totalWidth - sPaddingStart - sPaddingEnd;
