...
public class TileGridLayout extends FrameLayout {
    // TODO(oskopek): Authoritative source on values?
    private static final int sPaddingStart = 0;
    private static final int sPaddingEnd = 0;
     ...
     */
    public static int calculatemNumColumns() {
