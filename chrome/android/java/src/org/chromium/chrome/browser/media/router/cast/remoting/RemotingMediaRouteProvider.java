...
public class RemotingMediaRouteProvider implements MediaRouteProvider, DiscoveryDelegate {
    ...
    /**
     * @return Initialized {@link RemotingMediaRouteProvider} object or null if it's not supported.
     */
    @Nullable
    ...
    public void startObservingMediaSinks(String sourceId) {
        ...
        if (source == null) {
            ...
            // TODO(avayvod): must never happen.
    ...
    // TODO(avayvod): implement the methods below.
    @Override
