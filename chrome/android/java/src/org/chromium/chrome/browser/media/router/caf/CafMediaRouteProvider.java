...
public class CafMediaRouteProvider
    ...
    CafMediaRouteProvider(MediaRouter androidMediaRouter, MediaRouteManager manager) {
    ...
    private boolean handleClientConnectMessage(JSONObject jsonMessage) throws JSONException {
        ...
        if (mSessionController != null) {
            mSessionController.onClientConnected(clientId);
        }
    ...
    public void onSessionEnding(CastSession session) {
        // Replacement of onSessionStopAction().
    }
