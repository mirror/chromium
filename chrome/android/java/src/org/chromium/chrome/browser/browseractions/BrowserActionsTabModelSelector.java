...
public class BrowserActionsTabModelSelector
    ...
    private List<LoadUrlParams> mPendingUrls = new ArrayList<>();

    private Deque<Callback<Tab>> mCallbacks = new ArrayDeque<>();
    ...
    public void markTabStateInitialized() {
        ...
        // Add observer when tab model is fully restored to prevent restored tabs updating tab model
        ...
        TabModelObserver tabModelObserver = new EmptyTabModelObserver() {
            ...
            public void didAddTab(Tab tab, TabLaunchType type) {
                if (tab != null) {
                    ...
                    Callback<Tab> onTabCreated = mCallbacks.pollFirst();
     ...
     */
    public void openNewTab(LoadUrlParams loadUrlParams, Callback<Tab> onTabCreated) {
        mCallbacks.add(onTabCreated);
