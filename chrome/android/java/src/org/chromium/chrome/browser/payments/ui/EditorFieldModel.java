...
public class EditorFieldModel {
     ...
     *
     * @param plusIconDisplayed Whether the last item of the this dropdown list needs a '+' icon.
     */
    public void setDisplayPlusIcon(boolean plusIconDisplayed) {
        assert mInputTypeHint == INPUT_TYPE_HINT_DROPDOWN;
        mPlusIconIncluded = plusIconDisplayed;
    }
