...
public class AddressEditor
     ...
     *
     * @param emailFieldIncluded is true if the address editor has an email field.
     * The autofill form has an email address, and the payment request doesn't.
     */
    ...
    public void edit(
        ...
        System.out.println("Parastoo AddressEditor isNewAddress: " + isNewAddress);
