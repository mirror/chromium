...
public class AddressEditor
    ...
    public void edit(
        ...
        // Email address is present and required if the mEmailIncluded is true.
        if (mEmailIncluded) {
            if (mEmailField == null) {
            ...
            // Email address field is cached, so its value needs to be updated for every new profile
            // that's being edited.
