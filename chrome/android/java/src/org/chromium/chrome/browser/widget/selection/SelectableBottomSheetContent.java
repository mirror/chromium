...
public abstract class SelectableBottomSheetContent<E> implements BottomSheetContent {
    ...
    public void initialize(
        ...
        mManager = manager;
        mContentView = manager.getView();
        mRecyclerView = manager.getRecyclerView();
        mEmptyView = manager.getEmptyView();
    ...
    public List<View> getViewsForPadding() {
        return CollectionUtil.newArrayList(mRecyclerView, mEmptyView);
    }
