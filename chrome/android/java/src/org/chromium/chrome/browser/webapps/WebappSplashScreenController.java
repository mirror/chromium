...
class WebappSplashScreenController extends EmptyTabObserver {
    ...
    public WebappSplashScreenController(WebappActivity activity) {
        mWebappUma = new WebappUma();
    }

    /** Shows the splash screen. */
    public void showSplashScreen(
            WebappActivity activity, ViewGroup parentView, final WebappInfo webappInfo) {
        ...
        mAppName = activity.mWebappInfo.name();
