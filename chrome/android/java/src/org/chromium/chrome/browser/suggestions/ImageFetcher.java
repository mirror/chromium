 ...
 *   - for favicons: {@link #createFaviconRequest(SnippetArticle, int, Callback)}
 *   - for article thumbnails: {@link #createArticleThumbnailRequest(SnippetArticle, Callback)}
 *   - for article downloads: {@link #createDownloadThumbnailRequest(SnippetArticle, int, Callback)}
 *   - for large icons: {@link #createLargeIconRequest(String, int,
 * LargeIconBridge.LargeIconCallback)}
 *
 * You must call the fetch() method on the returned object in order to initiate the
 * image fetching.
 *
...
public class ImageFetcher implements DestructionObserver {
     ...
     *
     * To initiate the image fetch, call {@link DownloadThumbnailRequest#fetch()}.
     *
     ...
     */
    public DownloadThumbnailRequest createDownloadThumbnailRequest(
     ...
     *
     * To initiate the image fetch, call {@link ArticleThumbnailRequest#fetch()}.
     *
     * If there is an error while fetching the thumbnail, the callback will not be called.
     *
     ...
     */
    public ArticleThumbnailRequest createArticleThumbnailRequest(
     ...
     *
     * To initiate the image fetch, call {@link FaviconRequest#fetch()}.
     *
     ...
     */
    public FaviconRequest createFaviconRequest(SnippetArticle suggestion, final int faviconSizePx,
     ...
     *
     * To initiate the image fetch, call {@link LargeIconRequest#fetch()}.
     *
     ...
     */
    public LargeIconRequest createLargeIconRequest(
    ...
    /**
     * Abstract class for all ImageFetcher requests.
     *
     * All requests must have a {@link #fetch()}  method, which will initiate the image fetching.
     */
    public abstract class ImageFetcherRequest {
        protected final SnippetArticle mSuggestion;
        protected final Callback<Bitmap> mCallback;
        protected final int mSize;

        ImageFetcherRequest(SnippetArticle suggestion, Callback<Bitmap> callback, int size) {
    ...
    public class DownloadThumbnailRequest
            extends ImageFetcherRequest implements ThumbnailProvider.ThumbnailRequest {
        DownloadThumbnailRequest(SnippetArticle suggestion, Callback<Bitmap> callback, int size) {
            super(suggestion, callback, size);
        }
     ...
     */
    public class ArticleThumbnailRequest extends ImageFetcherRequest {
        ArticleThumbnailRequest(SnippetArticle suggestion, Callback<Bitmap> callback) {
            super(suggestion, callback, 0);
        }
     ...
     */
    public class FaviconRequest extends ImageFetcherRequest {
     ...
     */
    public class LargeIconRequest extends ImageFetcherRequest {
