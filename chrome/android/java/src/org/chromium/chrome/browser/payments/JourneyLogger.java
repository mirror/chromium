...
public class JourneyLogger {
    ...
    /*
     * Records what payment methods were requested by the merchant in the Payment Request.
     *
     ...
     *                              payment method.
     */
    public void setRequestedPaymentMethods(boolean requestedBasicCard,
            boolean requestedMethodGoogle, boolean requestedMethodOther) {
        nativeSetRequestedPaymentMethods(mJourneyLoggerAndroid, requestedBasicCard,
    ...
    private native void nativeSetRequestedInformation(long nativeJourneyLoggerAndroid,
            ...
            boolean requestName);
    private native void nativeSetRequestedPaymentMethods(long nativeJourneyLoggerAndroid,
