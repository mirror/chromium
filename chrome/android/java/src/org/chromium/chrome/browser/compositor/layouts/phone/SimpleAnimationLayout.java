...
public class SimpleAnimationLayout extends Layout {
    ...
    private void tabCreatedInBackground(
        ...
        CompositorAnimator borderScaleAnimation = CompositorAnimator.ofFloatProperty(handler,
                sourceLayoutTab, LayoutTab.BORDER_SCALE, 1f / scale, 1f, BACKGROUND_STEP1_DURATION);
        CompositorAnimator borderAlphaAnimation = CompositorAnimator.ofFloatProperty(handler,
                sourceLayoutTab, LayoutTab.BORDER_ALPHA, 0f, 1f, BACKGROUND_STEP1_DURATION);
