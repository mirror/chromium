...
public class LanguagesPreferences
        extends PreferenceFragment implements LanguageSelectionFragment.Launcher {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD_LANGUAGES) {
            if (resultCode == getActivity().RESULT_OK) {
                String code =
                        data.getStringExtra(LanguageSelectionFragment.INTENT_NEW_ACCEPT_LANGAUGE);
    ...
    @Override
    public void launchLanguageSeletion() {
