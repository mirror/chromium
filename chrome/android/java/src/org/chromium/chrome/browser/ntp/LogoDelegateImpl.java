...
public class LogoDelegateImpl implements LogoView.Delegate {
    ...
    private static final String LOGO_SHOWN_ID_UMA_NAME = "NewTabPage.LogoShown.ID";
    private static final String LOGO_SHOWN_ID_FROM_CACHE_UMA_NAME =
            "NewTabPage.LogoShown.ID.FromCache";
    private static final String LOGO_SHOWN_ID_FRESH_UMA_NAME = "NewTabPage.LogoShown.ID.Fresh";
    ...
    private static final String LOGO_CLICK_ID_UMA_NAME = "NewTabPage.LogoClick.ID.StaticOrAnimated";
    private static final String LOGO_CLICK_CTA_ID_UMA_NAME = "NewTabPage.LogoClick.ID.CallToAction";
