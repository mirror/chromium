...
public class DataReductionStatsPreference extends Preference {
    ...
    public static void initializeDataReductionSiteBreakdownPref() {
        ...
        long lastUpdate = DataReductionProxySettings.getInstance().getDataReductionLastUpdateTime();
        ...
        if (lastUpdate + DAYS_IN_CHART * DateUtils.DAY_IN_MILLIS > System.currentTimeMillis()) {
            ContextUtils.getAppSharedPreferences()
                    .edit()
                    .putLong(PREF_DATA_REDUCTION_SITE_BREAKDOWN_ALLOWED_DATE,
                            lastUpdate + DAYS_IN_CHART * DateUtils.DAY_IN_MILLIS)
                    .apply();
        } else {
            ContextUtils.getAppSharedPreferences()
                    .edit()
