...
public class WebappInfo {
    ...
    public static WebappInfo create(Intent intent) {
        ...
        return create(id, url, forceNavigation, scope, new Icon(icon), name, shortName, displayMode,
     ...
     */
    public static WebappInfo create(String id, String url, boolean forceNavigation, String scope,
        ...
        return new WebappInfo(id, url, forceNavigation, scope, icon, name, shortName, displayMode,
                orientation, source, themeColor, backgroundColor, isIconGenerated);
    }

    protected WebappInfo(String id, String url, boolean forceNavigation, String scope, Icon icon,
