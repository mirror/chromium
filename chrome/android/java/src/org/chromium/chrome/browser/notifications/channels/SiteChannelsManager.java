...
public class SiteChannelsManager {
    static final java.lang.String CHANNEL_ID_SEPARATOR = ";";
     ...
     */
    public SiteChannel createSiteChannel(String origin, String creationTime, boolean enabled) {
    ...
    private SiteChannel getSiteChannelForOrigin(String origin) {
    ...
    private static SiteChannel toSiteChannel(Channel channel) {
        assert isValidSiteChannelId(channel.getId());
        ...
        return new SiteChannel(
                channel.getId(), parts[0], parts[1], toChannelStatus(channel.getImportance()));
    }
    ...
    static boolean isValidSiteChannelId(String channelId) {
        ...
        String[] parts = channelId.substring(ChannelDefinitions.CHANNEL_ID_PREFIX_SITES.length())
     ...
     */
    public static String createChannelId(String origin, String creationTime) {
    ...
    public String getChannelIdForOrigin(String origin) {
        ...
        return channel != null ? channel.getId() : ChannelDefinitions.CHANNEL_ID_SITES;
    }
}
