...
public class CompositorAnimator extends Animator {
    ...
    private final ObserverList<AnimatorUpdateListener> mAnimatorUpdateListeners =
            new ObserverList<>();
    ...
    public void doAnimationFrame(long deltaTimeMs) {
        ...
        // Push update to listeners. This is done in a for loop to prevent allocating an iterator.
        for (int i = 0; i < mAnimatorUpdateListeners.size(); i++) {
            mAnimatorUpdateListeners.getObserverAt(i).onAnimationUpdate(this);
        }
    ...
    public void addUpdateListener(AnimatorUpdateListener listener) {
        mAnimatorUpdateListeners.addObserver(listener);
    }
    ...
    public void removeUpdateListener(AnimatorUpdateListener listener) {
        mAnimatorUpdateListeners.removeObserver(listener);
    }
