...
public class PartnerBookmarksReader {
    ...
    public static final String LAST_READ_PREFS_NAME = "PartnerBookmarksReader.last_empty_read";
    ...
    private class ReadBookmarksTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (count == 0) {
                ...
                editor.putLong(LAST_READ_PREFS_NAME, System.currentTimeMillis());
                editor.apply();

                Log.w(TAG, "Obtained zero bookmarks.");
            }
