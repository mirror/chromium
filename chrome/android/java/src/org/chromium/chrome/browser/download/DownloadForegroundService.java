 ...
 */
@TargetApi(24) // android.app.Service#stopForeground(int flags) requires API >= 24.
public class DownloadForegroundService extends Service {
    ...
    public void stopDownloadForegroundService(
        ...
        // Reset pinned notification if notification is detached or killed.
        if ((detachNotification && isSdkAtLeast24()) || killNotification) {
