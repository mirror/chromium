...
public class SpannableAutocompleteEditTextModel implements AutocompleteEditTextModelBase {
    ...
    private void setAutocompleteTextInternal(String userText, String autocompleteText) {
        ...
        // Avoid any unnecessary removal and addition of autocomplete text when it
        // is not changed or the previous autocomplete text has been reused.
        if (mPreviouslySetState.getText().equals(userText + autocompleteText)) return;
