...
public class SpannableAutocompleteEditTextModel implements AutocompleteEditTextModelBase {
    ...
    /**
     * A class to keep track of mBatchEditNestCount. It helps avoid incrementing and decrementing
     * the count on every super.beginBatchEdit() and super.endBatchEdit().
     */
