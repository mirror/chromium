...
public class SpannableAutocompleteEditTextModel implements AutocompleteEditTextModelBase {
    ...
    public boolean shouldAutocomplete() {
        boolean retVal = mBatchEditNestCount == 0 && !mLastEditWasDelete && !isPastedText()
                ...
                && (!isComposing()
                           || isTextAlphaNumericOrPunctuations(getTextWithoutAutocomplete()));
    ...
    @VisibleForTesting
    public static boolean isTextAlphaNumericOrPunctuations(String text) {
        // For now we are only concerned about English language use cases.
    ...
    private class AutocompleteInputConnection extends InputConnectionWrapper {
        ...
        public boolean endBatchEdit() {
            ...
            if (mPreBatchEditValidSelection && isCursorAtEndOfUserText()
