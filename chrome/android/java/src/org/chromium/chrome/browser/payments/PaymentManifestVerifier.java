...
public class PaymentManifestVerifier
    ...
    public void onWebAppManifestParseSuccess(WebAppManifestSection[] manifest) {
        ...
        mWebDataService.addPaymentWebAppManifest(flattenListOfLists(mSupportedAppParsedManifests));
     ...
     *
     * @param listOfLists A lists of lists to flatten.
     * @return A single list result.
     */
    private static WebAppManifestSection[] flattenListOfLists(
