...
public class ChannelsInitializer {
    ...
    public @interface ChromeChannel {}
    ...
    @Retention(RetentionPolicy.SOURCE)
    private @interface ChannelGroup {}
    private static final String CHANNEL_GROUP_ID_GENERAL = "general";

    public static void ensureInitialized(Context context, @ChromeChannel String channelId) {
        switch (channelId) {
    ...
    private static void createNotificationChannel(Context context, String channelId,
            int channelNameResId, @ChannelGroup String channelGroupId, int channelGroupNameResId,
