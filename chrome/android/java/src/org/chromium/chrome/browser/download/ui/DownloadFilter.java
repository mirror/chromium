...
public class DownloadFilter {
     ...
     */
    public static int getDrawableForFilter(@Index int filter) {
     ...
     */
    public static int getStringIdForFilter(@Index int filter) {
     ...
     */
    public static String getUrlForFilter(@Index int filter) {
     ...
     */
    public static @Index int getFilterFromUrl(String url) {
    ...
    public static @Index int fromMimeType(String mimeType) {
