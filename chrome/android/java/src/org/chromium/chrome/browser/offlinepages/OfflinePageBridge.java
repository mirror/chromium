...
public class OfflinePageBridge {
    ...
    public boolean isAMP(WebContents webContents) {
        return nativeIsAMP(mNativeOfflinePageBridge, webContents);
    }
    ...
    private native boolean nativeIsOfflinePage(
            long nativeOfflinePageBridge, WebContents webContents);
    private native boolean nativeIsAMP(long nativeOfflinePageBridge, WebContents webContents);
