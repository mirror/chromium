...
public class ChromeWebApkHost {
    ...
    private static class IsGoogleSignedPackageInternal
            implements WebApkValidator.IGoogleSignedPackage {
    ...
    public static void init() {
        WebApkValidator.init(ChromeWebApkHostSignature.EXPECTED_SIGNATURE,
                ChromeWebApkHostSignature.PUBLIC_KEY, new IsGoogleSignedPackageInternal());
