...
public interface ContextualSearchRankerLogger {
    ...
    /**
     * Runs the machine intelligence model for tap suppression (if possible) and returns an int that
     ...
     * details on the {@link MachineIntelligencePrediction} possibilities.
    ...
    /**
     * Gets the previous result from running the machine intelligence model for tap suppression.
     * A previous call to {@link #runPredictionForTapSuppression} is required.
     * See chrome/browser/android/contextualsearch/contextual_search_ranker_logger_impl.h for
     * details on the {@link MachineIntelligencePrediction} possibilities.
     * @return An integer that encodes the prediction.
     */
