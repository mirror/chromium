...
public class ContextualSearchManager
    ...
    /** Whether the Contextual Search UI needs to be suppressed due to Smart Select being active. */
    private boolean mSuppressContextualSearchForSmartSelect;
    ...
    /**
     * Suppress the Contextual Search UX due to Smart Select handling long-press.
     */
    public void suppressContextualSearchForSmartSelect() {
        // TODO(donnd): add logging for Smart Select suppression!
        mSuppressContextualSearchForSmartSelect = true;
    }
    ...
    private void showContextualSearch(StateChangeReason stateChangeReason) {
        ...
        if (isTap && mPolicy.shouldPreviousTapResolve()) {
            ...
            if (!isTap && mSearchPanel.isPeeking()) {
                ...
                String userActionToRecordString = isSingleWord
                        ? "ContextualSearch.ManualRefineSingleWord"
                        : "ContextualSearch.ManualRefineMultiWord";
                RecordUserAction.record(userActionToRecordString);
            }
        } else {
    ...
    /**
     * @return a {@link SelectionClient} that can handle ContextualSearch.
     */
    SelectionClient createSelectionClient() {
        return new ContextualSearchSelectionClient();
    }
    ...
    ContextualSearchInternalStateHandler getContextualSearchInternalStateHandler() {
        return new ContextualSearchInternalStateHandler() {
            ...
            public void showContextualSearchLongpressUi() {
                ...
                boolean isSmartSelectActive = mSuppressContextualSearchForSmartSelect
