...
public class ContextualSearchManager
    ...
    private void loadSearchUrl() {
        ...
        nativeEnableContextualSearchJsApi(
                mNativeContextualSearchManagerPtr, getSearchPanelWebContents(), searchUrl);
    ...
    protected native void nativeGatherSurroundingText(long nativeContextualSearchManager,
            ContextualSearchContext contextualSearchContext, WebContents baseWebContents);
    private native void nativeEnableContextualSearchJsApi(
            long nativeContextualSearchManager, WebContents overlayWebContents, String url);
