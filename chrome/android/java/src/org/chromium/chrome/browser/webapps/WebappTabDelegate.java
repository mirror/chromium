...
public class WebappTabDelegate extends TabDelegate {
    ...
    private WebappActivity.ActivityType mActivityType;

    public WebappTabDelegate(boolean incognito, WebappActivity.ActivityType activityType) {
        super(incognito);
    ...
    public void createNewTab(AsyncTabCreationParams asyncParams, TabLaunchType type, int parentId) {
        ...
        intent.putExtra(
                CustomTabIntentDataProvider.EXTRA_BROWSER_LAUNCH_SOURCE, mActivityType.getValue());
