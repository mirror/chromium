...
public final class ReauthenticationManager {
    ...
    public enum ReauthScope { BULK, ONE_AT_A_TIME }
    ...
    private static ReauthScope sLastReauthScope = ReauthScope.ONE_AT_A_TIME;
     ...
     */
    public static void recordLastReauth(long timeStampMillis, ReauthScope scope) {
    ...
    public static void displayReauthenticationFragment(int descriptionId, int containerViewId,
            FragmentManager fragmentManager, ReauthScope scope) {
    ...
    /** Checks whether authentication is recent enought to be valid. The authentication is valid as
     * long as the user authenticated less than |VALID_REAUTHENTICATION_TIME_INTERVAL_MILLIS|
     * milliseconds ago, for a scope including the passed |scope| argument. The BULK scope includes
     * the ONE_AT_A_TIME scope.
     * @param scope The scope the reauth should be valid for. */
    public static boolean authenticationStillValid(ReauthScope scope) {
        final boolean scopeIncluded =
                scope == sLastReauthScope || sLastReauthScope == ReauthScope.BULK;
        return sLastReauthTimeMillis != 0 && scopeIncluded
