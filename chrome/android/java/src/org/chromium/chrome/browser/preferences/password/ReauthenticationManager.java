...
public final class ReauthenticationManager {
    ...
    // Used in tests to override the result of check for availability of the screen-locking API.
    ...
    public static void setApiOverride(OverrideState apiOverride) {
        // Ensure that tests don't accidentally try to launch the OS-privided lock screen.
