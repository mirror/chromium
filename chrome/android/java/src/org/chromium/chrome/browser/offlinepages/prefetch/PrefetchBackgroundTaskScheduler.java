...
public class PrefetchBackgroundTaskScheduler {
    ...
    /** Shorter delay for when limitless prefetching is enabled. */
    public static final long SHORT_START_DELAY_SECONDS = 30;
     ...
     */
    @CalledByNative
    public static void scheduleTask(int additionalDelaySeconds, boolean limitlessPrefetching) {
        final long minimumTimeSeconds =
                (limitlessPrefetching ? SHORT_START_DELAY_SECONDS : DEFAULT_START_DELAY_SECONDS)
