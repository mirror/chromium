...
public class VrDialog implements DialogRenderer {
    ...
    protected void closeVrDialog() {
        nativeCloseVrDialog(mNativeVrShellDelegate);
    }

    protected void initVrDialog() {
        ...
        nativeInitVrDialog(mNativeVrShellDelegate, mVrLayout.getWidth(), mVrLayout.getHeight());
    }
    ...
    private native long nativeInitVrDialog(long vrShellDelegate, int width, int height);
    private native void nativeSetSize(long vrShellDelegate, int width, int height);
    private native void nativeCloseVrDialog(long vrShellDelegate);
}
