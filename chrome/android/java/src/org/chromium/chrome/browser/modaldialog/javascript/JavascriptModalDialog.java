...
public class JavascriptModalDialog extends ModalDialog {
    ...
    public JavascriptModalDialog(Activity ownerActivity, ModalDialog.Controller controller) {
        super(ownerActivity, controller);
        initViews();
    }
    ...
    public void setSuppressCheckBoxVisibility(boolean visible) {
        mCustomLayout.findViewById(org.chromium.chrome.R.id.suppress_js_modal_dialogs)
