...
public class MostVisitedSitesBridge
    ...
    @Override
    public void recordTileImpression(int index, int tileType, int source, String tileUrl) {
        nativeRecordTileImpression(mNativeMostVisitedSitesBridge, index, tileType, source, tileUrl);
    }
    ...
    private native void nativeRecordTileImpression(
            long nativeMostVisitedSitesBridge, int index, int tileType, int source, String tileUrl);
