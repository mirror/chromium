...
public class PasswordEditor extends EditorBase<SavedPasswordEntry> {
    ...
    private SiteValidator mSiteValidator;
    ...
    public void edit(@Nullable final SavedPasswordEntry toEdit,
        ...
        super.edit(null, callback); // toEdit is ignored on purpose. Only adding new is supported.
        ...
        mEditor.setCancelCallback(() -> { callback.onResult(toEdit); });
