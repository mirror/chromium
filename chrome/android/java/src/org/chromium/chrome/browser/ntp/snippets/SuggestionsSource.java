...
public interface SuggestionsSource {
    ...
    /**
     * Destroys the resources associated to the source and all observers will be unregistered.
     * It should not be used after this is called.
     * DestructionObservers are guaranteed to be called before the SuggestionsSource is destroyed.
     */
    void destroy();
