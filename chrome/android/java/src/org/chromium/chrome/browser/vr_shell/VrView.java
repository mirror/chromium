...
public class VrView implements DialogRenderer {
    ...
    protected long mNativeVrShellDelegate;
    protected long mNativeVrView;
    private boolean mIsDown = false;
    private boolean mIsShowing = false;

    protected PointerProperties[] mPointerProperties;
    protected PointerCoords[] mPointerCoords;
    protected View mTarget;
    private long mDownTimeInMs;
    protected LinearLayout mVrLayout;
    ...
    @Override
    public void dismiss() {
        closeVrView(mNativeVrShellDelegate);
    }
    ...
    public void onMouseUp(float x, float y) {
        mIsDown = false;
        VrShellDelegate.sendToView(new Runnable() {
            public void run() {
    ...
    protected void closeVrView(long vrShellDelegate) {
        nativeCloseVrView(vrShellDelegate);
    }

    protected long initVrView(long vrShellDelegate) {
        return nativeInitVrView(vrShellDelegate);
    }
