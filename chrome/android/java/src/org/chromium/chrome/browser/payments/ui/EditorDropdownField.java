...
class EditorDropdownField implements EditorFieldView {
    ...
    public EditorDropdownField(Context context, ViewGroup root, final EditorFieldModel fieldModel,
        ...
        if (mFieldModel.getHint() != null) {
            ...
            if (mFieldModel.isPlusIconDisplayed()) {
        ...
        // If no value is selected the mSelectedIndex would be negative. In this case, we select the
        // hint, which is the first item on the dropdown adapter.
