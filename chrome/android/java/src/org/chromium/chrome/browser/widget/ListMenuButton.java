...
public class ListMenuButton extends TintedImageButton {
    ...
    public static class Item {
        ...
        /**
         * Creates a new {@link Item} without Icon.
         */
    ...
    private void showMenu() {
        ...
        mPopupMenu.setAdapter(new ArrayAdapter<Item>(getContext(), R.layout.list_menu_item, items) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                // Set a drawable for the textview at the end if a valid icon resId returns.
                if (items[position].getEndIconId() != INVALID_RES_ID) {
