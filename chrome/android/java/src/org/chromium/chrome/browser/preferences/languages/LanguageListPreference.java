...
public class LanguageListPreference extends Preference {
    ...
    private LanguageSelectionFragment.Launcher mLauncher;
    ...
    public View onCreateView(ViewGroup parent) {
        ...
        ApiCompatibilityUtils.setCompoundDrawablesRelativeWithIntrinsicBounds(mAddLanguageButton,
                ...
                null, null, null);
        mAddLanguageButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mLauncher != null) mLauncher.launchLanguageSeletion();
            }
        });
    ...
    /**
     * Register a launcher for LanguageSelectionFragment. Preference's host fragment should call
     * this in its onCreate().
     */
    void registerActivityLauncher(LanguageSelectionFragment.Launcher launcher) {
        mLauncher = launcher;
    }
}
