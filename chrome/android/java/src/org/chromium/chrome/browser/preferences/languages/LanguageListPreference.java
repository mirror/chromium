...
public class LanguageListPreference extends Preference {
    ...
    private static class LanguageItemViewHolder extends RecyclerView.ViewHolder
            implements ListMenuButton.Delegate, ListMenuButton.MenuDecorator {
        ...
        LanguageItemViewHolder(View view) {
            ...
            // language.
            mItems = new Item[] {
                    new Item(mContext, R.string.languages_item_option_offer_to_translate, true),
                    new Item(mContext, R.string.languages_item_option_remove, true)};
        }

        private void setupUI(final int langPosition, String title) {
        ...
        public void onItemSelected(Item item) {
            ...
            } else if (item.getTextId() == R.string.languages_item_option_remove) {
