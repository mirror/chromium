...
public class WebappUma {
     ...
     */
    public static void recordCommittedNavigationStatus(boolean isSuccess) {
        RecordHistogram.recordBooleanHistogram(WebappUma.HISTOGRAM_NAVIGATION_STATUS, isSuccess);
    }
