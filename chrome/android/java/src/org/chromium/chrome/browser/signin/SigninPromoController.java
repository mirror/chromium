...
public class SigninPromoController {
    ...
    /**
     * Records "ImpressionsTilDismiss" histogram if the user has not interacted with the promo
     * whatsoever.
     */
    public void recordImpressionsTilDismiss() {
        if (mWasUsed || mImpressionsTilDismissHistogramName == null) {
            return;
        }
