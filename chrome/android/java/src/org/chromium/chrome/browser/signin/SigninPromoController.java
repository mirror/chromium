...
public class SigninPromoController {
    ...
    private ProfileDataCache.CacheEntry mProfileData;
    ...
    public void recordSigninPromoImpression() {
        ...
        if (mProfileData.getAccountName() == null) {
    ...
    /**
     * Sets the profile data which will be used in the promo's configuration.
     */
    public void setProfileData(ProfileDataCache.CacheEntry profileData) {
    ...
    private void setupHotState(final Context context, SigninPromoView view) {
        Drawable accountImage = mProfileData.getPicture();
        ...
        String signinButtonText =
                context.getString(R.string.signin_promo_continue_as, mProfileData.getFullName());
