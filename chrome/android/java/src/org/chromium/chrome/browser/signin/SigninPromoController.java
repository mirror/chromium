...
public class SigninPromoController {
    ...
    public void setupPromoView(Context context, PersonalizedSigninPromoView view,
        ...
        // TODO(bauerb): Change to an assert if we have more certainty that this doesn't happen.
        if (mImpressionTracker != null) {
            throw new IllegalStateException("detach() should be called before setting up a new " +
                    "view");
        }
