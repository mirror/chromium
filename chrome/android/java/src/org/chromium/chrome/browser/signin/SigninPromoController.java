...
import org.chromium.chrome.browser.metrics.ImpressionFilter;
...
public class SigninPromoController {
    ...
    private final ImpressionFilter mImpressionFilter =
            new ImpressionFilter(this::recordSigninPromoImpression);
