...
public class PureJavaExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static void uninstallHandler() {
        // This handler can be in the middle of an exception handler chain. We do not know
        // about the handlers before it. If resetting the uncaught exception handler using the
        // mParent, we lost all the handlers before mParent. To disable this handler, globally
        // setting a flag to ignore it seems to be the easiest way.
        sIsDisabled = true;
    }
