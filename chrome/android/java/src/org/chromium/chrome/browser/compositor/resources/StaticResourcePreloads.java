...
public class StaticResourcePreloads {
    ...
    public static int[] getSynchronousResources(Context context) {
        return DeviceFormFactor.isTabletLayout(context) ? sSynchronousResources : sEmptyList;
    }

    public static int[] getAsynchronousResources(Context context) {
        return DeviceFormFactor.isTabletLayout(context) ? sAsynchronousResources : sEmptyList;
    }
}
