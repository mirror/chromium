...
public class DownloadActivity extends SnackbarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean expandPrefetchContent = DownloadUtils.shouldExpandPrefetchContent(getIntent());
        ...
        if (expandPrefetchContent) mDownloadManagerUi.expandPrefetchedContent(true);
    }
