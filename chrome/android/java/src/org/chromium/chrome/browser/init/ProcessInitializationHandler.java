    ...
    private static void logEGLShaderCacheSizeHistogram() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... unused) {
                ...
                // This filename is defined in core/java/android/view/HardwareRenderer.java in
                // Android's platform/frameworks/base since ICS.
                File cacheFile = new File(codeCacheDir, "com.android.opengl.shaders_cache");
                if (!cacheFile.exists()) {
                    return null;
                }
                // Record file sizes between 0-2560KB. Expected range is 0-2048KB, so this gives
                // us a bit of buffer.
                int minFileSizeKb = 0;
                int maxFileSizeKb = 2560;
                ...
                if (cacheFileSizeKb < minFileSizeKb) cacheFileSizeKb = minFileSizeKb;
                if (cacheFileSizeKb >= maxFileSizeKb) cacheFileSizeKb = maxFileSizeKb - 1;
                String histogramName = "Memory.Experimental.Browser.EGLShaderCacheSize.Android";
                RecordHistogram.recordCustomCountHistogram(
                        histogramName, (int) cacheFileSizeKb, minFileSizeKb, maxFileSizeKb, 50);
                return null;
            }
        }
                .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
