...
public class MainPreferences extends PreferenceFragment
    ...
    private void loadPreferences() {
        ...
        cachePreferences();
        configureChromeBasePreference(PREF_SEARCH_ENGINE);
        configureChromeBasePreference(PREF_AUTOFILL_SETTINGS);
        configureChromeBasePreference(PREF_SAVED_PASSWORDS);
        configureChromeBasePreference(PREF_DATA_REDUCTION);
    ...
    private void configureChromeBasePreference(String key) {
