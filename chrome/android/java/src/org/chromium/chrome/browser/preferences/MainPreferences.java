...
public class MainPreferences extends PreferenceFragment
    ...
    private ChromeBasePreference mSearchEnginePreference;
    ...
    private void setupSearchEnginePreference() {
        if (mSearchEnginePreference == null) {
            mSearchEnginePreference = setupChromeBasePreference(
        ...
        if (TemplateUrlService.getInstance().isLoaded()) {
            ...
            mSearchEnginePreference.setEnabled(false);
        }
    }
    ...
    private void updateSearchEnginePreferenceSummary() {
        ...
        mSearchEnginePreference.setEnabled(true);
        mSearchEnginePreference.setSummary(defaultSearchEngineName);
    }
