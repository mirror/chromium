...
public class MainPreferences extends PreferenceFragment
        implements SigninManager.SignInStateObserver, SigninManager.SignInAllowedObserver,
                   Preference.OnPreferenceClickListener, TemplateUrlService.LoadListener {
    ...
    private Preference getPreferenceFromSavedPreferences(String key) {
        ...
        assert false : "Unexpected key preference key: " + key;
        return null;
    }
