...
/**
 * UI component that handles showing a popupwindow  Positioning this bubble happens through
 * calls to {@link #setAnchorRect(Rect)}.  This should be called at least once before the
 * {@link #show()} call.  To attach to a {@link View} see {@link ViewAnchoredPopupWindow}.
 */
public class AnchoredPopupWindow implements OnTouchListener {
    /** VerticalOrientation preferences for the bubble */
    public enum VerticalOrientation { MAX_AVAILABLE_SPACE, BELOW, ABOVE }

    /** HorizontalOrientation preferences for the bubble */
    ...
    private void updateBubbleLayout() {
        ...
        mBackground.getPadding(mCachedPaddingRect);
