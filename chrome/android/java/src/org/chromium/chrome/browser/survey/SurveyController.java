 ...
 * survey can be downloaded and shown.
 */
public class SurveyController {
     ...
     */
    public void downloadSurvey(Context context, String surveyId, String advertisingId) {
        return;
    }
     ...
     */
    public void initialize(Context context, String surveyId, boolean showAsBottomSheet,
            int displayLogo, Callback<?> onSurveyAvailableCallback) {
        return;
    }
