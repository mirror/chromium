...
public class WebApkInstaller {
    ...
    /** We always use the same id for the notification*/
    ...
    private void installWebApkAsync(final String packageName, int version, final String title,
        ...
        showInstallStartNotification(packageName, title, url, icon);
    ...
    private void showNotification(String webApkPackage, String title, String url, Bitmap icon,
        ...
        notificationManager.notify(webApkPackage, PLATFORM_ID, notificationBuilder.build());
    }

    /** Cancels any ongoing notification for the WebAPK. */
    @CalledByNative
    private void cancelNotification(String webApkPackage) {
        NotificationManager notificationManager =
                (NotificationManager) ContextUtils.getApplicationContext().getSystemService(
                        NOTIFICATION_SERVICE);
        notificationManager.cancel(webApkPackage, PLATFORM_ID);
    }
