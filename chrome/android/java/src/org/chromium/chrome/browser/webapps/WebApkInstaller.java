...
public class WebApkInstaller {
     ...
     * @param badge The badge icon of the WebAPK to install.
     */
    @CalledByNative
        ...
        Callback<Integer> callback = new Callback<Integer>() {
            ...
            public void onResult(Integer result) {
                ...
                if (result == WebApkInstallResult.SUCCESS
                    ...
                    showInstallNotification(packageName, title, url, icon, badge);
                }
    ...
    private void showInstallNotification(
            String webApkPackage, String title, String url, Bitmap icon, Bitmap badge) {
