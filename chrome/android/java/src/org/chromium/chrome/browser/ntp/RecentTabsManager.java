...
public class RecentTabsManager implements AndroidSyncSettingsObserver, SignInStateObserver,
    ...
    @IntDef({PROMO_NEW, PROMO_NONE, PROMO_OLD})
    @interface PromoType {}
    static final int PROMO_NEW = 0;
    static final int PROMO_NONE = 1;
    static final int PROMO_OLD = 2;
    ...
    int getPromoType() {
        ...
        return SigninPromoController.shouldShowPromo(SigninAccessPoint.RECENT_TABS) ? PROMO_NEW
                                                                                    : PROMO_OLD;
    }
