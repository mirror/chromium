...
public class CardUnmaskPrompt
    ...
    public CardUnmaskPrompt(Context context, CardUnmaskPromptDelegate delegate, String title,
        ...
        // Hitting the "submit" button on the software keyboard should submit the form if valid or
        // show the validation error otherwise.
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (positiveButton.isEnabled()) {
                        ...
                        showDetailedErrorMessage(getExpirationAndCvcErrorType());
                        if (sObserverForTest != null) {
                            sObserverForTest.onCardUnmaskPromptValidationDone(
