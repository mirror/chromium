...
public class ToolbarProgressBar extends ClipDrawableProgressBar {
    ...
    /** Whether the smooth animation is running. */
    private boolean mIsRunningSmoothAnimation;
    ...
    private final Runnable mHideRunnable = new Runnable() {
        ...
        public void run() {
            animateAlphaTo(0.0f);
            mIsRunningSmoothAnimation = false;
    ...
    private final Runnable mStartSmoothIndeterminate = new Runnable() {
        ...
        public void run() {
            ...
            mIsRunningSmoothAnimation = true;
