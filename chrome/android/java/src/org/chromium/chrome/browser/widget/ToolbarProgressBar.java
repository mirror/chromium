...
public class ToolbarProgressBar extends ClipDrawableProgressBar {
    ...
    private final class ThrottleTimeListener implements TimeListener {
        ...
        private float mThrottledProgessTarget;
        ...
        public void onTimeUpdate(TimeAnimator animation, long totalTime, long deltaTime) {
            ...
            setProgressInternal(MathUtils.clamp(updatedProgress, 0f, mThrottledProgessTarget));

            if (updatedProgress >= mThrottledProgessTarget) animation.end();
    ...
    public void setProgress(float progress) {
        ...
        if (mProgressThrottle != null
            ...
            mProgressThrottleListener.mThrottledProgessTarget = progress;
