...
public class OfflinePageUtils {
    ...
    private static class OfflinePageUtilsImpl implements Internal {
        ...
        public boolean isAMP(Tab tab) {
            ...
            return offlinePageBridge.isAMP(webContents);
        }
    ...
    public static boolean isAMP(Tab tab) {
        return getInstance().isAMP(tab);
    }
