...
public class ContextualSearchRankerLoggerImpl implements ContextualSearchRankerLogger {
    ...
    private @MachineIntelligencePrediction int mMachineIntelligencePrediction =
            MachineIntelligencePrediction.UNDETERMINED;
    ...
    @Override
    public @MachineIntelligencePrediction int runPredictionForTapSuppression() {
        ...
        if (isEnabled() && mBasePageWebContents != null && mFeaturesToLog != null) {
            ...
            int predictionDescriptor = nativeRunInference(mNativePointer);
            mMachineIntelligencePrediction = predictionDescriptor;
        }

        return mMachineIntelligencePrediction;
    }

    @Override
    public @MachineIntelligencePrediction int getPredictionForTapSuppression() {
        return mMachineIntelligencePrediction;
    }
    ...
    public void reset() {
        ...
        mMachineIntelligencePrediction = MachineIntelligencePrediction.UNDETERMINED;
    }
    ...
    // Returns a MachineIntelligencePrediction value.
