...
public interface AutocompleteEditTextModelBase {
    ...
    public interface Delegate {
        /** See {@link TextView#getText()}.*/
        Editable getText();

        /** See {@link TextView#getEditableText()}.*/
        Editable getEditableText();

        /** See {@link TextView#append(CharSequence)}.*/
        void append(CharSequence subSequence);

        /** See {@link TextView#getSelectionStart()}.*/
        int getSelectionStart();

        /** See {@link TextView#getSelectionEnd()}.*/
        int getSelectionEnd();

        /** See {@link EditText#setSelection(int, int)}.*/
        void setSelection(int autocompleteIndex, int length);

        /** See {@link TextView#announceForAccessibility(CharSequence)}.*/
