...
public class FeatureUtilities {
    ...
    private static Boolean sIsChromeModernDesignEnalbed;
    ...
    public static boolean isChromeModernDesignEnabled() {
        ...
        if (sIsChromeModernDesignEnalbed == null) {
            ChromePreferenceManager prefManager = ChromePreferenceManager.getInstance();
            try (StrictModeContext unused = StrictModeContext.allowDiskReads()) {
                sIsChromeModernDesignEnalbed = prefManager.isChromeModernDesignEnabled();
            }
        }

        return sIsChromeModernDesignEnalbed;
    }
