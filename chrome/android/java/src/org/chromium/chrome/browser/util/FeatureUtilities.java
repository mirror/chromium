...
public class FeatureUtilities {
    ...
    public static boolean isChromeHomeEnabled() {
        ...
        if (sChromeHomeEnabled == null) {
            ...
            if (ChromeFeatureList.isInitialized() && !didUserEnableFeature) {
