...
/**
 * Fragment with a {@link RecyclerView} containing a list of languages.
 */
public class LanguageSelectionFragment extends Fragment {
    static final String INTENT_NEW_ACCEPT_LANGAUGE = "LanguageSelectionFragment.NewLangauge";

    /**
     * A host to launch LanguageSelectionFragment and receive the result.
     */
    interface Launcher {
        /**
         * Launches LanguageSelectionFragment.
         */
        void launchLanguageSeletion();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO(crbug/783049): Record impression.
    }
