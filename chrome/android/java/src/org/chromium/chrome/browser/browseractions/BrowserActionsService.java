...
public class BrowserActionsService extends Service {
    ...
    public static final String ACTION_TAB_CREATION_CRHOME_DISPLAYED =
            "org.chromium.chrome.browser.browseractions.ACTION_TAB_CREATION_CRHOME_DISPLAYED";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        } else if (TextUtils.equals(intent.getAction(), ACTION_TAB_CREATION_CRHOME_DISPLAYED)) {
            setStatus(false);
            stopForeground(true);
        }
    ...
    private void setStatus(boolean isAlive) {
        ContextUtils.getAppSharedPreferences()
                .edit()
                .putBoolean(PREF_IS_BROWSER_ACTIONS_SERVICE_ALIVE, isAlive)
                .apply();
    }

    private static boolean getStatus() {
        return ContextUtils.getAppSharedPreferences().getBoolean(
                PREF_IS_BROWSER_ACTIONS_SERVICE_ALIVE, false);
    }
    ...
    public static void cancelBrowserActionsNotification() {
        ...
        // will be dismissed.
        if (BrowserActionsService.getStatus()) {
            BrowserActionsService.sendIntent(
                    ACTION_TAB_CREATION_CRHOME_DISPLAYED, Tab.INVALID_TAB_ID);
        } else {
