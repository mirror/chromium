...
public abstract class PaymentInstrument extends PaymentOption {
    ...
    public interface InstrumentDetailsCallback {
        ...
        /**
         * Called after aborting retrieving instrument details.
         *
         * @param result Indicates whether abort is succeed or not.
         */
        void onAbortedInstrumentDetails(boolean result);
    }
    ...
    public void abortInvokePaymentApp(InstrumentDetailsCallback callback) {
        ThreadUtils.postOnUiThread(new Runnable() {
            @Override
            public void run() {
                callback.onAbortedInstrumentDetails(false);
            }
        });
    }
