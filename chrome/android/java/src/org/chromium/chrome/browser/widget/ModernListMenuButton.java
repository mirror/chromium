 ...
 * results.
 */
public class ModernListMenuButton extends TintedImageButton {
    ...
    /**
     * Creates a new {@link ModernListMenuButton}.
     ...
     */
    public ModernListMenuButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void showMenu() {
        ...
        mPopupMenu = new ListPopupWindow(getContext(), null, 0, R.style.ModernListMoreMenuStyle);
        mPopupMenu.setAdapter(
                new ArrayAdapter<Item>(getContext(), R.layout.modern_list_more_item, items) {
                    @Override
        ...
        mPopupMenu.setWidth(getResources().getDimensionPixelSize(R.dimen.list_more_menu_width));
