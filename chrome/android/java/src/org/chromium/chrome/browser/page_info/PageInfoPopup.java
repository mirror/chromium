...
public class PageInfoPopup implements OnClickListener {
    ...
    private PageInfoPopup(Activity activity, Tab tab, String offlinePageCreationDate,
        ...
        boolean isInstantAppAvailable = instantAppsHandler.isInstantAppAvailable(
                mFullUrl, false /* checkHoldback */, false /* includeUserPrefersBrowser */);
        if (!mIsInternalPage && !isShowingOfflinePage() && isInstantAppAvailable) {
