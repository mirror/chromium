...
public class ChromeCastSessionManager {
    ...
    public interface CastSessionLaunchRequest {
        ...
        public ChromeCastSessionObserver getSessionObserver();
    }
     ...
     * @param sessionObserver the object that should be notified of the session's lifetime changes.
     */
    public void onSessionCreated(CastSession session) {
     ...
     * Calls back into onSessionLaunching.
     * @param request the information required to launch the session.
     */
    ...
    /**
     * Starts the session launching request.
     * Will receive a call to onSessionCreated or onSessionLaunchError based on the success/failure
     * of the launch.
     */
    private void launchSession(CastSessionLaunchRequest request) {
        mSessionLaunching = true;

        mCurrentSessionObserver = request.getSessionObserver();
        mCurrentSessionObserver.onSessionLaunching(request);
    ...
    /**
     * Called when the session has closed. The session may no longer be valid at this point.
     */
    public void onSessionClosed() {
