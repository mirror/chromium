...
public class ChromeCastSessionManager {
    ...
    public interface CastSessionLaunchRequest {
        ...
        // onSessionCreated() and onSessionLaunchError() calls.
     ...
     * Calls back into onBeforeSessionLaunch.
     ...
     * Will result in a call to onSessionCreated or onSessionLaunchError based on the
    ...
    private void launchSession(CastSessionLaunchRequest request) {
        ...
        mCurrentSessionObserver.onBeforeSessionLaunch(request);
