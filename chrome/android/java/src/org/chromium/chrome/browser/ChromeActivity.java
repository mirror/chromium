...
public abstract class ChromeActivity extends AsyncInitializationActivity
    ...
    try (TraceEvent te = TraceEvent.scoped("ChromeActivity.createWindowAndroid")) {
    ...
    public void onStartWithNative() {
        try (TraceEvent te = TraceEvent.scoped("ChromeActivity.onStartWithNative")) {
    ...
    @Override
    public void onStart() {
        try (TraceEvent te = TraceEvent.scoped("ChromeActivity.onStart")) {
