...
public abstract class ChromeActivity extends AsyncInitializationActivity
    ...
    protected void completePostInflationStartup() {
        try (TraceEvent te = TraceEvent.scoped("ChromeActivity.completePostInflationStartup")) {
    ...
    protected final void setContentView() {
        ...
        if (warmupManager.hasViewHierarchyWithToolbar(getControlContainerLayoutId())) {
            ...
            try (TraceEvent te2 = TraceEvent.scoped("ChromeActivity.setContentView:fake_toolbar")) {
                setContentView(R.layout.fake_toolbar);
            }
    ...
    public void initializeState() {
        try (TraceEvent te = TraceEvent.scoped("ChromeActivity.initializeState")) {
    ...
    public void finishNativeInitialization() {
        try (TraceEvent te = TraceEvent.scoped("ChromeActivity.finishNativeInitialization")) {
