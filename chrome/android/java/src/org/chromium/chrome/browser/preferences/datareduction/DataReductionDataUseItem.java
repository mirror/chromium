...
public class DataReductionDataUseItem {
     ...
     * data saved, return zero savings so that negative savings are not shown.
     ...
     * greater than data saved, return zero savings so that negative savings are not shown.
     * @param context An Android context.
