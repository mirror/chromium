...
public class OmniboxSuggestion {
    ...
    private static SharedPreferences sSharedPreferencesForZeroSuggest;
    ...
    private static SharedPreferences getSharedPreferencesForCachedSuggestions() {
        return sSharedPreferencesForZeroSuggest;
    }

    private static void initializeSharedPreferencesForCachedSuggestions() {
        sSharedPreferencesForZeroSuggest =
    ...
    public static void cacheOmniboxSuggestionListForZeroSuggest(
        ...
        if (suggestions.equals(sCachedZeroSuggestList)
                || getSharedPreferencesForCachedSuggestions() == null)
            return;
    ...
    public static List<OmniboxSuggestion> getCachedOmniboxSuggestionsForZeroSuggest() {
        initializeSharedPreferencesForCachedSuggestions();
