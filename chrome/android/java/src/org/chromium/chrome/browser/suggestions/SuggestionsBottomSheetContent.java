...
public class SuggestionsBottomSheetContent implements BottomSheet.BottomSheetContent,
    ...
    private void updateLogoTransition() {
        ...
        if (toolbarOffset == maxToolbarOffset) {
     ...
     */
    private class NtpTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            if (mLogoRect.contains(x, y)) {
                return mLogoTouchDelegate.onTouchEvent(event);
            } else if (mMenuButtonRect.contains(x, y)) {
                return mMenuButtonTouchDelegate.onTouchEvent(event);
            } else if (mToolbarRect.contains(x, y)) {
                return mToolbarTouchDelegate.onTouchEvent(event);
            }
