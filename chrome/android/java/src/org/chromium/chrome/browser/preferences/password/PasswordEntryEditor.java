...
public class PasswordEntryEditor extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // NOTE: This is deliberately not simplified so that the histogram strings can be found
        // via code search and pre-submit scripts can catch errors. Also applies to similar spots
        // below.
        if (mException) {
