            ...
            if (!mException) {
                ...
                if (isReauthenticationAvailable()) {
                    ...
                    if (!isPasswordSyncingUser()) {
                        ...
                        View passwordsLinkView = mView.findViewById(R.id.password_sync);
                        passwordsLinkView.setVisibility(View.VISIBLE);
                        TextView passwordsLinkTextView =
                                passwordsLinkView.findViewById(R.id.passwords_link);
