...
public class CompositorButton implements VirtualView {
     ...
     */
    public static final android.util.Property<CompositorButton, Float> OPACITY =
            new Property<CompositorButton, Float>(Float.class, "opacity") {
                @Override
                public void set(CompositorButton object, Float value) {
