...
public class AccessibilityTabModelWrapper extends LinearLayout {
            ...
            mModernStackButtonWrapper.addOnTabSelectedListener(
                    new TabLayout.OnTabSelectedListener() {
                        ...
                        public void onTabSelected(TabLayout.Tab tab) {
                            setSelectedMode(mModernIncognitoButton.isSelected());
                        }
    ...
    /**
     * Set either standard or incognito mode is currently selected.
     * @param incognitoSelected Whether incognito mode is selected.
     */
    private void setSelectedMode(boolean incognitoSelected) {
        if (mTabModelSelector != null) {
            if (incognitoSelected != mTabModelSelector.isIncognitoSelected()) {
