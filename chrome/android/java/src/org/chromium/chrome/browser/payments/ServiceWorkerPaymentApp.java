...
public class ServiceWorkerPaymentApp extends PaymentInstrument implements PaymentApp {
    ...
    public ServiceWorkerPaymentApp(WebContents webContents, long registrationId, String label,
            ...
            @Nullable String[] preferredRelatedApplicationIds) {
        ...
        if (preferredRelatedApplicationIds != null) {
            mPreferredRelatedApplicationIds = new HashSet();
            for (int i = 0; i < preferredRelatedApplicationIds.length; i++) {
                mPreferredRelatedApplicationIds.add(preferredRelatedApplicationIds[i]);
            }
        }
    }
