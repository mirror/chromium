...
public class ChromeContextMenuPopulator implements ContextMenuPopulator {
    ...
    static class ContextMenuUma {
        ...
        static final int TYPE_SAVE_IMAGE_SHOWN = 1;
        static final int TYPE_SAVE_IMAGE_FETCHED_LOFI = 2;
        static final int TYPE_SAVE_IMAGE_NOT_DOWNLOADABLE = 3;
        static final int NUM_SAVE_IMAGE_TYPES = 4;
