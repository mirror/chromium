...
public final class PrefServiceBridge {
    ...
    public void setChromeHomePersonalizedSuggestionsEnabled(boolean enabled) {
        nativeSetChromeHomePersonalizedSuggestionsEnabled(enabled);
    }
    ...
    private native void nativeSetChromeHomePersonalizedSuggestionsEnabled(boolean enabled);
}
