...
public class LanguageListBaseAdapter
    ...
    static class LanguageRowViewHolder extends RecyclerView.ViewHolder {
         ...
         * @param menuButtonDelegate A {@link ListMenuButton.Delegate} to set up this row's menu
         *                           button.
         * @param startIconId The icon in the beginning of this row.
         */
        void bindView(LanguageItem item, ItemClickListener itemClickListener,
            ...
            if (itemClickListener != null) {
                mRow.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        itemClickListener.onLanguageClicked(item);
                    }
                });
            }
        }
