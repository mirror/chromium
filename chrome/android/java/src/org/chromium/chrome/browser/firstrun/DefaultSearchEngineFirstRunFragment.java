...
public class DefaultSearchEngineFirstRunFragment extends Fragment {
    /** FRE page that instantiates this fragment. */
    public static class Page implements FirstRunPage {
        @Override
    ...
    private FirstRunPageDelegate getPageDelegate() {
