...
public class ChromeHomePromoDialog extends PromoDialog {
    ...
    public void onClick(View view) {
        ...
        if (FeatureUtilities.isChromeHomeEnabled()) {
            state = mSwitchStateShouldEnable ? PromoResult.ON_REMAIN_ON
                                             : PromoResult.ON_CHANGED_TO_OFF;
        } else {
            state = mSwitchStateShouldEnable ? PromoResult.OFF_CHANGED_TO_ON
                                             : PromoResult.OFF_REMAIN_OFF;
        }
