...
public class SurveyInfoBar extends InfoBar {
    ...
    private SurveyInfoBarDelegate mObserver;
    ...
    public static void showSurveyInfoBar(WebContents webContents, String siteId,
            ...
            SurveyInfoBarDelegate surveyInfoBarObserver) {
        nativeCreate(
    ...
    private static SurveyInfoBar create(String siteId, boolean showAsBottomSheet,
            int displayLogoResId, SurveyInfoBarDelegate surveyInfoBarObserver) {
