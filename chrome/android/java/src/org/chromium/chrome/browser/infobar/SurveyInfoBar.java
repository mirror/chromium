...
public class SurveyInfoBar extends InfoBar {
    ...
    // Boolean to track if the infobar was closed via onCloseButtonClicked() to prevent
    // onStartHiding() from being called after.
    private boolean mClosedByCloseButton;
    ...
    public void onCloseButtonClicked() {
        ...
        mDelegate.onSurveyInfoBarClosed(true);
        mClosedByCloseButton = true;
    }
    ...
    protected void onStartedHiding() {
        ...
        if (mClosedByCloseButton || !isFrontInfoBar()) return;

        mDelegate.onSurveyInfoBarClosed(false);
    }
