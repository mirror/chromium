...
public class ThumbnailDiskStorage {
     ...
     */
    private class GetThumbnailTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            if (mRequest.shouldCacheToDisk()
                ...
                onThumbnailRetrieved(true, mRequest.getContentId(),
                        ThumbnailDiskStorage.this.getFromDisk(mRequest.getContentId()));
                return true;
            }
            return false;
        }
        ...
        @Override
        protected void onPostExecute(Boolean isRetrieved) {
