...
public class Tab
    ...
    private void showMediaDownloadInProductHelp(int x, int y, int width, int height) {
        ...
        // TODO(shaktisahu): Send the exact coordinates of download button from blink, if we can't
        // find exact, we should not show the pulse at all.
        Rect rect = new Rect(x, (int) (y + height * 0.5), x + width, (int) (y + height * 1.5));
