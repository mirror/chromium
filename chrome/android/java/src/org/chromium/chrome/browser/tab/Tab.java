...
public class Tab
    ...
    protected boolean unfreezeContents() {
        try {
            ...
            nativeOnSizeChanged(mNativeTabAndroid, webContents, rect.getWidth(), rect.getHeight());
    ...
    Rect getEstimatedContentSize() {
        return ExternalPrerenderHandler.estimateContentSize(
    ...
    private void swapContentViewCore(ContentViewCore newContentViewCore,
        ...
        if (mContentView != null) {
            ...
            mContentViewCore.onHide(); ///// needs updating
        }

        Rect bounds = new Rect();
        if (originalWidth == 0 && originalHeight == 0) bounds = getEstimatedContentSize();
        ...
        nativeOnSizeChanged(mNativeTabAndroid, newContentViewCore.getWebContents(), originalWidth,
                originalHeight);
