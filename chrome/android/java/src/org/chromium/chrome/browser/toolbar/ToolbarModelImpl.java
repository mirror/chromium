...
class ToolbarModelImpl extends ToolbarModel implements ToolbarDataProvider, ToolbarModelDelegate {
    ...
    public boolean isOfflinePage() {
        return hasTab() && !isBottomSheetOpen() && OfflinePageUtils.isOfflinePage(mTab);
    }

    @Override
    public int getSecurityLevel() {
        return getSecurityLevel(getTab(), isOfflinePage(), isBottomSheetOpen());
    }
    ...
    @VisibleForTesting
    static int getSecurityLevel(Tab tab, boolean isOfflinePage, boolean isBottomSheetOpen) {
        if (tab == null || isOfflinePage || isBottomSheetOpen) {
