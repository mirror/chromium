...
class ToolbarModelImpl extends ToolbarModel implements ToolbarDataProvider, ToolbarModelDelegate {
    ...
    public int getSecurityLevel() {
        return getSecurityLevel(getTab(), isOfflinePage(), isAMP());
    }

    @Override
    public int getSecurityIconResource() {
        return getSecurityIconResource(
                getSecurityLevel(), !DeviceFormFactor.isTablet(), isOfflinePage(), isAMP());
    }

    @VisibleForTesting
    @ConnectionSecurityLevel
    static int getSecurityLevel(Tab tab, boolean isOfflinePage, boolean isAMP) {
        if (tab == null || isOfflinePage || isAMP) {
    ...
    static int getSecurityIconResource(
            int securityLevel, boolean isSmallDevice, boolean isOfflinePage, boolean isAMP) {
        if (isOfflinePage) {
    ...
    private boolean isAMP() {
        return hasTab() && OfflinePageUtils.isAMP(mTab);
    }
}
