...
public class DownloadDirectoryAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public Object getItem(int position) {
        ...
        if (position <= canonicalDirectoriesEndPosition) {
            ...
            return mAdditionalDirectoryOptions.get(canonicalDirectoriesEndPosition - position);
        }
    }
    ...
    private void styleViewSelectionAndIcons(View view, boolean isSelected) {
        ...
        int directoryIconIndex = ((DownloadDirectoryOption) getItem((int) view.getTag())).mIcon;
        Drawable directoryIcon = ContextCompat.getDrawable(mContext, directoryIconIndex);
