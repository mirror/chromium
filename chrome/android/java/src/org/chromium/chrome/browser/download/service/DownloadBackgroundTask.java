...
public class DownloadBackgroundTask extends NativeBackgroundTask {
    private static final int TASK_TYPE_INVALID = -1;

    // Helper class to track the number of in progress tasks and their related information.
    ...
    protected void onStartTaskWithNative(
        ...
        @DownloadTaskType
        final int taskType = taskParameters.getExtras().getInt(
                DownloadTaskScheduler.EXTRA_TASK_TYPE, TASK_TYPE_INVALID);
        assert taskType != TASK_TYPE_INVALID;
    ...
    protected boolean onStopTaskWithNative(Context context, TaskParameters taskParameters) {
        @DownloadTaskType
        int taskType = taskParameters.getExtras().getInt(
                DownloadTaskScheduler.EXTRA_TASK_TYPE, TASK_TYPE_INVALID);
        assert taskType != TASK_TYPE_INVALID;
