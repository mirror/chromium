 ...
 * scheduler. The scheduled task is executed for both regular and incognito profiles.
 */
...
public class DownloadBackgroundTask extends NativeBackgroundTask {
    ...
    public void reschedule(Context context) {
        // TODO(shaktisahu): Called when system asks us to schedule the task again. Inform download
        // service to take necessary action.
    }
