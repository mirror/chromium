 ...
 *  - Has_new_pages: boolean indicating whether new pages have been saved or not
...
public class PrefetchPrefs {
    static final String PREF_PREFETCH_HAS_NEW_PAGES = "prefetch_has_new_pages";
    static final String PREF_PREFETCH_NOTIFICATION_TIME = "prefetch_notification_shown_time";
    static final String PREF_PREFETCH_OFFLINE_COUNTER = "prefetch_offline_counter";
    ...
    /**
     * Sets the last time, in milliseconds, a notification is shown.
     */
    public void setNotificationLastShownTime(long timeInMillis) {
        ContextUtils.getAppSharedPreferences()
                .edit()
    ...
    /**
     * Returns the last time, in milliseconds, a notification is shown.
     */
