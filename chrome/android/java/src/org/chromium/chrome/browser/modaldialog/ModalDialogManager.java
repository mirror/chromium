...
public class ModalDialogManager {
    ...
    /**
     * The type of the current dialog. Note that this is used for determining whether the current
     * dialog should be suspended when {@link #suspendType(int)} is called.
     */
