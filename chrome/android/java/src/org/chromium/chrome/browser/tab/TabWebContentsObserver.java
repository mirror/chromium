...
public class TabWebContentsObserver extends WebContentsObserver {
    ...
    public void didFinishNavigation(String url, boolean isInMainFrame, boolean isErrorPage,
        ...
        if (UmaUtils.isRunningApplicationStart() && hasCommitted && isInMainFrame && !isErrorPage
                && !isSameDocument && !isFragmentNavigation && UrlUtilities.isHttpOrHttps(url)) {
            ...
            long duration = SystemClock.uptimeMillis() - UmaUtils.getApplicationStartTimeMs();
            RecordHistogram.recordCustomTimesHistogram(
                    "MobileStartup.Experimental.Cold.TimeToFirstNavigationCommit.ZoomedIn",
                    duration, 200, 1000, TimeUnit.MILLISECONDS, 100);
            // For ZoomedOut very rarely is it under 50ms and this range matches
            // CustomTabs.IntentToFirstCommitNavigationTime3.ZoomedOut.
            RecordHistogram.recordCustomTimesHistogram(
                    "MobileStartup.Experimental.Cold.TimeToFirstNavigationCommit.ZoomedOut",
                    duration, 50, TimeUnit.MINUTES.toMillis(10), TimeUnit.MILLISECONDS, 50);
        }
