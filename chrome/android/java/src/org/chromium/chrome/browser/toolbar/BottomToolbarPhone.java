    ...
    public void onFinishInflate() {
        ...
        mLocationBar.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom,
                ...
                // height.
                float locationBarHeight = mLocationBar.getBottom() - mLocationBarVerticalMargin * 2
                        - mLocationBar.getTop();
                mLocationBarBackgroundCornerRadius = (int) (locationBarHeight / 2);
                mLocationBarBackground.mutate();
                ((GradientDrawable) mLocationBarBackground).setCornerRadius(locationBarHeight / 2);
