...
public class BottomToolbarPhone extends ToolbarPhone {
    ...
    private final BottomSheetObserver mBottomSheetObserver = new EmptyBottomSheetObserver() {
        ...
        public void onTransitionPeekToHalf(float transitionFraction) {
            boolean isMovingDown = transitionFraction < mLastPeekToHalfHeightFraction;
            boolean isMovingUp = transitionFraction > mLastPeekToHalfHeightFraction;
            mLastPeekToHalfHeightFraction = transitionFraction;

            updateToolbarButtonAnimation(isMovingUp, isMovingDown);
        }
    };
     ...
     * @param isMovingDown Whether the sheet is currently moving down.
     */
    private void updateToolbarButtonAnimation(boolean isMovingUp, boolean isMovingDown) {
        ...
        } else if (isMovingDown && !mAnimatingToolbarButtonAppearance
                && mToolbarButtonVisibilityPercent != 1.f) {
    ...
    private void onToolbarButtonAnimationEnd(boolean visible) {
        ...
        if (mUrlFocusChangeInProgress) return;
