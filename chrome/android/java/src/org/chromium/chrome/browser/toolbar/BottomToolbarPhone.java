...
public class BottomToolbarPhone extends ToolbarPhone {
    ...
    private void updateToolbarButtonVisibility() {
        ...
        if (isLocationBarRtl) {
            ...
            // Use the difference between the unfocused width and current width to determine the
            // base translation for the location bar contents. If RTL text is displayed in an LTR
            // toolbar, the right position of the location bar background will change. Use the
            // difference between the current right position of the location bar background and the
            // end unfocused location bar right position to account for this.
            locationBarTranslationX = mUnfocusedLocationBarLayoutLeft
                    + mUnfocusedLocationBarLayoutWidth - currentWidth
                    + getRightPositionOfLocationBarBackground(mVisualState)
                    - mUnfocusedLocationBarLayoutRight;
            ...
            // the location bar background will change.
            locationBarTranslationX = mUnfocusedLocationBarLayoutLeft
