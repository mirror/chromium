...
public class ToolbarPhone extends ToolbarLayout
    ...
    /** Updates the unfocused layout parameters for the location bar. */
    protected void updateUnfocusedLocationBarLayoutParams() {
     ...
     * @param priorVisibleWidth The width any visible views prior to the location bar.
