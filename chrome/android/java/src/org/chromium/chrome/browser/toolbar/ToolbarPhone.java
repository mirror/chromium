...
public class ToolbarPhone extends ToolbarLayout
    ...
    protected void updateVisualsForToolbarState() {
        ...
        // updateToolbarState may have changed the background color.
        // TODO(mdjones): Remove the following line after modern launches.
        currentPrimaryColor = mToolbarBackground.getColor();
        getProgressBar().setThemeColor(themeColorForProgressBar, isIncognito());
