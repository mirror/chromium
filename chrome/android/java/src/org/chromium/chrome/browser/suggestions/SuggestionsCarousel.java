...
public class SuggestionsCarousel extends OptionalLeaf {
     ...
     */
    void newContextualSuggestionsAvailable(String url, List<SnippetArticle> newSuggestions) {
    ...
    /**
     * Creates a horizontal recycler view where contextual suggestions will be displayed.
     *
     * @param parentView The container for the recycler view.
     * @return The created recycler view.
     */
    public View createView(ViewGroup parentView) {
        mRecyclerView = new RecyclerView(parentView.getContext());
     ...
     */
    String getCurrentCarouselContextUrl() {
