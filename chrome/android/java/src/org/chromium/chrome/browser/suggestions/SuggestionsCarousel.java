...
public class SuggestionsCarousel extends OptionalLeaf implements ImpressionTracker.Listener {
    ...
    /**
     * Creates a {@link ViewHolder} for the carousel and registers a listener for scroll events from
     * the carousel {@link RecyclerView}.
     */
    public NewTabPageViewHolder createViewHolder(ViewGroup parent) {
        ViewHolder viewHolder = new ViewHolder(parent);

        RecyclerView carouselRecyclerView = (RecyclerView) viewHolder.itemView;
    ...
    public void refresh(final Context context, @Nullable final String newUrl) {
        ...
        // We want to record once per impression that the carousel was scrolled.
