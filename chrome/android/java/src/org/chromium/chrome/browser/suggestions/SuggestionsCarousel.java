...
public class SuggestionsCarousel extends OptionalLeaf {
    ...
    void clearSuggestions() {
        ...
        mAdapter.setSuggestions(new ArrayList<SnippetArticle>());
    }

    /**
     * Creates a horizontal recycler view.
     *
     * @param parentView The container for the recycler view.
     * @return The created recycler view.
     */
    public static View createHorizontalRecyclerView(ViewGroup parentView) {
