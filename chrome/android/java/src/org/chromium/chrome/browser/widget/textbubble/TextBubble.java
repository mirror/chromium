...
public class TextBubble implements AnchoredPopupWindow.LayoutObserver {
    ...
    /**
     * The {@link RectProvider} used to provide a rect to anchor the bubble in screen space.
    ...
    /**
     * The {@link ViewRectProvider} used to provide a rect based on a View to anchor the bubble
     * in screen space.
    ...
    public void setAnchorView(View anchorView) {
        assert !mPopupWindow.isShowing() && mRectProvider == null;
