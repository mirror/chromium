...
public class TextBubble implements OnTouchListener {
    ...
    public TextBubble(Context context, View rootView, @StringRes int stringId,
        ...
        mArrowDrawable.setShowArrow(showArrow);

        mHandler = new Handler();

        mPopupWindow.setWidth(ViewGroup.LayoutParams.WRAP_CONTENT);
        mPopupWindow.setHeight(ViewGroup.LayoutParams.WRAP_CONTENT);
        mPopupWindow.setBackgroundDrawable(mArrowDrawable);
    ...
    private void updateBubbleLayout() {
        ...
        boolean currentPositionBelow = mArrowDrawable.isArrowOnTop();
        boolean preferCurrentOrientation = mPopupWindow.isShowing();

        mArrowDrawable.getPadding(mCachedPaddingRect);
        ...
        int arrowXOffset = 0;
        if (mArrowDrawable.isShowingArrow()) {
