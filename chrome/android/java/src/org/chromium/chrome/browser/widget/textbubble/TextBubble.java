...
public class TextBubble implements AnchoredPopupWindow.LayoutObserver {
    ...
    /**
     * The {@link RectProvider} used to provide a {@link Rect} to anchor the bubble in screen space.
     * Either this or {@code mViewRectProvider} will be used.
     */
    @Nullable
    private RectProvider mRectProvider;

    /**
     * The {@link ViewRectProvider} used to provide a {@link Rect} based on a View to anchor the
     * bubble in screen space.
     * Either this or {@code mRectProvider} will be used.
     */
    @Nullable
    ...
    public void setAnchorRect(Rect rect) {
        ...
        if (mRectProvider == null) {
            mRectProvider = new RectProvider();
            setProvider = true;
        }

        mRectProvider.setRect(rect);

        if (setProvider) mPopupWindow.setAnchorRectProvider(mRectProvider);
    }
    ...
    public void setAnchorView(View anchorView) {
        assert !mPopupWindow.isShowing() && mRectProvider == null && mViewRectProvider == null;

        mViewRectProvider = new ViewRectProvider(anchorView);
        mPopupWindow.setAnchorRectProvider(mViewRectProvider);
    }
