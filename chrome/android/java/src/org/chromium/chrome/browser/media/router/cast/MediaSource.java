...
public class MediaSource {
    ...
    public static MediaSource from(String sourceId) {
        ...
        if (sourceId.startsWith(CAST_URL_SCHEME)) {
            return fromCastUrl(sourceId);
        }
        return fromLegacyUrl(sourceId);
    }
    ...
    private static MediaSource fromCastUrl(String sourceId) {
        ...
        Uri sourceUri = Uri.parse(sourceId.substring(CAST_URL_SCHEME.length()));
