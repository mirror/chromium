...
public class ContextualSearchFieldTrial {
    ...
    /**
     * @return Whether Smart Select as the only handler of long-press on Android O is disabled.
     *         If this returns true, the Contextual Search Bar will be allowed to show in response
     *         to a long-press gesture on Android O, in addition to the Smart Select UX.
     */
