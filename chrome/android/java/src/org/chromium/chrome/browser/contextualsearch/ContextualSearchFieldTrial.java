...
public class ContextualSearchFieldTrial {
    ...
    /**
     * Whether Ranker integration or the user-visible flag for whether Tap suppression is enabled or
     * not.
     * @return Whether to apply Ranker ML in this session, even if only for internal ranking.
     */
    static boolean isRankerIntegrationOrTapSuppressionEnabled() {
        return isRankerIntegrationEnabled() || isContextualSearchTapSuppressionEnabled();
    }
