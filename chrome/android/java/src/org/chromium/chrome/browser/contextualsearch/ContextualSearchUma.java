...
public class ContextualSearchUma {
    ...
    public static void logRankerInference(
            boolean wasPanelSeen, @MachineIntelligencePrediction int predictionKind) {
        RecordHistogram.recordBooleanHistogram("Search.ContextualSearchRankerSuppressed",
                predictionKind == MachineIntelligencePrediction.NO);
        if (predictionKind == MachineIntelligencePrediction.YES) {
            RecordHistogram.recordEnumeratedHistogram(
