...
public class ProfileDataCache implements ProfileDownloader.Observer, ProfileDataSource.Observer {
    ...
    /**
     * Gets the {@link DisplayableProfileData} containing the cached profile data corresponding to
     * an account, providing a placeholder for missing entries.
     */
    public DisplayableProfileData getProfileData(String accountName) {
    ...
    private DisplayableProfileData createDisplayableProfileData(
        ...
        return new DisplayableProfileData(accountId, prepareAvatar(profileData.getAvatar()),
