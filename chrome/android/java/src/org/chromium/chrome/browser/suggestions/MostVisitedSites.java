...
public interface MostVisitedSites {
     ...
     * @param nameSource The {@link TileNameSource} where the item's name originated from.
     * @param source The {@link TileSource} that generated this item.
     * @param url The URL of the tile.
     */
    void recordTileImpression(int index, @TileVisualType int type, @TileNameSource int nameSource,
