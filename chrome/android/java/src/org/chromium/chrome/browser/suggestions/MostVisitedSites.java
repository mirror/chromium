...
interface MostVisitedSites {
    ...
    /**
     * Records metrics about an impression of a tiles surface.
     * @param tilesCount Count of tiles impressed on the surface.
     */
    ...
    void recordTileImpression(
            int index, @TileVisualType int tileType, @TileSource int source, String tileUrl);
