...
public class SnippetsBridge implements SuggestionsSource {
    ...
    /**
     * Notifies to the C++ ContentSuggestionsService that Chrome on Android has been upgraded.
     */
    ...
    /**
     * Notifies to the C++ ContentSuggestionsService that the persistent fetching scheduler woke up.
     */
