...
public abstract class SuggestionsMetrics {
    ...
    /**
     * Records the result from a favicon fetch for an article and the time it took to fetch the
     * favicon.
     *
     * @param suggestion The suggestion whose favicon was fetched.
     * @param result {@link FaviconFetchResult} The result from the fetch.
     */
    public static void recordArticleFaviconFetchResult(
        ...
        recordArticleFaviconFetchTime(fetchTime);
    }
