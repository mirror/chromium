...
public abstract class SuggestionsMetrics {
     ...
     * @param maxNumTiles max number of tiles that can be displayed.
     */
    public static void recordTileOfflineAvailability(int tileIndex, int maxNumTiles) {
        RecordHistogram.recordEnumeratedHistogram(
                "NewTabPage.TileOfflineAvailable", tileIndex, maxNumTiles);
    }
