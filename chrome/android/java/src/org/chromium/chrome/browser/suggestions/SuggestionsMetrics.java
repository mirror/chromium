...
public abstract class SuggestionsMetrics {
    ...
    /**
     * Records the time it took to fetch a favicon.
     *
     * @param fetchTime The time it took to fetch a favicon.
     */
    public static void recordFaviconFetchTime(long fetchTime) {
    ...
    /**
     * Records the result from a favicon fetch and the time it took to fetch the favicon.
     *
     * @param suggestion The suggestion whose favicon was fetched.
     * @param result {@link FaviconFetchResult} The result from the fetch.
     * @param fetchTime The time it took to fetch a favicon.
     */
    public static void recordFaviconFetchResult(
            SnippetArticle suggestion, @FaviconFetchResult int result, long fetchTime) {
        ...
        recordFaviconFetchTime(fetchTime);
    }
