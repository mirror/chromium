...
public class WebApkUma {
    ...
    public static void logUnimportantStorageSizeInUMA(boolean installSucceeded) {
        WebsitePermissionsFetcher fetcher = new WebsitePermissionsFetcher(
                new UnimportantStorageSizeCalculator(installSucceeded));
    ...
    private static class UnimportantStorageSizeCalculator
        ...
        boolean mInstallSucceeded = false;
        UnimportantStorageSizeCalculator(boolean installSucceeded) {
            mInstallSucceeded = installSucceeded;
        }
        @Override
        public void onWebsitePermissionsAvailable(Collection<Website> sites) {
            ...
            if (mInstallSucceeded) {
                RecordHistogram.recordSparseSlowlyHistogram(
                        "WebApk.Install.ChromeUnimportantStorage.Success",
                        unimportantSiteStorageTotalMb);
            } else {
                RecordHistogram.recordSparseSlowlyHistogram(
                        "WebApk.Install.ChromeUnimportantStorage.Fail",
                        unimportantSiteStorageTotalMb);
            }
        }
    }
