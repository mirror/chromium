...
public class WebApkUma {
    ...
    private static long sAvailableSpaceInByte = 0;

    private static long sCacheSizeInByte = 0;
    ...
    public static void logSpaceUsageUMAWhenInstallationFails() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                sAvailableSpaceInByte = getAvailableSpaceAboveLowSpaceLimit();
                sCacheSizeInByte =
    ...
    private static void logSpaceUsageUMA() {
    ...
    private static class UnimportantStorageSizeCalculator
        ...
        public void onWebsitePermissionsAvailable(Collection<Website> sites) {
            ...
            logSpaceUsageUMAOnDataAvailable(
                    sAvailableSpaceInByte, sCacheSizeInByte, importantSiteStorageTotal);
        }
    }
}
