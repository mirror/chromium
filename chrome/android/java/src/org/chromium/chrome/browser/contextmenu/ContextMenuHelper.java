...
public class ContextMenuHelper implements OnCreateContextMenuListener {
     ...
     * @param topContentOffsetY the offset of the content from the top in device pixel unit.
     */
    @CalledByNative
    private void showContextMenu(ContextMenuParams params, View view, float topContentOffsetY) {
        ...
        if (ChromeFeatureList.isEnabled(ChromeFeatureList.CUSTOM_CONTEXT_MENU)) {
            ...
            menuUi.setTopContentOffsetY(topContentOffsetY);
