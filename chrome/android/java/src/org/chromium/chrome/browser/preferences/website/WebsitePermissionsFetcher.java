...
public class WebsitePermissionsFetcher {
    ...
    /**
     * A specialisation of Pair to hold an (origin, embedder) tuple. This overrides the hashCode
     * method as android.util.Pair's hashCode simply XORs the pair of values together. This means
     * that having origin == embedder (a fix for a crash in crbug.com/636330) results in
     * pathological performance and causes Site Settings/All Sites to lag significantly on opening.
     * See crbug.com/732907.
     */
    static class OriginAndEmbedder extends Pair<WebsiteAddress, WebsiteAddress> {
        ...
        @Override
        public int hashCode() {
            // This is the same calculation as Arrays.hashCode().
