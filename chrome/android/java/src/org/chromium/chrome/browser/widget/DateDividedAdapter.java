...
public abstract class DateDividedAdapter extends Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Add a list of headers as the first group in this adapter. If headerItems is null or no
     * header item view is visible, header group will not be created. Otherwise, header items will
     * be added as child items to the header group. Sub-classes should implement
     * {@link #bindViewHolderForHeaderItem(ViewHolder, HeaderItem)} to bind the BasicViewHolder to
     * the associated HeaderItem.
