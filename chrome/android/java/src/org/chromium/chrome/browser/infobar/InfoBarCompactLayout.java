...
public class InfoBarCompactLayout extends LinearLayout implements View.OnClickListener {
    ...
    /** Returns a builder that will configure a text message to show via this infobar layout. */
    ...
    public static class MessageBuilder {
        ...
        private MessageBuilder(InfoBarCompactLayout layout) {
            mLayout = layout;
        }
