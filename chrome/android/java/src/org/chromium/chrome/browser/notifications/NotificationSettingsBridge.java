...
public class NotificationSettingsBridge {
     ...
     */
    @CalledByNative
    static SiteChannel createChannel(String origin, String creationTime, boolean enabled) {
    ...
    public static class SiteChannel {
        ...
        public SiteChannel(String channelId, String origin, String creationTimestamp,
