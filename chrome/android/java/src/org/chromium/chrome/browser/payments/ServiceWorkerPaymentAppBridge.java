...
public class ServiceWorkerPaymentAppBridge implements PaymentAppFactory.PaymentAppFactoryAddition {
    ...
    public static void abortInvokePaymentApp(WebContents webContents, long registrationId,
            PaymentInstrument.AbortInvokePaymentAppCallback callback) {
    ...
    @CalledByNative
    private static void onAbortInvokePaymentApp(Object callback, boolean result) {
        assert callback instanceof PaymentInstrument.AbortInvokePaymentAppCallback;
        ((PaymentInstrument.AbortInvokePaymentAppCallback) callback)
                .onAbortInvokePaymentAppResult(result);
    }
