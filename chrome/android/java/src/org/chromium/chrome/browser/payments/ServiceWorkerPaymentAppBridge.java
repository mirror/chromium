...
public class ServiceWorkerPaymentAppBridge implements PaymentAppFactory.PaymentAppFactoryAddition {
    ...
    @CalledByNative
    private static void onInvokePaymentAppAborted(Object callback, boolean result) {
        assert callback instanceof PaymentInstrument.InstrumentDetailsCallback;
        ((PaymentInstrument.InstrumentDetailsCallback) callback).onInstrumentDetailsAborted(result);
    }
