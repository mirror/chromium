...
import org.chromium.chrome.browser.widget.ModernListMenuButton;
import org.chromium.chrome.browser.widget.ModernListMenuButton.Item;
...
abstract class BookmarkRow extends SelectableItemView<BookmarkId>
        implements BookmarkUIObserver, ModernListMenuButton.Delegate {
    protected ModernListMenuButton mMoreIcon;
    ...
    protected void onFinishInflate() {
        ...
        mMoreIcon = (ModernListMenuButton) findViewById(R.id.more);
