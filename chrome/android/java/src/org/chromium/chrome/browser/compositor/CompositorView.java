...
public class CompositorView
    ...
    void setTopControlsHeight(WebContents webContents, int height, boolean controlsResizeView) {
        nativeSetTopControlsHeight(mNativeCompositorView, webContents, height, controlsResizeView);
    }

    void setBottomControlsHeight(WebContents webContents, int height) {
        nativeSetBottomControlsHeight(mNativeCompositorView, webContents, height);
    }
