...
public class ImpressionTracker
    ...
    /**
     * The Listener will be called back on the first impression, where an impression is defined as
     * At least 2/3 of the view's height being visible.
     *
     * @see #setListener
     */
    ...
    /**
     * Creates a new instance tracking the given {@code view} while a listener is attached.
