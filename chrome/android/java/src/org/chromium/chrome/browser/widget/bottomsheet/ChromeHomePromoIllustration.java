...
public class ChromeHomePromoIllustration extends Drawable {
    ...
    @ColorRes
    protected final int mPhoneOmniboxNtpTileColor;
    ...
    public ChromeHomePromoIllustration(@NonNull Context context) {
        ...
        mPhoneDrawable = new PhoneDrawable();
        ...
        mHomeSectionDrawable = new HomeSectionDrawable(
        ...
        mRepeatRunnable = new Runnable() {
            ...
            public void run() {
                ...
                invalidateSelf();
                mAnimator.setStartDelay(DURATION_SHEET_COLLAPSED_MS);
                mAnimator.start();
            }
        };
        buildAnimation();
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate((getBounds().width() - mPhoneDrawable.getBounds().width()) / 2, 0);
        ...
        if (mHighlightAnimationPercent > 0 && mSheetAnimationPercent == 0.5f) {
            canvas.save();
            ...
            canvas.translate((phoneBounds.width() - highlightWidth) / 2,
    ...
    private class HomeSectionDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            mPaint.setColor(mPhoneOmniboxNtpTileColor);
    ...
    private class BookmarkSectionDrawable extends Drawable {
    ...
    private class SheetDrawable extends Drawable {
    ...
    private class HighlightDrawable extends Drawable {
    ...
    private class PhoneDrawable extends Drawable {
