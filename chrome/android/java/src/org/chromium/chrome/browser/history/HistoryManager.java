...
public class HistoryManager implements OnMenuItemClickListener, SignInStateObserver,
    ...
    boolean shouldShowInfoButton() {
        ...
        // This is checking less than 0 to take into account NO_POSITION from
        // findFirstVisibleItemPosition. Otherwise, the menu buttons will be incorrectly drawn
        // in Chrome Home possibly due to android bug.
        boolean headerIsVisible = (layoutManager.findFirstVisibleItemPosition() <= 0);
