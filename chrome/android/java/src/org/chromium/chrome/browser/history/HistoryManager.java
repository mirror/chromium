...
import org.chromium.chrome.browser.preferences.PrefChangeRegistrar.PrefChangeRegistrarObserver;
...
public class HistoryManager implements OnMenuItemClickListener, SignInStateObserver,
                                       ...
                                       SnackbarController, PrefChangeRegistrarObserver {
    ...
    public HistoryManager(Activity activity, boolean isSeparateActivity,
        ...
        mPrefChangeRegistrar.addObserver(PrefServiceBridge.ALLOW_DELETING_BROWSER_HISTORY, this);
        mPrefChangeRegistrar.addObserver(PrefServiceBridge.INCOGNITO_MODE_AVAILABILITY, this);
