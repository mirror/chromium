...
public class ChromeHomeSnackbarController implements SnackbarController {
    private static final String SURVEY_URL = "https://support.google.com/chrome/?p=home_optout";
    ...
    public void onAction(Object actionData) {
        mTabCreator.createNewTab(new LoadUrlParams(SURVEY_URL), TabLaunchType.FROM_CHROME_UI, null);
