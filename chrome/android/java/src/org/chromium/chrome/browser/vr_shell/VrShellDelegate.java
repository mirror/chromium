...
public class VrShellDelegate
    ...
    private void onEnterVrUnsupported(ChromeActivity activity) {
        ...
        mVrDaydreamApi.launchVrHomescreen();
        // We need to explicitly disable VR mode since some devices handle system UI themselves
        // depending on the VR mode, and not doing this would prevent the system UI from showing up
        // if the user resumes Chrome.
    ...
    private void setWindowModeForVr() {
        ...
        // when Chrome is started in VR mode. This has the issue that if we hide it for another
