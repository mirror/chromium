...
public class VrShellDelegate
    ...
    public static void onNewIntentWithNative(ChromeActivity activity, Intent intent) {
        ...
        if (instance == null) return;
        // TODO(ymalik): This should use isTrustedAutopresentIntent once the Daydream change that
        // adds the autopresent intent extra rolls out on most devices. This will allow us to
