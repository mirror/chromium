...
public class VrShellDelegate
    ...
    // Gets run when the user exits VR mode by hidding the 'x' button or system UI back button.
        ...
        mCloseButtonListener = new Runnable() {
            ...
            public void run() {
                ...
                if (startedForAutopresentation) {
                    // For auto-presentation, we shutdownVr when Chrome is stopped by this intent.
