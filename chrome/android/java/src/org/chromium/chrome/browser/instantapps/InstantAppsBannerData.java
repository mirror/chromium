...
public class InstantAppsBannerData {
    ...
    private final boolean mInstantAppDefault;
    ...
    public InstantAppsBannerData(String appName, Bitmap icon, String url, Uri referrer,
        ...
        mReferrer = referrer;
        mInstantAppDefault = false;
    }

    public InstantAppsBannerData(String appName, Bitmap icon, String url, Uri referrer,
            Intent intent, String primaryActionLabel, WebContents webContents,
            boolean isInstantAppDefault) {
        mAppName = appName;
        mAppIcon = icon;
        mUrl = url;
        mIntent = intent;
        ...
        mWebContents = webContents;
        mReferrer = referrer;
        mInstantAppDefault = isInstantAppDefault;
    }
    ...
    /**
     * @return Whether or not the app is already installed while showing the banner for it.
     *
