...
public class ChromeTabbedActivity
    ...
    public void initializeState() {
        ...
        try {
            ...
            if (selector != null) {
                mergeBrowserActionsTabModel(selector);
            }
    ...
    private void mergeBrowserActionsTabModel(BrowserActionsTabModelSelector selector) {
        ...
        while (model.getCount() > 0) {
            ...
            model.removeTab(tab);
            tab.attachTabContentManager(getTabContentManager());
            tab.updateWindowAndroid(getWindowAndroid());
