    ...
    protected AppMenuPropertiesDelegate createAppMenuPropertiesDelegate() {
        return new AppMenuPropertiesDelegate(this) {
            ...
            public View getHeaderView() {
                ...
                boolean shouldShowPageMenu = getAppMenuPropertiesDelegate().shouldShowPageMenu();
                boolean shouldShowNtpMenu =
                        getAppMenuPropertiesDelegate().shouldShowBottomSheetNtpMenu();

                // Return early if the menu being shown isn't for a web page or the NTP.
                if (!shouldShowPageMenu && !shouldShowNtpMenu) return null;
                ...
                if (mControlContainer.getVisibility() != View.VISIBLE
                        || getBottomSheet().isSheetOpen() || !shouldShowPageMenu) {
                    return null;
                }
