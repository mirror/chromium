...
public class ChromeTabbedActivity
    ...
    public ChromeTabbedActivity() {
        ...
        mController = new ChromeHomeSurveyController();
    }
    ...
    public void finishNativeInitialization() {
        try {
            ...
            mController.kickoffSurveyProcess(getActivityTab(), getApplicationContext());
    ...
    protected TabModelSelector createTabModelSelector() {
        ...
        mController.setTabModelSelector(mTabModelSelectorImpl);
