...
public class TileGroup implements MostVisitedSites.Observer {
    ...
    private final TileSetupDelegate mTileSetupDelegate = new TileSetupDelegate() {
        ...
        public TileInteractionDelegate createInteractionDelegate(Tile tile) {
            return new TileInteractionDelegate(tile.getUrl(), tile.getSection());
        }
        ...
        public LargeIconBridge.LargeIconCallback createIconLoadCallback(Tile tile) {
            ...
            boolean trackLoad =
                    isLoadTracked() && tile.getSection() == TileGroup.TileSection.PERSONAL;
    ...
    public TileGroup(Context context, SuggestionsUiDelegate uiDelegate,
        ...
        mObserver = observer;
        mTileRenderer =
                new TileRenderer(context, titleLines, tileStyle, uiDelegate.getImageFetcher());
    ...
    public void onSiteSuggestionsAvailable(List<SiteSuggestion> siteSuggestions) {
        ...
        for (SiteSuggestion suggestion : siteSuggestions) {
            ...
            // if (suggestion.section != TileSection.PERSONAL) continue;
    ...
    public void renderTiles(ViewGroup parent) {
        ...
        assert mTileSections.size() == 1
                && mTileSections.keyAt(0) == TileGroup.TileSection.PERSONAL;
    ...
    public Tile[] getTiles(@TileSection int section) {
    ...
    private void loadTiles() {
        ...
        List<Tile> personalisedTiles = mTileSections.get(TileSection.PERSONAL);
        ...
        boolean countChanged = isInitialLoad
                || mTileSections.get(TileSection.PERSONAL).size() != oldPersonalisedTilesCount;
    ...
    @Nullable
    private Tile findTile(String url, @TileSection int section) {
    ...
    private void removeTask(@TileTask int task) {
        ...
        if (mPendingTasks.isEmpty()) {
            ...
            mTileGroupDelegate.onLoadingComplete(getTiles(TileSection.PERSONAL));
        }
    }
    ...
    private static SparseArray<List<Tile>> createEmptyTileData() {
        ...
        // the others.
        newTileData.put(TileSection.PERSONAL, new ArrayList<Tile>());
