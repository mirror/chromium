...
public class WebApkServiceClient {
    ...
    public static void notifyNotification(final String webApkPackage,
                ...
                new WebApkServiceImplClient.ConnectionCallback() {
                    ...
                    public void onConnected(IWebApkApi api) {
                        try {
                            ...
                            WebApkUma.recordNotificationPermissionStatus(
        ...
        WebApkServiceImplClient.getInstance().notifyNotification(
                ContextUtils.getApplicationContext(), webApkPackage, platformTag, platformID,
                callback);
    }
    ...
    public void requestPermission(String webApkPackage, final IPermissionRequestCallback callback,
        ...
        WebApkServiceImplClient.getInstance().requestPermission(
                ContextUtils.getApplicationContext(), webApkPackage, callback, permissions);
    }
