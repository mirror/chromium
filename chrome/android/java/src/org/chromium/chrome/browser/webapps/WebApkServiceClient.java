...
public class WebApkServiceClient {
    ...
    /**
     * Creates a public version of WebAPK's notification be displayed in sensitive contexts, such as
     * on the lockscreen.
     */
    private static Notification buildPublicVersionNotification(
        ...
        // Therefore, we need to recreate the notification by passing a WebAPK's context to the
        // builder.
