...
public class HintedDropDownAdapterWithPlusIcon<T> extends HintedDropDownAdapter<T> {
    /**
     * Creates an array adapter for which the first element is a hint that is view and where the
     * last shown element has a "+" icon on its left and has a blue tint.
     *
