...
public class SavePasswordsPreferences
    ...
    // True if the option to export passwords in the three-dots menu should be enabled. It should be
    // enabled if there are some passwords to export and if the export is not currently in progress.
    private boolean mExportOptionEnabled = false;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        menu.findItem(R.id.export_passwords).setEnabled(mExportOptionEnabled);
    ...
    public void passwordListAvailable(int count) {
        ...
        mExportOptionEnabled = !mNoPasswords;
        if (mNoPasswords) {
