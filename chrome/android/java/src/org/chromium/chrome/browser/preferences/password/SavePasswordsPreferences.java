            ...
            PasswordManagerHandlerProvider.getInstance()
                    ...
                    .serializePasswords(new Callback<String>() {
                        ...
                        public void onResult(String serializedPasswords) {
                            new AsyncTask<String, Void, ExportResult>() {
                                @Override
                                protected ExportResult doInBackground(
                                        String... serializedPasswords) {
                                ...
                                protected void onPostExecute(ExportResult result) {
                                    ...
                                    .executeOnExecutor(
                                            AsyncTask.THREAD_POOL_EXECUTOR, serializedPasswords);
                        }
                    });
...
*/
    ...
    private ExportResult exportPasswordsIntoFile(String serializedPasswords) {
        ...
        try {
            File passwordsDir = new File(
                    ContextUtils.getApplicationContext().getCacheDir() + PASSWORDS_CACHE_DIR);
            passwordsDir.mkdir();
        ...
        // content:// URI.
        File tempFile;
        tempFile = new File(ContextUtils.getApplicationContext().getCacheDir() + PASSWORDS_CACHE_DIR
                + "/password-export.csv");
