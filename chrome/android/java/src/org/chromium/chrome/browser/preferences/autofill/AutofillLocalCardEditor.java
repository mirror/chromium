...
import org.chromium.chrome.browser.payments.PaymentPreferencesObserver;
...
public class AutofillLocalCardEditor extends AutofillCreditCardEditor {
    ...
    protected boolean saveEntry() {
        ...
        PaymentPreferencesObserver.getInstance().notifyOnCreditCardUpdated(card);
        return true;
    }
    ...
    protected void deleteEntry() {
        if (mGUID != null) {
            ...
            PaymentPreferencesObserver.getInstance().notifyOnCreditCardDeleted(mGUID);
        }
    }
