...
public class ContextualSearchBarControl {
    ...
    */
    ...
    private final AnimatedFloat mDividerLineVisibilityPercentage = new AnimatedFloat();
    ...
    public ContextualSearchBarControl(ContextualSearchPanel panel,
        ...
        mImageControl = new ContextualSearchImageControl(context);
    ...
    public void onUpdateFromPeekToExpand(float percentage) {
        ...
        if (!getQuickActionControl().hasQuickAction()) {
            mDividerLineVisibilityPercentage.set(percentage);
        }
    ...
    public float getDividerLineVisibilityPercentage() {
        return mDividerLineVisibilityPercentage.get();
    }
    ...
    private void animateDividerLine(boolean visible) {
        ...
        if (mDividerLineVisibilityPercentage.get() == endValue) return;
        mDividerLineVisibilityAnimation = CompositorAnimator.ofAnimatedFloat(mContext,
                mDividerLineVisibilityPercentage, mDividerLineVisibilityPercentage.get(), endValue,
    ...
    private void showTouchHighlight(float x) {
        ...
        if (mTouchHighlightAnimation == null) {
            mTouchHighlightAnimation = new CompositorAnimator(mContext);
    ...
    public void animateSearchTermResolution() {
        if (mTextOpacityAnimation == null) {
            mTextOpacityAnimation = new CompositorAnimator(mContext);
            mTextOpacityAnimation.setDuration(OverlayPanelAnimation.MAXIMUM_ANIMATION_DURATION_MS);
            mTextOpacityAnimation.addUpdateListener(new AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(CompositorAnimator animator) {
                    updateSearchBarTextOpacity(animator.getAnimatedFraction());
                }
            });
            mTextOpacityAnimation.setInterpolator(CompositorAnimator.getDecelerateInterpolator());
        }
