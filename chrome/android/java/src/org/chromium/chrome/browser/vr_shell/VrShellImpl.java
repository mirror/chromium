...
public class VrShellImpl
    ...
    private final FrameCallback mFrameCallback = new FrameCallback() {
        ...
        public void doFrame(long frameTimeNanos) {
            ...
            if (mUiViews == null) return;
            if (!mUiSurface.isValid()) return;
            final Canvas surfaceCanvas = mUiSurface.lockCanvas(null);
           surfaceCanvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);

            mUiViews.setBackgroundColor(Color.LTGRAY);
            mUiViews.invalidate();
   ...
   mUiViews.measure(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
     ...
     //ll.getMeasuredWidth returns 0
     mUiViews.layout(0,0, 2000, 500);
//      Log.e(TAG, "VR size0: " + mSurfaceWidth + ", " + mSurfaceHeight + " - " + ll.getMeasuredWidth() +", "+ ll.getMeasuredWidth());
    mUiViews.measure(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
                    MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));

//      Log.e(TAG, "VR size1: " + mSurfaceWidth + ", " + mSurfaceHeight + " - " + ll.getMeasuredWidth() +", "+ ll.getMeasuredWidth());
     mUiViews.layout(0,0, 2000, 500);
//      Log.e(TAG, "VR size2: " + mSurfaceWidth + ", " + mSurfaceHeight + " - " + ll.getMeasuredWidth() +", "+ ll.getMeasuredWidth());

 //     mUiViews = ll;

        Log.e(TAG, "VR setDialogView");
    }
