...
public class VrShellImpl
    ...
    public void updateSelection(int selectionStart, int selectionEnd) {
        assert mNativeVrShell != 0;
        nativeUpdateWebInputSelectionIndices(mNativeVrShell, selectionStart, selectionEnd);
    }

    @Override
    public void updateComposition(int compositionStart, int compositionEnd) {
        assert mNativeVrShell != 0;
        nativeUpdateWebInputCompositionIndices(mNativeVrShell, compositionStart, compositionEnd);
    }

    @Override
    public void updateText(String text) {
        assert mNativeVrShell != 0;
        nativeUpdateWebInputText(mNativeVrShell, text);
    }
    ...
    private native void nativeUpdateWebInputSelectionIndices(
            long nativeVrShell, int selectionStart, int selectionEnd);
    private native void nativeUpdateWebInputCompositionIndices(
            long nativeVrShell, int compositionStart, int compositionEnd);
    private native void nativeUpdateWebInputText(long nativeVrShell, String text);
}
