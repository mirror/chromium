...
public class VrShellImpl
    ...
    public void setWebVrModeEnabled(boolean enabled, boolean showToast) {
        // No need to draw/update non-VR UI when in webvr presentation.
        // TODO(mthiesse): Should we also destroy/recreate the surface used for non-VR UI here?
        mNonVrViews.setVisibility(enabled ? View.INVISIBLE : View.VISIBLE);
