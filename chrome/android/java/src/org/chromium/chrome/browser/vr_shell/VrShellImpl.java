...
public class VrShellImpl extends GvrLayout implements VrShell, SurfaceHolder.Callback {
    ...
    private static final float INCH_TO_METER_RATIO = 0.0254f;
    ...
    public VrShellImpl(
        ...
        // Set the initial content size and DPR. Otherwise, Chrome will crash due to a GL buffer
    ...
    public void initializeNative(Tab currentTab, boolean forWebVr,
        ...
        float displayPhysicalWidthM = (dm.widthPixels / dm.xdpi) * INCH_TO_METER_RATIO;
        float displayPhysicalHeightM = (dm.heightPixels / dm.ydpi) * INCH_TO_METER_RATIO;
        ...
        mNativeVrShell = nativeInit(mDelegate, mContentVrWindowAndroid.getNativePointer(), forWebVr,
                ...
                mReprojectedRendering, displayPhysicalWidthM, displayPhysicalHeightM,
    ...
    private native long nativeInit(VrShellDelegate delegate, long nativeWindowAndroid,
            ...
            boolean reprojectedRendering, float displayPhysicalWidthM, float displayPhysicalHeightM,
            int displayPixelWidth, int displayPixelHeight);
