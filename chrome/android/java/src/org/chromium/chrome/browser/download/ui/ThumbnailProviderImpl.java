 ...
 */
public class ThumbnailProviderImpl implements ThumbnailProvider, ThumbnailProviderCallback {
    ...
    /**
     * Removes the thumbnail with the given contentId from disk (if disk-cached).
     * @param contentId
     */
    public void removeThumbnail(String contentId) {
