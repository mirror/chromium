...
public class UmaUtils {
    ...
    // All these values are uptime millis.
    ...
    // Event durations recorded from the application start.
    private static long sFirstCommitTimeMs;
    private static long sFirstContentfulPaintTimeMs;
    ...
    public static void recordFinishNavigation(boolean isTrackedPage) {
        ...
        boolean shouldRecordHistogram = isTrackedPage && isRunningApplicationStart();
    ...
    public static void recordFirstContentfulPaint(long firstContentfulPaintMs) {
        ...
        if (sFirstContentfulPaintTimeMs != 0 || sFirstCommitTimeMs == 0) return;

        sFirstContentfulPaintTimeMs = firstContentfulPaintMs - sApplicationStartTimeMs;
        RecordHistogram.recordLongTimesHistogram100(
                "Startup.Android.Experimental.Cold.TimeToFirstContentfulPaint",
                sFirstContentfulPaintTimeMs, TimeUnit.MILLISECONDS);
    }
