...
public class BottomSheetSwipeDetector extends GestureDetector.SimpleOnGestureListener {
    ...
    private class SwipeGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            if (!mSheetDelegate.shouldGestureMoveSheet(e1, e2)) return false;
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (!mSheetDelegate.shouldGestureMoveSheet(e1, e2) || !mIsScrolling) return false;
    ...
    private boolean isTouchEventInToolbar(MotionEvent e) {
        return e.getRawY() < mSheetDelegate.getCurrentOffsetPx() - mSheetDelegate.getMinOffsetPx();
    }
