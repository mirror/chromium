...
public class PaymentRequestImpl
    ...
    private PaymentDetailsModifier getModifier(@Nullable PaymentInstrument instrument) {
        ...
        for (String methodName : methodNames) {
            ...
            if (methodName == "basic-card" && modifier.methodData != null) {
                if (!instrument.isCardNetworksAndTypesSupported(
                            modifier.methodData.supportedNetworks,
                            modifier.methodData.supportedTypes)) {
                    continue;
                }
            }
            return modifier;
