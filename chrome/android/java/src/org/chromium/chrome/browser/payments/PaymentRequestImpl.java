...
public class PaymentRequestImpl
    ...
    public void complete(int result) {
        ...
        closeUIAndFinalize(/*close_immediately=*/PaymentComplete.FAIL != result);
    }
    ...
    /**
     * Closes the UI and finalizes the Payment Request. If the client is still connected, then it's
     ...
     *                       always pass "true."
     */
    private void closeUIAndFinalize(boolean immediateClose) {
        if (mUI != null) {
