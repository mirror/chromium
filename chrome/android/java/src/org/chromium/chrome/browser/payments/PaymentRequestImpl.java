...
public class PaymentRequestImpl
        implements PaymentRequest, PaymentRequestUI.Client, PaymentApp.InstrumentsCallback,
                   ...
                   PaymentAppFactory.PaymentAppCreatedCallback, PaymentPreferencesObserver.Observer,
    ...
    public void onAddressDeleted(String guid) {
        ...
        // only displayed SUGGESTIONS_LIMIT addresses, so we may want to add additional previously
        // ignored addresses.
    }
    ...
    public void onInstrumentsReady(PaymentApp app, List<PaymentInstrument> instruments) {
        ...
        PaymentPreferencesObserver.getInstance().registerObserver(this);
    ...
    private void closeUIAndDestroyNativeObjects(boolean immediateClose) {
        ...
        PaymentPreferencesObserver.getInstance().unregisterObserver(this);
