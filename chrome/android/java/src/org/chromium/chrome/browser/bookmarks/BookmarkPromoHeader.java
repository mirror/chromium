...
class BookmarkPromoHeader implements AndroidSyncSettingsObserver, SignInStateObserver,
     ...
     *         {@link RecyclerView}.
     */
    ViewHolder createPersonalizedPromoHolder(ViewGroup parent) {
    ...
    /**
     * @return Signin and sync promo header {@link ViewHolder} instance that can be used with
     *         {@link RecyclerView}.
     */
    ViewHolder createGenericPromoHolder(ViewGroup parent) {
    ...
    /**
     * Saves that the personalized promo was declined and updates the UI.
     */
    ...
    /**
     * Saves that the generic promo was declined and updates the UI.
     */
