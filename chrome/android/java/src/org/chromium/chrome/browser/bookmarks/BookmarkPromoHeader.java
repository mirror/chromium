...
class BookmarkPromoHeader implements AndroidSyncSettingsObserver, SignInStateObserver,
    ...
    /**
     * Saves that the new promo was dismissed and updates the UI.
     */
    ...
    /**
     * @return Whether the user dismissed the new signin promo.
     */
    private boolean wasNewSigninPromoDismissed() {
