...
public class ChromeHomeIphBubbleController {
     ...
     * @param toolbar The {@BottomToolbar} used to determine if the expand button is showing.
     * @param controlContainer The {@View} used to position bubbles.
    ...
    /**
     * Dismiss the in-product help bubble if it is showing.
     */
