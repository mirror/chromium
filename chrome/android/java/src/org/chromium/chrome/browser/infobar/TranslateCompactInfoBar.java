    ...
    protected void createCompactLayoutContent(InfoBarCompactLayout parent) {
        ...
        mMenuButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOverflowMenuHelper.show(TranslateMenu.MENU_OVERFLOW, getContainerWidth());
                mMenuExpanded = true;
            }
        });
    ...
    public void onOverflowMenuItemClicked(int itemId) {
        switch (itemId) {
            case TranslateMenu.ID_OVERFLOW_MORE_LANGUAGE:
                ...
                mLanguageMenuHelper.show(TranslateMenu.MENU_TARGET_LANGUAGE, getContainerWidth());
                return;
            ...
            case TranslateMenu.ID_OVERFLOW_NOT_THIS_LANGUAGE:
                ...
                mLanguageMenuHelper.show(TranslateMenu.MENU_SOURCE_LANGUAGE, getContainerWidth());
                return;
            default:
