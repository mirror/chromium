...
public class NotificationManagerProxyImpl implements NotificationManagerProxy {
    ...
    @Override
    public void createNotificationChannel(ChannelsInitializer.NotificationChannel channel) {
        ...
        try {
            ...
            Object channelObject =
                    channelConstructor.newInstance(channel.mId, channel.mName, channel.mImportance);
    ...
    public void createNotificationChannelGroup(ChannelsInitializer.ChannelGroup channelGroup) {
        ...
        try {
            ...
            Object channelGroupObject =
                    channelGroupConstructor.newInstance(channelGroup.mId, channelGroup.mName);
