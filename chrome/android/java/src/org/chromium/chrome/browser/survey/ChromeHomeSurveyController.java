...
public class ChromeHomeSurveyController implements InfoBarContainer.InfoBarAnimationListener {
    ...
    private TabObserver getTabObserver() {
        return new EmptyTabObserver() {
            // Restarts the logging countdown when the infobar tab is made visible again.
            @Override
            ...
            // Stops the countdown when the user switches tabs.
            @Override
    ...
    // Triggered anytime an infobar is added/removed.
    // If the survey infobar is visible, starts the countdown to log that it was displayed.
    @Override
