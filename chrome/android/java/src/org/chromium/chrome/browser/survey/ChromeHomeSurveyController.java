...
import org.chromium.chrome.browser.infobar.SurveyInfoBarObserver;
...
public class ChromeHomeSurveyController {
    ...
    static final String SURVEY_INFOBAR_DISMISSED = "chrome_home_survey_info_bar_dismissed";
    ...
    private void showSurveyInfoBar(WebContents webContents, String siteId) {
        SurveyInfoBar.showSurveyInfoBar(
                webContents, siteId, true, R.drawable.chrome_sync_logo, getSurveyInfoBarObserver());
    ...
    private SurveyInfoBarObserver getSurveyInfoBarObserver() {
        return new SurveyInfoBarObserver() {
