    ...
    TabObserver getTabObserver(Tab tab, String siteId) {
        return new EmptyTabObserver() {
            ...
            public void onInteractabilityChanged(boolean isInteractable) {
                // Don't show the survey infobar until the user commits to a tab
                // (i.e. a tab is interactable).
                if (!isInteractable) {
                    return;
                }
            ...
            public void onPageLoadFinished(Tab tab) {
                // Return because the tab finished loading in the background. This prevents an
                // infobar from showing on a background tab waiting for the user to return to it.
