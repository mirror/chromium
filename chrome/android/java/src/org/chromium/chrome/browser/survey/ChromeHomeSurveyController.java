...
public class ChromeHomeSurveyController implements InfoBarContainer.InfoBarAnimationListener {
     ...
     *  Note: these values must match the SurveyFilteringResult enum in histograms.xml.
     */
     ...
     * Note: these values must match the InfoBarClosingStates enum in histograms.xml.
     */
    ...
    private void recordInfoBarClosingState(int value) {
