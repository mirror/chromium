...
public class ChromeHomeSurveyController {
    ...
    public void kickoffSurveyProcess(Tab tab, Context context) {
        ...
        if (tab != null && context != null && userQualifiesForSurvey()) {
            ...
            surveyController.initController(context, tab.getWebContents(), surveyId, "", true,
                    R.drawable.chrome_sync_logo, new SurveyAvailableCallback());
    ...
    /**
     * Sets the tab model selector to pull the current tab info.
     * @param tabModelSelector The tab model selector that has information on the current tab.
     */
    ...
    public class SurveyAvailableCallback implements Callback {
                ...
                if (webContents.isLoading()) {
                    webContents.addObserver(new WebContentsObserver() {
                        ...
                        public void didStopLoading(String url) {
                            SurveyInfoBar.showSurveyInfoBar(webContents, mSurveyId, mAdvertisingId);
                        }
                    });
                } else {
                    SurveyInfoBar.showSurveyInfoBar(webContents, mSurveyId, mAdvertisingId);
        ...
        public void initInfoBarParams(String surveyId, String advertisingId) {
            mSurveyId = surveyId;
