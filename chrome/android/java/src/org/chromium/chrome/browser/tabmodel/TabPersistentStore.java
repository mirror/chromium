...
public class TabPersistentStore extends TabPersister {
    ...
    public abstract static class TabPersistentStoreObserver {
         ...
         * @param normalModelIds A list of tab ids saved from normal tab model.
         * @param incognitoModelIds A list of tab ids saved from incognito tab model.
         */
        public void onMetadataSavedAsynchronously(
                List<Integer> normalModelIds, List<Integer> incognitoModelIds) {}
    }
    ...
    /** Stores meta data information about a TabModelSelector. */
    public static class TabModelSelectorMetadata {
        public final byte[] mListData;
        public final TabModelMetadata mNormalModelMetadata;
        public final TabModelMetadata mIncognitoModelMetadata;
        public final List<TabRestoreDetails> mTabsBeingRestored;
        ...
        public TabModelSelectorMetadata(byte[] listData, TabModelMetadata normalModelMetadata,
            ...
            mListData = listData;
            mNormalModelMetadata = normalModelMetadata;
            mIncognitoModelMetadata = incognitoModelMetadata;
            mTabsBeingRestored = tabsBeingRestored;
        }
    }
    ...
    private class SaveListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            ...
            if (mSaveListTask == this) {
                mSaveListTask = null;
                for (TabPersistentStoreObserver observer : mObservers) {
                    observer.onMetadataSavedAsynchronously(mMetadata.mNormalModelMetadata.ids,
                            mMetadata.mIncognitoModelMetadata.ids);
                }
                mMetadata = null;
            }
        }
