...
public class SelectionClientManager {
     ...
     * @param windowAndroid The window this client is presented in.
     */
    public SelectionClientManager(ContentViewCore contentViewCore, WindowAndroid windowAndroid) {
        if (ALLOW_CHROME_SMART_SELECTION) {
            assert contentViewCore != null;
            WebContents webContents = contentViewCore.getWebContents();
            assert webContents != null;
            mOptionalSelectionClient = SelectionClientFactory.create(
