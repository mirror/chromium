...
public class SelectionClientManager implements SelectionClient {
    // Whether Smart Select is enabled in Chrome.
    private static final boolean ENABLE_CHROME_SMART_SELECT = true;
    ...
    public SelectionClientManager(
        ...
        mIsEnabled = mOptionalSelectionClient != null;
    }
    ...
    public SelectionClient setContextualSearchSelectionClient(
            @Nullable SelectionClient contextualSearchSelectionClient) {
        if (contextualSearchSelectionClient == null) {
            removeContextualSearchSelectionClient(contextualSearchSelectionClient);
        } else {
            addContextualSearchSelectionClient(contextualSearchSelectionClient);
        }
        return this;
    }
     ...
     */
    private void addContextualSearchSelectionClient(
        ...
        if (mOptionalSelectionClient == null) {
            ...
            mOptionalSelectionClient = new SelectionClientBridge(
                    mOptionalSelectionClient, contextualSearchSelectionClient);
            mIsBridged = true;
            System.out.println("ctxs bridged now.");
        }
    }
     ...
     */
    private void removeContextualSearchSelectionClient(SelectionClient selectionClientToRemove) {
