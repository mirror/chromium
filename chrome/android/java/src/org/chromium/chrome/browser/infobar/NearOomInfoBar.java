...
public class NearOomInfoBar extends InfoBar {
    ...
    protected void createCompactLayoutContent(InfoBarCompactLayout layout) {
        View view = new InfoBarCompactLayout.MessageBuilder(layout)
                            .setMessage(R.string.near_oom_intervention_message)
                            .setLink(R.string.near_oom_intervention_decline, v -> onLinkClicked())
                            .build();
        layout.addContent(view, 1f);
    }
