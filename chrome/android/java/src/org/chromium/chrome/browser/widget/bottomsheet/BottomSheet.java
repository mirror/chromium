...
public class BottomSheet
     ...
     * sheet intentionally. This is specifically for the 'maria-model' of swipe logic.
     */
    ...
    /**
     * Whether or not swipe/scroll/fling events are currently being blocked for the
     * 'maria-model' swipe logic.
     */
    private boolean mMariaSwipeModelBlockSwipe;
    ...
    private boolean shouldGestureMoveSheet(MotionEvent initialEvent, MotionEvent currentEvent) {
        ...
        if (currentEvent.getActionMasked() == MotionEvent.ACTION_DOWN) {
            mMariaSwipeModelBlockSwipe = false;
        }
        ...
        if (ChromeSwitches.CHROME_HOME_SWIPE_LOGIC_RESTRICT_AREA.equals(logicType)) {
        ...
        } else if (ChromeSwitches.CHROME_HOME_SWIPE_LOGIC_MARIA_MODEL.equals(logicType)) {
            if (mMariaSwipeModelBlockSwipe) return false;
            ...
            if (dpPerMs > SHEET_SWIPE_MAX_DP_PER_MS) {
                mMariaSwipeModelBlockSwipe = true;
                return false;
            }
