...
public class BottomSheet
     ...
     *
     * - If called before the browser is started, it sets a flag to ensure we set the state to half
     * when we call this again in the browser startup callback.
     * - If called after the browser is already started, it immediately sets the sheet state to
     * half.
     */
