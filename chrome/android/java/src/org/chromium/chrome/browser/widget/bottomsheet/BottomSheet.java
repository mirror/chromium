...
public class BottomSheet
    ...
    private void postBrowserStartupInit() {
        ...
        // Initializing the bottom navigation menu height has to happen before the call to
        // BottomSheetContentController#initializeMenuView.
        initBottomNavHeight();
     ...
     *
     * This DOES NOT initialize the bottom navigation menu visually. A call to
     * BottomSheetContentController#initializeMenuView is necessary afterwards to ensure the menu
     * view matches this.
     */
    private void initBottomNavHeight() {
