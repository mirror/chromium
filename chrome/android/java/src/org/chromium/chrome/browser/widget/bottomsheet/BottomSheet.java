...
public class BottomSheet
    ...
    public BottomSheet(Context context, AttributeSet atts) {
        ...
        addObserver(new BottomSheetObserver() {
            @Override
            public void onSheetOpened(int reason) {
                android.util.Log.w("mdjones", "onSheetOpened");
            }

            @Override
            public void onSheetClosed(int reason) {
                android.util.Log.w("mdjones", "onSheetClosed");
            }

            @Override
            public void onSheetReleased() {
                android.util.Log.w("mdjones", "onSheetReleased");
            }

            @Override
            public void onLoadUrl(String url) {
                android.util.Log.w("mdjones", "onLoadUrl");
            }

            @Override
            public void onSheetOffsetChanged(float heightFraction) {
                android.util.Log.w("mdjones", "onSheetOffsetChanged: " + heightFraction);
            }
            ...
            public void onSheetStateChanged(int newState) {
                android.util.Log.w("mdjones", "onSheetStateChanged: " + newState);
            }
    ...
    public void init(View root, ChromeActivity activity) {
        mToolbarHolder = (TouchRestrictingFrameLayout) findViewById(R.id.toolbar_holder);
        mDefaultToolbarView = mToolbarHolder.findViewById(R.id.toolbar);
    ...
    private void setSheetOffsetFromBottom(float offset) {
        ...
        android.util.Log.w(
                "mdjones", "setSheetOffsetFromBottom: " + mContainerHeight + "      " + offset);
    ...
    public void setSheetState(
        ...
        if (state == SHEET_STATE_FULL) {
            android.util.Log.w("mdjones", "expanding to full");
            Thread.dumpStack();
        }
