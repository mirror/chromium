...
public class BottomSheet
    ...
    /**
     * Record swipe velocity in microseconds per dp. This histogram will record between 0 and 15k
     * microseconds with 250 buckets.
    ...
    private void recordSwipeVelocity(String name, int microsPerDp) {
        RecordHistogram.recordCustomCountHistogram(name, microsPerDp, 0, 15000, 250);
    }
