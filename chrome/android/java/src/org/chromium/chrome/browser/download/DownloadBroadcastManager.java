...
public final class DownloadBroadcastManager {
    ...
    // TODO(jming): Check to see if this wait time is long enough for native to be loaded.
     ...
     */
    private void loadNativeAndPropagateInteraction(Context context, final Intent intent) {
