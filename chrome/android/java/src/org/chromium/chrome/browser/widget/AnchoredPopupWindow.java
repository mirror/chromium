 ...
 * a {@link RectProvider} set through a call to {@link #setAnchorRectProvider(RectProvider)}.
 * This should be called at least once before the {@link #show()} call.
 */
public class AnchoredPopupWindow implements OnTouchListener, RectProvider.Observer {
    ...
    public AnchoredPopupWindow(
            Context context, View rootView, Drawable background, View contentView) {
        mContext = context;
    ...
    /**
     * Sets the {@link RectProvider} that will provide the {@link Rect} this popup attaches and
     * orients to.  This should be called exactly once before calling {@link #show()}.
     *
     * @param provider The {@link RectProvider} that will provide the anchor {@link Rect}.
     */
    public void setAnchorRectProvider(RectProvider provider) {
        assert mRectProvider == null;

        mRectProvider = provider;
    }
