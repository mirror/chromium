...
@Features(@Features.Register(ChromeFeatureList.CONTEXTUAL_SUGGESTIONS_CAROUSEL))
public class ImageFetcherTest {
    ...
    public void testFaviconFetch() {
        SnippetArticle suggestion =
                ContentSuggestionsTestUtils.createDummySuggestions(1, KnownCategories.BOOKMARKS)
                        .get(0);
