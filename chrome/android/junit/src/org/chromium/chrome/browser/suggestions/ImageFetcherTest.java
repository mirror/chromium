...
import static org.chromium.chrome.browser.suggestions.ImageFetcher.getSnippetDomain;
...
public class ImageFetcherTest {
    ...
    public void setUp() {
        ...
        mImageFetcher = new ImageFetcher(mUiDelegate, mock(Profile.class));
    ...
    public void testFaviconFetch() {
        ...
        String expectedFaviconDomain = getSnippetDomain(URI.create(suggestion.getUrl()));
    ...
    public void testLargeIconFetch() {
        ...
        String expectedIconDomain = getSnippetDomain(URI.create(URL_STRING));
    ...
    public void testSnippetDomainExtraction() {
        ...
        String actual = getSnippetDomain(uri);
