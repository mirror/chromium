...
public class TileTest {
    ...
    //
    //        // importData should not report the change since it has no visible impact. The new
    //        tile
    ...
    //
    //        // Old transient data should be copied over to the new tile without flagging the
    //        change. assertFalse(tile.importData(oldTile));
