...
public class SuggestionsSectionTest {
    ...
    public void testFetchMoreAfterDismissAll() {
        ...
        for (int i = 0; i < suggestionCount; i++) {
            suggestions.get(i).trackImpression();
            @SuppressWarnings("unchecked")
            Callback<String> callback = mock(Callback.class);
            section.dismissItem(1, callback);
        }
    ...
    public void testUpdateSectionReplacesSuggestions() {
        ...
        section.updateSuggestions();
        // The first suggestion is kept around as it is assumed to be impressed.
        ...
        // The data is stale because one of the suggestions was not replaced.
    ...
    public void testUpdateSectionDoesNotReplaceFirstSuggestionWhenSeen() {
        ...
        // The first suggestion is assumed to be seen automatically.
    ...
    public void testUpdateSectionDoesNotReplaceFirstTwoSuggestionWhenSeen() {
        ...
        // Mark the first suggestion as impressed, the second one is assumed to be seen
        // automatically.
        snippets.get(0).trackImpression();
    ...
    public void testUpdateSectionDoesNothingWhenAllSeen() {
        ...
        for (SnippetArticle snippet : snippets) snippet.trackImpression();
