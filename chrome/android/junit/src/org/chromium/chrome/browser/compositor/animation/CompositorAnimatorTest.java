...
public final class CompositorAnimatorTest {
    ...
    @Test
    public void testAnimationCancelValue() {
        CompositorAnimator animator = new CompositorAnimator(mContext);
        animator.setDuration(10);
    ...
    @Test
    public void testAnimationEndValue() {
        CompositorAnimator animator = new CompositorAnimator(mContext);
        animator.setDuration(10);
        animator.addUpdateListener(mUpdateListener);
    ...
    public void testAnimatorSet_playTogether() {
        ...
        CompositorAnimator animator2 = new CompositorAnimator(mContext);
        ...
        assertEquals("There should be two active animations.", 2, mHandler.getActiveAnimations());
