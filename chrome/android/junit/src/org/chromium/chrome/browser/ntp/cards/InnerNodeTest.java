...
public class InnerNodeTest {
    ...
    @Mock private ListObserver mObserver;
    ...
    public void testRemoveChild() {
        ...
        verify(child).removeObserver(eq(mObserver));
        ...
        verify(child2).removeObserver(eq(mObserver));
    ...
    private static class MockListObserver implements ListObserver {
        ...
        private void checkCount(ListObservable child) {
            ...
            assertThat(((TreeNode) child).getItemCount(), is(mNextExpectedItemCount));
