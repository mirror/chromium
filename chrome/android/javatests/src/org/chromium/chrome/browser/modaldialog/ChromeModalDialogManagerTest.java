...
public class ChromeModalDialogManagerTest {
    ...
    private ChromeModalDialogManager mManager;
    ...
    public void setUp() throws Exception {
        ...
        mManager = (ChromeModalDialogManager) mActivity.getModalDialogManager();
    ...
    public void testShow_UrlBarFocused() throws Exception {
        ...
        final View dialogContainer = mManager.getDialogContainerForTest();
        final View controlContainer = mActivity.findViewById(R.id.control_container);
        final ViewGroup containerParent = mManager.getContainerParentForTest();
