...
public class ThumbnailProviderImplTest {
    ...
    private CallbackHelper mThumbnailRetrievedCallback;
    ...
    public void setUp() throws Exception {
        ...
        mThumbnailRetrievedCallback = new CallbackHelper();
    }
    ...
    public void testBothThumbnailSidesSmallerThanRequiredSize() throws Exception {
        ...
        mThumbnailRetrievedCallback.waitForCallback(
    ...
    private void checkResult(int expectedWidth, int expectedHeight, String expectedFilePath,
        ...
        Assert.assertTrue(TextUtils.equals(expectedFilePath, request.getRetrievedFilePath()));
    }
    ...
    private class TestThumbnailRequest implements ThumbnailRequest {
        ...
        public void onThumbnailRetrieved(String filePath, Bitmap thumbnail) {
            ...
            mThumbnailRetrievedCallback.notifyCalled();
        }
