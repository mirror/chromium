...
public class PaymentRequestPaymentAppsSortingTest implements MainActivityStartCallback {
    ...
    public void testPaymentAppsSortingByFrecency()
        ...
        Assert.assertEquals(
                0, PaymentPreferencesUtil.getPaymentInstrumentUseCount(charliePayId));
        Assert.assertEquals(
                0, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(alicePayId));
        Assert.assertEquals(
                0, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(bobPayId));
        Assert.assertEquals(
        ...
        Assert.assertEquals(
                15, PaymentPreferencesUtil.getPaymentInstrumentUseCount(charliePayId));
        Assert.assertEquals(
                5, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(alicePayId));
        Assert.assertEquals(
                10, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(bobPayId));
        Assert.assertEquals(
        ...
        // it.
        Assert.assertEquals(
                21, PaymentPreferencesUtil.getPaymentInstrumentUseCount(alicePayId));
        Assert.assertEquals(10, PaymentPreferencesUtil.getPaymentInstrumentUseCount(bobPayId));
        Assert.assertEquals(
                15, PaymentPreferencesUtil.getPaymentInstrumentUseCount(charliePayId));
        Assert.assertTrue(
                PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(alicePayId) > 20);
        Assert.assertEquals(
                10, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(bobPayId));
        Assert.assertEquals(
                15, PaymentPreferencesUtil.getPaymentInstrumentLastUseDate(charliePayId));
