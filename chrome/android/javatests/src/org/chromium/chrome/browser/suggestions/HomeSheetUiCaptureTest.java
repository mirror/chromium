...
public class HomeSheetUiCaptureTest {
    ...
    @CommandLineFlags
            .Add({"enable-features=" + ChromeFeatureList.CHROME_HOME_MODERN_LAYOUT + ","
    ...
    @CommandLineFlags
        ...
        ThreadUtils.runOnUiThreadBlocking(() -> {
            mSuggestionsSource.setSuggestionsForCategory(
                    KnownCategories.ARTICLES, Collections.emptyList());
        ...
        mScreenShooter.shoot("All_dismissed" + (SuggestionsConfig.useModern() ? "_modern" : ""));
    }
