...
/**
 * Tests for a PWA Notification governed by {@link WebappActionsNotificationManager}.
 */
...
public class WebappActionsNotificationTest {
    ...
    public void testNotification() throws Exception {
        Notification notification = getPwaNotification();
        ...
        Assert.assertNull("PWA Notification should no longer be shown", getPwaNotification());
    }
    ...
    public void testNotificationNotEnabled() throws Exception {
        ...
        Assert.assertNull(getPwaNotification());
    }

    @Nullable
    private Notification getPwaNotification() {
