...
public class MultiWindowIntegrationTest {
    ...
    testMoveTabTwice() throws InterruptedException {
        ...
        waitForTabs("CTA2", cta2, 2, googleTabId);
        ...
        waitForTabs("CTA2", cta2, 1, Tab.INVALID_TAB_ID);
    ...
    private static void waitForTabs(final String tag, final ChromeTabbedActivity activity,
        ...
        CriteriaHelper.pollUiThread(new Criteria() {
            ...
            public boolean isSatisfied() {
                int actualTotalTabCount = activity.getTabModelSelector().getModel(false).getCount();
