...
/**
 * A payment integration test for a merchant that either does not listen to update callbacks or does
 * not call updateWith(). These behaviors are both OK and should not cause timeouts.
 */
...
public class PaymentRequestNoUpdateWithTest implements MainActivityStartCallback {
    ...
    public void testNoEventListener() throws Throwable {
        ...
        mRule.expectResultContains(new String[] {"4111111111111111"});
    }
