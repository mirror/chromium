...
public class PaymentRequestDebitTest implements MainActivityStartCallback {
    ...
    public void onMainActivityStarted()
        ...
        helper.addServerCreditCard(new CreditCard("", "https://example.com", false, true, "Jon Doe",
                ...
                CreditCard.CARD_TYPE_DEBIT, billingAddressId, "server-id-1"));

        // Should be available, but never pre-selected:
        helper.addServerCreditCard(new CreditCard("", "https://example.com", false, true, "Jon Doe",
                "6011111111111117", "1117", "12", "2050", "discover", R.drawable.pr_discover,
                CreditCard.CARD_TYPE_UNKNOWN, billingAddressId, "server-id-2"));

        // Should not be available:
        helper.addServerCreditCard(new CreditCard("", "https://example.com", false, true, "Jon Doe",
                "378282246310005", "0005", "12", "2050", "amex", R.drawable.pr_amex,
                CreditCard.CARD_TYPE_CREDIT, billingAddressId, "server-id-3"));
        helper.addServerCreditCard(new CreditCard("", "https://example.com", false, true, "Jon Doe",
                "5555555555554444", "4444", "12", "2050", "mastercard", R.drawable.pr_mc,
                CreditCard.CARD_TYPE_PREPAID, billingAddressId, "server-id-4"));
    }
