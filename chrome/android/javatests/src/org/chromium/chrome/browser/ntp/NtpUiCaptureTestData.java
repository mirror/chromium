...
public class NtpUiCaptureTestData {
    ...
    public static SuggestionsSource getSuggestionsSource() {
    ...
    public static MostVisitedSites getMostVisitedSites() {
    ...
    public static LargeIconBridge getLargeIconBridge() {
