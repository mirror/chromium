...
public class BrowserActionActivityTest {
    ...
    @DrawableRes
    private static final int CUSTOM_ITEM_ICON_ID_1 = R.drawable.star_green;
    @DrawableRes
    private static final int CUSTOM_ITEM_ICON_ID_2 = R.drawable.ic_add;
    @DrawableRes
    private static final int CUSTOM_ITEM_ICON_ID_3 = -1;
    ...
    private List<BrowserActionItem> createCustomItems() {
        ...
        BrowserActionItem item1 =
                new BrowserActionItem(CUSTOM_ITEM_TITLE_1, action1, CUSTOM_ITEM_ICON_ID_1);
        PendingIntent action2 = createCustomItemAction(mTestPage);
        BrowserActionItem item2 =
                new BrowserActionItem(CUSTOM_ITEM_TITLE_2, action2, CUSTOM_ITEM_ICON_ID_2);
        PendingIntent action3 = createCustomItemAction(mTestPage);
        BrowserActionItem item3 =
                new BrowserActionItem(CUSTOM_ITEM_TITLE_3, action3, CUSTOM_ITEM_ICON_ID_3);
