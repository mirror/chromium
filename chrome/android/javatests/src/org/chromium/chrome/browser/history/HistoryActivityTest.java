...
public class HistoryActivityTest {
    ...
    private void signInToSupervisedAccount() throws Exception {
        ...
        ThreadUtils.runOnUiThreadBlocking(() -> {
            PrefChangeRegistrar prefChangeRegistrar = new PrefChangeRegistrar(false);
            prefChangeRegistrar.addObserver(
                    PrefServiceBridge.ALLOW_DELETING_BROWSER_HISTORY, mTestObserver);
            prefChangeRegistrar.addObserver(
                    PrefServiceBridge.INCOGNITO_MODE_AVAILABILITY, mTestObserver);
        });
