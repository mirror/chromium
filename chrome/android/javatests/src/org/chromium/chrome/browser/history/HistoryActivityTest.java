...
public class HistoryActivityTest {
    ...
    public void testSupervisedUser() throws Exception {
        ...
        // The preference for supervised user sign in is async and the
        // HistoryAdapter#onSignInStateChange call does guarantee preference is already update.
        // Thus, this test would poll until preference is changed and UI is updated
        CriteriaHelper.pollUiThread(new Criteria() {
            @Override
            public boolean isSatisfied() {
                if (View.GONE == item.findViewById(R.id.remove).getVisibility()) {
                    return true;
                }
                mAdapter.updateClearBrowsingDataButtonVisibilityForTest();
                return false;
            }
