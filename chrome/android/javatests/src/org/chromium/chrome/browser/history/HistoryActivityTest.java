...
public class HistoryActivityTest {
    ...
    public void setUp() throws Exception {
        ...
        final HistoryActivity activity = mActivityTestRule.getActivity();
    ...
    public void testPrivacyDisclaimers_SignedOut() {
        ...
        Assert.assertEquals(View.GONE, mAdapter.getSignedInNotSyncedViewForTests().getVisibility());
        Assert.assertEquals(View.GONE, mAdapter.getSignedInSyncedViewForTests().getVisibility());
        Assert.assertEquals(
    ...
    public void testPrivacyDisclaimers_SignedIn() {
        ...
        Assert.assertEquals(
                View.VISIBLE, mAdapter.getSignedInNotSyncedViewForTests().getVisibility());
        Assert.assertEquals(View.GONE, mAdapter.getSignedInSyncedViewForTests().getVisibility());
        Assert.assertEquals(
                View.GONE, mAdapter.getOtherFormsOfBrowsingHistoryViewForTests().getVisibility());
    ...
    public void testPrivacyDisclaimers_SignedInSynced() {
        ...
        Assert.assertEquals(View.GONE, mAdapter.getSignedInNotSyncedViewForTests().getVisibility());
        Assert.assertEquals(View.VISIBLE, mAdapter.getSignedInSyncedViewForTests().getVisibility());
        Assert.assertEquals(
                View.GONE, mAdapter.getOtherFormsOfBrowsingHistoryViewForTests().getVisibility());
    ...
    public void testCopyLink() throws Exception {
        final ClipboardManager clipboardManager =
                (ClipboardManager) mActivityTestRule.getActivity().getSystemService(
                        mActivityTestRule.getActivity().CLIPBOARD_SERVICE);
