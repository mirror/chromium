...
import static org.chromium.chrome.browser.webapps.WebappActivity.IMMERSIVE_MODE_UI_FLAGS;
...
public class WebappDisplayModeTest {
    ...
    private WebappActivity startActivity(int displayMode) throws Exception {
        mActivityTestRule.startWebappActivity(mActivityTestRule.createIntent()
    ...
    private static boolean isFullscreen(WebappActivity activity) {
        ...
        return (systemUiVisibility & IMMERSIVE_MODE_UI_FLAGS) == IMMERSIVE_MODE_UI_FLAGS;
    }
}
