...
public class TabModalDialogManagerTest {
    @Rule
    public ChromeTabbedActivityTestRule mActivityTestRule = new ChromeTabbedActivityTestRule();

    private static final int MAX_DIALOGS = 3;
    private ChromeTabbedActivity mActivity;
    private TabModalDialogManager mManager;
    private ModalDialog[] mModalDialogs;
    ...
    public void setUp() throws Exception {
        ...
        mModalDialogs = new ModalDialog[MAX_DIALOGS];
        for (int i = 0; i < MAX_DIALOGS; i++) mModalDialogs[i] = createDialog(i);
    }
    ...
    private ModalDialog createDialog(final int index) throws Exception {
        return ThreadUtils.runOnUiThreadBlocking(new Callable<ModalDialog>() {
            @Override
            public ModalDialog call() {
                ModalDialog.Controller controller = new ModalDialog.Controller() {
                    @Override
                ...
                final ModalDialog dialog = new ModalDialog(mActivity, controller, true);
    ...
    private void showDialog(final int index) {
        ThreadUtils.runOnUiThreadBlocking(() -> { mManager.showDialog(mModalDialogs[index]); });
    }

    private void dismissDialog(final int index) {
        ThreadUtils.runOnUiThreadBlocking(() -> { mManager.dismissDialog(mModalDialogs[index]); });
    }
