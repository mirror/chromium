...
public class PersonalDataManagerTest {
    ...
    public void testCreditCardsDeduping()
        ...
        CreditCard card1 = new CreditCard("" /* guid */, "https://www.example.com" /* origin */,
                ...
                "2020", "Visa", 0 /* issuerIconDrawableId */, CreditCard.CARD_TYPE_UNKNOWN,
    ...
    public void testCreditCardUseStatsSettingAndGetting()
            throws InterruptedException, ExecutionException, TimeoutException {
        String guid = mHelper.setCreditCard(new CreditCard("" /* guid */,
                "https://www.example.com" /* origin */, true /* isLocal */, false /* isCached */,
                "John Doe", "1234123412341234", "", "5", "2020", "Visa",
