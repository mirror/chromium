...
public class PaymentRequestExpiredLocalCardTest implements MainActivityStartCallback {
    ...
    public void testPayWithExpiredCard_ValidExpiration()
        ...
        mRule.clickAndWait(
                R.id.button_primary, mRule.getReadyForUnmaskInput());
        ...
        mRule.clickCardUnmaskButtonAndWait(
                DialogInterface.BUTTON_POSITIVE, mRule.getDismissed());
        mRule.expectResultContains(new String[] {"Jon Doe", "4111111111111111",
    ...
    public void testCannotAddExpiredCard()
        ...
        mRule.clickInPaymentMethodAndWait(
                R.id.payments_section, mRule.getReadyForInput());
        mRule.clickInPaymentMethodAndWait(
                R.id.payments_add_option_button, mRule.getReadyToEdit());
        ...
        mRule.clickInCardEditorAndWait(
                R.id.payments_edit_done_button, mRule.getReadyToPay());
    }
    ...
    /**
     * Tests that hitting "submit" on the software keyboard in the CVC numberfield will submit the
     * CVC unmask dialog.
     */
    @MediumTest
    @Feature({"Payments"})
