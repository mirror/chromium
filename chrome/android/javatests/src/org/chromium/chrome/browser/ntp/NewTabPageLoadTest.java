...
public class NewTabPageLoadTest {
    ...
    public void setUp() throws Exception {
        ...
        mSuggestionDeps.getFactory().mLargeIconBridge = new AsyncMockLargeIconBridge();
    ...
    // @Test
    // @SmallTest
    @DisabledTest(message = "needs https://chromium-review.googlesource.com/c/545897/ to pass.")
