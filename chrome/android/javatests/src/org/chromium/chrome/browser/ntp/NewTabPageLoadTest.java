...
public class NewTabPageLoadTest {
    ...
    private VerifyingMostVisitedSites mMostVisitedSites;
    ...
    public void setUp() throws Exception {
        ...
        mMostVisitedSites = new VerifyingMostVisitedSites();
        mMostVisitedSites.setTileSuggestions(mTestServer.getURLs("/site1", "/site2"));
        mSuggestionDeps.getFactory().mMostVisitedSites = mMostVisitedSites;
        mSuggestionDeps.getFactory().mLargeIconBridge = new LargeIconBridge() {
            @Override
            public boolean getLargeIconForUrl(
                    String pageUrl, int desiredSizePx, LargeIconCallback callback) {
...
//    @Test
//    @SmallTest
    @DisabledTest(message = "fails until https://crbug.com/695806 is fixed.")
    ...
    private static class VerifyingMostVisitedSites extends FakeMostVisitedSites {
        ...
        public void recordPageImpression(int[] sources, int[] tileTypes, String[] tileUrls) {
            ...
            for (int i : tileTypes) assertNotEquals(TileVisualType.NONE, i);
        }
    }
}
