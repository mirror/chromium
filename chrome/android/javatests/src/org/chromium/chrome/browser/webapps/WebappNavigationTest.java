...
public class WebappNavigationTest {
    ...
    public void testRegularLinkOffOriginNoWebappThemeColor() throws Exception {
        ...
        Assert.assertEquals(defaultPrimaryColor(), activity.getToolbarManager().getPrimaryColor());
    }
    ...
    /**
     * Test that navigating outside of the webapp scope by tapping a LINK WITH TARGET BLANK:
     * - Launches a CCT.
    ...
    public void testOffScopeNewTabLinkOpensInCct() throws Exception {
        ...
        Assert.assertEquals(defaultPrimaryColor(), customTab.getToolbarManager().getPrimaryColor());
    }

    /**
     * Test that navigating within the webapp scope by tapping a LINK WITH TARGET BLANK launches a
     * CCT.
     */
    @Test
    @SmallTest
    ...
    private long defaultPrimaryColor() {
