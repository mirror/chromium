...
public class WebappNavigationTest {
    ...
    public void testPostRequestIsNotHandledByCct() throws Exception {
        ...
        // as its hard to test WebAPKs as well as to stub responses to POST requests.
        Assert.assertFalse(WebappInterceptNavigationDelegate.shouldOpenInCustomTab(
                ...
                WebApkInfo.create("", "https://somewebapp.com", "https://somewebapp.com", null,
                        null, null, null, WebDisplayMode.STANDALONE, 0, 0, 0, 0, "", 0, null, "",
                        null, false /* forceNavigation */),
                WebappScopePolicy.WEBAPK));
    }
