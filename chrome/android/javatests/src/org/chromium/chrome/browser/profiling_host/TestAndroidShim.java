...
public class TestAndroidShim {
     ...
     */
    public boolean runTestForMode(String mode, boolean dynamicallyStartProfiling,
            boolean pseudoStacks, boolean includeThreadNames) {
        return nativeRunTestForMode(mNativeTestAndroidShim, mode, dynamicallyStartProfiling,
                pseudoStacks, includeThreadNames);
    }
    ...
    private native boolean nativeRunTestForMode(long nativeTestAndroidShim, String mode,
            boolean dynamicallyStartProfiling, boolean pseudoStacks, boolean includeThreadNames);
}
