...
public class PermissionTestRule extends ChromeActivityTestRule<ChromeActivity> {
    public static final String MODAL_FLAG = "ModalPermissionPrompts";
    ...
    public static final String NO_GESTURE_FEATURE =
            "enable-features=ModalPermissionPrompts<ModalPrompts";

    public static final String FORCE_FIELDTRIAL = "force-fieldtrials=ModalPrompts/Group1";

    public static final String FORCE_FIELDTRIAL_PARAMS =
