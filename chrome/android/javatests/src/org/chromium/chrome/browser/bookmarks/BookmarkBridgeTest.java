...
public class BookmarkBridgeTest {
    @Rule
    public final RuleChain mChain = RuleChain.outerRule(new ChromeBrowserTestRule());
    ...
    public void testAddBookmarksAndFolders() throws Throwable {
        ThreadUtils.runOnUiThreadBlocking(() -> {
            BookmarkId bookmarkA = mBookmarkBridge.addBookmark(mDesktopNode, 0, "a",
                    "http://a.com");
            verifyBookmark(bookmarkA, "a", "http://a.com/", false, mDesktopNode);
            BookmarkId bookmarkB = mBookmarkBridge.addBookmark(mOtherNode, 0, "b",
                    "http://b.com");
            verifyBookmark(bookmarkB, "b", "http://b.com/", false, mOtherNode);
            BookmarkId bookmarkC = mBookmarkBridge.addBookmark(mMobileNode, 0, "c",
                    "http://c.com");
            ...
            BookmarkId bookmarkAA = mBookmarkBridge.addBookmark(folderA, 0, "aa",
                    "http://aa.com");
