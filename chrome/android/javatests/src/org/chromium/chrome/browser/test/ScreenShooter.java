...
public class ScreenShooter extends TestWatcher {
    ...
    public void shoot(String shotName, Map<String, String> tags) {
        String defaultTags[] = {TEST_CLASS_TAG, TEST_METHOD_TAG, SCREENSHOT_NAME_TAG,
        ...
        for (String tag : tags.keySet()) {
            assertThat("Test must not set the default tag \"" + tag + "\"", defaultTags,
                    not(hasItemInArray(tag)));
        }
