...
public class ShareIntentTest {
    ...
    public void testShareIntent() {
        final AtomicReference<MockChromeActivity> activityRef = new AtomicReference<>();
        ThreadUtils.runOnUiThreadBlocking(() -> {
            ...
            activityRef.set(new MockChromeActivity(mActivityTestRule.getActivity()));
        });
        MockChromeActivity mockActivity = activityRef.get();
