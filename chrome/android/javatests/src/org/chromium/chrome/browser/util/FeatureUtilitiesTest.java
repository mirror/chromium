...
public class FeatureUtilitiesTest {
    ...
    private void setUpAccountManager(String accountType, boolean addAccount) {
    ...
    public void testHasGoogleAccountCorrectlyDetected() {
        ...
        // when queried.
        setUpAccountManager(AccountManagerHelper.GOOGLE_ACCOUNT_TYPE, true);
    ...
    public void testHasNoGoogleAccountCorrectlyDetected() {
        ...
        setUpAccountManager("Non A Google Account", false);
