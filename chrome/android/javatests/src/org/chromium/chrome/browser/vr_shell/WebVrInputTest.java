...
public class WebVrInputTest {
    ...
    public void testScreenTapsRegisteredOnCardboard() throws InterruptedException {
        ...
        // TODO(mthiesse): Injecting touch events into the root GvrLayout (VrShellImpl) is flaky.
        // Sometimes the events just don't get routed to the presentation view for no apparent
        // reason. We should figure out why this is and see if it's fixable.
