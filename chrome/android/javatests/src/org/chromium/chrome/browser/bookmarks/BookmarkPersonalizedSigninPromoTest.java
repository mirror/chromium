...
public class BookmarkPersonalizedSigninPromoTest {
    ...
    @Test
    @MediumTest
    public void testSigninButtonDefaultAccount() throws InterruptedException {
        addTestAccount();
        openBookmarkManager();
        onView(withId(R.id.signin_promo_view_container)).check(matches(isDisplayed()));
    ...
    @Test
    @MediumTest
    public void testSigninButtonNotDefaultAccount() throws InterruptedException {
        addTestAccount();
        openBookmarkManager();
        onView(withId(R.id.signin_promo_view_container)).check(matches(isDisplayed()));
    ...
    @Test
    @MediumTest
    public void testSigninButtonNewAccount() throws InterruptedException {
        openBookmarkManager();
        onView(withId(R.id.signin_promo_view_container)).check(matches(isDisplayed()));
        ...
        assertFalse(
                "Adding a new account should fire at least an intent!", startedIntents.isEmpty());
