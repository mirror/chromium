...
public class ChromeHomeAppMenuTest {
    ...
    public void testPromoAppMenuHeader() throws InterruptedException, TimeoutException {
        ...
        // Load a test page and show the app menu. The header is only shown on the page menu and
        // the NTP.
        loadTestPage();
        showAppMenuAndAssertMenuShown();
    ...
    @CommandLineFlags.Add({
        "disable-field-trial-config", "disable-features=" + ChromeFeatureList.CHROME_HOME_PROMO,
