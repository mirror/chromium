...
public class TileGridLayoutTest {
    ...
    private List<SiteSuggestion> makeSuggestions(int count) {
        ...
        for (int i = 0; i < count; i++) siteSuggestions.add(makeSuggestionFromDataIndex(i));
    ...
    private SiteSuggestion makeSuggestionFromDataIndex(int dataIndex) {
        return FakeMostVisitedSites.createSiteSuggestion(FAKE_MOST_VISITED_TITLES[dataIndex],
