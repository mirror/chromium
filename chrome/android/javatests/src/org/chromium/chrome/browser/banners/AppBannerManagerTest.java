...
public class AppBannerManagerTest {
    ...
    public void testPostInstallationApiCustomTab() throws Exception {
        runWebAppBannerAndCheckInstallEvent(mCustomTabActivityTestRule, mWebAppUrl, 5);
    }
    ...
    public void testPostInstallationApi() throws Exception {
        triggerWebAppBanner(mTabbedActivityTestRule, mWebAppApiUrl, WEB_APP_TITLE, true);
