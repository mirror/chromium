...
//@Features(@Features.Register(ChromeFeatureList.DATA_REDUCTION_SITE_BREAKDOWN))
public class DataReductionStatsPreferenceTest {
    ...
    public static final String ENABLE_SITE_BREAKDOWN = "enable-features="
            + ChromeFeatureList.DATA_REDUCTION_SITE_BREAKDOWN;
    ...
    private class TestDataReductionProxySettings extends DataReductionProxySettings {
    ...
    @SmallTest
    @UiThreadTest
    @CommandLineFlags.Add(ENABLE_SITE_BREAKDOWN)
    @Feature({"DataReduction"})
