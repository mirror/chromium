...
public class BottomSheetNewTabControllerTest {
    ...
    private static class TestTabModelObserver extends EmptyTabModelObserver {
        ...
        private final CallbackHelper mPendingTabAdditionCallbackHelper = new CallbackHelper();
        ...
        public void pendingTabAdd(boolean isPendingTabAdd) {
            mPendingTabAdditionCallbackHelper.notifyCalled();
        }
    }
    ...
    @Test
    @SmallTest
    public void testNTPOverTabSwitcher_LauncherShortcuts()
        ...
        int currentPendingTabCalls =
                mIncognitoTabModelObserver.mPendingTabAdditionCallbackHelper.getCallCount();
        ThreadUtils.runOnUiThreadBlocking(new Runnable() {
            @Override
            public void run() {
        ...
        mNormalTabModelObserver.mPendingTabAdditionCallbackHelper.waitForCallback(
        ...
        // Wait for two callbacks; one when closing the normal new tab and one when opening the
        // incognito new tab.
        mIncognitoTabModelObserver.mPendingTabAdditionCallbackHelper.waitForCallback(
                currentIncognitoPendingTabCalls, 2);
