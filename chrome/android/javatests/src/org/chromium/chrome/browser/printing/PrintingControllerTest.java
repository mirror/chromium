...
public class PrintingControllerTest {
    ...
    public void testNormalPrintingFlow() throws Throwable {
        ...
        try {
            onWriteFinishedCompleted.waitForCallback("onWriteFinished callback never called.");
    ...
    public void testPrintCloseWindowBeforeStart() throws Throwable {
        ...
        ThreadUtils.runOnUiThreadBlocking(() -> {
            ...
            Assert.assertTrue("currentTab should be closed already.", !currentTab.isInitialized());
