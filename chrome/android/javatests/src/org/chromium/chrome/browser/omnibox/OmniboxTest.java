...
public class OmniboxTest {
    ...
    /**
     * Test to verify that the security icon is not present on visiting http://
     * and is present on visiting valid https:// URLs.
     */
    @Test
    @MediumTest
    public void testSecurityIcon() throws InterruptedException {
        ...
        EmbeddedTestServer httpsTestServer = new EmbeddedTestServer();
        EmbeddedTestServer.initializeAndStartHTTPSServer(httpsTestServer,
                InstrumentationRegistry.getInstrumentation().getContext(),
