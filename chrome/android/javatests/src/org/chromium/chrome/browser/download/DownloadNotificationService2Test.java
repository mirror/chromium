...
public class DownloadNotificationService2Test {
    ...
    @UiThreadTest
    @Feature({"Download"})
    public void testBasicDownloadFlowWithPendingState() {
        // Download is in-progress.
        mDownloadNotificationService.notifyDownloadProgress(ID1, "test",
                new Progress(1, 100L, OfflineItemProgressUnit.PERCENTAGE), 100L, 1L, 1L, true, true,
                false, null);
    ...
    @UiThreadTest
    @Feature({"Download"})
    public void testDownloadPendingAndCancelledWithPendingState() {
        // Download is in-progress.
        mDownloadNotificationService.notifyDownloadProgress(ID1, "test",
                new Progress(1, 100L, OfflineItemProgressUnit.PERCENTAGE), 100L, 1L, 1L, true, true,
                false, null);
    ...
    @UiThreadTest
    @Feature({"Download"})
    public void testDownloadInterruptedAndFailedWithPendingState() {
        // Download is in-progress.
        mDownloadNotificationService.notifyDownloadProgress(ID1, "test",
                new Progress(1, 100L, OfflineItemProgressUnit.PERCENTAGE), 100L, 1L, 1L, true, true,
                false, null);
