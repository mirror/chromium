...
public class ArticleSnippetsTest {
    ...
    @MediumTest
    @Feature({"ArticleSnippets", "RenderTest"})
    @CommandLineFlags.Add("enable-features=ContentSuggestionsThumbnailDominantColor")
    public void testSnippetAppearanceWithThumbnailDominantColor() throws IOException {
        ...
        renderSuggestion(shortSnippet, fullCategoryInfo,
                "short_snippet_dominant_color_"
                        + (mChromeHomeEnabled ? "chrome_home" : "non_chrome_home"));
    }
