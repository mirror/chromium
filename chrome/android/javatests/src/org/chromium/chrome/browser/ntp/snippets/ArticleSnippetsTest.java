...
public class ArticleSnippetsTest {
    ...
    @Rule
    public ExternalResource disableChromeAnimations() {
    ...
    public void setUp() throws Exception {
        ...
        ThreadUtils.runOnUiThreadBlocking(() -> {
            ...
            mSigninPromo =
                    new SignInPromo.ViewHolder(mRecyclerView, mContextMenuManager, mUiConfig);
        });
    }
    ...
    public void testDownloadSuggestion() throws IOException {
        ...
        final Bitmap thumbnail = BitmapFactory.decodeFile(downloadFilePath);
