...
public class ArticleSnippetsTest {
    ...
    private class MockUiDelegate implements SuggestionsUiDelegate {
        ...
        private final ImageFetcher mImageFetcher = new MockImageFetcher(this);
    ...
    private class MockImageFetcher extends ImageFetcher {
        public MockImageFetcher(SuggestionsUiDelegate uiDelegate) {
            super(uiDelegate, null);
        }

        @Override
        protected ThumbnailProvider getThumbnailProvider() {
            // We want the mock image fetcher to be using a mock thumbnail provider.
            // All calls inside the image fetcher use this method when they use the thumbnail
            // provider.
