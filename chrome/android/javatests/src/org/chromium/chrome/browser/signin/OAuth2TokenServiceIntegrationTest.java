...
public class OAuth2TokenServiceIntegrationTest {
    ...
    private void mapAccountNamesToIds() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(
    ...
    @MediumTest
    @Feature({"Sync"})
    public void testFireRefreshTokenAvailableNotifiesJavaObservers() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
    ...
    @MediumTest
    @Feature({"Sync"})
    public void testFireRefreshTokenRevokedNotifiesJavaObservers() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
            // Adding an observer should not lead to a callback.
            Assert.assertEquals(0, mObserver.getRevokedCallCount());
    ...
    @MediumTest
    @Feature({"Sync"})
    public void testFireRefreshTokensLoadedNotifiesJavaObservers() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
            // Adding an observer should not lead to a callback.
            Assert.assertEquals(0, mObserver.getLoadedCallCount());
    ...
    @Test
    @MediumTest
    public void testValidateAccountsNoAccountsRegisteredAndNoSignedInUser() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
            // Run test.
            mOAuth2TokenService.validateAccounts(false);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsOneAccountsRegisteredAndNoSignedInUser() throws Exception {
    ...
    @Test
    @MediumTest
    public void testValidateAccountsOneAccountsRegisteredSignedIn() throws Exception {
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsSingleAccountWithoutChanges() throws Exception {
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsSingleAccountThenAddOne() throws Exception {
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsTwoAccountsThenRemoveOne() throws Exception {
        // Add accounts.
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_2);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsTwoAccountsThenRemoveAll() throws Exception {
        // Add accounts.
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_2);
    ...
    @MediumTest
    @RetryOnFailure
    public void testValidateAccountsTwoAccountsThenRemoveAllSignOut() throws Exception {
        // Add accounts.
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_2);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsTwoAccountsRegisteredAndOneSignedIn() throws Exception {
        // Add accounts.
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_1);
        mAccountManager.addAccountHolderBlocking(TEST_ACCOUNT_HOLDER_2);
    ...
    @Test
    @MediumTest
    public void testValidateAccountsNoAccountsRegisteredButSignedIn() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
    ...
    @Test
    @MediumTest
    public void testValidateAccountsFiresEventAtTheEnd() throws Exception {
        ThreadUtils.runOnUiThreadBlocking(() -> {
            // Mark user as signed in without setting up the account.
            mChromeSigninController.setSignedInAccountName(TEST_ACCOUNT1.name);
