...
void PdfToEmfConverterFactoryImpl::CreateConverter(
  ...
  LOG(ERROR)
      << "** JAY ** UTILITY PdfToEmfConverterFactoryImpl::CreateConverter";
  ...
  LOG(ERROR) << "** JAY ** UTILITY "
                "PdfToEmfConverterFactoryImpl::CreateConverter called callback";
}

// static
void PdfToEmfConverterFactoryImpl::Create(
    mojom::PdfToEmfConverterFactoryRequest request) {
  LOG(ERROR) << "** JAY ** UTILITY PdfToEmfConverterFactoryImpl::Create";
