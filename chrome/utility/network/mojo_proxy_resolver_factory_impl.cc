...
class MojoProxyResolverFactoryImpl::Job {
 public:
  Job(MojoProxyResolverFactoryImpl* parent,
      ...
      mojo::InterfaceRequest<net::interfaces::ProxyResolver> request,
 ...
 private:
  ...
  mojo::InterfaceRequest<net::interfaces::ProxyResolver> proxy_request_;
  net::ProxyResolverV8TracingFactory* factory_;
  std::unique_ptr<net::ProxyResolverFactory::Request> request_;
  net::interfaces::ProxyResolverFactoryRequestClientPtr client_ptr_;
...
MojoProxyResolverFactoryImpl::Job::Job(
  ...
  factory_->CreateProxyResolverV8Tracing(
      ...
      std::make_unique<net::MojoProxyResolverV8TracingBindings<
          net::interfaces::ProxyResolverFactoryRequestClient>>(
          client_ptr_.get()),
...
void MojoProxyResolverFactoryImpl::Job::OnProxyResolverCreated(int error) {
  if (error == net::OK) {
    mojo::MakeStrongBinding(std::make_unique<net::MojoProxyResolverImpl>(
