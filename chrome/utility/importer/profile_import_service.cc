...
ProfileImportService::ProfileImportService() : weak_factory_(this) {}
...
void ProfileImportService::OnStart() {
  ref_factory_.reset(new service_manager::ServiceContextRefFactory(base::Bind(
      &ProfileImportService::MaybeRequestQuitDelayed, base::Unretained(this))));
...
void ProfileImportService::MaybeRequestQuitDelayed() {
  // TODO(jcivelli): is this needed?
  base::ThreadTaskRunnerHandle::Get()->PostDelayedTask(
      FROM_HERE,
      base::Bind(&ProfileImportService::MaybeRequestQuit,
                 weak_factory_.GetWeakPtr()),
      base::TimeDelta::FromSeconds(5));
}

void ProfileImportService::MaybeRequestQuit() {
  DCHECK(ref_factory_);
