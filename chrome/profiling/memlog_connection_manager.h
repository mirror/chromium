...
class MemlogConnectionManager {
 ...
 public:
  ...
  // Parameters to DumpProcessForTracing().
  struct DumpProcessForTracingArgs : public DumpArgs {
    DumpProcessForTracingArgs();
    DumpProcessForTracingArgs(DumpProcessForTracingArgs&&) noexcept;
    ~DumpProcessForTracingArgs();
  ...
  void DumpProcessForTracing(DumpProcessForTracingArgs args);
 ...
 private:
  ...
  void DoDumpProcessForTracing(DumpProcessForTracingArgs args,
                               bool success,
                               AllocationCountMap counts,
                               AllocationTracker::ContextMap context);
