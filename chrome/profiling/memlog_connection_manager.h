...
class MemlogConnectionManager {
 public:
  ...
  // flushed before the dump is executed. This is important for tests, since the
  // browser process can make allocations and send corresponding messages to the
  // profiling process faster than the profiling process can receive and parse
  // the messages.
