...
class AllocationTracker : public MemlogReceiver {
 public:
  ...
  using SnapshotCallback =
      base::OnceCallback<void(bool, AllocationCountMap, ContextMap, AddressToStringMap)>;
  ...
  void OnStringMapping(const StringMappingPacket& string_mapping_packet, std::vector<char> raw_string) override;
