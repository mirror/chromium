...
TEST(ProfilingJsonExporterTest, Metadata) {
  ...
  metadata_dict->SetString("product-version", "asdf1");
  metadata_dict->SetString("user-agent", "\"\"\"9283hfa--+,/asdf2");
  std::string metadata_json;
  base::JSONWriter::Write(*metadata_dict, &metadata_json);
  ...
  EXPECT_EQ(*metadata_dict, *metadata);
}
