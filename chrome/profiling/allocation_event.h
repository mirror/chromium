...
class AllocationEvent {
 public:
  ...
  // Implements < for AllocationEvents using address only.
  struct AddressLess
      : public std::binary_function<AllocationEvent, AllocationEvent, bool> {
...
using AllocationEventSet =
    std::set<AllocationEvent, AllocationEvent::AddressLess>;
