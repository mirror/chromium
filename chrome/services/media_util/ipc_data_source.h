...
#ifndef CHROME_SERVICES_MEDIA_UTIL_IPC_DATA_SOURCE_H_
#define CHROME_SERVICES_MEDIA_UTIL_IPC_DATA_SOURCE_H_
...
#endif  // CHROME_SERVICES_MEDIA_UTIL_IPC_DATA_SOURCE_H_
