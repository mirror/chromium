...
#ifndef CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_AUDIO_VIDEO_CHECKER_H_
#define CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_AUDIO_VIDEO_CHECKER_H_
...
#endif  // CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_AUDIO_VIDEO_CHECKER_H_
