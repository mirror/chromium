...
#ifndef CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_MEDIA_METADATA_PARSER_H_
#define CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_MEDIA_METADATA_PARSER_H_
...
#endif  // CHROME_SERVICES_MEDIA_UTIL_PUBLIC_CPP_SAFE_MEDIA_METADATA_PARSER_H_
