...
#include "chrome/services/wifi_util_win/wifi_credentials_getter_impl.h"
...
WiFiCredentialsGetterImpl::WiFiCredentialsGetterImpl(
    std::unique_ptr<service_manager::ServiceContextRef> service_ref)
    : service_ref_(std::move(service_ref)) {}

WiFiCredentialsGetterImpl::~WiFiCredentialsGetterImpl() = default;

void WiFiCredentialsGetterImpl::GetWiFiCredentials(
