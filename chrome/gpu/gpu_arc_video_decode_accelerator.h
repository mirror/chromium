...
class GpuArcVideoDecodeAccelerator
 ...
 private:
  ...
  void DecodeReqeust(ScopedBitstreamBuffer&& bitstream_buffer,
                     PendingCallback cb,
  ...
  std::set<int32_t> picture_buffer_ids_;
  ...
  std::map<int32_t, std::unique_ptr<ProtectedBufferHandle>>
      protected_output_handles_;
