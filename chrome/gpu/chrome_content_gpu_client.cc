...
void ChromeContentGpuClient::Initialize(
  ...
  registry->AddInterface(
      base::Bind(&ChromeContentGpuClient::CreateArcVideoDecodeAcceleratorNew,
                 base::Unretained(this)),
      base::ThreadTaskRunnerHandle::Get());
  registry->AddInterface(
...
void ChromeContentGpuClient::CreateArcVideoDecodeAcceleratorNew(
    ::arc::mojom::VideoDecodeAcceleratorNewRequest request) {
  mojo::MakeStrongBinding(
      base::MakeUnique<chromeos::arc::GpuArcVideoDecodeAcceleratorNew>(
          gpu_preferences_),
      std::move(request));
}
