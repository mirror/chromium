...
InitializeEnd:
  ...
  // ::arc::mojom::VideoDecodeAccelerator::Result does not have a boundary.
  // So we calculate the boundary here. If the final enum value is changed,
  // RESULT_MAX must be changed.
  const int RESULT_MAX = static_cast<int>(::arc::mojom::VideoDecodeAccelerator::
