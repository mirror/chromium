...
class IsPinnedToTaskbarHelper {
 ...
 private:
  ...
  chrome::mojom::WinShellUtilPtr win_shell_util_ptr_;
...
IsPinnedToTaskbarHelper::IsPinnedToTaskbarHelper(
  ...
  connector_->BindInterface(chrome::mojom::kChromeWinUtilServiceName,
                            &win_shell_util_ptr_);
  ...
  win_shell_util_ptr_.set_connection_error_handler(base::Bind(
      &IsPinnedToTaskbarHelper::OnConnectionError, base::Unretained(this)));
  win_shell_util_ptr_->IsPinnedToTaskbar(
