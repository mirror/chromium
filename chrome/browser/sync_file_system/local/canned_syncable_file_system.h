...
class CannedSyncableFileSystem
 ...
 public:
  using OpenFileSystemCallback = base::Callback<void(const GURL& root,
                                                     const std::string& name,
                                                     base::File::Error result)>;
  using StatusCallback = base::OnceCallback<void(base::File::Error)>;
  using WriteCallback = base::OnceCallback<void(int64_t)>;
