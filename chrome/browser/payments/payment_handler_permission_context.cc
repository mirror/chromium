...
PaymentHandlerPermissionContext::PaymentHandlerPermissionContext(Profile* profile)
...
void PaymentHandlerPermissionContext::UpdateTabContext(const PermissionRequestID& id,
