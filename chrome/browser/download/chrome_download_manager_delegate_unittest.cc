...
const SafeBrowsingTestParameters kSafeBrowsingTestCases[] = {
    ...
    {content::DOWNLOAD_DANGER_TYPE_NOT_DANGEROUS,
     DownloadFileType::NOT_DANGEROUS, safe_browsing::SAFE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_NOT_DANGEROUS,
     DownloadFileType::NOT_DANGEROUS, safe_browsing::UNKNOWN,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_NOT_DANGEROUS,
     DownloadFileType::NOT_DANGEROUS, safe_browsing::DANGEROUS,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_NOT_DANGEROUS,
     DownloadFileType::NOT_DANGEROUS, safe_browsing::UNCOMMON,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_NOT_DANGEROUS,
     DownloadFileType::NOT_DANGEROUS, safe_browsing::POTENTIALLY_UNWANTED,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::ALLOW_ON_USER_GESTURE, safe_browsing::SAFE,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::ALLOW_ON_USER_GESTURE, safe_browsing::UNKNOWN,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::ALLOW_ON_USER_GESTURE, safe_browsing::DANGEROUS,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::ALLOW_ON_USER_GESTURE, safe_browsing::UNCOMMON,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     ...
     safe_browsing::POTENTIALLY_UNWANTED,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::DANGEROUS, safe_browsing::SAFE,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::DANGEROUS, safe_browsing::UNKNOWN,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::DANGEROUS, safe_browsing::DANGEROUS,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::DANGEROUS, safe_browsing::UNCOMMON,
     DownloadPrefs::DownloadRestriction::NONE,
    ...
    {content::DOWNLOAD_DANGER_TYPE_MAYBE_DANGEROUS_CONTENT,
     DownloadFileType::DANGEROUS, safe_browsing::POTENTIALLY_UNWANTED,
     DownloadPrefs::DownloadRestriction::NONE,
...
TEST_F(ChromeDownloadManagerDelegateTestWithSafeBrowsing,
  ...
  EXPECT_CALL(*delegate(), GetDownloadProtectionService());
  EXPECT_CALL(*download_protection_service(), MockCheckClientDownload())
      .WillOnce(Return(safe_browsing::SAFE));
  EXPECT_CALL(*download_item, GetDangerType())
