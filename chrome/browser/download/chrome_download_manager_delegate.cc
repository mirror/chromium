...
ChromeDownloadManagerDelegate::ChromeDownloadManagerDelegate(Profile* profile)
    : profile_(profile),
      ...
      in_progress_cache_task_runner_(base::CreateSequencedTaskRunnerWithTraits(
  ...
  download_metadata_cache_.reset(new download::InProgressCache(
      metadata_cache_file, in_progress_cache_task_runner_));
}
...
void ChromeDownloadManagerDelegate::CheckForFileExistence(
  ...
  base::PostTaskAndReplyWithResult(
      in_progress_cache_task_runner_.get(), FROM_HERE,
