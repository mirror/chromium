...
ChromeDownloadManagerDelegate::ChromeDownloadManagerDelegate(Profile* profile)
  ...
  download_metadata_cache_->Initialize(
      base::Bind(&ChromeDownloadManagerDelegate::OnInProgressCacheInitialized,
...
download::InProgressCache* ChromeDownloadManagerDelegate::GetInProgressCache() {
  ...
  return download_metadata_cache_;
}

void ChromeDownloadManagerDelegate::OnInProgressCacheInitialized() {
  // Indicate that the in progres cache is initialized.
  download_manager_->PostInitialization(false, true);
}
