...
class ChromeDownloadManagerDelegate
 ...
 private:
  ...
  // Sets the next download id, and runs all cached id callbacks.
  ...
  // If the download database is available to persist download history and
  // provide the next download id.
