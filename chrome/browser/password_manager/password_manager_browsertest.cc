...
// Inject a password form with the specified action URL into |web_contents|.
...
// Fills in a fake password and submits a form with ID 'testform' in frame
// |frame|, waiting for the submit's navigation to finish.  |action_url| is the
// form action URL to wait for.
