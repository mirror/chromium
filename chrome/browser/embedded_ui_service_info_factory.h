...
// This standalone function works as a factory for creating
// EmbeddedServiceInfo for running the UI service as a thread.
// It is kept separated so it can be reused.
