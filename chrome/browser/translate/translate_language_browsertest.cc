...
const char kEnglishTestPath[] = FILE_PATH_LITERAL("english_page.html");
const char kFrenchTestPath[] = FILE_PATH_LITERAL("french_page.html");
...
class TranslateLanguageBrowserTest : public InProcessBrowserTest {
 ...
 protected:
  ...
  language::UrlLanguageHistogram* GetUrlLanguageHistogram() {
    ...
    return lang_client->language_histogram();
  }
