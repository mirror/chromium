...
std::string InitResourceBundleAndDetermineLocale(
  ...
  return ui::ResourceBundle::InitSharedInstanceWithLocale(
...
//
// . kInstalled: t is the initial state. Tasks are added to
//   |deferred_runner_|. In this  state this is installed as the active
...
int ChromeBrowserMainParts::PreCreateThreadsImpl() {
  ...
  // and relesae the ref to |initial_task_runner_| so that it may be destroyed.
  initial_task_runner_->AdvanceToNextState();
