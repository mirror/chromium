...
void ChromeBrowserMainParts::PostCreateThreads() {
  ...
  // base version of the function being invoked. The IO thread is firstly
  // utilized in BrowserMainLoop::InitializeMainThread(), so it is also
  // functionally okay to post this task at the very top of
  // BrowserMainLoop::InitializeMainThread().
