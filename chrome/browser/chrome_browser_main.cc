...
void ChromeBrowserMainParts::SetupFieldTrials() {
  ...
  // TODO(kmilka):  had to add this check and move FeatureList::SetInstance out
  // of VariationsSeedManager::SetupFieldTrials.
  variations::VariationsService* variations_service =
      browser_process_->variations_service();
  if (variations_service) {
    variations_service->SetupFieldTrials(field_trial_list_, feature_list,
                                         variation_ids, &browser_field_trials_);
  }
