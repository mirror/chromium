...
// The profiler object is stored in a SequenceLocalStorageSlot so that it will
// be destroyed when the IO thread stops.
...
void ChromeBrowserMainParts::StartProfilingIOThread() {
...
void ChromeBrowserMainParts::PostThreadCreate(base::Thread* thread) {
  thread->task_runner()->PostTask(
      FROM_HERE, base::BindOnce(&ChromeBrowserMainParts::StartProfilingIOThread,
