...
const struct UmaEnumCommandIdPair {
  ...
  int control_id;
    ...
    */
    ...
    // Also, add new items to RenderViewContextMenuItem enum in enums.xml.
      ...
      menu_model_.AddItem(
          ...
          GetBrowser()->is_app()
              ? l10n_util::GetStringFUTF16(
                    IDS_CONTENT_CONTEXT_OPENLINKNEWTAB_INAPP, product_name)
  ...
  if (const Extension* bookmark_app =
    ...
    if (GetBrowser()->app_name() ==
      ...
      open_link_in_app_string = l10n_util::GetStringFUTF16(
          IDS_CONTENT_CONTEXT_OPENLINKBOOKMARKAPP_SAMEAPP,
