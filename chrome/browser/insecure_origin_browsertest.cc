...
namespace {
// InsecureOriginBrowserTests differ in the setup of the browser. Since the
...
class InsecureOriginBrowserTest
...
INSTANTIATE_TEST_CASE_P(InsecureOriginBrowserTest,
                        InsecureOriginBrowserTest,
                        testing::Values(TestVariant::kNone,
                                        TestVariant::kCommandline,
                                        TestVariant::kPolicy));

IN_PROC_BROWSER_TEST_P(InsecureOriginBrowserTest, Simple) {
