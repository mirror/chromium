...
// static
background_fetch::BackgroundFetchDelegateImpl*
BackgroundFetchDelegateFactory::GetForProfile(Profile* profile) {
  return static_cast<background_fetch::BackgroundFetchDelegateImpl*>(
...
KeyedService* BackgroundFetchDelegateFactory::BuildServiceInstanceFor(
  ...
  return new background_fetch::BackgroundFetchDelegateImpl(
