...
void BackgroundFetchDelegateImpl::DownloadUrl(
  ...
  job_details.current_download_guids.push_back(download_guid);
...
void BackgroundFetchDelegateImpl::OnDownloadFailed(
  ...
  job_details.current_download_guids.erase(
      std::find(job_details.current_download_guids.begin(),
                job_details.current_download_guids.end(), download_guid));
