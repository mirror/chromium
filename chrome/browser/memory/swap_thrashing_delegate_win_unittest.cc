...
class TestSwapThrashingMonitorDelegateWin
 ...
 public:
  ...
  MockPageFaultDetectionWindow* escalation_window() {
 ...
 private:
  MockPageFaultDetectionWindow* escalation_window_;
...
void TestSwapThrashingMonitorDelegateWin::ResetEscalationWindow(
  ...
  std::unique_ptr<MockPageFaultDetectionWindow> escalation_window =
...
class SwapThrashingMonitorDelegateWinTest : public testing::Test {
 public:
  ...
  void ResetObservationWindows(bool enable_escalation_window,
    ...
    delegate_.ResetEscalationWindow(base::TimeDelta());
    mock_escalation_window_ = delegate_.escalation_window();
 ...
 protected:
  ...
  MockPageFaultDetectionWindow* mock_escalation_window_;
...
TEST_F(SwapThrashingMonitorDelegateWinTest, PageFaultDetectionWindowTests) {
  ...
  // yet.
  double average = 0;
  EXPECT_FALSE(escalation_window.AveragePageFaultRate(&average));
  ...
  EXPECT_TRUE(escalation_window.AveragePageFaultRate(&average));
