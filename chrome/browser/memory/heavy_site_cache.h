...
// This class implements a simple cache of origins with an LRU eviction policy.
// The backend is a WebsiteSetting. The class hangs off of a Profile and deletes
// entries if corresponding URLs are deleted from history.
//
// The class is designed to be used to persist and keep track of sites using an
// exorbitant amount of memory, so that Chrome can apply pre-emptive
// interventions on the site and avoid foreground OOMs for future loads.
