...
#ifndef CHROME_BROWSER_MEDIA_ACCESSIBILITY_PERMISSION_CONTEXT_H_
#define CHROME_BROWSER_MEDIA_ACCESSIBILITY_PERMISSION_CONTEXT_H_
...
#endif  // CHROME_BROWSER_MEDIA_ACCESSIBILITY_PERMISSION_CONTEXT_H_
