...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"enable-vr-shell-keyboard", flag_descriptions::kEnableVrShellKeyboardName,
     flag_descriptions::kEnableVrShellKeyboardDescription, kOsAndroid,
     FEATURE_VALUE_TYPE(features::kVrShellKeyboard)},
