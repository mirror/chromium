...
// Native client is compiled out if ENABLE_NACL is not set.
    ...
    {"enable-chrome-home-personalized-suggestions",
     flag_descriptions::kChromeHomePersonalizedSuggestionsName,
     flag_descriptions::kChromeHomePersonalizedSuggestionsDescription,
     kOsAndroid,
     FEATURE_VALUE_TYPE(chrome::android::kChromeHomePersonalizedSuggestions)},
