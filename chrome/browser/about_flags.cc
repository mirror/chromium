...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"omnibox-tab-searches", flag_descriptions::kOmniboxTabSearchesName,
     flag_descriptions::kOmniboxTabSearchesDescription, kOsDesktop,
     FEATURE_VALUE_TYPE(omnibox::kOmniboxTabSearches)},
