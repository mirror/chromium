...
// Native client is compiled out when DISABLE_NACL is defined.
    ...
    {"enable-webassembly-indexeddb",
     flag_descriptions::kEnableWasmIndexedDBName,
     flag_descriptions::kEnableWasmIndexedDBDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kWebAssemblyIndexedDB)},
