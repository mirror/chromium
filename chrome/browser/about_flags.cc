...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"omnibox-rich-entity-suggest",
     flag_descriptions::kOmniboxRichEntitySuggestName,
     flag_descriptions::kOmniboxRichEntitySuggestDescription, kOsDesktop,
     FEATURE_VALUE_TYPE(omnibox::kOmniboxRichEntitySuggest)},
