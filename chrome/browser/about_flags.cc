...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"android-payment-app-descriptions",
     flag_descriptions::kAndroidPaymentAppDescriptionsName,
     flag_descriptions::kAndroidPaymentAppDescriptionsDescription, kOsAndroid,
     FEATURE_VALUE_TYPE(chrome::android::kAndroidPaymentAppDescriptions)},
