...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"enable-autofill-credit-card-google-pay-branding",
     flag_descriptions::kEnableAutofillCreditCardGooglePayBrandingName,
     flag_descriptions::kEnableAutofillCreditCardGooglePayBrandingDescription,
     kOsAll,
     FEATURE_VALUE_TYPE(autofill::kAutofillCreditCardGooglePayBranding)},
