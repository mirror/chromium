...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"enable-fullscreen-content", flag_descriptions::kFullscreenContentName,
     flag_descriptions::kFullscreenContentDescription, kOsMac,
     FEATURE_VALUE_TYPE(features::kFullscreenContent)},
