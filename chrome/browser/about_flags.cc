...
// Native client is compiled out if ENABLE_NACL is not set.
    ...
    {"enable-service-worker-full-code-cache-install",
     flag_descriptions::kServiceWorkerFullCodeCacheInstallName,
     flag_descriptions::kServiceWorkerFullCodeCacheInstallDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kServiceWorkerFullCodeCacheInstall)},
