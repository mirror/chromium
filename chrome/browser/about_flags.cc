...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"webvr-orientation-sensor-device",
     flag_descriptions::kWebVrOrientationSensorDeviceName,
     flag_descriptions::kWebVrOrientationSensorDeviceDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kWebVrOrientationSensorDevice)},
