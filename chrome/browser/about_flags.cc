...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"stacked-tab-strip-always", flag_descriptions::kStackedTabStripAlwaysName,
     flag_descriptions::kStackedTabStripAlwaysDescription, kOsWin,
     FEATURE_VALUE_TYPE(features::kStackedTabStripAlways)},
