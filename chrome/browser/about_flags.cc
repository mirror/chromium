...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"offline-pages-pending-download",
      flag_descriptions::kOfflinePagesPendingDownloadName,
      flag_descriptions::kOfflinePagesPendingDownloadDescription, kOsAndroid,
      FEATURE_VALUE_TYPE(offline_pages::kOfflinePagesPendingDownloadFeature)},
