...
const FeatureEntry::FeatureParam kSimplifyHttpsIndicatorEVToLock[] = {
    {toolbar::features::kSimplifyHttpsIndicatorParameterName,
...
const FeatureEntry::FeatureVariation kSimplifyHttpsIndicatorVariations[] = {
    ...
    {"(show Lock icon for EV pages)", kSimplifyHttpsIndicatorEVToLock,
     arraysize(kSimplifyHttpsIndicatorEVToLock), nullptr},
