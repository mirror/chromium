...
// Native client is compiled out if ENABLE_NACL is not set.
    ...
    {"contextual-search-tap-suppression",
     flag_descriptions::kContextualSearchTapSuppressionName,
     flag_descriptions::kContextualSearchTapSuppressionDescription, kOsAndroid,
     FEATURE_VALUE_TYPE(chrome::android::kContextualSearchTapSuppression)},
#endif  // OS_ANDROID
