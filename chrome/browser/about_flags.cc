...
#if defined(OS_CHROMEOS)
    {"force-stylus-internal", flag_descriptions::kForceStylusInternalName,
     flag_descriptions::kForceStylusInternalDescription, kOsCrOS,
     SINGLE_VALUE_TYPE(ash::switches::kAshStylusIsInternal)},
#endif  // defined(OS_CHROMEOS)
