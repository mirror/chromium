...
// Native client is compiled out if ENABLE_NACL is not set.
    ...
    {"enable-client-lo-fi", flag_descriptions::kEnableClientLoFiName,
     ...
     FEATURE_WITH_PARAMS_VALUE_TYPE(
         ...
         kClientPlaceholdersForServerLoFiFeatureVariations,
         "PreviewsClientLoFi")},
    {"enable-noscript-previews", flag_descriptions::kEnableNoScriptPreviewName,
     flag_descriptions::kEnableNoScriptPreviewDescription, kOsAll,
     FEATURE_VALUE_TYPE(previews::features::kNoScriptPreview)},
