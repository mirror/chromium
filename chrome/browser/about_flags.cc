...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"omnibox-tab-search", flag_descriptions::kOmniboxTabSearchName,
     flag_descriptions::kOmniboxTabSearchDescription, kOsDesktop,
     FEATURE_VALUE_TYPE(omnibox::kOmniboxTabSearch)},
