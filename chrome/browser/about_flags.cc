...
const FeatureEntry::Choice kRecognizableTabFaviconChoices[] = {
    ...
    {flag_descriptions::kRecognizableTabFaviconFadingWeak,
     switches::kRecognizableTabFavicon,
     switches::kRecognizableTabFaviconFadingWeak},
    {flag_descriptions::kRecognizableTabFaviconFadingStrong,
     switches::kRecognizableTabFavicon,
     switches::kRecognizableTabFaviconFadingStrong},
    {flag_descriptions::kRecognizableTabFaviconScale,
     switches::kRecognizableTabFavicon,
     switches::kRecognizableTabFaviconScale},
};
#endif
