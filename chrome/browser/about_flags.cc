...
const FeatureEntry::Choice kOOPHPStackModeChoices[] = {
    {flags_ui::kGenericExperimentChoiceDisabled, "", ""},
    {flag_descriptions::kOOPHPStackModeNative,
     switches::kMemlogStackMode, switches::kMemlogStackModeNative},
    {flag_descriptions::kOOPHPStackModePseudo,
     switches::kMemlogStackMode, switches::kMemlogStackModePseudo},
    {flag_descriptions::kOOPHPStackModeMixed,
     switches::kMemlogStackMode, switches::kMemlogStackModeMixed},
};
