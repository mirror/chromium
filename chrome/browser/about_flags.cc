...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"enable-sites-exploration-ui", flag_descriptions::kSitesExplorationName,
     flag_descriptions::kSitesExplorationDescription, kOsAndroid,
     FEATURE_VALUE_TYPE(ntp_tiles::kSitesExplorationFeature)},
