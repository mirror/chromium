...
// enable-drive-search-in-chrome-launcher flag.
    ...
    {"simple-user-activation", flag_descriptions::kSimpleUserActivationName,
     flag_descriptions::kSimpleUserActivationDescription, kOsAll,
     FEATURE_VALUE_TYPE(features::kSimpleUserActivation)},
