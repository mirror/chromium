...
#define CoCreatableClassInClangFormat(className) \
  CoCreatableClassWithFactoryInClangFormat(      \
      className, mswr::SimpleClassFactory<className>)

#define CoCreatableClassWithFactoryInClangFormat(className, factory) \
  InternalWrlCreateCreatorMapInClangFormat(                          \
      className##_COM, &__uuidof(className), nullptr,                \
      mswrd::CreateClassFactory<factory>, "minATL$__f")

#define InternalWrlCreateCreatorMapInClangFormat(                      \
    className, runtimeClassName, trustLevel, creatorFunction, section) \
...
class DECLSPEC_UUID(CLSID_KEY) NotificationActivatorChromium
...
CoCreatableClassInClangFormat(NotificationActivatorChromium);
