...
// Metro and to a utility process otherwise. The utility process is used to
// isolate the Chrome browser process from potential instability caused by
// Shell extension modules loaded by ::GetOpenFileName, ::GetSaveFileName.
