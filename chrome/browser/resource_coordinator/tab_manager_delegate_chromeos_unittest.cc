...
TEST_F(TabManagerDelegateTest, SetOomScoreAdj) {
  ...
  DummyLifecycleUnit tab2(base::TimeTicks() + base::TimeDelta::FromSeconds(5),
                          11);
  tab_manager_delegate.AddLifecycleUnit(&tab2);
  DummyLifecycleUnit tab3(base::TimeTicks() + base::TimeDelta::FromSeconds(1),
                          12);
  tab_manager_delegate.AddLifecycleUnit(&tab3);
  DummyLifecycleUnit tab4(base::TimeTicks() + base::TimeDelta::FromSeconds(2),
                          12);
  tab_manager_delegate.AddLifecycleUnit(&tab4);
  DummyLifecycleUnit tab5(base::TimeTicks() + base::TimeDelta::FromSeconds(4),
                          12);
  ...
  // tab5                pid: 12
  // tab2                pid: 11
  tab_manager_delegate.AdjustOomPrioritiesImpl(lifecycle_units,
