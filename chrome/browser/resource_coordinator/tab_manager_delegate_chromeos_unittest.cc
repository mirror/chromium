...
class MockTabManagerDelegate : public TabManagerDelegate {
 ...
 protected:
  ...
  bool KillTab(const TabStats& tab_stats, DiscardCondition reason) override {
...
TEST_F(TabManagerDelegateTest, DoNotKillRecentlyKilledArcProcesses) {
  ...
  tab_manager_delegate.LowMemoryKillImpl(DiscardCondition::URGENT, tab_list,
                                         arc_processes);
...
TEST_F(TabManagerDelegateTest, KillMultipleProcesses) {
  ...
  tab_manager_delegate.LowMemoryKillImpl(DiscardCondition::PROACTIVE, tab_list,
                                         arc_processes);
