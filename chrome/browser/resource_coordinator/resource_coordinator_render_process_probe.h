...
class ResourceCoordinatorRenderProcessMetricsHandler
 ...
 public:
  ...
  ~ResourceCoordinatorRenderProcessMetricsHandler() override;
...
class ResourceCoordinatorRenderProcessProbe {
 ...
 protected:
  explicit ResourceCoordinatorRenderProcessProbe(
      std::unique_ptr<RenderProcessMetricsHandler> metrics_sender);
