...
constexpr base::TimeDelta kShortTimeDelta = base::TimeDelta::FromSeconds(1);
...
class TabManagerTest : public InProcessBrowserTest {
 public:
  TabManagerTest() : scoped_set_tick_clock_for_testing_(&test_clock_) {
    ...
    test_clock_.Advance(kShortTimeDelta);
  }
...
// Makes sure that focused tabs are protected.
