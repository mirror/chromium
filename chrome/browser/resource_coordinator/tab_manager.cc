...
TabManager::MaybeThrottleNavigation(BackgroundTabNavigationThrottle* throttle) {
  ...
  // as favicon and title can be updated accordingly. TabUIHelper is initialized
  // in TabHelpers::AttachTabHelpers. But this place could get called earlier
  // than that. So also initialize the TabUIHelper here.
