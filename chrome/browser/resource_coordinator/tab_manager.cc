...
TabManager::MaybeThrottleNavigation(BackgroundTabNavigationThrottle* throttle) {
  ...
  // user experience. We need to notify WebContents explicitly here in order
  // to promptly update the tab UI. |favicon_driver| will re-notify WebContents
  // if there is favicon available in the history service.
