...
class BrowserChildProcessWatcher : public content::BrowserChildProcessObserver {
 public:
  explicit BrowserChildProcessWatcher(
 ...
 private:
  ...
  // The |ResourceCoordinatorInterface| is owned by
  // |ChromeBrowserMainExtraPartsResourceCoordinator| which outlive this object.
  resource_coordinator::ResourceCoordinatorInterface*
