...
class TabManagerDelegate : public wm::ActivationChangeObserver,
 ...
 public:
  ...
  void LowMemoryKill(DiscardCondition reason);
 ...
 protected:
  ...
  // Virtual for unit testing.
  virtual bool KillTab(const TabStats& tab_stats, DiscardCondition reason);
 ...
 private:
  ...
  void LowMemoryKillImpl(DiscardCondition reason,
                         const TabStatsList& tab_list,
                         const std::vector<arc::ArcProcess>& arc_processes);
