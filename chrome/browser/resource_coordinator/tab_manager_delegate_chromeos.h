...
class TabManagerDelegate : public wm::ActivationChangeObserver,
 ...
 public:
  ...
  void AdjustOomPriorities(const LifecycleUnitSet& lifecycle_units);
 ...
 private:
  ...
  static std::vector<Candidate> GetSortedCandidates(
      const LifecycleUnitSet& lifecycle_units,
  ...
  void AdjustOomPrioritiesImpl(const LifecycleUnitSet& lifecycle_units,
                               std::vector<arc::ArcProcess> arc_processes);
