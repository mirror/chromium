...
class TabManagerDelegate : public wm::ActivationChangeObserver,
 ...
 public:
  ...
  void LowMemoryKill(MemoryCondition condition);
 ...
 protected:
  ...
  // Virtual for unit testing.
  virtual bool KillTab(LifetimeUnit* lifetime_unit, MemoryCondition condition);
 ...
 private:
  ...
  void LowMemoryKillImpl(MemoryCondition condition,
