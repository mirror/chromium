...
class TabManagerDelegate : public wm::ActivationChangeObserver,
 ...
 public:
  ...
  void LowMemoryKill(DiscardReason condition);
 ...
 protected:
  ...
  // Virtual for unit testing.
  virtual bool KillTab(const TabStats& tab_stats, DiscardReason condition);
 ...
 private:
  ...
  void LowMemoryKillImpl(DiscardReason condition,
                         const TabStatsList& tab_list,
                         const std::vector<arc::ArcProcess>& arc_processes);
