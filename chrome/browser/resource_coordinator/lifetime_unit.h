...
class LifetimeUnit {
 public:
  ...
  //
  // TODO(fdoray): Consider handling urgent discard with groups of LifetimeUnits
  // that live in the same process(es) and thus must be discarded together to
  // avoid accessing memory while discarding. https://crbug.com/783309
