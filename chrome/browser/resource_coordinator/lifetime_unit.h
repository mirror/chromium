...
class LifetimeUnit {
 public:
  ...
  // Returns a title describing this LifetimeUnit, or an empty string if no
  // title is available.
  virtual base::string16 GetTitle() const = 0;

  // Returns the URL of an icon for this LifetimeUnit, or an empty string if no
  // icon is available.
  ...
  // than for individual LifetimeUnits. https://crbug.com/775644
