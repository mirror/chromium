...
class TabLifecycleUnit : public LifecycleUnit, public TabLifecycleUnitExternal {
 public:
  ...
  // Sets the TabStripModel associated with this tab. The component that created
  ...
  // Sets the WebContents associated with this tab. The component that created
  // this TabLifecycleUnit is responsible for calling this when the tab's
  // WebContents changes (e.g. when the tab is discarded or when prerendered or
