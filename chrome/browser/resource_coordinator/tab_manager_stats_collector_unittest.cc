...
TEST_F(TabManagerStatsCollectorTest, HistogramsSessionOverlap) {
  histogram_tester_.ExpectTotalCount(
      TabManagerStatsCollector::kHistogramBackgroundTabOpeningSessionOverlap,
      0);
  ...
  EXPECT_THAT(histogram_tester_.GetAllSamples(
                  TabManagerStatsCollector::
                      kHistogramBackgroundTabOpeningSessionOverlap),
              ElementsAre(Bucket(0, 1)));  // non-overlapping session restore
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(2, 1)));  // non-overlapping background tab opening
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(1, 1),    // overlapping session restore
                  Bucket(2, 1),    // non-overlapping background tab opening
                  Bucket(3, 1)));  // overlapping background tab opening
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(1, 2),    // overlapping session restore
                  Bucket(2, 1),    // non-overlapping background tab opening
                  Bucket(3, 2)));  // overlapping background tab opening
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(1, 3),    // overlapping session restore
                  Bucket(2, 1),    // non-overlapping background tab opening
                  Bucket(3, 3)));  // overlapping background tab opening
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(1, 4),    // overlapping session restore
                  Bucket(2, 1),    // non-overlapping background tab opening
                  Bucket(3, 4)));  // overlapping background tab opening
  ...
  EXPECT_THAT(
      histogram_tester_.GetAllSamples(
          TabManagerStatsCollector::
              kHistogramBackgroundTabOpeningSessionOverlap),
      ElementsAre(Bucket(0, 1),    // non-overlapping session restore
                  Bucket(1, 5),    // overlapping session restore
                  Bucket(2, 1),    // non-overlapping background tab opening
                  Bucket(3, 6)));  // overlapping background tab opening
}
