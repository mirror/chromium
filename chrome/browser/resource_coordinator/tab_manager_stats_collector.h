...
class TabManagerStatsCollector : public SessionRestoreObserver {
 public:
  ...
  // Houses all of the tab count statistics gathered by TabManagerStatsCollector
  // for background tabs.
 ...
 private:
  ...
  void CreateAndInitSessionRestoreSwapMetricsDriverIfNeeded();
  void CreateAndInitBackgroundTabOpeningSwapMetricsDriverIfNeeded();
