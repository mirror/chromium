...
#ifndef CHROME_BROWSER_RESOURCE_COORDINATOR_TAB_LIFETIME_UNIT_H_
#define CHROME_BROWSER_RESOURCE_COORDINATOR_TAB_LIFETIME_UNIT_H_
...
// Represents a tab.
class TabLifetimeUnit : public LifetimeUnit {
 public:
  // Returns the TabLifetimeUnit associated with |web_contents|, or nullptr if
  // the WebContents is not associated with a tab.
  static TabLifetimeUnit* FromWebContents(content::WebContents* web_contents);
 ...
 protected:
  // Sets the TabLifetimeUnit associated with |web_contents|.
...
#endif  // CHROME_BROWSER_RESOURCE_COORDINATOR_TAB_LIFETIME_UNIT_H_
