...
DefaultBrowserIterator::DefaultBrowserIterator() = default;
DefaultBrowserIterator::~DefaultBrowserIterator() = default;

std::vector<BrowserInfo> DefaultBrowserIterator::GetBrowserInfoList() const {
...
base::Optional<BrowserInfo> DefaultBrowserIterator::GetActiveBrowserInfo()
    const {
  BrowserList* browser_list = BrowserList::GetInstance();
