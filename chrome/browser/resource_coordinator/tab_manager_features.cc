...
constexpr char kProactiveTabDiscard_LowLoadedTabCountParam[] =
    "LowLoadedTabCount";
constexpr char kProactiveTabDiscard_ModerateLoadedTabsPerGbRamParam[] =
    "ModerateLoadedTabsPerGbRam";
constexpr char kProactiveTabDiscard_HighLoadedTabCountParam[] =
    "HighLoadedTabCount";
constexpr char kProactiveTabDiscard_LowOccludedTimeoutParam[] =
    "LowOccludedTimeoutSeconds";
constexpr char kProactiveTabDiscard_ModerateOccludedTimeoutParam[] =
    "ModerateOccludedTimeoutSeconds";
constexpr char kProactiveTabDiscard_HighOccludedTimeoutParam[] =
...
constexpr uint32_t kProactiveTabDiscard_LowLoadedTabCountDefault = 4;
...
constexpr uint32_t kProactiveTabDiscard_ModerateLoadedTabsPerGbRamDefault = 3;
...
constexpr uint32_t kProactiveTabDiscard_HighLoadedTabCountDefault = 100;
// Current discarding uses 10 minutes as a minimum cap. This uses exponentially
// increasing timeouts beyond that.
constexpr base::TimeDelta kProactiveTabDiscard_LowOccludedTimeoutDefault =
    base::TimeDelta::FromHours(6);
constexpr base::TimeDelta kProactiveTabDiscard_ModerateOccludedTimeoutDefault =
    base::TimeDelta::FromHours(1);
constexpr base::TimeDelta kProactiveTabDiscard_HighOccludedTimeoutDefault =
...
void GetProactiveTabDiscardParams(ProactiveTabDiscardParams* params) {
  ...
  params->moderate_occluded_timeout =
      base::TimeDelta::FromSeconds(base::GetFieldTrialParamByFeatureAsInt(
          features::kProactiveTabDiscarding,
          kProactiveTabDiscard_ModerateLoadedTabsPerGbRamParam,
          kProactiveTabDiscard_ModerateOccludedTimeoutParam.InSeconds()));
