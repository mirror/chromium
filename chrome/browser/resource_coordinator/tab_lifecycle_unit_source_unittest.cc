...
class TabLifecycleUnitSourceTest : public ChromeRenderViewHostTestHarness {
 protected:
  ...
  // Appends 2 tabs to the tab strip. Returns the associated LifecycleUnits via
  // |first_lifecycle_unit| and |second_lifecycle_unit|. |tab_strip_is_focused|
  // indicates whether the tab strip is focused. The second tab is active in the
  // tab strip when this returns.
  void CreateTwoTabs(bool tab_strip_is_focused,
  ...
  void TestAppendTabsToTabStrip(bool tab_strip_is_focused) {
    LifecycleUnit* first_lifecycle_unit = nullptr;
    LifecycleUnit* second_lifecycle_unit = nullptr;
    CreateTwoTabs(tab_strip_is_focused, &first_lifecycle_unit,
...
TEST_F(TabLifecycleUnitSourceTest, AppendTabsToFocusedTabStrip) {
  ...
  TestAppendTabsToTabStrip(true /* tab_strip_is_focused */);
}

TEST_F(TabLifecycleUnitSourceTest, AppendTabsToNonFocusedTabStrip) {
  TestAppendTabsToTabStrip(false /* tab_strip_is_focused */);
}
...
TEST_F(TabLifecycleUnitSourceTest, SwitchTabInFocusedTabStrip) {
  ...
  LifecycleUnit* first_lifecycle_unit = nullptr;
  LifecycleUnit* second_lifecycle_unit = nullptr;
  CreateTwoTabs(true /* tab_strip_is_focused */, &first_lifecycle_unit,
                &second_lifecycle_unit);
