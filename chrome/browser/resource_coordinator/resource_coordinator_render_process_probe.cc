...
void ResourceCoordinatorRenderProcessProbe::StartGatherCycle() {
  ...
  timer_.Start(
      ...
      &ResourceCoordinatorRenderProcessProbe::RegisterAliveRenderProcesses);
}

void ResourceCoordinatorRenderProcessProbe::RegisterAliveRenderProcesses() {
  DCHECK_CURRENTLY_ON(content::BrowserThread::UI);
  ...
  content::BrowserThread::PostTask(
      ...
      base::BindOnce(
          &ResourceCoordinatorRenderProcessProbe::CollectRenderProcessMetrics,
          base::Unretained(this)));
}

void ResourceCoordinatorRenderProcessProbe::CollectRenderProcessMetrics() {
  ...
  while (iter != render_process_info_map_.end()) {
    ...
    // If the the last gather cycle the render process was marked as active is
  ...
  content::BrowserThread::PostTask(
      ...
      base::BindOnce(&ResourceCoordinatorRenderProcessProbe::
                         SendRenderProcessMetricsToResourceCoordinatorService,
                     base::Unretained(this)));
}
