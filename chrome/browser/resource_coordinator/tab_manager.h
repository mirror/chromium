...
class TabManager : public LifetimeUnitSink, public TabStripModelObserver {
 ...
 private:
  ...
  // Returns TabLifetimeUnit whose contents id matches the given
  // |tab_contents_id|.
  TabLifetimeUnit* GetTabLifetimeUnitByContentsId(
  ...
  // Discards the less important LifetimeUnit that supports discarding under
  // |condition|.
