...
class TabManager : public TabStripModelObserver,
 ...
 public:
  ...
  // extension.
  bool CanDiscardTab(const TabStats& tab_stats, DiscardReason condition) const;
  ...
  void DiscardTab(DiscardReason condition);
  ...
  content::WebContents* DiscardTabById(int32_t tab_id, DiscardReason condition);
  ...
  void LogMemoryAndDiscardTab(DiscardReason condition);
 ...
 private:
  ...
  static void PurgeMemoryAndDiscardTab(DiscardReason condition);
  ...
  content::WebContents* DiscardTabImpl(DiscardReason condition);
