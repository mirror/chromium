...
constexpr SkColor kDefaultTouchUiColorTabAlertRecordingIcon =
    SkColorSetRGB(0xC5, 0x39, 0x29);
constexpr SkColor kDefaultTouchUiColorTabAlertCapturingIcon =
...
base::Optional<SkColor> MaybeGetDefaultColorForTouchOptimizedUi(
  ...
  switch (id) {
    ...
    case ThemeProperties::COLOR_TAB_CLOSE_BUTTON_ICON_HOVER:
      return incognito ? gfx::kGoogleGrey100 : kDefaultTouchUiColorToolbar;
...
SkColor ThemeProperties::GetDefaultColor(int id, bool incognito) {
  ...
  switch (id) {
    ...
    case COLOR_TAB_ALERT_RECORDING:
      return kDefaultTouchUiColorTabAlertRecordingIcon;
    case COLOR_TAB_ALERT_CAPTURING:
      return kDefaultTouchUiColorTabAlertCapturingIcon;
#if defined(OS_MACOSX)
