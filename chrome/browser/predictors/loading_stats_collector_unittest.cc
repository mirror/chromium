...
TEST_F(LoadingStatsCollectorTest, TestPreconnectHitsMissesHistograms) {
  const std::string main_frame_url("http://google.com/?query=cats");
  auto gen = [](int index) {
  ...
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveMissesCountCached, 1, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveMissesCountNotCached, 1, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveHitsCountCached, 1, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveHitsCountNotCached, 1, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreconnectHitsCount, 1, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreconnectMissesCount, 1, 1);
}
