...
TEST_F(LoadingStatsCollectorTest, TestPreconnectHistograms) {
  ...
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveHitsPercentage, 50, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreconnectHitsPercentage, 50, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreresolveCount, 4, 1);
  histogram_tester_->ExpectUniqueSample(
      internal::kPreconnectManagerPreconnectCount, 2, 1);
}
