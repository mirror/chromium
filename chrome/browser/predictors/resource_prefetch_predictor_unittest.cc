...
TEST_F(ResourcePrefetchPredictorTest, TestPredictPreconnectOrigins) {
  ...
  const std::string script_url = "https://cdn.google.com/script";
  InitializeOriginStat(google.add_origins(), script_url + "1", 10, 0, 0, 1.0,
                       true, true);  // High confidence - preconnect.
  InitializeOriginStat(google.add_origins(), script_url + "2", 10, 5, 0, 2.0,
                       true, true);  // Medium confidence - preresolve.
  InitializeOriginStat(google.add_origins(), script_url + "3", 1, 10, 10, 3.0,
  ...
  const std::string style_url = "https://cdn.google.com/style.css";
  InitializeOriginStat(www_google.add_origins(), style_url, 10, 0, 0, 1.0, true,
  ...
  EXPECT_EQ(*prediction,
            CreatePreconnectPrediction("www.google.com", true,
                                       {GURL(style_url)}, std::vector<GURL>()));
}
