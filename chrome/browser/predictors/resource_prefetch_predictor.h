...
class ResourcePrefetchPredictor
 ...
 public:
  ...
  void SetStatsCollector(GlowplugStatsCollector* stats_collector);
 ...
 private:
  ...
  // Cleanup inflight_navigations_ and inflight_prefetches_.
  ...
  GlowplugStatsCollector* stats_collector_;
