...
void ReportPreconnectAccuracy(
  ...
  UMA_HISTOGRAM_PERCENTAGE(internal::kPreconnectManagerPreresolveHitsPercentage,
                           preresolve_hits_percentage);
  UMA_HISTOGRAM_PERCENTAGE(internal::kPreconnectManagerPreconnectHitsPercentage,
                           preconnect_hits_percentage);
  UMA_HISTOGRAM_COUNTS_100(internal::kPreconnectManagerPreresolveCount,
                           preresolve_hits_count + preresolve_misses_count);
  UMA_HISTOGRAM_COUNTS_100(internal::kPreconnectManagerPreconnectCount,
