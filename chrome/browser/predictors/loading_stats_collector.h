...
constexpr char kPreconnectManagerPreresolveHitsPercentage[] =
    "PreconnectManager.PreresolveHitsPercentage";
constexpr char kPreconnectManagerPreconnectHitsPercentage[] =
    "PreconnectManager.PreconnectHitsPercentage";
constexpr char kPreconnectManagerPreresolveCount[] =
    "PreconnectManager.PreresolveCount";
constexpr char kPreconnectManagerPreconnectCount[] =
    "PreconnectManager.PreconnectCount";
}  // namespace internal
