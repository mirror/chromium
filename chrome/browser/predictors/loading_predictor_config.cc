...
const base::Feature kSpeculativePreconnectFeature =
    base::Feature(kSpeculativePreconnectFeatureName,
                  base::FEATURE_DISABLED_BY_DEFAULT);

bool IsSpeculativePreconnectEnabled(Profile* profile,
...
bool IsLoadingPredictorEnabled(Profile* profile,
  ...
  bool resource_prefetching_enabled =
      IsSpeculativeResourcePrefetchingEnabled(profile, config);
  bool preconnect_enabled = IsSpeculativePreconnectEnabled(profile, config);
