...
class IOThread : public content::BrowserThreadDelegate {
 ...
 private:
  ...
  // The serialized NetworkContextParams. Most values can be safely sent between
  // threads without serializing them, but InterfacePtrs can not be, since
  // they're bound to a thread.
  std::vector<uint8_t> serialized_network_context_params_;
