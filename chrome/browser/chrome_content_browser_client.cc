  ...
  if (safe_browsing_service_) {
    ...
    registry->AddInterface(
        base::Bind(
            ...
            render_process_host->GetID(), base::Unretained(resource_context),
            base::Bind(
                &ChromeContentBrowserClient::GetSafeBrowsingUrlCheckerDelegate,
                base::Unretained(this), base::Unretained(resource_context))),
...
ChromeContentBrowserClient::CreateURLLoaderThrottles(
  ...
  if (network_service_enabled ||
    ...
    if (delegate && !delegate->IsRequestWhitelisted(resource_context, url)) {
