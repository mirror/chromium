...
content::BrowserMainParts* ChromeContentBrowserClient::CreateBrowserMainParts(
  ...
  // TODO(palmer): The cleaner way to do
  // `base::CommandLine::ForCurrentProcess()->AppendSwitchNative(
  // switches::kIsolateOrigins, // value);` (and kSitePerProcess) (see
  // ChromeContentBrowserClient::AppendExtraCommandLineSwitches) is to do it
  // here, either in a MainParts subclass or perhaps in
  // chrome::AddProfilesExtraParts.
...
#error Unsupported platform.
        ...
        command_line->AppendSwitchNative(switches::kIsolateOrigins, value);
        // TODO(palmer): This doesn't seem to be working in manual testing,
        // although kSitePerProcess does.
        base::CommandLine::ForCurrentProcess()->AppendSwitchNative(
            switches::kIsolateOrigins, value);
      }
