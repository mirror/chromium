...
class PermissionRequestManager
 ...
 private:
  ...
  // Prompts are only shown when a tab is showing. On switching tabs with an
  // active prompt, we destroy the prompt on desktop but not Android as the
  // infobar system handles it for us and modals prevent tab switching.
