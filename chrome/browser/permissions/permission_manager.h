...
class PermissionManager : public KeyedService,
 ...
 public:
  ...
  // origin of the local NTP gets mapped to the Google base URL instead. Or,
  // with Permission Delegation, it will transform the requesting origin into
  // the embedding origin (as with permission delegation all permission checks)
  // happen on the top leve origin.
  //
