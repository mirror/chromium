...
ContentSettingsType PermissionTypeToContentSetting(PermissionType permission) {
  switch (permission) {
    ...
    case PermissionType::CLIPBOARD_FULL:
      return CONTENT_SETTINGS_TYPE_CLIPBOARD_FULL;
...
PermissionManager::PermissionManager(Profile* profile)
  ...
  permission_contexts_[CONTENT_SETTINGS_TYPE_CLIPBOARD_FULL] =
      base::MakeUnique<ClipboardFullPermissionContext>(profile);
