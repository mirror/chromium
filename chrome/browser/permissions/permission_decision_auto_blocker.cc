...
void PermissionDecisionAutoBlocker::UpdateFromVariations() {
  ...
  auto update_value_from_variation = [](const std::string& variation_value,
                                        int* value_store,
  ...
  update_value_from_variation(dismissals_before_block_value,
                              &g_dismissals_before_block,
                              kDefaultDismissalsBeforeBlock);
  update_value_from_variation(ignores_before_block_value,
                              &g_ignores_before_block,
                              kDefaultIgnoresBeforeBlock);
  update_value_from_variation(dismissal_embargo_days_value,
                              &g_dismissal_embargo_days, kDefaultEmbargoDays);
  update_value_from_variation(ignore_embargo_days_value, &g_ignore_embargo_days,
                              kDefaultEmbargoDays);
  update_value_from_variation(blacklist_embargo_days_value,
