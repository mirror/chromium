...
class ChromeContentBrowserClient : public content::ContentBrowserClient {
 public:
  ...
  // TODO(creis, pastarmovj): This file is about calls from content/ out to
  // chrome/ to get values or notify about events, but both of these functions
  // are from chrome/ to chrome/ and don't involve content/ at all.  That
  // suggests they belong somewhere else at the chrome/ layer.
