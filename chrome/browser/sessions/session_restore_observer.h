...
class SessionRestoreObserver {
 public:
  ...
  // WillRestoreTab() gets called right after a tab is created by session
  // restore and before it is loaded by the TabLoader.
  ...
  // callback is per each tab called in OnWillRestoreTab().
