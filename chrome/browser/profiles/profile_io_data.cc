...
void ProfileIOData::Init(
  ...
  builder->set_shared_host_resolver(io_thread_globals->system_request_context
                                        .url_request_context->host_resolver());

  builder->set_shared_http_auth_handler_factory(
      io_thread_globals->system_request_context.url_request_context
  ...
  resource_context_->host_resolver_ = io_thread_globals->system_request_context
                                          .url_request_context->host_resolver();
