...
#if defined(OS_CHROMEOS)
  profile_params_->policy_cert_verifier_ =
...
void ProfileIOData::Init(
  ...
  if (g_cert_verifier_for_testing) {
    ...
    if (profile_params_->policy_cert_verifier_) {
      profile_params_->policy_cert_verifier_->InitializeOnIOThread(verify_proc);
      cert_verifier = std::move(profile_params_->policy_cert_verifier_);
    } else {
