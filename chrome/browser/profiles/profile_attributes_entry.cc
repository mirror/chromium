...
void ProfileAttributesEntry::SetString(const char* key, std::string value) {
...
void ProfileAttributesEntry::SetString16(const char* key,
                                         base::string16 value) {
  const base::Value* old_data = GetEntryData();
  base::Value new_data = old_data ? base::Value(*GetEntryData())
                                  : base::Value(base::Value::Type::DICTIONARY);
...
void ProfileAttributesEntry::SetDouble(const char* key, double value) {
  const base::Value* old_data = GetEntryData();
  base::Value new_data = old_data ? base::Value(*GetEntryData())
                                  : base::Value(base::Value::Type::DICTIONARY);
  new_data.SetKey(key, base::Value(value));
...
void ProfileAttributesEntry::SetBool(const char* key, bool value) {
  const base::Value* old_data = GetEntryData();
  base::Value new_data = old_data ? base::Value(*GetEntryData())
                                  : base::Value(base::Value::Type::DICTIONARY);
  new_data.SetKey(key, base::Value(value));
