 ...
 protected:
  ...
  void PostValidateShortcut(
    ...
    base::CreateCOMSTATaskRunnerWithTraits({})->PostTask(
        FROM_HERE, base::Bind(&base::win::ValidateShortcut, shortcut_path,
                              expected_properties));
    RunTasksUntilIdle();
  }
  ...
  void ValidateProfileShortcutAtPath(const tracked_objects::Location& location,
    ...
    PostValidateShortcut(shortcut_path, expected_properties);
  }
  ...
  void PostCreateOrUpdateShortcut(
    ...
    base::PostTaskAndReplyWithResult(
        ...
        base::Bind(&CreateOrUpdateShortcutCallback));
    RunTasksUntilIdle();
  }

  static void CreateOrUpdateShortcutCallback(bool succeeded) {
