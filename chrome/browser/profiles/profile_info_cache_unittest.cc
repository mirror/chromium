...
TEST_F(ProfileInfoCacheTest, GetGaiaImageForAvatarMenu) {
  ...
  // A default avatar is used instead.
  EXPECT_EQ(AvatarMenu::ImageLoadStatus::USE_DEFAULT_AS_GAIA_LOADING,
  ...
  EXPECT_EQ(AvatarMenu::ImageLoadStatus::SUCCESS_LOAD_GAIA,
            AvatarMenu::GetImageForMenuButton(profile_path, &image_loaded));
