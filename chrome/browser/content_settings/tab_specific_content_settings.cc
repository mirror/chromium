...
void SetAsInterstitial(content::RenderFrameHost* frame) {
  chrome::mojom::InterstitialPagePtr interstitial_page;
  frame->GetRemoteInterfaces()->GetInterface(
      mojo::MakeRequest(&interstitial_page));
...
void TabSpecificContentSettings::RenderFrameForInterstitialPageCreated(
  ...
  // page.
  web_contents()->ForEachFrame(base::Bind(&::SetAsInterstitial));
}
