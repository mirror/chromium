...
class PolicyRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
  ...
  def SetRepeatedField(self, group_message, field, field_value):
    ...
    if field.message_type is None:
      ...
      for sub_value in field_value:
        ...
        if sub_value in [sub_field.name
  ...
  def SetMessageField(self, group_message, field, field_value):
  ...
  def SetField(self, group_message, field, field_value):
  ...
  def SetProtobufMessageField(self, group_message, field, field_value):
    ...
    if field.label == field.LABEL_REPEATED:
      SetRepeatedField(group_message, field, field_value)
    elif field.type == field.TYPE_MESSAGE:
      SetMessageField(group_message, field, field_value)
    elif not SetField(group_message, field, field_value):
