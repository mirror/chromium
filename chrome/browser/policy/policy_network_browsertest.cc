...
bool IsQuicEnabled(network::mojom::NetworkContext* network_context) {
  GURL url = GURL(std::string("https://") +
                  net::QuicSimpletTestServer::kTestServerHost + ":" +
                  base::NumberToString(net::QuicSimpletTestServer::GetPort()) +
                  net::QuicSimpletTestServer::kHelloPath);
...
class QuicTestBase : public InProcessBrowserTest {
 public:
  ...
  void SetUpOnMainThread() override {
    ...
    net::QuicSimpletTestServer::Start();
