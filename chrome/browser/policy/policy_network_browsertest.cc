...
bool IsQuicEnabled(network::mojom::NetworkContext* network_context) {
  //GURL url = GURL(net::QuicSimpleTestServer::simple_url());
  GURL url = GURL(std::string("https://") +
                  net::QuicSimpleTestServer::host() + ":" +
                  base::NumberToString(net::QuicSimpleTestServer::GetPort()) +
                  net::QuicSimpleTestServer::hello_path());
