...
IN_PROC_BROWSER_TEST_F(PolicyTest, PasswordProtectionWarningTrigger) {
  // Without setting up the enterprise policy, value should be 0 (a.k.a
  // PASSWORD_PROTECTION_OFF).
  const PrefService* const prefs = browser()->profile()->GetPrefs();
  safe_browsing::ChromePasswordProtectionService* service =
      safe_browsing::ChromePasswordProtectionService::
          GetPasswordProtectionService(browser()->profile());
  EXPECT_EQ(0, prefs->GetInteger(prefs::kPasswordProtectionWarningTrigger));
  ...
  UpdateProviderPolicy(policies);
  EXPECT_EQ(1, prefs->GetInteger(prefs::kPasswordProtectionWarningTrigger));
  ...
  UpdateProviderPolicy(policies);
  EXPECT_EQ(2, prefs->GetInteger(prefs::kPasswordProtectionWarningTrigger));
...
IN_PROC_BROWSER_TEST_F(PolicyTest, PasswordProtectionRiskTrigger) {
  ...
  safe_browsing::ChromePasswordProtectionService* service =
      safe_browsing::ChromePasswordProtectionService::
          GetPasswordProtectionService(browser()->profile());
  EXPECT_EQ(0, prefs->GetInteger(prefs::kPasswordProtectionRiskTrigger));
  EXPECT_EQ(safe_browsing::PASSWORD_PROTECTION_OFF,
            service->GetPasswordProtectionRiskTriggerPref());
  ...
  policies.Set(key::kPasswordProtectionRiskTrigger, POLICY_LEVEL_MANDATORY,
               ...
               base::WrapUnique(new base::Value(1)), nullptr);
  UpdateProviderPolicy(policies);
  EXPECT_EQ(1, prefs->GetInteger(prefs::kPasswordProtectionRiskTrigger));
  EXPECT_EQ(safe_browsing::PASSWORD_REUSE,
            service->GetPasswordProtectionRiskTriggerPref());
  ...
  policies.Set(key::kPasswordProtectionRiskTrigger, POLICY_LEVEL_MANDATORY,
               ...
               base::WrapUnique(new base::Value(2)), nullptr);
  UpdateProviderPolicy(policies);
  EXPECT_EQ(2, prefs->GetInteger(prefs::kPasswordProtectionRiskTrigger));
  EXPECT_EQ(safe_browsing::PHISHING_REUSE,
            service->GetPasswordProtectionRiskTriggerPref());
}
