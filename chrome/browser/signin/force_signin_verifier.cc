...
const char kForceSigninVerificationMetricsName[] = "Signin.ForceSigninVerification";
...
ForceSigninVerifier::ForceSigninVerifier(Profile* profile)
  ...
  UMA_HISTOGRAM_BOOLEAN(kForceSigninVerificationMetricsName, ShouldSendRequest());
  SendRequest();
}
