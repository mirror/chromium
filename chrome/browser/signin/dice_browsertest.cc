...
class DiceBrowserTest : public InProcessBrowserTest,
 ...
 protected:
  ...
  void SetUpOnMainThread() override {
    ...
    scoped_dice_ = base::MakeUnique<signin::ScopedAccountConsistency>(
        signin::AccountConsistencyMethod::kDice, false);
  ...
  std::unique_ptr<signin::ScopedAccountConsistency> scoped_dice_;
