...
class DiceBrowserTest : public InProcessBrowserTest,
 ...
 protected:
  ...
  void SetUpOnMainThread() override {
    ...
    scoped_dice_ = base::MakeUnique<ScopedAccountConsistency>(
        switches::AccountConsistencyMethod::kDice, false);
  ...
  std::unique_ptr<ScopedAccountConsistency> scoped_dice_;
