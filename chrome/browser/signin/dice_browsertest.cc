...
class DiceBrowserTestBase : public InProcessBrowserTest,
 ...
 protected:
  ...
  void OnEnableSyncRequest(base::OnceClosure unblock_response_closure) {
    ...
    unblock_enable_sync_response_ = std::move(unblock_response_closure);
  }
  ...
  void OnTokenExchangeRequest(base::OnceClosure unblock_response_closure) {
    ...
    unblock_token_exchange_response_ = std::move(unblock_response_closure);
  }
  ...
  void UnblockAndWaitEnableSyncRequest() {
    if (!enable_sync_requested_)
      WaitForClosure(&enable_sync_requested_quit_closure_);
    DCHECK(unblock_enable_sync_response_);
    std::move(unblock_enable_sync_response_).Run();
  }
  ...
  void UnblockAndWaitToken() {
    ...
    DCHECK(unblock_token_exchange_response_);
    std::move(unblock_token_exchange_response_).Run();
  ...
  base::OnceClosure unblock_token_exchange_response_;
  base::OnceClosure unblock_enable_sync_response_;
...
IN_PROC_BROWSER_TEST_F(DicePrepareMigrationChromeSynEndpointBrowserTest,
  ...
  // Receive ENABLE_SYNC.
  UnblockAndWaitEnableSyncRequest();
