...
KeyedService* AccountReconcilorFactory::BuildServiceInstanceFor(
  ...
  SetupAccountReconcilorDelegate(reconcilor, profile);
...
// static
void AccountReconcilorFactory::SetupAccountReconcilorDelegate(
  ...
  switch (signin::GetAccountConsistencyMethod()) {
    ...
    case signin::AccountConsistencyMethod::kMirror:
      delegate = std::make_unique<signin::MirrorAccountReconcilorDelegate>(
          reconcilor, SigninManagerFactory::GetForProfile(profile));
      break;
  ...
  reconcilor->SetDelegate(std::move(delegate));
}
