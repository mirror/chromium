...
const char kGaiaUrl[] = "https://accounts.google.com";
...
IN_PROC_BROWSER_TEST_F(ChromeSigninHelperTest,
  ...
  ASSERT_TRUE(prefs->GetBoolean(prefs::kAccountConsistencyRequired));
...
IN_PROC_BROWSER_TEST_F(ChromeSigninHelperTest,
  ...
  PrefService* prefs = profile->GetPrefs();
  ASSERT_FALSE(prefs->GetBoolean(prefs::kAccountConsistencyRequired));
