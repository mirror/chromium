...
TEST_F(ForceSigninVerifierTest, OnGetTokenSuccess) {
  ...
  histogram_tester_.ExpectBucketCount(kForceSigninVerificationMetricsName, 0, 1);
  histogram_tester_.ExpectTotalCount(kForceSigninVerificationSuccessTimeMetricsName, 1);
  histogram_tester_.ExpectTotalCount(kForceSigninVerificationFailureTimeMetricsName, 0);
}
...
TEST_F(ForceSigninVerifierTest, OnGetTokenPersistentFailure) {
  ...
  ASSERT_EQ(0, verifier_->FailureCount());
  histogram_tester_.ExpectBucketCount(kForceSigninVerificationMetricsName, 0, 1);
  histogram_tester_.ExpectTotalCount(kForceSigninVerificationSuccessTimeMetricsName, 0);
  histogram_tester_.ExpectTotalCount(kForceSigninVerificationFailureTimeMetricsName, 1);
}
