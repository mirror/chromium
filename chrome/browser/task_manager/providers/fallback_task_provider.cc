...
void FallbackTaskProvider::StartUpdating() {
  ...
  task_providers_[0]->SetObserver(
      new FallbackTaskProvider::FallbackHelperObserver(this,
                                                       &primary_subprovider_));
  task_providers_[1]->SetObserver(
      new FallbackTaskProvider::FallbackHelperObserver(
