...
class WebContentsEntry : public content::WebContentsObserver {
 ...
 private:
  ...
  // Notify our observer that a task was added, removed, or replaced. An "Added"
  // or "Removed" event occurs if one of |old_task| and |new_task| is null. If
  // both are non-null, a "Replaced" event occurs.
