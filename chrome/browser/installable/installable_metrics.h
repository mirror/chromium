...
class InstallableMetrics {
 public:
  ...
  // Returns the appropriate WebappInstallSource for |web_contents| based on
  // whether the prompt was automatically triggered or not.
  static WebappInstallSource GetPromptInstallSource(
      content::WebContents* web_contents,
      bool is_api);

  // Returns the appropriate WebappInstallSource for |web_contents| when
  // triggered by the menu item.
  static WebappInstallSource GetMenuInstallSource(
      content::WebContents* web_contents);
