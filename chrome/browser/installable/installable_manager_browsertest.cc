...
class InstallableManagerBrowserTest : public InProcessBrowserTest {
 public:
  ...
  InstallabilityCheckStatus GetStatus() {
    return GetManager()->metrics_.GetStatusForTesting();
  }
};
...
IN_PROC_BROWSER_TEST_F(InstallableManagerBrowserTest,
  ...
  EXPECT_EQ(nullptr, tester->badge_icon());
  EXPECT_EQ(NO_ERROR_DETECTED, tester->error_code());
  EXPECT_EQ(InstallabilityCheckStatus::COMPLETE_PROGRESSIVE_WEB_APP,
            manager->metrics_.GetStatusForTesting());
...
IN_PROC_BROWSER_TEST_F(InstallableManagerBrowserTest,
  ...
  EXPECT_EQ(InstallabilityCheckStatus::COMPLETE_NON_PROGRESSIVE_WEB_APP,
            manager->metrics_.GetStatusForTesting());
}
