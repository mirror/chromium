...
class InstallableManager
 ...
 public:
  ...
  // Returns the minimum platform-specific  icon size in pixels for a site to be
  // installable.
 ...
 private:
  ...
  // The ideal primary icon size to fetch.
  int ideal_primary_icon_size_in_px_;

  // The minimum primary icon size to fetch.
  int minimum_primary_icon_size_in_px_;

  // The ideal badge icon size to fetch.
  int ideal_badge_icon_size_in_px_;
