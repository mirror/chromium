...
class FakeExternalProtocolHandlerDelegate
 ...
 public:
  ...
  std::string launch_or_prompt_url() { return launch_or_prompt_url_.spec(); }
...
TEST_F(ExternalProtocolHandlerTest, TestUrlEscape) {
  ...
  GURL url = MakeNonCanonicalGURL("mailto:test@test.com\" --bad 文本 \"file");
  DoTest(ExternalProtocolHandler::UNKNOWN, shell_integration::NOT_DEFAULT,
         Action::PROMPT, url);
  EXPECT_EQ("mailto:test@test.com%22%20--bad%20%E6%96%87%E6%9C%AC%20%22file",
