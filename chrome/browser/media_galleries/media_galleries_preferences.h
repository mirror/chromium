...
class MediaGalleriesPreferences
 ...
 private:
  ...
  // This is a hack - Some devices (Picasa) are singletons in that only
  // one instance of that type is supported at a time. As such, the device id
  // should just be ""picasa:" but that would mean finding the
  ...
  // Handle a Picasa finder returning a device ID to us.
