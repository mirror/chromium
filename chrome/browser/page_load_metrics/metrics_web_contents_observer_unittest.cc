...
class TestPageLoadMetricsObserver : public PageLoadMetricsObserver {
 public:
  TestPageLoadMetricsObserver(
      ...
      std::list<ExtraRequestCompleteInfo>* loaded_resources,
  ...
  void OnLoadedResource(
    ...
    loaded_resources_->emplace_back(
        extra_request_complete_info.url,
        extra_request_complete_info.host_port_pair,
        extra_request_complete_info.frame_tree_node_id,
        extra_request_complete_info.was_cached,
        extra_request_complete_info.raw_body_bytes,
        extra_request_complete_info.original_network_content_length,
        extra_request_complete_info.data_reduction_proxy_data
            ? extra_request_complete_info.data_reduction_proxy_data->DeepCopy()
            : nullptr,
        extra_request_complete_info.resource_type,
        extra_request_complete_info.net_error);
  }
 ...
 private:
  ...
  std::list<ExtraRequestCompleteInfo>* const loaded_resources_;
...
class TestPageLoadMetricsEmbedderInterface
 ...
 public:
  ...
  const std::list<ExtraRequestCompleteInfo>& loaded_resources() const {
 ...
 private:
  ...
  std::list<ExtraRequestCompleteInfo> loaded_resources_;
...
TEST_F(MetricsWebContentsObserverTest, OnLoadedResourceMainFrame) {
  ...
  observer()->OnRequestComplete(
      main_resource_url, net::HostPortPair(),
      web_contents()->GetMainFrame()->GetFrameTreeNodeId(), request_id,
