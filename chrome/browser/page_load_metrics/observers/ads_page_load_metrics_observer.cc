...
const int64_t kMaxDesktopFrameSizeBytes = 500 * 1024;
const int64_t kMaxMobileFrameSizeBytes = 300 * 1024;
...
void AdsPageLoadMetricsObserver::OnDidFinishSubFrameNavigation(
  ...
  if (ad_types.test(AD_TYPE_GOOGLE)) {
    ...
    if (render_frame_host) {
      ...
      render_frame_host->SetSizePolicy(
          net::NetworkChangeNotifier::IsConnectionCellular(
              ...
              ? kMaxMobileFrameSizeBytes
              : kMaxDesktopFrameSizeBytes);
    }
  }
