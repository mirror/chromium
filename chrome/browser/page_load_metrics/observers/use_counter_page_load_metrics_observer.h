...
class UseCounterPageLoadMetricsObserver
 ...
 public:
  ...
  void OnFeatureUsageObserved(const std::vector<blink::WebFeature>&) override;

 private:
  static const int kNumberOfFeatures =
      static_cast<int>(blink::WebFeature::kNumberOfFeatures);
  void RecordMeasurement(base::Histogram::Sample);
