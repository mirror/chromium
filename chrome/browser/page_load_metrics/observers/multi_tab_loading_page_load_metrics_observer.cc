...
const char kHistogramMultiTabLoadingAlreadyLoadingTabCount[] =
    "PageLoad.Clients.MultiTabLoading.AlreadyLoadingTabCount";
...
MultiTabLoadingPageLoadMetricsObserver::OnStart(
  ...
  int num_loading_tabs = NumberOfAlreadyLoadingTabs(navigation_handle);
  UMA_HISTOGRAM_COUNTS_100(
      internal::kHistogramMultiTabLoadingAlreadyLoadingTabCount,
      num_loading_tabs);
  return num_loading_tabs > 0 ? CONTINUE_OBSERVING : STOP_OBSERVING;
}
...
int MultiTabLoadingPageLoadMetricsObserver::NumberOfAlreadyLoadingTabs(
    content::NavigationHandle* navigation_handle) {
