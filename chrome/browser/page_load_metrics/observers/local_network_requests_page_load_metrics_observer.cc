...
static const std::map<uint16_t, internal::PortType>& localhost_port_categories =
    *new std::map<uint16_t, internal::PortType>{
        {80, internal::PORT_TYPE_WEB},    {8000, internal::PORT_TYPE_WEB},
        {8008, internal::PORT_TYPE_WEB},  {8080, internal::PORT_TYPE_WEB},
        {8081, internal::PORT_TYPE_WEB},  {8088, internal::PORT_TYPE_WEB},
        {8181, internal::PORT_TYPE_WEB},  {8888, internal::PORT_TYPE_WEB},
        {443, internal::PORT_TYPE_WEB},   {3306, internal::PORT_TYPE_DB},
        {5432, internal::PORT_TYPE_DB},   {27017, internal::PORT_TYPE_DB},
        {27018, internal::PORT_TYPE_DB},  {27019, internal::PORT_TYPE_DB},
...
LocalNetworkRequestsPageLoadMetricsObserver::OnCommit(
  ...
  // for our purposes.
  return (page_load_type_ == internal::DOMAIN_TYPE_LOCALHOST)
             ? STOP_OBSERVING
             : CONTINUE_OBSERVING;
}
...
void LocalNetworkRequestsPageLoadMetricsObserver::RecordHistograms() {
  ...
  // the page load.
  if (page_load_type_ == internal::DOMAIN_TYPE_PUBLIC) {
    UMA_HISTOGRAM_COUNTS_1000(
        internal::kNonlocalhostHistogramNames.at(internal::DOMAIN_TYPE_PUBLIC)
            .at(internal::RESOURCE_TYPE_PRIVATE)
            .at(true),
        counts[internal::kNonlocalhostHistogramNames
    ...
    UMA_HISTOGRAM_COUNTS_1000(
        ...
        counts[internal::kNonlocalhostHistogramNames
                   ...
                   .at(false)]);
    UMA_HISTOGRAM_COUNTS_1000(
        internal::kLocalhostHistogramNames.at(internal::DOMAIN_TYPE_PUBLIC)
            .at(internal::PORT_TYPE_WEB)
            .at(true),
        counts[internal::kLocalhostHistogramNames
                   .at(internal::DOMAIN_TYPE_PUBLIC)
                   .at(internal::PORT_TYPE_WEB)
                   .at(true)]);
    UMA_HISTOGRAM_COUNTS_1000(
    ...
    UMA_HISTOGRAM_COUNTS_1000(
        internal::kNonlocalhostHistogramNames.at(internal::DOMAIN_TYPE_PRIVATE)
    ...
    UMA_HISTOGRAM_COUNTS_1000(
        ...
        counts[internal::kNonlocalhostHistogramNames
                   ...
                   .at(false)]);
    UMA_HISTOGRAM_COUNTS_1000(
        internal::kLocalhostHistogramNames.at(internal::DOMAIN_TYPE_PRIVATE)
            .at(internal::PORT_TYPE_WEB)
            .at(true),
        counts[internal::kLocalhostHistogramNames
                   .at(internal::DOMAIN_TYPE_PRIVATE)
...
LocalNetworkRequestsPageLoadMetricsObserver::DetermineResourceType(
  ...
  if (page_load_type_ == internal::DOMAIN_TYPE_PUBLIC) {
    ...
    if (IsLikelyRouterIP(resource_ip)) {
      return internal::RESOURCE_TYPE_ROUTER;
    } else {
      return internal::RESOURCE_TYPE_PRIVATE;
    }
  } else {
    if (resource_ip.IsReserved()) {  // PRIVATE
      if (net::CommonPrefixLength(page_ip_address_, resource_ip) >=
          page_ip_prefix_length_) {
        return internal::RESOURCE_TYPE_LOCAL_SAME_SUBNET;
      }
      return internal::RESOURCE_TYPE_LOCAL_DIFF_SUBNET;
    } else {  // PUBLIC
      return internal::RESOURCE_TYPE_PUBLIC;
    }
  }
}
