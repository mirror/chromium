...
static const std::map<uint16_t, PortType>& localhost_port_categories =
    *new std::map<uint16_t, PortType>{
        ...
        {8181, PortType::PORT_TYPE_WEB},  {8888, PortType::PORT_TYPE_WEB},
        ...
        {427, PortType::PORT_TYPE_PRINT}, {515, PortType::PORT_TYPE_PRINT},
        {631, PortType::PORT_TYPE_PRINT}, {9100, PortType::PORT_TYPE_PRINT},
        {3000, PortType::PORT_TYPE_DEV},  {5000, PortType::PORT_TYPE_DEV},
