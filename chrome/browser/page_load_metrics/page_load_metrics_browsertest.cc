...
IN_PROC_BROWSER_TEST_F(PageLoadMetricsBrowserTest, NewPage) {
  ...
  histogram_tester_.ExpectTotalCount(internal::kPageLoadHistogramTotalBytes, 1);
  histogram_tester_.ExpectTotalCount(
...
IN_PROC_BROWSER_TEST_F(PageLoadMetricsBrowserTest, PayloadSize) {
  ...
  histogram_tester_.ExpectBucketCount(internal::kPageLoadHistogramTotalBytes,
                                      10, 1);
}
...
IN_PROC_BROWSER_TEST_F(PageLoadMetricsBrowserTest,
  ...
  histogram_tester_.ExpectUniqueSample(internal::kPageLoadHistogramTotalBytes,
                                       0, 1);
}
