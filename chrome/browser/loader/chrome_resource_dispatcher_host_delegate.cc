...
ChromeResourceDispatcherHostDelegate::DetermineCommittedPreviews(
  ...
  previews_state =
      previews::DetermineCommittedClientPreviewsState(*request, previews_state);
