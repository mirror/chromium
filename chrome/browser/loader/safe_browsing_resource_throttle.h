...
// SafeBrowsingParallelResourceThrottle instace if
// --enable-features=SafeBrowsingParallelUrlCheck is specified; returns
// a SafeBrowsingResourceThrottle otherwise.
//
// It could return nullptr if URL checking is not supported no this
// build+device.
...
// request or following redirects, no matter on mobile or desktop. It any of the
