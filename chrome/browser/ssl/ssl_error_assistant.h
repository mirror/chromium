...
class SSLErrorAssistant {
 public:
  ...
  // UrgentInterstials is loaded on the first use.
 ...
 private:
  ...
  // Data about urgent interstitials pulled from the SSLErrorAssistant proto.
  // Null until MatchUrgentInterstitial() is called.
