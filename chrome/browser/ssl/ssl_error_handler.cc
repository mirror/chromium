...
ConfigSingleton::ConfigSingleton()
    : interstitial_delay_(
      ...
      is_enterprise_managed_for_testing_(FLAG_NOT_SET) {}
...
void ConfigSingleton::SetEnterpriseManagedForTesting(bool enterprise_managed) {
  if (enterprise_managed) {
    is_enterprise_managed_for_testing_ = ENTERPRISE_MANAGED;
  } else {
    is_enterprise_managed_for_testing_ = NOT_ENTERPRISE_MANAGED;
  }
}

bool ConfigSingleton::IsEnterpriseManagedFlagSetForTesting() const {
#if !defined(OS_IOS)
  if (is_enterprise_managed_for_testing_ == FLAG_NOT_SET) {
    return false;
  }
  return true;
#endif
...
bool ConfigSingleton::IsEnterpriseManaged() const {
  ...
  if (is_enterprise_managed_for_testing_ == ENTERPRISE_MANAGED) {
    return true;
  }
  if (is_enterprise_managed_for_testing_ == NOT_ENTERPRISE_MANAGED) {
    return false;
  }
