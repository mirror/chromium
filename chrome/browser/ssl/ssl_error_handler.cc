...
class ConfigSingleton {
 ...
 private:
  ...
  bool is_enterprise_managed_for_testing_;
#endif
...
ConfigSingleton::ConfigSingleton()
    : interstitial_delay_(
      ...
      is_enterprise_managed_for_testing_(false) {}
...
void ConfigSingleton::SetEnterpriseManagedForTesting() {
  is_enterprise_managed_for_testing_ = true;
}

bool ConfigSingleton::IsEnterpriseManaged() const {
#if !defined(OS_IOS)
  if (is_enterprise_managed_for_testing_) {
    return true;
  }
...
// static
bool SSLErrorHandler::IsEnterpriseManagedForTesting() {
