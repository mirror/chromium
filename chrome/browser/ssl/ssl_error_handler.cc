...
bool ConfigSingleton::ShouldDisplayCaptivePortalInterstitial(
    const net::SSLInfo& ssl_info,
    bool only_error_is_name_mismatch) {
  return ssl_error_assistant_->ShouldDisplayCaptivePortalInterstitial(
      ssl_info, only_error_is_name_mismatch);
}
...
void SSLErrorHandler::StartHandlingError() {
  ...
  if (g_config.Pointer()->ShouldDisplayCaptivePortalInterstitial(
          ssl_info_, only_error_is_name_mismatch)) {
