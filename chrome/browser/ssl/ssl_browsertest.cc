...
class SSLUITestBase : public InProcessBrowserTest {
 public:
  ...
  // Helper functions that checks that after proceeding through an interstitial,
  // the app window should be closed, and a new tab should be opened with the
  // app URL and there should no longer be an interstitial.
  void ProceedThroughInterstitialInAppAndCheckNewTabOpened(
    ...
    EXPECT_FALSE(new_tab->GetInterstitialPage());
