...
void InsecureSensitiveInputDriver::BindSensitiveInputEventServiceRequest(
    blink::mojom::SensitiveInputEventServiceRequest request) {
  sensitive_input_event_bindings_.AddBinding(this, std::move(request));
}
...
void InsecureSensitiveInputDriver::FieldEditedInInsecureContext() {
  ...
  input_events->set_insecure_field_edited(true);
