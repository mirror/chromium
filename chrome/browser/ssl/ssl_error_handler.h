...
class SSLErrorHandler : public content::WebContentsUserData<SSLErrorHandler>,
 ...
 public:
  ...
  enum UMAEvent {
    ...
    SHOW_TLS_INTERCEPTION_INTERSTITIAL = 11,
    TLS_INTERCEPTION_CERT_FOUND = 12,
  ...
  class Delegate {
   public:
    ...
    virtual void ShowTLSInterceptionInterstitial() = 0;
 ...
 private:
  ...
  void ShowTLSInterceptionInterstitial();
  ...
  bool IsOnlyCertError(const net::CertStatus cert_status);
