...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestHTTP) {
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted,
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, GoBackToMixedContent) {
  ASSERT_TRUE(embedded_test_server()->Start());
  ASSERT_TRUE(https_server_.Start());
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestOKHTTPS) {
  ASSERT_TRUE(https_server_.Start());
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestHTTPSOCSPOk) {
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestHTTPSOCSPRevoked) {
  EnableRevocationChecking();
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, MarkFileAsNonSecure) {
...
// MarkNonSecureAs Dangerous flag is enabled.
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, MarkAboutAsNonSecure) {
  base::test::ScopedCommandLine scoped_command_line;
  scoped_command_line.GetProcessCommandLine()->AppendSwitchASCII(
      security_state::switches::kMarkHttpAs,
      security_state::switches::kMarkHttpAsDangerous);
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, MarkDataAsNonSecure) {
  content::WebContents* contents =
      browser()->tab_strip_model()->GetActiveWebContents();
  ASSERT_TRUE(contents);
...
// MarkNonSecureAs Dangerous flag is enabled.
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, MarkHTTPAsDangerous) {
  base::test::ScopedCommandLine scoped_command_line;
  scoped_command_line.GetProcessCommandLine()->AppendSwitchASCII(
      security_state::switches::kMarkHttpAs,
      security_state::switches::kMarkHttpAsDangerous);
...
// MarkNonSecureAs Dangerous flag is enabled.
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, MarkBlobAsNonSecure) {
  base::test::ScopedCommandLine scoped_command_line;
  scoped_command_line.GetProcessCommandLine()->AppendSwitchASCII(
      security_state::switches::kMarkHttpAs,
      security_state::switches::kMarkHttpAsDangerous);
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestUnsafeContents) {
  ASSERT_TRUE(https_server_.Start());
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, TestConnectToBadPort) {
...
IN_PROC_BROWSER_TEST_F(SSLUITestCommitted, ProceedLinkOverridable) {
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, RestoreHasSSLState) {
  ASSERT_TRUE(https_server_.Start());
  GURL url(https_server_.GetURL("/ssl/google.html"));
  ui_test_utils::NavigateToURL(browser(), url);
  WebContents* tab = browser()->tab_strip_model()->GetActiveWebContents();
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, ClientRedirectSSLState) {
  ASSERT_TRUE(embedded_test_server()->Start());
  ASSERT_TRUE(https_server_.Start());
...
IN_PROC_BROWSER_TEST_F(SSLUITestTransientAndCommitted, PushStateSSLState) {
  ASSERT_TRUE(https_server_.Start());
...
IN_PROC_BROWSER_TEST_F(SSLUITestCommitted, ErrorPage) {
  if (!content::IsBrowserSideNavigationEnabled())
    return;
