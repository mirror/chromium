...
using CommittedSSLUITest = TransientAndCommittedSSLUITest;
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest,
                       TestInterstitialCrossSiteNavigation) {
  ASSERT_TRUE(embedded_test_server()->Start());
  ASSERT_TRUE(https_server_.Start());
  ASSERT_TRUE(https_server_mismatched_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest,
                       TestHTTPSErrorCausedByClockUsingBuildTime) {
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest,
                       TestHTTPSErrorCausedByClockUsingNetwork) {
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest, TestBadHTTPSDownload) {
  ASSERT_TRUE(embedded_test_server()->Start());
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest, TestRefNavigation) {
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest, TestBadFrameNavigation) {
  ASSERT_TRUE(embedded_test_server()->Start());
  ASSERT_TRUE(https_server_.Start());
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest,
                       TestUnsafeImageWithUserException) {
  WebContents* tab = browser()->tab_strip_model()->GetActiveWebContents();
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest, ProceedLinkOverridable) {
  ASSERT_TRUE(https_server_expired_.Start());
  WebContents* tab = browser()->tab_strip_model()->GetActiveWebContents();
  ui_test_utils::NavigateToURL(
      browser(), https_server_expired_.GetURL("/ssl/google.html"));
...
IN_PROC_BROWSER_TEST_P(CommittedSSLUITest, ProceedLinkOverridable) {
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest,
                       TestInterstitialLinksOpenInNewTab) {
  ASSERT_TRUE(https_server_.Start());
  ASSERT_TRUE(https_server_expired_.Start());
...
IN_PROC_BROWSER_TEST_P(TransientAndCommittedSSLUITest, OSReportsCaptivePortal) {
  ASSERT_TRUE(https_server_mismatched_.Start());
  base::HistogramTester histograms;
...
IN_PROC_BROWSER_TEST_P(CommittedSSLUITest, ErrorPage) {
  if (!content::IsBrowserSideNavigationEnabled())
    return;
