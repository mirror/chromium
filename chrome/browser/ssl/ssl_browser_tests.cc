...
class SSLUIMITMSoftwareTest : public SSLUITest {
 public:
  SSLUIMITMSoftwareTest() : SSLUITest() {}
 ...
 protected:
  void SetUpTransportSecurityState(
    ...
    EXPECT_FALSE(state->ShouldUpgradeToSSL("http://127.0.0.1/ssl/blank_page.html"));
    state->AddHSTS("http://127.0.0.1/ssl/blank_page.html",
                   expiry, false);
    EXPECT_TRUE(state->ShouldUpgradeToSSL("http://127.0.0.1/ssl/blank_page.html"));
  }
};
