...
IN_PROC_BROWSER_TEST_F(SSLUICaptivePortalListResourceBundleTest, CertHash) {
...
IN_PROC_BROWSER_TEST_F(SSLUICaptivePortalListResourceBundleTest, SPKIHash) {
  // Mark the server's cert as a captive portal cert.
