...
// A test fixture that can intercept certificate verification performed during
// connections initiated by a profile request context.
 ...
 protected:
  void TestCTHistogramsArePopulated(bool use_profile) {
    ...
    histograms.ExpectUniqueSample(
        "Net.CertificateTransparency.SCTsPerConnection", kNumSCTs, 1);
