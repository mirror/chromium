...
class ModuleListManager {
 public:
  ...
  // Creates a ModuleListManager bound to the task runner it is created on. All
  // calls to the manager are expected to be received on that task runner, and
  // all outgoing callbacks will be on the same task runner.
