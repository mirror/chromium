...
class ModuleListManagerTest : public ::testing::Test {
 public:
  ...
  void TearDown() override { ModuleListManager::TearDownForTesting(); }

  void NotifyNewModuleList(ModuleListManager* mlm) {
    // Add an observer.
    MockObserver observer;
    mlm->AddObserver(&observer);
...
TEST_F(ModuleListManagerTest, FindsNoPathInRegistry) {
  ModuleListManager* mlm = ModuleListManager::GetInstance();
