...
class ShellExtensionEnumerator {
 public:
  ...
  // Starts enumerating shell extensions.
  void Start();

  // Returns true if the ShellExtensionEnumerator is finished enumerating all
  // shell extensions.
  bool IsDone();
 ...
 private:
  ...
  // Set to true when all shell extensions have been sent via the callback.
  bool is_done_;
