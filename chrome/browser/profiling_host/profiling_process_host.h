...
class ProfilingProcessHost : public content::BrowserChildProcessObserver,
 ...
 private:
  ...
  bool IsReportForUpload();
  void SetIsReportForUpload(bool new_state);
  ...
  bool is_report_for_upload_ = false;

  // Guards |is_report_for_upload_|.
  base::Lock is_report_for_upload_lock_;
