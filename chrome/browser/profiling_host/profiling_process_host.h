...
class ProfilingProcessHost : public content::BrowserChildProcessObserver,
 ...
 public:
  // This is emitted as an enumerated histogram. Do not change the values. If
  // adding new modes, make sure to update the max value for
  // OutOfProcessHeapProfiling.ProfilingMode.
  enum class Mode {
