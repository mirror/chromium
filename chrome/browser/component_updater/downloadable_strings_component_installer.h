...
class DownloadableStringsComponentInstallerTraits
    : public ComponentInstallerTraits {
 public:
  DownloadableStringsComponentInstallerTraits() {}
  ~DownloadableStringsComponentInstallerTraits() override {}
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DownloadableStringsComponentInstallerTraits);
};
