...
class CrOSComponentManager {
 public:
  enum class Error {
    NONE = 0,
    NOT_EXIST = 1,       // Component requested does not exist.
    NOT_COMPATIBLE = 2,  // Component version requested is not compatible.
    DOWNLOAD_ERROR = 3,  // update_client fails to download component.
    MOUNT_ERROR = 4,     // Component can not be mounted.
  };
  using LoadCallback =
