...
void OnDataLoaded(base::Closure closure) {
  // We can not call the closure directly since PostTaskWithTraitsAndReply
  // does not support and empty reply.
...
void MediaEngagementPreloadComponentInstallerPolicy::ComponentReady(
  ...
  base::PostTaskWithTraitsAndReply(
      ...
      base::BindOnce(&OnDataLoaded, std::move(on_load_closure_)));
}
