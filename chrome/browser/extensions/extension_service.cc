...
ExtensionService::ExtensionService(Profile* profile,
    ...
    : extensions::Blacklist::Observer(blacklist),
      ...
      extension_loader_(
          base::MakeUnique<extensions::ExtensionLoader>(profile)) {
  CHECK(BrowserThread::CurrentlyOn(BrowserThread::UI));
...
void ExtensionService::EnableExtension(const std::string& extension_id) {
  ...
  FinishEnablingExtension(extension);
...
void ExtensionService::DisableExtension(const std::string& extension_id,
  ...
  if (registry_->enabled_extensions().Contains(extension->id())) {
    ...
    FinishUnloadingExtension(extension, UnloadedExtensionReason::DISABLE);
  } else {
...
void ExtensionService::FinishEnablingExtension(const Extension* extension) {
...
void ExtensionService::FinishUnloadingExtension(
    const Extension* extension,
...
void ExtensionService::UnloadExtension(const std::string& extension_id,
  ...
  if (registry_->disabled_extensions().Contains(extension->id())) {
    ...
    registry_->RemoveEnabled(extension->id());
    FinishUnloadingExtension(extension.get(), reason);
  }
