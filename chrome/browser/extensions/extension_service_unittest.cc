...
// Test than an unpacked extension with an empty kMetadataFolder loads
// successfully.
...
// Test that an unpacked extension with only reserved filenames in the
...
// Test that an unpacked extension with non-reserved files in the
...
// Test than an unpacked extension with an empty kMetadataFolder and a folder
...
// Test that an unpacked extension with an arbitrary folder beginning with an
