...
bool DisplayInfoProviderChromeOS::SetCustomMirrorMode(
  ...
  auto mirroring_param =
      std::make_unique<display::CustomSoftwareMirroringParam>(source_id,
                                                              destination_ids);
  display::CustomSoftwareMirroringParamErrors error_type =
      display::ValidateParamsForCustomSoftwareMirroring(
          display_manager->GetCurrentDisplayIdList(), *mirroring_param);
  switch (error_type) {
    case display::CustomSoftwareMirroringParamErrors::kErrorSingleDisplay:
      *out_error = kMirrorModeSingleDisplayError;
      return false;
    case display::CustomSoftwareMirroringParamErrors::kErrorSourceIdNotFound:
      *out_error = kMirrorModeSourceIdNotFoundError;
      return false;
    case display::CustomSoftwareMirroringParamErrors::kErrorDestinationIdsEmpty:
      *out_error = kMirrorModeDestinationIdsEmptyError;
      return false;
    case display::CustomSoftwareMirroringParamErrors::
        kErrorDestinationIdNotFound:
      *out_error = kMirrorModeDestinationIdNotFoundError;
      return false;
    case display::CustomSoftwareMirroringParamErrors::kErrorDuplicateId:
      *out_error = kMirrorModeDuplicateIdError;
      return false;
    case display::CustomSoftwareMirroringParamErrors::kSuccess:
