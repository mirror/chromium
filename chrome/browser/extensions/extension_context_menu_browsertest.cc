...
IN_PROC_BROWSER_TEST_F(ExtensionContextMenuBrowserTest, UpdateCheckboxes) {
  ExtensionTestMessageListener listener_created_checkbox1("created checkbox 1",
                                                          false);
  ExtensionTestMessageListener listener_created_checkbox2("created checkbox 2",
                                                          false);
  ExtensionTestMessageListener listener_checked_checkbox2("checkbox2 checked",
                                                          false);
  ExtensionTestMessageListener listener_created_item1("created normal item",
                                                      false);
  ...
  // Check that all menu items are created.
  ASSERT_TRUE(listener_created_checkbox1.WaitUntilSatisfied());
  ASSERT_TRUE(listener_created_checkbox2.WaitUntilSatisfied());
  ASSERT_TRUE(listener_checked_checkbox2.WaitUntilSatisfied());
  ASSERT_TRUE(listener_created_item1.WaitUntilSatisfied());
