...
IN_PROC_BROWSER_TEST_F(PasswordsPrivateApiTest, GetExportProgressStatus) {
  EXPECT_TRUE(RunPasswordsSubtest("getExportProgressStatus")) << message_;
}
