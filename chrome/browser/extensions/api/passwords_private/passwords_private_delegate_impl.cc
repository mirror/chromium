...
void PasswordsPrivateDelegateImpl::RemoveSavedPassword(size_t index) {
  ExecuteFunction(
      base::Bind(&PasswordManagerPresenter::RemoveSavedPassword,
                 base::Unretained(password_manager_presenter_.get()), index));
}

void PasswordsPrivateDelegateImpl::RemovePasswordException(size_t index) {
  ExecuteFunction(
      base::Bind(&PasswordManagerPresenter::RemovePasswordException,
                 base::Unretained(password_manager_presenter_.get()), index));
}
...
void PasswordsPrivateDelegateImpl::RequestShowPassword(
  ...
  ExecuteFunction(
      base::Bind(&PasswordManagerPresenter::RequestShowPassword,
                 base::Unretained(password_manager_presenter_.get()), index));
}
