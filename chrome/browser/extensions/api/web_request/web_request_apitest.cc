...
IN_PROC_BROWSER_TEST_F(ExtensionWebRequestApiTest,
  ...
  EXPECT_EQ(kHeaderValueFromServer,
            test_webcontents_observer.dice_header_value_);
  EXPECT_EQ(kHeaderValueFromExtension,
            test_webcontents_observer.new_header_value_);
  EXPECT_EQ(kHeaderValueFromExtension,
            test_webcontents_observer.control_header_value_);
  ...
  test_webcontents_observer.did_finish_navigation_called_ = false;
