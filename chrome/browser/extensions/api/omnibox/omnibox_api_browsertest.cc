...
IN_PROC_BROWSER_TEST_F(OmniboxApiTest, DISABLED_Basic) {
  ...
  // it.
  {
    AutocompleteInput input(ASCIIToUTF16("keywor"), base::string16::npos,
                            std::string(),
  ...
  {
    AutocompleteInput input(ASCIIToUTF16("keyword suggestio"),
...
IN_PROC_BROWSER_TEST_F(OmniboxApiTest, OnInputEntered) {
  ...
  {
    AutocompleteInput input(ASCIIToUTF16("keyword command"),
                            base::string16::npos, std::string(),
                            ChromeAutocompleteSchemeClassifier(profile));
    input.set_current_page_classification(metrics::OmniboxEventProto::NTP);
    input.set_prevent_inline_autocomplete();
  ...
  {
    AutocompleteInput input(ASCIIToUTF16("keyword newtab"),
                            base::string16::npos, std::string(),
                            ChromeAutocompleteSchemeClassifier(profile));
    input.set_current_page_classification(metrics::OmniboxEventProto::NTP);
    input.set_prevent_inline_autocomplete();
...
IN_PROC_BROWSER_TEST_F(OmniboxApiTest, DISABLED_IncognitoSplitMode) {
  ...
  {
    ResultCatcher catcher;
    AutocompleteInput input(ASCIIToUTF16("keyword command incognito"),
                            base::string16::npos, std::string(),
                            ChromeAutocompleteSchemeClassifier(profile));
    input.set_current_page_classification(metrics::OmniboxEventProto::NTP);
    input.set_prevent_inline_autocomplete();
