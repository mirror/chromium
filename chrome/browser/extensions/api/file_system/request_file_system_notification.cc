...
void RequestFileSystemNotification::ShowAutoGrantedNotification(
  ...
  auto* request_file_system_notification = new RequestFileSystemNotification();
  request_file_system_notification->Init(profile, extension,
...
RequestFileSystemNotification::InitAndShow(
    Profile* profile,
    const extensions::Extension& extension,
