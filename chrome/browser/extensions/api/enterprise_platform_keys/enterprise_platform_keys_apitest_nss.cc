...
struct Params {
  Params(PlatformKeysTestBase::SystemToken system_token,
  ...
  PlatformKeysTestBase::SystemToken system_token_;
...
class EnterprisePlatformKeysTest
 ...
 public:
  ...
  SystemToken GetSystemToken() override { return GetParam().system_token_; }

  EnrollmentStatus GetEnrollmentStatus() override {
    return GetParam().enrollment_status_;
  }

  UserStatus GetUserStatus() override { return GetParam().user_status_; }
 ...
 private:
  void PrepareTestSystemSlotOnIO(
      crypto::ScopedTestSystemNSSKeySlot* slot) override {
    ...
    ImportPrivateKeyPKCS8ToSlot(privateKeyPkcs8System,
                                arraysize(privateKeyPkcs8System), slot->slot());
  }
};
...
INSTANTIATE_TEST_CASE_P(
    ...
    EnterprisePlatformKeysTest,
    ::testing::Values(
        Params(PlatformKeysTestBase::SystemToken::EXISTS,
        ...
        Params(PlatformKeysTestBase::SystemToken::EXISTS,
               ...
               PlatformKeysTestBase::UserStatus::MANAGED_OTHER_DOMAIN),
        Params(PlatformKeysTestBase::SystemToken::DOES_NOT_EXIST,
               PlatformKeysTestBase::EnrollmentStatus::ENROLLED,
               PlatformKeysTestBase::UserStatus::MANAGED_AFFILIATED_DOMAIN)));
