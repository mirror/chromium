...
IN_PROC_BROWSER_TEST_F(ExtensionApiTest, WindowsCreate_NoOpener) {
  ...
  // browsing instance - to avoid this the |new_contents| are navigated
  // to a web url which pushes them to another process).  After fixing
  // http://crbug.com/718489 we should be able to remove the statements below
  // (up to and including EXPECT_EQ).
  ASSERT_TRUE(StartEmbeddedTestServer());
  ...
  // Verify that |new_contents| can NOT find |old_contents| using
  // window.open/name.
