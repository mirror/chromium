...
api::developer_private::ItemInfo MangleExtensionInfo(
  ...
  for (const api::developer_private::ManifestError& error :
    ...
    value->SetKey(
        "type", base::Value(static_cast<int>(ExtensionError::MANIFEST_ERROR)));
    value->SetKey("level", base::Value(static_cast<int>(logging::LOG_WARNING)));
  ...
  for (const api::developer_private::RuntimeError& error :
    ...
    std::unique_ptr<base::DictionaryValue> value = error.ToValue();
    value->SetKey("type",
                  base::Value(static_cast<int>(ExtensionError::RUNTIME_ERROR)));
    ...
    value->SetKey("level", base::Value(static_cast<int>(severity)));
