...
DeveloperPrivateAPI::UnpackedRetryId DeveloperPrivateAPI::AddUnpackedPath(
  ...
  WebContentsData* data = GetWebContentsData(web_contents, true);
...
base::FilePath DeveloperPrivateAPI::GetUnpackedPath(
    content::WebContents* web_contents,
    const UnpackedRetryId& id) {
  DeveloperPrivateAPI::WebContentsData* data =
      GetWebContentsData(web_contents, false);
  if (!data)
...
base::FilePath DeveloperPrivateAPI::GetDraggedPath(
    content::WebContents* web_contents) {
  WebContentsData* data = GetWebContentsData(web_contents, false);
...
DeveloperPrivateAPI::WebContentsData* DeveloperPrivateAPI::GetWebContentsData(
    content::WebContents* web_contents,
    bool create) {
