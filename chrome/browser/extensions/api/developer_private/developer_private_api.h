...
class DeveloperPrivateAPI : public BrowserContextKeyedAPI,
 ...
 public:
  ...
  base::FilePath GetDraggedPath(content::WebContents* web_contents);
 ...
 private:
  ...
  struct WebContentsData {
    ...
    // The last dragged path for a the WebContents.
  ...
  WebContentsData* GetWebContentsData(content::WebContents* web_contents,
                                      bool create);
