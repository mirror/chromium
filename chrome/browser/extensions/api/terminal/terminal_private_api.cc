...
TerminalPrivateOpenTerminalProcessFunction::Run() {
  ...
  chromeos::ProcessProxyRegistry::GetTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(
          &TerminalPrivateOpenTerminalProcessFunction::OpenOnTaskRunner, this,
...
void TerminalPrivateOpenTerminalProcessFunction::OpenOnTaskRunner(
...
ExtensionFunction::ResponseAction TerminalPrivateSendInputFunction::Run() {
  ...
  chromeos::ProcessProxyRegistry::GetTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(&TerminalPrivateSendInputFunction::SendInputOnTaskRunner,
                     this, params->pid, params->input));
  return RespondLater();
}

void TerminalPrivateSendInputFunction::SendInputOnTaskRunner(
    int terminal_id,
...
TerminalPrivateCloseTerminalProcessFunction::Run() {
  ...
  chromeos::ProcessProxyRegistry::GetTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(
          &TerminalPrivateCloseTerminalProcessFunction::CloseOnTaskRunner, this,
          params->pid));

  return RespondLater();
}

void TerminalPrivateCloseTerminalProcessFunction::CloseOnTaskRunner(
    int terminal_id) {
  bool success =
...
TerminalPrivateOnTerminalResizeFunction::Run() {
  ...
  chromeos::ProcessProxyRegistry::GetTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(
          &TerminalPrivateOnTerminalResizeFunction::OnResizeOnTaskRunner, this,
          params->pid, params->width, params->height));

  return RespondLater();
}

void TerminalPrivateOnTerminalResizeFunction::OnResizeOnTaskRunner(
    int terminal_id,
    int width,
    int height) {
...
ExtensionFunction::ResponseAction TerminalPrivateAckOutputFunction::Run() {
  ...
  chromeos::ProcessProxyRegistry::GetTaskRunner()->PostTask(
      FROM_HERE,
      base::BindOnce(&TerminalPrivateAckOutputFunction::AckOutputOnTaskRunner,
                     this, params->pid));

  return RespondNow(NoArguments());
}

void TerminalPrivateAckOutputFunction::AckOutputOnTaskRunner(int terminal_id) {
