...
BookmarkManagerPrivateGetStringsFunction::Run() {
  ...
  localized_strings->SetKey(
      "title",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_TITLE)));
  localized_strings->SetKey("search_button",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_SEARCH_BUTTON)));
  localized_strings->SetKey("folders_menu",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_FOLDERS_MENU)));
  localized_strings->SetKey("organize_menu",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_ORGANIZE_MENU)));
  localized_strings->SetKey("show_in_folder",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_SHOW_IN_FOLDER)));
  localized_strings->SetKey(
      "sort",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_SORT)));
  localized_strings->SetKey(
      "import_menu",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_IMPORT_MENU)));
  localized_strings->SetKey(
      "export_menu",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_EXPORT_MENU)));
  localized_strings->SetKey(
      "rename_folder",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_RENAME_FOLDER)));
  localized_strings->SetKey(
      "edit", base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_EDIT)));
  localized_strings->SetKey(
      "should_open_all",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_SHOULD_OPEN_ALL)));
  localized_strings->SetKey(
      "open_incognito",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_OPEN_INCOGNITO)));
  localized_strings->SetKey(
      "open_in_new_tab",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_OPEN_IN_NEW_TAB)));
  localized_strings->SetKey("open_in_new_window",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_BAR_OPEN_IN_NEW_WINDOW)));
  localized_strings->SetKey("add_new_bookmark",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_BAR_ADD_NEW_BOOKMARK)));
  localized_strings->SetKey(
      "new_folder",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_NEW_FOLDER)));
  localized_strings->SetKey(
      "open_all",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_OPEN_ALL)));
  localized_strings->SetKey("open_all_new_window",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_BAR_OPEN_ALL_NEW_WINDOW)));
  localized_strings->SetKey("open_all_incognito",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_BAR_OPEN_ALL_INCOGNITO)));
  localized_strings->SetKey(
      "remove",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_BAR_REMOVE)));
  localized_strings->SetKey(
      "copy", base::Value(l10n_util::GetStringUTF16(IDS_CONTENT_CONTEXT_COPY)));
  localized_strings->SetKey(
      "cut", base::Value(l10n_util::GetStringUTF16(IDS_CONTENT_CONTEXT_CUT)));
  localized_strings->SetKey(
      "paste",
      base::Value(l10n_util::GetStringUTF16(IDS_CONTENT_CONTEXT_PASTE)));
  localized_strings->SetKey(
      "delete",
      base::Value(l10n_util::GetStringUTF16(IDS_CONTENT_CONTEXT_DELETE)));
  localized_strings->SetKey(
      "undo_delete", base::Value(l10n_util::GetStringUTF16(IDS_UNDO_DELETE)));
  localized_strings->SetKey("new_folder_name",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_EDITOR_NEW_FOLDER_NAME)));
  localized_strings->SetKey("name_input_placeholder",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_NAME_INPUT_PLACE_HOLDER)));
  localized_strings->SetKey("url_input_placeholder",
                            base::Value(l10n_util::GetStringUTF16(
                                IDS_BOOKMARK_MANAGER_URL_INPUT_PLACE_HOLDER)));
  localized_strings->SetKey(
      "invalid_url",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_INVALID_URL)));
  localized_strings->SetKey(
      "recent",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_RECENT)));
  localized_strings->SetKey(
      "search",
      base::Value(l10n_util::GetStringUTF16(IDS_BOOKMARK_MANAGER_SEARCH)));
  localized_strings->SetKey("save",
                            base::Value(l10n_util::GetStringUTF16(IDS_SAVE)));
