...
IN_PROC_BROWSER_TEST_F(AutofillPrivateApiTest, AddNewAddress) {
  EXPECT_TRUE(RunAutofillSubtest("addNewAddress")) << message_;
}

IN_PROC_BROWSER_TEST_F(AutofillPrivateApiTest, UpdateExistingAddress) {
  EXPECT_TRUE(RunAutofillSubtest("updateExistingAddress")) << message_;
}

IN_PROC_BROWSER_TEST_F(AutofillPrivateApiTest, AddNewCreditCard) {
  EXPECT_TRUE(RunAutofillSubtest("addNewCreditCard")) << message_;
}

IN_PROC_BROWSER_TEST_F(AutofillPrivateApiTest, UpdateExistingCreditCard) {
  EXPECT_TRUE(RunAutofillSubtest("updateExistingCreditCard")) << message_;
}
