...
class PrefTransformerInterface {
 public:
  ...
  // |error| and returns a Value of type none otherwise. |bad_message| is
  // passed to simulate the behavior of EXTENSION_FUNCTION_VALIDATE. It is
  // never nullptr.
  ...
  // Returns the extension representation in case of success or a Value of type
  // none otherwise.
