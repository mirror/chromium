...
void ChromeVirtualKeyboardPrivateDelegate::OnKeyboardConfigChanged() {
  ...
  GetKeyboardConfig(base::Bind(
      &ChromeVirtualKeyboardPrivateDelegate::DispatchConfigChangeEvent,
      weak_this_));
}
...
bool ChromeVirtualKeyboardPrivateDelegate::InsertText(
...
bool ChromeVirtualKeyboardPrivateDelegate::SendKeyEvent(
...
bool ChromeVirtualKeyboardPrivateDelegate::SetVirtualKeyboardMode(
    int mode_enum) {
...
bool ChromeVirtualKeyboardPrivateDelegate::SetRequestedKeyboardState(
    int state_enum) {
