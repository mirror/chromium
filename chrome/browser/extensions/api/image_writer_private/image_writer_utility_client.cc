...
void DeleteInterfacePtrs(std::unique_ptr<service_manager::Connector> connector,
                         chrome::mojom::RemovableStorageWriterPtr writer_ptr) {
...
ImageWriterUtilityClient::~ImageWriterUtilityClient() {
  ...
  task_runner_->PostTask(
      FROM_HERE, base::BindOnce(&DeleteInterfacePtrs, std::move(connector_),
