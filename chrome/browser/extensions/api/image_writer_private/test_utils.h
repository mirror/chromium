...
class FakeImageWriterUtilityClientFactory
    : public ImageWriterUtilityClientFactory {
 public:
 ...
 private:
  ImageWriterTestUtils* utils_;  // Owns us.

  DISALLOW_COPY_AND_ASSIGN(FakeImageWriterUtilityClientFactory);
};
...
class ImageWriterTestUtils {
 ...
 protected:
  ...
  FakeImageWriterUtilityClientFactory utility_client_factory_;
