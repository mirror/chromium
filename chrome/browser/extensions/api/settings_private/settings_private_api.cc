...
ExtensionFunction::ResponseAction SettingsPrivateSetPrefFunction::Run() {
  ...
  switch (result) {
    case SetPrefResult::SUCCESS:
      return RespondNow(OneArgument(base::MakeUnique<base::Value>(true)));
    case SetPrefResult::PREF_NOT_MODIFIABLE:
