      ...
      profile_(
          IndependentOTRProfileManager::GetInstance()
              ->CreateFromOriginalProfile(
                  ...
                  base::BindOnce(&OffscreenTab::OriginalProfileDestroyed,
...
void OffscreenTab::Start(const GURL& start_url,
  ...
  WebContents::CreateParams params(profile_->profile());
...
void OffscreenTab::OriginalProfileDestroyed(Profile* profile) {
