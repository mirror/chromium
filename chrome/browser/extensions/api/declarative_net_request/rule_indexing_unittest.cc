  ...
  void SetUp() override {
    ...
    switch (GetParam()) {
      case ExtensionLoadType::PACKED:
        ...
        // A packed extension with a kMetadata folder would yield a warning
        // during installation. However, install warnings for packed extensions
        // aren't actually surfaced to the user.
