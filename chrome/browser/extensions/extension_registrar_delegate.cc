#include "chrome/browser/extensions/extension_registrar_delegate.h"
...
ExtensionRegistrarDelegate::ExtensionRegistrarDelegate(
...
ExtensionRegistrarDelegate::~ExtensionRegistrarDelegate() = default;

void ExtensionRegistrarDelegate::CheckExtensionBeforeAdding(
...
void ExtensionRegistrarDelegate::PostEnableExtension(
...
void ExtensionRegistrarDelegate::PostDisableExtension(
    scoped_refptr<const Extension> extension) {
  // TODO(kalman): Convert ExtensionSpecialStoragePolicy to a
  // BrowserContextKeyedService and use ExtensionRegistryObserver.
...
void ExtensionRegistrarDelegate::OnAddedExtensionDisabled(
    const Extension* extension) {
...
bool ExtensionRegistrarDelegate::ShouldBlockExtension(
...
bool ExtensionRegistrarDelegate::CanEnableExtension(
    const Extension* extension) {
...
bool ExtensionRegistrarDelegate::CanDisableExtension(
    const Extension* extension) {
...
void ExtensionRegistrarDelegate::GrantPermissions(const Extension* extension) {
