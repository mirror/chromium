...
ExtensionSyncData GetEnableSyncData(const Extension& extension) {
  ...
  return ExtensionSyncData(
      extension, enabled, extensions::EXTENSION_DISABLE_NONE, incognito_enabled,
      remote_install, has_all_urls, installed_by_custodian);
}
 ...
 public:
  ...
  void DisableExtensionFromSync(const Extension& extension,
    ...
    ExtensionSyncData disable_extension = GetDisableSyncData(
        extension, extensions::EXTENSION_DISABLE_USER_ACTION);
    SyncChangeList list(
...
TEST_F(ExtensionServiceSyncTest, DisableExtensionFromSync) {
  ...
  ExtensionSyncData disable_good_crx(
      *extension, false, extensions::EXTENSION_DISABLE_USER_ACTION, false,
...
TEST_F(ExtensionServiceSyncTest, ReenableDisabledExtensionFromSync) {
  ...
  EXPECT_EQ(extensions::EXTENSION_DISABLE_USER_ACTION,
...
TEST_F(ExtensionServiceSyncTest, IgnoreSyncChangesWhenLocalStateIsMoreRecent) {
  ...
  service()->DisableExtension(good0, extensions::EXTENSION_DISABLE_USER_ACTION);
  ASSERT_FALSE(service()->IsExtensionEnabled(good0));
  ...
  service()->DisableExtension(good2, extensions::EXTENSION_DISABLE_USER_ACTION);
  ...
  ExtensionSyncData disable_good0(
      *extension0, false, extensions::EXTENSION_DISABLE_USER_ACTION, false,
      false, ExtensionSyncData::BOOLEAN_UNSET, false);
  ExtensionSyncData enable_good2(
      *extension2, true, extensions::EXTENSION_DISABLE_NONE, false, false,
...
TEST_F(ExtensionServiceSyncTest, DontSelfNotify) {
...

  {
    ...
    ExtensionSyncData data(*extension, false,
                           extensions::EXTENSION_DISABLE_USER_ACTION, false,
                           false, ExtensionSyncData::BOOLEAN_UNSET, false);
...

  {
    ...
    ExtensionSyncData data(*extension, false,
                           extensions::EXTENSION_DISABLE_NONE, true, false,
                           ExtensionSyncData::BOOLEAN_UNSET, false);
    SyncChangeList list(1, data.GetSyncChange(SyncChange::ACTION_UPDATE));
...
TEST_F(ExtensionServiceSyncTest, GetSyncDataDisableReasons) {
...

  {
    ...
    EXPECT_EQ(extensions::EXTENSION_DISABLE_NONE, data->disable_reasons());
  }
  ...
  service()->DisableExtension(good_crx, extensions::EXTENSION_DISABLE_RELOAD);
  {
    syncer::SyncDataList list =
        extension_sync_service()->GetAllSyncData(syncer::EXTENSIONS);
    ASSERT_EQ(list.size(), 1U);
...
TEST_F(ExtensionServiceSyncTest, ProcessSyncDataNewExtension) {
  ...
  struct TestCase {
    ...
    bool expect_permissions_granted;
      ...
      {"Disabled", false, extensions::EXTENSION_DISABLE_USER_ACTION,
       extensions::EXTENSION_DISABLE_USER_ACTION, true},
      ...
      {"Legacy", false, -1, extensions::EXTENSION_DISABLE_USER_ACTION, true},
      ...
      {"PermissionsIncrease", false,
       extensions::EXTENSION_DISABLE_PERMISSIONS_INCREASE,
       extensions::EXTENSION_DISABLE_PERMISSIONS_INCREASE, false},
  };
...
TEST_F(ExtensionServiceSyncTest, ProcessSyncDataEnableDisable) {
  ...
  struct TestCase {
    ...
    int expect_disable_reasons;
      ...
      {"NopDisable", extensions::EXTENSION_DISABLE_USER_ACTION, false,
       extensions::EXTENSION_DISABLE_USER_ACTION,
       extensions::EXTENSION_DISABLE_USER_ACTION},
      {"Enable", extensions::EXTENSION_DISABLE_USER_ACTION, true, 0, 0},
      {"Disable", 0, false, extensions::EXTENSION_DISABLE_USER_ACTION,
       extensions::EXTENSION_DISABLE_USER_ACTION},
      {"AddDisableReason", extensions::EXTENSION_DISABLE_REMOTE_INSTALL, false,
       extensions::EXTENSION_DISABLE_REMOTE_INSTALL |
           extensions::EXTENSION_DISABLE_USER_ACTION,
       extensions::EXTENSION_DISABLE_REMOTE_INSTALL |
           extensions::EXTENSION_DISABLE_USER_ACTION},
      {"RemoveDisableReason",
       extensions::EXTENSION_DISABLE_REMOTE_INSTALL |
           extensions::EXTENSION_DISABLE_USER_ACTION,
       false, extensions::EXTENSION_DISABLE_USER_ACTION,
       extensions::EXTENSION_DISABLE_USER_ACTION},
      {"PreserveLocalDisableReason", extensions::EXTENSION_DISABLE_RELOAD, true,
       0, extensions::EXTENSION_DISABLE_RELOAD},
      {"PreserveOnlyLocalDisableReason",
       extensions::EXTENSION_DISABLE_USER_ACTION |
           extensions::EXTENSION_DISABLE_RELOAD,
       true, 0, extensions::EXTENSION_DISABLE_RELOAD},

      // Interaction with Chrome clients <=M44, which don't sync disable_reasons
      // at all (any existing reasons are preserved).
      {"M44Enable", extensions::EXTENSION_DISABLE_USER_ACTION, true, -1, 0},
      ...
      {"M44ReEnable", extensions::EXTENSION_DISABLE_USER_ACTION, true,
       extensions::EXTENSION_DISABLE_USER_ACTION, 0},
      {"M44Disable", 0, false, -1, extensions::EXTENSION_DISABLE_USER_ACTION},
      {"M44ReDisable", 0, false, 0, extensions::EXTENSION_DISABLE_USER_ACTION},
      {"M44AlreadyDisabledByUser", extensions::EXTENSION_DISABLE_USER_ACTION,
       false, -1, extensions::EXTENSION_DISABLE_USER_ACTION},
      {"M44AlreadyDisabledWithOtherReason",
       extensions::EXTENSION_DISABLE_REMOTE_INSTALL, false, -1,
       extensions::EXTENSION_DISABLE_REMOTE_INSTALL |
           extensions::EXTENSION_DISABLE_USER_ACTION},
  };
...
TEST_F(ExtensionServiceSyncTest, ProcessSyncDataDeferredEnable) {
  ...
  ext_specifics->set_enabled(true);
  ext_specifics->set_disable_reasons(extensions::EXTENSION_DISABLE_NONE);
...
TEST_F(ExtensionServiceSyncCustomGalleryTest,
  ...
  struct TestCase {
    ...
    bool expect_permissions_granted;
      ...
      // set of permissions.
      {"OldVersion", v1, 0, extensions::EXTENSION_DISABLE_PERMISSIONS_INCREASE,
       false},
      // Legacy case: Sync tells us to re-enable the extension, but doesn't
      // specify disable reasons. No permissions should be granted.
      {"Legacy", v2, -1, extensions::EXTENSION_DISABLE_PERMISSIONS_INCREASE,
       false},
      ...
      {"GrantPermissions", v2, 0, extensions::EXTENSION_DISABLE_NONE, true},
  };
...
TEST_F(ExtensionServiceTestSupervised,
  ...
  EXPECT_TRUE(ExtensionPrefs::Get(profile())->HasDisableReason(
      id, extensions::EXTENSION_DISABLE_PERMISSIONS_INCREASE));
  EXPECT_TRUE(ExtensionPrefs::Get(profile())->HasDisableReason(
      id, extensions::EXTENSION_DISABLE_CUSTODIAN_APPROVAL_REQUIRED));
