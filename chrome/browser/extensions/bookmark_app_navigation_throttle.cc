...
BookmarkAppNavigationThrottle::ProcessNavigation() {
  ...
  // The ChromeNavigationUIData passed to the NavigationHandle without
  // without PlzNavigate does not have the disposition.
  if (content::IsBrowserSideNavigationEnabled()) {
    ...
    // statement below.
    // TODO(): Stop intercepting some FOREGROUND_TAB navigations.
    //
    ...
    // TODO(): Stop intercepting NEW_WINDOW navigations outside the app.
