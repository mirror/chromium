...
class BookmarkAppNavigationThrottleNavigationBrowserTest
...
INSTANTIATE_TEST_CASE_P(
    /* no prefix */,
    BookmarkAppNavigationThrottleNavigationBrowserTest,
...
IN_PROC_BROWSER_TEST_P(BookmarkAppNavigationThrottleNavigationBrowserTest,
