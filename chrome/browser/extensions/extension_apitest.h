...
class ExtensionApiTest : public ExtensionBrowserTest {
 ...
 private:
  ...
  // path ("chrome/test/data/extensions/api_test").
  ...
  // If |extension_path| is not empty, the path is assumed to be relative
  // to |test_data_dir_| unless it starts with a specific test data directory.
