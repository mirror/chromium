...
std::vector<ExtensionInstallProto::DisableReason> GetDisableReasons(
  ...
  if ((disable_reasons & disable_reason::DISABLE_USER_ACTION) != 0)
    reasons.push_back(ExtensionInstallProto::USER_ACTION);
  if ((disable_reasons & disable_reason::DISABLE_PERMISSIONS_INCREASE) != 0)
    reasons.push_back(ExtensionInstallProto::PERMISSIONS_INCREASE);
  if ((disable_reasons & disable_reason::DISABLE_RELOAD) != 0)
    reasons.push_back(ExtensionInstallProto::RELOAD);
  if ((disable_reasons & disable_reason::DISABLE_UNSUPPORTED_REQUIREMENT) != 0)
    reasons.push_back(ExtensionInstallProto::UNSUPPORTED_REQUIREMENT);
  if ((disable_reasons & disable_reason::DISABLE_SIDELOAD_WIPEOUT) != 0)
  ...
  if ((disable_reasons & disable_reason::DISABLE_NOT_VERIFIED) != 0)
    reasons.push_back(ExtensionInstallProto::NOT_VERIFIED);
  if ((disable_reasons & disable_reason::DISABLE_GREYLIST) != 0)
    reasons.push_back(ExtensionInstallProto::GREYLIST);
  if ((disable_reasons & disable_reason::DISABLE_CORRUPTED) != 0)
    reasons.push_back(ExtensionInstallProto::CORRUPTED);
  if ((disable_reasons & disable_reason::DISABLE_REMOTE_INSTALL) != 0)
    reasons.push_back(ExtensionInstallProto::REMOTE_INSTALL);
  if ((disable_reasons & disable_reason::DISABLE_EXTERNAL_EXTENSION) != 0)
    reasons.push_back(ExtensionInstallProto::EXTERNAL_EXTENSION);
  if ((disable_reasons & disable_reason::DISABLE_UPDATE_REQUIRED_BY_POLICY) !=
      0) {
    reasons.push_back(ExtensionInstallProto::UPDATE_REQUIRED_BY_POLICY);
  }
  if ((disable_reasons & disable_reason::DISABLE_CUSTODIAN_APPROVAL_REQUIRED) !=
      0) {
