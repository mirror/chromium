...
class ExtensionBrowserTest : virtual public InProcessBrowserTest {
 protected:
  ...
  // missing content verification hashes. Disable content verification by
  // default. This should be overriden by derived tests who care about content
  // verification.
  virtual bool ShouldEnableContentVerification() { return false; }
