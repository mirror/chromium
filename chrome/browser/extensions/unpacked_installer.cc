...
bool UnpackedInstaller::LoadExtension(Manifest::Location location,
  ...
  // Delete the metadata folder if one already exists. This is used exclusively
  // for files generated by the Extension System.
  base::DeleteFile(extension_path_.Append(kMetadataFolder), true /*recursive*/);
