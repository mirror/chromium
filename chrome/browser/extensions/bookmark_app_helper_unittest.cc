...
const char kManifestUrl[] = "http://foo.com/manifest.json";
const char kAppUrl[] = "http://foo.com/index.html";
const char kAlternativeAppUrl[] = "http://www.notchromium.org";
const char kAppScope[] = "http://foo.com/scope/";
const char kAppAlternativeScope[] = "http://foo.com/new/";
const char kAppDefaultScope[] = "http://foo.com/";
