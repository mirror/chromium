...
static_assert(extensions::EXTENSION_DISABLE_REASON_LAST == (1 << 16),
...
const int kKnownSyncableDisableReasons =
    ...
    extensions::EXTENSION_DISABLE_SIDELOAD_WIPEOUT |
    extensions::EXTENSION_DISABLE_GREYLIST |
    extensions::EXTENSION_DISABLE_REMOTE_INSTALL;
const int kAllKnownDisableReasons =
    extensions::EXTENSION_DISABLE_REASON_LAST - 1;
...
ExtensionSyncData ExtensionSyncService::CreateSyncData(
  ...
  bool enabled = (disable_reasons == extensions::EXTENSION_DISABLE_NONE);
  enabled = enabled &&
  ...
  bool remote_install = extension_prefs->HasDisableReason(
      id, extensions::EXTENSION_DISABLE_REMOTE_INSTALL);
...
void ExtensionSyncService::ApplySyncData(
  ...
  if (extension_sync_data.remote_install())
    disable_reasons |= extensions::EXTENSION_DISABLE_REMOTE_INSTALL;
  ...
  if (!!incoming_disable_reasons == extension_sync_data.enabled()) {
    ...
    if (extension_sync_data.enabled())
      ...
      disable_reasons |= extensions::EXTENSION_DISABLE_USER_ACTION;
  } else {
  ...
  bool should_be_enabled =
      (disable_reasons == extensions::EXTENSION_DISABLE_NONE);
  ...
  if (should_be_enabled && !extension_service()->IsExtensionEnabled(id)) {
    if (extension) {
      ...
      // reasons to extensions::EXTENSION_DISABLE_NONE (as opposed to the legacy
