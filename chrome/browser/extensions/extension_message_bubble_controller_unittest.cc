...
TEST_F(ExtensionMessageBubbleTest, WipeoutControllerTest) {
  ...
  service_->DisableExtension(kId1, EXTENSION_DISABLE_NOT_VERIFIED);
  ...
  service_->DisableExtension(kId2, EXTENSION_DISABLE_NOT_VERIFIED);
...
TEST_F(ExtensionMessageBubbleTest, DevModeControllerTest) {
  ...
  service_->DisableExtension(kId1, EXTENSION_DISABLE_USER_ACTION);
  service_->DisableExtension(kId2, EXTENSION_DISABLE_USER_ACTION);
...
TEST_F(ExtensionMessageBubbleTest, TestShouldShowMethod) {
  ...
  service_->DisableExtension(kId1, extensions::EXTENSION_DISABLE_NOT_VERIFIED);
