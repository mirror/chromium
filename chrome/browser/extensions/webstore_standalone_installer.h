...
class WebstoreStandaloneInstaller
 ...
 protected:
  ...
  // serialized JSON or proto based on |context_type| to the webstore data
  // request before sending. The default implementation returns an empty string.
  virtual std::string GetPostData(const std::string& context_type);
