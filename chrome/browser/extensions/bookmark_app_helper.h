...
class BookmarkAppHelper : public content::NotificationObserver {
 public:
  ...
  // If |web_app_info| represents an installable app, |install_source| should
  // be set to a value which indicates how the installation was triggered.
  // Otherwise |install_source| should be null.
