...
void CrxInstaller::UpdateExtensionFromUnpackedCrx(
  ...
  creation_flags_ = GetCreationFlagsForUpdate(extension, Extension::NO_FLAGS);
...
int CrxInstaller::GetCreationFlagsForUpdate(const Extension* extension,
                                            const int initial_flags) const {
  DCHECK(extension);

  int creation_flags = initial_flags;
