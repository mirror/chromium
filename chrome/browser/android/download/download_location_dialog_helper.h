...
#ifndef CHROME_BROWSER_ANDROID_DOWNLOAD_DOWNLOAD_LOCATION_DIALOG_HELPER_H_
#define CHROME_BROWSER_ANDROID_DOWNLOAD_DOWNLOAD_LOCATION_DIALOG_HELPER_H_
...
class DownloadLocationDialogHelper {
 ...
 private:
  ...
  ConfirmationCallback dialog_complete_callback_;

  DISALLOW_COPY_AND_ASSIGN(DownloadLocationDialogHelper);
};

#endif  // CHROME_BROWSER_ANDROID_DOWNLOAD_DOWNLOAD_LOCATION_DIALOG_HELPER_H_
