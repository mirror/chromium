 ...
 public:
  static void Create(int icon_size,
    ...
    ImageThumbnailRequest* request =
        new ImageThumbnailRequest(icon_size, file_path, weak_generator);
    request->Start();
  }
...
void ThumbnailGenerator::OnThumbnailRetrieved(const std::string& file_path,
