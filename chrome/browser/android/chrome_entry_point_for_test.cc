...
bool NativeInit() {
  LOG(ERROR) << "ProfilingProcessHost::NativeInit1";
  bool r = android::OnJNIOnLoadInit();
  return r;
}
...
JNI_EXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
  LOG(ERROR) << "ProfilingProcessHost::JNI_OnLoad1";
  ...
  LOG(ERROR) << "ProfilingProcessHost::JNI_OnLoad2";
