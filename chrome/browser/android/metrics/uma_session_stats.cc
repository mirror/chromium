...
// the Java side.
static void UmaSessionStats__ChangeMetricsReportingConsent(JNIEnv*,
...
static void UmaSessionStats__UpdateMetricsServiceState(JNIEnv*,
                                      const JavaParamRef<jclass>&,
                                      jboolean may_upload) {
...
static void UmaSessionStats__RegisterExternalExperiment(
    JNIEnv* env,
...
static void UmaSessionStats__RegisterSyntheticFieldTrial(
    JNIEnv* env,
    const JavaParamRef<jclass>& clazz,
    const JavaParamRef<jstring>& jtrial_name,
...
static void UmaSessionStats__RecordMultiWindowSession(JNIEnv*,
                                     const JavaParamRef<jclass>&,
                                     jint area_percent,
                                     jint instance_count) {
...
static void UmaSessionStats__RecordTabCountPerLoad(JNIEnv*,
                                  const JavaParamRef<jclass>&,
                                  jint num_tabs) {
...
static void UmaSessionStats__RecordPageLoaded(JNIEnv*,
                             const JavaParamRef<jclass>&,
...
static void UmaSessionStats__RecordPageLoadedWithKeyboard(JNIEnv*, const JavaParamRef<jclass>&) {
