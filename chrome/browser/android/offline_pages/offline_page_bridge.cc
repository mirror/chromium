...
ScopedJavaLocalRef<jobject> ToJavaDeletedPageInfo(
    JNIEnv* env,
    const OfflinePageModel::DeletedPageItem& deleted_page) {
  return Java_OfflinePageBridge_createDeletedPageItem(
...
void OfflinePageBridge::OfflinePageDeleted(
  ...
  JNIEnv* env = base::android::AttachCurrentThread();
  Java_OfflinePageBridge_offlinePageDeleted(env, java_ref_,
                                            ToJavaDeletedPageInfo(page_info));
}
