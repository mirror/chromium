...
void MostVisitedSitesBridge::JavaObserver::OnURLsAvailable(
  ...
  for (const auto& section : sections) {
    ...
    for (const auto& tile : tiles) {
      ...
      name_sources.emplace_back(static_cast<int>(tile.name_source));
  ...
  Java_MostVisitedSitesBridge_onURLsAvailable(
      ...
      ToJavaIntArray(env, name_sources), ToJavaIntArray(env, sources));
}
...
void MostVisitedSitesBridge::RecordTileImpression(
  ...
  TileNameSource name_source = static_cast<TileNameSource>(jname_source);
  TileSource source = static_cast<TileSource>(jsource);
  TileVisualType type = static_cast<TileVisualType>(jtype);

  ntp_tiles::metrics::RecordTileImpression(jindex, name_source, source, type,
                                           url,
...
void MostVisitedSitesBridge::RecordOpenedMostVisitedItem(
  ...
  ntp_tiles::metrics::RecordTileClick(
      index, static_cast<TileNameSource>(name_source),
