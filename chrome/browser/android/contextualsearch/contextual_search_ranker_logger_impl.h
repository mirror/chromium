...
enum MachineIntelligencePrediction {
  MACHINE_INTELLIGENCE_PREDICTION_UNDETERMINED,
  MACHINE_INTELLIGENCE_PREDICTION_UNAVAILABLE,
  MACHINE_INTELLIGENCE_PREDICTION_NO,
  MACHINE_INTELLIGENCE_PREDICTION_YES,
};
...
class ContextualSearchRankerLoggerImpl {
 public:
  ...
  // Runs the model and returns the inference result as a
  // MachineIntilligencePrediction enum.
  MachineIntelligencePrediction RunInference(JNIEnv* env, jobject obj);
