...
void WebApkInstaller::InstallOrUpdateWebApk(const std::string& package_name,
  ...
  base::android::ScopedJavaLocalRef<jobject> java_badge_icon = nullptr;
  if (!install_badge_icon_.drawsNothing())
    java_badge_icon = gfx::ConvertToJavaBitmap(&install_badge_icon_);
