...
void WebApkUpdateDataFetcher::OnDataAvailable(
  ...
  ScopedJavaLocalRef<jstring> java_share_url_template =
      base::android::ConvertUTF16ToJavaString(env, info_.share_url_template);
  ...
  Java_WebApkUpdateDataFetcher_onDataAvailable(
      ...
      java_share_url_template, java_primary_icon_url,
      java_primary_icon_murmur2_hash, java_primary_icon, java_badge_icon_url,
      java_badge_icon_murmur2_hash, java_badge_icon, java_icon_urls,
      info_.display, info_.orientation, info_.theme_color,
      info_.background_color);
}
