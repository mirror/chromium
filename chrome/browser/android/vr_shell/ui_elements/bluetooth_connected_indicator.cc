...
BluetoothConnectedIndicator::BluetoothConnectedIndicator(int preferred_width)
    : TexturedElement(preferred_width),
      texture_(base::MakeUnique<SystemIndicatorTexture>(
          vector_icons::kSystemMenuBluetoothIcon)) {}

BluetoothConnectedIndicator::~BluetoothConnectedIndicator() = default;

UiTexture* BluetoothConnectedIndicator::GetTexture() const {
  return texture_.get();
}
