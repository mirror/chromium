...
void VrMetricsUtil::LogVrViewerType(gvr_viewer_type viewer_type) {
...
ViewerType VrMetricsUtil::GetVrViewerType(gvr_viewer_type viewer_type) {
  switch (viewer_type) {
