...
#ifndef CHROME_BROWSER_ANDROID_VR_SHELL_UI_RENDERER_H_
#define CHROME_BROWSER_ANDROID_VR_SHELL_UI_RENDERER_H_
...
#endif  // CHROME_BROWSER_ANDROID_VR_SHELL_UI_RENDERER_H_
