...
void VrShellGl::InitializeGl(gfx::AcceleratedWidget window) {
  ...
  // TODO(crbug.com/760389): force this on for S8 via whitelist?
...
void VrShellGl::ConnectPresentingService(
  ...
  // TODO(crbug.com/795049): Add a metric to track how much the
  // permitted-but-not-recommended preserveDrawingBuffer=true mode
  // is used by WebVR 1.1 sites. Having this option set will disable
  // the planned direct-draw-to-shared-buffer optimization.
