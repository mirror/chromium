...
class UiSceneManager {
 ...
 private:
  ...
  void ConfigStartPresentationToast(bool show_toast);
  void UpdateBackgroundColor();
  void CloseExitPrompt();
  void OnSecurityWarningTimer();
  void OnTransientUrlBarTimer();
  void OnStartPresentationToastTimer();
  ...
  UiElement* start_presentation_toast_ = nullptr;
  ...
  base::OneShotTimer start_presentation_toast_timer_;
