...
void VrShellDelegate::AddAlertDialog(jlong icon,
  ...
  vr_shell_->ShowAlertDialog(icon, title_text, toggle_text, button_positive,
                             b_positive_text, button_negative, b_negative_text);
}
