...
class VrShell : public device::GvrDelegate,
 ...
 private:
  ...
  // ViewAndroid for building native view tree for VrShell. This is not
  // a full-fledged version that forwards events. Used mainly to provide
  // a container view. Needs to be attached to VrShell's WindowAndroid
