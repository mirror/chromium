 ...
 public:
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    command_line->AppendSwitchASCII(switches::kEnableFeatures,
                                    "SubresourceFilter,AbusiveAdEnforcement");
  }
...
IN_PROC_BROWSER_TEST_F(SafeBrowsingTriggeredPopupBlockerBrowserTest,
  ...
  database_helper()->MarkUrlAsMatchingListWithId(
      a_url, safe_browsing::GetUrlSocEngId(),
...
IN_PROC_BROWSER_TEST_P(SafeBrowsingTriggeredPopupBlockerParamBrowserTest,
  ...
  scoped_feature_list.InitAndEnableFeatureWithParameters(
      kAbusiveAdEnforcement, {{"ignore_sublists", ignore_param}});
