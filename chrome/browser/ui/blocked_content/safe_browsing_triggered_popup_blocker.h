...
extern const base::Feature kAbusiveAdEnforcement;
...
// which match the ABUSIVE_ADS safe browsing list, this class will aide the
// popup tab helper in applying a stronger policy for blocked popups.
class SafeBrowsingTriggeredPopupBlocker
 ...
 private:
  ...
  // stronger popup blocker.
  bool trigger_for_next_committed_navigation_ = false;
