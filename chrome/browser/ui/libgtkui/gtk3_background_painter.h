...
// A background that paints using GTK foreign drawing.  The type and
// style of widget to be drawn is decided by a GtkStyleContext.
// Always renders a background and a frame.
