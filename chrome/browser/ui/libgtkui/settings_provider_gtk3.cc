...
void SettingsProviderGtk3::OnMiddleClickActionChanged(GtkSettings* settings,
                                                      GParamSpec* param) {
  std::string value =
...
void SettingsProviderGtk3::OnDoubleClickActionChanged(GtkSettings* settings,
                                                      GParamSpec* param) {
  std::string value =
...
void SettingsProviderGtk3::OnRightClickActionChanged(GtkSettings* settings,
                                                     GParamSpec* param) {
  std::string value =
