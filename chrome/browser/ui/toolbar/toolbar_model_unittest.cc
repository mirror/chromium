...
struct TestItem {
  ...
  const char* expected_elided_url_for_display;
} test_items[] = {
    {
    ...
    {
        GURL(url::kAboutBlankURL), url::kAboutBlankURL, url::kAboutBlankURL,
    },
    {
        GURL("http://searchurl/?q=tractor+supply"),
        "searchurl/?q=tractor+supply", "searchurl/?q=tractor+supply",
    },
    {
