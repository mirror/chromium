...
void SigninViewController::ShowModalSignin(
  ...
  // The sign-in dialog displays a Gaia sign-in webpage. An HTTP logging dialog
  // needs to be displayed when loading the Gaia webpage goes through a proxy
  // that requires HTTP authentication. Ensure that such a dialog can be
