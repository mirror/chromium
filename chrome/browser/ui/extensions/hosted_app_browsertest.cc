...
class HostedAppWithinIsolatedOriginTest : public HostedAppProcessModelTest {
 public:
  HostedAppWithinIsolatedOriginTest() {}
  ~HostedAppWithinIsolatedOriginTest() override {}
...
IN_PROC_BROWSER_TEST_P(HostedAppWithinIsolatedOriginTest,
