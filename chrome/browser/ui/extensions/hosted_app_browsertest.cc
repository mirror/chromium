...
class HostedAppProcessModelTest : public HostedAppTest {
 public:
  ...
  RenderFrameHost* TestSubframeProcess(RenderFrameHost* parent_rfh,
    ...
    EXPECT_TRUE(ExecuteScript(parent_rfh,
...
// that they can be scripted, but this is not yet supported.
...
// OOPIF unless there is another reason to, but popups from outside the app will
// swap into the app.
