...
FindBarDecoration::FindBarDecoration(CommandUpdater* command_updater)
...
void FindBarDecoration::SetStarred(bool starred, bool location_bar_is_dark) {
  starred_ = starred;
...
NSPoint FindBarDecoration::GetStarBubblePointInFrame(NSRect draw_frame) {
...
bool FindBarDecoration::OnMousePressed(NSRect frame, NSPoint location) {
...
NSPoint FindBarDecoration::GetBubblePointInFrame(NSRect frame) {
