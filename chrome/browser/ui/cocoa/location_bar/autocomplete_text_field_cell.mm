...
- (void)drawWithFrame:(NSRect)frame inView:(NSView*)controlView {
  ...
  // Insetting rounded rectangles also decreases their corner radius. Compare to
  // SkRRect::inset().
  CGFloat innerBorderRadius = kCornerRadius - singlePixelLineWidth_;
  rect =
  ...
  // Draw the "background". This will look terrible if it's not opaque.
  ...
  CGFloat innerFocusRadius = kCornerRadius - 2 * singlePixelLineWidth_;
  CGFloat outerFocusRadius = kCornerRadius + singlePixelLineWidth_;
  rect =
