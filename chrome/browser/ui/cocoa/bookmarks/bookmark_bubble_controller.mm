...
- (NSTouchBar*)makeTouchBar {
  ...
  NSArray* dialogItems = @[
    base::mac::CreateTouchBarItemId(kBookmarkBubbleTouchBarId,
                                    kRemoveTouchBarId),
    base::mac::CreateTouchBarItemId(kBookmarkBubbleTouchBarId, kEditTouchBarId),
    base::mac::CreateTouchBarItemId(kBookmarkBubbleTouchBarId, kDoneTouchBarId)
  ];
...
- (NSTouchBarItem*)touchBar:(NSTouchBar*)touchBar
  ...
  if ([identifier hasSuffix:kRemoveTouchBarId]) {
    ...
    button = [BaseBubbleController doneTouchBarButtonWithTarget:self
                                                         action:@selector(ok:)];
  } else {
    return nil;
  }
