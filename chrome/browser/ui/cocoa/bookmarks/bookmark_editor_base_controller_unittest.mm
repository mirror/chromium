...
TEST_F(BookmarkEditorBaseControllerTest, TouchBar) {
  ...
  EXPECT_TRUE([touch_bar_items
      containsObject:base::mac::CreateTouchBarItemId(
                         kBookmarkEditDialogTouchBarId, kNewFolderTouchBarId)]);
  EXPECT_TRUE([touch_bar_items
      containsObject:base::mac::CreateTouchBarItemId(
                         kBookmarkEditDialogTouchBarId, kCancelTouchBarId)]);
  EXPECT_TRUE([touch_bar_items
      containsObject:base::mac::CreateTouchBarItemId(
                         kBookmarkEditDialogTouchBarId, kSaveTouchBarId)]);
