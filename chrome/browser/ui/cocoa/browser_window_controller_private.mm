...
- (void)windowDidEnterFullScreen:(NSNotification*)notification {
  ...
  // that contains the views, and hide it if the window contains a toolbar.
  // There is no need to ever unhide the view. http://crbug.com/380235
  if (base::mac::IsAtLeastOS10_10()) {
    for (NSWindow* window in [[NSApplication sharedApplication] windows]) {
      ...
      // FramedBrowserWindow doesn't contain toolbar.
