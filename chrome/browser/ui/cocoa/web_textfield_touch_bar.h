...
#ifndef CHROME_BROWSER_UI_COCOA_WEB_TEXTFIELD_TOUCH_BAR_H_
#define CHROME_BROWSER_UI_COCOA_WEB_TEXTFIELD_TOUCH_BAR_H_
...
- (instancetype)initWithRenderWidgetHostView:(RenderWidgetHostViewCocoa*)rwhv;
