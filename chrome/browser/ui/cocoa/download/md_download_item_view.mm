...
- (void)setStateFromDownload:(DownloadItemModel*)downloadModel {
  ...
  switch (state) {
    case content::DownloadItem::COMPLETE:
      [progressIndicator_
          setState:MDDownloadItemProgressIndicatorState::Complete
          progress:1
          animations:^{
    ...
    case content::DownloadItem::IN_PROGRESS:
      [progressIndicator_
            setState:MDDownloadItemProgressIndicatorState::InProgress
    ...
    case content::DownloadItem::INTERRUPTED:
      [progressIndicator_
            setState:MDDownloadItemProgressIndicatorState::Canceled
            progress:0
          animations:nil
          completion:^{
            [self finish];
