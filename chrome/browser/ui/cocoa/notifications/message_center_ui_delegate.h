...
// UiControllerBridge is the owner of all the Cocoa UI objects for the
// message_center. It bridges C++ notifications from the UiController to
// the various UI objects.
class UiControllerBridge : public message_center::UiDelegate {
 public:
  explicit UiControllerBridge(message_center::MessageCenter* message_center);
  ~UiControllerBridge() override;
 ...
 private:
  friend class UiControllerBridgeTest;
  ...
  DISALLOW_COPY_AND_ASSIGN(UiControllerBridge);
};
