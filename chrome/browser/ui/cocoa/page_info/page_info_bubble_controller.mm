  ...
  if (changePasswordButton_) {
    ...
    if (canFitInOneLine) {
      ...
      whitelistReuseButtonOrigin.x =
          isRTL ? changePasswordButtonWidth + horizontalPadding
                : viewWidth - changePasswordButtonWidth -
                      whitelistReuseButtonWidth - horizontalPadding;
      changePasswordButtonOrigin.x =
          isRTL ? horizontalPadding
                : viewWidth - horizontalPadding - changePasswordButtonWidth;
    } else {
