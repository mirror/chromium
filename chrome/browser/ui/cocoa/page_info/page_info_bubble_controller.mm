  ...
  if (changePasswordButton_) {
    ...
    if (canFitInOneLine) {
      ...
      whitelistReuseButtonOrigin.x =
          isRTL ? viewWidth - whitelistReuseButtonWidth - horizontalPadding
                : horizontalPadding;
      changePasswordButtonOrigin.x =
          isRTL ? viewWidth - horizontalPadding - whitelistReuseButtonWidth -
                      changePasswordButtonWidth
                : horizontalPadding + whitelistReuseButtonWidth;
    } else {
