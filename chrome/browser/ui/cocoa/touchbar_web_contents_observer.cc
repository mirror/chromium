...
void TouchbarWebContentsObserver::DisplayWebContentsInTouchbar(
...
void TouchbarWebContentsObserver::WasShown() {
  content::WebContentsDelegate* delegate = web_contents()->GetDelegate();
...
bool TouchbarWebContentsObserver::IsTouchbarDinoGameEnabled() {
