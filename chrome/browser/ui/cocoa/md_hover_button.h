...
// MDHoverButton is a button with a gray background and rounded corners. The
// background is normally hidden, but fades in on hover and gets darker on
// click. It's friendly to subviews.
