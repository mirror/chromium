...
class BrowserWindowCocoa
 ...
 private:
  // Notifies observers if the current show state has successfully changed.
  void NotifyIfShowStateChanged();
  ...
  // The last ShowState seen. Since changing the ShowState could fail, check
  // this before firing OnShowStateChanged.
  ui::WindowShowState last_show_state_ = ui::SHOW_STATE_DEFAULT;
