...
- (void)startPulse {
  if (!isPulsing_) {
    ...
    // If the tab is not yet pulsing, start it. It may be that the pulse was
    // stopped with -stopPulse yet was making its way through its final cycle.
