...
@property(assign, nonatomic) int currentAttentionTypes;
...
- (BOOL)blocked {
  return self.currentAttentionTypes & AttentionType::kBlockedWebContents;
}
...
- (int)currentAttentionTypes {
  return currentAttentionTypes_;
}
