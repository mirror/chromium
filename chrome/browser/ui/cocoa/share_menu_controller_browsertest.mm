...
// Superclass declares |init| unavailable, so redeclare.
- (instancetype)init;
...
- (instancetype)init {
  return [super initWithTitle:@"Mock service"
  ...
  base::scoped_nsobject<NSSharingService> service([[NSSharingService alloc]
      ...
      alternateImage:nil
             handler:^{
               ...
               EXPECT_FALSE(
                   NSEqualRects([controller_ sharingService:mockService
               ...
               NSRect contentRect;
               EXPECT_FALSE([controller_ sharingService:mockService
