...
class WebTextfieldTouchBarControllerUnitTest : public CocoaTest {
 public:
  void SetUp() override {
    CocoaTest::SetUp();
    feature_list.InitAndEnableFeature(features::kCreditCardAutofillTouchBar);

    touch_bar_controller_.reset([[WebTextfieldTouchBarController alloc]
        initWithTabContentsController:nil]);
  }
  ...
  void ShowAutofillPopup(bool is_credit_card_field) {
    autofill_popup_controller_.SetIsCreditCardField(is_credit_card_field);
    [touch_bar_controller_
        setAutofillPopupController:&autofill_popup_controller_];
  }
 ...
 protected:
  base::scoped_nsobject<WebTextfieldTouchBarController> touch_bar_controller_;
...
TEST_F(WebTextfieldTouchBarControllerUnitTest, CreditCardAutofillTouchBar) {
