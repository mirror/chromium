...
PasswordReuseWarningDialogCocoa::PasswordReuseWarningDialogCocoa(
  ...
  modal_window_ = web_contents->GetTopLevelNativeWindow();
  [modal_window_ beginSheet:window_.get()
...
void PasswordReuseWarningDialogCocoa::Close() {
  ...
  [modal_window_ endSheet:window_.get() returnCode:NSModalResponseStop];
}
