...
@interface FullscreenToolbarController : NSObject {
 @private
  ...
  std::unique_ptr<ui::ScopedMenuBarLock> menubarLock_;
  ...
  // Tracking area which keeps the menu bar and toolbar visible until the mouse
  // moves far enough away from them. Weak, owned by the toolbar view.
