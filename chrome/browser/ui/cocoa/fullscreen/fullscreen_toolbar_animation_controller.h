...
// This class is used by FullscreenToolbarAnimationController to observe
// first meaningful paint events in a WebContents object.
class FullscreenToolbarAnimationWebObserver
 ...
 private:
  FullscreenToolbarAnimationController* owner_;  // weak.

  DISALLOW_COPY_AND_ASSIGN(FullscreenToolbarAnimationWebObserver);
};
...
class FullscreenToolbarAnimationController : public gfx::AnimationDelegate {
 public:
  ...
  // Called by |observer_| when its web contents did its first meaningful
  // paint.
