...
class AnimatedIcon : public gfx::AnimationDelegate {
 public:
  explicit AnimatedIcon(const gfx::VectorIcon& icon, NSView* host_view);
  ...
  // Paints the icon on |canvas|. The icon is centered in |frame|.
  void PaintIcon(gfx::Canvas* canvas, NSRect frame);
