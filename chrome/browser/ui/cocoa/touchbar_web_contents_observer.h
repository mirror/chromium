...
#ifndef CHROME_BROWSER_TOUCHBAR_CONTENTS_OBSERVER_H_
#define CHROME_BROWSER_TOUCHBAR_CONTENTS_OBSERVER_H_
...
class TouchbarWebContentsObserver : public WebContentsObserver {
 public:
  TouchbarWebContentsObserver(WebContents* web_contents)
...
#endif  // CHROME_BROWSER_TOUCHBAR_CONTENTS_OBSERVER_H_
