...
LanguageComboboxModel::LanguageComboboxModel(
    bool is_source_combobox,
    int default_index,
    TranslateBubbleModel* model)
    : is_source_combobox_(is_source_combobox),
...
bool LanguageComboboxModel::IsItemEnabledAt(int index) const {
  return is_source_combobox_ || index != model_->GetUnknownLanguageIndex();
}
