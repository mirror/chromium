...
PasswordReuseModalWarningDialog::PasswordReuseModalWarningDialog(
  ...
  column_set->AddColumn(views::GridLayout::FILL, views::GridLayout::FILL, 1,
                        views::GridLayout::USE_PREF, 0, 400);
...
gfx::ImageSkia PasswordReuseModalWarningDialog::GetWindowIcon() {
  // Resize icon to 24 x 24.
  int icon_size = 24;
  return show_softer_warning_
             ? gfx::CreateVectorIcon(kSecurityIcon, icon_size,
                                     gfx::kChromeIconGrey)
             : gfx::CreateVectorIcon(vector_icons::kWarningIcon, icon_size,
                                     gfx::kGoogleRed700);
}
