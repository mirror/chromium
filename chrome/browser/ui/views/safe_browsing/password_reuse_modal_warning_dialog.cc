...
bool PasswordReuseModalWarningDialog::Close() {
  // If user hasn't clicked on any button and Close() is called. This is
...
views::View* PasswordReuseModalWarningDialog::GetContentsView() {
  return dialog_message_view_;
}

views::Widget* PasswordReuseModalWarningDialog::GetWidget() {
  return dialog_message_view_->GetWidget();
}

const views::Widget* PasswordReuseModalWarningDialog::GetWidget() const {
  return dialog_message_view_->GetWidget();
}

void PasswordReuseModalWarningDialog::DeleteDelegate() {
  delete this;
}
