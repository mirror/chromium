...
void ShowChromeCleanerRebootPrompt(
  ...
  ChromeCleanerRebootDialog* dialog =
      new ChromeCleanerRebootDialog(dialog_controller /*, cleaner_controller*/);
  dialog->Show(browser);
}
...
ChromeCleanerRebootDialog::ChromeCleanerRebootDialog(
  ...
  views::Label* label = new views::Label(
      L"To finish removing harmful software, restart your computer"
