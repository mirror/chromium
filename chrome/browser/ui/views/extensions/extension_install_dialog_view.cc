 ...
 public:
  ...
  void GetAccessibleNodeData(ui::AXNodeData* node_data) override {
    ...
    if (rating_count_ == 0) {
      ...
      // TODO(devlin): In the case of exactly one rating (which is very rare),
      // this will result in a broken plural in the string.
      accessible_text = l10n_util::GetStringFUTF16(
          IDS_EXTENSION_PROMPT_RATING_ACCESSIBLE_TEXT,
          base::UTF8ToUTF16(base::StringPrintf("%.1f", rating_)),
