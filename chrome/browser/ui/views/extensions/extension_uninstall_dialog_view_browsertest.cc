...
class ExtensionUninstallDialogViewInteractiveBrowserTest
 ...
 public:
  ...
  void RunTest(bool uninstall_by_extension, bool use_webstore_extension) {
    use_webstore_extension_ = use_webstore_extension;
    uninstall_by_extension_ = uninstall_by_extension;
 ...
 private:
  ...
  bool uninstall_by_extension_;
  bool use_webstore_extension_;
};
