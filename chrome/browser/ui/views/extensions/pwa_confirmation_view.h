...
static constexpr int kPWAConfirmationViewIconSize =
...
class PWAConfirmationView : public views::DialogDelegateView {
 ...
 private:
  ...
  // Lays out the dialog.
  // |title| is the full title of the app, which will be elided, if necessary,
  // to fit on one line. |app_url| is the start url for the app. An icon from
  // |icons| will be displayed in the dialog.
  void InitializeView(const base::string16& title,
                      const GURL& app_url,
