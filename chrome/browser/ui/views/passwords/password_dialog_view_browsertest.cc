...
class PasswordDialogViewWithEmbeddedServerTest : public PasswordDialogViewTest {
 public:
...
void PasswordDialogViewWithEmbeddedServerTest::SetUpOnMainThread() {
  PasswordDialogViewTest::SetUpOnMainThread();
  // Set up the test server.
  embedded_test_server()->RegisterRequestHandler(base::BindRepeating(
      &PasswordDialogViewWithEmbeddedServerTest::HandleRequest,
      base::Unretained(this)));
  EXPECT_CALL(*this, OnIconRequestDone());
  ASSERT_TRUE(embedded_test_server()->Start());
}

IN_PROC_BROWSER_TEST_F(PasswordDialogViewWithEmbeddedServerTest,
