...
IN_PROC_BROWSER_TEST_F(PasswordDialogViewTest,
  ...
  GURL icon_url = embedded_test_server()->GetURL("/icon.png");
  ...
  EXPECT_CALL(*this, OnIconRequestDone(icon_url));
