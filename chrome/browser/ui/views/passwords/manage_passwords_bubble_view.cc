...
enum ColumnSetType {
  ...
  // Used for the username line of the bubble, for the pending view.
  DOUBLE_VIEW_COLUMN_SET,
  DOUBLE_VIEW_COLUMN_SET_2,
...
// DOUBLE_VIEW_COLUMN_SET will be used for password row instead of
// TRIPLE_VIEW_COLUMN_SET.
void BuildCredentialRow(views::GridLayout* layout,
  ...
  // Password row.
  ColumnSetType type =
      password_view_button ? TRIPLE_VIEW_COLUMN_SET : DOUBLE_VIEW_COLUMN_SET_2;
