...
class ManagePasswordsBubbleViewWithEmbeddedServerTest
    : public ManagePasswordsBubbleViewTest {
 public:
  void SetUpOnMainThread() override {
    ManagePasswordsBubbleViewTest::SetUpOnMainThread();
    // Set up the test server.
    embedded_test_server()->RegisterRequestHandler(base::BindRepeating(
        &ManagePasswordsBubbleViewWithEmbeddedServerTest::HandleRequest,
...
IN_PROC_BROWSER_TEST_F(ManagePasswordsBubbleViewWithEmbeddedServerTest,
                       AutoSignin) {
