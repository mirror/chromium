...
void ChromeBrowserMainExtraPartsViews::PreMainMessageLoopRun() {
#if !defined(OS_CHROMEOS)
  restart_notification_controller_ =
      std::make_unique<RestartNotificationController>(
...
#if !defined(OS_CHROMEOS)
  restart_notification_controller_.reset();
#endif
}
