...
void PaymentSheetViewController::FillContentView(views::View* content_view) {
  ...
  if (spec()->request_shipping()) {
    ...
    shipping_row->SetPreviousRow(previous_row);
    ...
    if (shipping_option_row) {
      shipping_option_row->SetPreviousRow(previous_row);
  ...
  payment_method_row->SetPreviousRow(previous_row);
  ...
  if (spec()->request_payer_name() || spec()->request_payer_email() ||
    ...
    contact_info_row->SetPreviousRow(previous_row);
