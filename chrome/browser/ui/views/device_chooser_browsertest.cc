...
IN_PROC_BROWSER_TEST_F(BluetoothChooserBrowserTest,
  ...
  set_status(FakeBluetoothChooserController::SCANNING);
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, false, FakeBluetoothChooserController::kSignalStrengthLevel0));
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, false, FakeBluetoothChooserController::kSignalStrengthLevel1));
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, false, FakeBluetoothChooserController::kSignalStrengthLevel2));
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, false, FakeBluetoothChooserController::kSignalStrengthLevel3));
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, false, FakeBluetoothChooserController::kSignalStrengthLevel4));
  RunDialog();
}
...
IN_PROC_BROWSER_TEST_F(BluetoothChooserBrowserTest,
  ...
  set_status(FakeBluetoothChooserController::IDLE);
  add_device(FakeBluetoothChooserController::FakeDevice(
      true, false, FakeBluetoothChooserController::kSignalStrengthLevel4));
  RunDialog();
}
...
IN_PROC_BROWSER_TEST_F(BluetoothChooserBrowserTest,
  ...
  set_status(FakeBluetoothChooserController::IDLE);
  add_device(FakeBluetoothChooserController::FakeDevice(
      false, true, FakeBluetoothChooserController::kSignalStrengthLevel4));
  RunDialog();
}
