...
class HoverButton : public views::LabelButton {
 public:
  ...
  // Creates a single or double line hover button with a custom view in place of
  // the icon. Passing an empty |subtitle| turn this into a single line hover,
  // and adjust |title| text to be vertically centered to |icon_view|.
  HoverButton(views::ButtonListener* button_listener,
