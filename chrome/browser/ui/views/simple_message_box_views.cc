...
ui::ModalType SimpleMessageBoxViews::GetModalType() const {
  bool use_system_modal = is_system_modal_;
#if defined(OS_MACOSX)
  // Mac does not support system modal dialogs.
  use_system_modal = false;
#endif
  return use_system_modal ? ui::MODAL_TYPE_SYSTEM : ui::MODAL_TYPE_WINDOW;
}
...
void ShowWarningMessageBox(gfx::NativeWindow parent,
                           const base::string16& title,
                           const base::string16& message) {
  ShowMessageBoxViews(parent, title, message, chrome::MESSAGE_BOX_TYPE_WARNING,
...
MessageBoxResult ShowMessageBoxWithButtonText(gfx::NativeWindow parent,
                                              ...
                                              const base::string16& yes_text,
                                              const base::string16& no_text) {
  return ShowMessageBoxViews(parent, title, message,
