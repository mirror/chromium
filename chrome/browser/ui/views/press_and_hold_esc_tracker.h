...
class PressAndHoldEscTracker {
 public:
  explicit PressAndHoldEscTracker(gfx::NativeView parent_view);
  ~PressAndHoldEscTracker();

  void StartTracking(const gfx::Rect& parent_bounds_in_screen,
 ...
 private:
  ...
  FullscreenControlPopup control_popup_;
