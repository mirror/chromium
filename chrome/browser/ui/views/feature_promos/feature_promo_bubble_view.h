...
class FeaturePromoBubbleView : public views::BubbleDialogDelegateView {
 ...
 protected:
  ...
  // unless the |anchor_view| is not appropriate for certain conditions
  // (ie. fullscreen, off the browser window). Then the |anchor_rect| should
  // be used. The |arrow| sets where the arrow hangs off the bubble and
  // the |string_specifier| is the text displayed on the bubble.
