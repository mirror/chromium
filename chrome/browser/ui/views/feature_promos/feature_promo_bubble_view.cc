...
FeaturePromoBubbleView::FeaturePromoBubbleView(
  ...
  if (activatation_action == ActivationAction::DO_NOT_ACTIVATE)
    set_can_activate(activatation_action == ActivationAction::ACTIVATE);
  views::Widget* widget = views::BubbleDialogDelegateView::CreateBubble(this);
  if (activatation_action == ActivationAction::DO_NOT_ACTIVATE)
    SetArrowPaintType(views::BubbleBorder::PAINT_TRANSPARENT);
  UseCompactMargins();
  widget->Show();
  if (activatation_action == ActivationAction::ACTIVATE)
