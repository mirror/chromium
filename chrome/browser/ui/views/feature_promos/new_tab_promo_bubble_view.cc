...
//   return browser->tabstrip()->new_tab_button();
// }
...
void NewTabPromoBubbleView::ShowPromoBubble(Browser* browser) {
  ...
  set_browser(browser);
  auto* new_tab_button = feature_engagement::GetNewTabButton(browser);
