...
class TryChromeDialogBrowserTestBase : public InProcessBrowserTest {
 ...
 protected:
  ...
  TryChromeDialogBrowserTestBase() : TryChromeDialogBrowserTestBase(0) {}
  explicit TryChromeDialogBrowserTestBase(int group)
...
IN_PROC_BROWSER_TEST_F(TryChromeDialogBrowserTestBase, ShowAndCloseNotNow) {
  ...
  // Now close it, verifying tha the delegate is invoked as appropriate.
  {
