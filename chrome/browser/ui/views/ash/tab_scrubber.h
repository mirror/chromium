...
class TabScrubber : public ui::EventHandler,
 ...
 private:
  ...
  void TabStripAddedTabAt(TabStripImpl* tab_strip, int index) override;
  void TabStripMovedTab(TabStripImpl* tab_strip,
                        int from_index,
                        int to_index) override;
  void TabStripRemovedTabAt(TabStripImpl* tab_strip, int index) override;
  void TabStripDeleted(TabStripImpl* tab_strip) override;
