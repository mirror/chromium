...
// TODO(sky): reenable this. This test can't be enabled until presentation-token
// is wired for glx (http://crbug.com/776877).
IN_PROC_BROWSER_TEST_F(TimeToFirstPresentRecorderTest,
                       DISALBED_VerifyTimeCalculated) {
