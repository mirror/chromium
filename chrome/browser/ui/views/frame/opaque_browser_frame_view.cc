...
OpaqueBrowserFrameView::OpaqueBrowserFrameView(BrowserFrame* frame,
  ...
  minimize_button_ =
      InitWindowCaptionButton(views::FrameButtonDisplayType::MINIMIZE);
  maximize_button_ =
      InitWindowCaptionButton(views::FrameButtonDisplayType::MAXIMIZE);
  restore_button_ =
      InitWindowCaptionButton(views::FrameButtonDisplayType::RESTORE);
  close_button_ = InitWindowCaptionButton(views::FrameButtonDisplayType::CLOSE);
