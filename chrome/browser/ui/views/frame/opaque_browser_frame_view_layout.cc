...
void OpaqueBrowserFrameViewLayout::Layout(views::View* host) {
  ...
  if (delegate_->ShouldRenderNativeNavButtons()) {
    ...
    minimize_button_->SetImage(
        ...
        button_provider->GetNavButtonImage(views::FRAME_BUTTON_DISPLAY_MINIMIZE,
                                           views::CustomButton::STATE_NORMAL,
    ...
    maximize_button_->SetImage(
        views::CustomButton::STATE_NORMAL,
        button_provider->GetNavButtonImage(views::FRAME_BUTTON_DISPLAY_MAXIMIZE,
                                           views::CustomButton::STATE_NORMAL,
                                           delegate_->GetTopAreaHeight()));
    maximize_button_->SetImage(
        views::CustomButton::STATE_HOVERED,
    ...
    restore_button_->SetImage(
        views::CustomButton::STATE_NORMAL,
        button_provider->GetNavButtonImage(views::FRAME_BUTTON_DISPLAY_RESTORE,
                                           views::CustomButton::STATE_NORMAL,
                                           delegate_->GetTopAreaHeight()));
    restore_button_->SetImage(
        views::CustomButton::STATE_HOVERED,
    ...
    close_button_->SetImage(
        views::CustomButton::STATE_NORMAL,
        button_provider->GetNavButtonImage(views::FRAME_BUTTON_DISPLAY_CLOSE,
                                           views::CustomButton::STATE_NORMAL,
                                           delegate_->GetTopAreaHeight()));
    close_button_->SetImage(
        views::CustomButton::STATE_HOVERED,
