...
FullscreenControlHost* BrowserView::GetFullscreenControlHost() {
  if (!fullscreen_control_host_) {
    ...
    auto* fullscreen_exit_host_view = new views::View();
    // AddChildView() takes ownership of |fullscreen_exit_host_view| and adds it
    // to the BrowserView tree, allowing FullscreenControlHost to receive a
    // fully parented view.
