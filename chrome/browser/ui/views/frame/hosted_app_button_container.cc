...
void HostedAppButtonContainer::RecordContentSettingImageBubbleShown(
    ContentSettingImageModel::ContentSettingImageType type) const {
  UMA_HISTOGRAM_ENUMERATION("HostedAppFrame.ContentSettings.PageActionPressed",
                            type, ContentSettingImageModel::NUM_TYPES);
}
