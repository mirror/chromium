...
void SystemMenuModelBuilder::BuildSystemMenuForBrowserWindow(
  ...
  model->AddItemWithStringId(IDC_MINIMIZE_WINDOW, IDS_ACCNAME_MINIMIZE);
  model->AddItemWithStringId(IDC_MAXIMIZE_WINDOW, IDS_ACCNAME_MAXIMIZE);
  model->AddItemWithStringId(IDC_RESTORE_WINDOW, IDS_ACCNAME_RESTORE);
  model->AddSeparator(ui::NORMAL_SEPARATOR);
#endif
  ...
  model->AddSeparator(ui::NORMAL_SEPARATOR);
  model->AddItemWithStringId(IDC_CLOSE_WINDOW, IDS_ACCNAME_CLOSE);
#endif
