...
#include "chrome/browser/ui/views/frame/native_nav_buttons_frame_view.h"
...
NativeNavButtonsFrameView::NativeNavButtonsFrameView(
    BrowserFrame* frame,
...
void NativeNavButtonsFrameView::MaybeRedrawFrameButtons() {
...
views::ImageButton* NativeNavButtonsFrameView::GetButtonFromDisplayType(
