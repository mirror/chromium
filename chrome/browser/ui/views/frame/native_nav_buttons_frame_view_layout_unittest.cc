...
using NNBFVL = NativeNavButtonsFrameViewLayout;
...
class NativeNavButtonsFrameViewLayoutTest : public views::ViewsTestBase {
 public:
  NativeNavButtonsFrameViewLayoutTest() {}
  ~NativeNavButtonsFrameViewLayoutTest() override {}
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(NativeNavButtonsFrameViewLayoutTest);
};

// Tests layout of native navigation buttons.
TEST_F(NativeNavButtonsFrameViewLayoutTest, NativeNavButtons) {
