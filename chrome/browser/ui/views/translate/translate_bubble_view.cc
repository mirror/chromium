...
TranslateBubbleView::TranslateBubbleView(
    ...
    : LocationBarBubbleDelegateView(anchor_view, anchor_point, web_contents),
      ...
      before_options_menu_button_(NULL),
...
views::View* TranslateBubbleView::CreateViewBeforeTranslate() {
  ...
  before_options_menu_button_ = views::MdTextButton::CreateSecondaryUiButton(
      this,
      l10n_util::GetStringUTF16(IDS_TRANSLATE_BUBBLE_OPTIONS_MENU_BUTTON));
  before_options_menu_button_->set_id(BUTTON_ID_OPTIONS_MENU);
  layout->AddView(before_options_menu_button_);
