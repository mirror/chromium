...
DesktopMediaPickerDialogView::DesktopMediaPickerDialogView(
  ...
  for (auto source_type : source_types_) {
    switch (source_type) {
      ...
      case DesktopMediaID::TYPE_SCREEN:
        if (screen_list) {
          ...
          list_views_.push_back(new DesktopMediaListView(
              this, std::move(screen_list), kGenericScreenStyle,
      ...
      case DesktopMediaID::TYPE_WINDOW:
        if (window_list) {
          ...
          list_views_.push_back(new DesktopMediaListView(
              this, std::move(window_list), kWindowStyle, kWindowStyle,
              window_title_text));
      ...
      case DesktopMediaID::TYPE_WEB_CONTENTS:
        if (tab_list) {
          ...
          views::ScrollView* tab_scroll_view =
              views::ScrollView::CreateScrollViewWithBorder();
          base::string16 tab_title_text = l10n_util::GetStringUTF16(
...
void DesktopMediaPickerViews::Show(
  ...
  dialog_ = new DesktopMediaPickerDialogView(
      web_contents, context, this, app_name, target_name, source_types,
