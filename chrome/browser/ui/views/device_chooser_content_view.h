...
class DeviceChooserContentView : public views::View,
 ...
 private:
  ...
  // These views are owned by their parents.
  ...
  std::unique_ptr<views::LabelButton> re_scan_button_;
  std::unique_ptr<views::Throbber> throbber_;
  std::unique_ptr<views::Label> scanning_label_;
