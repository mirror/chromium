...
void InvertBubbleView::Init() {
  ...
  learn_more_ = views::CreateVectorImageButton(this);
  views::SetImageFromVectorIcon(learn_more_, vector_icons::kHelpOutlineIcon);

  views::Label* header =
      new views::Label(l10n_util::GetStringUTF16(IDS_HIGH_CONTRAST_TRY));
  header->SetFontList(original_font_list);
