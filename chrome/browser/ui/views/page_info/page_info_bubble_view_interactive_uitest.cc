...
void TestOpeningSiteDetails(Browser* browser,
                            const GURL& url,
  ...
  EXPECT_EQ(expected_url, browser->tab_strip_model()
...
IN_PROC_BROWSER_TEST_F(PageInfoBubbleViewBrowserTest, SiteSettingsLink) {
  ...
  TestOpeningSiteDetails(browser(), url, false,
...
IN_PROC_BROWSER_TEST_F(PageInfoBubbleViewBrowserTest,
  ...
  TestOpeningSiteDetails(
      browser(), url, true,
      GURL(chrome::kChromeUISiteDetailsPrefixURL + expected_origin));
}
...
IN_PROC_BROWSER_TEST_F(PageInfoBubbleViewBrowserTest,
  ...
  TestOpeningSiteDetails(browser(), GURL(url::kAboutBlankURL), true,
                         GURL(chrome::kChromeUIContentSettingsURL));
}
