...
class InternalPageInfoBubbleView : public views::BubbleDialogDelegateView {
 public:
  InternalPageInfoBubbleView(Browser* browser, const GURL& url);
...
InternalPageInfoBubbleView::InternalPageInfoBubbleView(Browser* browser,
                                                       const GURL& url)
    : BubbleDialogDelegateView(GetPageInfoAnchorView(browser),
                               views::BubbleBorder::TOP_LEFT) {
  g_shown_bubble_type = PageInfoBubbleView::BUBBLE_INTERNAL_PAGE;
  g_page_info_bubble = this;

  if (!GetAnchorView()) {
    SetAnchorRect(GetPageInfoAnchorRect(browser));
    set_parent_window(
...
views::BubbleDialogDelegateView* PageInfoBubbleView::CreatePageInfoBubble(
  ...
  if (url.SchemeIs(content::kChromeUIScheme) ||
    ...
    return new InternalPageInfoBubbleView(browser, url);
  }
