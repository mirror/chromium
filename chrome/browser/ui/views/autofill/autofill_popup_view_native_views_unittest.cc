...
// An empty string is needed for the mock implementation of GetElidedLabelAt.
// The constref return type means it can't be local, since it needs to outlast
// the call.
const base::string16 kDummyElidedLabel;
