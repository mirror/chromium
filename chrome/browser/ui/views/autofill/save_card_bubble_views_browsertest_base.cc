...
void SaveCardBubbleViewsBrowserTestBase::SetUpOnMainThread() {
  ...
  https_server_->ServeFilesFromSourceDirectory("components/test/data/autofill");
  ...
  // Set up this class as the two ObserverForTest implementations.
  ...
  chrome_autofill_client->SetServiceManagerConnector(connector_.get());
