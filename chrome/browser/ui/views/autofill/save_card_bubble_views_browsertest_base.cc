...
std::string kResponseGetUploadDetailsSuccess =
...
std::string kResponseGetUploadDetailsFailure =
...
SaveCardBubbleViewsBrowserTestBase::DialogEventObserver::DialogEventObserver(
    std::list<SaveCardBubbleViewsBrowserTestBase::DialogEvent> event_sequence)
    : events_(std::move(event_sequence)) {}
SaveCardBubbleViewsBrowserTestBase::DialogEventObserver::
    ~DialogEventObserver() {}

void SaveCardBubbleViewsBrowserTestBase::DialogEventObserver::Wait() {
  if (events_.empty())
    return;
...
void SaveCardBubbleViewsBrowserTestBase::DialogEventObserver::Observe(
    SaveCardBubbleViewsBrowserTestBase::DialogEvent event) {
  if (events_.empty())
    return;
...
void SaveCardBubbleViewsBrowserTestBase::ResetEventObserverForSequence(
  ...
  event_observer_ =
      std::make_unique<DialogEventObserver>(std::move(event_sequence));
}
