...
const AcceleratorMapping kAcceleratorMap[] = {
    ...
    {ui::VKEY_D, ui::EF_SHIFT_DOWN | kPlatformModifier, IDC_BOOKMARK_ALL_TABS},
    ...
    {ui::VKEY_B, ui::EF_SHIFT_DOWN | kPlatformModifier, IDC_SHOW_BOOKMARK_BAR},
...
#endif  // OS_MACOSX
#if !defined(NDEBUG)
    {ui::VKEY_X, ui::EF_SHIFT_DOWN | kPlatformModifier,
     IDC_EVENT_RECORDER_TOOL},
#endif  // !NDEBUG
};
