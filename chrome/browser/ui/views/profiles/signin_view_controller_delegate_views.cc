...
SigninViewControllerDelegate::CreateModalSigninDelegate(
    ...
    Browser* browser,
    signin_metrics::AccessPoint access_point) {
  std::unique_ptr<views::WebView> signin_web_view =
      SigninViewControllerDelegateViews::CreateGaiaWebView(
          nullptr, mode, browser, access_point);
  content::WebContents* signin_web_contents = signin_web_view->GetWebContents();
  SigninViewControllerDelegate* signin_controller_delegate =
      new SigninViewControllerDelegateViews(signin_view_controller,
                                            std::move(signin_web_view), browser,
  ...
  web_modal::WebContentsModalDialogManager* manager =
      web_modal::WebContentsModalDialogManager::FromWebContents(
          signin_web_contents);
  manager->SetDelegate(signin_controller_delegate);
  return signin_controller_delegate;
}
