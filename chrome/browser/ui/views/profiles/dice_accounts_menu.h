...
class DiceAccountsMenu : public ui::SimpleMenuModel::Delegate {
 public:
  // Shows a list of selectable accounts(|accounts|) and a "Use another
  ...
  // |anchor_view|. If the accounts menu is already showing, this function does
  // nothing.
 ...
 private:
  ...
  void ShowMenu(views::View* anchor_view);
