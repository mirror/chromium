...
void UserManager::Show(
  ...
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManager::ShowCocoa(profile_path_to_focus, user_manager_action);
    return;
  }
#endif
...
#if defined(OS_MACOSX)
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManager::OnUserManagerShownCocoa();
    return;
  }
#endif
...
#if defined(OS_MACOSX)
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManagerProfileDialog::ShowReauthDialogWithProfilePathCocoa(
...
#if defined(OS_MACOSX)
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManagerProfileDialog::ShowSigninDialogCocoa(browser_context,
                                                    profile_path, reason);
    return;
  }
#endif
...
#if defined(OS_MACOSX)
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManagerProfileDialog::ShowDialogAndDisplayErrorMessageCocoa(
        browser_context);
    return;
  }
#endif
...
#if defined(OS_MACOSX)
  if (views_mode_controller::IsViewsBrowserCocoa()) {
    UserManagerProfileDialog::HideDialogCocoa();
    return;
  }
#endif
