...
views::View* ProfileChooserView::CreateDiceSyncErrorView(
  ...
  hover_button->SetStyle(HoverButton::HOVER_BUTTON_STYLE_ERROR);
...
views::View* ProfileChooserView::CreateDiceSigninView() {
  ...
  // A border around the sign-in button is created. HoverButton already has it's
  ...
  first_account_button->SetStyle(HoverButton::HOVER_BUTTON_STYLE_BLUEBUTTON);
  ...
  HoverButton* sync_to_another_account_button = new HoverButton(
      this,
      gfx::CreateVectorIcon(kSyncSwitchAccountIcon, kSmallIconSize,
                            gfx::kChromeIconGrey),
      l10n_util::GetStringUTF16(
