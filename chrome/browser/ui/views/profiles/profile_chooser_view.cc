...
views::View* ProfileChooserView::CreateCurrentProfileView(
  ...
  int profile_card_height =
      kImageSideLength + 2 * kBadgeSpacing + 2 * vertical_spacing_small;
  ...
  BadgedProfilePhoto* current_profile_photo =
      new BadgedProfilePhoto(this, GetProfileBadgeType(*browser_->profile()),
                             avatar_item.icon, kImageSideLength, kBadgeSpacing);
