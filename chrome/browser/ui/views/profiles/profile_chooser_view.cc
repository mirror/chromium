...
views::View* ProfileChooserView::CreateDiceSigninView() {
  ...
  gfx::Image account_icon =
      AccountTrackerServiceFactory::GetForProfile(browser_->profile())
          ->GetAccountImage(dice_sync_promo_accounts_[0].account_id);
