...
class TitleCard : public views::View {
 ...
 private:
  void Layout() override {
    ...
    // amount of space between the them.
    ...
    // Because the title is centered, the unavailable space is really on the
    // left and the right of the title.
    const int unavailable_space = 2 * label_padding;
