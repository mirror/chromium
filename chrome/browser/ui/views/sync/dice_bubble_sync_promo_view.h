...
// A personalized sync promo used whenDesktop Identity Consistency is enabled.
// It display a message informing the user the benefits of enabling sync and
// a button that allows the user to enable sync.
// The button has 2 different displays:
// * When Chrome has no accounts, then the promo button is a MD button
//   allowing the user to sign in to Chrome.
// * When Chrome has at least one account, then the promo button is personalized
