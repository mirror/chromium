...
DiceSigninButton::DiceSigninButton(const AccountInfo& account,
                                   ...
                                   bool display_drop_down_arrow)
    : views::MdTextButton(button_listener, views::style::CONTEXT_BUTTON),
      account_(account) {
  DCHECK(account_ || !display_drop_down_arrow)
      << "Cannot display a drop down arrow when there is no account.";
