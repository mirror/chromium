...
class DiceSigninButtonx : public views::MdTextButton {
 public:
  DiceSigninButtonx(views::ButtonListener* listener,
  ...
  ~DiceSigninButtonx() override = default;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DiceSigninButtonx);
};
...
DiceBubbleSyncPromoView::DiceBubbleSyncPromoView(
  ...
  AddChildView(new DiceSigninButtonx(this, this));
}
