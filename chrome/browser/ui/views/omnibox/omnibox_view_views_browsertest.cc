...
IN_PROC_BROWSER_TEST_F(OmniboxViewViewsTest, FriendlyAccessibleLabel) {
  ...
  EXPECT_EQ("both", node_data.GetStringAttribute(
                        ax::mojom::StringAttribute::AUTO_COMPLETE));
...
IN_PROC_BROWSER_TEST_F(OmniboxViewViewsTest, AccessiblePopup) {
  ...
  EXPECT_FALSE(popup_node_data_1.HasState(ax::mojom::State::EXPANDED));
  EXPECT_TRUE(popup_node_data_1.HasState(ax::mojom::State::COLLAPSED));
  EXPECT_TRUE(popup_node_data_1.HasState(ax::mojom::State::INVISIBLE));
  ...
  EXPECT_TRUE(popup_node_data_2.HasState(ax::mojom::State::EXPANDED));
  EXPECT_FALSE(popup_node_data_2.HasState(ax::mojom::State::COLLAPSED));
  EXPECT_FALSE(popup_node_data_2.HasState(ax::mojom::State::INVISIBLE));
}
