...
OmniboxTextView::OmniboxTextView(const gfx::FontList& font_list)
...
void OmniboxTextView::SetHighlightState(
...
void OmniboxTextView::SetFontList(const gfx::FontList& font_list) {
  font_list_ = font_list;
  font_height_ =
