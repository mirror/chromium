...
class OmniboxResultView : public views::View,
 ...
 private:
  ...
  std::unique_ptr<OmniboxTextView> CreateOmniboxTextView(
  ...
  mutable std::unique_ptr<OmniboxTextView> content_view_;
  mutable std::unique_ptr<OmniboxTextView> description_view_;
  mutable std::unique_ptr<OmniboxTextView> separator_view_;
  mutable std::unique_ptr<OmniboxTextView> keyword_content_view_;
  mutable std::unique_ptr<OmniboxTextView> keyword_description_view_;
