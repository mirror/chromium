...
std::unique_ptr<views::LabelButton> CreateWin10StyleButton(
  ...
  // Request specific 32pt height, 166pt width.
   ...
   protected:
    ...
    class CaretBorder : public views::Border {
     public:
      ...
      // account for the side from which the caret extends.
      // |caret_border_insets| specifies how far into the caret the border
      // around the popup should extend. |rotation_amount| specifies how much
      // the caret icon must be rotated to have the desired orientation.
...
TryChromeDialog::Context::TaskbarCalculator::CaretBorder::CaretBorder(
    ...
    : calculator_(calculator),
      insets_(insets),
      caret_border_insets_(caret_border_insets),
...
TryChromeDialog::Context::TopTaskbarCalculator::MakeBorder() {
  return std::make_unique<CaretBorder>(
      ...
      gfx::Insets(0, 1, 0, 1), CaretBorder::RotationAmount::k180Degrees);
}
...
TryChromeDialog::Context::LeftTaskbarCalculator::MakeBorder() {
  return std::make_unique<CaretBorder>(
      ...
      gfx::Insets(1, 0, 1, 0), CaretBorder::RotationAmount::k90Degrees);
}
...
TryChromeDialog::Context::BottomTaskbarCalculator::MakeBorder() {
  return std::make_unique<CaretBorder>(
      ...
      gfx::Insets(0, 1, 0, 1), CaretBorder::RotationAmount::kNone);
}
...
TryChromeDialog::Context::RightTaskbarCalculator::MakeBorder() {
  return std::make_unique<CaretBorder>(
      ...
      gfx::Insets(1, 0, 1, 0), CaretBorder::RotationAmount::k270Degrees);
}
