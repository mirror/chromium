...
class LocationBarView : public LocationBar,
 ...
 public:
  ...
  // Shows the first inactive LocationBarBubbleDelegateView for accessibility.
  bool ShowFirstInactiveLocationBarBubbleDelegateViewForAccessibility();
 ...
 private:
  ...
  //    - |view is visible
  //    - |view has a bubble visible, inactive widget
