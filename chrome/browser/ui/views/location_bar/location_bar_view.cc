...
void LocationBarView::ShowFindBar() {
  FindBarController* controller = browser_->GetFindBarController();
  controller->Show();
  find_bar_image_view_->SetVisible(controller->find_bar()->IsFindBarVisible());
  SchedulePaint();
}
