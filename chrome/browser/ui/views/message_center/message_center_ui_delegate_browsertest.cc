...
class MessageCenterUiDelegateTest : public InProcessBrowserTest {
 public:
  MessageCenterUiDelegateTest() {}
  ~MessageCenterUiDelegateTest() override {}
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(MessageCenterUiDelegateTest);
};

// TODO(dewittj): More exhaustive testing.
IN_PROC_BROWSER_TEST_F(MessageCenterUiDelegateTest, WebNotifications) {
...
IN_PROC_BROWSER_TEST_F(MessageCenterUiDelegateTest,
                       WebNotificationPopupBubble) {
  std::unique_ptr<MessageCenterUiDelegate> delegate(
      new MessageCenterUiDelegate());
...
IN_PROC_BROWSER_TEST_F(MessageCenterUiDelegateTest, ManyPopupNotifications) {
  std::unique_ptr<MessageCenterUiDelegate> delegate(
      new MessageCenterUiDelegate());
