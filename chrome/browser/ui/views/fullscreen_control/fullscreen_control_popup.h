...
////////////////////////////////////////////////////////////////////////////////
//
// FullscreenControlPopup implements the visual feedback to indicate that
...
class FullscreenControlPopup : public gfx::AnimationDelegate {
 public:
  explicit FullscreenControlPopup(gfx::NativeView parent_view,
 ...
 private:
  ...
  FullscreenControlView* control_view_;
