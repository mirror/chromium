...
void Tab::Layout() {
  ...
  const int extra_padding =
      needs_extra_padding_ ? kExtraLeftPaddingToBalanceCloseButtonPadding : 0;
...
void Tab::UpdateIconVisibility() {
  ...
  if (is_pinned) {
    ...
    if (is_active) {
      ...
      // See comment for |needs_extra_padding_|.
      ...
      // favicon. See comment for |needs_extra_padding_|.
    ...
    needs_extra_padding_ = showing_close_button_;
  }
}
