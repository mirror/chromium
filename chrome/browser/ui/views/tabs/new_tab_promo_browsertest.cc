...
class NewTabPromoBrowserTest : public InProcessBrowserTest {
 public:
  NewTabPromoBrowserTest() = default;
  ~NewTabPromoBrowserTest() override = default;
...
IN_PROC_BROWSER_TEST_F(NewTabPromoBrowserTest, TestShowPromo) {
