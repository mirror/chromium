...
TabIcon::FaviconEffect TabIcon::GetFaviconEffect() {
  ...
  if (switch_value == switches::kRecognizableTabFaviconFadingWeak)
    return TabIcon::FaviconEffect::kFadingWeak;
  if (switch_value == switches::kRecognizableTabFaviconFadingStrong)
    return TabIcon::FaviconEffect::kFadingStrong;
  if (switch_value == switches::kRecognizableTabFaviconScale)
