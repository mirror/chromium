...
class GroupedTabStripController::TabContextMenuContents
 ...
 public:
  TabContextMenuContents(Tab* tab,
                         GroupedTabStripController* controller)
      : tab_(tab),
...
GroupedTabStripController::GroupedTabStripController(TabStripGrouper* grouper,
                                                     BrowserView* browser_view)
    : grouper_(grouper),
      model_(grouper->model()),
      tabstrip_(NULL),
...
GroupedTabStripController::GetSelectionModel() const {
...
void GroupedTabStripController::OnDropIndexUpdate(int index,
                                                  bool drop_before) {
...
void GroupedTabStripController::AddTab(WebContents* contents,
                                       int index,
                                       bool is_active) {
  // Cancel any pending tab transition.
  hover_tab_selector_.CancelTabTransition();
