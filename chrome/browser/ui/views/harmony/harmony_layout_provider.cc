...
int HarmonyLayoutProvider::GetDistanceMetric(int metric) const {
  ...
  switch (metric) {
    ...
    case views::DISTANCE_DIALOG_CONTROL_CONTENT_TO_BUTTONS:
      return kHarmonyLayoutUnit * 3 / 2;
    case views::DISTANCE_DIALOG_TEXT_CONTENT_TO_BUTTONS:
      return kHarmonyLayoutUnit;
    case views::DISTANCE_DIALOG_TITLE_TO_CONTROL_CONTENT:
      return kHarmonyLayoutUnit;
    case views::DISTANCE_DIALOG_TITLE_TO_TEXT_CONTENT:
      return kHarmonyLayoutUnit / 2;
