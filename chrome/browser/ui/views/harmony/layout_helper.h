...
// Configure a five-column ColumnSet for the standard layout with:
// {Margin, Label, Padding, Textfield, Padding}. The Margin column can be used
// to host column-spanning Views.
