...
#ifndef CHROME_BROWSER_UI_VIEWS_FULLSCREEN_CONTROL_HOST_H_
#define CHROME_BROWSER_UI_VIEWS_FULLSCREEN_CONTROL_HOST_H_
...
#endif  // CHROME_BROWSER_UI_VIEWS_FULLSCREEN_CONTROL_HOST_H_
