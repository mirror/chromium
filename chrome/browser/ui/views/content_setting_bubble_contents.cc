...
void ContentSettingBubbleContents::ListItemAdded(
    const ContentSettingBubbleModel::ListItem& item) {
...
void ContentSettingBubbleContents::ListItemWillBeRemovedAt(
    const ContentSettingBubbleModel::ListItem& item,
    int index) {
  DCHECK(list_item_container_);
...
void ContentSettingBubbleContents::Init() {
  ...
  if (list_item_container_)
    content_setting_bubble_model_->AddObserver(this);
}
