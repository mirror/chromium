...
enum class RelaunchNotification {
...
RelaunchNotification ReadPreference() {
  switch (g_browser_process->local_state()->GetInteger(
      prefs::kRelaunchNotification)) {
    case 1:
      return RelaunchNotification::kRecommendedBubble;
    case 2:
      return RelaunchNotification::kRequiredDialog;
  }
  return RelaunchNotification::kChromeMenuOnly;
}
...
void RelaunchNotificationController::HandleCurrentStyle() {
  ...
  switch (ReadPreference()) {
    case RelaunchNotification::kChromeMenuOnly:
      DCHECK_EQ(notification_style, NotificationStyle::kNone);
      break;
    case RelaunchNotification::kRecommendedBubble:
      notification_style = NotificationStyle::kRecommended;
      break;
    case RelaunchNotification::kRequiredDialog:
