...
class PageInfo : public TabSpecificContentSettings::SiteDataObserver,
 ...
 public:
  ...
  // This method is called when PageInfo is shown with "Change password" button
  // on it.
  void OnChangePasswordButtonShown(content::WebContents* web_contents);
  ...
  // This method is called when the user pressed "This site is legitimate"
  // button.
