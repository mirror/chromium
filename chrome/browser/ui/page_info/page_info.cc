...
void PageInfo::OnChangePasswordButtonShown(content::WebContents* web_contents) {
  DCHECK(password_protection_service_);
  password_protection_service_->OnChangePasswordButtonShownInPageInfo(
      web_contents);
}
...
void PageInfo::OnChangePasswordButtonPressed(
    content::WebContents* web_contents) {
  DCHECK(password_protection_service_);
  password_protection_service_->OnPageInfoChangePasswordButtonPressed(
      web_contents);
}

void PageInfo::OnIgnorePasswordWarningButtonPressed(
    content::WebContents* web_contents) {
  DCHECK(password_protection_service_);
  password_protection_service_->OnPageInfoIgnoreButtonPressed(web_contents);
}
...
void PageInfo::PresentSiteIdentity() {
  ...
  if (show_change_password_button_)
    OnChangePasswordButtonShown(web_contents());
}
