...
const PermissionsUIInfo kPermissionsUIInfo[] = {
    {CONTENT_SETTINGS_TYPE_COOKIES, 0, &kCookieIcon},
    {CONTENT_SETTINGS_TYPE_IMAGES, IDS_PAGE_INFO_TYPE_IMAGES, &kImageIcon},
    {CONTENT_SETTINGS_TYPE_JAVASCRIPT, IDS_PAGE_INFO_TYPE_JAVASCRIPT,
     &kCodeIcon},
    {CONTENT_SETTINGS_TYPE_POPUPS, IDS_PAGE_INFO_TYPE_POPUPS, &kLaunchIcon},
#if BUILDFLAG(ENABLE_PLUGINS)
    {CONTENT_SETTINGS_TYPE_PLUGINS, IDS_PAGE_INFO_TYPE_FLASH, &kExtensionIcon},
#endif
    ...
    {CONTENT_SETTINGS_TYPE_AUTOMATIC_DOWNLOADS,
     IDS_AUTOMATIC_DOWNLOADS_TAB_LABEL, &kFileDownloadIcon},
    ...
    // Android ignores these icons, so we can specify an empty icon here.
    {CONTENT_SETTINGS_TYPE_AUTOPLAY, IDS_PAGE_INFO_TYPE_AUTOPLAY,
     &gfx::kNoneIcon},
    {CONTENT_SETTINGS_TYPE_ADS, IDS_PAGE_INFO_TYPE_ADS,
     &kSubresourceFilterActiveIcon},
    {CONTENT_SETTINGS_TYPE_SOUND, IDS_PAGE_INFO_TYPE_SOUND, &kVolumeUpIcon},
...
const gfx::ImageSkia PageInfoUI::GetPermissionIcon(const PermissionInfo& info) {
  ...
  if (setting == CONTENT_SETTING_BLOCK) {
    return gfx::CreateVectorIconWithBadge(
        *vector, 16, SkColorSetARGB(138, 0, 0, 0), kBlockedBadgeIcon);
  }
...
const gfx::ImageSkia PageInfoUI::GetChosenObjectIcon(
  ...
  if (deleted)
    return gfx::CreateVectorIconWithBadge(
        *object.ui_info.icon, 16, gfx::kChromeIconGrey, kBlockedBadgeIcon);

  return gfx::CreateVectorIcon(*object.ui_info.icon, 16, gfx::kChromeIconGrey);
}
