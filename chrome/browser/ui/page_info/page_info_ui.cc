...
const gfx::ImageSkia PageInfoUI::GetPermissionIcon(const PermissionInfo& info,
  ...
  switch (info.type) {
    ...
    case CONTENT_SETTINGS_TYPE_PLUGINS:
      vector = &kExtensionIcon;
      break;
#endif
    case CONTENT_SETTINGS_TYPE_GEOLOCATION:
      vector = &vector_icons::kLocationOnIcon;
      break;
    case CONTENT_SETTINGS_TYPE_NOTIFICATIONS:
      vector = &vector_icons::kNotificationsIcon;
      break;
    case CONTENT_SETTINGS_TYPE_MEDIASTREAM_MIC:
      vector = &vector_icons::kMicIcon;
      break;
    case CONTENT_SETTINGS_TYPE_MEDIASTREAM_CAMERA:
      vector = &vector_icons::kVideocamIcon;
      break;
    case CONTENT_SETTINGS_TYPE_AUTOMATIC_DOWNLOADS:
      vector = &kFileDownloadIcon;
      break;
    case CONTENT_SETTINGS_TYPE_MIDI_SYSEX:
      vector = &vector_icons::kMidiIcon;
      break;
    ...
    case CONTENT_SETTINGS_TYPE_SOUND:
      vector = &kVolumeUpIcon;
      break;
    case CONTENT_SETTINGS_TYPE_CLIPBOARD_READ:
      vector = &kPageInfoContentPasteIcon;
      break;
    default:
  ...
  if (setting == CONTENT_SETTING_BLOCK) {
    return gfx::CreateVectorIconWithBadge(*vector, kIconSize, icon_color,
                                          kBlockedBadgeIcon);
  }
  return gfx::CreateVectorIcon(*vector, kIconSize, icon_color);
}
...
const gfx::ImageSkia PageInfoUI::GetChosenObjectIcon(
  ...
  const gfx::VectorIcon* vector = &vector_icons::kUsbIcon;
  if (deleted) {
    return gfx::CreateVectorIconWithBadge(*vector, kIconSize, icon_color,
                                          kBlockedBadgeIcon);
  }
...
// static
const gfx::ImageSkia PageInfoUI::GetCertificateIcon(const SkColor icon_color) {
  return gfx::CreateVectorIcon(kCertificateIcon, kIconSize, icon_color);
}

// static
const gfx::ImageSkia PageInfoUI::GetSiteSettingsIcon(const SkColor icon_color) {
  return gfx::CreateVectorIcon(kSettingsIcon, kIconSize, icon_color);
}
#endif
