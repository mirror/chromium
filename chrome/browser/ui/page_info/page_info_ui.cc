...
const gfx::ImageSkia PageInfoUI::GetPermissionIcon(const PermissionInfo& info) {
  ...
  if (setting == CONTENT_SETTING_BLOCK) {
    return gfx::CreateVectorIconWithBadge(*vector, 16, kIconColor,
                                          kBlockedBadgeIcon);
  }
  return gfx::CreateVectorIcon(*vector, 16, kIconColor);
}
...
const gfx::ImageSkia PageInfoUI::GetCertificateIcon() {
  return gfx::CreateVectorIcon(kCertificateIcon, 16, kIconColor);
}

// static
const gfx::ImageSkia PageInfoUI::GetSiteSettingsIcon() {
  return gfx::CreateVectorIcon(kSettingsIcon, 16, kIconColor);
}
#endif
