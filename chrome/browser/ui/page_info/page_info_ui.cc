...
#if !defined(OS_ANDROID)
// TODO(https://crbug.com/783546): Replace with a more general way to retrieve
// icon colors.
constexpr SkColor kIconColor = SkColorSetRGB(117, 117, 117);
...
const gfx::ImageSkia PageInfoUI::GetPermissionIcon(const PermissionInfo& info) {
  ...
  if (setting == CONTENT_SETTING_BLOCK) {
    return gfx::CreateVectorIconWithBadge(*vector, kIconSize, kIconColor,
                                          kBlockedBadgeIcon);
  }
  return gfx::CreateVectorIcon(*vector, kIconSize, kIconColor);
}
...
const gfx::ImageSkia PageInfoUI::GetCertificateIcon() {
  return gfx::CreateVectorIcon(kCertificateIcon, kIconSize, kIconColor);
}

// static
const gfx::ImageSkia PageInfoUI::GetSiteSettingsIcon() {
  return gfx::CreateVectorIcon(kSettingsIcon, kIconSize, kIconColor);
}
#endif
