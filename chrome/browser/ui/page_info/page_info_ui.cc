...
std::unique_ptr<PageInfoUI::SecurityDescription> CreateSecurityDescription(
    PageInfoUI::OverallSecurityState state,
    int summary_id,
    int details_id) {
  std::unique_ptr<PageInfoUI::SecurityDescription> security_description(
      new PageInfoUI::SecurityDescription());
  security_description->state = state;
...
PageInfoUI::IdentityInfo::GetSecurityDescription() const {
  ...
  switch (identity_status) {
    case PageInfo::SITE_IDENTITY_STATUS_INTERNAL_PAGE:
      ...
      return CreateSecurityDescription(OverallSecurityState::kSecure,
    ...
    case PageInfo::SITE_IDENTITY_STATUS_ADMIN_PROVIDED_CERT:
      switch (connection_status) {
        case PageInfo::SITE_CONNECTION_STATUS_INSECURE_ACTIVE_SUBRESOURCE:
          return CreateSecurityDescription(OverallSecurityState::kInsecure,
        ...
        case PageInfo::SITE_CONNECTION_STATUS_INSECURE_PASSIVE_SUBRESOURCE:
          return CreateSecurityDescription(OverallSecurityState::kNeutral,
                                           IDS_PAGE_INFO_MIXED_CONTENT_SUMMARY,
    ...
    case PageInfo::SITE_IDENTITY_STATUS_SOCIAL_ENGINEERING:
      return CreateSecurityDescription(
          OverallSecurityState::kInsecure,
