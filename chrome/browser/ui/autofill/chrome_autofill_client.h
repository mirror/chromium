...
#endif  // !defined(OS_ANDROID)
{
 ...
 private:
  ...
  // Sets a connector to expose test services; for example, allows using a fake
  // geolocation service when loading risk data.
  void SetServiceManagerConnector(service_manager::Connector* connector);
  ...
  // If set, the connector to use when loading risk data.
