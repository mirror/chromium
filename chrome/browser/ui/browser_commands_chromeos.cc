...
void TakeScreenshot() {
  ...
  //     ash::Shell::Get()->screenshot_delegate();
  // if (screenshot_delegate && screenshot_delegate->CanTakeScreenshot())
  // TODO(jamescook): Call directly into ChromeScreenshotGrabber.
  ash::Shell::Get()->screenshot_controller()->TakeScreenshotForAllRootWindows();
}
