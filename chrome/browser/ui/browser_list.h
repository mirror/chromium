...
class BrowserList {
 public:
  ...
  // Returns iterated access to the list of browsers that are currently in
  // the closing state.
  const_iterator currently_closing_browsers_begin() const {
    return currently_closing_browsers_.begin();
  }
  const_iterator currently_closing_browsers_end() const {
    return currently_closing_browsers_.end();
  }
