...
class TabStripModelImpl : public TabStripModel {
 public:
  ...
  TabStripModelDelegate* delegate() const override { return delegate_; }
  ...
  int count() const override { return static_cast<int>(contents_data_.size()); }
  bool empty() const override { return contents_data_.empty(); }

  // Retrieve the Profile associated with this TabStripModel.
  Profile* profile() const override { return profile_; }
  ...
  int active_index() const override { return selection_model_.active(); }
  ...
  bool closing_all() const override { return closing_all_; }
