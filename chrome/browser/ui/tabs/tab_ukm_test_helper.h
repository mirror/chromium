...
class UkmEntryChecker {
 public:
  ...
  // happens.
  // This function increments |num_entries_| for |entry_name| by 1 and checks
  // the new value of |num_entries_| is the same as number of recorded entries
  // in ukm.
  ...
  // happens. We use source ids to identify multiple events.
  // This function increments |num_entries_| for |entry_name| by the size of
  // |expected_data| and checks the new value of |num_entries_| is the same as
  // number of recorded entries in  ukm.
  ...
  // This function only checks if number of entries in ukm is the same as
  // |new_num_entries| + |num_entries_| (for |entry_name|), it does not update
  // |num_entries_|.
