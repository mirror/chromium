...
TabStripModelImpl::WebContentsData::WebContentsData(TabStripModel* tab_strip_model,
...
TabStripModelImpl::TabStripModelImpl(TabStripModelDelegate* delegate, Profile* profile)
    : delegate_(delegate),
      profile_(profile),
      weak_factory_(this) {
  DCHECK(delegate_);
...
WebContents* TabStripModelImpl::ReplaceWebContentsAt(int index,
...
int TabStripModelImpl::GetIndexOfWebContents(const WebContents* contents) const {
...
int TabStripModelImpl::GetIndexOfNextWebContentsOpenedBy(const WebContents* opener,
                                                     int start_index,
...
int TabStripModelImpl::GetIndexOfLastWebContentsOpenedBy(const WebContents* opener,
...
void TabStripModelImpl::SetSelectionFromModel(
...
void TabStripModelImpl::SetSelection(
...
// static
bool TabStripModelImpl::OpenerMatches(const std::unique_ptr<WebContentsData>& data,
