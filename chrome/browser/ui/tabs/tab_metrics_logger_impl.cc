...
// Returns the NavigationSource corresponding to the PageTransition. Currently
// this is a fairly literal conversion. Only considers main-frame transitions.
...
// static
TabMetricsEvent::NavigationSource
TabMetricsLoggerImpl::GetNavigationSourceFromPageTransition(
    ui::PageTransition page_transition) {
  // Exposed for testing.
  return ::GetNavigationSourceFromPageTransition(page_transition);
}
