...
class TabDataExperimental::ContentsWatcher : public content::WebContentsObserver {
 public:
...
TabDataExperimental::TabDataExperimental(
    TabDataExperimental&&) noexcept = default;

TabDataExperimental::TabDataExperimental(content::WebContents* contents,
                                         TabStripModel* model)
    : type_(Type::kSingle), contents_(contents),
      contents_watcher_(base::MakeUnique<ContentsWatcher>(model, contents)) {
}

TabDataExperimental::~TabDataExperimental() = default;

TabDataExperimental& TabDataExperimental::operator=(TabDataExperimental&&) = default;
