...
TEST_F(TabsTrackerTest, Basic) {
  ...
  TestWebContents* test_contents_1 =
      TestWebContents::Create(profile(), nullptr);
  TestWebContents* test_contents_2 =
      TestWebContents::Create(profile(), nullptr);
  ...
  test_contents_1->NavigateAndCommit(GURL("https://example.com"));
  test_contents_2->NavigateAndCommit(GURL("https://example.com/2"));
