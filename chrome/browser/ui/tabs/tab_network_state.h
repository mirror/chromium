...
#ifndef CHROME_BROWSER_UI_VIEWS_TABS_TAB_NETWORK_STATE_H_
#define CHROME_BROWSER_UI_VIEWS_TABS_TAB_NETWORK_STATE_H_
...
#endif  // CHROME_BROWSER_UI_VIEWS_TABS_TAB_NETWORK_STATE_H_
