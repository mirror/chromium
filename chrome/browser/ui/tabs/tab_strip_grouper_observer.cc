...
void TabStripGrouperObserver::ItemUpdatedAt(
    int index, TabChangeType change_type) {}

void TabStripGrouperObserver::ItemSelectionChanged(const ui::ListSelectionModel& old_model) {}
