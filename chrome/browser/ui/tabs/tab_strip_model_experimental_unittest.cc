...
TEST_F(TabStripModelExperimentalTest, ViewIterator) {
  ...
  AppendData(std::make_unique<TabDataExperimental>(
      nullptr, TabDataExperimental::Type::kSingle, contents0, &model()));
  ...
  auto hub = std::make_unique<TabDataExperimental>(
      nullptr, TabDataExperimental::Type::kHubAndSpoke, contents1, &model());
  hub->children().push_back(std::make_unique<TabDataExperimental>(
      hub.get(), TabDataExperimental::Type::kSingle, contents2, &model()));
  hub->children().push_back(std::make_unique<TabDataExperimental>(
      hub.get(), TabDataExperimental::Type::kSingle, contents3, &model()));
  ...
  group->children().push_back(std::make_unique<TabDataExperimental>(
      group.get(), TabDataExperimental::Type::kSingle, contents4, &model()));
  group->children().push_back(std::make_unique<TabDataExperimental>(
      group.get(), TabDataExperimental::Type::kSingle, contents5, &model()));
  ...
  expected.emplace_back(TabDataExperimental::Type::kSingle, contents0);
  expected.emplace_back(TabDataExperimental::Type::kHubAndSpoke, contents1);
  expected.emplace_back(TabDataExperimental::Type::kSingle, contents2);
  expected.emplace_back(TabDataExperimental::Type::kSingle, contents3);
  expected.emplace_back(TabDataExperimental::Type::kSingle, contents4);
  expected.emplace_back(TabDataExperimental::Type::kSingle, contents5);
