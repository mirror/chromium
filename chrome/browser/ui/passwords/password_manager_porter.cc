...
void PasswordManagerPorter::ImportPasswordsFromPath(
  ...
  scoped_refptr<PasswordManagerPorter::PasswordImportConsumer> form_consumer(
      new PasswordManagerPorter::PasswordImportConsumer(profile));
  password_manager::PasswordImporter::Import(
      path, base::Bind(
                &PasswordManagerPorter::PasswordImportConsumer::ConsumePassword,
                form_consumer));
}
...
PasswordManagerPorter::PasswordImportConsumer::PasswordImportConsumer(
    Profile* profile)
    : profile_(profile) {}

void PasswordManagerPorter::PasswordImportConsumer::ConsumePassword(
