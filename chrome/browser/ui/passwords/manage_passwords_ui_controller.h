...
class ManagePasswordsUIController
 ...
 public:
  ...
  bool IsPasswordRevealedWhenOpened() override;
 ...
 private:
  ...
  // Shows an authentication dialog and re-opens the dialog. The password in the
  // reopened bubble will be revealed if the authentication was successful.
  void RequestAuthenticationAndReopensBubbleImpl();
  ...
  bool reveal_password_when_next_bubble_is_opened_;
