...
class PasswordManagerPresenter
 ...
 public:
  ...
  void Initialize(password_manager::ExportFlow* export_flow,
 ...
 private:
  ...
  // Corresponding ExportFlow implementation, to be set through Initialize.
  password_manager::ExportFlow* export_flow_;

  // Corresponding ImportFlow implementation, to be set through Initialize.
  password_manager::ImportFlow* import_flow_;
