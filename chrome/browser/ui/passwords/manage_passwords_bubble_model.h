...
class ManagePasswordsBubbleModel {
 public:
  ...
  // Returns true iff passwords viewing is allowed. If viewing was locked, the
  // methods calls OS authentication.
  ...
  // Requests an authentication to view passwords in a prompt and returns true
