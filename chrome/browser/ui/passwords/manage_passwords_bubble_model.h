...
class ManagePasswordsBubbleModel {
 public:
  ...
  // method calls re-authentication and re-opens the bubble (the password will
  // be revealed if the re-auth is successful).
  bool TryToViewPasswords() const;

  // Returns true iff the password value should be revealed by default.
  bool PasswordIsRevealedByDefault();
