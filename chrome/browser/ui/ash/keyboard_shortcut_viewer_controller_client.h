...
class KeyboardShortcutViewerControllerClient
 ...
 private:
  ...
  // ShowKeyboardShortcutViewer() of the controller.
  keyboard_shortcut_viewer::KSVItemInfoPtrList GetChromeShortcutsMetadata();
  ...
  keyboard_shortcut_viewer::KSVItemInfoList chrome_shortcuts_metadata_;
