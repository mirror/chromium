...
class WallpaperControllerClient : public ash::mojom::WallpaperControllerClient,
 ...
 public:
  ...
  // and changing wallpaper is allowed per the user type.
 ...
 private:
  // The implementation of |SetPolicyWallpaper|. Called when |CanGetFilesId|
  // returns true.
  void SetPolicyWallpaperImpl(const AccountId& account_id,
                              std::unique_ptr<std::string> data);
