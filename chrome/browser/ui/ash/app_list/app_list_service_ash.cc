...
void AppListServiceAsh::ShowAndSwitchToState(ash::mojom::AppListState state) {
  ...
  if (state == ash::mojom::AppListState::INVALID_STATE)
    return;
...
void AppListServiceAsh::ShowForAppInstall(Profile* profile,
  ...
  if (app_list::features::IsFullscreenAppListEnabled())
    return;
  ShowAndSwitchToState(ash::mojom::AppListState::STATE_APPS);
