...
void AppListControllerDelegateAsh::GetAppListDisplayId(
    GetAppListDisplayIdCallback callback) {
  auto* screen = display::Screen::GetScreen();
  int64_t display_id =
      screen ? screen->GetDisplayNearestWindow(app_list_presenter_->GetWindow())
                   .id()
