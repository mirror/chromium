...
//JAMES
  // LOG(ERROR) << "JAMES registering prefs in chrome";
  // registry->RegisterIntegerPref(ash::prefs::kLogoutDialogDurationMs, 20000);
  // registry->RegisterBooleanPref(ash::prefs::kShowLogoutButtonInTray, false);
}
