...
class ChromeScreenshotGrabber : public ash::ScreenshotDelegate {
 public:
  ...
  void AddTestObserver(ChromeScreenshotGrabberTestObserver* observer);
  void RemoveTestObserver(ChromeScreenshotGrabberTestObserver* observer);
 ...
 private:
  ...
  base::ObserverList<ChromeScreenshotGrabberTestObserver> test_observers_;
