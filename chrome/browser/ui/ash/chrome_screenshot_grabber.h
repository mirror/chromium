...
class ChromeScreenshotGrabber : public ash::ScreenshotDelegate,
 ...
 private:
  ...
  //
  // |screenshot_path| is screenshot path on the drive.
  ...
  // Read a screenshot file in |screenshot_cache_path|, and run
  // DecodeScreenshotFileForPreview.
  //
  // |screenshot_path| and |screenshot_cache_path| are different when the
  // screenshot is saved to the drive. Otherwise, they should be same.
  ...
  // Decode |image_data| and run OnScreenshotFileForPreviewDecoded.
  // Altough |image_data| is originally generated by the screenshot grabber,
