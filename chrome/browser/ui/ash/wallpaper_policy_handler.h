 ...
 public:
  ...
  class Delegate {
   public:
    ...
    virtual void OnShowUserWallpaperOnLoginChanged() = 0;
  ...
  // Returns true if user wallpapers should be shown on the login screen.
  bool ShouldShowUserWallpaperOnLogin();
