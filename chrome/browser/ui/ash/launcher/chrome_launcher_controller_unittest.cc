...
TEST_F(ChromeLauncherControllerTest, MergePolicyAndUserPrefPinnedApps) {
  ...
  EXPECT_EQ("Back, AppList, App2, App4, App1, Chrome, App3", GetPinnedAppStatus());
}
...
TEST_P(ChromeLauncherControllerWithArcTest, ArcAppPin) {
  ...
  EXPECT_EQ("Back, AppList, Chrome, App1, Fake App 0, App2", GetPinnedAppStatus());
  ...
  launcher_controller_->PinAppWithID(arc_app_id);
  EXPECT_EQ("Back, AppList, Chrome, App1, App2, Fake App 0", GetPinnedAppStatus());
  EnablePlayStore(false);
  EXPECT_EQ("Back, AppList, Chrome, App1, App2", GetPinnedAppStatus());
  EnablePlayStore(true);
  EXPECT_EQ("Back, AppList, Chrome, App1, App2", GetPinnedAppStatus());
...
TEST_F(ChromeLauncherControllerTest,
  ...
  extension_service_->AddExtension(extension3_.get());
  EXPECT_EQ("Back, AppList, Chrome, App1, App3, *platform_app", GetPinnedAppStatus());
  ...
  InsertAddPinChange(&sync_list1, 2, extension1_->id());
  SendPinChanges(sync_list1, true);
  EXPECT_EQ("Back, AppList, Chrome, App3, *Platform_App, App1", GetPinnedAppStatus());
  ...
  InsertAddPinChange(&sync_list2, 1, extension1_->id());
  SendPinChanges(sync_list2, true);
  EXPECT_EQ("Back, AppList, Chrome, App3, App1, *platform_app", GetPinnedAppStatus());
...
TEST_F(ChromeLauncherControllerTest, UserSwitchIconRestore) {
  ...
  EXPECT_EQ("Back, AppList, App1, App2, App3, *Platform_App, App4, App5, Chrome",
            GetPinnedAppStatus());
...
TEST_F(ChromeLauncherControllerTest,
  ...
  EXPECT_EQ("Back, AppList, App1, App2, App3, *Platform_App, App4, Chrome, App5",
            GetPinnedAppStatus());
