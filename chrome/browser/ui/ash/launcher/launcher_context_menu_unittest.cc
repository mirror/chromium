...
bool IsItemPresentInMenu(ui::SimpleMenuModel* menu, int command_id) {
...
TEST_F(LauncherContextMenuTest, ArcDeferredLauncherContextMenuItemCheck) {
  ...
  ui::SimpleMenuModel* simple_menu =
      reinterpret_cast<ui::SimpleMenuModel*>(menu.get());

  EXPECT_FALSE(
      IsItemPresentInMenu(simple_menu, LauncherContextMenu::MENU_OPEN_NEW));
  EXPECT_TRUE(IsItemPresentInMenu(simple_menu, LauncherContextMenu::MENU_PIN));
  EXPECT_TRUE(
      IsItemPresentInMenu(simple_menu, LauncherContextMenu::MENU_CLOSE));
  ...
  simple_menu = reinterpret_cast<ui::SimpleMenuModel*>(menu.get());
