...
void AppWindowLauncherController::SetItemControllerDiscardedCallback(
    AppWindowLauncherItemController* controller) {
  DCHECK(controller);
  controller->SetDiscardedCallback(
      base::Bind(&AppWindowLauncherController::OnItemControllerDiscarded,
