...
void AppWindowLauncherController::ShelfItemAdded(int model_index) {}

void AppWindowLauncherController::ShelfItemRemoved(
    int model_index,
    const ash::ShelfItem& old_item) {}

void AppWindowLauncherController::ShelfItemChanged(
    int model_index,
    const ash::ShelfItem& old_item) {}

void AppWindowLauncherController::ShelfItemMoved(int start_index,
                                                 int target_index) {}
...
void AppWindowLauncherController::ShelfItemDelegateChanged(
  ...
  if (!old_delegate)
    return;
  AppWindowLauncherItemController* controller = ControllerForShelfId(id);
  if (controller != old_delegate)
    return;
  OnItemControllerDiscarded(controller);
}
