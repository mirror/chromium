...
AppWindowLauncherItemController*
ExtensionAppWindowLauncherController::ControllerForShelfId(
    const ash::ShelfID& id) {
  AppControllerMap::const_iterator it = app_controller_map_.find(id);
  if (it == app_controller_map_.end())
    return nullptr;
  return it->second;
}

void ExtensionAppWindowLauncherController::OnItemControllerDiscarded(
