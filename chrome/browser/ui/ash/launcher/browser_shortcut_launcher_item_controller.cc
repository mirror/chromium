...
std::unique_ptr<ui::MenuModel> BrowserShortcutLauncherItemController::GetContextMenu(int64_t display_id) {
  LOG(ERROR) << "MSW BrowserShortcutLauncherItemController::GetContextMenu";
  ChromeLauncherController* controller = ChromeLauncherController::instance();
