...
void WallpaperControllerClient::Init() {
  ...
  BindAndSetClient();
  // Shows the first wallpaper.
  ShowInitialWallpaper();
}
...
void WallpaperControllerClient::ShowInitialWallpaper() {
  wallpaper_controller_->SetPathId(chrome::DIR_USER_DATA,
                                   chrome::DIR_CHROMEOS_WALLPAPERS,
                                   chrome::DIR_CHROMEOS_CUSTOM_WALLPAPERS);
  // TODO(crbug.com/776464): Move the implementation of
  // |WallpaperManager::InitializeWallpaper| here and remove
  // |InitializeWallpaper| in the |WallpaperDelegate| interface.
}
