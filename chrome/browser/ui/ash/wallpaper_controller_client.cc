...
void WallpaperControllerClient::SetPathIds(
    int user_data_path_id,
    int chromeos_wallpapers_path_id,
    int chromeos_custom_wallpapers_path_id) {
  wallpaper_controller_->SetPathIds(user_data_path_id,
                                    chromeos_wallpapers_path_id,
                                    chromeos_custom_wallpapers_path_id);
}
