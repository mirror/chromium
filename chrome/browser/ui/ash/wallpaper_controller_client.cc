...
void WallpaperControllerClient::OnShowUserWallpaperOnLoginChanged() {
...
void WallpaperControllerClient::ShowRegisteredDeviceWallpaper() {
  ...
  if ((!policy_handler_.ShouldShowUserWallpaperOnLogin() &&
       public_session_user_index == -1) ||
