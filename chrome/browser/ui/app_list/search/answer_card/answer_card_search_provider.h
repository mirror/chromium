...
class AnswerCardSearchProvider : public SearchProvider,
 ...
 private:
  ...
  struct NavigationContext {
    ...
    void Clear();  ////////////////////////////////// other actions for comlex
                   /// actions
  ...
  // Index of the navigation contents corres[ponsing to the current result. 1 -
  // |current_navigation_context_| will be used for loading the next card, or is
  // already loading a new card. It switches to the other contents after the
  // card gets successfully loaded.
