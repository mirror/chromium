...
void ArcPlayStoreSearchResult::Open(int event_flags) {
  ...
  // Opens the installing page of this result in Play Store.
  RecordHistogram(is_instant_app() ? PLAY_STORE_INSTANT_APP
                                   : PLAY_STORE_UNINSTALLED_APP);
  base::RecordAction(
      is_instant_app()
          ? base::UserMetricsAction("Launcher_OpenPlayStoreInstantApp")
          : base::UserMetricsAction("Launcher_OpenPlayStoreUninstalledApp"));
