...
void URLSuggestionResult::UpdateIcon() {
  ...
  icon_types.insert(favicon_base::IconType::WEB_MANIFEST_ICON);
  icon_types.insert(favicon_base::IconType::FAVICON);
  icon_types.insert(favicon_base::IconType::TOUCH_ICON);
  icon_types.insert(favicon_base::IconType::TOUCH_PRECOMPOSED_ICON);
