...
#if defined(OS_CHROMEOS)
// We show up to 6 Playstore results. However, part of Playstore results may be
// filtered out because they may correspond to already installed Web apps. So we
// request twice as many Playstore apps as we can show. Note that this still
