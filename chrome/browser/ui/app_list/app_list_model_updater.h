...
class AppListModelUpdater {
 public:
  ...
  virtual void MoveItemToFolder(AppListItem* item,
                                const std::string& folder_id) {}
  virtual void MoveItem(size_t from_index, size_t to_index) {}
  virtual void SetItemPosition(AppListItem* item,
                               const syncer::StringOrdinal& new_position) {}
  virtual void SetCustomLauncherPageEnabled(bool enabled) {}
  virtual void PushCustomLauncherPageSubpage() {}
  virtual void SetStatus(AppListModel::Status status) {}
  virtual void SetState(AppListModel::State state) {}
  virtual void SetFolderName(const std::string& id, const std::string& name) {}
  virtual void SetItemName(const std::string& id, const std::string& name) {}
  virtual void SetFoldersEnabled(bool enabled) {}
