...
#ifndef CHROME_BROWSER_UI_APP_LIST_ARC_ARC_VPN_PROVIDER_HELPER_H_
#define CHROME_BROWSER_UI_APP_LIST_ARC_ARC_VPN_PROVIDER_HELPER_H_
...
class ArcVpnProviderHelper {
 public:
  ...
  class Observer {
   public:
    ...
    virtual void OnArcVpnProviderUpdated(
        std::unique_ptr<ArcVpnProvider> arc_vpn_provider) {}
  };

  explicit ArcVpnProviderHelper(ArcAppListPrefs* arc_app_list_prefs);
  ~ArcVpnProviderHelper();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ArcVpnProviderHelper);
};

#endif  //  CHROME_BROWSER_UI_APP_LIST_ARC_ARC_VPN_PROVIDER_HELPER_H_
