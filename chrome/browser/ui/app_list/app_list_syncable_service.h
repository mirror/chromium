...
class AppListSyncableService : public syncer::SyncableService,
 ...
 public:
  ...
  void UpdateItem(ChromeAppListItem* app_item);
 ...
 private:
  ...
  bool RemoveDefaultApp(const ash::mojom::AppListItemMetadata* item_data,
                        SyncItem* sync_item);
  ...
  void UpdateSyncItem(const ash::mojom::AppListItemMetadata* app_item);
