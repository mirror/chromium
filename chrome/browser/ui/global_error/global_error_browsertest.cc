...
// Closure used with NOTIFICATION_GLOBAL_ERRORS_CHANGED to detect the addition
// of the GlobalError that has associated UI.
...
bool GlobalErrorBubbleTest::SetUpUserDataDirectory() {
  ...
  CHECK(
      JSONFileValueSerializer(profile_dir.Append(chrome::kPreferencesFilename))
