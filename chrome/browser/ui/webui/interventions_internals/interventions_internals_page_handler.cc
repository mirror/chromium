...
std::string GetSwitchFlagStatus(const std::string& switch_name) {
...
void InterventionsInternalsPageHandler::OnLastObserverRemove() {
  ...
  previews_ui_service_->UnsetIgnorePreviewsBlacklistDecision();
}
...
void InterventionsInternalsPageHandler::GetPreviewsFlagsDetails(
  ...
  ignore_previews_blacklist->value =
      GetSwitchFlagStatus(previews::switches::kIgnorePreviewsBlacklist);
