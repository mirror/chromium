...
TEST_F(InterventionsInternalsPageHandlerTest, GetEctFlagsDefaultValue) {
  page_handler_->GetPreviewsFlagsDetails(
      base::BindOnce(&MockGetPreviewsFlagsCallback));
...
TEST_F(InterventionsInternalsPageHandlerTest, GetNoScriptFlagsDefaultValue) {
  page_handler_->GetPreviewsFlagsDetails(
      base::BindOnce(&MockGetPreviewsFlagsCallback));
...
TEST_F(InterventionsInternalsPageHandlerTest,
       TestAndroid(GetOfflinePageFlagsDefaultValue)) {
  page_handler_->GetPreviewsFlagsDetails(
      base::BindOnce(&MockGetPreviewsFlagsCallback));
