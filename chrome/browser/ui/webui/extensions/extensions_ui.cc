...
content::WebUIDataSource* CreateMdExtensionsSource() {
  ...
  source->AddLocalizedString("shortcutIncludeEitherModifier",
                             IDS_MD_EXTENSIONS_INCLUDE_EITHER_MODIFIER);
  source->AddLocalizedString("shortcutNotBothModifiers",
                             IDS_MD_EXTENSIONS_NOT_BOTH_MODIFIERS);
  source->AddLocalizedString("shortcutNeedLetter",
                             IDS_MD_EXTENSIONS_NEED_LETTER);
  source->AddString(
