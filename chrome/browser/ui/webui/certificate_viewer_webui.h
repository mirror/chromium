...
class CertificateViewerModalDialog : public ui::WebDialogDelegate {
 public:
  ...
  // viewer.
  explicit CertificateViewerModalDialog(net::ScopedCERTCertificateVector certs);
 ...
 protected:
  ...
  // TODO(mattm): maybe rewrite certificate viewer to not depend on NSS?
  net::ScopedCERTCertificateVector nss_certs_;
...
class CertificateViewerDialog : public CertificateViewerModalDialog {
 public:
  ...
  // to the certificate pointer is added for the lifetime of the certificate
  // viewer.
  explicit CertificateViewerDialog(net::ScopedCERTCertificateVector certs);
...
class CertificateViewerDialogHandler : public content::WebUIMessageHandler {
 public:
  CertificateViewerDialogHandler(CertificateViewerModalDialog* dialog,
                                 net::ScopedCERTCertificateVector cert_chain);
 ...
 private:
  ...
  net::ScopedCERTCertificateVector cert_chain_;
