...
std::string StorageTypeToString(blink::StorageType type) {
  switch (type) {
    case blink::StorageType::Temporary:
      return "temporary";
    case blink::StorageType::Persistent:
      return "persistent";
    case blink::StorageType::Syncable:
      return "syncable";
    case blink::StorageType::QuotaNotManaged:
      return "quota not managed";
    case blink::StorageType::Unknown:
      return "unknown";
  }
  return "unknown";
}
