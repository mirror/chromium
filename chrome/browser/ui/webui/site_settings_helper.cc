...
const ContentSettingsTypeNameEntry kContentSettingsTypeGroupNames[] = {
    // The following ContentSettingsTypes have corresponding UI in Site
    // Settings, and require a mapping from their Javascript string
    // representation to their C++ ContentSettingsType provided here.
    ...
    // USB_CHOOSER_DATA, does have UI in Site Settings but does not require
    // separate string.
...
static_assert(arraysize(kContentSettingsTypeGroupNames) ==
                  static_cast<int>(CONTENT_SETTINGS_NUM_TYPES),
