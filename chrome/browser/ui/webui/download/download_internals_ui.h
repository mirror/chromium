...
#ifndef CHROME_BROWSER_UI_WEBUI_DOWNLOAD_DOWNLOAD_INTERNALS_UI_H_
#define CHROME_BROWSER_UI_WEBUI_DOWNLOAD_DOWNLOAD_INTERNALS_UI_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_DOWNLOAD_DOWNLOAD_INTERNALS_UI_H_
