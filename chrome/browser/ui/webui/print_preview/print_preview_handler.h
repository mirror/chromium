...
class PrintPreviewHandler
 ...
 private:
  ...
  // Lazily creates |privet_printer_handler_| that can be used to handle
  // privet printers requests.
  void EnsurePrivetPrinterHandlerSet();

  // Called when a privet printer is detected.
  ...
  void OnGotPrintersForPrivet(const std::string& callback_id,
