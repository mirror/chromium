...
class PdfPrinterHandlerTest : public PrintPreviewTest {
 public:
  PdfPrinterHandlerTest() : preview_ui_(nullptr) {}
 ...
 protected:
  void CreateUIAndHandler() {
    ...
    pdf_printer_ = base::MakeUnique<FakePdfPrinterHandler>(
        Profile::FromBrowserContext(preview_dialog->GetBrowserContext()),
