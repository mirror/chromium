...
LocalPrinterHandlerChromeos::~LocalPrinterHandlerChromeos() override {
  DCHECK_CURRENTLY_ON(content::BrowserThread::UI);
}
...
void LocalPrinterHandlerChromeos::StartGetPrinters(
  ...
  content::BrowserThread::PostTask(
      ...
      base::Bind(&ConvertPrinterListForCallback, cb, printer_list));
}
...
void LocalPrinterHandlerChromeos::StartGrantPrinterAccess(
...
LocalPrinterHandlerChromeos::HandlePrinterSetup(
    std::unique_ptr<chromeos::Printer> printer,
    const GetCapabilityCallback& cb,
