...
void PrintPreviewHandler::HandleGetPrinters(const base::ListValue* args) {
  ...
  // starts.
  handler->Reset();
  handler->StartGetPrinters(base::Bind(&PrintPreviewHandler::OnGotPrinters,
...
void PrintPreviewHandler::OnGotPrinters(const std::string& callback_id,
