...
struct Call<std::index_sequence<Is...>, Args...> {
  static void Impl(PrintPreviewHandler* handler,
                   void (PrintPreviewHandler::*func)(Args...),
                   const base::ListValue* list) {
    const base::Value::ListStorage& storage = list->GetList();
    CHECK(storage.size() == sizeof...(Args));
    (handler->*func)(GetValue<Args>(storage[Is])...);
  }
};
...
void RegisterMethod(PrintPreviewHandler* handler,
                    const std::string& message,
                    void (PrintPreviewHandler::*func)(Args...)) {
  handler->web_ui()->RegisterMessageCallback(
      message,
      base::Bind(&Call<std::index_sequence_for<Args...>, Args...>::Impl,
                 base::Unretained(handler), func));
}
...
void PrintPreviewHandler::RegisterMessages() {
  RegisterMethod(this, "getPrinters", &PrintPreviewHandler::HandleGetPrinters);
  RegisterMethod(this, "getPreview", &PrintPreviewHandler::HandleGetPreview);
  RegisterMethod(this, "print", &PrintPreviewHandler::HandlePrint);
  RegisterMethod(this, "getPrinterCapabilities",
                 &PrintPreviewHandler::HandleGetPrinterCapabilities);
  RegisterMethod(this, "setupPrinter",
                 &PrintPreviewHandler::HandlePrinterSetup);
#if BUILDFLAG(ENABLE_BASIC_PRINT_DIALOG)
  RegisterMethod(this, "showSystemDialog",
                 &PrintPreviewHandler::HandleShowSystemDialog);
#endif
  RegisterMethod(this, "signIn", &PrintPreviewHandler::HandleSignin);
  RegisterMethod(this, "getAccessToken",
                 &PrintPreviewHandler::HandleGetAccessToken);
  RegisterMethod(this, "manageCloudPrinters",
                 &PrintPreviewHandler::HandleManageCloudPrint);
  RegisterMethod(this, "manageLocalPrinters",
                 &PrintPreviewHandler::HandleManagePrinters);
  RegisterMethod(this, "closePrintPreviewDialog",
                 &PrintPreviewHandler::HandleClosePreviewDialog);
  RegisterMethod(this, "hidePreview", &PrintPreviewHandler::HandleHidePreview);
  RegisterMethod(this, "cancelPendingPrintRequest",
                 &PrintPreviewHandler::HandleCancelPendingPrintRequest);
  RegisterMethod(this, "saveAppState",
                 &PrintPreviewHandler::HandleSaveAppState);
  RegisterMethod(this, "getInitialSettings",
                 &PrintPreviewHandler::HandleGetInitialSettings);
  RegisterMethod(this, "forceOpenNewTab",
                 &PrintPreviewHandler::HandleForceOpenNewTab);
  RegisterMethod(this, "grantExtensionPrinterAccess",
