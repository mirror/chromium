...
// Additional counters for new ui.
...
void ClearBrowsingDataHandler::UpdateSyncState() {
  ...
  // TODO(dullweber): Remove "show_history_footer" because we always show
  // the myactivity.google.com info when a user is signed in or syncing.
