...
void SmbHandler::OnJavascriptAllowed() {}
void SmbHandler::OnJavascriptDisallowed() {}

void SmbHandler::RegisterMessages() {
  web_ui()->RegisterMessageCallback(
      "smbMount",
      base::BindRepeating((&SmbHandler::HandleSmbMount,
...
void SmbHandler::HandleSmbMount(const base::ListValue* args) {
  ...
  mo.display_name = "display name temp";
