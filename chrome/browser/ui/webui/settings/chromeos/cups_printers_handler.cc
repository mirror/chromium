...
void CupsPrintersHandler::HandleGetCupsPrintersList(
  ...
  std::vector<std::unique_ptr<Printer>> printers =
      PrintersSyncManagerFactory::GetForBrowserContext(profile_)->GetPrinters();
...
void CupsPrintersHandler::HandleUpdateCupsPrinter(const base::ListValue* args) {
  ...
  PrintersSyncManagerFactory::GetForBrowserContext(profile_)->RegisterPrinter(
      std::move(printer));
}
...
void CupsPrintersHandler::OnPrintersFound(
  ...
  PrintersSyncManager* printers_manager =
      PrintersSyncManagerFactory::GetForBrowserContext(profile_);
