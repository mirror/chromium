...
// TODO(lgcheng@) Create a ThirdPartyVpnHandler to handle extension VPN provider
// and Arc VPN provider messages. The rest of this handler will be deprecated
// soon. crbug.com/785500
