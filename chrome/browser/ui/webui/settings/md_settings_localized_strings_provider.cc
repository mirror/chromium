  ...
  LocalizedString localized_strings[] =
      show_softer_warning
          ? {{"changePasswordPageTitle",
              IDS_SETTINGS_RESET_PASSWORD_TITLE_SOFTER},
             {"changePasswordPageDetails",
              IDS_SETTINGS_RESET_PASSWORD_DETAILS_SOFTER},
             {"changePasswordPageButton", IDS_SETTINGS_RESET_PASSWORD_BUTTON}}
          : {
    {"changePasswordPageTitle", IDS_SETTINGS_RESET_PASSWORD_TITLE},
        {"changePasswordPageDetails", IDS_SETTINGS_RESET_PASSWORD_DETAILS}, {
      "changePasswordPageButton", IDS_SETTINGS_RESET_PASSWORD_BUTTON
    }
  }
  AddLocalizedStringsBulk(html_source, localized_strings,
