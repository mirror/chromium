...
void AddChangePasswordStrings(content::WebUIDataSource* html_source) {
  ...
  // TODO(jialiul): change the above to PasswordProtectionService::ShouldShowSofterWarning();
  ...
  if (show_softer_warning)
    localized_strings[0].id = IDS_SETTINGS_CHANGE_PASSWORD_TITLE_SOFTER;
