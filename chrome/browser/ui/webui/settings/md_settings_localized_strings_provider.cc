...
void AddSiteSettingsStrings(content::WebUIDataSource* html_source,
  ...
  LocalizedString localized_strings[] = {
    ...
    {"siteSettingsActionAllow", IDS_PAGE_INFO_BUTTON_TEXT_ALLOWED_BY_USER},
    {"siteSettingsActionBlock", IDS_PAGE_INFO_BUTTON_TEXT_BLOCKED_BY_USER},
    {"siteSettingsActionAsk", IDS_PAGE_INFO_BUTTON_TEXT_ASK_BY_USER},
