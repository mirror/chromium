...
void AddSiteSettingsStrings(content::WebUIDataSource* html_source,
  ...
  LocalizedString localized_strings[] = {
    ...
    {"siteSettingsPopupsAllowedWithGesture",
     IDS_SETTINGS_SITE_SETTINGS_POPUPS_ALLOWED_WITH_GESTURE},
    {"siteSettingsPopupsAllowedWithGestureRecommended",
     IDS_SETTINGS_SITE_SETTINGS_POPUPS_ALLOWED_WITH_GESTURE_RECOMMENDED},
