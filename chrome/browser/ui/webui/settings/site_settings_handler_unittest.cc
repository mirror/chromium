...
const char kExtensionName[] = "Test Extension";
...
TEST_F(SiteSettingsHandlerTest, GetAndSetDefault) {
  ...
  ValidateDefault(CONTENT_SETTING_ASK, site_settings::kDefaultSource, 1U);
  ...
  handler()->HandleGetDefaultValueForContentType(&get_args);
  ValidateDefault(CONTENT_SETTING_BLOCK, site_settings::kDefaultSource, 3U);
}

TEST_F(SiteSettingsHandlerTest, Origins) {
  const std::string google_with_port("http://www.google.com:80");
  ...
  get_origin_permissions_args.AppendString(google_with_port);
  {
  ...
  ValidateOrigin(google_with_port, google_with_port, google,
                 CONTENT_SETTING_BLOCK, site_settings::kPreferenceSource, 2U);
  ...
  ValidateOrigin(google_with_port, google_with_port, google,
                 CONTENT_SETTING_BLOCK, site_settings::kPreferenceSource, 3U);
  ...
  ValidateOrigin(google_with_port, google_with_port, google,
                 CONTENT_SETTING_ASK, site_settings::kDefaultSource, 6U);
}
...
TEST_F(SiteSettingsHandlerTest, DefaultSettingSource) {
  ...
  const std::string google("http://www.google.com:183");
  ...
  ValidateOrigin(google, google, google, CONTENT_SETTING_ASK,
                 site_settings::kDefaultSource, 1U);
  ...
  ValidateOrigin(google, google, google, CONTENT_SETTING_BLOCK,
                 site_settings::kDefaultSource, 3U);
  ...
  ValidateOrigin(google, google, google, CONTENT_SETTING_ALLOW,
                 site_settings::kPreferenceSource, 5U);
...
TEST_F(SiteSettingsHandlerTest, ExceptionHelpers) {
  ...
  std::unique_ptr<base::DictionaryValue> exception =
      site_settings::GetExceptionForPage(
          ...
          site_settings::kPreferenceSource, false);
...
TEST_F(SiteSettingsHandlerTest, ExtensionDisplayName) {
  ...
  ValidateOrigin(test_extension_url, test_extension_url, kExtensionName,
                 CONTENT_SETTING_ASK, site_settings::kDefaultSource, 1U);
}
