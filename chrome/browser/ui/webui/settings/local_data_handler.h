...
#ifndef CHROME_BROWSER_UI_WEBUI_SETTINGS_LOCAL_DATA_HANDLER_H_
#define CHROME_BROWSER_UI_WEBUI_SETTINGS_LOCAL_DATA_HANDLER_H_
...
class LocalDataHandler : public SettingsPageUIHandler,
                         public content_settings::Observer,
                         public content::NotificationObserver {
 public:
  explicit LocalDataHandler(Profile* profile);
  ~LocalDataHandler() override;
 ...
 private:
  friend class LocalDataHandlerTest;
  friend class LocalDataHandlerInfobarTest;
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, DefaultSettingSource);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, ExceptionHelpers);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, ExtensionDisplayName);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, GetAndSetDefault);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, GetAndSetOriginPermissions);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, GetAndSetForInvalidURLs);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, Incognito);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, Origins);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, Patterns);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerTest, ZoomLevels);
  FRIEND_TEST_ALL_PREFIXES(LocalDataHandlerInfobarTest,
  ...
  DISALLOW_COPY_AND_ASSIGN(LocalDataHandler);
};

}  // namespace settings

#endif  // CHROME_BROWSER_UI_WEBUI_SETTINGS_LOCAL_DATA_HANDLER_H_
