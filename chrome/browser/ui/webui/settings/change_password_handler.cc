...
ChangePasswordHandler::ChangePasswordHandler(Profile* profile)
  ...
  if (g_browser_process && g_browser_process->safe_browsing_service()) {
    service_ = static_cast<safe_browsing::ChromePasswordProtectionService*>(
