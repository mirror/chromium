...
class MediaEngagementUI
    : public MojoWebUIController<mojom::MediaEngagementScoreDetailsProvider> {
 public:
 ...
 private:
  ...
  void BindUIHandler(
      ...
      mojom::MediaEngagementScoreDetailsProviderRequest request) override;

  std::unique_ptr<mojom::MediaEngagementScoreDetailsProvider> ui_handler_;
