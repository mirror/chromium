...
// Implementation of mojom::MediaEngagementScoreDetailsProvider that retrieves
// engagement details from the MediaEngagementService.
class MediaEngagementScoreDetailsProviderImpl
    : public mojom::MediaEngagementScoreDetailsProvider {
 public:
  MediaEngagementScoreDetailsProviderImpl(
      Profile* profile,
      mojo::InterfaceRequest<mojom::MediaEngagementScoreDetailsProvider>
          request)
  ...
  // mojom::MediaEngagementScoreDetailsProvider overrides:
  void GetMediaEngagementScoreDetails(
      mojom::MediaEngagementScoreDetailsProvider::
    ...
    std::vector<mojom::MediaEngagementScoreDetails> details =
        service->GetAllScoreDetails();

    std::vector<mojom::MediaEngagementScoreDetailsPtr> engagement_info;
    engagement_info.reserve(details.size());
    for (const auto& info : details) {
      mojom::MediaEngagementScoreDetailsPtr origin_info(
          mojom::MediaEngagementScoreDetails::New());
 ...
 private:
  ...
  mojo::Binding<mojom::MediaEngagementScoreDetailsProvider> binding_;
...
MediaEngagementUI::MediaEngagementUI(content::WebUI* web_ui)
    : MojoWebUIController<mojom::MediaEngagementScoreDetailsProvider>(web_ui) {
...
void MediaEngagementUI::BindUIHandler(
    ...
    mojom::MediaEngagementScoreDetailsProviderRequest request) {
  ui_handler_.reset(new MediaEngagementScoreDetailsProviderImpl(
