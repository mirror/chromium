...
IN_PROC_BROWSER_TEST_F(InlineLoginUIBrowserTest, CanOfferNoProfile) {
  ...
  EXPECT_FALSE(
      signin::CanOfferSignin(NULL, signin::CAN_OFFER_SIGNIN_FOR_ALL_ACCOUNTS,
...
IN_PROC_BROWSER_TEST_F(InlineLoginUIBrowserTest, CanOffer) {
  EnableOneClick(true);
  EXPECT_TRUE(signin::CanOfferSignin(browser()->profile(),
  ...
  EXPECT_TRUE(signin::CanOfferSignin(
      browser()->profile(), signin::CAN_OFFER_SIGNIN_FOR_ALL_ACCOUNTS, "12345",
...
IN_PROC_BROWSER_TEST_F(InlineLoginUIBrowserTest, CanOfferProfileConnected) {
  ...
  EXPECT_FALSE(signin::CanOfferSignin(
      browser()->profile(), signin::CAN_OFFER_SIGNIN_FOR_ALL_ACCOUNTS, "12345",
      "user@gmail.com", &error_message));
