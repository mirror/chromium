...
void SigninInNewGaiaFlow(Browser* browser,
  ...
  WaitUntilAtLeastOneElementExistsInSigninFrame(browser, {"identifierId"});
  ...
  WaitUntilAtLeastOneElementExistsInSigninFrame(browser, {"password"});
...
void SigninInOldGaiaFlow(Browser* browser,
  ...
  WaitUntilAtLeastOneElementExistsInSigninFrame(browser, {"Email"});
  ...
  WaitUntilAtLeastOneElementExistsInSigninFrame(browser, {"Passwd"});
...
void ExecuteJsToSigninInSigninFrame(Browser* browser,
                                    const std::string& email,
                                    const std::string& password) {
  WaitUntilAtLeastOneElementExistsInSigninFrame(browser,
                                                {"identifierNext", "next"});
