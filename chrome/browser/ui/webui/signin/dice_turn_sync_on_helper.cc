...
void SetUserChoiceHistogram(DiceTurnSyncOnHelper::SigninChoice choice) {
...
bool DiceTurnSyncOnHelper::HasCanOfferSigninError() {
  ...
  delegate_->ShowLoginError(error_msg, account_info_.email);
  return true;
}
...
void DiceTurnSyncOnHelper::CompleteInitForNewProfile(
  ...
  switch (status) {
    ...
    case Profile::CREATE_STATUS_INITIALIZED:
      ...
      delegate_->ShowSigninPage(new_profile, account_info_.email);
      AbortAndDelete();
      break;
