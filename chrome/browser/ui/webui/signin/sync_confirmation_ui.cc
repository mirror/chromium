...
SyncConfirmationUI::SyncConfirmationUI(content::WebUI* web_ui)
  ...
  if (base::FeatureList::IsEnabled(signin::kAccountConsistencyFeature)) {
    source->SetDefaultResource(IDR_NEW_SYNC_CONFIRMATION_HTML);
    source->AddResourcePath("sync_confirmation.css",
                            IDR_NEW_SYNC_CONFIRMATION_CSS);
    source->AddResourcePath("sync_confirmation.js",
                            IDR_NEW_SYNC_CONFIRMATION_JS);
  } else {
