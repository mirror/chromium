...
SyncConfirmationUI::SyncConfirmationUI(content::WebUI* web_ui)
  ...
  if (is_dice_enabled && is_sync_allowed) {
    ...
    source->AddResourcePath("sync_confirmation_component.html",
                            IDR_DICE_SYNC_CONFIRMATION_COMPONENT_HTML);
    source->AddResourcePath("sync_confirmation_component.js",
                            IDR_DICE_SYNC_CONFIRMATION_COMPONENT_JS);
