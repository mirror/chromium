...
#ifndef CHROME_BROWSER_UI_WEBUI_CHROMEOS_GAIA_DIALOG_DELEGATE_H_
#define CHROME_BROWSER_UI_WEBUI_CHROMEOS_GAIA_DIALOG_DELEGATE_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_CHROMEOS_GAIA_DIALOG_DELEGATE_H_
