...
void AddInternetStrings(content::WebUIDataSource* html_source) {
  ...
  // If this dialog is opened in the login screen (user is not logged in),
  // the behavior is the same as when logged in as a guest; any new network
  // configurations are stored in the shared profile.
