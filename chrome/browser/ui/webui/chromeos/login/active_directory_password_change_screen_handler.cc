...
void ActiveDirectoryPasswordChangeScreenHandler::DeclareLocalizedValues(
  ...
  builder->Add("adNewPasswordRejected", IDS_AD_NEW_PASSWORD_REJECTED);
  builder->Add("adPasswordsMismatch",
               IDS_AD_PASSWORD_CHANGE_PASSWORDS_MISMATCH);
}
...
void ActiveDirectoryPasswordChangeScreenHandler::RegisterMessages() {
  AddCallback("completeAdPasswordChange",
              &ActiveDirectoryPasswordChangeScreenHandler::
                  HandleCompleteAdPasswordChange);
  AddCallback("cancel",
              &ActiveDirectoryPasswordChangeScreenHandler::HandleCancel);
}

void ActiveDirectoryPasswordChangeScreenHandler::HandleCompleteAdPasswordChange(
  ...
  authpolicy_login_helper_->AuthenticateUser(
      ...
      old_password + "\n" + new_password + "\n" + new_password,
      base::BindOnce(&ActiveDirectoryPasswordChangeScreenHandler::DoAdAuth,
...
void ActiveDirectoryPasswordChangeScreenHandler::DoAdAuth(
    const std::string& username,
    const Key& key,
