...
void SigninScreenHandler::SetSigninScreenColors(SkColor dark_muted_color) {
  ...
  SkColor base_color = color_utils::GetResultingPaintColor(
      SkColorSetA(ash::kLoginDefaultBaseColor,
                  ash::kLoginTranslucentColorDarkenAlpha),
      dark_muted_color);
  SkColor background_color =
      SkColorSetA(base_color, ash::kLoginTranslucentAlpha);
  SkColor scroll_color =
      SkColorSetA(base_color, ash::kLoginScrollTranslucentAlpha);
