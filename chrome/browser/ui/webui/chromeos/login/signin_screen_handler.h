...
class SigninScreenHandler
 ...
 public:
  ...
  // the offline message to show instantaneously in tests. Or to make it really
  // high to not show the offline message at all because on some slow
  // configurations (e.g. MSAN) it triggers every run.
