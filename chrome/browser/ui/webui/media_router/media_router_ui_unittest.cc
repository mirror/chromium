...
TEST_F(MediaRouterUITest, UpdateSinksWhenDialogMovesToAnotherDisplay) {
  ...
  // Notify MRUI that the dialog WebContents has moved to |display2|. Now
  // |display_sink2| should be removed from the list of sinks.
  EXPECT_CALL(*message_handler_, UpdateSinks(_))
