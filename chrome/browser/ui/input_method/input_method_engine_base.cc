  ...
  for (std::vector<SegmentInfo>::const_iterator segment = segments.begin();
    ...
    switch (segment->style) {
      case SEGMENT_STYLE_UNDERLINE:
        ime_text_span.thickness = ui::IME_TEXT_SPAN_THICKNESS_THIN;
        break;
      case SEGMENT_STYLE_DOUBLE_UNDERLINE:
        ime_text_span.thickness = ui::IME_TEXT_SPAN_THICKNESS_THICK;
        break;
      case SEGMENT_STYLE_NO_UNDERLINE:
        ime_text_span.thickness = ui::IME_TEXT_SPAN_THICKNESS_NONE;
        break;
      default:
        continue;
    }
