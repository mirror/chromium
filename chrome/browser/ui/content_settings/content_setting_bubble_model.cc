...
ContentSettingPopupBubbleModel::ContentSettingPopupBubbleModel(
  ...
  set_manage_text_style(
      UseMd() ? ContentSettingBubbleModel::ManageTextStyle::kButton
              : ContentSettingBubbleModel::ManageTextStyle::kLink);
...
ContentSettingPopupBubbleModel::CreateListItem(int32_t id, const GURL& url) {
  ...
  if (UseMd()) {
    // Insert the unicode single dot bullet code-point \u2022 and two spaces.
