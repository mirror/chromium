...
ContentSettingMediaImageModel::ContentSettingMediaImageModel()
    : ContentSettingImageModel(TYPE_MEDIASTREAM_CAMERA) {}
...
ContentSettingImageModel::GenerateContentSettingImageModels() {
  ...
  result.push_back(CreateForContentType(TYPE_COOKIES));
  result.push_back(CreateForContentType(TYPE_IMAGES));
  result.push_back(CreateForContentType(TYPE_JAVASCRIPT));
  result.push_back(CreateForContentType(TYPE_PPAPI_BROKER));
  result.push_back(CreateForContentType(TYPE_PLUGINS));
  result.push_back(CreateForContentType(TYPE_POPUPS));
  result.push_back(CreateForContentType(TYPE_GEOLOCATION));
  result.push_back(CreateForContentType(TYPE_MIXEDSCRIPT));
  result.push_back(CreateForContentType(TYPE_PROTOCOL_HANDLERS));
  result.push_back(CreateForContentType(TYPE_MEDIASTREAM_CAMERA));
  result.push_back(CreateForContentType(TYPE_ADS));
  result.push_back(CreateForContentType(TYPE_AUTOMATIC_DOWNLOADS));
  result.push_back(CreateForContentType(TYPE_MIDI_SYSEX));
  result.push_back(CreateForContentType(TYPE_SOUND));
  result.push_back(CreateForContentType(TYPE_FRAMEBUST));
  return result;
}
