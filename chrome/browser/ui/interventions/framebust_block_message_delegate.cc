...
base::string16 FramebustBlockMessageDelegate::GetMessage() const {
#if defined(OS_ANDROID)
...
base::string16 FramebustBlockMessageDelegate::GetFeaturedLinkText() const {
  return url_formatter::FormatUrlForSecurityDisplay(blocked_url_);
}

void FramebustBlockMessageDelegate::OnLinkTapped() {
