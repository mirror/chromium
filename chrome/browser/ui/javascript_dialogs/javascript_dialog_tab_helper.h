...
// is foremost, its renderer is held blocked, but when the user switches to a
// different tab, or if the dialog is shown while the tab is not foremost, the
// renderer is not held blocked.
//
