...
//   }
//
//   for (auto it = AllTabContentses().begin();
//        it != AllTabContentses().end(); ++it) {
//     if (*it == desired_web_contents)
//       return it.browser();
//   }
 ...
 public:
  class Iterator {
   public:
    ...
    content::WebContents* operator->() const { return cur_; }
    content::WebContents* operator*() const { return cur_; }
...
AllTabContentsesList AllTabContentses();
