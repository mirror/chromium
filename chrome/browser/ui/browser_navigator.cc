...
void LoadURLInContents(WebContents* target_contents,
  ...
  load_url_params.navigation_ui_data = std::make_unique<ChromeNavigationUIData>(
      target_contents, params->frame_tree_node_id,
      params->frame_tree_node_id == -1 /* navigating_main_frame */,
      params->disposition);
