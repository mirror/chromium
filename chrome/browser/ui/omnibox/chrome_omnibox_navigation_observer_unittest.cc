...
TEST_F(ChromeOmniboxNavigationObserverTest, DeleteBrokenCustomSearchEngines) {
  ...
  std::vector<TestData> cases = {
      TestData{auto_generated_search_keyword(), 200, true},
      TestData{auto_generated_search_keyword(), 404, false},
      TestData{non_auto_generated_search_keyword(), 404, true},
      TestData{default_search_keyword(), 404, true},
      TestData{prepopulated_search_keyword(), 404, true},
      TestData{policy_search_keyword(), 404, true}};
