...
class ThumbnailTabHelper
 ...
 private:
  ...
  void UpdateThumbnailIfNecessary(Trigger trigger);

  // Create a thumbnail from the web contents bitmap.
  void ProcessCapturedBitmap(Trigger trigger,
  ...
  static void LogThumbnailingOutcome(Trigger trigger, Outcome outcome);
