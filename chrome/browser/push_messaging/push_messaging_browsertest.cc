 ...
 public:
  ...
  void RemoveAllNotifications() {
    display_service_tester_->RemoveAllNotifications(
        NotificationCommon::PERSISTENT, true /* by_user */);
  }
...
IN_PROC_BROWSER_TEST_F(PushMessagingBrowserTest,
  ...
  {
    const Notification& forced_notification = GetDisplayedNotifications()[0];
  ...
  ASSERT_EQ(1u, GetNotificationCount());
  {
    const Notification& first_notification = GetDisplayedNotifications()[0];
...
IN_PROC_BROWSER_TEST_F(PushMessagingBrowserTest,
  ...
  display_service_tester_->SetNotificationAddedClosure(quit_barrier);
