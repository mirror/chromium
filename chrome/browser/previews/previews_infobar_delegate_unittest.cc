...
#define MAYBE(x) x
#endif
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestNavigationDismissal)) {
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestReloadDismissal)) {
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestUserDismissal)) {
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestTabClosedDismissal)) {
  CreateInfoBar(previews::PreviewsType::LOFI, base::Time(),
                true /* is_data_saver_user */, false /* is_reload */);
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestClickLinkLoFi)) {
  NavigateAndCommit(GURL(kTestUrl));
  const struct {
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(InfobarTestClickLinkLitePage)) {
  NavigateAndCommit(GURL(kTestUrl));
  ConfirmInfoBarDelegate* infobar =
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(InfobarTestShownOncePerNavigation)) {
  ConfirmInfoBarDelegate* infobar =
      CreateInfoBar(previews::PreviewsType::LOFI, base::Time(),
                    true /* is_data_saver_user */, false /* is_reload */);
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(LoFiInfobarTest)) {
  ConfirmInfoBarDelegate* infobar =
      CreateInfoBar(previews::PreviewsType::LOFI, base::Time(),
                    true /* is_data_saver_user */, false /* is_reload */);
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(PreviewInfobarTest)) {
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(OfflineInfobarNonDataSaverUserTest)) {
  PreviewsInfoBarDelegate* infobar =
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(OfflineInfobarDataSaverUserTest)) {
  PreviewsInfoBarDelegate* infobar =
      CreateInfoBar(previews::PreviewsType::OFFLINE, base::Time(),
                    true /* is_data_saver_user */, false /* is_reload */);
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(OfflineInfobarDisablesLoFi)) {
  NavigateAndCommit(GURL(kTestUrl));
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(PreviewInfobarTimestampMinutesTest)) {
  // Use default params.
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(PreviewInfobarTimestampHourTest)) {
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(PreviewInfobarTimestampHoursTest)) {
  // Use default variation_params.
  std::map<std::string, std::string> variation_params;
  EnableStalePreviewsTimestamp(variation_params);
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(PreviewInfobarTimestampFinchParamsUMA)) {
  std::map<std::string, std::string> variation_params;
...
TEST_F(PreviewsInfoBarDelegateUnitTest, MAYBE(PreviewInfobarTimestampUMA)) {
  // Use default params.
  std::map<std::string, std::string> variation_params;
  EnableStalePreviewsTimestamp(variation_params);
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(PreviewInfobarTimestampReloadTest)) {
  // Use default params.
  std::map<std::string, std::string> variation_params;
  EnableStalePreviewsTimestamp(variation_params);
  int staleness_in_minutes = 5;
...
TEST_F(PreviewsInfoBarDelegateUnitTest,
       MAYBE(CreateInfoBarLogPreviewsInfoBarType)) {
