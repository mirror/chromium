...
class SuggestionsSourceWrapper : public content::URLDataSource {
 public:
  explicit SuggestionsSourceWrapper(Profile* profile);
...
SuggestionsSourceWrapper::SuggestionsSourceWrapper(Profile* profile)
    : profile_(profile),
      suggestions_source_(SuggestionsServiceFactory::GetForProfile(profile_),
...
SuggestionsUI::SuggestionsUI(content::WebUI* web_ui)
  ...
  content::URLDataSource::Add(profile, new SuggestionsSourceWrapper(profile));
}
