...
const char kMicrophoneIconFilename[] = "ic_mic_48px.svg";
...
const struct Resource{
  ...
  const char* mime_type;
    ...
    {kMicrophoneIconFilename, IDR_LOCAL_NTP_VOICE_MIC_ICON_SVG,
     "image/svg+xml"},
...
std::string GetConfigData(bool is_google) {
  ...
  config_data.SetString("microphoneIconFilename", kMicrophoneIconFilename);
