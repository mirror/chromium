...
void ChromeWebViewPermissionHelperDelegate::OnPluginAuthHostRequest(
    chrome::mojom::PluginAuthHostAssociatedRequest request) {
  plugin_host_bindings_.AddBinding(this, std::move(request));
}
