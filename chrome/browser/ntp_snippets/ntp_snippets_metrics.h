...
enum class ContentSuggestionsNotificationImpression : unsigned {
...
enum class ContentSuggestionsNotificationAction : unsigned {
...
// GENERATED_JAVA_ENUM_PACKAGE: org.chromium.chrome.browser.ntp.snippets
enum class ContentSuggestionsNotificationOptOut : unsigned {
