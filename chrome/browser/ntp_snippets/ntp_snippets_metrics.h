...
enum class ContentSuggestionsNotificationImpression : unsigned short {
  ARTICLE,     // Server-provided "articles" category.
  NONARTICLE,  // Anything else.

  MAX_NOTIFICATION_IMPRESSION
};

// GENERATED_JAVA_ENUM_PACKAGE: org.chromium.chrome.browser.ntp.snippets
enum class ContentSuggestionsNotificationAction : unsigned short {
  TAP,        // User tapped notification to open article.
  ...
  MAX_NOTIFICATION_ACTION
};

// GENERATED_JAVA_ENUM_PACKAGE: org.chromium.chrome.browser.ntp.snippets
enum class ContentSuggestionsNotificationOptOut : unsigned short {
  IMPLICIT,  // User ignored notifications.
  EXPLICIT,  // User explicitly opted-out.

  MAX_NOTIFICATION_OPT_OUT
};
