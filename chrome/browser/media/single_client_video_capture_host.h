...
// Implements mojom::VideoCaptureHost and communicates between a
// content::LaunchedVideoCaptureDevice and a single client. On Start(), uses
// |device_laucher_factory| to launch a video capture device that outputs frames
// to |this|. The frames are received through the VideoFrameReceiver interface
// and are forwarded to |observer| through the mojom::VideoCaptureObserver
// interface.
