...
void CastRemotingSender::ProcessNextInput() {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
...
void CastRemotingSender::CompleteInput() {
  DCHECK_CURRENTLY_ON(BrowserThread::IO);
