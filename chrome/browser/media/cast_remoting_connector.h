...
class CastRemotingConnector : public base::SupportsUserData::Data,
 ...
 private:
  ...
  // when remoting stops. The enabled features are set according to what has
  // been enabled via |features::kMediaRemoting|. These are controlled manually
  // via chrome://flags or the command line; or in-the-wild via feature
  // experiments.
