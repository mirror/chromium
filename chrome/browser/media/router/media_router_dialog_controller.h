...
class MediaRouterDialogController {
 ...
 protected:
  ...
  // Passes the ownership of the StartPresentationContext to the
  // caller.
  std::unique_ptr<StartPresentationContext> TakeStartPresentationContext();

  // Returns the StartPresentationContext to the caller but keeps the
  // ownership with the MediaRouterDialogController.
  const StartPresentationContext* presentation_request_context() const {
