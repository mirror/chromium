...
class PresentationReceiverWindow : public content::WebContentsDelegate,
 ...
 public:
  // These methods allow interaction with ~Browser to properly delete the
  // separate off-the-record profile used for the presentation.
  // TODO(btolsch): Remove these when OTR profiles are no longer considered to
  // be owned by their original profile and their destruction can be handled
  // uniformly.
 ...
 private:
  ...
  // The profile used for the presentation.  Ownership is somewhat shared
  // between this class and Browser.  See the definition of DeleteProfile for
  // more details.
  Profile* profile_;
