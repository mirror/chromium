...
TEST(WiredDisplayDeviceCountMetricsTest, RecordWiredDisplaySinkCount) {
  ...
  tester.ExpectTotalCount(
      WiredDisplayDeviceCountMetrics::kHistogramWiredDisplaySinkCount, 0);
  ...
  tester.ExpectTotalCount(
      WiredDisplayDeviceCountMetrics::kHistogramWiredDisplaySinkCount, 5);
  EXPECT_THAT(
      tester.GetAllSamples(
          WiredDisplayDeviceCountMetrics::kHistogramWiredDisplaySinkCount),
      ElementsAre(
