...
TEST(DialDeviceCountMetricsTest, RecordDeviceCountsPeriodically) {
  ...
  metrics.RecordDeviceCountsPeriodically(6, 10);
  metrics.RecordDeviceCountsPeriodically(7, 10);
  tester.ExpectTotalCount(
...
TEST(CastDeviceCountMetricsTest, RecordDeviceCountsPeriodically) {
