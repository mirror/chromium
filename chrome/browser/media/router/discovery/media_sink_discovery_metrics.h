...
class DeviceCountMetrics {
 public:
  ...
  void RecordDeviceCountsPeriodically(size_t available_device_count,
                                      size_t known_device_count);

  // Record device counts.
  virtual void RecordDeviceCount(size_t available_device_count,
...
class DialDeviceCountMetrics : public DeviceCountMetrics {
 public:
  ...
  void RecordDeviceCount(size_t available_device_count,
