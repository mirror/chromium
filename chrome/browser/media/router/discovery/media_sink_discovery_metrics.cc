...
void DeviceCountMetrics::RecordDeviceCountsPeriodically(
  ...
  RecordDeviceCount(available_device_count, known_device_count);
...
void DialDeviceCountMetrics::RecordDeviceCount(size_t available_device_count,
                                               size_t known_device_count) {
...
void CastDeviceCountMetrics::RecordDeviceCount(size_t available_device_count,
                                               size_t known_device_count) {
