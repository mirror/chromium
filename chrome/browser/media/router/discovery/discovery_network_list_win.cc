...
bool operator<(const GUID& guid1, const GUID& guid2) {
  return guid1.Data1 < guid2.Data1 || guid1.Data2 < guid2.Data2 ||
         guid1.Data3 < guid2.Data3 || guid1.Data4[0] < guid2.Data4[0] ||
         guid1.Data4[1] < guid2.Data4[1] || guid1.Data4[2] < guid2.Data4[2] ||
         guid1.Data4[3] < guid2.Data4[3] || guid1.Data4[4] < guid2.Data4[4] ||
         guid1.Data4[5] < guid2.Data4[5] || guid1.Data4[6] < guid2.Data4[6] ||
...
struct MAC {
  ...
  bool operator<(const MAC& o) const { return memcmp(data, o.data, 6) < 0; }
  uint8_t data[6];
};

class WlanClientHandle {
 public:
  WlanClientHandle() {}
  ~WlanClientHandle() {
    if (handle != nullptr) {
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(WlanClientHandle);
};

base::small_map<std::map<GUID, MAC>> GetInterfaceGuidMacMap() {
  ...
  base::small_map<std::map<GUID, MAC>> guid_mac_map;
...
base::small_map<std::map<MAC, std::string>> GetMacSsidMap() {
  WlanClientHandle wlan_client_handle;
  ...
  base::small_map<std::map<MAC, std::string>> mac_ssid_map;
  ...
  for (DWORD i = 0; i < wlan_interface_list->dwNumberOfItems; ++i) {
    ...
    mac_ssid_map.insert(std::make_pair(interface_mac, std::move(ssid)));
  }
  return mac_ssid_map;
}
...
std::vector<DiscoveryNetworkInfo> GetDiscoveryNetworkInfoList() {
  ...
  static constexpr int kInitialAddressBufferSize = 15000;
  ...
  char initial_buf[kInitialAddressBufferSize];
