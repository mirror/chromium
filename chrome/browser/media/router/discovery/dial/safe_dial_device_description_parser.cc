...
void OnXmlParsingDone(DialDeviceDescriptionParserCallback callback,
  ...
  constexpr size_t kArraySize = 4U;
  constexpr std::array<const char* const, kArraySize> kNodeNames{
      {"UDN", "friendlyName", "modelName", "deviceType"}};
  constexpr std::array<DialDeviceDescriptionParsingError, kArraySize>
      kParsingErrors{
