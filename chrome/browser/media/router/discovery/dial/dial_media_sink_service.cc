...
CreateAppOriginWhitelist() {
  base::flat_map<std::string, std::vector<url::Origin>> origins;
...
const base::flat_map<std::string, std::vector<url::Origin>>
    DialMediaSinkService::kAppOriginWhitelist = CreateAppOriginWhitelist();
