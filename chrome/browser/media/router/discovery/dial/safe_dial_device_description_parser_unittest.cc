...
TEST_F(SafeDialDeviceDescriptionParserTest, TestParse) {
  ...
  ParsedDialDeviceDescription device_description =
      Parse(xml_text, SafeDialDeviceDescriptionParser::ParsingError::kNone);
