...
enum class SinkAppStatus { kAvailable, kUnavailable, kUnknown, kError };
...
class DialAppDiscoveryService {
 public:
  ...
  // |sink_id|: ID of media sink object initiating the HTTP GET request.
 ...
 private:
  ...
  void OnDialAppInfo(const std::string& sink_id,
                     const std::string& app_name,
  ...
  DialAppInfoParseCompletedCallback completed_cb_;
