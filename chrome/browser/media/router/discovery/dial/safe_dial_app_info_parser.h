...
class SafeDialAppInfoParser {
 public:
  enum class ParsingError {
    ...
    kFailToReadName = 2,
    kFailToReadState = 3,
    kFailToReadCapabilities = 4,
    kMissingName = 5,
    kInvalidState = 6,
    kUtilityProcessError = 7
  };
 ...
 private:
  ...
  ParsingError ProcessChildElement(const base::Value& child_element,
  ...
  ParsingError ValidateParsedAppInfo(const ParsedDialAppInfo& app_info);
