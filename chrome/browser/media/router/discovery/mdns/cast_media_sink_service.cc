...
void CastMediaSinkService::Start() {
    ...
    cast_media_sink_service_impl_ =
        std::unique_ptr<CastMediaSinkServiceImpl,
            ...
            new CastMediaSinkServiceImpl(
                base::Bind(&CastMediaSinkService::OnSinksDiscoveredOnIOThread,
                           this),
  ...
  content::BrowserThread::PostTask(
      ...
      base::Bind(&CastMediaSinkServiceImpl::Start,
...
void CastMediaSinkService::Stop() {
  ...
  content::BrowserThread::PostTask(
      content::BrowserThread::IO, FROM_HERE,
      base::Bind(&CastMediaSinkServiceImpl::Stop,
                 cast_media_sink_service_impl_->AsWeakPtr()));
...
void CastMediaSinkService::OnDnsSdEvent(
  ...
  content::BrowserThread::PostTask(
      content::BrowserThread::IO, FROM_HERE,
      base::Bind(&CastMediaSinkServiceImpl::OpenChannels,
                 cast_media_sink_service_impl_->AsWeakPtr(),
                 std::move(cast_sinks)));
}
