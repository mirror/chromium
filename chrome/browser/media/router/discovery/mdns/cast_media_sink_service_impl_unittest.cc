...
TEST_F(CastMediaSinkServiceImplTest, TestOnChannelOpenFailed) {
  ...
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint1, CastMediaSinkServiceImpl::SinkSource::kMdns);
...
TEST_F(CastMediaSinkServiceImplTest, TestOnDialSinkAddedSkipsIfNonCastDevice) {
  ...
  // We don't use trigger retries, thus each iteration will only increment the
  // failure count once.
  for (int i = 0; i < CastMediaSinkServiceImpl::kMaxDialSinkFailureCount - 1;
    ...
    EXPECT_CALL(*mock_cast_socket_service_,
        ...
        .WillOnce(DoAll(
            WithArgs<2>(
                Invoke([&](const base::Callback<void(cast_channel::CastSocket *
                                                     socket)>& callback) {
  ...
  // The outcome of the channel does no tmatter here; the sink is considered a
...
TEST_F(CastMediaSinkServiceImplTest, CacheSinksForKnownNetwork) {
  ...
  content::RunAllTasksUntilIdle();
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint1, CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint2, CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
...
TEST_F(CastMediaSinkServiceImplTest, CacheUpdatedForKnownNetwork) {
  ...
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint3, CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
  ...
  content::RunAllTasksUntilIdle();
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint4, CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
...
TEST_F(CastMediaSinkServiceImplTest, DualDiscoveryDoesntDuplicateCacheItems) {
  ...
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint1_cast,
      CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
  media_sink_service_impl_.OnChannelOpenFailed(
      ip_endpoint1_dial,
      CastMediaSinkServiceImpl::SinkSource::kConnectionRetry);
