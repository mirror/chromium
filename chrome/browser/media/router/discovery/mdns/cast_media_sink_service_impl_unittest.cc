...
TEST_F(CastMediaSinkServiceImplTest, TestOpenChannelWithRetry) {
  ...
  ExpectOpenSocketInternal(&socket);
  backoff_entry.reset(new net::BackoffEntry(&policy));
  media_sink_service_impl_.OpenChannel(ip_endpoint, cast_sink,
                                       std::move(backoff_entry));
...
TEST_F(CastMediaSinkServiceImplTest, TestOnChannelError) {
  ...
  media_sink_service_impl_.OnChannelError(
      ip_endpoint1, cast_channel::ChannelError::CHANNEL_NOT_OPEN);
  EXPECT_TRUE(media_sink_service_impl_.current_sinks_by_mdns_.empty());
}

TEST_F(CastMediaSinkServiceImplTest, TestOnChannelErrorMayRetry) {
  auto cast_sink = CreateCastSink(1);
  net::IPEndPoint ip_endpoint1 = CreateIPEndPoint(1);
  cast_channel::MockCastSocket socket;
  socket.set_id(1);
  ...
  net::BackoffEntry::Policy policy = CastMediaSinkServiceImpl::kBackoffPolicy;
  policy.initial_delay_ms = 0;
  media_sink_service_impl_.SetBackoffPolicyForTest(&policy);
...
TEST_F(CastMediaSinkServiceImplTest, CacheSinksForKnownNetwork) {
  ...
  content::RunAllBlockingPoolTasksUntilIdle();
  media_sink_service_impl_.OnChannelError(
      ip_endpoint1, cast_channel::ChannelError::CAST_SOCKET_ERROR);
  media_sink_service_impl_.OnChannelError(
      ip_endpoint2, cast_channel::ChannelError::CAST_SOCKET_ERROR);
...
TEST_F(CastMediaSinkServiceImplTest, CacheUpdatedForKnownNetwork) {
  ...
  media_sink_service_impl_.OnChannelError(
      ip_endpoint3, cast_channel::ChannelError::CAST_SOCKET_ERROR);
  ...
  content::RunAllBlockingPoolTasksUntilIdle();
  media_sink_service_impl_.OnChannelError(
      ip_endpoint4, cast_channel::ChannelError::CAST_SOCKET_ERROR);
...
TEST_F(CastMediaSinkServiceImplTest, DualDiscoveryDoesntDuplicateCacheItems) {
  ...
  content::RunAllBlockingPoolTasksUntilIdle();
  media_sink_service_impl_.OnChannelError(
      ip_endpoint1_cast, cast_channel::ChannelError::CAST_SOCKET_ERROR);
  media_sink_service_impl_.OnChannelError(
      ip_endpoint1_dial, cast_channel::ChannelError::CAST_SOCKET_ERROR);
