...
TEST_F(CastMediaSinkServiceImplTest, TestOnChannelOpened) {
  ...
  media_sink_service_impl_.OnChannelOpened(cast_sink, 1,
...
TEST_F(CastMediaSinkServiceImplTest, TestMultipleOnChannelOpened) {
  ...
  media_sink_service_impl_.OnChannelOpened(cast_sink1, 1,
                                           cast_channel::ChannelError::NONE);
  media_sink_service_impl_.OnChannelOpened(cast_sink2, 2,
                                           cast_channel::ChannelError::NONE);
