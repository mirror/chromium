...
constexpr char CastMediaSinkServiceImpl::kParamNameInitialDelayMS[];
constexpr char CastMediaSinkServiceImpl::kParamNameMaxRetryAttempts[];
constexpr char CastMediaSinkServiceImpl::kParamNameExponential[];
