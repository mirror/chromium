...
// static
constexpr int CastMediaSinkServiceImpl::kCastControlPort = 8009;
...
// static
constexpr net::BackoffEntry::Policy CastMediaSinkServiceImpl::kBackoffPolicy = {
    // Number of initial errors (in sequence) to ignore before going into
    // exponential backoff.
    0,

    // Initial delay (in ms) once backoff starts. It should be longer than Cast
