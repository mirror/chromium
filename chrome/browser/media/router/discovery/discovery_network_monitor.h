...
class DiscoveryNetworkMonitor
 ...
 public:
  ...
  // be executed on the calling thread.  |callback| will be called with the
  // updated network ID value.
 ...
 private:
  ...
  void GetNetworkIdOnSequence(std::string* result) const;
  void UpdateNetworkInfo(std::string* result);
