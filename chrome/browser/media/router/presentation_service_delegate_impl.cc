...
void PresentationServiceDelegateImpl::SetDefaultPresentationRequest(
  ...
  default_presentation_request_.reset(
      new content::PresentationRequest(default_presentation_request));
