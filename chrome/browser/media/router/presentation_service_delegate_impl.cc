    ...
    if (pid_route.second.is_offscreen_presentation()) {
      auto* local_presentation_manager =
          LocalPresentationManagerFactory::GetOrCreateForWebContents(
              web_contents_);
      local_presentation_manager->UnregisterOffscreenPresentationController(
...
void PresentationFrame::ConnectToPresentation(
  ...
  if (pid_route_it->second.is_offscreen_presentation()) {
    auto* local_presentation_manager =
        LocalPresentationManagerFactory::GetOrCreateForWebContents(
            web_contents_);
    local_presentation_manager->RegisterOffscreenPresentationController(
...
void PresentationServiceDelegateImpl::ReconnectPresentation(
  ...
  if (local_presentation_manager->IsOffscreenPresentation(presentation_id)) {
