...
class WiredDisplayMediaRouteProvider : public mojom::MediaRouteProvider,
 ...
 public:
  ...
  // Sets the callback used to instantiate a presentation receiver.
  void SetCreateReceiverCallbackForTesting(CreateReceiverCallback callback);
 ...
 private:
  ...
  // Requests presentation receivers on |display| to be terminated.
  ...
  // The original profile based on which presentation profiles are created.
  Profile* profile_;
  ...
  // Used in tests. When this is set, it is used for instantiating a receiver.
