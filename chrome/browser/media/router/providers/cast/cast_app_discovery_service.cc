...
CastAppDiscoveryService::CastAppDiscoveryService(
    ...
    : core_task_runner_(socket_service->task_runner()),
      core_(nullptr, base::OnTaskRunnerDeleter(core_task_runner_)),
...
CastAppDiscoveryService::Core::Core(
    ...
    : message_handler_(message_handler),
      ...
      outer_task_runner_(task_runner),
      outer_(outer),
      weak_ptr_factory_(this) {
