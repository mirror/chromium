...
// any call returns false, the presentation tab is destroyed.  The default
// policy allows all navigations.
class NavigationPolicy {
 public:
  NavigationPolicy();
  virtual ~NavigationPolicy();
  virtual bool AllowNavigation(content::NavigationHandle* navigation_handle);
};
