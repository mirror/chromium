...
TEST_F(MediaRouterMojoImplTest, ObserveSinksFromMultipleProviders) {
  ...
  sink1a.sink().set_provider_id(MediaRouteProviderId::EXTENSION);
  sink1b.set_sink(MediaSink("sink1b", "", SinkIconType::CAST));
  sink1b.sink().set_provider_id(MediaRouteProviderId::EXTENSION);
  ...
  sink2a.sink().set_provider_id(MediaRouteProviderId::WIRED_DISPLAY);
  sink2b.set_sink(MediaSink("sink2b", "", SinkIconType::CAST));
  sink2b.sink().set_provider_id(MediaRouteProviderId::WIRED_DISPLAY);
  RegisterWiredDisplayProvider();
