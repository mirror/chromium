...
TEST_F(MediaRouterMojoImplTest, HandleIssue) {
  LOG(ERROR) << "_____________________________-1";
  ...
  LOG(ERROR) << "_____________________________-2";
  ...
  LOG(ERROR) << "_____________________________-3a";
  router()->OnIssue(issue_info);
  LOG(ERROR) << "_____________________________-3b";
