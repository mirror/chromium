 ...
 private:
  ...
  class MediaSinksQuery {
   ...
   private:
    ...
    // TODO(takumif): Consider making MRP ID an attribute of MediaSinks, so that
    // we can simplify this into a vector.
  ...
  class MediaRoutesQuery {
   ...
   private:
    ...
    // TODO(takumif): Consider making MRP ID an attribute of MediaRoute, so that
    // we can simplify these into vectors.
