...
class MediaRouteProviderProxy : public mojom::MediaRouteProvider {
 public:
  ...
  // Mojo connections are ready, and runs |callback|.
  ...
  void RegisterProviderManager(mojom::MediaRouteProviderPtr provider_manager);
  mojom::MediaRouteProviderPtr BindInterfacePtr();
