...
#ifndef CHROME_BROWSER_MEDIA_ROUTER_MOJO_MEDIA_ROUTE_PROVIDER_PROXY_H_
#define CHROME_BROWSER_MEDIA_ROUTER_MOJO_MEDIA_ROUTE_PROVIDER_PROXY_H_
...
class MediaRouteProviderProxy : public mojom::MediaRouteProvider {
 public:
  ...
  // Stores the Mojo pointer to the provider, notifies |request_manager_| that
  // Mojo connections are ready, and runs the callback.
 ...
 private:
  ...
  // Notifies |request_manager_| of the disconnection.
  ...
  // Mojo pointer to the Media Route Provider in the component extension.
  // Set to null initially, and later set to the Provider Manager Mojo pointer
  // passed in via RegisterMediaRouteProvider(). This is set to null again when
  // the component extension is suspended or a Mojo channel error occurs.
  ...
  // The MediaRouter implementation using the MediaRouteProvider methods.
...
#endif  // CHROME_BROWSER_MEDIA_ROUTER_MOJO_MEDIA_ROUTE_PROVIDER_PROXY_H_
