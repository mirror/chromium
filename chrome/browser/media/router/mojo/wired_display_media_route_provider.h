...
class WiredDisplayMediaRouteProvider : public mojom::MediaRouteProvider,
 ...
 public:
  ...
  void set_create_receiver_for_testing_cb(CreateReceiverCallback callback) {
    create_receiver_for_testing_cb_ = std::move(callback);
  }
 ...
 private:
  ...
  // instance.
  CreateReceiverCallback create_receiver_for_testing_cb_;
