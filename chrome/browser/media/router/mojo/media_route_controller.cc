...
HangoutMediaRouteController::HangoutMediaRouteController(
  ...
  hangout_controller_.set_connection_error_handler(
      base::BindOnce(&HangoutMediaRouteController::OnMojoConnectionError,
...
void HangoutMediaRouteController::Invalidate() {
  hangout_controller_.reset();
