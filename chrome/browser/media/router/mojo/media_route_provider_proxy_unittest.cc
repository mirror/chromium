...
class MediaRouteProviderProxyTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    ...
    auto provider_proxy = base::MakeUnique<MediaRouteProviderProxy>(
  ...
  MediaRouteProviderProxy* provider_proxy_;
...
TEST_F(MediaRouteProviderProxyTest, ConnectRouteByRouteId) {
  EXPECT_CALL(
      mock_provider_,
...
TEST_F(MediaRouteProviderProxyTest, TerminateRoute) {
...
TEST_F(MediaRouteProviderProxyTest, SendRouteMessage) {
...
TEST_F(MediaRouteProviderProxyTest, SendRouteBinaryMessage) {
...
TEST_F(MediaRouteProviderProxyTest, StartAndStopObservingMediaSinks) {
...
TEST_F(MediaRouteProviderProxyTest, StartAndStopObservingMediaRoutes) {
...
TEST_F(MediaRouteProviderProxyTest, ProvideSinks) {
...
TEST_F(MediaRouteProviderProxyTest, CreateMediaRouteController) {
  EXPECT_CALL(mock_provider_,
