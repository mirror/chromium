...
TEST(MediaRouterMetricsTest, RecordDialDeviceDescriptionParsingError) {
  base::HistogramTester tester;
  const MediaRouterDialParsingError action1 =
      MediaRouterDialParsingError::MISSING_UNIQUE_ID;
  const MediaRouterDialParsingError action2 =
      MediaRouterDialParsingError::MISSING_FRIENDLY_NAME;
  const MediaRouterDialParsingError action3 =
      MediaRouterDialParsingError::MISSING_APP_URL;
