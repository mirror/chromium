...
// "Unsupported keySystem or supportedConfigurations." is the actually error
// message generated by navigator.requestMediaKeySystemAccess(), and will have
// to change if that code is modified.
...
#define EXPECT_ECK_UNSUPPORTED EXPECT_UNSUPPORTED
#else
...
#define EXPECT_WV_UNSUPPORTED EXPECT_UNSUPPORTED
...
IN_PROC_BROWSER_TEST_F(EncryptedMediaSupportedTypesExternalClearKeyTest,
                       NoCodecs) {
  EXPECT_ECK_UNSUPPORTED(AreCodecsSupportedByKeySystem(
...
IN_PROC_BROWSER_TEST_F(EncryptedMediaSupportedTypesWidevineTest, NoCodecs) {
  EXPECT_WV_UNSUPPORTED(AreCodecsSupportedByKeySystem(kVideoWebMMimeType,
                                                      no_codecs(), kWidevine));
  EXPECT_WV_UNSUPPORTED(AreCodecsSupportedByKeySystem(kAudioWebMMimeType,
                                                      no_codecs(), kWidevine));
  EXPECT_WV_UNSUPPORTED(
...
IN_PROC_BROWSER_TEST_F(EncryptedMediaSupportedTypesWidevineTest, Video_WebM) {
  ...
  // Non-video WebM codecs.
  EXPECT_WV_UNSUPPORTED(AreCodecsSupportedByKeySystem(
