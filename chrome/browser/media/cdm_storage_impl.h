...
class CdmStorageImpl : public media::mojom::CdmStorage,
 ...
 private:
  ...
  // is asynchronous).
  void OnFileSystemOpened(const std::string& fsid,
                          OpenCallback callback,
                          base::File::Error error);

  // Called when the requested file has been opened.
  void OnFileOpened(OpenCallback callback,
                    base::File file,
  ...
  media::mojom::CdmFileReleaserPtr releaser_;
