...
IN_PROC_BROWSER_TEST_F(EncryptedMediaW3CTest,
                       SetMediaKeys_Multiple_Times_With_The_Same_MediaKeys) {
  TestW3CPlayback(
      "clearkey-mp4-setmediakeys-multiple-times-with-the-same-mediakeys.https."
      "html");
}

IN_PROC_BROWSER_TEST_F(EncryptedMediaW3CTest, Syntax_MediaKeySession) {
  TestW3CPlayback("clearkey-mp4-syntax-mediakeysession.https.html");
}

IN_PROC_BROWSER_TEST_F(EncryptedMediaW3CTest, Syntax_MediaKeys) {
  TestW3CPlayback("clearkey-mp4-syntax-mediakeys.https.html");
}

IN_PROC_BROWSER_TEST_F(EncryptedMediaW3CTest, Syntax_MediaKeySystemAccess) {
