...
class MediaEngagementScoreTest : public ChromeRenderViewHostTestHarness {
 ...
 protected:
  ...
  void VerifyScore(MediaEngagementScore* score,
    ...
    EXPECT_EQ(visits_with_video_tag, score->visits_with_video_tag());
  }
  ...
  void UpdateScore(MediaEngagementScore* score) {
    ...
    score->IncrementVisitsWithVideoTag();
  }
...
TEST_F(MediaEngagementScoreTest, PopulatedDictionary) {
  ...
  dict->SetInteger(MediaEngagementScore::kVisitsWithVideoTagKey, 3);
...
TEST_F(MediaEngagementScoreTest, ContentSettings) {
  ...
  int example_visits_with_video_tags = 10;
  ...
  score_dict->SetInteger(MediaEngagementScore::kVisitsWithVideoTagKey,
                         example_visits_with_video_tags);
  ...
  EXPECT_EQ(score->visits_with_video_tag(), example_visits_with_video_tags);
  ...
  int stored_visits_with_video_tag;
  ...
  values->GetInteger(MediaEngagementScore::kVisitsWithVideoTagKey,
                     &stored_visits_with_video_tag);
  ...
  EXPECT_EQ(stored_visits_with_video_tag, example_visits_with_video_tags + 1);
