...
TEST_F(MediaEngagementServiceTest, CleanupOriginsOnHistoryDeletion) {
  ...
  SetScores(origin1, MediaEngagementScore::ScoreMinVisits() + 3, 2);
  SetScores(origin2, 2, 1);
  SetScores(origin3, 2, 1);
  SetScores(origin4, MediaEngagementScore::ScoreMinVisits(), 2);
  ...
  ExpectScores(origin1, 0.25, MediaEngagementScore::ScoreMinVisits() + 3, 2,
               TimeNotSet());
  ...
  ExpectScores(origin4, 0.4, MediaEngagementScore::ScoreMinVisits(), 2,
               TimeNotSet());
...

  {
    ...
    ExpectScores(origin1, 1.0 / 6.0, MediaEngagementScore::ScoreMinVisits() + 1,
                 1, TimeNotSet());
    EXPECT_TRUE(GetActualScore(origin1));
...

  {
    ...
    ExpectScores(origin1, 0.0, MediaEngagementScore::ScoreMinVisits(), 0,
                 TimeNotSet());
    ExpectScores(origin2, 0.0, 1, 0, TimeNotSet());
    ExpectScores(origin3, 0.0, 1, 0, TimeNotSet());
    ExpectScores(origin4, 0.4, MediaEngagementScore::ScoreMinVisits(), 2,
