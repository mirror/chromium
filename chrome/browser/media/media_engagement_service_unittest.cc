...
TEST_F(MediaEngagementServiceTest, LogScoresOnStartupToHistogram) {
  ...
  tester.ExpectTotalCount(MediaEngagementService::kHistogramScoreAtStartupName,
                          3);
  tester.ExpectBucketCount(MediaEngagementService::kHistogramScoreAtStartupName,
                           0, 1);
  tester.ExpectBucketCount(MediaEngagementService::kHistogramScoreAtStartupName,
                           50, 1);
  tester.ExpectBucketCount(MediaEngagementService::kHistogramScoreAtStartupName,
