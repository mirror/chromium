...
const char kPepperMediaFeaturePolicyDeprecationMessage[] =
    "Flash microphone and camera usage in cross-origin iframes is deprecated "
    "and will be disabled in M64 (around January 2018). To continue to use "
    "this feature, it must be enabled by the embedding document using Feature "
...
MediaStreamDevicesController::MediaStreamDevicesController(
  ...
  if (request_.request_type == content::MEDIA_OPEN_DEVICE_PEPPER_ONLY) {
    DCHECK(audio_setting_ != CONTENT_SETTING_DEFAULT &&
