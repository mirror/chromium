...
class FakeDeviceLauncher final : public content::VideoCaptureDeviceLauncher {
 public:
  explicit FakeDeviceLauncher(DeviceLaunchedCallback cb)
      : after_launch_cb_(std::move(cb)), weak_factory_(this) {}
...
class FackeDeviceLauncherFactory final
 ...
 public:
  explicit FackeDeviceLauncherFactory(DeviceLaunchedCallback cb)
      : after_launch_cb_(std::move(cb)) {}
