...
const char MediaEngagementScore::kVisitsWithVideoTagKey[] =
    "visitsWithVideoTag";
...
MediaEngagementScore::MediaEngagementScore(
  ...
  score_dict_->GetInteger(kVisitsWithVideoTagKey, &visits_with_video_tag_);
...
MediaEngagementScore::GetScoreDetails() const {
  return media::mojom::MediaEngagementScoreDetails::New(
      ...
      significant_playbacks(), visits_with_video_tag());
}
...
bool MediaEngagementScore::UpdateScoreDict() {
  ...
  int stored_visits_with_video_tag = 0;
  ...
  score_dict_->GetInteger(kVisitsWithVideoTagKey,
  ...
  bool changed = stored_visits != visits() ||
                 ...
                 stored_visits_with_video_tag != visits_with_video_tag() ||
                 stored_last_media_playback_internal !=
  ...
  score_dict_->SetInteger(kVisitsWithVideoTagKey, visits_with_video_tag_);
