...
#else
  // For non-Google builds, the GN flag "cdm_storage_id_key" must be set if
  // "enable_cdm_storage_id" specified. See comments in media/media_options.gni.
  return BUILDFLAG(BROWSER_SPECIFIC_CDM_STORAGE_ID_KEY);
#endif
}
