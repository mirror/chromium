...
// TODO(ke.he@intel.com): Remove this class and rewrite the test case of
// UrlWithApiKey as a services_unittest. Also remove the
...
class GeolocationBrowserTestWithoutOverrider : public GeolocationBrowserTest {
 public:
  ...
  ~GeolocationBrowserTestWithoutOverrider() override;
...
// The WebContentImpl tries to connect Device Service earlier than the calling
// of SetUpOnMainThread(), so create the |geolocation_overrider_| in
// constructor.
