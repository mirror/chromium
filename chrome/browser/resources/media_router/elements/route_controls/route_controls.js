...
Polymer({
  ...
  onVolumeChangeByDragging_: function(e) {
    ...
    // We limit the volume change requests during dragging to at most 2 per
    // second, to limit the number of Mojo calls to the component extension.
    if (currentTime - this.lastVolumeChangeByDragging_ < 500) {
      return;
    }
