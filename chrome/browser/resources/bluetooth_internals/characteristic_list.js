...
cr.define('characteristic_list', function() {
  ...
  CharacteristicListItem.prototype = {
    ...
    createShowAllButtonId: function() {
      return 'show-all-properties-' + this.info.id;
    },
    ...
    setupShowAllButton: function() {
      ...
      this.showAllBtn_.addEventListener('click', function() {
        if (this.propertiesFieldSet_.showAll) {
          this.propertiesFieldSet_.showAll = false;
          this.showAllBtn_.textContent = 'Show All';
          this.propertiesFieldSet_.redraw();
        } else {
          this.propertiesFieldSet_.showAll = true;
          this.showAllBtn_.textContent = 'Hide';
          this.propertiesFieldSet_.redraw();
        }
      }.bind(this));
    },
    ...
    decorate: function() {
      ...
      // Setup the ShowAllButton asynchronously, after the DOM gets updated.
      // If setupShowAllButton function is called directly without setTimeout,
      // then |$(this.createShowAllButtonId())| returns undefined and
      // click eventListener cannot be added to the button.
      setTimeout(function() {
