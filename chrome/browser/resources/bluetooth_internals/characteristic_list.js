...
cr.define('characteristic_list', function() {
  ...
  CharacteristicListItem.prototype = {
    ...
    decorate: function() {
      ...
      // With just class(.show-all-properties) selector,
      // style "margin" is not applied to the button as
      // the margin property for button in widgets.css is over-riding.
      // So, to increase the specificity, Id selector is used.
      propertiesBtn.id = 'show-all-properties-' + this.info.id;
