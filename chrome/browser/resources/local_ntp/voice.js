...
/* @const */ var RecognitionError = speech.RecognitionError;
...
/* @const */ var State_ = speech.State_;
 ...
 * @private {State_}
 */
speech.currentState_ = State_.UNINITIALIZED;
...
speech.init = function(configData) {
  ...
  request.onreadystatechange = function() {
    ...
    if (request.readyState == 4) {
      ...
      svg.id = 'voice-microphone';
      $('voice-microphone-container').appendChild(svg);
    }
  };
  request.open('GET', '/' + configData.microphoneIconFilename, /*async=*/true);
