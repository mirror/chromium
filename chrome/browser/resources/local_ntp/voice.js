...
voice.speech.submitSpeechQuery_ = function() {
  ...
  // TODO(oskopek): Encode (and wrap) the speech.speechQuery_.
  /* @const */ var queryUrl = voice.speech.googleBaseUrl_ +
      `search?hl=${getChromeUILanguage()}&q=${speech.speechQuery_}&gs_ivs=1`;
