 ...
 * @param {HTMLElement} fakeboxSpeech Fakebox microphone icon element.
 * @param {!Object} searchboxApiHandle SearchBox API handle.
 * @param {!boolean|undefined} opt_noInit True if internal initialization
 *    of speech should be skipped. By default, initialization is performed.
 */
speech.listen = function(
    configData, fakeboxSpeech, searchboxApiHandle, opt_noInit) {
