...
cr.define('extensions', function() {
  ...
  const ShortcutInput = Polymer({
    ...
    getErrorString_: function(
      ...
      if (error == Error.TOO_MANY_MODIFIERS)
        return tooManyModifiers;
      if (error == Error.NEED_CHARACTER)
