...
cr.define('extensions', function() {
  ...
  PackDialogDelegate.prototype = {
     ...
     * @param {undefined|number} flag
     * @param {undefined|function(chrome.developerPrivate.PackDirectoryResponse)} callback
     */
  ...
  var PackDialog = Polymer({
    ...
    properties: {
      ...
      packDirectory_: {
        type: String,
        value: null,  // Initialized to trigger binding when attached.
      },
