 ...
 * }}
 */
let GetNamedDestinationMessage;
 ...
 * @param {!function(GetNamedDestinationMessage):void} postMessageCallback
 *     Function called to fetch information for a named destination.
 * @constructor
 */
OpenPDFParamsParser = function(postMessageCallback) {
  /** @private {!Map<number,!GetNamedDestinationRequest>} */
  this.outstandingRequests_ = new Map();

  /** @private {number} */
  this.nextId_ = 0;

  /** @private {function(GetNamedDestinationMessage):void} */
...
OpenPDFParamsParser.prototype = {
  ...
  onNamedDestinationReceived: function(namedDestination) {
    const outstandingRequest =
        this.outstandingRequests_.get(namedDestination.id);
    this.outstandingRequests_.delete(namedDestination.id);
