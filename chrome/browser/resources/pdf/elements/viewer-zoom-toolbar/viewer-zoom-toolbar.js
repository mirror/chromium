...
Polymer({
  ...
  forceFitToHeight: function() {
    ...
    // fit-to-height, which is not a real state but will often be equivalent to
    // fit-to-page and is equivalent to fit-to-width only if the proportion of
    // the page is exactly equal to the proportion of the viewport.
    // The button should then do fit-to-width on the next click.
    this.$['fit-button'].activeIndex = FIT_TO_WIDTH;
  },
