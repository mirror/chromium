...
PDFViewer.prototype = {
  ...
  fitToChanged_: function(e) {
    if (e.detail.fittingType == Viewport.FittingType.FIT_TO_PAGE) {
      this.viewport_.fitToPage();
      this.toolbarManager_.forceHideTopToolbar();
    } else if (e.detail.fittingType == Viewport.FittingType.FIT_TO_WIDTH) {
      this.viewport_.fitToWidth();
    } else if (e.detail.fittingType == Viewport.FittingType.FIT_TO_HEIGHT) {
