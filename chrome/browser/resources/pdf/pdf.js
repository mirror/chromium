...
PDFViewer.prototype = {
  ...
  fitToChanged_: function(e) {
    if (e.detail == Viewport.FittingType.FIT_TO_PAGE) {
      this.viewport_.fitToPage();
      this.toolbarManager_.forceHideTopToolbar();
    } else if (e.detail == Viewport.FittingType.FIT_TO_WIDTH) {
      this.viewport_.fitToWidth();
    } else if (e.detail == Viewport.FittingType.FIT_TO_HEIGHT) {
    ...
    switch (message.data.type.toString()) {
      ...
      case 'resetPrintPreviewMode':
        ...
        if (!this.inPrintPreviewMode_) {
          ...
          this.isUserInitiatedEvent_ = false;
          this.zoomToolbar_.forceFit(Viewport.FittingType.FIT_TO_PAGE);
          this.isUserInitiatedEvent_ = true;
        }
