...
PDFViewer.prototype = {
  ...
  viewportChanged_: function() {
    ...
    // scroll position can be restored. This is only possible in normal tabs.
    if (this.loadState_ == LoadState.SUCCESS && chrome.tabs &&
        this.browserApi_.getStreamInfo().tabId != -1) {
