...
(function() {
    ...
    function initializeProxies() {
      uiHandler = new mojom.MediaEngagementDetailsProviderPtr;
      Mojo.bindInterface(mojom.MediaEngagementDetailsProvider.name,
    ...
    function createRow(info) {
        ...
        if (info.last_media_playback_time)
            ...
            new Date(info.last_media_playback_time).toISOString();
