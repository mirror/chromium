...
class PasswordManager {
   ...
   */
  undoRemoveSavedPasswordOrException_() {}
...
Polymer({
  ...
  onMenuRemovePasswordTap_: function() {
    ...
    passwords.UndoManager.getInstance().show(this.i18n('passwordDeleted'));
    /** @type {CrActionMenuElement} */ (this.$.menu).close();
  },
  ...
  onRemoveExceptionButtonTap_: function(e) {
    ...
    passwords.UndoManager.getInstance().show(this.i18n('exceptionDeleted'));
  },
