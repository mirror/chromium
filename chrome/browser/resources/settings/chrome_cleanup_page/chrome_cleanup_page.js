...
Polymer({
  ...
  attached: function() {
    ...
    this.cardStateToComponentsMap_ = this.getCardStateToComponentsMap_();
  ...
  getCardStateToComponentsMap_: function() {
    ...
    /**
     * @type {!Map<settings.ChromeCleanerCardState,
     *             !settings.ChromeCleanupCardComponents>}
     */
    var cardStateToComponentsMap = new Map();

    cardStateToComponentsMap.set(settings.ChromeCleanerCardState.HIDDEN_CARD, {
      title: null,
      icon: null,
      actionButton: null,
    ...
    cardStateToComponentsMap.set(settings.ChromeCleanerCardState.CLEANING, {
    ...
    return cardStateToComponentsMap;
  },
});
