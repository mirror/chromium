...
Polymer({
  ...
  /** override */
  attached: function() {
    // Note: When attach() is called, |this.scanIntervalId_| may already be set
    // if a device state change had already occurred. In that case, the scan
    // will be stopped when the route changes away from the Internet subpage.
