...
cr.define('settings', function() {
  ...
  class ChangePasswordBrowserProxy {
    ...
    /**
     * Initiate the change password process. For example, for gmail users, it
     * navigates to accounts.google.com; for GSuite users, it navigates to
     * corresponding change password URL.
     */
    changePassword() {}
  }
