...
Polymer({
   ...
   *     prefs.settings.resolve_timezone_by_geolocation_method.value
   * @return {settings.TimeZoneAutoDetectPolicyRestriction} Whether time zone
  ...
  computeTimeZoneAutoDetectMethod_: function(
    ...
    if (hasTimeZoneAutoDetectPolicyRestriction) {
      ...
      return this
          .getPref('settings.resolve_device_timezone_by_geolocation_policy')
          .value;
    }
  ...
  onTimeZoneSettings_: function() {
    ...
    // if (this.hasTimeZoneAutoDetectPolicyRestriction_)
    //  return;
