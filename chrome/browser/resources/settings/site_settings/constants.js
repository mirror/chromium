...
// <if expr="chromeos">
function getProtectedContent(contentSettingsTypes) {
  contentSettingsTypes.PROTECTED_CONTENT = 'protectedContent';
}
getProtectedContent(settings.ContentSettingsTypes);
// </if>
