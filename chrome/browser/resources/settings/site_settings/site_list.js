...
Polymer({
  ...
  onAllowTap_: function() {
    this.setPermissionForActionMenuSite_(settings.ContentSetting.ALLOW);
    this.closeActionMenu_();
  },

  /** @private */
  onBlockTap_: function() {
    this.setPermissionForActionMenuSite_(settings.ContentSetting.BLOCK);
    this.closeActionMenu_();
  },

  /** @private */
  onSessionOnlyTap_: function() {
    this.setPermissionForActionMenuSite_(settings.ContentSetting.SESSION_ONLY);
    this.closeActionMenu_();
  },
