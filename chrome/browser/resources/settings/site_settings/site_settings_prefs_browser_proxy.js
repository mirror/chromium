...
cr.define('settings', function() {
  ...
  class SiteSettingsPrefsBrowserProxy {
     ...
     *    may be different to the results retrieved by getExceptionList(), since
     *    it combines different sources of data to get a permission's value.
     ...
     * @param {!Array<settings.ContentSettingsTypes>} contentTypes A list of
     *    categories to set the permission for. Typically this would be a single
     *    category, but sometimes it is useful to clear any permissions set for
     *    all categories.
     ...
     *    and secondary patterns). Only use this if intending to set an
     *    exception - use setOriginPermissions() for origin-scoped settings.
     * @param {string} primaryPattern The origin to change (primary pattern).
     * @param {string} secondaryPattern The embedding origin to change
     *    (secondary pattern).
