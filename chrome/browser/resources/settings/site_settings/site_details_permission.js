...
Polymer({
  ...
  permissionInfoString_: function(source, category, setting) {
    ...
    if (source == settings.SiteSettingSource.ADS_FILTER_BLACKLIST) {
      ...
      infoStringId = 'siteSettingsSourceAdsBlacklist';
    } else if (
        category == settings.ContentSettingsTypes.ADS &&
        setting == settings.ContentSetting.BLOCK) {
      infoStringId = 'siteSettingsAdsBlockSingular';
      ...
      infoStringId = 'siteSettingsSourceDrmDisabled';
    ...
    assert(
        infoStringId != null,
        `No string for ${category} setting source '${source}'`);
