...
Polymer({
  ...
  /** @override */
  ready: function() {
    this.infoStringMap_ = /** @type Object<string> */ (JSON.parse(
   ...
   * @param {!settings.ContentSettingsTypes} category The permission type.
   * @param {!settings.ContentSetting} setting The permission setting.
   * @param {?Object<string>} strings The array of strings used
  ...
  permissionInfoString_: function(source, category, setting, strings) {
    ...
    /** @type {string} */
    let infoStringId = this.permissionInfoStringKey_(source, category, setting);
