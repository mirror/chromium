...
Polymer({
   ...
   * @param {boolean} shouldShowAndroidApps
   * @return {boolean}
   * @private
   */
  showAssistantSection_: function(featureAvailable, shouldShowAndroidApps) {
    return featureAvailable && shouldShowAndroidApps;
  },
  // </if>
