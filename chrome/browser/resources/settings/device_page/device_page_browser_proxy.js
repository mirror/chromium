...
cr.define('settings', function() {
  ...
  class DevicePageBrowserProxy {
    ...
    /**
     * Sets whethet the note taking app should be enabled to run as a lock
     * screen note action handler.
     * @param {string} appId The app id.
     * @param {boolean} enabled Wehther the app should be enabled to handle note
