...
/** @const {number} */ const MIN_VISUAL_SCALE = .01;
...
Polymer({
  ...
  getDivStyle_: function(id, displayBounds, visualScale, opt_offset) {
    ...
    /** @const {number} */ const BORDER = 1;
    /** @const {number} */ const MARGIN = 4;
    /** @const {number} */ const OFFSET = opt_offset || 0;
    /** @const {number} */ const PADDING = 3;
