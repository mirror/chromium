...
cr.define('interventions_internals', () => {
  ...
  function getPreviewsEnabled() {
    pageHandler.getPreviewsEnabled()
        .then((response) => {
          let statuses = $('previews-statuses-modes');
  ...
  function getPreviewsFlagsStatuses() {
    pageHandler.getPreviewsFlagsStatuses()
        .then((response) => {
          let statuses = $('previews-flags-table');
