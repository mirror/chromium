...
cr.define('print_preview', function() {
   ...
   * @param {!print_preview.NativeLayer} nativeLayer Used to send messages to
   *     C++.
   * @constructor
   * @extends {print_preview.Overlay}
   */
  function DestinationSearch(
      destinationStore, invitationStore, userInfo, nativeLayer) {
    ...
    /**
     * Instance of native layer used to send messages to C++.
