...
cr.define('print_preview', function() {
  ...
  class PrintTicketStore extends cr.EventTarget {
    ...
    onSelectedDestinationCapabilitiesReady_() {
      ...
      if (!isFirstUpdate &&
          (this.destination_.id != selectedDestination.id ||
           this.destination_.origin != selectedDestination.origin &&
               this.destination_.type != selectedDestination.type)) {
      ...
      this.destination_ = new print_preview.Destination(
          selectedDestination.id, selectedDestination.type,
          selectedDestination.origin, '', true,
