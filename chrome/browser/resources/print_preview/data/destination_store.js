...
cr.define('print_preview', function() {
  ...
  class DestinationStore extends cr.EventTarget {
    ...
    /**
     * Sends SELECTED_DESTINATION_CAPABILIITES_READY event if the destination
     * is supported, and SELECTED_DESTINATION_UNSUPPORTED otherwise.
     * @private
     */
    sendSelectedDestinationUpdateEvent_() {
      if (!loadTimeData.getBoolean('isEnterpriseManaged') &&
        ...
        cr.dispatchSimpleEvent(
            this, DestinationStore.EventType.SELECTED_DESTINATION_UNSUPPORTED);
      } else {
        cr.dispatchSimpleEvent(
            this,
