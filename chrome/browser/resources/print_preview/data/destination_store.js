...
cr.define('print_preview', function() {
  ...
  DestinationStore.prototype = {
    ...
    fetchPreselectedDestination_: function(
      ...
      var type = this.originToType_(origin);
      ...
      if (origin == print_preview.DestinationOrigin.PRIVET ||
        ...
        var params =
            (origin !== print_previewDestinationOrigin.EXTENSION) ? null : {
              description: '',
    ...
    fetchMatchingDestination_: function(destinationMatch) {
      ...
      var type = this.originToType_(destinationMatch.origins_[0]);
      if (type != null) {
