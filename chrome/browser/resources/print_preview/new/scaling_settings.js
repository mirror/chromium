...
Polymer({
  ...
  onFitToPageSettingChange_: function() {
    ...
    if (!fitToPage.value) {
      ...
      // If scaling is currently invalid, this will trigger 2 calls to
      // onInputChanged_, one from inputValid_ and one from inputString_.
      // Otherwise, only 1 call will occur due to inputString_.
