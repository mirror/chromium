...
Polymer({
   ...
   * @private
   */
  onPrintButtonTapped_: function() {
    this.printButtonTapped_ = true;
  },

  /**
   * @private
   */
  onCancelButtonTapped_: function() {
    this.printButtonTapped_ = false;
  },
  ...
  getSummary_: function() {
    return 'Hello world I am print preview';
