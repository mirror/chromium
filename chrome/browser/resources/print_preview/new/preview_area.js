...
Polymer({
  ...
  observers: [
    'onSettingsChanged_(settings.color.value, settings.cssBackground.value, ' +
        ...
        'settings.pages.value, settings.rasterize.value, ' +
  ...
  getPreview_: function() {
    ...
    const ticket = {
      ...
      color: getNativeColorModel(
          null, /**@type {boolean} */ (this.getSetting('color').value)),
    ...
    /*
        This needs to be restored when custom margins are added.
        if (this.settings.margins.isCapabilityAvailable() &&
            this.settings.marginsType.value ==
                print_preview.ticket_items.MarginsTypeValue.CUSTOM) {
          const customMargins = this.settings.customMargins.value;
