...
const NUM_DESTINATIONS_ = 3;

/** @type {Array<string>} */
const STICKY_SETTING_NAMES_ = [
...
Polymer({
  ...
  updateRecentDestinations_: function() {
    ...
    // index n.
    if (indexFound == -1 &&
        this.recentDestinations.length == NUM_DESTINATIONS_) {
      indexFound = NUM_DESTINATIONS_ - 1;
    }
    if (indexFound != -1)
  ...
  updateFromStickySettings: function(savedSettingsStr) {
    ...
    STICKY_SETTING_NAMES_.forEach(settingName => {
