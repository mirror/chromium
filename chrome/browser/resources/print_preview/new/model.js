...
Polymer({
  ...
  updateSettingsAvailable_: function() {
    ...
    let layoutAvailable = caps && caps.page_orientation &&
        caps.page_orientation.option && this.documentInfo.isModifiable &&
        !this.documentInfo.hasCssMediaStyles;
    if (layoutAvailable) {
      let hasAutoOrPortraitOption = false;
      let hasLandscapeOption = false;
      caps.page_orientation.option.forEach(function(option) {
