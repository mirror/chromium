...
cr.define('print_preview', function() {
  ...
  function PageSettings(pageRangeTicketItem) {
    ...
    /**
     * Custom page range button and input wrapper.
     * @type {HTMLElement}
     * @private
     */
    ...
    /**
     * Whether the custom input wrapper has had a mouse down event since the
     * last click event.
     * @private {boolean}
     */
  ...
  PageSettings.prototype = {
     ...
     * to detect when the custom input wrapper is the causing the input to lose
     * focus.
     * @private
     */
