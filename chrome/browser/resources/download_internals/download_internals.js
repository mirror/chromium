...
cr.define('downloadInternals', function() {
  ...
  /**
   * @param list {!Array<ServiceEntry>} A list to remove the entry from.
   * @param guid {string} The guid to remove from the list.
   */
   ...
   * @param list {!Array<ServiceEntry>} A list to update.
   * @param newEntry {!ServiceEntry} The new entry.
   */
  ...
  /**
   * @param state {!ServiceStatus} The current status of the download service.
   */
  ...
  /**
   * @param entries {!Array<ServiceEntry>} A list entries currently tracked by
  ...
  /**
   * @param entry {!ServiceEntry} The new state for a particular download
   *     service entry.
   */
  ...
  /**
   * @param entry {!ServiceEntry} The new state for a failed download service
   *     entry.
   */
  ...
  /**
   * @param request {!ServiceRequest} The state for a newly issued download
   *     service request.
   */
