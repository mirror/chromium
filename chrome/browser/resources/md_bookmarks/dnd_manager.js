...
cr.define('bookmarks', function() {
  ...
  function getDragElement(path) {
    ...
    return dragElement.getAttribute('draggable') ? dragElement : null;
  }
  ...
  DNDManager.prototype = {
    ...
    onMouseMove_: function(e) {
      ...
      // Once we are outside of the web contents, allow the drag to start.
      ...
      // Return if the item being dragged over isn't a bookmark item.
      if (!getBookmarkElement(e.path))
        return;
