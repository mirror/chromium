...
cr.define('sync.confirmation', function() {
  ...
  class SyncConfirmationBrowserProxy {
     ...
     * @param {!Array<!string>} description Names of the string resources that
     * the user was presented with in the UI.
     * @param {!string} confirmation Name of the string resource of the element
