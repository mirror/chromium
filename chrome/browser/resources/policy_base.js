...
cr.define('policy', function() {
  ...
  Policy.prototype = {
    ...
    initialize: function(name, value, unknown) {
      ...
      this.querySelector('.name').querySelector('a.name').textContent = name;
      this.querySelector('.name').querySelector('a.name').href =
          'https://chromium.org/administrators/policy-list-3#' + name;
      this.querySelector('.name').querySelector('a.name').title =
          'Learn more about ' + name + ' policy';
