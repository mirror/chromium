...
LineChart.Label = class {
  ...
  setMaxValue(maxValue) {
    ...
    const /** number */ unitIdx = result.unitIdx;
    const /** number */ suitableMaxValue = result.value;
    this.currentUnitIdx_ = unitIdx;
    this.maxValue_ = suitableMaxValue;
    this.isCache_ = false;
  }
  ...
  getSuitableStepSize_() {
     ...
     * @type {number}
     */
    let stepSizePrecision = this.precision_;
    while (true) {
 ...
 * @const
 */
LineChart.getSuitableUnit = LineChart.Label.getSuitableUnit;
