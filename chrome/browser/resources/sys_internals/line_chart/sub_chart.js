 ...
 * Maintains data series which share the same |LineChart.Lable|, that is, share
 * the same unit set. Also, this object is responsible for drawing the line and
 * the unit label on the line chart.
 * @const
 */
LineChart.SubChart = class {
  constructor(/** LineChart.Label */ label, /** number */ labelAlign) {
