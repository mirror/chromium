...
cr.define('SysInternals', function() {
  ...
  function initGeneralInfo() {
    return {
      cpu: {core: 0, idle: 0, kernel: 0, usage: 0, user: 0},
      memory: {swapTotal: 0, swapUsed: 0, total: 0, used: 0},
      zram: {compr: 0, comprRatio: NaN, orig: 0, total: 0},
    };
  }
