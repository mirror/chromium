...
cr.define('SysInternals', function() {
  ...
  function updateCpuData_(cpus, timeTick) {
    ...
    generalCpu.usage = usageNum.toFixed(2) + '%';
  ...
  function updateMemoryData_(memory, timeTick) {
    ...
    generalMem.used = getValueWithUnit(memUsed, UNIT_MEMORY, UNITSCALE_MEMORY);
  ...
  function updateZramData_(zram, timeTick) {
    ...
    generalZram.comprRatio = comprRatioNum.toFixed(2) + '%';
  }
