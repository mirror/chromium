...
Output.ROLE_INFO_ = {
  ...
  menuItem: {msgId: 'role_menuitem', inherits: 'abstractItem'},
  menuItemCheckBox: {msgId: 'role_menuitemcheckbox', inherits: 'abstractItem'},
  menuItemRadio: {msgId: 'role_menuitemradio', inherits: 'abstractItem'},
  menuListOption: {msgId: 'role_menuitem', inherits: 'abstractItem'},
