...
editing.TextEditHandler.prototype = {
  ...
  /**
   * Moves range to before this text field.
   */
  moveToBeforeEditText: function() {
    var before = AutomationUtil.findNextNode(
                     this.node_, Dir.BACKWARD, AutomationPredicate.object) ||
        this.node_;
    ChromeVoxState.instance.navigateToRange(cursors.Range.fromNode(before));
  },
