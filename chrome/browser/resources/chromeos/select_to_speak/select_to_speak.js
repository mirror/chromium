...
SelectToSpeak.prototype = {
  ...
  requestSpeakSelectedText_: function(focusedNode) {
    ...
    if (dir == constants.Dir.FORWARD) {
      firstPosition = getNodeForSelection(anchorObject, anchorOffset);
      lastPosition = getNodeForSelection(focusObject, focusOffset);
    } else {
      lastPosition = getNodeForSelection(anchorObject, anchorOffset);
      firstPosition = getNodeForSelection(focusObject, focusOffset);
    }
