...
// chrome/browser/resources/chromevox/cvox2/background/automation_predicate.js
 ...
 * @constructor
 */
var AutomationPredicate = function() {};
...
AutomationPredicate.visitedLink = function(node) {
  return node.state.VISITED;  // TODO: Caps for compiler!?
};
...
AutomationPredicate.makeTableCellPredicate = function(start, opts) {
  ...
  var dir = opts.dir || constants.Dir.FORWARD;
