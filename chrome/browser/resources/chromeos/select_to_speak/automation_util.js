...
// chrome/browser/resources/chromevox/cvox2/background/automation_util.js
...
AutomationUtil.findNodePre = function(cur, dir, pred) {
  ...
  var child = dir == constants.Dir.BACKWARD ? cur.lastChild : cur.firstChild;
  while (child) {
  ...
  do {
    ...
    if (shallowest)
      return shallowest;
               ...
               AutomationUtil.findNextNode(node, constants.Dir.BACKWARD, pred));
