...
cr.define('mobile.util', function() {
   ...
   * <code>paymentUrl</code> - The intended form action.
   * <code>postData</code> - The post request data submitted though the form.
   ...
   * @param {!Object} deviceInfo An object containing PST request information.
