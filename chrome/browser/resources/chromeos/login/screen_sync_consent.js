...
login.createScreen('SyncConsentScreen', 'sync-consent', function() {
  return {
    EXTERNAL_API: ['profileSyncCompleted'],
     ...
     */
    profileSyncCompleted: function(sync_everything, is_managed) {
      $('sync-consent-impl').profileSyncCompleted(sync_everything, is_managed);
    },
  };
});
