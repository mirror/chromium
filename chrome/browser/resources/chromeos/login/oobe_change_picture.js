...
Polymer({
  ...
  properties: {
    ...
    profileImageUrl: {
      type: String,
      observer: 'profileImageUrlChanged_',
    },
   ...
   * @private
   */
  profileImageUrlChanged_: function(imageUrl) {
    this.pictureList_.setProfileImageUrl(imageUrl, true /* selected */);
  },
  ...
  sendSelectImage_: function(type, src) {
    console.info('sendSelectImage: ' + type);
