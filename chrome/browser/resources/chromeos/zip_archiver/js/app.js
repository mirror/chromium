  ...
  onLaunchedWithPack: function(launchData) {
    ...
    unpacker.app.moduleLoadedPromise
        ...
        .then(function(stringData) {
          ...
          var notificationFunction = chrome.notifications.create;
          ...
          var onProgress = function(compressorId, progress) {
            ...
            if (!progressNotificationCreated) {
              ...
              notificationFunction = chrome.notifications.update;
            }
          };

          compressor.compress(onSuccess, onError, onProgress);

          // If notifcation is closed while packing is in progress, notification
          // function and flag to create/update are reset.
          chrome.notifications.onClosed.addListener(function() {
            progressNotificationCreated = false;
            notificationFunction = chrome.notifications.create;
          });
        });
  },
