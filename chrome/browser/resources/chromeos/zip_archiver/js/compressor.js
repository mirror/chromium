...
/**
 * Sends a cancel archive request to minizip. minizip interrupts itself on the
 * archive and releases objects obtainted in the packing process.
 */
...
/**
 * A handler of cancel archive response.
 * Receiving this response means that we do not allow new requests to or from
 * Zip Archiver.
 * @private
 */
unpacker.Compressor.prototype.onCancelArchiveDone_ = function() {
  console.warn('Archive for "' + this.archiveName_ + '" has been canceled.');
