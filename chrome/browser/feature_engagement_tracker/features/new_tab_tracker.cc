...
// If the user has opened a new tab (new tab button, CTRL+T, tabstrip context
// menu, window frame context menu, app menu).
// New tabs created programmatically by extensions will not be tracked.
...
void NewTabTracker::ShowPromo() {
  ...
  // Sets the bool pref true for having displayed the new tab in-product help.
...
// Returns whether or not the elapsed session time has been 2 hours or more.
