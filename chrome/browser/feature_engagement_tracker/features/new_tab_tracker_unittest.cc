...
class NewTabTrackerEventTest : public testing::Test {
 public:
  NewTabTrackerEventTest() {}
  ~NewTabTrackerEventTest() override {}
  ...
  void SetUp() override {
    ...
    instance_ = base::MakeUnique<FakeNewTabTracker>(
...
class NewTabTrackerFeatureEngagementTrackerTest : public testing::Test {
 public:
  NewTabTrackerFeatureEngagementTrackerTest() {}
  ~NewTabTrackerFeatureEngagementTrackerTest() override {}
...
TEST_F(NewTabTrackerFeatureEngagementTrackerTest, TestOnSessionEnded) {
  ...
  if (real_feature_tracker->IsInitialized()) {
    ...
    metrics::DesktopSessionDurationTracker::Observer* observer =
        dynamic_cast<FakeNewTabTracker*>(instance.get());
