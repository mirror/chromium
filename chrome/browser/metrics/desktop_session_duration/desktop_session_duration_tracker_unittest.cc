...
class MockDesktopSessionObserver
 ...
 public:
  ...
  bool session_started_seen() const { return session_started_seen; }
  bool session_ended_seen() const { return session_ended_seen; }
 ...
 private:
  bool session_started_seen = false;
  bool session_ended_seen = false;
