...
ProcessInfoVector GetProcessInfo(ukm::UkmRecorder& ukm_recorder) {
  ...
  // Process 201 always has 1 URL
  {
    ...
    page_info->time_since_last_visibility_change = 15;
    page_info->time_since_last_navigation = 20;
  ...
  // Process 202 always has 2 URL
  {
    ...
    page_info1->time_since_last_visibility_change = 11;
    page_info1->time_since_last_navigation = 21;
    PageInfoPtr page_info2(resource_coordinator::mojom::PageInfo::New());
    page_info2->ukm_source_id = second_source_id;
    page_info2->time_since_last_visibility_change = 12;
    page_info2->time_since_last_navigation = 22;
