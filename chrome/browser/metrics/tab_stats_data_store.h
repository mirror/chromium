...
class TabStatsDataStore {
 public:
  ...
  // Ensure that |web_contents| has been removed from |existing_tabs|, if it's
  // not the case send a crash report and remove it.
  void EnsureTabHasBeenRemoved(content::WebContents* web_contents);
