...
class TabStatsDataStore {
 ...
 private:
  ...
  base::flat_set<content::WebContents*> existing_tabs_;

  // The IDs of the tabs that currently exist and some of the old ones. Old Tab
  // IDs get removed from this map when the memory that was backing a
  // WebContents gets reassigned to another WebContents.
  base::flat_map<content::WebContents*, TabID> tab_ids_;
