...
const char TabStatsTracker::kTabStatsDailyEventHistogramName[] =
    "Tabs.TabStats.DailyEventInteral";
...
TabStatsTracker::TabsStatsDataStore::TabsStatsDataStore(
...
void TabStatsTracker::TabsStatsDataStore::OnBrowsersAdded(
    size_t browser_count) {
  tab_stats_.browser_count += browser_count;
  UpdateBrowserCountMaxIfNeeded();
}

void TabStatsTracker::TabsStatsDataStore::OnBrowsersRemoved(
    size_t browser_count) {
  tab_stats_.browser_count -= browser_count;
}

void TabStatsTracker::TabsStatsDataStore::OnTabsAdded(size_t tab_count) {
  tab_stats_.total_tab_count += tab_count;
  UpdateTotalTabCountMaxIfNeeded();
}

void TabStatsTracker::TabsStatsDataStore::OnTabsRemoved(size_t tab_count) {
  tab_stats_.total_tab_count -= tab_count;
}
...
void TabStatsTracker::TabsStatsDataStore::ResetMaximumsToCurrentState() {
