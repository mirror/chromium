...
class TabStatsTracker::WebContentsUsageObserver
 ...
 public:
  ...
  void WebContentsDestroyed() override {
    ...
    tab_stats_tracker_->OnTabRemoved(web_contents());
...
void TabStatsTracker::TabDetachedAt(content::WebContents* web_contents,
  ...
  // called after |TabClosingAt|, or it could also get called if a tab has been
  // killed because a tab's WebContents has been freed).
