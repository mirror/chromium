...
class ChromeBrowserMainExtraPartsChecker : public ChromeBrowserMainExtraParts {
 public:
  explicit ChromeBrowserMainExtraPartsChecker(bool value) : value_(value) {}
...
class MetricsReportingStateTest : public InProcessBrowserTest,
 ...
 public:
  ...
  void OnPostMainLoopInit(content::BrowserMainParts* parts) override {
    ...
    ChromeMetricsServiceAccessor::SetForceOfficialEnabledTest(true);
