...
// correct input conditions to be validated. Returns the filepath of the
// local state file which can be used for future verification. Returns
// empty filepath if there was an error.
