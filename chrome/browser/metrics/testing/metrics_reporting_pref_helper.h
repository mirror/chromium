...
// This is used in for setting prefs to validate metrics reporting state is
// processed correctly in browser tests. The prefs are set to replicate how
// group policy configurations are configured.
