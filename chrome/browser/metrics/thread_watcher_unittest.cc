...
constexpr char ThreadWatcherTest::kIOThreadName[] = "IO";
constexpr char ThreadWatcherTest::kUIThreadName[] = "UI";
constexpr char ThreadWatcherTest::kCrashOnHangThreadNames[] = "UI,IO";
constexpr char ThreadWatcherTest::kCrashOnHangThreadData[] = "UI:12,IO:12";
