...
class TabStatsTracker : public TabStripModelObserver,
 ...
 protected:
  ...
  // To call when a WebContents get destroyed directly (without a TabClosingAt
  // call).
 ...
 private:
  ...
  // The WebContents for which we received a TabClosingAt or a
  // WebContentsObserver::WebContentsDestroyed signal but which haven't been
  // detached from the tab strip yet. See
  // WebContentsUsageObserver::WebContentsDestroyed for more details.
  base::flat_set<content::WebContents*> webcontentes_being_destroyed_;
