...
// Operator< functor for comparing navigation times.
struct NavTreeNodeTimeLess {
  bool operator()(const NavTreeNode* a, const NavTreeNode* b) const;
};

struct NavTreeNodeTimeGreater {
  bool operator()(const NavTreeNode* a, const NavTreeNode* b) const;
};
