        ...
        net::DefinePartialNetworkTrafficAnnotation("web_history_expire",
          ...
          semantics {
            description:
              ...
              "history item(s), Chromium sends a request to history.google.com "
              "to execute the corresponding deletion serverside."
            trigger:
              "Deleting one or more history items form the history page, or "
              "deleting history in bulk from the Clear Browsing Data dialog."
            data:
              "For bulk history deletion, the begin and end timestamps of the "
              "selected time range. For deletion of individual history items, "
              "the selected items represented by an URL and timestamp. The "
