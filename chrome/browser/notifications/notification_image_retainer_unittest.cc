...
TEST_F(NotificationImageRetainerTest, FileCreation) {
  ...
  base::string16 dir_profile1_origin1 = base::UintToString16(base::Hash(
      base::UTF8ToUTF16(kProfileId1) + base::UTF8ToUTF16(origin1.spec())));
  base::string16 dir_profile1_origin2 = base::UintToString16(base::Hash(
      base::UTF8ToUTF16(kProfileId1) + base::UTF8ToUTF16(origin2.spec())));
  base::string16 dir_profile2_origin1 = base::UintToString16(base::Hash(
      base::UTF8ToUTF16(kProfileId2) + base::UTF8ToUTF16(origin1.spec())));
  base::string16 dir_profile2_origin2 = base::UintToString16(base::Hash(
      base::UTF8ToUTF16(kProfileId2) + base::UTF8ToUTF16(origin2.spec())));
