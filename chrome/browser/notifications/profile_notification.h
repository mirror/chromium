...
// TODO(estade): make the NotificationUiManager a profile keyed service so this
// class becomes less necessary.
class ProfileNotification {
 public:
  ...
  const NotificationCommon::Metadata* metadata() const { return metadata_.get(); }
