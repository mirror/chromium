...
class NotificationPlatformBridgeWinUITest : public InProcessBrowserTest {
 public:
  NotificationPlatformBridgeWinUITest() : weak_factory_(this) {}
  ...
  void Delegate(NotificationCommon::Operation operation,
 ...
 protected:
  ...
  base::WeakPtrFactory<NotificationPlatformBridgeWinUITest> weak_factory_;
};
...
IN_PROC_BROWSER_TEST_F(NotificationPlatformBridgeWinUITest, HandleEvent) {
 ...
 <action content="Click" arguments="args" activationType="foreground"/>
  ...
  display_service_tester_->SetProcessNotificationOperationDelegate(
      base::BindRepeating(&NotificationPlatformBridgeWinUITest::Delegate,
  ...
  EXPECT_TRUE(ValidateNotificationValues(
      NotificationCommon::CLICK, NotificationHandler::Type::WEB_PERSISTENT,
