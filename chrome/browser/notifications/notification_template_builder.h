...
class NotificationTemplateBuilder {
 ...
 private:
  ...
  // Writes the <text> element with the given |id| and |content|. The
  // |attribution| flag specifies whether |content| contains the source that the
  // notification is attributed to, or false otherwise.
