...
class NotificationPlatformBridgeWinImpl
 ...
 public:
  ...
  // In Chrome, the worker threads on Windows automatically initialize, but
  // in unit tests this is not the case and we must explicitly do so.
  void CoInitializeForTesting() {
