...
class NotificationPlatformBridgeWinImpl
 ...
 public:
  explicit NotificationPlatformBridgeWinImpl(
    ...
    image_retainer_.reset(
        new NotificationImageRetainerImpl(kNotificationsPrefix, task_runner));
  }
  ...
  void Display(
    ...
    std::unique_ptr<NotificationTemplateBuilder> notification_template =
        NotificationTemplateBuilder::Build(
            notification_id, image_retainer_.get(), profile_id, notification);
    mswr::ComPtr<winui::Notifications::IToastNotification> toast;
    HRESULT hr = GetToastNotification(*notification_template, &toast);
    if (FAILED(hr)) {
 ...
 private:
  ...
  ~NotificationPlatformBridgeWinImpl() override = default;
  ...
  // The task runner this object runs on. Weak, not owned by us.
...
NotificationPlatformBridgeWin::NotificationPlatformBridgeWin() {
  ...
  impl_ = new NotificationPlatformBridgeWinImpl(task_runner_.get());
}
...
void NotificationPlatformBridgeWin::Display(
  ...
  PostTaskToTaskRunnerThread(base::BindOnce(
      ...
      notification_id, profile_id, is_incognito, *notification_copy,
