...
void NotificationPlatformBridgeWin::StartActivationListener() {
...
void NotificationPlatformBridgeWin::StopActivationListener() {
  activator_register_.reset(nullptr);
}
