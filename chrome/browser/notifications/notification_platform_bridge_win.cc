...
const wchar_t kGroup[] = L"Chrome Notifications";
 ...
 public:
  ...
  HRESULT GetToastNotification(
    ...
    *toast_notification = nullptr;
    ...
    // limits. Although Group is hard-coded, uniqueness is guaranteed since Web
    // Notifications will ensure uniqueness of notification.id().
