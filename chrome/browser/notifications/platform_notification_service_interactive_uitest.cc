...
class PlatformNotificationServiceBrowserTest : public InProcessBrowserTest {
 ...
 protected:
  ...
  // Executes |script| and stores the result as a string in |result|. Waits for
  // the notification to be added to the |display_tester_| before returning.
