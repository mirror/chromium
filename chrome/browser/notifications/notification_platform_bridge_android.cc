...
void NotificationPlatformBridgeAndroid::Close(
  ...
  bool hasQueryWebApkPackage = notification_info.webapk_package.has_value();
  std::string webapk_package =
      hasQueryWebApkPackage ? *notification_info.webapk_package : "";
  ...
  Java_NotificationPlatformBridge_closeNotification(
      env, java_object_, j_notification_id, origin, tag, hasQueryWebApkPackage,
      j_webapk_package);
}
