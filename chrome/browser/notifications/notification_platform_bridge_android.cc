...
void NotificationPlatformBridgeAndroid::Display(
  ...
  // base::Unretained(this) is safe because this object is tied to the global
  // browser process |g_browser_process| and lives as long as the browser
  // process does.
  uintptr_t callback_pointer =
      reinterpret_cast<uintptr_t>(new QueryWebApkPackageCallback(
          base::Bind(&NotificationPlatformBridgeAndroid::DisplayInternal,
                     base::Unretained(this), notification_id, profile_id,
