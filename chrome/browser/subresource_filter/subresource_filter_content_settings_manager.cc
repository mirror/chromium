...
void SubresourceFilterContentSettingsManager::OnContentSettingChanged(
  ...
  // Reset the smart UI here. Be careful not to delete the metadata, just
  // remove the timestamp. This is to allow the UI appear again after a user has
  // made a manual setting change in the settings UI.
