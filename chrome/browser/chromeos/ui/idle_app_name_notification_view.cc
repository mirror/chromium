...
void CreateAndShowWidget(views::WidgetDelegateView* delegate,
  ...
  delegate->NotifyAccessibilityEvent(ax::mojom::Event::ALERT, true);
}
...
class IdleAppNameNotificationDelegateView
 ...
 public:
  ...
  void GetAccessibleNodeData(ui::AXNodeData* node_data) override {
    ...
    node_data->role = ax::mojom::Role::ALERT;
  }
...
base::string16 IdleAppNameNotificationView::GetShownTextForTest() {
  ...
  return node_data.GetString16Attribute(ax::mojom::StringAttribute::NAME);
}
