 ...
 public:
  ...
  void SetUp() override {
    ...
    path_override_ = std::make_unique<base::ScopedPathOverride>(
        chrome::FILE_CHROME_OS_TPM_FIRMWARE_UPDATE,
        temp_dir_.GetPath().AppendASCII("tpm_firmware_update"));
  ...
  void SetUpdateAvailability(Availability availability) {
    ...
    ASSERT_TRUE(PathService::Get(chrome::FILE_CHROME_OS_TPM_FIRMWARE_UPDATE,
