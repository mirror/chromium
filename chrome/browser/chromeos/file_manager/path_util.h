...
// DEPRECATED
// While this function can convert paths under Downloads directory,
// /media/removable and /special/drive, this CANNOT convert paths under
// ARC media directories (/special/arc-documents-provider/).
