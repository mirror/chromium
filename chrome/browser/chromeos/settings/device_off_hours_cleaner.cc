...
em::ChromeDeviceSettingsProto DeviceOffHoursController::clear_policies(
  ...
  if (off_policies.find("OBSOLETE_DeviceProxySettingsProto") != off_policies.end()) {
  ...
  if (off_policies.find("DeviceOpenNetworkConfigurationProto") != off_policies.end()) {
  ...
  if (off_policies.find("OBSOLETE_ForcedLogoutTimeoutsProto") != off_policies.end()) {
  ...
  if (off_policies.find("AllowRedeemChromeOsRegistrationOffersProto") != off_policies.end()) {
  ...
  if (off_policies.find("LoginScreenPowerManagementProto") != off_policies.end()) {
  ...
  if (off_policies.find("LoginScreenDomainAutoCompleteProto") != off_policies.end()) {
  ...
  if (off_policies.find("AllowKioskAppControlChromeVersionProto") != off_policies.end()) {
    policies.clear_allow_kiosk_app_control_chrome_version();
  }
  if (off_policies.find("LoginAuthenticationBehaviorProto") != off_policies.end()) {
  ...
  if (off_policies.find("DeviceQuirksDownloadEnabledProto") != off_policies.end()) {
    policies.clear_quirks_download_enabled();
  }
  if (off_policies.find("LoginVideoCaptureAllowedUrlsProto") != off_policies.end()) {
    policies.clear_login_video_capture_allowed_urls();
  }
  if (off_policies.find("DeviceLoginScreenAppInstallListProto") != off_policies.end()) {
    policies.clear_device_login_screen_app_install_list();
  }
  if (off_policies.find("NetworkThrottlingEnabledProto") != off_policies.end()) {
  ...
  if (off_policies.find("DeviceEcryptfsMigrationStrategyProto") != off_policies.end()) {
    policies.clear_device_ecryptfs_migration_strategy();
  }
  if (off_policies.find("DeviceSecondFactorAuthenticationProto") != off_policies.end()) {
