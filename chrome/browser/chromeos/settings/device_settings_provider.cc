...
void DeviceSettingsProvider::DecodePolicies(
    ...
    const em::ChromeDeviceSettingsProto& policy,
    PrefValueMap* new_values_cache) {
  DecodeLoginPolicies(policy_connector, policy, new_values_cache);
  ...
  DecodeGenericPolicies(policy_connector, policy, new_values_cache);
...
void DeviceSettingsProvider::UpdateValuesCache(
  ...
  DecodePolicies(policy_connector_, settings, &new_values_cache);
