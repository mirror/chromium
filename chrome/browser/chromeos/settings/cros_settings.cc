...
void CrosSettings::Initialize(PrefService* local_state,
  ...
  g_cros_settings = new CrosSettings(local_state, policy_connector, DeviceSettingsService::Get());
}
...
CrosSettings::CrosSettings(PrefService* local_state,
                           policy::BrowserPolicyConnectorChromeOS* policy_connector,
