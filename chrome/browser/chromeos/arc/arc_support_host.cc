...
// "onOpenSettingPageClicked" is fired when a user clicks settings link
constexpr char kEventOnOpenSettingPageClicked[] = "onOpenSettingPageClicked";
...
void ArcSupportHost::OnMessage(const base::DictionaryValue& message) {
  ...
  } else if (event == kEventOnOpenSettingPageClicked) {
