...
int32_t ArcAccessibilityHelperBridge::GetActiveWindowTaskId() {
  exo::WMHelper* wm_helper = exo::WMHelper::GetInstance();
  if (!wm_helper)
    return kNoTaskId;
  ...
  return GetTaskId(active_window);
}
