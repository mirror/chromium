...
TEST_F(ArcAccessibilityHelperBridgeTest, NotificationEventArriveFirst) {
  ...
  auto event1 = arc::mojom::AccessibilityEventData::New();
  event1->event_type =
      arc::mojom::AccessibilityEventType::ARC_NOTIFICATION_SURFACE_ADDED;
  ...
  auto event2 = arc::mojom::AccessibilityEventData::New();
  event2->event_type =
      arc::mojom::AccessibilityEventType::ARC_NOTIFICATION_SURFACE_REMOVED;
  ...
  // mojo: notification 2 removed
  auto event4 = arc::mojom::AccessibilityEventData::New();
  event4->event_type =
      arc::mojom::AccessibilityEventType::ARC_NOTIFICATION_SURFACE_REMOVED;
  event4->notification_key = base::make_optional<std::string>(kNotificationKey);
  helper_bridge->OnAccessibilityEvent(event4.Clone());
