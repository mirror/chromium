 ...
 public:
    ...
    switch (callback_type_) {
      case CallbackType::AUTH_CODE:
        ...
        std::move(auth_callback_)
            .Run(std::string() /* auth_code */, true /* is_enforced */);
        break;
      ...
      case CallbackType::ACCOUNT_INFO:
        ...
        std::move(account_info_callback_).Run(nullptr, failure_reason);
        break;
    }
  }
  ...
  void NotifySuccess(bool is_enforced,
    ...
    switch (callback_type_) {
      ...
      case CallbackType::ACCOUNT_INFO:
        DCHECK(!account_info_callback_.is_null());
        std::move(account_info_callback_)
            .Run(CreateAccountInfo(is_enforced, auth_info, account_name,
