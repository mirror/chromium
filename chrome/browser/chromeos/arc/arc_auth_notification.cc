...
void ArcAuthNotification::Show() {
  ...
  std::unique_ptr<message_center::Notification> notification =
      std::make_unique<message_center::Notification>(
          ...
          GURL(), notifier_id, data, new ArcAuthNotificationDelegate(profile_));
  if (message_center::IsNewStyleNotificationEnabled()) {
    notification->set_icon(gfx::Image());
    notification->set_accent_color(
        message_center::kSystemNotificationColorNormal);
    notification->set_small_image(gfx::Image(
        gfx::CreateVectorIcon(kNotificationPlayPrismIcon,
                              message_center::kSystemNotificationColorNormal)));
    notification->set_vector_small_image(kNotificationPlayPrismIcon);
  }
