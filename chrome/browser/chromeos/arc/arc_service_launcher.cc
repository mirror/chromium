...
void ArcServiceLauncher::OnPrimaryUserProfilePrepared(Profile* profile) {
  ...
  auto* arc_context = ArcContext::FromBrowserContext(profile);
  ArcAccessibilityHelperBridge::GetForContext(arc_context);
  ArcAudioBridge::GetForContext(arc_context);
  ArcAuthService::GetForContext(arc_context);
  ArcBluetoothBridge::GetForContext(arc_context);
  ArcBootErrorNotification::GetForContext(arc_context);
  ArcBootPhaseMonitorBridge::GetForContext(arc_context);
  ArcCastReceiverService::GetForContext(arc_context);
  ArcCertStoreBridge::GetForContext(arc_context);
  ArcClipboardBridge::GetForContext(arc_context);
  ArcCrashCollectorBridge::GetForContext(arc_context);
  ArcDownloadsWatcherService::GetForContext(arc_context);
  ArcEnterpriseReportingService::GetForContext(arc_context);
  ArcFileSystemBridge::GetForContext(arc_context);
  ArcFileSystemMounter::GetForContext(arc_context);
  ArcImeService::GetForContext(arc_context);
  ArcIntentHelperBridge::GetForContext(arc_context);
  ArcKioskBridge::GetForContext(arc_context);
  ArcLockScreenBridge::GetForContext(arc_context);
  ArcMetricsService::GetForContext(arc_context);
  ArcMidisBridge::GetForContext(arc_context);
  ArcNetHostImpl::GetForContext(arc_context);
  ArcNotificationManager::GetForContext(arc_context);
  ArcObbMounterBridge::GetForContext(arc_context);
  ArcOemCryptoBridge::GetForContext(arc_context);
  ArcPolicyBridge::GetForContext(arc_context);
  ArcPowerBridge::GetForContext(arc_context);
  ArcPrintService::GetForContext(arc_context);
  ArcProcessService::GetForContext(arc_context);
  ArcProvisionNotificationService::GetForContext(arc_context);
  ArcRotationLockBridge::GetForContext(arc_context);
  ArcSettingsService::GetForContext(arc_context);
  ArcTracingBridge::GetForContext(arc_context);
  ArcTtsService::GetForContext(arc_context);
  ArcUserSessionService::GetForContext(arc_context);
  ArcVoiceInteractionArcHomeService::GetForContext(arc_context);
  ArcVoiceInteractionFrameworkService::GetForContext(arc_context);
  ArcVolumeMounterBridge::GetForContext(arc_context);
  ArcWallpaperService::GetForContext(arc_context);
  GpuArcVideoServiceHost::GetForContext(arc_context);
