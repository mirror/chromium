...
// static
VoiceInteractionControllerClient* VoiceInteractionControllerClient::instance =
    nullptr;

VoiceInteractionControllerClient::VoiceInteractionControllerClient() {
  DCHECK(!VoiceInteractionControllerClient::Get());
  ...
  VoiceInteractionControllerClient::SetInstance(this);
}

VoiceInteractionControllerClient::~VoiceInteractionControllerClient() {
  DCHECK_EQ(instance, this);
  VoiceInteractionControllerClient::SetInstance(nullptr);
}

// static
VoiceInteractionControllerClient* VoiceInteractionControllerClient::Get() {
  return VoiceInteractionControllerClient::instance;
}
...
// static
void VoiceInteractionControllerClient::SetInstance(
    VoiceInteractionControllerClient* instance) {
  VoiceInteractionControllerClient::instance = instance;
}
