...
void ArcVoiceInteractionArcHomeService::OnAssistanceStarted() {
  VLOG(1) << "Assistant flow started";
  LockPai();
}

void ArcVoiceInteractionArcHomeService::OnAssistanceAppRequested() {
  ...
  assistant_started_timer_.Start(
      ...
      base::Bind(&ArcVoiceInteractionArcHomeService::OnAssistantFailedToStart,
                 base::Unretained(this)));
}

void ArcVoiceInteractionArcHomeService::OnAssistanceCanceled() {
...
void ArcVoiceInteractionArcHomeService::OnTaskDestroyed(int32_t task_id) {
  ...
  wizard_completed_timer_.Start(
      ...
      base::Bind(&ArcVoiceInteractionArcHomeService::OnWizardDidNotComplete,
                 base::Unretained(this)));
}

void ArcVoiceInteractionArcHomeService::Reset() {
...
void ArcVoiceInteractionArcHomeService::OnAssistantFailedToStart() {
  LOG(WARNING) << "Failed to start Assistant app.";
  UnlockPai();
}

void ArcVoiceInteractionArcHomeService::OnWizardDidNotComplete() {
