...
class ArcVoiceInteractionFrameworkService
 ...
 public:
  ...
  void SetVoiceInteractionState(mojom::VoiceInteractionState state) override;
 ...
 private:
  ...
  // Whether the voice interaction service is ready. There is usually a long
  ...
  mojom::VoiceInteractionState state_ = mojom::VoiceInteractionState::NOT_READY;
