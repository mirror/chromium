...
void ArcVoiceInteractionFrameworkService::SetVoiceInteractionState(
  ...
  ash::mojom::VoiceInteractionState state = ToAshState(voice_interaction_state);
...
ArcVoiceInteractionFrameworkService::ToAshState(
    arc::mojom::VoiceInteractionState state) {
  return state == arc::mojom::VoiceInteractionState::NOT_READY
             ? ash::mojom::VoiceInteractionState::NOT_READY
             : state == arc::mojom::VoiceInteractionState::STOPPED
