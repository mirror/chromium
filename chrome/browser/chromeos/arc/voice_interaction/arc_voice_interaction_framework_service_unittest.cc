...
TEST_F(ArcVoiceInteractionFrameworkServiceTest,
  ...
  EXPECT_EQ(
      ...
      true);
  EXPECT_EQ(voice_interaction_controller()->voice_interaction_context_enabled(),
            true);
  EXPECT_EQ(voice_interaction_controller()->voice_interaction_setup_completed(),
            true);
  EXPECT_EQ(voice_interaction_controller()->voice_interaction_state(),
            ash::VoiceInteractionState::STOPPED);

  // Send the signal to disable voice interaction settings.
  voice_interaction_controller_client()->NotifyVoiceInteractionSettingsEnabled(
      false);
  FlushVoiceInteractionControllerMojo();
  EXPECT_EQ(
      voice_interaction_controller()->voice_interaction_settings_enabled(),
  ...
  voice_interaction_controller_client()->NotifyVoiceInteractionContextEnabled(
      false);
  FlushVoiceInteractionControllerMojo();
  EXPECT_EQ(voice_interaction_controller()->voice_interaction_context_enabled(),
            false);
  ...
  voice_interaction_controller_client()->NotifyVoiceInteractionSetupCompleted(
      false);
  FlushVoiceInteractionControllerMojo();
  EXPECT_EQ(voice_interaction_controller()->voice_interaction_setup_completed(),
            false);
  ...
  voice_interaction_controller_client()->NotifyVoiceInteractionStatusChanged(
