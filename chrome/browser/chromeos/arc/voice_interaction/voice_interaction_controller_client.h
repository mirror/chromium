...
namespace arc {
class VoiceInteractionControllerClientTest;
...
class VoiceInteractionControllerClient
 ...
 protected:
  static void SetInstance(VoiceInteractionControllerClient* instance);
 ...
 private:
  ...
  static VoiceInteractionControllerClient* instance;
