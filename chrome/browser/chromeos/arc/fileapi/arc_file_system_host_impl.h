...
#ifndef CHROME_BROWSER_CHROMEOS_ARC_FILEAPI_ARC_FILE_SYSTEM_HOST_IMPL_H_
#define CHROME_BROWSER_CHROMEOS_ARC_FILEAPI_ARC_FILE_SYSTEM_HOST_IMPL_H_
...
// FileSystemHost implementation.
class ArcFileSystemHostImpl : public mojom::FileSystemHost {
 public:
  ...
  explicit ArcFileSystemHostImpl(Delegate* delegate);
  ~ArcFileSystemHostImpl() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ArcFileSystemHostImpl);
};

}  // namespace arc

#endif  // CHROME_BROWSER_CHROMEOS_ARC_FILEAPI_ARC_FILE_SYSTEM_HOST_IMPL_H_
