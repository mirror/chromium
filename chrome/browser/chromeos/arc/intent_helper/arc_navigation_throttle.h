...
class ArcNavigationThrottle : public content::NavigationThrottle {
 public:
  ...
  enum class CloseReason : int {
    ...
    // The preffix "CHROME"/"ARC_APP" determines whether the user pressed [Stay
 ...
 private:
  ...
  // TODO(djacobo): Find a better place for these methods, they don't depend at
  // all on the throttle and keeping them here can be confusing.
  ...
  // Keeps track of whether we already shown the UI or preferred app.
  bool ui_displayed_;
