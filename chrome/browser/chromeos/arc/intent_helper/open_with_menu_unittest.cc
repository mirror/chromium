...
TEST(OpenWithMenuTest, TestBuildHandlersMap) {
  ...
  EXPECT_EQ(-1, result.second);
  EXPECT_EQ(base::ASCIIToUTF16("App 0"), result.first[kFirstMainMenuId].name);
  ...
  EXPECT_EQ(-1, result.second);
  EXPECT_EQ(base::ASCIIToUTF16("App 0"), result.first[kFirstMainMenuId].name);
  EXPECT_EQ(base::ASCIIToUTF16("App 1"),
            result.first[kFirstMainMenuId + 1].name);
  ...
  EXPECT_EQ(base::ASCIIToUTF16("App 1"),
            result.first[kFirstMainMenuId + 1].name);
  EXPECT_EQ(base::ASCIIToUTF16("App 2"),
            result.first[kFirstMainMenuId + 2].name);
  ...
  EXPECT_EQ(base::ASCIIToUTF16("App 1"),
            result.first[kFirstMainMenuId + 1].name);
  EXPECT_EQ(base::ASCIIToUTF16("App 2"), result.first[kFirstSubMenuId].name);
  EXPECT_EQ(base::ASCIIToUTF16("App 3"),
            result.first[kFirstSubMenuId + 1].name);
  ...
  for (size_t i = 0; i < 10; ++i) {
    ...
    EXPECT_EQ(base::ASCIIToUTF16(base::StringPrintf("App %zu", i + 2)),
