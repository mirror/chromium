...
void ArcNavigationThrottle::OnAppCandidatesReceived(
  ...
  // If there is a preferred app or if we show the UI, make it impossible for
  // the bubble to be displayed again.
  dont_display_again_ = true;
