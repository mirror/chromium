...
class ArcCertStoreBridge
 ...
 public:
  ...
  void Update(uint64_t op_handle,
              const std::vector<uint8_t>& data,
              const UpdateCallback& callback) override;
  void Finish(uint64_t op_handle, const FinishCallback& callback) override;
  void Abort(uint64_t op_handle, const AbortCallback& callback) override;
