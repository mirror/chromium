...
class ArcCertStoreBridge
 ...
 public:
  ...
  void Finish(uint64_t operation_handle,
              const FinishCallback& callback) override;
  void Abort(uint64_t operation_handle, const AbortCallback& callback) override;
 ...
 private:
  void OnGetNSSCertDatabaseForUser(const ListCertificatesCallback& callback,
                                   net::NSSCertDatabase* database);
  void OnCertificatesListed(const ListCertificatesCallback& callback,
