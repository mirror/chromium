...
class ClientCertFilterChromeOS : public ClientCertStoreChromeOS::CertFilter {
 public:
  // Creates a ClientCertFilterChromeOS for |username_hash|. If |use_system| is
  // true, certificates from the system slot will also be allowed.
  static std::unique_ptr<ClientCertFilterChromeOS> CreateForUserProfile(
      bool use_system_,
      const std::string& username_hash);
  // Creates a ClientCertFilterChromeOS which only allows certificates from the
  // system slot.
