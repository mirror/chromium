...
class NetworkPortalDetectorImpl : public NetworkPortalDetector,
 ...
 public:
  static constexpr char kOobeDetectionResultHistogram[] =
      "CaptivePortal.OOBE.DetectionResult";
  static constexpr char kOobeDetectionDurationHistogram[] =
      "CaptivePortal.OOBE.DetectionDuration";
  static constexpr char kOobeShillOnlineHistogram[] =
      "CaptivePortal.OOBE.DiscrepancyWithShill_Online";
  static constexpr char kOobeShillPortalHistogram[] =
      "CaptivePortal.OOBE.DiscrepancyWithShill_RestrictedPool";
  static constexpr char kOobeShillOfflineHistogram[] =
      "CaptivePortal.OOBE.DiscrepancyWithShill_Offline";
  static constexpr char kOobePortalToOnlineHistogram[] =
      "CaptivePortal.OOBE.PortalToOnlineTransition";

  static constexpr char kSessionDetectionResultHistogram[] =
      "CaptivePortal.Session.DetectionResult";
  static constexpr char kSessionDetectionDurationHistogram[] =
      "CaptivePortal.Session.DetectionDuration";
  static constexpr char kSessionShillOnlineHistogram[] =
      "CaptivePortal.Session.DiscrepancyWithShill_Online";
  static constexpr char kSessionShillPortalHistogram[] =
      "CaptivePortal.Session.DiscrepancyWithShill_RestrictedPool";
  static constexpr char kSessionShillOfflineHistogram[] =
      "CaptivePortal.Session.DiscrepancyWithShill_Offline";
  static constexpr char kSessionPortalToOnlineHistogram[] =
      "CaptivePortal.Session.PortalToOnlineTransition";

  static constexpr char kDetectedOfflineSincePortalNetworkHistogram[] =
      "CaptivePortal.DetectedOfflineSincePortalNetwork";

  // The delay since default network reports portal network, used to record
  // offline detection result.
  static constexpr base::TimeDelta kDelaySincePortalNetworkForUMA =
