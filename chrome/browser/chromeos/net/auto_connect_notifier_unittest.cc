...
class AutoConnectNotifierTest : public NetworkStateTest {
 protected:
  ...
  class TestAutoConnectHandler : public AutoConnectHandler {
   public:
    ...
    // Make AutoConnectHandler::NotifyAutoConnectInitiated() public.
    using AutoConnectHandler::NotifyAutoConnectInitiated;
  };
