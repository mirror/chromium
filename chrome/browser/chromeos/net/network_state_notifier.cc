...
void ShowErrorNotification(const std::string& service_path,
  ...
  // The other CreateSystemNotification (with a callback) calls
  // SetSystemPriority, but this one does not. Set the priority to high to make
  // sure it shows on the lock screen.
