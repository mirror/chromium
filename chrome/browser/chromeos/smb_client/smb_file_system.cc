...
// any time you visit a folder. A bug
// https://bugs.chromium.org/p/chromium/issues/detail?id=548050 tracks not doing
// that for NETWORK providers. This work around is to supply an icon but make it
...
void SmbFileSystem::HandleRequestGetMetadataEntryCallback(
  ...
  // Mime types are not currently supported.
