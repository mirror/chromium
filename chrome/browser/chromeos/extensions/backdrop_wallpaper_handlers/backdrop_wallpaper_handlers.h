...
class CollectionNameFetcher : public net::URLFetcherDelegate {
 ...
 private:
  ...
  // The callback upon completion of fetching the collection names.
  OnCollectionNamesFetched callback_;
...
class ImageInfoFetcher : public net::URLFetcherDelegate {
 public:
  using OnImagesInfoFetched = base::OnceCallback<void(base::Value images_info)>;
