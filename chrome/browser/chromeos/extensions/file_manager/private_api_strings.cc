...
ExtensionFunction::ResponseAction FileManagerPrivateGetStringsFunction::Run() {
  ...
  SET_STRING("RENAMING_FINISHED_FAILURE_MESSAGE",
             IDS_RENAMING_FINISHED_FAILURE_MESSAGE);
  SET_STRING("RENAMING_FINISHED_SUCCESS_MESSAGE",
             IDS_RENAMING_FINISHED_SUCCESS_MESSAGE);
