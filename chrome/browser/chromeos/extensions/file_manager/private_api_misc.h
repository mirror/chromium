...
// Implements the chrome.fileManagerPrivate.getRecentFiles method.
class FileManagerPrivateGetRecentFilesFunction
    : public UIThreadExtensionFunction {
 public:
  FileManagerPrivateGetRecentFilesFunction();
  DECLARE_EXTENSION_FUNCTION("fileManagerPrivate.getRecentFiles",
                             FILEMANAGERPRIVATE_GETRECENTFILES)
 protected:
  ~FileManagerPrivateGetRecentFilesFunction() override {}
 ...
 private:
  ...
  const ChromeExtensionFunctionDetails chrome_details_;
  DISALLOW_COPY_AND_ASSIGN(FileManagerPrivateGetRecentFilesFunction);
};
