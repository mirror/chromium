...
ExtensionFunction::ResponseAction
FileManagerPrivateGetRecentFilesFunction::Run() {
  const scoped_refptr<storage::FileSystemContext> file_system_context =
      file_manager::util::GetFileSystemContextForRenderFrameHost(
          chrome_details_.GetProfile(), render_frame_host());
  ...
  model->GetRecentFiles(
      ...
      base::BindOnce(
          &FileManagerPrivateGetRecentFilesFunction::OnGetRecentFiles, this));
  return RespondLater();
}

void FileManagerPrivateGetRecentFilesFunction::OnGetRecentFiles(
  ...
  file_manager::util::ConvertFileDefinitionListToEntryDefinitionList(
      ...
      base::Bind(&FileManagerPrivateGetRecentFilesFunction::
                     OnConvertFileDefinitionListToEntryDefinitionList,
                 this));
}

void FileManagerPrivateGetRecentFilesFunction::
    OnConvertFileDefinitionListToEntryDefinitionList(
