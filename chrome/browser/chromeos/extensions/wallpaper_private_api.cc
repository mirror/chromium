...
#undef SET_STRING
  ...
  // TODO(crbug.com/777293, 776464): Make it work under mash. It'll be trivial
  // if the new wallpaper picker is implemented in views (most likely),
  // otherwise, create a mojo callback.
