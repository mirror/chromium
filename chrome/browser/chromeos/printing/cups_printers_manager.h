...
class CupsPrintersManager {
 public:
  ...
  // Allows the PrinterDetector objects that the CupsPrinterManager is observing
  // to begin registering callbacks. This method is meant to be called only once
  // after CupsPrintersManager has been added as an observer to the appropriate
  // PrinterDetector objects.
  virtual void StartObservingPrinterDetectors() = 0;
