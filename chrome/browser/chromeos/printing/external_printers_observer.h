...
#ifndef CHROME_BROWSER_CHROMEOS_PRINTING_EXTERNAL_PRINTERS_OBSERVER_H_
#define CHROME_BROWSER_CHROMEOS_PRINTING_EXTERNAL_PRINTERS_OBSERVER_H_
...
class ExternalPrintersObserver {
 public:
  ExternalPrintersObserver(const ExternalPrinterPolicies& policies,
...
#endif  // CHROME_BROWSER_CHROMEOS_PRINTING_EXTERNAL_PRINTERS_OBSERVER_H_
