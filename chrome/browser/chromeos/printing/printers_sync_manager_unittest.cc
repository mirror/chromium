...
class LoggingObserver : public PrintersSyncManager::Observer {
 public:
...
class PrintersSyncManagerTest : public testing::Test {
 protected:
  PrintersSyncManagerTest()
      : manager_(
            &profile_,
  ...
  PrintersSyncManager manager_;
};

TEST_F(PrintersSyncManagerTest, AddPrinter) {
...
TEST_F(PrintersSyncManagerTest, UpdatePrinterAssignsId) {
...
TEST_F(PrintersSyncManagerTest, UpdatePrinter) {
  manager_.RegisterPrinter(base::MakeUnique<Printer>(kPrinterId));
...
TEST_F(PrintersSyncManagerTest, RemovePrinter) {
...
TEST_F(PrintersSyncManagerTest, RecommendedPrinters) {
...
TEST_F(PrintersSyncManagerTest, GetRecommendedPrinter) {
