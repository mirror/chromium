...
TEST_F(UserActivityLoggerDelegateUkmTest, Basic) {
  ...
  EXPECT_TRUE(
      ukm_entry_checker_.WasNewEntryRecorded(UserActivity::kEntryName, 1));
  EXPECT_TRUE(
      ukm_entry_checker_.WasNewEntryRecorded(UserActivityId::kEntryName, 2));
...
TEST_F(UserActivityLoggerDelegateUkmTest, NoOpenTabs) {
  ...
  EXPECT_TRUE(
      ukm_entry_checker_.WasNewEntryRecorded(UserActivity::kEntryName, 1));
  EXPECT_TRUE(
      ukm_entry_checker_.WasNewEntryRecorded(UserActivityId::kEntryName, 0));
