...
// Video starts then a user activity comes in, followed by video stopped soon
// afterwards.
TEST_F(IdleEventNotifierTest, ActivityAfterVideoStarts) {
  ...
  idle_event_notifier_->OnVideoStateChanged(
      ash::VideoDetector::State::NOT_PLAYING);
  FastForwardAndCheckResults(
      1, {now_3 /* last_activity_data */, now_1 /* earliest_activity_time */,
          now_2 /* last_user_activity_time */, now_2 /* last_mouse_time */});
}
