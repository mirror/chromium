...
class KioskAppLaunchWaiter : public KioskAppManagerObserver {
 public:
  KioskAppLaunchWaiter() : scoped_observer_(this) {
    scoped_observer_.Add(KioskAppManager::Get());
  }
  ~KioskAppLaunchWaiter() override = default;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(KioskAppLaunchWaiter);
};
