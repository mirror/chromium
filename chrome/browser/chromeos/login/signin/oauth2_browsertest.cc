...
class ThreadBlocker {
 ...
 private:
  ...
  static void BlockThreadOnThread(base::WaitableEvent* event) {
...
IN_PROC_BROWSER_TEST_F(OAuth2Test, OverlappingContinueSessionRestore) {
  ...
  auto restored_command_line =
      base::MakeUnique<base::test::ScopedCommandLine>();
