...
// Find locales information of public account user.
...
//                         recommended locales.
std::unique_ptr<base::ListValue> FindPublicSessionLocales(
...
void AddPublicSessionDetailsToUserDictionaryEntry(
  ...
  bool has_multiple_locale;
  std::unique_ptr<base::ListValue> available_locales =
      FindPublicSessionLocales(public_session_recommended_locales,
                               &selected_locale, &has_multiple_locale);
...
void UserSelectionScreen::FillUserMojoStruct(
  ...
  user_info->public_account_info->show_advanced_view = has_multiple_locale;
}
