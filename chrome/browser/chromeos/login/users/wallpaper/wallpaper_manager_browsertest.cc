...
const int kLargeWallpaperHeight = ash::WallpaperController::kLargeWallpaperMaxHeight;
constexpr int kSmallWallpaperWidth = 256;
const int kSmallWallpaperHeight = ash::WallpaperController::kSmallWallpaperMaxHeight;
