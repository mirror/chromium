...
class WallpaperManager : public ash::mojom::WallpaperPicker,
 ...
 public:
  ...
  // Sets default wallpaper (asynchronously with zero or default delay).
  // |update_wallpaper| indicates whether to actually change the wallpaper, or
  // only update cache. |remove_custom_wallpaper| indicates whether to remove
  // the custom wallpaper of this user (if any), or only set the default
  // wallpaper once.
  void SetDefaultWallpaper(const AccountId& account_id,
                           bool update_wallpaper,
                           bool remove_custom_wallpaper);

  // Sets |account_id|'s wallpaper (asynchronously with zero or default delay).
  ...
  // Sets wallpaper to |image| (asynchronously with zero or default delay) from
  // an URL. |update_wallpaper| indicates whether to actually change the
  // wallpaper, or only update cache.
  ...
  // current display's resolution (asynchronously with zero or default delay).
