...
// const char ash::WallpaperController::kLargeWallpaperSubDir[] = "large";
// const char ash::WallpaperController::kOriginalWallpaperSubDir[] = "original";
// const char ash::WallpaperController::kThumbnailWallpaperSubDir[] = "thumb";
...
bool WallpaperManager::GetLoggedInUserWallpaperInfo(WallpaperInfo* info) {
  ...
  if (user_manager::UserManager::Get()->IsLoggedInAsStub()) {
    *info =
        WallpaperInfo("", wallpaper::WALLPAPER_LAYOUT_CENTER_CROPPED,
...
void WallpaperManager::LoadWallpaper(const AccountId& account_id,
  ...
  if (info.type == wallpaper::ONLINE) {
    ...
    DCHECK(
        ash::WallpaperController::dir_chromeos_wallpapers_path_id.has_value());
    CHECK(PathService::Get(
        ash::WallpaperController::dir_chromeos_wallpapers_path_id.value(),
        &wallpaper_dir));
    ...
    DCHECK(ash::WallpaperController::dir_user_data_path_id.has_value());
    PathService::Get(ash::WallpaperController::dir_user_data_path_id.value(),
                     &user_data_dir);
...
base::FilePath WallpaperManager::GetDeviceWallpaperDir() {
  base::FilePath wallpaper_dir;
  DCHECK(ash::WallpaperController::dir_chromeos_wallpapers_path_id.has_value());
  if (!PathService::Get(
          ash::WallpaperController::dir_chromeos_wallpapers_path_id.value(),
          &wallpaper_dir)) {
...
ash::CustomWallpaperMap* WallpaperManager::GetWallpaperCacheMap() {
  if (!ash::Shell::HasInstance() || ash_util::IsRunningInMash())
    ...
    return ash::Shell::Get()->wallpaper_controller()->wallpaper_cache_map();
}
