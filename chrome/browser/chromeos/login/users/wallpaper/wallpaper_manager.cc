...
void WallpaperManager::InitializeWallpaper() {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
  WallpaperControllerClient::Get()->SetPathIds(
...
void WallpaperManager::LoadWallpaper(const AccountId& account_id,
  ...
  if (info.type == wallpaper::ONLINE) {
    ...
    DCHECK(ash::WallpaperController::kDirChromeOsWallpapersPathId != -1);
    CHECK(
        PathService::Get(ash::WallpaperController::kDirChromeOsWallpapersPathId,
                         &wallpaper_dir));
    ...
    DCHECK(ash::WallpaperController::kDirUserDataPathId != -1);
    PathService::Get(ash::WallpaperController::kDirUserDataPathId,
                     &user_data_dir);
...
base::FilePath WallpaperManager::GetDeviceWallpaperDir() {
  base::FilePath wallpaper_dir;
  DCHECK(ash::WallpaperController::kDirChromeOsWallpapersPathId != -1);
  if (!PathService::Get(ash::WallpaperController::kDirChromeOsWallpapersPathId,
                        &wallpaper_dir)) {
