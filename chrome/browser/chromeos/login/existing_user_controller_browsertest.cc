...
class ExistingUserControllerSavePasswordHashTest
 ...
 public:
  ...
  void SetUpInProcessBrowserTestFixture() override {
    ...
    // The following line of code is not needed, but it coincidentally prevents
    // race condition between SuccessFetcher and IntranetRedirectDetector.
    // TODO(xiyuan): Remove this test class and use ExistingUserControllerTest
    // instead after crbug.com/796636 is fixed.
    RefreshDevicePolicy();
  }
};
