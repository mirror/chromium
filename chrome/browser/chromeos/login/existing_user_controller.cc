...
void ExistingUserController::OnPolicyFetchResult(
  ...
  arc::EcryptfsMigrationAction action =
      arc::EcryptfsMigrationAction::DISALLOW_ARC_NO_MIGRATION;
  if (result == PolicyFetchResult::NO_POLICY) {
    ...
    action = arc::EcryptfsMigrationAction::DISALLOW_ARC_NO_MIGRATION;
  }
  ...
  switch (action) {
    ...
    case arc::EcryptfsMigrationAction::DISALLOW_ARC_NO_MIGRATION:
