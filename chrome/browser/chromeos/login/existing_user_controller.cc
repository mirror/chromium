...
// EcryptfsMigrationAction enum. If the policy is present, returns true after
// setting its value to *|out_value| and the value of ArcEnabled policy, if
// present, to *|is_arc_enabled|. Otherwise, returns false.
