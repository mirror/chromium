...
// EcryptfsMigrationAction enum. If the policy is present, its value is set to
// *|out_value| and the value of ArcEnabled policy is decoded, setting its value
// to *|is_arc_enabled|. Otherwise, returns false.
