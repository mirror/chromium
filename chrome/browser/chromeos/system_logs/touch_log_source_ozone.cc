...
void OnStatusLogCollected(
  ...
  ui::InputDeviceControllerClient* input_device_controler_client =
      g_browser_process->platform_part()->GetInputDeviceControllerClient();
  input_device_controler_client->GetTouchEventLog(
      kBaseLogPath,
...
void TouchLogSource::Fetch(const SysLogsSourceCallback& callback) {
  ...
  ui::InputDeviceControllerClient* input_device_controler_client =
      g_browser_process->platform_part()->GetInputDeviceControllerClient();
  input_device_controler_client->GetTouchDeviceStatus(
