...
#ifndef CHROME_BROWSER_CHROMEOS_SAMBA_CLIENT_SAMBA_FILE_SYSTEM_H_
#define CHROME_BROWSER_CHROMEOS_SAMBA_CLIENT_SAMBA_FILE_SYSTEM_H_
...
class SambaFileSystem
    : public file_system_provider::ProvidedFileSystemInterface {
 public:
  explicit SambaFileSystem(
      const file_system_provider::ProvidedFileSystemInfo& file_system_info);
  ~SambaFileSystem() override;
 ...
 private:
  ...
  base::WeakPtrFactory<SambaFileSystem> weak_ptr_factory_;
  DISALLOW_COPY_AND_ASSIGN(SambaFileSystem);
};

}  // namespace samba_client
}  // namespace chromeos

#endif  // CHROME_BROWSER_CHROMEOS_SAMBA_CLIENT_SAMBA_FILE_SYSTEM_H_
