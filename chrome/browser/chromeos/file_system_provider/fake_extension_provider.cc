...
// static
std::unique_ptr<ProviderInterface>
FakeExtensionProvider::CreateWithCapabilities(
    const std::string& extension_id,
    const Capabilities& capabilities) {
  return std::unique_ptr<ProviderInterface>(
      new FakeExtensionProvider(extension_id, capabilities));
}
...
Capabilities FakeExtensionProvider::GetCapabilities() {
