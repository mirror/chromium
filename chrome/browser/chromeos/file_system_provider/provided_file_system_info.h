...
class ProviderId {
 public:
  enum ProviderType : uint32_t { EXTENSION, NATIVE };
  ProviderId();

  ProviderId(const std::string& provider_id, ProviderType provider_type);
...
class ProvidedFileSystemInfo {
 public:
  ...
  ProvidedFileSystemInfo(ProviderId provider_id,
