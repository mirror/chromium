...
class FileSystemProviderServiceTest : public testing::Test {
 protected:
  ...
  static bool called_default_factory_;
  static bool called_custom_factory_;
...
bool FileSystemProviderServiceTest::called_default_factory_;
bool FileSystemProviderServiceTest::called_custom_factory_;
...
TEST_F(FileSystemProviderServiceTest, RegisterFileSystemFactory) {
  ...
  ASSERT_EQ(false, FileSystemProviderServiceTest::called_default_factory_);

  EXPECT_EQ(base::File::FILE_OK,
            service_->MountFileSystem(
                kProviderId, MountOptions(kFileSystemId, kDisplayName)));

  ASSERT_EQ(true, FileSystemProviderServiceTest::called_default_factory_);

  ASSERT_EQ(false, FileSystemProviderServiceTest::called_custom_factory_);

  EXPECT_EQ(base::File::FILE_OK,
            service_->MountFileSystem(
                kCustomProviderId, MountOptions(kFileSystemId, kDisplayName)));

  ASSERT_EQ(true, FileSystemProviderServiceTest::called_custom_factory_);
}
