 ...
 public:
  ...
  void SetUp() override {
    ...
    std::unique_ptr<FakeChromeUserManager> fake_user_manager =
        base::MakeUnique<FakeChromeUserManager>();
    fake_user_manager_enabler_ =
        base::MakeUnique<ScopedUserManagerEnabler>(fake_user_manager.get());
    ...
    mock_user_manager_enabler_ =
        base::MakeUnique<ScopedUserManagerEnabler>(new MockUserManager());
  ...
  void TearDown() override {
    ...
    mock_user_manager_enabler_.reset();
    fake_user_manager_enabler_.reset();
