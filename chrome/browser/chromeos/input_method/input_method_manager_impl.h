...
// TODO(jamescook): Replace ash::ImeManager with mojo interface.
class InputMethodManagerImpl : public InputMethodManager,
                               public ash::ImeManager,
 ...
 public:
  ...
  // ash::ImeManager:
  ash::IMEInfo GetCurrentIme() override;
  std::vector<ash::IMEPropertyInfo> GetCurrentImeProperties() override;
  std::vector<ash::IMEInfo> GetAvailableImes() override;
  bool IsImeManaged() override;
