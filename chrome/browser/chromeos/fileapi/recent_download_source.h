...
class RecentDownloadSource : public RecentSource {
 ...
 private:
  ...
  void OnGetDownloadsMountPointName(const std::string& mount_point_name);
  ...
  // Mount point name of Downloads. It is filled on the first call of
  // GetRecentFiles().
  base::Optional<std::string> mount_point_name_;
