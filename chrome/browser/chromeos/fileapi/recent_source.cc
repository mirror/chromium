...
RecentSource::Params::Params() : is_valid_(false), max_files_(0) {}
...
RecentSource::Params::Params(const Params& other) = default;

RecentSource::Params::Params(Params&& other)
...
RecentSource::Params& RecentSource::Params::operator=(const Params& other) =
    default;
