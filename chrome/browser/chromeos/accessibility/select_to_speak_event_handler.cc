...
bool SelectToSpeakEventRewriter::OnMouseEvent(const ui::MouseEvent* event) {
  ...
  if (event_delegate_for_testing_) {
    ...
    ui::MouseEvent mouse_event = GetMouseEventInDIPs(event);
...
ui::MouseEvent SelectToSpeakEventRewriter::GetMouseEventInDIPs(
  ...
  DCHECK(mouse_event.IsMouseEvent());
  // ui::MouseEvent* mouse_event =
