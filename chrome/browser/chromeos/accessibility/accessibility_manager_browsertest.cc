...
void SessionStarted(const AccountId& account_id) {
  // Load the user profile of |account_id|.
...
IN_PROC_BROWSER_TEST_F(AccessibilityManagerLoginTest, Login) {
  ...
  // Loads user profile and starts session.
  SessionStarted(test_account_id_);
