...
class TimeZoneResolverManager : public TimeZoneResolver::Delegate {
 public:
  ...
  // Returns kResolveTimezoneByGeolocationMethod preference value.
  // Defaults DISABLED for unknown values.
  static TimeZoneResolveMethod GetUserTimeZoneResolveMethod(
