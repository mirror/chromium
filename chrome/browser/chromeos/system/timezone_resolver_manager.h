 ...
 public:
  class Observer {
   public:
    ...
    // preferences updated, it can be used to observe all time zone -related
    // preference changes.
  ...
  // Returns true if time zone resolve is policy controlled and thus
  // cannot be changed by user.
  static bool IsTimeZoneResolvePolicyControlled();
