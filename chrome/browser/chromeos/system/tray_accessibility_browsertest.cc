...
class TrayAccessibilityTest
 ...
 protected:
  ...
  void ClickSpokenFeedbackOnDetailMenu() {
    auto* view = static_cast<views::View*>(
  ...
  void ClickHighContrastOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->high_contrast_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
  ...
  void ClickAutoclickOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->autoclick_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
  ...
  void ClickLargeMouseCursorOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->large_cursor_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
  ...
  void ClickMonoAudioOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->mono_audio_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
  ...
  void ClickStickyKeysOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->sticky_keys_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
  ...
  void ClickTapDraggingOnDetailMenu() {
    auto* view =
        static_cast<views::View*>(tray()->detailed_menu_->tap_dragging_view_);
    ASSERT_TRUE(view);
    tray()->detailed_menu_->OnViewClicked(view);
  }
