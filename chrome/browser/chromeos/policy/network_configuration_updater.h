...
class NetworkConfigurationUpdater : public PolicyService::Observer {
 ...
 protected:
  ...
  // Certificates of the current policy. Returns true if the policy was valid.
  // Callers can pass nullptr to any of |network_configs|,
  // |global_network_config|, |certificates| if they don't need that specific
  // part of the ONC policy.
