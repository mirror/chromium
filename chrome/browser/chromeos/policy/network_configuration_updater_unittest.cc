...
class FakeCertificateImporter : public chromeos::onc::CertificateImporter {
 public:
  ...
  void ImportCertificates(const base::ListValue& certificates,
    ...
    ++call_count_;
    done_callback.Run(true, net::x509_util::DupCERTCertificateVector(
 ...
 private:
  ...
  net::ScopedCERTCertificateVector onc_trusted_certificates_;
...
TEST_F(NetworkConfigurationUpdaterTest,
  ...
  net::ScopedCERTCertificateVector cert_list =
