...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_OFF_HOURS_UTILS_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_OFF_HOURS_UTILS_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_OFF_HOURS_UTILS_H_
