...
WeeklyTime WeeklyTime::AddMilliseconds(int milliseconds) const {
  ...
  int millisecond_offset = milliseconds_ + milliseconds;
  // Get milliseconds from the start of the day.
  int result_milliseconds = millisecond_offset % kDay.InMilliseconds();
  int day_offset = millisecond_offset / kDay.InMilliseconds();
