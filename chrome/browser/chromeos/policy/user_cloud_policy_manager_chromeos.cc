...
UserCloudPolicyManagerChromeOS::UserCloudPolicyManagerChromeOS(
  ...
  DLOG(ERROR) << "enforcement_type = " << static_cast<int>(enforcement_type_);
  DLOG(ERROR) << "waiting_for_policy_fetch_ = " << waiting_for_policy_fetch_;
  DLOG(ERROR) << "policy_refresh_timeout = " << policy_refresh_timeout;
  ...
  if (!policy_refresh_timeout.is_zero()) {
    ...
    policy_refresh_timeout_.Start(
        ...
        base::Bind(&UserCloudPolicyManagerChromeOS::OnPolicyRefreshTimeout,
