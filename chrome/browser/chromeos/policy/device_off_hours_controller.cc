...
// WeeklyTime class contains day of week number and time in milliseconds.
class WeeklyTime {
 public:
...
void DeviceOffHoursController::StartOffHoursTimer(int delay) {
  ...
  VLOG(1) << "OffHours mode timer starts for " << delay / kMillisecondsInMinute
          << " minutes.";
...
void DeviceOffHoursController::UpdateOffHoursMode(
  ...
  WeeklyTime cur_t(aTime->tm_wday, aTime->tm_hour * kMillisecondsInHour +
                                       aTime->tm_min * kMillisecondsInMinute +
                                       aTime->tm_sec * 1000);
