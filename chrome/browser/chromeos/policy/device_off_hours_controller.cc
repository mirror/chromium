...
DeviceOffHoursController::DeviceOffHoursController() : weak_ptr_factory_(this) {
  ...
  if (chromeos::DBusThreadManager::IsInitialized()) {
    ...
    chromeos::DBusThreadManager::Get()
        ...
        ->AddServiceInitiallyAvailableCallback(base::Bind(
            &DeviceOffHoursController::ClockServiceInitiallyAvailable,
...
void DeviceOffHoursController::ClockServiceInitiallyAvailable(
