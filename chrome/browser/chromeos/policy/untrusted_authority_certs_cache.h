...
class UntrustedAuthorityCertsCache {
 ...
 private:
  ...
  // Please don't delete this field, even if it looks unused!
  ...
  // However, this is not a (security) issue, as we don't import these
  // certificates into permanent databases, and we don't attempt to mutate trust
  // on these certificats.
