...
class UserNetworkConfigurationUpdater : public NetworkConfigurationUpdater,
 ...
 private:
  ...
  void OnCertificatesImported(bool success);
  ...
  // Holds certificates from the last import.
  ...
  // to true. The certificates to be imported are in |certs_| and will be
  // processed when the certificate importer is set.
  bool pending_certificate_import_ = false;
