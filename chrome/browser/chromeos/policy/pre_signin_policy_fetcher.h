...
class PreSigninPolicyFetcher : public CloudPolicyClient::Observer {
 ...
 private:
  ...
  // The CloudPolicyClient passed in from tests which should be used instead of
  // creating our own CloudPolicyClient.
  std::unique_ptr<CloudPolicyClient> cloud_policy_client_for_testing_;
