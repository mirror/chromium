...
// Remove |policies_proto_tags_to_remove| fields from |policies|.
// Vector |policies_proto_tags_to_remove| contains device policies proto tags
...
void RemovePolicies(enterprise_management::ChromeDeviceSettingsProto* policies,
                    const std::vector<int>& policies_proto_tags_to_remove);
