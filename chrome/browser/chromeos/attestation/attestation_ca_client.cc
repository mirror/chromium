  ...
  const net::NetworkTrafficAnnotationTag traffic_annotation =
      net::DefineNetworkTrafficAnnotation("arc_auth_code_fetcher", R"(
        ...
        policy {
          cookies_allowed: NO
          setting:
            "Admin can deprovision the device to disable this feature. Also "
            "disable-machine-cert-request Chrome flag disables the certificate "
            "request, but it cannot be set by a policy."
