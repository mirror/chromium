...
class TetherService : public KeyedService,
 ...
 private:
  ...
  bool IsBleAdvertisingSupported();
  ...
  bool has_set_ble_advertising_interval_ = false;

  // Whether BLE advertising is supported on this device. This will only become
  // true if a call to BluetoothAdapter::SetAdvertisingInterval() during
  // TetherService construction succeeds. That method will fail in cases like
  // those captured in crbug.com/738222.
  bool is_ble_advertising_supported_ = false;
