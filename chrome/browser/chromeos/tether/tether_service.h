...
class TetherService : public KeyedService,
 ...
 private:
  ...
  // TetherFeatureState::BLE_NOT_PRESENT as Bluetooth starts up. We do not want
  // to record this initial "false positive", so this method suppresses its
  // first report.
  void RecordTetherFeatureStateWithoutBleNotPresentFalsePositive();
  ...
  // Used by RecordTetherFeatureStateWithoutBleNotPresentFalsePositive().
