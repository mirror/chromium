...
class LockScreenAppManagerImplTest
 ...
 public:
  ...
  // |create_lock_screen_profile| - whether the lock screen profile creator
  //     passed to the app manager should start lock  screen profile creation
  //     before starting the app manager. If this is not set, the test should
  //     create the lock screen profile itself (and should not use
