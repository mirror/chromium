...
class StateController : public ash::mojom::TrayActionClient,
 ...
 public:
  ...
  // Sets tick clock to be used in tests.
  ...
  // Called from lock screen Web UI when the animation shown on note action
  // launch finishes (the animation is started when the lock screen note state
  // changes to kLaunching).
 ...
 private:
  ...
  enum class ScreenState {
    // The screen state has not yet been initialized (by querying the power
    // manager for current brightness.
    kUnknown,
