...
class StateController : public ash::mojom::TrayActionClient,
 ...
 public:
  ...
  // Sets test ProfileLoader implementation. Should be called before
  // |SetPrimaryProfile|
  void SetLockScreenProfileLoaderForTesting(
      std::unique_ptr<ProfileLoader> profile_loader);
 ...
 private:
  ...
  void OnProfilesReady(Profile* primary_profile, bool success);
  ...
  std::unique_ptr<ProfileLoader> lock_screen_profile_loader_;
