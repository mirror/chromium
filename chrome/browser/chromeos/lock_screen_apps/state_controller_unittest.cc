...
class TestAppManager : public lock_screen_apps::AppManager {
 public:
  ...
  TestAppManager(
      ...
      lock_screen_apps::LockScreenProfileCreator* lock_screen_profile_loader)
  ...
  void Initialize(Profile* primary_profile,
                  lock_screen_apps::LockScreenProfileCreator*
                      lock_screen_profile_loader) override {
 ...
 private:
  ...
  lock_screen_apps::LockScreenProfileCreator* lock_screen_profile_loader_;
...
class LockScreenAppStateTest : public BrowserWithTestWindowTest {
 public:
  ...
  lock_screen_apps::FakeLockScreenProfileCreator* lock_screen_profile_loader() {
 ...
 private:
  ...
  lock_screen_apps::FakeLockScreenProfileCreator* lock_screen_profile_loader_ =
      nullptr;
