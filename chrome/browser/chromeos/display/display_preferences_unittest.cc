...
TEST_F(MultiMirroringDisplayPreferencesTest, DisplayCustomMirrorMode) {
  ...
  display::CustomSoftwareMirroringParam mirroring_param(internal_display_id,
                                                        {first_display_id});
  ...
  std::unique_ptr<display::CustomSoftwareMirroringParam> new_mirroring_param =
      std::make_unique<display::CustomSoftwareMirroringParam>(first_display_id,
                                                              dst_ids);
