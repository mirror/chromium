...
TEST_F(DisplayPreferencesTest, BasicStores) {
  ...
  // Test for legacy support on touch calibration data.
  display::test::DisplayManagerTestApi(display_manager())
      .SetLegacyTouchCalibrationData(
          id1, display::TouchCalibrationData(point_pair_quad_1, touch_size_1));
  ...
  // Make sure legacy touch calibration data is still working as expected.
  ...
  display_manager()->RegisterDisplayProperty(
      ...
      1.0f, nullptr /* touch_calibration_data */,
