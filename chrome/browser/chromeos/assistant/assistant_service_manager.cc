...
AssistantServiceManager::AssistantServiceManager(
    ...
    : auth_token_provider_(auth_token_provider),
      ...
      assistant_manager_(
          assistant_client::AssistantManager::Create(platform_api_.get(),
                                                     kDefaultConfigStr)),
      assistant_manager_internal_(
          UnwrapAssistantManagerInternal(assistant_manager_.get())) {}

AssistantServiceManager::~AssistantServiceManager() = default;

void AssistantServiceManager::Start() {
