...
#ifndef CHROME_BROWSER_CHROMEOS_ASSISTANT_PLATFORM_API_IMPL_H_
#define CHROME_BROWSER_CHROMEOS_ASSISTANT_PLATFORM_API_IMPL_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_ASSISTANT_PLATFORM_API_IMPL_H_
