...
#ifndef CHROME_BROWSER_FONT_PREF_CHANGE_NOFITIER_FACTORY_H_
#define CHROME_BROWSER_FONT_PREF_CHANGE_NOFITIER_FACTORY_H_
...
#endif  // CHROME_BROWSER_FONT_PREF_CHANGE_NOFITIER_FACTORY_H_
