...
class ChromeMojoProxyResolverFactory::ResolverFactoryChannel
 ...
 private:
  ...
  void OnResolverDestroyed() override {
    ...
    // the untility process is killed when it shouldn't be, or is not killed
...
ChromeMojoProxyResolverFactory::GetFactoryInterface() {
...
#if DCHECK_IS_ON()
  size_t real_num_proxy_resolvers = 0;
