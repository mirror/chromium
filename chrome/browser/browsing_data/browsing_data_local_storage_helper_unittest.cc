...
TEST_F(CannedBrowsingDataLocalStorageTest, Delete) {
  ...
  helper->DeleteOrigin(origin2, base::OnceClosure());
  EXPECT_EQ(2u, helper->GetLocalStorageCount());
  helper->DeleteOrigin(origin1, base::OnceClosure());
  ...
  EXPECT_EQ(2u, helper->GetLocalStorageCount());
  helper->DeleteOrigin(origin3, base::OnceClosure());
  ...
  helper->AddLocalStorage(suborigin_on_origin_3);
  EXPECT_EQ(2u, helper->GetLocalStorageCount());
  helper->DeleteOrigin(suborigin_on_origin_3, base::OnceClosure());
  EXPECT_EQ(0u, helper->GetLocalStorageCount());
}
