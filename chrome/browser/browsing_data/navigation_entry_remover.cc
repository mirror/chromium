...
// TODO: This can't be shared with IOS as almost everything depends on browser/
// or content/ but it could be split into an Interface with
// vector<WebContents*> WebContentsProvider::GetWebContents(Profile*)
// (One Impl for desktop, one for Android) and a NavigationEntryRemover.
