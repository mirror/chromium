...
struct RequestSpecifics {
 public:
  RequestSpecifics(ResourceLoadingObserver::ResourceDataType type, bool done);

 private:
  ResourceLoadingObserver::ResourceDataType request_type;
  bool complete;  // true if the request has completed.
};
