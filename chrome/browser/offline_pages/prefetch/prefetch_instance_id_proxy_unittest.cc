...
class PrefetchInstanceIDProxyTest : public testing::Test {
 public:
  ...
  PrefetchInstanceIDProxy* proxy() { return &proxy_; }
 ...
 private:
  ...
  PrefetchInstanceIDProxy proxy_;
...
PrefetchInstanceIDProxyTest::PrefetchInstanceIDProxyTest()
    : proxy_(kAppIdForTest, &profile_) {
