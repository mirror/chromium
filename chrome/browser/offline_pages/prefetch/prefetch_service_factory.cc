...
KeyedService* PrefetchServiceFactory::BuildServiceInstanceFor(
  ...
  std::unique_ptr<PrefetchGCMAppHandler> prefetch_gcm_app_handler =
      base::MakeUnique<PrefetchGCMAppHandler>());

  std::unique_ptr<OfflineMetricsCollectorImpl> offline_metrics_collector =
