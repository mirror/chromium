...
int PrefetchBackgroundTaskHandlerImpl::GetAdditionalBackoffSeconds() {
...
PrefetchBackgroundTaskHandlerImpl::GetCurrentBackoff() {
...
void PrefetchBackgroundTaskHandlerImpl::SetTickClockForTest(
