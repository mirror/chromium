...
class OfflinePageUtils {
 public:
  ...
  // already downloaded or will be downloaded soon (as indicated by
  // |exists_duplicate_request|). The user either decides to continue with
  // creating a duplicate - which is indicated by invoking the
