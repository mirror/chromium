...
void OfflinePageRequestJobTest::SetUp() {
  ...
  // Skip the consistency check at startup. Otherwise the MHTMLs for testing
  // will be deleted before usage since they'll be considered as orphaned
  // archives.
  model->set_skip_consistency_check_for_testing();
