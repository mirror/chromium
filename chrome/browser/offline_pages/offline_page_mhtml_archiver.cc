...
void OfflinePageMHTMLArchiver::GenerateMHTML(
  ...
  base::PostTaskWithTraitsAndReplyWithResult(
      ...
      base::BindOnce(
          &OfflinePageMHTMLArchiver::ContinueMHTMLGenerationWithFileName,
          weak_ptr_factory_.GetWeakPtr(), url, title, create_archive_params));
}

void OfflinePageMHTMLArchiver::ContinueMHTMLGenerationWithFileName(
    const GURL& url,
