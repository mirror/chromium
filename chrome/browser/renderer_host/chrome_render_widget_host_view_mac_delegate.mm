...
- (void)checkSpelling:(id)sender {
  ...
  spellcheck::mojom::SpellCheckPanelPtr focused_frame_panel_client;
  webContents->GetFocusedFrame()->GetRemoteInterfaces()->GetInterface(
      &focused_frame_panel_client);
  focused_frame_panel_client->AdvanceToNextMisspelling();
}
...
- (void)showGuessPanel:(id)sender {
  ...
  webContents->GetFocusedFrame()->GetRemoteInterfaces()->GetInterface(
      &focused_frame_panel_client);
  focused_frame_panel_client->ToggleSpellPanel(visible);
}
