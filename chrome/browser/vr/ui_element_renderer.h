...
class UiElementRenderer {
 public:
  ...
  void DrawLaser(float opacity, const gfx::Transform& view_proj_matrix);

  void DrawReticle(float opacity, const gfx::Transform& view_proj_matrix);

  void DrawWebVr(int texture_data_handle);

  void Flush();
  void SetUp(std::unique_ptr<ControllerMesh> mesh);
