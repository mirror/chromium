...
// TODO(vollick): move CornerRadii to its own header.
...
static constexpr char const* kVertexShader = SHADER(
  ...
  void main() {
    ...
    // TODO(vollick): we can do the picking of corner offsets based on vertex
    // attributes rather than having all this conditional logic.
    vec2 corner_offset;
