...
static constexpr float kIndicatorHeightDMM = 0.064f * 2.4f;
...
static constexpr float kIndicatorMarginDMM = kIndicatorHeightDMM * 0.2f * 2.4f;
...
static constexpr float kIndicatorButtonDiameterDMM = 0.064f;
static constexpr float kIndicatorTooltipHeightDMM = 0.056f;
static constexpr float kIndicatorTooltipGapDMM = 0.008f;
