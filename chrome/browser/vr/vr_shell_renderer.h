...
class VrShellRenderer : public vr::UiElementRenderer {
 public:
  ...
  gfx::Size content_texture_size() const { return content_texture_size_; }
  void set_content_texture_size(const gfx::Size& content_texture_size) {
    content_texture_size_ = content_texture_size;
  }
 ...
 private:
  ...
  gfx::Size content_texture_size_;
...
class TexturedQuadRenderer : public BaseQuadRenderer {
 ...
 private:
  ...
  float ComputePhysicalWidth(const QuadData& quad) const;
