...
const std::vector<std::string> kElementsInDrawOrder = {
    ...
    "kContentQuad",
    "kAudioCaptureIndicator",
    "kAudioCaptureIndicator:kTypeToastBackground",
    "kAudioCaptureIndicator:kTypeToastIcon",
    "kAudioCaptureIndicator:kTypeToastText",
    "kVideoCaptureIndicator",
    "kVideoCaptureIndicator:kTypeToastBackground",
    "kVideoCaptureIndicator:kTypeToastIcon",
    "kVideoCaptureIndicator:kTypeToastText",
    "kScreenCaptureIndicator",
    "kScreenCaptureIndicator:kTypeToastBackground",
    "kScreenCaptureIndicator:kTypeToastIcon",
    "kScreenCaptureIndicator:kTypeToastText",
    "kBluetoothConnectedIndicator",
    "kBluetoothConnectedIndicator:kTypeToastBackground",
    "kBluetoothConnectedIndicator:kTypeToastIcon",
    "kLocationAccessIndicator",
    "kLocationAccessIndicator:kTypeToastBackground",
    "kLocationAccessIndicator:kTypeToastIcon",
    "kUrlBar",
    "kLoadingIndicator",
    ...
    "kExclusiveScreenToast:kTypeToastBackground",
    "kExclusiveScreenToast:kTypeToastText",
    "kExitPromptBackplane",
    "kExitPrompt",
    "kAudioPermissionPromptBackplane",
    ...
    "kExclusiveScreenToastViewportAware:kTypeToastBackground",
    "kExclusiveScreenToastViewportAware:kTypeToastText",
    "kSplashScreenText",
    "kWebVrTimeoutSpinner",
    "kWebVrTimeoutMessage",
    "kWebVrTimeoutMessageIcon",
