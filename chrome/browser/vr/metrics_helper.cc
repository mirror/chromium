...
static constexpr char kComponentUpdateStatus[] =
    "VR.AssetsComponent.UpdateStatus";
static constexpr char kAssetsLoadStatus[] = "VR.Assets.LoadStatus";
...
static uint32_t EncodeVersionStatus(
