...
void UiSceneCreator::CreateHostedDialog() {
  ...
  backplane->AddBinding(VR_BIND_FUNC(bool, Model, model_,
                                     native_ui.alert_dialog_enabled, UiElement,
                                     backplane.get(), SetVisible));

  std::unique_ptr<ContentElement> hosted_dialog =
      base::MakeUnique<ContentElement>(content_input_delegate_,
  ...
  hosted_dialog->AddBinding(VR_BIND_FUNC(ContentInputDelegatePtr, Model, model_,
                                         native_ui.delegate, ContentElement,
                                         hosted_dialog.get(), SetDelegate));
  hosted_dialog->AddBinding(VR_BIND_FUNC(unsigned int, Model, model_,
                                         ui_texture_id, ContentElement,
                                         hosted_dialog.get(), SetTextureId));
  hosted_dialog->AddBinding(base::MakeUnique<Binding<bool>>(
  ...
  hosted_dialog->AddBinding(base::MakeUnique<Binding<float>>(
