...
void UiSceneCreator::CreateOmnibox() {
  ...
  omnibox_outer_layout->SetTranslate(0, kUrlBarVerticalOffsetDMM, 0.013);
  omnibox_outer_layout->AddBinding(base::MakeUnique<Binding<bool>>(
      ...
      base::Bind(
          [](UiElement* e, const bool& v) {
            ...
            e->SetTranslate(0, y_offset, 0.013);
          },
  ...
  lower_spacer->AddBinding(VR_BIND_FUNC(bool, Model, model_,
                                        omnibox_suggestions.empty() == false,
                                        Rect, lower_spacer.get(), SetVisible));
