...
std::unique_ptr<UiElement> CreateSnackbar(
  ...
  auto snackbar_oval_left =
      Create<Rect>(kSnackbarDownloading, kPhaseForeground);
...
void UiSceneCreator::CreateSnackbars() {
  //  auto snackbar =
  CreateSnackbar(model_, kSadTabIcon, base::ASCIIToUTF16("Downloading update"),
                 base::ASCIIToUTF16("PAUSE"),
                 base::BindRepeating([]() { LOG(ERROR) << "clicked!"; }));
