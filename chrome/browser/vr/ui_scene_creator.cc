...
void UiSceneCreator::CreateHostedUi() {
  ...
  std::unique_ptr<DiscButton> close_button =
      Create<DiscButton>(kCloseButton, kPhaseForeground, click_handler,
                         vector_icons::kClose16Icon);
  close_button->SetSize(kHostedDialogCloseButtonDiameter,
                        kHostedDialogCloseButtonDiameter);
  close_button->set_hover_offset(kHostedDialogCloseButtonZOffsetHoverDMM);
  close_button->SetTranslate(-kHostedDialogCloseButtonDiameter / 2,
                             -kHostedDialogCloseButtonDiameter / 2, 0);
  ...
  VR_BIND_VISIBILITY(close_button, model->native_ui.hosted_ui_enabled);
