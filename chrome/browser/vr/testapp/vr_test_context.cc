...
void VrTestContext::CycleOrigin() {
  const std::vector<ToolbarState> states = {
      ...
      {GURL("http://domain.com/x/"),
       security_state::SecurityLevel::HTTP_SHOW_WARNING, &toolbar::kHttpIcon,
       base::string16(), true, false},
      {GURL("http://domain.com/xxxxxxx/"),
       security_state::SecurityLevel::HTTP_SHOW_WARNING, &toolbar::kHttpIcon,
       base::string16(), true, false},
      {GURL("http://domain.com/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/"),
       security_state::SecurityLevel::HTTP_SHOW_WARNING, &toolbar::kHttpIcon,
       base::string16(), true, false},
      {GURL("http://domaaaaaaaaaaaaaaaaain.com/xxxxxxxxxxxxxxxxxxxxxxxxxxxxx/"),
       security_state::SecurityLevel::HTTP_SHOW_WARNING, &toolbar::kHttpIcon,
       base::string16(), true, false},
      {GURL("http://domaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaain.com/xxxxxxxxxx/"),
       security_state::SecurityLevel::HTTP_SHOW_WARNING, &toolbar::kHttpIcon,
       base::string16(), true, false},
