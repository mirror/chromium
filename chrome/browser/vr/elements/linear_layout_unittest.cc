...
TEST(LinearLayout, VerticalLayout) {
  ...
  EXPECT_FLOAT_EQ(0.0f, rect_a.transform_operations().at(0).translate.x);
  EXPECT_FLOAT_EQ(-15.0f, rect_a.transform_operations().at(0).translate.y);
  EXPECT_FLOAT_EQ(0.0f, rect_a.transform_operations().at(0).translate.z);

  EXPECT_FLOAT_EQ(0.0f, rect_b.transform_operations().at(0).translate.x);
  EXPECT_FLOAT_EQ(10.0f, rect_b.transform_operations().at(0).translate.y);
  EXPECT_FLOAT_EQ(0.0f, rect_b.transform_operations().at(0).translate.z);
