...
TEST_P(ElisionTest, ProperOffsetAndFading) {
  ...
  const base::string16 reference_text = url_formatter::FormatUrl(
      reference_gurl, kUrlFormatTypes, net::UnescapeRule::NORMAL, nullptr,
      nullptr, nullptr);
  gfx::FontList font_list;
  auto field_width = gfx::GetStringWidth(reference_text, font_list);
  gfx::Rect field(field_width, field_width);
  ...
  const base::string16 text =
      url_formatter::FormatUrl(gurl, kUrlFormatTypes, net::UnescapeRule::NORMAL,
