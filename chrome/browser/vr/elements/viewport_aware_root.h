...
#ifndef CHROME_BROWSER_VR_ELEMENTS_VIEWPORT_AWARE_H_
#define CHROME_BROWSER_VR_ELEMENTS_VIEWPORT_AWARE_H_
...
#endif  // CHROME_BROWSER_VR_ELEMENTS_VIEWPORT_AWARE_H_
