...
class PagedGridView : public UiElement {
 public:
  ...
  // We override this function to cope with hit testing while CurrentPage != 0.
  // If we don't do this, the system will only consider us "hit" on the first
  // page.
 ...
 private:
  ...
  float ComputePageOffset(size_t page) const;

  void OnFlingBegin(std::unique_ptr<blink::WebGestureEvent> gesture,
