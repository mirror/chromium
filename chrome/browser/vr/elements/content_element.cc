...
void ContentElement::OnProjMatrixChanged(const gfx::Transform& proj_matrix) {
  ...
  gfx::Transform target_transform = GetTargetWorldSpaceTransform();
  gfx::SizeF screen_size =
      CalculateScreenSize(proj_matrix, target_transform, target_size);
