...
TEST(Repositioner, RepositionNegativeZWithReticle) {
  ...
  std::vector<TestCase> test_cases = {
      ...
      {{1, -2, 1}, {0, 0, -1}, {0, -kTestRepositionDistance, 0}, {1, 0, 0}},
      // TODO(bshe): fix the follow case. It currently doesn't work due to
      // quaternion(from, to) decide to not use cross product of from and to,
      // i.e, when real < kEpsilon * norm in the ctor.
