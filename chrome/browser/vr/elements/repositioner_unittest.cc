...
TEST(Repositioner, RepositionNegativeZWithReticle) {
  std::vector<TestCase> test_cases = {
      {{-2, 2.414210f, -1},
       {0, 1, 0},
       {-1.215563f, 1.467313f, -0.607782f},
       {0.447214f, -0, -0.894427f}},
      {{-2, 2.414210f, 1},
       {0, 1, 0},
       {-1.215564f, 1.467313f, 0.607782f},
       {-0.447214f, -0, -0.894427f}},
      {{0, 2.414210f, 1}, {0, 1, 0}, {0, 1.847759f, -0.765368f}, {-1, 0, 0}},
      {{0, 2.414210f, -1}, {0, 1, 0}, {0, 1.847759f, -0.765368f}, {1, 0, 0}},
      {{-2, -0.414210f, -1},
       {0, 1, 0},
       {-1.758931f, -0.364283f, -0.879465f},
       {0.447214f, -0, -0.894427f}},
      {{-2, -0.414210f, 1},
       {0, 1, 0},
       {-1.758931f, -0.364283f, 0.879465f},
       {-0.447214f, 0, -0.894427f}},
      {{0, -0.414210f, 1}, {0, 1, 0}, {0, -0.765361f, -1.847761f}, {-1, 0, 0}},
      {{0, -0.414210f, -1}, {0, 1, 0}, {0, -0.765361f, -1.847761f}, {1, 0, 0}},
      {{-1, 3, 0},
       {0, 0, 1},
       {-0.632456f, 1.897367f, 0},
       {-0.948683f, -0.316228f, -0}},
      {{-1, -1, 0},
       {0, 0, -1},
       {-1.414214f, -1.414214f, 0},
       {-0.707107f, 0.707107f, -0}},
      {{-1, 1, 2},
       {-1, 0, 0},
       {-0.816497f, 0.816497f, 1.632993f},
      ...
      {{0, 0, -1}, {0, 0.9, 0}, {0, 0, -kTestContentDistance}, {1, 0, 0}},
