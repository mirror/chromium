...
constexpr char const* kFragmentShader = SHADER(
  ...
  void main() {
    ...
    OverlayChannel(v_GradientColor.r, background_color.r, color.r);
    OverlayChannel(v_GradientColor.g, background_color.g, color.g);
    OverlayChannel(v_GradientColor.b, background_color.b, color.b);
