...
class UiElement : public cc::AnimationTarget {
 public:
  ...
  struct Reversed {
    ...
    UiElement::reverse_iterator begin() { return root->rbegin(); }
    UiElement::reverse_iterator end() { return root->rend(); }
    UiElement::const_reverse_iterator begin() const { return root->rbegin(); }
    UiElement::const_reverse_iterator end() const { return root->rend(); }
    T* root;
  };
