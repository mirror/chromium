...
static constexpr size_t kSkyGradientColorsSize = 28;
...
static_assert(kSkyGradientColorsSize == sizeof(SkyGradientColors),
              "If the new colors are added to SkyGradientColors, we must "
              "explicitly bump this size and update operator== below");

bool SkyGradientColors::operator==(const SkyGradientColors& other) const {
