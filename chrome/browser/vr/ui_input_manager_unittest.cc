...
TEST_F(UiInputManagerTest, FocusedElement) {
  ...
  EXPECT_CALL(*p_element1, OnInputCommited(edit)).InSequence(s);
  input_manager_->OnInputCommited(edit);
