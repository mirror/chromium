...
//   kWebVrRoot
//     kWebVrContent
//     TODO(vollick): could the viewport aware root be a linear layout?
...
//       kTransientUrlBar
//
// TODO(vollick): The following hierarchy is complex and would be easier to
// manage if it were specified in a declarative format.
...
void UiSceneManager::Create2dBrowsingRoot() {
