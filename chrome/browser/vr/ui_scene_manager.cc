...
void UiSceneManager::CreateVoiceSearchUiGroup(Model* model) {
  ...
  speech_recognition_prompt_->AddBinding(VR_BIND_FUNC(
      int, Model, model, speech_recognition_state, SpeechRecognitionPrompt,
      speech_recognition_prompt_, OnSpeechRecognitionStateChanged));
