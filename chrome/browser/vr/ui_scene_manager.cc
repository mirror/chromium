...
void UiSceneManager::CreateSecurityWarnings() {
  ...
  operations.AppendRotate(1, 0, 0, base::Rad2Deg(kWarningAngleRadians));
...
void UiSceneManager::CreateUrlBar() {
  ...
  operations.AppendRotate(1, 0, 0, base::Rad2Deg(kUrlBarRotationRad));
...
void UiSceneManager::ConfigureExclusiveScreenToast() {
  ...
  if (fullscreen_ && !web_vr_mode_) {
    ...
    operations.AppendRotate(1, 0, 0, base::Rad2Deg(kWebVrAngleRadians));
