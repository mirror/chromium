...
void UiSceneManager::CreateUrlBar() {
  ...
  // XXX: this is just for testing. Must not submit.
  ...
  transition.duration = base::TimeDelta::FromInternalValue(500000);
  url_bar->animation_player().set_transition(transition);
