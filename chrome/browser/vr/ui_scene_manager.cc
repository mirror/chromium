...
static constexpr int kWarningTimeoutSeconds = 3000;
...
static constexpr int kTransientUrlBarTimeoutSeconds = 6000;
...
void UiSceneManager::ConfigureExclusiveScreenToast() {
  ...
  // web_vr_show_toast_);
  exclusive_screen_toast_viewport_aware_->SetEnabled(true);
}
