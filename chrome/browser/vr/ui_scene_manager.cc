...
void UiSceneManager::ConfigureScene() {
  ...
  // TODO(ymalik): This should be the splash screen root once opacity is
  // inherited correctly for elements in the subtree.
  scene_->GetUiElementByName(kSplashScreenText)
