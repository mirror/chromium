...
class MockBrowserUiInterface : public BrowserUiInterface {
 public:
  ...
  MOCK_METHOD1(SetVideoCapturingIndicator, void(bool enabled));
  MOCK_METHOD1(SetScreenCapturingIndicator, void(bool enabled));
  MOCK_METHOD1(SetAudioCapturingIndicator, void(bool enabled));
  MOCK_METHOD1(SetBluetoothConnectedIndicator, void(bool enabled));
  MOCK_METHOD1(SetLocationAccessIndicator, void(bool enabled));
