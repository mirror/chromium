...
void UiTest::MakeManager(InCct in_cct, InWebVr in_web_vr) {
  MakeManagerInternal(in_cct, in_web_vr, kNotAutopresented);
}

void UiTest::MakeAutoPresentedManager() {
...
int UiTest::NumVisibleChildren(UiElementName name) const {
...
void UiTest::MakeManagerInternal(InCct in_cct,
                                 InWebVr in_web_vr,
