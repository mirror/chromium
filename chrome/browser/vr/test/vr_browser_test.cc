...
constexpr char VrBrowserTest::kVrOverrideEnvVar[] = "VR_OVERRIDE";
constexpr char VrBrowserTest::kVrOverrideVal[] = "./mock_vr_clients/";
constexpr char VrBrowserTest::kVrConfigPathEnvVar[] = "VR_CONFIG_PATH";
constexpr char VrBrowserTest::kVrConfigPathVal[] = "./";
constexpr char VrBrowserTest::kVrLogPathEnvVar[] = "VR_LOG_PATH";
...
bool VrBrowserTest::PollJavaScriptBoolean(const std::string& bool_expression,
  ...
  auto poll_lambda = [](const std::string& be, content::WebContents* wc) {
    return RunJavaScriptAndExtractBoolOrFail(be, wc);
  };
