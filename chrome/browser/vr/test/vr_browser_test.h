...
class VrBrowserTest : public InProcessBrowserTest {
 public:
  ...
  static constexpr char kVrOverrideEnvVar[];
  static constexpr char kVrOverrideVal[];
  static constexpr char kVrConfigPathEnvVar[];
  static constexpr char kVrConfigPathVal[];
  static constexpr char kVrLogPathEnvVar[];
