...
void InitializeColorSchemes() {
  ...
  normal_scheme.audio_permission_prompt_secondary_button_hover = 0xFFE5E5E5;
  normal_scheme.audio_permission_prompt_secondary_button_down = 0xFFD5D5D5;
  normal_scheme.audio_permission_prompt_primary_button_background = 0xFF4285F4;
  normal_scheme.audio_permission_prompt_primary_button_hover = 0xFF3275E3;
  ...
  normal_scheme.speech_recognition_circle_background = 0xFF4DB6AC;
