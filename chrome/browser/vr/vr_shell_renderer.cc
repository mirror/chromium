      ...
      return SHADER(
          ...
          void main() {
            ...
            if (u_RightEye != 0) {
              ...
              v_TexCoordinate = a_TexCoordinate * vec2(1, .5);
            }
          }
          /* clang-format on */);
...
StereoBackgroundRenderer::StereoBackgroundRenderer()
  ...
  model_view_proj_matrix_handle_ =
      glGetUniformLocation(program_handle_, "u_ModelViewProjMatrix");
  opacity_handle_ = glGetUniformLocation(program_handle_, "u_Opacity");
  right_eye_handle_ = glGetUniformLocation(program_handle_, "u_RightEye");
...
void StereoBackgroundRenderer::Draw(int texture_data_handle,
  ...
  glUniform1i(tex_uniform_handle_, 0);
  glUniform1f(opacity_handle_, opacity);
  glUniform1i(right_eye_handle_, right_eye ? 1 : 0);
