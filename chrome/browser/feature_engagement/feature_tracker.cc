...
FeatureTracker::FeatureTracker(Profile* profile,
                               ...
                               int defaultTimeRequiredToShowPromo)
    : profile_(profile),
      session_duration_updater_(session_duration_updater),
      session_duration_observer_(this),
      feature_(feature),
      field_trial_minutes_value_(
          base::TimeDelta::FromMinutes(defaultTimeRequiredToShowPromo)) {
