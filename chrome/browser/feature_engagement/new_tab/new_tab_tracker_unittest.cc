...
#include "components/feature_engagement/test/test_feature_engagement_tracker.h"
...
class MockFeatureEngagementTracker : public feature_engagement::Tracker {
 public:
...
class NewTabTrackerFeatureEngagementTrackerTest : public testing::Test {
 ...
 protected:
  std::unique_ptr<FakeNewTabTracker> new_tab_tracker_;
  std::unique_ptr<feature_engagement::Tracker> feature_engagement_tracker_;
