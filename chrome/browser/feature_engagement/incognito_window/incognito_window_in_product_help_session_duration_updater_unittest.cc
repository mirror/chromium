...
class IncognitoWindowInProductHelpSessionDurationUpdaterTest
 ...
 public:
  ...
  void SetUp() override {
    ...
    //  test_observer_ =
    //  base::MakeUnique<TestIncognitoSessionDurationObserver>();
    // pref_service = new sync_preferences::TestingPrefServiceSyncable();
 ...
 protected:
  ...
  // std::unique_ptr<TestIncognitoSessionDurationObserver> test_observer_;
