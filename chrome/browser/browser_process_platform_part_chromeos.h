...
class BrowserProcessPlatformPart : public BrowserProcessPlatformPartBase {
 public:
  ...
  // Save the name and install path of a compatible component.
  void AddCompatibleCrosComponent(const std::string& name,
                                  const base::FilePath& path);

  // Check if the current installed component is compatible given a component
  // |name|. If compatible, set |path| to be its installed path.
  bool IsCompatibleCrosComponent(const std::string& name) const;

  // Return installed path of a compatible component given |name|.
 ...
 private:
  ...
  // map from a compatible component name to its installed path.
