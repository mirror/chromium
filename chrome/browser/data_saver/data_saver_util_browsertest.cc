...
IN_PROC_BROWSER_TEST_F(DataSaverUtilBrowserTest, DataSaverEnabledUI) {
  EnableDataSaver(true);
  EXPECT_TRUE(
      WouldLikelyBeFetchedViaDataSaverUI(browser()->profile(), kHttpUrl));
  EXPECT_FALSE(
      WouldLikelyBeFetchedViaDataSaverUI(browser()->profile(), kHttpsUrl));
}

IN_PROC_BROWSER_TEST_F(DataSaverUtilBrowserTest, DataSaverDisabledUI) {
