...
class CertificateManagerModel {
 public:
  ...
  typedef std::map<std::string, std::vector<net::ScopedCERTCertificate>>
      OrgGroupingMap;
  ...
  // imported.
  bool ImportCACerts(const net::ScopedCERTCertificateVector& certificates,
  ...
  bool ImportServerCert(
      const net::ScopedCERTCertificateVector& certificates,
      net::NSSCertDatabase::TrustBits trust_bits,
      net::NSSCertDatabase::ImportCertFailureList* not_imported);
 ...
 private:
  ...
  net::ScopedCERTCertificateVector extension_cert_list_;
