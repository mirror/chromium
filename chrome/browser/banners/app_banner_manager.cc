...
void AppBannerManager::StopWithCode(InstallableStatusCode code) {
  ...
  // Every call to RequestAppBanner() should call ReportStatus() once, unless
  // the pipeline was terminated while we were waiting for the
  // beforeinstallpromptevent to resolve.
