...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest,
  ...
  RunBannerTest(browser(), manager.get(), "/banners/manifest_test_page.html",
                engagement_scores, "verifyBeforeInstallPromptEvents()",
                WebappInstallSource::AUTOMATIC_PROMPT_BROWSER_TAB,
                SHOWING_WEB_APP_BANNER, true,
...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest, DoesNotShowInIncognito) {
  ...
  RunBannerTest(incognito_browser, manager.get(),
                ...
                WebappInstallSource::COUNT, IN_INCOGNITO, false);
}
...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest,
  ...
  TriggerBannerFlowWithNavigation(
      browser(), manager.get(), test_url, "" /* setup_script */,
      false /* expected_will_show */, State::PENDING_ENGAGEMENT);
  ...
  TriggerBannerFlow(
      ...
      "" /* setup_script */, true /* expected_will_show */, State::COMPLETE);
...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest, CheckOnLoadThenNavigate) {
  ...
  TriggerBannerFlowWithNavigation(
      browser(), manager.get(), GURL("about:blank"), "" /* setup_script */,
      false /* expected_will_show */, State::INACTIVE);
...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest,
  ...
  TriggerBannerFlow(
      ...
      base::BindOnce(&ExecuteScript, browser(), "callStashedPrompt();",
                     false /* with_gesture */),
      "" /* setup_script */, false /* expected_will_show */, State::COMPLETE);
