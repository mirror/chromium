...
class AppBannerManagerBrowserTest : public InProcessBrowserTest {
 ...
 protected:
  ...
  void RunNavigationStagedBannerTest(Browser* browser,
                                     AppBannerManagerTest* manager,
                                     const GURL& url,
  ...
  void RunStagedBannerTest(Browser* browser,
                           AppBannerManagerTest* manager,
...
IN_PROC_BROWSER_TEST_F(AppBannerManagerBrowserTest, CheckOnLoadThenNavigate) {
  ...
  RunNavigationStagedBannerTest(browser(), manager.get(), GURL("about:blank"),
