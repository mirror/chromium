...
const char kEnableFileManagerTouchModeName[] = "Files App. touch mode";
const char kEnableFileManagerTouchModeDescription[] =
    "Enables touch support for the Files app.";
