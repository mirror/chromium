...
const char kOfflinePagesPendingDownloadName[] =
    "Enables descriptive pending download status text.";
const char kOfflinePagesPendingDownloadDescription[] =
    "Enables pending download status text in notifications and Download Home "
