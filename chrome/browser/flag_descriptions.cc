...
const char kContextualSearchTapSuppressionName[] =
    "Contextual Search - Tap Suppression";
const char kContextualSearchTapSuppressionDescription[] =
    "Whether or not tap gestures may be suppressed to improve CTR.";
