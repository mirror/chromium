...
const char kRecognizableTabFaviconFadingWeak[] = "Fading - weak";
const char kRecognizableTabFaviconFadingStrong[] = "Fading - strong";
extern const char kRecognizableTabFaviconScale[] = "Scale";
