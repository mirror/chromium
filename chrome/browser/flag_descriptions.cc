...
const char kWebXrRenderPathName[] = "WebXR render path";
const char kWebXrRenderPathDescription[] =
    "Rendering path preference for WebXR (including WebVR)";
const char kWebXrRenderPathChoiceClientWaitDescription[] =
    "Mailbox & ClientWait";
const char kWebXrRenderPathChoiceGpuFenceDescription[] = "Mailbox & GpuFence";
