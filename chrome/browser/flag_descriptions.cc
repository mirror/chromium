...
const char kWhitelistLockScreenExtensionsPermissionName[] =
    "Allow lockScreen extensions permission for all apps";

const char kWhitelistLockScreenExtensionsPermissionDescription[] =
    "The lockScreen extensions permission is protected by a white-list. "
    "Enabling this flag will make this permission available to any apps that "
    "declare it - the white-list will be ignored when determining whether the "
    "permission should be given to an app or not. This flag works only on "
    "dev channel.";
