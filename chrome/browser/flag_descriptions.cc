...
const char kAshDisableShelfModelSynchronizationDescription[] =
    "Avoid synchronizing separate Chrome OS shelf data model instances between "
    "Chrome and Ash. This only applies to the Classic Ash and Mus configs; "
    "synchronization is required when running the Mash config via --mash.";
