...
enum ContextType { kWindow, kWorker, kSharedWorker, kServiceWorker };
...
GURL ConstructJsRequestURL(const GURL& base_url, JsRequestType request_type) {
  return request_type == kWebSocket ? ConstructWebSocketURL(base_url)
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(kWindow, kWebSocket),
                      JsRequestTestParam(kWorker, kWebSocket),
                      JsRequestTestParam(kWindow, kFetch),
                      JsRequestTestParam(kWorker, kFetch)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(kSharedWorker, kWebSocket),
                      JsRequestTestParam(kServiceWorker, kWebSocket),
                      JsRequestTestParam(kSharedWorker, kFetch),
                      JsRequestTestParam(kServiceWorker, kFetch)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(kWindow, kWebSocket),
                      JsRequestTestParam(kWorker, kWebSocket),
                      JsRequestTestParam(kSharedWorker, kWebSocket),
                      JsRequestTestParam(kServiceWorker, kWebSocket),
                      JsRequestTestParam(kWindow, kFetch),
                      JsRequestTestParam(kWorker, kFetch),
                      JsRequestTestParam(kSharedWorker, kFetch),
