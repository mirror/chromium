...
enum ContextType { WINDOW, WORKER, SHARED_WORKER, SERVICE_WORKER };
...
GURL ConstructJsRequestURL(const GURL& base_url, JsRequestType request_type) {
  return request_type == WEBSOCKET ? ConstructWebSocketURL(base_url)
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(WINDOW, WEBSOCKET),
                      ...
                      JsRequestTestParam(WINDOW, FETCH),
                      JsRequestTestParam(WORKER, FETCH)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(SHARED_WORKER, WEBSOCKET),
                      ...
                      JsRequestTestParam(SHARED_WORKER, FETCH),
                      JsRequestTestParam(SERVICE_WORKER, FETCH)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(JsRequestTestParam(WINDOW, WEBSOCKET),
                      JsRequestTestParam(WORKER, WEBSOCKET),
                      JsRequestTestParam(SHARED_WORKER, WEBSOCKET),
                      JsRequestTestParam(SERVICE_WORKER, WEBSOCKET),
                      JsRequestTestParam(WINDOW, FETCH),
                      JsRequestTestParam(WORKER, FETCH),
                      JsRequestTestParam(SHARED_WORKER, FETCH),
