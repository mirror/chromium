...
IN_PROC_BROWSER_TEST_F(SettingsResetPromptModelBrowserTest,
  ...
  // Add a second homepage-overriding extension. Homepage can no longer needs
  // to be reset since domains don't match.
  ...
  // Let the domain used by the second extension require reset. Homepage can no
  // longer be reset.
  {
    ModelPointer model =
...
IN_PROC_BROWSER_TEST_F(SettingsResetPromptModelBrowserTest,
  ...
  // Load extension that overrides search to a domain that that requires reset.
  // Search no longer needs to be reset.
  ...
  // Let the domain used by the second extension require reset. Search can no
  // longer be reset.
  {
    ModelPointer model =
