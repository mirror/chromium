...
// Filename suffix for the deprecated module whitelist.
...
void SafeBrowsingDatabaseNew::Init(const base::FilePath& filename_base) {
...

  {
    ...
    // Delete any files of the module whitelist that may be around from when it
    // was previously enabled.
    //
    // TODO(proberge): Remove this after September 2018.
    SafeBrowsingStoreFile::DeleteStore(
        ModuleWhitelistDBFilename(db_state_manager_.filename_base()));
    base::DeleteFile(PrefixSetForFilename(ModuleWhitelistDBFilename(
