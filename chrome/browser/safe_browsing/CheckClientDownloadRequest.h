...
#ifndef CHROME_BROWSER_SAFE_BROWSING_CHECK_CLIENT_DOWNLOAD_REQUEST_H_
#define CHROME_BROWSER_SAFE_BROWSING_CHECK_CLIENT_DOWNLOAD_REQUEST_H_
...
#endif  // CHROME_BROWSER_SAFE_BROWSING_CHECK_CLIENT_DOWNLOAD_REQUEST_H_
