...
TEST_F(ThreatDetailsTest, ThreatDOMDetails) {
  ...
  auto attr = mojom::AttributeNameValue::New("src", kDOMChildURL);
...
TEST_F(ThreatDetailsTest, ThreatDOMDetails_MultipleFrames) {
  ...
  auto attr = mojom::AttributeNameValue::New("id", "outer");
  ...
  auto attr1 = mojom::AttributeNameValue::New("src", kDOMChildURL);
  outer_child_iframe->attributes.push_back(std::move(attr1));
  auto attr2 = mojom::AttributeNameValue::New("foo", "bar");
  ...
  auto attr3 = mojom::AttributeNameValue::New("id", "inner");
  inner_child_div->attributes.push_back(std::move(attr3));
  auto attr4 = mojom::AttributeNameValue::New("bar", "baz");
  ...
  auto attr5 = mojom::AttributeNameValue::New("src", kDOMChildUrl2);
...
TEST_F(ThreatDetailsTest, ThreatDOMDetails_AmbiguousDOM) {
  ...
  auto attr = mojom::AttributeNameValue::New("src", kDataURL);
  ...
  auto attr1 = mojom::AttributeNameValue::New("src", kDOMChildUrl2);
  attr1->name = "src";
...
TEST_F(ThreatDetailsTest, ThreatDOMDetails_TrimToAdTags) {
  ...
  auto attr1 = mojom::AttributeNameValue::New("src", kReferrerURL);
  outer_sibling_script->attributes.push_back(std::move(attr1));
  auto attr2 = mojom::AttributeNameValue::New("id", "outer-sibling");
  ...
  auto attr3 = mojom::AttributeNameValue::New("src", kFirstRedirectURL);
  sibling_script->attributes.push_back(std::move(attr3));
  auto attr4 = mojom::AttributeNameValue::New("id", "sibling");
  ...
  auto attr5 = mojom::AttributeNameValue::New("data-google-query-id", "ad-tag");
  ...
  outer_child_iframe->tag_name = "iframe";
  outer_child_iframe->parent = GURL(kDOMParentURL);
  auto attr6 = mojom::AttributeNameValue::New("src", kDOMChildURL);
  outer_child_iframe->attributes.push_back(std::move(attr6));
  auto attr7 = mojom::AttributeNameValue::New("foo", "bar");
  ...
  inner_child_div->tag_name = "div";
  inner_child_div->parent = GURL(kDOMChildURL);
  auto attr8 = mojom::AttributeNameValue::New("id", "inner");
  inner_child_div->attributes.push_back(std::move(attr8));
  auto attr9 = mojom::AttributeNameValue::New("bar", "baz");
  ...
  inner_child_script->tag_name = "script";
  inner_child_script->parent = GURL(kDOMChildURL);
  auto attr10 = mojom::AttributeNameValue::New("src", kDOMChildUrl2);
