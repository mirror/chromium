...
class ThreatDetailsWrap : public ThreatDetails {
 public:
  ...
  int done_callback_count() { return done_callback_count_; }

 private:
  ~ThreatDetailsWrap() override {}

  base::RunLoop* run_loop_;
  int done_callback_count_;
};
