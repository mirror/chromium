...
TEST_F(ThreatDetailsTest, ThreatDOMDetails) {
  ...
  mojom::AttributeNameValuePtr attr;
  attr->name = "src";
...
TEST_F(ThreatDetailsTest, ThreatDOMDetails_MultipleFrames) {
  ...
  mojom::AttributeNameValuePtr attr3;
  attr3->name = "id";
  attr3->value = "inner";
  inner_child_div->attributes.push_back(std::move(attr3));
  mojom::AttributeNameValuePtr attr4;
  attr4->name = "bar";
  attr4->value = "baz";
  ...
  mojom::AttributeNameValuePtr attr5;
  attr5->name = "src";
...
TEST_F(ThreatDetailsTest, ThreatDOMDetails_TrimToAdTags) {
  ...
  // and then another for the inner page containing the contents of that iframe.
  std::vector<mojom::ThreatDOMDetailsNodePtr> outer_params;
  mojom::ThreatDOMDetailsNodePtr outer_div;
  outer_div->node_id = 1;
  ...
  inner_child_div->tag_name = "div";
  inner_child_div->parent = GURL(kDOMChildURL);
  mojom::AttributeNameValuePtr attr8;
  attr8->name = "id";
  attr8->value = "inner";
  inner_child_div->attributes.push_back(std::move(attr8));
  mojom::AttributeNameValuePtr attr9;
  attr9->name = "bar";
  attr9->value = "baz";
  ...
  inner_child_script->tag_name = "script";
  inner_child_script->parent = GURL(kDOMChildURL);
  mojom::AttributeNameValuePtr attr10;
  attr10->name = "src";
