...
// when instantiated and calls the given callback every time the state change.
...
class ChromeCleanerStateChangeObserver
 ...
 public:
  ...
  // Runs |on_state_change_|. Will be called when any of the override methods
  // below are called.
 ...
 private:
  base::RepeatingClosure on_state_change_;
