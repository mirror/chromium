...
void ChromeCleanerControllerImpl::OnSwReporterReady(
  ...
  safe_browsing::MaybeStartSwReporter(pending_invocation_type_,
                                      std::move(invocations));
  // Reset the pending invocation type to the default value.
  pending_invocation_type_ = SwReporterInvocationType::kPeriodicRun;
}
