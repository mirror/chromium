...
TEST_P(ChromeCleanerControllerReporterInteractionTest,
  ...
  ExpectStateChangeToIdle(SwReporterInvocationResult::kTimedOut,
                          ChromeCleanerController::IdleReason::kReporterFailed);
}

TEST_P(ChromeCleanerControllerReporterInteractionTest,
       OnReporterSequenceDone_ProcessFailedToLaunch) {
  ExpectStateChangeToIdle(SwReporterInvocationResult::kProcessFailedToLaunch,
                          ChromeCleanerController::IdleReason::kReporterFailed);
}

TEST_P(ChromeCleanerControllerReporterInteractionTest,
       OnReporterSequenceDone_GeneralFailure) {
  ExpectStateChangeToIdle(SwReporterInvocationResult::kGeneralFailure,
                          ChromeCleanerController::IdleReason::kReporterFailed);
}

TEST_P(ChromeCleanerControllerReporterInteractionTest,
       OnReporterSequenceDone_NothingFound) {
  ExpectStateChangeToIdle(
