...
class ReporterRunnerTest
 ...
 public:
  ...
  void TestSequenceNotScheduled(SwReporterInvocationType invocation_type1,
    ...
    RunSwReporters(invocation_type1, CreateInvocationSequence(invocations1));
    ...
    RunSwReporters(invocation_type2, CreateInvocationSequence(invocations2));
...
IN_PROC_BROWSER_TEST_P(ReporterRunnerTest, CleanupNeeded) {
  ...
  // Enable once https://crrev.com/c/794531 lands.
  // EXPECT_EQ(
  //     invocation_type ==
  //     SwReporterInvocationType::kUserInitiatedWithLogsAllowed,
