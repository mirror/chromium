...
ChromePasswordProtectionService::ChromePasswordProtectionService(
    ...
    : PasswordProtectionService(
      ...
      request_context_getter_(sb_service->url_request_context()) {
...
void ChromePasswordProtectionService::MaybeStartThreatDetailsCollection(
  ...
  if (trigger_manager_->CanStartDataCollection(
    ...
    trigger_manager_->StartCollectingThreatDetails(
        ...
        profile_->GetRequestContext(), history_service(), options);
  }
}
...
void ChromePasswordProtectionService::UpdateSecurityState(
  ...
  bool already_whitelisted =
      ui_manager_->IsUrlWhitelistedOrPendingForWebContents(
  ...
  UMA_HISTOGRAM_BOOLEAN(
      "PasswordProtection.SBInterstitialBeforeModalWarningDialog",
      already_whitelisted && current_threat_type != threat_type);
...
ChromePasswordProtectionService::request_context_getter() {
...
ChromePasswordProtectionService::ChromePasswordProtectionService(
    ...
    : PasswordProtectionService(nullptr, nullptr, content_setting_map.get()),
