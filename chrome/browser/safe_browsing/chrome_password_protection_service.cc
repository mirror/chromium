...
#else
  /*PasswordReuseModalWarningDialog::ShowWaringDialog(
      web_contents,
      base::Bind(&ChromePasswordProtectionService::OnWarningDone, GetWeakPtr(),
                 web_contents, PasswordProtectionService::MODAL_DIALOG));*/
