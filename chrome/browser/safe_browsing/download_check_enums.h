...
//
// Enums that specify values that specify the results of download checking as performed by SafeBrowsing download protection service.

#ifndef CHROME_BROWSER_SAFE_BROWSING_DOWNLOAD_CHECK_ENUMS_H_
#define CHROME_BROWSER_SAFE_BROWSING_DOWNLOAD_CHECK_ENUMS_H_
...
#endif  // CHROME_BROWSER_SAFE_BROWSING_DOWNLOAD_CHECK_ENUMS_H_