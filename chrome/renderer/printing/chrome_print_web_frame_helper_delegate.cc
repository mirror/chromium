...
ChromePrintWebFrameHelperDelegate::~ChromePrintWebFrameHelperDelegate() {}

bool ChromePrintWebFrameHelperDelegate::CancelPrerender(
...
blink::WebElement ChromePrintWebFrameHelperDelegate::GetPdfElement(
...
bool ChromePrintWebFrameHelperDelegate::IsPrintPreviewEnabled() {
  base::CommandLine* command_line = base::CommandLine::ForCurrentProcess();
  return !command_line->HasSwitch(switches::kDisablePrintPreview);
}

bool ChromePrintWebFrameHelperDelegate::OverridePrint(
    blink::WebLocalFrame* frame) {
#if BUILDFLAG(ENABLE_EXTENSIONS)
