...
#include "chrome/common/render_frame_observer.mojom.h"
...
class ChromeRenderFrameObserver
    : public content::RenderFrameObserver,
      ...
      public chrome::mojom::RenderFrameObserver {
 public:
 ...
 private:
  ...
  mojo::AssociatedBindingSet<chrome::mojom::RenderFrameObserver>
