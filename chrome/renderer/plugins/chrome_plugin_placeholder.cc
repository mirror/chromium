...
void ChromePluginPlaceholder::RegisterMojoInterfaces(
    content::AssociatedInterfaceRegistry* associated_interfaces) {
  if (associated_interfaces->CanBindRequest(
          chrome::mojom::PluginRenderer::Name_)) {
    associated_interfaces->AddInterface(
        base::Bind(&ChromePluginPlaceholder::OnPluginRendererRequest,
                   base::Unretained(this)));
  }
}

void ChromePluginPlaceholder::UnregisterMojoInterfaces(
    content::AssociatedInterfaceRegistry* associated_interfaces) {
  if (!associated_interfaces->CanBindRequest(
          chrome::mojom::PluginRenderer::Name_)) {
