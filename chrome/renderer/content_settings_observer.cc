...
ContentSettingsObserver::ContentSettingsObserver(
  ...
  registry->AddInterface(
      base::Bind(&ContentSettingsObserver::OnInterstitialPageRequest,
                 base::Unretained(this)));
...
void ContentSettingsObserver::OnInterstitialPageRequest(
    chrome::mojom::InterstitialPageRequest request) {
  interstitial_page_bindings_.AddBinding(this, std::move(request));
}
