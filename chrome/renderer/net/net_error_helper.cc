...
void NetErrorHelper::FetchNavigationCorrections(
  ...
  WebURLRequest request(navigation_correction_url);
  request.SetHTTPMethod(WebString::FromUTF8("POST"));
  request.SetHTTPHeaderField(WebString::FromUTF8("Content-Type"),
...
void NetErrorHelper::SendTrackingRequest(
  ...
  WebURLRequest request(tracking_url);
  request.SetHTTPMethod(WebString::FromUTF8("POST"));
  request.SetHTTPHeaderField(WebString::FromUTF8("Content-Type"),
                             WebString::FromUTF8("application/json"));
  request.SetRequestContext(WebURLRequest::kRequestContextInternal);
  ...
  blink::WebHTTPBody web_http_body;
  web_http_body.Initialize();
  web_http_body.AppendData(blink::WebData(tracking_request_body));
  request.SetHTTPBody(web_http_body);
