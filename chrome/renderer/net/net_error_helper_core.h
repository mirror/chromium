...
class NetErrorHelperCore {
 public:
  ...
  // Sets values in |pending_error_pege_info_|. If |error_html| is empty, it
 ...
 private:
  ...
  // Sets values in pending_error_page_info fora main frame error page. If
  // |error_html| is empty, it also fetches the string containing the error
