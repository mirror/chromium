...
// Unit test for AutofillAgent::DoAcceptDataListSuggestion.
TEST_F(FormAutocompleteTest, DoAcceptDataListSuggestion) {
  LoadHTML(
      "<html>"
  ...
  for (const auto& c : cases) {
    ...
    autofill_agent_->DoAcceptDataListSuggestion(kSuggestion);
