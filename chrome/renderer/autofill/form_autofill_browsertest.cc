...
class FormAutofillTest : public ChromeRenderViewTest {
 public:
  ...
  void TestFillFormNonEmptyField(const char* html,
    ...
    // The preview is shown using the InnerEditor because the user typed some
    // text. The text entered by the user should not be selected ("Wy") but the
    // rest of the suggestion should ("att").
