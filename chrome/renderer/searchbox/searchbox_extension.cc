...
class NewTabPageBindings : public gin::Wrappable<NewTabPageBindings> {
 ...
 private:
  ...
  v8::Local<v8::Object> GetMostVisited(gin::Arguments* args);
  v8::Local<v8::Object> GetThemeBackgroundInfo(gin::Arguments* args);
...
v8::Local<v8::Object> NewTabPageBindings::GetMostVisited(gin::Arguments* args) {
...
v8::Local<v8::Object> NewTabPageBindings::GetThemeBackgroundInfo(
    gin::Arguments* args) {
  const ThemeBackgroundInfo& theme_info =
...
v8::Local<v8::Value> NewTabPageBindings::GetMostVisitedItemData(
  ...
  return GenerateMostVisitedItemData(
