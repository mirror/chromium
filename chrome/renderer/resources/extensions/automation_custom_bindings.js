...
automationInternal.onAccessibilityEvent.addListener(function(eventParams) {
  ...
  // Note that focus type events have already been handled above. All other
  // events, even non-focus events that triggered a focus dispatch, still need
  // to have their original event fired.
