...
// These adapter classes preserve backward compatibility for the media router
// component extension.
...
// mediaRouter.mojom.HangoutsMediaStatusExtraData
...
HangoutsMediaStatusExtraDataAdapter.fromNewVersion = function(other) {
  return new HangoutsMediaStatusExtraDataAdapter({
    'local_present': other.localPresent,
  });
};
...
MediaStatusAdapter.fromNewVersion = function(other) {
  return new MediaStatusAdapter({
    'title': other.title,
    'description': other.description,
    'can_play_pause': other.canPlayPause,
    'can_mute': other.canMute,
    'can_set_volume': other.canSetVolume,
    'can_seek': other.canSeek,
    'is_muted': other.isMuted,
    'play_state': other.playState,
    'volume': other.volume,
    'duration': other.duration,
    'current_time': other.currentTime,
    'hangouts_extra_data': HangoutsMediaStatusExtraDataAdapter.fromNewVersion(
        other.hangoutsExtraData),
  });
};
...
MediaStatusAdapter.prototype.toNewVersion = function() {
  return new mediaRouter.mojom.MediaStatus({
    ...
    'hangoutsExtraData': this.hangouts_extra_data.toNewVersion(),
  });
};

// media.mojom.RemotingSinkMetadata
...
RemotingSinkMetadataAdapter.prototype.toNewVersion = function() {
  return media.mojom.RemotingSinkMetadata({
...
MediaSinkAdapter.fromNewVersion = function(other) {
  return new MediaSinkAdapter({
    ...
    'extra_data': MediaSinkExtraDataAdapter.fromNewVersion(other.extraData),
  });
};
...
MediaSinkAdapter.prototype.toNewVersion = function() {
  return new mediaRouter.mojom.MediaSink({
    ...
    'extraData': this.extraData.toNewVersion(),
  });
};
...
MediaSinkExtraDataAdapter.fromNewVersion = function(other) {
  if (other.$tag == MediaSinkExtraData.Tags.dialMediaSink) {
...
// media.mojom.MirrorServiceRemoterPtr
...
MirrorServiceRemoterStubAdapter.prototype = Object.create(
    media.mojom.MirrorServiceRemoter.stubClass.MirrorServiceRemoterStub
        .prototype);
...
// media.mojom.MirrorServiceRemotingSourcePtr
...
var MirrorServiceRemotingSourceAdpater = {
...
MediaRouteProvider.prototype.createMediaRouteController = function(
  ...
  return this.handlers_.createMediaRouteController(
      ...
      new MediaStatusObserverPtrAdapter(observer.passInterface())).then(
