...
#if BUILDFLAG(ENABLE_SPELLCHECK)
  // This function is public because it may also be called from tests (via
  // ChromeRenderViewTest::SetUp()) in synthetic situations where
  // RenderThreadStarted() would not otherwise be called.
  void InitSpellCheck();
#endif
