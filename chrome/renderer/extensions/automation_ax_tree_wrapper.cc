...
bool AutomationAXTreeWrapper::IsEventTypeHandledByAXEventGenerator(
  ...
  switch (event_type) {
    // Actively used by ChromeVox, handled by AXEventGenerator.
    ...
    // Handled by AXEventGenerator but not currently used by ChromeVox.
    ...
    // Not generated by AXEventGenerator, not currently used by ChromeVox,
    // and possible candidates for removal from the automation API entirely.
