...
ui::AXNode* FindNodeWithChildTreeId(ui::AXNode* node, int child_tree_id) {
  if (child_tree_id == node->data().GetIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID))
    return node;
...
#define ROUTE_FUNCTION(FN)                                        \
  ...
  RouteNodeIDPlusRangeFunction(
      ...
      [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
        ...
        std::string name = node->data().GetStringAttribute(ax::mojom::StringAttribute::NAME);
        std::vector<int> character_offsets =
            node->data().GetIntListAttribute(ax::mojom::IntListAttribute::CHARACTER_OFFSETS);
        int len =
        ...
        if (start >= 0 && start <= end && end <= len) {
          ...
          switch (static_cast<ax::mojom::TextDirection>(
              node->data().GetIntAttribute(ax::mojom::IntAttribute::TEXT_DIRECTION))) {
  ...
  RouteNodeIDFunction(
      "GetBold", [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
                    AutomationAXTreeWrapper* tree_wrapper, ui::AXNode* node) {
        bool value = (node->data().GetIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE) &
                      static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_BOLD)) != 0;
  ...
  RouteNodeIDFunction(
      "GetItalic", [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
                      AutomationAXTreeWrapper* tree_wrapper, ui::AXNode* node) {
        bool value = (node->data().GetIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE) &
                      static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_ITALIC)) != 0;
        result.Set(v8::Boolean::New(isolate, value));
      });
  RouteNodeIDFunction(
      "GetUnderline",
      [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
         AutomationAXTreeWrapper* tree_wrapper, ui::AXNode* node) {
        bool value = (node->data().GetIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE) &
                      static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_UNDERLINE)) != 0;
        result.Set(v8::Boolean::New(isolate, value));
      });
  RouteNodeIDFunction(
      "GetLineThrough",
      [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
         AutomationAXTreeWrapper* tree_wrapper, ui::AXNode* node) {
        bool value =
            (node->data().GetIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE) &
             static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_LINE_THROUGH)) != 0;
        result.Set(v8::Boolean::New(isolate, value));
      });
  RouteNodeIDFunction(
      "GetCustomActions",
      [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
        ...
        const std::vector<int32_t>& custom_action_ids =
            node->data().GetIntListAttribute(ax::mojom::IntListAttribute::CUSTOM_ACTION_IDS);
  ...
  RouteNodeIDFunction("GetChecked", [](v8::Isolate* isolate,
                                       ...
                                       AutomationAXTreeWrapper* tree_wrapper,
                                       ui::AXNode* node) {
    const ax::mojom::CheckedState checked_state = static_cast<ax::mojom::CheckedState>(
        node->data().GetIntAttribute(ax::mojom::IntAttribute::CHECKED_STATE));
  ...
  RouteNodeIDFunction(
      ...
      [](v8::Isolate* isolate, v8::ReturnValue<v8::Value> result,
        ...
        const ax::mojom::Restriction restriction = static_cast<ax::mojom::Restriction>(
            node->data().GetIntAttribute(ax::mojom::IntAttribute::RESTRICTION));
        if (restriction != ax::mojom::Restriction::NONE) {
...
void AutomationInternalCustomBindings::GetSchemaAdditions(
  ...
  for (int32_t i = static_cast<int32_t>(ax::mojom::NameFrom::NONE);
       i <= static_cast<int32_t>(ax::mojom::NameFrom::LAST); ++i) {
    name_from_type.Set(
        i, base::StringPiece(ui::ToString(static_cast<ax::mojom::NameFrom>(i))));
  }

  gin::DataObjectBuilder restriction(isolate);
  for (int32_t i = static_cast<int32_t>(ax::mojom::Restriction::NONE);
       i <= static_cast<int32_t>(ax::mojom::Restriction::LAST); ++i) {
    restriction.Set(
        i, base::StringPiece(ui::ToString(static_cast<ax::mojom::Restriction>(i))));
  }

  gin::DataObjectBuilder description_from_type(isolate);
  for (int32_t i = static_cast<int32_t>(ax::mojom::DescriptionFrom::NONE);
       i <= static_cast<int32_t>(ax::mojom::DescriptionFrom::LAST); ++i) {
    description_from_type.Set(
        i,
        base::StringPiece(ui::ToString(static_cast<ax::mojom::DescriptionFrom>(i))));
  }
...
bool AutomationInternalCustomBindings::GetFocusInternal(
  ...
  while (focus->data().HasIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID)) {
    ...
    int child_tree_id =
        focus->data().GetIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID);
  ...
  if ((*in_out_tree_wrapper)->host_node_id() > 0) {
    ...
    if (parent) {
      int parent_child_tree_id =
          parent->data().GetIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID);
...
void AutomationInternalCustomBindings::SendTreeChangeEvent(
  ...
  if (node->data().HasIntAttribute(ax::mojom::IntAttribute::CHILD_TREE_ID))
  ...
  if (tree_change_observer_overall_filter_ &
    ...
    if (node->data().HasStringAttribute(ax::mojom::StringAttribute::CONTAINER_LIVE_STATUS) ||
        node->data().role == ax::mojom::Role::ALERT) {
      has_filter = true;
    }
  }
  ...
  if (tree_change_observer_overall_filter_ &
    ...
    if (node->data().HasIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES))
      has_filter = true;
  }
