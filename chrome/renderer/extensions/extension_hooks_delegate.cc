...
void RequestAccessor(v8::Local<v8::Name> name,
                     const v8::PropertyCallbackInfo<v8::Value>& info) {
  v8::Isolate* isolate = info.GetIsolate();
  isolate->ThrowException(v8::Exception::Error(
        gin::StringToV8(isolate, "sendRequest and onRequest are obsolete."
...
void ExtensionHooksDelegate::InitializeInstance(
  ...
  v8::Maybe<bool> success =
      instance->SetAccessor(context,
                            gin::StringToV8(context->GetIsolate(), "onRequest"),
                            &RequestAccessor);
