...
TEST_F(ExtensionLocalizationPeerTest, OnCompletedRequestEmptyData) {
  ...
  EXPECT_CALL(
      *original_peer_,
      OnCompletedRequest(net::OK, null_cors_error, null_headers,
                         false /* stale_copy_in_cache */,
                         base::TimeTicks() /* completion_time */,
                         -1 /* total_transfer_size */,
                         0 /* encoded_body_size */, 0 /* decoded_body_size */));
...
TEST_F(ExtensionLocalizationPeerTest, OnCompletedRequestNoCatalogs) {
  ...
  filter_peer_->OnCompletedRequest(
      ...
      nullptr /* error_response_headers */, false /* stale_copy_in_cache */,
      base::TimeTicks() /* completion_time */, -1 /* total_transfer_size */,
      -1 /* encoded_body_size */, -1 /* decoded_body_size */);
