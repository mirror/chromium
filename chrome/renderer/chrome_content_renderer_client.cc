    ...
    switch (status) {
      ...
      case ChromeViewHostMsg_GetPluginInfo_Status::kOutdatedBlocked: {
        ...
        render_frame->GetRemoteAssociatedInterfaces()->GetInterface(
            &plugin_host);
        plugin_host->BlockedOutdatedPlugin(placeholder->CreateRoutingId(),
                                           identifier);
        break;
      }
      ...
      case ChromeViewHostMsg_GetPluginInfo_Status::kUnauthorized: {
        ...
        render_frame->GetRemoteAssociatedInterfaces()->GetInterface(
            &plugin_host);
        plugin_host->BlockedUnauthorizedPlugin(group_name, identifier);
      ...
      case ChromeViewHostMsg_GetPluginInfo_Status::kComponentUpdateRequired: {
        ...
        plugin_host->BlockedComponentUpdatedPlugin(
            placeholder->CreateRoutingId(), identifier);
        break;
      }
#if defined(OS_LINUX)
