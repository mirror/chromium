...
void BindModuleEventSink(
    mojo::InterfacePtr<mojom::ModuleEventSink>* module_event_sink,
    mojo::InterfacePtrInfo<mojom::ModuleEventSink> interface_ptr_info) {
...
void HandleModuleEventOnIOThread(
    const mojo::InterfacePtr<mojom::ModuleEventSink>& module_event_sink,
