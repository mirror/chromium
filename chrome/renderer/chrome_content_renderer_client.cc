...
ChromeContentRendererClient::ChromeContentRendererClient()
    : main_entry_time_(base::TimeTicks::Now()), weak_factory_(this) {
#if BUILDFLAG(ENABLE_EXTENSIONS)
...
#if BUILDFLAG(HAS_SPELLCHECK_PANEL)
  new SpellCheckPanel(render_frame, registry, weak_factory_.GetWeakPtr());
#endif  // BUILDFLAG(HAS_SPELLCHECK_PANEL)
#endif
...
void ChromeContentRendererClient::GetInterface(
  ...
  if (!connector_) {
    LOG(ERROR) << "::::::::::::::::::::::: ChromeContentRendererClient::GetInterface: no connector";
    return;
  }
...
void ChromeContentRendererClient::InitSpellCheck() {
  spellcheck_ =
      std::make_unique<SpellCheck>(&registry_, weak_factory_.GetWeakPtr());
}
#endif
