...
class TargetsAffinity {
 public:
  ...
  // Label 0 is assigned to targets that can not be associated. Labels for old
  // targets are written to |old_labels| and labels for new targets are written
  // to |new_labels|. Returns the upper bound on assigned labels.
