...
// A class that holds data for References that have the same semantics:
// - Ordered list of targets.
// - List of associated reference type.
class TargetPool {
 public:
  ...
  // Following methods insert every new targets found in |references|. This
 ...
 private:
  // Stores targets for pool in ascending order.
