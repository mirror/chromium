...
class TargetPool {
 public:
  ...
  // The following functions insert each new |targets|. This invalidates all
  ...
  // Returns a canonical key associated with the lower bound of |offset|. Note
  // that this may return the invalid |size()| key.
  key_t KeyForLowerBoundOffset(offset_t offset) const;
