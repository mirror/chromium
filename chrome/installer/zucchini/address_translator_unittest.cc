...
// Test case structs. The convention of EXPECT() is to specify "expect" before
// "computed value". However, AddressTranslator interfaces explicitly state "X
...
class TestAddressTranslatorBuilder : public AddressTranslatorBuilder {
 public:
  ...
  // "..AAA...|....aaaa" is split into "..AAA..." for offsets, and "....aaaa":
...
TEST(AddressTranslatorTest, OverlapFromComment) {
  ...
  struct {
    ...
    ATB::Status expected = ATB::kSuccess;
      ...
      {"..tttthhhh..", "..TTTT..HHHH.."},
      {"..tttthhhh..", "..HHHH..TTTT.."},
      {"..tttthhhh..", "..TTOOHH..", ATB::kErrorBadOverlap},
      {"..tttooohhh..", "..TTTOOOHHH.."},
      {"..tttooohhh..", "..TTTTTOHHHHH..", ATB::kErrorBadOverlap},
      {"..tttooohhh..", "..HHOOOOTT..", ATB::kErrorBadOverlap},
      {"..tttooohhh..", "..TTTOOOH.."},
      {"..tttooohhh..", "..TTTOOOH.."},
      {"..tttooottt..", "..TTTOOOT.."},
      {"..tttooohhh..", "..TTTOO.."},
      {"..tttooohhh..", "..TTTOHHH..", ATB::kErrorBadOverlapDanglingRVA},
      {"..tttooottt..", "..TTTOOTTTT..", ATB::kErrorBadOverlapDanglingRVA},
      {"..oooooo..", "..OOO.."},
  };
  ...
  for (const auto& test_case : test_cases) {
    ...
    std::string unit_str1 = to_period(to_period(base_str, 'T'), 't');
    std::string unit_str2 = to_period(to_period(base_str, 'H'), 'h');
