...
// overrun. BufferSink should be passed by pointer to maintain cursor progress
// across writes.
class BufferSink : public MutableBufferView {
 public:
  ...
  // |value| starting at cursor, advancing the cursor beyond the written region,
  ...
  // starting at cursor, advancing the cursor beyond the written region and
