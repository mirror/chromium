...
TEST_F(LabeledPoolTest, ResetLabels) {
  ...
  labeled_pool_.ResetLabels({1, 2, 1}, 3);
  EXPECT_EQ(std::vector<offset_t>({1, 2, 1}), labeled_pool_.labels());
}
