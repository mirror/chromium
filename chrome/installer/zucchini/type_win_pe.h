...
static_assert(sizeof(ImageDOSHeader) == 0x40, "DOS header size is 0x40 bytes");
...
static_assert(sizeof(ImageSectionHeader) == 0x28,
              "Section header size is 0x28 bytes");
...
static_assert(sizeof(ImageDataDirectory) == 0x08,
              "Data directory size is 0x08 bytes");
...
static_assert(sizeof(ImageFileHeader) == 0x14,
              "File header size is 0x14 bytes");
...
static_assert(sizeof(ImageOptionalHeader) == 0xE0,
              "Optional header (32) size is 0xE0 bytes");
...
static_assert(sizeof(ImageOptionalHeader64) == 0xF0,
              "Optional header (64) size is 0xF0 bytes");
