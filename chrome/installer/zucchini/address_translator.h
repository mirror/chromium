...
class AddressTranslator {
 public:
  ...
  class CachedForOffsetToRva {
   public:
    // Embeds |translator| for use. Now object lifetime is tied to |translator|
    // lifetime.
    explicit CachedForOffsetToRva(const AddressTranslator& translator);
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(CachedForOffsetToRva);
  };
  ...
  class CachedForRvaToOffset {
   public:
    // Embeds |translator| for use. Now object lifetime is tied to |translator|
    // lifetime.
    explicit CachedForRvaToOffset(const AddressTranslator& translator);
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(CachedForRvaToOffset);
  };
  ...
  Status Initialize(std::vector<Unit>&& units_in);
