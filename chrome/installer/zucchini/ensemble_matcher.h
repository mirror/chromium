...
// A base class for ensemble matching stragegies, which identify Elements in a
...
// - A "new" Element may have no match. This can happen when no viable matche
...
class EnsembleMatcher {
 ...
 protected:
  ...
  // "new" elements have increasing offsets and dono't overlap. May be empty.
