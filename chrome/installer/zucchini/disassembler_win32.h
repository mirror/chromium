...
class DisassemblerWin32 : public Disassembler {
 ...
 private:
  ...
  AddressTranslator trans_;

  // An exclusive upper bound on all RVAs used in the image. This is used as a
  // quick test for target RVA validity (rather than using |trans_|) during
  // rel32 extraction.
  rva_t rva_bound_ = 0;
