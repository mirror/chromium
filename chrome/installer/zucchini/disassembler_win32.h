...
class DisassemblerWin32 : public Disassembler, public AddressTranslatorFactory {
 public:
  ...
  // AddressTranslator:
  // The returned objects have the same lifetime as *this.
 ...
 private:
  ...
  // An upper bound on all RVA in the image.
  rva_t rva_bound_ = 0;

  // Some RVAs has no matching offset on disk (e.g., RVAs to .bss sections).
  ...
  // This is made into a large value (e.g., max of \rva_bound_| and imgae size)
