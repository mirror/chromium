...
class ReferenceSet {
 public:
  ...
  // Transforms reference's targets from offset to key in |target_pool|.
  void CanonicalizeTargets(const TargetPool& target_pool);
  ...
  Reference at(offset_t location) const;
