...
TEST(ImageUtilsTest, MarkIndex) {
  ...
  EXPECT_EQ(0xF0000000, MarkIndex(0x70000000));
  EXPECT_EQ(0xFFFFFFFF, MarkIndex(0x7FFFFFFF));
...
TEST(ImageUtilsTest, UnmarkIndex) {
  ...
  EXPECT_EQ(0x70000000, UnmarkIndex(0x70000000));
  EXPECT_EQ(0x7FFFFFFF, UnmarkIndex(0x7FFFFFFF));
