...
class TestDisassembler : public Disassembler {
 ...
 private:
  ...
  std::unique_ptr<ReferenceReader> MakeReadRefs(offset_t lower,
                                                offset_t upper,
                                                int type);
