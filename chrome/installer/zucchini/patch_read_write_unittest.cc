...
TEST(PatchElementTest, Normal) {
  ...
  PatchElementReader patch_element_reader =
      TestParseMember<PatchElementReader>(&data);
  ...
  TestSerializeMember(data, patch_element_writer);
}
...
TEST(EnsemblePatchTest, RawPatch) {
  ...
  EnsemblePatchReader ensemble_patch_reader =
      TestParseMember<EnsemblePatchReader>(&data);
  ...
  TestSerializeMember(data, ensemble_patch_writer);
}
...
TEST(EnsemblePatchTest, InvalidMagic) {
  ...
  TestInvalidParseMember<EnsemblePatchReader>(&data);
}
