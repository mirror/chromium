...
class MappedFileWriter {
 public:
  // Creates |file_path| and maps it to memory for writing. |should_delete|
  // indicates whether the file should be deleted when the object gets
  // destructed.
 ...
 private:
  ...
  base::MemoryMappedFile buffer_;
  bool will_delete_on_close_ = false;
  bool should_delete_;
