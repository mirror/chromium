...
class DisassemblerElfX86 : public DisassemblerElf<ELF32Traits> {
 public:
  ...
  static std::unique_ptr<DisassemblerElfX86> Make(ConstBufferView image) {
    std::unique_ptr<DisassemblerElfX86> disasm =
        base::MakeUnique<DisassemblerElfX86>();
...
class DisassemblerElfARM32 : public DisassemblerElfARM<ELF32Traits> {
 public:
  ...
  static std::unique_ptr<DisassemblerElfARM32> Make(ConstBufferView image) {
    std::unique_ptr<DisassemblerElfARM32> disasm =
        base::MakeUnique<DisassemblerElfARM32>();
    if (!disasm->Parse(image))
      return nullptr;
    return disasm;
  }
...
class DisassemblerElfAArch64 : public DisassemblerElfARM<ELF64Traits> {
 public:
  ...
  static std::unique_ptr<DisassemblerElfAArch64> Make(ConstBufferView image) {
    std::unique_ptr<DisassemblerElfAArch64> disasm =
        base::MakeUnique<DisassemblerElfAArch64>();
    if (!disasm->Parse(image))
      return nullptr;
    return disasm;
  }
