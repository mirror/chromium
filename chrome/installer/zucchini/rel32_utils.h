...
class Rel32ReaderX86 : public ReferenceReader {
 ...
 private:
  ...
  AddressTranslator::CachedForRvaToOffset target_rva_to_offset_;
  AddressTranslator::CachedForOffsetToRva location_offset_to_rva_;
  const offset_t hi_;
...
class Rel32WriterX86 : public ReferenceWriter {
 ...
 private:
  ...
  AddressTranslator::CachedForOffsetToRva target_offset_to_rva_;
  AddressTranslator::CachedForOffsetToRva location_offset_to_rva_;
