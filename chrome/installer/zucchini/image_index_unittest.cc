...
TEST_F(ImageIndexTest, TypeAndPool) {
  ...
  EXPECT_EQ(0, image_index_.LabelBound(PoolTag(0)));
  EXPECT_EQ(0, image_index_.LabelBound(PoolTag(1)));
}
...
TEST_F(ImageIndexTest, LabelTargets) {
  ...
  EXPECT_EQ(4, image_index_.LabelBound(PoolTag(0)));
  EXPECT_EQ(0, image_index_.LabelBound(PoolTag(1)));
  ...
  EXPECT_EQ(4, image_index_.LabelBound(PoolTag(0)));
  EXPECT_EQ(1, image_index_.LabelBound(PoolTag(1)));
...
TEST_F(ImageIndexTest, LabelAssociatedTargets) {
  ...
  EXPECT_EQ(5, image_index_.LabelBound(PoolTag(0)));
  EXPECT_EQ(0, image_index_.LabelBound(PoolTag(1)));
  EXPECT_EQ(
