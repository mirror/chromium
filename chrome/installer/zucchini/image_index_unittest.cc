...
TEST_F(ImageIndexTest, TypeAndPool) {
  ...
  EXPECT_EQ(TypeTag(0), image_index_.at(TypeTag(0)).type_tag());
  EXPECT_EQ(TypeTag(1), image_index_.at(TypeTag(1)).type_tag());
  EXPECT_EQ(TypeTag(2), image_index_.at(TypeTag(2)).type_tag());

  EXPECT_EQ(PoolTag(0), image_index_.at(TypeTag(0)).pool_tag());
  EXPECT_EQ(PoolTag(0), image_index_.at(TypeTag(1)).pool_tag());
  EXPECT_EQ(PoolTag(1), image_index_.at(TypeTag(2)).pool_tag());
}
