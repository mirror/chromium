...
TEST_F(ImageIndexTest, TypePoolCount) {
  EXPECT_EQ(3, image_index_.TypeCount());
  EXPECT_EQ(2, image_index_.PoolCount());
  EXPECT_EQ(0, image_index_.LabelCount(TypeTag(0)));
  EXPECT_EQ(0, image_index_.LabelCount(TypeTag(1)));
  EXPECT_EQ(0, image_index_.LabelCount(TypeTag(2)));
  EXPECT_EQ(0, image_index_.LabelCount(PoolTag(0)));
  EXPECT_EQ(0, image_index_.LabelCount(PoolTag(1)));
}
