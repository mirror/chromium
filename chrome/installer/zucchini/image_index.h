...
class ImageIndex {
 public:
  ...
  // |label_manager| by the index of this label, and updates the label count
  ...
  // function, implying it can not be called twice in a row.
  ...
  // target indices. Resets label count associated with |pool| to 0.
