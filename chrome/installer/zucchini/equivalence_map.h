...
// Returns a metric capturing the similarity between content in |old_view| and
// |new_view| at offsets |src| and |dst|, respectively. Both |src| and
// |dst| must refer to tokens in |old_image| and |new_image|.
