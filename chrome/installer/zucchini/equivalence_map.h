...
// Returns a similarity score between content in |old_image| and |new_image| at
// offsets |src| and |dst|, respectively. |targets_affinities| describes
// affinities for each target pool and is used to evaluate similarity between
// references, hence it's size must be equal to the number of pools in both
// |old_image| and |new_image|. Both |src| and |dst| must refer to tokens in
// |old_image| and |new_image|.
...
// Returns a similarity score between content in |old_image| and |new_image| at
// regions described by |equivalence|, using |targets_affinities| to evaluate
// similarity between references.
...
// |old_image| and |new_image|, and returns the result. |targets_affinities|
// is used to evaluate similarity between references. |min_similarity| describes
// the minimum acceptable similarity score and is used as threshold to discard
// bad equivalences.
