...
void AddNativeNotificationWorkItems(const InstallerState& installer_state,
  ...
  // COM probe/flush below does its job. Delete both 64 and 32 keys to handle
  // 32->64 or 64->32 migration.
  ...
  notification_helper = notification_helper.AppendASCII(new_version.GetString())
