...
constexpr const wchar_t kChromeInstallFilesCapabilitySid[] =
    L"S-1-15-3-1024-3424233489-972189580-2057154623-747635277-1604371224-"
    L"316187997-3786583170-1043257646";
constexpr const wchar_t kLpacChromeInstallFilesCapabilitySid[] =
...
bool AddAclToPath(const base::FilePath& path,
  ...
  for (const wchar_t* trustee : trustees) {
    ...
    converted_trustees.emplace_back(ATL::CSid(static_cast<SID*>(sid)));
    ::LocalFree(sid);
  }
