...
class ShellUtil {
 public:
  ...
  struct ShortcutProperties {
    ...
    // Sets the toast activator CLSID to |toast_activator_clsid_in| (Win10+).
    void set_toast_activator_clsid(
        const base::string16& toast_activator_clsid_in) {
    ...
    base::string16 toast_activator_clsid;
    bool pin_to_taskbar;
