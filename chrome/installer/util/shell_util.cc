...
bool LaunchDefaultAppsSettingsModernDialog(const wchar_t* protocol) {
  ...
  static constexpr base::Feature kHighlightDefaultProtocolInWindowsSettings{
      "HighlightDefaultProtocolInWindowsSettings",
  ...
  if (SUCCEEDED(hr)) {
    ...
    hr = activator->ActivateApplication(kControlPanelAppModelId,
                                        ...
                                        AO_NONE, &pid);
    if (SUCCEEDED(hr) && base::FeatureList::IsEnabled(
                             kHighlightDefaultProtocolInWindowsSettings)) {
