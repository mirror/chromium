...
const char kSkipCompress[] = "skip_compress";
...
void DumpUsage(const base::CommandLine& cmd_line,
  ...
  fwprintf(
      ...
      L" --skip_compress            Disable compression.\n",
...
int wmain(int argc, wchar_t *argv[]) {
  ...
  if (upgrade_test::GenerateAlternateVersion(
          ...
          base::MakeAbsoluteFilePath(out), direction,
          cmd_line->HasSwitch(switches::kSkipCompress)
              ? upgrade_test::NO_COMPRESSION
              : upgrade_test::COMPRESSION,
