...
#define CoCreatableClass2(className) \
  CoCreatableClassWithFactory2(className, SimpleClassFactory2<className>)
...
HRESULT RegisterAppForNativeNotification() {
  ...
  static const auto path_cch_combine =
...
void PrepareForNativeNotification() {
  RoInitializeWrapper2 winRtInitializer(RO_INIT_MULTITHREADED);
