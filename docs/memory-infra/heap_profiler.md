...
## How to obtain a heap dump (M66+, Linux, macOS, Windows)
 ...
 4. By default, stack traces use native stack traces, which does not contain any thread information. To include
    the thread at time of allocation, set `memlog-stack-mode` to
