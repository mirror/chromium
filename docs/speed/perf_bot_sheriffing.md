...
platform Q, story baz is failing. To disable these stories, go the [expectations
config file](https://cs.chromium.org/chromium/src/tools/perf/expectations.config).
...
a single expectation are treated as logical and so it must meet all conditions
to be disabled.
...
of this format: `crbug.com/123456 [ CONDITIONS ] bar/* [ Skip ]`
