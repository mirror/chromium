...
Similar to [debugging apk targets](android_debugging_instructions.md#waiting-for-debugger-on-early-startup):

```shell
out/Default/run_chrome_junit_tests --wait-for-java-debugger
```
