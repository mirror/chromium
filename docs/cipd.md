...
This document outlines how to use [CIPD]() for managing binary dependencies in
chromium.
...
For more on third-party dependencies, see [here][1].
...
For more information about the package definition spec, see [the code][2].
...
[1]: /docs/adding_to_third_party.md
[2]: https://chromium.googlesource.com/infra/luci/luci-go/+/master/cipd/client/cipd/local/pkgdef.go
