...
`src/components/hello_world/BUILD`
...
### Guide to WebUI message handler
Creating a WebUI message handler and the dialogue c++->js and js->c++ is described in [WebUI Explainer](https://chromium.googlesource.com/chromium/src/+/master/docs/webui_explainer.md).
