...
| `artifact_types_info` | dict | **Optional. Required if any artifacts are present for any tests** MIME Type information for artifacts in this json file. All artifacts with the same name must share the same MIME type.  |
