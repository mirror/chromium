...
lists get a reply (by someone; not necessarily the sheriff themselves).
...
management](https://www.chromium.org/Home/chromium-security/security-labels) on
bugs, for example applying the correct Merge and Restrict-View labels when a
bug transitions to Fixed.
...
TODO(palmer): Grab the images from https://www.chromium.org/Home/chromium-security/security-sheriff

https://twitter.com/__apf__/status/728776130564526080
...
#### Step 3. [Label, label,
label](https://www.chromium.org/Home/chromium-security/security-labels).
