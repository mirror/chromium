...
modify the project sdk, hence causing problems when you next run gclient sync.

See [android_test_instructions.md](android_test_instructions.md#using_emulators)
