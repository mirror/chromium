...
class IteratorProxy {
  // In order to figure out the return type of operator* using decltype, the
  // variable involved has to be located above the function. Hence, put the
  // private block here instead of at the bottom (or sticking it somewhere in
  // the middle.
 private:
