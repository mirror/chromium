...
TEST_F(AnimationPlayerTest, AddTwoTickersFromTheSameElementToOnePlayerTest) {
  ...
  size_t ticker_id1 = player_->NextTickerId();
  ...
  size_t ticker_id2 = player_->NextTickerId();
