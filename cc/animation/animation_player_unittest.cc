...
TEST_F(AnimationPlayerTest, AddTwoTickersFromTheSameElementToOnePlayerTest) {
  ...
  unsigned ticker_id1 = player_->NextTickerId();
  ...
  unsigned ticker_id2 = player_->NextTickerId();
