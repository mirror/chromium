...
class CC_ANIMATION_EXPORT SingleAnimationPlayer : public AnimationPlayer {  //,
 ...
 public:
  ...
  //  //virtual scoped_refptr<SingleAnimationPlayer> CreateImplInstance() const;
  //
  ...
  //
  //  AnimationTicker* animation_ticker() const { return
  ...
  //
  //  //virtual void PushPropertiesTo(SingleAnimationPlayer* player_impl);
  //
  ...
  //  bool NotifyAnimationFinishedForTesting(TargetProperty::Type
  //  target_property,
  //                                         int group_id);
  //
