...
bool TransformOperation::ApproximatelyEqual(const TransformOperation& other,
  ...
  switch (type) {
    case TransformOperation::TRANSFORM_OPERATION_TRANSLATE:
      return gfx::MathUtil::ApproximatelyEqual(translate.x, other.translate.x,
                                               tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(translate.y, other.translate.y,
                                               tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(translate.z, other.translate.z,
                                               tolerance);
    case TransformOperation::TRANSFORM_OPERATION_ROTATE:
      return gfx::MathUtil::ApproximatelyEqual(
                 rotate.axis.x, other.rotate.axis.x, tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(
                 rotate.axis.y, other.rotate.axis.y, tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(
                 rotate.axis.z, other.rotate.axis.z, tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(rotate.angle, other.rotate.angle,
                                               tolerance);
    case TransformOperation::TRANSFORM_OPERATION_SCALE:
      return gfx::MathUtil::ApproximatelyEqual(scale.x, other.scale.x,
                                               tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(scale.y, other.scale.y,
                                               tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(scale.z, other.scale.z,
                                               tolerance);
    case TransformOperation::TRANSFORM_OPERATION_SKEW:
      return gfx::MathUtil::ApproximatelyEqual(skew.x, other.skew.x,
                                               tolerance) &&
             gfx::MathUtil::ApproximatelyEqual(skew.y, other.skew.y, tolerance);
    case TransformOperation::TRANSFORM_OPERATION_PERSPECTIVE:
      return gfx::MathUtil::ApproximatelyEqual(
