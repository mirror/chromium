...
void AnimationHost::SetAnimationCounts(
  ...
  // The |total_animations_count| is the number of total blink::Animations.
  ...
  // So to check how many main thread animations, we subtract the number of
  // cc::AnimationPlayer from |total_animations_count|.
