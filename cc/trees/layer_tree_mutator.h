...
struct AnimatorOutputState {
  ...
  // TODO(majidvp): This assumes each animator has a single output effect which
  // does not hold once we state support group effects.
