...
void ScrollNode::AsValueInto(base::trace_event::TracedValue* value) const {
  ...
  gfx::MathUtil::AddToTracedValue("container_bounds", container_bounds, value);
  gfx::MathUtil::AddToTracedValue("bounds", bounds, value);
  gfx::MathUtil::AddToTracedValue("offset_to_transform_parent",
