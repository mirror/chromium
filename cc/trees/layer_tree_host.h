...
class CC_EXPORT LayerTreeHost : public viz::SurfaceReferenceOwner,
 ...
 public:
  ...
  // Whether this host is configured to use layer lists rather than
  // layer trees. This also implies that property trees are always
  // already built and so cc doesn't have to build them.
