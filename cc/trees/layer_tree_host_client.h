...
// LayerTreeHost, which then processes them and also calls into the equivalent
// methods on its LayerTreeHostClient.
//
...
class LayerTreeHostClient {
 public:
  ...
  // appropriate.
  //
  // For a LayerTreeHostClient backed by Blink, this methodwill update
