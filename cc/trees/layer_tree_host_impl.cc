...
LayerTreeHostImpl::LayerTreeHostImpl(
    ...
    : client_(client),
      ...
      content_requires_crisp_edges_(false),
...
void LayerTreeHostImpl::SetContentRequiresCrispEdges(bool flag) {
  if (content_requires_crisp_edges_ != flag) {
    content_requires_crisp_edges_ = flag;
    need_update_gpu_rasterization_status_ = true;
  }
}
...
bool LayerTreeHostImpl::UpdateGpuRasterizationStatus() {
  ...
  bool using_msaa_for_slow_paths =
      ...
      (!content_requires_crisp_edges_ || supports_disable_msaa);
