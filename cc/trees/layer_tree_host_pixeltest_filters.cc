...
class LayerTreeHostFiltersScaledPixelTest
 ...
 protected:
  void RunPixelTestType(int content_size,
    ...
    FilterOperations filters;
    FilterOperation::ShapeRects alpha_region;
    alpha_region.emplace_back(half_content, half_content, content_size,
                              content_size);
    filters.Append(
...
class EnlargedTextureWithAlphaThresholdFilter
 ...
 protected:
  void RunPixelTestType(PixelTestType test_type, base::FilePath image_name) {
    ...
    rect2.Inset(-5, -5);
    FilterOperation::ShapeRects alpha_region;
    alpha_region.push_back(rect1);
    alpha_region.push_back(rect2);
    FilterOperations filters;
    filters.Append(
