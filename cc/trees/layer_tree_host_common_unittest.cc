...
TEST_F(LayerTreeHostCommonTest, ScrollTreeBuilderTest) {
  ...
  scroll_child7.max_scroll_offset_affected_by_page_scale = true;
  ...
  scroll_parent5.max_scroll_offset_affected_by_page_scale = true;
