...
class LayerTreeHostAnimationTest : public LayerTreeTest {
 public:
  ...
  void GetImplTimelineAndPlayerByID(const LayerTreeHostImpl& host_impl) {
    ...
    player_child_impl_ = (SingleAnimationPlayer*)(timeline_impl_->GetPlayerById(
        player_child_id_));
 ...
 protected:
  ...
  scoped_refptr<SingleAnimationPlayer> player_child_impl_;
...
class LayerTreeHostAnimationTestAddAnimationWithTimingFunction
 ...
 public:
  ...
  void AnimateLayers(LayerTreeHostImpl* host_impl,
    ...
    scoped_refptr<SingleAnimationPlayer> player_child_impl =
        (SingleAnimationPlayer*)(timeline_impl->GetPlayerById(
            player_child_id_));
...
class LayerTreeHostAnimationTestDoNotSkipLayersWithAnimatedOpacity
 ...
 public:
  ...
  void DidActivateTreeOnThread(LayerTreeHostImpl* host_impl) override {
    scoped_refptr<AnimationTimeline> timeline_impl =
        GetImplAnimationHost(host_impl)->GetTimelineById(timeline_id_);
    scoped_refptr<SingleAnimationPlayer> player_impl =
        (SingleAnimationPlayer*)(timeline_impl->GetPlayerById(player_id_));
