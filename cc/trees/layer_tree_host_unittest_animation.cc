...
// Ensures that LayerClient::(Will|Did)ChangeLayerTransform() is notified when
// an animation changes the transform of a layer.
class LayerTreeHostAnimationTestTransformAnimationNotifiesClient
 ...
 public:
  void BeginTest() override {
    ...
    EXPECT_CALL(layer_client_, WillChangeLayerTransform());
