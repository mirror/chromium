...
void ProxyMain::BeginMainFrame(
  ...
  bool skip_paint_and_commit =
      begin_main_frame_state->begin_frame_args.skip_compositor_frame;

  // If commits are deferred, skip the rest of the pipeline.
  ...
  layer_tree_host_->RequestMainFrameUpdate(
      skip_paint_and_commit
          ? LayerTreeHost::MainFrameLifecyclePhase::kLayoutClean
          : LayerTreeHost::MainFrameLifecyclePhase::kAll);
