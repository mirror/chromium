...
class LayerTreeHostCopyRequestTestMultipleRequests
 ...
 protected:
  ...
  void NextStep() {
    ...
    switch (frame) {
      case 1:
        child->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
      ...
      case 3:
        ...
        root->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
            viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
            base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::
                               CopyOutputCallback,
...
class LayerTreeHostCopyRequestCompletionCausesCommit
 ...
 protected:
  ...
  void DidCommit() override {
    ...
    switch (frame) {
      case 1:
        layer_->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
            viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
...
class LayerTreeHostCopyRequestTestLayerDestroyed
 ...
 protected:
  ...
  void DidCommit() override {
    ...
    switch (frame) {
      case 1:
        main_destroyed_->RequestCopyOfOutput(base::MakeUnique<
                                             viz::CopyOutputRequest>(
            viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
            base::BindOnce(
                &LayerTreeHostCopyRequestTestLayerDestroyed::CopyOutputCallback,
                base::Unretained(this))));
        impl_destroyed_->RequestCopyOfOutput(base::MakeUnique<
                                             viz::CopyOutputRequest>(
            viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
            base::BindOnce(
                &LayerTreeHostCopyRequestTestLayerDestroyed::CopyOutputCallback,
...
class LayerTreeHostCopyRequestTestInHiddenSubtree
 ...
 protected:
  ...
  void AddCopyRequest(Layer* layer) {
    layer->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
        viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
        base::BindOnce(
...
class LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest
 ...
 protected:
  ...
  void BeginTest() override {
    ...
    copy_layer_->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
        viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
        base::BindOnce(
...
class LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest
 ...
 protected:
  ...
  void DidCommit() override {
    ...
    if (layer_tree_host()->SourceFrameNumber() == 1) {
      child_->RequestCopyOfOutput(base::MakeUnique<viz::CopyOutputRequest>(
          viz::CopyOutputRequest::ResultFormat::RGBA_BITMAP,
          base::BindOnce(
