...
static inline float UserScrollableHorizontal(Layer* layer) {
  return layer->user_scrollable_horizontal();
}

static inline float UserScrollableHorizontal(LayerImpl* layer) {
  return layer->test_properties()->user_scrollable_horizontal;
}

static inline float UserScrollableVertical(Layer* layer) {
  return layer->user_scrollable_vertical();
}

static inline float UserScrollableVertical(LayerImpl* layer) {
