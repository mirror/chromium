...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, ScrollBeforeMouseMove) {
  ...
  gfx::Vector2dF offset_down(0, 10);
  scroll_tree.ScrollBy(scroll_node, offset_down, host_impl_.active_tree());
  ...
  gfx::Vector2dF offset_up(0, -10);
  scroll_tree.ScrollBy(scroll_node, offset_up, host_impl_.active_tree());
