...
class CC_SURFACES_EXPORT CompositorFrameSinkSupport
 ...
 private:
  // Update surface references with SurfaceManager based on
  // |active_referenced_surfaces| from the most recent CompositorFrame. This
  // will add and remove top-level root references if |is_root_| is true and
  // |local_surface_id| has changed since the last time surface references were
  // updated.
