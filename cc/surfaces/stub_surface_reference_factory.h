...
// A stub implementation that creates a closure which does nothing. Once surface
// references are switched on everywhere this class and all usage of
// SurfaceReferenceFactory will be deleted.
