...
DirectCompositorFrameSink::~DirectCompositorFrameSink() {
  ...
  if (display_begin_frame_source_ &&
      unregister_begin_frame_source_on_destruction_)
    surface_manager_->UnregisterBeginFrameSource(display_begin_frame_source_);
}
...
bool DirectCompositorFrameSink::BindToClient(
  ...
  // Display's context.
  if (display_begin_frame_source_) {
    unregister_begin_frame_source_on_destruction_ = true;
