...
void CompositorFrameSinkSupport::UpdateSurfaceReferences(
  ...
  const base::flat_set<SurfaceId>& current_referenced_surfaces =
  ...
  // difference between current surface references and surface references for
  ...
  GetSurfaceReferenceDifference(surface_id, current_referenced_surfaces,
