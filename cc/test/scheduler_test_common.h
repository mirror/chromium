...
class FakeCompositorTimingHistory : public CompositorTimingHistory {
 public:
  ...
  void SetBeginMainSentToReadyToCommitEstimate(base::TimeDelta duration);
  ...
  base::TimeDelta BeginMainFrameSentToReadyToCommitDurationEstimate()
      const override;
 ...
 protected:
  ...
  base::TimeDelta begin_main_frame_sent_to_ready_to_commit_duration_;
