...
#ifndef CC_TEST_FAKE_LAYER_CLIENT_H_
#define CC_TEST_FAKE_LAYER_CLIENT_H_
...
class FakeLayerClient : public LayerClient {
 public:
  FakeLayerClient();
  ~FakeLayerClient();
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(FakeLayerClient);
};

}  // namespace cc

#endif  // CC_TEST_FAKE_LAYER_CLIENT_H_
