...
void CreateVirtualViewportLayers(Layer* root_layer,
  ...
  outer_scroll_layer->SetScrollable();
  ...
  inner_viewport_scroll_layer->SetScrollContainerBounds(inner_bounds);
  inner_viewport_scroll_layer->SetBounds(outer_bounds);
  outer_viewport_container_layer->SetBounds(outer_bounds);
  outer_scroll_layer->SetScrollContainerBounds(outer_bounds);
