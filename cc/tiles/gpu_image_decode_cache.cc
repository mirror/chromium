...
bool DrawAndScaleImage(const DrawImage& draw_image,
  ...
  // We don't want to perform any color conversion except in PaintImageDecode
  // (which gets the target color space explicitly), so create a new pixmap with
  // a null colorspace that shares |target_pixmap|'s memory.
