...
class CC_EXPORT Layer : public base::RefCounted<Layer> {
 public:
  ...
  void SetWheelEventListenerRegion(const Region& wheel_event_listener_region);
  const Region& wheel_event_listener_region() const {
    return inputs_.wheel_event_listener_region;
  }
 ...
 private:
  ...
  struct Inputs {
    ...
    Region wheel_event_listener_region;
