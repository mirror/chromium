...
typedef std::map<TouchAction, Region> RegionMap;
...
class CC_EXPORT Layer : public base::RefCounted<Layer> {
 public:
  ...
  void SetTouchEventHandlerRegion(const RegionMap& touch_event_handler_region);
  const RegionMap& touch_event_handler_region() const {
  ...
  Region CompositeRegion(const RegionMap&) const;
 ...
 private:
  ...
  struct Inputs {
    ...
    RegionMap touch_event_handler_region;
