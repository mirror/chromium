...
class CC_EXPORT Layer : public base::RefCounted<Layer> {
 public:
  ...
  bool scrollable() const { return !inputs_.scroll_container_bounds.IsEmpty(); }
 ...
 private:
  ...
  struct Inputs {
    ...
    // Size of the scroll container that this layer scrolls in. If this is
    // empty the layer will not be scrollable.
