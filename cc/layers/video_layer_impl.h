...
class CC_EXPORT VideoLayerImpl : public LayerImpl {
 public:
  ...
  void DidDraw(viz::ResourceProvider* resource_provider) override;
 ...
 private:
  ...
  // TODO(danakj): Remove these, hide software path inside viz::ResourceProvider
  // and ExternalResource (aka TextureMailbox) classes.
  std::vector<unsigned> software_resources_;
  // Called once for each software resource.
  viz::ReleaseCallbackImpl software_release_callback_;
