...
void PictureLayer::SquashToFirstPictureLayer(
  ...
  fprintf(stderr, "first: %zu\n",
          first_picture_layer->GetDisplayItemList()->op_count());
  ...
  first_flag.setStyle(static_cast<cc::PaintFlags::Style>(SkPaint::kFill_Style));
  first_flag.setColor(SK_ColorGREEN);
  concated_display_list->StartPaint();
  concated_display_list->push<DrawRectOp>(DrawRectOp(first_rect, first_flag));
  ...
  second_flag.setStyle(static_cast<cc::PaintFlags::Style>(SkPaint::kFill_Style));
  second_flag.setColor(SK_ColorRED);
  concated_display_list->StartPaint();
  concated_display_list->push<DrawRectOp>(DrawRectOp(second_rect, second_flag));
  concated_display_list->FinishPaint();


  fprintf(stderr, "concat: %zu\n", concated_display_list->op_count());
