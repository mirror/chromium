...
class PendingLayerImplScrollTest : public LayerImplScrollTest {
 public:
  PendingLayerImplScrollTest() : LayerImplScrollTest(settings()) {}
...
TEST_F(PendingLayerImplScrollTest, PushPropertiesToMirrorsCurrentScrollOffset) {
  gfx::ScrollOffset scroll_offset(10, 5);
