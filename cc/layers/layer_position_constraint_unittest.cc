...
class LayerPositionConstraintTest : public testing::Test {
 public:
  ...
  void CreateTreeForTest() {
    ...
    scroll_layer_->SetScrollContainerBounds(clip_bounds);
    ...
    child_->SetScrollContainerBounds(clip_bounds);
    grand_child_->SetElementId(
        LayerIdToElementIdForTesting(grand_child_->id()));
    grand_child_->SetScrollContainerBounds(clip_bounds);
...
TEST_F(LayerPositionConstraintTest,
  ...
  great_grand_child_->SetScrollContainerBounds(gfx::Size(100, 100));
