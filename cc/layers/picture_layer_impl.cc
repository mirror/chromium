...
// If the visible rect is scrolled past the offset threshold, append quads will
// shift the quads up and adjust the shared quad state to avoid floating point
// precision problems in the renderer.
