...
class FakePictureLayerImplForRenderSurfaceTest : public FakePictureLayerImpl {
 public:
  ...
  void SetExpectedQuadRects(std::vector<gfx::Rect>* quad_rects) {
