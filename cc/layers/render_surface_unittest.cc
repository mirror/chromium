 ...
 public:
  ...
  void AppendQuads(RenderPass* render_pass,
    ...
    PopulateScaledSharedQuadState(shared_quad_state, max_contents_scale,
                                  max_contents_scale);
    gfx::Rect rect1(0, 0, 100, 100), rect2(100, 0, 100, 100);
    TileDrawQuad* one = render_pass->CreateAndAppendDrawQuad<TileDrawQuad>();
    TileDrawQuad* two = render_pass->CreateAndAppendDrawQuad<TileDrawQuad>();
    one->SetNew(shared_quad_state, rect1, rect1, rect1, 0, gfx::RectF(rect1),
                gfx::Size(200, 100), false, false);
    two->SetNew(shared_quad_state, rect2, rect2, rect2, 0, gfx::RectF(rect2),
                gfx::Size(200, 100), false, false);
  }
...
TEST(RenderSurfaceTest, SanityCheckSurfaceCreatesCorrectRenderPassDrawQuads) {
  FakeImplTaskRunnerProvider task_runner_provider;
  TestTaskGraphRunner task_graph_runner;
  std::unique_ptr<LayerTreeFrameSink> layer_tree_frame_sink =
      FakeLayerTreeFrameSink::Create3d();
