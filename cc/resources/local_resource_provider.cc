...
LocalResourceProvider::ScopedLocalReadGL::ScopedLocalReadGL(
...
LocalResourceProvider::ScopedLocalReadGL::~ScopedLocalReadGL() = default;

LocalResourceProvider::ScopedLocalSamplerGL::ScopedLocalSamplerGL(
    LocalResourceProvider* resource_provider,
    viz::ResourceId resource_id,
    GLenum filter)
...
LocalResourceProvider::ScopedLocalSamplerGL::~ScopedLocalSamplerGL() = default;

LocalResourceProvider::ScopedLocalWriteGL::ScopedLocalWriteGL(
    LocalResourceProvider* resource_provider,
    viz::ResourceId resource_id)
...
void LocalResourceProvider::ScopedLocalWriteGL::AllocateGpuMemoryBuffer(
    GLES2Interface* gl,
    GLuint texture_id) {
  DCHECK(resource_);
...
void LocalResourceProvider::ScopedLocalWriteGL::AllocateTexture(
    GLES2Interface* gl,
    GLuint texture_id) {
  DCHECK(gl);
  DCHECK(resource_);
