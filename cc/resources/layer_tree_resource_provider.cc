...
viz::ResourceId LayerTreeResourceProvider::CreateResourceFromTextureMailbox(
  ...
  viz::internal::RemotableResource* resource = InsertResource(
      ...
      viz::internal::RemotableResource(
          mailbox.size_in_pixels(), viz::internal::RemotableResource::EXTERNAL,
          viz::RemotableResourceTextureHint::kDefault,
          mailbox.IsTexture() ? viz::RemotableResourceType::kTexture
                              : viz::RemotableResourceType::kBitmap,
...
LayerTreeResourceProvider::ScopedWriteLockGpuMemoryBuffer ::
  ...
  DCHECK_EQ(resource->type, viz::RemotableResourceType::kGpuMemoryBuffer);
  size_ = resource->size;
