...
class CC_EXPORT LocalResourceProvider : public ResourceProvider {
 public:
  ...
  class CC_EXPORT ScopedLocalReadGL {
   public:
    ScopedLocalReadGL(LocalResourceProvider* resource_provider,
  ...
  class CC_EXPORT ScopedLocalSamplerGL {
   public:
    ScopedLocalSamplerGL(LocalResourceProvider* resource_provider,
                         viz::ResourceId resource_id,
                         GLenum filter);
    ScopedLocalSamplerGL(LocalResourceProvider* resource_provider,
                         viz::ResourceId resource_id,
   ...
   private:
    const ScopedLocalReadGL resource_lock_;
    const GLenum unit_;
    const GLenum target_;

    DISALLOW_COPY_AND_ASSIGN(ScopedLocalSamplerGL);
  };
  ...
  class CC_EXPORT ScopedLocalWriteGL {
   public:
    ScopedLocalWriteGL(LocalResourceProvider* resource_provider,
                       viz::ResourceId resource_id);
    ~ScopedLocalWriteGL();
