...
class CC_EXPORT Resource {
 ...
 private:
  ...
  // local_ means resource is used inside the same GL context and will not be
  // sent into another process.
process. So no need to create fence&mailbox for local resource.
  bool local_;
