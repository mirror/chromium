...
class CC_EXPORT DisplayResourceProvider : public ResourceProvider {
 public:
  ...
  void SetReadLockFence(viz::RemotableResourceFence* fence) {
 ...
 private:
  ...
  const viz::internal::RemotableResource* LockForRead(viz::ResourceId id);
  ...
  scoped_refptr<viz::RemotableResourceFence> current_read_lock_fence_;
  ChildMap children_;
