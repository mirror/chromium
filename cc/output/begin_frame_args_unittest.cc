...
TEST(BeginFrameArgsTest, Helpers) {
  ...
  EXPECT_EQ(k1Usec, args2.frame_time - base::TimeTicks());
  EXPECT_EQ(k2Usec, args2.deadline - base::TimeTicks());
  ...
  EXPECT_EQ(k1Usec, args4.frame_time - base::TimeTicks());
  EXPECT_EQ(k2Usec, args4.deadline - base::TimeTicks());
...
TEST(BeginFrameArgsTest, Create) {
  ...
  EXPECT_EQ(k1Usec, args2.frame_time - base::TimeTicks()) << args2;
  EXPECT_EQ(k2Usec, args2.deadline - base::TimeTicks()) << args2;
