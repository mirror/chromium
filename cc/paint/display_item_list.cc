...
void DisplayItemList::PrintDisplayList() {
  for (auto* op : PaintOpBuffer::Iterator(&paint_op_buffer_)) {
    ...
    switch (type) {
      case PaintOpType::DrawRect: {
        ...
        fprintf(stderr, "%f %f %f %f %p\n", rect.fLeft, rect.fRight,
                rect.fTop, rect.fBottom, static_cast<DrawRectOp*>(op));
        fprintf(stderr, "%d %d %d %d %d\n", SkColorGetA(flag.getColor()),
                SkColorGetR(flag.getColor()), SkColorGetG(flag.getColor()),
                SkColorGetB(flag.getColor()),
                static_cast<DrawRectOp*>(op)->IsValid()); 
        break;
      }
      default:
        break;
          ...
          switch (record_type) {
            ...
            case PaintOpType::DrawRect: {
              ...
              fprintf(stderr, "%f %f %f %f\n", rect.fLeft,
                      ...
                      rect.fTop,
                      rect.fBottom);
              paint_op_buffer_.push<DrawRectOp>(
                  *(static_cast<DrawRectOp*>(op)));
