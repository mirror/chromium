...
// PaintImageGenerator is the cc/paint equivalent of the SkImageGenerator
// interface for creating a PaintImage which can lazily generate its content.
// For detailed comments on the interface methods, see
