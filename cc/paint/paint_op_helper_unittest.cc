...
TEST(PaintOpHelper, ClipRectToString) {
  ClipRectOp op(SkRect::MakeXYWH(10.1, 20.2, 30.3, 40.4), SkClipOp::kIntersect,
                false);
...
TEST(PaintOpHelper, DrawImageToString) {
  DrawImageOp op(PaintImage(), 10.5, 20.3, nullptr);
...
TEST(PaintOpHelper, DrawLineToString) {
  DrawLineOp op(1.1, 2.2, 3.3, 4.4, PaintFlags());
