...
class DiscardableImageGenerator {
 public:
  ...
  void RecordColorHistograms() const {
    if (color_stats_total_image_count_ > 0) {
      size_t srgb_image_percent = (100 * color_stats_srgb_image_count_) /
  ...
  bool has_non_srgb_lazy_images() const {
 ...
 private:
  ...
  size_t color_stats_srgb_image_count_ = 0;
  size_t color_stats_total_image_count_ = 0;
  base::CheckedNumeric<int> color_stats_srgb_pixel_count_ = 0;
  base::CheckedNumeric<int> color_stats_total_pixel_count_ = 0;
};
