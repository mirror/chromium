...
TEST_F(DiscardableImageMapTest, GathersAnimatedImages) {
  ...
  PaintImage animated_loop_none = CreateAnimatedImage(
      image_size, {FrameMetadata()}, PaintImage::RepetitionPolicy::kLoopNone);
  ...
  EXPECT_EQ(animated_images[0], animation_loop_infinite);
}
