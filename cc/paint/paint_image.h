...
class CC_PAINT_EXPORT PaintImage {
 public:
  ...
  enum class DecodingMode {
    ...
    // Its preferred to display this image synchronously with the rest of the
    // content updates, ignoring any heuristics.
    kSync,

    // Async is preferred. The compositor may decode async if it meets the
    // heuristics
    // used to avoid flickering (for instance vetoing of multipart response,
    // animated, partially loaded images) and would be performant. See
