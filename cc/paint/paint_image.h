...
class CC_PAINT_EXPORT PaintImage {
 public:
  ...
  static const size_t kDefaultFrameIndex = 0u;
 ...
 private:
  ...
  // An incrementing counter maintained by the painter to indicate if this
  // animation should be reset in the compositor.
