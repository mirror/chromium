...
class CC_PAINT_EXPORT SkiaPaintImageGenerator final : public SkImageGenerator {
 public:
  // This is required only be the DecodingImageGenerator in blink for caching
  // of animated image frames.
  // TODO(khushalsagar): Replace with an id based on [paint_image_id,
  // frame_index, generator_id] to uniquely identify image frames.
