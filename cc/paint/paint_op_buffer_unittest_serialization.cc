  ...
  void PushTestOps(PaintOpType type) {
    switch (type) {
      case PaintOpType::Annotate:
        POBTest::PushAnnotateOps(&buffer_);
        break;
      case PaintOpType::ClipPath:
        POBTest::PushClipPathOps(&buffer_);
        break;
      case PaintOpType::ClipRect:
        POBTest::PushClipRectOps(&buffer_);
        break;
      case PaintOpType::ClipRRect:
        POBTest::PushClipRRectOps(&buffer_);
        break;
      case PaintOpType::Concat:
        POBTest::PushConcatOps(&buffer_);
        break;
      case PaintOpType::DrawArc:
        POBTest::PushDrawArcOps(&buffer_);
        break;
      case PaintOpType::DrawCircle:
        POBTest::PushDrawCircleOps(&buffer_);
        break;
      case PaintOpType::DrawColor:
        POBTest::PushDrawColorOps(&buffer_);
        break;
      case PaintOpType::DrawDRRect:
        POBTest::PushDrawDRRectOps(&buffer_);
        break;
      case PaintOpType::DrawImage:
        POBTest::PushDrawImageOps(&buffer_);
        break;
      case PaintOpType::DrawImageRect:
        POBTest::PushDrawImageRectOps(&buffer_);
        break;
      case PaintOpType::DrawIRect:
        POBTest::PushDrawIRectOps(&buffer_);
        break;
      case PaintOpType::DrawLine:
        POBTest::PushDrawLineOps(&buffer_);
        break;
      case PaintOpType::DrawOval:
        POBTest::PushDrawOvalOps(&buffer_);
        break;
      case PaintOpType::DrawPath:
        POBTest::PushDrawPathOps(&buffer_);
        break;
      case PaintOpType::DrawPosText:
        POBTest::PushDrawPosTextOps(&buffer_);
        break;
      case PaintOpType::DrawRecord:
        // Not supported.
        break;
      case PaintOpType::DrawRect:
        POBTest::PushDrawRectOps(&buffer_);
        break;
      case PaintOpType::DrawRRect:
        POBTest::PushDrawRRectOps(&buffer_);
        break;
      case PaintOpType::DrawText:
        POBTest::PushDrawTextOps(&buffer_);
        break;
      case PaintOpType::DrawTextBlob:
        POBTest::PushDrawTextBlobOps(&buffer_);
        break;
      case PaintOpType::Noop:
        POBTest::PushNoopOps(&buffer_);
        break;
      case PaintOpType::Restore:
        POBTest::PushRestoreOps(&buffer_);
        break;
      case PaintOpType::Rotate:
        POBTest::PushRotateOps(&buffer_);
        break;
      case PaintOpType::Save:
        POBTest::PushSaveOps(&buffer_);
        break;
      case PaintOpType::SaveLayer:
        POBTest::PushSaveLayerOps(&buffer_);
        break;
      case PaintOpType::SaveLayerAlpha:
        POBTest::PushSaveLayerAlphaOps(&buffer_);
        break;
      case PaintOpType::Scale:
        POBTest::PushScaleOps(&buffer_);
        break;
      case PaintOpType::SetMatrix:
        POBTest::PushSetMatrixOps(&buffer_);
        break;
      case PaintOpType::Translate:
        POBTest::PushTranslateOps(&buffer_);
        break;
    }
  }
...
TEST_P(PaintOpSerializationTest, SmokeTest) {
  ...
  for (auto* base_written :
    ...
    POBTest::ExpectOpsEqual(*iter, base_written);
    ++iter;
    ++i;
  }
...
TEST(PaintOpBufferTest, ValidateSkClip) {
  ...
  const auto& test_rects = POBTest::TestRects();
  const auto& test_rrects = POBTest::TestRRects();
...
TEST(PaintOpBufferTest, ValidateSkBlendMode) {
  ...
  const auto& test_flags = POBTest::TestFlags();
  const auto& test_rects = POBTest::TestRects();
