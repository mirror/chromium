...
class CC_PAINT_EXPORT LightingDistantPaintFilter final : public PaintFilter {
 public:
  ...
  DEFINE_PAINT_FILTER_CAST(LightingDistantPaintFilter, Type::kLightingDistant)
...
class CC_PAINT_EXPORT LightingPointPaintFilter final : public PaintFilter {
 public:
  ...
  DEFINE_PAINT_FILTER_CAST(LightingPointPaintFilter, Type::kLightingPoint)
...
class CC_PAINT_EXPORT LightingSpotPaintFilter final : public PaintFilter {
 public:
  ...
  DEFINE_PAINT_FILTER_CAST(LightingSpotPaintFilter, Type::kLightingSpot)
