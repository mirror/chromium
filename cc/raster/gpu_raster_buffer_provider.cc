...
void GpuRasterBufferProvider::RasterBufferImpl::Playback(
  ...
  // The |sync_token_| here was created on the compositor thread. Returned back
  // is another SyncToken generated on the worker thread to synchronize with
  // after the raster is complete.
