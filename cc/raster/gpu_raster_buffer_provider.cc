...

  {
    ...
    if (!unpremultiply_and_dither) {
      ...
      scoped_dither_surface.emplace(
          ...
          resource_lock->size(), use_distance_field_text,
          playback_settings.use_lcd_text, msaa_sample_count);
...
GpuRasterBufferProvider::GpuRasterBufferProvider(
    ...
    bool use_unpremultiply_and_dither_copy)
    : compositor_context_provider_(compositor_context_provider),
      ...
      use_unpremultiply_and_dither_copy_(use_unpremultiply_and_dither_copy) {
...
bool GpuRasterBufferProvider::ShouldUnpremultiplyAndDitherResource(
  ...
  if (!use_unpremultiply_and_dither_copy_)
    return false;
