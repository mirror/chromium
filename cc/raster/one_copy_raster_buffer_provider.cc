...
void OneCopyRasterBufferProvider::RasterBufferImpl::Playback(
  ...
  // after the raster and upload are complete.
  sync_token_ = client_->PlaybackAndCopyOnWorkerThread(
      mailbox_, sync_token_, raster_source, raster_full_rect, raster_dirty_rect,
      transform, resource_size_, resource_format_, color_space_,
...
gpu::SyncToken OneCopyRasterBufferProvider::PlaybackAndCopyOnWorkerThread(
  ...
  gpu::SyncToken sync_token_after_upload =
      CopyOnWorkerThread(staging_buffer.get(), raster_source, raster_full_rect,
                         mailbox, sync_token);
...
gpu::SyncToken OneCopyRasterBufferProvider::CopyOnWorkerThread(
  ...
  // Wait on the sync token that was created on the compositor thread after
