...
void OneCopyRasterBufferProvider::RasterBufferImpl::Playback(
  ...
  sync_token_ = client_->PlaybackAndCopyOnWorkerThread(
      ...
      mailbox_texture_storage_allocated_, sync_token_, raster_source,
      raster_full_rect, raster_dirty_rect, transform, resource_size_,
      resource_format_, color_space_, playback_settings, previous_content_id_,
      new_content_id);
