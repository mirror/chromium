...
class CC_EXPORT CompositorTimingHistory {
 ...
 protected:
  ...
  base::TimeDelta composited_animations_draw_interval_for_testing_;
  base::TimeDelta main_thread_animations_draw_interval_for_testing_;
  base::TimeDelta
      main_thread_compositable_animations_draw_interval_for_testing_;
