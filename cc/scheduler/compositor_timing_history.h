...
class CC_EXPORT CompositorTimingHistory {
 ...
 protected:
  ...
  // The |new_active_tree_draw_end_time_prev_| is set when it is committing
  // continuously. This variable is similar to that, but doesn't require to be
  // comitting continuously.
  base::TimeTicks draw_end_time_prev_no_committing_continuously_;
