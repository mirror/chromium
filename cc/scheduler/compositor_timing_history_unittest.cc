...
class CompositorTimingHistoryTest : public testing::Test {
 public:
  ...
  void DrawMainFrame(int advance_ms,
                     ...
                     bool current_frame_has_raf = false) {
    ...
    timing_history_.DidDraw(
        true, Now(), composited_animations_count, main_thread_animations_count,
        main_thread_compositable_animations_count, current_frame_has_raf);
  }
