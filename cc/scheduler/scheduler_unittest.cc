 ...
 public:
  SchedulerTest()
      : now_src_(new base::SimpleTestTickClock()),
        task_runner_(new viz::OrderedSimpleTaskRunner(now_src_.get(), true)),
 ...
 protected:
  TestScheduler* CreateScheduler(BeginFrameSourceType bfs_type) {
    ...
    unthrottled_frame_source_.reset(new viz::BackToBackBeginFrameSource(
        base::MakeUnique<viz::TestDelayBasedTimeSource>(now_src_.get(),
                                                        task_runner_.get())));
  ...
  viz::OrderedSimpleTaskRunner& task_runner() { return *task_runner_; }
