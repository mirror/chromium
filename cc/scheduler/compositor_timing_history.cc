...
void CompositorTimingHistory::DidDraw(
  ...
  if (used_new_active_tree) {
    ...
    bool current_frame_had_visual_update =
        main_thread_animations_count > 0 || current_frame_has_raf;
    bool previous_frame_had_visual_update =
        previous_frame_had_main_thread_animations_ || previous_frame_had_raf_;
    if (current_frame_had_visual_update && previous_frame_had_visual_update) {
