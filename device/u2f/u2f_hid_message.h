...
class U2FHidMessage {
 public:
  ...
  std::list<std::unique_ptr<U2FHidPacket>>::const_iterator begin() const {
    return packets_.cbegin();
  }
  std::list<std::unique_ptr<U2FHidPacket>>::const_iterator end() const {
 ...
 private:
  ...
  std::list<std::unique_ptr<U2FHidPacket>> packets_;
