...
void U2fHidDevice::Transition(std::unique_ptr<U2fApduCommand> command,
  ...
  switch (state_) {
    ...
    case State::IDLE: {
      state_ = State::BUSY;
      std::unique_ptr<U2FHidMessage> msg =
          U2FHidMessage::Create(channel_id_, CTAPHIDDeviceCommand::kCtapHidMsg,
...
void U2fHidDevice::AllocateChannel(std::unique_ptr<U2fApduCommand> command,
  ...
  std::unique_ptr<U2FHidMessage> message = U2FHidMessage::Create(
...
void U2fHidDevice::WriteMessage(std::unique_ptr<U2FHidMessage> message,
...
void U2fHidDevice::PacketWritten(std::unique_ptr<U2FHidMessage> message,
                                 bool response_expected,
                                 U2fHidMessageCallback callback,
                                 bool success) {
...
void U2fHidDevice::OnRead(U2fHidMessageCallback callback,
  ...
  std::unique_ptr<U2FHidMessage> read_message =
      U2FHidMessage::CreateFromSerializedData(*buf);
...
void U2fHidDevice::TryWink(WinkCallback callback) {
  ...
  std::unique_ptr<U2FHidMessage> wink_message = U2FHidMessage::Create(
