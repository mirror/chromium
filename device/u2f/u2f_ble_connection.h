...
class U2fBleConnection : public BluetoothAdapter::Observer {
 public:
  ...
  using ControlPointLengthCallback = base::OnceCallback<void(uint16_t)>;
 ...
 private:
  ...
  std::string address_;
  base::RepeatingCallback<ConnectCallback::RunType> connect_callback_;
  ...
  BluetoothRemoteGattCharacteristic* control_point_length_ = nullptr;
  BluetoothRemoteGattCharacteristic* control_point_ = nullptr;
  BluetoothRemoteGattCharacteristic* status_ = nullptr;
  BluetoothRemoteGattCharacteristic* service_revision_ = nullptr;
  BluetoothRemoteGattCharacteristic* service_revision_bitfield_ = nullptr;
