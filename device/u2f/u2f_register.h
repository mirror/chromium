...
class U2fRegister : public U2fRequest {
 ...
 private:
  ...
  // Returns whether the current_device_ has been checked for duplicate
  // registration for all key handles provided in exclude list.
  ...
  // by the exclude list.
  std::unordered_set<std::string> checked_device_id_list_;
