...
static const std::vector<uint8_t> kTestAttestedData = []() {
...
static const std::vector<uint8_t> kTestAuthenticatorData = []() {
  ...
  test_authenticator_data.insert(test_authenticator_data.end(),
                                 kTestAttestedData.begin(),
                                 kTestAttestedData.end());
  return test_authenticator_data;
}();

static const std::vector<uint8_t> kTestAttestationObject = []() {
  std::vector<uint8_t> test_attestation_object(std::begin(kFormatFidoU2fCBOR),
  ...
  test_attestation_object.insert(test_attestation_object.end(),
                                 kTestAuthenticatorData.begin(),
                                 kTestAuthenticatorData.end());
