...
class U2fApduCommand {
 ...
 private:
  ...
  // Control byte used for check only setting. If set to 0x07 by the client,
  // authenticator simply checks whether the provided key handle was created
  // by itself.
  //
  // See section of 5.1 of https://fidoalliance.org/specs/
  // fido-u2f-v1.0-nfc-bt-amendment-20150514/fido-u2f-raw-message-formats.html.
