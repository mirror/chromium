...
RegisterResponseData::RegisterResponseData(RegisterResponseData&& other)
    : RegisterResponseData(std::move(other.raw_id_),
                           std::move(other.attestation_object_)) {}
/*    : raw_id_(std::move(other.credential_id)),
    attestation_object_(std::move(other.attestation_object_)) {}
*/
RegisterResponseData& RegisterResponseData::operator=(
    RegisterResponseData&& other) {
