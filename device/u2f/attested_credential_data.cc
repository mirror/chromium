...
AttestedCredentialData::AttestedCredentialData(AttestedCredentialData&& other)
    : AttestedCredentialData(std::move(other.aaguid_),
                             std::move(other.credential_id_length_),
                             std::move(other.credential_id_),
                             std::move(other.public_key_)) {}
/*    : aaguid_(std::move(other.aaguid_)),
    credential_id_length_(std::move(other.length_)),
...
AttestedCredentialData& AttestedCredentialData::operator=(
    AttestedCredentialData&& other) {
  aaguid_ = std::move(other.aaguid_);
  credential_id_length_ = std::move(other.credential_id_length_);
  credential_id_ = std::move(other.credential_id_);
  public_key_ = std::move(other.public_key_);
  return *this;
}
