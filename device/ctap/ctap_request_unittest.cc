...
TEST(CTAPDataTest, TestConstructMakeCredentialRequestParam) {
  ...
  CTAPMakeCredentialRequestParam::MakeCredentialRequestBuilder request_builder;
  ...
  base::Optional<CTAPMakeCredentialRequestParam> req =
...
TEST(CTAPDataTest, TestMakeCredentialRequestReturnNullOnInsufficientParams) {
  ...
  CTAPMakeCredentialRequestParam::MakeCredentialRequestBuilder no_rp_builder;
  ...
  CTAPMakeCredentialRequestParam::MakeCredentialRequestBuilder no_user_builder;
  no_rp_builder.set_client_data_hash(client_data_hash_bytes);
...
TEST(CTAPDataTest, TestConstructGetAssertionRequest) {
  ...
  CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder request_builder;
  request_builder.set_client_data_hash(client_data_hash_bytes);
  ...
  base::Optional<CTAPGetAssertionRequestParam> req =
      request_builder.BuildRequest();
  ASSERT_TRUE(req);
  auto serialized_data = req->SerializeToCBOR();
  ASSERT_TRUE(serialized_data);
...
TEST(CTAPDataTest, TestGetAssertuinReturnNullOnInsufficientParams) {
  ...
  CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder no_rp_id_builder;
