...
// are not provided.
class CTAPMakeCredentialRequest : public CTAPData {
 public:
  ...
  base::Optional<std::vector<uint8_t>> SerializeToCBOR() const;
...
// Object that encapsulate request parameters for AuthenticatorGetAssertion as
// specified in the CTAP spec.
class CTAPGetAssertionRequest : public CTAPData {
 public:
