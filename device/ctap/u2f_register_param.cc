...
U2FRegisterParam::U2FRegisterParam(const U2FRegisterParam& that) = default;

U2FRegisterParam& U2FRegisterParam::operator=(U2FRegisterParam&& other) =
    default;

U2FRegisterParam& U2FRegisterParam::operator=(const U2FRegisterParam& other) =
    default;
