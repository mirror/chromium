...
CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    CTAPGetAssertionRequestBuilder() = default;

CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    ~CTAPGetAssertionRequestBuilder() = default;

void CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::set_rp_id(
    std::string rp_id) {
  rp_id_param_ = std::move(rp_id);
};

void CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    set_client_data_hash(std::vector<uint8_t> client_data_hash) {
  client_data_hash_param_ = std::move(client_data_hash);
};

void CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    set_allow_list(std::vector<PublicKeyCredentialDescriptor> allow_list) {
  allow_list_param_ = std::move(allow_list);
};

void CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::set_pin_auth(
    std::vector<uint8_t> pin_auth) {
  pin_auth_param_ = std::move(pin_auth);
};

void CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    set_pin_protocol(uint8_t pin_protocol) {
  pin_protocol_param_ = pin_protocol;
};

bool CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::
    CheckRequiredParameters() {
  return rp_id_param_ && client_data_hash_param_;
};

base::Optional<CTAPGetAssertionRequestParam>
CTAPGetAssertionRequestParam::CTAPGetAssertionRequestBuilder::BuildRequest() {
  if (CheckRequiredParameters()) {
    return CTAPGetAssertionRequestParam(
        std::move(rp_id_param_.value()),
        std::move(client_data_hash_param_.value()),
        std::move(allow_list_param_), std::move(pin_auth_param_),
        pin_protocol_param_);
  }
  return base::nullopt;
};
