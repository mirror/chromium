...
TEST(CTAPResponseTest, TestReadMakeCredentialResponse) {
  ...
  auto make_credential_response =
      response_convertor::ReadCTAPMakeCredentialResponse(
          constants::CTAPDeviceResponseCode::kSuccess, kDeviceResponse);
  ASSERT_TRUE(make_credential_response);
  EXPECT_THAT(make_credential_response->response_code(),
              constants::CTAPDeviceResponseCode::kSuccess);
...
TEST(CTAPResponseTest, TestReadGetAssertionResponse) {
  ...
  auto get_assertion_response =
      response_convertor::ReadCTAPGetAssertionResponse(
          constants::CTAPDeviceResponseCode::kSuccess, kDeviceResponse);
