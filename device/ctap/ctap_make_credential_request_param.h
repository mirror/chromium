...
#ifndef DEVICE_CTAP_CTAP_MAKE_CREDENTIAL_PARAM_H_
#define DEVICE_CTAP_CTAP_MAKE_CREDENTIAL_PARAM_H_
 ...
 public:
  class MakeCredentialRequestBuilder {
   public:
    ...
    base::Optional<CTAPMakeCredentialRequestParam> BuildRequest();
...
#endif  // DEVICE_CTAP_CTAP_MAKE_CREDENTIAL_PARAM_H_
