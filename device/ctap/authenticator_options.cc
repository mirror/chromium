...
AuthenticatorOptions& AuthenticatorOptions::SetPlatformDevice(
    const bool platform_device) {
  platform_device_ = platform_device;
  return *this;
}

AuthenticatorOptions& AuthenticatorOptions::SetRK(const bool rk) {
  rk_ = rk;
  return *this;
}

AuthenticatorOptions& AuthenticatorOptions::SetUV(const bool uv) {
  uv_ = uv;
  return *this;
}

AuthenticatorOptions& AuthenticatorOptions::SetUP(const bool up) {
  up_ = up;
  return *this;
}

AuthenticatorOptions& AuthenticatorOptions::SetClientPin(
    const bool client_pin) {
