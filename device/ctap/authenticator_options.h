...
class AuthenticatorOptions {
 public:
  ...
  AuthenticatorOptions& SetResidentKey(bool rk);
  AuthenticatorOptions& SetUserVerification(bool uv);
  ...
  bool rk() const { return resident_key_; }
  bool uv() const { return user_verification_; }
  bool up() const { return user_presence_; }
