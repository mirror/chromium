...
void CTAPGetAssertionRequest::CTAPGetAssertionRequestBuilder::set_rp_id(
    std::string rp_id) {
  rp_id_param_ = std::move(rp_id);
};

void CTAPGetAssertionRequest::CTAPGetAssertionRequestBuilder::
    set_client_data_hash(std::vector<uint8_t> client_data_hash) {
  client_data_hash_param_ = std::move(client_data_hash);
};

void CTAPGetAssertionRequest::CTAPGetAssertionRequestBuilder::set_allow_list(
    std::vector<PublicKeyCredentialDescriptor> allow_list) {
  allow_list_param_ = std::move(allow_list);
};

void CTAPGetAssertionRequest::CTAPGetAssertionRequestBuilder::set_pin_auth(
    std::vector<uint8_t> pin_auth) {
  pin_auth_param_ = std::move(pin_auth);
};

void CTAPGetAssertionRequest::CTAPGetAssertionRequestBuilder::set_pin_protocol(
