...
class TestVRSystem : public IVRSystem {
 public:
  ...
  void AcknowledgeQuit_Exiting() override { NOTREACHED(); }
...
class TestVRCompositor : public IVRCompositor {
 public:
  ...
  void ClearLastSubmittedFrame() override { NOTREACHED(); }
  ...
  void ShowMirrorWindow() override { NOTREACHED(); }
  ...
  void ForceInterleavedReprojectionOn(bool bOverride) override { NOTREACHED(); }
  void ForceReconnectProcess() override { NOTREACHED(); }
