...
class InputServiceLinux : public device::mojom::InputDeviceManager {
 public:
  ...
  // Create the InputServiceLinux instance by GetInstance(), bind the request.
  static void Create(device::mojom::InputDeviceManagerRequest request);
  ...
  void AddBinding(device::mojom::InputDeviceManagerRequest request);
