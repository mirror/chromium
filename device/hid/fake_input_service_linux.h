...
class FakeInputServiceLinux : public device::mojom::InputDeviceManager {
 public:
  ...
  // device::mojom::InputDeviceManager implementation:
 ...
 private:
  mojo::BindingSet<device::mojom::InputDeviceManager> bindings_;
  mojo::AssociatedInterfacePtrSet<device::mojom::InputDeviceManagerClient>
      clients_;
