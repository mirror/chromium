...
class GamepadDeviceLinux : public AbstractHapticGamepad {
 public:
  ...
  bool IsSameDevice(const UdevGamepad& pad_info);

  // Opens the joydev device node and queries device info.
  bool OpenJoydevNode(const UdevGamepad& pad_info, udev_device* device);
