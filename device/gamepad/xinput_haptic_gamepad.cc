...
XInputHapticGamepad::XInputHapticGamepad(int pad_id,
                                         XInputSetStateFunc xinput_set_state)
    : pad_id_(pad_id), xinput_set_state_(xinput_set_state) {}

XInputHapticGamepad::~XInputHapticGamepad() = default;

void XInputHapticGamepad::SetVibration(double strong_magnitude,
