...
StructTraits<device::mojom::GamepadDataView, device::Gamepad>::id(
  ...
  return ConstCArray<uint16_t>(reinterpret_cast<const uint16_t*>(&r.id[0]),
                               id_length);
}
...
StructTraits<device::mojom::GamepadDataView, device::Gamepad>::mapping(
  ...
  return ConstCArray<uint16_t>(reinterpret_cast<const uint16_t*>(&r.mapping[0]),
                               mapping_length);
}
...
bool StructTraits<device::mojom::GamepadDataView, device::Gamepad>::Read(
  ...
  CArray<uint16_t> mapping(out->mapping);
