...
#include "device/gamepad/xinput_haptic_gamepad.h"
...
class GamepadPlatformDataFetcherWin : public GamepadDataFetcher {
 ...
 private:
  ...
  XInputHapticGamepad::XInputSetStateFunc xinput_set_state_;

  bool xinput_connected_[XUSER_MAX_COUNT];
  std::unique_ptr<XInputHapticGamepad> haptics_[XUSER_MAX_COUNT];
