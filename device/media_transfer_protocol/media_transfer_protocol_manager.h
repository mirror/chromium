...
class MediaTransferProtocolManager {
 public:
  ...
  // The first argument is the returned vector of available MTP storages info.
  ...
  // The first argument is the returned vector of available MTP storage names.
  ...
  class Observer {
   public:
    ...
    virtual void StorageAttached(
        device::mojom::MtpStorageInfo storage_info) = 0;
  ...
  // Adds an observer and return the existing storages.
