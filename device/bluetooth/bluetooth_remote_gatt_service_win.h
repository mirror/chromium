...
class DEVICE_BLUETOOTH_EXPORT BluetoothRemoteGattServiceWin
 ...
 private:
  ...
  // Sends GattServicesDiscovered notification if necessary.
  void NotifyGattServicesDiscoveredIfNecessary();
  ...
  // Flag indicates if service discovered notification has been send out to
  // avoid duplicate notification.
  bool gatt_services_discovered_notified_;
