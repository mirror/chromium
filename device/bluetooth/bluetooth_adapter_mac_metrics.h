...
enum class WebBluetoothMacOSAPIs : int {
  DID_FAIL_TO_CONNECT_TO_PERIPHERAL = 0,
  DID_DISCONNECT_PERIPHERAL,
  DID_DISCOVER_PRIMARY_SERVICES,
  DID_DISCOVER_CHARACTERISTICS,
  DID_UPDATE_VALUE,
  DID_WRITE_VALUE,
  DID_UPDATE_NOTIFICATION_STATE,
  DID_DISCOVER_DESCRIPTORS,
  DID_UPDATE_VALUE_FOR_DESCRIPTOR,
  DID_WRITE_VALUE_FOR_DESCRIPTOR,
};

enum class WebBluetoothMacOSErrors : int {
  UNKNOWN_ERROR_DOMAIN = -1,
  ...
  CBERROR_CONNECTION_TIMEOUT = 1005,
  CBERROR_PERIPHERAL_DISCONNECTED = 1007,
  CBERROR_UUID_NOT_ALLOWED = 1008,
  CBERROR_ALREADY_ADVERTISING = 1010,
  CBERROR_MAX_CONNECTION = 1011,
  CBERROR_MAX = 1999,
  MAX,
};
