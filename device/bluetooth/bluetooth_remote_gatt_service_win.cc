...
BluetoothRemoteGattServiceWin::BluetoothRemoteGattServiceWin(
    ...
    : device_(device),
      ...
      gatt_services_discovered_notified_(false),
...
void BluetoothRemoteGattServiceWin::GattCharacteristicDiscoveryComplete(
  ...
  NotifyGattServicesDiscoveredIfNecessary();
}
...
void BluetoothRemoteGattServiceWin::NotifyGattServicesDiscoveredIfNecessary() {
  if (discovery_completed_included_charateristics_.size() ==
          included_characteristics_.size() &&
      IsDiscoveryComplete() && !gatt_services_discovered_notified_) {
    adapter_->NotifyGattServicesDiscovered(this);
    gatt_services_discovered_notified_ = true;
  }
}
