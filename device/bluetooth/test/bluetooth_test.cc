...
const std::string BluetoothTestBase::kTestDeviceNameU2f = "U2F FakeDevice";
...
const std::string BluetoothTestBase::kTestUUIDU2f =
...
const std::string BluetoothTestBase::kTestUUIDU2fControlPointLength =
