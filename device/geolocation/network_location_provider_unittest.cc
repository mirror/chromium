...
class GeolocationNetworkProviderTest : public testing::Test {
 public:
  ...
  LocationProvider* CreateProvider(bool set_permission_granted) {
    // No URLContextGetter or api key needed: The request within the provider is
    // tested directly using TestURLFetcherFactory.
    LocationProvider* provider =
        new NetworkLocationProvider(nullptr, std::string());
