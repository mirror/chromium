...
class DEVICE_GEOLOCATION_EXPORT LocationArbitrator : public LocationProvider {
 public:
  ...
  // Passing nullptr to |override_location_provider| results in using the
  // default system location provider.
  LocationArbitrator(
      std::unique_ptr<LocationProvider> override_location_provider,
 ...
 private:
  ...
  std::unique_ptr<LocationProvider> override_location_provider_;
