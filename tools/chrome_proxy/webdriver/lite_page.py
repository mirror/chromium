...
class LitePage(IntegrationTest):
  ...
  # of the page and is able to load all resources. This test expects is on
  ...
  # bottom of the page and is able to load all resources. This test expects
  # is on Android because it depends on window size of the browser.
  @AndroidOnly
