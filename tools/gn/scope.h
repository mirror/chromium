...
class Scope {
 public:
  ...
  // set is constructed conservertively, meanining that every file that can
  ...
  void AddRelatedFile(const SourceFile& related_file);
 ...
 private:
  ...
  std::set<const SourceFile> related_files_;
