...
(defvar gn-font-lock-buildfile-fun-keywords
  '("assert" "config" "declare_args" "defined" "exec_script" "foreach"
    ...
    "get_target_outputs" "getenv" "import" "print" "process_file_template"
    "read_file" "rebase_path" "set_default_toolchain" "set_defaults"
    "set_sources_assignment_filter" "split_list" "template" "tool" "toolchain"
    "toolchain_args" "write_file"))
...
(defvar gn-font-lock-var-keywords
  '("all_dependent_configs" "allow_circular_includes_from" "arflags" "args"
    ...
    "code_signing_sources" "complete_static_lib" "configs" "console" "data"
    "data_deps" "defines" "depfile" "deps" "include_dirs" "inputs" "ldflags"
    "lib_dirs" "libs" "output_extension" "output_name" "output_prefix_override"
    "outputs" "precompiled_header" "precompiled_header_type"
    "precompiled_source" "product_type" "public" "public_configs" "public_deps"
