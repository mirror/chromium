...
Scope::Scope(Scope* parent)
    : const_containing_(nullptr),
      ...
      mode_flags_(0),
      item_collector_(nullptr),
      related_files_(parent->related_files_) {}
...
bool Scope::NonRecursiveMergeTo(Scope* dest,
  ...
  // Propogate related files,
  dest->related_files_.insert(related_files_.begin(), related_files_.end());
...
void Scope::AddRelatedFile(const SourceFile& related_file) {
  related_files_.insert(related_file);
}
