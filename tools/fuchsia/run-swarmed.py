...
def _Spawn(args):
  ...
  - --gtest_filter arg, or empty if none.
...
def main():
  ...
  parser.add_argument('--gtest_filter',
                      help='Use the given gtest_filter (default is to use the '
                           'filter file in testing/buildbot/filters if it '
                           'exists')
