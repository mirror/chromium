...
def _GenerateHeaderFileContent(header_filename, namespace, hash_datatype,
  ...
  Args:
    header_filename: filename of the generated header file.
    namespace: namespace to contain generated array.
    hash_datatype: datatype of histogram names' hash.
    histograms_map(Dict[int, str]): dictionary {hash: histogram_name}.
