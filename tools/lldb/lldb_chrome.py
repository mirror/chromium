...
def __lldb_init_module(debugger, dict):
    ...
    debugger.HandleCommand('type summary add --python-function lldb_chrome.GURL_Summary GURL')
...
def GURL_Summary(valobj, dict):
    return valobj.GetValueForExpressionPath(".spec_").GetSummary()
