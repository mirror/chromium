...
class BattOrConnection {
 public:
  ...
  // listener's OnConnectionOpened() when complete. This function must be
  // called before using the BattOrConnection. If the connection is already
  // open, calling this method calls the listener's OnConnectionOpened method.
  virtual void Open() = 0;
