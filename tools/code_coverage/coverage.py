...
"""This script helps to generate code coverage report.
  ...
  url_unittests with only files under url/ and crypto/ are included in the
  report, and all generated artifacts are stored in out/report.
...
def Main():
  ...
  if args.include_paths:
    _AssertPathsExist(args.include_paths)
