...
def aggregate_components_from_owners(root, include_subdirs=False):
  ...
  dir_to_component = {}
  dir_no_component_no_team_by_depth = defaultdict(list)
  ...
  for dirname, _, files in os.walk(root):
    ...
    if owners_file_names:
      ...
      if component:
        ...
        if not team:
          dir_no_component_no_team_by_depth[file_depth].append(owners_rel_path)
  ...
  stats = {'OWNERS-count': num_total,
           ...
           'OWNERS-no-component-no-team-by-depth':
           dir_no_component_no_team_by_depth}
