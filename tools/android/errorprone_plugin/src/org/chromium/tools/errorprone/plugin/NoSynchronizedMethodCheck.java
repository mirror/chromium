...
@BugPattern(name = "NoSynchronizedMethodCheck", category = BugPattern.Category.JDK,
        summary = "Use of synchronized disallowed", severity = BugPattern.SeverityLevel.ERROR,
        linkType = BugPattern.LinkType.CUSTOM,
        link = "https://chromium.googlesource.com/chromium/src/+/master/tools/android/findbugs_plugin/README")
    ...
    public Description matchMethod(MethodTree methodTree, VisitorState visitorState) {
        ...
        return buildDescription(methodTree)
                ...
                .setMessage(String.format(
                        "Used synchronized modifier in method %s", method.getSimpleName()))
                .build();
    }
}
