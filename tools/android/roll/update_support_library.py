...
from pylib.constants import host_paths  # noqa - mute E402 errors from pep8
from pylib.utils import logging_utils  # noqa
from pylib.utils import maven_downloader  # noqa
...
def main():
  ...
  maven_downloader.MavenDownloader().Install(args.target_repo, [
  ...
  ], include_poms=True, sync=args.debug)
