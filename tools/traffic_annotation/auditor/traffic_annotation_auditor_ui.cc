...
int main(int argc, char* argv[]) {
  ...
  base::FilePath xml_filepath =
      source_path.Append(FILE_PATH_LITERAL("chrome"))
          .Append(FILE_PATH_LITERAL("traffic_annotation"))
          .Append(FILE_PATH_LITERAL("annotations_list.xml"));
  if (!TrafficAnnotationExporter().UpdateAnnotationsXML(
          xml_filepath, auditor.extracted_annotations(),
