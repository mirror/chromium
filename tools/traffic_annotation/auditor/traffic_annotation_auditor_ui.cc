...
base::FilePath kAnnotationsXmlPartialPath = base::FilePath(
    FILE_PATH_LITERAL("chrome/traffic_annotation/annotations_list.xml"));
...
int main(int argc, char* argv[]) {
  ...
  if (!TrafficAnnotationExporter().UpdateAnnotationsXML(
          source_path.Append(kAnnotationsXmlPartialPath),
