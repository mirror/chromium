...
class TrafficAnnotationAuditor {
 ...
 private:
  ...
  // For exception types ALL and MISSING, partial path to the file(s) to apply.
  // For DIRECT_ASSIGNMENT case, full_function_name@file_path. e.g., for the
  // function bar in class foo, in file baz.cc, it should be foo::bar@baz.cc.
