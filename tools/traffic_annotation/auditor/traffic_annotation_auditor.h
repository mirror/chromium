...
class CallInstance {
 public:
  ...
  std::string function_context_;

  // Name of the function that may need annotation.
  std::string function_name_;

  // Is function |function_name_| annotated?
  bool is_annotated_;
};
