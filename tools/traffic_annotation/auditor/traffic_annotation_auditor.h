...
class TrafficAnnotationAuditor {
 public:
  ...
  // duplicated. Adds errors to |errors_| and unique id hash codes of duplicate
  // annotations to |annotations_to_be_perged_|.
  ...
  // to |errors| and unique id hash codes of all annotations that have errors
  // or cannot be completed to |annotations_to_be_perged_|.
