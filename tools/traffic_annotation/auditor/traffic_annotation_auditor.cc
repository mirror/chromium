...
bool TrafficAnnotationAuditor::RunClangTool(
  ...
  // If |use_compile_commands| is requested or |filter_files| is false, we do
  // not pass the |safe_list_[ALL]| here as there is now way to pass it to
  // run_tools.py except enumerating all alternatives.
