...
// - Check that functions are ordered
// - Delimit the start of .text
// - Delimit the end of .text
//
// The first and last one require a suitably constructed orderfile, with these
// functions at the beginning and end. The second one doesn't need to be in it.
//
