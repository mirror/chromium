...
class PatchNativeLibraryTestCase(unittest.TestCase):
  _SYMBOL_LINES = """002f7ee0 <_ZN6google8protobuf8internal12_GLOBAL__N_112InitDetectorC2Ev>:
  2f7ee0:       b570            push    {r4, r5, r6, lr}
  2f7ee2:       4e09            ldr     r6, [pc, #36]   ; (2f7f08 <_ZN6google8protobuf8internal12_GLOBAL__N_112InitDetectorC2Ev+0x28>)
  ...
  2f7ef2:       4806            ldr     r0, [pc, #24]   ; (2f7f0c <_ZN6google8protobuf8internal12_GLOBAL__N_112InitDetectorC2Ev+0x2c>)
  2f7ef4:       2101            movs    r1, #1
  2f7ef6:       4478            add     r0, pc
  2f7ef8:       7001            strb    r1, [r0, #0]
  2f7efa:       4630            mov     r0, r6
  2f7efc:       4621            mov     r1, r4
  2f7efe:       f3f3 ef58       blx\t6ebdb0 <_ZNKSt6__ndk110unique_ptrINS_11__hash_nodeINS_17__hash_value_typeIiN4base8FilePathEEEPvEENS_26__hash_map_node_destructorINS_9allocatorIS7_EEEEE3getEv+0x5c>
...
"""
  def testSymbolDataParsing(self):
    ...
    self.assertEquals(
        "_ZN6google8protobuf8internal12_GLOBAL__N_112InitDetectorC2Ev",
        symbol_data.name)
    ...
    self.assertEquals([(
        int("2f7efe", 16), ("_ZNKSt6__ndk110unique_ptrINS_11__hash_nodeINS"
                            "_17__hash_value_typeIiN4base8FilePathEEEPvEENS"
                            "_26__hash_map_node_destructorINS_9allocatorIS7"
                            "_EEEEE3getEv+0x5c"))], symbol_data.blx)
