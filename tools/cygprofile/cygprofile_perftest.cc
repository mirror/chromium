...
void AddEntryCost(int iterations, int symbols) {
  ...
  uintptr_t addresses_count = symbols;
  for (int i = 0; i < iterations; i++) {
    for (uintptr_t address = 0; address < addresses_count; address++) {
  ...
  // Entries clenup, see comment at the beginning of the function.
