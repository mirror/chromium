...
class OffsetOrderfileGenerator(object):
  ...
  the same build.
  """
  def __init__(self, symbol_offset_processor, obj_dir):
    ...
    if obj_dir is not None:
      self._symbol_to_sections = GetSymbolToSectionsMapFromObjectFiles(obj_dir)
    else:
      # Testing use case.
...
def GetSymbolToSectionsMapFromObjectFiles(self, obj_dir):
