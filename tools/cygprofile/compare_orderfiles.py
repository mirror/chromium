...
This shows some statistics about two orderfile, possibly extracted from an
updating commit from the orderfile bot.
"""
...
def ParseOrderfile(filename):
  """Parses an orderfile into a lost of symbols.
