...
def ResolveBlxTargets(symbols_data, native_lib_filename):
  ...
  Args:
    symbols_data: ([SymbolData]) As returned by ParseDump().
    native_lib_filename: (str) Path to the unstripped native library.

  Returns:
    {"blx_target_name": "actual jump target"}
  """
  blx_targets = set()
