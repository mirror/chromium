...
def _process_perf_results(output_json, configuration_name,
  ...
  # file containing the performance results in histogram or dashboard json format
  # and an output.json file containing the json test results for the benchmark.
...
def main():
  ...
  # configuration-name and results-url are set in the json file which is going away
  # tools/perf/core/chromium.perf.fyi.extras.json
