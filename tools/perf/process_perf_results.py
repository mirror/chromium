...
def _upload_perf_results(output_json, jsons_to_upload):
...
def _process_perf_results(output_json, json_files, build_properties):
  ...
  _upload_perf_results(shard_perf_results_list)
  return _merge_json_output(output_json, shard_json_output_list)
...
def main():
  ...
  return _process_perf_results(
      args.output_json, args.jsons_to_merge, args.build_properties)
