...
def _upload_perf_results(jsons_to_upload, name, output_json_file, got_revision_cp,
    build_dir, perf_id, results_url, buildername, buildnumber, got_webrtc_revision,
    got_v8_revision, version, git_revision, output_json_dashboard_url, oauth_token_file,
  ...
  for file_name in jsons_to_upload:
    print upload_perf_dashboard_results.upload_perf_dashboard_results(name, file_name,
        output_json_file, got_revision_cp, build_dir, perf_id, results_url,
        buildername, buildnumber, got_webrtc_revision, got_v8_revision, version,
...
def _process_perf_results(output_json, json_files, configuration_name, results_url,
                          build_properties):
...
def main():
  ...
  return _process_perf_results(
      ...
      args.results_url, args.build_properties)
