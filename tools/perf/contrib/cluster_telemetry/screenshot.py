  ...
  def ValidateAndMeasurePage(self, page, tab, results):
    ...
    if self._dc_detect:
      for i in range(self._dc_extra_screenshots):
        ...
        if not IsPageRenderingStabilized(screenshot, next_screenshot,
          content_pixels, num_total_pixels, self._dc_threshold):
...
def IsPageRenderingStabilized(base_screenshot, next_screenshot, content_pixels,
  num_total_pixels, dynamic_content_threshold):
