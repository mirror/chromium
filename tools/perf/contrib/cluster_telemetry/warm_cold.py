...
class LoadingClusterTelemetryWarmCold(loading._LoadingBase):
  ...
  def AddBenchmarkCommandLineArgs(cls, parser):
    super(LoadingClusterTelemetryWarmCold, cls).AddBenchmarkCommandLineArgs(parser)
  ...
  def CreateStorySet(self, options):
    ...
    return page_set.CTPageSet(
      ...
      cache_temperatures=[cache_temperature_module.COLD, cache_temperature_module.WARM, cache_temperature_module.HOT],
      run_page_interaction_callback=Wait)

  @classmethod
  def Name(cls):
    return 'loading.cluster_telemetry.warm_cold'
