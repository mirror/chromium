...
CLUSTER_TELEMETRY_BENCHMARKS = [
    'skpicture_printer', 'skpicture_printer_ct', 'loading.cluster_telemetry',
    'multipage_skpicture_printer', 'multipage_skpicture_printer_ct',
    'rasterize_and_record_micro_ct', 'repaint_ct',
]
