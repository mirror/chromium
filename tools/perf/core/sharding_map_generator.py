...
def verify(benchmarks, dry_run):
  ...
  # TODO(martiniss): Comment back in below line, and require new benchmark
  # times being added with new benchmarks.
  # return 1 if (new_benchmarks or unused_benchmarks) else 0
  return 1 if unused_benchmarks else 0
