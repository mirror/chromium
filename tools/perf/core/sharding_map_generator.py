...
def regenerate(
    benchmarks, waterfall_configs, dry_run, verbose, buildernames=None):
...
def get_args():
  ...
  parser.add_argument('--builder-names', '-b', action='append', default=None)
  parser.add_argument('--no-dry-run', action='store_true',
                      help='If the current run should be a dry run.')
...
def main(args, benchmarks, configs):
  return regenerate(
      benchmarks, configs, not args.no_dry_run, args.verbose, args.buildernames)
