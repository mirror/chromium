...
def _GetActiveMaster():
  """Replacement for chromium_utils.GetActiveMaster()

  Blocked by crbug.com/801289

  The mastername that currently exists in build properties is the wrong name
  for the perf dashboard.

  Eventually, this will be at build_properties[perf_dashboard_mastername].

  Returns:
    The perf master name
  """
  return "ChromiumPerfFyi"
