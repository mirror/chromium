...
"""Script to generate story_avg_times.json. This file will be used by
sharding_map_generator.py. It is currently not used by anything.
"""
    ...
    for builder in lst:
      ...
      try:
        for tasks in data.values():
          tasks = [t for t in tasks if t.state not in ('EXPIRED', 'BOT_DIED')]
          for task in tasks:
