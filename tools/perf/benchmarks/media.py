...
class _MediaTBMv2Benchmark(perf_benchmark.PerfBenchmark):
  ...
  def CreateCoreTimelineBasedMeasurementOptions(self):
    ...
    # Collect 'playing' and 'ended' events from media element, etc.
    category_filter.AddIncludedCategory('event')

    # Collect 'willPlay' and 'willSeek' events generated by catapult.
    category_filter.AddIncludedCategory('devtools.timeline')

    # Collect events generated by performance.mark method.
