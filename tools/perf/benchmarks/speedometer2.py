...
class _Speedometer2MeasurementBase(legacy_page_test.LegacyPageTest):
  def __init__(self, should_add_total):
    super(_Speedometer2MeasurementBase, self).__init__()
...
class Speedometer2Measurement(_Speedometer2MeasurementBase):
  def __init__(self):
    super(Speedometer2Measurement, self).__init__(should_add_total=True)

class Speedometer2IndividualMeasurement(_Speedometer2MeasurementBase):
  def __init__(self):
