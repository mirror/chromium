...
class _MemorySystemHealthBenchmark(perf_benchmark.PerfBenchmark):
  ...
  def ValueCanBeAddedPredicate(cls, value, is_first_result):
    if 'browser_process:reported_by_os:system_memory:java_heap:proportional_resident_size_avg' in value.name:
      print 'browser_process pss java_heap by os: %.2f MiB' % (float(value.value) / 1024 / 1024)
