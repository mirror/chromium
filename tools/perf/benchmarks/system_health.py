...
class _MemorySystemHealthBenchmark(perf_benchmark.PerfBenchmark):
  ...
  def ValueCanBeAddedPredicate(cls, value, is_first_result):
    if 'renderer_processes:reported_by_chrome:java_heap:allocated_objects_size_avg' in value.name:
      print 'by_chrome:java_heap:allocated_objects: %.2f MiB' % (float(value.value) / 1024 / 1024)
