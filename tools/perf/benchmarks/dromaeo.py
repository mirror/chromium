...
class Dromaeo(press.PressBenchmark):
  name = 'dromaeo'
  stories = [('dromaeo.domcoreattr', 'http://dromaeo.com?dom-attr'),
             ('dromaeo.domcoremodify', 'http://dromaeo.com?dom-modify'),
             ('dromaeo.domcorequery', 'http://dromaeo.com?dom-query'),
             ('dromaeo.domcoretraverse', 'http://dromaeo.com?dom-traverse')]
