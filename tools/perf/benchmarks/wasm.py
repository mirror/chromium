...
class _WasmRuntimeStats(perf_benchmark.PerfBenchmark):
...
class WasmRealWorldRuntimeStats(_WasmRuntimeStats):
  """Runtime Stats benchmark for real world wasm apps."""

  @classmethod
  def Name(cls):
    return 'wasm.runtime_stats.real_world'

  def CreateStorySet(self, options):
    return page_sets.WasmRealWorldPerfStorySet()
