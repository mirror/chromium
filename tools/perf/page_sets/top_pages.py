...
class GoogleDocPage(TopPages):
  ...
  def __init__(self, page_set, name='Docs_(1_open_document_tab)',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class BlogspotPage(TopPages):
  ...
  def __init__(self, page_set, name='Blogger',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class WordpressPage(TopPages):
  ...
  def __init__(self, page_set, name='Wordpress',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class FacebookPage(TopPages):
  ...
  def __init__(self, page_set, name='Facebook',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class WikipediaPage(TopPages):
  ...
  def __init__(self, page_set, name='Wikipedia_(1_tab)',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class TwitterPage(TopPages):
  ...
  def __init__(self, page_set, name='Twitter',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class PinterestPage(TopPages):
  ...
  def __init__(self, page_set, name='Pinterest',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class ESPNPage(TopPages):
  ...
  def __init__(self, page_set, name='ESPN',
               shared_page_state_class=shared_page_state.SharedPageState):
...
class WeatherPage(TopPages):
  ...
  def __init__(self, page_set, name='Weather.com',
               shared_page_state_class=shared_page_state.SharedPageState):
