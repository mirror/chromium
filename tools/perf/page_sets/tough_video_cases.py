...
class NormalPlayPage(ToughVideoCasesPage):
  """A normal play page simply plays the given media until the end."""

  def __init__(self, url, page_set, tags, extra_browser_args=None):
    tags.append('normal_play')
    self.add_browser_metrics = True
    super(NormalPlayPage, self).__init__(
        url, page_set, tags, extra_browser_args=extra_browser_args)
