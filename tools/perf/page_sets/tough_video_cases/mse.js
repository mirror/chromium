...
(() => {
  ...
  function runTest() {
    ...
    // Set up BufferAppenders for source audio and video.
    for (let i=0; i < testParams.media.length; i++) {
      let media_file = testParams.media[i];
    ...
    // wil transition from closed to open, and the sourceopen event will fire.
