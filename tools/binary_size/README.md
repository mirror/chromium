...
These tools currently focus on Android. They somewhat work Linux builds, but not
as well. As for Windows, some great tools already exist and are documented here:
