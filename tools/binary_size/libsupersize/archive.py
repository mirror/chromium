...
# 1: shared .text symbols = 1772874 bytes, file size = 9.43mb (645476 symbols).
# 2: shared .text symbols = 1065654 bytes, file size = 9.58mb (669952 symbols).
# 6: shared .text symbols = 464058 bytes, file size = 10.11mb (782693 symbols).
# 10: shared .text symbols = 365648 bytes, file size = 10.24mb (813758 symbols).
# 20: shared .text symbols = 86202 bytes, file size = 10.38mb (854548 symbols).
# 40: shared .text symbols = 48424 bytes, file size = 10.50mb (890396 symbols).
# 50: shared .text symbols = 41860 bytes, file size = 10.54mb (902304 symbols).
# max: shared .text symbols = 0 bytes, file size = 11.10mb (1235449 symbols).
...
def Run(args, parser):
  ...
  logging.info('Done. File size is %.2fmb.', size_in_mb)
