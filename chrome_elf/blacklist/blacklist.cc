...
blacklist::GenerateCrashDumpFunction g_generate_crashdump_func =
    &NullCrashDumpFunction;
...
void SetCrashdumpFunction(GenerateCrashDumpFunction crashdump_function) {
  if (crashdump_function == nullptr)
    crashdump_function = NullCrashDumpFunction;
  g_generate_crashdump_func = crashdump_function;
}
