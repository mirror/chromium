...
LeakDetector::LeakDetector(BlinkTestRunner* test_runner)
  ...
  previous_result_.number_of_live_script_promises = kInitialNumberOfScriptPromises;
...
void LeakDetector::OnLeakDetectionComplete(
  ...
  if (previous_result_.number_of_live_audio_nodes < result.number_of_live_audio_nodes) {
  ...
  if (previous_result_.number_of_live_documents < result.number_of_live_documents) {
    base::ListValue* list = new base::ListValue();
  ...
  if (previous_result_.number_of_live_resources < result.number_of_live_resources) {
    base::ListValue* list = new base::ListValue();
