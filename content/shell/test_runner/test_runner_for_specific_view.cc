...
void TestRunnerForSpecificView::Reset() {
  ...
  if (web_view() && web_view()->MainFrame()) {
    ...
    web_view()->SetVisibilityState(
        blink::mojom::WebPageVisibilityState::kVisible, true);
...
void TestRunnerForSpecificView::SetPageVisibility(
  ...
  if (new_visibility == "visible")
    web_view()->SetVisibilityState(
        blink::mojom::WebPageVisibilityState::kVisible, false);
  else if (new_visibility == "hidden")
    web_view()->SetVisibilityState(
        blink::mojom::WebPageVisibilityState::kHidden, false);
  else if (new_visibility == "prerender")
    web_view()->SetVisibilityState(
        blink::mojom::WebPageVisibilityState::kPrerender, false);
}
