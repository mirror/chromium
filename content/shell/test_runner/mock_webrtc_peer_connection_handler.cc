 ...
 public:
  ...
  blink::WebVector<std::unique_ptr<blink::WebRTCRtpSource>> GetSources()
    ...
    for (size_t i = 0; i < num_csrcs; ++i) {
      ...
      contributing_sources[i] = base::MakeUnique<MockWebRTCRtpSource>(
    ...
    contributing_sources[num_csrcs] = base::MakeUnique<MockWebRTCRtpSource>(
        blink::WebRTCRtpSourceType::SSRC,
