...
void MockWebRTCPeerConnectionHandler::GetStats(
  ...
  stats.addMember("sequenceUint32", blink::kWebRTCStatsMemberTypeSequenceUint32);
  stats.addMember("sequenceInt64", blink::kWebRTCStatsMemberTypeSequenceInt64);
  stats.addMember("sequenceUint64", blink::kWebRTCStatsMemberTypeSequenceUint64);
  stats.addMember("sequenceDouble", blink::kWebRTCStatsMemberTypeSequenceDouble);
  stats.addMember("sequenceString", blink::kWebRTCStatsMemberTypeSequenceString);
