...
void EventSender::DoDragDrop(const WebDragData& drag_data,
  ...
  WebFloatPoint client_point(event->PositionInWidget());
  WebFloatPoint screen_point(event->PositionInScreen());
...
void EventSender::FinishDragAndDrop(const WebMouseEvent& raw_event,
  ...
  WebFloatPoint client_point(event->PositionInWidget().x,
                             event->PositionInWidget().y);
  WebFloatPoint screen_point(event->PositionInScreen().x,
