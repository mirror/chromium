...
class TestRunnerBindings : public gin::Wrappable<TestRunnerBindings> {
 ...
 private:
  ...
  void SetPrinting();
  void SetPrintingForFrame(const std::string& name);
...
void TestRunnerBindings::SetPrintingForFrame(const std::string& name) {
  if (runner_)
    runner_->SetPrintingForFrame(name);
}
...
void TestRunner::SetPrinting() {
  layout_test_runtime_flags_.set_printing_frame("");
  layout_test_runtime_flags_.set_is_printing(true);
  OnLayoutTestRuntimeFlagsChanged();
}

void TestRunner::SetPrintingForFrame(const std::string& name) {
  layout_test_runtime_flags_.set_printing_frame(name);
  layout_test_runtime_flags_.set_is_printing(true);
  OnLayoutTestRuntimeFlagsChanged();
}
