...
std::string StatsCollectionController::GetBrowserHistogram(
  ...
  content::mojom::RendererHostPtr renderer_host;
  RenderThread::Get()->GetConnector()->BindInterface(
      content::mojom::kBrowserServiceName, &renderer_host);
  renderer_host->GetBrowserHistogram(histogram_name, &histogram_json);
