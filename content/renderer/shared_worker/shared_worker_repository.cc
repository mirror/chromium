...
void SharedWorkerRepository::Connect(
  ...
  mojom::SharedWorkerInfoPtr info(mojom::SharedWorkerInfo::New(
      ...
      static_cast<uint32_t>(content_security_policy_type),  // XXX avoid casts
      static_cast<uint32_t>(creation_address_space),
      static_cast<uint32_t>(creation_context_type), data_saver_enabled));
