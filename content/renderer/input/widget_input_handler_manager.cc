...
void WidgetInputHandlerManager::ObserveGestureEvent(
    const blink::WebGestureEvent& gesture_event,
    const cc::InputHandlerScrollResult& scroll_result) {
  if (!main_thread_task_runner_->BelongsToCurrentThread()) {
    compositor_task_runner_->PostTask(
        FROM_HERE,
        base::BindOnce(&WidgetInputHandlerManager::ObserveGestureEvent, this,
...
void WidgetInputHandlerManager::DispatchEvent(
  ...
  if (has_compositor_) {
    ...
    RunOnMainThread(base::BindOnce(&WidgetInputHandlerManager::HandleInputEvent,
                                   this, std::move(event->web_event),
...
void WidgetInputHandlerManager::BindAssociatedChannel(
  ...
  WidgetInputHandlerImpl* handler = new WidgetInputHandlerImpl(
      this, has_compositor_, main_thread_task_runner_, input_event_queue_,
      render_widget_);
...
void WidgetInputHandlerManager::RunOnMainThread(base::OnceClosure closure) {
