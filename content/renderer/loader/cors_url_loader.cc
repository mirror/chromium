...
ResourceRequestCompletionStatus CreateCompletionStatus(
  ...
  completion_status.cors_error_status =
      static_cast<ResourceRequestCORSErrorStatus>(access_status);
...
void CORSURLLoader::OnReceiveResponse(
  ...
  if (fetch_cors_flag_ &&
    ...
    network::mojom::CORSAccessStatus cors_status = blink::WebCORS::CheckAccess(
