...
#if 0
class WebPackageSubresourceManagerImpl::ResponseLoader
    : public mojom::URLLoader {
 public:
  ResponseLoader(std::uniuqe_ptr<ResponseHandler> response_handler)
      : response_handler_(std::move(response_handler)) {}
  ~ResponseLoader();

  void OnResponse(const ResourceResponseHead& response_head,
 ...
 private:
  ...
  base::WeakPtrFactory<ResponseHandler> weak_factory_;
};
#endif
