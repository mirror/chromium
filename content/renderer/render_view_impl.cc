...
void RenderViewImpl::Initialize(
  ...
  if (params->main_frame_routing_id != MSG_ROUTING_NONE) {
    DCHECK(params->main_frame_interfaces.is_bound());
    main_render_frame_ = RenderFrameImpl::CreateMainFrame(
        this, params->main_frame_routing_id,
        std::move(params->main_frame_interfaces),
        params->main_frame_widget_routing_id, params->hidden, screen_info(),
        compositor_deps_, opener_frame, params->replicated_frame_state);
  }
...
WebView* RenderViewImpl::CreateView(WebLocalFrame* creator,
  ...
  view_params->main_frame_interfaces = std::move(reply->main_frame_interfaces);
