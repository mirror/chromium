...
void RenderFrameProxy::OnIntrinsicSizingOfChildChanged(gfx::SizeF size,
                                                       gfx::SizeF aspect_ratio,
                                                       bool has_width,
                                                       bool has_height) {
  web_frame()->IntrinsicSizingInfoChanged(size, aspect_ratio, has_width,
                                          has_height);
}
...
bool RenderFrameProxy::OnMessageReceived(const IPC::Message& msg) {
  ...
  IPC_BEGIN_MESSAGE_MAP(RenderFrameProxy, msg)
    ...
    IPC_MESSAGE_HANDLER(FrameMsg_IntrinsicSizeOfChildChanged,
                        OnIntrinsicSizingOfChildChanged)
