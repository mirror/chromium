  ...
  void AddStringAttribute(blink::WebAXStringAttribute attribute,
    ...
    switch (attribute) {
      case blink::WebAXStringAttribute::kAriaKeyShortcuts:
        dst_->AddStringAttribute(ax::mojom::StringAttribute::KEY_SHORTCUTS,
                                 value.Utf8());
        break;
      case blink::WebAXStringAttribute::kAriaRoleDescription:
        dst_->AddStringAttribute(ax::mojom::StringAttribute::ROLE_DESCRIPTION,
                                 value.Utf8());
        break;
      default:
        NOTREACHED();
  ...
  void AddObjectAttribute(WebAXObjectAttribute attribute,
    ...
    switch (attribute) {
      ...
      case WebAXObjectAttribute::kAriaDetails:
        dst_->AddIntAttribute(ax::mojom::IntAttribute::DETAILS_ID,
                              value.AxID());
        break;
      case WebAXObjectAttribute::kAriaErrorMessage:
        dst_->AddIntAttribute(ax::mojom::IntAttribute::ERRORMESSAGE_ID,
                              value.AxID());
        break;
      default:
        NOTREACHED();
    ...
    switch (attribute) {
      case WebAXObjectVectorAttribute::kAriaControls:
        AddIntListAttributeFromWebObjects(
            ax::mojom::IntListAttribute::CONTROLS_IDS, value, dst_);
        break;
      case WebAXObjectVectorAttribute::kAriaFlowTo:
        AddIntListAttributeFromWebObjects(
            ax::mojom::IntListAttribute::FLOWTO_IDS, value, dst_);
        break;
      default:
        NOTREACHED();
    }
...
void BlinkAXTreeSource::SerializeNode(WebAXObject src,
  ...
  if (!web_description.IsEmpty()) {
    dst->AddStringAttribute(ax::mojom::StringAttribute::DESCRIPTION,
  ...
  if (src.ValueDescription().length()) {
    dst->AddStringAttribute(ax::mojom::StringAttribute::VALUE,
  ...
  switch (src.Restriction()) {
    case blink::kWebAXRestrictionReadOnly:
      dst->SetRestriction(ax::mojom::Restriction::READ_ONLY);
      break;
    case blink::kWebAXRestrictionDisabled:
      dst->SetRestriction(ax::mojom::Restriction::DISABLED);
      break;
  ...
  if (!src.Url().IsEmpty())
    dst->AddStringAttribute(ax::mojom::StringAttribute::URL,
  ...
  if (accessibility_mode_.has_mode(ui::AXMode::kScreenReader)) {
    ...
    if (!web_placeholder.IsEmpty())
      dst->AddStringAttribute(ax::mojom::StringAttribute::PLACEHOLDER,
                              web_placeholder.Utf8());

    if (dst->role == ax::mojom::Role::COLOR_WELL)
      dst->AddIntAttribute(ax::mojom::IntAttribute::COLOR_VALUE,
                           src.ColorValue());
    ...
    if (dst->role == ax::mojom::Role::LINK) {
      ...
      if (!target.IsNull()) {
        ...
        dst->AddIntAttribute(ax::mojom::IntAttribute::IN_PAGE_LINK_TARGET_ID,
                             target_id);
      }
    }
    ...
    if (dst->role == ax::mojom::Role::RADIO_BUTTON) {
      AddIntListAttributeFromWebObjects(
          ax::mojom::IntListAttribute::RADIO_GROUP_IDS,
          src.RadioButtonsInGroup(), dst);
    }

    // Text attributes.
    if (src.BackgroundColor())
      dst->AddIntAttribute(ax::mojom::IntAttribute::BACKGROUND_COLOR,
                           src.BackgroundColor());
    ...
    if (src.FontSize())
      dst->AddFloatAttribute(ax::mojom::FloatAttribute::FONT_SIZE,
                             src.FontSize());
    ...
    if (dst->role == ax::mojom::Role::INLINE_TEXT_BOX) {
      ...
      dst->AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                               word_starts);
      dst->AddIntListAttribute(ax::mojom::IntListAttribute::WORD_ENDS,
                               word_ends);
    }

    if (src.AccessKey().length()) {
      dst->AddStringAttribute(ax::mojom::StringAttribute::ACCESS_KEY,
                              src.AccessKey().Utf8());
    }
    ...
    if (src.Language().length()) {
      if (parent.IsNull() || parent.Language() != src.Language())
        dst->AddStringAttribute(ax::mojom::StringAttribute::LANGUAGE,
                                src.Language().Utf8());
    }
    ...
    if (src.CanvasHasFallbackContent())
      dst->AddBoolAttribute(ax::mojom::BoolAttribute::CANVAS_HAS_FALLBACK,
                            true);
    ...
    if (src_marker_types.size()) {
      ...
      dst->AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES,
                               marker_types);
      dst->AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_STARTS,
                               marker_starts);
      dst->AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_ENDS,
                               marker_ends);
    }

    if (src.IsInLiveRegion()) {
      dst->AddBoolAttribute(ax::mojom::BoolAttribute::LIVE_ATOMIC,
      ...
      dst->AddStringAttribute(
          ax::mojom::StringAttribute::CONTAINER_LIVE_RELEVANT,
          src.ContainerLiveRegionRelevant().Utf8());
    }

    if (dst->role == ax::mojom::Role::PROGRESS_INDICATOR ||
        dst->role == ax::mojom::Role::METER ||
        dst->role == ax::mojom::Role::SCROLL_BAR ||
        dst->role == ax::mojom::Role::SLIDER ||
        dst->role == ax::mojom::Role::SPIN_BUTTON ||
        (dst->role == ax::mojom::Role::SPLITTER &&
         src.CanSetFocusAttribute())) {
      float value;
      if (src.ValueForRange(&value))
        dst->AddFloatAttribute(ax::mojom::FloatAttribute::VALUE_FOR_RANGE,
                               value);

      float max_value;
      if (src.MaxValueForRange(&max_value)) {
        dst->AddFloatAttribute(ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE,
                               max_value);
      }

      float min_value;
      if (src.MinValueForRange(&min_value)) {
        dst->AddFloatAttribute(ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE,
                               min_value);
      }

      float step_value;
      if (src.StepValueForRange(&step_value)) {
        dst->AddFloatAttribute(ax::mojom::FloatAttribute::STEP_VALUE_FOR_RANGE,
                               step_value);
      }
    }
    ...
    if (is_table_like_role) {
      ...
      if (column_count > 0 && row_count > 0) {
        ...
        dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_COLUMN_COUNT,
                             column_count);
        dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_ROW_COUNT,
                             row_count);
        WebAXObject header = src.HeaderContainerObject();
        if (!header.IsDetached())
          dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_HEADER_ID,
                               header.AxID());
        ...
        dst->AddIntListAttribute(ax::mojom::IntListAttribute::CELL_IDS,
                                 cell_ids);
        dst->AddIntListAttribute(ax::mojom::IntListAttribute::UNIQUE_CELL_IDS,
                                 unique_cell_ids);
      }

      int aria_colcount = src.AriaColumnCount();
      if (aria_colcount)
        dst->AddIntAttribute(ax::mojom::IntAttribute::ARIA_COLUMN_COUNT,
                             aria_colcount);

      int aria_rowcount = src.AriaRowCount();
      if (aria_rowcount)
        dst->AddIntAttribute(ax::mojom::IntAttribute::ARIA_ROW_COUNT,
                             aria_rowcount);
    }

    if (dst->role == ax::mojom::Role::ROW) {
      dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_ROW_INDEX,
                           src.RowIndex());
      WebAXObject header = src.RowHeader();
      if (!header.IsDetached())
        dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_ROW_HEADER_ID,
                             header.AxID());
    }

    if (dst->role == ax::mojom::Role::COLUMN) {
      dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_COLUMN_INDEX,
                           src.ColumnIndex());
      WebAXObject header = src.ColumnHeader();
      if (!header.IsDetached())
        dst->AddIntAttribute(ax::mojom::IntAttribute::TABLE_COLUMN_HEADER_ID,
                             header.AxID());
    }
    ...
    if (dst->role == ax::mojom::Role::CELL ||
      ...
      if (aria_rowindex)
        dst->AddIntAttribute(ax::mojom::IntAttribute::ARIA_CELL_ROW_INDEX,
                             aria_rowindex);
    }
...
// and remove ifdef.
    ...
    if (src.IsEditable()) {
      ...
      if (src.IsControl() && !src.IsRichlyEditable()) {
        ...
        dst->AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START,
                             src.SelectionStart());
        dst->AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_END,
                             src.SelectionEnd());
      }
      ...
      if (src_line_breaks.size()) {
        ...
        dst->AddIntListAttribute(ax::mojom::IntListAttribute::LINE_BREAKS,
                                 line_breaks);
      }
  ...
  if (src.IsScrollableContainer()) {
    ...
    dst->AddIntAttribute(ax::mojom::IntAttribute::SCROLL_X_MIN,
                         minScrollOffset.x());
    dst->AddIntAttribute(ax::mojom::IntAttribute::SCROLL_Y_MIN,
                         minScrollOffset.y());

    const gfx::Point& maxScrollOffset = src.MaximumScrollOffset();
    dst->AddIntAttribute(ax::mojom::IntAttribute::SCROLL_X_MAX,
                         maxScrollOffset.x());
    dst->AddIntAttribute(ax::mojom::IntAttribute::SCROLL_Y_MAX,
                         maxScrollOffset.y());
  }
