...
// Container class accessible from any threads. ThreadSafeScriptContainer stores
// the scripts of a service worker for startup. The IO thread adds scripts to
// the container, and the worker thread takes the scripts.
