...
ControllerServiceWorkerConnector::ControllerServiceWorkerConnector(
  ...
  if (controller_ptr)
    SetControllerInternal(std::move(controller_ptr));
}
...
void ControllerServiceWorkerConnector::ResetControllerConnection(
  ...
  if (controller_ptr) {
    ...
    controller_service_worker_ = nullptr;
...
void ControllerServiceWorkerConnector::SetControllerInternal(
    mojom::ControllerServiceWorkerPtr controller_ptr) {
  DCHECK(controller_ptr);
  state_ = State::kConnected;
