...
class MockServiceWorkerRegistrationObjectHost
 ...
 public:
  MockServiceWorkerRegistrationObjectHost(int64_t registration_id)
  ...
  blink::mojom::ServiceWorkerRegistrationObjectInfoPtr CreateObjectInfo(
      MockServiceWorkerObjectHost* mock_active_worker_object_host,
      MockServiceWorkerObjectHost* mock_waiting_worker_object_host,
      MockServiceWorkerObjectHost* mock_installing_worker_object_host) {
    ...
    info->active = mock_active_worker_object_host->CreateObjectInfo();
    info->waiting = mock_waiting_worker_object_host->CreateObjectInfo();
    info->installing = mock_installing_worker_object_host->CreateObjectInfo();
    return info;
  }
...
TEST_F(ServiceWorkerProviderContextTest, CreateForController) {
  auto mock_active_worker_object_host =
      std::make_unique<MockServiceWorkerObjectHost>(100 /* handle_id */,
                                                    200 /* version_id */);
  auto mock_waiting_worker_object_host =
      std::make_unique<MockServiceWorkerObjectHost>(101 /* handle_id */,
                                                    201 /* version_id */);
  auto mock_installing_worker_object_host =
      std::make_unique<MockServiceWorkerObjectHost>(102 /* handle_id */,
                                                    202 /* version_id */);
  ASSERT_EQ(0, mock_active_worker_object_host->GetBindingCount());
  ASSERT_EQ(0, mock_waiting_worker_object_host->GetBindingCount());
  ASSERT_EQ(0, mock_installing_worker_object_host->GetBindingCount());
  ...
  blink::mojom::ServiceWorkerRegistrationObjectInfoPtr registration_info =
      mock_registration_object_host->CreateObjectInfo(
          mock_active_worker_object_host.get(),
          mock_waiting_worker_object_host.get(),
          mock_installing_worker_object_host.get());
  ...
  EXPECT_EQ(1, mock_active_worker_object_host->GetBindingCount());
  EXPECT_EQ(1, mock_waiting_worker_object_host->GetBindingCount());
  EXPECT_EQ(1, mock_installing_worker_object_host->GetBindingCount());
  ...
  EXPECT_EQ(0, mock_active_worker_object_host->GetBindingCount());
  EXPECT_EQ(0, mock_waiting_worker_object_host->GetBindingCount());
  EXPECT_EQ(0, mock_installing_worker_object_host->GetBindingCount());
}
...
TEST_F(ServiceWorkerProviderContextTest, SetControllerServiceWorker) {
  ...
  blink::mojom::ServiceWorkerObjectInfoPtr active_worker_info =
      mock_active_worker_object_host->CreateObjectInfo();
  blink::mojom::ServiceWorkerObjectInfoPtr waiting_worker_info =
      mock_waiting_worker_object_host->CreateObjectInfo();
  EXPECT_EQ(1, mock_active_worker_object_host->GetBindingCount());
  EXPECT_EQ(1, mock_waiting_worker_object_host->GetBindingCount());
...
TEST_F(ServiceWorkerProviderContextTest, GetOrAdoptRegistration) {
...

  {
    ...
    // ServiceWorkerObjectHost Mojo connections have been added.
    EXPECT_EQ(2, mock_active_worker_object_host->GetBindingCount());
    EXPECT_EQ(2, mock_waiting_worker_object_host->GetBindingCount());
    EXPECT_EQ(2, mock_installing_worker_object_host->GetBindingCount());
