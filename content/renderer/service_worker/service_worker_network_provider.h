...
class CONTENT_EXPORT ServiceWorkerNetworkProvider {
 public:
  ...
  // |controller_ptr| is the Mojo ptr info that is connected to the
  // service worker that controls this client.
 ...
 private:
  ...
  //
  // For S13nServiceWorker:
  // See the comment at CreateForNavigation() for |controller_ptr| and
