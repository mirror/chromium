...
class CONTENT_EXPORT ServiceWorkerNetworkProvider {
 public:
  ...
  // |default_loader_factory| contains a set of default loader factories for the
  // associated loading context, and is used when we create a subresource loader
  // for controllees. This is non-null only if the provider is created for
  // controllees, and if the loading context, e.g. a frame, provides the loading
  // factory for default loaders.
