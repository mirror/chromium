...
// worker, and lives as long as the service worker is running. This class
// deletes itself when the worker stops (or if start failed). The ownership
// graph is a cycle like this:
