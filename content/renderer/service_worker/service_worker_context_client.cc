...
struct ServiceWorkerContextClient::WorkerContextData {
  ...
  // S13nServiceWorker
  // |controller_impl| should be destructed before |timeout_timer| since the
  ...
  // as a parameter of a pending task pushed after a termination request.
...
void ServiceWorkerContextClient::OnIdleTimeout() {
  ...
  // termination has been requested to the browser process.
