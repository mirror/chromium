...
struct ServiceWorkerContextClient::WorkerContextData {
  ...
  // Pending callbacks for Payment App Invoke.
  std::map<int /* event_id */, payments::mojom::PaymentAppInvokeCallbackPtr>
...
void ServiceWorkerContextClient::RespondToPaymentRequestEvent(
  ...
  const payments::mojom::PaymentAppInvokeCallbackPtr& invoke_callback =
