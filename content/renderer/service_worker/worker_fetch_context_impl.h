...
class WorkerFetchContextImpl : public blink::WebWorkerFetchContext,
 ...
 public:
  ...
  void SetSubresourceFilterInfo(
      std::unique_ptr<blink::WebSubresourceFilterInfo>) override;
 ...
 private:
  ...
  std::unique_ptr<blink::WebSubresourceFilterInfo> subresource_filter_info_;
