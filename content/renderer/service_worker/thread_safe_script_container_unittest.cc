        ...
        base::Bind(
            [](scoped_refptr<ThreadSafeScriptContainer> container,
              ...
              auto data = ThreadSafeScriptContainer::Data::Create(
                  ...
                  blink::WebVector<blink::WebVector<char>>(),
                  blink::WebVector<blink::WebVector<char>>());
              *out_data = data.get();
              container->Add(url, std::move(data));
              waiter->Signal();
            },
    ...
    reader_task_runner_->PostTask(
        ...
        base::Bind(
            [](scoped_refptr<ThreadSafeScriptContainer> container,
              ...
              *out_exists = container->Exists(url);
              waiter->Signal();
            },
