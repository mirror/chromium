...
class MockWebServiceWorkerContextProxy
 ...
 public:
  ...
  void DispatchForeignFetchEvent(
      int fetch_event_id,
      const blink::WebServiceWorkerRequest& web_request) override {
    NOTREACHED();
  };
...
class ServiceWorkerContextClientTest : public testing::Test {
 ...
 protected:
  ...
  void TearDown() override {
    ServiceWorkerContextClient::RemoveThreadLocalPointerForTesting();
  ...
  std::unique_ptr<ServiceWorkerContextClient> CreateContextClient(
    ...
    return std::make_unique<ServiceWorkerContextClient>(
        ...
        instance_host_ptr.PassInterface(),
