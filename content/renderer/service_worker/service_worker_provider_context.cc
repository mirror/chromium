...
void ServiceWorkerProviderContext::SetController(
  ...
  if (ServiceWorkerUtils::IsServicificationEnabled() &&
    ...
    if (should_notify_controllerchange) {
      // |should_notify_controllerchange| indicates whether the web context
      // should observe that the controller changed from what it was before. In
      // that case, reset the factory so that subsequent loads can use the new
      // controller.
...
bool ServiceWorkerProviderContext::CanCreateSubresourceLoaderFactory() {
