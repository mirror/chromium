...
class WebServiceWorkerRegistrationImpl::RegistrationObjectHostCallbacksHolder {
 public:
  RegistrationObjectHostCallbacksHolder() : weak_ptr_factory_(this){};
  ~RegistrationObjectHostCallbacksHolder() = default;
  ...
  WebServiceWorkerRegistrationImpl::ResponseCallback WrapResponseCallback(
    ...
    return base::BindOnce(&RegistrationObjectHostCallbacksHolder::
                              OnRegistrationObjectHostResponse,
  ...
  blink::mojom::ServiceWorkerRegistrationObjectHost::
    ...
    return base::BindOnce(&RegistrationObjectHostCallbacksHolder::
                              OnGetNavigationPreloadStateResponse,
 ...
 private:
  ...
  base::WeakPtrFactory<RegistrationObjectHostCallbacksHolder> weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(RegistrationObjectHostCallbacksHolder);
};
...
WebServiceWorkerRegistrationImpl::WrapResponseCallback(
  ...
  if (!web_callbacks_holder_) {
    web_callbacks_holder_ =
        std::make_unique<RegistrationObjectHostCallbacksHolder>();
  }
