...
// ServiceWorker's WorkerGlobalScope. It is created when the service worker
// begins starting up, and destroyed when the service worker stops. It is
// owned by EmbeddedWorkerInstanceClientImpl's internal WorkerWrapper class.
//
