...
class CONTENT_EXPORT WebServiceWorkerRegistrationImpl
 ...
 private:
  ...
  // |client_context_->controllee_state_->registrations_| for service worker
  // client contexts, the key is |registration_id|. |client_context_| is null
  // for service worker execution contexts.
  base::WeakPtr<ServiceWorkerProviderContext> client_context_;
