...
// WebServiceWorkerRegistration::Handles are still held by Blink, in such case
// this instance will be finally destroyed until Blink destroys all those
...
class CONTENT_EXPORT WebServiceWorkerRegistrationImpl
 ...
 private:
  ...
  //   overridden to |kAttachedAndBound| state soon in the factory methods
  ...
  //   object arrived, |this| is resued to be provided to Blink, in such case
  //   AttachForServiceWorkerGlobalScope() or AttachForServiceWorkerClient()
  //   transits |state_| to |kAttachedAndBound|.
