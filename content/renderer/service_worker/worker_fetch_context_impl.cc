...
void WorkerFetchContextImpl::SetIsDedicatedWorkerOnSubframe(
    bool is_dedicated_worker_on_sub_frame) {
  is_dedicated_worker_on_sub_frame_ = is_dedicated_worker_on_sub_frame;
}

bool WorkerFetchContextImpl::IsDedicatedWorkerOnSubframe() const {
  return is_dedicated_worker_on_sub_frame_;
}
