...
#ifndef CONTENT_RENDERER_NET_CORS_URL_LOADER_FACTORY_H_
#define CONTENT_RENDERER_NET_CORS_URL_LOADER_FACTORY_H_
...
#endif  // CONTENT_RENDERER_NET_CORS_URL_LOADER_FACTORY_H_
