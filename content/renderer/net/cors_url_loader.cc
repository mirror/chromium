...
bool CORSURLLoader::NeedsPreflight() {
  ...
  return !CrossOriginPreflightResultCache::Shared().CanSkipPreflight(
...
void CORSURLLoader::StartPreflightRequest() {
  ...
  // TODO(hintzed): Should referrer and referrer_policy be the same as the
  // original request?
...
void CORSURLLoader::AddOriginHeader(ResourceRequest& request) {
  ...
  // Also, FrameFetchContext does add Origin and Refeerer, which feels kind of
  // messy.
