...
class CONTENT_EXPORT CrossOriginAccessControl {
 public:
  ...
  static AccessStatus CheckAccess(const GURL&,
  ...
  static PreflightStatus CheckPreflight(const scoped_refptr<ResourceResponse>);
  ...
  static PreflightStatus CheckExternalPreflight(
      const scoped_refptr<ResourceResponse>);

  // https://fetch.spec.whatwg.org/#cors-safelisted-method
  // "A CORS-safelisted method is a method that is `GET`, `HEAD`, or `POST`."
  static bool IsCORSSafelistedMethod(const std::string&);
  ...
  static RedirectStatus CheckRedirectLocation(const GURL&);
...
*/
  ...
  static bool IsForbiddenHeaderName(const std::string&);

  static bool IsCORSSafelistedHeader(const std::string&, const std::string&);

 private:
  static bool IsCORSSafelistedContentType(const std::string&);
  static std::string ExtractMIMETypeFromMediaType(const std::string&);
};
/*
