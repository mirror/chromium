...
TEST_F(RenderViewImplTest, OnImeTypeChanged) {
  ...
  LoadHTML(
      ...
      "<input id=\"test2\" type=\"text\" inputmode=\"none\"></input>"
      "<input id=\"test3\" type=\"text\" inputmode=\"text\"></input>"
      "<input id=\"test4\" type=\"text\" inputmode=\"tel\"></input>"
      "<input id=\"test5\" type=\"text\" inputmode=\"url\"></input>"
      "<input id=\"test6\" type=\"text\" inputmode=\"email\"></input>"
      "<input id=\"test7\" type=\"text\" inputmode=\"numeric\"></input>"
      "<input id=\"test8\" type=\"text\" inputmode=\"decimal\"></input>"
      "<input id=\"test9\" type=\"text\" inputmode=\"search\"></input>"
      "<input id=\"test10\" type=\"text\" inputmode=\"unknown\"></input>"
      "</body>"
      "</html>");
  render_thread_->sink().ClearMessages();
  ...
  static const InputModeTestCase kInputModeTestCases[] = {
      ...
      {"test2", ui::TEXT_INPUT_MODE_NONE},
      {"test3", ui::TEXT_INPUT_MODE_TEXT},
      {"test4", ui::TEXT_INPUT_MODE_TEL},
      {"test5", ui::TEXT_INPUT_MODE_URL},
      {"test6", ui::TEXT_INPUT_MODE_EMAIL},
      {"test7", ui::TEXT_INPUT_MODE_NUMERIC},
      {"test8", ui::TEXT_INPUT_MODE_DECIMAL},
      {"test9", ui::TEXT_INPUT_MODE_SEARCH},
      {"test10", ui::TEXT_INPUT_MODE_DEFAULT},
  };
