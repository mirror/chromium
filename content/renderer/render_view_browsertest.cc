...
class RenderViewImplBlinkSettingsTest : public RenderViewImplTest {
 public:
  ...
  blink::WebSettings* settings() {
    return view()->webview()->GetSettings();
  }
...
TEST_F(RenderViewImplTest, DecideNavigationPolicy) {
  ...
  popup_policy_info.default_policy = blink::kWebNavigationPolicyNewForegroundTab;
...
TEST_F(RenderViewImplTest, OnSetTextDirection) {
  ...
  static const struct {
    ...
    { blink::kWebTextDirectionRightToLeft, L"\x000A" L"rtl,rtl" },
    { blink::kWebTextDirectionLeftToRight, L"\x000A" L"ltr,ltr" },
  };
