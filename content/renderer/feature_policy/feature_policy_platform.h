...
#ifndef CONTENT_RENDERER_FEATURE_POLICY_FEATURE_POLICY_PLATFORM_H_
#define CONTENT_RENDERER_FEATURE_POLICY_FEATURE_POLICY_PLATFORM_H_
...
#endif  // CONTENT_RENDERER_FEATURE_POLICY_FEATURE_POLICY_PLATFORM_H_
