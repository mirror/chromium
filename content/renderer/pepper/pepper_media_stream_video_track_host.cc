...
const int32_t kVideoDefaultNumberOfBuffers = 4;
const int32_t kVideoMaxNumberOfBuffers = 8;
...
PepperMediaStreamVideoTrackHost::PepperMediaStreamVideoTrackHost(
    ...
    : PepperMediaStreamTrackHostBase(host, instance, resource),
      track_(track),
      number_of_buffers_(kVideoDefaultNumberOfBuffers),
...
int32_t PepperMediaStreamVideoTrackHost::OnHostMsgConfigure(
  ...
  int32_t buffers = attributes.buffers
                        ? std::min(kVideoMaxNumberOfBuffers, attributes.buffers)
                        : kVideoDefaultNumberOfBuffers;
