...
bool PepperPluginInstanceImpl::GetPrintPresetOptionsFromDocument(
  ...
  preset_options->is_page_size_uniform = PP_ToBool(options.is_page_size_uniform);
  preset_options->uniform_page_size =
...
bool PepperPluginInstanceImpl::CanAccessMainFrame() const {
  ...
  if (!containing_document.GetFrame() || !containing_document.GetFrame()->View() ||
