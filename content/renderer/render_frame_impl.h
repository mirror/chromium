...
class CONTENT_EXPORT RenderFrameImpl
 ...
 private:
  ...
  // for this frame. Used only when the Network Service is enabled, and in that
  // case this always returns non-null. For frames with committed navigations,
  // this bundle is provided by the browser at navigation time. For (child)
  // frames without a committed navigation, the bundle returned here is lazily
  // cloned from the parent's own bundle.
