...
#include "third_party/WebKit/public/platform/modules/presentation/WebScreenAvailability.h"
...
using blink::WebScreenAvailability;
...
class MockPresentationAvailabilityObserver
 ...
 public:
  ...
  MOCK_METHOD1(AvailabilityChanged, void(WebScreenAvailability availability));
...
class PresentationDispatcherTest : public ::testing::Test {
 public:
  ...
  void ChangeURLState(const GURL& url, blink::WebScreenAvailability state) {
    switch (state) {
      ...
      case WebScreenAvailability::kSourceNotCompatible:
        dispatcher_.OnScreenAvailabilityUpdated(
            url, ScreenAvailability::SOURCE_NOT_COMPATIBLE);
        break;
  ...
  void TestGetAvailability(
      ...
      const std::vector<WebScreenAvailability>& states,
...
TEST_F(PresentationDispatcherTest, TestListenForScreenAvailability) {
  ...
  EXPECT_CALL(observer_,
              AvailabilityChanged(WebScreenAvailability::kUnavailable));
  dispatcher_.OnScreenAvailabilityUpdated(url1_,
                                          ScreenAvailability::UNAVAILABLE);
  EXPECT_CALL(observer_,
              AvailabilityChanged(WebScreenAvailability::kSourceNotCompatible));
  dispatcher_.OnScreenAvailabilityUpdated(
      url1_, ScreenAvailability::SOURCE_NOT_COMPATIBLE);
  EXPECT_CALL(observer_,
              AvailabilityChanged(WebScreenAvailability::kAvailable));
  dispatcher_.OnScreenAvailabilityUpdated(url1_, ScreenAvailability::AVAILABLE);
  for (const auto& gurl : gurls_) {
    EXPECT_CALL(presentation_service_,
                StopListeningForScreenAvailability(gurl));
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesAvailable) {
  ...
  TestGetAvailability({url1_}, {WebScreenAvailability::kAvailable},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesNotCompatible) {
  ...
  TestGetAvailability({url1_}, {WebScreenAvailability::kSourceNotCompatible},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesUnavailable) {
  ...
  TestGetAvailability({url1_}, {WebScreenAvailability::kUnavailable},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesUnsupported) {
  ...
  TestGetAvailability({url1_}, {WebScreenAvailability::kUnsupported},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability(
      {url1_, url2_},
      {WebScreenAvailability::kAvailable, WebScreenAvailability::kAvailable},
      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability({url1_, url2_},
                      {WebScreenAvailability::kUnavailable,
                       WebScreenAvailability::kUnavailable},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability({url1_, url2_},
                      {WebScreenAvailability::kSourceNotCompatible,
                       WebScreenAvailability::kSourceNotCompatible},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability({url1_, url2_},
                      {WebScreenAvailability::kUnsupported,
                       WebScreenAvailability::kUnsupported},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  std::vector<WebScreenAvailability> state_seq = {
      WebScreenAvailability::kUnavailable, WebScreenAvailability::kAvailable,
      WebScreenAvailability::kUnavailable};
...
TEST_F(PresentationDispatcherTest, StopListeningListenToEachURLOnce) {
  ...
  // Clean up callbacks.
  ChangeURLState(gurl2_, WebScreenAvailability::kUnavailable);
...
TEST_F(PresentationDispatcherTest,
  ...
  ChangeURLState(gurl1_, WebScreenAvailability::kAvailable);
  run_loop.RunUntilIdle();
  ...
  ChangeURLState(gurl1_, WebScreenAvailability::kUnavailable);
  ...
  ChangeURLState(gurl1_, WebScreenAvailability::kSourceNotCompatible);
...
TEST_F(PresentationDispatcherTest,
  ...
  ChangeURLState(gurl2_, WebScreenAvailability::kAvailable);
  run_loop.RunUntilIdle();
  ...
  base::RunLoop run_loop_3;
  ChangeURLState(gurl2_, WebScreenAvailability::kSourceNotCompatible);
  run_loop_3.RunUntilIdle();
}
