  ...
  void ChangeURLState(const GURL& url, ScreenAvailability state) {
    switch (state) {
      case ScreenAvailability::AVAILABLE:
        ...
        break;
      case ScreenAvailability::SOURCE_NOT_COMPATIBLE:
...
TEST_F(PresentationDispatcherTest, TestListenForScreenAvailability) {
  ...
  EXPECT_CALL(observer_,
              AvailabilityChanged(ScreenAvailability::SOURCE_NOT_COMPATIBLE));
  dispatcher_.OnScreenAvailabilityUpdated(
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesNotCompatible) {
  ...
  TestGetAvailability({url1_}, {ScreenAvailability::SOURCE_NOT_COMPATIBLE},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest, GetAvailabilityOneUrlBecomesUnsupported) {
  ...
  TestGetAvailability({url1_}, {ScreenAvailability::UNSUPPORTED},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability({url1_, url2_},
                      {ScreenAvailability::SOURCE_NOT_COMPATIBLE,
                       ScreenAvailability::SOURCE_NOT_COMPATIBLE},
                      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  TestGetAvailability(
      {url1_, url2_},
      {ScreenAvailability::UNSUPPORTED, ScreenAvailability::UNSUPPORTED},
      mock_callback);
}
...
TEST_F(PresentationDispatcherTest,
  ...
  ChangeURLState(gurl1_, ScreenAvailability::SOURCE_NOT_COMPATIBLE);
...
TEST_F(PresentationDispatcherTest,
  ...
  base::RunLoop run_loop_3;
  ChangeURLState(gurl2_, ScreenAvailability::SOURCE_NOT_COMPATIBLE);
  run_loop_3.RunUntilIdle();
}
