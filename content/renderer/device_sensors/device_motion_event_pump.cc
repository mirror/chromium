...
void DeviceMotionEventPump::DidStartIfPossible() {
  ...
  // During the DeviceMotionEventPump::SensorEntry::OnSensorCreated() callback,
  // it is possible that the |sensor| is already initialized but its
  // |shared_buffer| is not initialized yet. And in that case when
