...
void SynchronousCompositorProxyChromeIPC::DidNotProduceFrame(
    const viz::BeginFrameAck& ack) {
  Send(new SyncCompositorHostMsg_DidNotProduceFrame(routing_id_, ack));
}

void SynchronousCompositorProxyChromeIPC::SetNeedsBeginFrames(
