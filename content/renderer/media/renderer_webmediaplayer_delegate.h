...
class CONTENT_EXPORT RendererWebMediaPlayerDelegate
 ...
 public:
  ...
  void PictureInPicture(viz::FrameSinkId frame_sink_id, const gfx::Size& size) override;
  void PictureInPictureSurfaceIdUpdated(viz::FrameSinkId frame_sink_id,
                                        uint32_t parent_id,
                                        base::UnguessableToken nonce, const gfx::Size& size) override;
