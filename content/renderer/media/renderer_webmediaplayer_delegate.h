...
class CONTENT_EXPORT RendererWebMediaPlayerDelegate
 ...
 public:
  ...
  void PictureInPicture(int delegate_id, viz::FrameSinkId frame_sink_id,
                        const gfx::Size& size) override;
  void PictureInPictureSurfaceIdUpdated(int delegate_id, viz::FrameSinkId frame_sink_id,
                                        uint32_t parent_id,
