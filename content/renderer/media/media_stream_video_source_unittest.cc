...
TEST_F(MediaStreamVideoSourceTest, RotatedSourceDetectionDisabled) {
  // Disable device-rotation heuristic.
  source()->SetDeviceRotationDetectionEnabled(false);
...
TEST_F(MediaStreamVideoSourceTest, RotatedSourceDetectionEnabled) {
  // Enable device-rotation heuristic.
  source()->SetDeviceRotationDetectionEnabled(true);
