...
#include "content/renderer/media/webrtc/two_keys_map.h"
...
class CONTENT_EXPORT WebRtcMediaStreamTrackAdapterMap
 ...
 public:
  ...
  // Gets the new reference to the local track adapter, or null if no such
  ...
  // Gets the new reference to the remote track adapter if it exists and is
