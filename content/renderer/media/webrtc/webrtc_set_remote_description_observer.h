...
// on the main thread. The implementation should process the state changes of
// the SetRemoteDescription by inspecting the updated States.
...
// invokes the WebRtcSetRemoteDescriptionObserverInterface on the main thread
...
class CONTENT_EXPORT WebRtcSetRemoteDescriptionObserverHandler
 ...
 private:
  ...
  void OnFailureOnMainThread(webrtc::RTCError error);
