...
WebRtcMediaStreamAdapter::AdapterRefMap GetAdapterRefMapFromWebRtcStream(
...
WebRtcMediaStreamAdapter::CreateLocalStreamAdapter(
  ...
  return std::unique_ptr<WebRtcMediaStreamAdapter>(
      new LocalWebRtcMediaStreamAdapter(factory, std::move(track_adapter_map),
                                        web_stream));
}
...
WebRtcMediaStreamAdapter::CreateRemoteStreamAdapter(
  ...
  return std::unique_ptr<WebRtcMediaStreamAdapter>(
      new RemoteWebRtcMediaStreamAdapter(std::move(main_thread),
