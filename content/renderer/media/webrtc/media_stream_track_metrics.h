...
class CONTENT_EXPORT MediaStreamTrackMetrics {
 ...
 private:
  ...
  mojom::MediaStreamTrackMetricsHost* GetMediaStreamTrackMetricsHost();

  mojom::MediaStreamTrackMetricsHostAssociatedPtr track_metrics_host_ptr_;
  mojom::MediaStreamTrackMetricsHost* track_metrics_host_;
