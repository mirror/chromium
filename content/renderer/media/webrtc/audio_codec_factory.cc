...
CreateWebrtcAudioEncoderFactory() {
  return webrtc::CreateAudioEncoderFactory<
      webrtc::AudioEncoderG711, webrtc::AudioEncoderG722,
      webrtc::AudioEncoderIsac, NotAdvertisedEncoder<webrtc::AudioEncoderL16>,
...
CreateWebrtcAudioDecoderFactory() {
  return webrtc::CreateAudioDecoderFactory<
      webrtc::AudioDecoderG711, webrtc::AudioDecoderG722,
      webrtc::AudioDecoderIsac, NotAdvertisedDecoder<webrtc::AudioDecoderL16>,
