...
class TwoKeysMapTest : public ::testing::Test {
 public:
  ...
  TwoKeysMap<std::string, std::string, MoveOnlyValue> map_;
};

TEST_F(TwoKeysMapTest, ShouldInitiallyBeEmpty) {
...
TEST_F(TwoKeysMapTest, InsertPrimaryShouldAllowLookup) {
...
TEST_F(TwoKeysMapTest, SetSecondaryKeyShouldAllowLookup) {
  map_.Insert("aPrimary", MoveOnlyValue("aValue"));
...
TEST_F(TwoKeysMapTest, EraseByPrimaryShouldRemoveElement) {
  map_.Insert("aPrimary", MoveOnlyValue("aValue"));
  map_.SetSecondaryKey("aPrimary", "aSecondary");
...
TEST_F(TwoKeysMapTest, EraseBySecondaryShouldRemoveElement) {
  map_.Insert("aPrimary", MoveOnlyValue("aValue"));
  map_.SetSecondaryKey("aPrimary", "aSecondary");
...
TEST_F(TwoKeysMapTest, EraseInvalidElementShouldReturnFalse) {
