...
#ifndef CONTENT_RENDERER_MEDIA_GPU_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
#define CONTENT_RENDERER_MEDIA_GPU_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
...
//
// The GpuVideoAcceleratorFactories can be constructed on any thread,
...
class CONTENT_EXPORT GpuVideoAcceleratorFactories
 ...
 public:
  ...
  ~GpuVideoAcceleratorFactories() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(GpuVideoAcceleratorFactories);
};

}  // namespace content

#endif  // CONTENT_RENDERER_MEDIA_GPU_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
