...
GpuVideoAcceleratorFactoriesImpl::Create(
  ...
  return base::WrapUnique(new GpuVideoAcceleratorFactoriesImpl(
      ...
      native_image_texture_target_list, enable_video_accelerator,
...
GpuVideoAcceleratorFactoriesImpl::GpuVideoAcceleratorFactoriesImpl(
    ...
    : main_thread_task_runner_(main_thread_task_runner),
      ...
      native_image_texture_target_list_(native_image_texture_target_list),
...
unsigned GpuVideoAcceleratorFactoriesImpl::ImageTextureTarget(
    gfx::BufferFormat format) {
  auto it = std::find(native_image_texture_target_list_.begin(),
                      native_image_texture_target_list_.end(),
                      viz::BufferUsageAndFormat(
                          gfx::BufferUsage::GPU_READ_CPU_READ_WRITE, format));
  if (it == native_image_texture_target_list_.end())
