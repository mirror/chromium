...
class MockMediaStreamVideoSource : public MediaStreamVideoSource {
 public:
  ...
  void DisableStopForRestart() { is_unable_to_stop_for_restart_ = true; }

  void DisableRestartAfterStop() { is_unable_to_restart_after_stop_ = true; }
 ...
 private:
  ...
  bool is_unable_to_stop_for_restart_ = false;
  bool is_unable_to_restart_after_stop_ = false;
