...
class CONTENT_EXPORT MediaStreamTrack
 ...
 public:
  ...
  // |callback| is invoked when the track has stopped.
  virtual void StopWithNotification(base::OnceClosure callback) = 0;
  void Stop() { StopWithNotification(base::OnceClosure()); }
