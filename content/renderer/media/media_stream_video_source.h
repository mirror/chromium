...
class CONTENT_EXPORT MediaStreamVideoSource : public MediaStreamSource {
 public:
  ...
  // a successful restart. Code relying on Restart() cannot not assume that
  // new frames are guaranteed to arrive in the new format until the first
  // frame in the new format is received.
