...
TEST(VideoTrackAdapterTest, ZeroInputArea) {
  ...
  VideoTrackAdapter::CalculateTargetSize(
      false /* is_rotated */, gfx::Size(0, 0), gfx::Size(kMaxWidth, kMaxHeight),
  ...
  // Zero width.
  VideoTrackAdapter::CalculateTargetSize(
      false /* is_rotated */, gfx::Size(0, 300),
  ...
  VideoTrackAdapter::CalculateTargetSize(
      false /* is_rotated */, gfx::Size(0, 1000),
      gfx::Size(kMaxWidth, kMaxHeight), kMinAspectRatio, kMaxAspectRatio,
      &desired_size);
  EXPECT_EQ(desired_size.width(), 0);
  EXPECT_EQ(desired_size.height(), kMaxHeight);

  // Zero height.
  VideoTrackAdapter::CalculateTargetSize(
      false /* is_rotated */, gfx::Size(300, 0),
      gfx::Size(kMaxWidth, kMaxHeight), kMinAspectRatio, kMaxAspectRatio,
      &desired_size);
  ...
  VideoTrackAdapter::CalculateTargetSize(
      false /* is_rotated */, gfx::Size(1000, 0),
      gfx::Size(kMaxWidth, kMaxHeight), kMinAspectRatio, kMaxAspectRatio,
      &desired_size);
  EXPECT_EQ(desired_size.width(), kMaxWidth);
  EXPECT_EQ(desired_size.height(), 0);
}
