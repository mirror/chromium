...
void ObtainAndSetContextProvider(
    base::Callback<void(viz::ContextProvider*)> set_context_provider_callback,
    media::GpuVideoAcceleratorFactories* factories) {
  viz::ContextProvider* context_provider = factories->GetMediaContextProvider();
  set_context_provider_callback.Run(context_provider);
}
...
void PostMediaContextProviderToCallback(
  ...
  base::PostTaskAndReplyWithResult(
      ...
      base::Bind(&ObtainAndSetContextProvider, set_context_provider_callback));
}
...
blink::WebMediaPlayer* MediaFactory::CreateMediaPlayer(
  ...
  std::unique_ptr<media::WebMediaPlayerParams> params(
      new media::WebMediaPlayerParams(
          ...
          base::Bind(&PostMediaContextProviderToCallback,
