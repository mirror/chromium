...
void MojoAudioInputIPC::CreateStream(media::AudioInputIPCDelegate* delegate,
  ...
  main_task_runner_->PostTask(
      FROM_HERE,
      base::Bind(stream_creator_, base::Passed(mojo::MakeRequest(&stream_)),
                 session_id, params, automatic_gain_control, total_segments,
                 base::Passed(&client),
                 base::Passed(base::BindOnce(&MojoAudioInputIPC::StreamCreated,
