...
class AudioCaptureCandidates {
 public:
  ...
  const BoolSet& GetBoolSet(BoolConstraint property) const {
  ...
  // Convenience accessors.
  const BoolSet& hotword_enabled_set() const {
 ...
 private:
  ...
  std::array<BoolSet, NUM_BOOL_CONSTRAINTS> bool_sets_;
...
struct BoolSetPropertyEntry {
  BoolSet AudioCaptureCandidates::*bool_set;
