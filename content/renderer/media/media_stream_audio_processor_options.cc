...
AudioProcessingProperties AudioProcessingProperties::FromConstraints(
  ...
  properties.enable_sw_echo_cancellation = audio_constraints.GetEchoCancellationProperty();
  // properties.disable_hw_echo_cancellation is not used when IsOldAudioConstraints() is true.
  properties.goog_audio_mirroring = audio_constraints.GetGoogAudioMirroring();
  properties.goog_auto_gain_control = audio_constraints.GetGoogAutoGainControl();
  properties.goog_experimental_echo_cancellation = audio_constraints.GetGoogExperimentalEchoCancellation();
  properties.goog_typing_noise_detection = audio_constraints.GetGoogTypingNoiseDetection();
  properties.goog_noise_suppression = audio_constraints.GetGoogNoiseSuppression();
  properties.goog_experimental_noise_suppression = audio_constraints.GetGoogExperimentalNoiseSuppression();
  ...
  properties.goog_experimental_auto_gain_control = audio_constraints.GetGoogExperimentalAutoGainControl();
  properties.goog_array_geometry = GetArrayGeometryPreferringConstraints(audio_constraints, input_params);
