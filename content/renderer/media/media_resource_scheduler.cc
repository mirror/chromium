...
class ResourceAwareMediaPlayer : public InterceptingMediaPlayerDelegate,
                                 public PassthroughMediaPlayerClient {
 public:
  ResourceAwareMediaPlayer(WebMediaPlayerClient* real_client)
      : InterceptingMediaPlayerClient(real_client) {}
...
std::unique_ptr<InterceptingMediaPlayerDelegate>
