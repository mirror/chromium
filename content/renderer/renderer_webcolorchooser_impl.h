...
class RendererWebColorChooserImpl : public blink::WebColorChooser,
 ...
 private:
  ...
  content::mojom::ColorChooserFactoryAssociatedPtr color_chooser_factory_;
  content::mojom::ColorChooserPtr color_chooser_;
  mojo::Binding<content::mojom::ColorChooserClient> mojo_client_binding_;
