...
AppCacheDispatcher::AppCacheDispatcher(IPC::Sender* sender,
                                       AppCacheFrontend* frontend)
    : backend_proxy_(sender), frontend_(frontend), binding_(this) {}

AppCacheDispatcher::~AppCacheDispatcher() {}

void AppCacheDispatcher::Bind(mojom::AppCacheRendererRequest request) {
