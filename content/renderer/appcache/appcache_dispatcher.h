...
class AppCacheDispatcher : public mojom::AppCacheRenderer {
 public:
  explicit AppCacheDispatcher(AppCacheFrontend* frontend);
  ~AppCacheDispatcher() override;

  void Bind(mojom::AppCacheRendererRequest request);
 ...
 private:
  ...
  mojo::Binding<mojom::AppCacheRenderer> binding_;
};
