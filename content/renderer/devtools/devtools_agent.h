...
class CONTENT_EXPORT DevToolsAgent : public RenderFrameObserver,
 ...
 private:
  ...
  void AttachDevToolsSession(
      mojom::DevToolsSessionHostAssociatedPtrInfo session_host_info,
      mojom::DevToolsSessionAssociatedRequest session_request,
  ...
  base::flat_map<int, std::unique_ptr<SessionProxy, base::OnTaskRunnerDeleter>> session_proxies_;
  base::flat_map<int, mojom::DevToolsSessionHostAssociatedPtr> session_hosts_;
  bool paused_;
