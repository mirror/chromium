...
void RenderFrameImpl::CommitNavigation(
  ...
  LOG(ERROR) << "RenderFrameImpl::CommitNavigation "
             << common_params.navigation_id;
  last_commit_navigation_id_ = common_params.navigation_id;
...
void RenderFrameImpl::DidStopLoading() {
  ...
  LOG(ERROR) << "FrameHostMsg_DidStopLoading " << last_commit_navigation_id_;
  Send(
      new FrameHostMsg_DidStopLoading(routing_id_, last_commit_navigation_id_));
}
