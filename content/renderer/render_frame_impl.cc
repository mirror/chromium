...
void RenderFrameImpl::DidStartProvisionalLoad(blink::WebDataSource* data_source,
  ...
  // Can be NULL in tests.
  if (render_thread_impl)
    render_thread_impl->GetRendererScheduler()->OnStartProvisionalLoad(this);
...
void RenderFrameImpl::DidFailProvisionalLoad(
  ...
  // Can be NULL in tests.
  if (render_thread_impl)
    render_thread_impl->GetRendererScheduler()->OnDidFailProvisionalLoad(this);
...
void RenderFrameImpl::DidCommitProvisionalLoad(
  ...
  if (render_thread_impl) {  // Can be NULL in tests.
    render_thread_impl->GetRendererScheduler()->OnDidCommitProvisionalLoad(
        this, commit_type == blink::kWebHistoryInertCommit,
