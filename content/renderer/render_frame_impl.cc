...
v8::Local<v8::Object> RenderFrameImpl::GetScriptableObjectForPluginFrame(
    v8::Isolate* isolate,
    blink::WebFrame* frame) {
  DCHECK_EQ(frame->Parent(), GetWebFrame());
  return GetContentClient()->renderer()->GetScriptableObjectForPluginFrame(
      isolate, frame);
}
