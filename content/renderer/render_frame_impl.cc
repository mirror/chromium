...
void RenderFrameImpl::DidCommitProvisionalLoad(
  ...
  NotifyObservers(is_new_navigation, false /* is_same_document */);
...
void RenderFrameImpl::DidNavigateWithinPage(
  ...
  NotifyObservers(is_new_navigation, true /* is_same_document */);
...
void RenderFrameImpl::UpdateStateAfterNavigation() {}
