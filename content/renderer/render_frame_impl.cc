...
void RenderFrameImpl::DidCommitProvisionalLoad(
  ...
  // TODO(engedy, lukasza): Swapping of InterfaceProvider (pending in
  // https://crrev.com/c/735686) should happen here - before notifying observers
  // via RenderFrameObserver::WillCommitProvisionalLoad.
