 ...
 public:
  ...
  std::unique_ptr<blink::WebURLLoader> CreateURLLoader(
    ...
    return std::make_unique<WebURLLoaderImpl>(
        ...
        std::move(task_runner), frame_->GetLoaderFactories(),
...
void RenderFrameImpl::CommitNavigation(
  ...
  SetupLoaderFactories(std::move(subresource_loader_factories));
...
RenderFrameImpl::CreateWorkerFetchContext() {
  ...
  std::unique_ptr<WorkerFetchContextImpl> worker_fetch_context =
      std::make_unique<WorkerFetchContextImpl>(
          ...
          std::move(container_host_ptr_info), GetLoaderFactories()->Clone(),
...
void RenderFrameImpl::DidCreateDocumentLoader(
  ...
  document_loader->SetServiceWorkerNetworkProvider(
      ServiceWorkerNetworkProvider::CreateForNavigation(
          ...
          render_thread ? GetLoaderFactories() : nullptr));
}
...
ChildURLLoaderFactoryBundle* RenderFrameImpl::GetLoaderFactories() {
...
void RenderFrameImpl::SetCustomURLLoaderFactory(
  ...
  GetLoaderFactories()->SetDefaultFactory(std::move(factory));
}
...
network::mojom::URLLoaderFactory* RenderFrameImpl::GetURLLoaderFactory(
  ...
  return GetLoaderFactories()->GetFactoryForURL(request_url);
}
