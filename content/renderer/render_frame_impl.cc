...
RenderFrameImpl* RenderFrameImpl::Create(
  ...
  CreateParams params(render_view, routing_id, devtools_frame_guid);
...
RenderFrameImpl* RenderFrameImpl::CreateMainFrame(
  ...
  RenderFrameImpl* render_frame =
      RenderFrameImpl::Create(render_view, routing_id, devtools_frame_guid);
...
void RenderFrameImpl::CreateFrame(
  ...
  if (proxy_routing_id == MSG_ROUTING_NONE) {
    ...
    render_frame = RenderFrameImpl::Create(parent_proxy->render_view(),
                                           routing_id, devtools_frame_guid);
...
RenderFrameImpl::RenderFrameImpl(const CreateParams& params)
    : frame_(NULL),
      ...
      devtools_frame_guid_(params.devtools_frame_guid),
      weak_factory_(this) {
...
blink::WebLocalFrame* RenderFrameImpl::CreateChildFrame(
  ...
  RenderFrameImpl* child_render_frame = RenderFrameImpl::Create(
      render_view_, child_routing_id, devtools_frame_guid);
...
blink::WebString RenderFrameImpl::GetDevToolsFrameGUID() {
  return blink::WebString::FromUTF8(devtools_frame_guid_);
}
