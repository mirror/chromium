...
public class ChildProcessLauncherTest {
    ...
    public void testServiceFailedToBind() {
        ...
        startSandboxedChildProcess(context.getPackageName(), false /* blockUntilConected */,
    ...
    public void testServiceCrashedBeforeSetup() throws RemoteException {
        ...
        ChildProcessLauncherHelper launcher = startSandboxedChildProcess(null /* packageName */,
                true /* blockUntilConnected */, false /* doSetupConnection */);
    ...
    public void testServiceCrashedAfterSetup() throws RemoteException {
        ...
        // Start and connect to a new service.
        ChildProcessLauncherHelper launcher = startSandboxedChildProcess(null /* packageName */,
                true /* blockUntilConnected */, true /* doSetupConnection */);
        Assert.assertEquals(1, getConnectedSandboxedServicesCount());

        // Verify that the connection completes the setup.
        final ChildProcessConnection connection = retrieveConnection(launcher);
    ...
    public void testPendingSpawnQueue() throws RemoteException {
        ...
        ChildProcessLauncherHelper launcher1 = startSandboxedChildProcess(null /* packageName */,
                true /* blockUntilConnected */, true /* doSetupConnection */);
        Assert.assertEquals(1, getConnectedSandboxedServicesCount());
        Assert.assertNotNull(ChildProcessLauncherTestUtils.getConnection(launcher1));

        ChildProcessLauncherHelper launcher2 = startSandboxedChildProcess(null /* packageName */,
                false /* blockUntilConnected */, true /* doSetupConnection */);
        Assert.assertEquals(1, getConnectedSandboxedServicesCount());
    ...
    public void testBindServiceFromMultipleProcesses() throws RemoteException {
        ...
        ChildProcessLauncherHelper launcher = startSandboxedChildProcessWithCreationParams(
                creationParams, true /* blockUntilConnected */, true /* doSetupConnection */);
        ...
        Assert.assertTrue(
                ChildProcessLauncherTestUtils.getConnectionPid(retryConnection) != helperConnPid);
        Assert.assertTrue(
    ...
    private void testWarmUpWithCreationParams(ChildProcessCreationParams creationParams) {
        ...
        Assert.assertEquals(1, getConnectedSandboxedServicesCount()); // Used warmup connection.

        ChildProcessLauncherTestUtils.runOnLauncherThreadBlocking(new Runnable() {
            @Override
            public void run() {
                ChildProcessLauncherHelper.stop(
                        ChildProcessLauncherTestUtils.getConnectionPid(connection));
            }
        });
    ...
    public void testCustomCreationParamDoesNotReuseWarmupConnection() {
        ...
        // identity, having the params match exactly is fine).ount());
        startSandboxedChildProcessWithCreationParams(
                otherCreationParams, true /* blockUntilConected */, true /* doSetupConnection */);
        Assert.assertEquals(2, getConnectedSandboxedServicesCount());

        startSandboxedChildProcessWithCreationParams(
                defaultCreationParams, true /* blockUntilConected */, true /* doSetupConnection */);
        Assert.assertEquals(2, getConnectedSandboxedServicesCount());
    }
    ...
    private static ChildProcessLauncherHelper startSandboxedChildProcess(final String packageName,
            boolean blockUntilConnected, final boolean doSetupConnection) {
        ...
        return startSandboxedChildProcessWithCreationParams(
                creationParams, blockUntilConnected, doSetupConnection);
    }

    private static ChildProcessLauncherHelper startSandboxedChildProcessWithCreationParams(
            final ChildProcessCreationParams creationParams, boolean blockUntilConnected,
