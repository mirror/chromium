...
public class ClipboardTest {
    ...
    public void testCopyDocumentFragment() throws Throwable {
        final AtomicReference<ClipboardManager> clipboardManagerRef = new AtomicReference<>();
        ThreadUtils.runOnUiThreadBlocking(() -> {
            ClipboardManager clipboardManager = (ClipboardManager) mActivityTestRule.getActivity()
                    .getSystemService(Context.CLIPBOARD_SERVICE);
            Assert.assertNotNull(clipboardManager);
            clipboardManagerRef.set(clipboardManager);
        ...
        CriteriaHelper.pollUiThread(new Criteria() {
            ...
            public boolean isSatisfied() {
                return hasPrimaryClip(clipboardManagerRef.get());
            }
        });

        ThreadUtils.runOnUiThreadBlocking(() -> {
            ClipboardManager clipboardManager = clipboardManagerRef.get();
