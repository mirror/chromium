...
public class ContentViewCoreSelectionTest {
    ...
    private static class MySelectionClient implements SelectionClient {
    ...
    */
    ...
    public void testSmartSelectionNormalFlow() throws Throwable {
        ...
        Assert.assertTrue(returnResult.startAdjust == result.startAdjust
                && returnResult.endAdjust == result.endAdjust
                && returnResult.label == result.label);
    }
