...
public class ImeInputModeTest {
    ...
    public void testShowAndHideInputMode() throws Exception {
        ...
        mRule.waitForKeyboardStates(0, 1, 1, new Integer[] {TextInputType.CONTENT_EDITABLE},
        ...
        mRule.waitForKeyboardStates(1, 1, 2,
        ...
        mRule.waitForKeyboardStates(2, 1, 3,
                ...
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.TEXT, WebTextInputMode.TEL});
        ...
        mRule.waitForKeyboardStates(4, 1, 5,
                new Integer[] {TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE,
                        ...
                        TextInputType.CONTENT_EDITABLE},
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.TEXT, WebTextInputMode.TEL,
                        WebTextInputMode.URL, WebTextInputMode.EMAIL});
        ...
        mRule.waitForKeyboardStates(7, 1, 8,
                ...
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.TEXT, WebTextInputMode.TEL,
                        WebTextInputMode.URL, WebTextInputMode.EMAIL, WebTextInputMode.NUMERIC,
                        WebTextInputMode.DECIMAL, WebTextInputMode.SEARCH});
        ...
        mRule.waitForKeyboardStates(7, 2, 9,
                ...
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.TEXT, WebTextInputMode.TEL,
                        WebTextInputMode.URL, WebTextInputMode.EMAIL, WebTextInputMode.NUMERIC,
                        WebTextInputMode.DECIMAL, WebTextInputMode.SEARCH, WebTextInputMode.NONE});
    }
    ...
    public void testShowAndHideInputModeWithPhysicalKeyboard() throws Throwable {
        ...
        mRule.waitForKeyboardStates(1, 1, 2,
                new Integer[] {TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE},
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.NONE});
        Assert.assertNotNull(mRule.getInputMethodManagerWrapper().getInputConnection());
        ...
        mRule.waitForKeyboardStates(2, 1, 3,
                ...
                new Integer[] {
                        WebTextInputMode.NONE, WebTextInputMode.NONE, WebTextInputMode.TEXT});
        Assert.assertNotNull(mRule.getInputMethodManagerWrapper().getInputConnection());
        ...
        // mRule.restartInput()
        mRule.waitForKeyboardStates(2, 1, 4,
                new Integer[] {TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE,
                        TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE},
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.NONE, WebTextInputMode.TEXT,
        ...
        mRule.waitForKeyboardStates(2, 2, 5,
                new Integer[] {TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE,
                        TextInputType.CONTENT_EDITABLE, TextInputType.CONTENT_EDITABLE,
                        TextInputType.CONTENT_EDITABLE},
                new Integer[] {WebTextInputMode.NONE, WebTextInputMode.NONE, WebTextInputMode.TEXT,
                        WebTextInputMode.NONE, WebTextInputMode.NONE});
        Assert.assertNotNull(mRule.getInputConnection());
    }
}
