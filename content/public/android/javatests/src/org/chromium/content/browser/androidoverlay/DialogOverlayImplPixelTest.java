...
public class DialogOverlayImplPixelTest extends DialogOverlayImplTestBase {
    ...
    void takeScreenshotOfBackground() {
        ...
        for (int retries = 0; retries < NUM_RETRIES; retries++) {
            ...
            mTargetAreaMinPx = (mDivWidthPx - 1) * (mDivHeightPx - 1);
            ...
            mAreaOfInterestPx.left = mDivXPx - 1;
            mAreaOfInterestPx.top = mDivYPx - 1;
            mAreaOfInterestPx.right = mDivXPx + mDivWidthPx - 1 + 1;
