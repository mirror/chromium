...
@RetryOnFailure
@CommandLineFlags.Add({"enable-features=MediaSession",
...
public class MediaSessionTest {
    ...
    static {
        // Restriction.RESTRICTION_TYPE_NON_LOW_END_DEVICE applied to one of the tests
        // requires {@link CommandLine} be initialized before any test to start. Sets
        // the instance with an empty one here.
        CommandLine.init(new String[]{});
    }

    private AudioManager getAudioManager() {
        return ThreadUtils.runOnUiThreadBlockingNoException(new Callable<AudioManager>() {
            @Override
