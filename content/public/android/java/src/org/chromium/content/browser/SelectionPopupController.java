...
public class SelectionPopupController extends ActionModeCallbackHelper {
    ...
    void setSelectionClient(@Nullable SelectionClient selectionClient) {
        mSelectionClientManager.setSelectionClient(selectionClient);
    ...
    /** Adds the given {@link SelectionClient} to the {@link SelectionClientManager}. */
    void addSelectionClient(SelectionClient selectionClientToAdd, Runnable howToHide) {
        mSelectionClientManager.addSelectionClient(selectionClientToAdd, howToHide);
    }
    ...
    void removeSelectionClient(SelectionClient selectionClientToRemove) {
        mSelectionClientManager.removeSelectionClient(selectionClientToRemove);
    }
