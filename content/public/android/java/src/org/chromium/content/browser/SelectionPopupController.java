...
public class SelectionPopupController extends ActionModeCallbackHelper {
    ...
    /**
     * The {@link HandleObserver} that processes handle events, or {@code null} if none exists.
     */
    private HandleObserver mHandleObserver;
        ...
        switch (eventType) {
            ...
            case SelectionEventType.SELECTION_HANDLES_MOVED:
                ...
                if (mDragStarted && mHandleObserver != null) {
                    mHandleObserver.handleDragStarted(boundMiddlePointX, boundMiddlePointY);
                }
                break;
     ...
     */
    @VisibleForTesting
    void setHandleObserver(@Nullable HandleObserver handleObserver) {
