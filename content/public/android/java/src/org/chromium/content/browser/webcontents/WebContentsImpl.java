...
/* package */ class WebContentsImpl implements WebContents, RenderFrameHostDelegate {
    ...
    // The render coordinates for this WebContents which has a copy of all positions and scales
    // reported from the renderer.
    private RenderCoordinates mCoordinateSpace;
    ...
    class SmartClipCallbackImpl implements SmartClipCallback {
        ...
        public void onSmartClipDataExtracted(String text, String html, Rect clipRect) {
            // Return the screen coordiantes for clipRect by adding the contentOffset which was
            // removed while requesting smart clip extract.
            final float dpi = mCoordinateSpace.getDeviceScaleFactor();
            clipRect.offset(0, (int) (mCoordinateSpace.getContentOffsetYPix() / dpi));
    ...
    private static void onSmartClipDataExtracted(
            String text, String html, Rect clipRect, SmartClipCallback callback) {
        callback.onSmartClipDataExtracted(text, html, clipRect);
    }
