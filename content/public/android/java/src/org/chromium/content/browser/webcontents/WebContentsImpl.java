...
public class WebContentsImpl implements WebContents, RenderFrameHostDelegate {
    ...
    class SmartClipCallbackImpl implements SmartClipCallback {
        ...
        public void onSmartClipDataExtracted(String text, String html, Rect clipRect) {
            // The clipRect is in dip scale here. Convert the clipRect to Screen co-ordinates by
            // adding the contentOffset in same scale.
            clipRect.offset(0,
                    (int) (getRenderCoordinates().fromPixToDip(
