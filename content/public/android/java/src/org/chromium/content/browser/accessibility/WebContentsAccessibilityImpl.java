...
public class WebContentsAccessibilityImpl extends AccessibilityNodeProvider
        implements AccessibilityStateChangeListener, WebContentsAccessibility {
    ...
    // Class implementing {@link WebContentsAccessibility} interface. Depends on OS build version.
    private static Class<? extends WebContentsAccessibilityImpl> sImplClass;

    static {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            sImplClass = OWebContentsAccessibility.class;
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            sImplClass = LollipopWebContentsAccessibility.class;
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            sImplClass = KitKatWebContentsAccessibility.class;
        } else {
            sImplClass = WebContentsAccessibilityImpl.class;
        }
    }

    private static final class UserDataFactoryLazyHolder {
        private static final UserDataFactory<WebContentsAccessibilityImpl> INSTANCE =
                WebContentsAccessibilityImpl::new;
    }
    ...
    public static WebContentsAccessibilityImpl create(Context context, ViewGroup containerView,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            wcax = WebContentsUserData.fromWebContents(webContents, OWebContentsAccessibility.class,
                    OWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            wcax = WebContentsUserData.fromWebContents(webContents,
                    LollipopWebContentsAccessibility.class,
                    LollipopWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            wcax = WebContentsUserData.fromWebContents(webContents,
                    KitKatWebContentsAccessibility.class,
                    KitKatWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE);
        } else {
            wcax = WebContentsUserData.fromWebContents(webContents,
    ...
    public static WebContentsAccessibilityImpl fromWebContents(WebContents webContents) {
        return WebContentsUserData.fromWebContents(webContents, sImplClass, null);
    }
