...
public class WebContentsAccessibilityImpl extends AccessibilityNodeProvider
    ...
    public static WebContentsAccessibilityImpl create(Context context, ViewGroup containerView,
        ...
        UserDataFactory<WebContentsAccessibilityImpl> userDataFactory;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            userDataFactory = OWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE;
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            userDataFactory = LollipopWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE;
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            userDataFactory = KitKatWebContentsAccessibility.UserDataFactoryLazyHolder.INSTANCE;
        } else {
            userDataFactory = UserDataFactoryLazyHolder.INSTANCE;
        }
        WebContentsAccessibilityImpl wcax = WebContentsUserData.fromWebContents(
                webContents, WebContentsAccessibilityImpl.class, userDataFactory);
