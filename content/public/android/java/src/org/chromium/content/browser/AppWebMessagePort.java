...
public class AppWebMessagePort implements MessagePort {
    ...
    private static final MessageHeader sMessageHeader = new MessageHeader(0);
    ...
    private class Receiver implements MessageReceiver {
        ...
        public boolean accept(Message mojoMessage) {
            TransferableMessage msg = TransferableMessage.deserialize(
                    new ServiceMessage(mojoMessage, sMessageHeader).getPayload());
    ...
    public void postMessage(String message, MessagePort[] sentPorts) throws IllegalStateException {
        ...
        msg.ports = ports;
        mConnector.accept(msg.serializeWithHeader(mMojoCore, sMessageHeader));
    }
