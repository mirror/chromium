...
public class BrowserStartupController {
    ...
    void prepareToStartBrowserProcess(
        ...
        Runnable commandLineFlagInitialization = new Runnable() {
            @Override
            public void run() {
        ...
        if (completionCallback == null) {
            ...
            commandLineFlagInitialization.run();
        } else {
            ResourceExtractor.get().addCompletionCallback(commandLineFlagInitialization);
        }
    }
