...
public class ImeUtils {
    ...
    public static void computeEditorInfo(int inputType, int inputFlags, int inputMode,
        ...
        // the HTML spec, so we can respect its value exactly here. For the default state, we
        // explicitly enable sentences autocapitalization since Android IMEs don't autocapitalize
        // by default.
