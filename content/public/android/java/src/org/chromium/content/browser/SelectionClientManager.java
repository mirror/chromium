...
public class SelectionClientManager implements SelectionClient {
    ...
    private Runnable mSuppressContextualSearch;
     ...
     *        is used.
     * @param suppressContextualSearch A {@link Runnable} that knows how to suppress Contextual
     *        Search.
     */
    void addSelectionClient(
            SelectionClient selectionClientToAdd, Runnable suppressContextualSearch) {
        ...
        mSuppressContextualSearch = suppressContextualSearch;
    }
    ...
    private class SelectionClientBridge implements SelectionClient {
        ...
        public void onSelectionEvent(int eventType, float posXPix, float posYPix) {
            ...
            // Notify Contextual Search that the selection is being handled by Smart Select.
            mSuppressContextualSearch.run();

            // Contextual Search will track the action and do whatever is appropriate.
