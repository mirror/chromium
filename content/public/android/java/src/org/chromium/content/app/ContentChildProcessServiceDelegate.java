...
class ContentChildProcessServiceDelegate implements ChildProcessServiceDelegate {
    ...
    public boolean loadNativeLibrary(Context hostContext) {
        ...
        try {
            LibraryLoader.get(mLibraryProcessType).loadNowOverrideApplicationContext(hostContext);
            isLoaded = true;
    ...
    public void onBeforeMain() {
        nativeInitChildProcess(this, mCpuCount, mCpuFeatures);
    }
    ...
    private static native void nativeInitChildProcess(
            ContentChildProcessServiceDelegate service, int cpuCount, long cpuFeatures);
