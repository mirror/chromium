...
public class ChildProcessConnection {
    ...
    public void start(
        ...
        try {
            ...
            if (retryOnTimeout) {
                resetWatchdog(useStrongBinding, serviceCallback);
            }
    ...
    private void resetWatchdog(
            final boolean useStrongBinding, final ServiceCallback serviceCallback) {
        assert LauncherThread.runningOnLauncherThread();
        cancelWatchDog();
        ...
        mOnServiceConnectedWatchDog = new Runnable() {
            ...
            public void run() {
                ...
                unbindAll();
                start(useStrongBinding, serviceCallback, true /* retryOnTimeout */);
            }
        };
