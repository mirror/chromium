...
public class ContentViewCore implements AccessibilityStateChangeListener, DisplayAndroidObserver,
    ...
    public AccessibilityNodeProvider getAccessibilityNodeProvider() {
        ...
        if (mWebContentsAccessibility != null) {
            ...
            // Nulled-out provider effectively means WebContentsAccessibility was destroyed.
            if (provider == null) mWebContentsAccessibility = null;
            return provider;
        }
        ...
        if (mNativeAccessibilityAllowed) {
            ...
            mWebContentsAccessibility.setAccessibilityEnabled(true);
        }
