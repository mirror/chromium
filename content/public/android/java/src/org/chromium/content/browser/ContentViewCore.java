...
public class ContentViewCore implements AccessibilityStateChangeListener, DisplayAndroidObserver,
    ...
    public int getTopControlsHeightForTesting() {
        ...
        try {
            return ThreadUtils.runOnUiThreadBlocking(() -> {
                return nativeGetTopControlsHeightPixForTesting(mNativeContentViewCore);
            });
    ...
    private native int nativeGetTopControlsHeightPixForTesting(long nativeContentViewCore);
