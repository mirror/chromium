...
public class ContentViewCore implements AccessibilityStateChangeListener, DisplayAndroidObserver,
     ...
     */
    @VisibleForTesting
    public int getVisibleTopControlsHeightForTesting() {
        // TODO(jinsukkim): Let callsites provide with its own top controls height to remove
        //                  the test-only method in content layer.
        return nativeGetVisibleTopControlsHeightPixForTesting(mNativeContentViewCore);
    }
    ...
    private native int nativeGetVisibleTopControlsHeightPixForTesting(long nativeContentViewCore);
