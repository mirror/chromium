        ...
        LauncherThread.post(new Runnable() {
            ...
            public void run() {
                ...
                sSpareSandboxedConnection = new SpareChildConnection(context,
                        SANDBOXED_SPARE_CONNECTION_FATORY, ChildProcessCreationParams.getDefault());
            }
        });
    }
    ...
    public static boolean start(final Context context, final Bundle serviceBundle,
        ...
        try {
            ...
            if (sSpareSandboxedConnection != null) {
                connection = sSpareSandboxedConnection.getConnection(creationParams, startCallback);
                if (connection != null) {
