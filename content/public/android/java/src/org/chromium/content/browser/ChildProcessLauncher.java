...
public class ChildProcessLauncher {
    ...
    private static boolean isServiceExternalFromCreationParams(
    ...
    public static void startModerateBindingManagement(final Context context) {
        ...
        LauncherThread.post(new Runnable() {
            ...
            public void run() {
                ChildConnectionAllocator allocator =
                        getConnectionAllocator(context, context.getPackageName(),
                                true /* sandboxed */, false /* bindAsExternalService*/);
