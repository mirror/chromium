...
public class SmartSelectionMetricsLogger implements SelectionMetricsLogger {
    ...
    private final Class<?> mTrackerClass;
    protected Class<?> mSelectionEventClass;
    ...
    private SmartSelectionMetricsLogger(Context context) {
        ...
        setSelectionEventProxy(SelectionEventProxyImpl.create(mSelectionEventClass));
    ...
    public void logSelectionStarted(String selectionText, int startOffset, boolean editable) {
        ...
        mConverter.setSessionStartOffset(startOffset);
    ...
    public void logSelectionModified(
        ...
        if (DEBUG) Log.d(TAG, "logSelectionModified");
    ...
    public void logSelectionAction(String selectionText, int startOffset, @ActionType int action,
        ...
        if (DEBUG) Log.d(TAG, "logSelectionAction");
    ...
    private boolean hasSelectionStarted() {
        return mTracker != null && mSelectionEventClass != null && mSelectionEventProxy != null;
    }
    ...
    private Class<?> getSelectionEventClass() {
        if (mTrackerClass == null) return null;
        try {
