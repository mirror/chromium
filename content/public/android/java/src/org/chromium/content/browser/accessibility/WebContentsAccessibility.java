...
/**
 * Native accessibility for a {@link WebContents}.
 */
...
public class WebContentsAccessibility {
    ...
    public static WebContentsAccessibility create(Context context, ViewGroup containerView,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return new LollipopWebContentsAccessibility(
                    context, containerView, webContents, renderCoordinates);
    ...
    public void setAccessibilityEnabled(boolean enabled) {
        nativeSetAccessibilityEnabled(mNativeObj, enabled);
    }
    ...
    private native void nativeOnAutofillPopupDisplayed(long nativeWebContentsAccessibility);
    private native void nativeOnAutofillPopupDismissed(long nativeWebContentsAccessibility);
    private native int nativeGetIdForElementAfterElementHostingAutofillPopup(
            long nativeWebContentsAccessibility);
    private native int nativeGetRootId(long nativeWebContentsAccessibility);
    private native boolean nativeIsNodeValid(long nativeWebContentsAccessibility, int id);
    private native boolean nativeIsAutofillPopupNode(long nativeWebContentsAccessibility, int id);
    private native boolean nativeIsEditableText(long nativeWebContentsAccessibility, int id);
    private native boolean nativeIsFocused(long nativeWebContentsAccessibility, int id);
    private native int nativeGetEditableTextSelectionStart(
            long nativeWebContentsAccessibility, int id);
    private native int nativeGetEditableTextSelectionEnd(
            long nativeWebContentsAccessibility, int id);
    private native void nativeHitTest(long nativeWebContentsAccessibility, int x, int y);
    private native boolean nativePopulateAccessibilityNodeInfo(
            long nativeWebContentsAccessibility, AccessibilityNodeInfo info, int id);
    private native boolean nativePopulateAccessibilityEvent(
            long nativeWebContentsAccessibility, AccessibilityEvent event, int id, int eventType);
    private native void nativeClick(long nativeWebContentsAccessibility, int id);
    private native void nativeFocus(long nativeWebContentsAccessibility, int id);
    private native void nativeBlur(long nativeWebContentsAccessibility);
    private native void nativeScrollToMakeNodeVisible(long nativeWebContentsAccessibility, int id);
    private native int nativeFindElementType(
            long nativeWebContentsAccessibility, int startId, String elementType, boolean forwards);
    private native void nativeSetTextFieldValue(
            long nativeWebContentsAccessibility, int id, String newValue);
    private native void nativeSetSelection(
            long nativeWebContentsAccessibility, int id, int start, int end);
    private native boolean nativeNextAtGranularity(long nativeWebContentsAccessibility,
            int selectionGranularity, boolean extendSelection, int id, int cursorIndex);
    private native boolean nativePreviousAtGranularity(long nativeWebContentsAccessibility,
            int selectionGranularity, boolean extendSelection, int id, int cursorIndex);
    private native boolean nativeAdjustSlider(
            long nativeWebContentsAccessibility, int id, boolean increment);
    private native void nativeSetAccessibilityFocus(long nativeWebContentsAccessibility, int id);
    private native boolean nativeIsSlider(long nativeWebContentsAccessibility, int id);
    private native boolean nativeScroll(long nativeWebContentsAccessibility, int id, int direction);
    protected native String nativeGetSupportedHtmlElementTypes(long nativeWebContentsAccessibility);
    private native void nativeShowContextMenu(long nativeWebContentsAccessibility, int id);
    private native void nativeSetAccessibilityEnabled(
            long nativeWebContentsAccessibility, boolean enabled);
}
