...
public class WebContentsAccessibility extends AccessibilityNodeProvider {
    ...
    @VisibleForTesting
    private static int sSelectionIndexForTesting = -1;
    ...
    /**
     * Index used to test correct granularity navigation.
     * Only used for testing.
     */
    @VisibleForTesting
    static int getSelectionIndex() {
        return sSelectionIndexForTesting;
    }
    ...
    private boolean nextAtGranularity(int granularity, boolean extendSelection, int virtualViewId) {
        if (mAccessibilityFocusId != View.NO_ID && virtualViewId != mAccessibilityFocusId)
            return false;
    ...
    private void finishGranularityMove(String text, boolean extendSelection, int itemStartIndex,
        ...
        sSelectionIndexForTesting = mSelectionEndIndex;
