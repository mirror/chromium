...
public class TapDisambiguator implements ImeEventObserver {
    ...
    public static TapDisambiguator create(
        ...
        assert tabDismabiguator != null && !tabDismabiguator.initialized();
    ...
    private void init(Context context, ViewGroup containerView) {
        mPopupView = new PopupZoomer(context, containerView);
        ...
        mPopupView.setVisibilityChangedListener(listener);
        ...
        mPopupView.setOnTapListener(tapListener);
