 ...
 */
public interface GestureListenerManager extends Data {
    /**
    ...
    static GestureListenerManager fromWebContents(WebContents webContents) {
        ...
        GestureListenerManager manager =
                (GestureListenerManager) webContentsImpl.getUserData(GestureListenerManager.class);
        if (manager == null) {
            manager = new GestureListenerManagerImpl(webContentsImpl);
            webContentsImpl.setUserData(GestureListenerManager.class, manager);
        }
        return manager;
    }
