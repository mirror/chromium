...
public interface WebContents extends Parcelable {
     ...
     * The WebContents must be fullscreen when this method is called. This should only be called if
     ...
     * the rectangle is meaningless. Will return null if there is no such video. This should only be
     * called if AppHooks.shouldDetectVideoFullscreen() returns true.
     */
