...
public interface WebContents extends Parcelable {
     ...
     * List of user data
     */
    public enum UserData { RETAINED_JAVASCRIPT_OBJECTS; }

    /**
     * Passes a map of user data which should be held weakly by WebContents. For now
     * Only WebView needs to call this to ensure there will no memory leak when
     * WebView is detached from Android view tree.
     */
    void setUserData(Callable<Map<UserData, Object>> data);
}
