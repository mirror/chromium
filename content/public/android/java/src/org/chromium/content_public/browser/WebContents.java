...
public interface WebContents extends Parcelable {
    ...
    /**
     * Interface used to transfer the object holder from WebContents.
     */
    interface ObjectHolderCallback {
        /**
         * Called when WebContents returns the object holder.
         *
         * @param objectHolder a holder of the objects to pass to the caller.
         */
        void onReceived(WebContentsInternals objectHolder);
    }

    /**
     * Sets holder of the objects used internally by WebContents for various features.
     * This transfers the ownership of the objects to the caller since they will have
     * the same lifecycle as that of the caller. The caller doesn't have to care about
     * the objects inside the holder but should hold a reference to it and manage its
     * lifetime, since WebContents holds only a weak reference to it.
     *
     * @param callback {@link #ObjectHolderCallback} used to transfer the object holder
     *        from WebContents to the caller.
     */
    void setObjectHolder(ObjectHolderCallback callback);
