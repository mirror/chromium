...
public interface WebContents extends Parcelable {
     ...
     * <ul>
     * <li>{@link #JAVA_BRIDGE_HOST_OBJECTS} creates Java bridge host that allows injected
     *     Java objects to be exposed as Javascript objects. Requires {@link HashSet<Object>}
     *     which ensures the injected objects are not garbage-collected until the page
     *     is navigated.</li>
     * </ul>
     *
