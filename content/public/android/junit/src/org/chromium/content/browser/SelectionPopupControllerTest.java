...
public class SelectionPopupControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        mController = new SelectionPopupController(mContext, mWindowAndroid, mWebContents, mView,
                mRenderCoordinates, /* initializeNative = */ false);
    }

    @Test
    @Feature({"SmartSelection"})
    public void testSmartSelectionAdjustSelectionRange() {
        assertFalse(mController == null);
