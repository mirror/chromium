...
public class SelectionPopupControllerTest {
    ...
    private class MySelectionClient implements SelectionClient {
    ...
    class SelectionClientOnlyReturnTrue extends MySelectionClient {
        @Override
        public boolean requestSelectionPopupUpdates(boolean shouldSuggest) {
            return true;
        }
    ...
    public void testSmartSelectionAnotherLongPressBeforeAdjustment() {
        ...
        MySelectionClient client = new SelectionClientOnlyReturnTrue();
        mController.setSelectionClient(client);
