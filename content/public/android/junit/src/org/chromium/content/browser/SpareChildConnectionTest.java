...
public class SpareChildConnectionTest {
    ...
    public void testCreateAndGet() {
        // Tests retrieving the connection with the wrong parameter.
        ChildProcessConnection connection =
                mSpareConnection.getConnection(mWrongConnectionAllocator, mStartCallback);
        assertNull(connection);

        // And with the right one.
        connection = mSpareConnection.getConnection(mConnectionAllocator, mStartCallback);
    ...
    public void testCallbackCalledConnectionReady() {
        ...
        ChildProcessConnection connection =
                mSpareConnection.getConnection(mConnectionAllocator, mStartCallback);
        assertNotNull(connection);
        ShadowLooper.runUiThreadTasksIncludingDelayedTasks();
