...
public class SpareChildConnectionTest {
    ...
    public void setUp() {
        ...
        mSpareConnection = new SpareChildConnection(
                null /* context */, mTestConnectionfactory, mCreationParams);
    }
    ...
    public void testCreateAndGet() {
        ...
        ChildProcessConnection connection =
                mSpareConnection.getConnection(null /* creationParams */, mStartCallback);
        assertNull(connection);

        // And with the right one.
        connection = mSpareConnection.getConnection(mCreationParams, mStartCallback);
    ...
    public void testCallbackCalledConnectionReady() {
        ...
        ChildProcessConnection connection =
                mSpareConnection.getConnection(mCreationParams, mStartCallback);
        assertNotNull(connection);
        ShadowLooper.runUiThreadTasksIncludingDelayedTasks();
