...
public class SmartSelectionMetricsLoggerTest {
    private static class TestSmartSelectionMetricsLogger extends SmartSelectionMetricsLogger {
        TestSmartSelectionMetricsLogger() {
            // Let it pass hasSelectionStarted().
            mTracker = new Object();
            mSelectionEventClass = SmartSelectionMetricsLogger.SelectionEventProxy.class;
        }
    ...
    public void testGetWordDelta() {
        ...
        // Partial word case. "ace"
        indices = converter.getWordDelta(22, 25);
        assertEquals(3, indices[0]);
        assertEquals(4, indices[1]);
    }
    ...
    public void testNormalLoggingFlow() {
        ...
        //             0         1         2         3         4
        //            -7-6   -5-4   -3-2        -1   0    1    2
        String text = "O Romeo, Romeo! Wherefore art thou Romeo?\n"
                //         5         6         7
                // 3    4   5      6   7      8   9   0
        ...
        logger.logSelectionAction(text, 0, ActionType.SELECT_ALL, null);
