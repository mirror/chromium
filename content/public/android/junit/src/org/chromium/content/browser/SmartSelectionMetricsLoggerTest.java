...
public class SmartSelectionMetricsLoggerTest {
    ...
    public void testMultipleDrag() {
        ...
        order.verify(selectionEventProxy).createSelectionAction(0, 3, ActionType.DRAG);

        // Drag left handle to " and refuse"
        logger.logSelectionAction(" and refuse", 57, ActionType.DRAG, null);
        order.verify(selectionEventProxy, never())
                .createSelectionAction(anyInt(), anyInt(), anyInt());
    ...
    public void testTextShift() {
        ...
        order.verify(selectionEventProxy).createSelectionAction(-3, 0, ActionType.DRAG);
    }
    ...
    public void testSelectionChanged() {
        ...
        order.verify(selectionEventProxy).createSelectionAction(-2, 0, ActionType.DRAG);
