...
/**
 * Unit tests for SpareChildConnectionManagerTest.
 */
@RunWith(LocalRobolectricTestRunner.class)
@Config(manifest = Config.NONE)
public class SpareChildConnectionManagerTest {
    @Mock
    private ChildProcessConnection.StartCallback mStartCallback;

    static class TestConnectionFactory implements SpareChildConnectionManager.ConnectionFactory {
        ...
        public ChildProcessConnection allocateBoundConnection(ChildSpawnData spawnData,
            ...
            connection = ChildProcessConnection.createEmptyConnection();
            return connection;
        }
    }

    private final SpareChildConnectionManager mSpareConnectionManager =
            new SpareChildConnectionManager();
    ...
    public SpareChildConnectionManagerTest() {
        mSpareConnectionManager.setConnectionfactoryForTesting(mTestConnectionfactory);
    }
    ...
    public void setUp() {
        ...
        // Create the spare connection.
        mSpareConnectionManager.createConnection(
                null /* context */, SANDBOXED, ALWAYS_IN_FOREGROUND, mCreationParams);
    }
    ...
    public void testCreateAndGet() {
        ...
        ChildProcessConnection connection = mSpareConnectionManager.getConnection(
                !SANDBOXED, ALWAYS_IN_FOREGROUND, mCreationParams, mStartCallback);
        assertNull(connection);

        connection = mSpareConnectionManager.getConnection(
                SANDBOXED, !ALWAYS_IN_FOREGROUND, mCreationParams, mStartCallback);
        assertNull(connection);

        connection = mSpareConnectionManager.getConnection(
                SANDBOXED, ALWAYS_IN_FOREGROUND, null /* creationParams */, mStartCallback);
        assertNull(connection);
    ...
    public void testConnectionFreeing() {
        mSpareConnectionManager.onConnectionFreed(mTestConnectionfactory.connection);
