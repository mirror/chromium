...
// serve the same URL twice, you can create two ControllableHttpResponse. They
// are used in the order they were created.
class ControllableHttpResponse {
 ...
 private:
  ...
  // Used as a callback for EmbeddedTestServer::RegisterRequestHandler().
