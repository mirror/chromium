...
void TestStoragePartition::AddNetworkServiceObserver(NetworkServiceObserver*) {}

void TestStoragePartition::RemoveNetworkServiceObserver(
    const NetworkServiceObserver*) {}
