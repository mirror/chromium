...
// Appends command line switches to |command_line| to enable the |feature|
// and to set field trial params associated with the feature as specified
// by |param_name| and |param_value|.
//
// See also variations::testing::VariationsParamsManager class.
void EnableFeatureWithParams(const base::Feature& feature,
