...
RenderFrameHost* NavigationSimulator::GoBack(WebContents* web_contents) {
  NavigationSimulator simulator(GURL(), true /* browser_initiated */,
                                static_cast<WebContentsImpl*>(web_contents),
                                nullptr);
  simulator.SetIsBackwardNavigation(true);
  simulator.Commit();
  return simulator.GetFinalRenderFrameHost();
}
...
// static
RenderFrameHost* NavigationSimulator::GoForwardAndFail(
    WebContents* web_contents,
    int net_error_code) {
  NavigationSimulator simulator(GURL(), true /* browser_initiated */,
                                static_cast<WebContentsImpl*>(web_contents),
...
void NavigationSimulator::Commit() {
  ...
  if (is_forward_navigation_ || is_backward_navigation_) {
...
void NavigationSimulator::SetIsBackwardNavigation(bool is_backward_navigation) {
  is_backward_navigation_ = is_backward_navigation;
  if (is_backward_navigation_)
    transition_ = ui::PageTransitionFromInt(transition_ |
