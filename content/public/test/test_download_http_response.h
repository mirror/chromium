...
class TestDownloadHttpResponse : public net::test_server::HttpResponse {
 public:
  ...
  struct Parameters {
    ...
    // Map of starting offset range and the static response sent to the
    // client.
 ...
 private:
  ...
  // Gets response header for range request starts from |first_byte_position|.
