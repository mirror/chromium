...
class NavigationSimulator : public WebContentsObserver {
 public:
  ...
  // Returns the GlobalRequestID for the simulated navigation. Can be invoked
  // after the navigation has completed. It is an error to call this before the
  // simulated navigation has completed its WillProcessResponse callback.
