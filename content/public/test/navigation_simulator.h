...
class NavigationSimulator : public WebContentsObserver {
 public:
  ...
  // navigation. Changes to the page transition should be made before calling
  // |Start|, changes to the referroer should be made before calling |Redirect|,
  // and changes to the socket address associated with the navigation should be
  // made before calling |Fail| or |Commit|.
