...
class MockRenderThread : public RenderThread {
 public:
  ...
  // was passed in to the constructor of RenderFrame with |routing_id| to
  // service GetInterface requests for its initial empty document; if any.
  service_manager::mojom::InterfaceProviderRequest
  TakeInitialInterfacesRequestForFrame(int32_t routing_id);
 ...
 protected:
  ...
  std::map<int32_t, service_manager::mojom::InterfaceProviderRequest>
      frame_routing_id_to_initial_interfaces_requests_;
