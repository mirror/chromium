...
void TestBrowserThreadBundle::Init() {
  ...
  // Create the ScopedTaskEnvironment, if it doesn't already exist (one may have
  // been provided by the parent fixture of the test that instantiates this
  // TestBrowserThreadBundle). This results in creating a TaskScheduler and a
  // main MessageLoop. In production, the TaskScheduler is created in the
  // constructor of BrowserMainLoop while the main MessageLoop is created in
