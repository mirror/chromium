...
#ifndef CONTENT_PUBLIC_COMMON_IGNORE_ERRORS_CERT_VERIFIER_UTILS_H_
#define CONTENT_PUBLIC_COMMON_IGNORE_ERRORS_CERT_VERIFIER_UTILS_H_
...
#endif  // CONTENT_PUBLIC_COMMON_IGNORE_ERRORS_CERT_VERIFIER_UTILS_H_