...
#ifndef CONTENT_PUBLIC_COMMON_SPEECH_GRAMMAR_STRUCT_TRAITS_H_
#define CONTENT_PUBLIC_COMMON_SPEECH_GRAMMAR_STRUCT_TRAITS_H_
...
struct StructTraits<content::mojom::SpeechRecognitionGrammarDataView,
  ...
  static std::string url(const content::SpeechRecognitionGrammar& r) {
    return r.url;
  }
...
#endif  // CONTENT_PUBLIC_COMMON_SPEECH_GRAMMAR_STRUCT_TRAITS_H_
