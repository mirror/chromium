...
class SimpleURLLoaderImpl final : public SimpleURLLoader,
...
// request completion.
class SimpleURLLoaderImpl::BodyHandler {
 public:
...
class SimpleURLLoaderImpl::SaveToStringBodyHandler
    : public SimpleURLLoaderImpl::BodyHandler {
 public:
  SaveToStringBodyHandler(SimpleURLLoaderImpl* simple_url_loader,
                          BodyAsStringCallback body_as_string_callback,
...
void SimpleURLLoaderImpl::DownloadToStringOfUnboundedSizeUntilCrashAndDie(
  ...
  SimpleURLLoaderImpl::StartInternal(resource_request, url_loader_factory,
                                     annotation_tag);
}
