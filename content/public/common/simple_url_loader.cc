...
class SimpleURLLoaderImpl : public SimpleURLLoader,
 ...
 private:
  ...
  // BodyHandler invokes Retry via a callback.
  void PrepareToRetry();

  // Restarts a request, after the state of |this| and its BodyHandler have been
  // reset.
  void Retry();
  ...
  // Along with BodyHandler, these contains all the information required to
