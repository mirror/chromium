...
TEST(SandboxTypeTest, Utility) {
  ...
  SetCommandLineFlagsForSandboxType(&command_line3, SANDBOX_TYPE_DELAYED);
  EXPECT_EQ(SANDBOX_TYPE_DELAYED, SandboxTypeFromCommandLine(command_line3));
  ...
  command_line5.AppendSwitchASCII(switches::kUtilityProcessSandboxType,
                                  "bogus");
  EXPECT_EQ(SANDBOX_TYPE_UTILITY, SandboxTypeFromCommandLine(command_line5));
