...
enum PushUnregistrationReason {
  ...
  // The Service Worker database got deleted, most likely due to corruption.
  PUSH_UNREGISTRATION_REASON_SERVICE_WORKER_DATABASE_DELETED = 10,
  ...
  PUSH_UNREGISTRATION_REASON_LAST =
      PUSH_UNREGISTRATION_REASON_SERVICE_WORKER_DATABASE_DELETED
};
