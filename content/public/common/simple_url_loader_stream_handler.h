...
class CONTENT_EXPORT SimpleURLLoaderStreamHandler {
 public:
  ...
  // Called on successful completion, or error. |success| is true if the request
  // received a 2xx response and the entire response body, false otherwise.
  //
  // SettubgAllowing partial responses
