...
class MockURLLoaderFactory : public mojom::URLLoaderFactory {
 public:
  ...
  void CreateLoaderAndStart(mojom::URLLoaderRequest url_loader_request,
    ...
    active_loader_ = url_loaders_.front().get();
    url_loaders_.back()->RunTest();
 ...
 private:
  base::test::ScopedTaskEnvironment* scoped_task_environment_;
  MockURLLoader* active_loader_ = nullptr;
...
TEST_P(SimpleURLLoaderTest, RetryOn5xx) {
  struct TestCase {
    ...
    bool expect_success;
      ...
      1 /* num_retries */, SimpleURLLoader::RETRY_ON_5XX, 1 /* num_5xx */,
      true /* expect_success */
  };
