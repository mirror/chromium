...
class SimpleLoaderTestHelper : public SimpleURLLoaderStreamHandler {
 public:
  ...
  // Returns the number of retries. Numer of retries are only exposed when
 ...
 private:
  ...
  // SimpleURLLoaderStreamHandler implementation:
  ...
  void OnComplete(bool success) override {
    ...
    download_as_stream_succeeded_ = success;
  ...
  bool download_as_stream_succeeded_ = false;
