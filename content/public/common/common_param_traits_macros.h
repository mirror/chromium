...
#endif
IPC_ENUM_TRAITS_MAX_VALUE(content::SavePreviousDocumentResourcesUntil,
                          content::SavePreviousDocumentResourcesUntil::LAST)
...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(save_previous_document_resources_until)
#if defined(OS_ANDROID)
