...
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::Event, ax::mojom::Event::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::Role, ax::mojom::Role::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::BoolAttribute, ax::mojom::BoolAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::FloatAttribute, ax::mojom::FloatAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::IntAttribute, ax::mojom::IntAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::IntListAttribute,
                          ax::mojom::IntListAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::StringListAttribute,
                          ax::mojom::StringListAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::StringAttribute, ax::mojom::StringAttribute::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::TextAffinity, ax::mojom::TextAffinity::LAST)
IPC_ENUM_TRAITS_MAX_VALUE(ax::mojom::EventFrom, ax::mojom::EventFrom::LAST)
