...
class CONTENT_EXPORT ContentBrowserClient {
 public:
  ...
  // Returns true if the initiating origins of |initiator| should be allowed to
  // receive a document at |url|, bypassing the usual blocking logic. Defaults
  // to false. This is called on the IO thread.
