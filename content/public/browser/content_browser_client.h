...
class CONTENT_EXPORT ContentBrowserClient {
 public:
  ...
  // Returns true if site isolation should be enabled for |url|.
  // This call allows the embedder to supplement the site isolation policy
  // enforced by the content layer.
  //
  // Will only be called if the content layer didn't decide to isolate site for
  // |real_url| according to its internal policy (e.g. because of
  // --site-per-process).
