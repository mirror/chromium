...
class CONTENT_EXPORT ContentBrowserClient {
 public:
  ...
  struct CONTENT_EXPORT OutOfProcessServiceInfo {
    ...
    OutOfProcessServiceInfo(base::string16 process_name,
    ...
    // Constant to make initializers more readable.
    static constexpr base::nullopt_t kNoProcessGroup = base::nullopt;
  };
