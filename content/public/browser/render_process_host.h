...
class CONTENT_EXPORT RenderProcessHost : public IPC::Sender,
 ...
 public:
  ...
  // "Keep alive ref count" is the number of users who wish the renderer process
  // to be alive. While the ref count is positive, |this| object will keep
  // the renderer process alive, unless DisableKeepAliveRefCount is called.
  //
