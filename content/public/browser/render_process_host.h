...
class CONTENT_EXPORT RenderProcessHost : public IPC::Sender,
 ...
 public:
  ...
  // A base file_path must be supplied, which will be extended to include
  ...
  virtual bool StartLocalRtcEventLogs(const base::FilePath& file_path) = 0;
  ...
  virtual bool StopLocalRtcEventLogs() = 0;
