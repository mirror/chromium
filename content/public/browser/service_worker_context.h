...
class ServiceWorkerContext {
 public:
  ...
  // Starts a Service Worker for a navigation hint to |document_url|. Must be
  // called from the UI thread. The |callback| will always be called on the UI
  // thread. This method can fail if no Service Worker was registered for
  // |document_url|.
