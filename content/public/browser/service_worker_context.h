...
#include "third_party/WebKit/public/platform/modules/serviceworker/service_worker_registration.mojom-shared.h"
#include "url/gurl.h"
...
class ServiceWorkerContext {
 public:
  ...
  // scope, updateViaCache: update_via_cache}). |callback| is passed true when
  // the JS promise is fulfilled or false when the JS promise is rejected.
  //
