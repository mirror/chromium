...
//
// ServiceWorkerContext is an abstract base class. The implementation of the
// non-virtual functions is in service_worker_context_wrapper.cc, which also
// contains ServiceWorkerContextWrapper, the primary implementation of this
// class.
