...
class NavigationController {
 public:
  ...
  using NavigationEntryScreenshotCallback =
      base::OnceCallback<void(ReadbackResponse)>;
  ...
  // overscroll gestures, when it is discarded to save memory).
  virtual void TakeScreenshot(NavigationEntryScreenshotCallback callback) = 0;
