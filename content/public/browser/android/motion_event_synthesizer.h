...
class CONTENT_EXPORT MotionEventSynthesizer {
 public:
  ...
  static std::unique_ptr<MotionEventSynthesizer> Create(
      WebContents* web_contents);

  // Sets the target view to which events are dispatched.
  virtual void SetTargetView(gfx::NativeView target);
