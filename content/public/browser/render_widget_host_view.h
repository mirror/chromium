...
class CONTENT_EXPORT RenderWidgetHostView {
 public:
  ...
  // Shows the view and forces it to act as if it was visible (it might not be
  // visible if it has an hidden parent or if it's occluded).
  virtual void ShowAndPretendIsVisible() = 0;
