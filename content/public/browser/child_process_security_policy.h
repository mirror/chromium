...
class ChildProcessSecurityPolicy {
 public:
  ...
  // the given origin. This is currently used to protect data such as cookies,
  // passwords, and local storage. Does not affect cookies attached to or set
  // by network requests.
  //
  ...
  // or for isolated origins that require a dedicated process, such as
  // accounts.google.com.
