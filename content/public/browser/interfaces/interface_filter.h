...
#define CONTENT_BROWSER_INTERFACES_INTERFACE_FILTER_H_
...
class InterfaceFilter {
 public:
  ...
  virtual bool IsAllowed(WebContextType context_type,
                         RenderProcessHost*,
                         RenderFrameHost*,
...
class InterfaceConfiguration {
 public:
  ...
  bool IsAllowed(WebContextType type,
...
#endif  // CONTENT_BROWSER_INTERFACES_INTERFACE_FILTER_H_
