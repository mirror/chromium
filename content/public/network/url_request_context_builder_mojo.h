...
// Specialization of URLRequestContextBuilder that can create a ProxyResolutionService
// that uses a Mojo ProxyResolver. The consumer is responsible for providing
// the proxy_resolver::mojom::ProxyResolverFactory.  If a ProxyResolutionService is set
