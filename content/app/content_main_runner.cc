...
class ContentMainRunnerImpl : public ContentMainRunner {
 public:
  ...
  int Initialize(const ContentMainParams& params) override {
    ...
    post_main_loop_init_closure_ = params.post_main_loop_init_closure;
...
// On Android, the ipc_fd is passed through the Java service.
  ...
  int Run() override {
    ...
    main_params.post_main_loop_init_closure = post_main_loop_init_closure_;
#if defined(OS_WIN)
 ...
 private:
  ...
  PostMainLoopInitClosure* post_main_loop_init_closure_ = nullptr;
