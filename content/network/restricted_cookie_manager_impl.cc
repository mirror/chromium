...
void RestrictedCookieManagerImpl::CreateMojoService(
  ...
  mojo::MakeStrongBinding(
      base::WrapUnique(new RestrictedCookieManagerImpl(
          cookie_store, render_process_id, render_frame_id)),
      std::move(request));
}
...
void RestrictedCookieManagerImpl::SetCanonicalCookie(
  ...
  // TODO(pwnall): Reason about whether it makes sense to allow a renderer set
  //               these fields.
