...
class CONTENT_EXPORT CookieManagerImpl : public content::mojom::CookieManager {
 public:
  ...
  void AddRequest(content::mojom::CookieManagerRequest request);
  ...
  void CloneInterface(
      content::mojom::CookieManagerRequest new_interface) override;
 ...
 private:
  ...
  mojo::BindingSet<content::mojom::CookieManager> bindings_;
