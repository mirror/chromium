...
class URLLoaderTest : public testing::Test {
 ...
 private:
  ...
  network::mojom::URLLoaderFactoryPtr loader_factory_;
...
TEST_F(URLLoaderTest, DestroyContextWithLiveRequest) {
  ...
  network::NetworkServiceURLLoaderFactory* loader_factory_impl =
      new network::NetworkServiceURLLoaderFactory(
          context(), 0 /* process_id */, mojo::MakeRequest(&loader_factory));
