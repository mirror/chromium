...
// Most test of this class are with NetworkContext's unittests.

// Makes sure that a ProxyObserver is correctly notified of changes when the
// ProxyConfig changes, and is not informed of them in the case of "changes"
// that result in the same ProxyConfig as before.
