...
class CONTENT_EXPORT NetworkChangeManagerImpl
 ...
 public:
  // If |create_network_change_notifier| is true, a net::NetworkChangeNotifier
  // will be created and owned by |this|.
  explicit NetworkChangeManagerImpl(bool create_network_change_notifier);
