...
class CONTENT_EXPORT NetworkChangeManagerImpl
 ...
 public:
  explicit NetworkChangeManagerImpl(service_manager::BinderRegistry* registry);
  ...
  // Simulates a connection type change. Used in testing.
  void SimulateConnectionTypeChangeForTesting(mojom::ConnectionType type);
