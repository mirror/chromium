...
class TestNetworkChangeManagerClient
 ...
 public:
  ...
  // Waits for the desired |connection_type| notification. If system's
  // net::NetworkChangeNotifier is used, there might be an initial notification
  // of the current connection type.
