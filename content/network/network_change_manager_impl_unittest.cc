...
// ChromeOS has a different code path to set up net::NetworkChangeNotifier.
#if defined(OS_CHROMEOS)
#define MAYBE_OneCientPipeBroken DISABLED_OneClientPipeBroken
#else
#define MAYBE_OneCientPipeBroken OneClientPipeBroken
#endif
TEST_F(NetworkChangeManagerImplTest, DISABLED_OneClientPipeBroken) {
