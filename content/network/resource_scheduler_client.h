...
class CONTENT_EXPORT ResourceSchedulerClient final
 ...
 public:
  ...
  // Detaches this client from the ResourceScheduler. This function must be
  // called, or this instance must be destructed, before the associated
  // NetworkContext is destructed.
  void Detach();
