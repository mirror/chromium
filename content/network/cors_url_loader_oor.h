...
#ifndef CONTENT_NETWORK_CORS_URL_LOADER_OOR_H_
#define CONTENT_NETWORK_CORS_URL_LOADER_OOR_H_
...
// created it.
class CONTENT_EXPORT CORSURLLoaderOOR : public mojom::URLLoader,
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CORSURLLoaderOOR);
};

}  // namespace content

#endif  // CONTENT_NETWORK_CORS_URL_LOADER_OOR_H_
