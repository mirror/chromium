...
#include "content/public/common/checked_cookie_manager.mojom.h"
...
class CONTENT_EXPORT CheckedCookieManagerImpl
    : public mojom::CheckedCookieManager {
 public:
  ~CheckedCookieManagerImpl() override;
 ...
 private:
  ...
  base::WeakPtrFactory<CheckedCookieManagerImpl> weak_ptr_factory_;

  DISALLOW_COPY_AND_ASSIGN(CheckedCookieManagerImpl);
};
