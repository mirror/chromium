...
class TestProxyConfigServiceObserver
 ...
 public:
  ...
  void OnProxyConfigChanged(
    ...
    // The ControlledProxyConfigService only sends on availability state.
...
TEST(ControlledProxyConfigServiceTest, ObserveProxyChanges) {
  base::test::ScopedTaskEnvironment scoped_task_environment(
      base::test::ScopedTaskEnvironment::MainThreadType::IO);

  mojom::ProxyConfigClientAssociatedPtr config_client;
  ControlledProxyConfigService proxy_config_service(
      nullptr, base::Optional<net::ProxyConfig>(),
