...
class CONTENT_EXPORT NetworkChangeManagerClientImpl
 ...
 public:
  ...
  // Initializes the per-process global NetworkChangeManagerClientImpl. Must
  // be called on BrowserThread::UI. This must be called before all other
  // static methods can be called.
  static void Initialize(mojom::NetworkService* network_service);
  ...
  static mojom::ConnectionType GetConnectionType();
  ...
  static mojom::ConnectionSubtype GetConnectionSubtype();
 ...
 protected:
  ...
  mojom::ConnectionType GetCurrentConnectionType() const;
  mojom::ConnectionSubtype GetCurrentConnectionSubtype() const;
