...
class CONTENT_EXPORT RestrictedCookieManagerImpl
 ...
 public:
  ...
  // Creates a service that will be served from RenderFrameHost. Once the
  // network service launches, this will go away and consumers will get
  // RestrictedCookieManager instances from NetworkService.
