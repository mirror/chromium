...
ServiceWorkerDispatcher::GetOrCreateRegistrationForController(
  ...
  auto registration = base::MakeRefCounted<WebServiceWorkerRegistrationImpl>(
      std::move(info), binding_task_runner);
...
scoped_refptr<WebServiceWorkerRegistrationImpl>
ServiceWorkerDispatcher::GetOrAdoptRegistrationForControllee(
    blink::mojom::ServiceWorkerRegistrationObjectInfoPtr info,
    const ServiceWorkerVersionAttributes& attrs) {
