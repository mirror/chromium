...
struct ServiceWorkerProviderContext::ControllerState {
  ...
  // ServiceWorkerProviderContext::TakeRegistrationStartupInfo().
...
void ServiceWorkerProviderContext::SaveRegistrationStartupInfo(
    blink::mojom::ServiceWorkerRegistrationObjectInfoPtr registration,
    std::unique_ptr<ServiceWorkerHandleReference> installing,
    std::unique_ptr<ServiceWorkerHandleReference> waiting,
    std::unique_ptr<ServiceWorkerHandleReference> active) {
...
void ServiceWorkerProviderContext::TakeRegistrationStartupInfo(
  ...
  // |info| takes |state->registration->host_ptr_info|.
