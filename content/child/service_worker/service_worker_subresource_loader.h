...
class CONTENT_EXPORT ServiceWorkerSubresourceLoader
    : public mojom::URLLoader, public mojom::URLLoaderClient {
 public:
  // |event_dispatcher| and |blob_loader_factory| are supposed to outlive
  // this instance.
 ...
 private:
  ...
  void StartResponse(ServiceWorkerFetchEventResult fetch_result,
