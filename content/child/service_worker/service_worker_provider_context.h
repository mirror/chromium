...
//  - For controllees, this is used for keeping the
//    the controller alive to create controllee's ServiceWorkerContainer.
//    references to them are kept until or OnSetControllerServiceWorker() is
//    called with an invalid worker info.
//  - For controllers, this is used for keeping the associated registration and
//    its versions alive to create controller's ServiceWorkerGlobalScope.
