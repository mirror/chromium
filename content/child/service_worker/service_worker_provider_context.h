...
class CONTENT_EXPORT ServiceWorkerProviderContext
 ...
 public:
  ...
  // TakeRegistrationStartupInfo(), called on the main thread.
  // SaveRegistrationStartupInfo() is called during the setup for service worker
  // startup, so it is guaranteed to be called before
  // TakeRegistrationStartupInfo().
  void SaveRegistrationStartupInfo(
  ...
  void TakeRegistrationStartupInfo(
