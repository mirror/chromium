...
// To allow mojo::ServiceWorkerEventDispatcherPtr to be co-owned by
// multiple holders.
class CONTENT_EXPORT ServiceWorkerEventDispatcherHolder
 ...
 public:
  ...
  mojom::ServiceWorkerEventDispatcher* get() {
    if (event_dispatcher_rawptr_for_testing_)
      return event_dispatcher_rawptr_for_testing_;
 ...
 private:
  ...
  mojom::ServiceWorkerEventDispatcher* event_dispatcher_rawptr_for_testing_;
