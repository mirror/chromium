...
class HttpRequestHeadersVisitor : public blink::WebHTTPHeaderVisitor {
 public:
  explicit HttpRequestHeadersVisitor(
  ...
  void VisitHeader(const WebString& name, const WebString& value) override {
    ...
    headers_->emplace_back(name_latin1, value_latin1);
  }

 private:
  net::HttpRequestHeaders::HeaderVector* const headers_;
};
...
net::HttpRequestHeaders GetWebURLRequestHeaders(
  ...
  HttpRequestHeadersVisitor visitor(&header_vector);
