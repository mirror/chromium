...
class FontFallbackUnitTest : public testing::Test {
 public:
  FontFallbackUnitTest() {
    ...
    DWriteFontCollectionProxy::Factory(&collection_, factory_.Get(),
...
TEST_F(FontFallbackUnitTest, MapCharacters) {
  ...
  FontFallback::Factory(&fallback, collection_.Get(),
                        fake_collection_->GetSender());
  ...
  gfx::win::TextAnalysisSource::Factory(&text, L"hello", L"en-us",
...
TEST_F(FontFallbackUnitTest, CacheMissShouldRepeatIPC) {
  ...
  gfx::win::TextAnalysisSource::Factory(&unmappable_text, L"\uffff", L"en-us",
                                        number_substitution_.Get(),
                                        DWRITE_READING_DIRECTION_LEFT_TO_RIGHT);
  fallback->MapCharacters(text.Get(), 0, 5, nullptr, nullptr,
                          DWRITE_FONT_WEIGHT_NORMAL, DWRITE_FONT_STYLE_NORMAL,
...
TEST_F(FontFallbackUnitTest, SurrogatePairCacheHit) {
  ...
  gfx::win::TextAnalysisSource::Factory(&surrogate_pair_text, L"\U0001d300",
