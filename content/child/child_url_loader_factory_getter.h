...
class ChildURLLoaderFactoryGetter
 ...
 public:
  ...
  using URLLoaderFactoryGetterCallback =
      base::OnceCallback<PossiblyAssociatedURLLoaderFactory()>;
 ...
 private:
  ...
  // Either factory_getter or factory is non-null.
  URLLoaderFactoryGetterCallback network_loader_factory_getter_;
