...
#ifndef CONTENT_CHILD_LOADER_CROSS_ORIGIN_PREFLIGHT_RESULT_CACHE_H_
#define CONTENT_CHILD_LOADER_CROSS_ORIGIN_PREFLIGHT_RESULT_CACHE_H_
...
class CONTENT_EXPORT CrossOriginPreflightResultCacheItem {
 ...
 private:
  ...
  // (https://tools.ietf.org/html/rfc2616#section-5.1.1), header names are not
...
#endif  // CONTENT_CHILD_LOADER_CROSS_ORIGIN_PREFLIGHT_RESULT_CACHE_H_
