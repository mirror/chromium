...
ChildURLLoaderFactoryGetter::ChildURLLoaderFactoryGetter(
    URLLoaderFactoryGetterCallback network_loader_factory_getter,
    URLLoaderFactoryGetterCallback blob_loader_factory_getter)
    : network_loader_factory_getter_(std::move(network_loader_factory_getter)),
...
ChildURLLoaderFactoryGetter::GetNetworkLoaderFactory() {
  if (!network_loader_factory_) {
    DCHECK(!network_loader_factory_getter_.is_null());
    network_loader_factory_ = std::move(network_loader_factory_getter_).Run();
  }
