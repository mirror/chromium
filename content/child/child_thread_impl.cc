...
void ChildThreadImpl::Init(const Options& options) {
  ...
  // DO NOT SUBMIT - only execute the code below if we are not in the browser
  // process (to duplicate the behavior of GpuChildThread and
  // ChromeContentGpuClient::Initialize).
  if (true) {
