...
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kUncached, APPCACHE_STATUS_UNCACHED);
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kIdle, APPCACHE_STATUS_IDLE);
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kChecking, APPCACHE_STATUS_CHECKING);
...
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kObsolete, APPCACHE_STATUS_OBSOLETE);
...
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kCachedEvent, APPCACHE_CACHED_EVENT);
...
STATIC_ASSERT_ENUM(WebApplicationCacheHost::kPolicyError, APPCACHE_POLICY_ERROR);
