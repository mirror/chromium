...
void GpuServiceFactory::RegisterServices(ServiceMap* services) {
  ...
  // This service will host audio/video decoders which can be computationally
  // intensive. Thus it "may block". Also if these decoding operations are
  // blocked, user may hear audio glitch or see video freezing, hence "user
  // blocking".
  // TODO(xhwang): Investigate whether this needs to be single threaded.
