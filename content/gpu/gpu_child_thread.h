...
class GpuChildThread : public ChildThreadImpl, public viz::VizMain::Delegate {
 public:
  GpuChildThread(std::unique_ptr<gpu::GpuInit> gpu_init,
                 viz::VizMain::LogMessages deferred_messages);
