...
class HistoryNavigationBeforeCommitInjector
 ...
 public:
  HistoryNavigationBeforeCommitInjector(WebContentsImpl* web_contents,
      ...
      : DidCommitProvisionalLoadInterceptor(web_contents),
        did_triggery_history_navigation_(false),
        url_(url) {}
  ~HistoryNavigationBeforeCommitInjector() override {}

  bool did_triggery_history_navigation() const {
    return did_triggery_history_navigation_;
  }
 ...
 private:
  ...
  void WillDispatchDidCommitProvisionalLoad(
    ...
    if (params.url == url_) {
      did_triggery_history_navigation_ = true;
      web_contents()->GetController().GoBack();
    }
  }

  bool did_triggery_history_navigation_;
  GURL url_;
...
IN_PROC_BROWSER_TEST_F(
  ...
  EXPECT_TRUE(trigger.did_triggery_history_navigation());
