...
void RenderFrameHostManager::Init(
  ...
  SetRenderFrameHost(CreateRenderFrameHost(
      ...
      std::move(initial_interfaces_request), widget_routing_id,
...
RenderFrameHostManager::CreateRenderFrameHost(
  ...
  return RenderFrameHostFactory::Create(
      ...
      std::move(initial_interfaces_request), widget_routing_id, hidden,
...
std::unique_ptr<RenderFrameHostImpl> RenderFrameHostManager::CreateRenderFrame(
  ...
  new_render_frame_host =
      CreateRenderFrameHost(instance, MSG_ROUTING_NONE, MSG_ROUTING_NONE,
                            nullptr, widget_routing_id, hidden, false);
