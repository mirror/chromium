...
RenderFrameHostManager::GetSiteInstanceForNavigation(
  ...
  // the last URL it sucessfully committed. If it has yet to commit a URL, this
  // is the Site URL of its SiteInstance.
  ...
  // RenderFrameHost was swapped in at the beginning of the navigation.
