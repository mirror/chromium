...
TEST_F(RenderFrameHostManagerTestWithSiteIsolation, DetachPendingChild) {
  ...
  contents()->GetMainFrame()->OnCreateChildFrame(
      contents()->GetMainFrame()->GetProcess()->GetNextRoutingID(), nullptr,
...
TEST_F(RenderFrameHostManagerTestWithSiteIsolation,
  ...
  contents1->GetMainFrame()->OnCreateChildFrame(
      contents1->GetMainFrame()->GetProcess()->GetNextRoutingID(), nullptr,
      blink::WebTreeScopeType::kDocument, "frame_name", "uniqueName1",
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
...
TEST_F(RenderFrameHostManagerTestWithSiteIsolation,
  ...
  main_rfh->OnCreateChildFrame(
      main_rfh->GetProcess()->GetNextRoutingID(), nullptr,
...
TEST_F(RenderFrameHostManagerTest, TraverseComplexOpenerChain) {
  ...
  tree1->AddFrame(root1, process_id, 12, nullptr,
  ...
  tree1->AddFrame(root1, process_id, 13, nullptr,
                  blink::WebTreeScopeType::kDocument, std::string(),
  ...
  tree2->AddFrame(root2, process_id, 22, nullptr,
                  blink::WebTreeScopeType::kDocument, std::string(),
                  "uniqueName2", blink::WebSandboxFlags::kNone,
                  ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  tree2->AddFrame(root2, process_id, 23, nullptr,
                  blink::WebTreeScopeType::kDocument, std::string(),
  ...
  tree4->AddFrame(root4, process_id, 42, nullptr,
                  blink::WebTreeScopeType::kDocument, std::string(),
...
TEST_F(RenderFrameHostManagerTest, PageFocusPropagatesToSubframeProcesses) {
  ...
  main_test_rfh()->OnCreateChildFrame(
      main_test_rfh()->GetProcess()->GetNextRoutingID(), nullptr,
