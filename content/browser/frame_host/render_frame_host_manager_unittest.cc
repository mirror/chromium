...
TEST_F(RenderFrameHostManagerTest, Navigate) {
  ...
  NavigationEntryImpl entry1(
      ...
      ui::PAGE_TRANSITION_TYPED, false /* is_renderer_init */, nullptr);
  ...
  NavigationEntryImpl entry3(nullptr /* instance */, kUrl3,
                             ...
                             base::string16() /* title */,
                             ui::PAGE_TRANSITION_LINK,
                             false /* is_renderer_init */, nullptr);
...
TEST_F(RenderFrameHostManagerTest, WebUIInNewTab) {
  ...
  NavigationEntryImpl entry2(
      ...
      ui::PAGE_TRANSITION_LINK, true /* is_renderer_init */, nullptr);
...
TEST_F(RenderFrameHostManagerTestWithSiteIsolation,
  ...
  NavigationEntryImpl webui_entry(nullptr /* instance */, kWebUIUrl, Referrer(),
                                  base::string16() /* title */,
                                  ui::PAGE_TRANSITION_TYPED,
                                  false /* is_renderer_init */, nullptr);
  ...
  NavigationEntryImpl subframe_entry(nullptr /* instance */, kSubframeUrl,
...
TEST_F(RenderFrameHostManagerTest, RestoreNavigationToWebUI) {
  ...
  NavigationEntryImpl entry(nullptr /* instance */, kInitUrl, Referrer(),
                            base::string16() /* title */,
