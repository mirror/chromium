...
class CONTENT_EXPORT NavigationRequest : public NavigationURLLoaderDelegate {
 ...
 private:
  ...
  // Wheter the navigation request was created via browser-initiated navigations
  // or renderer-inititated navigations started via the OpenURL path.
  // From this is inferred that the request may be transferred to a different
  // process upon commit.
