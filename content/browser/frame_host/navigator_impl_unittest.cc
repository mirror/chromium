...
class NavigatorTestWithBrowserSideNavigation
 ...
 public:
  ...
  void TearDown() override {
    EnsureNavigationIsCompleted();
    RenderViewHostImplTestHarness::TearDown();
  }

  void EnsureNavigationIsCompleted() {
    // Run all the remaining tasks in the message queue that may handle
    // NavigationRequest in pending delete status.
