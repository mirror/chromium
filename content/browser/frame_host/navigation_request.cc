...
void NavigationRequest::OnRequestRedirected(
  ...
  if (should_override_url_loading) {
    // Update the url of the navigation handle to ensure AwWebContents receives
    // the new URL and thus passes that URL to onPageFinished (rather than
    // passing the old URL).
    navigation_handle_->set_url(redirect_info.new_url);
