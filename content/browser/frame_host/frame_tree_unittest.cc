...
TEST_F(FrameTreeTest, Shape) {
  ...
  frame_tree->AddFrame(
      root, process_id, 14, blink::WebTreeScopeType::kDocument, std::string(),
      "uniqueName0", blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      root, process_id, 15, blink::WebTreeScopeType::kDocument, std::string(),
      "uniqueName1", blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      root, process_id, 16, blink::WebTreeScopeType::kDocument, std::string(),
      "uniqueName2", blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 244, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName3", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      root->child_at(1), process_id, 255, blink::WebTreeScopeType::kDocument,
      no_children_node, "uniqueName4", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 245, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName5", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  ...
  frame_tree->AddFrame(
      child_16, process_id, 264, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName6", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      child_16, process_id, 265, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName7", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      child_16, process_id, 266, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName8", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      child_16, process_id, 267, blink::WebTreeScopeType::kDocument,
      deep_subtree, "uniqueName9", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
  frame_tree->AddFrame(
      child_16, process_id, 268, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName10", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());

  FrameTreeNode* child_267 = child_16->child_at(3);
  frame_tree->AddFrame(
      child_267, process_id, 365, blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName11", blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties(), std::string());
