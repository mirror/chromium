...
CreateIsolatedInterfacesRequest() {
  return TestRenderFrameHost::CreateIsolatedInterfacesRequest();
}
...
TEST_F(FrameTreeTest, Shape) {
  ...
  frame_tree->AddFrame(root, process_id, 14, CreateIsolatedInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
                       "uniqueName0", base::UnguessableToken::Create(),
                       FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(root, process_id, 15, CreateIsolatedInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
                       "uniqueName1", base::UnguessableToken::Create(),
                       FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(root, process_id, 16, CreateIsolatedInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
                       "uniqueName2", base::UnguessableToken::Create(),
                       FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 244, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName3",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(1), process_id, 255, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, no_children_node, "uniqueName4",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 245, CreateIsolatedInterfacesRequest(),
  ...
  frame_tree->AddFrame(
      child_16, process_id, 264, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName6",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 265, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName7",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 266, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName8",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 267, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, deep_subtree, "uniqueName9",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 268, CreateIsolatedInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName10",
      base::UnguessableToken::Create(), FramePolicy(), FrameOwnerProperties());

  FrameTreeNode* child_267 = child_16->child_at(3);
  frame_tree->AddFrame(
      child_267, process_id, 365, CreateIsolatedInterfacesRequest(),
  ...
  frame_tree->AddFrame(child_267->child_at(0)->child_at(0)->child_at(0),
                       process_id, 655, CreateIsolatedInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
...
TEST_F(FrameTreeTest, FindFrames) {
  ...
  main_test_rfh()->OnCreateChildFrame(
      22, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child0", "uniqueName0", base::UnguessableToken::Create(), FramePolicy(),
      FrameOwnerProperties());
  main_test_rfh()->OnCreateChildFrame(
      23, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child1", "uniqueName1", base::UnguessableToken::Create(), FramePolicy(),
      FrameOwnerProperties());
  main_test_rfh()->OnCreateChildFrame(
      24, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
  ...
  child1->current_frame_host()->OnCreateChildFrame(
      33, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
...
TEST_F(FrameTreeTest, GetSibling) {
  ...
  main_test_rfh()->OnCreateChildFrame(
      24, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child2", "uniqueName2", base::UnguessableToken::Create(), FramePolicy(),
      FrameOwnerProperties());
  FrameTreeNode* child0 = root->child_at(0);
  FrameTreeNode* child1 = root->child_at(1);
  FrameTreeNode* child2 = root->child_at(2);
...
TEST_F(FrameTreeTest, ObserverWalksTreeDuringFrameCreation) {
  ...
  // Simulate attaching a series of frames to build the frame tree.
  main_test_rfh()->OnCreateChildFrame(
      14, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
  ...
  EXPECT_EQ(
      ...
      activity.GetLog());
  main_test_rfh()->OnCreateChildFrame(
      18, CreateIsolatedInterfacesRequest(), blink::WebTreeScopeType::kDocument,
...
TEST_F(FrameTreeTest, FailAddFrameWithWrongProcessId) {
  ...
  ASSERT_FALSE(frame_tree->AddFrame(
      root, process_id + 1, 1, CreateIsolatedInterfacesRequest(),
