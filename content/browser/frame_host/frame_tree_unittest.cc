...
CreateDeadEndInterfacesRequest() {
  return TestRenderFrameHost::CreateDeadEndInterfacesRequest();
}
...
TEST_F(FrameTreeTest, Shape) {
  ...
  frame_tree->AddFrame(root, process_id, 14, CreateDeadEndInterfacesRequest(),
  ...
  frame_tree->AddFrame(root, process_id, 15, CreateDeadEndInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
                       "uniqueName1", base::UnguessableToken::Create(),
                       blink::WebSandboxFlags::kNone,
                       ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(root, process_id, 16, CreateDeadEndInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
                       "uniqueName2", base::UnguessableToken::Create(),
                       blink::WebSandboxFlags::kNone,
                       ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 244, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName3",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(1), process_id, 255, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, no_children_node, "uniqueName4",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      root->child_at(0), process_id, 245, CreateDeadEndInterfacesRequest(),
  ...
  frame_tree->AddFrame(
      child_16, process_id, 264, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName6",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 265, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName7",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 266, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName8",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 267, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, deep_subtree, "uniqueName9",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_16, process_id, 268, CreateDeadEndInterfacesRequest(),
  ...
  frame_tree->AddFrame(
      child_267, process_id, 365, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName11",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  frame_tree->AddFrame(
      child_267->child_at(0), process_id, 455, CreateDeadEndInterfacesRequest(),
      blink::WebTreeScopeType::kDocument, std::string(), "uniqueName12",
      base::UnguessableToken::Create(), blink::WebSandboxFlags::kNone,
      ParsedFeaturePolicyHeader(), FrameOwnerProperties());
  ...
  frame_tree->AddFrame(child_267->child_at(0)->child_at(0)->child_at(0),
                       process_id, 655, CreateDeadEndInterfacesRequest(),
                       blink::WebTreeScopeType::kDocument, std::string(),
...
TEST_F(FrameTreeTest, FindFrames) {
  ...
  main_test_rfh()->OnCreateChildFrame(
      22, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child0", "uniqueName0", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
  main_test_rfh()->OnCreateChildFrame(
      23, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child1", "uniqueName1", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
  main_test_rfh()->OnCreateChildFrame(
      24, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName2", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
  ...
  child1->current_frame_host()->OnCreateChildFrame(
      33, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "grandchild", "uniqueName3", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
...
TEST_F(FrameTreeTest, GetSibling) {
  ...
  main_test_rfh()->OnCreateChildFrame(
      24, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      "child2", "uniqueName2", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
  FrameTreeNode* child0 = root->child_at(0);
  FrameTreeNode* child1 = root->child_at(1);
...
TEST_F(FrameTreeTest, ObserverWalksTreeDuringFrameCreation) {
  ...
  // Simulate attaching a series of frames to build the frame tree.
  main_test_rfh()->OnCreateChildFrame(
      14, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
  ...
  EXPECT_EQ(
      ...
      activity.GetLog());
  main_test_rfh()->OnCreateChildFrame(
      18, CreateDeadEndInterfacesRequest(), blink::WebTreeScopeType::kDocument,
      std::string(), "uniqueName1", base::UnguessableToken::Create(),
      blink::WebSandboxFlags::kNone, ParsedFeaturePolicyHeader(),
      FrameOwnerProperties());
  EXPECT_EQ(
...
TEST_F(FrameTreeTest, FailAddFrameWithWrongProcessId) {
  ...
  ASSERT_FALSE(frame_tree->AddFrame(
      root, process_id + 1, 1, CreateDeadEndInterfacesRequest(),
