...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 private:
  ...
  // The InterfaceProvider binding which receives messages from the currently
  // navigated document. This is always rebound on navigation commit, so any
  // GetInterface messages it dispatches are guaranteed to pertain to the last
  // committed URL.
