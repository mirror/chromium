...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 private:
  ...
  // This is bound to a message pipe endpoint lazily. Normally, whoever creates
  // this RFHI, is responsible for creating that message pipe, then supplying
  // the request end to BindInterfacesRequest(), and plumbing the client end to
  // the RenderFrame in the renderer process.
  //
