...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  // unregister itself by passing in nullptr. This mechanism can be used in unit
  // and browser tests to redirect these calls to a testing object.
 ...
 private:
  ...
  // By default, forwards all mojo::FrameHost calls to this RFHI. In unit and
  // browser tests, however, it can be configured to redirect these calls to a
