...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  using ExtractSmartClipDataCallback =
      base::CallbackRepeating<void(const base::string16&,
                                   const base::string16&)>;

  void RequestSmartClipExtract(const ExtractSmartClipDataCallback& callback,
                               gfx::Rect rect);

  void OnSmartClipDataExtracted(int32_t id,
