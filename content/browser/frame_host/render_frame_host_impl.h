...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  // RenderFrame with |new_routing_id|. The |interfaces_request| is the
  // request end of the InterfaceProvider interface that the RenderFrameHost
  // corresponding to the child should bind to expose services to the
  // renderer. The caller takes care of sending down the client end of the pipe
  // to the child RenderFrame to use.
