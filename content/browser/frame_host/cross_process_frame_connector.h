...
class CONTENT_EXPORT CrossProcessFrameConnector
 ...
 private:
  ...
  // The last physical backing size received from the parent renderer.
  // |last_received_physical_backing_size_| may be in DIP if use zoom for DSF is
  // off.
  gfx::Size last_received_physical_backing_size_;
