...
class TestSSLStatusData : public SSLStatus::UserData {
 public:
  TestSSLStatusData() : SSLStatus::UserData() {}
...
TEST_F(NavigationEntryTest, SSLStatusUserData) {
  ...
  SSLStatus ssl;
  ssl.SetUserData(base::MakeUnique<TestSSLStatusData>());
  TestSSLStatusData* ssl_data =
      static_cast<TestSSLStatusData*>(ssl.GetUserData());
  ...
  TestSSLStatusData* cloned_ssl_data =
      static_cast<TestSSLStatusData*>(cloned.GetUserData());
