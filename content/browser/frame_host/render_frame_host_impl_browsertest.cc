...
IN_PROC_BROWSER_TEST_F(RenderFrameHostImplBrowserTest,
  ...
  // There should have been a NavigationStateChange event for invalidating the
  // URL in the address bar, to avoid leaving the stale URL visible.
  EXPECT_EQ(1, dialog_manager.url_invalidate_count());
