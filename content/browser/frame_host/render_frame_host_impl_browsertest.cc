...
class PrerenderTestContentBrowserClient : public TestContentBrowserClient {
 public:
  PrerenderTestContentBrowserClient()
      : override_enabled_(false),
        visibility_override_(blink::mojom::WebPageVisibilityState::kVisible) {}
  ~PrerenderTestContentBrowserClient() override {}

  void EnableVisibilityOverride(
      blink::mojom::WebPageVisibilityState visibility_override) {
 ...
 private:
  ...
  blink::mojom::WebPageVisibilityState visibility_override_;
...
IN_PROC_BROWSER_TEST_F(RenderFrameHostImplBrowserTest,
  ...
  EXPECT_EQ(blink::mojom::WebPageVisibilityState::kVisible,
            web_contents->GetMainFrame()->GetVisibilityState());

  web_contents->WasHidden();
  EXPECT_EQ(blink::mojom::WebPageVisibilityState::kHidden,
            web_contents->GetMainFrame()->GetVisibilityState());
}
...
IN_PROC_BROWSER_TEST_F(RenderFrameHostImplBrowserTest,
  ...
  new_client.EnableVisibilityOverride(
      blink::mojom::WebPageVisibilityState::kPrerender);
  EXPECT_EQ(blink::mojom::WebPageVisibilityState::kPrerender,
            web_contents->GetMainFrame()->GetVisibilityState());
