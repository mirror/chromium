...
// real committed load. This happens when the security origin of the two
// documents are the same. We do not want to recalculate this in the browser
// process, however, so in for the first commit it is up to the renderer whether
// it wants to replace the InterfaceProvider connection or not.
IN_PROC_BROWSER_TEST_F(RenderFrameHostImplBrowserTest,
