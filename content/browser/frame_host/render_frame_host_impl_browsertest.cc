...
// With browser-side-navigation (aka PlzNavigate), a navigation is started in
// the browser process. After the headers are received, the URLLoaderCLient is
// transfered from the browser process to the renderer process and will continue
// the navigation.  This test ensures that when the the URLLoader is deleted
// while the URLLoaderClient is in the renderer side, the navigation stops
// properly.
