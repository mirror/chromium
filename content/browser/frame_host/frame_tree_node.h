...
class CONTENT_EXPORT FrameTreeNode {
 public:
  ...
  // may not yet have taken effect, since sandbox flag and allow updates in an
  // <iframe> element take effect on next navigation. To retrieve the currently
  // active policy for this frame, use effective_frame_policy().
