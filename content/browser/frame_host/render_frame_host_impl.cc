...
bool RenderFrameHostImpl::OnMessageReceived(const IPC::Message &msg) {
  ...
  IPC_BEGIN_MESSAGE_MAP(RenderFrameHostImpl, msg)
    ...
    IPC_MESSAGE_HANDLER(FrameHostMsg_AddResourceTimingToParent,
                        OnAddResourceTimingToParent)
...
void RenderFrameHostImpl::OnAddResourceTimingToParent(
  ...
  // TODO(dcheng): update the RFH and all RFPH to suppress further resource
  // timing info.
  ...
  proxy->Send(new FrameMsg_AddResourceTimingToParent(proxy->GetRoutingID(),
                                                     resource_timing));
}
