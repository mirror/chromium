...
class ScopedCommitStateResetter {
 public:
  ...
  ~ScopedCommitStateResetter() {
    ...
    render_frame_host_->SetNavigationRequest(
...
RenderFrameHostImpl::~RenderFrameHostImpl() {
  // Destroying navigation request may call into delegates/observers,
...
void RenderFrameHostImpl::FailedNavigation(
  ...
  if (frame_tree_node_->navigation_request() &&
      frame_tree_node_->navigation_request()->navigation_handle())
    DCHECK_NE(net::OK, frame_tree_node_->navigation_request()
                           ->navigation_handle()
                           ->GetNetErrorCode());
}
...
RenderFrameHostImpl::TakeNavigationHandleForCommit(
  ...
  if (params.was_within_same_document) {
    ...
    if (is_browser_initiated && navigation_handle &&
      ...
      return navigation_request()->TakeNavigationHandle();
    }
