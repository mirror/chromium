...
void RenderFrameHostImpl::SetNavigationHandle(
    std::unique_ptr<NavigationHandleImpl> navigation_handle) {
  // bool was_already_loading = navigation_handle_ || is_loading_; //
  // frame_tree_node_->frame_tree()->IsLoading(); if (was_already_loading) {
  //   had_double_load_ = true;
  //   LOG(WARNING) << "REGISTERING had_double_load_";
  // }
...
bool RenderFrameHostImpl::set_is_loading(bool is_loading) {
  // if (!IsBrowserSideNavigationEnabled()) {
  ...
  // Creates a buffer
  // if (is_loading) {
  //     bool was_already_loading = frame_tree_node_->frame_tree()->IsLoading();
  //     if (was_already_loading) {
  //       had_double_load_ = true;
  //       return false;
  //     }
  // } else if (had_double_load_) {
  //   had_double_load_ = false;
  //   return false;
  // }
...
void RenderFrameHostImpl::OnDidStopLoading() {
  ...
  if (frame_tree_node_->had_double_load()) {
    frame_tree_node_->set_had_double_load(false);
    return;
  }
