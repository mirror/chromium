...
RenderFrameHostImpl::RenderFrameHostImpl(SiteInstance* site_instance,
  ...
  // as it is loaded or when SetLastCommittedOrigin(origin) is called.
  // This is necessary to define 'self' right now because the initial navigation
  // needs to enforce CSP correctly.
