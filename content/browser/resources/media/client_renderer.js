...
var ClientRenderer = (function() {
  var ClientRenderer = function() {
    ...
    copyAllButton.onclick = this.copyAllToClipboard_.bind(this);
  ...
  ClientRenderer.prototype = {
    ...
    redrawVideoCaptureCapabilities: function(videoCaptureCapabilities, keys) {
      ...
      copyButtonElement.onclick = function() {
        this.showClipboard_(JSON.stringify(videoCaptureCapabilities, null, 2));
      }.bind(this);
    ...
    showClipboard_: function(string) {
    ...
    copyToClipboard_: function() {
      ...
      this.showClipboard_(stringBuffer.join(''));
    },

    copyAllToClipboard_: function() {
      this.showClipboard_(JSON.stringify(this.players, null, 2));
    },
