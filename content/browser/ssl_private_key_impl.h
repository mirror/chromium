...
class SSLPrivateKeyImpl : public mojom::SSLPrivateKey {
 public:
  ...
  void Sign(uint16_t algorithm,
            ...
            mojom::SSLPrivateKey::SignCallback callback) override;

 private:
  void Callback(mojom::SSLPrivateKey::SignCallback callback,
                net::Error net_error,
