...
class LockManager::OriginState {
 public:
  ...
  void Drop(const std::string& name) {
    ...
    // Update sets used for quick tests.
    shared_.erase(name);
    exclusive_.erase(name);
    DCHECK(IsGrantable(name, LockMode::EXCLUSIVE));
  }
