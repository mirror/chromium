...
ChildProcessLauncherHelper::LaunchProcessOnLauncherThread(
  ...
  // HACK: Remove a really long command line argument to work around Fuchsia's
  // intolerance of long flags.
  // TODO(fuchsia): Remove this when Fuchsia bug MG-1038 is fixed.
  base::CommandLine scrubbed_commandline({command_line()->argv()[0]});
