...
class HistogramController {
 public:
  ...
  // Contact all |clients_| and get their histogram data.
  ...
  void RegisterClientOnIoThread(mojom::HistogramControllerClientPtr client);
 ...
 private:
  ...
  void GetHistogramDataFromClients(
      int sequence_number,
      mojo::InterfacePtrSet<mojom::HistogramControllerClient>* clients,
      bool end);

  mojo::InterfacePtrSet<mojom::HistogramControllerClient> ui_thread_clients_;
  mojo::InterfacePtrSet<mojom::HistogramControllerClient> io_thread_clients_;
