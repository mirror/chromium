...
class CONTENT_EXPORT BackgroundFetchScheduler
 ...
 public:
  ...
  class CONTENT_EXPORT Controller {
   ...
   protected:
    explicit Controller(const BackgroundFetchRegistrationId& registration_id,
  ...
  class CONTENT_EXPORT RequestProvider {
   public:
    ...
    // Retrieve the next pending request for |registration_id| and invoke
    // |callback| with it.
  ...
  // void OnDownloadPaused(const std::string& download_guid);

  // void OnDownloadResumed(const std::string& download_guid);

  // void OnDownloadCancelled(const std::string& download_guid);
  ...
  void OnUserAborted(const BackgroundFetchRegistrationId& registration_id,
