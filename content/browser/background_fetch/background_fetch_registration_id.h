...
class CONTENT_EXPORT BackgroundFetchRegistrationId {
 public:
  ...
  // The ID provided by the website.
  //
  ...
  // Always use this instead of |developer_id| (APIs that receive an
  // |developer_id| from the website must convert it to a |unique_id| as soon as
  // possible).
