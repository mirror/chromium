...
const int64_t example_service_worker_registration_id = 1;
...
class FakeBackgroundFetchRequestManager : public BackgroundFetchRequestManager {
 public:
  ...
  void MarkRequestAsComplete(
    ...
    DCHECK(state.status == JobCompletionStatus::kRunning);
 ...
 public:
  ...
  CreateRegistrationForRequests(
    ...
    *registration_id = BackgroundFetchRegistrationId(
        example_service_worker_registration_id, origin(), kExampleDeveloperId,
        base::GenerateGUID());
