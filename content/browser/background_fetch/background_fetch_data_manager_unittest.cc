...
// An additional "bgfetch_active_registration_unique_id_".
...
TEST_F(BackgroundFetchDataManagerTest, CreateAndDeleteRegistrationPersisted) {
  ...
  size_t expected_inactive_data_count =
      ...
      requests.size() * kUserDataKeysPerRequest;

  size_t expected_active_data_count = kUserDataKeysPerActiveRegistration +
                                      requests.size() * kUserDataKeysPerRequest;
