...
class BackgroundFetchRegistrationNotifier {
 public:
  ...
  // identified by the |unique_id|.
  void AddObserver(
      const std::string& unique_id,
      blink::mojom::BackgroundFetchRegistrationObserverPtr observer);

  // Notifies any registered observer for the registration identified by the
 ...
 private:
  ...
  base::flat_map<
      std::string,
      std::vector<blink::mojom::BackgroundFetchRegistrationObserverPtr>>
      observers_;
