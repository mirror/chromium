...
class CONTENT_EXPORT BackgroundFetchDataManager {
 ...
 private:
  ...
  // Set of background fetch registration |unique_id|s that are still accessible
  // and so could have their UI updated.
  base::flat_set<std::string> still_accessible_ids_;
