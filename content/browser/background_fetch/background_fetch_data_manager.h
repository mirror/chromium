...
class CONTENT_EXPORT BackgroundFetchDataManager {
 public:
  ...
  // registration data. Must outlive |this| or call SetController(nullptr) in
  // its destructor.
  void SetController(const BackgroundFetchRegistrationId& registration_id,
                     BackgroundFetchDatabaseClient* controller);

  BackgroundFetchDatabaseClient* GetControllerFromUniqueID(
 ...
 private:
  ...
  // the registration.
  base::flat_map<std::string, BackgroundFetchDatabaseClient*> controllers_;
