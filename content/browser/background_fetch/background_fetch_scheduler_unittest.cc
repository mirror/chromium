...
TEST_F(BackgroundFetchSchedulerTest, SingleController) {
  BackgroundFetchRegistrationId registration_id1(
      ...
      base::GenerateGUID());
  FakeController controller(registration_id1,
                            BackgroundFetchScheduler::FinishedCallback(),
                            &scheduler_, "A", &controller_sequence_list_, 4);
...
TEST_F(BackgroundFetchSchedulerTest, TwoControllers) {
  ...
  BackgroundFetchRegistrationId registration_id2(
      ...
      base::GenerateGUID());
  FakeController controller1(registration_id1,
                             BackgroundFetchScheduler::FinishedCallback(),
                             &scheduler_, "A", &controller_sequence_list_, 4);
  FakeController controller2(registration_id2,
                             BackgroundFetchScheduler::FinishedCallback(),
                             &scheduler_, "B", &controller_sequence_list_, 4);
