...
class BackgroundFetchServiceTest : public BackgroundFetchTestBase {
 public:
  ...
  void SetUp() override {
    ...
    scoped_refptr<net::URLRequestContextGetter> url_request_context = nullptr;

    base::RunLoop run_loop;
    BrowserThread::PostTask(
        BrowserThread::UI, FROM_HERE,
        base::BindOnce(&BackgroundFetchContext::InitializeOnUIThread, context_,
                       url_request_context, run_loop.QuitClosure()));
    run_loop.Run();
