...
void DOMStorageContextWrapper::GetSessionStorageUsage(
  ...
  if (mojo_session_state_) {
    ...
    base::RepeatingClosure got_session_storage_usage = base::BarrierClosure(
        1, base::BindOnce(&InvokeSessionStorageUsageCallbackHelper, callback,
                          std::move(infos)));
