...
class LocalStorageContextMojo::LevelDBDelegate final
 ...
 public:
  ...
  void SetWrapper(LevelDBWrapperImpl* wrapper) {
    level_db_wrapper_ptr_ = wrapper;
  }

  LevelDBWrapperImpl* level_db_wrapper() const { return level_db_wrapper_ptr_; }
...
class LocalStorageContextMojo::LevelDBWrapperHolder {
 public:
  LevelDBWrapperHolder(base::WeakPtr<LocalStorageContextMojo> context,
    ...
    delegate_->SetWrapper(level_db_wrapper_.get());
  }
