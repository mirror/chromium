...
// doesn't work.
#define MAYBE_FileUrlWithHost DISABLED_FileUriWithHost
#else
#define MAYBE_FileUrlWithHost FileUriWithHost
#endif
IN_PROC_BROWSER_TEST_F(MojoDOMStorageBrowserTest, MAYBE_FileUrlWithHost) {
