...
class CONTENT_EXPORT DOMStorageSession
 ...
 public:
  ...
  explicit DOMStorageSession(DOMStorageContextImpl* context, SessionStorageContextMojo* mojo_context);

  // Constructs a |DOMStorageSession| and assigns |persistent_namespace_id|
  // to it. Allocates a new non-persistent ID.
  DOMStorageSession(DOMStorageContextImpl* context, SessionStorageContextMojo* mojo_context,
