 ...
 public:
  ...
  void ReceiveTraceEnd() override {
    ...
    BrowserThread::PostTask(
        ...
        base::Bind(done_callback_, base::RetainedRef(chunk_ptr)));
  }
...
class TracingControllerTest : public ContentBrowserTest {
 public:
  ...
  void StopTracingStringDoneCallbackTest(base::Closure quit_callback,
  ...
  void TestStartAndStopTracingString() {
    ...
    {
      base::RunLoop run_loop;
      base::Callback<void(base::RefCountedString*)> callback =
          base::Bind(&TracingControllerTest::StopTracingStringDoneCallbackTest,
