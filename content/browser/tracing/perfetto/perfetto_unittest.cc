...
class Producer : public perfetto::mojom::Producer {
 public:
  ...
  void OnConnect() override {
    ...
    data_source_descriptor->name = "perfetto_chrome_test";
...
class RemoteProducer : public perfetto::Producer {
 public:
  ...
  void CreateDataSourceInstance(perfetto::DataSourceInstanceID,
...
class ProducerService : public perfetto::mojom::ProducerService {
 public:
  ...
  static void OnDataSourceRegistered(perfetto::DataSourceID id) {}
...
class Consumer : public perfetto::Consumer {
 public:
  ...
  void OnDisconnect() override { 
    LOG(ERROR) << "Consumer::OnDisconnect();";
  }

  void OnTraceData(const std::vector<perfetto::TracePacket>&,
