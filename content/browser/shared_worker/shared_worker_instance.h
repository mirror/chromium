...
#include "third_party/WebKit/common/net/net_address_space.mojom.h"
...
class CONTENT_EXPORT SharedWorkerInstance {
 public:
  ...
  blink::mojom::NetAddressSpace creation_address_space() const {
 ...
 private:
  ...
  const blink::mojom::NetAddressSpace creation_address_space_;
