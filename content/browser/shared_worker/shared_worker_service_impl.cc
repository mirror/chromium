...
SharedWorkerServiceImpl::MakeProcessHelperFunc
    SharedWorkerServiceImpl::s_make_process_helper_func_for_testing_ = nullptr;
...
std::unique_ptr<SharedWorkerServiceImpl::ProcessHelper>
SharedWorkerServiceImpl::MakeProcessHelper(int process_id) {
  if (s_make_process_helper_func_for_testing_)
    return s_make_process_helper_func_for_testing_(process_id);
