...
// This is the interface of blink::mojom::SharedWorkerContentSettingsProxy.
// Created in SharedWorker::Start(), and then passed onto renderer.
// Renderer can call AllowIndexedDB() and RequestFileSystemAccessSync() to get
