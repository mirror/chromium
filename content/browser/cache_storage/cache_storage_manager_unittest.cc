...
class TestCacheStorageObserver : public CacheStorageContextImpl::Observer {
 public:
  TestCacheStorageObserver() = default;
  ~TestCacheStorageObserver() override = default;
  ...
  int32_t notify_list_changed_count = 0;
  int32_t notify_context_changed_count = 0;
};
...
TEST_P(CacheStorageManagerTestP, NotifyCacheListChanged_Created) {
  std::unique_ptr<TestCacheStorageObserver> observer =
      base::MakeUnique<TestCacheStorageObserver>();
  cache_manager_->AddObserver(observer.get());
