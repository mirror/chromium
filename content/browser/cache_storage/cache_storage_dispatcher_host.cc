...
const uint32_t kFilteredMessageClassesCache[] = {CacheStorageMsgStart};
...
CacheStorageDispatcherHost::CacheStorageDispatcherHost()
    : BrowserMessageFilter(kFilteredMessageClassesCache,
                           arraysize(kFilteredMessageClassesCache)) {}
