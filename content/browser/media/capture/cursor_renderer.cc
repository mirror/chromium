...
CursorRendererUndoer::CursorRendererUndoer(CursorRendererUndoer&& other) = default;

CursorRendererUndoer& CursorRendererUndoer::operator=(CursorRendererUndoer&& other) = default;
