...
class MediaInterfaceProxy : public media::mojom::InterfaceFactory {
 ...
 private:
  // Get the InterfaceFactory connected to the implementation hosted in the
  // service named kMediaServiceName.
  media::mojom::InterfaceFactory* GetMediaInterfaceFactory();

  // Get the InterfaceFactory hosting the CDM service.
  ...
  void OnConnectionError(const std::string& service_name);
  ...
  // hosted in the service named kMediaServiceName.
  media::mojom::InterfaceFactoryPtr interface_factory_ptr_;

  // InterfacePtr to the remote media::mojom::InterfaceFactory implementation
  // hosted in the service named kCdmServiceName.
