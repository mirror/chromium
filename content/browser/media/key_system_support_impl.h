...
// This class implements the media::mojom::KeySystemSupport interface.
class CONTENT_EXPORT KeySystemSupportImpl final
 ...
 private:
  KeySystemSupportImpl(media::mojom::KeySystemSupportRequest request);
  ~KeySystemSupportImpl() final;

  mojo::Binding<media::mojom::KeySystemSupport> binding_;
