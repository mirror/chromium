...
base::TimeTicks GetEventTimestamp(const Maybe<double>& timestamp) {
  return GetEventTimeTicks(timestamp);
}
...
void InputHandler::DispatchMouseEvent(
  ...
  base::TimeTicks timestamp = GetEventTimestamp(maybe_timestamp);
