...
class CONTENT_EXPORT DevToolsDownloadManagerDelegate
 ...
 public:
  ...
  static void TakeOver(content::DownloadManager* download_manager);
  // Resets the download manager's previous download delegate.
  static void Reset();
 ...
 private:
  friend class base::Singleton<DevToolsDownloadManagerDelegate>;
