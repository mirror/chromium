...
DevToolsDownloadManager::DevToolsDownloadManager(
    BrowserContext* browser_context)
    : browser_context_(browser_context), shutdown_needed_(false) {
...
void DevToolsDownloadManager::Shutdown() {
  GetDownloadTaskRunner()->PostTask(
      FROM_HERE, base::BindOnce(&DevToolsDownloadManager::ShutdownOnRunner,
                                base::Unretained(this)));
};

void DevToolsDownloadManager::ShutdownOnRunner() {
