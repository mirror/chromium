...
DevToolsDownloadManagerDelegate::DevToolsDownloadManagerDelegate()
    : download_manager_(nullptr),
      proxy_download_delegate_(nullptr),
...
void DevToolsDownloadManagerDelegate::SetProxyDelegate(
    content::DownloadManagerDelegate* proxy_delegate) {
  proxy_download_delegate_ = proxy_delegate;
}
...
bool DevToolsDownloadManagerDelegate::DetermineDownloadTarget(
  ...
  if (!download_helper && proxy_download_delegate_) {
    return proxy_download_delegate_->DetermineDownloadTarget(download,
                                                             callback);
  }
