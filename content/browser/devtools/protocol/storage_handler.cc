...
void UsageAndQuotaDataCallback(
  ...
  BrowserThread::PostTask(
      ...
      base::Bind(&StorageHandler::GetUsageAndQuotaCallback::sendSuccess,
                 base::Passed(std::move(callback)), usage, quota));
}
...
void GetUsageAndQuotaOnIOThread(
  ...
  manager->GetUsageAndQuotaForWebApps(
      ...
      base::Bind(&UsageAndQuotaDataCallback,
...
void StorageHandler::GetUsageAndQuota(
  ...
  BrowserThread::PostTask(
      ...
      base::Bind(&GetUsageAndQuotaOnIOThread, manager, GURL(origin),
                 base::Passed(std::move(callback))));
}
