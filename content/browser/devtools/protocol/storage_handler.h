 ...
 private:
  ...
  class CacheStorageObserver : CacheStorageContext::Observer {
   ...
   private:
    ...
    CacheStorageContext* context_;
  };

  void GetCacheStorageObserver();
