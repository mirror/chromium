...
ui::GestureProviderConfigType TouchEmulationConfigurationToType(
  ...
  if (protocol_value ==
      Emulation::SetEmulateTouchFromMouse::ConfigurationEnum::Mobile) {
    result = ui::GestureProviderConfigType::GENERIC_MOBILE;
  }
  if (protocol_value ==
      Emulation::SetEmulateTouchFromMouse::ConfigurationEnum::Desktop) {
...
Response EmulationHandler::SetEmulateTouchFromMouse(
    bool enabled,
