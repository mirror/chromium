...
class DevToolsURLRequestInterceptor::State::InterceptedWebContentsObserver
 ...
 public:
  ...
  void RenderFrameHostChanged(RenderFrameHost* old_host,
    ...
    DCHECK_CURRENTLY_ON(BrowserThread::UI);
    DevToolsURLRequestInterceptor::State::RendererFrameHostInfo old_host_info;
    ...
    BrowserThread::PostTask(
        ...
        base::BindOnce(&DevToolsURLRequestInterceptor::State::
                           StartInterceptingRequestsFromOldHostOnIO,
...
void DevToolsURLRequestInterceptor::State::
  ...
  StopInterceptingRequestsInternal(old_host_info);
