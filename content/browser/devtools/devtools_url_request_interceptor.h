 ...
 public:
  ...
  class State : public base::RefCountedThreadSafe<State> {
   public:
    ...
    // Must be called on the UI thread.
    void StopInterceptingRequests(const base::UnguessableToken& host_id);
   ...
   private:
    ...
    void StopInterceptingRequestsOnIO(const base::UnguessableToken& host_id);
