...
// static
void DevToolsAgentHost::StartRemoteDebuggingPipeHandler(int rhandle, int whandle) {
  DevToolsManager* manager = DevToolsManager::GetInstance();
  manager->SetPipeHandler(base::MakeUnique<DevToolsPipeHandler>(rhandle, whandle));
}
