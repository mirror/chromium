...
// received from the renderer process with ID |process_id|, running an
// execution context of the type corresponding to |spec|. |request| is the
// InterfaceProviderRequest from the renderer; the return value is an equivalent
// InterfaceProviderRequest after filtering by service manager.
//
