...
void FrameSinkIdMessageFilter::OnUpdateFrameSinkId(
  ...
  content::BrowserThread::GetTaskRunnerForThread(content::BrowserThread::UI)
      ->PostTask(
          FROM_HERE,
          base::BindOnce(&FrameSinkIdMessageFilter::OnUpdateFrameSinkIdOnUI,
                         base::Unretained(this)));
}

void FrameSinkIdMessageFilter::OnUpdateFrameSinkIdOnUI() {
  run_loop_.Quit();
}
