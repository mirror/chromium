...
void RenderWidgetHostInputEventRouter::SendGestureScrollBegin(
  ...
  scroll_begin.data.scroll_begin.delta_x_hint = event.data.scroll_update.delta_x;
  scroll_begin.data.scroll_begin.delta_y_hint = event.data.scroll_update.delta_y;
