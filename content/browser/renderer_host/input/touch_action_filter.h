...
class CONTENT_EXPORT TouchActionFilter {
 public:
  ...
  base::Optional<cc::TouchAction> allowed_touch_action() const {
    return blink_computed_touch_action_;
  }
 ...
 private:
  ...
  // Blink is received, we recalculate |suppress_manipulation_event_| and this
  // bit is true.
  bool suppress_manipulation_events_from_blink_computed_touch_action_ = false;
  ...
  base::Optional<cc::TouchAction> blink_computed_touch_action_;
