...
// pinch-zoom. The expected behavior should disallow the pinch-zoom.
...
// allowed. The expected behaviour should disallow the pan.
...
TEST(TouchActionFilterTest, WhiteListedTouchActionNotMatchesHint) {
  TouchActionFilter filter;
...
TEST(TouchActionFilterTest, WhiteListedTouchActionMatchHint) {
  TouchActionFilter filter;
