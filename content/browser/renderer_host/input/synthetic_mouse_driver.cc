...
void SyntheticMouseDriver::Move(float x, float y, int index) {
  ...
  mouse_event_ = SyntheticWebMouseEventBuilder::Build(
      ...
      mouse_event_.pointer_type);
  mouse_event_.button = blink::WebMouseEvent::Button::kNoButton;
  if (last_modifiers_ & blink::WebMouseEvent::kLeftButtonDown)
    mouse_event_.button = blink::WebMouseEvent::Button::kLeft;
  if (last_modifiers_ & blink::WebMouseEvent::kMiddleButtonDown)
    mouse_event_.button = blink::WebMouseEvent::Button::kMiddle;
  if (last_modifiers_ & blink::WebMouseEvent::kRightButtonDown)
    mouse_event_.button = blink::WebMouseEvent::Button::kRight;
