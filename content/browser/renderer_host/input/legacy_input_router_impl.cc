...
void LegacyInputRouterImpl::OnTouchEventAck(
  ...
  if (WebTouchEventTraits::IsTouchSequenceStart(event.event) &&
    ...
    // unlike most enums, we must add one to the upper bound to be able to
    // visualize the number of times |cc::kTouchActionAuto| is hit.
...
void LegacyInputRouterImpl::OnSetTouchAction(cc::TouchAction touch_action) {
  ...
  // etc.
  // Since |cc::kTouchActionAuto| is equivalent to |cc::kTouchActionMax|
  // unlike most enums, we must add one to the upper bound to be able
  // to visualize the number of times |cc::kTouchActionAuto| is hit.
