...
class InputRouterImplScaleTouchEventTest
 ...
 public:
  ...
  void RunTouchEventTest(const std::string& name, WebTouchPoint::State state) {
    ...
    EXPECT_EQ(25, sent_event->touches[0].radius_x);
    EXPECT_EQ(25, sent_event->touches[0].radius_y);
    ...
    EXPECT_EQ(25, sent_event->touches[1].radius_x);
    EXPECT_EQ(25, sent_event->touches[1].radius_y);
    ...
    EXPECT_EQ(12.5, filter_event->touches[0].radius_x);
    EXPECT_EQ(12.5, filter_event->touches[0].radius_y);
    ...
    EXPECT_EQ(12.5, filter_event->touches[1].radius_x);
    EXPECT_EQ(12.5, filter_event->touches[1].radius_y);
  }
