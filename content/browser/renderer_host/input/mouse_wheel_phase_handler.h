...
class MouseWheelPhaseHandler {
 public:
  ...
  void set_mouse_wheel_end_dispatch_timer_timeout(base::TimeDelta timeout) {
    mouse_wheel_end_dispatch_timer_timeout_ = timeout;
  }
 ...
 private:
  ...
  base::TimeDelta mouse_wheel_end_dispatch_timer_timeout_;
