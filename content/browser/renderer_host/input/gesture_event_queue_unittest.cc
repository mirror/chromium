...
// Test that a GestureFlingStart is not filtered out by debouncing, that
// GestureFlingStart causes debouncing queue to empty into coalescing queue, and
// that GestureScroll events are discarded during fling.
TEST_F(GestureEventQueueTest, DebounceEndsWithFlingStartEvent) {
  ...
  WebInputEvent::Type expected[] = {
      ...
      WebInputEvent::kGestureFlingStart, WebInputEvent::kGestureTapDown};
