...
TouchActionFilter::TouchActionFilter()
    : suppress_manipulation_events_(false),
      ...
      allowed_touch_action_set_(false),
      white_listed_touch_action_(cc::kTouchActionAuto),
      white_listed_touch_action_set_(false),
...
bool TouchActionFilter::FilterGestureEvent(WebGestureEvent* gesture_event) {
  ...
  if (!white_listed_touch_action_set_ && !allowed_touch_action_set_)
    allowed_touch_action_set_ = true;

  cc::TouchAction touch_action = allowed_touch_action_set_
  ...
  if (!suppress_manipulation_events_set_ && allowed_touch_action_set_ &&
      white_listed_touch_action_set_ &&
...
void TouchActionFilter::OnSetWhiteListedTouchAction(
  ...
  white_listed_touch_action_set_ = true;
}

bool TouchActionFilter::ShouldSuppressManipulation(
    const blink::WebGestureEvent& gesture_event) {
  cc::TouchAction allowed_touch_action = allowed_touch_action_set_
                                             ? allowed_touch_action_
                                             : white_listed_touch_action_;
  suppress_manipulation_events_set_ = allowed_touch_action_set_;
