...
void TouchActionFilter::OnSetWhiteListedTouchAction(
  ...
  // fingers that have gone down durin gthis action.  In the majority of
  // real-world scenarios the touch action for all fingers will be the same.
  ...
  // desirable properties of this choice: 1. Not sensitive to finger touch
  // order.  Behavior of putting two fingers
  //    down "at once" will be deterministic.
