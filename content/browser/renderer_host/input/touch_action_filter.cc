...
bool TouchActionFilter::ShouldFilterGestureEvent(
  ...
  switch (gesture_event->GetType()) {
    ...
    case WebInputEvent::kGestureScrollUpdate:
      ...
      // two-finger scrolling but a "touch-action: pan-x pinch1-zoom" region
      // doesn't.
...
bool TouchActionFilter::FilterGestureWhiteListed(
  ...
  processing_white_listed_ = ShouldFilterGestureEvent(&gesture_event, true);
  return processing_white_listed_;
}
