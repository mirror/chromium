...
void FlingController::ProcessGestureFlingStart(
  ...
  UpdateCurrentFlingState(gesture_event.event, gfx::Vector2dF(vx, vy));
...
void FlingController::ScheduleFlingProgress() {
  base::ThreadTaskRunnerHandle::Get()->PostDelayedTask(
      FROM_HERE,
      base::BindOnce(&FlingController::ProgressFling, base::Unretained(this)),
...
void FlingController::UpdateCurrentFlingState(
