...
// FlingProgress will get called once every kDefaultFlingProgressCallIntervalMs
// during an active fling.
const int64_t kDefaultFlingProgressCallIntervalms = 16666;
}  // namespace
...
void FlingController::ScheduleFlingProgress() {
  fling_progress_timer_.Start(
      FROM_HERE,
      base::TimeDelta::FromMicroseconds(kDefaultFlingProgressCallIntervalms),
...
bool FlingController::UpdateCurrentFlingState(
  ...
  current_fling_parameters_.start_time = fling_start_event.TimeStampSeconds();
