...
class InputRouter : public IPC::Listener {
 public:
  ...
  // Get some private members of touch action filter, used for testing in
  // TouchActionBrowserTest.
  virtual base::Optional<cc::TouchAction>
  WhiteListedTouchActionForTesting() = 0;
  virtual gfx::Vector2dF AccumulatedScrollingForTesting() = 0;
