...
void InputRouterImpl::UpdateTouchAckTimeoutEnabled() {
  ...
  base::Optional<cc::TouchAction> allowed_white_listed_touch_action =
      touch_action_filter_.allowed_white_listed_touch_action();
  const bool touch_ack_timeout_disabled =
      (allowed_touch_action.has_value() &&
       allowed_touch_action.value() == cc::kTouchActionNone) ||
      (allowed_white_listed_touch_action.has_value() &&
       allowed_white_listed_touch_action.value() == cc::kTouchActionNone);
