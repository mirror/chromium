...
InputRouterImpl::WhiteListedTouchActionForTesting() {
  return touch_action_filter_.white_listed_touch_action_for_testing();
}

gfx::Vector2dF InputRouterImpl::AccumulatedScrollingForTesting() {
  return touch_action_filter_.accumulated_scrolling_for_testing();
}
...
void InputRouterImpl::SetWhiteListedTouchAction(cc::TouchAction touch_action,
  ...
  touch_action_filter_.OnReceiveWhiteListedTouchAction(touch_action);
