...
int RenderWidgetHostViewAndroid::GetMouseWheelMinimumGranularity() const {
  ...
  // On Android, the mouse wheel MotionEvents specify the number of ticks and
  // how many pixels each tick scrolls. This multiplier is specified as theme
  // setting so the minimum granularity will be the size of this tick
  // multiplier.
