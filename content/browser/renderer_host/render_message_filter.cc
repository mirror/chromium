...
void RenderMessageFilter::SetThreadPriority(int32_t ns_tid, int32_t priority) {
#if defined(OS_LINUX)
  ...
  base::PostTaskWithTraits(
      ...
      base::BindOnce(&RenderMessageFilter::SetThreadPriorityOnFileThread, this,
                     static_cast<base::PlatformThreadId>(ns_tid),
                     static_cast<base::ThreadPriority>(priority)));
#endif
}
