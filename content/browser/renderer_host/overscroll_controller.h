...
class CONTENT_EXPORT OverscrollController {
 public:
  ...
  // side. This is called before ReceivedEventAck. It contains two
  // OverscrollBehavior values that can prevent overscroll navigationon.
 ...
 private:
  ...
  bool overscroll_effects_disabled_ = false;
