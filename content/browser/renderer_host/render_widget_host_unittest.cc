...
class MockRenderWidgetHost : public RenderWidgetHostImpl {
 public:
  ...
  // CompositorFrameSinkClientPtr bound to |mock|.
  void mock_renderer_compositor_frame_sink_(
      std::unique_ptr<viz::MockCompositorFrameSinkClient> mock) {
    renderer_compositor_frame_sink_ = mock->BindInterfacePtr();
  }
...
TEST_F(RenderWidgetHostTest, NewContentRenderingTimeout) {
  ...
  host_->mock_renderer_compositor_frame_sink_(
