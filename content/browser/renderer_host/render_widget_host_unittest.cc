...
TEST_F(RenderWidgetHostTest, TouchEmulator) {
  ...
  SimulateMouseEvent(
      WebInputEvent::kMouseMove, 10, 40, WebInputEvent::kShiftKey, true);
  EXPECT_EQ(WebInputEvent::kTouchMove, host_->acked_touch_event_type());
  ...
  SimulateMouseEvent(
      WebInputEvent::kMouseMove, 10, 50, WebInputEvent::kShiftKey, true);
  EXPECT_EQ(WebInputEvent::kTouchMove, host_->acked_touch_event_type());
  ...
  // Another pinch.
  SimulateMouseEvent(
      WebInputEvent::kMouseMove, 10, 110, WebInputEvent::kShiftKey, true);
  EXPECT_EQ(WebInputEvent::kTouchMove, host_->acked_touch_event_type());
  EXPECT_EQ("GesturePinchBegin",
            GetInputMessageTypes(process_));
  EXPECT_EQ(0U, process_->sink().message_count());
  ...
  SimulateMouseEvent(
      WebInputEvent::kMouseMove, 10, 120, WebInputEvent::kShiftKey, true);
  EXPECT_EQ(WebInputEvent::kTouchMove, host_->acked_touch_event_type());
  EXPECT_EQ("GesturePinchUpdate",
            GetInputMessageTypes(process_));
  SendInputEventACK(WebInputEvent::kGesturePinchUpdate,
  ...
  SimulateMouseEvent(
      WebInputEvent::kMouseMove, 10, 10, WebInputEvent::kShiftKey, true);
...
TEST_F(RenderWidgetHostTest, InputEventRWHLatencyComponent) {
  ...
  CheckLatencyInfoComponentInMessage(
      process_, GetLatencyComponentId(), WebInputEvent::kMouseWheel);
  ...
  SimulateMouseEvent(WebInputEvent::kMouseMove);
  CheckLatencyInfoComponentInMessage(
      process_, GetLatencyComponentId(), WebInputEvent::kMouseMove);
  ...
  SimulateGestureEvent(WebInputEvent::kGestureScrollBegin,
                       blink::kWebGestureDeviceTouchscreen);
  CheckLatencyInfoComponentInMessage(
      process_, GetLatencyComponentId(), WebInputEvent::kGestureScrollBegin);
  ...
  host_->OnMessageReceived(InputHostMsg_HandleInputEvent_ACK(0, ack));
  CheckLatencyInfoComponentInMessage(
      process_, GetLatencyComponentId(), WebInputEvent::kTouchStart);
}
