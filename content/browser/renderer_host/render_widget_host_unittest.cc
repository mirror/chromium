...
class MockRenderWidgetHost : public RenderWidgetHostImpl {
 public:
  ...
  // Stubs out renderer_compositor_frame_sink_client_ with a mock.
  void set_mock_renderer_compositor_frame_sink_client_() {
...
TEST_F(RenderWidgetHostTest, NewContentRenderingTimeout) {
  ...
  // Mocking |renderer_compositor_frame_sink_client_| to prevent crashes in
  // renderer_compositor_frame_sink_->DidReceiveCompositorFrameAck(resources).
  host_->set_mock_renderer_compositor_frame_sink_client_();
