...
class CONTENT_EXPORT RenderProcessHostImpl
 ...
 public:
  ...
  void BindCacheStorage(blink::mojom::CacheStorageRequest request, const url::Origin& origin);
 ...
 private:
  ...
  mojo::StrongBindingSet<blink::mojom::CacheStorage> cache_storage_dispatcher_bindings_;
