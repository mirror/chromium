...
TEST_P(MediaDevicesDispatcherHostTest, ChangeSalt) {
  EnumerateDevicesAndWaitForResult(true, true, true);
  ...
  // Change the salt and expect different device IDs in a new enumeration,
  // except for default audio devices, which are always hashed to a well-known
  // constant.
