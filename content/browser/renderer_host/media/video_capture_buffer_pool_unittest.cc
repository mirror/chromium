...
static const PixelFormatAndStorage kCapturePixelFormatAndStorages[] = {
    {media::PIXEL_FORMAT_I420, media::VideoPixelStorage::PIXEL_STORAGE_CPU},
    {media::PIXEL_FORMAT_ARGB, media::VideoPixelStorage::PIXEL_STORAGE_CPU},
    {media::PIXEL_FORMAT_Y16, media::VideoPixelStorage::PIXEL_STORAGE_CPU},
};
