...
void ServiceLaunchedVideoCaptureDevice::GetPhotoCapabilities(
  ...
  DCHECK(sequence_checker_.CalledOnValidSequence());
  device_->GetPhotoCapabilities(base::Bind(
      &ServiceLaunchedVideoCaptureDevice::OnGetPhotoCapabilitiesResponse,
...
void ServiceLaunchedVideoCaptureDevice::OnGetPhotoCapabilitiesResponse(
