...
void CreateJpegDecodeAcceleratorMojoOnIOThread(
...
void CreateJpegDecodeAcceleratorMojo(
    media::mojom::JpegDecodeAcceleratorRequest request) {
  BrowserThread::PostTask(
      BrowserThread::IO, FROM_HERE,
      base::BindOnce(&CreateJpegDecodeAcceleratorMojoOnIOThread,
      ...
      video_capture_provider = InProcessVideoCaptureProvider::CreateInstance(
          std::make_unique<media::VideoCaptureSystemImpl>(
              media::VideoCaptureDeviceFactory::CreateFactory(
                  ...
                  base::BindRepeating(&CreateJpegDecodeAcceleratorMojo))),
          std::move(device_task_runner),
          base::BindRepeating(&SendVideoCaptureLogMessage));
    }
  }
