...
class MediaStreamDispatcherHostTest : public testing::Test {
 public:
  ...
  void TearDown() override { host_->OnConnectionError(); }
...
TEST_F(MediaStreamDispatcherHostTest, CancelPendingStreamsOnConnectionError) {
  StreamControls controls(false, true);
  ...
  // Calling OnConnectionError() to cancel all the pending requests.
  host_->OnConnectionError();
  run_loop.RunUntilIdle();
}

TEST_F(MediaStreamDispatcherHostTest, StopGeneratedStreamsOnConnectionError) {
  StreamControls controls(false, true);
  ...
  // Calling OnConnectionError() to cancel all the pending/generated streams.
  host_->OnConnectionError();
