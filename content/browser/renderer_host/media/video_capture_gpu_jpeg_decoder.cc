...
// static
void VideoCaptureGpuJpegDecoder::CreateGpuJpegDecoderMojoOnIOThread(
...
// static
void VideoCaptureGpuJpegDecoder::CreateGpuJpegDecoderMojo(
    media::mojom::GpuJpegDecodeAcceleratorRequest request) {
  BrowserThread::PostTask(BrowserThread::IO, FROM_HERE,
...
void VideoCaptureGpuJpegDecoder::FinishInitialization(
  ...
  if (gpu_info.jpeg_decode_accelerator_supported) {
    ...
    CreateGpuJpegDecoderMojo(mojo::MakeRequest(&remote_decoder));
