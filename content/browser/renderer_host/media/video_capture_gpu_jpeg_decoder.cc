...
// TODO(c.padhi): Enable the below piece of code when
// https://crrev.com/2967573002 is ready, to connect to
// mojom::GpuJpegDecodeAccelerator in the GPU process.
#if defined(BROWSER_GPU_CLIENT_LIB)
    BrowserMainLoop::GetInstance()->gpu()->CreateJpegDecodeAccelerator(
