...
class FakeAudioInputStreamClient : public media::mojom::AudioInputStreamClient {
 public:
  ...
  void OnStreamCreated(mojo::ScopedSharedBufferHandle,
                       mojo::ScopedHandle,
                       bool) override {
    was_called_ = true;
  }
...
TEST(RenderFrameAudioInputStreamFactoryTest, CreateStream) {
  ...
  FakeAudioInputStreamClient client;
  ...
  mojo::Binding<media::mojom::AudioInputStreamClient> client_binding(
  ...
  factory_ptr->CreateStream(mojo::MakeRequest(&stream_ptr), kSessionId,
...
TEST(RenderFrameAudioInputStreamFactoryTest, OutOfRangeSessionId_BadMessage) {
  ...
  factory_ptr->CreateStream(mojo::MakeRequest(&stream_ptr), session_id,
                            GetTestAudioParameters(), kAGC, kSharedMemoryCount,
                            std::move(client_ptr));
