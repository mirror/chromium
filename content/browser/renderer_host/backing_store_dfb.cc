...
BackingStoreDfb::BackingStoreDfb(RenderWidgetHost* widget,
                                   const gfx::Size& size)
...
BackingStoreDfb::~BackingStoreDfb() {
}

void BackingStoreDfb::SkiaShowRect(const gfx::Point& point,
                                    gfx::Canvas* canvas) {
...
void BackingStoreDfb::ScaleFactorChanged(float device_scale_factor) {
...
size_t BackingStoreDfb::MemorySize() {
...
void BackingStoreDfb::PaintToBackingStore(
...
void BackingStoreDfb::ScrollBackingStore(const gfx::Vector2d& delta,
...
bool BackingStoreDfb::CopyFromBackingStore(const gfx::Rect& rect,
