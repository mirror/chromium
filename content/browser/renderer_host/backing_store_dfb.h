...
#ifndef CONTENT_BROWSER_RENDERER_HOST_BACKING_STORE_DFB_H_
#define CONTENT_BROWSER_RENDERER_HOST_BACKING_STORE_DFB_H_
...
// RenderWidgetHostViewDfb.
class BackingStoreDfb : public BackingStore {
 public:
  CONTENT_EXPORT BackingStoreDfb(
      RenderWidgetHost* widget,
      const gfx::Size& size);

  virtual ~BackingStoreDfb();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BackingStoreDfb);
};

}  // namespace content

#endif  // CONTENT_BROWSER_RENDERER_HOST_BACKING_STORE_DFB_H_
