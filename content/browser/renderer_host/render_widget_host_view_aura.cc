...
void RenderWidgetHostViewAura::SubmitCompositorFrame(
  ...
  if (IsUseZoomForDSFEnabled()) {
    // With zoom-for-DSF Blink screen pixel coordinates are used and zoom
    // is used to adjusts for the device scale factor. That's why
    // last_scroll_offset_ needs to be scaled to view coordinates.
