...
void DWriteFontProxyImpl::SetWindowsFontsPathForTesting(
    base::string16 path) {
...
void DWriteFontProxyImpl::GetFamilyCount(
...
void DWriteFontProxyImpl::GetFamilyNames(
    UINT32 family_index,
...
bool DWriteFontProxyImpl::IsLastResortFallbackFont(
    uint32_t font_index) {
