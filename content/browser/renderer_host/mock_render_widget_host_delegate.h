...
#ifndef CONTENT_BROWSER_RENDERER_HOST_MOCK_RENDER_WIDGET_HOST_DELEGATE_H_
#define CONTENT_BROWSER_RENDERER_HOST_MOCK_RENDER_WIDGET_HOST_DELEGATE_H_
...
class MockRenderWidgetHostDelegate : public RenderWidgetHostDelegate {
 public:
  ...
  void set_is_captured(bool is_captured) { is_captured_ = is_captured; }
...
#endif  // CONTENT_BROWSER_RENDERER_HOST_MOCK_RENDER_WIDGET_HOST_DELEGATE_H_
