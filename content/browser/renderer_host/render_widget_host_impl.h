...
struct ViewHostMsg_Resize_ACK_Params;
...
class CONTENT_EXPORT RenderWidgetHostImpl
 ...
 private:
  ...
  void OnResizeACK(const ViewHostMsg_Resize_ACK_Params& params);
  ...
  void DidCompleteResizeOrRepaint(const ViewHostMsg_Resize_ACK_Params& params,
