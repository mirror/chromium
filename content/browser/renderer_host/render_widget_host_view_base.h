 ...
 public:
  ...
  class ScopedAllocationPendingLock {
   public:
    ...
    ScopedAllocationPendingLock(const ScopedAllocationPendingLock&) = delete;
    ScopedAllocationPendingLock& operator=(const ScopedAllocationPendingLock&) =
        delete;
    ScopedAllocationPendingLock(ScopedAllocationPendingLock&&) = default;
    ScopedAllocationPendingLock& operator=(ScopedAllocationPendingLock&&) =
        default;
