...
void RenderWidgetHostImpl::DelayedAutoResized(int sequence_number) {
  ...
  viz::LocalSurfaceId old_local_surface_id(view_->GetLocalSurfaceId());
  if (delegate_)
    delegate_->ResizeDueToAutoResize(this, new_size);

  viz::LocalSurfaceId local_surface_id(view_->GetLocalSurfaceId());
  DCHECK(!old_local_surface_id.is_valid() ||
         old_local_surface_id != local_surface_id);
  if (local_surface_id.is_valid()) {
