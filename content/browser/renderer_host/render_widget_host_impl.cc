...
inline blink::WebGestureEvent CreateScrollBeginForWrapping(
  ...
  wrap_gesture_scroll_begin.resending_plugin_id = gesture_event.resending_plugin_id;
...
inline blink::WebGestureEvent CreateScrollEndForWrapping(
  ...
  wrap_gesture_scroll_end.resending_plugin_id = gesture_event.resending_plugin_id;
...
void RenderWidgetHostImpl::ForwardWheelEventWithLatencyInfo(
  ...
  TRACE_EVENT2("input", "RenderWidgetHostImpl::ForwardWheelEvent",
               "dx", wheel_event.delta_x, "dy", wheel_event.delta_y);
...
void RenderWidgetHostImpl::ForwardGestureEventWithLatencyInfo(
  ...
  } else if (gesture_event.GetType() == blink::WebInputEvent::kGestureScrollEnd ||
