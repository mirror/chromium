...
void RenderWidgetHostImpl::ImeSetComposition(
    ...
    int selection_start,
    int selection_end) {
  GetWidgetInputHandler()->ImeSetComposition(text, ime_spans, replacement_range,
...
void RenderWidgetHostImpl::ImeCommitText(
  ...
  GetWidgetInputHandler()->ImeCommitText(text, ime_spans, replacement_range,
                                         relative_cursor_pos);
}
