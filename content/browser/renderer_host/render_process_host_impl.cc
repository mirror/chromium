...
void RenderProcessHostImpl::RegisterMojoInterfaces() {
  ...
  // Unretained is safe here since the profile (browser context) owns the store
  registry->AddInterface(base::Bind(
      &origin_manifest::OriginManifestStore::BindRequest,
      base::Unretained(GetBrowserContext()->GetOriginManifestStore())));
