...
// This CL verifies that a new ViewMsg_SetLocalSurfaceIdForAutoResize message is
// sent when ScreenInfo changes and that message contains the latest ScreenInfo.
