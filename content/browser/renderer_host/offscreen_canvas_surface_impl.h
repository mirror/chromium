...
// the embedder and embedded surface are submitted from the same renderer. Holds
// a client connection to the renderer that is notified when a new SurfaceId
// activates for the embedded surface.
