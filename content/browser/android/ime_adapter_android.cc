...
void AppendBackgroundColorSpan(JNIEnv*,
  ...
  underlines->push_back(ui::CompositionUnderline(
      ...
      SK_ColorTRANSPARENT, kWebCompositionUnderlineThicknessNone,
...
void AppendUnderlineSpan(JNIEnv*,
  ...
  underlines->push_back(ui::CompositionUnderline(
      static_cast<unsigned>(start), static_cast<unsigned>(end),
      SK_ColorTRANSPARENT, kWebCompositionUnderlineThicknessThin,
      SK_ColorTRANSPARENT));
}
...
void ImeAdapterAndroid::SetComposingText(JNIEnv* env,
  ...
  if (underlines.empty()) {
    underlines.push_back(ui::CompositionUnderline(
        ...
        kWebCompositionUnderlineThicknessThin, SK_ColorTRANSPARENT));
  }
