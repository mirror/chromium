...
void DialogOverlayImpl::CompleteInit(JNIEnv* env,
  ...
  // Note: if ever AndroidOverlayProviderImpl.MAX_OVERLAYS > 1, SetOverlayMode()
  // and the AndroidOverlayModeManager should be changed to count overlays,
  // rather than setting the overlay mode directly.
