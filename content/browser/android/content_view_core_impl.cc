...
void ContentViewCoreImpl::ScrollBegin(JNIEnv* env,
  ...
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureScrollBegin, time_ms, x, y);
...
void ContentViewCoreImpl::ScrollEnd(JNIEnv* env,
                                    ...
                                    jlong time_ms) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureScrollEnd, time_ms, 0, 0);
  SendGestureEvent(event);
}
...
void ContentViewCoreImpl::ScrollBy(JNIEnv* env,
                                   ...
                                   jfloat dy) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureScrollUpdate, time_ms, x, y);
...
void ContentViewCoreImpl::FlingStart(JNIEnv* env,
                                     ...
                                     jboolean target_viewport) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureFlingStart, time_ms, x, y);
...
void ContentViewCoreImpl::FlingCancel(JNIEnv* env,
                                      ...
                                      jlong time_ms) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureFlingCancel, time_ms, 0, 0);
...
void ContentViewCoreImpl::DoubleTap(JNIEnv* env,
                                    ...
                                    jfloat y) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGestureDoubleTap, time_ms, x, y);
...
void ContentViewCoreImpl::PinchBegin(JNIEnv* env,
                                     ...
                                     jfloat y) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGesturePinchBegin, time_ms, x, y);
  SendGestureEvent(event);
}
...
void ContentViewCoreImpl::PinchEnd(JNIEnv* env,
                                   ...
                                   jlong time_ms) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGesturePinchEnd, time_ms, 0, 0);
  SendGestureEvent(event);
}
...
void ContentViewCoreImpl::PinchBy(JNIEnv* env,
                                  ...
                                  jfloat delta) {
  WebGestureEvent event = MakeGestureEvent(
      WebInputEvent::kGesturePinchUpdate, time_ms, anchor_x, anchor_y);
