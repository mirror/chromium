...
void SynchronousCompositorSyncCallBridge::BindFilterOnUIThread() {
  ...
  BrowserThread::PostTask(
      ...
      base::BindOnce(&SynchronousCompositorBrowserFilter::RegisterHost,
...
bool SynchronousCompositorSyncCallBridge::ReceiveFrameOnIOThread(
  ...
  future = std::move(frame_futures_.front());
  DCHECK(future);
  ...
  if (compositor_frame) {
    BrowserThread::PostTask(
        ...
        base::BindOnce(&SynchronousCompositorSyncCallBridge::
                       ...
                       this, base::Passed(compositor_frame->metadata.Clone())));
...
void SynchronousCompositorSyncCallBridge::HostDestroyedOnUIThread() {
  ...
  if (filter) {
    unregister_callback_ = base::BindOnce(base::BindOnce(
        &SynchronousCompositorSyncCallBridge::UnregisterHostOnIOThread, this,
        filter));
...
void SynchronousCompositorSyncCallBridge::UnregisterHostOnIOThread(
  ...
  if (filter)
    filter->UnregisterHost(routing_id_);
}
...
void SynchronousCompositorSyncCallBridge::UnregisterHostIfNecessary() {
