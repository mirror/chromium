...
// This object is used manage the waiting and signaling behavior on the UI
// thread. The UI thread will wait on a WaitableEvent or condition variable
// which is then signal by handlers in this class. This object is a cross
// thread object accessed both on the UI and IO threads.
