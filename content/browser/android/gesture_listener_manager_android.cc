...
void GestureListenerManagerAndroid::WebContentsDestroyed() {
  ...
  // needs not resetting since it is being destroyed.
  delete this;
}
...
void JNI_GestureListenerManagerImpl_Init(
  ...
  new GestureListenerManagerAndroid(env, obj, static_cast<WebContentsImpl*>(web_contents));
}
