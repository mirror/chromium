...
const base::Feature* kFeaturesExposedToJava[] = {
    &kRequestUnbufferedDispatch, &kSelectionInsertionAssistant,
};
...
const base::Feature kSelectionInsertionAssistant{
    "SelectionInsertionAssistant", base::FEATURE_ENABLED_BY_DEFAULT};
