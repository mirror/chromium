...
int BrowserMainLoop::BrowserThreadsStarted() {
  ...
  if (!is_mus) {
    ...
    if (enable_viz) {
      // TODO(kylechar): Remove fatal error when full implementation has landed.
      DLOG(FATAL) << "Working --enable-viz implementation not yet landed";
      ...
      // Post task to IO thread and connect to FrameSinkManager in viz process.
      BrowserThread::PostTask(
          BrowserThread::IO, FROM_HERE,
          base::BindOnce(
