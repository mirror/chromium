...
#if BUILDFLAG(ENABLE_WEBRTC)
  LOG(ERROR) << "ELAD!!! Before WebRtcEventLogManager::CreateSingletonInstance = " << ((void*) webrtc_event_log_manager_.get());
  webrtc_event_log_manager_.reset(
      WebRtcEventLogManager::CreateSingletonInstance());
  LOG(ERROR) << "ELAD!!! After WebRtcEventLogManager::CreateSingletonInstance = " << ((void*) webrtc_event_log_manager_.get());
