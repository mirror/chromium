...
enum BadMessageReason {
  ...
  RVH_CAN_ACCESS_FILES_OF_PAGE_STATE = 6,  // obsolete; no longer used
  RFH_FILE_CHOOSER_PATH = 7,
  RWH_SYNTHETIC_GESTURE = 8,  // obsolete; no longer used
  RWH_FOCUS = 9,              // obsolete; no longer used
  RWH_BLUR = 10,              // obsolete; no longer used
  RWH_SHARED_BITMAP = 11,
  RWH_BAD_ACK_MESSAGE = 12,
  RWHVA_SHARED_MEMORY = 13,  // obsolete; no longer used
  SERVICE_WORKER_BAD_URL = 14,
  WC_INVALID_FRAME_SOURCE = 15,      // obsolete; no longer used
  ...
  ACDH_SELECT_CACHE_FOR_WORKER = 39,  // obsolete; no longer used
  ...
  ACDH_SWAP_CACHE = 47,
  SWDH_NOT_HANDLED = 48,
  SWDH_REGISTER_BAD_URL = 49,                    // obsolete; no longer used
  SWDH_REGISTER_NO_HOST = 50,                    // obsolete; no longer used
  SWDH_REGISTER_CANNOT = 51,                     // obsolete; no longer used
  SWDH_UNREGISTER_BAD_URL = 52,                  // obsolete; no longer used
  SWDH_UNREGISTER_NO_HOST = 53,                  // obsolete; no longer used
  SWDH_UNREGISTER_CANNOT = 54,                   // obsolete; no longer used
  SWDH_GET_REGISTRATION_BAD_URL = 55,            // obsolete; no longer used
  SWDH_GET_REGISTRATION_NO_HOST = 56,            // obsolete; no longer used
  SWDH_GET_REGISTRATION_CANNOT = 57,             // obsolete; no longer used
  SWDH_GET_REGISTRATION_FOR_READY_NO_HOST = 58,  // obsolete; no longer used
  SWDH_GET_REGISTRATION_FOR_READY_ALREADY_IN_PROGRESS = 59,  // obsolete
  ...
  SWDH_SET_HOSTED_VERSION_NO_HOST = 63,   // obsolete; no longer used
  OBSOLETE_SWDH_SET_HOSTED_VERSION = 64,  // obsolete; no longer used
  SWDH_WORKER_SCRIPT_LOAD_NO_HOST = 65,   // obsolete; no longer used
  SWDH_INCREMENT_WORKER_BAD_HANDLE = 66,
  SWDH_DECREMENT_WORKER_BAD_HANDLE = 67,
  SWDH_INCREMENT_REGISTRATION_BAD_HANDLE = 68,  // obsolete; no longer used
  SWDH_DECREMENT_REGISTRATION_BAD_HANDLE = 69,  // obsolete; no longer used
  SWDH_TERMINATE_BAD_HANDLE = 70,
  FAMF_APPEND_ITEM_TO_BLOB = 71,             // obsolete; no longer used
  FAMF_APPEND_SHARED_MEMORY_TO_BLOB = 72,    // obsolete; no longer used
  FAMF_MALFORMED_STREAM_URL = 73,            // obsolete; no longer used
  FAMF_APPEND_ITEM_TO_STREAM = 74,           // obsolete; no longer used
  FAMF_APPEND_SHARED_MEMORY_TO_STREAM = 75,  // obsolete; no longer used
  IDBDH_CAN_READ_FILE = 76,                  // obsolete; no longer used
  IDBDH_GET_OR_TERMINATE = 77,               // obsolete; no longer used
  RFMF_SET_COOKIE_BAD_ORIGIN = 78,
  RFMF_GET_COOKIES_BAD_ORIGIN = 79,
  SWDH_GET_REGISTRATIONS_NO_HOST = 80,         // obsolete; no longer used
  SWDH_GET_REGISTRATIONS_INVALID_ORIGIN = 81,  // obsolete; no longer used
  AOAH_UNAUTHORIZED_URL = 82,                  // obsolete; no longer used
  BDH_INVALID_SERVICE_ID = 83,
  RFH_COMMIT_DESERIALIZATION_FAILED = 84,  // obsolete; no longer used
  BDH_INVALID_CHARACTERISTIC_ID = 85,
  SWDH_UPDATE_NO_HOST = 86,                  // obsolete; no longer used
  SWDH_UPDATE_BAD_REGISTRATION_ID = 87,      // obsolete; no longer used
  SWDH_UPDATE_CANNOT = 88,                   // obsolete; no longer used
  SWDH_UNREGISTER_BAD_REGISTRATION_ID = 89,  // obsolete; no longer used
  ...
  OBSOLETE_BDH_DUPLICATE_REQUEST_DEVICE_ID = 93,    // obsolete; no longer used
  CSDH_INVALID_ORIGIN = 94,
  RDH_ILLEGAL_ORIGIN = 95,
  RDH_UNAUTHORIZED_HEADER_REQUEST = 96,  // obsolete; no longer used
  RDH_INVALID_URL = 97,
  BDH_CHARACTERISTIC_ALREADY_SUBSCRIBED = 98,  // obsolete; no longer used
  ...
  IDBDH_INVALID_ORIGIN = 119,                 // obsolete; no longer used
  RFH_FAIL_PROVISIONAL_LOAD_NO_HANDLE = 120,  // obsolete; no longer used
  RFH_FAIL_PROVISIONAL_LOAD_NO_ERROR = 121,   // obsolete; no longer used
  NI_IN_PAGE_NAVIGATION = 122,
  RPH_MOJO_PROCESS_ERROR = 123,
  DBMF_INVALID_ORIGIN_ON_GET_SPACE = 124,  // obsolete; no longer used
  DBMF_INVALID_ORIGIN_ON_MODIFIED = 125,   // obsolete; no longer used
  DBMF_INVALID_ORIGIN_ON_CLOSED = 126,     // obsolete; no longer used
  WSI_INVALID_HEADER_VALUE = 127,
  SWDH_SET_HOSTED_VERSION_INVALID_HOST = 128,      // obsolete; no longer used
  SWDH_SET_HOSTED_VERSION_PROCESS_MISMATCH = 129,  // obsolete; no longer used
  MSDH_INVALID_FRAME_ID = 130,                     // obsolete; no longer used
  SDH_INVALID_PORT_RANGE = 131,
  SCO_INVALID_ARGUMENT = 132,  // obsolete; no longer used
  ...
  SWDH_ENABLE_NAVIGATION_PRELOAD_NO_HOST = 143,  // obsolete; no longer used
  SWDH_ENABLE_NAVIGATION_PRELOAD_INVALID_ORIGIN = 144,       // obsolete
  SWDH_ENABLE_NAVIGATION_PRELOAD_BAD_REGISTRATION_ID = 145,  // obsolete
  RDH_TRANSFERRING_REQUEST_NOT_FOUND = 146,  // Disabled - crbug.com/659613.
  RDH_TRANSFERRING_NONNAVIGATIONAL_REQUEST = 147,
  SWDH_GET_NAVIGATION_PRELOAD_STATE_NO_HOST = 148,               // obsolete
  SWDH_GET_NAVIGATION_PRELOAD_STATE_INVALID_ORIGIN = 149,        // obsolete
  SWDH_GET_NAVIGATION_PRELOAD_STATE_BAD_REGISTRATION_ID = 150,   // obsolete
  SWDH_SET_NAVIGATION_PRELOAD_HEADER_NO_HOST = 151,              // obsolete
  SWDH_SET_NAVIGATION_PRELOAD_HEADER_INVALID_ORIGIN = 152,       // obsolete
  SWDH_SET_NAVIGATION_PRELOAD_HEADER_BAD_REGISTRATION_ID = 153,  // obsolete
  SWDH_SET_NAVIGATION_PRELOAD_HEADER_BAD_VALUE = 154,
  MDDH_INVALID_SUBSCRIPTION_REQUEST = 155,
  MDDH_INVALID_UNSUBSCRIPTION_REQUEST = 156,  // obsolete; no longer used
  AOAH_NONSENSE_DEVICE_ID = 157,              // obsolete; no longer used
  ...
  RWH_INVALID_BEGIN_FRAME_ACK_DID_NOT_SWAP = 162,      // obsolete; not used
  RWH_INVALID_BEGIN_FRAME_ACK_COMPOSITOR_FRAME = 163,  // obsolete; not used
  BFSI_INVALID_DEVELOPER_ID = 164,
  BFSI_INVALID_REQUESTS = 165,
  BFSI_INVALID_TITLE = 166,
  RWH_INVALID_FRAME_TOKEN = 167,
  RWH_BAD_FRAME_SINK_REQUEST = 168,  // obsolete; no longer used
