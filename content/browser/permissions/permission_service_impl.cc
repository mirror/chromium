...
void PermissionServiceImpl::RequestPermissions(
  ...
  int id = browser_context->GetPermissionManager()->RequestPermissions(
      request_types, context_->render_frame_host(),
      context_->GetRequestingOrigin().GetURL(), user_gesture,
...
PermissionStatus PermissionServiceImpl::GetPermissionStatusFromType(
  ...
  GURL requesting_origin(context_->GetRequestingOrigin().Serialize());
  // If the embedding_origin is empty we'll use |requesting_origin| instead.
