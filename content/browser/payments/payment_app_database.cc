...
std::unique_ptr<StoredPaymentApp> ToStoredPaymentApp(const std::string& input) {
  ...
  for (const auto& related_app : app_proto.related_application()) {
    app->related_applications.emplace_back(RelatedApplication());
