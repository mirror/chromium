...
class InvocationCallbacks
 ...
 public:
  ...
  StatusCallback getDispatchPaymentRequestEventError() {
    DCHECK_CURRENTLY_ON(BrowserThread::IO);

    return base::Bind(&InvocationCallbacks::OnErrorStatusCallback,
...
void DispatchPaymentRequestEvent(
  ...
  int payment_request_id = active_version->StartRequest(
      ...
      invocation_callbacks->getDispatchPaymentRequestEventError());
