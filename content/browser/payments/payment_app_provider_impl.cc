...
class RespondWithCallbacks
 ...
 private:
  ...
  // Close all the windows in the payment handler scope.
  // Note that this will close the windows not necessary opened through
  // PaymentRequestEvent.openWindow or Clients.openWindow().
