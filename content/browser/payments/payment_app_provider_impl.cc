...
class InvokeCallback : public payments::mojom::PaymentAppInvokeCallback {
 public:
  static payments::mojom::PaymentAppInvokeCallbackPtr Create(
    ...
    InvokeCallback* response_callback = new InvokeCallback(
        payment_request_id, std::move(service_worker_version), callback,
        statusCallback);
    payments::mojom::PaymentAppInvokeCallbackPtr callback_proxy;
 ...
 private:
  ...
  mojo::Binding<payments::mojom::PaymentAppInvokeCallback> binding_;
};
...
void DispatchPaymentRequestEvent(
  ...
  payments::mojom::PaymentAppInvokeCallbackPtr invoke_callback_ptr =
