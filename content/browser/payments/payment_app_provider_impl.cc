 ...
 public:
  InvocationCallbacks(
    ...
    request_id_ = service_worker_version->StartRequest(
        event_type, base::AdaptCallbackForRepeating(
                        base::BindOnce(&InvocationCallbacks::OnErrorStatus,
...
void DidFindRegistrationOnIO(
  ...
  active_version->RunAfterStartWorker(
      ...
      base::AdaptCallbackForRepeating(base::BindOnce(
          std::move(callback), make_scoped_refptr(active_version),
...
void FindRegistrationOnIO(
  ...
  service_worker_context->FindReadyRegistrationForIdOnly(
      registration_id, base::AdaptCallbackForRepeating(base::BindOnce(
                           &DidFindRegistrationOnIO, std::move(callback))));
}
