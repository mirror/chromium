...
class PaymentAppBrowserTest : public ContentBrowserTest {
 public:
  PaymentAppBrowserTest() : is_payment_app_cancelled_(false) {}
  ...
  void SetInvokePaymentAppCancelled() { is_payment_app_cancelled_ = true; }

  bool IsInvokePaymentAppCancelled() { return is_payment_app_cancelled_; }
 ...
 private:
  bool is_payment_app_cancelled_;
