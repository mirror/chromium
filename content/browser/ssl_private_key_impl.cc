...
void SSLPrivateKeyImpl::Sign(uint16_t algorithm,
                             const std::vector<uint8_t>& input,
                             mojom::SSLPrivateKey::SignCallback callback) {
...
void SSLPrivateKeyImpl::Callback(mojom::SSLPrivateKey::SignCallback callback,
                                 net::Error net_error,
