...
// TODO: !!! Names.
CONTENT_EXPORT extern const size_t kMaxNumberActiveRemoteWebRtcEventLogFiles;
CONTENT_EXPORT extern const size_t kMaxPendingRemoteLogFilesPerBrowserContext;

// The file extension to be associated with remote-bound logs while they are
// kept on local disk.
CONTENT_EXPORT extern const char* const kRemoteBoundLogExtension;
...
class LogFileWriter {
 ...
 protected:
  ...
  bool WriteToLogFile(LogFilesMap::iterator it, const std::string& output);
