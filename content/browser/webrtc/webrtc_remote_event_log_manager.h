...
// TODO(eladalon): Remove BrowserContext; pass an intptr_t instead.
// The BrowserContext is only used as an identifier here, and should therefore
// not be dereference-able. https://crbug.com/775415
...
class CONTENT_EXPORT WebRtcRemoteEventLogManager final
 ...
 public:
  ...
  // earlier (while it was enabled) may still be uploaded, but not additional
