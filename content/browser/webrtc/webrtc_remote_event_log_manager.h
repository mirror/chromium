...
class CONTENT_EXPORT WebRtcRemoteEventLogManager final
 ...
 public:
  ...
  // This method facilitates testing upload behavior.
  // Note that while the method is public here, it is protected in the owning
  // object (WebRtcEventLogManager), so visibility is limited to unit tests.
 ...
 private:
  ...
  // TODO: !!! Unit tests for all of the above.
  ...
  void OnWebRtcEventLogUploadCompleteInternal(const base::FilePath& file_path,
  ...
  // by the unit test.)
  std::unique_ptr<const WebRtcEventLogUploader::Factory> uploader_factory_;

  // Some unit tests will inject an observer here and test upload behavior.
  WebRtcEventLogUploaderObserver* upload_observer_for_testing_;
