...
class CONTENT_EXPORT WebRtcRemoteEventLogManager final
 ...
 public:
  ...
  // TODO: !!!
  // TODO: !!! also mention it's being torn down.
  void DisableForBrowserContext(const BrowserContext* browser_context);
 ...
 protected:
  ...
  // Same as the other version of GetLogsDirectoryPath(), but allows us to
  // know the path before the BrowserContext is initialized; this is useful
  // in unit tests.
  static base::FilePath GetLogsDirectoryPath(
