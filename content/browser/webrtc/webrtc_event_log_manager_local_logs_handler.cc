...
bool WebRtcEventLogManagerLocalLogsHandler::PeerConnectionAdded(int render_process_id, int lid) {
...
bool WebRtcEventLogManagerLocalLogsHandler::PeerConnectionRemoved(int render_process_id, int lid) {
...
bool WebRtcEventLogManagerLocalLogsHandler::EnableLocalLogging(base::FilePath base_path, size_t max_file_size_bytes) {
  if (!local_logs_base_path_.empty()) {
    return false;
  }
...
bool WebRtcEventLogManagerLocalLogsHandler::DisableLocalLogging() {
  if (local_logs_base_path_.empty()) {
    return false;
  }
...
void WebRtcEventLogManagerLocalLogsHandler::SetLocalLogsObserver(WebRtcLocalEventLogsObserver* observer) {
  local_logs_observer_ = observer;
}

void WebRtcEventLogManagerLocalLogsHandler::InjectClockForTesting(base::Clock* clock) {
  clock_for_testing_ = clock;
}

void WebRtcEventLogManagerLocalLogsHandler::StartLocalLogFile(int render_process_id, int lid) {
...
void WebRtcEventLogManagerLocalLogsHandler::StopLocalLogFile(int render_process_id, int lid) {
  auto it = local_logs_.find(PeerConnectionKey(render_process_id, lid));
  if (it == local_logs_.end()) {
    return;
  }
  CloseLocalLogFile(it);
//  MaybeUpdateWebRtcEventLoggingState(render_process_id, lid);  // TODO: !!!
}

bool WebRtcEventLogManagerLocalLogsHandler::WriteToLocalLogFile(
...
WebRtcEventLogManagerLocalLogsHandler::LocalLogFilesMap::iterator
WebRtcEventLogManagerLocalLogsHandler::CloseLocalLogFile(LocalLogFilesMap::iterator it) {
...
base::FilePath WebRtcEventLogManagerLocalLogsHandler::GetLocalFilePath(
