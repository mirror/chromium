...
bool WebRtcEventLogManagerLocalLogsHandler::EnableLogging(
...
bool WebRtcEventLogManagerLocalLogsHandler::DisableLogging() {
  if (base_path_.empty()) {
    return false;
  }
...
bool WebRtcEventLogManagerLocalLogsHandler::EventLogWrite(
    int render_process_id,
    int lid,
...
void WebRtcEventLogManagerLocalLogsHandler::StartLogFile(
    int render_process_id,
    int lid) {
...
void WebRtcEventLogManagerLocalLogsHandler::StopLogFile(
    int render_process_id,
    int lid) {
  auto it = local_logs_.find(PeerConnectionKey(render_process_id, lid));
  if (it == local_logs_.end()) {
...
WebRtcEventLogManagerLocalLogsHandler::LogFilesMap::iterator
WebRtcEventLogManagerLocalLogsHandler::CloseLogFile(LogFilesMap::iterator it) {
