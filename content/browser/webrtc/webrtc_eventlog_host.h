...
class CONTENT_EXPORT WebRTCEventLogHost {
 ...
 private:
  ...
  // RecordRtcEventLogRemoved() returns whether actual removal took place.
  void RecordRtcEventLogAdded(int peer_connection_local_id);
  bool RecordRtcEventLogRemoved(int peer_connection_local_id);
