...
bool WebRtcRemoteEventLogManager::StartRemoteLogging(int render_process_id, int lid,
                                                     size_t max_file_size_bytes) {
  // TODO: !!!
  return true;
}

bool WebRtcRemoteEventLogManager::StopRemoteLogging(int render_process_id, int lid) {
  // TODO: !!!
  return true;
}
