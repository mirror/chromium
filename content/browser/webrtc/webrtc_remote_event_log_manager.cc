...
bool WebRtcRemoteEventLogManager::StartRemoteLogging(
  ...
  // TODO: !!! Consider disallowing unlimited size.
  CHECK(!browser_context->IsOffTheRecord());
...
bool WebRtcRemoteEventLogManager::MaybeCreateLogsDirectory(
  ...
  if (base::PathExists(path)) {
    ...
    // TODO: !!! Check what happens if permissions change while we're running?
    // TODO: !!! Check what happens if permissions change when we restart
    // Chrome?
