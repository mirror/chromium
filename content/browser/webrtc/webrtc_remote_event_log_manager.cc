...
WebRtcRemoteEventLogManager::WebRtcRemoteEventLogManager(
    ...
    : log_extension_(FILE_PATH_LITERAL("log")),
      ...
      upload_observer_for_testing_(nullptr) {}
...
void WebRtcRemoteEventLogManager::SetWebRtcEventLogUploaderObserverForTesting(
    WebRtcEventLogUploaderObserver* observer) {
  upload_observer_for_testing_ = observer;
}
...
void WebRtcRemoteEventLogManager::OnWebRtcEventLogUploadCompleteInternal(
  ...
  if (upload_observer_for_testing_) {
    upload_observer_for_testing_->OnWebRtcEventLogUploadComplete(
        file_path, upload_successful);
  }
