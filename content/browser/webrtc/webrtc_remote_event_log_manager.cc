...
// TODO: !!! Retry limit? Following discussion with terelius, we'll just
// delete the file after the first time.
...
void WebRtcRemoteEventLogManager::OnWebRtcEventLogUploadSuccess() {
  base::SequencedTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(
          &WebRtcRemoteEventLogManager::OnWebRtcEventLogUploadFinished,
          base::Unretained(this), true));
  // TODO(eladalon): Send indication of success back to JS.
...
void WebRtcRemoteEventLogManager::OnWebRtcEventLogUploadFailure() {
  ...
  // TODO(eladalon): Send indication of failure back to JS.
  // https://crbug.com/775415
}
...
void WebRtcRemoteEventLogManager::OnWebRtcEventLogUploadFinished(
