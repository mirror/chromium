...
void WebRtcEventLogManager::LocalRtcEventLogStart(
...
void WebRtcEventLogManager::LocalRtcEventLogStop(int render_process_id,
                                                 int lid) {
  DCHECK_CURRENTLY_ON(BrowserThread::UI);
  file_task_runner_->PostTask(
      FROM_HERE,
...
void WebRtcEventLogManager::OnRtcEventLogWrite(int render_process_id,
                                               int lid,
