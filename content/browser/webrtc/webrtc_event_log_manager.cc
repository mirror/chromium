...
void WebRtcEventLogManager::PeerConnectionAddedInternal(
  ...
  if (!local_logs_base_path_.empty() && local_logs_.size() < kMaxNumberLogFiles) {
...
void WebRtcEventLogManager::DisableLocalLoggingInternal(
  ...
  std::set<PeerConnectionKey> removed_logs;
...
WebRtcEventLogManager::LocalLogFilesMap::iterator WebRtcEventLogManager::CloseLocalLogFile(
