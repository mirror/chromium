...
// configuration. We are going to use this to set up fake devices that responds
...
struct GetPhotoCapabilitiesFailsConfigTraits {
...
using WebRtcImageCaptureGetCapabilitiesFailsBrowserTest =
    WebRtcImageCaptureCustomConfigFakeDeviceBrowserTest<
        GetPhotoCapabilitiesFailsConfigTraits>;
