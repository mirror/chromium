...
// TODO: !!!!!!!!!!!!!!!
// // This uploader "hangs" - it does not upload anything, nor prtends to have
// // finished. Most importantly, it does not get rid of the locally-stored log
// // file after finishing a simulated upload; this is useful because it keeps
// // the file on disk, where unit tests may inspect it.
