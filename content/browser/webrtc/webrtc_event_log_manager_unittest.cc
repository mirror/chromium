...
class WebRtcEventLogManagerTest : public ::testing::TestWithParam<bool>,
 ...
 public:
  ...
  void WaitForReply() {
    // Please note that you must not write tests that would produce two replies
    // that could potentially be fired without a wait strictly in between them.
    run_loop_->Run();
