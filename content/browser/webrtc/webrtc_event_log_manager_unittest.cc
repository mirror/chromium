...
class WebRtcEventLogManagerTest : public ::testing::Test,
 ...
 public:
  ...
  void ExpectUploadComplete(  // const base::FilePath& file_path, // TODO: !!!
...
TEST_F(WebRtcEventLogManagerTest, FinishedRemoteLogsUploaded) {
  ...
  NiceMock<MockWebRtcRemoteEventLogsObserver> logs_observer;
  SetRemoteLogsObserver(&logs_observer);

  // NiceMock<MockWebRtcEventLogUploaderObserver> upload_observer;
  // SetWebRtcEventLogUploaderObserverForTesting(this);
