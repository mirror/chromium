...
class WebRtcEventLogManagerTest : public ::testing::Test {
 public:
  ...
  // TODO: !!! Rename to local_logs_base_dir_.
...
// TODO(eladalon): Add unit tests that make sure that inability to create the
// remote logs' directory is handled gracefully. (Postponed because it requires
// changes to TestBrowserContext that would introduce a version of the ctor that
// would take on a temporary directory created externally.)
...
// TODO: !!! Prove support for different maximum values for remote logs.
...
// TODO: !!! Maximum file size for remote.
