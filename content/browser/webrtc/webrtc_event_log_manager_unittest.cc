...
class NullWebRtcEventLogUploaderFactory : public WebRtcEventLogUploaderFactory {
 public:
  ~NullWebRtcEventLogUploaderFactory() override = default;
 ...
 public:
  ...
  void SetUp() override {
    manager_->SetWebRtcEventLogUploaderFactoryForTesting(
        std::make_unique<NullWebRtcEventLogUploaderFactory>());
...
class MockWebRtcEventLogUploaderObserver
 ...
 public:
  ...
  MOCK_METHOD1(OnWebRtcEventLogUploadComplete, void(bool));
};
...
TEST_F(WebRtcEventLogManagerTest, FinishedRemoteLogsUploaded) {
  ...
  SetWebRtcEventLogUploaderObserverForTesting(&upload_observer);
