...
class CONTENT_EXPORT WebRtcEventLogManager
 ...
 private:
  ...
  // TODO: !!!
  const BrowserContext* GetBrowserContextFromPeerConnection(
  ...
  std::map<BrowserContext*, WebRtcRemoteEventLogManager> remote_logs_managers_;

  // TODO: !!!
  std::map<PeerConnectionKey, BrowserContext*> pc_to_browser_context_mapping_;
