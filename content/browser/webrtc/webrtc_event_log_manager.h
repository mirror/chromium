...
class CONTENT_EXPORT WebRtcEventLogManager
 ...
 public:
  ...
  // TODO: !!! Comment
  // If a reply callback is given, it will be posted back to BrowserThread::UI.
  // The value provided to the callback would be:
  // * If the log could not be written in its entirety to either the local or
  //   the remote-bound file, false.
  // * If, for both the local as well as the remote-bound file, the log was
  //   either uninteresting OR written in its entirety, true.
