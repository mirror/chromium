...
class CONTENT_EXPORT WebRtcEventLogManager
 ...
 private:
  ...
  // TODO: !!! Same for remote logs, to know if they're ever closed prematurely?

  // WebRtcRemoteEventLogsObserver implementation:
  void OnRemoteLogStopped(WebRtcEventLogPeerConnectionKey pc_key) override;

  void OnLoggingTargetStarted(LoggingTarget target, PeerConnectionKey pc_key);
  void OnLoggingTargetStopped(LoggingTarget target, PeerConnectionKey pc_key);
  ...
  // TODO: !!! This comment might no longer be correct.
