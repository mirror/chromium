...
class CONTENT_EXPORT WebRtcEventLogManager {
 public:
  ...
  // TODO(eladalon): !!! Document the results.
  ...
  void LocalWebRtcEventLogStart(int render_process_id,
                                ...
                                base::Callback<void(base::FilePath)> reply =
                                    base::Callback<void(base::FilePath)>());
 ...
 protected:
  friend class WebRtcEventLogManagerTest;  // TODO(eladalon): !!! Remove.
  // TODO(eladalon): WebRtcEventlogHostTest should be removed, and with it
