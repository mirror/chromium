...
class CONTENT_EXPORT WebRtcEventLogManager
 ...
 public:
  ...
  // initialization.
  // This function must not be called for a off-the-records BrowserContext.
  // Local-logging is not associated with BrowserContexts, and therefore
  // allowed even if EnableForBrowserContext is not called.
 ...
 private:
  ...
  void EnableForBrowserContextInternal(const BrowserContext* browser_context,
