...
class CONTENT_EXPORT SpeechRecognitionDispatcherHost
 ...
 public:
  ...
  void AbortRequest(int32_t render_view_id, int32_t request_id) override;
  void AbortAllRequests(int32_t render_view_id) override;
  void StopCaptureRequest(int32_t render_view_id, int32_t request_id) override;
