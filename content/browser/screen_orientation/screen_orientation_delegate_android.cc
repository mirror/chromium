...
bool ScreenOrientationDelegateAndroid::ScreenOrientationProviderSupported() {
  // TODO: Consider moving isOrientationLockEnabled to a separate function, so
  // reported error messages can differentiate between the device never
  // supporting orientation or currently not support orientation.
