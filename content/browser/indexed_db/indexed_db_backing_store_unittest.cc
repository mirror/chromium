      ...
      base::BindOnce(
          [](IndexedDBBackingStore* backing_store) {
...

            {
              ...
              leveldb::Status s =
                  metadata_factory.CreateAndWriteDatabaseMetadata(
              ...
              s = metadata_factory.CreateAndWriteObjectStore(
              ...
              s = metadata_factory.CreateAndWriteIndex(
...

            {
              IndexedDBDatabaseMetadata database;
              bool found;
              leveldb::Status s = metadata_factory.ReadFullDatabaseMetadata(
                  backing_store->db(), backing_store->origin_identifier(),
  ...
  idb_context_->TaskRunner()->PostTask(
      FROM_HERE, base::BindOnce(
                     [](IndexedDBBackingStore* backing_store) {
                       ...
                       s = metadata_factory.CreateAndWriteDatabaseMetadata(
                           backing_store->db(),
