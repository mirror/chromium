      ...
      base::BindOnce(
          [](IndexedDBBackingStore* backing_store) {
...

            {
              ...
              leveldb::Status s = metadata_factory.CreateDatabase(
              ...
              s = metadata_factory.CreateObjectStore(
              ...
              s = metadata_factory.CreateIndex(
...

            {
              IndexedDBDatabaseMetadata database;
              bool found;
              leveldb::Status s = metadata_factory.ReadDatabase(
                  backing_store->db(), backing_store->origin_identifier(),
  ...
  idb_context_->TaskRunner()->PostTask(
      FROM_HERE, base::BindOnce(
                     [](IndexedDBBackingStore* backing_store) {
                       ...
                       s = metadata_factory.CreateDatabase(
                           backing_store->db(),
