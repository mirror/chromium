...
Status ReadIndexes(LevelDBDatabase* db,
  ...
  IDB_TRACE("IndexedDBMetadataFactory::ReadIndexes");
...
Status ReadObjectStores(
  ...
  IDB_TRACE("IndexedDBMetadataFactory::ReadObjectStores");
...
Status IndexedDBMetadataCoding::ReadDatabase(
    LevelDBDatabase* db,
    const std::string& origin_identifier,
...
Status IndexedDBMetadataCoding::CreateObjectStore(
  ...
  IDB_TRACE("IndexedDBMetadataFactory::CreateAndWriteObjectStoreMetadata");
  if (!KeyPrefix::ValidIds(database_id, object_store_id))
    return InvalidDBKeyStatus();
...
Status IndexedDBMetadataCoding::DeleteObjectStore(
  ...
  IDB_TRACE("IndexedDBMetadataFactory::DeleteMetadata");
...
Status IndexedDBMetadataCoding::RenameObjectStore(
    ...
    IndexedDBObjectStoreMetadata* metadata) {
  IDB_TRACE("IndexedDBMetadataFactory::Rename");
...
Status IndexedDBMetadataCoding::CreateIndex(LevelDBTransaction* transaction,
  ...
  IDB_TRACE("IndexedDBMetadataFactory::CreateIndex");
