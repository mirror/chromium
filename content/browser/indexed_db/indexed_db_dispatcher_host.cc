...
class IndexedDBDispatcherHost::IDBSequenceHelper {
 public:
  ...
  void GetDatabasesInfoOnIDBThread(scoped_refptr<IndexedDBCallbacks> callbacks,
...
void IndexedDBDispatcherHost::GetDatabasesInfo(
  ...
  IDBTaskRunner()->PostTask(
      FROM_HERE, base::BindOnce(&IDBSequenceHelper::GetDatabasesInfoOnIDBThread,
...
void IndexedDBDispatcherHost::IDBSequenceHelper::GetDatabasesInfoOnIDBThread(
    scoped_refptr<IndexedDBCallbacks> callbacks,
    const url::Origin& origin) {
  DCHECK(indexed_db_context_->TaskRunner()->RunsTasksInCurrentSequence());

  base::FilePath indexed_db_path = indexed_db_context_->data_path();
  indexed_db_context_->GetIDBFactory()->GetDatabasesInfo(
