...
class CONTENT_EXPORT SiteInstanceImpl final : public SiteInstance,
 ...
 public:
  ...
  // SiteInstance. If none exists, and there are unmatched service worker
  // processes of the site, the newest process is reused. If none exists a new
  ...
  enum class ProcessReusePolicy {
    ...
    // In this mode, SiteInstances doesn't proactively reuse processes. An
