...
class CONTENT_EXPORT SiteInstanceImpl final : public SiteInstance,
 ...
 public:
  ...
  // Returns the URL which was used to set the site for this SiteInstance.
  // May be empty if this SiteInstance does not have a site.
 ...
 private:
  ...
  // The URL which was used to set the site for this SiteInstance.
  GURL original_url_;
