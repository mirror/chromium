...
class TestInterstitialPage : public InterstitialPageImpl {
 public:
  ...
  void TestDidNavigate(int nav_entry_id,
    ...
    InitNavigateParams(params.get(), nav_entry_id, did_create_new_entry, url,
...
TEST_F(WebContentsImplTest, UpdateTitle) {
  ...
  auto params = mojom::DidCommitProvisionalLoadParams::New();
  InitNavigateParams(params.get(), 0, true, GURL(url::kAboutBlankURL),
                     ui::PAGE_TRANSITION_TYPED);
...
TEST_F(WebContentsImplTest, DirectNavigationToViewSourceWebUI) {
  ...
  auto params = mojom::DidCommitProvisionalLoadParams::New();
  InitNavigateParams(params.get(), entry_id, true, kRewrittenURL,
                     ui::PAGE_TRANSITION_TYPED);
