...
class WebContentsImpl::ColorChooser : public content::mojom::ColorChooser {
 public:
  ...
  // mojo bindings.
  mojo::Binding<content::mojom::ColorChooser> binding_;
...
void WebContentsImpl::DidChooseColorInColorChooser(SkColor color) {
  color_chooser_->client_->DidChooseColor(color);
}
