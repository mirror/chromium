...
void WebContentsImpl::SetAsFocusedWebContentsIfNecessary() {
  ...
  LOG(ERROR) << "SetAsFocused this=" << this <<"(parent = " << GetOuterWebContents() <<"), old_contents="<<old_contents << "(parent = " << (old_contents?old_contents->GetOuterWebContents() : nullptr) << "), guest is " << browser_plugin_guest_.get();
  ...
  if (!GuestMode::IsCrossProcessFrameGuest(this) && browser_plugin_guest_) {
    ...
    GetOuterWebContents()->GetMainFrame()->GetRenderWidgetHost()->SetPageFocus(true);
    return;
  }
