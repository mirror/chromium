...
WebContents* WebContents::CreateWithSessionStorage(
  ...
  new_contents->SetOpenerForNewContents(
      FindOpenerRFH(params)->frame_tree_node(), params.opener_suppressed);
...
WebContentsImpl* WebContentsImpl::CreateWithOpener(
  ...
  FrameTreeNode* opener = opener_rfh->frame_tree_node();
  WebContentsImpl* new_contents = new WebContentsImpl(params.browser_context);
...
WebContents* WebContentsImpl::Clone() {
  ...
  WebContentsImpl* tc = CreateWithOpener(
      create_params, frame_tree_.root()->opener()->current_frame_host());
