...
class CONTENT_EXPORT WebContentsImpl : public WebContents,
                                       ...
                                       public content::mojom::ColorChooser,
 ...
 public:
  ...
  // content::mojom::ColorChooser ----------------------------------------------

  void OpenColorChooser(
      content::mojom::ColorChooserClientAssociatedPtrInfo client,
      uint32_t id,
      SkColor color,
      std::vector<content::mojom::ColorSuggestionPtr> suggestions) override;
  void EndColorChooser(uint32_t id) override;
  void SetSelectedColorInColorChooser(uint32_t id, SkColor color) override;
 ...
 private:
  ...
  struct ColorChooserInfo {
    ColorChooserInfo(content::ColorChooser* chooser,
                     content::mojom::ColorChooserClientAssociatedPtrInfo,
                     int identifier);
    ~ColorChooserInfo();

    // TODO(joelhockey): remove Matches
    bool Matches(int color_chooser_id);

    // Color chooser that was opened by this tab.
    std::unique_ptr<content::ColorChooser> chooser;

    // mojo renderer client.
    content::mojom::ColorChooserClientAssociatedPtr client;
  ...
  std::unique_ptr<
      content::WebContentsFrameBindingSet<content::mojom::ColorChooser>>
      color_chooser_bindings_;
  content::mojom::ColorChooserClientPtr color_chooser_client_;
