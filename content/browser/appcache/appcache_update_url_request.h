...
// URLRequest subclass for the AppCacheUpdateRequestBase class. Provides
// functionality to update the AppCache using functionality provided by the
// URLRequest class.
class AppCacheUpdateURLRequest : public AppCacheUpdateRequestBase,
                                 public net::URLRequest::Delegate {
 public:
  ~AppCacheUpdateURLRequest() override;

  // AppCacheUpdateRequestBase overrides.
  void Start() override;
 ...
 private:
  AppCacheUpdateURLRequest(net::URLRequestContext* request_context,
                           const GURL& url,
                           URLFetcher* fetcher);

  friend class AppCacheUpdateRequestBase;

  std::unique_ptr<net::URLRequest> request_;
  URLFetcher* fetcher_;

  DISALLOW_COPY_AND_ASSIGN(AppCacheUpdateURLRequest);
};
