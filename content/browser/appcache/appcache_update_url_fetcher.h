...
class AppCacheUpdateRequestBase;
...
class URLFetcher {
 public:
  ...
  AppCacheUpdateRequestBase* request() const { return request_.get(); }
 ...
 private:
  ...
  friend class AppCacheUpdateURLRequest;
  ...
  std::unique_ptr<AppCacheUpdateRequestBase> request_;
