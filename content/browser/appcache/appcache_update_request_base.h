...
class AppCacheUpdateJob::UpdateRequestBase {
 public:
  ...
  // Returns a weak pointer reference to the update request.
  base::WeakPtr<AppCacheUpdateJob::UpdateRequestBase> GetWeakPtr();
 ...
 protected:
  ...
  base::WeakPtrFactory<AppCacheUpdateJob::UpdateRequestBase> weak_factory_;
};
