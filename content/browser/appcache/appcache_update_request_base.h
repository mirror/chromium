...
class AppCacheUpdateRequestBase {
 public:
  virtual ~AppCacheUpdateRequestBase();

  // Creates an instance of the AppCacheUpdateRequestBase subclass.
  static std::unique_ptr<AppCacheUpdateRequestBase> Create(
 ...
 protected:
  AppCacheUpdateRequestBase();

 private:
  DISALLOW_COPY_AND_ASSIGN(AppCacheUpdateRequestBase);
};
