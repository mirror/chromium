...
class CONTENT_EXPORT AppCacheRequestHandler
 ...
 public:
  ...
  // The AppCacheInterceptor calls these directly when we're using
  // the network library based impl. The network service specific
  // MaybeLoad methods call these internally when we're using the
  // NetworkService based impl.
