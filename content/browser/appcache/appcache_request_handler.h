...
class CONTENT_EXPORT AppCacheRequestHandler
 ...
 public:
  ...
  // These methods are used by the NavigationURLLoaderNetworkService for
  // loading the main resource during a navigation and to setup a factory
  // which will be used later to produce subresource loaders.
  ...
  // These methods are used for subresource loading.
