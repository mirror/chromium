...
// URLLoaderClient subclass for the AppCacheUpdateRequestBase class. Provides
// functionality to update the AppCache using functionality provided by the
// network URL loader
class AppCacheUpdateURLLoaderRequest : public AppCacheUpdateRequestBase,
                                       public mojom::URLLoaderClient {
 public:
  ~AppCacheUpdateURLLoaderRequest() override;
 ...
 private:
  AppCacheUpdateURLLoaderRequest(net::URLRequestContext* request_context,
                                 const GURL& url,
                                 URLFetcher* fetcher);
  ...
  DISALLOW_COPY_AND_ASSIGN(AppCacheUpdateURLLoaderRequest);
};
