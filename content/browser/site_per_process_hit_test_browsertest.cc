...
IN_PROC_BROWSER_TEST_F(SitePerProcessBrowserTest, MainframeTouchEventRouting) {
  GURL main_url(
...
// // Site per process browser tests that use viz-hit-test.
// class SitePerProcessVizBrowserTest : public SitePerProcessBrowserTest {
// public:
//   SitePerProcessVizBrowserTest() {}
//
// protected:
//   void SetUpCommandLine(base::CommandLine* command_line) override {
//     SitePerProcessBrowserTest::SetUpCommandLine(command_line);
//     command_line->AppendSwitch(switches::kUseVizHitTest);
//   }
//
// private:
//   mojo::ScopedSharedBufferMapping active_buffer_;
//
//   DISALLOW_COPY_AND_ASSIGN(SitePerProcessVizBrowserTest);
// };
