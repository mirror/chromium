...
class CONTENT_EXPORT ServiceWorkerProviderHost
 ...
 public:
  ...
  // the active_version and controller may temporarily differ. For
 ...
 private:
  ...
  // Sets the controller version field to |controller| or if |controller| is
  // nullptr, clears the field. If |notify_controllerchange| is true, instructs
  // the renderer to dispatch a 'controller' change event.
  void SetControllerVersionAttribute(ServiceWorkerVersion* controller,
                                     bool notify_controllerchange);
