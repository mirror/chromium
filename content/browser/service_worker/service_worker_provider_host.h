...
class CONTENT_EXPORT ServiceWorkerProviderHost
 ...
 public:
  ...
  // The object info holds a
  // Mojo connection to the ServiceWorkerHandle for the
  // |version| to ensure the handle stays alive while the object info is
 ...
 private:
  ...
  // is created.
  ServiceWorkerHandle* precreated_controller_handle_;
