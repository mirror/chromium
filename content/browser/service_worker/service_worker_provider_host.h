...
//
// A ServiceWorkerProviderHost instance is created when
// ServiceWorkerNetworkProvider is created on the renderer process for
// navigation or hosting service worker's context. Mojo's connection from
