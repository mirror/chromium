...
class CONTENT_EXPORT ServiceWorkerProviderHost
 ...
 public:
  ...
  // |registration| to ensure the ServiceWorkerRegistrationObjectHost instance
  // stays alive while the object info is alive. A new
  // ServiceWorkerRegistrationObjectHost instance is created if one does not
  // already exist.
