...
class EmbeddedWorkerTestHelper::MockRendererInterface : public mojom::Renderer {
 public:
  MockRendererInterface(base::WeakPtr<EmbeddedWorkerTestHelper> helper)
      : helper_(helper) {}

  void Bind(mojom::RendererAssociatedRequest request) {
...
EmbeddedWorkerTestHelper::EmbeddedWorkerTestHelper(
    ...
    : browser_context_(base::MakeUnique<TestBrowserContext>()),
      render_process_host_(
          base::MakeUnique<MockRenderProcessHostImpl>(browser_context_.get())),
  ...
  mock_renderer_interface_->Bind(
      render_process_host_->MakeRequestForRendererInterface());
  mock_renderer_interface_->Bind(
      new_render_process_host_->MakeRequestForRendererInterface());
}
