...
class CONTENT_EXPORT ServiceWorkerScriptURLLoader
 ...
 private:
  ...
  bool are_headers_written_ = false;
  ...
  // This is a barrier closure for synchronizing the completion of the message
  // pipe read with the completion of the data pipe read.
