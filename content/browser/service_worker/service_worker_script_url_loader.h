...
// time. This forwards a service worker script (a main script or an imported
// script) fetched via the network service to the service worker context in a
// renderer process while storing them in the service worker's script cache.
...
class CONTENT_EXPORT ServiceWorkerScriptURLLoader
 ...
 private:
  ...
  // Writes the given data into the ServiceWorkerDiskCache.
