...
TEST_F(ServiceWorkerURLRequestJobTest, Simple) {
  ...
  EXPECT_EQ(blink::mojom::ServiceWorkerResponseType::kDefault,
 ...
 protected:
  void OnFetchEvent(
    ...
    response_callback->OnResponse(
        ServiceWorkerResponse(
            base::MakeUnique<std::vector<GURL>>(), 200, "OK",
            blink::mojom::ServiceWorkerResponseType::kDefault, MakeHeaders(),
  ...
  void OnFetchEvent(
    ...
    response_callback->OnResponseStream(
        ServiceWorkerResponse(
            base::MakeUnique<std::vector<GURL>>(), 200, "OK",
            blink::mojom::ServiceWorkerResponseType::kDefault, MakeHeaders(),
            "", 0, blink::kWebServiceWorkerResponseErrorUnknown, base::Time(),
            false /* response_is_in_cache_storage */,
            std::string() /* response_cache_storage_cache_name */,
            base::MakeUnique<
                ServiceWorkerHeaderList>() /* cors_exposed_header_names */),
