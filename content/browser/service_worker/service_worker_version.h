...
class CONTENT_EXPORT ServiceWorkerVersion
 ...
 private:
  ...
  // Returns true if the service worker has work to do on the browser: it has
  // pending requests, in-progress streaming URLRequestJobs, or pending start
  // callbacks.
  //
