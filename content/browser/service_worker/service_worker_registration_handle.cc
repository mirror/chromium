...
void ServiceWorkerRegistrationHandle::Clone(
    blink::mojom::ServiceWorkerRegistrationHostAssociatedRequest request) {
...
void ServiceWorkerRegistrationHandle::OnConnectionError() {
  ...
  if (dispatcher_host_) {
    // Will destroy |this|.
    dispatcher_host_->RemoveServiceWorkerRegistrationHandle(handle_id_);
  }
}
