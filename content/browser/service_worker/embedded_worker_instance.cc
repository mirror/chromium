...
void SetupOnUIThread(
  ...
  if (request.is_pending()) {
    rph->GetRendererInterface()->CreateEmbeddedWorkerInstanceClient(
        mojom::CreateEmbeddedWorkerInstanceClientParams::New(
            std::move(request)));
  }
...
class EmbeddedWorkerInstance::StartTask {
 ...
 private:
  ...
  // Ownership is transferred to a PostTask() call after process allocation.
