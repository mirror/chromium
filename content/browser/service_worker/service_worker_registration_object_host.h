...
//
// During lifetime of |this|, there may have multiple calls to
// CreateObjectInfo() creating multiple references (associated interface
// pointers of blink::mojom::ServiceWorkerRegistrationObjectHost) of |this|,
// these references are passed to the corresponding WebServiceWorkerRegistration
// in the renderer process, although at any given time point only one reference
// is kept there. Once all these references disappeared, |this| will be
// destroyed.
//
