...
// The host stays alive while the WebServiceWorkerRegistration is alive, it
// destroys itself once detected it's no longer needed (all
// ServiceWorkerRegistrationObjectHost Mojo connections bound on it have
// broken), at the same time also initiates destruction of the
