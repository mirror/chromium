...
void ServiceWorkerStorage::DidDeleteDatabase(
  ...
  // Delete the disk cache.  We want to make sure it's BLOCK_SHUTDOWN in order
  // to support ClearSessionOnlyOrigins() (called due to the "clear on browser
  // exit" content setting).
