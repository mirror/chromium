...
TEST_F(ServiceWorkerJobTest, Unregister) {
  ...
  // During registration, service worker handles will be created for hosting the
  // worker's context. KeepHandlesDispatcherHost will store the handles.
  ...
  // has been created/added into this provider host for the worker's context.
