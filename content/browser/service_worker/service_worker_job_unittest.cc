...
scoped_refptr<ServiceWorkerRegistration> ServiceWorkerJobTest::RunRegisterJob(
  ...
  EXPECT_TRUE(job_timer_running());
  EXPECT_FALSE(called);
  base::RunLoop().RunUntilIdle();
  EXPECT_TRUE(called);
  EXPECT_FALSE(job_timer_running());
  return registration;
}
...
void ServiceWorkerJobTest::SetJobTimeOutAndHandle() {
