...
void ServiceWorkerURLLoaderJob::StartRequest() {
  ...
  std::unique_ptr<ServiceWorkerFetchRequest> fetchRequest =
      ServiceWorkerLoaderHelpers::CreateFetchRequest(resource_request_);
  fetchRequest->blob = request_body_blob_handle_;

  fetch_dispatcher_ = std::make_unique<ServiceWorkerFetchDispatcher>(
      std::move(fetchRequest), active_worker, resource_request_.resource_type,
...
void ServiceWorkerURLLoaderJob::CreateRequestBodyBlob() {
...
bool ServiceWorkerURLLoaderJob::HasRequestBody() {
  ...
  return resource_request_.request_body.get() && blob_storage_context_;
}
