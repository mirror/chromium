...
const base::TimeDelta ServiceWorkerVersion::kTimeoutTimerDelay =
    base::TimeDelta::FromSeconds(30);
const base::TimeDelta ServiceWorkerVersion::kStartNewWorkerTimeout =
    base::TimeDelta::FromMinutes(5);
const base::TimeDelta ServiceWorkerVersion::kStopWorkerTimeout =
