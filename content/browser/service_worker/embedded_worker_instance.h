...
class CONTENT_EXPORT EmbeddedWorkerInstance
 ...
 private:
  ...
  class StartingPhaseTracker {
   public:
    StartingPhaseTracker(const EmbeddedWorkerInstance* owner);

    void Start(const GURL& script_url);
    void NextPhase();
    void Done();
    void Reset();
   ...
   private:
    ...
    const EmbeddedWorkerInstance* owner_;
    StartingType type_;
