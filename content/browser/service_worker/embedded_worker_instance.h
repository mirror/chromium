...
class CONTENT_EXPORT EmbeddedWorkerInstance
 ...
 private:
  ...
  // |pending_installed_scripts_info_| |pending_service_worker_host_ptr_info_|
  // are parameters of the StartWorker message. These are called "pending"
  // because they are not used directly by this class and are just transferred
  // to the renderer in SendStartWorker().
