...
class CONTENT_EXPORT ServiceWorkerHandle
 ...
 public:
  ...
  // delete itself once it detected that all the Mojo connections have gone
  // away.
  //
  // If |dispatcher_host| is non-null, this instance also registers itself
  // into |dispatcher_host| to be owned there and unregisters itself on
  // destruction.
