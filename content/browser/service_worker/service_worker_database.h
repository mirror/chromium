...
class CONTENT_EXPORT ServiceWorkerDatabase {
 public:
  ...
  // |user_data_name_prefix| from the database. Returns OK only if keys matched
  // to |user_data_name_prefix| are found; otherwise NOT_FOUND, and
  // |user_data_map| will be empty.
