...
class ServiceWorkerNavigationHintUMATest : public ServiceWorkerVersionTest {
 protected:
  ...
  static const char kStartForNavigationHintPrecision[];
...
const char
    ServiceWorkerNavigationHintUMATest::kStartForNavigationHintPrecision[] =
        "ServiceWorker.StartForNavigationHintPrecision";

TEST_F(ServiceWorkerNavigationHintUMATest, Precision) {
  version_->SetStatus(ServiceWorkerVersion::ACTIVATED);
  StartWorker(ServiceWorkerMetrics::EventType::NAVIGATION_HINT);
  StopWorker();
  histogram_tester_.ExpectBucketCount(kStartForNavigationHintPrecision, true,
                                      0);
  histogram_tester_.ExpectBucketCount(kStartForNavigationHintPrecision, false,
                                      1);
...
TEST_F(ServiceWorkerNavigationHintUMATest, ConcurrentStart) {
  ...
  histogram_tester_.ExpectTotalCount(kStartForNavigationHintPrecision, 0);
  ...
  histogram_tester_.ExpectTotalCount(kStartForNavigationHintPrecision, 1);
  histogram_tester_.ExpectBucketCount(kStartForNavigationHintPrecision, true,
                                      1);
  histogram_tester_.ExpectBucketCount(kStartForNavigationHintPrecision, false,
                                      0);
...
TEST_F(ServiceWorkerNavigationHintUMATest, StartWhileStopping) {
  ...
  histogram_tester_.ExpectTotalCount(kStartForNavigationHintPrecision, 2);
}
