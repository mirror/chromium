...
class MessageReceiver : public EmbeddedWorkerTestHelper {
 public:
  ...
  void SimulateSWGlobalScopeSetCachedMetadata(
  ...
  void SimulateSWGlobalScopeClearCachedMetadata(int embedded_worker_id,
                                                const GURL& url) {
    ASSERT_TRUE(
        embedded_worker_id_service_worker_host_ptr_map_[embedded_worker_id]);
    embedded_worker_id_service_worker_host_ptr_map_[embedded_worker_id]
...
TEST_F(ServiceWorkerVersionTest, UpdateCachedMetadataFromSWGlobalScope) {
  ...
  helper_->SimulateSWGlobalScopeSetCachedMetadata(
  ...
  // scope.
  helper_->SimulateSWGlobalScopeClearCachedMetadata(
