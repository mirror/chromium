...
void ExpectNoNavPreloadStartWorkerExistingProcessUMA(
    const base::HistogramTester& histogram_tester) {
  histogram_tester.ExpectTotalCount(
      "ServiceWorker.NavPreload.FinishedFirst_StartWorkerExistingProcess", 0);
  histogram_tester.ExpectTotalCount(
      "ServiceWorker.NavPreload.ConcurrentTime_StartWorkerExistingProcess", 0);
  histogram_tester.ExpectTotalCount(
      "ServiceWorker.NavPreload.WorkerWaitTime_StartWorkerExistingProcess", 0);
...
TEST(ServiceWorkerMetricsTest,
  ...
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.ResponseTime", response_start, 1);
  histogram_tester.ExpectUniqueSample("ServiceWorker.NavPreload.FinishedFirst",
                                      false, 1);
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.ConcurrentTime", worker_start, 1);
  histogram_tester.ExpectTotalCount("ServiceWorker.NavPreload.WorkerWaitTime",
                                    0);
...
TEST(ServiceWorkerMetricsTest,
  ...
  histogram_tester.ExpectUniqueSample(
      "ServiceWorker.NavPreload.FinishedFirst_StartWorkerExistingProcess",
      false, 1);
  histogram_tester.ExpectTimeBucketCount(
...
TEST(ServiceWorkerMetricsTest,
  ...
  histogram_tester.ExpectUniqueSample("ServiceWorker.NavPreload.FinishedFirst",
                                      true, 1);
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.ConcurrentTime", response_start, 1);
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.WorkerWaitTime", wait_time, 1);
  ...
  histogram_tester.ExpectUniqueSample(
      "ServiceWorker.NavPreload.FinishedFirst_StartWorkerExistingProcess", true,
      1);
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.ConcurrentTime_StartWorkerExistingProcess",
      response_start, 1);
  histogram_tester.ExpectTimeBucketCount(
      "ServiceWorker.NavPreload.WorkerWaitTime_StartWorkerExistingProcess",
      wait_time, 1);
