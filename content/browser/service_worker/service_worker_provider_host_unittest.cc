...
TEST_F(ServiceWorkerProviderHostTest, CrossSiteTransfer) {
  ...
  const int is_parent_frame_secure = provider_host->is_parent_frame_secure();
  ...
  EXPECT_EQ(false, provider_host->is_parent_frame_secure());
  ...
  EXPECT_EQ(false, provisional_host->is_parent_frame_secure());
