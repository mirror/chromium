...
// and destruction occur on IO thread, as with most (or all?) message handling.
// It lives as long as the renderer process lives. Therefore much tracking of
// renderer processes in browser-side service worker code is built on
