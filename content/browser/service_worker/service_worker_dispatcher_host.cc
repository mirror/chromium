...
void ServiceWorkerDispatcherHost::DispatchExtendableMessageEvent(
  ...
  ServiceWorkerProviderHost* sender_provider_host =
      GetContext()->GetProviderHost(render_process_id_, sender_provider_id);
    ...
    case blink::mojom::ServiceWorkerProviderType::kForServiceWorker: {
      ...
      base::ThreadTaskRunnerHandle::Get()->PostTask(
          ...
          base::BindOnce(&ServiceWorkerDispatcherHost::
                         ...
                         sender_provider_id, nullptr /* source_client_info */));
      break;
    }
...
void ServiceWorkerDispatcherHost::DispatchExtendableMessageEventInternal(
  ...
  DCHECK(sender_worker_provider_id != kInvalidServiceWorkerProviderId ||
         source_client_info);
  if (sender_worker_provider_id == kInvalidServiceWorkerProviderId) {
  ...
  worker->RunAfterStartWorker(
      ...
      base::BindOnce(&ServiceWorkerDispatcherHost::
                     ...
                     this, worker, std::move(message), source_origin,
                     sender_worker_provider_id, std::move(source_client_info),
...
void ServiceWorkerDispatcherHost::
  ...
  DCHECK(sender_worker_provider_id != kInvalidServiceWorkerProviderId ||
         (source_client_info && !source_client_info->client_uuid.empty()));
