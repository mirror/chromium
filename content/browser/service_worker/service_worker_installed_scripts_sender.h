...
// 1. All installed scripts are sent to the renderer. |pending_scripts_| is set
//    to all the scripts and |state_| is kSendingScripts. This initial phase is
//    called "streaming".
// 2. |pending_scripts_| is empty and |state_| is kIdle. If the renderer calls
//    RequestInstallScript(), the requested script is added to
//    |pending_scripts_| and |state_| is kSendingScripts again.
...
class CONTENT_EXPORT ServiceWorkerInstalledScriptsSender
 ...
 public:
  ...
  // kSuccess, or an error code during the latest script transfer.
