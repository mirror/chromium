...
class ServiceWorkerDispatcherHostTest : public testing::Test {
 protected:
  ...
  void SendRegister(mojom::ServiceWorkerProviderHost* provider_host,
                    GURL pattern,
                    GURL worker_url) {
    ServiceWorkerRegistrationOptions options(pattern);
    provider_host->Register(
        worker_url, options,
        base::BindOnce(
  ...
  void RegisterAndExpect(mojom::ServiceWorkerProviderHost* provider_host,
                         GURL pattern,
                         GURL worker_url,
  ...
  ServiceWorkerRemoteProviderEndpoint PrepareServiceWorkerProviderHost(
    ...
    auto host = CreateProviderHostWithDispatcherHost(
        helper_->mock_render_process_id(), provider_id, context()->AsWeakPtr(),
        kRenderFrameId, dispatcher_host_.get(), &remote_endpoint);
...
TEST_F(ServiceWorkerDispatcherHostTest,
  ...
  RegisterAndExpect(remote_endpoint.host_ptr()->get(),
