...
class Helper : public EmbeddedWorkerTestHelper {
 public:
  ...
  // Sets the helper to respond to fetch events with the specified blob.
 ...
 private:
  enum class Mode { kDefault, kBlob };
  Mode mode_;
...
class ServiceWorkerURLLoaderJobTest
 ...
 public:
  ...
  void TestRequest() {
    ...
    base::RunLoop().RunUntilIdle();
    // TODO(falken): This will fail for fallback to network tests.
