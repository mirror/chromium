...
// worker.
std::unique_ptr<ResourceResponseHead> CreateResponseInfo() {
...
TEST_F(ServiceWorkerURLLoaderJobTest, Basic) {
  ...
  ExpectResponseInfo(info, *CreateResponseInfo());
}
...
TEST_F(ServiceWorkerURLLoaderJobTest, NavigationPreload) {
  ...
  std::unique_ptr<ResourceResponseHead> expected_info = CreateResponseInfo();
