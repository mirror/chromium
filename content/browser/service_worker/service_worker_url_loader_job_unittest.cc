...
class NavigationPreloadLoaderClient final : public mojom::URLLoaderClient {
 public:
  ...
  ~NavigationPreloadLoaderClient() override {}
...
class MockNetworkURLLoaderFactory : public mojom::URLLoaderFactory {
 public:
  static void Create(mojom::URLLoaderFactoryPtr* loader_factory) {
    ...
    new MockNetworkURLLoaderFactory(std::move(request));
  }
 ...
 private:
  MockNetworkURLLoaderFactory(mojom::URLLoaderFactoryRequest request)
      : binding_(this, std::move(request)) {
    binding_.set_connection_error_handler(
        base::BindOnce(&MockNetworkURLLoaderFactory::OnConnectionError,
                       base::Unretained(this)));
  }
...
class Helper : public EmbeddedWorkerTestHelper {
 public:
  Helper()
    ...
    MockNetworkURLLoaderFactory::Create(&mock_loader_factory);
  ...
  void OnFetchEvent(
    ...
    switch (response_mode_) {
      ...
      case ResponseMode::kNavigationPreloadResponse:
        ...
        new NavigationPreloadLoaderClient(
