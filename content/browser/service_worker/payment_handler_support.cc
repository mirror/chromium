...
//   false and do nothing else, then |this| will be dropped silently without
//   invoking Run(). In such a case, dtor of |this| invokes |fallback| to
//   fallback onto the general open window process, |response_callback| is bound
//   into |fallback| and invoked there.
