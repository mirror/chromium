...
ServiceWorkerProviderHost::CreateServiceWorkerRegistrationObjectInfo(
  ...
  ServiceWorkerRegistrationObjectHost* existing_registration_object_host =
      dispatcher_host_->FindServiceWorkerRegistrationObjectHost(
          provider_id(), registration->id());
  if (existing_registration_object_host) {
    return existing_registration_object_host->CreateObjectInfo();
  }
  ...
  return registration_object_host->CreateObjectInfo();
}
