...
void PushMessagingRouter::DeliverMessageToWorker(
  ...
  DCHECK_EQ(EmbeddedWorkerStatus::RUNNING, service_worker->running_status());
  DCHECK(ServiceWorkerVersion::ACTIVATING == service_worker->status() ||
         ServiceWorkerVersion::ACTIVATED == service_worker->status());
