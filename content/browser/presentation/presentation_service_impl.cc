...
void PresentationServiceImpl::SetReceiver(
  ...
  // initialized.
  // TODO(imcheng): Split PresentationServiceImpl into controller and receiver
  // versions. Currently this class contains a mix of both, which makes the
  // state of this object more difficult to reason about.
