...
class BroadcastChannelProvider::Connection
 ...
 public:
  ...
  void OnMessage(blink::MessagePortMessage message) override;
  void MessageToClient(const blink::MessagePortMessage& message) const;
...
void BroadcastChannelProvider::Connection::OnMessage(
    blink::MessagePortMessage message) {
...
void BroadcastChannelProvider::Connection::MessageToClient(
    const blink::MessagePortMessage& message) const {
  blink::MessagePortMessage msg;
  ...
  for (const auto& blob : message.blobs) {
    ...
    msg.blobs.push_back(blink::mojom::SerializedBlob::New(
