...
// May optionally receive a key_handle corresponding to the authenticator
// that approved a sign request.
...
// Response contains a CBOR attestation_object per
...
// Construct a response to a navigator.credentials.get request from the
// data returned from a U2F authenticator.
// Response contains authenticator_data and a signature per
