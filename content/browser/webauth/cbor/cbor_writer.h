...
class CONTENT_EXPORT CBORWriter {
 ...
 private:
  ...
  // needs to traverse or the number of { or [ characters without their
  // matching closing parenthesis crossed to reach a given
  // character in a string. Because some authenticators are memory constrained,
  // the depth of nested CBOR structures used by all message encodings is
  // limited to at most four.
  //
