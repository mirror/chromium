...
base::Optional<CBORValue> CBORReader::ReadSimpleValue(uint8_t additional_info,
  ...
  switch (value) {
    case base::strict_cast<int>(CBORValue::SimpleValue::FALSE_VALUE):
      return CBORValue(CBORValue::SimpleValue::FALSE_VALUE);
    case base::strict_cast<int>(CBORValue::SimpleValue::TRUE_VALUE):
      return CBORValue(CBORValue::SimpleValue::TRUE_VALUE);
    case base::strict_cast<int>(CBORValue::SimpleValue::NULL_VALUE):
      return CBORValue(CBORValue::SimpleValue::NULL_VALUE);
    case base::strict_cast<int>(CBORValue::SimpleValue::UNDEFINED):
