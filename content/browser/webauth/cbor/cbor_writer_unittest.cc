...
TEST(CBORWriterTest, TestWriteMapWithMapValue) {
  ...
  map[CBORValue(-1)] = CBORValue("a");
  map[CBORValue(-24)] = CBORValue("b");
  map[CBORValue(-25)] = CBORValue("c");
  map[CBORValue(-256)] = CBORValue("d");
  map[CBORValue(-257)] = CBORValue("e");
  map[CBORValue(-65537)] = CBORValue("g");
  map[CBORValue(int64_t(-4294967296))] = CBORValue("h");
  map[CBORValue(int64_t(-4294967297))] = CBORValue("i");
  map[CBORValue(std::numeric_limits<int64_t>::min())] = CBORValue("j");
