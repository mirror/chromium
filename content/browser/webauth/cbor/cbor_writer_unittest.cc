...
TEST_F(CBORWriterTest, TestWriteString) {
  ...
  static const StringTestCase kStringTestCases[] = {
      {base::StringPiece("", 0), base::StringPiece("\x60")},
      {base::StringPiece("a"), base::StringPiece("\x61\x61")},
      {base::StringPiece("IETF"), base::StringPiece("\x64\x49\x45\x54\x46")},
      {base::StringPiece("\"\\"), base::StringPiece("\x62\x22\x5c")},
      {base::StringPiece("\xc3\xbc"), base::StringPiece("\x62\xc3\xbc")},
      {base::StringPiece("\xe6\xb0\xb4"),
       base::StringPiece("\x63\xe6\xb0\xb4")},
      {base::StringPiece("\xf0\x90\x85\x91"),
       base::StringPiece("\x64\xf0\x90\x85\x91")}};

  for (const StringTestCase& test_case : kStringTestCases) {
    std::vector<uint8_t> cbor;
    CBORWriter::Write(CBORValue(test_case.string), &cbor);
    EXPECT_THAT(cbor, testing::ElementsAreArray(test_case.cbor));
  }
}
...
TEST_F(CBORWriterTest, TestWriteMapWithMapValue) {
  ...
  map["a"] = CBORValue(base::StringPiece("A"));
  map["b"] = CBORValue(base::StringPiece("B"));
  map["c"] = CBORValue(base::StringPiece("C"));
  map["d"] = CBORValue(base::StringPiece("D"));
  map["e"] = CBORValue(base::StringPiece("E"));
...
TEST_F(CBORWriterTest, TestWriteNestedMap) {
