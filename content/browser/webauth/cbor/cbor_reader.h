...
// CBOR(Concise Binary Object Representation) decoder as defined by RFC
// 7049(https://tools.ietf.org/html/rfc7049). This decoder only accepts
// input that could be deserialized into a CBOR value in a canonical way.
// Supported:
//  * Major types:
...
class CONTENT_EXPORT CBORReader {
 public:
  ...
  static const char kNonMinimalEncoding[];
