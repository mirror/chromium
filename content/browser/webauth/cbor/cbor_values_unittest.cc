...
TEST(CBORValuesTest, ConstructArray) {
  ...
  array.emplace_back(CBORValue(base::StringPiece("foo")));
  {
  ...
  array.back() = CBORValue(base::StringPiece("bar"));
  {
...
TEST(CBORValuesTest, ConstructMap) {
  ...
  map.emplace("foo", CBORValue(base::StringPiece("bar")));
  {
    CBORValue value(map);
  ...
  map["foo"] = CBORValue(base::StringPiece("baz"));
  {
...
TEST(CBORValuesTest, CopyString) {
  CBORValue value(base::StringPiece("foobar"));
  CBORValue copied_value(value.Clone());
  EXPECT_EQ(value.type(), copied_value.type());
...
TEST(CBORValuesTest, MoveString) {
  ...
  blank = CBORValue(base::StringPiece("foobar"));
