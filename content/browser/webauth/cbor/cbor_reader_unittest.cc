...
TEST(CBORReaderTest, TestUnsupportedSimplevalue) {
  static const std::vector<std::vector<uint8_t>> zero_padded_cbor_list = {
      ...
      // Simple value (255)
      {0xF8, 0xFF},
      // Unassigned simple value with addition information 28
      {0xFC},
      // Unassigned simple value with addition information 29
      {0xFD},
      // Unassigned simple value with addition information 30
      {0xFE},
      // Simple value BREAK code
      {0xFF},
  };
