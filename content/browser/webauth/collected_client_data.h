...
extern const char kCreateType[];

// JSON key values
extern const char kTypeKey[];
extern const char kChallengeKey[];
extern const char kOriginKey[];
extern const char kHashAlgorithm[];
extern const char kTokenBindingKey[];
}
