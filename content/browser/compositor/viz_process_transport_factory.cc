...
void VizProcessTransportFactory::ConnectHostFrameSinkManager() {
  ...
  GetHostFrameSinkManager()->SetErrorHandler(
      base::BindOnce(&VizProcessTransportFactory::OnContextLost,
...
void VizProcessTransportFactory::CreateLayerTreeFrameSink(
  ...
  LOG(ERROR) << "VizProcessTransportFactory::CreateLayerTreeFrameSink "
...
void VizProcessTransportFactory::OnContextLost() {
  LOG(ERROR) << "VizProcessTransportFactory::OnContextLost()";

  GetHostFrameSinkManager()->OnContextLost();
  ConnectHostFrameSinkManager();
  GetHostFrameSinkManager()->RegisterAfterCrash();
