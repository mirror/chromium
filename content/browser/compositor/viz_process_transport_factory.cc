...
scoped_refptr<ui::ContextProviderCommandBuffer> CreateContextProviderImpl(
  ...
  return base::MakeRefCounted<ui::ContextProviderCommandBuffer>(
      ...
      surface_handle, std::move(url), kAutomaticFlushes, support_locking,
...
void VizProcessTransportFactory::CreateLayerTreeFrameSinkForGpuChannel(
  ...
  scoped_refptr<ui::ContextProviderCommandBuffer> context_provider =
      CreateContextProvider(std::move(gpu_channel_host), surface_handle);
  ...
  DCHECK(!compositor_data_map_[compositor].display_private);
...
VizProcessTransportFactory::CreateContextProvider(
  ...
  if (!shared_worker_context_provider_) {
    shared_worker_context_provider_ = CreateContextProviderImpl(
        gpu_channel_host, gpu::kNullSurfaceHandle, true /* support_locking */,
  ...
  // TODO(kylechar): Use the same ContextProvider for all Compositors.
  scoped_refptr<ui::ContextProviderCommandBuffer> context_provider =
      CreateContextProviderImpl(
          std::move(gpu_channel_host), surface_handle,
          false /* support_locking */, shared_worker_context_provider_.get(),
