...
void VizProcessTransportFactory::OnEstablishedGpuChannel(
  ...
  compositor_data_map_[compositor].display_private_client =
      std::make_unique<InProcessDisplayPrivateClient>(compositor->widget());
  viz::mojom::DisplayPrivateClientPtr display_private_client =
      compositor_data_map_[compositor].display_private_client->GetBoundPtr();
  ...
  GetHostFrameSinkManager()->CreateRootCompositorFrameSink(
      ...
      std::move(display_private_request), std::move(display_private_client));
