...
struct GpuProcessTransportFactory::PerCompositorData {
  ...
  std::unique_ptr<viz::mojom::DisplayPrivateClient> display_private_client;
  ...
  auto layer_tree_frame_sink =
      vulkan_context_provider
          ? std::make_unique<viz::DirectLayerTreeFrameSink>(
                ...
                data->display_private_client.get(),
                static_cast<scoped_refptr<viz::VulkanContextProvider>>(
                    vulkan_context_provider))
          : std::make_unique<viz::DirectLayerTreeFrameSink>(
                compositor->frame_sink_id(), GetHostFrameSinkManager(),
                GetFrameSinkManager(), data->display.get(),
                data->display_private_client.get(), context_provider,
