...
bool IsGpuCompositingDisabledByCommandLine(const base::CommandLine* cmd_line) {
  DCHECK(cmd_line);
...
scoped_refptr<ui::ContextProviderCommandBuffer> CreateContextCommon(
  ...
  DCHECK(!IsGpuCompositingDisabledByCommandLine(
...
GpuProcessTransportFactory::GpuProcessTransportFactory(
  ...
  if (IsGpuCompositingDisabledByCommandLine(command_line))
