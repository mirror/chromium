...
void PrepareBitmapCopyOutputResult(
  ...
  if (source.width() != dst_size_in_pixel.width() ||
    ...
    // CopyOutputRequest::SetScaleRatio() API. http://crbug.com/754872
...
void CopyFromCompositingSurfaceHasResult(
  ...
  switch (result->format()) {
    case viz::CopyOutputResult::Format::RGBA_TEXTURE:
      // TODO(miu): Delete this code path. All requests want a SkBitmap result;
      // so all requests should be for RGBA_BITMAP. http://crbug.com/759310
