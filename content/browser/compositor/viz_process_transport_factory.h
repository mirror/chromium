...
class VizProcessTransportFactory : public ui::ContextFactory,
 ...
 private:
  ...
  // Context provider used on worker threads for rasterization.
  scoped_refptr<viz::RasterContextProvider> worker_context_provider_;

  // Context provider used on the main thread. Shared by ui::Compositors and
  // also returned from GetSharedMainThreadContextProvider().
