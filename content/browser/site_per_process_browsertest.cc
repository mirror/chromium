...
class TouchSelectionControllerClientAndroidSiteIsolationTest
 ...
 private:
  ...
  void SendGestureTap(RenderWidgetHostViewAndroid* view, gfx::Point point) {
    ...
    ui::GestureEventData gesture_tap_down(
        tap_down_details, 0, ui::MotionEvent::TOOL_TYPE_FINGER,
        ui::EventTimeForNow(), point.x(), point.y(), point.x(), point.y(), 1,
        gfx::RectF(point.x() - 1.f, point.y() - 1.f, 2.f, 2.f),
        ui::EventFlags::EF_NONE, unique_touch_event_id_++);
    view->OnGestureEvent(gesture_tap_down);

    ui::GestureEventDetails tap_details(ui::ET_GESTURE_TAP);
    tap_details.set_device_type(ui::GestureDeviceType::DEVICE_TOUCHSCREEN);
    tap_details.set_tap_count(1);
    ui::GestureEventData gesture_tap(
        tap_details, 0, ui::MotionEvent::TOOL_TYPE_FINGER,
        ui::EventTimeForNow(), point.x(), point.y(), point.x(), point.y(), 1,
        gfx::RectF(point.x() - 1.f, point.y() - 1.f, 2.f, 2.f),
        ui::EventFlags::EF_NONE, unique_touch_event_id_++);
  ...
  void SendGestureLongPress(RenderWidgetHostViewAndroid* view,
                            gfx::Point point) {
    ui::GestureEventDetails long_press_details(ui::ET_GESTURE_LONG_PRESS);
    long_press_details.set_device_type(
        ui::GestureDeviceType::DEVICE_TOUCHSCREEN);
    ui::GestureEventData gesture_long_press(
        long_press_details, 0, ui::MotionEvent::TOOL_TYPE_FINGER,
        ui::EventTimeForNow(), point.x(), point.y(), point.x(), point.y(), 1,
        gfx::RectF(point.x() - 1.f, point.y() - 1.f, 2.f, 2.f),
        ui::EventFlags::EF_NONE, unique_touch_event_id_++);
...
class TouchSelectionControllerClientTestWrapper
 ...
 private:
  ...
  bool SupportsAnimation() const override {
    // TODO(wjmaaclean): perhaps always return false here for testing?
...
IN_PROC_BROWSER_TEST_P(TouchSelectionControllerClientAndroidSiteIsolationTest,
  ...
  TouchSelectionControllerClientTestWrapper* selection_controller_client =
      new TouchSelectionControllerClientTestWrapper(
          parent_view->GetSelectionControllerClientManagerForTest());
  ...
  auto* manager = static_cast<TouchSelectionControllerClientManagerAndroid*>(
      parent_view->touch_selection_controller_client_manager());
