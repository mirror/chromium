...
IN_PROC_BROWSER_TEST_F(SitePerProcessBrowserTest,
  ...
  blink::WebMouseWheelEvent wheel_event1(
      blink::WebInputEvent::kMouseWheel, blink::WebInputEvent::kNoModifiers,
      blink::WebInputEvent::kTimeStampForTesting);
  wheel_event1.SetPositionInWidget(75, 75);
  wheel_event1.delta_x = 10;
  wheel_event1.delta_y = 20;
  ...
  blink::WebMouseWheelEvent wheel_event2(
      blink::WebInputEvent::kMouseWheel, blink::WebInputEvent::kNoModifiers,
      blink::WebInputEvent::kTimeStampForTesting);
  wheel_event2.SetPositionInWidget(75, 75);
  wheel_event2.delta_x = 10;
  wheel_event2.delta_y = 20;
  ...
  EXPECT_EQ(wheel_event1.delta_x + wheel_event2.delta_x,
            gesture_event.data.scroll_update.delta_x);
  EXPECT_EQ(wheel_event1.delta_y + wheel_event2.delta_y,
