...
IN_PROC_BROWSER_TEST_F(SitePerProcessAutoplayBrowserTest,
  ...
  GURL main_url(embedded_test_server()->GetURL(
      "example.com", "/media/autoplay/gesture-delegation.html"));
  GURL foo_url(embedded_test_server()->GetURL(
      "foo.com", "/media/autoplay/gesture-delegation.html"));
  GURL bar_url(embedded_test_server()->GetURL(
      "bar.com", "/media/autoplay/gesture-delegation.html"));
  GURL secondary_url(embedded_test_server()->GetURL(
      "test.example.com", "/media/autoplay/gesture-delegation.html"));
  GURL disabled_url(embedded_test_server()->GetURL(
      "test.example.com", "/media/autoplay/gesture-delegation-disabled.html"));

  // Load a page with an iframe that has allowed gesture delegation.
  ...
  // Navigate to a page with gesture delegation disabled.
