...
void HitTestLayerSquashing(
  ...
  std::string elem;
  EXPECT_TRUE(ExecuteScriptWithoutUserGestureAndExtractString(web_contents,
      "domAutomationController.send(document.elementFromPoint(195, 11).getAttribute('id'))",
      &elem));
  LOG(ERROR) << "Elememt at (195, 11): " << elem;
  ...
  DispatchMouseEventAndWaitUntilDispatch(web_contents, rwhv_root,
                                         ...
                                         gfx::PointF(195, 11));
  EXPECT_TRUE(ExecuteScriptWithoutUserGestureAndExtractString(web_contents,
      "domAutomationController.send(document.elementFromPoint(195, 30).getAttribute('id'))",
      &elem));
  LOG(ERROR) << "Elememt at (195, 30): " << elem;
