...
base::Optional<cbor::CBORValue> GenerateCanonicalRequestCBOR(
  ...
  map.insert_or_assign(cbor::CBORValue::BytestringFromString(kMethodKey),
                       cbor::CBORValue::BytestringFromString(input.method));
  map.insert_or_assign(cbor::CBORValue::BytestringFromString(kUrlKey),
                       cbor::CBORValue::BytestringFromString(input.url));
...
base::Optional<cbor::CBORValue> GenerateCanonicalResponseCBOR(
  ...
  map.insert_or_assign(
      ...
      cbor::CBORValue::BytestringFromString(response_code_str));
  for (const std::string& name : input.signed_header_names) {
    ...
    map.insert_or_assign(cbor::CBORValue::BytestringFromString(name),
                         cbor::CBORValue::BytestringFromString(value));
  }
