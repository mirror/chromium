...
class ResourceRequestInfoImpl : public ResourceRequestInfo,
 ...
 public:
  ...
  const base::Optional<std::string>& GetCustomCancelReason() const override;
  ...
  void set_custom_cancel_reason(const base::Optional<std::string>& reason) {
    custom_cancel_reason_ = reason;
  }
 ...
 private:
  ...
  base::Optional<std::string> custom_cancel_reason_;
