...
SignedExchangeHandler::SignedExchangeHandler(
  ...
  header_out_buf_ =
      base::MakeRefCounted<net::IOBufferWithSize>(kBufferSizeForRead);
...
void SignedExchangeHandler::ReadLoop() {
  ...
  int rv = upstream_->Read(
      header_out_buf_.get(), header_out_buf_->size(),
...
void SignedExchangeHandler::DidRead(bool completed_syncly, int result) {
  ...
  original_body_string_.append(header_out_buf_->data(), result);
