...
bool SignedExchangeHandler::RunHeadersCallback() {
  // TODO(https://crbug.com/803774): Instead of crashing, propagate errors to
  // the upper layers.
