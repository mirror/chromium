...
class CONTENT_EXPORT ResourceScheduler {
 ...
 private:
  ...
  typedef std::set<net::EffectiveConnectionType> EffectiveConnectionTypeSet;
  ...
  EffectiveConnectionTypeSet GetMaxDelayableRequestsExperimentConnectionTypes();
  ...
  const EffectiveConnectionTypeSet
      max_delayable_requests_network_override_ect_values_;
