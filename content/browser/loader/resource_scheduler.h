...
class CONTENT_EXPORT ResourceScheduler {
 ...
 private:
  ...
  // must be multiplied in the computation for the number of delayable requests
  // allowed in-flight. This is decided based on the current network quality and
  // the default weight specified in the experiment configuration for
