...
// WebPackageURLLoader keeps a WebPackageLoader while a renderer process is
// loading an Origin-Signed response. The renderer process keeps the
// URLLoaderPtr which is binded to |this| by a StrongBinding in
// WebPackageRequestHandler::StartResponse()
