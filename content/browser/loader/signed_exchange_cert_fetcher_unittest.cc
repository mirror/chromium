...
class SignedExchangeCertFetcherTest : public testing::Test {
 public:
  SignedExchangeCertFetcherTest() = default;
  ~SignedExchangeCertFetcherTest() override = default;
...
TEST_F(SignedExchangeCertFetcherTest, OneCert) {
  const uint8_t input[] = {
      // clang-format off
...
TEST_F(SignedExchangeCertFetcherTest, OneCertWithExtension) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, TwoCerts) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, Empty) {
  EXPECT_FALSE(GetCertChain(nullptr, 0));
}

TEST_F(SignedExchangeCertFetcherTest, InvalidRequestContextSize) {
  const uint8_t input[] = {
      // clang-format off
...
TEST_F(SignedExchangeCertFetcherTest, CanNotReadCertListSize1) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, CanNotReadCertListSize2) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, CertListSizeError) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, CanNotReadCertDataSize) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, CertDataSizeError) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, CanNotReadExtensionsSize) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
...
TEST_F(SignedExchangeCertFetcherTest, ExtensionsSizeError) {
  const uint8_t input[] = {
      // clang-format off
      0x00, // request context size
      0x00, 0x00, 0x07, // certificate list size
