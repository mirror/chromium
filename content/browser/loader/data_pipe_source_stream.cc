...
#include "content/browser/loader/data_pipe_source_stream.h"
...
DataPipeSourceStream::DataPipeSourceStream(
  ...
  handle_watcher_.Watch(
      ...
      base::BindRepeating(&DataPipeSourceStream::OnReadable,
                          base::Unretained(this)));
}

DataPipeSourceStream::~DataPipeSourceStream() = default;

std::string DataPipeSourceStream::Description() const {
  return "DataPipeSourceStream";
}

int DataPipeSourceStream::Read(net::IOBuffer* buf,
                               int buf_size,
...
void DataPipeSourceStream::OnReadable(MojoResult unused) {
...
void DataPipeSourceStream::FinishReading() {
