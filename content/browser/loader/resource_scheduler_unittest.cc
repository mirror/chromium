...
class ResourceThrottleAdapter final
    : public ResourceThrottle,
      public ResourceScheduler::ScheduledResourceRequest::Delegate {
 public:
  using ScheduledResourceRequest = ResourceScheduler::ScheduledResourceRequest;
 ...
 private:
  std::unique_ptr<ScheduledResourceRequest> request_;
};
...
TEST_F(ResourceSchedulerTest, CancelOtherRequestsWhileResuming) {
  ...
  std::unique_ptr<ResourceThrottle> throttle(
      std::make_unique<ResourceThrottleAdapter>(scheduler()->ScheduleRequest(
