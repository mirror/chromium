...
class ResourceScheduler::Client {
 public:
  Client(
      ...
      bool max_delayable_requests_override_enabled,
      ...
      : is_loaded_(false),
        ...
        max_delayable_requests_override_enabled_(
            max_delayable_requests_override_enabled),
  ...
  void ScheduleRequest(net::URLRequest* url_request,
    ...
    if (max_delayable_requests_override_enabled_ &&
...
void ResourceScheduler::OnClientCreated(int child_id,
  ...
  Client* client = new Client(
      ...
      max_requests_before_yielding_, max_delayable_requests_override_enabled_,
      &max_delayable_requests_by_bdp_ranges_,
      max_delayable_requests_network_override_max_ect_);
