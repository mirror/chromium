...
class ResourceScheduler::Client {
 public:
  Client(bool priority_requests_delayable,
         ...
         const BDPRangeRequestCountMap* const
             max_delayable_requests_network_override_params,
         const EffectiveConnectionTypeSet* const
...
ResourceScheduler::BDPRangeRequestCountMap
ResourceScheduler::GetMaxDelayableRequestsExperimentConfig() {
  ...
  BDPRangeRequestCountMap result;
  ...
  while (true) {
    ...
    if (!base::StringToInt64(
            base::GetFieldTrialParamValueByFeature(
                ...
                kBDPLowerBoundBase + std::to_string(config_param_index)),
            &lower_bound_value)) {
      break;
    }
    if (!base::StringToInt64(
            base::GetFieldTrialParamValueByFeature(
                kMaxDelayableRequestsNetworkOverride,
                kBDPUpperBoundBase + std::to_string(config_param_index)),
            &upper_bound_value)) {
      break;
    }
    if (!base::StringToSizeT(
            base::GetFieldTrialParamValueByFeature(
                kMaxDelayableRequestsNetworkOverride,
                kMaxDelayableRequestsBase + std::to_string(config_param_index)),
...
// a parameter.
ResourceScheduler::EffectiveConnectionTypeSet
ResourceScheduler::GetMaxDelayableRequestsExperimentConnectionTypes() {
  ...
  EffectiveConnectionTypeSet result;
  int config_param_index = 1;
  ...
  while (true) {
    ...
    if (!base::StringToInt(
            base::GetFieldTrialParamValueByFeature(
                kMaxDelayableRequestsNetworkOverride,
                kConnectionTypeBase + std::to_string(config_param_index)),
            &ect_int_value)) {
      break;
    }
