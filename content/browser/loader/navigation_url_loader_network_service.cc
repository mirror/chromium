...
class NavigationURLLoaderNetworkService::URLLoaderRequestController
 ...
 public:
  ...
  void FollowRedirect() {
    ...
    // TODO(michaeln): This is still WIP, there likely remains more to be done.
    // For subframe navigations, the Origin header may need to be modified
    // differently?
    ...
    // TODO(michaeln): How should redirect_info_.referred_token_binding_host
    // be handled?
