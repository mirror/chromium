...
class NavigationURLLoaderNetworkService::URLLoaderRequestController
  ...
  void CreateNonNetworkServiceURLLoader(
    ...
    if (ResourceDispatcherHostImpl::Get()) {
      ResourceDispatcherHostImpl::Get()->BeginNavigationRequest(
          ...
          std::move(navigation_ui_data), nullptr, &request_id_,
 ...
 private:
  ...
  void OnReceiveResponse(
    ...
    GlobalRequestID global_request_id(-1, request_id_);
    ...
    if (base::FeatureList::IsEnabled(features::kNetworkService)) {
      ...
      DCHECK(rdh);
      net::URLRequest* url_request = rdh->GetURLRequest(global_request_id);
      DCHECK(url_request);
    ...
    BrowserThread::PostTask(
        ...
        base::BindOnce(&NavigationURLLoaderNetworkService::OnReceiveResponse,
                       ...
                       std::move(url_loader_client_endpoints), ssl_info,
                       std::move(embedder_navigation_data), global_request_id,
                       is_download, is_stream, base::Passed(&downloaded_file)));
  }
...
void NavigationURLLoaderNetworkService::OnReceiveResponse(
  ...
  delegate_->OnResponseStarted(
      ...
      global_request_id, allow_download_ && is_download, is_stream,
