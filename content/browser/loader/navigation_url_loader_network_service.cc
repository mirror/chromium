...
class NavigationURLLoaderNetworkService::URLLoaderRequestController
 ...
 public:
  ...
  void Restart() {
    ...
    // AppCache or service worker loader. We keep the default url loader to
    // reuse it and call FollowRedirect() in MaybeStartLoader() if the all
    // |handlers_| doesn't handle the request.
