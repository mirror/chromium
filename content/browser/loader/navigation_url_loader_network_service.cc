...
class NavigationURLLoaderNetworkService::URLLoaderRequestController
 ...
 private:
  ...
  void OnReceiveResponse(
    ...
    DCHECK(url_loader_);
    mojom::URLLoaderPtr new_url_loader;
    mojom::URLLoaderClientRequest new_url_loader_client;
    url_loader_->Unbind(&new_url_loader, &new_url_loader_client);
    url_loader_.reset();
    ...
    BrowserThread::PostTask(
        ...
        base::BindOnce(&NavigationURLLoaderNetworkService::OnReceiveResponse,
                       owner_, new_url_loader.PassInterface(),
                       std::move(new_url_loader_client), response->DeepCopy(),
...
void NavigationURLLoaderNetworkService::OnReceiveResponse(
  ...
  delegate_->OnResponseStarted(
      ...
      nullptr, ssl_status_, std::unique_ptr<NavigationData>(),
