 ...
 public:
  ...
  void StartWithoutNetworkService(
    ...
    url_loader_ = ThrottlingURLLoader::CreateLoaderAndStart(
        SharedURLLoaderFactory::CreateForSingleRequest(
            std::move(load_single_request)),
        std::vector<std::unique_ptr<content::URLLoaderThrottle>>(),
        /* routing_id = */ -1, /* request_id */ -1,
  ...
  void MaybeStartLoader(URLLoaderRequestHandler* handler,
    ...
    if (loader) {
      ...
      url_loader_ = ThrottlingURLLoader::CreateLoaderAndStart(
          SharedURLLoaderFactory::CreateForSingleRequest(std::move(loader)),
