...
std::unique_ptr<DetachedResourceRequest> DetachedResourceRequest::Create(
  ...
  return std::unique_ptr<DetachedResourceRequest>(
      new DetachedResourceRequest(url_request_context_getter, resource_context,
...
void DetachedResourceRequest::StartOnIOThread() {
  // TODO(lizeb): Put a proper annotation.
  ...
  rdh->OnRequestResourceWithMojo(requester_info_.get(), -1, -1, 0,
