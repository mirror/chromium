...
static size_t g_max_cert_size_for_signed_exchange = (1u << 24) + 3;
...
const net::NetworkTrafficAnnotationTag kCertFetcherTrafficAnnotation =
    ...
    comments:
      ...
      " of request. Using either URLBlacklist or URLWhitelist policies (or a "
...
// static
void SignedExchangeCertFetcher::SetMaxCertSizeForTest(size_t max_cert_size) {
