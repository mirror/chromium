...
void InitializeResourceBufferConstantsFoo() {
  ...
  GetNumericCommandLineArg("resource-buffer-min-allocation-size",
                           &kBufferMinAllocationSize);
  GetNumericCommandLineArg("resource-buffer-max-allocation-size",
                           &kMaxAllocationSize);
}
...
bool AsyncResourceHandler::EnsureResourceBufferIsInitialized() {
  ...
  return buffer_->Initialize(kBufferSize, kBufferMinAllocationSize,
                             kMaxAllocationSize);
}
