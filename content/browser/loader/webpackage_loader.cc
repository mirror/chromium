...
class MainResourceLoader : public mojom::URLLoader {
 public:
  MainResourceLoader(scoped_refptr<WebPackageReaderAdapter> reader,
...
void WebPackageRequestHandler::MaybeCreateLoader(
  ...
  if (webpackage_loader_) {
    ...
    subresource_loader_factory_ =
        webpackage_loader_->CreateSubresourceLoaderFactory(
            std::move(loader_factory_getter_));
  ...
  webpackage_loader_ = std::make_unique<WebPackageLoader>(
      std::move(callback), resource_request, loader_factory_getter_.get());
}
...
void WebPackageRequestHandler::CreateMainResourceLoader(
    mojom::URLLoaderRequest loader_request,
    mojom::URLLoaderClientPtr loader_client) {
  webpackage_loader_->CreateMainResourceLoader(std::move(loader_request),
...
void WebPackageLoader::CreateMainResourceLoader(
  ...
  mojo::MakeStrongBinding(
      std::make_unique<MainResourceLoader>(reader_, std::move(loader_client)),
...
mojom::URLLoaderFactoryPtr WebPackageLoader::CreateSubresourceLoaderFactory(
  ...
  auto* factory = new SubresourceLoaderFactory(reader_, loader_factory_getter);
