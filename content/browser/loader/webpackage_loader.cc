...
bool WebPackageStreamResourcesEnabled() {
  static bool enable_streaming = base::CommandLine::ForCurrentProcess()->HasSwitch("enable-webpackage-streaming");
  ...
  if (webpackage_loader_) {
    ...
    if (WebPackageStreamResourcesEnabled()) {
      ...
      auto* factory = new WebPackageSubresourceLoaderFactory(
          ...
          base::Bind(&URLLoaderFactoryGetter::GetNetworkFactory, loader_factory_getter_));
