...
void WebPackageRequestHandler::MaybeCreateLoader(
  ...
  // TODO(803774): Ask WebPackageFetchManager to get the ongoing matching
  // SignedExchangeHandler which was created by a WebPackagePrefetcher.
...
bool WebPackageRequestHandler::MaybeCreateLoaderForResponse(
  ...
  *client_request = mojo::MakeRequest(&client);
  ...
  // TODO(803774): Consider creating a new ThrottlingURLLoader or reusing the
  // existing ThrottlingURLLoader by reattaching URLLoaderClient, to support
  // SafeBrowsing checking of the content of the WebPackage.
