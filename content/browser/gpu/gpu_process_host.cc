...
void GpuProcessHost::BindBrowserGpuRequest(ui::mojom::GpuRequest request) {
  if (!browser_gpu_client_)
    browser_gpu_client_ = std::make_unique<BrowserGpuClient>();
  browser_gpu_client_->BindGpuRequest(std::move(request));
}
