...
void GpuClient::PreEstablishGpuChannel() {
  ...
  BrowserThread::PostTask(
      ...
      base::BindOnce(&GpuClient::EstablishGpuChannelImpl,
                     weak_factory_.GetWeakPtr(), base::nullopt));
}
...
void GpuClient::ClearCallback() {
  ...
  OnEstablishGpuChannel(
      mojo::ScopedMessagePipeHandle(), gpu::GPUInfo(), gpu::GpuFeatureInfo(),
...
void GpuClient::EstablishGpuChannelImpl(
  ...
  if (channel_handle_.is_valid()) {
    ...
    OnEstablishGpuChannel(std::move(channel_handle_), gpu_info_,
                          gpu_feature_info_,
