...
IN_PROC_BROWSER_TEST_F(NetworkServiceRestartDisableWebSecurityTest, BasicXHR) {
  ...
  // notification. Will send new URLLoaderFactoryBundle to the frame.
  main_frame()->FlushNetworkInterfaceForTesting();
  // Make sure new URLLoaderFactoryBundle has been received by the frame.
  main_frame()->FlushFrameNavigationControlForTesting();
