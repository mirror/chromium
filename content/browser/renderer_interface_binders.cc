...
std::unique_ptr<WebInterfaceBroker> CreateContentWebInterfaceBroker() {
  ...
  builder->AddInterface(
      CreateContextTypeInterfaceFilter({WebContextType::kMainFrame,
                                        WebContextType::kIFrame,
                                        WebContextType::kServiceWorker}),
  ...
  builder->AddInterface(
      CreateContextTypeInterfaceFilter(
          {WebContextType::kMainFrame, WebContextType::kIFrame}),
