...
WebInterfaceConfiguration::WebInterfaceConfiguration(
    WebInterfaceConfiguration&&) = default;
WebInterfaceConfiguration& WebInterfaceConfiguration::operator=(
    WebInterfaceConfiguration&&) = default;
WebInterfaceConfiguration::~WebInterfaceConfiguration() = default;

WebInterfaceFilter::Result WebInterfaceConfiguration::FilterInterface(
    WebContextType type,
    RenderProcessHost* process_host,
    RenderFrameHost* frame_host,
    const url::Origin& origin) {
