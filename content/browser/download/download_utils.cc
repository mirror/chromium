...
content::DownloadSource ToDownloadSource(
    download::DownloadSource download_source) {
  switch (download_source) {
    case download::DownloadSource::UNKNOWN:
      return content::DownloadSource::UNKNOWN;
    case download::DownloadSource::NAVIGATION:
      return content::DownloadSource::NAVIGATION;
    case download::DownloadSource::DRAG_AND_DROP:
      return content::DownloadSource::DRAG_AND_DROP;
    case download::DownloadSource::MANUAL_RESUMPTION:
      return content::DownloadSource::MANUAL_RESUMPTION;
    case download::DownloadSource::AUTO_RESUMPTION:
      return content::DownloadSource::AUTO_RESUMPTION;
    case download::DownloadSource::FROM_RENDERER:
      return content::DownloadSource::FROM_RENDERER;
    case download::DownloadSource::EXTENSION_API:
      return content::DownloadSource::EXTENSION_API;
    case download::DownloadSource::EXTENSION_INSTALLER:
      return content::DownloadSource::EXTENSION_INSTALLER;
    case download::DownloadSource::INTERNAL_API:
      return content::DownloadSource::INTERNAL_API;
    case download::DownloadSource::WEB_CONTENTS_API:
      return content::DownloadSource::WEB_CONTENTS_API;
    case download::DownloadSource::OFFLINE_PAGE:
      return content::DownloadSource::OFFLINE_PAGE;
    case download::DownloadSource::CONTEXT_MENU:
      return content::DownloadSource::CONTEXT_MENU;
    case download::DownloadSource::COUNT:
      break;
  }
  NOTREACHED();
  return content::DownloadSource::UNKNOWN;
