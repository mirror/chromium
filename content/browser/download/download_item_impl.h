...
class CONTENT_EXPORT DownloadItemImpl : public download::DownloadItem,
 ...
 public:
  ...
  void SetDelegate(
      std::unique_ptr<download::DownloadItemDelegate> delegate) override;
 ...
 private:
  ...
  // Helper method to create the ContentDownloadItemDelegate.
  void CreateDelegate();
  ...
  // Delegate to provide extra information.
  std::unique_ptr<download::DownloadItemDelegate> download_item_delegate_;
