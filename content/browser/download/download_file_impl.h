...
class CONTENT_EXPORT DownloadFileImpl : public DownloadFile {
 public:
  ...
  void AddDataPipeConsumerHandle(mojom::DownloadStreamHandlePtr stream_handle,
                                 int64_t offset,
                                 int64_t length) override;
 ...
 private:
  ...
  class CONTENT_EXPORT SourceStream : public mojom::DownloadStreamCallback {
   public:
    ...
    // mojom::DownloadStreamCallback
    void OnCompleted(int status) override;
   ...
   private:
    ...
    bool is_producer_completed_;

    CompletionCallback completion_callback_;

    // Objects for reading from the input mojo stream handle.
    mojo::ScopedDataPipeConsumerHandle consumer_handle_;
    mojo::Binding<mojom::DownloadStreamCallback> binding_;
