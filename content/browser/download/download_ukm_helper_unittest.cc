...
TEST_F(DownloadUkmHelperTest, TestBasicReporting) {
  ...
  ExpectUkmMetrics(
      ...
      {download_id_, file_type, download_source});
  ...
  ExpectUkmMetrics(
      ...
      {download_id_,
       DownloadUkmHelper::CalcExponentialBucket(change_in_file_size), reason,
  ...
  ExpectUkmMetrics(
      ...
      {download_id_, mode, time_since_start_resume});
