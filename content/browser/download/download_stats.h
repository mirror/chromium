...
enum DownloadTriggerSource {
  // Formerly INITIATED_BY_SAVE_PACKAGE_ON_NON_HTML.
  DOWNLOAD_SOURCE_UNUSED_0 = 0,

  // Formerly INITIATED_BY_DRAG_N_DROP.
  DOWNLOAD_SOURCE_UNUSED_1,

  // Formerly INITIATED_BY_RENDERER.
  DOWNLOAD_SOURCE_UNUSED_2,
