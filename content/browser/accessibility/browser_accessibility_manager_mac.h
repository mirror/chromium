...
class CONTENT_EXPORT BrowserAccessibilityManagerMac
 ...
 private:
  ...
  // Required by Voiceover in order to support character echo and other announcements during editing.
  struct TextEdit {
    TextEdit(base::string16 text, bool is_deleted) : Text(text), IsDeleted(is_deleted) {}
    base::string16 Text;
