    ...
    switch (direction) {
      case ui::FORWARDS_DIRECTION: {
        ...
        AXPlatformPositionInstance next_word =
            position->CreateNextWordStartPosition(ui::AXBoundaryBehavior::StopAtAnchorBoundary);
        return next_word->text_offset();
      }
      case ui::BACKWARDS_DIRECTION: {
        AXPlatformPositionInstance position =
            owner()->CreatePositionAt(static_cast<int>(start_offset), affinity);
        AXPlatformPositionInstance previous_word = position->CreatePreviousWordStartPosition(ui::AXBoundaryBehavior::StopAtCurrentBoundary);
    ...
    switch (direction) {
      case ui::FORWARDS_DIRECTION: {
        ...
        AXPlatformPositionInstance next_line =
            position->CreateNextLineStartPosition(ui::AXBoundaryBehavior::StopAtAnchorBoundary);
        return next_line->text_offset();
      }
      case ui::BACKWARDS_DIRECTION: {
        AXPlatformPositionInstance position =
            owner()->CreatePositionAt(static_cast<int>(start_offset), affinity);
        AXPlatformPositionInstance previous_line = position->CreatePreviousLineStartPosition(ui::AXBoundaryBehavior::StopAtCurrentBoundary);
