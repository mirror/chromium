...
STDMETHODIMP BrowserAccessibilityComWin::get_anchorTarget(
  ...
  if (!(MSAAState() & STATE_SYSTEM_LINKED) ||
      FAILED(
          GetStringAttributeAsBstr(ax::mojom::StringAttribute::URL, &target))) {
...
STDMETHODIMP BrowserAccessibilityComWin::get_name(long action_index,
  ...
  int action;
  if (!owner()->GetIntAttribute(ax::mojom::IntAttribute::DEFAULT_ACTION_VERB,
                                &action) ||
      action_index != 0) {
    *name = nullptr;
    return E_INVALIDARG;
...
STDMETHODIMP BrowserAccessibilityComWin::get_currentValue(VARIANT* value) {
  ...
  float float_val;
  if (GetFloatAttribute(ax::mojom::FloatAttribute::VALUE_FOR_RANGE,
                        &float_val)) {
    value->vt = VT_R8;
...
STDMETHODIMP BrowserAccessibilityComWin::get_minimumValue(VARIANT* value) {
  ...
  float float_val;
  if (GetFloatAttribute(ax::mojom::FloatAttribute::MIN_VALUE_FOR_RANGE,
                        &float_val)) {
    value->vt = VT_R8;
    value->dblVal = float_val;
    return S_OK;
...
STDMETHODIMP BrowserAccessibilityComWin::get_maximumValue(VARIANT* value) {
  ...
  float float_val;
  if (GetFloatAttribute(ax::mojom::FloatAttribute::MAX_VALUE_FOR_RANGE,
                        &float_val)) {
    value->vt = VT_R8;
    value->dblVal = float_val;
    return S_OK;
...
STDMETHODIMP BrowserAccessibilityComWin::get_fontFamily(BSTR* font_family) {
  ...
  *font_family = nullptr;
  ...
  base::string16 family = owner()->GetInheritedString16Attribute(
      ax::mojom::StringAttribute::FONT_FAMILY);
  if (family.empty())
    return S_FALSE;
...
void BrowserAccessibilityComWin::UpdateStep1ComputeWinAttributes() {
  ...
  win_attributes_->name =
      owner()->GetString16Attribute(ax::mojom::StringAttribute::NAME);
...
std::vector<base::string16> BrowserAccessibilityComWin::ComputeTextAttributes()
  ...
  if (owner()->GetIntAttribute(ax::mojom::IntAttribute::BACKGROUND_COLOR,
                               &color)) {
  ...
  int32_t text_style =
      owner()->GetIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE);
  if (text_style == static_cast<int32_t>(ax::mojom::TextStyle::NONE)) {
    ...
    if (text_style &
        static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_ITALIC)) {
    ...
    if (text_style &
        static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_BOLD)) {
  ...
  int32_t invalid_state =
      owner()->GetIntAttribute(ax::mojom::IntAttribute::INVALID_STATE);
  switch (static_cast<ax::mojom::InvalidState>(invalid_state)) {
    ...
    case ax::mojom::InvalidState::GRAMMAR: {
      ...
      if (invalid_state &
          static_cast<int32_t>(ax::mojom::InvalidState::SPELLING))
  ...
  if (text_style &
      static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_LINE_THROUGH)) {
  ...
  if (text_style &
      static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_UNDERLINE)) {
    // TODO(nektar): Figure out a more specific value.
