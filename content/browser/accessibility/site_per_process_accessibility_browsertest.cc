...
IN_PROC_BROWSER_TEST_F(MAYBE_SitePerProcessAccessibilityBrowserTest,
  ...
  EXPECT_EQ(ax::mojom::Role::STATIC_TEXT, ax_child_frame_static_text->GetRole());
