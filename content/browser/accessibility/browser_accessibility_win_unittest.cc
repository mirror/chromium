...
TEST_F(BrowserAccessibilityTest, TestTextBoundaries) {
  ...
  text_field.AddIntListAttribute(
      ax::mojom::IntListAttribute::CACHED_LINE_STARTS, line_start_offsets);
  ...
  inline_box1.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                  word_start_offsets1);
  ...
  inline_box1.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID,
                              line_break.id);
  line_break.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID,
                             inline_box1.id);
  ...
  inline_box2.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                  word_start_offsets2);
...
TEST_F(BrowserAccessibilityTest, TestComplexHypertext) {
  ...
  check_box.SetCheckedState(ax::mojom::CheckedState::TRUE_VALUE);
...
TEST_F(BrowserAccessibilityTest, TestIA2Attributes) {
  ...
  pseudo_before.AddStringAttribute(ax::mojom::StringAttribute::HTML_TAG,
                                   "<pseudo:before>");
  ...
  checkbox.SetName("Checkbox");
  checkbox.role = ax::mojom::Role::CHECK_BOX;
  checkbox.SetCheckedState(ax::mojom::CheckedState::TRUE_VALUE);
...
TEST_F(BrowserAccessibilityTest, TestTextAttributesInContentEditables) {
  ...
  div_editable.AddState(ax::mojom::State::EDITABLE);
  div_editable.AddState(ax::mojom::State::FOCUSABLE);
  div_editable.AddStringAttribute(ax::mojom::StringAttribute::FONT_FAMILY,
                                  "Helvetica");
  ...
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES,
                                marker_types);
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_STARTS,
                                marker_starts);
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_ENDS,
                                marker_ends);
...
TEST_F(BrowserAccessibilityTest, TestExistingMisspellingsInSimpleTextFields) {
  ...
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES,
                                   marker_types);
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_STARTS,
                                   marker_starts);
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_ENDS,
                                   marker_ends);
...
TEST_F(BrowserAccessibilityTest, TestIAccessible2Relations) {
  ...
  child1.AddIntListAttribute(ax::mojom::IntListAttribute::LABELLEDBY_IDS,
                             labelledby_ids);
