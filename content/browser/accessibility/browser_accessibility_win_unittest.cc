...
TEST_F(BrowserAccessibilityTest, TestChildrenChange) {
  ...
  ui::AXNodeData text;
  text.id = 2;
  text.role = ax::mojom::Role::STATIC_TEXT;
  ...
  param.event_type = ax::mojom::Event::CHILDREN_CHANGED;
...
TEST_F(BrowserAccessibilityTest, TestChildrenChangeNoLeaks) {
  ...
  ui::AXNodeData text4;
  text4.id = 4;
  text4.role = ax::mojom::Role::STATIC_TEXT;
...
TEST_F(BrowserAccessibilityTest, TestTextBoundaries) {
  ...
  text_field.id = 2;
  text_field.role = ax::mojom::Role::TEXT_FIELD;
  text_field.AddState(ax::mojom::State::EDITABLE);
  text_field.SetValue(text_value);
  std::vector<int32_t> line_start_offsets;
  line_start_offsets.push_back(15);
  text_field.AddIntListAttribute(ax::mojom::IntListAttribute::CACHED_LINE_STARTS,
                                 line_start_offsets);
  ...
  static_text1.AddState(ax::mojom::State::EDITABLE);
  static_text1.SetName(line1);
  static_text1.child_ids.push_back(4);

  ui::AXNodeData inline_box1;
  inline_box1.id = 4;
  inline_box1.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_box1.AddState(ax::mojom::State::EDITABLE);
  ...
  inline_box1.AddIntListAttribute(
      ax::mojom::IntListAttribute::WORD_STARTS, word_start_offsets1);

  ui::AXNodeData line_break;
  line_break.id = 5;
  line_break.role = ax::mojom::Role::LINE_BREAK;
  line_break.AddState(ax::mojom::State::EDITABLE);
  line_break.SetName("\n");

  inline_box1.AddIntAttribute(ax::mojom::IntAttribute::NEXT_ON_LINE_ID, line_break.id);
  line_break.AddIntAttribute(ax::mojom::IntAttribute::PREVIOUS_ON_LINE_ID, inline_box1.id);

  ui::AXNodeData static_text2;
  static_text2.id = 6;
  static_text2.role = ax::mojom::Role::STATIC_TEXT;
  static_text2.AddState(ax::mojom::State::EDITABLE);
  static_text2.SetName(line2);
  static_text2.child_ids.push_back(7);

  ui::AXNodeData inline_box2;
  inline_box2.id = 7;
  inline_box2.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_box2.AddState(ax::mojom::State::EDITABLE);
  ...
  inline_box2.AddIntListAttribute(
      ax::mojom::IntListAttribute::WORD_STARTS, word_start_offsets2);
...
TEST_F(BrowserAccessibilityTest, TestComplexHypertext) {
  ...
  combo_box.id = 12;
  combo_box.role = ax::mojom::Role::TEXT_FIELD_WITH_COMBO_BOX;
  combo_box.AddState(ax::mojom::State::EDITABLE);
  ...
  check_box.id = 14;
  check_box.role = ax::mojom::Role::CHECK_BOX;
  check_box.AddIntAttribute(ax::mojom::IntAttribute::CHECKED_STATE,
  ...
  link.role = ax::mojom::Role::LINK;
  link_text.role = ax::mojom::Role::STATIC_TEXT;
...
TEST_F(BrowserAccessibilityTest, TestCreateEmptyDocument) {
  ...
  EXPECT_EQ(ax::mojom::Role::ROOT_WEB_AREA, root->GetRole());
  EXPECT_EQ(0, root->GetState());
  EXPECT_EQ(true, root->GetBoolAttribute(ax::mojom::BoolAttribute::BUSY));
  ...
  tree1_2.id = 2;
  tree1_2.role = ax::mojom::Role::TEXT_FIELD;
  ...
  msg->event_type = ax::mojom::Event::LOAD_COMPLETE;
  ...
  EXPECT_EQ(ax::mojom::Role::TEXT_FIELD, acc1_2->GetRole());
  EXPECT_EQ(2, acc1_2->GetId());

  // Tree with a child button.
  ui::AXNodeData tree2_1;
  tree2_1.id = 1;
  tree2_1.role = ax::mojom::Role::ROOT_WEB_AREA;
  tree2_1.child_ids.push_back(3);

  ui::AXNodeData tree2_2;
  tree2_2.id = 3;
  tree2_2.role = ax::mojom::Role::BUTTON;
  ...
  EXPECT_EQ(ax::mojom::Role::BUTTON, acc2_2->GetRole());
...
TEST_F(BrowserAccessibilityTest, TestIA2Attributes) {
  ...
  pseudo_before.id = 2;
  pseudo_before.role = ax::mojom::Role::GENERIC_CONTAINER;
  pseudo_before.AddStringAttribute(ax::mojom::StringAttribute::HTML_TAG, "<pseudo:before>");
  pseudo_before.AddStringAttribute(ax::mojom::StringAttribute::DISPLAY, "none");

  ui::AXNodeData checkbox;
  checkbox.id = 3;
  checkbox.SetName("Checkbox");
  checkbox.role = ax::mojom::Role::CHECK_BOX;
  checkbox.AddIntAttribute(ax::mojom::IntAttribute::CHECKED_STATE,
                           static_cast<int32_t>(ax::mojom::CheckedState::TRUE_VALUE));
...
TEST_F(BrowserAccessibilityTest, TestValueAttributeInTextControls) {
  ...
  combo_box.role = ax::mojom::Role::TEXT_FIELD_WITH_COMBO_BOX;
  combo_box_text.role = ax::mojom::Role::STATIC_TEXT;
  combo_box.AddBoolAttribute(ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
  combo_box.AddState(ax::mojom::State::EDITABLE);
  combo_box.AddState(ax::mojom::State::RICHLY_EDITABLE);
  combo_box.AddState(ax::mojom::State::FOCUSABLE);
  combo_box_text.AddState(ax::mojom::State::EDITABLE);
  combo_box_text.AddState(ax::mojom::State::RICHLY_EDITABLE);
  ...
  new_line.SetName("\n");
  search_box.role = ax::mojom::Role::SEARCH_BOX;
  search_box_text.role = ax::mojom::Role::STATIC_TEXT;
  new_line.role = ax::mojom::Role::LINE_BREAK;
  search_box.AddBoolAttribute(ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
  search_box.AddState(ax::mojom::State::EDITABLE);
  search_box.AddState(ax::mojom::State::RICHLY_EDITABLE);
  search_box.AddState(ax::mojom::State::FOCUSABLE);
  search_box_text.AddState(ax::mojom::State::EDITABLE);
  search_box_text.AddState(ax::mojom::State::RICHLY_EDITABLE);
  new_line.AddState(ax::mojom::State::EDITABLE);
  new_line.AddState(ax::mojom::State::RICHLY_EDITABLE);
  ...
  text_field.id = 7;
  text_field.role = ax::mojom::Role::TEXT_FIELD;
  text_field.AddBoolAttribute(ax::mojom::BoolAttribute::EDITABLE_ROOT, true);
  text_field.AddState(ax::mojom::State::EDITABLE);
  text_field.AddState(ax::mojom::State::FOCUSABLE);
  ...
  slider.id = 10;
  slider_text.id = 11;
  slider.AddFloatAttribute(ax::mojom::FloatAttribute::VALUE_FOR_RANGE, 5.0F);
  slider_text.SetName("Slider text");
  slider.role = ax::mojom::Role::SLIDER;
  slider_text.role = ax::mojom::Role::STATIC_TEXT;
...
TEST_F(BrowserAccessibilityTest, TestWordBoundariesInTextControls) {
  ...
  textarea_div.id = 3;
  textarea_text.id = 4;
  textarea.role = ax::mojom::Role::TEXT_FIELD;
  textarea_div.role = ax::mojom::Role::GENERIC_CONTAINER;
  textarea_text.role = ax::mojom::Role::STATIC_TEXT;
  textarea.AddState(ax::mojom::State::EDITABLE);
  textarea.AddState(ax::mojom::State::FOCUSABLE);
  textarea.AddState(ax::mojom::State::MULTILINE);
  textarea_div.AddState(ax::mojom::State::EDITABLE);
  textarea_text.AddState(ax::mojom::State::EDITABLE);
  textarea.SetValue(base::UTF16ToUTF8(text));
  textarea_text.SetName(base::UTF16ToUTF8(text));
  textarea.AddStringAttribute(ax::mojom::StringAttribute::HTML_TAG, "textarea");
  ...
  textarea_line1.id = 5;
  textarea_line2.id = 6;
  textarea_line1.role = ax::mojom::Role::INLINE_TEXT_BOX;
  textarea_line2.role = ax::mojom::Role::INLINE_TEXT_BOX;
  textarea_line1.AddState(ax::mojom::State::EDITABLE);
  textarea_line2.AddState(ax::mojom::State::EDITABLE);
  textarea_line1.SetName(base::UTF16ToUTF8(line1));
  textarea_line2.SetName(base::UTF16ToUTF8(line2));
  textarea_line1.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                     line1_word_starts);
  textarea_line2.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                     line2_word_starts);
  ...
  text_field.role = ax::mojom::Role::TEXT_FIELD;
  text_field_div.role = ax::mojom::Role::GENERIC_CONTAINER;
  text_field_text.role = ax::mojom::Role::STATIC_TEXT;
  text_field.AddState(ax::mojom::State::EDITABLE);
  text_field.AddState(ax::mojom::State::FOCUSABLE);
  text_field_div.AddState(ax::mojom::State::EDITABLE);
  text_field_text.AddState(ax::mojom::State::EDITABLE);
  text_field.SetValue(base::UTF16ToUTF8(line1));
  text_field_text.SetName(base::UTF16ToUTF8(line1));
  text_field.AddStringAttribute(ax::mojom::StringAttribute::HTML_TAG, "input");
  ...
  text_field_line.role = ax::mojom::Role::INLINE_TEXT_BOX;
  text_field_line.AddState(ax::mojom::State::EDITABLE);
  text_field_line.SetName(base::UTF16ToUTF8(line1));
  text_field_line.AddIntListAttribute(ax::mojom::IntListAttribute::WORD_STARTS,
                                      line1_word_starts);
...
TEST_F(BrowserAccessibilityTest, TestCaretAndSelectionInSimpleFields) {
  ...
  combo_box.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START, 1);
  combo_box.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_END, 1);
  ...
  // Select the letter 'e'.
  text_field.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_START, 1);
  text_field.AddIntAttribute(ax::mojom::IntAttribute::TEXT_SEL_END, 2);
...
TEST_F(BrowserAccessibilityTest, TestCaretInContentEditables) {
  ...
  div_editable.id = 2;
  div_editable.role = ax::mojom::Role::GENERIC_CONTAINER;
  div_editable.AddState(ax::mojom::State::EDITABLE);
  div_editable.AddState(ax::mojom::State::FOCUSABLE);

  ui::AXNodeData text;
  text.id = 3;
  text.role = ax::mojom::Role::STATIC_TEXT;
  text.AddState(ax::mojom::State::EDITABLE);
  text.SetName("Click ");

  ui::AXNodeData link;
  link.id = 4;
  link.role = ax::mojom::Role::LINK;
  link.AddState(ax::mojom::State::EDITABLE);
  link.AddState(ax::mojom::State::FOCUSABLE);
  link.AddState(ax::mojom::State::LINKED);
  link.SetName("here");

  ui::AXNodeData link_text;
  link_text.id = 5;
  link_text.role = ax::mojom::Role::STATIC_TEXT;
  link_text.AddState(ax::mojom::State::EDITABLE);
  link_text.AddState(ax::mojom::State::FOCUSABLE);
  link_text.AddState(ax::mojom::State::LINKED);
...
TEST_F(BrowserAccessibilityTest, TestSelectionInContentEditables) {
  ...
  text.id = 3;
  text.role = ax::mojom::Role::STATIC_TEXT;
  text.AddState(ax::mojom::State::FOCUSABLE);
  text.AddState(ax::mojom::State::EDITABLE);
  text.SetName("Click ");
...
TEST_F(BrowserAccessibilityTest, TestIAccessibleHyperlink) {
  ...
  div.AddState(ax::mojom::State::FOCUSABLE);
  ...
  link.AddState(ax::mojom::State::LINKED);
  link.SetName("here");
  link.AddStringAttribute(ax::mojom::StringAttribute::URL, "example.com");
...
TEST_F(BrowserAccessibilityTest, TestTextAttributesInContentEditables) {
  ...
  div_editable.AddState(ax::mojom::State::EDITABLE);
  div_editable.AddState(ax::mojom::State::FOCUSABLE);
  div_editable.AddStringAttribute(ax::mojom::StringAttribute::FONT_FAMILY, "Helvetica");

  ui::AXNodeData text_before;
  text_before.id = 3;
  text_before.role = ax::mojom::Role::STATIC_TEXT;
  text_before.AddState(ax::mojom::State::EDITABLE);
  ...
  link.AddState(ax::mojom::State::LINKED);
  link.SetName("lnk");
  link.AddIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE,
  ...
  link_text.AddIntAttribute(ax::mojom::IntAttribute::TEXT_STYLE,
                            static_cast<int32_t>(ax::mojom::TextStyle::TEXT_STYLE_UNDERLINE));
  ...
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES, marker_types);
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_STARTS, marker_starts);
  link_text.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_ENDS, marker_ends);

  ui::AXNodeData text_after;
  text_after.id = 6;
  text_after.role = ax::mojom::Role::STATIC_TEXT;
  text_after.AddState(ax::mojom::State::EDITABLE);
...
TEST_F(BrowserAccessibilityTest, TestExistingMisspellingsInSimpleTextFields) {
  ...
  combo_box_div.id = 3;
  combo_box_div.role = ax::mojom::Role::GENERIC_CONTAINER;
  combo_box_div.AddState(ax::mojom::State::EDITABLE);
  ...
  std::vector<int32_t> marker_types;
  marker_types.push_back(static_cast<int32_t>(ax::mojom::MarkerType::SPELLING));
  std::vector<int32_t> marker_starts;
  marker_starts.push_back(0);
  std::vector<int32_t> marker_ends;
  marker_ends.push_back(4);
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_TYPES, marker_types);
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_STARTS, marker_starts);
  static_text2.AddIntListAttribute(ax::mojom::IntListAttribute::MARKER_ENDS, marker_ends);
...
TEST_F(BrowserAccessibilityTest, TestDeepestFirstLastChild) {
  ...
  child2_child1.id = 4;
  child2_child1.role = ax::mojom::Role::INLINE_TEXT_BOX;
  child2.child_ids.push_back(4);

  ui::AXNodeData child2_child2;
  child2_child2.id = 5;
  child2_child2.role = ax::mojom::Role::INLINE_TEXT_BOX;
...
TEST_F(BrowserAccessibilityTest, TestInheritedStringAttributes) {
  ...
  root.id = 1;
  root.role = ax::mojom::Role::ROOT_WEB_AREA;
  root.AddStringAttribute(ax::mojom::StringAttribute::LANGUAGE, "en-US");
  root.AddStringAttribute(ax::mojom::StringAttribute::FONT_FAMILY, "Helvetica");
  ...
  child2.id = 3;
  child2.role = ax::mojom::Role::STATIC_TEXT;
  child2.AddStringAttribute(ax::mojom::StringAttribute::LANGUAGE, "fr");
  child2.AddStringAttribute(ax::mojom::StringAttribute::FONT_FAMILY, "Arial");
  root.child_ids.push_back(3);
  ...
  EXPECT_EQ(
      ...
      root_accessible->GetInheritedString16Attribute(ax::mojom::StringAttribute::LANGUAGE));
  EXPECT_EQ(
      base::UTF8ToUTF16("en-US"),
      child1_accessible->GetInheritedString16Attribute(ax::mojom::StringAttribute::LANGUAGE));
  EXPECT_EQ(
      base::UTF8ToUTF16("fr"),
      child2_accessible->GetInheritedString16Attribute(ax::mojom::StringAttribute::LANGUAGE));
  ...
  EXPECT_TRUE(root_accessible->GetInheritedString16Attribute(
      ax::mojom::StringAttribute::LANGUAGE, &value16));
  ...
  EXPECT_TRUE(root_accessible->GetInheritedStringAttribute(
      ax::mojom::StringAttribute::FONT_FAMILY, &value));
...
TEST_F(BrowserAccessibilityTest, UniqueIdWinInvalidAfterDeletingTree) {
  ...
  root_node.id = 1;
  root_node.role = ax::mojom::Role::ROOT_WEB_AREA;
...
TEST_F(BrowserAccessibilityTest, TestIAccessible2Relations) {
  ...
  child1.AddIntListAttribute(ax::mojom::IntListAttribute::LABELLEDBY_IDS, labelledby_ids);
  AXEventNotificationDetails event;
  event.event_type = ax::mojom::Event::ARIA_ATTRIBUTE_CHANGED;
