...
TEST_F(BrowserAccessibilityTest, TestNoLeaks) {
  ...
  button.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS, ui::AX_RESTRICTIONS_ENABLED);

  ui::AXNodeData checkbox;
  checkbox.id = 3;
  checkbox.SetName("Checkbox");
  checkbox.role = ui::AX_ROLE_CHECK_BOX;
  checkbox.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                           ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestTextBoundaries) {
  ...
  text_field.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                             ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestComplexHypertext) {
  ...
  combo_box.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                            ui::AX_RESTRICTIONS_ENABLED);
  ...
  check_box.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                            ui::AX_RESTRICTIONS_ENABLED);
  ...
  link.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS, ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestCreateEmptyDocument) {
  ...
  tree1_2.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                          ui::AX_RESTRICTIONS_ENABLED);
  ...
  tree2_2.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                          ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestValueAttributeInTextControls) {
  ...
  search_box.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                             ui::AX_RESTRICTIONS_ENABLED);
  ...
  slider.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS, ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestWordBoundariesInTextControls) {
  ...
  textarea.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                           ui::AX_RESTRICTIONS_ENABLED);
...
TEST_F(BrowserAccessibilityTest, TestCaretInContentEditables) {
  ...
  div_editable.AddIntAttribute(ui::AX_ATTR_RESTRICTIONS,
                               ui::AX_RESTRICTIONS_ENABLED);
