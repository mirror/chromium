...
void AccessibilityTreeFormatterBlink::AddProperties(
  ...
  for (int32_t state_index = static_cast<int32_t>(ax::mojom::State::NONE);
       state_index <= static_cast<int32_t>(ax::mojom::State::LAST);
       ++state_index) {
  ...
  for (int32_t attr_index =
           static_cast<int32_t>(ax::mojom::StringAttribute::NONE);
  ...
  for (int32_t attr_index =
           static_cast<int32_t>(ax::mojom::FloatAttribute::NONE);
  ...
  for (int32_t attr_index =
           static_cast<int32_t>(ax::mojom::BoolAttribute::NONE);
