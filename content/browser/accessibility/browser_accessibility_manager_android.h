...
class CONTENT_EXPORT BrowserAccessibilityManagerAndroid
    : public BrowserAccessibilityManager,
      public WebContentsAccessibilityAndroid::Delegate {
 public:
  ...
  // WebContentsAccessibilityAndroid::Delegate overrides.
  BrowserAccessibility* GetRootNode() override;
  BrowserAccessibility* GetFocusNode() override;
  void SetFocusNode(const BrowserAccessibility& node) override;
  void HitTestNode(const gfx::Point& point) override;
  bool NextAtGranularity(int32_t granularity,
                         int cursor_index,
                         BrowserAccessibilityAndroid* node,
                         int32_t* start_index,
                         int32_t* end_index) override;
