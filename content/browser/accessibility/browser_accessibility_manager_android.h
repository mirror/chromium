...
class CONTENT_EXPORT BrowserAccessibilityManagerAndroid
 ...
 public:
  BrowserAccessibilityManagerAndroid(
      ...
      WebContentsAccessibility* web_contents_accessibility,
  ...
  bool NextAtGranularityForTesting(int32_t granularity,
                                   int cursor_index,
                                   BrowserAccessibilityAndroid* node,
                                   int32_t* start_index,
                                   int32_t* end_index);
  bool PreviousAtGranularityForTesting(int32_t granularity,
                                       int cursor_index,
                                       BrowserAccessibilityAndroid* node,
                                       int32_t* start_index,
                                       int32_t* end_index);
 ...
 private:
  ...
  WebContentsAccessibility* GetWebContentsAXFromRootManager();
