...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_STREQ("Accessibility Test",
               GetAttr(root, ax::mojom::StringAttribute::NAME).c_str());
  EXPECT_EQ(ax::mojom::Role::ROOT_WEB_AREA, root->data().role);

  // Check properties of the BODY element.
  ASSERT_EQ(1, root->child_count());
  const ui::AXNode* body = root->ChildAtIndex(0);
  EXPECT_EQ(ax::mojom::Role::GROUP, body->data().role);
  EXPECT_STREQ("body",
               GetAttr(body, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_STREQ("block",
               GetAttr(body, ax::mojom::StringAttribute::DISPLAY).c_str());
  ...
  EXPECT_EQ(ax::mojom::Role::BUTTON, button->data().role);
  EXPECT_STREQ("input",
               GetAttr(button, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_STREQ("push",
               GetAttr(button, ax::mojom::StringAttribute::NAME).c_str());
  EXPECT_STREQ("inline-block",
               GetAttr(button, ax::mojom::StringAttribute::DISPLAY).c_str());
  ...
  EXPECT_EQ(ax::mojom::Role::CHECK_BOX, checkbox->data().role);
  EXPECT_STREQ("input",
               GetAttr(checkbox, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_STREQ("inline-block",
               GetAttr(checkbox, ax::mojom::StringAttribute::DISPLAY).c_str());
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_EQ(ax::mojom::Role::TEXT_FIELD, text->data().role);
  EXPECT_STREQ("input",
               GetAttr(text, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_EQ(0, GetIntAttr(text, ax::mojom::IntAttribute::TEXT_SEL_START));
  EXPECT_EQ(0, GetIntAttr(text, ax::mojom::IntAttribute::TEXT_SEL_END));
  EXPECT_STREQ("Hello, world.",
               GetAttr(text, ax::mojom::StringAttribute::VALUE).c_str());
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_STREQ("input",
               GetAttr(text, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_EQ(0, GetIntAttr(text, ax::mojom::IntAttribute::TEXT_SEL_START));
  EXPECT_EQ(13, GetIntAttr(text, ax::mojom::IntAttribute::TEXT_SEL_END));
  EXPECT_STREQ("Hello, world.",
               GetAttr(text, ax::mojom::StringAttribute::VALUE).c_str());
}
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_EQ(ax::mojom::Role::TABLE, table->data().role);
  const ui::AXNode* row = table->ChildAtIndex(0);
  EXPECT_EQ(ax::mojom::Role::ROW, row->data().role);
  const ui::AXNode* cell1 = row->ChildAtIndex(0);
  EXPECT_EQ(ax::mojom::Role::CELL, cell1->data().role);
  const ui::AXNode* cell2 = row->ChildAtIndex(1);
  EXPECT_EQ(ax::mojom::Role::CELL, cell2->data().role);
  const ui::AXNode* column1 = table->ChildAtIndex(1);
  EXPECT_EQ(ax::mojom::Role::COLUMN, column1->data().role);
  EXPECT_EQ(0, column1->child_count());
  EXPECT_EQ(1U, column1->data().intlist_attributes.size());
  EXPECT_EQ(ax::mojom::IntListAttribute::INDIRECT_CHILD_IDS,
  ...
  EXPECT_EQ(ax::mojom::Role::COLUMN, column2->data().role);
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_EQ(ax::mojom::Role::BUTTON, button1->data().role);
  EXPECT_STREQ("Button 1",
               GetAttr(button1, ax::mojom::StringAttribute::NAME).c_str());

  const ui::AXNode* iframe = body->ChildAtIndex(1);
  EXPECT_STREQ("iframe",
               GetAttr(iframe, ax::mojom::StringAttribute::HTML_TAG).c_str());
  ASSERT_EQ(1, iframe->child_count());

  const ui::AXNode* sub_document = iframe->ChildAtIndex(0);
  EXPECT_EQ(ax::mojom::Role::WEB_AREA, sub_document->data().role);
  ...
  EXPECT_EQ(ax::mojom::Role::BUTTON, button2->data().role);
  EXPECT_STREQ("Button 2",
               GetAttr(button2, ax::mojom::StringAttribute::NAME).c_str());

  const ui::AXNode* button3 = body->ChildAtIndex(2);
  EXPECT_EQ(ax::mojom::Role::BUTTON, button3->data().role);
  EXPECT_STREQ("Button 3",
               GetAttr(button3, ax::mojom::StringAttribute::NAME).c_str());
}
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_EQ(ax::mojom::Role::ROW, table->ChildAtIndex(0)->data().role);
  EXPECT_EQ(ax::mojom::Role::ROW, table->ChildAtIndex(1)->data().role);
  EXPECT_EQ(ax::mojom::Role::COLUMN, table->ChildAtIndex(2)->data().role);
  EXPECT_EQ(ax::mojom::Role::COLUMN, table->ChildAtIndex(3)->data().role);
  EXPECT_EQ(ax::mojom::Role::COLUMN, table->ChildAtIndex(4)->data().role);
  EXPECT_EQ(3, GetIntAttr(table, ax::mojom::IntAttribute::TABLE_COLUMN_COUNT));
  EXPECT_EQ(2, GetIntAttr(table, ax::mojom::IntAttribute::TABLE_ROW_COUNT));
  ...
  ASSERT_EQ(ax::mojom::IntListAttribute::CELL_IDS,
  ...
  EXPECT_EQ(
      0, GetIntAttr(cell1, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_INDEX));
  EXPECT_EQ(0,
            GetIntAttr(cell1, ax::mojom::IntAttribute::TABLE_CELL_ROW_INDEX));
  EXPECT_EQ(2,
            GetIntAttr(cell1, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_SPAN));
  EXPECT_EQ(1, GetIntAttr(cell1, ax::mojom::IntAttribute::TABLE_CELL_ROW_SPAN));
  EXPECT_EQ(
      2, GetIntAttr(cell2, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_INDEX));
  EXPECT_EQ(1,
            GetIntAttr(cell2, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_SPAN));
  EXPECT_EQ(
      0, GetIntAttr(cell3, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_INDEX));
  EXPECT_EQ(1,
            GetIntAttr(cell3, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_SPAN));
  EXPECT_EQ(
      1, GetIntAttr(cell4, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_INDEX));
  EXPECT_EQ(2,
            GetIntAttr(cell4, ax::mojom::IntAttribute::TABLE_CELL_COLUMN_SPAN));
}
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_TRUE(textbox->data().HasAction(ax::mojom::Action::SET_VALUE));
}
