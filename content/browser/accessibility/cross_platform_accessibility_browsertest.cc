...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_STREQ(
      "input", GetAttr(button, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_STREQ(
      "push",
  ...
  EXPECT_STREQ(
      "input", GetAttr(checkbox, ax::mojom::StringAttribute::HTML_TAG).c_str());
  EXPECT_STREQ(
      "inline-block",
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_STREQ(
      "input", GetAttr(text, ax::mojom::StringAttribute::HTML_TAG).c_str());
...
IN_PROC_BROWSER_TEST_F(CrossPlatformAccessibilityBrowserTest,
  ...
  EXPECT_EQ(3,
            GetIntAttr(table, ax::mojom::IntAttribute::TABLE_COLUMN_COUNT));
  ...
  EXPECT_EQ(0, GetIntAttr(cell1,
                          ax::mojom::IntAttribute::TABLE_CELL_COLUMN_INDEX));
  EXPECT_EQ(0, GetIntAttr(cell1,
                          ax::mojom::IntAttribute::TABLE_CELL_ROW_INDEX));
  EXPECT_EQ(2, GetIntAttr(cell1,
                          ax::mojom::IntAttribute::TABLE_CELL_COLUMN_SPAN));
  EXPECT_EQ(1, GetIntAttr(cell1,
                          ax::mojom::IntAttribute::TABLE_CELL_ROW_SPAN));
