...
// Native class that bridges BrowserAccessibilityManagerAndroid and Java
// WebContentsAccessibility. A RenderWidgetHostConnector runs behind to manage
// the connection. Referenced by BrowserAccessibilityManagerAndroid for
// main frame (root manager) only. The others for subframes acquires this
// instance through the root manager to access Java layer.
//
...
class CONTENT_EXPORT WebContentsAccessibility {
 public:
  ...
  // --------------------------------------------------------------------------
  // Methods called from BrowserAccessibilityManagerAndroid for main frame
  // --------------------------------------------------------------------------
 ...
 private:
  ...
  // A weak reference to the Java WebContentsAccessibility object.
