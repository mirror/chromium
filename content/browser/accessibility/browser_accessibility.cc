...
bool BrowserAccessibility::IsPlainTextField() const {
  // TODO(dmazzoni): Remove this and add a new role for editable combo box.
  bool is_editable_combo_box =
      GetRole() == ui::AX_ROLE_COMBO_BOX && HasState(ui::AX_STATE_EDITABLE);
  ...
  return !HasState(ui::AX_STATE_RICHLY_EDITABLE) &&
         (GetRole() == ui::AX_ROLE_TEXT_FIELD ||
          GetRole() == ui::AX_ROLE_SEARCH_BOX || is_editable_combo_box ||
