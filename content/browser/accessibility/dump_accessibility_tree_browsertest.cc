...
IN_PROC_BROWSER_TEST_F(DumpAccessibilityTreeTest, Fullscreen) {
  // TODO(foolip): something needs to actually call target.requestFullscreen()
  RunHtmlTest(FILE_PATH_LITERAL("fullscreen.html"));
}
