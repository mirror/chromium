...
TEST(BrowserAccessibilityManagerTest, TestNoLeaks) {
  ...
  button.role = ax::mojom::Role::BUTTON;

  ui::AXNodeData checkbox;
  checkbox.id = 3;
  checkbox.SetName("Checkbox");
  checkbox.role = ax::mojom::Role::CHECK_BOX;

  ui::AXNodeData root;
  root.id = 1;
  root.SetName("Document");
  root.role = ax::mojom::Role::ROOT_WEB_AREA;
...
TEST(BrowserAccessibilityManagerTest, TestReuseBrowserAccessibilityObjects) {
  ...
  tree1_child1.role = ax::mojom::Role::BUTTON;

  ui::AXNodeData tree1_child2;
  tree1_child2.id = 3;
  tree1_child2.SetName("Child2");
  tree1_child2.role = ax::mojom::Role::BUTTON;

  ui::AXNodeData tree1_child3;
  tree1_child3.id = 4;
  tree1_child3.SetName("Child3");
  tree1_child3.role = ax::mojom::Role::BUTTON;

  ui::AXNodeData tree1_root;
  tree1_root.id = 1;
  tree1_root.SetName("Document");
  tree1_root.role = ax::mojom::Role::ROOT_WEB_AREA;
  ...
  tree2_child0.role = ax::mojom::Role::BUTTON;

  ui::AXNodeData tree2_root;
  tree2_root.id = 1;
  tree2_root.SetName("DocumentChanged");
  tree2_root.role = ax::mojom::Role::ROOT_WEB_AREA;
  ...
  msg->event_type = ax::mojom::Event::CHILDREN_CHANGED;
...
TEST(BrowserAccessibilityManagerTest, TestReuseBrowserAccessibilityObjects2) {
  ...
  tree1_grandchild1.role = ax::mojom::Role::BUTTON;
  ...
  tree1_grandchild2.role = ax::mojom::Role::BUTTON;
  ...
  tree1_grandchild3.role = ax::mojom::Role::BUTTON;
  ...
  tree1_container.role = ax::mojom::Role::GROUP;
  ...
  tree2_grandchild0.role = ax::mojom::Role::BUTTON;
  ...
  tree2_container.role = ax::mojom::Role::GROUP;
...
TEST(BrowserAccessibilityManagerTest, TestMoveChildUp) {
  ...
  tree1_1.id = 1;
  tree1_1.role = ax::mojom::Role::ROOT_WEB_AREA;
...
TEST(BrowserAccessibilityManagerTest, DISABLED_TestFatalError) {
  ...
  ui::AXNodeData root2;
  root2.id = 1;
  root2.role = ax::mojom::Role::ROOT_WEB_AREA;
...
TEST(BrowserAccessibilityManagerTest, BoundsForRange) {
  ...
  static_text.role = ax::mojom::Role::STATIC_TEXT;
  ...
  inline_text1.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_text1.location = gfx::RectF(100, 100, 29, 9);
  inline_text1.AddIntAttribute(ax::mojom::IntAttribute::TEXT_DIRECTION,
                               static_cast<int32_t>(ax::mojom::TextDirection::LTR));
  ...
  inline_text1.AddIntListAttribute(
      ax::mojom::IntListAttribute::CHARACTER_OFFSETS, character_offsets1);
  static_text.child_ids.push_back(3);

  ui::AXNodeData inline_text2;
  inline_text2.id = 4;
  inline_text2.SetName("world.");
  inline_text2.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_text2.location = gfx::RectF(100, 109, 28, 9);
  inline_text2.AddIntAttribute(ax::mojom::IntAttribute::TEXT_DIRECTION,
                               static_cast<int32_t>(ax::mojom::TextDirection::LTR));
  ...
  inline_text2.AddIntListAttribute(
      ax::mojom::IntListAttribute::CHARACTER_OFFSETS, character_offsets2);
...
TEST(BrowserAccessibilityManagerTest, BoundsForRangeMultiElement) {
  ...
  inline_text1.AddIntListAttribute(
      ax::mojom::IntListAttribute::CHARACTER_OFFSETS, character_offsets);
  static_text.child_ids.push_back(3);

  ui::AXNodeData static_text2;
  static_text2.id = 4;
  static_text2.SetName("ABC");
  static_text2.role = ax::mojom::Role::STATIC_TEXT;
...
TEST(BrowserAccessibilityManagerTest, BoundsForRangeBiDi) {
  ...
  inline_text2.AddIntAttribute(ax::mojom::IntAttribute::TEXT_DIRECTION,
                               static_cast<int32_t>(ax::mojom::TextDirection::RTL));
  std::vector<int32_t> character_offsets2;
  character_offsets2.push_back(10);
  character_offsets2.push_back(20);
...
TEST(BrowserAccessibilityManagerTest, BoundsForRangeScrolledWindow) {
  ...
  root.id = 1;
  root.role = ax::mojom::Role::ROOT_WEB_AREA;
  root.AddIntAttribute(ax::mojom::IntAttribute::SCROLL_X, 25);
  root.AddIntAttribute(ax::mojom::IntAttribute::SCROLL_Y, 50);
  root.location = gfx::RectF(0, 0, 800, 600);
  ...
  inline_text.role = ax::mojom::Role::INLINE_TEXT_BOX;
  inline_text.location = gfx::RectF(100, 100, 16, 9);
  inline_text.AddIntAttribute(ax::mojom::IntAttribute::TEXT_DIRECTION,
                              static_cast<int32_t>(ax::mojom::TextDirection::LTR));
  std::vector<int32_t> character_offsets1;
  character_offsets1.push_back(6);   // 0
  character_offsets1.push_back(11);  // 1
...
TEST(BrowserAccessibilityManagerTest, BoundsForRangeOnParentElement) {
  ...
  ui::AXNodeData div;
  div.id = 2;
  div.role = ax::mojom::Role::GENERIC_CONTAINER;
  ...
  static_text1.role = ax::mojom::Role::STATIC_TEXT;
...
TEST(BrowserAccessibilityManagerTest, TestNextPreviousTextOnlyObject) {
  ...
  ui::AXNodeData text1;
  text1.id = 3;
  text1.role = ax::mojom::Role::STATIC_TEXT;
  root.child_ids.push_back(3);
  ...
  ui::AXNodeData text2;
  text2.id = 5;
  text2.role = ax::mojom::Role::STATIC_TEXT;
  ...
  ui::AXNodeData text3;
  text3.id = 7;
  text3.role = ax::mojom::Role::STATIC_TEXT;
  ...
  ui::AXNodeData text4;
  text4.id = 9;
  text4.role = ax::mojom::Role::LINE_BREAK;
...
TEST(BrowserAccessibilityManagerTest, TestFindIndicesInCommonParent) {
  ...
  paragraph_line2.role = ax::mojom::Role::INLINE_TEXT_BOX;
...
TEST(BrowserAccessibilityManagerTest, DeletingFocusedNodeDoesNotCrash) {
  ...
  events2[0].id = -1;
  events2[0].event_type = ax::mojom::Event::NONE;
