...
template <class T>
void HistogramController::NotifyHostDied(T* host) {
  RemoveChildHistogramInterface(host);
}

template void HistogramController::NotifyHostDied(RenderProcessHost* host);
...
void HistogramController::GetHistogramDataFromChildProcesses(
  ...
  for (BrowserChildProcessHostIterator iter; !iter.Done(); ++iter) {
    ...
    if (auto* child_histogram = GetChildHistogramInterface(iter.GetHost())) {
