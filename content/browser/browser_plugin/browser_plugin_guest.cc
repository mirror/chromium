...
ui::ImeTextSpan::Type ConvertWebTypeToUiType(blink::WebImeTextSpan::Type type) {
  switch (type) {
    case blink::WebImeTextSpan::Type::COMPOSITION:
      return ui::ImeTextSpan::Type::COMPOSITION;
    case blink::WebImeTextSpan::Type::SUGGESTION:
      return ui::ImeTextSpan::Type::SUGGESTION;
  }
}
