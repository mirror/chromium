...
class StoragePartitonInterceptor
 ...
 public:
  ...
  void SetForwardingInterface(
    ...
    storage_partition_service_.reset(storage_partition_service);
  }
 ...
 private:
  ...
  std::unique_ptr<mojom::StoragePartitionService> storage_partition_service_;
};
...
void CreateTestStoragePartitionService(
  ...
  interceptor->SetForwardingInterface(
