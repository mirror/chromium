...
// would be processed, enabling unit/browser tests to scrutinize the parameters,
// or trigger other calls just before the navigation is committed to simulate
// race conditions.
class DidCommitProvisionalLoadInterceptor : public WebContentsObserver {
 ...
 private:
  ...
  base::WeakPtrFactory<DidCommitProvisionalLoadInterceptor> weak_factory_;
