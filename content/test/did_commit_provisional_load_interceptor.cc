...
// Responsible for intercepting DCPL for exactly one RenderFrameHostImpl.
 ...
 public:
  FrameAgent(DidCommitProvisionalLoadInterceptor* interceptor,
      ...
      : interceptor_(interceptor),
        ...
        impl_(rfhi_->frame_host_binding().SwapImplForTesting(this)) {}

  ~FrameAgent() override {
    auto* old_impl = rfhi_->frame_host_binding().SwapImplForTesting(impl_);
