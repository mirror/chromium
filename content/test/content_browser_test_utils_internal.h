...
class RenderProcessHostKillWaiter {
 public:
  ...
  // Waits until the renderer process exits.  Returns the bad message that
  // made //content kill the renderer.  An empty base::Optional<...> is returned
  // if the renderer was killed outside of //content or exited normally.
