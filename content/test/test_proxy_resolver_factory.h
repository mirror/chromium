...
#ifndef CONTENT_TEST_TEST_PROXY_RESOLVER_FACTORY_H_
#define CONTENT_TEST_TEST_PROXY_RESOLVER_FACTORY_H_
...
class TestProxyResolverFactory
...
#endif  // CONTENT_TEST_TEST_PROXY_RESOLVER_FACTORY_H_
