...
void TestRenderFrameHost::SendNavigateWithParams(
  ...
  mojom::DidCommitProvisionalLoadParamsPtr extended_params =
      mojom::DidCommitProvisionalLoadParams::New();
  extended_params->native_params = *params;
  DidCommitProvisionalLoad(std::move(extended_params));
