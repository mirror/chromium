...
#ifndef CONTENT_TEST_MOCK_OVERSCROLL_REFRESH_HANDLER_H_
#define CONTENT_TEST_MOCK_OVERSCROLL_REFRESH_HANDLER_H_
...
class MockOverscrollRefreshHandler : public ui::OverscrollRefreshHandler,
 ...
 public:
  MockOverscrollRefreshHandler();
  ~MockOverscrollRefreshHandler() override;
 ...
 private:
  ...
  bool seen_update_;
  bool pull_ended_;
  DISALLOW_COPY_AND_ASSIGN(MockOverscrollRefreshHandler);
};

}  // namespace content

#endif  // CONTENT_TEST_MOCK_OVERSCROLL_REFRESH_HANDLER_H_
