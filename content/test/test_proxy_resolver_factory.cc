...
TestProxyResolverFactory::TestProxyResolverFactory() : binding_(this) {
  mojo::MakeStrongBinding(
      std::make_unique<proxy_resolver::ProxyResolverFactoryImpl>(),
      mojo::MakeRequest(&factory_));
}

TestProxyResolverFactory::~TestProxyResolverFactory() = default;

void TestProxyResolverFactory::CreateResolver(
...
void TestProxyResolverFactory::OnResolverDestroyed() {}

proxy_resolver::mojom::ProxyResolverFactoryPtr
TestProxyResolverFactory::CreateFactoryInterface() {
