...
IPC_STRUCT_TRAITS_BEGIN(content::ResourceRequest)
  ...
  IPC_STRUCT_TRAITS_MEMBER(is_external_request)
  IPC_STRUCT_TRAITS_MEMBER(cors_preflight_referrer)
  IPC_STRUCT_TRAITS_MEMBER(cors_preflight_referrer_policy)
  IPC_STRUCT_TRAITS_MEMBER(prevent_preflight)
...
IPC_STRUCT_TRAITS_BEGIN(content::ResourceRequestCompletionStatus)
  IPC_STRUCT_TRAITS_MEMBER(error_code)
  IPC_STRUCT_TRAITS_MEMBER(error_description)
