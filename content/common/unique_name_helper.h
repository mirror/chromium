...
//
// newTrimmedUniqueSuffix is only generated if needed: it is simply a generated
// newUniqueSuffix, with the restriction that the number of frame indices is
// limited to 10. This is to guarantee that hashedGeneratedName remains under
// the max size.
//
