...
#ifndef CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_CACHE_STORAGE_STRUCT_TRAITS_H_
#define CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_CACHE_STORAGE_STRUCT_TRAITS_H_
...
template <>
struct EnumTraits<blink::mojom::CacheError, content::CacheStorageError> {
  static blink::mojom::CacheError ToMojom(content::CacheStorageError input);
};
...
struct StructTraits<blink::mojom::QueryParamsDataView,
  ...
  // TODO(cmumford): Should this return optional or NullableString?
  static base::Optional<base::string16> cache_name(
      const content::CacheStorageCacheQueryParams& query_params) {
    return query_params.cache_name.is_null() ? base::Optional<base::string16>()
                                             : query_params.cache_name.string();
  }
...
#endif  // CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_CACHE_STORAGE_STRUCT_TRAITS_H_
