...
ServiceWorkerClientInfo::ServiceWorkerClientInfo()
    : ServiceWorkerClientInfo(std::string(),
                              blink::mojom::WebPageVisibilityState::kLast,
                              false,
                              GURL(),
...
ServiceWorkerClientInfo::ServiceWorkerClientInfo(
    ...
    blink::mojom::WebPageVisibilityState page_visibility_state,
    bool is_focused,
    const GURL& url,
...
bool ServiceWorkerClientInfo::IsEmpty() const {
  return page_visibility_state == blink::mojom::WebPageVisibilityState::kLast &&
