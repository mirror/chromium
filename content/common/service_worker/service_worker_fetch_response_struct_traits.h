...
#ifndef CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_FETCH_RESPONSE_STRUCT_TRAITS_H_
#define CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_FETCH_RESPONSE_STRUCT_TRAITS_H_
...
struct StructTraits<blink::mojom::FetchAPIResponseDataView,
  ...
  static bool is_in_cache_storage(const content::ServiceWorkerResponse& response) {
...
#endif  // CONTENT_COMMON_SERVICE_WORKER_SERVICE_WORKER_FETCH_RESPONSE_STRUCT_TRAITS_H_
