...
// Tells the browser that a child's frame rect has changed (or the rect/scroll
// position of a child's ancestor has changed).
IPC_MESSAGE_ROUTED2(FrameHostMsg_FrameRectChanged,
                    gfx::Rect /* frame_rect */,
                    viz::LocalSurfaceId /* local_surface_id */)

// Produces an ACK to the browser about the updated ScreenInfo.
IPC_MESSAGE_ROUTED2(FrameHostMsg_ScreenInfoChanged,
