...
IPC_ENUM_TRAITS_MIN_MAX_VALUE(blink::WebRemoteScrollProperties::Alignment,
                              blink::WebRemoteScrollProperties::kCenterIfNeeded,
                              blink::WebRemoteScrollProperties::kRightAlways)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(blink::WebRemoteScrollProperties::Type,
                              blink::WebRemoteScrollProperties::kUser,
                              blink::WebRemoteScrollProperties::kSequenced)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(blink::WebRemoteScrollProperties::Behavior,
                              blink::WebRemoteScrollProperties::kAuto,
                              blink::WebRemoteScrollProperties::kSmooth)
...
// Send by a local root to request scrolling in its parent process.
