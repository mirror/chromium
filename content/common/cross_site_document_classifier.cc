...
//
// For example:
// - IsMimeTypePrefixMatched("application/json", "application/json") -> true
// - IsMimeTypePrefixMatched("application/json+foo", "application/json") -> true
// - IsMimeTypePrefixMatched("application/jsonp", "application/json") -> false
// - IsMimeTypePrefixMatched("application/foo", "application/json") -> false
bool IsMimeTypePrefixMatched(base::StringPiece mime_type,
...
CrossSiteDocumentMimeType CrossSiteDocumentClassifier::GetCanonicalMimeType(
  ...
  constexpr auto kCaseInsensitive = base::CompareCase::INSENSITIVE_ASCII;
  if (IsMimeTypePrefixMatched(mime_type, kAppJson) ||
      IsMimeTypePrefixMatched(mime_type, kTextJson) ||
      IsMimeTypePrefixMatched(mime_type, kTextXjson) ||
      base::EndsWith(mime_type, kJsonSuffix, kCaseInsensitive)) {
    return CROSS_SITE_DOCUMENT_MIME_TYPE_JSON;
  }

  if (IsMimeTypePrefixMatched(mime_type, kAppXml) ||
      IsMimeTypePrefixMatched(mime_type, kTextXml) ||
