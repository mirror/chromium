...
TEST_F(EventWithLatencyInfoTest, TimestampCoalescingForMouseEvent) {
  MouseEventWithLatencyInfo mouse_0 = CreateMouseEvent(
      WebInputEvent::kMouseMove, 5.0);
  MouseEventWithLatencyInfo mouse_1 = CreateMouseEvent(
      WebInputEvent::kMouseMove, 10.0);
...
TEST_F(EventWithLatencyInfoTest, TimestampCoalescingForTouchEvent) {
  TouchEventWithLatencyInfo touch_0 = CreateTouchEvent(
      WebInputEvent::kTouchMove, 5.0);
  TouchEventWithLatencyInfo touch_1 = CreateTouchEvent(
      WebInputEvent::kTouchMove, 10.0);
...
TEST_F(EventWithLatencyInfoTest, TimestampCoalescingForGestureEvent) {
  GestureEventWithLatencyInfo scroll_0 = CreateGestureEvent(
      WebInputEvent::kGestureScrollUpdate, 5.0);
  GestureEventWithLatencyInfo scroll_1 = CreateGestureEvent(
      WebInputEvent::kGestureScrollUpdate, 10.0);
...
TEST_F(EventWithLatencyInfoTest, TouchEventCoalescing) {
  ...
  touch1.event.touches[1] = CreateTouchPoint(WebTouchPoint::kStateStationary, 1);
  touch0.event.touches[1] = CreateTouchPoint(WebTouchPoint::kStateStationary, 0);
...
TEST_F(EventWithLatencyInfoTest, WebMouseWheelEventCoalescing) {
  ...
  EXPECT_TRUE(CanCoalesce(mouse_wheel_0, mouse_wheel_1));
  EXPECT_EQ(mouse_wheel_0.event.GetModifiers(), mouse_wheel_1.event.GetModifiers());
  EXPECT_EQ(mouse_wheel_0.event.scroll_by_page, mouse_wheel_1.event.scroll_by_page);
  ...
  EXPECT_EQ(
      mouse_wheel_1_copy.event.wheel_ticks_x + mouse_wheel_0.event.wheel_ticks_x,
      mouse_wheel_1.event.wheel_ticks_x);
  EXPECT_EQ(
      mouse_wheel_1_copy.event.wheel_ticks_y + mouse_wheel_0.event.wheel_ticks_y,
      mouse_wheel_1.event.wheel_ticks_y);
  EXPECT_EQ(mouse_wheel_1_copy.event.movement_x + mouse_wheel_0.event.movement_x,
            mouse_wheel_1.event.movement_x);
  EXPECT_EQ(mouse_wheel_1_copy.event.movement_y + mouse_wheel_0.event.movement_y,
