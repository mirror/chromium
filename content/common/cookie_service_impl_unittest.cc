 ...
 public:
  ...
  mojom::CookieChangeNotificationRequest RequestNotification(
    ...
    cookie_service_->RequestNotification(
        url, cookie_name,
        base::BindOnce(
            &SynchronousCookieServiceWrapper::RequestNotificationCallback,
            &run_loop, &request));
    run_loop.Run();
    return request;
  }
...
TEST_F(CookieServiceTest, NotificationRequestDestroyed) {
  ...
  GURL notification_url("http://www.testing.com/pathele");
  std::string notification_name("Cookie_Name");
  mojom::CookieChangeNotificationRequest request1 =
      service_wrapper()->RequestNotification(notification_url,
                                             notification_name);
  ...
  mojom::CookieChangeNotificationRequest request2 =
      service_wrapper()->RequestNotification(notification_url,
                                             notification_name);
