...
class PossiblyAssociatedInterfacePtrInfo final {
 public:
  ...
  PossiblyAssociatedInterfacePtrInfo(
      PossiblyAssociatedInterfacePtrInfo&& other) {
    *this = std::move(other);
  }
  ~PossiblyAssociatedInterfacePtrInfo() {}
  ...
  PossiblyAssociatedInterfacePtrInfo& operator=(
      PossiblyAssociatedInterfacePtrInfo&& other) {
    independent_ptr_info_ = std::move(other.independent_ptr_info_);
    associated_ptr_info_ = std::move(other.associated_ptr_info_);
    return *this;
  }
