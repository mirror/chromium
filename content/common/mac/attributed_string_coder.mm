...
AttributedStringCoder::FontAttribute::FontAttribute(NSDictionary* dict,
    ...
    : font_point_size_(0), effective_range_(effective_range) {
...
AttributedStringCoder::FontAttribute::FontAttribute(base::string16 font_name,
...
AttributedStringCoder::FontAttribute::FontAttribute()
    : font_point_size_(0), effective_range_() {}
...
bool ParamTraits<AttributedStringCoder::FontAttribute>::Read(
  ...
  if (success) {
    *p =
        AttributedStringCoder::FontAttribute(font_name, font_point_size, range);
  }
  return success;
}
