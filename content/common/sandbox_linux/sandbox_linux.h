...
class LinuxSandbox {
 public:
  ...
  static bool InitializeSandbox(gpu::GPUInfo* gpu_info = NULL);
  ...
  bool StartSeccompBPF(const std::string& process_type, gpu::GPUInfo* gpu_info);
 ...
 private:
  ...
  bool InitializeSandboxImpl(gpu::GPUInfo* gpu_info);
