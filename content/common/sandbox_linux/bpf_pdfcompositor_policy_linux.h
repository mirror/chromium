...
#ifndef CONTENT_COMMON_SANDBOX_LINUX_BPF_PDFCOMPOSITOR_POLICY_LINUX_H_
#define CONTENT_COMMON_SANDBOX_LINUX_BPF_PDFCOMPOSITOR_POLICY_LINUX_H_
...
#endif  // CONTENT_COMMON_SANDBOX_LINUX_BPF_PDFCOMPOSITOR_POLICY_LINUX_H_
