...
bool StartSandboxedProcess(
  ...
  return StartSandboxedProcessInternal(
             ...
             base::Bind(&delegate->PreSpawnTarget, base::Unretained(delegate)),
             base::Bind(&delegate->PostSpawnTarget, base::Unretained(delegate)),
             process) == sandbox::SBOX_ALL_OK;
}
