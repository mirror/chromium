...
EnumTraits<blink::mojom::MediaDeviceType, content::MediaDeviceType>::ToMojom(
  ...
  switch (type) {
    ...
    case content::MediaDeviceType::NUM_MEDIA_DEVICE_TYPES:
  ...
  switch (input) {
    ...
    case blink::mojom::MediaDeviceType::MEDIA_AUDIO_OUTPUT:
      *out = content::MediaDeviceType::MEDIA_DEVICE_TYPE_AUDIO_OUTPUT;
      return true;
    case blink::mojom::MediaDeviceType::NUM_MEDIA_DEVICE_TYPES:
      *out = content::MediaDeviceType::NUM_MEDIA_DEVICE_TYPES;
      return true;
  }
  NOTREACHED();
  return false;
