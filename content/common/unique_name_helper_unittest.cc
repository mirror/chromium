...
class TestAdapter : public UniqueNameHelper::FrameAdapter {
 public:
  ...
  // FrameState children is guaranteed to match the order of TestAdapter
  // children.
...
TEST(UniqueNameHelper, Basic) {
  ...
  // strange...
  TestAdapter frame_2a_5(&frame_2a, 5, "");
  EXPECT_EQ(
...
TEST(UniqueNameHelper, Hashing) {
  ...
  // are preserved.
  TestAdapter frame_0_0_0b(&frame_0_0, 0, "");
  EXPECT_EQ(
      "<!--framePath //<!--frameHash "
      "2EDC986847E209B4016E141A6DC8716D3207350F416969382D431539BF292E4A-->/"
  ...
  // in the frame path.
  TestAdapter frame_0_0_0b_0(&frame_0_0_0b, 0, "");
  EXPECT_EQ(
      "<!--framePath //<!--frameHash "
      "2EDC986847E209B4016E141A6DC8716D3207350F416969382D431539BF292E4A-->/"
  ...
  // unique suffix embedded in the frame path) is handled correctly.
  TestAdapter frame_0_0_0b_0b(&frame_0_0_0b, 0, "");
  EXPECT_EQ(
      "<!--framePath //<!--frameHash "
      "2EDC986847E209B4016E141A6DC8716D3207350F416969382D431539BF292E4A-->/"
      "<!--frame0-->--><!--framePosition-0-0-0/0/"
