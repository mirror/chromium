...
SOURCE_PATH = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(
    __file__))))
LLVM_BUILD_PATH = os.path.join(SOURCE_PATH, 'third_party', 'llvm-build')
...
def downloadCoverageToolsIfNeeded():
  ...
  clang_script_path = os.path.join(SOURCE_PATH, 'tools', 'clang', 'scripts')
...
def process_coverage_dump(profile_file, coverage_file):
...
def main():
  ...
  process_coverage_dump(profile_file, coverage_file)
