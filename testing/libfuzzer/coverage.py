...
with "use_clang_coverage=true use_libfuzzer=true" GN configuration.

Clang coverage flag is not compatible with other sanitizer flags:
"is_asan", "is_msan", etc and also with "optimize_for_fuzzing".
