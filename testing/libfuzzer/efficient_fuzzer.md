...
Try to keep `LLVMFuzzerTestOneInput` function as simple as possible. If you fuzzing
...
fuzzer speed on every run and its ability to find new interesting inputs. Checkout
