// This is scaled-down version of the DeltaBlue benchmark. Today, this
...
// JavaScript testing framework (kasperl 11/27/06).
 ...
 */
Constraint.prototype.satisfy = function satisfy(mark) {
 ...
 * constraint solver.
 **/
function Variable(name, initialValue, walkStrength, nConstraints) {
  this.value = initialValue || 0;
  this.constraints = new Vector(nConstraints || 2);
  this.determinedBy = null;
  this.mark = 0;
  this.walkStrength = walkStrength || Strength.WEAKEST;
  this.stay = true;
  this.name = name;
}
