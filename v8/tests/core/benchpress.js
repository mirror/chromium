// This is scaled-down version of the BenchPress benchmark. I have
// turned it into a test run by the JavaScript testing framework
// (kasperl 11/09/06).
...
// Run each benchmark exactly once.
...
function towers() {
  towersPiles = new Array(null, null, null);
  towersBuild(0, 13);
  towersMovesDone = 0;
  towersMove(0, 1, 13);
  if (towersMovesDone != 8191) 
    error("Error in result: " + towersMovesDone + " should be: 8192");
}
