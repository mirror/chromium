...
static void CheckOddball(Object* obj, char* string) {
  CHECK(obj->IsOddball());
  bool exc;
...
static void CheckSmi(int value, char* string) {
  bool exc;
  Object* print_string =
...
static void CheckNumber(double value, char* string) {
...
#define __ assm.
  ...
  Object* not_right = Heap::FindCodeObject(obj_addr + obj->Size());
  CHECK(not_right != code);
}


static void TestHeapObjects() {
  InitializeVM();
...
static void TestWeakGlobalHandlesScavenge() {
  InitializeVM();
...
static void TestWeakGlobalHandlesMark() {
  InitializeVM();
...
static void TestDeleteWeakGlobalHandle() {
  InitializeVM();
...
static char* not_so_random_string_table[] = {
  "abstract",
  "boolean",
  "break",
  "byte",
...
static void CheckSymbols(char** strings) {
  for (char* string = *strings; *strings != 0; string = *strings++) {
...
static void TestFunctionAllocation() {
  InitializeVM();
...
static void TestObjectProperties() {
  InitializeVM();
