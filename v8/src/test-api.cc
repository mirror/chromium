...
class ApiTestFuzzer: public v8::internal::Thread {
 ...
 private:
  ...
  static ApiTestFuzzer* tests_[kNumberOfTests];
...
static void TestReceiverSignature() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestArgumentSignature() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestScriptUsingStringResource() {
...
static void TestScriptUsingAsciiStringResource() {
...
static void TestFunctionTemplate() {
  v8::HandleScope scope;
  LocalContext env;
  {
...
static void TestPropertyHandler() {
  v8::HandleScope scope;
  Local<v8::FunctionTemplate> fun_templ = v8::FunctionTemplate::New();
...
static void TestGlobalPrototype() {
  v8::HandleScope scope;
...
static void TestObjectTemplate() {
  v8::HandleScope scope;
...
static void TestDescriptorInheritance() {
  v8::HandleScope scope;
...
static void TestNamedPropertyHandlerGetter() {
  ...
  char* code = "var str = 'oddle'; obj[str] + obj.poddle;";
...
static void TestIndexedPropertyHandlerGetter() {
  v8::HandleScope scope;
  v8::Handle<v8::FunctionTemplate> templ = v8::FunctionTemplate::New();
...
static void TestPropertyHandlerInPrototype() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestPrePropertyHandler() {
  v8::HandleScope scope;
...
static void TestCallbackExceptionRegression() {
  v8::HandleScope scope;
...
static void TestRegress1054726() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> obj = ObjectTemplate::New();
...
static void TestFunctionPrototype() {
  v8::HandleScope scope;
...
static void TestInternalFields() {
  v8::HandleScope scope;
...
static void TestScriptException() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestMessageHandlerData() {
...
static void TestGetSetProperty() {
  v8::HandleScope scope;
  LocalContext context;
...
static void TestPropertyAttributes() {
  v8::HandleScope scope;
  LocalContext context;
  // read-only
...
static void TestOutOfMemoryNested() {
  // It's not possible to read a snapshot into a heap with different dimensions.
  v8::internal::Snapshot::DisableInternal();
  // Set heap limits.
  static const int K = 1024;
...
static void TestHugeConsStringOutOfMemory() {
  // It's not possible to read a snapshot into a heap with different dimensions.
  v8::internal::Snapshot::DisableInternal();
  v8::HandleScope scope;
  LocalContext context;
...
static void TestConversionException() {
  v8::HandleScope scope;
  LocalContext env;
  CompileRun(
    "function TestClass() { };"
...
static void TestExternalScriptException() {
  v8::HandleScope scope;
  Local<ObjectTemplate> templ = ObjectTemplate::New();
  templ->Set(v8_str("ThrowFromC"),
             v8::FunctionTemplate::New(ThrowFromC));
...
static void TestExceptionOrder() {
  v8::HandleScope scope;
  Local<ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestCatchExceptionFromWith() {
  v8::HandleScope scope;
  LocalContext context;
  v8::TryCatch try_catch;
  CHECK(!try_catch.HasCaught());
...
static void TestSimplePropertyRead() {
  v8::HandleScope scope;
  Local<ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestSimplePropertyWrite() {
  v8::HandleScope scope;
  Local<ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestNamedInterceporPropertyRead() {
  v8::HandleScope scope;
  Local<ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestFunctionPrototypeAcrossContexts() {
...
static void TestUndetectableObject() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestUndetectableString() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestGlobalObjectTemplate() {
...
static void TestSimpleExtensions() {
  v8::HandleScope handle_scope;
...
static void TestAutoExtensions() {
  v8::HandleScope handle_scope;
 ...
 *     \-- C <--/
 */
static void TestExtensionDependency() {
...
static void TestFunctionLookup() {
...
static void TestErrorWithMissingScriptInfo() {
  v8::HandleScope scope;
  LocalContext context;
...
static void TestPreInterceptorHolders() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> obj = ObjectTemplate::New();
...
static void TestApiUncaughtException() {
  v8::HandleScope scope;
  LocalContext env;
...
static void TestSecurityChecksForPrototypeChain() {
  v8::HandleScope scope;
...
static void TestCrossDomainDelete() {
  v8::HandleScope handle_scope;
  LocalContext env1;
  v8::Persistent<Context> env2 = Context::New();
...
static void TestAccessControlIC() {
...
// case.
static void TestAccessControlFlatten() {
  named_access_count = 0;
  indexed_access_count = 0;
...
static void TestAccessControlInterceptorIC() {
  named_access_count = 0;
  indexed_access_count = 0;
...
static void TestGlobalObjectInstanceProperties() {
  v8::HandleScope handle_scope;
...
static void TestHiddenPrototype() {
  v8::HandleScope handle_scope;
  LocalContext context;
...
static void TestGetterSetterExceptions() {
  v8::HandleScope handle_scope;
  LocalContext context;
  CompileRun(
    "function Foo() { };"
...
static void TestFunctionDescriptorException() {
  v8::HandleScope handle_scope;
  LocalContext context;
  Local<v8::FunctionTemplate> templ = v8::FunctionTemplate::New();
  templ->SetClassName(v8_str("Fun"));
...
static void TestInterceptorLoadIC() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestInterceptorStoreIC() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
  templ->SetNamedPropertyHandler(InterceptorLoadICGetter,
...
static void TestInterceptorCallIC() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestInterceptorICReferenceErrors() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestInterceptorICGetterExceptions() {
...
// once in a while.
static void TestInterceptorICSetterExceptions() {
...
static void TestNullNamedInterceptor() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
...
// Test that we ignore null interceptors.
static void TestNullIndexedInterceptor() {
  v8::HandleScope scope;
  v8::Handle<v8::ObjectTemplate> templ = ObjectTemplate::New();
...
static void TestIsConstructCall() {
  v8::HandleScope scope;
...
static void TestObjectProtoToString() {
  v8::HandleScope scope;
  Local<v8::FunctionTemplate> templ = v8::FunctionTemplate::New();
...
ApiTestFuzzer* ApiTestFuzzer::tests_[kNumberOfTests];
...
void ApiTestFuzzer::Fuzz() {
  if (!fuzzing_) return;
  ApiTestFuzzer* test = tests_[current_];
  test->ContextSwitch();
}
...
bool ApiTestFuzzer::NextThread() {
  ...
  if (test_position == current_) {
    printf("Stay with %d\n", tests_[current_]->test_number_);
    return false;
  }
  printf("Switch from %d to %d\n",
         current_ < 0 ? 0 : tests_[current_]->test_number_,
         test_position < 0 ? 0 : tests_[test_position]->test_number_);
  current_ = test_position;
  tests_[current_]->gate_->Signal();
  return true;
}
...
void ApiTestFuzzer::Setup(PartOfTest part) {
  ...
  fuzzing_ = true;
  int start = (part == FIRST_PART) ? 0 : (kNumberOfTests >> 1);
  int end = (part == FIRST_PART) ? (kNumberOfTests >> 1) : kNumberOfTests;
  active_tests_ = tests_being_run_ = end - start;
  for (int i = 0; i < tests_being_run_; i++) {
    tests_[i] = new ApiTestFuzzer(i + start);
  }
...
static void CallTestNumber(int test_number_);
...
int ApiTestFuzzer::GetNextTestNumber() {
  ...
  } while (!tests_[next_test]->active_);
  return next_test;
}
...
const char* kExcludedTests[] = {
  ...
  // API fuzzer.
  "DontLeakGlobalObjects",

  NULL
};


static bool ExcludedTest(char* name) {
  for (int i = 0; kExcludedTests[i] != NULL; i++) {
    if (!strcmp(name, kExcludedTests[i]))
      return true;
  }
  return false;
}
...
static void TestNestedLockersNoTryCatch() {
  v8::Locker locker;
  v8::HandleScope scope;
  LocalContext env;
  Local<v8::FunctionTemplate> fun_templ =
...
static void TestRecursiveLocking() {
  v8::Locker locker;
  {
    v8::Locker locker2;
    v8::Locker::AssertIsLocked();
...
static void TestLockUnlockLock() {
  {
    v8::Locker locker;
    v8::HandleScope scope;
    LocalContext env;
...
static void TestDontLeakGlobalObjects() {
...
static void TestCheckForCrossContextObjectLiterals() {
  v8::internal::V8::Initialize(NULL);
...
static void TestNestedHandleScopeAndContexts() {
...
static void TestDisposeEnteredContext() {
  v8::HandleScope scope;
  LocalContext outer;
