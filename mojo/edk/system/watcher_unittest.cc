...
void DoRandomThing(MojoHandle* watchers,
  ...
  switch (base::RandInt(0, 10)) {
    case 0:
      MojoClose(watchers[base::RandInt(0, num_watchers - 1)]);
      break;
    case 1:
      MojoClose(watched_handles[base::RandInt(0, num_watched_handles - 1)]);
      break;
    case 2:
    case 3:
    case 4: {
      ...
      MojoWriteMessage(
          watched_handles[base::RandInt(0, num_watched_handles - 1)], message,
          MOJO_WRITE_MESSAGE_FLAG_NONE);
      break;
    }
    case 5:
    case 6: {
      MojoHandle w = watchers[base::RandInt(0, num_watchers - 1)];
      MojoHandle h = watched_handles[base::RandInt(0, num_watched_handles - 1)];
    ...
    case 8: {
      ...
      MojoResult ready_result;
      MojoHandleSignalsState ready_state;
      if (MojoArmWatcher(watchers[base::RandInt(0, num_watchers - 1)],
