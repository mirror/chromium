...
class NodeController : public ports::NodeDelegate,
 ...
 public:
  ...
  /*
>>>>>>>
   stupid hack - don't commit - testing wow64 nacl failure
  */
  void StashGlobalReservedPort(const std::string& name, const ports::PortRef& port) {
    base::AutoLock lock(reserved_ports_lock_);
    global_reserved_ports_.emplace(name, port);
  }
...
>>>>>>>
no commit */
  PortMap global_reserved_ports_;
