...
MojoResult UserMessageImpl::CreateEventForNewSerializedMessage(
  ...
  MojoResult rv = CreateOrExtendSerializedEventMessage(
      event.get(), nullptr, num_bytes, num_bytes, dispatchers, num_dispatchers,
...
MojoResult UserMessageImpl::AttachSerializedMessageBuffer(
  ...
  Channel::MessagePtr channel_message;
  MojoResult rv = CreateOrExtendSerializedEventMessage(
      message_event_, nullptr, payload_size,
...
MojoResult UserMessageImpl::CommitSerializedContents(
  ...
  if (!pending_handle_attachments_.empty()) {
    CreateOrExtendSerializedEventMessage(
        message_event_, std::move(channel_message_), user_payload_size_,
        user_payload_size_, pending_handle_attachments_.data(),
        pending_handle_attachments_.size(), &channel_message_, &header_,
