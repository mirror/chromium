...
// default arguments passed into CallbackWithDefault. Alternatively, it will
// run the delete closure passed to CallbackWithDelete.
//
...
// before runniing, may not run on the thread you expected. If this is a problem
...
//
//  foo->DoWorkAndReturnResult(
//      CallbackWithDelete(base::BindOnce(&Foo::OnResult, this),
