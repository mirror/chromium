...
#ifndef MOJO_PUBLIC_CPP_BINDINGS_LIB_WTF_CLONE_UTIL_H_
#define MOJO_PUBLIC_CPP_BINDINGS_LIB_WTF_CLONE_UTIL_H_
...
#endif  // MOJO_PUBLIC_CPP_BINDINGS_LIB_WTF_CLONE_UTIL_H_
