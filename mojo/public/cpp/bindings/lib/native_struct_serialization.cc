...
mojo::native::SerializedHandle::Type AttachmentTypeToMojomType(
    IPC::MessageAttachment::Type type) {
  switch (type) {
    case IPC::MessageAttachment::Type::MOJO_HANDLE:
      return mojo::native::SerializedHandle::Type::MOJO_HANDLE;
    case IPC::MessageAttachment::Type::PLATFORM_FILE:
      return mojo::native::SerializedHandle::Type::PLATFORM_FILE;
    case IPC::MessageAttachment::Type::WIN_HANDLE:
      return mojo::native::SerializedHandle::Type::WIN_HANDLE;
    case IPC::MessageAttachment::Type::MACH_PORT:
      return mojo::native::SerializedHandle::Type::MACH_PORT;
    case IPC::MessageAttachment::Type::FUCHSIA_HANDLE:
      return mojo::native::SerializedHandle::Type::FUCHSIA_HANDLE;
  }
}

IPC::MessageAttachment::Type MojomTypeToAttachmentType(
    mojo::native::SerializedHandle::Type type) {
  switch (type) {
    case mojo::native::SerializedHandle::Type::MOJO_HANDLE:
      return IPC::MessageAttachment::Type::MOJO_HANDLE;
    case mojo::native::SerializedHandle::Type::PLATFORM_FILE:
      return IPC::MessageAttachment::Type::PLATFORM_FILE;
    case mojo::native::SerializedHandle::Type::WIN_HANDLE:
      return IPC::MessageAttachment::Type::WIN_HANDLE;
    case mojo::native::SerializedHandle::Type::MACH_PORT:
      return IPC::MessageAttachment::Type::MACH_PORT;
    case mojo::native::SerializedHandle::Type::FUCHSIA_HANDLE:
...
void UnmappedNativeStructSerializerImpl::Serialize(
  ...
  native::internal::NativeStruct_Data* struct_data = writer->data();
  ...
  struct_data->data.Set(data_writer.data());
  ...
  mojo::internal::Serialize<
      ...
      context);
  struct_data->handles.Set(handles_writer.is_null() ? nullptr
                                                    : handles_writer.data());
}
...
bool UnmappedNativeStructSerializerImpl::Deserialize(
  ...
  return StructTraits<
      ::mojo::native::NativeStructDataView,
      native::NativeStructPtr>::Read(native::NativeStructDataView(input,
                                                                  context),
                                     output);
}
...
void UnmappedNativeStructSerializerImpl::SerializeMessageContents(
  ...
  if (message->attachment_set()->empty()) {
    struct_data->handles.Set(nullptr);
    return;
  }
  ...
  for (size_t i = 0; i < attachments->size(); ++i) {
    ...
    handle_writer->type =
        static_cast<int32_t>(AttachmentTypeToMojomType(attachment->GetType()));
    handles_writer.data()->at(i).Set(handle_writer.data());
  }
  struct_data->handles.Set(handles_writer.data());
}
