...
void ReportNonNullableValidationError(ValidationContext* validation_context, ValidationError error, 
  ...
  std::string error_message = base::StringPrintf("%s %s field in %s", null_or_invalid, field_name, object_name);
...
bool ValidateHandleOrInterfaceNonNullable(
  ...
  ReportNonNullableValidationError(validation_context, VALIDATION_ERROR_UNEXPECTED_INVALID_INTERFACE_ID, field_name, object_name);
  return false;
}
...
bool ValidateHandleOrInterfaceNonNullable(
  ...
  ReportNonNullableValidationError(validation_context, VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, field_name, object_name);
  return false;
}
