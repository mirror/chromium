...
class MOJO_CPP_BINDINGS_EXPORT SerializationContext {
 public:
  ...
  // later.
  bool PushNextNullState(bool is_null);
  ...
  // Finalizes a serialized message which was prepared by this context. Must be
  // called after the bindings message payload is filled in.
