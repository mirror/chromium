...
class MOJO_CPP_BINDINGS_EXPORT Message {
 public:
  ...
  // attached later by calling |AttachSerializedHandles()|. See the note on that
  // method regarding performance considerations.
  ...
  // buffer.
  void AttachSerializedHandles(std::vector<ScopedHandle> handles);
