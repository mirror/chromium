...
class MOJO_CPP_BINDINGS_EXPORT Message {
 public:
  ...
  uint32_t* mutable_payload_interface_ids();
 ...
 private:
  ...
  // elsewhere. In general this is true unless serialized handles are extracted
  // from the message object identified by |handle_| above.
