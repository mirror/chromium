...
class Binding {
 public:
  ...
  // returned callback may be called exactly once any time thereafter as long as
  // the binding itself hasn't been destroyed yet to report the message as bad.
  // This may only be called once per message.
