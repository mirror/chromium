...
TEST(UnionTest, SerializeIsNullInlined) {
  ...
  internal::PodUnion_Data::BufferWriter writer(&buffer);
  mojo::internal::SerializationContext context;
...
TEST(UnionTest, OutOfAlignmentValidation) {
  ...
  mojo::internal::FixedBufferForTesting buffer(size + 1);
  internal::PodUnion_Data* data =
      reinterpret_cast<internal::PodUnion_Data*>(buffer.data());
  mojo::internal::ValidationContext validation_context(
      data, static_cast<uint32_t>(size), 0, 0);
  EXPECT_FALSE(
      internal::PodUnion_Data::Validate(data, &validation_context, false));
...
TEST(UnionTest, OOBValidation) {
  ...
  internal::PodUnion_Data::BufferWriter writer(message.payload_buffer());
  mojo::internal::ValidationContext validation_context(
...
TEST(UnionTest, NullStringValidation) {
  ...
  internal::ObjectUnion_Data::BufferWriter writer(&buffer);
...
TEST(UnionTest, Validation_NullUnion_Failure) {
  ...
  mojo::internal::FixedBufferForTesting buffer(size);
  mojo::Message message;
  internal::SmallStructNonNullableUnion_Data::BufferWriter writer(&buffer);
  mojo::internal::ValidationContext validation_context(
      writer.data(), static_cast<uint32_t>(size), 0, 0);
