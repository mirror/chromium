...
#ifndef MOJO_PUBLIC_CPP_BASE_BIG_STRING_STRUCT_TRAITS_H_
#define MOJO_PUBLIC_CPP_BASE_BIG_STRING_STRUCT_TRAITS_H_
...
#endif  // MOJO_PUBLIC_CPP_BASE_BIG_STRING_STRUCT_TRAITS_H_
