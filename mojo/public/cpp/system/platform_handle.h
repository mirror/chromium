...
// base::SharedMemory object, and |protection| indicates whether or not
// |memory_handle| supports being mapped to writable memory segments.
//
...
// WRAPPED HANDLE.
//
// The |protection| argument is only an indication of the memory protection
// status of |memory_handle| as known by the caller.
//
// DO NOT wrap a writable |memory_handle| with |protection| set to
...
// to a read-only memory segment. If |*protection| is
// |UnwrappedSharedMemoryHandleProtection::kReadOnly| upon return, attempts to
// map |*memory_handle| to a writable memory segment will fail.
