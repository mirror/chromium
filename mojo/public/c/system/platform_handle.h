...
//       valid on Windows.
//   |MOJO_PLATFORM_HANDLE_TYPE_MAGENTA_HANDLE| - A Magenta mx_handle_t value.
...
const MojoPlatformHandleType MOJO_PLATFORM_HANDLE_TYPE_MAGENTA_HANDLE = 4;
#else
...
#define MOJO_PLATFORM_HANDLE_TYPE_MAGENTA_HANDLE ((MojoPlatformHandleType)4)
#endif
