...
#include "mojo/common/memory_allocator_dump_guid.mojom-shared.h"
...
template <>
struct StructTraits<common::mojom::MemoryAllocatorDumpGuidDataView,
                    base::trace_event::MemoryAllocatorDumpGuid> {
  static uint64_t value(const base::trace_event::MemoryAllocatorDumpGuid& id) {
    return id.ToUint64();
  }

  static bool Read(common::mojom::MemoryAllocatorDumpGuidDataView data,
