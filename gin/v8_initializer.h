...
class GIN_EXPORT V8Initializer {
 public:
  ...
  // Gets address and size information for loaded snapshot, and
  // returns which type of snapshot is loaded.
  // If no snapshot is loaded, sets nullptr and 0 in |snapshot|.
