...
IsolateHolder::IsolateHolder(
  ...
  SnapshotType offering_snapshot_type = g_reference_table
                                            ? SnapshotType::kV8ContextSnapshot
                                            : SnapshotType::kV8Snapshot;
  snapshot_type_ = V8Initializer::GetV8ContextSnapshotData(
      offering_snapshot_type, snapshot_blob_.get());
