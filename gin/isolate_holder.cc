...
IsolateHolder::IsolateHolder(
    ...
    : IsolateHolder(std::move(task_runner),
                    access_mode,
                    kAllowAtomicsWait,
                    IsolateCreator::kIsolateHolder) {}

IsolateHolder::IsolateHolder(
    scoped_refptr<base::SingleThreadTaskRunner> task_runner,
    AccessMode access_mode,
    AllowAtomicsWaitMode atomics_wait_mode,
    IsolateCreator isolate_creator)
  ...
  if (isolate_creator == IsolateCreator::kSnapshotCreator) {
    ...
    snapshot_creator_.reset(new v8::SnapshotCreator(
        g_reference_table, startup_data_.data ? &startup_data_ : nullptr));
