...
#ifndef ZUCCHINI_REFERENCE_BYTES_MIXER_H_
#define ZUCCHINI_REFERENCE_BYTES_MIXER_H_
...
class ReferenceBytesMixer {
 public:
  ...
  // new instruction, and writes the result to preallocaed buffer |*out|, which
...
class ReferenceBytesMixerElfARM : public ReferenceBytesMixer {
 public:
  ...
  ReferenceBytesMixerElfARM(ExecutableType exe_type,
                            const AddressTranslator& old_trans,
                            const AddressTranslator& new_trans);
  ...
  void Mix(uint8_t type,
           ...
           Region::const_iterator new_base,
           offset_t new_offset,
           Region::iterator out) const override;
 ...
 private:
  ...
  mutable OffsetToRVATranslator old_offset_to_rva_;
  mutable OffsetToRVATranslator new_offset_to_rva_;
...
#endif  // ZUCCHINI_REFERENCE_BYTES_MIXER_H_
