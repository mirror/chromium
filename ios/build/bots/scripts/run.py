...
def parse_args():
  ...
  parser.add_argument(
    ...
    '--test-shard',
    action='append',
    help=('Tests that should be included in the test run. '
  ...
  args.test_shard = args.test_shard or []
  args.test_shard.extend(args_json.get('test shard', []))
