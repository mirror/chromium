...
#import "ios/clean/chrome/browser/ui/history_popup/history_popup_coordinator_private.h"
...
TEST_F(HistoryPopupCoordinatorTest, TestStopCoordinator) {
  EXPECT_TRUE(coordinator_.tabHistoryPopupController);
  [coordinator_ stop];
  EXPECT_FALSE(coordinator_.tabHistoryPopupController);
}
