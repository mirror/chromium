...
#import "ios/clean/chrome/browser/ui/dialogs/context_menu/context_menu_overlay_coordinator.h"
#import "ios/clean/chrome/browser/ui/dialogs/context_menu/context_menu_request.h"
...
- (void)childCoordinatorDidStart:(BrowserCoordinator*)childCoordinator {
  ...
  if ([childCoordinator isKindOfClass:[ContextMenuOverlayCoordinator class]]) {
...
- (void)webState:(web::WebState*)webState
  ...
  DCHECK_EQ(self.webState, webState);
  ContextMenuRequest* request = [ContextMenuRequest requestWithParams:params];
  ContextMenuOverlayCoordinator* contextMenu =
      [[ContextMenuOverlayCoordinator alloc] initWithRequest:request];
