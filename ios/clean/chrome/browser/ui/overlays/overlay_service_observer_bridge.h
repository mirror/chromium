...
#ifndef IOS_CLEAN_CHROME_BROWSER_UI_OVERLAYS_OVERLAY_SERVICE_OBSERVER_BRIDGE_H_
#define IOS_CLEAN_CHROME_BROWSER_UI_OVERLAYS_OVERLAY_SERVICE_OBSERVER_BRIDGE_H_

#include "ios/clean/chrome/browser/ui/overlays/overlay_service_observer.h"
...
// owned).
class OverlayServiceObserverBridge : public OverlayServiceObserver {
 public:
...
#endif  // IOS_CLEAN_CHROME_BROWSER_UI_OVERLAYS_OVERLAY_SERVICE_OBSERVER_BRIDGE_H_
