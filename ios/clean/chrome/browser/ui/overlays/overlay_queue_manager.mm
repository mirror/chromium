...
OverlayQueueManager::OverlayQueueManager(Browser* browser)
    : web_state_list_(&browser->web_state_list()), is_browser_closing_(false) {
...
void OverlayQueueManager::BrowserWillClose() {
  DCHECK(!is_browser_closing_);
  is_browser_closing_ = true;
