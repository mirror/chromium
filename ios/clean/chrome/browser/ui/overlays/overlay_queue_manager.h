...
class OverlayQueueManager : public BrowserUserData<OverlayQueueManager>,
 ...
 public:
  ...
  // Called to perform cleanup tasks when the Browser is about to be destroyed.
  // This will remove the manager as an observer and clear queues() and
  // web_state_list().
 ...
 private:
  ...
  // Whether the associated Browser is in the process of being destroyed.
  bool is_browser_closing_;
