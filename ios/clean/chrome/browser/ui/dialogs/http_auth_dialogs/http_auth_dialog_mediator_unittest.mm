...
@interface TestHTTPAuthDialogDismissalDispatcher
    : NSObject<HTTPAuthDialogDismissalCommands>
@end

@implementation TestHTTPAuthDialogDismissalDispatcher
...
class HTTPAuthDialogMediatorTest : public PlatformTest {
 public:
  HTTPAuthDialogMediatorTest()
      : PlatformTest(),
        dispatcher_([[TestHTTPAuthDialogDismissalDispatcher alloc] init]) {
 ...
 private:
  __strong TestHTTPAuthDialogDismissalDispatcher* dispatcher_;
