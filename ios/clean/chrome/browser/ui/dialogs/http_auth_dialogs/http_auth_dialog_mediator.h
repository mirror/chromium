...
// Designated initializer for a mediator that uses |request| to provide datat to
// consumers, and |dispatcher| to communicate HTTP auth dismissal commands.
// Both are expected to be non-nil.
- (instancetype)initWithRequest:(HTTPAuthDialogRequest*)request
                     dispatcher:(id<HTTPAuthDialogDismissalCommands>)dispatcher
