...
#ifndef IOS_CLEAN_CHROME_BROWSER_UI_DIALOGS_CONTEXT_MENU_CONTEXT_MENU_MEDIATOR_H_
#define IOS_CLEAN_CHROME_BROWSER_UI_DIALOGS_CONTEXT_MENU_CONTEXT_MENU_MEDIATOR_H_
...
@interface ContextMenuMediator : DialogMediator

// Designated initializer for a mediator that uses |request| to configure
// consumers and |dispatcher| for dismissal.
- (nullable instancetype)initWithRequest:(nonnull ContextMenuRequest*)request
...
#endif  // IOS_CLEAN_CHROME_BROWSER_UI_DIALOGS_CONTEXT_MENU_CONTEXT_MENU_MEDIATOR_H_
