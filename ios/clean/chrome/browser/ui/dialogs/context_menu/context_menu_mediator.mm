...
#import "ios/clean/chrome/browser/ui/dialogs/context_menu/context_menu_mediator.h"
...
@interface ContextMenuMediator ()<DialogDismissalCommands>

// The request passed on initializaton.
@property(nonatomic, readonly, strong) ContextMenuRequest* request;
...
@implementation ContextMenuMediator (DialogMediatorSubclassing)
