...
class FullscreenControllerObserver {
 public:
  ...
  // Invoked when |controller| is disabled.
  virtual void FullscreenDisabled(FullscreenController* controller) {}

  // Invoked when |controller| is enabled.
  virtual void FullscreenEnabled(FullscreenController* controller) {}
