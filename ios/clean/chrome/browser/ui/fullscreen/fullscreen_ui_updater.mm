...
void FullscreenUIUpdater::FullscreenDisabled(FullscreenController* controller) {
  [ui_element_ updateForFullscreenEnabled:false];
}

void FullscreenUIUpdater::FullscreenEnabled(FullscreenController* controller) {
  [ui_element_ updateForFullscreenEnabled:true];
}
