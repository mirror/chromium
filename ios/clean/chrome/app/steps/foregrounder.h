...
#ifndef IOS_INTERNAL_CHROME_APP_STEPS_FOREGROUNDER_H_
#define IOS_INTERNAL_CHROME_APP_STEPS_FOREGROUNDER_H_
...
#endif  // IOS_INTERNAL_CHROME_APP_STEPS_FOREGROUNDER_H_
