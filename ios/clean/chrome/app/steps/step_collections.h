...
#ifndef IOS_INTERNAL_CHROME_APP_STEPS_STEP_COLLECTIONS_H_
#define IOS_INTERNAL_CHROME_APP_STEPS_STEP_COLLECTIONS_H_
...
#endif  // IOS_INTERNAL_CHROME_APP_STEPS_STEP_COLLECTIONS_H_
