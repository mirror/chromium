...
#ifndef IOS_INTERNAL_CHROME_APP_STEPS_SIMPLE_APPLICATION_STEP_H_
#define IOS_INTERNAL_CHROME_APP_STEPS_SIMPLE_APPLICATION_STEP_H_
...
#endif  // IOS_INTERNAL_CHROME_APP_STEPS_SIMPLE_APPLICATION_STEP_H_
