...
#ifndef IOS_INTERNAL_CHROME_APP_STEPS_CHROME_MAIN_H_
#define IOS_INTERNAL_CHROME_APP_STEPS_CHROME_MAIN_H_
...
#endif  // IOS_INTERNAL_CHROME_APP_STEPS_CHROME_MAIN_H_
