...
- (ui::PageTransition)getPageTransitionFromNavigationType:
...
registerLoadRequestForURL:(const GURL&)URL
  ...
  ui::PageTransition transition =
      [self getPageTransitionFromNavigationType:navigationType];
...
- (void)webView:(WKWebView*)webView
  ...
  if (allowLoad) {
    ui::PageTransition transition =
        [self getPageTransitionFromNavigationType:action.navigationType];
    allowLoad =
