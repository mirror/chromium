...
TEST_F(ContextMenuJsTest, LinkOfTextWithoutCalloutProperty) {
  static const char link_html[] =
      "<a href='%s'>link"
      "</a>";

  LoadHtml(base::StringPrintf(link_html, "http://destination"));
...
TEST_F(ContextMenuJsTest, LinkOfTextWithCalloutDefault) {
  static const char link_html[] =
      "<a href='%s' style='-webkit-touch-callout:default;'>link"
      "</a>";
...
TEST_F(ContextMenuJsTest, LinkOfTextWithCalloutNone) {
  static const char link_html[] =
      "<a href='%s' style='-webkit-touch-callout:none;'>link"
      "</a>";
