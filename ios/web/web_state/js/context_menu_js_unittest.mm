...
TEST_F(ContextMenuJsTest, DISABLED_LinkOfImage) {
...
// TODO(crbug.com/758735): enable this test.
TEST_F(ContextMenuJsTest, DISABLED_LinkOfImageWithCalloutNone) {
...
// TODO(crbug.com/758735): enable this test.
TEST_F(ContextMenuJsTest, DISABLED_LinkOfTextWithoutCalloutProperty) {
...
// https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-touch-callout
// TODO(crbug.com/758735): enable this test
TEST_F(ContextMenuJsTest, DISABLED_LinkOfTextWithCalloutDefault) {
...
// https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-touch-callout
// TODO(crbug.com/758735): enable this test.
TEST_F(ContextMenuJsTest, DISABLED_LinkOfTextWithCalloutNone) {
  const char kLink_html[] =
...
// https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-touch-callout
// TODO(crbug.com/758735): enable this test.
TEST_F(ContextMenuJsTest, DISABLED_LinkOfTextWithCalloutFromAncester) {
  const char kLink_html[] =
...
// https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-touch-callout
// TODO(crbug.com/758735): enable this test.
TEST_F(ContextMenuJsTest, DISABLED_LinkOfTextWithCalloutOverride) {
  const char kLink_html[] =
      "<body style='-webkit-touch-callout: none'>"
      " <a href='%s' style='-webkit-touch-callout: default'>link</a>"
      "</body>";
