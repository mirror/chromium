...
(function() {
   ...
   *
   * @param {string} value The value the input element will be set. For text
   *     input, it is the value to set. For select, it is the value of the
   *     option to set. For checkable element, it is the checked value
   *     (true/false).
