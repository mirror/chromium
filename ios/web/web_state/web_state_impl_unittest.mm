...
TEST_F(WebStateImplTest, ObserverTest) {
  ...
  EXPECT_EQ(params.form_name, observer->form_activity_info()->form_name);
  EXPECT_EQ(params.field_name, observer->form_activity_info()->field_name);
  EXPECT_EQ(params.field_type, observer->form_activity_info()->field_type);
  EXPECT_EQ(params.type, observer->form_activity_info()->type);
  EXPECT_EQ(params.value, observer->form_activity_info()->value);
