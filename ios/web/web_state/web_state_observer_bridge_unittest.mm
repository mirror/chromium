...
TEST_F(WebStateObserverBridgeTest, FormActivityRegistered) {
  ...
  EXPECT_EQ(params.form_name, [observer_ formActivityInfo]->form_name);
  EXPECT_EQ(params.field_name, [observer_ formActivityInfo]->field_name);
  EXPECT_EQ(params.field_type, [observer_ formActivityInfo]->field_type);
  EXPECT_EQ(params.type, [observer_ formActivityInfo]->type);
  EXPECT_EQ(params.value, [observer_ formActivityInfo]->value);
