...
class CRWSessionControllerTest : public PlatformTest {
 protected:
  void SetUp() override {
    ...
    SetNavigationManager(session_controller_);
  }
  ...
  void SetNavigationManager(CRWSessionController* session_controller) {
...
TEST_F(CRWSessionControllerTest, CopyState) {
  ...
  CRWSessionController* other_session_controller =
      [[CRWSessionController alloc] initWithBrowserState:&browser_state_];
  SetNavigationManager(other_session_controller);
...
TEST_F(CRWSessionControllerTest, CreateWithEmptyNavigations) {
  ...
  SetNavigationManager(controller);
