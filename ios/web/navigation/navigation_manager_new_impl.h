...
class NavigationManagerNewImpl : public NavigationManager {
 public:
  ...
  // Replay history into the web view.
  void RestoreSession();

  // DO NOT SUBMIT
  // NSDictionary* restoredSessionHistory;
  std::string restoredSessionHistory;
  bool history_is_restored = false;
 ...
 private:
  ...
  // NSString* serializeSessionHistoryAsJson() const;
