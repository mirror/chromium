...
class NavigationManagerImpl : public NavigationManager {
 public:
  ...
  // TODO(crbug.com/661316): Make this prive once all navigation code is moved
 ...
 protected:
  ...
  // Creates a NavigationItem using the given properties, where |prev_url| is
  // the URL of the navigation just prior to the current one. If |url_rewriters|
  // is not nullptr, apply them before applying the permanent URL rewriters from
  // BrowserState.
