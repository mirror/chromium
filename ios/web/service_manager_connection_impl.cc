...
#include "services/service_manager/embedder/runner/embedded_service_runner.h"
...
class ServiceManagerConnectionImpl::IOThreadContext
 ...
 public:
  ...
  void AddEmbeddedService(const std::string& name, const service_manager::ServiceInfo& info) {
    io_task_runner_->PostTask(
 ...
 private:
  ...
  ~IOThreadContext() override { DCHECK(0); }
  ...
  void AddEmbeddedServiceRequestHandlerOnIoThread(const std::string& name,
    ...
    // TODO(blundell): Oops, looks like I need the below.
    AddServiceRequestHandlerOnIoThread(
        name, base::Bind(&service_manager::EmbeddedServiceRunner::BindServiceRequest,
  ...
  void OnBindInterface(const service_manager::BindSourceInfo& source_info,
    ...
    // TODO(blundell): Do I need this?
      ...
      // TODO(blundell): What should I do here?
#if 0
  ...
  std::unordered_map<std::string, std::unique_ptr<service_manager::EmbeddedServiceRunner>>
      embedded_services_;
