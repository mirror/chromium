...
// Allows observing of creating, updating and destruction of DownloadTask
...
class DownloadControllerObserver {
 public:
  ...
  // if the donwload has failed, DownloadTask::GetPercentComplete() to update
  ...
  // references to DownloadTask objects are still alive, but DownloadTask will
  // stop download operations and will not call DownloadControllerObserver
  // callbacks.
