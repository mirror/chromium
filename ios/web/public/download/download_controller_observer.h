...
class DownloadControllerObserver {
 public:
  ...
  // downloaded data.
  virtual void OnDownloadUpdated(DownloadController* download_controller,
                                 const WebState* web_state,
                                 DownloadTask* task) {}

  // Called when download task is about to be destroyed. Cliends should remove
  // all references to the given DownloadTask and stop using the task.
  virtual void OnDownloadDestroyed(DownloadController* download_controller,
                                   const WebState* web_state,
                                   DownloadTask* task) {}
