...
//     DownloadController::FromBrowserState(state_)->SetDelegate(this);
//   }
//  private:
//    BrowserState* state_;
...
class DownloadController {
 public:
  ...
  // download after the app relaunch. Clients must not to call this method to
  // initiate a renderer-initiated download (those downloads are created
  // automatically).
  // In order to resume the download after the app relaunch clients have to pass
