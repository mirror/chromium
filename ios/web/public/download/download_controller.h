...
//     DownloadController::FromBrowserState(state)->AddDelegate(this);
//   }
//   void OnDownloadCreated(
//       const WebState*, std::unique_ptr<DownloadTask> task) override {
...
//     DownloadController::FromBrowserState(_state)->RemoveDelegate(this);
//   }
// };
//
...
//   DownloadTask* task = controller->CreateDownloadTask(
...
class DownloadController {
 public:
  ...
  // Callers do no own the returned pointer and must not hold on it.
  ...
  // Sets DownloadControllerDelegate. Clients must remove the delegate in
