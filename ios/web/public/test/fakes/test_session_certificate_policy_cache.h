...
#ifndef IOS_WEB_PUBLIC_TEST_FAKES_TEST_SESSION_CERTIFICATE_POLICY_CACHE_H_
#define IOS_WEB_PUBLIC_TEST_FAKES_TEST_SESSION_CERTIFICATE_POLICY_CACHE_H_
...
class TestSessionCertificatePolicyCache : public SessionCertificatePolicyCache {
 public:
  TestSessionCertificatePolicyCache();
  ~TestSessionCertificatePolicyCache() override;
...
TestSessionCertificatePolicyCache::TestSessionCertificatePolicyCache() {}

TestSessionCertificatePolicyCache::~TestSessionCertificatePolicyCache() {}

}  // namespace web

#endif  // IOS_WEB_PUBLIC_TEST_FAKES_TEST_SESSION_CERTIFICATE_POLICY_CACHE_H_
