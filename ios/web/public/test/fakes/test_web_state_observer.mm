...
void TestWebStateObserver::FormActivityRegistered(
  ...
  form_activity_info_->form_name = params.form_name;
  form_activity_info_->field_name = params.field_name;
  form_activity_info_->field_type = params.field_type;
  form_activity_info_->type = params.type;
  form_activity_info_->value = params.value;
  form_activity_info_->input_missing = params.input_missing;
}
