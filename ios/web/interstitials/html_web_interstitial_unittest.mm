...
class MockInterstitialDelegate : public web::HtmlWebInterstitialDelegate {
 public:
  ...
  // web::HtmlWebMockInterstitialDelegate overrides
...
class HtmlWebInterstitialImplTest : public web::WebTest {
 protected:
  void SetUp() override {
    WebTest::SetUp();
...
TEST_F(HtmlWebInterstitialImplTest, Proceed) {
  ...
  web::HtmlWebInterstitialImpl* interstitial = new web::HtmlWebInterstitialImpl(
