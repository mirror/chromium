...
namespace {
// The origin of the target element view, defined as a ratio of the container
// view's width.
CGFloat kElementOriginRatio = 2.0f / 3.0f;
}
...
- (void)start {
  ...
  UIView* elementView =
      [[UIView alloc] initWithFrame:CGRectMake(containerView.frame.size.width *
                                                   kElementOriginRatio,
                                               20.0f, 20.0f, 20.0f)];
