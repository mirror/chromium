...
#import "ios/chrome/browser/ui/payments/cells/payments_is_selector_type.h"
...
// PaymentRequestSelectorViewControllerDataSource.
@property(nonatomic, strong)
    NSArray<CollectionViewItem<PaymentsIsSelectorType>*>* items;
...
- (NSArray<CollectionViewItem<PaymentsIsSelectorType>*>*)selectableItems {
  return self.items;
}
...
- (NSArray<CollectionViewItem<PaymentsIsSelectorType>*>*)createItems {
  return @[
...
- (CollectionViewItem<PaymentsIsSelectorType>*)createItemWithText:
    (NSString*)text {
