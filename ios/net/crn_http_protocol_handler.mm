...
MetricsDelegate::Metrics::Metrics() {}
MetricsDelegate::Metrics::~Metrics() {}
}
...
//  DVLOG(5) << "canInitWithRequest " <<
//  net::FormatUrlRequestForLogging(request); return
//  g_protocol_handler_delegate->CanHandleRequest(request);
//}
...
+ (BOOL)canInitWithTask:(NSURLSessionTask*)task {
  ...
  BOOL canInit =
      g_protocol_handler_delegate->CanHandleRequest(task.currentRequest);
  if (canInit && g_metrics_delegate) {
