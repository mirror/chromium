...
class ChunkedDataStreamUploader : public net::UploadDataStream {
 public:
  ...
  int UploadWhenReady(bool is_final_chunk);

  // The uploader interface for iOS layer to use. It is a weak pointer because
  // the owner of the uploader is the URLRequest.
