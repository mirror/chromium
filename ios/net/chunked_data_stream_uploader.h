 ...
 public:
  class Delegate {
   public:
    ...
    // Called when read data from NSInputstream meet error. Since currently
    // UploadDataStream::Read does not support to return failure, notify the
    // delegate to fail the request.
