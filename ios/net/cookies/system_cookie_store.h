...
class SystemCookieStore {
 ...
 protected:
  ...
  // Internal cookie stores doesn't store creation time. So we use this object
  // to keep track of the creation time of cookies, this is mainly used to
  // convert between SystemCookie and Chromium CookieMonster.
