...
"""Script to generate code coverage report for iOS.
  ...
  identified by postfixes: ['unittest.cc', 'unittest.mm', 'egtest.mm']. As far
  as I know, there is no perfect way to identify test files, but these hardcoded
  values should work for most of the cases.
