...
#pragma mark - MockMetricsRecorder

// A mock MetricsRecorder that provides information about calls to
// |recordMetricForInvocation:|.
@interface MockMetricsRecorder : NSObject<MetricsRecorder>
...
@implementation MockMetricsRecorder
...
TEST(CommandDispatcherTest, MetricsRecorderNoArguments) {
  ...
  CommandDispatcherTestSimpleTarget* target =
      [[CommandDispatcherTestSimpleTarget alloc] init];
  MockMetricsRecorder* recorder = [[MockMetricsRecorder alloc] init];
...
TEST(CommandDispatcherTest, MetricsRecorderWithArguments) {
  ...
  int int_invocation_argument = 0;
  [recorder.mostRecentInvocation getArgument:&int_invocation_argument
                                     atIndex:2];
  EXPECT_EQ(int_argument, int_invocation_argument);
  ...
  __unsafe_unretained NSObject* object_invocation_argument = nil;
  [recorder.mostRecentInvocation getArgument:&object_invocation_argument
                                     atIndex:2];
  EXPECT_NSEQ(object_argument, object_invocation_argument);
}
...
TEST(CommandDispatcherTest, MetricsRecorderMultipleRecorders) {
  ...
  CommandDispatcherTestSimpleTarget* showTarget =
      [[CommandDispatcherTestSimpleTarget alloc] init];
  MockMetricsRecorder* showRecorder = [[MockMetricsRecorder alloc] init];
  CommandDispatcherTestSimpleTarget* hideTarget =
      [[CommandDispatcherTestSimpleTarget alloc] init];
  MockMetricsRecorder* hideRecorder = [[MockMetricsRecorder alloc] init];
