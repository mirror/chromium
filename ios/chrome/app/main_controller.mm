...
- (SigninInteractionCoordinator*)signinInteractionCoordinator {
  if (_signinInteractionCoordinator)
    return _signinInteractionCoordinator;
  DCHECK(_mainBrowserState);
  DCHECK(self.mainBVC.dispatcher);
  _signinInteractionCoordinator = [[SigninInteractionCoordinator alloc]
...
- (void)dismissSigninInteractionCoordinator {
  ...
  // it owns objects which dismiss the sign in UI after this point.
  [_signinInteractionCoordinator cancelAndDismiss];
}
...
- (void)dismissModalDialogsWithCompletion:(ProceduralBlock)completion
  ...
  [_signinInteractionCoordinator cancel];
