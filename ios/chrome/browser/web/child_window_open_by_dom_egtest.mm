...
- (void)test2ChildWindowsWithName {
  ...
  GREYAssert(TapWebViewElementWithId(kNamedWindowLink), @"Failed to tap %s", kNamedWindowLink);
  ...
  GREYAssert(TapWebViewElementWithId("compareNamedWindows"), @"Failed to tap \"compareNamedWindows\"");
...
- (void)test2ChildWindowsWithoutName {
  ...
  GREYAssert(TapWebViewElementWithId(kUnnamedWindowLink), @"Failed to tap %s", kUnnamedWindowLink);
  [ChromeEarlGrey waitForMainTabCount:2];
  chrome_test_util::SelectTabAtIndexInCurrentMode(0);
  ...
  GREYAssert(TapWebViewElementWithId("compareUnnamedWindows"), @"Failed to tap \"compareUnnamedWindows\"");
...
- (void)testChildWindowsWithAndWithoutName {
  ...
  // Check that they aren't the same window object.
  GREYAssert(TapWebViewElementWithId("compareNamedAndUnnamedWindows"), @"Failed to tap \"compareNamedAndUnnamedWindows\"");
...
- (void)testWindowClosedWithName {
  GREYAssert(TapWebViewElementWithId("openWindowWithName"), @"Failed to tap \"openWindowWithName\"");
  [ChromeEarlGrey waitForMainTabCount:2];
  chrome_test_util::SelectTabAtIndexInCurrentMode(0);
  ...
  GREYAssert(TapWebViewElementWithId(kCheckWindow1Link), @"Failed to tap %s", kCheckWindow1Link);
  [ChromeEarlGrey waitForWebViewContainingText:kWindow1Open];
  const char kCheckWindow2Link[] = "checkNamedWindow2Closed";
  GREYAssert(TapWebViewElementWithId(kCheckWindow2Link), @"Failed to tap %s", kCheckWindow2Link);
  ...
  [ChromeEarlGrey waitForMainTabCount:2];
  chrome_test_util::SelectTabAtIndexInCurrentMode(0);
  GREYAssert(TapWebViewElementWithId(kCheckWindow2Link), @"Failed to tap |kCheckWindow2Link|");
...
- (void)testWindowClosedWithoutName {
  GREYAssert(TapWebViewElementWithId("openWindowNoName"), @"Failed to tap \"openWindowNoName\"");
  [ChromeEarlGrey waitForMainTabCount:2];
  chrome_test_util::SelectTabAtIndexInCurrentMode(0);
