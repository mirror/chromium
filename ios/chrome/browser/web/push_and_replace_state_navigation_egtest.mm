...
- (void)testHtml5HistoryPushStateThenGoBackAndForward {
  ...
  [self assertStatusText:nil
         withOmniboxText:getContentAndFragment(historyTestURL)
              pageLoaded:NO];
...
- (void)testHtml5HistoryReplaceStateThenGoBackAndForward {
  ...
  [self assertStatusText:@"replaceStateHashWithObject"
         withOmniboxText:getContentAndFragment(replaceStateHashWithObjectURL)
              pageLoaded:NO];
  ...
  [self assertStatusText:@"pushStateHashString"
         withOmniboxText:getContentAndFragment(pushStateHashStringURL)
              pageLoaded:NO];
  ...
  [self assertStatusText:@"replaceStateHashString"
         withOmniboxText:getContentAndFragment(replaceStateHashStringURL)
              pageLoaded:NO];
  ...
  [self assertStatusText:@"pushStatePath"
         withOmniboxText:getContentAndFragment(pushStatePathURL)
              pageLoaded:NO];
  ...
  [self assertStatusText:@"replaceStateRootPathSpace"
         withOmniboxText:getContentAndFragment(replaceStateRootPathSpaceURL)
              pageLoaded:NO];
