...
TEST_F(ExternalAppLauncherTest, TestRepeatedAppLaunches) {
  ...
  GURL sourceURL1("http://www.google.com");
  GURL sourceURL2("https://www.goog.com");
  ...
  [[[launcherMock expect] ignoringNonObjectArgs] openURL:GURL()
                                             linkClicked:YES];
  [launcher requestToOpenURL:GURL("facetime://+1354")
               sourcePageURL:sourceURL1
                 linkClicked:YES];
  ...
  [[[launcherMock expect] ignoringNonObjectArgs] openURL:GURL()
                                             linkClicked:YES];
  [launcher requestToOpenURL:GURL("facetime://+12354")
               sourcePageURL:sourceURL1
                 linkClicked:YES];
  EXPECT_EQ(NO, promptShown);
  EXPECT_OCMOCK_VERIFY(launcherMock);

  [launcherMock requestToOpenURL:GURL("facetime://+1236")
                   sourcePageURL:sourceURL1
                     linkClicked:YES];
  ...
  [[[launcherMock expect] ignoringNonObjectArgs] openURL:GURL()
                                             linkClicked:YES];
  [launcher requestToOpenURL:GURL("facetime://+1234")
               sourcePageURL:sourceURL2
                 linkClicked:YES];
  EXPECT_EQ(NO, promptShown);
  EXPECT_OCMOCK_VERIFY(launcherMock);
  ...
  [[[launcherMock expect] ignoringNonObjectArgs] openURL:GURL()
                                             linkClicked:YES];
  [launcher requestToOpenURL:GURL("facetime-audio://+1234")
               sourcePageURL:sourceURL1
                 linkClicked:YES];
  EXPECT_EQ(NO, promptShown);
  EXPECT_OCMOCK_VERIFY(launcherMock);
