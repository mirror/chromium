...
TEST_F(LoadTimingTabHelperTest, MetricReportedForNonPrerenderTab) {
...
// Tests that timing of preload tabs are not collected.
TEST_F(LoadTimingTabHelperTest, MetricNotReportedForPrerenderTab) {
  tab_helper()->DidInitiatePageLoad();
