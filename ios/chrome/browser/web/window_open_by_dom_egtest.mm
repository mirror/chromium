...
- (void)testLinkWithBlankTargetWithImmediateClose {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenBlankTargetWithImmediateClose"), @"Failed to tap \"webScenarioWindowOpenBlankTargetWithImmediateClose\"");
  [ChromeEarlGrey waitForMainTabCount:1];
}
...
- (void)testLinkWithBlankTargetSessionStorage {
  ...
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenSameURLWithBlankTarget"), @"Failed to tap \"webScenarioWindowOpenSameURLWithBlankTarget\"");
...
- (void)testLinkWithBlankTarget {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenRegularLink"), @"Failed to tap \"webScenarioWindowOpenRegularLink\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}

// Tests a link with target="_blank" multiple times.
- (void)testLinkWithBlankTargetMultipleTimes {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenRegularLinkMultipleTimes"), @"Failed to tap \"webScenarioWindowOpenRegularLinkMultipleTimes\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testWindowOpenAndAssignToHref {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenTabWithAssignmentToHref"), @"Failed to tap \"webScenarioWindowOpenTabWithAssignmentToHref\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}
...
- (void)testWindowOpenAndCallLocationAssign {
  // Open a child tab.
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenAndCallLocationAssign"), @"Failed to tap \"webScenarioWindowOpenAndCallLocationAssign\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testWindowOpenAndSetLocation {
  // Open a child tab.
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenAndSetLocation"), @"Failed to tap \"webScenarioWindowOpenAndSetLocation\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testWindowOpenWithBlankTarget {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithBlankTarget"), @"Failed to tap \"webScenarioWindowOpenWithBlankTarget\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}
...
- (void)testLinkWithBlankTargetWithDelayedClose {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithDelayedClose"), @"Failed to tap \"webScenarioWindowOpenWithDelayedClose\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testWindowOpenWithButtonOnClick {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithButtonOnClick"), @"Failed to tap \"webScenarioWindowOpenWithButtonOnClick\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}

// Tests a button that invokes window.open with an empty target parameter.
- (void)testWindowOpenWithEmptyTarget {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithEmptyTarget"), @"Failed to tap \"webScenarioWindowOpenWithEmptyTarget\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}

// Tests a link with JavaScript in the href.
+ (void)testWindowOpenWithJavaScriptInHref {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithJavaScriptInHref"), @"Failed to tap \"webScenarioWindowOpenWithJavaScriptInHref\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}

// Tests a window.open by running Meta-Refresh.
- (void)testWindowOpenWithMetaRefresh {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithMetaRefresh"), @"Failed to tap \"webScenarioWindowOpenWithMetaRefresh\"");
  [ChromeEarlGrey waitForMainTabCount:2];
}
...
- (void)testWindowOpenWithPreventDefaultLink {
  // Open a child tab.
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithPreventDefaultLink"), @"Failed to tap \"webScenarioWindowOpenWithPreventDefaultLink\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testWindowOpenWithAboutNewTabScript {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowOpenWithAboutNewTabScript"), @"Failed to tap \"webScenarioWindowOpenWithAboutNewTabScript\"");
  [ChromeEarlGrey waitForMainTabCount:2];
...
- (void)testCloseWindowNotOpenByDOM {
  GREYAssert(TapWebViewElementWithId("webScenarioWindowClose"), @"Failed to tap \"webScenarioWindowClose\"");
  [ChromeEarlGrey waitForMainTabCount:1];
}
...
- (void)testBlockPopupInjectedIntoOpenedWindow {
  ...
  GREYAssert(TapWebViewElementWithId("webScenarioOpenWindowAndInjectPopup"), @"Failed to tap \"webScenarioOpenWindowAndInjectPopup\"");
