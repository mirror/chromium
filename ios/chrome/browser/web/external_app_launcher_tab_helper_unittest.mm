...
using ExternalAppLauncherTabHelperTest = PlatformTest;

// A URL with a malformed scheme should return the original URL string.
TEST_F(ExternalAppLauncherTabHelperTest, TestMalformedScheme) {
...
// scheme.
TEST_F(ExternalAppLauncherTabHelperTest, TestProperlyFormedExternalUrl) {
...
TEST_F(ExternalAppLauncherTabHelperTest, TestRemovingPercentEncoding) {
  EXPECT_NSEQ(@"+1 650 555 1212",
              GetFormattedAbsoluteUrlWithSchemeRemoved(
