...
#ifndef IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_OBSERVER_H_
#define IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_OBSERVER_H_
...
#endif  // IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_OBSERVER_H_
