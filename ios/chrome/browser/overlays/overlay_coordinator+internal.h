...
#ifndef IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_COORDINATOR_INTERNAL_H_
#define IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_COORDINATOR_INTERNAL_H_
...
#endif  // IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_COORDINATOR_INTERNAL_H_
