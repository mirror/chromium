...
#ifndef IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_IMPL_H_
#define IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_IMPL_H_
...
#endif  // IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SERVICE_IMPL_H_
