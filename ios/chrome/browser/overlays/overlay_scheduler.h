...
#ifndef IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SCHEDULER_H_
#define IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SCHEDULER_H_
...
#endif  // IOS_CHROME_BROWSER_OVERLAYS_OVERLAY_SCHEDULER_H_
