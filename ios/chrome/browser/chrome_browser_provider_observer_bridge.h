...
#ifndef IOS_CHROME_BROWSER_SIGNIN_CHROME_BROWSER_PROVIDER_OBSERVER_BRIDGE_H_
#define IOS_CHROME_BROWSER_SIGNIN_CHROME_BROWSER_PROVIDER_OBSERVER_BRIDGE_H_
...
class ChromeBrowserProviderObserverBridge
 ...
 private:
  ...
  void OnChromeIdentityServiceDidChange(
      ios::ChromeIdentityService* newIdentityService) override;
  void OnChromeBrowserProviderWillBeDestroyed() override;

  __unsafe_unretained id<ChromeBrowserProviderObserver> observer_;  // Weak.
...
#endif  // IOS_CHROME_BROWSER_SIGNIN_CHROME_BROWSER_PROVIDER_OBSERVER_BRIDGE_H_
