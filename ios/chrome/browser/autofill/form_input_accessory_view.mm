...
- (UIView*)viewForNavigationButtons {
  ...
  NSString* horizontalConstraint =
      @"H:|[separator1(==areaSeparatorWidth)][previousButton(==buttonWidth)]["
      @"separator2(==buttonSeparatorWidth)][nextButton(==buttonWidth)]";
  ...
  NSDictionary* metrics = @{
    ...
    @"buttonWidth" : @(kNavigationButtonWidth),
    @"topPadding" : @(1)
  };
