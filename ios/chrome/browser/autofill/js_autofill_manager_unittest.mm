...
TEST_F(JsAutofillManagerTest, TestExtractedFieldsNames) {
  ...
  NSArray* fields = [resultDict[@"forms"] firstObject][@"fields"];
...
TEST_F(JsAutofillManagerTest, TestExtractedFieldsIDs) {
  ...
  NSArray* owned_fields = [resultDict[@"forms"] objectAtIndex:0][@"fields"];
  ...
  NSArray* unowned_fields = [resultDict[@"forms"] objectAtIndex:1][@"fields"];
