...
// Returns the list of form field tests data that fail to be detected correctly
// on iOS.
// TODO(crbug.com/762970): Umbrella bug about making those tests pass.
...
TEST_P(FormStructureBrowserTest, DataDrivenHeuristics) {
  ...
  bool test_expected_to_fail =
      failing_tests.find(param.BaseName().value()) != failing_tests.end();
