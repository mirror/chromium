...
- (void)setUp {
  [super setUp];
  // Creates a language detection callback. The callback is cleared in tearDown.
  language::IOSLanguageDetectionClient::FromWebState(
      chrome_test_util::GetCurrentWebState())
      ->set_callback_for_testing(base::BindBlockArc(
