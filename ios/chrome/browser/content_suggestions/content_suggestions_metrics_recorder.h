...
- (void)onSuggestion:(nonnull ContentSuggestionsItem*)item
        openedAtIndexPath:(nonnull NSIndexPath*)indexPath
...
- (void)onMenuForSuggestion:(nonnull ContentSuggestionsItem*)item
          openedAtIndexPath:(nonnull NSIndexPath*)indexPath
      suggestionsShownAbove:(NSInteger)suggestionsAbove;
