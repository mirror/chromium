...
- (void)onSuggestion:(ContentSuggestionsItem*)item
        openedAtIndexPath:(NSIndexPath*)indexPath
...
- (void)onMenuForSuggestion:(ContentSuggestionsItem*)item
          openedAtIndexPath:(NSIndexPath*)indexPath
      suggestionsShownAbove:(NSInteger)suggestionsAbove {
  ContentSuggestionsSectionInformation* sectionInfo =
      item.suggestionIdentifier.sectionInfo;
...
- (void)onSuggestion:(CollectionViewItem*)item
         shownAtIndexPath:(NSIndexPath*)indexPath
    suggestionsShownAbove:(NSInteger)suggestionsAbove {
...
- (void)onSuggestion:(CollectionViewItem<SuggestedContent>*)item
     dismissedAtIndexPath:(NSIndexPath*)indexPath
    suggestionsShownAbove:(NSInteger)suggestionsAbove {
  ContentSuggestionsSectionInformation* sectionInfo =
      item.suggestionIdentifier.sectionInfo;
  ContentSuggestionsCategoryWrapper* categoryWrapper =
