...
DEFINE_WEB_STATE_USER_DATA_KEY(VoiceSearchNavigations);
...
VoiceSearchNavigations::VoiceSearchNavigations(web::WebState* web_state)
    : web::WebStateObserver(web_state) {
  DCHECK(web_state);
}

void VoiceSearchNavigations::WillLoadVoiceSearchResult() {
  will_navigate_to_voice_search_result_ = true;
}

bool VoiceSearchNavigations::IsNavigationFromVoiceSearch(
...
void VoiceSearchNavigations::NavigationItemCommitted(
