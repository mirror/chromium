...
- (void)retrieveSnapshotForSessionID:(NSString*)sessionID
                        withOverlays:(NSArray<SnapshotOverlay*>*)overlays
                            callback:(void (^)(UIImage*))callback {
  DCHECK(callback);
  void (^wrappedCallback)(UIImage*) = ^(UIImage* image) {
    if (!image) {
      image = [self updateSnapshotForSessionID:sessionID
...
- (void)retrieveGreySnapshotForSessionID:(NSString*)sessionID
                            withOverlays:(NSArray<SnapshotOverlay*>*)overlays
                                callback:(void (^)(UIImage*))callback {
  DCHECK(callback);
  void (^wrappedCallback)(UIImage*) = ^(UIImage* image) {
...
- (UIImage*)updateSnapshotForSessionID:(NSString*)sessionID
                          withOverlays:(NSArray<SnapshotOverlay*>*)overlays
                      visibleFrameOnly:(BOOL)visibleFrameOnly {
  UIImage* snapshot = [self generateSnapshotForWithOverlays:overlays
                                           visibleFrameOnly:visibleFrameOnly];
...
- (UIImage*)generateSnapshotForWithOverlays:(NSArray<SnapshotOverlay*>*)overlays
                           visibleFrameOnly:(BOOL)visibleFrameOnly {
