...
const char kReadingListBadgeAcessibilityIdentifier[] =
...
id<GREYMatcher> ReadingListTextBadge() {
  return grey_accessibilityID(
      base::SysUTF8ToNSString(kReadingListBadgeAcessibilityIdentifier));
}

// Simulate a Chrome Open event for the Feature Engagement Tracker.
...
// Test cases related to the triggering of In Product Help features.
