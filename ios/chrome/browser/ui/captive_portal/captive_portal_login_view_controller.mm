...
- (instancetype)
initWithLandingURL:(const GURL&)landingURL
          delegate:(id<CaptivePortalLoginViewControllerDelegate>)delegate {
...
- (void)donePressed {
  [self.delegate closeCaptivePortalLoginViewController:self];
}
