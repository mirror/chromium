...
// Presents and returns a bubble associated with an in-product help promotion if
...
// arrow on the button. |anchorPoint| is the point at which the bubble is
// anchored in window coordinates. |text| is the text displayed by the bubble.
