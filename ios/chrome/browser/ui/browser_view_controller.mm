...
- (ToolsMenuConfiguration*)configurationForToolsMenuCoordinator {
  // Build the configuration for the tools configuration.
...
- (void)buildToolbarAndTabStrip {
  ...
  _toolbarCoordinator.toolsMenuCoordinator.configurationProvider = self;

  _toolbarCoordinator.toolsMenuCoordinator.toolsMenuConfiguration =
      [self configurationForToolsMenuCoordinator];
...
- (void)updateToolbar {
  ...
  [self updateToolsMenuCoordinator];
...
- (void)updateToolsMenuCoordinator {
  BOOL shouldHighlight =
      [_model currentTab] ? _toolbarModelIOS->IsCurrentTabBookmarked() : NO;
  [_toolbarCoordinator.toolsMenuCoordinator
      setShouldHighlightBookmarkButton:shouldHighlight];

  BOOL shouldShowShareMenu = [_model currentTab] ? self.canShowShareMenu : NO;
  [_toolbarCoordinator.toolsMenuCoordinator
      setShouldShowShareMenu:shouldShowShareMenu];

  BOOL shouldShowFindBar = [_model currentTab] ? self.canShowFindBar : NO;
  [_toolbarCoordinator.toolsMenuCoordinator
      setShouldShowFindBar:shouldShowFindBar];

  BOOL isTabLoading = ([_model currentTab] && !IsIPadIdiom())
                          ? _toolbarModelIOS->IsLoading()
                          : NO;
  [_toolbarCoordinator.toolsMenuCoordinator setTabIsLoading:isTabLoading];
