...
- (void)presentIphBubbleForFeature:(const base::Feature&)feature
                       inDirection:(BubbleArrowDirection)direction
                     withAlignment:(BubbleAlignment)alignment
...
- (void)viewDidAppear:(BOOL)animated {
  ...
  void (^onInitializedBlock)(bool) = ^(bool successfullyLoaded) {
    ...
    CGPoint tabSwitcherAnchor = [_toolbarController
        anchorPointForTabSwitcherButton:BubbleArrowDirectionUp];
    [strongSelf
        presentIphBubbleForFeature:feature_engagement::kIPHNewTabTipFeature
                       inDirection:BubbleArrowDirectionUp
                     withAlignment:BubbleAlignmentTrailing
                     atAnchorPoint:tabSwitcherAnchor
                          withText:text];
  };
