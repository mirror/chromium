...
// Presents the New Tab Tip or New Incognito Tab Tip Bubble if they are
// available. Only one can be eligible per session. If neither is eligible,
// neither bubble is presented. This method requires that |self.browserState| is
// not NULL.
