...
- (void)loadModel {
  ...
  [[self.dataSource selectableItems]
      enumerateObjectsUsingBlock:^(
          CollectionViewItem<PaymentsIsSelectorType>* item, NSUInteger index,
          BOOL* stop) {
  ...
  switch (item.type) {
    case ItemTypeSelectableItem: {
      ...
      if (self.dataSource.selectedItemIndex != NSUIntegerMax) {
        ...
        CollectionViewItem<PaymentsIsSelectorType>* oldSelectedItem =
            [[self.dataSource selectableItems]
      ...
      CollectionViewItem<PaymentsIsSelectorType>* newSelectedItem =
          reinterpret_cast<CollectionViewItem<PaymentsIsSelectorType>*>(item);
