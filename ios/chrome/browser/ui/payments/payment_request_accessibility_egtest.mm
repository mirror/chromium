...
// of |string_id|.
id<GREYMatcher> RequiredButtonCellMatcher(int string_id) {
  return chrome_test_util::ButtonWithAccessibilityLabel(
...
- (void)testAccessibilityOnPaymentRequestDeliveryAddressPage {
  ...
  [[EarlGrey
      selectElementWithMatcher:RequiredButtonCellMatcher(
...
- (void)testAccessibilityOnPaymentRequestPaymentMethodPage {
  ...
  [[EarlGrey selectElementWithMatcher:RequiredButtonCellMatcher(
