...
// Tests that canMakePayment() resolves with true with credit and prepaid cards.
...
// Tests that a server debit card is preselected.
...
// Tests that an "unknown" card type is not preselected.
