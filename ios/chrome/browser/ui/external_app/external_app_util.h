...
#ifndef IOS_CHROME_BROWSER_UI_EXTERNAL_APP_EXTERNAL_APP_UTIL_H_
#define IOS_CHROME_BROWSER_UI_EXTERNAL_APP_EXTERNAL_APP_UTIL_H_
...
#endif  // IOS_CHROME_BROWSER_UI_EXTERNAL_APP_EXTERNAL_APP_UTIL_H_
