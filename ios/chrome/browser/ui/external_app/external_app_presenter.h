...
// A presentation protocol for launching external apps and alerting the user
// before launching an external app.
...
// Shows an alert that there are repeated attempts to launch an external app.
// The |completionHandler| is passed a BOOL indicating whether the user has
// allowed the launching of the external app after seeing the alert.
