...
// The |visibilityFactor| is here to change the alpha value of the background
// color, which have an alpha value, even when the |visibilityFactor| is 1. The
// final alpha value is "defaultValue * |visibilityFactor|"
