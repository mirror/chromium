    ...
    _expandedToolbarConstraints = @[
      ...
      [self.locationBarContainerStackView.topAnchor
          constraintEqualToAnchor:self.topSafeAnchor
                         constant:kLocationBarVerticalMargin],
      // When expanded keep the StackViews previous size.
      [self.leadingStackView.widthAnchor
          constraintEqualToConstant:self.leadingStackView.frame.size.width],
      [self.trailingStackView.widthAnchor
          constraintEqualToConstant:self.trailingStackView.frame.size.width],
    ];
  }
