...
- (void)setUpToolbarButtons {
  ...
  [self registerEventsForButton:self.backButton];
  ...
  [self registerEventsForButton:self.forwardButton];
  ...
  [self.tabSwitchStripButton addTarget:self.dispatcher
                      ...
                      forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.tabSwitchStripButton];
  ...
  [self.toolsMenuButton addTarget:self.dispatcher
                 ...
                 forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.toolsMenuButton];
  ...
  [self.shareButton addTarget:self.dispatcher
             ...
             forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.shareButton];
  ...
  [self.reloadButton addTarget:self.dispatcher
              ...
              forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.reloadButton];
  ...
  [self.stopButton addTarget:self.dispatcher
            ...
            forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.stopButton];
  ...
  [self registerEventsForButton:self.voiceSearchButton];
  ...
  [self.bookmarkButton addTarget:self.dispatcher
                ...
                forControlEvents:UIControlEventTouchUpInside];
  [self registerEventsForButton:self.bookmarkButton];
...
// Registers the events which will be triggered when tapping the button.
