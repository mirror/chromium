...
#import "ios/chrome/browser/ui/toolbar/public/toolbar_public_interface.h"
...
@protocol BVCToolbarProtocol<BVCWebToolbarPublicInterface,
                             OmniboxFocuser,
...
- (void)setToolbarController:(id<BVCToolbarProtocol>)toolbarController;
