...
- (void)toolbarDidLayout {
  if (CGRectEqualToRect(_lastKnownToolbarFrame, self.view.frame))
    return;
  _lastKnownToolbarFrame = self.view.frame;
  [self updateToolbarAlphaForFrame:_lastKnownToolbarFrame];
}
