...
#pragma clang diagnostic pop
  ...
  [NSLayoutConstraint activateConstraints:@[
    ...
    [omniboxPopupGuide.heightAnchor constraintEqualToConstant:1],
  ]];
  if (IsIPadIdiom()) {
    // The layout guide should be positioned from the bottom of the location
    // bar, but it doesn't work due to conflict between autolayout and
    // autoresizing mask. Position it from the bottom of the view instead.
