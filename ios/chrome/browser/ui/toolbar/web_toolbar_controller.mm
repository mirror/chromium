...
- (void)expandOmnibox API_AVAILABLE(ios(10.0)) {
  ...
  [self fadeOutStandardControlsAnimation];

  // Add navigation buttons animations.
  [self fadeOutNavigationControlsAnimation];
...
- (void)contractOmnibox API_AVAILABLE(ios(10.0)) {
  ...
  // Add standard Toolbar buttons animations.
  [self fadeInStandardControlsAnimation];

  // Add navigation buttons animations.
  [self fadeInNavigationControlsAnimation];
...
- (void)fadeInNavigationControlsAnimation API_AVAILABLE(ios(10.0)) {
...
- (void)fadeOutNavigationControlsAnimation API_AVAILABLE(ios(10.0)) {
