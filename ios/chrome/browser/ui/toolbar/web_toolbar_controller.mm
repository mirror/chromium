...
#pragma clang diagnostic pop
  ...
  if (idiom == IPAD_IDIOM) {
    ...
    _leadingOmniboxBackgroundConstraint = [_omniboxBackground.leadingAnchor constraintEqualToAnchor:_webToolbar.leadingAnchor constant:10];
    _trailingOmniboxBackgroundConstraint = [_omniboxBackground.trailingAnchor constraintEqualToAnchor:_webToolbar.trailingAnchor constant:-10];
    _topOmniboxBackgroundConstraint = [_omniboxBackground.topAnchor constraintEqualToAnchor:_webToolbar.topAnchor constant:10];
    _bottomOmniboxBackgroundConstraint = [_omniboxBackground.bottomAnchor constraintEqualToAnchor:_webToolbar.bottomAnchor constant:10];

    [NSLayoutConstraint activateConstraints:@[_leadingOmniboxBackgroundConstraint, _trailingOmniboxBackgroundConstraint, _topOmniboxBackgroundConstraint, _bottomOmniboxBackgroundConstraint]];
...
//                                       UIViewAutoresizingFlexibleBottomMargin];
    ...
    _leadingClippingViewConstraint = [_clippingView.leadingAnchor constraintEqualToAnchor:_webToolbar.leadingAnchor constant:0];
    _trailingClippingViewConstraint = [_clippingView.trailingAnchor constraintEqualToAnchor:_webToolbar.trailingAnchor constant:0];
    _topClippingViewConstraint = [_clippingView.topAnchor constraintEqualToAnchor:_webToolbar.topAnchor constant:0];
    _bottomClippingViewConstraint = [_clippingView.bottomAnchor constraintEqualToAnchor:_webToolbar.bottomAnchor constant:0];

    [NSLayoutConstraint activateConstraints:@[_leadingClippingViewConstraint, _trailingClippingViewConstraint, _topClippingViewConstraint, _bottomClippingViewConstraint]];
...
//    [_omniboxBackground setFrame:omniboxBackgroundFrame];
    ...
    _leadingOmniboxBackgroundConstraint = [_omniboxBackground.leadingAnchor constraintEqualToAnchor:_clippingView.leadingAnchor];
    _trailingOmniboxBackgroundConstraint = [_omniboxBackground.trailingAnchor constraintEqualToAnchor:_clippingView.trailingAnchor];
    _topOmniboxBackgroundConstraint = [_omniboxBackground.topAnchor constraintEqualToAnchor:_clippingView.topAnchor];
    _bottomOmniboxBackgroundConstraint = [_omniboxBackground.bottomAnchor constraintEqualToAnchor:_clippingView.bottomAnchor];
    [NSLayoutConstraint activateConstraints:@[_leadingOmniboxBackgroundConstraint, _trailingOmniboxBackgroundConstraint, _topOmniboxBackgroundConstraint, _bottomOmniboxBackgroundConstraint]];
...
//    [_omniBox setFrame:[self newOmniboxFrame]];
