...
@interface ToolbarController () {
  ...
  id<ToolsMenuCoordinatorPresentationStateProtocol> toolsMenuStateProvider_;
}
...
@synthesize toolsMenuButton = toolsMenuButton_;
...
#pragma mark Tools Menu Popup Notifications
