...
TEST_F(ReadingListMenuViewCellTest, Initialization) {
  EXPECT_TRUE([readingListMenuViewCell_ isNumberBadgeHidden]);
  EXPECT_TRUE([readingListMenuViewCell_ isTextBadgeHidden]);
}
...
TEST_F(ReadingListMenuViewCellTest, NumberBadgeAlone) {
  ...
  EXPECT_FALSE([readingListMenuViewCell_ isNumberBadgeHidden]);
  EXPECT_TRUE([readingListMenuViewCell_ isTextBadgeHidden]);
}
...
TEST_F(ReadingListMenuViewCellTest, TextBadgeAlone) {
  ...
  EXPECT_TRUE([readingListMenuViewCell_ isNumberBadgeHidden]);
  EXPECT_FALSE([readingListMenuViewCell_ isTextBadgeHidden]);
}
