...
// The coordinator that manages the display of page info. When |dispatcher|, is
// set, this coordinator uses |dispatcher| to register itself as the target for
// PageInfoCommmands. These commands can then trigger the showing/hiding of
// page info.
