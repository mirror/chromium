...
// The |source| parameter should be in the coordinate system of |provider|'s
// view. Typically, |source| would be the midpoint of a button that resulted in
// this popup being displayed.
