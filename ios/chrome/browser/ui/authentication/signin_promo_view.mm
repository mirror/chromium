...
- (instancetype)initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    NSDictionary* metrics = @{
      ...
      @"bvp_vp" : @(kVerticalPadding + kButtonVerticalPadding),
    };
    NSDictionary* views = @{
    ...
    NSArray* visualConstraints = @[
      @"V:|-vpx2-[imageView]-vp-[textLabel]-bvp_vp-[primaryButton(bh)]",
    ...
    NSArray* warmStateVisualConstraints = @[
      @"V:[primaryButton]-bvpx2-[secondaryButton(bh)]-bvp_vp-|",
