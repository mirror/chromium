...
// Called when one of the sign promo view button is being tapped. This method
...
// The consumer has also the responsability make sure |completion| is called
// once the sign-in is done.
// |mediator| is in charge to send all the histograms.
