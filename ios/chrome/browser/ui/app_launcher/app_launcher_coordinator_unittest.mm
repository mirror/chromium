...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  OCMExpect([application_
      openURL:[OCMArg checkWithBlock:^BOOL(id value) {
        EXPECT_NSEQ([NSURL URLWithString:@"some-app://1234"], value);
        return YES;
      }]]);
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
  OCMStub([application_ openURL:[OCMArg checkWithBlock:^BOOL(id value) {
                          EXPECT_NSEQ(
                              [NSURL URLWithString:@"no-app-installed://1234"],
                              value);
                          return YES;
                        }]])
      .andReturn(NO);
