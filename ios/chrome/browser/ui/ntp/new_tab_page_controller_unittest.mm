...
TEST_F(NewTabPageControllerTest, SelectBookmarkPanel) {
  ...
  [controller_ selectPanel:ntp_home::kBookmarksPanel];
...
TEST_F(NewTabPageControllerTest, SelectIncognitoPanel) {
  ...
  [incognitoController_ selectPanel:ntp_home::kBookmarksPanel];
...
TEST_F(NewTabPageControllerTest, NewTabPageIdentifierConversion) {
  EXPECT_EQ("open_tabs",
            NewTabPage::FragmentFromIdentifier(ntp_home::kOpenTabsPanel));
  EXPECT_EQ("", NewTabPage::FragmentFromIdentifier(ntp_home::kNone));
  EXPECT_EQ(ntp_home::kBookmarksPanel,
            NewTabPage::IdentifierFromFragment("bookmarks"));
  EXPECT_EQ(ntp_home::kNone, NewTabPage::IdentifierFromFragment("garbage"));
  EXPECT_EQ(ntp_home::kNone, NewTabPage::IdentifierFromFragment(""));
}
