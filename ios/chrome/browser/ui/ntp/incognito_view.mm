...
- (instancetype)initWithFrame:(CGRect)frame urlLoader:(id<UrlLoader>)loader {
  ...
  if (self) {
    ...
    if (@available(iOS 11.0, *)) {
      [_stackView setCustomSpacing:24 afterView:incognitoImage];
    }
    ...
    [NSLayoutConstraint activateConstraints:@[
      ...
      [_stackView.topAnchor constraintEqualToAnchor:topGuide.bottomAnchor
                                           constant:8],
      [bottomGuide.topAnchor constraintEqualToAnchor:_stackView.bottomAnchor
                                            constant:8],
      [_containerView.bottomAnchor
          constraintEqualToAnchor:bottomGuide.bottomAnchor],

      // Center the stackview horizontally, with at least a 24pt margin.
      ...
      // Ensure that the stackview is no wider than 416pt.
      [_stackView.widthAnchor constraintLessThanOrEqualToConstant:416],

      // Set a minimum top margin and make the bottom guide twice as tall as the
      // top guide.
      [topGuide.heightAnchor constraintGreaterThanOrEqualToConstant:12],
