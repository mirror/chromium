...
@interface TabStripController ()<DropAndNavigateDelegate,
  ...
  // Default handlers of drops in the tab strip.
  API_AVAILABLE(ios(11.0))
  DropAndNavigateInteraction* _tabStripDropbInteraction;
#endif
}
...
- (instancetype)initWithTabModel:(TabModel*)tabModel
  ...
  if ((self = [super init])) {
    ...
    if (@available(iOS 11.0, *)) {
      _tabStripDropbInteraction =
          [[DropAndNavigateInteraction alloc] initWithDelegate:self];
      [_view addInteraction:_tabStripDropbInteraction];
    }
#endif
