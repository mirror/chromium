...
#import "ios/chrome/browser/ui/history_popup/tab_history_constants.h"

@protocol TabHistoryPositioner
// CGPoint from which the Tab History Popup will be presented from.
- (CGPoint)originPointForToolbarButton:(ToolbarButton)toolbarButton;

// UIView from which the Tab History Popup will be presented from.
