...
- (instancetype)initWithMainCardSet:(CardSet*)mainCardSet
  ...
  if (self) {
    ...
    // When checking for the existence of tabs, catch the case where the main
    // set is both active and empty, but the incognito set has some cards.
    ...
    _toolsMenuCoordinator.toolsMenuConfiguration = configuration;
  }
  return self;
}
