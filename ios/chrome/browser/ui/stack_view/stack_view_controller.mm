...
- (void)scrollViewDidScroll:(UIScrollView*)scrollView {
  ...
  // bar triggers a |-scrollViewDidScroll:| callback before before any rotation-
  ...
  // calculations.  The layout logic will eventually be triggered when we reset
  // the UIScrollView's contentSize.
