...
- (void)startEdit {
  ...
  // TODO(crbug.com/695749): Need to discuss to see what is the expected
  // behavior if the following happens when editing folder name:
  // 1. Click on 'Done' or 'Back' of the navigation bar.
  // 2. Click on other folder or bookmark.
  // 3. Click on 'New Folder' or 'Select' of the context bar.

  // TODO(crbug.com/695749): Discuss if we need to disable refresh content when
  // editing folder name.
