...
#ifndef IOS_CHROME_BROWSER_UI_SAFE_MODE_SAFE_MODE_UTIL_H_
#define IOS_CHROME_BROWSER_UI_SAFE_MODE_SAFE_MODE_UTIL_H_
...
#endif  // IOS_CHROME_BROWSER_UI_SAFE_MODE_SAFE_MODE_UTIL_H_
