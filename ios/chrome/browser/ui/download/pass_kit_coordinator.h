...
// If PKPass is a valid pass then coordinator will present "Add pkpass UI",
// otherwise coordinator will present "failed to add pkpass UI". Set to null
// when stop method is called or web state is destroyed.
