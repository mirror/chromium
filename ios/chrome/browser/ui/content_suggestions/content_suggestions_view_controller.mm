...
- (UIEdgeInsets)collectionView:(UICollectionView*)collectionView
  ...
  UIEdgeInsets safeAreaInsets = SafeAreaInsetsForView(collectionView);
  CGFloat safeAreaWidth = CGRectGetWidth(
      UIEdgeInsetsInsetRect(collectionView.frame, safeAreaInsets));
