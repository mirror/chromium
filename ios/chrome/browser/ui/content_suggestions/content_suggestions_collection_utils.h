...
// new architecture is completed. Returns the expected height of the header.
// |logoIsShowing| refers to the Google logo or the doodle. |promoCanShow|
// represents whether a what's new promo can be displayed.  |toolbarPresent|
// represent whether the height should take into account a space to show the
// toolbar.
