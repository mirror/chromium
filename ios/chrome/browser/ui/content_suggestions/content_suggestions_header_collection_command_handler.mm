...
@implementation ContentSuggestionsHeaderCollectionCommandHandler
...
- (void)shiftTilesUpWithCompletionBlock:(ProceduralBlock)completion {
  ...
  CGFloat pinnedOffsetY = [self.delegate pinnedOffsetY];
...
- (void)shiftTilesDownAnimationDidFire:(CADisplayLink*)link {
  ...
  CGFloat yOffset = (1.0 - percentComplete) * [self.delegate pinnedOffsetY];
