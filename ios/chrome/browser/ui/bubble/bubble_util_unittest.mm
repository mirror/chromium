 ...
 public:
  BubbleUtilTest()
      : centerAlignedTarget_(CGRectMake(250.0f, 200.0f, 100.0f, 100.0f)),
        leftAlignedAnchorPoint_(CGPointMake(70.0f, 250.0f)),
        centerAlignedAnchorPoint_(CGPointMake(300.0f, 250.0f)),
        rightAlignedAnchorPoint_(CGPointMake(450.0f, 250.0f)),
        bubbleSize_(CGSizeMake(300.0f, 100.0f)),
        containerSize_(CGSizeMake(500.0f, 600.0f)) {}
...
TEST_F(BubbleUtilTest, AnchorPointUp) {
  ...
  EXPECT_EQ(300.0f, anchorPoint.x);
  EXPECT_EQ(300.0f, anchorPoint.y);
}
...
TEST_F(BubbleUtilTest, AnchorPointDown) {
  ...
  EXPECT_EQ(300.0f, anchorPoint.x);
  EXPECT_EQ(200.0f, anchorPoint.y);
}
