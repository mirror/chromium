...
class BubbleUtilTest : public PlatformTest {
 public:
  BubbleUtilTest()
      : leftAlignedTarget_(CGRectMake(
            20.0f,
            200.0f,
            100.0f,
            100.0f)),  // Target element on the left side of the container.
        centerAlignedTarget_(CGRectMake(
            250.0f,
            200.0f,
            100.0f,
            100.0f)),  // Target element on the center of the container.
        rightAlignedTarget_(CGRectMake(
            400.0f,
            200.0f,
            100.0f,
            100.0f)),  // Target element on the right side of the container.
        bubbleSize_(CGSizeMake(300.0f, 100.0f)),
        containerWidth_(
            500.0f)  // Bounding width of the bubble's coordinate system.
  {}
