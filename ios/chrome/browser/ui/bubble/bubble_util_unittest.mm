...
class BubbleUtilTest : public PlatformTest {
 public:
  BubbleUtilTest() {
    ...
    // Target element on the center side of the container.
 ...
 protected:
  CGRect leftAlignedTarget_;
  CGRect centerAlignedTarget_;
  CGRect rightAlignedTarget_;
};

// Test |OriginY| when the bubble points up at the target element.
TEST_F(BubbleUtilTest, OriginUpArrow) {
  CGFloat originY = bubble_util::OriginY(centerAlignedTarget_,
                                         BubbleArrowDirectionUp, 100.0f);
...
TEST_F(BubbleUtilTest, OriginDownArrow) {
  CGFloat originY = bubble_util::OriginY(centerAlignedTarget_,
                                         BubbleArrowDirectionDown, 100.0f);
...
TEST_F(BubbleUtilTest, LeadingDistanceLeadingAlignment) {
  CGFloat leading = bubble_util::LeadingDistance(
      leftAlignedTarget_, BubbleAlignmentLeading, 300.0f);
...
TEST_F(BubbleUtilTest, LeadingDistanceCenterAlignment) {
  CGFloat leading = bubble_util::LeadingDistance(centerAlignedTarget_,
                                                 BubbleAlignmentCenter, 300.0f);
...
TEST_F(BubbleUtilTest, LeadingDistanceTrailingAlignment) {
  CGFloat leading = bubble_util::LeadingDistance(
      rightAlignedTarget_, BubbleAlignmentTrailing, 300.0f);
...
TEST_F(BubbleUtilTest, MaxWidthLeadingWithTargetOnLeft) {
  ...
  CGFloat leftAlignedWidth =
      bubble_util::MaxWidth(leftAlignedTarget_, BubbleAlignmentLeading, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthLeadingWithTargetOnCenter) {
  ...
  CGFloat centerAlignedWidth = bubble_util::MaxWidth(
      centerAlignedTarget_, BubbleAlignmentLeading, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthLeadingWithTargetOnRight) {
  ...
  CGFloat rightAlignedWidth = bubble_util::MaxWidth(
      rightAlignedTarget_, BubbleAlignmentLeading, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthCenterWithTargetOnLeft) {
  ...
  base::i18n::SetICUDefaultLocale("en");
  CGFloat leftAlignedWidth =
      bubble_util::MaxWidth(leftAlignedTarget_, BubbleAlignmentCenter, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthCenterWithTargetOnCenter) {
  ...
  base::i18n::SetICUDefaultLocale("en");
  CGFloat centerAlignedWidth = bubble_util::MaxWidth(
      centerAlignedTarget_, BubbleAlignmentCenter, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthCenterWithTargetOnRight) {
  ...
  CGFloat rightAlignedWidth =
      bubble_util::MaxWidth(rightAlignedTarget_, BubbleAlignmentCenter, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthTrailingWithTargetOnLeft) {
  ...
  CGFloat leftAlignedWidth = bubble_util::MaxWidth(
      leftAlignedTarget_, BubbleAlignmentTrailing, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthTrailingWithTargetOnCenter) {
  ...
  base::i18n::SetICUDefaultLocale("en");
  CGFloat centerAlignedWidth = bubble_util::MaxWidth(
      centerAlignedTarget_, BubbleAlignmentTrailing, 500.0f);
...
TEST_F(BubbleUtilTest, MaxWidthTrailingWithTargetOnRight) {
  ...
  base::i18n::SetICUDefaultLocale("en");
  CGFloat rightAlignedWidth = bubble_util::MaxWidth(
      rightAlignedTarget_, BubbleAlignmentTrailing, 500.0f);
