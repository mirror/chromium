...
class MainPresentingViewControllerTest : public BlockCleanupTest {
 public:
  MainPresentingViewControllerTest() = default;
  ~MainPresentingViewControllerTest() override = default;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(MainPresentingViewControllerTest);
};
