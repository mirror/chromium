...
@property(nonatomic, readwrite, strong) id<UIViewControllerContextTransitioning>
    transitionContext;
...
- (void)animateTransition:
  ...
  id<TabSwitcher> tabSwitcher =
      static_cast<MainPresentingViewController*>(toViewController).tabSwitcher;
  tabSwitcher.animationDelegate = self;
