...
#import "ios/chrome/browser/ui/omnibox/autocomplete_suggestion_formatter.h"
...
- (NSArray<id<AutocompleteSuggestion>>*)wrappedMatches {
  ...
  for (size_t i = 0; i < size; i++) {
    ...
    AutocompleteSuggestionFormatter* formatter =
        [AutocompleteSuggestionFormatter formatterWithMatch:match];
    formatter.isStarredMatch = _delegate->IsStarredMatch(match);
