...
- (NSArray<id<AutocompleteResultWrapper>>*)wrappedMatches {
  NSMutableArray<id<AutocompleteResultWrapper>>* wrappedMatches =
  ...
  for (size_t i = 0; i < size; i++) {
    ...
    AutocompleteResultWrapperImpl* wrapper =
        [[AutocompleteResultWrapperImpl alloc] init];
    wrapper.match = match;
    wrapper.isStarredMatch = _delegate->IsStarredMatch(match);
    wrapper.incognito = _incognito;
    [wrappedMatches addObject:wrapper];
  }
