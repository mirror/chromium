...
class ChromeBroadcastObserverInterface {
 public:
  ...
  // Invoked by |-broadcastSelectedNTPPanel:|.
  virtual void OnSelectedNTPPanelBroadcasted(
      ntp_home::PanelIdentifier panelIdentifier) {}

  // Invoked by |-broadcastOmniboxFrame:|.
  virtual void OnOmniboxFrameBroadcasted(CGRect frame) {}
};
