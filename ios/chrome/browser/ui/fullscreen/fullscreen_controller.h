...
@class KeyboardFullscreenDisabler;
class WebStateList;
...
class FullscreenController : public KeyedService {
 ...
 private:
  ...
  // A helper object that disables fullscreen while the keyboard is visible.
  __strong KeyboardFullscreenDisabler* keyboard_disabler_ = nil;
