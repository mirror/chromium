...
// Sets switchItem's enaled status to |enabled|. It is important that there is
// no more than one item of |switchItemType| in SectionIdentifierSwitches.
...
- (void)collectionViewWillBeginEditing:(UICollectionView*)collectionView {
  ...
  [sections
      addIndex:[self.collectionViewModel
                   sectionForSectionIdentifier:SectionIdentifierSwitches]];
