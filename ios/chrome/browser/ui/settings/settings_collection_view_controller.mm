...
- (void)onSignInStateChanged {
  // While the sign-in interaction coordinator is presenting, the collection
  // view should not be updated. Otherwise, it would lead to have an UI glitch
  // either while the interaction coordinator is appearing or while it is
  // disappearing. The collection view will be reloaded once the animation is
  // finished. See: -[SettingsCollectionViewController didFinishSignin:].
