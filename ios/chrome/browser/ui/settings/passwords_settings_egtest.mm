...
- (void)testAccessibilityOnPasswords {
  ...
  TapEntry(@"example.com, concrete username");
  chrome_test_util::VerifyAccessibilityForCurrentScreen();
...
- (void)testDeletion {
  ...
  [GetInteractionForEntry(@"example.com, concrete username")
...
- (void)testFederated {
  ...
  TapEntry(@"example.com, federated username");
...
- (void)testStoredEntriesAlwaysShown {
  ...
  for (BOOL expected_state : kExpectedState) {
    ...
    [GetInteractionForEntry(@"example.com, concrete username")
        assertWithMatcher:grey_notNil()];
    [GetInteractionForEntry(@"blacklisted.com")
        assertWithMatcher:grey_notNil()];
  }
