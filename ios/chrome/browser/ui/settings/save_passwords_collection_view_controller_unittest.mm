...
const std::vector<ExportPasswordsFeatureStatus> export_passwords_feature_status{
    // Export disabled
    {FALSE, 0},
    // Export enabled
    {TRUE, 1}};

INSTANTIATE_TEST_CASE_P(ExportPasswordsToggle,
                        SavePasswordsCollectionViewControllerTest,
                        ::testing::ValuesIn(export_passwords_feature_status));
