...
- (void)loadAndSubmitTheForm {
  ...
  GREYAssert(TapWebViewElementWithId("fill_profile_president"), @"failed to tap \"fill_profile_president\"");
  GREYAssert(TapWebViewElementWithId("submit_profile"), @"failed to tap \"submit_profile\"");
}
