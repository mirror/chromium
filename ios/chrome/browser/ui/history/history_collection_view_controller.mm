...
#include "ios/chrome/browser/ui/history/browsing_history_driver_delegate.h"
...
- (void)onQueryCompleteWithResults:
  ...
  self.finishedLoading = queryResultsInfo.has_synced_results
                             ? queryResultsInfo.reached_beginning_of_local
                             : queryResultsInfo.reached_beginning_of_local &&
