...
- (void)string1:(NSString*)string1 string2:(NSString*)string2 {
  [_clearBrowsingDataButton setTitle:string1 forState:UIControlStateNormal];
  [_editButton setTitle:string2 forState:UIControlStateNormal];
}
