...
@protocol IOSBrowsingHistoryDriverDelegate;

// A simple implementation of BrowsingHistoryServiceHandler that delegates to
// objective-c object IOSBrowsingHistoryDriverDelegate for most actions.
class IOSBrowsingHistoryDriver : public BrowsingHistoryDriver {
 public:
 ...
 private:
  ...
  __weak id<IOSBrowsingHistoryDriverDelegate> delegate_;
