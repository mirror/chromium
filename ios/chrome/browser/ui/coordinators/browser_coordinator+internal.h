...
// Enum for defining the "mode" of the coordinator -- the way that it's view
// controller is positioned in the view controller hierarchy. There's no
// property in the base clas for this value, but subclasses may define a 'mode'
// property if they need to vary behavior or configuration based on the mode. In
// that case, the defaut should alway be UNDEFINED.
