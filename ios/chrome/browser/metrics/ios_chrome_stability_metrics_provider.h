...
class IOSChromeStabilityMetricsProvider : public metrics::MetricsProvider,
 ...
 public:
  ...
  // loads. Not all events are mutually exclusive.
  enum StabilityMetricEventType {
    // A same-document navigation event. This is not counted for page load.
    SAME_DOCUMENT_NAVIGATION = 0,
    // A chrome:// URL navigation. This is not counted for page load.
    CHROME_URL_NAVIGATION = 1,
    // A navigation that is not SAME_DOCUMENT or CHROME_URL. It is counted as a
    // page load.
