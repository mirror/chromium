...
class PaymentRequest : public payments::PaymentOptionsProvider,
 ...
 protected:
  ...
  // Fetches the payment methods for this user from that match a supported
  // type specified in |web_payment_request_| and stores copies of them,
  // owned by this PaymentRequest, in payment_method_cache_..
