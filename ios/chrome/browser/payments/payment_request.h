...
class PaymentRequest : public PaymentOptionsProvider,
 ...
 public:
  ...
  enum class State {
    CREATED,  // The payment request is constructed but has not been presented.
    INTERACTIVE,  // The payment request is being presented to the user.
    CLOSED,       // The payment request completed.
  };
