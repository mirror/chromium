...
class IOSPaymentApp : public PaymentInstrument {
 public:
  ...
  // identifier for this iOS payment app. The IOSPaymentApp takes ownership
  // of |icon_image|.
  ...
  // Given that this UIImage can only be determined at run-time, the icon
  // for IOSPaymentApp types is obtained using this UIImage object rather
  // than using a resource ID and Chrome's resource bundle.
