...
class TestIOSPaymentInstrumentFinder : public IOSPaymentInstrumentFinder {
 public:
  TestIOSPaymentInstrumentFinder()
      : IOSPaymentInstrumentFinder(new net::TestURLRequestContextGetter(
...
class IOSPaymentInstrumentFinderTest : public testing::Test {
 public:
  IOSPaymentInstrumentFinderTest()
    ...
    // This needs to be initialized on construction or else we will receive a
    // garbage value for some of the tests that return early before setting this
    // value.
    ios_payment_instrument_finder_->num_payment_methods_remaining_ = 0;
  }
