...
class AccountSelectFillData {
 public:
  ...
  // Returns whether suggestions is available for field with name
  ...
  // Returns suggesions for field with name |field_name| which is in the form
  // with name |form_name|.
  ...
  // Returns data for password form filling based on the user choosen
  // |username|.
