...
@interface CredentialManagerEarlGreyTestCase : ChromeTestCase

@end

@implementation CredentialManagerEarlGreyTestCase
...
- (void)setUp {
  ...
  if (!base::FeatureList::IsEnabled(features::kCredentialManager)) {
    ...
    GREYFail(@"CredentialManager feature is not enabled. This is unexpected.");
  }
...
- (void)testNotificationAppearsOnAutoSignIn {
  ...
  [ChromeEarlGrey waitForWebViewContainingText:std::string("You are here.")];
