...
// 1. Command is sent from JavaScript to the browser.
...
class CredentialManager {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseMediationRequirement);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseIncludePasswords);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseFederations);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseCredentialType);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseCommonCredentialFields);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParsePasswordCredential);
  FRIEND_TEST_ALL_PREFIXES(CredentialManagerTest, ParseFederatedCredential);
