...
// Class responsible for resolving and rejecting JavaScript promises associated
// with Credential Manager API requests. Each of ResolvePromiseWith* methods
// calls the |resolve| function of a Promise stored under |request_id| in JS.
// Each of RejectPromiseWith* methods calls the |reject| function of a Promise
// stored under |request_id| in JS.
