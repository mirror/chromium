...
// If Tab was shown, an there is a pending PasswordForm, display autosign-in
// notification.
...
- (void)showAutosigninNotification:
  ...
  if (![_delegate displaySignInNotification:self.notifyAutoSigninViewController
    ...
    // The notification was not shown. Suppress it and store in
    // |pendingAutoSigninPasswordForm_| to show later.
