...
// Finds all password forms in DOM and sends them to store for fetching stored
// credentials.
- (void)findPasswordFormsAndSendThemToStore;
...
- (void)webState:(web::WebState*)webState didLoadPageWithSuccess:(BOOL)success {
  ...
  [self findPasswordFormsAndSendThemToStore];
}
