...
// User's avatar, corresponding to Credential.iconURL field in JS.
...
- (void)viewDidLoad {
  ...
  self.avatar = [UIImage imageNamed:@"ic_account_circle"];
  // View containing user's avatar.
  self.avatarView = [[UIImageView alloc] initWithImage:self.avatar];
