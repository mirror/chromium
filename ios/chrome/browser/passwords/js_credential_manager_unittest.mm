...
TEST_F(JsCredentialManagerTest, ResolveWithPasswordCredential) {
  ...
  WaitForCondition(^{
    return (bool)[@"object"
        isEqual:ExecuteJavaScript(@"typeof test_credential_")];
  });
...
TEST_F(JsCredentialManagerTest, ResolveWithNullCredential) {
  ...
  // Wait for Promise to be resolved before checking the values.
  WaitForCondition(^{
    return (bool)[@"boolean" isEqual:ExecuteJavaScript(@"typeof test_result_")];
  });
...
TEST_F(JsCredentialManagerTest, RejectWithTypeError) {
  ...
  WaitForCondition(^{
    return (bool)[@"string"
        isEqual:ExecuteJavaScript(@"typeof test_result_message_")];
  });
