...
const flags_ui::FeatureEntry kFeatureEntries[] = {
    ...
    {"use-ddljson-api", flag_descriptions::kUseDdljsonApiName,
     ...
     FEATURE_WITH_PARAMS_VALUE_TYPE(
         ...
         "NTPUseDdljsonApi")},
    {"bookmark-reordering", flag_descriptions::kBookmarkReorderingName,
     flag_descriptions::kBookmarkReorderingDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(bookmark_reordering::features::kBookmarkReordering)}};
