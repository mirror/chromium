...
TEST_F(WebStateListTest, InsertUrlMultiple) {
  web_state_list_.InsertWebState(0, WebStateList::INSERT_FORCE_INDEX,
                                 CreateWebState(kURL0), WebStateOpener());
  web_state_list_.InsertWebState(0, WebStateList::INSERT_FORCE_INDEX,
                                 CreateWebState(kURL1), WebStateOpener());
  web_state_list_.InsertWebState(1, WebStateList::INSERT_FORCE_INDEX,
                                 CreateWebState(kURL2), WebStateOpener());
...
TEST_F(WebStateListTest, InsertInheritOpener) {
  ...
  web_state_list_.InsertWebState(WebStateList::kInvalidIndex,
                                 WebStateList::INSERT_INHERIT_OPENER,
                                 CreateWebState(kURL1), WebStateOpener());
...
TEST_F(WebStateListTest, OpenersChildsAfterOpener) {
  ...
  web_state_list_.InsertWebState(
      3, WebStateList::INSERT_FORCE_INDEX, CreateWebState(kURL2),
