...
TEST_F(WebStateListSerializationTest, SerializationRoundTrip) {
  WebStateList original_web_state_list(web_state_list_delegate());
  original_web_state_list.InsertWebState(0, WebStateList::INSERT_FORCE_INDEX,
                                         SerializableTestWebState::Create(),
                                         WebStateOpener());
  original_web_state_list.InsertWebState(
      1, WebStateList::INSERT_FORCE_INDEX | WebStateList::INSERT_ACTIVATE,
      SerializableTestWebState::Create(),
      WebStateOpener(original_web_state_list.GetWebStateAt(0), 3));
  original_web_state_list.InsertWebState(
      2, WebStateList::INSERT_FORCE_INDEX, SerializableTestWebState::Create(),
      WebStateOpener(original_web_state_list.GetWebStateAt(0), 2));
  original_web_state_list.InsertWebState(
      3, WebStateList::INSERT_FORCE_INDEX, SerializableTestWebState::Create(),
  ...
  restored_web_state_list.InsertWebState(0, WebStateList::INSERT_FORCE_INDEX,
                                         SerializableTestWebState::Create(),
                                         WebStateOpener());
