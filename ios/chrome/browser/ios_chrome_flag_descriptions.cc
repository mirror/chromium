...
const char kUIRebootPhase1Name[] = "UI Reboot Phase 1";
const char kUIRebootPhase1Description[] =
    "When enabled, the first phase of the iOS UI reboot will be displayed.";
