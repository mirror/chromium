...
const char kInProductHelpDemoModeDescription[] =
    "When a specific promotion is enabled, it "
    "triggers exactly once per cold start. Alternatively, all features can be "
    "enabled at once. Requires restart of Chrome.";
