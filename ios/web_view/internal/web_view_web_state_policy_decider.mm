...
bool WebViewWebStatePolicyDecider::ShouldAllowRequest(
  ...
  if ([delegate
    ...
    BOOL userInitiated = action.navigationType != WKNavigationTypeOther;
    CWVNavigationAction* CWVAction =
        [[CWVNavigationAction alloc] initWithRequest:action.request
                                       userInitiated:userInitiated];
    return [delegate webView:web_view_ shouldStartLoadWithAction:CWVAction];
  }
  return true;
}
