...
void WebViewSyncInitializer::InitializeFactories() {
  ...
  ContentSettingsPattern::SetNonWildcardDomainNonPortScheme(":no-extension-scheme:");
}
...
void WebViewSyncInitializer::InitializeServicesForBrowserState(WebViewBrowserState* browser_state) {
  ...
  WebViewAccountConsistencyServiceFactory::GetForBrowserState(browser_state);
}
...
// static
void WebViewSyncInitializer::RegisterBrowserPrefs(user_prefs::PrefRegistrySyncable* registry) {
