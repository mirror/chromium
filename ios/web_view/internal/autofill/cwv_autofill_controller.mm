...
@implementation CWVAutofillController {
  ...
  // The name of the form that was last focused.
  NSString* _lastFocusedFormName;
}
...
- (void)clearFocusedForm {
  if (_lastFocusedFormName) {
    [_jsAutofillManager clearAutofilledFieldsForFormNamed:_lastFocusedFormName
                                        completionHandler:^{
                                            // Empty.
                                        }];
  }
...
- (void)webState:(web::WebState*)webState
  ...
  _lastFocusedFormName = nsFormName;
}
...
- (void)handleSuggestions:(NSArray*)suggestions
  ...
  if (suggestions.count) {
    ...
    if ([_delegate respondsToSelector:@selector
      ...
      id fillBlock = ^(CWVAutofillFormSuggestion* formSuggestion) {
      ...
      [_delegate autofillController:self
            ...
            fillFormSuggestionBlock:fillBlock];
    }
  } else {
    if ([_delegate respondsToSelector:@selector
