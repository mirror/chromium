...
#ifndef IOS_WEB_VIEW_INTERNAL_SIGNIN_WEB_VIEW_SIGNIN_CLIENT_IMPL_H_
#define IOS_WEB_VIEW_INTERNAL_SIGNIN_WEB_VIEW_SIGNIN_CLIENT_IMPL_H_
...
class WebViewSigninClientImpl
 ...
 public:
  WebViewSigninClientImpl(ios_web_view::WebViewBrowserState* browser_state,
                          SigninErrorController* signin_error_controller);
  ~WebViewSigninClientImpl() override;

  // Utility method.
  static bool AllowsSigninCookies(
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(WebViewSigninClientImpl);
};

#endif  // IOS_WEB_VIEW_INTERNAL_SIGNIN_WEB_VIEW_SIGNIN_CLIENT_IMPL_H_
