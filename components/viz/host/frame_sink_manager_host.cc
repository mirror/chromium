...
void FrameSinkManagerHost::BindPtrAndSetClient(
...
void FrameSinkManagerHost::ConnectWithInProcessFrameSinkManager(
  ...
  manager->BindManagerClientAndSetManagerPtr(std::move(manager_mojo_request),
                                             std::move(host_mojo));
  // Sets |host_mojo| which was given to the |manager|.
  host->BindPtrAndSetClient(std::move(host_mojo_request),
