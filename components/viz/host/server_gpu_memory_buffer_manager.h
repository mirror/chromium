...
class VIZ_HOST_EXPORT ServerGpuMemoryBufferManager
 ...
 public:
  ...
  using AllocateGpuMemoryBufferCallback = base::OnceCallback<void(
  ...
  void AllocateGpuMemoryBuffer(gfx::GpuMemoryBufferId id,
                               int client_id,
                               const gfx::Size& size,
 ...
 private:
  ...
  gpu::GpuMemoryBufferImpl::DestructionCallback CreateBufferDestructionCallback(
      ...
      int client_id);
  void OnGpuMemoryBufferAllocated(int client_id,
