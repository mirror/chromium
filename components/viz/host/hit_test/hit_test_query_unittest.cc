...
TEST_F(HitTestQueryTest, OneSurface) {
  ...
  auto e_hit_test_rect = mojom::HitTestRect::New();
  e_hit_test_rect->flags = mojom::kHitTestMouse;
  e_hit_test_rect->rect = e_bounds;
  aggregated_hit_test_region_list[0].rects.push_back(
      std::move(e_hit_test_rect));
...
TEST_F(HitTestQueryTest, OneEmbedderTwoChildren) {
  ...
  auto e_hit_test_rect = mojom::HitTestRect::New();
  e_hit_test_rect->flags = mojom::kHitTestMouse;
  e_hit_test_rect->rect = e_bounds_in_e;
  aggregated_hit_test_region_list[0].rects.push_back(
      std::move(e_hit_test_rect));
  ...
  auto c1_hit_test_rect = mojom::HitTestRect::New();
  c1_hit_test_rect->flags = mojom::kHitTestMouse;
  c1_hit_test_rect->rect = c1_bounds_in_e;
  aggregated_hit_test_region_list[1].rects.push_back(
      std::move(c1_hit_test_rect));
  ...
  auto c2_hit_test_rect = mojom::HitTestRect::New();
  c2_hit_test_rect->flags = mojom::kHitTestMouse;
  c2_hit_test_rect->rect = c2_bounds_in_e;
  aggregated_hit_test_region_list[2].rects.push_back(
      std::move(c2_hit_test_rect));
...
TEST_F(HitTestQueryTest, OneEmbedderRotatedChild) {
  ...
  auto c_hit_test_rect = mojom::HitTestRect::New();
  c_hit_test_rect->flags = mojom::kHitTestMouse;
  c_hit_test_rect->rect = c_bounds_in_e;
  aggregated_hit_test_region_list[1].rects.push_back(
      std::move(c_hit_test_rect));
  aggregated_hit_test_region_list[1].child_count = 0;
...
TEST_F(HitTestQueryTest, ClippedChildWithTabAndTransparentBackground) {
  ...
  auto a_hit_test_rect = mojom::HitTestRect::New();
  a_hit_test_rect->flags = mojom::kHitTestMouse;
  a_hit_test_rect->rect = a_bounds_in_c;
  aggregated_hit_test_region_list[2].rects.push_back(
      std::move(a_hit_test_rect));
  aggregated_hit_test_region_list[2].child_count = 0;
  ...
  auto b_hit_test_rect = mojom::HitTestRect::New();
  b_hit_test_rect->flags = mojom::kHitTestMouse;
  b_hit_test_rect->rect = b_bounds_in_c;
  aggregated_hit_test_region_list[3].rects.push_back(
      std::move(b_hit_test_rect));
...
TEST_F(HitTestQueryTest, ClippedChildWithChildUnderneath) {
  ...
  auto d_hit_test_rect = mojom::HitTestRect::New();
  d_hit_test_rect->flags = mojom::kHitTestMouse;
  d_hit_test_rect->rect = d_bounds_in_e;
  aggregated_hit_test_region_list[4].rects.push_back(
      std::move(d_hit_test_rect));
...
TEST_F(HitTestQueryTest, ClippedChildrenWithTabAndTransparentBackground) {
  ...
  auto a_hit_test_rect = mojom::HitTestRect::New();
  a_hit_test_rect->flags = mojom::kHitTestMouse;
  a_hit_test_rect->rect = a_bounds_in_c1;
  aggregated_hit_test_region_list[2].rects.push_back(
      std::move(a_hit_test_rect));
  aggregated_hit_test_region_list[2].child_count = 0;
  ...
  auto b_hit_test_rect = mojom::HitTestRect::New();
  b_hit_test_rect->flags = mojom::kHitTestMouse;
  b_hit_test_rect->rect = b_bounds_in_c1;
  aggregated_hit_test_region_list[3].rects.push_back(
      std::move(b_hit_test_rect));
  aggregated_hit_test_region_list[3].child_count = 0;
  ...
  auto g_hit_test_rect = mojom::HitTestRect::New();
  g_hit_test_rect->flags = mojom::kHitTestMouse;
  g_hit_test_rect->rect = g_bounds_in_c2;
  aggregated_hit_test_region_list[5].rects.push_back(
      std::move(g_hit_test_rect));
  ...
  auto h_hit_test_rect = mojom::HitTestRect::New();
  h_hit_test_rect->flags = mojom::kHitTestMouse;
  h_hit_test_rect->rect = h_bounds_in_c2;
  aggregated_hit_test_region_list[6].rects.push_back(
      std::move(h_hit_test_rect));
...
TEST_F(HitTestQueryTest, MultipleLayerChild) {
  ...
  auto b_hit_test_rect = mojom::HitTestRect::New();
  b_hit_test_rect->flags = mojom::kHitTestMouse;
  b_hit_test_rect->rect = b_bounds_in_a;
  aggregated_hit_test_region_list[3].rects.push_back(
      std::move(b_hit_test_rect));
  ...
  auto g_hit_test_rect = mojom::HitTestRect::New();
  g_hit_test_rect->flags = mojom::kHitTestMouse;
  g_hit_test_rect->rect = g_bounds_in_b;
  aggregated_hit_test_region_list[4].rects.push_back(
      std::move(g_hit_test_rect));
  aggregated_hit_test_region_list[4].child_count = 0;
...
TEST_F(HitTestQueryTest, MouseTouchFlags) {
  ...
  aggregated_hit_test_region_list[0].transform = transform_e_to_e;
  auto e_hit_test_rect = mojom::HitTestRect::New();
  e_hit_test_rect->flags = mojom::kHitTestMouse | mojom::kHitTestTouch;
  e_hit_test_rect->rect = e_bounds_in_e;
  aggregated_hit_test_region_list[0].rects.push_back(
      std::move(e_hit_test_rect));
  aggregated_hit_test_region_list[0].child_count = 2;
  ...
  aggregated_hit_test_region_list[2].transform = transform_e_to_c2;
  auto c2_hit_test_rect = mojom::HitTestRect::New();
  c2_hit_test_rect->flags = mojom::kHitTestTouch;
  c2_hit_test_rect->rect = c2_bounds_in_e;
  auto c2_hit_test_rect_1 = mojom::HitTestRect::New();
  c2_hit_test_rect_1->flags = mojom::kHitTestTouch;
  c2_hit_test_rect_1->rect = gfx::Rect(500, 500, 20, 20);
  aggregated_hit_test_region_list[2].rects.push_back(
      std::move(c2_hit_test_rect));
  aggregated_hit_test_region_list[2].rects.push_back(
      std::move(c2_hit_test_rect_1));
  aggregated_hit_test_region_list[2].child_count = 0;
