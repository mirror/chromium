...
#include "components/viz/display_compositor/in_process_display_provider.h"
...
InProcessDisplayProvider::InProcessDisplayProvider(
...
InProcessDisplayProvider::~InProcessDisplayProvider() = default;

std::unique_ptr<cc::Display> InProcessDisplayProvider::CreateDisplay(
