...
#ifndef COMPONENTS_VIZ_DISPLAY_COMPOSITOR_MUS_DISPLAY_PROVIDER_H_
#define COMPONENTS_VIZ_DISPLAY_COMPOSITOR_MUS_DISPLAY_PROVIDER_H_
...
class VIZ_EXPORT InProcessDisplayProvider
    : public NON_EXPORTED_BASE(DisplayProvider) {
 public:
  InProcessDisplayProvider(
      scoped_refptr<gpu::InProcessCommandBuffer::Service> gpu_service,
      std::unique_ptr<gpu::GpuMemoryBufferManager> gpu_memory_buffer_manager,
      gpu::ImageFactory* image_factory);
  ~InProcessDisplayProvider() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(InProcessDisplayProvider);
};

}  // namespace viz

#endif  //  COMPONENTS_VIZ_DISPLAY_COMPOSITOR_MUS_DISPLAY_PROVIDER_H_
