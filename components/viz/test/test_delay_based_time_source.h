...
#ifndef COMPONENTS_VIZ_TEST_TEST_DELAY_BASED_TIME_SOURCE_H_
#define COMPONENTS_VIZ_TEST_TEST_DELAY_BASED_TIME_SOURCE_H_
...
#endif  // COMPONENTS_VIZ_TEST_TEST_DELAY_BASED_TIME_SOURCE_H_
