...
#ifndef COMPONENTS_VIZ_CLIENT_TEXTURE_ALLOCATION_H_
#define COMPONENTS_VIZ_CLIENT_TEXTURE_ALLOCATION_H_
...
class VIZ_CLIENT_EXPORT TextureAllocation {
 public:
  GLuint texture_id = 0;
...
#endif  // COMPONENTS_VIZ_CLIENT_TEXTURE_ALLOCATION_H_
