...
class SharedBitmapAllocationObserver {
 public:
  virtual void DidAllocateSharedBitmap(
      uint32_t last_shared_bitmap_sequence_number) = 0;
};
...
class VIZ_SERVICE_EXPORT SharedBitmapAllocationNotifierImpl
 ...
 public:
  ...
  uint32_t last_shared_bitmap_sequence_number() {
    return last_shared_bitmap_sequence_number_;
  }
 ...
 private:
  ...
  uint32_t last_shared_bitmap_sequence_number_ = 0;
