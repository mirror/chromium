...
#ifndef COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_SURFACELESS_DISPLAY_OUTPUT_SURFACE_H_
#define COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_SURFACELESS_DISPLAY_OUTPUT_SURFACE_H_
...
class SurfacelessDisplayOutputSurface : public DisplayOutputSurface {
 public:
  ...
  ~SurfacelessDisplayOutputSurface() override;
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(SurfacelessDisplayOutputSurface);
};

}  // namespace viz

#endif  // COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_SURFACELESS_DISPLAY_OUTPUT_SURFACE_H_
