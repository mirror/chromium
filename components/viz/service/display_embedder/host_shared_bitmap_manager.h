...
#ifndef COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_HOST_SHARED_BITMAP_MANAGER_H_
#define COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_HOST_SHARED_BITMAP_MANAGER_H_
...
#endif  // COMPONENTS_VIZ_SERVICE_DISPLAY_EMBEDDER_HOST_SHARED_BITMAP_MANAGER_H_
