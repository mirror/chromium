...
// HitTestAggregator queries HitTestManager for active HitTestRegionList
// objects and aggregates them into a list of HitTestRegion elements
// made available in shared memory to be used by HitTestQuery to
// enable efficient hit testing across processes.
//
...
class VIZ_SERVICE_EXPORT HitTestAggregator {
 public:
  ...
  HitTestAggregator(HitTestManager* hit_test_manager,
 ...
 protected:
  HitTestManager* const hit_test_manager_;
 ...
 private:
  ...
  // Accesses to the HitTestRegion list is localized to this call
