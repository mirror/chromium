...
// HitTestAggregator assembles the list of HitTestRegion
// objects that define the hit test information required
// for one display. Active HitTestRegionList information is
// obtained from the HitTestManager.  The resulting list
// is made available in shared memory and used by HitTestQuery to
