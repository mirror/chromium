...
TEST_F(HitTestAggregatorTest, OneEmbedderTwoChildren) {
  ...
  e_hit_test_region_c1->frame_sink_id = e_surface_id.frame_sink_id();
  e_hit_test_region_c1->local_surface_id = e_surface_id.local_surface_id();
...
TEST_F(HitTestAggregatorTest, OccludedChildFrame) {
  ...
  e_hit_test_region_c->frame_sink_id = e_surface_id.frame_sink_id();
  e_hit_test_region_c->local_surface_id = e_surface_id.local_surface_id();
...
TEST_F(HitTestAggregatorTest, ClippedChildWithTabAndTransparentBackground) {
  ...
  c_hit_test_region_a->frame_sink_id = e_surface_id.frame_sink_id();
  c_hit_test_region_a->local_surface_id = e_surface_id.local_surface_id();
  ...
  c_hit_test_region_b->frame_sink_id = e_surface_id.frame_sink_id();
  c_hit_test_region_b->local_surface_id = e_surface_id.local_surface_id();
...
TEST_F(HitTestAggregatorTest, ThreeChildrenDeep) {
  ...
  c2_hit_test_region_c3->frame_sink_id = e_surface_id.frame_sink_id();
  c2_hit_test_region_c3->local_surface_id = e_surface_id.local_surface_id();
