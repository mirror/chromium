 ...
 public:
  ...
  std::unique_ptr<Display> CreateDisplay() {
    ...
    auto scheduler = base::MakeUnique<DisplayScheduler>(
        new StubBeginFrameSource(), new base::NullTaskRunner(), 1);
    ...
    auto display = base::MakeUnique<Display>(
        new ServerSharedBitmapManager(),
        nullptr /* gpu_memory_buffer_manager */, RendererSettings(),
        frame_sink_id, std::move(output_surface), std::move(scheduler),
  ...
  void IterateOverlapShareQuadStates(const std::string& test_name,
                                     ...
                                     int quad_count) {
    frame_ = base::MakeUnique<CompositorFrame>(CompositorFrame());
...
TEST_F(RemoveOverdrawQuadPerfTest, IterateOverlapShareQuadStates) {
  IterateOverlapShareQuadStates("4_sqs_4_quads", 2, 2);
  IterateOverlapShareQuadStates("4_sqs_100_quads", 2, 10);
  IterateOverlapShareQuadStates("100_sqs_4_quads", 10, 2);
  IterateOverlapShareQuadStates("100_sqs_100_quads", 10, 10);
}

TEST_F(RemoveOverdrawQuadPerfTest, IterateIsolatedSharedQuadStates) {
  IterateIsolatedSharedQuadStates("2_sqs_4_quads", 2, 2);
  IterateIsolatedSharedQuadStates("2_sqs_100_quads", 2, 10);
  IterateIsolatedSharedQuadStates("10_sqs_4_quads", 10, 2);
  IterateIsolatedSharedQuadStates("10_sqs_100_quads", 10, 10);
}

TEST_F(RemoveOverdrawQuadPerfTest, IteratePatriallyOverlapSharedQuadStates) {
  IteratePatriallyOverlapSharedQuadStates("2_sqs_4_quads", 2, 0.5, 2);
  IteratePatriallyOverlapSharedQuadStates("2_sqs_100_quads", 2, 0.5, 10);
  IteratePatriallyOverlapSharedQuadStates("10_sqs_4_quads", 10, 0.5, 2);
  IteratePatriallyOverlapSharedQuadStates("10_sqs_100_quads", 10, 0.5, 10);
}

TEST_F(RemoveOverdrawQuadPerfTest, IterateAdjacentSharedQuadStates) {
  IterateAdjacentSharedQuadStates("4_sqs_4_quads", 2, 2);
  IterateAdjacentSharedQuadStates("4_sqs_100_quads", 2, 10);
  IterateAdjacentSharedQuadStates("100_sqs_4_quads", 10, 2);
  IterateAdjacentSharedQuadStates("100_sqs_100_quads", 10, 10);
}
