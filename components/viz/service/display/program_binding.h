...
class VIZ_SERVICE_EXPORT Program : public ProgramBindingBase {
 public:
  ...
  int temperature_blue_scale_location() const {
    return fragment_shader_.temperature_blue_scale_location_;
  }
  int temperature_green_scale_location() const {
    return fragment_shader_.temperature_green_scale_location_;
  }
