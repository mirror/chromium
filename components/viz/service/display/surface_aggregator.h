...
class VIZ_SERVICE_EXPORT SurfaceAggregator {
 public:
  using SurfaceIndexMap = base::flat_map<cc::SurfaceId, int>;
  ...
  cc::CompositorFrame Aggregate(const cc::SurfaceId& surface_id);
  void ReleaseResources(const cc::SurfaceId& surface_id);
  SurfaceIndexMap& previous_contained_surfaces() {
    return previous_contained_surfaces_;
  }
  void SetFullDamageForSurface(const cc::SurfaceId& surface_id);
 ...
 private:
  ...
  struct PrewalkResult {
    ...
    base::flat_set<cc::SurfaceId> undrawn_surfaces;
  ...
  void CopyQuadsToPass(
      ...
      cc::RenderPass* dest_pass,
      const cc::SurfaceId& surface_id);
  gfx::Rect PrewalkTree(const cc::SurfaceId& surface_id,
  ...
  void UnrefResources(const cc::SurfaceId& surface_id,
  ...
  base::flat_map<std::pair<cc::SurfaceId, cc::RenderPassId>, RenderPassInfo>
  ...
  base::flat_map<cc::SurfaceId, int> surface_id_to_resource_child_id_;
  ...
  // detect cycles.
  base::flat_set<cc::SurfaceId> referenced_surfaces_;
  ...
  base::flat_set<cc::SurfaceId> valid_surfaces_;
