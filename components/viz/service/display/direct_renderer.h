...
class VIZ_SERVICE_EXPORT DirectRenderer {
 ...
 protected:
  ...
  bool UseRenderPass(RenderPass* render_pass);
  ...
  virtual bool AllocateRenderPassResourceIfNeeded(
      const RenderPassId render_pass_id,
      const gfx::Size& enlarged_size,
      cc::ResourceProvider::TextureHint texturehint) = 0;
  ...
  virtual bool BindFramebufferToTexture(const RenderPassId render_pass_id) = 0;
