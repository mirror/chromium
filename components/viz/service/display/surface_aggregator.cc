...
void SurfaceAggregator::HandleSurfaceQuad(
  ...
  SurfaceId surface_id = surface_quad->primary_surface_id;
  ...
  if (!has_transparent_background && !primary_surface_quad) {
...
void SurfaceAggregator::EmitFallbackSurface(
  ...
  HandleSurfaceQuad(false /* primary_surface_quad */,
                    &fallback_surface_draw_quad, primary_rect, target_transform,
...
void SurfaceAggregator::CopyQuadsToPass(
  ...
  for (auto* quad : source_quad_list) {
    if (quad->material == DrawQuad::SURFACE_CONTENT) {
      ...
      HandleSurfaceQuad(true /* primary_surface_quad */, surface_quad,
                        surface_quad->rect, target_transform, clip_rect,
                        dest_pass, ignore_undamaged, &damage_rect_in_quad_space,
                        &damage_rect_in_quad_space_valid);
    } else {
