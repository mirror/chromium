...
constexpr cc::FrameSinkId kArbitraryRootFrameSinkId(1, 1);
constexpr cc::FrameSinkId kArbitraryFrameSinkId1(2, 2);
constexpr cc::FrameSinkId kArbitraryFrameSinkId2(3, 3);
constexpr cc::FrameSinkId kArbitraryMiddleFrameSinkId(4, 4);
constexpr cc::FrameSinkId kArbitraryReservedFrameSinkId(5, 5);
constexpr cc::FrameSinkId kArbitraryFrameSinkId3(6, 6);
...
cc::SurfaceId InvalidSurfaceId() {
  static cc::SurfaceId invalid(cc::FrameSinkId(),
                               cc::LocalSurfaceId(0xdeadbeef, kArbitraryToken));
  return invalid;
}
...
class SurfaceAggregatorTest : public testing::Test {
 public:
  ...
  struct Quad {
    ...
    static Quad SurfaceQuad(const cc::SurfaceId& primary_surface_id,
                            const cc::SurfaceId& fallback_surface_id,
                            float opacity) {
      Quad quad;
    ...
    cc::SurfaceId primary_surface_id;
    cc::SurfaceId fallback_surface_id;
    float opacity;
 ...
 private:
  static void AddSurfaceQuad(cc::RenderPass* pass,
                             ...
                             float opacity,
                             const cc::SurfaceId& primary_surface_id,
                             const cc::SurfaceId& fallback_surface_id) {
...
class SurfaceAggregatorValidSurfaceTest : public SurfaceAggregatorTest {
 public:
  ...
  void SetUp() override {
    ...
    root_surface_ = manager_.surface_manager()->GetSurfaceForId(
        cc::SurfaceId(support_->frame_sink_id(), root_local_surface_id_));
  }
 ...
 protected:
  ...
  cc::LocalSurfaceIdAllocator child_allocator_;
};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, SimpleFrame) {
  ...
  cc::SurfaceId root_surface_id(support_->frame_sink_id(),
                                root_local_surface_id_);
  cc::SurfaceId ids[] = {root_surface_id};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, OpacityCopied) {
  ...
  cc::LocalSurfaceId embedded_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId embedded_surface_id(embedded_support->frame_sink_id(),
...
TEST_F(SurfaceAggregatorValidSurfaceTest, MultiPassDeallocation) {
  ...
  cc::SurfaceId surface_id(support_->frame_sink_id(), root_local_surface_id_);
...
TEST_F(SurfaceAggregatorValidSurfaceTest, SimpleSurfaceReference) {
  ...
  cc::SurfaceId root_surface_id(support_->frame_sink_id(),
                                root_local_surface_id_);
  cc::SurfaceId ids[] = {root_surface_id, embedded_surface_id};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, FallbackSurfaceReference) {
  auto primary_child_support = CompositorFrameSinkSupport::Create(
      ...
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId primary_child_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId primary_child_surface_id(primary_child_support->frame_sink_id(),
  ...
  auto fallback_child_support = CompositorFrameSinkSupport::Create(
      ...
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId fallback_child_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId fallback_child_surface_id(
  ...
  cc::SurfaceId root_surface_id(support_->frame_sink_id(),
                                root_local_surface_id_);
  cc::SurfaceId ids[] = {root_surface_id, primary_child_surface_id,
                         fallback_child_surface_id};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, CopyRequest) {
  ...
  cc::SurfaceId surface_ids[] = {root_surface_id, embedded_surface_id};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, UnreferencedSurface) {
  ...
  cc::SurfaceId embedded_surface_id(embedded_support->frame_sink_id(),
                                    embedded_local_surface_id);
  cc::SurfaceId nonexistent_surface_id(support_->frame_sink_id(),
  ...
  cc::LocalSurfaceId parent_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId parent_surface_id(parent_support->frame_sink_id(),
...
TEST_F(SurfaceAggregatorValidSurfaceTest, MultiPassSurfaceReference) {
  cc::LocalSurfaceId embedded_local_surface_id = child_allocator_.GenerateId();
  cc::SurfaceId embedded_surface_id(child_support_->frame_sink_id(),
                                    embedded_local_surface_id);
...
TEST_F(SurfaceAggregatorValidSurfaceTest, InvalidSurfaceReference) {
  ...
  cc::SurfaceId root_surface_id(support_->frame_sink_id(),
                                root_local_surface_id_);
  cc::SurfaceId ids[] = {root_surface_id, InvalidSurfaceId()};
...
TEST_F(SurfaceAggregatorValidSurfaceTest, ValidSurfaceReferenceWithNoFrame) {
  cc::LocalSurfaceId empty_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId surface_with_no_frame_id(support_->frame_sink_id(),
  ...
  cc::SurfaceId root_surface_id(support_->frame_sink_id(),
                                root_local_surface_id_);
  cc::SurfaceId ids[] = {root_surface_id, surface_with_no_frame_id};
  AggregateAndVerify(expected_passes, arraysize(expected_passes), ids,
                     arraysize(ids));
}
...
TEST_F(SurfaceAggregatorValidSurfaceTest, TwoSurfaceCyclicalReference) {
  cc::LocalSurfaceId child_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId child_surface_id(child_support_->frame_sink_id(),
  ...
  Quad expected_quads[] = {Quad::SolidColorQuad(SK_ColorBLUE),
                           ...
                           Quad::SolidColorQuad(SK_ColorCYAN)};
  Pass expected_passes[] = {Pass(expected_quads, arraysize(expected_quads))};
  cc::SurfaceId ids[] = {root_surface_id, child_surface_id};
  AggregateAndVerify(expected_passes, arraysize(expected_passes), ids,
                     arraysize(ids));
}
...
TEST_F(SurfaceAggregatorValidSurfaceTest, AggregateSharedQuadStateProperties) {
  ...
  auto child_two_support = CompositorFrameSinkSupport::Create(
      ...
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  int pass_id = 1;
  cc::LocalSurfaceId grandchild_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId grandchild_surface_id(grandchild_support->frame_sink_id(),
  ...
  cc::LocalSurfaceId child_one_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId child_one_surface_id(child_one_support->frame_sink_id(),
  ...
  cc::LocalSurfaceId child_two_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId child_two_surface_id(child_two_support->frame_sink_id(),
...
TEST_F(SurfaceAggregatorValidSurfaceTest, AggregateMultiplePassWithTransform) {
  ...
  cc::LocalSurfaceId middle_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId middle_surface_id(middle_support->frame_sink_id(),
...
TEST_F(SurfaceAggregatorValidSurfaceTest, SwitchSurfaceDamage) {
  ...
  cc::LocalSurfaceId second_root_local_surface_id = allocator_.GenerateId();
  cc::SurfaceId second_root_surface_id(support_->frame_sink_id(),
...
TEST_F(SurfaceAggregatorWithResourcesTest, TakeResourcesOneSurface) {
  ...
  auto support = CompositorFrameSinkSupport::Create(
      ...
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId local_surface_id(7u, base::UnguessableToken::Create());
  cc::SurfaceId surface_id(support->frame_sink_id(), local_surface_id);

  cc::ResourceId ids[] = {11, 12, 13};
  SubmitCompositorFrameWithResources(ids, arraysize(ids), true, cc::SurfaceId(),
  ...
  SubmitCompositorFrameWithResources(NULL, 0u, true, cc::SurfaceId(),
                                     support.get(), surface_id);
...
TEST_F(SurfaceAggregatorWithResourcesTest, ReturnResourcesAsSurfacesChange) {
  ...
  auto support = CompositorFrameSinkSupport::Create(
      &client, &manager_, kArbitraryRootFrameSinkId, kRootIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId local_surface_id1(7u, base::UnguessableToken::Create());
  cc::LocalSurfaceId local_surface_id2(8u, base::UnguessableToken::Create());
  cc::SurfaceId surface_id1(support->frame_sink_id(), local_surface_id1);
  cc::SurfaceId surface_id2(support->frame_sink_id(), local_surface_id2);
  ...
  SubmitCompositorFrameWithResources(nullptr, 0u, true, cc::SurfaceId(),
...
TEST_F(SurfaceAggregatorWithResourcesTest, TakeInvalidResources) {
  ...
  SubmitCompositorFrameWithResources(NULL, 0, true, cc::SurfaceId(),
                                     support.get(), surface_id);
...
TEST_F(SurfaceAggregatorWithResourcesTest, TwoSurfaces) {
  ...
  auto support1 = CompositorFrameSinkSupport::Create(
      &client, &manager_, cc::FrameSinkId(1, 1), kChildIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  auto support2 = CompositorFrameSinkSupport::Create(
      &client, &manager_, cc::FrameSinkId(2, 2), kChildIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId local_frame1_id(7u, base::UnguessableToken::Create());
  cc::SurfaceId surface1_id(support1->frame_sink_id(), local_frame1_id);

  cc::LocalSurfaceId local_frame2_id(8u, base::UnguessableToken::Create());
  cc::SurfaceId surface2_id(support2->frame_sink_id(), local_frame2_id);
...
TEST_F(SurfaceAggregatorWithResourcesTest, InvalidChildSurface) {
  ...
  auto child_support = CompositorFrameSinkSupport::Create(
      nullptr, &manager_, kArbitraryFrameSinkId1, kChildIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId root_local_surface_id(7u, kArbitraryToken);
  cc::SurfaceId root_surface_id(root_support->frame_sink_id(),
                                root_local_surface_id);
  cc::LocalSurfaceId middle_local_surface_id(8u, kArbitraryToken);
  cc::SurfaceId middle_surface_id(middle_support->frame_sink_id(),
                                  middle_local_surface_id);
  cc::LocalSurfaceId child_local_surface_id(9u, kArbitraryToken);
  cc::SurfaceId child_surface_id(child_support->frame_sink_id(),
                                 child_local_surface_id);
...
TEST_F(SurfaceAggregatorWithResourcesTest, SecureOutputTexture) {
  auto support1 = CompositorFrameSinkSupport::Create(
      nullptr, &manager_, cc::FrameSinkId(1, 1), kChildIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  auto support2 = CompositorFrameSinkSupport::Create(
      nullptr, &manager_, cc::FrameSinkId(2, 2), kChildIsRoot,
      kHandlesFrameSinkIdInvalidation, kNeedsSyncPoints);
  cc::LocalSurfaceId local_frame1_id(7u, base::UnguessableToken::Create());
  cc::SurfaceId surface1_id(support1->frame_sink_id(), local_frame1_id);
