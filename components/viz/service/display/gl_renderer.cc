...
std::unique_ptr<cc::ScopedResource> GLRenderer::GetBackdropTexture(
  ...
  device_background_texture->Allocate(
      ...
      true);
  {
    cc::DisplayResourceProvider::ScopedLocalWriteGL local_resource(
...
sk_sp<SkImage> GLRenderer::ApplyBackgroundFilters(
  ...
  cc::DisplayResourceProvider::ScopedLocalReadGL local_resource(
    ...
    if (filter) {
      ...
      if (filter) {
        ...
        if (params->contents_texture->local()) {
          cc::DisplayResourceProvider::ScopedLocalReadGL
              prefilter_contents_texture_local(resource_provider_,
...
bool GLRenderer::BindFramebufferToTexture(const cc::ScopedResource* texture) {
  ...
  current_framebuffer_lock_ =
      base::MakeUnique<cc::DisplayResourceProvider::ScopedLocalWriteGL>(
...
void GLRenderer::CopyRenderPassDrawQuadToOverlayResource(
  ...
  *new_bounds =
  ...
  cc::DisplayResourceProvider::ScopedLocalWriteGL destination(
