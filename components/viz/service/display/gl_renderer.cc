...
struct DrawRenderPassDrawQuadParams {
  ...
  // The color space being drawn into.
...
void GLRenderer::DrawRenderPassQuad(const RenderPassDrawQuad* quad,
  ...
  params.target_color_space = current_frame()->current_render_pass->color_space;
...
void GLRenderer::ChooseRPDQProgram(DrawRenderPassDrawQuadParams* params) {
  ...
  SetUseProgram(ProgramKey::RenderPass(
                ...
                params->contents_color_space, params->target_color_space);
}
...
void GLRenderer::CopyRenderPassDrawQuadToOverlayResource(
  ...
  params.target_color_space = current_frame()->root_render_pass->color_space;
