...
GLuint GLRendererCopier::RenderResultTexture(
  ...
  if (request.is_scaled()) {
    ...
    scaler->Scale(source_texture, source_texture_size, src_offset,
...
void GLRendererCopier::StartI420ReadbackFromTexture(
  ...
  converter->Convert(source_texture, source_texture_size, src_offset, nullptr,
                     result_rect, plane_textures[0], plane_textures[1],
                     plane_textures[2]);
