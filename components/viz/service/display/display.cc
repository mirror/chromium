...
void Display::RemoveOverdrawQuads(CompositorFrame* frame) {
  ...
  UMA_HISTOGRAM_COUNTS_1000(
      ...
      (float)total_area_saved_in_px * 100 /
          (float)total_quad_area_shown_wo_occlusion_px);
  UMA_HISTOGRAM_COUNTS_1000(
      "Compositing.Display.Draw.Occlusion.Percentage.Draw",
      (float)(total_quad_area_shown_wo_occlusion_px - total_area_saved_in_px) *
          100 / (float)total_quad_area_shown_wo_occlusion_px);
  UMA_HISTOGRAM_COUNTS_1000(
