...
static constexpr cc::FrameSinkId kArbitraryFrameSinkId(3, 3);
static constexpr cc::FrameSinkId kAnotherFrameSinkId(4, 4);
...
class TestDisplayScheduler : public DisplayScheduler {
 public:
  ...
  void SetNewRootSurface(const cc::SurfaceId& root_surface_id) override {
    has_new_root_surface = true;
  }

  void ProcessSurfaceDamage(const cc::SurfaceId& surface_id,
...
TEST_F(DisplayTest, DisplayDamaged) {
  ...
  cc::LocalSurfaceId local_surface_id(id_allocator_.GenerateId());
...
TEST_F(DisplayTest, Finish) {
  cc::LocalSurfaceId local_surface_id1(id_allocator_.GenerateId());
  cc::LocalSurfaceId local_surface_id2(id_allocator_.GenerateId());
