...
class GLRendererCopierPixelTest
 ...
 public:
  ...
  static void TearDownTestCase() { delete source_bitmap_; }
 ...
 protected:
  ...
  static SkBitmap* source_bitmap_;
...
SkBitmap* GLRendererCopierPixelTest::source_bitmap_ = nullptr;
...
TEST_P(GLRendererCopierPixelTest, ExecutesCopyRequest) {
  ...
  EXPECT_TRUE(cc::MatchesPNGFile(actual, png_file_path,
