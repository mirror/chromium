...
class DisplayPerftest : public testing::Test {
 public:
  DisplayPerftest()
      : timer_(kWarmupRuns,
...
TEST_F(DisplayPerftest, IterateOverlapShareQuadStates) {
...
TEST_F(DisplayPerftest, IterateIsolatedSharedQuadStates) {
...
TEST_F(DisplayPerftest, IteratePatriallyOverlapSharedQuadStates) {
...
TEST_F(DisplayPerftest, IterateAdjacentSharedQuadStates) {
