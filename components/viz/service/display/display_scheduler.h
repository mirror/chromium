...
class VIZ_SERVICE_EXPORT DisplaySchedulerClient {
 public:
  ...
  virtual bool SurfaceHasUndrawnFrame(
      const cc::SurfaceId& surface_id) const = 0;
  virtual bool SurfaceDamaged(const cc::SurfaceId& surface_id,
                              const cc::BeginFrameAck& ack) = 0;
  virtual void SurfaceDiscarded(const cc::SurfaceId& surface_id) = 0;
};
...
class VIZ_SERVICE_EXPORT DisplayScheduler : public cc::BeginFrameObserverBase,
 ...
 public:
  ...
  virtual void SetNewRootSurface(const cc::SurfaceId& root_surface_id);
  virtual void ProcessSurfaceDamage(const cc::SurfaceId& surface_id,
 ...
 protected:
  ...
  base::flat_map<cc::SurfaceId, SurfaceBeginFrameState> surface_states_;
