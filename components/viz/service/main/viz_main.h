...
#ifndef COMPONENTS_VIZ_SERVICE_MAIN_VIZ_MAIN_H_
#define COMPONENTS_VIZ_SERVICE_MAIN_VIZ_MAIN_H_
...
class VizMain : public gpu::GpuSandboxHelper, public mojom::VizMain {
 public:
  struct LogMessage {
    int severity;
    std::string header;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(VizMain);
};

}  // namespace viz

#endif  // COMPONENTS_VIZ_SERVICE_MAIN_VIZ_MAIN_H_
