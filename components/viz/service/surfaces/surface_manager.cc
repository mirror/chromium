...
SurfaceManager::SurfaceManager(LifetimeType lifetime_type)
  ...
  if (using_surface_references()) {
    ...
    temporary_reference_timer_.Start(FROM_HERE,
                                     base::TimeDelta::FromSeconds(10), this,
                                     &SurfaceManager::MarkTemporaryReference);
  } else {
    reference_factory_ =
...
void SurfaceManager::MarkTemporaryReference() {
