...
void Surface::UpdateActivationDependencies(
  ...
  ComputeChangeInDependencies(frame_sink_id_dependencies_,
                              new_frame_sink_id_dependencies,
