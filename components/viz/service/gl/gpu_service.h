...
#ifndef COMPONENTS_VIZ_SERVICE_GL_GPU_SERVICE_H_
#define COMPONENTS_VIZ_SERVICE_GL_GPU_SERVICE_H_
...
class VIZ_SERVICE_EXPORT GpuService : public gpu::GpuChannelManagerDelegate,
...
#endif  // COMPONENTS_VIZ_SERVICE_GL_GPU_SERVICE_H_
