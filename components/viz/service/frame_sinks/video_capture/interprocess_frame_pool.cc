...
scoped_refptr<VideoFrame> InterprocessFramePool::ReserveVideoFrame(
  ...
  PoolBufferId ignored;  // Not applicable to this buffer pool use case.
  const PoolBufferId buffer_id = buffer_pool_->ReserveForProducer(
...
scoped_refptr<VideoFrame> InterprocessFramePool::ResurrectLastVideoFrame(
  ...
  const PoolBufferId buffer_id = buffer_pool_->ResurrectLastForProducer(
...
base::OnceClosure InterprocessFramePool::HoldFrameForDelivery(
  ...
  const PoolBufferId buffer_id = it->second;
