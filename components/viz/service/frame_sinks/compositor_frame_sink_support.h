...
class VIZ_SERVICE_EXPORT CompositorFrameSinkSupport
 ...
 public:
  ...
  // Viz hit-test setup is only called when both |is_root_| and
  // features::IsVizHitTestingEnabled() are true (except on android webview).
  void SetUpHitTest();
 ...
 private:
  ...
  // features::IsVizHitTestingEnabled()) is true.
