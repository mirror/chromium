...
class VIZ_SERVICE_EXPORT CompositorFrameSinkSupport
 ...
 public:
  ...
  bool SubmitCompositorFrame(const cc::LocalSurfaceId& local_surface_id,
 ...
 private:
  ...
  cc::SurfaceReference MakeTopLevelRootReference(
  ...
  base::Optional<cc::LocalSurfaceId> referenced_local_surface_id_;
