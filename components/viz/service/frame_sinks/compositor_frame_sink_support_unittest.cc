...
class FakeFrameSinkManagerClient : public mojom::FrameSinkManagerClient {
 public:
  ...
  void SetAssignTemporaryReference(const SurfaceId& surface_id,
...
TEST_F(CompositorFrameSinkSupportTest, InvalidateFrameSinkId) {
  ...
  SurfaceId surface_id(support_->frame_sink_id(), local_surface_id);

  frame_sink_manager_client_.SetAssignTemporaryReference(surface_id,
