...
void MultiContextProvider::AddRef() const {
  base::RefCountedThreadSafe<MultiContextProvider>::AddRef();
}

void MultiContextProvider::Release() const {
  base::RefCountedThreadSafe<MultiContextProvider>::Release();
}
