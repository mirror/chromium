...
VIZ_COMMON_EXPORT unsigned int GLDataType(ResourceFormat format);
VIZ_COMMON_EXPORT unsigned int GLDataFormat(ResourceFormat format);
VIZ_COMMON_EXPORT unsigned int GLInternalFormat(ResourceFormat format);
VIZ_COMMON_EXPORT unsigned int GLCopyTextureInternalFormat(
