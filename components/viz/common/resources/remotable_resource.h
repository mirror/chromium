...
struct VIZ_COMMON_EXPORT RemotableResource {
  ...
  // An abstract interface held by the RemotableResource, and implemented and
  // used internally to implement sharing resources between client and service.
  // TODO(danakj): Move this out of internal, it's used by the DirectRenderer
  // impls.
