...
const base::Feature kEnableOutOfProcessDisplay{
    "OutOfProcessDisplay", base::FEATURE_DISABLED_BY_DEFAULT};
...
bool IsSurfaceSynchronizationEnabled() {
  ...
  return base::FeatureList::IsEnabled(kEnableSurfaceSynchronization) ||
         ...
         base::FeatureList::IsEnabled(kEnableOutOfProcessDisplay);
}
