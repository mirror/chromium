...
struct VIZ_COMMON_EXPORT BeginFrameArgs {
  ...
  //
  // Observers have to explicitly opt-in to receiving side-effects-only
  // BeginFrames via BeginFrameObserver::WantsSideEffectsOnlyBeginFrames.
  //
