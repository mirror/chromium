...
class VIZ_COMMON_EXPORT CopyOutputResult {
 public:
  enum class Format : uint8_t {
    ...
    // internally within the VIZ component to support video capture.
    I420_PLANES,
  };
  ...
  // memory. Returns true if successful, or false if: 1) the arguments were
  // invalid, 2) this result is empty, or 3) the result format is not
  // I420_PLANES and does not provide a conversion implementation.
  //
