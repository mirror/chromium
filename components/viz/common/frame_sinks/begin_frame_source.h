...
class VIZ_COMMON_EXPORT BeginFrameObserver {
 public:
  ...
  // Whether the observer also wants to receive side-effects-only BeginFrames.
  virtual bool WantsSideEffectsOnlyBeginFrames() const = 0;
};
...
class VIZ_COMMON_EXPORT BeginFrameObserverBase : public BeginFrameObserver {
 ...
 protected:
  ...
  bool wants_side_effects_only_begin_frames_ = false;
