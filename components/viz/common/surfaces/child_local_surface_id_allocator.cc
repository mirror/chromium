...
LocalSurfaceId ChildLocalSurfaceIdAllocator::UpdateFromParent(
  ...
  nonce_ = parent_allocated_local_surface_id.nonce();
  return LocalSurfaceId(parent_sequence_number_, current_child_sequence_number_,
                        nonce_);
}
