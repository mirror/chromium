...
#ifndef COMPONENTS_VIZ_COMMON_DISPLAY_DISPLAY_RESOURCE_PROVIDER_H_
#define COMPONENTS_VIZ_COMMON_DISPLAY_DISPLAY_RESOURCE_PROVIDER_H_
...
// created on.
class VIZ_COMMON_EXPORT DisplayResourceProvider : public ResourceProvider {
 public:
  ...
  void SendPromotionHints(const ResourceToRectMap& promotion_hints);
#endif
  ...
  class VIZ_COMMON_EXPORT ScopedReadLockGL {
   public:
  ...
  class VIZ_COMMON_EXPORT ScopedSamplerGL {
   public:
  ...
  class VIZ_COMMON_EXPORT ScopedReadLockSkImage {
   public:
  ...
  class VIZ_COMMON_EXPORT ScopedReadLockSoftware {
   public:
  ...
  class VIZ_COMMON_EXPORT ScopedBatchReturnResources {
   public:
  ...
  int CreateChild(const cc::ReturnCallback& return_callback);
 ...
 private:
  ...
  struct Child {
    ...
    cc::ReturnCallback return_callback;
...
#endif  // COMPONENTS_VIZ_COMMON_DISPLAY_DISPLAY_RESOURCE_PROVIDER_H_
