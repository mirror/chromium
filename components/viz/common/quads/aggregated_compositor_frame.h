...
#ifndef COMPONENTS_VIZ_COMMON_QUADS_AGGREGATED_COMPOSITOR_FRAME_H_
#define COMPONENTS_VIZ_COMMON_QUADS_AGGREGATED_COMPOSITOR_FRAME_H_
...
// frame.
class VIZ_COMMON_EXPORT AggregatedCompositorFrame {
 public:
  AggregatedCompositorFrame();
  AggregatedCompositorFrame(AggregatedCompositorFrame&& other);
  ~AggregatedCompositorFrame();

  AggregatedCompositorFrame& operator=(AggregatedCompositorFrame&& other);
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(AggregatedCompositorFrame);
};

}  // namespace viz

#endif  // COMPONENTS_VIZ_COMMON_QUADS_AGGREGATED_COMPOSITOR_FRAME_H_
