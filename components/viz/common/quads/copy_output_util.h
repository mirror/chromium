...
#ifndef COMPONENTS_VIZ_COMMON_QUADS_COPY_OUTPUT_UTIL_H_
#define COMPONENTS_VIZ_COMMON_QUADS_COPY_OUTPUT_UTIL_H_
...
#endif  // COMPONENTS_VIZ_COMMON_QUADS_COPY_OUTPUT_UTIL_H_
