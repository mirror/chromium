...
class FileHelper {
 public:
  ...
  // Converts natife file path to URL which can be used in container.  We don't
  ...
  // Converts filesystem:// URL to something which can conatiners understand.
  // e.g. content:// URI for ARC container.
  virtual bool ConvertFileSystemUrlForContainer(const GURL& file_system_url,
                                                GURL* out) = 0;
};
