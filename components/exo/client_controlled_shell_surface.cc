...
void ClientControlledShellSurface::Restore() {
  TRACE_EVENT0("exo", "ClientControlledShellSurface::Restore");
  if (!widget_)
    return;
...
void ClientControlledShellSurface::Minimize() {
  TRACE_EVENT0("exo", "ClientControlledShellSurface::Minimize");
  if (!widget_)
...
void ClientControlledShellSurface::Maximize() {
  TRACE_EVENT0("exo", "ClientControlledShellSurface::Maximize");
