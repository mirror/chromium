...
class WaylandDataOfferDelegate : public DataOfferDelegate {
 public:
  ...
  void Action(uint32_t action) { wl_data_offer_send_action(offer_, action); }
...
void data_device_manager_get_data_device(wl_client* client,
  ...
  SetImplementation(
      ...
      base::MakeUnique<DataDevice>(GetUserDataAs<DataDeviceManager>(resource),
                                   base::MakeUnique<WaylandDataDeviceDelegate>(
