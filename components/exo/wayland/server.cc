...
class SeatDelegate {
 public:
  SeatDelegate(wl_resource* resource)
...
void seat_get_pointer(wl_client* client, wl_resource* resource, uint32_t id) {
  GetUserDataAs<SeatDelegate>(resource)->GetPointer(client, id);
}

void seat_get_keyboard(wl_client* client, wl_resource* resource, uint32_t id) {
  GetUserDataAs<SeatDelegate>(resource)->GetKeyboard(client, id);
}

void seat_get_touch(wl_client* client, wl_resource* resource, uint32_t id) {
  GetUserDataAs<SeatDelegate>(resource)->GetTouch(client, id);
}
...
void bind_seat(wl_client* client, void* data, uint32_t version, uint32_t id) {
  ...
  SetImplementation(resource, &seat_implementation,
                    std::make_unique<SeatDelegate>(resource));
