...
class EventTimes {
 public:
  void push_pointer_timestamp() { push_timestamp(&pointer_timestamp); }
  void push_touch_timestamp() { push_timestamp(&touch_timestamp); }
 ...
 private:
  void push_timestamp(base::TimeTicks* timestamp) {
...
void PointerMotion(void* data,
  ...
  event_times->push_pointer_timestamp();
}
...
void TouchMotion(void* data,
  ...
  event_times->push_touch_timestamp();
}
