 ...
 public:
  ...
  ScopedVulkanRenderFrame(VulkanClient* client,
    ...
    VkCommandBufferAllocateInfo command_buffer_allocate_info{
        ...
        .commandPool = client->vk_command_pool_,
        .level = VK_COMMAND_BUFFER_LEVEL_PRIMARY,
        .commandBufferCount = 1,
    };

    VkResult result = vkAllocateCommandBuffers(
        client_->vk_device_, &command_buffer_allocate_info, &command_buffer_);
    ...
    VkRenderPassBeginInfo render_pass_begin_info{
        ...
        .renderPass = client_->vk_renderpass_,
  ...
  ~ScopedVulkanRenderFrame() {
    ...
    vkFreeCommandBuffers(client_->vk_device_, client_->vk_command_pool_, 1,
                         &command_buffer_);
  }
