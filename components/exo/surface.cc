...
void Surface::RemoveSubSurface(Surface* sub_surface) {
  ...
  const auto sub_surface_iter = FindListEntry(sub_surfaces_, sub_surface);
  Damage({sub_surface_iter->second, sub_surface->content_size()});
  sub_surfaces_.erase(sub_surface_iter);
