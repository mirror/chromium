...
#ifndef COMPONENT_EXO_TEST_WAYLAND_CLIENT_TEST_H_
#define COMPONENT_EXO_TEST_WAYLAND_CLIENT_TEST_H_
...
class WaylandClientTest : public ash::AshTestBase {
 public:
  ...
  using TestEntry = base::Callback<float(void)>;
...
#endif  // COMPONENT_EXO_TEST_WAYLAND_CLIENT_TEST_H_
