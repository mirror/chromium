...
// This is a struct for accelerator keys used to close ShellSurfaces and
// reserved accelerator keys.
struct Accelerator {
...
// The accelerator keys reserved to be processed in chromium side.
const Accelerator kReservedAccelerators[] = {
    {ui::VKEY_SPACE, ui::EF_CONTROL_DOWN},
    {ui::VKEY_POWER, ui::EF_NONE}};
