...
// This class provides common functions for treating a surfaces like toplevel,
...
class ShellSurfaceBase : public SurfaceTreeHost,
 ...
 public:
  ...
  void set_surface_destroyed_callback(
      const base::RepeatingClosure& surface_destroyed_callback) {
 ...
 private:
  ...
  base::RepeatingClosure surface_destroyed_callback_;
