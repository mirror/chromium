...
class Seat : public aura::client::FocusChangeObserver,
 ...
 public:
  ...
  // rom input events which triggers the drag and drop operation.
  // |client_serial| Returns the most recent serial number of the client.
 ...
 private:
  ...
  // The serial number previously-passed to this Seat object.
