...
struct PrintMsg_Print_Params {
  ...
  bool use_page_defined_source_size;
};
...
IPC_STRUCT_TRAITS_BEGIN(PrintMsg_Print_Params)
  ...
  // True if page source size should be used (i.e. not scaled to paper size).
  IPC_STRUCT_TRAITS_MEMBER(use_page_defined_source_size)
