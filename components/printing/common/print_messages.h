...
struct PrintHostMsg_PrintFrameContent_Params {
  PrintHostMsg_PrintFrameContent_Params();
  PrintHostMsg_PrintFrameContent_Params(
      const PrintHostMsg_PrintFrameContent_Params& other);
  ~PrintHostMsg_PrintFrameContent_Params();
...
// Parameters to describe the rendered content of a frame.
IPC_STRUCT_TRAITS_BEGIN(PrintHostMsg_PrintFrameContent_Params)
  ...
  // All out-of-process subframe ids.
  IPC_STRUCT_TRAITS_MEMBER(subframe_uids)
IPC_STRUCT_TRAITS_END()

#if BUILDFLAG(ENABLE_PRINT_PREVIEW)
// Parameters to describe a rendered document.
IPC_STRUCT_BEGIN(PrintHostMsg_DidPreviewDocument_Params)
  // Frame's content including metafile data and subframe info.
  IPC_STRUCT_MEMBER(PrintHostMsg_PrintFrameContent_Params, content)
...
IPC_MESSAGE_ROUTED3(PrintMsg_PrintSubframe,
                    uint32_t /* the root frame id */,
                    gfx::Rect /* rect of the content area */,
                    uint32_t /* content unique id */)
#endif
...
// requested by a PrintMsg_PrintSubframe message.
IPC_MESSAGE_ROUTED1(PrintHostMsg_DidPrintSubframe,
                    PrintHostMsg_PrintFrameContent_Params)
