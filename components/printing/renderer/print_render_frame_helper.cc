...
bool PrintRenderFrameHelper::PrintPagesNative(blink::WebLocalFrame* frame,
  ...
  page_params.first_page_number = printed_pages[0];
  PrintPageInternal(print_params, page_params.first_page_number, page_count,
                    frame, &metafile, &page_params.page_size,
