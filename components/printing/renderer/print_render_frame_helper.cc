...
void AdjustPageParamsForDpi(PrintHostMsg_DidPrintDocument_Params* page_params,
  ...
  double scale_x = static_cast<double>(dpi.width()) / dpi_max;
  double scale_y = static_cast<double>(dpi.height()) / dpi_max;
  page_params->page_size = gfx::Size(page_params->page_size.width() * scale_x,
                                     page_params->page_size.height() * scale_y);
  page_params->content_area =
      gfx::Rect(page_params->content_area.x() * scale_x,
                page_params->content_area.y() * scale_y,
                page_params->content_area.width() * scale_x,
                page_params->content_area.height() * scale_y);
