...
//   anything.
ScopedJavaLocalRef<jobject> OfflineItemBridge__createOfflineItemAndMaybeAddToList(
    JNIEnv* env,
...
ScopedJavaLocalRef<jobject> OfflineItemBridge::CreateOfflineItem(
  ...
  return item ? OfflineItemBridge__createOfflineItemAndMaybeAddToList(env, nullptr, *item)
              : nullptr;
}
...
ScopedJavaLocalRef<jobject> OfflineItemBridge::CreateOfflineItemList(
  ...
  for (const auto& item : items)
    OfflineItemBridge__createOfflineItemAndMaybeAddToList(env, jlist, item);
