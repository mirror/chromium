...
void V4UpdateProtocolManager::OnURLFetchComplete(
  ...
  V4ProtocolManagerUtil::RecordHttpResponseOrErrorCode(
      "SafeBrowsing.V4Update.Network.Result", status, response_code_);
  ...
  if (status.is_success() && response_code_ == net::HTTP_OK) {
    ...
    DVLOG(1) << "SafeBrowsing GetEncodedUpdates request for: "
             ...
             << " and response code: " << response_code_;
...
void V4UpdateProtocolManager::SetUpdateProtocolManagerFields(
  ...
  update_info->set_network_status_code(response_code_);
