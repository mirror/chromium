...
#include "components/language/ios/browser/ios_language_detection_notifier.h"

#include "components/language/core/browser/url_language_histogram.h"
#include "components/translate/core/common/language_detection_details.h"

DEFINE_WEB_STATE_USER_DATA_KEY(language::IOSLanguageDetectionNotifier);

namespace language {

IOSLanguageDetectionNotifier::IOSLanguageDetectionNotifier(
...
IOSLanguageDetectionNotifier::~IOSLanguageDetectionNotifier() = default;

// static
void IOSLanguageDetectionNotifier::CreateForWebState(
  ...
  if (!FromWebState(web_state)) {
    web_state->SetUserData(UserDataKey(),
                           base::WrapUnique(new IOSLanguageDetectionNotifier(
                               translate_callback, url_language_histogram)));
  }
}

void IOSLanguageDetectionNotifier::OnLanguageDetermined(
...
void IOSLanguageDetectionNotifier::SetExtraCallbackForTesting(
