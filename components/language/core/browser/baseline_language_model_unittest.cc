...
constexpr static float kFloatEps = 0.00001;
...
TEST_F(BaselineLanguageModelTest, UiOnly) {
  ...
  EXPECT_THAT(model.GetLanguages(),
              ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0))));
}
...
TEST_F(BaselineLanguageModelTest, UiAndHist) {
  ...
  EXPECT_THAT(
      model.GetLanguages(),
      ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0)),
                  EqualsLd(LanguageModel::LanguageDetails("it", 1.0 / 2)),
                  EqualsLd(LanguageModel::LanguageDetails("de", 1.0 / 3))));
}
...
TEST_F(BaselineLanguageModelTest, UiAndAccept) {
  ...
  EXPECT_THAT(
      model.GetLanguages(),
      ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0)),
                  EqualsLd(LanguageModel::LanguageDetails("ja", 1.0 / 2)),
                  EqualsLd(LanguageModel::LanguageDetails("fr", 1.0 / 3))));
}
...
TEST_F(BaselineLanguageModelTest, UiAndHistAndAccept) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0)),
                  EqualsLd(LanguageModel::LanguageDetails("it", 1.0 / 2)),
                  EqualsLd(LanguageModel::LanguageDetails("de", 1.0 / 3)),
                  EqualsLd(LanguageModel::LanguageDetails("ja", 1.0 / 4)),
                  EqualsLd(LanguageModel::LanguageDetails("fr", 1.0 / 5))));
}
...
TEST_F(BaselineLanguageModelTest, Repeats) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0)),
                  EqualsLd(LanguageModel::LanguageDetails("it", 1.0 / 2)),
                  EqualsLd(LanguageModel::LanguageDetails("ja", 1.0 / 3))));
}
...
TEST_F(BaselineLanguageModelTest, Regions) {
  ...
  EXPECT_THAT(
      model.GetLanguages(),
      ElementsAre(EqualsLd(LanguageModel::LanguageDetails("en", 1.0)),
                  EqualsLd(LanguageModel::LanguageDetails("en-AU", 1.0 / 2)),
                  EqualsLd(LanguageModel::LanguageDetails("en-CA", 1.0 / 3)),
                  EqualsLd(LanguageModel::LanguageDetails("en-GB", 1.0 / 4))));
}
