...
// where r is the rank of the code in the input list.
//
// If the rank of a language is so low as to induce a negative increment, the
// corresponding score is not updated.
...
// scaled such that the initial entry has score 1.0 (unless the input map only
// contains 0 scores, in which case the output will also only contain 0 scores).
...
// included, and an empty vector is output if the reading list has confidence
