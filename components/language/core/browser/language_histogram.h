...
#ifndef COMPONENTS_LANGUAGE_CORE_BROWSER_LANGUAGE_HISTOGRAM_H_
#define COMPONENTS_LANGUAGE_CORE_BROWSER_LANGUAGE_HISTOGRAM_H_
...
class LanguageHistogram : public KeyedService {
 public:
  struct LanguageInfo {
  ...
  explicit LanguageHistogram(PrefService* pref_service);
  ~LanguageHistogram() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(LanguageHistogram);
};

}  // namespace language

#endif  // COMPONENTS_LANGUAGE_CORE_BROWSER_LANGUAGE_HISTOGRAM_H_
