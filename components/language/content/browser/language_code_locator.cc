...
namespace language {
namespace {
#include "components/language/content/browser/language_code_locator_helper.cc"
}  // namespace

LanguageCodeLocator::LanguageCodeLocator()
    : language_code_enums_(
          kLanguageEnumCodeMapping,
          kLanguageEnumCodeMapping + arraysize(kLanguageEnumCodeMapping)) {
  int pos = 0;
  int index = 0;
