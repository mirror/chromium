...
void HistoryCounter::OnInitialized() {
  ...
  history_sync_enabled_ = !!FetchWebHistoryService();
}
...
history::WebHistoryService* HistoryCounter::FetchWebHistoryService() {
...
void HistoryCounter::Count() {
  ...
  history::WebHistoryService* web_history = FetchWebHistoryService();
...
void HistoryCounter::OnStateChanged(syncer::SyncService* sync) {
  bool history_sync_enabled_new_state = !!FetchWebHistoryService();
