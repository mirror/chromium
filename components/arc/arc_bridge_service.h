...
class ProtectedBufferHost;
class ProtectedBufferInstance;
...
class ArcBridgeService {
 public:
  ...
  ConnectionHolder<mojom::ProtectedBufferInstance, mojom::ProtectedBufferHost>*
  protected_buffer() {
    return &protected_buffer_;
  }
