...
arc::mojom::Rotation ToMojoRotation(display::Display::Rotation rotation) {
  switch (rotation) {
    case display::Display::ROTATE_0:
      return arc::mojom::Rotation::ROTATION_0;
    case display::Display::ROTATE_90:
      return arc::mojom::Rotation::ROTATION_90;
    case display::Display::ROTATE_180:
      return arc::mojom::Rotation::ROTATION_180;
    case display::Display::ROTATE_270:
      return arc::mojom::Rotation::ROTATION_270;
  }
  NOTREACHED();
  return arc::mojom::Rotation::ROTATION_0;
}
...
void ArcRotationLockBridge::SendRotationLockState() {
  ...
  rotation_lock_instance->OnRotationLockStateChanged(
      accelerometer_active, ToMojoRotation(current_display.rotation()));
}
