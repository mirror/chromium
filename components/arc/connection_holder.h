...
// Small helper to implement HasInit<> traits below.
...
// Type tratis to return whether InstanceType has Init() or not.
template <typename InstanceType>
using HasInit = decltype(HasInitImpl::Check(std::declval<InstanceType>()));
