...
class ArcPowerBridgeTest : public testing::Test {
 ...
 protected:
  ...
  void ReleaseAllWakeLocks() { instance_->ReleaseAllWakeLocks(); }
  int WakeLockMapSize() { return instance_->wake_locks_.size(); }
