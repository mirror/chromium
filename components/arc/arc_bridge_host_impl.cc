...
void ArcBridgeHostImpl::OnProtectedBufferInstanceReady(
    mojom::ProtectedBufferInstancePtr protected_buffer_ptr) {
  OnInstanceReady(arc_bridge_service_->protected_buffer(),
                  std::move(protected_buffer_ptr));
}
