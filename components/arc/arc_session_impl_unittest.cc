...
class ArcSessionImplTest : public testing::Test {
 public:
  ...
  void WaitForMiniContainer(ArcSessionImpl* arc_session,
...
TEST_F(ArcSessionImplTest, MiniInstance_Success) {
  ...
  ASSERT_NO_FATAL_FAILURE(WaitForMiniContainer(arc_session.get(), &observer));
}
