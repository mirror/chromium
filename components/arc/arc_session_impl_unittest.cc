...
class ArcSessionImplPackagesCacheModeTest
 ...
 public:
  ArcSessionImplPackagesCacheModeTest() = default;
  ~ArcSessionImplPackagesCacheModeTest() override = default;

 private:
  DISALLOW_COPY_AND_ASSIGN(ArcSessionImplPackagesCacheModeTest);
};
