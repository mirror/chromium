...
// being available.
// The instance can be safely removed after OnSessionStopped() is called.
...
class ArcSession {
 public:
  ...
  class Observer {
   public:
    ...
    virtual void OnSessionStopped(
        ArcStopReason reason, bool was_running, bool full_requested) = 0;
  ...
  // Sends a D-Bus message to start or to upgrade to a full instance if
