...
class ArcSession {
 public:
  ...
  // Starts an instance in the |request_mode|. Or, if currently
  // a mini instance is starting/running, and FULL_INSTANCE is requested,
  // then (eventually) upgrade it to a full instance.
