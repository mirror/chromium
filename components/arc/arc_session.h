...
class ArcSession {
 public:
  ...
  // Starts an instance in the |request_mode|.
  // When Start(MINI_INSTANCE) was called then Start(FULL_INSTANCE) is called,
  // it upgrades the mini instance to a full instance.
