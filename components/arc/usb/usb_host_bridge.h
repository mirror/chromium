...
class UsbHostBridge : public KeyedService,
 ...
 public:
  ...
  void GetDevicesList(const GetDevicesListCallback& callback) override;
 ...
 private:
  ...
  void OnDeviceOpened(const OpenDeviceCallback& callback, base::ScopedFD fd);
  void OnDeviceOpenError(const OpenDeviceCallback& callback,
