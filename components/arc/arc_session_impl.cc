...
ArcStopReason GetArcStopReason(
  ...
  switch (result) {
    case chromeos::SessionManagerClient::StartArcInstanceResult::SUCCESS:
      NOTREACHED();
      break;
    case chromeos::SessionManagerClient::StartArcInstanceResult::UNKNOWN_ERROR:
      return ArcStopReason::GENERIC_BOOT_FAILURE;
    case chromeos::SessionManagerClient::StartArcInstanceResult::
        LOW_FREE_DISK_SPACE:
...
void ArcSessionImpl::OnMiniInstanceStarted(
  ...
  if (result !=
      chromeos::SessionManagerClient::StartArcInstanceResult::SUCCESS) {
