...
class ArcMetricsService : public KeyedService,
                          public MojoConnectionObserver<mojom::MetricsInstance>,
 ...
 public:
  ...
  // MojoConnectionObserver<mojom::MetricsInstance> overrides.
  void OnConnectionReady() override;
  void OnConnectionClosed() override;

  // Implementations for MojoConnectionObserver<mojom::ProcessInstance>.
