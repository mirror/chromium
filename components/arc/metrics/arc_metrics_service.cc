...
void ArcMetricsService::ReportNativeBridge(
  ...
  // The value is actually recored by RecordNativeBridgeUMA.
  native_bridge_type_ = native_bridge_type;
}

void ArcMetricsService::RecordNativeBridgeUMA() {
  UMA_HISTOGRAM_ENUMERATION("Arc.NativeBridge",
                            MojoToMetricsNativeBridgeType(native_bridge_type_),
                            MetricsNativeBridgeType::COUNT);
}
