...
#ifndef COMPONENTS_ARC_COMMON_VOLUME_MOUNTER_TRAITS_H_
#define COMPONENTS_ARC_COMMON_VOLUME_MOUNTER_TRAITS_H_
...
#endif  // COMPONENTS_ARC_COMMON_VOLUME_MOUNTER_TRAITS_H_
