...
// The base::Time used for safe seed expiry checks; usually, the time at which
// the last known "safe" seed was received. An empty/default-constructed
// base::Time time if there is no known "safe" seed. This is a server-provided
// timestamp.
...
// a copy of the last value stored to the |kVariationsLastFetchTime| pref
// corresponding to the same seed contents as the safe seed.
