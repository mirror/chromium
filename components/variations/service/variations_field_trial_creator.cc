...
std::unique_ptr<VariationsServiceClient>&
VariationsFieldTrialCreator::client() {
  return client_;
}

VariationsSeedStore& VariationsFieldTrialCreator::seed_store() {
  return seed_store_;
}

const VariationsSeedStore& VariationsFieldTrialCreator::seed_store() const {
  return seed_store_;
}

bool VariationsFieldTrialCreator::create_trials_from_seed_called() const {
  return create_trials_from_seed_called_;
}

PrefService* VariationsFieldTrialCreator::local_state() {
  return local_state_;
}

const base::ThreadChecker& VariationsFieldTrialCreator::thread_checker() const {
  return thread_checker_;
}

void VariationsFieldTrialCreator::set_create_trials_from_seed_called(
    bool called) {
