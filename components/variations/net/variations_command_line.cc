...
// Wrapper calling |net::EscapeQueryParamValue| which will replace special
// characters but will leave spaces.
std::string EscapeSpecialChars(base::StringPiece input) {
...
std::string GetVariationsCommandLine() {
  ...
  std::string field_trial_params =
      base::FieldTrialList::AllParamsToString(true, &EscapeSpecialChars);
