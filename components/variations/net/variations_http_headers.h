...
// The content of the headers will depend on |incognito| and |is_signed_in|
// parameters. It is fine to pass false for |is_signed_in| if the state is not
// known to the caller. This will prevent addition of ids of type
