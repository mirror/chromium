...
public class VariationsSeedFetcher {
     ...
     * @param milestone The milestone mode parameter to pass to the server via a URL param.
     * @param channel The channel mode parameter to pass to the server via a URL param.
     */
     ...
     * @param restrictMode the restrict mode parameter to pass to the server via a URL param.
     * @param milestone the restrict mode parameter to pass to the server via a URL param.
     * @param channel the restrict mode parameter to pass to the server via a URL param.
