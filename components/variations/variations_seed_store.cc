...
bool VariationsSeedStore::StoreSafeSeed(
  ...
  // TODO(isherman): histograms.xml entry
  UMA_HISTOGRAM_ENUMERATION("Variations.SafeMode.SafeSeed.Store.Result", result,
  ...
  local_state_->SetInt64(prefs::kVariationsSafeSeedDate,
                         client_state.reference_date.ToInternalValue());
    ...
    switch (seed_type) {
      ...
      case SeedType::SAFE:
        ...
        UMA_HISTOGRAM_ENUMERATION(
            "Variations.SafeMode.SafeSeed.Store.Signature", result,
            VerifySignatureResult::ENUM_SIZE);
        break;
    }
