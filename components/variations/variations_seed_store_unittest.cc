...
TEST(VariationsSeedStoreTest, LoadSeed_InvalidSeed) {
  ...
  prefs.SetString(prefs::kVariationsSafeCompressedSeed,
                  "some nondefault value");
  prefs.SetTime(prefs::kVariationsSafeSeedDate, base::Time::Now());
  prefs.SetString(prefs::kVariationsSafeSeedLocale, "some nondefault value");
  ...
  prefs.SetString(prefs::kVariationsSafeSeedSessionConsistencyCountry,
                  "some nondefault value");
  prefs.SetString(prefs::kVariationsSafeSeedSignature, "some nondefault value");
  prefs.SetTime(prefs::kVariationsSeedDate, base::Time::Now());
  prefs.SetString(prefs::kVariationsSeedSignature, "some nondefault value");
...
TEST(VariationsSeedStoreTest, LoadSafeSeed_InvalidSeed) {
  TestingPrefServiceSimple prefs;
  VariationsSeedStore::RegisterPrefs(prefs.registry());
  prefs.SetString(prefs::kVariationsCompressedSeed, "some nondefault value");
