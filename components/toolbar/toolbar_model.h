...
class ToolbarModel {
 public:
  ...
  // Returns a formatted URL for the toolbar. The formatting includes:
  ...
  // portion of the resulting URL. This method specifically keeps the URL
  // suitable for editing by not applying any elisions that change the meaning
  // of the URL.
  virtual base::string16 GetFormattedFullURL(size_t* prefix_end) const = 0;
