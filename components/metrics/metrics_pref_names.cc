...
// Maximum number of tabs that has been opened in a single browser since the
// last time it has been reported.
const char kTabStatsMaxTabsPerWindow[] = "tab_stats.max_tabs_per_window";

// Maximum number of browsers that has been opened since the last time it has
// been reported.
