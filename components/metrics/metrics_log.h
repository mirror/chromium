...
class MetricsLog {
 public:
  ...
  std::string RecordEnvironment(MetricsProvider* delegating_provider,
  ...
  void RecordPreviousSessionData(MetricsProvider* delegating_provider);

  // Record data from providers about the current session into the log.
  void RecordCurrentSessionData(MetricsProvider* delegating_provider,
