...
class MetricsService : public base::HistogramFlattener {
 ...
 private:
  ...
  void DisableRecording(bool collect_metrics = true);
  ...
  void CloseCurrentLog(bool collect_metrics = true);
  ...
  // are.
  void PushPendingLogsToPersistentStorage(bool collect_metrics = true);
