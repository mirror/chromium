...
void CleanupJob(IBackgroundCopyJob* job) {
  ...
  // Get the file paths associated with this job before cancelling the job.
  // Cancelling the job removes it from the BITS queue right away. It appears
