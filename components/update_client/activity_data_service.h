...
// This is an abstract that is used to inject certain update information
// (active, days since ...) into the update engine of the update client.
// GetDaysSinceLastActive and GetDaysSinceLastRollCall are mostly used
...
class ActivityDataService {
 public:
  ...
  // Clear the active bit of the specified |id|.
