...
DisabledReasons::DisabledReasons() : last_reason(0), reasons(0) {}

DisabledReasons::DisabledReasons(int last, int rs)
    : last_reason(last), reasons(rs) {}

DisabledReasons::DisabledReasons(const DisabledReasons& other) = default;
