...
class SimpleURLLoaderTest : public testing::Test {
 public:
  SimpleURLLoaderTest()
      : scoped_task_environment_(ScopedTaskEnvironment::MainThreadType::IO),
...
class MockURLLoader : public content::mojom::URLLoader {
 public:
  MockURLLoader(base::ScopedTaskEnvironment* scoped_task_environment,
                content::mojom::URLLoaderRequest url_loader_request,
...
class MockURLLoaderFactory : public content::mojom::URLLoaderFactory {
 public:
  explicit MockURLLoaderFactory(
      base::ScopedTaskEnvironment* scoped_task_environment)
      scoped_task_environment_(scoped_task_environment) {}
