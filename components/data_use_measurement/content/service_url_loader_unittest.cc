...
class ServiceURLLoaderWrapper : public ServiceURLLoader {
 public:
  ServiceURLLoaderWrapper(
      std::unique_ptr<network::SimpleURLLoader> default_loader,
      ServiceName service_name)
      : ServiceURLLoader(std::move(default_loader), service_name) {}
  ~ServiceURLLoaderWrapper() override {}
};
...
class ServiceURLLoaderTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    service_url_loader_ = std::make_unique<ServiceURLLoaderWrapper>(
...
TEST_F(ServiceURLLoaderTest, DownloadAsStreamPassThrough) {
