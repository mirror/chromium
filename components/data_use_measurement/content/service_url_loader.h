...
class ServiceURLLoader : public network::SimpleURLLoader {
 public:
  ...
  // network::SimpleURLLoader::Create) wrapped in a ServiceURLLoader.
 ...
 protected:
  ...
  ServiceURLLoader(std::unique_ptr<network::SimpleURLLoader> default_loader,
                   ServiceName service_name);
