...
void PrintHelp() {
  std::cout << std::endl;
  std::cout << "filtertool <indexed_ruleset_path> command" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "    <id>,<document-origin>,<request-url>,<optional type>"
            << std::endl;
  std::cout << "    The id your choice of integer, and is "
            << "printed in the output:" << std::endl;
  std::cout << "        <id> BLOCKED/ALLOWED" << std::endl;
  std::cout << std::endl;
}
