...
RulesetService::IndexAndWriteRulesetResult RulesetService::WriteRuleset(
  ...
  base::FilePath new_indexed_ruleset_version_dir = scratch_dir.Take();
  base::File::Error error;
  if (!(*g_replace_file_func)(new_indexed_ruleset_version_dir,
                              indexed_ruleset_version_dir, &error)) {
    base::DeleteFile(new_indexed_ruleset_version_dir, true);
