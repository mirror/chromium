...
#ifndef COMPONENTS_SIGNIN_IOS_BROWSER_GAIA_AUTH_FETCHER_IOS_H
#define COMPONENTS_SIGNIN_IOS_BROWSER_GAIA_AUTH_FETCHER_IOS_H
...
#endif  // COMPONENTS_SIGNIN_IOS_BROWSER_GAIA_AUTH_FETCHER_IOS_H
