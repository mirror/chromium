...
void ChromeConnectedHeaderHelper::SetAccountConsistencyRequiredByProfile(
    bool account_consistency_required_by_profile) {
  account_consistency_required_by_profile_ =
...
bool ChromeConnectedHeaderHelper::ShouldRequestAccountConsistency() {
  return IsAccountConsistencyMirrorEnabled()  // Enabled because of the platform
         || account_consistency_required_by_profile_;
}
