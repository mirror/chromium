...
class AccountReconcilor : public KeyedService,
 ...
 public:
  ...
  // Log out from all accounts in the Gaia cookie. Virtual for testing.
 ...
 private:
  ...
  // Extracts the list of valid accounts from the TokenService. Returns true if
  // the primary account is valid and false if it has an error.
  bool ValidateAccountsFromTokenService();
