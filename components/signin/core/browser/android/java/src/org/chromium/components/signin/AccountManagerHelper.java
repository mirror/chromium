...
public class AccountManagerHelper {
    ...
    /**
     * Retrieves a list of the Google account names on the device.
     * Will return an empty list if Google Play Services aren't available or out of date.
     */
    @WorkerThread
    ...
    /**
     * Retrieves all Google accounts on the device.
     * Will return an empty array if an error occurs while getting account list.
     */
    @WorkerThread
     ...
     * Will return false if an error occurs while getting account list.
     */
    @WorkerThread
     ...
     * Will return null if an error occurs while getting account list.
     */
    @WorkerThread
