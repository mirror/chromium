...
public class AccountManagerFacade {
    ...
    private class InitializeTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            mFilteredAccounts.set(getFilteredAccounts());
            // It's important that we call countDown on background thread, and not in onPostExecute,
            // as UI thread may be blocked in getGoogleAccounts waiting for this latch.
