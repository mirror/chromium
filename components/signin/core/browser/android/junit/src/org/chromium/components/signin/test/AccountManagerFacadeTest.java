...
public class AccountManagerFacadeTest {
    ...
    private void initAccountManagerFacadeWithAccountRestrictionPatterns(String... patterns) {
        Bundle restrictions = new Bundle();
        restrictions.putStringArray(AccountManagerFacade.ACCOUNT_RESTRICTION_PATTERN_KEY, patterns);
    ...
    public void testGetAccountsWithRestrictionPattern() throws AccountManagerDelegateException {
        initAccountManagerFacadeWithAccountRestrictionPatterns("*@example.com");
    ...
    @Test
    @SmallTest
    public void testGetAccountsWithTwoRestrictionPatterns() throws AccountManagerDelegateException {
        initAccountManagerFacadeWithAccountRestrictionPatterns(
                "test1@example.com", "test2@gmail.com");
        addTestAccount("test@gmail.com"); // Doesn't match the pattern.
