...
const char kAccountConsistencyFeatureMethodDicePrepareMigrationNewEndpoint[] =
...
AccountConsistencyMethod GetAccountConsistencyMethod() {
  ...
  if (method_value == kAccountConsistencyFeatureMethodMirror)
    ...
    return AccountConsistencyMethod::kDicePrepareMigrationNewEnpoint;
...
bool IsDicePrepareMigrationNewEndpointEnabled() {
  return AccountConsistencyMethodGreaterOrEqual(
      GetAccountConsistencyMethod(),
      AccountConsistencyMethod::kDicePrepareMigrationNewEnpoint);
}
