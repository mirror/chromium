...
class SigninErrorController : public KeyedService {
 public:
  ...
  // Sets the main account id. Only used in the PRIMARY_ACCOUNT account mode.
  void SetPrimaryAccountID(const std::string& main_account_id);
 ...
 private:
  ...
  // The main account ID. Only used in the PRIMARY_ACCOUNT account mode.
