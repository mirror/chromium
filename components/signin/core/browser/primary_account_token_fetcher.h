...
#ifndef COMPONENTS_SIGNIN_CORE_BROWSER_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
#define COMPONENTS_SIGNIN_CORE_BROWSER_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
...
class PrimaryAccountTokenFetcher : public SigninManagerBase::Observer,
 ...
 public:
  ...
  // PrimaryAccountTokenFetcher is destroyed before the process completes, the
  // callback is not called.
  PrimaryAccountTokenFetcher(const std::string& oauth_consumer_name,
                             SigninManagerBase* signin_manager,
                             OAuth2TokenService* token_service,
                             const OAuth2TokenService::ScopeSet& scopes,
                             TokenCallback callback);

  ~PrimaryAccountTokenFetcher() override;
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PrimaryAccountTokenFetcher);
};

#endif  // COMPONENTS_SIGNIN_CORE_BROWSER_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
