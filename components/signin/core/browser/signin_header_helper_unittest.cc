...
TEST_F(SigninHeaderHelperTest, TestBuildDiceResponseParams) {
...

  {
    ...
    EXPECT_EQ(1u, params.gaia_id.size());
    EXPECT_EQ(1u, params.email.size());
    EXPECT_EQ(1u, params.session_index.size());
    EXPECT_EQ(kGaiaID, params.gaia_id[0]);
    EXPECT_EQ(kEmail, params.email[0]);
    EXPECT_EQ(kSessionIndex, params.session_index[0]);
...

  {
    ...
    ASSERT_EQ(DiceAction::SIGNOUT, params.user_intention);
    EXPECT_EQ(2u, params.gaia_id.size());
    EXPECT_EQ(2u, params.email.size());
    EXPECT_EQ(2u, params.session_index.size());
    EXPECT_EQ(kGaiaID, params.gaia_id[0]);
    EXPECT_EQ(kEmail, params.email[0]);
    EXPECT_EQ(kSessionIndex, params.session_index[0]);
    EXPECT_EQ(kGaiaID2, params.gaia_id[1]);
    EXPECT_EQ(kEmail2, params.email[1]);
    EXPECT_EQ(kSessionIndex2, params.session_index[1]);
    EXPECT_EQ("", params.authorization_code);
  }
