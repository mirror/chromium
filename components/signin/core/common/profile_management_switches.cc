...
const char kAccountConsistencyFeatureMethodDiceFix[] = "dice_fix";
...
AccountConsistencyMethod GetAccountConsistencyMethod() {
  ...
  else if (method_value == kAccountConsistencyFeatureMethodDiceFix)
    return AccountConsistencyMethod::kDiceFix;
...
bool IsAccountConsistencyDiceEnabled() {
  return (GetAccountConsistencyMethod() == AccountConsistencyMethod::kDice) ||
         (GetAccountConsistencyMethod() == AccountConsistencyMethod::kDiceFix);
}
