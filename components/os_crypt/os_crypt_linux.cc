...
// Get the KeyStorage. Will be null if no service is found.
std::unique_ptr<KeyStorageLinux> GetKeyStorage() {
...
std::unique_ptr<KeyStorageLinux> (*g_key_storage_provider)() = &GetKeyStorage;
