...
IDNSpoofChecker::IDNSpoofChecker() {
  ...
  // Set the restriction level to high. It allows mixing Latin with CJK
  // scripts (+ COMMON and INHERITED). CJK scripts are {Han + Bopomofo}
  // for Chinese, {Hiragana, Katakana, Han} for Japanese, and {Hangul, Han}
  // for Korean.
