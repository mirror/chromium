...
const IDNTestCase idn_cases[] = {
    ...
    // decomposition into base + diacritci mark). The corresponding ASCII
    // domain names are in the test top domain list.
    // ϼκαω.com
    {"xn--mxar0cvm.com", L"\x03fc\x03ba\x03b1\x03c9.com", false},
    // þħĸŧƅ.com
    ...
    // щӎпғ.com
    {"xn--o1at7tki.com", L"\x0449\x04ce\x043f\x0493.com", false},
    // ҫұҳҽ.com
