...
const IDNTestCase idn_cases[] = {
    ...
    // wmhtb.com
    {"xn--l1acpvx.com", L"\x0448\x043c\x043d\x0442\x044c.com", true},
    // щмнть.com
    {"xn--l1acpzs.com", L"\x0449\x043c\x043d\x0442\x044c.com", true},
    // шмнтв.com
    {"xn--b1atdu1a.com", L"\x0448\x043c\x043d\x0442\x0432.com", true},
    // ഠട345.com
    {"xn--345-jtke.com", L"\x0d20\x0d1f" L"345.com", true},

    // At one point the skeleton of 'w' was 'vv', ensure that
    // that it's treated as 'w'.
    {"xn--wder-qqa.com", L"w\x00f3" L"der.com", true},
