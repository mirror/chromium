...
bool FaviconHandler::UpdateFaviconCandidate(
  ...
  // - next candidate has sizes attribute and it is not better than the best one
  ...
  //   and hence get sorted last during prioritization). We stop immediately to
  //   avoid downloading them all, although we don't have the certainty that no
  //   better favicon is among them.
