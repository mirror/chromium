...
TEST(MessageEncrypterTest, DecrypterWorksWithProperKey) {
  ...
  ASSERT_TRUE(encrypted_messages::DecryptMessage(server_private_key_,
                                                 kHkdfLabel, encrypted_message,
...
TEST(MessageEncrypterTest, DecrypterFailsWithWrongKey) {
  ...
  ASSERT_FALSE(encrypted_messages::DecryptMessage(
      server_private_key_, kHkdfLabel, encrypted_message,
