...
#ifndef COMPONENTS_DOWNLOAD_CONTENT_INTERNAL_NAVIGATION_MONITOR_IMPL_H_
#define COMPONENTS_DOWNLOAD_CONTENT_INTERNAL_NAVIGATION_MONITOR_IMPL_H_
...
#endif  // COMPONENTS_DOWNLOAD_CONTENT_INTERNAL_NAVIGATION_MONITOR_IMPL_H_
