...
void DownloadNavigationObserver::DidStartLoading() {
  NotifyNavigationEvent(NavigationEvent::START);
}

void DownloadNavigationObserver::DidStopLoading() {
  NotifyNavigationEvent(NavigationEvent::END);
}

void DownloadNavigationObserver::NavigationStopped() {
  NotifyNavigationEvent(NavigationEvent::END);
}

void DownloadNavigationObserver::WebContentsDestroyed() {
  NotifyNavigationEvent(NavigationEvent::END);
}
