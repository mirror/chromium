...
// the max download configuration.
TEST_F(DownloadServiceControllerImplTest, ThrottlingConfig) {
  ...
  // Throttle to only one running download.
  ...
  // Exceeded the throttling configuration, nothing should be called.
