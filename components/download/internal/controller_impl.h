...
class ControllerImpl : public Controller,
 ...
 private:
  ...
  // Internal state.
  // Set to true if this class is currently in the process of initializing it's
  // internal state.  This will be false until |startup_status_| signals it is
  // complete *and* all internal structures are set up.  This is to prevent
