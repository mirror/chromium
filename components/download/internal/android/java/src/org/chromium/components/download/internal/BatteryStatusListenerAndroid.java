...
/**
 * Helper Java class to query device status.
 *
...
public final class BatteryStatusListenerAndroid {
    ...
    private BatteryStatusListenerAndroid(long nativePtr) {
    ...
    @CalledByNative
    private static BatteryStatusListenerAndroid create(long nativePtr) {
        return new BatteryStatusListenerAndroid(nativePtr);
    }
