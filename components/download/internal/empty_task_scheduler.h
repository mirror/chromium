...
#ifndef COMPONENTS_DOWNLOAD_INTERNAL_EMPTY_TASK_SCHEDULER_H_
#define COMPONENTS_DOWNLOAD_INTERNAL_EMPTY_TASK_SCHEDULER_H_
...
#endif  // COMPONENTS_DOWNLOAD_INTERNAL_EMPTY_TASK_SCHEDULER_H_
