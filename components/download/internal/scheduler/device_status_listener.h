...
class DeviceStatusListener : public NetworkStatusListener::Observer,
 ...
 public:
  ...
  // Whether or not the DeviceStatusListener is currently starting up.  If not,
  // the device status will be more restrictive (network disabled, etc.).
 ...
 protected:
  ...
  // Whether or not the device listener is starting up and the state is valid.
  bool starting_up_;
