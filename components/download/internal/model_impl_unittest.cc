...
TEST_F(DownloadServiceModelImplTest, SuccessfulInitWithEntries) {
  ...
  // Verify histograms.
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records", 2, 1);
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records.New", 2, 1);
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records.Available", 0,
                                     1);
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records.Active", 0, 1);
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records.Paused", 0, 1);
  histogram_tester.ExpectBucketCount("DownloadService.Db.Records.Complete", 0,
                                     1);
}
