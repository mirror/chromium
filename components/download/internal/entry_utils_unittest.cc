...
TEST(DownloadServiceEntryUtilsTest, GetSchedulingCriteria) {
  ...
  EXPECT_EQ(
      Criteria(true, false, DeviceStatus::kDefaultOptimalBatteryPercentage),
      util::GetSchedulingCriteria(list2));
  EXPECT_EQ(Criteria(false, true, DeviceStatus::kMinimumBatteryPercentage),
            util::GetSchedulingCriteria(list3));
  EXPECT_EQ(Criteria(false, false, DeviceStatus::kMinimumBatteryPercentage),
  ...
  EXPECT_EQ(
      Criteria(false, true, DeviceStatus::kDefaultOptimalBatteryPercentage),
