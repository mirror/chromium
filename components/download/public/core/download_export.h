...
#ifndef COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_EXPORT_H_
#define COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_EXPORT_H_
...
#endif  // COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_EXPORT_H_
