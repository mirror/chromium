...
#ifndef COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_SOURCE_H_
#define COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_SOURCE_H_
...
#endif  // COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_SOURCE_H_
