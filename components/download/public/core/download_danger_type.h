...
#ifndef COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_DANGER_TYPE_H_
#define COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_DANGER_TYPE_H_
...
#endif  // COMPONENTS_DOWNLOAD_PUBLIC_CORE_DOWNLOAD_DANGER_TYPE_H_
