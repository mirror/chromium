...
// events to it.
//
// NavigationMonitor does NOT has ownership of WebContentsObserver, and is a
// essentially a singleton keyed service that glues download service with
...
class NavigationMonitor : public KeyedService {
 public:
  ...
  virtual void Start(NavigationMonitor::Observer*) = 0;
