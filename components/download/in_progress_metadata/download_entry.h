...
#ifndef COMPONENTS_DOWNLOAD_IN_PROGRESS_METADATA_DOWNLOAD_ENTRY_H_
#define COMPONENTS_DOWNLOAD_IN_PROGRESS_METADATA_DOWNLOAD_ENTRY_H_
...
#endif  // COMPONENTS_DOWNLOAD_IN_PROGRESS_METADATA_DOWNLOAD_ENTRY_H_
