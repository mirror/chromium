...
// Tests MostVisitedTitleUnchanged.
TEST_F(TopSitesImplTest, MostVisitedTitleUnchanged) {
  GURL url_1("http://url1/");
  GURL url_2("http://url2/");
  base::string16 title_1 = "title1";
  base::string16 title_2 = "title2";
  ...
  EXPECT_FALSE(
      history::TopSitesImpl::MostVisitedTitleUnchanged(old_list, new_list));
