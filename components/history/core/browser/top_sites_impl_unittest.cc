...
TEST_F(TopSitesImplTest, DoTitlesDiffer) {
  ...
  // TopSites has a new list and should notify its observers.
  std::vector<MostVisitedURL> list_1;
  AppendMostVisitedURLwithTitle(url_1, title_1, &list_1);
  EXPECT_TRUE(SetTopSites(list_1));
  ...
  EXPECT_TRUE(SetTopSites(list_2));
  ...
  EXPECT_FALSE(SetTopSites(list_1));
