...
base::Optional<GURL> ThumbnailDatabase::FindPageURLForHost(
  ...
  // Bind |host| with a prefix of "://" and suffix of "/" to ensure the entire
  // host name is matched.
  statement.BindString(0, base::StringPrintf("%%://%s/%%", host.c_str()));
