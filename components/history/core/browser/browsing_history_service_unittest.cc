...
TEST_F(BrowsingHistoryServiceTest, EmptyQueryHistoryAllSources) {
...
TEST_F(BrowsingHistoryServiceTest, ObservingWebHistoryDelayedWeb) {
  ...
  driver()->SetWebHistory(web_history());
  // Since WebHistory is currently not being observed, trigging a history
