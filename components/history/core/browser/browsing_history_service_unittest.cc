...
struct TestResult {
  ...
  BrowsingHistoryService::HistoryEntry::EntryType type;
};
...
TEST_F(BrowsingHistoryServiceTest, QueryHistoryAllSources) {
  ...
  QueryAndVerifySingleQueryResult(
      ...
      /*reached_beginning_of_sync*/ true,
      {{kUrl1, 4, BOTH}, {kUrl3, 3, REMOTE}, {kUrl2, 2, LOCAL}});
}
...
TEST_F(BrowsingHistoryServiceTest, QueryHistoryRemoteTimeRanges) {
  ...
  VerifyQueryResult(
      /*reached_beginning_of_local*/ true, /*has_synced_results*/ true,
      /*reached_beginning_of_sync*/ true,
      {{kUrl3, 3, REMOTE}, {kUrl2, 2, REMOTE}}, QueryHistory(options));
}

TEST_F(BrowsingHistoryServiceTest, QueryHistoryLocalPaging) {
  AddHistory({{kUrl1, 1, LOCAL}, {kUrl2, 2, LOCAL}, {kUrl3, 3, LOCAL}});
  ...
  VerifyQueryResult(
      /*reached_beginning_of_local*/ true, /*has_synced_results*/ true,
      /*reached_beginning_of_sync*/ true, {{kUrl1, 1, LOCAL}},
      QueryHistory(options));
  ...
  VerifyQueryResult(
      /*reached_beginning_of_local*/ true, /*has_synced_results*/ true,
      /*reached_beginning_of_sync*/ true,
      {{kUrl3, 3, LOCAL}, {kUrl2, 2, LOCAL}, {kUrl1, 1, LOCAL}},
      QueryHistory(options));
...
TEST_F(BrowsingHistoryServiceTest, QueryHistoryRemotePaging) {
  AddHistory({{kUrl1, 1, REMOTE}, {kUrl2, 2, REMOTE}, {kUrl3, 3, REMOTE}});
  ...
  VerifyQueryResult(
      /*reached_beginning_of_local*/ true, /*has_synced_results*/ true,
      /*reached_beginning_of_sync*/ true, {{kUrl1, 1, REMOTE}},
      QueryHistory(options));
  ...
  VerifyQueryResult(
      /*reached_beginning_of_local*/ true, /*has_synced_results*/ true,
      /*reached_beginning_of_sync*/ true,
      {{kUrl3, 3, REMOTE}, {kUrl2, 2, REMOTE}, {kUrl1, 1, REMOTE}},
      QueryHistory(options));
