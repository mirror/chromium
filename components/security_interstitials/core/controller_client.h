...
class ControllerClient {
 public:
  ...
  void OpenExtendedReportingPrivacyPolicy(bool should_open_links_in_new_tab);
  void OpenExtendedReportingWhitepaper(bool should_open_links_in_new_tab);

  // Helper method which either opens a URL in a new tab or a the current tab
  // based on the display options setting.
  void OpenURL(bool should_open_links_in_new_tab, const GURL& url);
