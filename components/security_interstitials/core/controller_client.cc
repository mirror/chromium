...
void ControllerClient::OpenExtendedReportingPrivacyPolicy(
  ...
  OpenURL(should_open_links_in_new_tab, privacy_url);
}
...
void ControllerClient::OpenExtendedReportingWhitepaper(
  ...
  OpenURL(should_open_links_in_new_tab, whitepaper_url);
}

void ControllerClient::OpenURL(bool should_open_links_in_new_tab,
                               const GURL& url) {
