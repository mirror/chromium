...
class BaseSafeBrowsingErrorUI {
 public:
  ...
  struct SBErrorDisplayOptions {
    ...
    // a proper page to navigate back to.
    // Chrome and Chromium builds should always set this option to true,
    // such that "Back to Safety" button always presents in safe browsing
    // interstitial.
    bool always_show_back_to_safety;
