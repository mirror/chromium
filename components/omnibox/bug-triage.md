...
| Hotlist-OmniboxKeyboardShortcuts | Bugs related to handling of keyboard shortcuts, including both incorrectly handling real omnibox shortcuts and preventing other Chrome shortcuts from working when the shortcut is done in the omnibox. (Note: label does not appear in the Hotlist completion dropdown.) |
