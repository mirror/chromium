...
base::string16 AutocompleteMatchType::ToAccessibilityLabel(
  ...
  int message_ids[] = {
      ...
      IDS_ACC_AUTOCOMPLETE_HISTORY,           // HISTORY_KEYWORD
      0,                                      // NAVSUGGEST
      ...
      IDS_ACC_AUTOCOMPLETE_SUGGESTED_SEARCH,  // SEARCH_SUGGEST_PERSONALIZED
      IDS_ACC_AUTOCOMPLETE_SUGGESTED_SEARCH,  // SEARCH_SUGGEST_PROFILE
      IDS_ACC_AUTOCOMPLETE_SEARCH,            // SEARCH_OTHER_ENGINE
      IDS_ACC_AUTOCOMPLETE_EXTENSION,         // EXTENSION_APP
      IDS_ACC_AUTOCOMPLETE_CONTACT,           // CONTACT_DEPRECATED
      IDS_ACC_AUTOCOMPLETE_BOOKMARK,          // BOOKMARK_TITLE
      0,                                      // NAVSUGGEST_PERSONALIZED
      0,                                      // CALCULATOR
  ...
  if (!message_ids[type])
    return text;
  return l10n_util::GetStringFUTF16(message_ids[type], text);
}
