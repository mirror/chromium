...
// matches and returns false. Note that it only works on containers of
// comparable elements, which also implies no maps.
...
class is_not_in {
 ...
 private:
  typename Container::const_iterator i, end_;
};
