...
std::string FormatRequestBodyExperimentalService(const std::string& url) {
  ...
  std::unique_ptr<base::DictionaryValue> url_entry(new base::DictionaryValue);
...
GURL ContextualSuggestionsService::ExperimentalContextualSuggestionsUrl(
  ...
  GURL suggest_url("https://cuscochromeextension-pa.googleapis.com/v1/json");
...
void ContextualSuggestionsService::CreateExperimentalRequest(
  ...
  std::unique_ptr<net::URLFetcher> fetcher = net::URLFetcher::Create(
      kFetcherID, suggest_url,
      /*request_typr=*/request_body.empty() ? net::URLFetcher::GET
                                            : net::URLFetcher::POST,
