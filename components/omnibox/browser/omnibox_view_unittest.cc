...
TEST_F(OmniboxViewTest, TestStripSchemasUnsafeForPaste) {
  const char* urls[] = {
      ...
      "\x18\x19 JavaScript:alert(0)",  // Leading control chars unsafe.
      "\x01\x02javascript:\x03\x04JavaScript:alert(0)"  // Embedded control
                                                        // characters unsafe.
  };
  ...
  const char* expecteds[] = {
      ...
      "alert(0)",  // Leading control chars unsafe.
      "alert(0)"   // Embedded control characters unsafe.
  };
