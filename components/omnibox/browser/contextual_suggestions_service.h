...
class ContextualSuggestionsService : public KeyedService {
 ...
 private:
  ...
  // suggestions, the |callback| function is ran with the HTTP GET request as a
  // parameter.
  //
  // This function is called by CreateContextualSuggestionsRequest. See the
  // function definition of the latter for details on the parameters.
  ...
  // suggestions, the |callback| function is ran with the HTTP POST request as a
  // parameter.
  //
  // This function is called by CreateContextualSuggestionsRequest. See the
  // function definition of the latter for details on the parameters.
