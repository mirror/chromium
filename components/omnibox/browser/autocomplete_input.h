...
class AutocompleteInput {
 public:
  ...
  // The current URL, or an invalid GURL if not relevant to query.
  const GURL& current_url() const { return current_url_; }
  // OnFocus providers need the current URL to produce a match that, when
  // displayed, contain the URL of the current page.
