...
class AutocompleteInput {
 public:
  ...
  static std::string TypeToString(metrics::omnibox::OmniboxInputType type);
  ...
  static metrics::omnibox::OmniboxInputType Parse(
  ...
  metrics::omnibox::OmniboxInputType type() const { return type_; }
 ...
 private:
  ...
  metrics::omnibox::OmniboxInputType type_;
  url::Parsed parts_;
