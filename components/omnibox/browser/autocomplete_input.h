...
class AutocompleteInput {
 public:
  ...
  void set_prevent_inline_autocomplete(
      bool prevent_inline_autocomplete = true) {
  ...
  void set_prefer_keyword(bool prefer_keyword = true) {
  ...
  void set_allow_exact_keyword_match(bool allow_exact_keyword_match = true) {
  ...
  void set_want_asynchronous_matches(bool want_asynchronous_matches = true) {
  ...
  void set_from_omnibox_focus(bool from_omnibox_focus = true) {
