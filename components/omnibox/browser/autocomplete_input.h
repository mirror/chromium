...
class AutocompleteInput {
 public:
  ...
  static metrics::OmniboxInputType::OmniboxInputType Parse(
  ...
  metrics::OmniboxInputType::OmniboxInputType type() const { return type_; }
 ...
 private:
  ...
  metrics::OmniboxInputType::OmniboxInputType type_;
  url::Parsed parts_;
