...
class AutocompleteInput {
 public:
  ...
  // If set to a valid search result page URL, providers can use it to
  // perform query refinement. For example, if it is set to an image search
  // result page, the search provider may generate an image search URL.
 ...
 private:
  ...
  // the base fields are set. These remaining parameters are used as inputs
