...
void OmniboxEditModel::OpenMatch(AutocompleteMatch match,
  ...
  OmniboxLog log(
      ...
      input_.type(),
      popup_open,
      dropdown_ignored ? 0 : index, !pasted_text.empty(),
      /*tab_id=*/-1,  // don't yet know tab ID; set later if appropriate
      ClassifyPage(),
      ...
      /*result=*/dropdown_ignored ? fake_single_entry_result : result());
