...
TEST_F(ScoredHistoryMatchTest, Inlining) {
...

  {
    ...
    EXPECT_FALSE(scored_a.match_in_path_query_or_ref);
    ...
    EXPECT_FALSE(scored_b.match_in_path_query_or_ref);
    ...
    EXPECT_FALSE(scored_c.match_in_path_query_or_ref);
    ...
    EXPECT_FALSE(scored_d.match_in_path_query_or_ref);
  }
...

  {
    ...
    EXPECT_FALSE(scored_d.match_in_scheme);
    EXPECT_FALSE(scored_d.match_in_subdomain);
    EXPECT_TRUE(scored_d.match_in_path_query_or_ref);
    ...
    EXPECT_TRUE(scored_e.match_in_path_query_or_ref);
    ...
    EXPECT_TRUE(scored_f.match_in_path_query_or_ref);
  }
