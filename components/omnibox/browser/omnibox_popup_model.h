...
class OmniboxPopupModel {
 public:
  ...
  // |has_selected_line_|). If |force| is true then the selected line will
  ...
  bool has_selected_line() { return has_selected_line_; }
 ...
 private:
  ...
  // The user has manually selected a line.
  bool has_selected_line_;
