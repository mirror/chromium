...
class OmniboxEditModel {
 public:
  ...
  // Returns the current display URL. It should be |display_only_url_|, unless
  // we are in editing mode, in which case it is |url_for_editing_|.
  const base::string16& GetCurrentDisplayedUrl() const;
