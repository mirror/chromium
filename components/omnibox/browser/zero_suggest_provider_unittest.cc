...
TEST_F(ZeroSuggestProviderTest, TestMostVisitedNavigateToSearchPage) {
  ...
  srp_input.set_current_page_classification(
      metrics::OmniboxEventProto::
          SEARCH_RESULT_PAGE_NO_SEARCH_TERM_REPLACEMENT);
  srp_input.set_allow_exact_keyword_match();
  srp_input.set_want_asynchronous_matches();
  srp_input.set_from_omnibox_focus();
