...
float ScoredHistoryMatch::GetFrequency(const base::Time& now,
  ...
  // - a single typed visit today, no other visits -> 1.5
...
float ScoredHistoryMatch::GetFinalRelevancyScore(float topicality_score,
  ...
  // The below code maps |intermediate_score|, the product of
  // |topicality_score|, |specificity_score|, and |frequency_score| to the
  // range [0, 1399].  For typical ranges, remember:
