...
void AutocompleteMatch::GetMatchComponents(
  ...
  // Add an extra character to exclude the '/' delimiter that prefixes every
  // path. Note that setting |include_delimiter| to true in the
  // CountCharactersBefore method call has no effect on PATH by design.
