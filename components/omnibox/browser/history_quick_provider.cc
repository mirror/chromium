...
int HistoryQuickProvider::FindMaxMatchScore(
  ...
  // |max_match_score| is the most we will give to a subsequent match.
  // Reduce |max_match_score| if we think there will be a URL-what-you-typed
  // match.  (We want URL-what-you-typed matches for visited URLs to beat
  // out any longer URLs, no matter how frequently they're visited.)  The
  // strength of this reduction depends on the likely score for the
  // URL-what-you-typed result.
