...
void FingerprintDataLoader::OnGotGeoposition(
  ...
  // The GeolocationImpl are owned by GeolocationContext which is strong-bound
  // to the mojo pipe. Reset the |geolocation_context_| will break the mojo
  // pipe of both |geolocation_| and |geolocation_context_|.
