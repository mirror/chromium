...
using autofill::FormDataPredictions;
using autofill::FormFieldData;
using autofill::FormFieldDataPredictions;
using autofill::FormsPredictionsMap;
using autofill::PasswordAndRealm;
using autofill::PasswordForm;
using autofill::PasswordFormFieldPredictionMap;
using autofill::PasswordFormFieldPredictionType;
...
EnumTraits<autofill::mojom::CheckStatus, FormFieldData::CheckStatus>::ToMojom(
...
// static
bool EnumTraits<autofill::mojom::CheckStatus, FormFieldData::CheckStatus>::
...
// static
autofill::mojom::RoleAttribute EnumTraits<
    autofill::mojom::RoleAttribute,
    FormFieldData::RoleAttribute>::ToMojom(FormFieldData::RoleAttribute input) {
  switch (input) {
...
// static
bool EnumTraits<autofill::mojom::RoleAttribute, FormFieldData::RoleAttribute>::
...
EnumTraits<autofill::mojom::PasswordFormLayout, PasswordForm::Layout>::ToMojom(
...
// static
bool EnumTraits<autofill::mojom::PasswordFormLayout, PasswordForm::Layout>::
...
EnumTraits<autofill::mojom::PasswordFormType, PasswordForm::Type>::ToMojom(
...
bool EnumTraits<autofill::mojom::PasswordFormType,
                PasswordForm::Type>::FromMojom(autofill::mojom::PasswordFormType
                                                   input,
...
EnumTraits<autofill::mojom::PasswordFormScheme, PasswordForm::Scheme>::ToMojom(
...
// static
bool EnumTraits<autofill::mojom::PasswordFormScheme, PasswordForm::Scheme>::
...
// static
autofill::mojom::PasswordFormFieldPredictionType EnumTraits<
...
// static
bool StructTraits<autofill::mojom::FormFieldDataDataView, FormFieldData>::Read(
    autofill::mojom::FormFieldDataDataView data,
    FormFieldData* out) {
...
// static
bool StructTraits<autofill::mojom::FormDataDataView, FormData>::Read(
...
// static
bool StructTraits<autofill::mojom::PasswordAndRealmDataView, PasswordAndRealm>::
...
// static
bool StructTraits<autofill::mojom::PasswordFormDataView, PasswordForm>::Read(
    autofill::mojom::PasswordFormDataView data,
    PasswordForm* out) {
...
std::vector<autofill::FormFieldData> StructTraits<
    autofill::mojom::PasswordFormFieldPredictionMapDataView,
...
StructTraits<autofill::mojom::FormsPredictionsMapDataView,
             FormsPredictionsMap>::keys(const FormsPredictionsMap& r) {
...
StructTraits<autofill::mojom::FormsPredictionsMapDataView,
             FormsPredictionsMap>::values(const FormsPredictionsMap& r) {
