...
// one. The function returns true if |username_element| was found. If the result
// for the input form is cached in |username_detector_cache|, then
// |username_element| set to the cached result.
