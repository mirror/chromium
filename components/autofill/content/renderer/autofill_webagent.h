...
class AutofillWebagent : public content::RenderFrameObserver,
 ...
 private:
  ...
  // PageClickListener:
  void FormControlElementClickedWebagents(const AutofillElement& element,
  ...
  void TextFieldDidChangeImpl(const AutofillElement& element);
  ...
  void ShowSuggestions(const AutofillElement& element,
                       const ShowSuggestionsOptions& options);

  // Queries the browser for Autocomplete and Autofill suggestions for the given
  // |element|.
  void QueryAutofillSuggestions(const AutofillElement& element);
  ...
  base::Optional<AutofillElement> element_webagents_;
  ...
  std::set<AutofillElement> formless_elements_user_edited_webagents_;
