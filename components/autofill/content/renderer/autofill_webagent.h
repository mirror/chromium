...
class AutofillWebagent : public content::RenderFrameObserver,
 ...
 private:
  ...
  void FireHostSubmitEvents(const blink::WebFormElement& form,
                            bool form_submitted);
  void FireHostSubmitEventsWebagents(const HTMLFormElement& form,
                                     bool form_submitted);
  ...
  void TextFieldDidChange(const HTMLInputElement& element) override;
  ...
  void TextFieldDidChangeImpl(const HTMLInputElement& element);
  ...
  void ShowSuggestions(const HTMLInputElement& element,
