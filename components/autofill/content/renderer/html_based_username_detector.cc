...
const char* const technicalWords[] = {
    "uid",         "userreg",    "laddress",     "regaccount",   "ureg",
    "loginid",     "userlogin",  "accountreg",   "regid",        "regname",
    "loginname",   "membername", "uname",        "ucreate",      "loginmail",
    "useraccount", "umail",      "loginreg",     "accountid",    "accountname",
    "userid",      "regemail",   "newmobile",    "loginaccount", "ulogin",
    "uaccount",    "usercreate", "accountlogin", "newtel"};
