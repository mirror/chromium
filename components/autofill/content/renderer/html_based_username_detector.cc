...
// Short words will not be used in regular string search, because a short word
// may be a part of another word. A short word should be enclosed between
// delimiters, otherwise an occurence doesn't count.
