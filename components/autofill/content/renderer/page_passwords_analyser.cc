...
const char* const kDocumentationUrl = "https://goo.gl/9p2vKq";

const char* const kTypeAttributes[] = {"text", "email", "tel", "password"};
const char* const kTypeTextAttributes[] = {"text", "email", "tel"};
