...
class AutofillAgent : public content::RenderFrameObserver,
 ...
 public:
  ...
  void SetSecureOriginRequired(bool required) override;
 ...
 private:
  ...
  // Whether or not a user gesture is required to query autofill suggestion.
  // Default to false.
  bool is_secure_origin_required_;
