...
class AutofillAgent : public content::RenderFrameObserver,
 ...
 private:
  friend class PageClickTrackerTest;
...
class AutofillAgent : public content::RenderFrameObserver,
 ...
 public:
  ...
  last_clicked_form_control_element_for_testing() const {
    return last_clicked_form_control_element_for_testing_;
  }
  bool last_clicked_form_control_element_was_focused_for_testing() const {
    return last_clicked_form_control_element_was_focused_for_testing_;
  }
