...
void PasswordAutofillAgent::SendPasswordForms(bool only_visible) {
  ...
  devtools_page_passwords_analyser_.AnalyseDocumentDOMLazily(render_frame());
#endif
...
#if !defined(OS_ANDROID) && !defined(OS_IOS)
  if (DevToolsAgent())
    DevToolsAgent()->AddObserver(this);
#endif
...
#if !defined(OS_ANDROID) && !defined(OS_IOS)
content::DevToolsAgent* PasswordAutofillAgent::DevToolsAgent() {
...
void PasswordAutofillAgent::OnDevToolsAttachmentChanged() {
  if (DevToolsAgent() && DevToolsAgent()->IsAttached())
...
void PasswordAutofillAgent::FrameClosing() {
  ...
  if (DevToolsAgent())
    DevToolsAgent()->RemoveObserver(this);
#endif
}
