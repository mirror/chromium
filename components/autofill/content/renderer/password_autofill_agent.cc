...
PasswordForm::SubmissionIndicatorEvent ToSubmissionIndicatorEvent(
    InteractedFormTracker::Observer::SubmissionSource source) {
  switch (source) {
    case InteractedFormTracker::Observer::SubmissionSource::FRAME_DETACHED: {
      return PasswordForm::SubmissionIndicatorEvent::FRAME_DETACHED;
    }
    case InteractedFormTracker::Observer::SubmissionSource::
        SAME_DOCUMENT_NAVIGATION: {
      return PasswordForm::SubmissionIndicatorEvent::SAME_DOCUMENT_NAVIGATION;
    }
    case InteractedFormTracker::Observer::SubmissionSource::XHR_SUCCEEDED: {
    ...
    default: { return PasswordForm::SubmissionIndicatorEvent::NONE; }
  }
}
...
void PasswordAutofillAgent::FireSuccessfulFormSubmission(
...
void PasswordAutofillAgent::OnSuccessfulSubmission(SubmissionSource source) {
  if (source == SubmissionSource::FRAME_DETACHED) {
    ...
    if (event == PasswordForm::SubmissionIndicatorEvent::NONE)
      return;
    FireSuccessfulFormSubmission(event);
  }
}
