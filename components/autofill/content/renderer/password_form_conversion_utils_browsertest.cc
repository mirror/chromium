...
TEST_F(MAYBE_PasswordFormConversionUtilsTest, IdentifyingUsernameFields) {
  ...
  struct TestCase {
    ...
    const char* expected_other_possible_usernames;
      ...
      // be treated as the username, but the other possibilities of username
      // should also be added to |other_possible_usernames|, because
      // autocomplete value might be wrong.
