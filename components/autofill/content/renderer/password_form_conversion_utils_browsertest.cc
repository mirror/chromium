...
TEST_F(MAYBE_PasswordFormConversionUtilsTest,
  ...
  std::vector<base::string16> all_passwords =
      password_form->other_possible_passwords;
  all_passwords.push_back(password_form->password_value);
  ...
  EXPECT_TRUE(base::ContainsValue(all_passwords, base::ASCIIToUTF16("alpha1")));
  EXPECT_TRUE(base::ContainsValue(all_passwords, base::ASCIIToUTF16("alpha2")));
  EXPECT_TRUE(base::ContainsValue(all_passwords, base::ASCIIToUTF16("alpha3")));
  EXPECT_TRUE(base::ContainsValue(all_passwords, base::ASCIIToUTF16("alpha4")));
}
