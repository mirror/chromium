...
class PasswordAutofillAgent : public content::RenderFrameObserver,
 ...
 public:
  ...
  // Determine whether |frame| is allowed to access the password manager.  For
  // example, frames with about:blank documents or documents with unique
  // origins aren't allowed access.
