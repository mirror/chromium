...
bool GetPasswordForm(
  ...
  if (username_element.IsNull()) {
    ...
    // classifier compared to the based heuristic, this block was added. When
    // crbug.com/786404 is fixed, this block can be removed and the base
    // heuristic can be run only if |username_element.IsNull()|.
    username_detection_method = BASE_HEURISTIC;
  }
