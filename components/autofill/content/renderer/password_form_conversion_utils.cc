...
// If |ignore_autofilled_values|, autofilled values are considered user input.
FieldFilteringLevel GetFiltertingLevelForField(
  ...
  return form_util::IsWebElementVisible(element) ? VISIBILITY : NO_FILTER;
}
...
void GetFieldFilteringLevels(
  ...
  *username_fields_level = NO_FILTER;
  *password_fields_level = NO_FILTER;

  FieldFilteringLevel max_level_found_for_username_fields = NO_FILTER;
...
bool GetPasswordForm(
  ...
  FieldFilteringLevel username_fields_level = NO_FILTER;
