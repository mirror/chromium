...
void PasswordFormToJSON(const PasswordForm& form,
  ...
  target->SetString("affiliated_play_name", form.affiliated_play_name);
  target->SetString("affiliated_icon_url",
                    form.affiliated_icon_url.possibly_invalid_spec());
...
bool PasswordForm::operator==(const PasswordForm& form) const {
  return scheme == form.scheme && signon_realm == form.signon_realm &&
         ...
         affiliated_play_name == form.affiliated_play_name &&
         affiliated_icon_url == form.affiliated_icon_url &&
