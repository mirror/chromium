...
void PasswordFormToJSON(const PasswordForm& form,
  ...
  target->SetString("branding_info_name", form.branding_info_name);
  target->SetString("branding_info_icon_url",
                    form.branding_info_icon_url.possibly_invalid_spec());
...
bool PasswordForm::operator==(const PasswordForm& form) const {
  return scheme == form.scheme && signon_realm == form.signon_realm &&
         ...
         branding_info_name == form.branding_info_name &&
         branding_info_icon_url == form.branding_info_icon_url &&
