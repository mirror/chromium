...
// Controls whether infered label is considered for comparing in
// FormFieldData.SimilarFieldAs.
const base::Feature kAutofillSkipInferedLabelInComparing{
    "AutofillSkipInferedLabelInComparing", base::FEATURE_DISABLED_BY_DEFAULT};
