...
std::vector<const ::i18n::addressinput::RegionData*>
TestRegionDataLoader::GetRegionData() {
  if (regions_ == nullptr)
    return std::vector<const ::i18n::addressinput::RegionData*>();
