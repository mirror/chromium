...
base::string16 PhoneNumber::GetInfoImpl(const AutofillType& type,
  ...
  // When is phone number autofill has stored cannot be normalized, it
  // responses to queries for complete numbers with verbatime numbers, and
  // simply return empty string for any queries for phone components.
