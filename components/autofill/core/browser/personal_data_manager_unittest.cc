...
TEST_F(PersonalDataManagerTest,
  ...
  // Add an expired card last used 10 days ago
  CreditCard credit_card1("287151C8-6AB1-487C-9095-28E80BE5DA15",
                          "https://www.example.com");
  test::SetCreditCardInfo(&credit_card1, "Clyde Barrow",
                          "378282246310005" /* American Express */, "04",
  ...
  // Add an expired card last used 180 days ago.
  CreditCard credit_card2("1141084B-72D7-4B73-90CF-3D6AC154673B",
                          "https://www.example.com");
  credit_card2.set_use_date(AutofillClock::Now() -
  ...
  // Query with prefix for card0 returns card0.
  {
    std::vector<Suggestion> suggestions =
        personal_data_->GetCreditCardSuggestions(
  ...
  // Query with prefix for card1 returns card1.
  {
    std::vector<Suggestion> suggestions =
        personal_data_->GetCreditCardSuggestions(
  ...
  // Query with prefix for card2 returns card2.
  {
    std::vector<Suggestion> suggestions =
        personal_data_->GetCreditCardSuggestions(
...
TEST_F(PersonalDataManagerTest,
       RemoveCreditCardsExpiredAndNotUsedSinceTimestamp) {
  ...
  // two cards have use dates more than 175 days ago and are expired.
  {
    ...
    base::HistogramTester histogram_tester;
    PersonalDataManager::RemoveCreditCardsExpiredAndNotUsedSinceTimestamp(
