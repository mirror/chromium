...
TEST_F(PersonalDataManagerTest,
       Metrics_SubmittedServerCardExpiration_FullServerCardMatch) {
  EnableWalletCardImport();
  ...
  histogram_tester.ExpectUniqueSample(
      "Autofill.SubmittedServerCardExpirationMetric",
      AutofillMetrics::FULL_SERVER_CARD_EXPIRATION_DATE_MATCHED, 1);
}

TEST_F(PersonalDataManagerTest,
       Metrics_SubmittedServerCardExpiration_FullServerCardMismatch) {
  EnableWalletCardImport();
...
TEST_F(PersonalDataManagerTest,
       Metrics_SubmittedServerCardExpiration_MaskedServerCardMatch) {
  EnableWalletCardImport();
...
TEST_F(PersonalDataManagerTest,
       Metrics_SubmittedServerCardExpiration_MaskedServerCardMismatch) {
  EnableWalletCardImport();
