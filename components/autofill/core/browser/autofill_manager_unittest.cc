...
TEST_F(AutofillManagerTest,
       UploadCreditCard_ZipCodesDiscardWhitespace_ComparatorDisabled) {
  personal_data_.ClearAutofillProfiles();
  autofill_manager_->set_credit_card_upload_enabled(true);
...
TEST_F(AutofillManagerTest,
       UploadCreditCard_CCFormHasMiddleName_ComparatorDisabled) {
  personal_data_.ClearAutofillProfiles();
  autofill_manager_->set_credit_card_upload_enabled(true);
...
TEST_F(AutofillManagerTest,
       UploadCreditCard_CCFormRemovesMiddleName_ComparatorDisabled) {
  personal_data_.ClearAutofillProfiles();
  autofill_manager_->set_credit_card_upload_enabled(true);
