...
class AutofillMetrics {
 public:
  ...
  enum FormEvent {
    ...
    // form. Depending on the user submitting a card that known by the browser,
    // a card that the browser does not know or submitting but Autofill could
    // not detect the card, one of the following will be triggered. Only one of
    // the following three will be triggered per page load.
