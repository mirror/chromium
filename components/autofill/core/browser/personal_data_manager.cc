...
CreditCard PersonalDataManager::ExtractCreditCardFromForm(
  ...
  DLOG(WARNING)
      << "3fengLog: ExtractCreditCardFromForm"
      << ExtractCreditCardFromForm(form, &hasDuplicateFieldType).number();
