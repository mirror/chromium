 ...
 public:
  ...
  void Get(const std::string& key, const Callback& data_ready) const override {
    data_ready(
        ...
        new std::string(
            "{\"data/CA\": {\"lang\": \"en\", "
            "\"name\": \"CANADA\", \"id\": \"data/CA\","
            "\"languages\": \"en~fr\", \"sub_keys\": \"AB~NB\", \"key\": "
            "\"CA\","
            "\"sub_names\": \"Alberta~New Brunswick\"}, \"data/CA/NB--fr\": "
            "{\"lang\": \"fr\", \"key\": \"NB\", \"id\": \"data/CA/NB--fr\", "
            "\"name\": \"Nouveau-Brunswick\"}, \"data/CA/AB--fr\": {\"lang\": "
            "\"fr\", \"key\": \"AB\", \"id\": \"data/CA/AB--fr\", "
            " \"name\": \"Alberta\"}, \"data/CA/NB\": {\"lang\": \"en\", "
            "\"key\":"
            " \"NB\", \"id\": \"data/CA/NB\", \"name\": \"New Brunswick\"}, "
            "\"data/CA/AB\": {\"lang\": \"en\", \"key\": \"AB\", \"id\": "
            "\"data/CA/AB\", \"name\": \"Alberta\"}, \"data/CA--fr\": "
            "{\"lang\": "
            "\"fr\", \"name\": \"CANADA\",\"sub_keys\": \"AB~NB\", \"key\": "
            "\"CA\", \"id\": \"data/CA--fr\", \"sub_names\": "
...
void TestFillingExpirationMonth(const std::vector<const char*>& values,
  ...
  // filler.FillFormField(field, ASCIIToUTF16("4"), "en-US", &field);
  // GetIndexOfValue(field.option_values, field.value, &content_index);
...
TEST_P(PhoneNumberTest, FillPhoneNumber) {
  ...
  address.SetRawInfo(PHONE_HOME_WHOLE_NUMBER, ASCIIToUTF16("+15141254578"));
  FieldFiller filler(/*app_locale=*/"en-US", /*address_normalizer=*/nullptr);
  filler.FillFormField(field, address, &field, /*cvc=*/base::string16());
...
INSTANTIATE_TEST_CASE_P(
    ...
    PhoneNumberTest,
    testing::Values(
        // TODO(crbug.com/581485): These cases do not work.
        // // Filling a phone type field with text should fill the text as is.
        // AutofillFieldFillerTestCase{HTML_TYPE_TEL, /* default value */ 0,
        //                              "Oh hai"},
        ...
        AutofillFieldFillerTestCase{HTML_TYPE_TEL, 10, "5141254578"},
        ...
        AutofillFieldFillerTestCase{HTML_TYPE_TEL, 5, "54578"}));
...
class AutofillSelectWithStatesTest
 ...
 protected:
  AddressNormalizer* normalizer() { return &normalizer_; }

 private:
  AddressNormalizerImpl normalizer_;
