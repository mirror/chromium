...
class PaymentsClient : public net::URLFetcherDelegate,
 ...
 public:
  ...
  // |pan_first_six| is used to help determine if credit card upload is likely
  // to be successful at all. If the conditions are met, the legal message will
  // be returned via OnDidGetUploadDetails. |active_experiments| is used by
