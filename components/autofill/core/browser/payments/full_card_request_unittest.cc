...
class FullCardRequestTest : public testing::Test,
 ...
 public:
  ...
  FullCardRequest* mutable_request() { return &request_; }
  const FullCardRequest& request() const { return request_; }
...
TEST_F(FullCardRequestTest, GetFullCardPanAndCvcForLocalCard) {
  ...
  mutable_request()->GetFullCard(card, AutofillClient::UNMASK_FOR_AUTOFILL,
...
TEST_F(FullCardRequestTest, GetFullCardPanAndCvcForFullServerCard) {
  ...
  test::SetCreditCardInfo(&full_server_card, nullptr, "4111", "12", "2050",
                          "1");
  mutable_request()->GetFullCard(
      full_server_card, AutofillClient::UNMASK_FOR_AUTOFILL,
...
TEST_F(FullCardRequestTest, IsGettingFullCardForMaskedServerCard) {
  ...
  EXPECT_FALSE(mutable_request()->IsGettingFullCard());
  ...
  EXPECT_TRUE(mutable_request()->IsGettingFullCard());
