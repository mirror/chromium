...
// web forms.  Owned by AutofillManager.
class FormDataImporter {
 public:
  // The parameters should outlive the FormDataImporter.
  FormDataImporter(CreditCardSaveManager* credit_card_save_manager,
                   PersonalDataManager* personal_data_manager,
                   const std::string& app_locale);
  ~FormDataImporter();

  // Imports the form data, submitted by the user, into
  // |personal_data_manager_|. If a new credit card was detected, also begins
  // the process to offer local or upload credit card save.
 ...
 private:
  ...
  CreditCardSaveManager* credit_card_save_manager_;
