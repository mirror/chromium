...
class AutofillProfileValidatorTest : public testing::Test {
 ...
 protected:
  ...
  void OnValidated() {
    ...
    for (auto expectation : expected_validity_) {
      EXPECT_EQ(expectation.second,
                validated_profile_->GetValidityState(expectation.first));
    }
  }
  ...
  AutofillProfile* validated_profile_;
...
TEST_F(AutofillProfileValidatorTest,
       ValidateProfile_EmptyPhone_InvalidAddress) {
  AutofillProfile profile(autofill::test::GetFullValidProfile());
...
TEST_F(AutofillProfileValidatorTest, ValidateProfile_EmptyEmail_InvalidZip) {
  AutofillProfile profile(autofill::test::GetFullValidProfile());
...
TEST_F(AutofillProfileValidatorTest, ValidateProfile_InvalidEmail_EmptyZip) {
  AutofillProfile profile(autofill::test::GetFullValidProfile());
