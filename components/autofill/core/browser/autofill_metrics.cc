...
void LogPredictionQualityMetrics(
  ...
  // TODO(wuandy): Do not log anything if a field is empty and is not supposed
  // to be automatically filled for now. Long term solution is add a server
  // enum to capture this case to accurately collect metrics.
