...
class AutofillField : public FormFieldData {
 public:
  ...
  bool only_fill_when_highlighted() const {
    return only_fill_when_highlighted_;
  }
  ...
  void set_only_fill_when_highlighted(bool fill_when_highlighted) {
    only_fill_when_highlighted_ = fill_when_highlighted;
  }
 ...
 private:
  ...
  bool only_fill_when_highlighted_;
