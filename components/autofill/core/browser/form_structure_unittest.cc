...
TEST_F(FormStructureTest, ParseQueryResponse) {
  ...
  ASSERT_EQ(2U, forms[0]->field(0)->server_types().size());
  EXPECT_EQ(7U, forms[0]->field(0)->server_types()[0].autofill_type());
  EXPECT_EQ(22U, forms[0]->field(0)->server_types()[1].autofill_type());
  EXPECT_EQ(30, forms[0]->field(1)->server_type());
  EXPECT_EQ(30U, forms[0]->field(1)->server_types()[0].autofill_type());
  EXPECT_EQ(9, forms[1]->field(0)->server_type());
  EXPECT_EQ(9U, forms[1]->field(0)->server_types()[0].autofill_type());
  EXPECT_EQ(0, forms[1]->field(1)->server_type());
  EXPECT_EQ(0U, forms[1]->field(1)->server_types()[0].autofill_type());
}
