...
extern const base::Feature kAutofillCreditCardSuggestionRestriction;
...
// Returns whether the expriment to restict the credit card suggestions is
// enabled.
bool IsAutofillCreditCardSuggestionRestrictionEnabled();
