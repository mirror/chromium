...
extern const base::Feature kAutofillCreditCardSuggestionStrictTriggering;
...
// Returns whether the experiment to be more strict in triggering the credit
// card suggestion dialog is enabled.
