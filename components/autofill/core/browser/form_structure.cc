...
void FormStructure::RationalizePhoneNumberFieldsPredictions() {
  ...
  // any phone number fields, or it is true and the pointers to the fields that
  // compose a first valid phone number are set to not-NULL, specifically:
  ...
  // In the update pass, if one field is phone
