...
void AutofillManager::FillOrPreviewCreditCardForm(
  ...
  if (action == AutofillDriver::FORM_DATA_ACTION_FILL) {
    if (credit_card.record_type() == CreditCard::MASKED_SERVER_CARD &&
      ...
      full_card_request = GetOrCreateFullCardRequest();
      full_card_request->SetFormParsedTimestamp(
...
bool AutofillManager::ParseForm(const FormData& form,
  ...
  TimeTicks form_parsed_timestamp = TimeTicks::Now();
  form_structure->set_form_parsed_timestamp(form_parsed_timestamp);
