...
class TestAutofillManager : public AutofillManager {
 public:
  ...
  void AddSeenForm(const FormData& form,
    ...
    form_interactions_ukm_logger()->OnFormsParsed(form.root_origin);
  }
...
void VerifyDeveloperEngagementUkm(
  ...
  EXPECT_EQ(form.root_origin, source->url());
...
TEST_F(AutofillMetricsTest, QualityMetrics) {
  ...
  form.root_origin = GURL("http://example_root.com/form.html");
...
TEST_F(AutofillMetricsTest, QueriedCreditCardFormIsSecure) {
...

  {
    ...
    form.root_origin = GURL("https://example_root.com/form.html");
    autofill_client_.set_form_origin(form.origin);
    autofill_manager_->AddSeenForm(form, field_types, field_types);
...
class AutofillMetricsParseQueryResponseTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    form.root_origin = GURL("http://foo_root.com");
    FormFieldData field;
