 ...
 public:
  class ObserverForTest {
   public:
    ...
    virtual void OnFooterShown() = 0;
    virtual void OnFooterHidden() = 0;
  ...
  // For the browser test observer.
  virtual void OnBubbleFooterShown() = 0;
  virtual void OnBubbleFooterHidden() = 0;
