...
enum class BadMessageReason {
  OBSOLETE_CPMD_BAD_ORIGIN_FORMS_PARSED = 1,
  OBSOLETE_CPMD_BAD_ORIGIN_FORMS_RENDERED = 2,
  OBSOLETE_CPMD_BAD_ORIGIN_FORM_SUBMITTED = 3,
  OBSOLETE_CPMD_BAD_ORIGIN_FOCUSED_PASSWORD_FORM_FOUND = 4,
  OBSOLETE_CPMD_BAD_ORIGIN_IN_PAGE_NAVIGATION = 5,
  OBSOLETE_CPMD_BAD_ORIGIN_PASSWORD_NO_LONGER_GENERATED = 6,
  OBSOLETE_CPMD_BAD_ORIGIN_PRESAVE_GENERATED_PASSWORD = 7,
  OBSOLETE_CPMD_BAD_ORIGIN_SAVE_GENERATION_FIELD_DETECTED_BY_CLASSIFIER = 8,
  OBSOLETE_CPMD_BAD_ORIGIN_SHOW_FALLBACK_FOR_SAVING = 9,
