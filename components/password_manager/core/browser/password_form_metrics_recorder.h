...
// This metric records whether submissions of password forms have been observed.
// The buckets 0 and 1 correspond to false and true respectively.
constexpr char kUkmSubmissionObserved[] = "Submission.Observed";

// This metric records the outcomes of password form submissions. The buckets
// are numbered according to PasswordFormMetricsRecorder::SubmitResult.
