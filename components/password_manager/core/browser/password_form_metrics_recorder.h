...
// was shown to ask the user for permission to update a password. The values
// correspond to PasswordFormMetricsRecorder::SaveBubbleTrigger.
...
// prompt was shown, which asked the user for permission to save new credential.
...
// was shown to ask the user for permission to save a new credential. The values
// correspond to PasswordFormMetricsRecorder::SaveBubbleTrigger.
