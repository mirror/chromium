...
class PasswordFormMetricsRecorder
 ...
 public:
  ...
  // (re-)bound to |main_frame_url| shortly before reporting. As such it crucial
  // that the |source_id| is never bound to a different URL by another consumer.
  // The reason for this late binding is that metrics can be collected for a
  // WebContents for a long period of time and by the time the reporting
  // happens, the binding of |source_id| to |main_frame_url| is already purged.
  // |ukm_recorder| may be a nullptr, in which case no UKM metrics are recorded.
