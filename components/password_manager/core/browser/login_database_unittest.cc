...
TEST_F(LoginDatabaseTest, ReloadOnFileCorrupt) {
  ...
  histogram_tester.ExpectUniqueSample(
    "Sqlite.SmartOpenRecovery.Passwords", 1, 1);
  histogram_tester.ExpectTotalCount(
    "Sqlite.SmartOpenDeleteFile.Passwords", 0);
}
...
TEST_F(LoginDatabaseTest, ReloadOnFileNotADB) {
  ...
  EXPECT_EQ(0U, result.size());
  histogram_tester.ExpectTotalCount(
    "Sqlite.SmartOpenRecovery.Passwords", 0);
  histogram_tester.ExpectUniqueSample(
    "Sqlite.SmartOpenDeleteFile.Passwords", 1, 1);
}
