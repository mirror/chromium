...
void PasswordFormManager::UpdateUsername(const base::string16& new_username) {
  ...
  // If |new_username| will not be found in |other_possible_usernames|, store
  // empty |username_element|.
  credential.username_element.clear();

  // |has_username_edited_vote_| will be true iff |new_username| was typed in
  // another field. Otherwise, |has_username_edited_vote_| is false and no vote
  // will be uploaded.
