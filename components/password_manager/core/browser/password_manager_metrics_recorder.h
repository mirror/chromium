...
// UKM that records a PasswordManagerMetricsRecorder::PasswordManagerUserAction.
extern const char kUkmPasswordManagerUserAction[];
...
class PasswordManagerMetricsRecorder {
 public:
  ...
  enum class PasswordManagerUserAction {
    kUnknown = 0,
  ...
  void RecordPasswordManagerUserAction(PasswordManagerUserAction action);
