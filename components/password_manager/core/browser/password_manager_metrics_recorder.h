...
// any onyer needs to destroy this instance when navigations are committed.
class PasswordManagerMetricsRecorder {
 public:
  ...
  // "PasswordManager". |source_id| should be bound the the correct URL in the
  ...
  // called multiple times but a single record will be reported.
 ...
 private:
  ...
  bool user_modified_password_field_;
