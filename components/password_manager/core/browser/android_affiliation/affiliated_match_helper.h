...
class AffiliatedMatchHelper : public PasswordStore::Observer,
 ...
 public:
  ...
  // credentials in |forms|, sets |affiliated_web_realm|, |branding_info_name|
  // and |branding_info_icon_url| of forms, and invokes |result_callback|. NOTE:
  // This will not issue an on-demand network request. If a request to cache
  // fails, no affiliation and branding information will be injected into
  // corresponding form.
 ...
 private:
  ...
  // information by setting |form->affiliated_web_realm|,
  // |form->branding_info_name| and |form->branding_info_icon_url| if |success|
