...
struct FacetBrandingInfo {
  // Human readable PlayStore name of this facet, e.g. "Netflix". This is empty
  // if this information is not available.
  std::string name;

  // URL of the corresponding PlayStore icon, e.g.
  // "https://lh3.googleusercontent.com/...". This is empty if this information
  // is not available.
  GURL icon_url;
};
