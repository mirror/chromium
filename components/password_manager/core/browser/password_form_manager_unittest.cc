...
// This fetcher clones itself.
class CloningFormFetcher : public FakeFormFetcher {
 public:
  std::unique_ptr<FormFetcher> Clone() override {
    return base::MakeUnique<CloningFormFetcher>();
  }
};
...
TEST_F(PasswordFormManagerTest, Clone_OnSave) {
  ...
  std::unique_ptr<PasswordFormManager> clone =
      form_manager->Clone(base::MakeUnique<NiceMock<MockFormSaver>>());
