...
#ifndef COMPONENTS_CRYPTAUTH_FAKE_REMOTE_DEVICE_PROVIDER_IMPL_H_
#define COMPONENTS_CRYPTAUTH_FAKE_REMOTE_DEVICE_PROVIDER_IMPL_H_
...
#endif  // COMPONENTS_CRYPTAUTH_FAKE_REMOTE_DEVICE_PROVIDER_IMPL_H_
