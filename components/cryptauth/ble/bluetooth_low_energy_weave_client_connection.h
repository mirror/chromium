...
class BluetoothLowEnergyWeaveClientConnection
 ...
 private:
  ...
  enum GattNotifySessionResult {
    GATT_NOTIFY_SESSION_RESULT_SUCCESS = 0,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_UNKNOWN = 1,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_FAILED = 2,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_IN_PROGRESS = 3,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_INVALID_LENGTH = 4,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_NOT_PERMITTED = 5,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_NOT_AUTHORIZED = 6,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_NOT_PAIRED = 7,
    GATT_NOTIFY_SESSION_RESULT_GATT_ERROR_NOT_SUPPORTED = 8,
    GATT_NOTIFY_SESSION_RESULT_MAX
  };
  ...
  GattConnectionResult BluetoothDeviceConnectErrorCodeToGattConnectionResult(
      device::BluetoothDevice::ConnectErrorCode error_code);
  void RecordGattNotifySessionResult(GattNotifySessionResult result);
