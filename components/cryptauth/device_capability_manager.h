...
class DeviceCapabilityManager {
 public:
  ...
  // that have |capability|.  User must pass a |success_callback| and
  // |error_callback| callback that is executed upon completion.
 ...
 private:
  ...
  void ProcessFindEligibleDevices();
