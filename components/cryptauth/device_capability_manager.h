...
class DeviceCapabilityManager {
 public:
  enum class Capability {
    ...
    // TODO(hsuregan): Add set capability for tether
    CAPABILITY_TETHER,
  };
  ...
  void FindEligibleDevices(
      ...
      const base::Callback<void(
          const ::google::protobuf::RepeatedPtrField<ExternalDeviceInfo>&)>&
          success_callback,
      const base::Callback<void(const std::string&)>& error_callback);
 ...
 private:
  ...
  void FindEligibleForUnlockDevices(
      const base::Callback<void(const ::google::protobuf::RepeatedPtrField<
                                ExternalDeviceInfo>&)>& success_callback,
      const CryptAuthClient::ErrorCallback& error_callback);
  ...
  void OnEligibleDevicesResponse(
      const base::Callback<void(const ::google::protobuf::RepeatedPtrField<
                                ExternalDeviceInfo>&)>& original_callback,
