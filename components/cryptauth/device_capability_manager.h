...
class DeviceCapabilityManager {
 ...
 private:
  ...
  struct Request {
    ...
    // Used for IS_DEVICE_PROMOTABLE Requests.
    Request(RequestType request_type,
            Capability capability,
            std::string public_key,
    ...
    // Defined for SET_CAPABILITY and IS_DEVICE_PROMOTABLE; otherwise, unused.
    std::string public_key;
    ...
    // Defined if |request_type_| is IS_DEVICE_PROMOTABLE; otherwise, unused.
