...
class DeviceCapabilityManager {
 ...
 private:
  ...
  struct Request {
    ...
    // Used for IS_DEVICE_PRMOTABLE Requests.
    Request(
    ...
    // Defined for SET_CAPABILITY and IS_DEVICE_PRMOTABLE; otherwise, unused.
    ...
    // Defined if |request_type_| is IS_DEVICE_PRMOTABLE; otherwise, unused.
    base::Callback<void(const bool&)> is_device_promotable_callback_;
  };
