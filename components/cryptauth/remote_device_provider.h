...
// This class manages syncing between remote devices that features involving
// multiple remote devices can use to keep a generic underlying connection.
...
class RemoteDeviceProvider : public CryptAuthDeviceManager::Observer {
 public:
  ...
  const RemoteDeviceList GetSyncedDevices();
