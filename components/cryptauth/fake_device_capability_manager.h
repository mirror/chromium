...
class FakeDeviceCapabilityManager : public cryptauth::DeviceCapabilityManager {
 public:
  ...
  void set_find_eligible_devices_for_capability_success(bool success) {
    find_eligible_devices_for_capability_success_ = success;
  }

  void set_is_capability_promotable_success(bool success) {
    is_capability_promotable_success_ = success;
  }

  void set_set_capability_enabled_error_code(std::string error_code) {
  ...
  bool find_eligible_devices_for_capability_success_ = true;
  bool is_capability_promotable_ = true;
  bool is_capability_promotable_success_ = true;
  std::string set_capability_enabled_error_code_ = kErrorCode;
  std::string is_capability_promotable_error_code_ = kErrorCode;
