...
class SuggestionsServiceTest : public testing::Test {
 protected:
  SuggestionsServiceTest()
    ...
    identity_test_env_.AutomaticallyGrantAccessTokenRequests(true);
  }
...
TEST_F(SuggestionsServiceTest, FetchSuggestionsDataNoAccessToken) {
  identity_test_env()->AutomaticallyGrantAccessTokenRequests(false);
  ...
  identity_test_env()->WaitForAccessTokenRequest();

  identity_test_env()->IssueErrorForAllPendingAccessTokenRequests(
