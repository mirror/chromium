...
class PreviewsOptimizationGuideImplTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    guide_ = std::make_unique<PreviewsOptimizationGuideImpl>(
 ...
 private:
  ...
  std::unique_ptr<PreviewsOptimizationGuideImpl> guide_;
...
TEST_F(PreviewsOptimizationGuideImplTest, ObserveWhitelistPopulatedCorrectly) {
...
TEST_F(PreviewsOptimizationGuideImplTest, ObserveUnsupportedKeyRepIsIgnored) {
  optimization_guide::proto::Configuration config;
...
TEST_F(PreviewsOptimizationGuideImplTest, ObserveHintWithNoKeyFailsDcheck) {
  optimization_guide::proto::Configuration config;
  optimization_guide::proto::Hint* hint = config.add_hints();
  hint->set_key_representation(optimization_guide::proto::HOST_SUFFIX);
  optimization_guide::proto::Optimization* optimization =
