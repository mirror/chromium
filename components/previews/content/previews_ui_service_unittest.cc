...
class TestPreviewsLogger : public PreviewsLogger {
 public:
  ...
  void LogPreviewDecisionMade(
      ...
      base::Time time,
      PreviewsType type,
      PassedPreviewsEligibilities&& passed_reasons) override {
  ...
  const PassedPreviewsEligibilities& decision_passed_reasons() const {
 ...
 private:
  ...
  PassedPreviewsEligibilities decision_passed_reasons_;
...
TEST_F(PreviewsUIServiceTest, TestLogPreviewDecisionMadePassesCorrectParams) {
  ...
  PassedPreviewsEligibilities passed_reasons_a = {
  ...
  const PassedPreviewsEligibilities expected_passed_reasons_a(passed_reasons_a);
  ...
  PassedPreviewsEligibilities passed_reasons_b = {
      PreviewsEligibilityReason::HOST_NOT_WHITELISTED_BY_SERVER,
      PreviewsEligibilityReason::NETWORK_QUALITY_UNAVAILABLE,
  };
  const PassedPreviewsEligibilities expected_passed_reasons_b(passed_reasons_b);
