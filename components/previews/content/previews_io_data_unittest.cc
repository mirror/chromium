...
class TestPreviewsUIService : public PreviewsUIService {
 public:
  ...
  const std::vector<PassedPreviewsEligibilities>& decision_passed_reasons()
      const {
 ...
 private:
  ...
  std::vector<PassedPreviewsEligibilities> decision_passed_reasons_;
...
TEST_F(PreviewsIODataTest, LogPreviewDecisionMadePassInCorrectParams) {
  ...
  const PassedPreviewsEligibilities expected_passed_reasons(passed_reasons);
