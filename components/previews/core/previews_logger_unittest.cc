...
class PreviewsLoggerTest : public testing::Test {
 public:
  ...
  std::string LogPreviewDecisionAndGetReasonDescription(
    ...
    logger_->LogPreviewDecisionMade(reason, url, time, type, reversed);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionAllowed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::ALLOWED, false /* reversed */);
  std::string expected_description = "Allowed";
  EXPECT_EQ(expected_description, actual_description);
}

TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionAllowedReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::ALLOWED, true /* reversed */);
  std::string expected_description = "Not allowed";
  EXPECT_EQ(expected_description, actual_description);
}

TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionUnavailabe) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::BLACKLIST_UNAVAILABLE, false /* reversed */);
  std::string expected_description = "Blacklist failed to be created";
  EXPECT_EQ(expected_description, actual_description);
}

TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionUnavailabeReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::BLACKLIST_UNAVAILABLE, true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionNotLoadedReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::BLACKLIST_DATA_NOT_LOADED,
      true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionRecentlyOptedOut) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::USER_RECENTLY_OPTED_OUT, false /* reversed */);
  std::string expected_description = "User recently opted out";
  EXPECT_EQ(expected_description, actual_description);
}

TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionRecentlyOptedOutReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::USER_RECENTLY_OPTED_OUT, true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionBlacklisted) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::USER_BLACKLISTED, false /* reversed */);
  std::string expected_description = "All previews are blacklisted";
  EXPECT_EQ(expected_description, actual_description);
}

TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionBlacklistedReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::USER_BLACKLISTED, true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionHostBlacklisted) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::HOST_BLACKLISTED, false /* reversed */);
...
TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionHostBlacklistedReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::HOST_BLACKLISTED, true /* reversed */);
...
TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionNetworkUnavailableReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::NETWORK_QUALITY_UNAVAILABLE,
      true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionNetworkNotSlow) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::NETWORK_NOT_SLOW, false /* reversed */);
...
TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionNetworkNotSlowReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::NETWORK_NOT_SLOW, true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionReloadDisallowed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::RELOAD_DISALLOWED, false /* reversed */);
  std::string expected_description =
...
TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionReloadDisallowedReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::RELOAD_DISALLOWED, true /* reversed */);
...
TEST_F(PreviewsLoggerTest, LogPreviewDecisionDescriptionServerRulesReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::HOST_BLACKLISTED_BY_SERVER,
      true /* reversed */);
...
TEST_F(PreviewsLoggerTest,
       LogPreviewDecisionDescriptionNotWhitelisedByServerReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::HOST_NOT_WHITELISTED_BY_SERVER,
      true /* reversed */);
...
TEST_F(
    PreviewsLoggerTest,
    LogPreviewDecisionDescriptionAllowedWithoutServerOptimizationHintsReversed) {
  std::string actual_description = LogPreviewDecisionAndGetReasonDescription(
      PreviewsEligibilityReason::ALLOWED_WITHOUT_OPTIMIZATION_HINTS,
      true /* reversed */);
