...
#ifndef CHROME_BROWSER_POLICY_POLICY_BLACKLIST_NAVIGATION_THROTTLE_H_
#define CHROME_BROWSER_POLICY_POLICY_BLACKLIST_NAVIGATION_THROTTLE_H_
...
class PolicyBlacklistNavigationThrottle : public content::NavigationThrottle {
 public:
  PolicyBlacklistNavigationThrottle(content::NavigationHandle*,
...
#endif  // CHROME_BROWSER_POLICY_POLICY_BLACKLIST_NAVIGATION_THROTTLE_H_
