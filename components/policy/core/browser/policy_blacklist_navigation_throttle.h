...
class POLICY_EXPORT PolicyBlacklistService : public KeyedService {
 public:
...
class POLICY_EXPORT PolicyBlacklistFactory
...
class POLICY_EXPORT PolicyBlacklistNavigationThrottle
