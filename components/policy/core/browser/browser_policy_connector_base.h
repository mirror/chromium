...
class POLICY_EXPORT BrowserPolicyConnectorBase {
 public:
  ...
  // its ownership is not taken though the connector will initialize and shut i
  // down.
 ...
 private:
  std::vector<ConfigurationPolicyProvider*> GetProviders();

  // Whether SetPolicyProviders() but not Shutdown() has been invoked.
  // XXX see about removing this.
