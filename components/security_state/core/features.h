...
// can have the following values: - 'warning': Show a Not Secure warning on all
// http:// pages - 'dangerous': Treat all http:// pages as actively dangerous -
// 'warning-and-dangerous-on-form-edits': Show a Not Secure warning on all
// http:// pages, and treat them as actively dangerous when the user edits form
// fields - 'warning-and-dangerous-on-passwords-and-credit-cards': Show a Not
// Secure warning on all http:// pages, and treat them as actively dangerous
// when there is a sensitive field
