...
class SyncSchedulerImplTest : public testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    workers_.clear();
    workers_.push_back(base::WrapRefCounted(new FakeModelWorker(GROUP_UI)));
    workers_.push_back(base::WrapRefCounted(new FakeModelWorker(GROUP_DB)));
    workers_.push_back(
        base::WrapRefCounted(new FakeModelWorker(GROUP_PASSIVE)));
