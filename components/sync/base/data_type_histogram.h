...
// Rounds memory size |value| to kilobytes and records it into |sample| bucket
// of histogram |name|. |value| should be greater or equal to 1 and |name| can
// be variable. DataTypes are  mapped to proper |sample| bucket by using
// ModelTypeToHistogramInt() function.
