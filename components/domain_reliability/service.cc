...
class DomainReliabilityServiceImpl : public DomainReliabilityService {
 ...
 private:
  void CheckUploadAllowedOnIOThread(
      base::SingleThreadTaskRunner* ui_task_runner,
      const GURL& origin,
      base::OnceCallback<void(bool)> callback) {
    LOG(ERROR) << "CheckUploadAllowedOnIOThread(" << origin.spec() << ")";
    ...
    ui_task_runner->PostTask(
        ...
        base::BindOnce(
            ...
            base::RetainedRef(base::ThreadTaskRunnerHandle::Get()), origin,
  ...
  void CheckUploadAllowedOnUIThread(
      ...
      const GURL& origin,
      base::OnceCallback<void(bool)> callback) {
    LOG(ERROR) << "CheckUploadAllowedOnUIThread(" << origin.spec() << ")";
