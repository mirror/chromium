...
bool ContentPreviewsRenderFrameObserver::ValidatePreviewsStateWithResponse(
  ...
  if (has_lite_page_state != has_lite_page_directive) {
    DLOG(ERROR) << "Inconsistent PreviewsState LitePage:" << has_lite_page_state
  ...
  if (has_lofi_state != has_empty_image_directive) {
    DLOG(ERROR) << "Inconsistent PreviewsState LitePage:" << has_lofi_state
