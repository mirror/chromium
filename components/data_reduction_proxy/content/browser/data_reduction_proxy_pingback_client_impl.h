...
#endif
{
 ...
 private:
  ...
  // The number of pageload messages in the current and pending fetcher.
  size_t current_fetcher_message_count_;
  size_t pending_fetcher_message_count_;

  // The number of pageload crash messages in the current and pending fetcher.
  size_t current_fetcher_crash_count_;
  size_t pending_fetcher_crash_count_;
