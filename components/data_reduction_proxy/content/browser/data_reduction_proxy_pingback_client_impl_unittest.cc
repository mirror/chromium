...
class TestDataReductionProxyPingbackClientImpl
 ...
 public:
  TestDataReductionProxyPingbackClientImpl(
      ...
      : DataReductionProxyPingbackClientImpl(url_request_context_getter),
        ...
        delay_(base::TimeDelta::FromSeconds(5)) {}
  ...
  void SetCrashReportingDelay(base::TimeDelta delay) { delay_ = delay; }
 ...
 private:
  ...
  base::TimeDelta GetCrashReportingDelay() const override { return delay_; }
...
class DataReductionProxyPingbackClientImplTest : public testing::Test {
 public:
  ...
  void SetCrashReportingDelayToZero() {
    pingback_client_->SetCrashReportingDelay(base::TimeDelta::FromSeconds(0));
  }
