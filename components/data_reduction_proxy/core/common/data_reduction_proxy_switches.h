...
extern const char kDataReductionProxyServerPreviews[];
extern const char kDataReductionProxyServerPreviewsEnabled[];
extern const char kDataReductionProxyServerPreviewsPreferLitePage[];
extern const char kDataReductionProxyServerPreviewsDisabled[];
