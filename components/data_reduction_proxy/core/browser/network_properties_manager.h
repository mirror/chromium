...
// Stores the properties of a single network. Created on the UI task runner. May
// be accessed on the IO task runner.
class NetworkPropertiesManager {
 ...
 private:
  ...
  // |path_| is the location of the network properties prefs.
