...
NetworkPropertiesManager::NetworkPropertiesManager(
    ...
    : ui_task_runner_(ui_task_runner),
      ...
      startup_networks_properties_(
          ConvertDictionaryValueToParsedPrefs(prefs_.get())),
  ...
  UMA_HISTOGRAM_EXACT_LINEAR(
      "DataReductionProxy.NetworkProperties.CountAtStartup", prefs_->size(),
      kMaxCacheSize);
}
...
void NetworkPropertiesManager::OnChangeInNetworkID(
  ...
  // Update |io_network_properties_|.
  {
    ...
    NetworksProperties::const_iterator it =
...
// static
NetworkPropertiesManager::NetworksProperties
NetworkPropertiesManager::ConvertDictionaryValueToParsedPrefs(
    const base::DictionaryValue* value) {
  NetworksProperties read_prefs;
