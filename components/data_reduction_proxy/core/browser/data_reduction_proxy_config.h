...
class DataReductionProxyConfig
 ...
 protected:
  ...
  // Sets |network_id| to the ID of the current network by calling the platform
  // APIs. |network_id| must not be null.
  virtual void GetCurrentNetworkID(std::string* network_id) const;
