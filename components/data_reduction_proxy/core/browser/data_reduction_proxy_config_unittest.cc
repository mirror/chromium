...
class DataReductionProxyConfigTest : public testing::Test {
 public:
  ...
  void CheckSecureProxyCheckOnConnectionChange(
...
TEST_F(DataReductionProxyConfigTest, TestOnNetworkChanged) {
  ...
  CheckSecureProxyCheckOnConnectionChange("OK", false, net::HTTP_OK, kSuccess,
  ...
  CheckSecureProxyCheckOnConnectionChange(
      "OK", true, net::HTTP_OK, kSuccess, SUCCEEDED_PROXY_ALREADY_ENABLED,
      std::vector<net::ProxyServer>(1, kHttpProxy));

  // Connection change triggers a secure proxy check that fails. Proxy is
  // restricted.
  CheckSecureProxyCheckOnConnectionChange(
      "Bad", false, net::HTTP_OK, kSuccess, FAILED_PROXY_DISABLED,
      std::vector<net::ProxyServer>(1, kHttpProxy));
  ...
  // restricted.
  CheckSecureProxyCheckOnConnectionChange(
      "Bad", true, net::HTTP_OK, kSuccess, FAILED_PROXY_DISABLED,
      std::vector<net::ProxyServer>(1, kHttpProxy));
  ...
  // restricted.
  CheckSecureProxyCheckOnConnectionChange(
      "Bad", false, net::HTTP_OK, kSuccess, FAILED_PROXY_ALREADY_DISABLED,
      std::vector<net::ProxyServer>(1, kHttpProxy));
