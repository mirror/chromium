...
bool DataReductionProxyConfig::IsDataReductionProxyACoreProxy(
...
void DataReductionProxyConfig::HandleWarmupFetcherResponse(
  ...
  bool is_core_proxy = IsDataReductionProxyACoreProxy(proxy_server);
  ...
  network_properties_manager_->SetHasWarmupURLProbeFailed(
      is_secure_drp_proxy, is_core_proxy, !success_response);
