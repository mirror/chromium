...
// Boolean that is true when translate is allowed (not necessarily enforced) by
// policy. If this is false, all translate functionality (e.g. the translate
// bubble, right-click translate) is disabled.
const char kTranslateAllowedByPolicy[] = "translate.policy_allowed";
