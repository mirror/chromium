...
TEST_F(TranslatePrefsTest, GetLanguageInfoListCorrectLocale) {
  ...
  TranslatePrefs::GetLanguageInfoList(true /* translate_allowed */, "en-US",
                                      &language_list);
  ...
  TranslatePrefs::GetLanguageInfoList(true /* translate_allowed */, "ja",
                                      &language_list);
  ...
  TranslatePrefs::GetLanguageInfoList(true /* translate_allowed */, "es-AR",
                                      &language_list);
  codes = ExtractLanguageCodes(language_list);
  EXPECT_THAT(codes, UnorderedElementsAreArray(expected_codes));
}
...
TEST_F(TranslatePrefsTest, GetLanguageInfoListSampleLanguages) {
  ...
  language_list.clear();
  TranslatePrefs::GetLanguageInfoList(true /* translate_allowed */, "it",
                                      &language_list);
