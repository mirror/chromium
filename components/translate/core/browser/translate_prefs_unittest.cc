...
class TranslatePrefsTest : public testing::Test {
 protected:
  ...
  void ExpectBlacklistContent(const std::vector<std::string>& list) {
...
TEST_F(TranslatePrefsTest, AddToLanguageList) {
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("", true);
  translate_prefs_->AddToLanguageList("", false);
  ExpectLanguagePrefs("");
  ExpectBlacklistContent(std::vector<std::string>());
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("it-IT", true);
  ExpectLanguagePrefs("it-IT,it", "it-IT");
  ExpectBlacklistContent({"it"});

  // Multiple languages.
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("it-IT", true);
  translate_prefs_->AddToLanguageList("fr-FR", true);
  translate_prefs_->AddToLanguageList("fr-CA", true);
  ExpectLanguagePrefs("it-IT,it,fr-FR,fr,fr-CA", "it-IT,fr-FR,fr-CA");
  ExpectBlacklistContent({"it", "fr"});

  // Language already in list.
  languages = {"en-US", "es-AR"};
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("es-AR", true);
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("es-ES", true);
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("it-IT", false);
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->AddToLanguageList("es-ES", false);
  ExpectLanguagePrefs("en-US,en,es-AR,es,es-ES", "en-US,es-AR,es-ES");
  ExpectBlacklistContent({"es"});
}
...
TEST_F(TranslatePrefsTest, RemoveFromLanguageList) {
  ...
  translate_prefs_->UpdateLanguageList(languages);
  translate_prefs_->ClearBlockedLanguages();
  translate_prefs_->RemoveFromLanguageList("");
  ExpectLanguagePrefs("");
  ExpectBlacklistContent(std::vector<std::string>());
