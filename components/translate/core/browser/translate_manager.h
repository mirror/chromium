...
class TranslateManager {
 public:
  ...
  // Returns the language to translate to. The language returned is the first
  // language found in the model that is supported by the translation service.
  // If no language is found then an empty string is returned.
  static std::string GetTargetLanguage(language::LanguageModel* language_model);
