...
const char kUMATranslateLanguageSettingChanges[] =
    "Translate.LanguageSettingChanges";
...
void TranslatePrefs::UpdateLanguageList(
  ...
  // UMA logging for the user who has made change to the language settings.
  UMA_HISTOGRAM_BOOLEAN(kUMATranslateLanguageSettingChanges, true);
}
