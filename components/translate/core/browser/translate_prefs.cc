...
TranslateLanguageInfo::TranslateLanguageInfo(
    const TranslateLanguageInfo& other) {
  code = other.code;
  display_name = other.display_name;
  native_display_name = other.native_display_name;
  display_name_rtl = other.display_name_rtl;
  supports_translate = other.supports_translate;
}
...
void TranslatePrefs::GetLanguageInfoList(
    ...
    std::vector<TranslateLanguageInfo>* language_list) const {
  ...
  for (const auto& entry : language_map) {
    ...
    language.supports_translate =
        translate_language_set.count(supports_translate_code);
