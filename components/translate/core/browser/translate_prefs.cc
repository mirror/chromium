...
const char kUMATranslateLanguageSettingsFirstChange[] =
    "Translate.LanguageSettingsFirstChange";
...
void TranslatePrefs::UpdateLanguageList(
  ...
  if (!language_setting_changed->GetBool()) {
    ...
    UMA_HISTOGRAM_BOOLEAN(kUMATranslateLanguageSettingsFirstChange, true);
