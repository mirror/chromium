...
class TranslateLanguageInfo {
 public:
  ...
  // Whether the display name is RTL text.
  bool display_name_rtl;
...
class TranslatePrefs {
 public:
  ...
  void GetLanguageInfoList(const std::string& app_locale,
                           std::vector<TranslateLanguageInfo>* languages) const;
