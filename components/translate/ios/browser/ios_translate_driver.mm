...
void IOSTranslateDriver::ObserveLanguageDetection(
    language::LanguageDetector* const language_detector) {
  language_detector->AddLanguageDetectionObserver(weak_method_factory_.GetWeakPtr());
}

void IOSTranslateDriver::OnLanguageDetected(const LanguageDetectionDetails& details) {
