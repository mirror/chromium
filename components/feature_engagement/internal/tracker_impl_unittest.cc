...
TEST_F(TrackerImplTest, TestTriggering) {
  ...
  VerifyHistograms(true, 1, 1, false, 0, 0, false, 0, 0, true, 0, 1);
  ...
  VerifyUserActionsDismissed(user_action_tester, 0);
  VerifyHistograms(true, 1, 1, true, 0, 1, false, 0, 0, true, 0, 2);
  ...
  VerifyHistograms(true, 1, 2, true, 1, 1, false, 0, 0, true, 0, 3);
  ...
  VerifyHistograms(true, 1, 3, true, 1, 2, false, 0, 0, true, 0, 4);
}
...
TEST_F(TrackerImplTest, TestTrackingOnlyTriggering) {
  ...
  VerifyUserActionsTriggered(user_action_tester, 0, 0, 1, 0);
  VerifyUserActionsNotTriggered(user_action_tester, 1, 0, 0, 0);
  VerifyUserActionsDismissed(user_action_tester, 0);
  VerifyHistograms(true, 0, 1, false, 0, 0, true, 1, 0, false, 0, 0);
  ...
  VerifyUserActionsDismissed(user_action_tester, 0);
  VerifyHistograms(true, 0, 2, false, 0, 0, true, 1, 0, false, 0, 0);
  ...
  VerifyUserActionsTriggered(user_action_tester, 1, 0, 1, 0);
  VerifyUserActionsNotTriggered(user_action_tester, 2, 0, 1, 0);
  VerifyUserActionsDismissed(user_action_tester, 1);
  VerifyHistograms(true, 1, 2, false, 0, 0, true, 1, 1, false, 0, 0);
}
