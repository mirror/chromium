...
public final class FeatureConstants {
     ...
     */
    public static final String CONTEXTUAL_SEARCH_WEB_SEARCH_FEATURE = "IPH_ContextualSearch";

    /**
     * An IPH feature for promoting tap over longpress for activating Contextual Search.
     */
    public static final String CONTEXTUAL_SEARCH_PROMOTE_TAP_FEATURE = "IPH_ContextualSearchTap";
