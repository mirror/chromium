...
Logo GetSampleLogo(const GURL& logo_url, base::Time response_time) {
  ...
  logo.metadata.source_url =
      GoogleNewAppendQueryparamsToLogoURL(false, logo_url);
...
void LogoServiceImplTest::SetServerResponseWhenFingerprint(
    ...
    net::URLRequestStatus::Status request_status,
    net::HttpStatusCode response_code) {
  GURL url_with_fp = GoogleAppendFingerprintParamToLogoURL(
...
TEST_F(LogoServiceImplTest, CTAURLHasComma) {
  GURL url_with_fp = GoogleAppendFingerprintParamToLogoURL(
      GoogleLegacyAppendQueryparamsToLogoURL(false,
                                             GURL("http://logourl.com/path")),
      "abc123");
  EXPECT_EQ("http://logourl.com/path?async=cta:1,es_dfp:abc123",
            url_with_fp.spec());

  url_with_fp = GoogleAppendFingerprintParamToLogoURL(
      GoogleLegacyAppendQueryparamsToLogoURL(false,
                                             GURL("http://logourl.com/?a=b")),
      "");
...
TEST_F(LogoServiceImplTest, CTAGrayBackgroundHasCommas) {
  GURL url_with_fp = GoogleAppendFingerprintParamToLogoURL(
      GoogleLegacyAppendQueryparamsToLogoURL(true,
                                             GURL("http://logourl.com/path")),
      "abc123");
  EXPECT_EQ(
      "http://logourl.com/path?async=cta:1,transp:1,graybg:1,es_dfp:abc123",
      url_with_fp.spec());
...
TEST_F(LogoServiceImplTest, CTARequestedBackgroundCanUpdate) {
  ...
  GURL query_with_gray_background = GoogleAppendFingerprintParamToLogoURL(
      GoogleNewAppendQueryparamsToLogoURL(true, DoodleURL()), std::string());
  GURL query_without_gray_background = GoogleAppendFingerprintParamToLogoURL(
      GoogleNewAppendQueryparamsToLogoURL(false, DoodleURL()), std::string());
...
TEST_F(LogoServiceImplTest, DownloadAndCacheLogo) {
  ...
  StrictMock<MockLogoCallback> fresh;
  // GoogleNewAppendQueryparamsToLogoURL
...
TEST_F(LogoServiceImplTest, AcceptMinimalLogoResponse) {
  ...
  logo.metadata.source_url =
      GoogleNewAppendQueryparamsToLogoURL(false, DoodleURL());
  logo.metadata.can_show_after_expiration = true;
  logo.metadata.mime_type = "image/png";
