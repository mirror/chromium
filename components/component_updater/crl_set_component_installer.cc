...
void LoadCRLSet(const base::FilePath& crl_path) {
  ...
  net::SSLConfigService::UpgradeCRLSet(crl_set);
}
...
bool CRLSetPolicy::VerifyInstallation(const base::DictionaryValue& manifest,
  ...
  return base::PathExists(install_dir.Append("crl-set"));
}
...
void CRLSetPolicy::ComponentReady(
  ...
  base::PostTaskWithTraits(
      ...
      base::BindOnce(&LoadCRLSet, install_dir.Append("crl-set")));
}
...
void DeleteLegacyCRLSet(const base::FilePath& user_data_dir) {
  base::PostTaskWithTraits(
      ...
      base::BindOnce(base::IgnoreResult(&base::DeleteFile),
                     user_data_dir.Append("Certificate Revocation Lists"),
                     false));
}
