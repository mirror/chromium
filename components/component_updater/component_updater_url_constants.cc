...
const char kUpdaterDefaultUrl[] = "https://omaha.sandbox.google.com/service/update2";

const char kUpdaterFallbackUrl[] = "https://omaha.sandbox.google.com/service/update2";
