...
// TODO(hamelphi) : Refactor this so that the service owns the predictor objects
// and keep a registry of loaded predictors in order to avoid cache collisions.
//
...
class AssistRankerService : public KeyedService {
 public:
  ...
  // TODO(hamelphi): Enforce model uniqueness through internal registration.
