...
#include "third_party/WebKit/public/platform/WebSpellCheckPanelHost.h"
...
class SpellCheckPanel : public content::RenderFrameObserver,
                        public blink::WebSpellCheckPanelHost,
 ...
 private:
  ...
  // Returns the frame host SpellCheckPanelHost interface.
  spellcheck::mojom::SpellCheckPanelHostPtr SpellingPanelHost();

  // blink::WebSpellCheckPanelHost:
  bool IsShowingSpellingUI() override;
  void ShowSpellingUI(bool show) override;
  void UpdateSpellingUIWithMisspelledWord(
      const blink::WebString& word) override;

  // Binds frame host requests for the frame SpellCheckPanel interface.
