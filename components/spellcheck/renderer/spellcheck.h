...
class SpellCheck : public content::RenderThreadObserver,
 ...
 private:
   ...
   // Handle requests for the spellcheck::mojom::SpellChecker interface.
   void SpellCheckClientRequest(spellcheck::mojom::SpellCheckerRequest request);
  ...
  // Bindings for spellcheck clients.
  mojo::BindingSet<spellcheck::mojom::SpellChecker> spellcheck_client_bindings_;
