...
SpellCheckPanel::SpellCheckPanel(content::RenderFrame* render_frame)
  ...
  render_frame->GetWebFrame()->SetSpellCheckPanelHost(this);
}
...
spellcheck::mojom::SpellCheckPanelHostPtr SpellCheckPanel::SpellingPanelHost() {
...
void SpellCheckPanel::ShowSpellingUI(bool show) {
  ...
  SpellingPanelHost()->ShowSpellingPanel(show);
}

void SpellCheckPanel::UpdateSpellingUIWithMisspelledWord(
    const blink::WebString& word) {
  SpellingPanelHost()->UpdateSpellingPanelWithMisspelledWord(word.Utf16());
}
