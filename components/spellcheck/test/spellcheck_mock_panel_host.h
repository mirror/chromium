...
#ifndef COMPONENTS_SPELLCHECK_TEST_SPELLCHECK_MOCK_PANEL_HOST_H_
#define COMPONENTS_SPELLCHECK_TEST_SPELLCHECK_MOCK_PANEL_HOST_H_
...
#endif  // COMPONENTS_SPELLCHECK_TEST_SPELLCHECK_MOCK_PANEL_HOST_H_
