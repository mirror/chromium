...
class MockOnNewRemoteSuggestionCallback {
 public:
  ...
  MOCK_METHOD1(Run, void(std::unique_ptr<RemoteSuggestion>* remote_suggestion));
};
...
TEST_F(BreakingNewsGCMAppHandlerTest,
       ShouldCallOnNewRemoteSuggestionCallbackUponPushByValueMessage) {
  std::string json = R"(
      {"categories" : [{
        "id": 1,
        ...
        "suggestions" : [{
          ...
          "expirationTime" : "2018-01-01T00:00:01.000Z",
...
TEST_F(BreakingNewsGCMAppHandlerTest,
       ShouldCallOnRefreshRequestedCallbackUponPushToRefreshMessage) {
  SetFeatureParams(/*enable_token_validation=*/false,
                   /*enable_forced_subscription=*/false);
