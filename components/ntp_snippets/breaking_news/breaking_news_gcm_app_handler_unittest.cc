...
class FakeCautiousGCMDriver : public gcm::GCMDriver {
 public:
  ...
  void OnSignedIn() override { FAIL() << "Not implemented"; }
  void OnSignedOut() override { FAIL() << "Not implemented"; }
  ...
  void Enable() override { FAIL() << "Not implemented"; }
  void Disable() override { FAIL() << "Not implemented"; }
...
TEST_F(BreakingNewsGCMAppHandlerTest,
  ...
  // Check that handler validates the token through GetToken. ValidateToken
