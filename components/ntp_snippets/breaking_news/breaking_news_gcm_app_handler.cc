...
void BreakingNewsGCMAppHandler::StartListening(
    OnNewArticleSuggestionCallback on_new_article_suggestion_callback) {
  ...
  on_new_article_suggestion_callback_ =
      std::move(on_new_article_suggestion_callback);
...
void BreakingNewsGCMAppHandler::StopListening() {
  ...
  on_new_article_suggestion_callback_ = OnNewArticleSuggestionCallback();
...
void BreakingNewsGCMAppHandler::OnJsonSuccess(
  ...
  on_new_article_suggestion_callback_.Run(
