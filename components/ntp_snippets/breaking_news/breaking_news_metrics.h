...
// Received message action to report the action in the pushed message. This enum
// is used in a UMA histogram, therefore, don't remove or reorder elements, only
// add new ones at the end (before COUNT), and keep in sync with
// ContentSuggestionsBreakingNewsMessageAction in enums.xml.
