...
const char kHistogramMessagesReceived[] =
    "NewTabPage.ContentSuggestions.BreakingNews.MessagesReceived";
...
void OnMessageReceived(bool contains_pushed_news) {
  UMA_HISTOGRAM_BOOLEAN(kHistogramMessagesReceived, contains_pushed_news);
}
