...
class BreakingNewsGCMAppHandler : public BreakingNewsListener,
 ...
 public:
  ...
  void StartListening(OnNewArticleSuggestionCallback
                          on_new_article_suggestion_callback) override;
 ...
 private:
  ...
  OnNewArticleSuggestionCallback on_new_article_suggestion_callback_;
