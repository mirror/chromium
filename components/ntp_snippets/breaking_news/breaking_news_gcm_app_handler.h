...
// TODO(vitaliii): To/FromInternalValue have been deprecated (crbug.com/634507).
// Once they provide a better (backward-compatible) way for serialization,
...
class BreakingNewsGCMAppHandler : public BreakingNewsListener,
 ...
 private:
  ...
  // Called when token validation response is obtained from the GCM server.
  void DidValidateToken(bool is_valid);
