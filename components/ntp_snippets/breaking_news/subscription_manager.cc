...
void SubscriptionManager::Unsubscribe(const std::string& token) {
  UnsubscribeInternal(/*old_token=*/token, /*new_token=*/std::string());
}

void SubscriptionManager::UnsubscribeInternal(const std::string& old_token,
...
void SubscriptionManager::Resubscribe(const std::string& old_token,
                                      const std::string& new_token) {
  UnsubscribeInternal(old_token, new_token);
}
