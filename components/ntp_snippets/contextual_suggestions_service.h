...
#ifndef COMPONENTS_NTP_SNIPPETS_CONTEXTUAL_SUGGESTIONS_SERVICE_H_
#define COMPONENTS_NTP_SNIPPETS_CONTEXTUAL_SUGGESTIONS_SERVICE_H_
...
class ContextualSuggestionsService {
 public:
  ...
  // Removes all contextual suggestions from the cache.
  void ClearCachedContextualSuggestions();
...
#endif  // COMPONENTS_NTP_SNIPPETS_CONTEXTUAL_SUGGESTIONS_SERVICE_H_
