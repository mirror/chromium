...
const base::FeatureParam<int> kPassingMarginParam{
...
const base::FeatureParam<int> kNumTopCategoriesWithExtraMarginParam{
    &kCategoryRanker,
...
const base::FeatureParam<int> kExtraPassingMarginParam{
...
const base::FeatureParam<int> kMinNumClicksToDecayParam{
...
const base::FeatureParam<int> kTimeBetweenDecaysParam{
...
const base::FeatureParam<int> kDecayFactorNumeratorParam{
    &kCategoryRanker, "click_based_category_ranker-decay_factor_numerator", 91};
const base::FeatureParam<int> kDecayFactorDenominatorParam{
...
const base::FeatureParam<int> kDismissedCategoryPenaltyParam{
    &kCategoryRanker, "click_based_category_ranker-dismissed_category_penalty",
    1};

const base::FeatureParam<int> kContentSuggestionsPromotedCategoryParam{
