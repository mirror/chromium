...
const base::FeatureParam<int> kMaxBookmarksParam{&kBookmarkSuggestionsFeature,
                                                 "bookmarks_max_count", 10};
const base::FeatureParam<int> kMaxBookmarkAgeInDaysParam{
    &kBookmarkSuggestionsFeature, "bookmarks_max_age_in_days", 7};
const base::FeatureParam<bool> kConsiderDesktopVisitsParam{
