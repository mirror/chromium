...
void AddFetchedCategoriesToRankerBasedOnArticlesCategory(
    ...
    const RemoteSuggestionsHelper::FetchedCategoriesVector& fetched_categories,
  ...
  for (const RemoteSuggestionsHelper::FetchedCategory& fetched_category :
       fetched_categories) {
...
void RemoteSuggestionsProviderImpl::OnFetchFinished(
  ...
  if (fetched_categories) {
    ...
    for (RemoteSuggestionsHelper::FetchedCategory& fetched_category :
         *fetched_categories) {
