...
const base::FeatureParam<int> kBackground5xxRetriesParam{
    &ntp_snippets::kArticleSuggestionsFeature, "background_5xx_retries_count",
    0};

const base::FeatureParam<bool> kSendTopLanguagesParam{
    &ntp_snippets::kArticleSuggestionsFeature, "send_top_languages", true};

const base::FeatureParam<bool> kSendUserClassParam{
