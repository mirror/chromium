...
TEST_F(RemoteSuggestionsSchedulerImplTest,
  ...
  feature_list.InitAndEnableFeature(kRemoteSuggestionsM58FetchingSchedule);
  RemoteSuggestionsProvider::FetchStatusCallback signal_fetch_done;
  ...
  // Foreground the browser again after a very long delay. This time no fetch is
  // executed for nother Foregrounded, nor ColdStart
