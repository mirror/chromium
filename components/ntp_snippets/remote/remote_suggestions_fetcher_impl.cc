...
const std::string& RemoteSuggestionsFetcherImpl::last_status_for_debugging()
    const {
  return last_status_;
}
const std::string& RemoteSuggestionsFetcherImpl::last_json_for_debugging()
    const {
  return last_fetch_json_;
}
const GURL& RemoteSuggestionsFetcherImpl::fetch_url_for_debugging() const {
  return fetch_url_;
}
...
bool RemoteSuggestionsFetcherImpl::JsonToSnippets(
