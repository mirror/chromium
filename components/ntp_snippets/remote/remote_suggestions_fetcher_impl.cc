...
const std::string& RemoteSuggestionsFetcherImpl::last_status() const {
  return last_status_;
}
const std::string& RemoteSuggestionsFetcherImpl::last_json() const {
  return last_fetch_json_;
}
const GURL& RemoteSuggestionsFetcherImpl::fetch_url() const {
  return fetch_url_;
}
