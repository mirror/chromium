...
class RemoteSuggestionsFetcherImpl : public RemoteSuggestionsFetcher {
 public:
  ...
  const std::string& last_status_for_debugging() const override;
  const std::string& last_json_for_debugging() const override;
  const GURL& fetch_url_for_debugging() const override;
