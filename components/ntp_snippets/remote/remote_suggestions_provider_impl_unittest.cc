...
class FetchedCategoryBuilder {
 public:
  ...
  FetchedCategoryBuilder& AddSuggestionAsBuilder(
...
TEST_F(RemoteSuggestionsProviderImplTest, Full) {
  ...
  fetched_categories.push_back(
      FetchedCategoryBuilder()
          ...
          .AddSuggestionAsBuilder(RemoteSuggestionBuilder()
          ...
          .Build());
  FetchThisSuggestions(provider.get(), /*interactive_request=*/true,
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  FetchThisSuggestions(provider.get(), /*interactive_request=*/false,
