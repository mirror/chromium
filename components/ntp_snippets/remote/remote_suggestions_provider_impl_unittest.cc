...
class RemoteSuggestionsProviderImplTest : public ::testing::Test {
 public:
  ...
  MakeSuggestionsProviderWithoutInitialization(
    ...
    if (use_fake_breaking_news_listener) {
      breaking_news_listener = base::MakeUnique<FakeBreakingNewsListener>();
    }
 ...
 protected:
  ...
  void PushArticleSuggestionToTheFront(
    ...
    static_cast<FakeBreakingNewsListener*>(breaking_news_listener_)
        ->PushSuggestion(std::move(suggestion));
  }
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  FakeBreakingNewsListener* fake_breaking_news_listener =
      static_cast<FakeBreakingNewsListener*>(breaking_news_listener());
  EXPECT_FALSE(fake_breaking_news_listener->IsListening());
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  FakeBreakingNewsListener* fake_breaking_news_listener =
      static_cast<FakeBreakingNewsListener*>(breaking_news_listener());
  ASSERT_FALSE(fake_breaking_news_listener->IsListening());
  ...
  ChangeRemoteSuggestionsStatus(
      RemoteSuggestionsStatus::EXPLICITLY_DISABLED,
      RemoteSuggestionsStatus::ENABLED_AND_SIGNED_OUT);
  EXPECT_TRUE(fake_breaking_news_listener->IsListening());
}
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  ChangeRemoteSuggestionsStatus(
      RemoteSuggestionsStatus::EXPLICITLY_DISABLED,
      RemoteSuggestionsStatus::ENABLED_AND_SIGNED_OUT);
  ASSERT_TRUE(fake_breaking_news_listener->IsListening());
