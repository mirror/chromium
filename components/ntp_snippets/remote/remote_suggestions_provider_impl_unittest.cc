...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  ASSERT_THAT(
      provider->GetSuggestionsForTesting(articles_category()),
      ElementsAre(Pointee(Property(&RemoteSuggestion::id, "http://1.com")),
                  Pointee(Property(&RemoteSuggestion::id, "http://3.com")),
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  // database to simulate behaviour of an older version.
