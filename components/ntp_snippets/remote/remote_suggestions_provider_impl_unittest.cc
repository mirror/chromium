...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  // The timeout does not fire earlier that it should.
  FastForwardBy(
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  auto response_callback_not_used =
      RefetchWhileDisplayingAndGetResponseCallback(provider.get());
...
TEST_F(RemoteSuggestionsProviderImplTest,
       ShouldPostponeTimeoutIfRefetchWhileDisplayingCalledAgain) {
  // Initialize the provider with two categories.
  auto provider = MakeSuggestionsProvider(
      /*use_mock_prefetched_pages_tracker=*/false,
      /*use_fake_breaking_news_listener=*/false,
  ...
  auto response_callback1_not_used =
      RefetchWhileDisplayingAndGetResponseCallback(provider.get());
  ...
  // Another fetch postpones the deadline.
  auto response_callback2_not_used =
      RefetchWhileDisplayingAndGetResponseCallback(provider.get());
