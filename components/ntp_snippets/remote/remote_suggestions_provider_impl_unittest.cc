...
class RemoteSuggestionsProviderImplTest : public ::testing::Test {
 ...
 protected:
  ...
  void SetCategoriesNotPresentInLastFetchResponseDeletionParam(bool enabled) {
    // VariationParamsManager supports only one
    // |SetVariationParamsWithFeatureAssociations| at a time, so we clear
    // previous settings first to make this explicit.
    params_manager_.ClearAllVariationParams();
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  SetCategoriesNotPresentInLastFetchResponseDeletionParam(/*enabled=*/true);
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  SetCategoriesNotPresentInLastFetchResponseDeletionParam(/*enabled=*/false);
