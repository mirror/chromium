...
class RemoteSuggestionsProviderImplTest : public ::testing::Test {
 ...
 protected:
  ...
  void SetDeleteCategoriesNotPresentInLastFetchResponseParam(bool enabled) {
    // VariationParamsManager supports only one
    // |SetVariationParamsWithFeatureAssociations| at a time, so we clear
    // previous settings first to make this explicit.
    params_manager_.ClearAllVariationParams();
    params_manager_.SetVariationParamsWithFeatureAssociations(
        kArticleSuggestionsFeature.name,
        {{"delete_categories_not_present_in_last_fetch_response",
...
TEST_F(RemoteSuggestionsProviderImplTest,
  ...
  SetDeleteCategoriesNotPresentInLastFetchResponseParam(/*enabled=*/true);
...
TEST_F(RemoteSuggestionsProviderImplTest,
       ShouldNotDeleteFetchedCategoryWhenDeletionEnabled) {
  SetDeleteCategoriesNotPresentInLastFetchResponseParam(/*enabled=*/true);
...
TEST_F(RemoteSuggestionsProviderImplTest,
       ShouldNotDeleteArticleCategoryEvenWhenNotFetchedAndDeletionEnabled) {
  SetDeleteCategoriesNotPresentInLastFetchResponseParam(/*enabled=*/true);
...
TEST_F(RemoteSuggestionsProviderImplTest,
       ShouldNotDeleteNotFetchedCategoryWhenDeletionDisabled) {
  SetDeleteCategoriesNotPresentInLastFetchResponseParam(/*enabled=*/false);
