...
class RemoteSuggestionsProviderImpl final : public RemoteSuggestionsProvider {
 ...
 private:
  ...
  // Calls UpdateCategoryStatus(_, CategoryStatus::AVAILABLE) for all provided
  // categories (unless they are currently loading).
  void UpdateAllNonLoadingCategoryStatusAvailable();
