...
#include "components/ntp_snippets/contextual/cached_timestamped_map.h"
...
class ContextualContentSuggestionsService : public KeyedService {
 ...
 private:
  ...
  // Non-persistant cache for contextual suggestions.
  internal::CachedTimestampedMap<GURL, std::vector<ContextualSuggestion>>
