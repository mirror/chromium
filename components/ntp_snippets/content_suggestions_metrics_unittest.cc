...
TEST(ContentSuggestionsMetricsTest, ShouldLogOnSuggestionsShown) {
  ...
  OnSuggestionShown(/*global_position=*/1,
                    ...
                    /*position_in_category=*/3, base::Time::Now(), 0.01f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/false);
  // Test corner cases for score.
  OnSuggestionShown(/*global_position=*/1,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/3, base::Time::Now(), 0.0f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/false);
  OnSuggestionShown(/*global_position=*/1,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/3, base::Time::Now(), 1.0f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/false);
  OnSuggestionShown(/*global_position=*/1,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/3, base::Time::Now(), 8.0f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/false);
...
TEST(ContentSuggestionsMetricsTest, ShouldLogOnPrefetchedSuggestionsShown) {
  base::HistogramTester histogram_tester;
  OnSuggestionShown(/*global_position=*/11,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/1, base::Time::Now(), 0.01f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/false);
  // Test corner cases for score.
  ...
  OnSuggestionShown(/*global_position=*/15,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/5, base::Time::Now(), 1.0f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
                    /*is_prefetched=*/false, /*is_offline=*/true);
  OnSuggestionShown(/*global_position=*/23,
                    Category::FromKnownCategory(KnownCategories::ARTICLES),
                    /*position_in_category=*/13, base::Time::Now(), 8.0f,
                    base::Time::Now() - base::TimeDelta::FromHours(2),
...
TEST(ContentSuggestionsMetricsTest, ShouldLogOnPrefetchedSuggestionsOpened) {
  base::HistogramTester histogram_tester;
...
TEST(ContentSuggestionsMetricsTest,
     ShouldLogPrefetchenInNonEmptyShownCategoryWhenPageShown) {
  base::HistogramTester histogram_tester;
  OnPageShown(std::vector<Category>(
                  {Category::FromKnownCategory(KnownCategories::ARTICLES)}),
              /*suggestions_per_category=*/{10},
