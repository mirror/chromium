...
TEST_F(SSLConfigServiceManagerPrefTest, TLS13VariantFeatureDisabled) {
  ...
  params["variant"] = "disabled";
  base::FieldTrialList::CreateFieldTrial("TLS13Variant", "Disabled");
  base::AssociateFieldTrialParams("TLS13Variant", "Disabled", params);
...
TEST_F(SSLConfigServiceManagerPrefTest, TLS13VariantFeatureDraft) {
  ...
  base::FieldTrialList field_trial_list(nullptr);
  std::map<std::string, std::string> params;
  params["variant"] = "draft";
  base::FieldTrialList::CreateFieldTrial("TLS13Variant", "Draft");
  base::AssociateFieldTrialParams("TLS13Variant", "Draft", params);
...
TEST_F(SSLConfigServiceManagerPrefTest, TLS13VariantFeatureExperiment) {
  ...
  base::FieldTrialList field_trial_list(nullptr);
  std::map<std::string, std::string> params;
  params["variant"] = "experiment";
  base::FieldTrialList::CreateFieldTrial("TLS13Variant", "Experiment");
  base::AssociateFieldTrialParams("TLS13Variant", "Experiment", params);
