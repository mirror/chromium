...
TEST_F(NetworkErrorLoggingServiceTest,
  ...
  service()->OnNetworkError(
      kOriginDifferentPort_, net::ERR_CONNECTION_REFUSED,
      base::Bind(&FillErrorDetails, kUrl_, net::ERR_CONNECTION_REFUSED));
...
TEST_F(NetworkErrorLoggingServiceTest, ExcludeSubdomainsDoesntMatchSubdomain) {
  ...
  service()->OnNetworkError(kOriginSubdomain_, net::ERR_CONNECTION_REFUSED,
                            base::Bind(&FillErrorDetails, kUrlSubdomain_,
...
TEST_F(NetworkErrorLoggingServiceTest, IncludeSubdomainsMatchesDifferentPort) {
  ...
  service()->OnNetworkError(kOriginDifferentPort_, net::ERR_CONNECTION_REFUSED,
                            base::Bind(&FillErrorDetails, kUrlDifferentPort_,
                                       net::ERR_CONNECTION_REFUSED));
