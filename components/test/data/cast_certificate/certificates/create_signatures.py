...
def create_signed_data(key_path, signed_data_pem_path):
...
These signatures were generated using the key from certificate:
  CN=RSA 1024 Device Cert

Which is defined in:
  ../certificates/rsa1024_device_cert.pem
