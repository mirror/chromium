...
TEST_F(HttpTest, ChangeThreadPriorityAfterStart) {
  // iOS Simulator doesn't support changing thread priorities.
  // Therefore, run this test only on a physical device.
  if (IsSimulator())
    return;
