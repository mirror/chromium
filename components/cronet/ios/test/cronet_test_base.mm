...
@implementation TestDelegate {
  // Dictinoary which maps tasks to completion semaphores for this TestDelegate.
  ...
  NSMutableDictionary*
      _semaphores;  // key: NSURLSessionDataTask*, value: dispatch_semaphore_t

  NSMutableDictionary* _responseDataPerTask;  // key: NSURLSessionDataTask*,
                                              // value: NSMutableArray<NSData*>*

  // private variable to allow for convenience functions that do not specify a
  // specific task
...
// |deadline|, if positive, specifies how long to wait before timing out in
