...
class CronetMetricsTest : public CronetTestBase {
 protected:
  ...
  void TearDown() override {
    EXPECT_FALSE([Cronet metricsTaskMapSizeForTesting]);
...
// Tests that CronetTransactionMetrics properties are set correctly.
TEST_F(CronetEnabledMetricsTest, Setters) {
  if (@available(iOS 10, *)) {
    ...
    cronet_metrics.request = test_req;
    cronet_metrics.response = test_resp;

    cronet_metrics.fetchStartDate = test_date;
    cronet_metrics.domainLookupStartDate = test_date;
    cronet_metrics.domainLookupEndDate = test_date;
    cronet_metrics.connectStartDate = test_date;
    cronet_metrics.secureConnectionStartDate = test_date;
    cronet_metrics.secureConnectionEndDate = test_date;
    cronet_metrics.connectEndDate = test_date;
    cronet_metrics.requestStartDate = test_date;
    cronet_metrics.requestEndDate = test_date;
    cronet_metrics.responseStartDate = test_date;
    cronet_metrics.responseEndDate = test_date;

    cronet_metrics.networkProtocolName = @"http/2";
    cronet_metrics.proxyConnection = YES;
    cronet_metrics.reusedConnection = YES;
    cronet_metrics.resourceFetchType =
