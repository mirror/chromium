...
base::SingleThreadTaskRunner* CronetEnvironment::NetworkThreadTaskRunner() {
...
void CronetEnvironment::PostToNetworkThread(
  ...
  NetworkThreadTaskRunner()->PostTask(from_here, task);
}
...
void CronetEnvironment::Start() {
  ...
  main_context_getter_ = new CronetURLRequestContextGetter(
      this, CronetEnvironment::NetworkThreadTaskRunner());
...
void CronetEnvironment::InitializeOnNetworkThread() {
  DCHECK(NetworkThreadTaskRunner()->BelongsToCurrentThread());
