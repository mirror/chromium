...
void SwizzleSessionWithConfiguration() {
  ...
  Method original_method = class_getInstanceMethod(nsurlsession_class,
    original_selector);
  Method swizzled_method = class_getInstanceMethod(nsurlsession_class,
    swizzled_selector);
