...
- (NSString*)description {
  return [NSString stringWithFormat:@""
      ...
      [self fetchStartDate],
      [self domainLookupStartDate],
      [self domainLookupEndDate],
      [self connectStartDate],
      [self secureConnectionStartDate],
      [self secureConnectionEndDate],
      [self connectEndDate],
      [self requestStartDate],
      [self requestEndDate],
      [self responseStartDate],
      [self responseEndDate],
      [self networkProtocolName],
      [self isProxyConnection],
      [self isReusedConnection],
...
void CronetMetricsDelegate::OnStartNetRequest(
...
// client delegate and iOS code.  The important function is the
...
@implementation URLSessionTaskDelegateProxy {
  ...
  BOOL respondsToDidFinishCollectingMetrics;
}
...
- (instancetype)initWithDelegate:(id<NSURLSessionDelegate>)delegate {
  _delegate = delegate;
  respondsToDidFinishCollectingMetrics =
...
- (void)URLSession:(NSURLSession*)session
  ...
  if (respondsToDidFinishCollectingMetrics) {
    if (netMetrics) {
