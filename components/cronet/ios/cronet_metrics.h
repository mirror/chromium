...
// Set to [task currentRequest].
@property(copy, readwrite) NSURLRequest* request;
// Set to [task response].
@property(copy, readwrite) NSURLResponse* response;

// Set to net::LoadTimingInfo::request_start_time.
@property(copy, readwrite) NSDate* fetchStartDate;
// Set to net::LoadTimingInfo::ConnectTiming::dns_start.
@property(copy, readwrite) NSDate* domainLookupStartDate;
// Set to net::LoadTimingInfo::ConnectTiming::dns_end.
@property(copy, readwrite) NSDate* domainLookupEndDate;
// Set to net::LoadTimingInfo::ConnectTiming::connect_start.
@property(copy, readwrite) NSDate* connectStartDate;
// Set to net::LoadTimingInfo::ConnectTiming::ssl_start.
@property(copy, readwrite) NSDate* secureConnectionStartDate;
// Set to net::LoadTimingInfo::ConnectTiming::ssl_end.
@property(copy, readwrite) NSDate* secureConnectionEndDate;
// Set to net::LoadTimingInfo::ConnectTiming::connect_end.
@property(copy, readwrite) NSDate* connectEndDate;
// Set to net::LoadTimingInfo::sent_start.
@property(copy, readwrite) NSDate* requestStartDate;
// Set to net::LoadTimingInfo::send_end.
@property(copy, readwrite) NSDate* requestEndDate;
// Set to net::LoadTimingInfo::receive_headers_end.
@property(copy, readwrite) NSDate* responseStartDate;
// Set to net::MetricsDelegate::Metrics::response_end_time.
@property(copy, readwrite) NSDate* responseEndDate;

// Set to net::HttpResponseInfo::connection_info.
@property(copy, readwrite) NSString* networkProtocolName;
// Set to YES if net::HttpResponseInfo::proxy_server.is_direct() returns false.
@property(assign, readwrite, getter=isProxyConnection) BOOL proxyConnection;
// Set to YES if net::LoadTimingInfo::ConnectTiming::conect_start is null.
@property(assign, readwrite, getter=isReusedConnection) BOOL reusedConnection;
// Set to LocalCache if net::HttpResponseInfo::was_cached is true, set to
// ServerPush if net::LoadTimingInfo::push_start is non-null, and set to
...
// This provide the swizzling function that Cronet (in its startInternal
...
class CronetMetricsDelegate : public net::MetricsDelegate {
 public:
  ...
  void OnStartNetRequest(base::scoped_nsobject<NSURLSessionTask> task) override;
  ...
  // Returns the size of task_metrics_map_; it's used primarily for testing that
  // the map does not grow unbounded.
  static size_t MetricsTaskMapSize();
 private:
  static NSObject* gTaskMetricsMapLock;
