...
public class CronetUrlRequestContextTest {
    ...
    public void setUp() throws Exception {
        mTestServer = EmbeddedTestServer.createAndStartServer(getTargetContext());
    ...
    static class RequestThread extends Thread {
        ...
        public void run() {
            mRunBlocker.block();
            CronetEngine cronetEngine = new CronetEngine.Builder(getTargetContext()).build();
    ...
    public void testShutdownDuringInit() throws Exception {
        ...
        final CronetUrlRequestContext cronetEngine =
                (CronetUrlRequestContext) new CronetEngine.Builder(getTargetContext()).build();
    ...
    public void testInitAndShutdownOnMainThread() throws Exception {
        ...
        Runnable blockingTask = new Runnable() {
            ...
            public void run() {
                ...
                final CronetUrlRequestContext cronetEngine =
                        (CronetUrlRequestContext) new CronetEngine.Builder(getTargetContext())
                                .build();
    ...
    private CronetEngine createCronetEngineWithCache(int cacheType) {
        CronetEngine.Builder builder = new CronetEngine.Builder(getTargetContext());
        ...
        NativeTestServer.startNativeTestServer(getTargetContext());
    ...
    public void testEnableHttpCacheDiskNewEngine() throws Exception {
        ...
        cronetEngine.shutdown();
        cronetEngine =
                mTestRule.enableDiskCache(new CronetEngine.Builder(getTargetContext())).build();
        checkRequestCaching(cronetEngine, url, true);
        cronetEngine.shutdown();
    }
    ...
    public void testEmptyGetCertVerifierData() {
        // Immediately make a request after initializing the engine.
        ExperimentalCronetEngine cronetEngine =
                new ExperimentalCronetEngine.Builder(getTargetContext()).build();
        TestUrlRequestCallback callback = new TestUrlRequestCallback();
        UrlRequest.Builder urlRequestBuilder =
                cronetEngine.newUrlRequestBuilder(mUrl, callback, callback.getExecutor());
        urlRequestBuilder.build().start();
    ...
    public void testInitDifferentEngines() throws Exception {
        ...
        CronetEngine firstEngine = new CronetEngine.Builder(getTargetContext()).build();
        CronetEngine secondEngine =
                new CronetEngine.Builder(getTargetContext().getApplicationContext()).build();
        CronetEngine thirdEngine =
                new CronetEngine.Builder(new ContextWrapper(getTargetContext())).build();
    ...
    public void testCronetEngineBuilderConfig() throws Exception {
        ...
        nativeVerifyUrlRequestContextConfig(
                ...
                CronetTestRule.getTestStorage(getTargetContext()));
    }
    ...
    public void testSkipLibraryLoading() throws Exception {
        ...
        try {
            ...
            CronetLibraryLoader.ensureInitialized(getTargetContext().getApplicationContext(),
                    (CronetEngineBuilderImpl) builder.mBuilderDelegate);
