...
public class CronetUrlRequestTest {
    ...
    public void testContentLengthMismatchFailsOnce() throws Exception {
        ...
        mTestRule.assertContains("Exception in CronetUrlRequest: net::ERR_CONTENT_LENGTH_MISMATCH",
    ...
    public void testMockSSLCertificateError() throws Exception {
        ...
        mTestRule.assertContains("Exception in CronetUrlRequest: net::ERR_CERT_DATE_INVALID",
                callback.mError.getMessage());
        Assert.assertEquals(ResponseStep.ON_FAILED, callback.mResponseStep);
    }
    ...
    public void testUploadWithBadLength() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Read upload data length 2 exceeds expected length 1",
    ...
    public void testUploadWithBadLengthBufferAligned() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Read upload data length 8192 exceeds expected length 8191",
                callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadReadFailSync() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Sync read failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadLengthFailSync() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Sync length failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadReadFailAsync() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Async read failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testDirectExecutorUploadProhibitedByDefault() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Inline execution is prohibited for this request",
                callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadReadFailThrown() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Thrown read failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadRewindFailSync() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Sync rewind failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadRewindFailAsync() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Async rewind failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadRewindFailThrown() throws Exception {
        ...
        mTestRule.assertContains(
                "Exception received from UploadDataProvider", callback.mError.getMessage());
        mTestRule.assertContains("Thrown rewind failure", callback.mError.getCause().getMessage());
        Assert.assertEquals(null, callback.mResponseInfo);
    }
    ...
    public void testUploadFailsWithoutInitializingStream() throws Exception {
        ...
        if (mTestRule.testingJavaImpl()) {
            ...
            mTestRule.assertContains("Exception in CronetUrlRequest: net::ERR_CONNECTION_REFUSED",
                    callback.mError.getMessage());
        }
    }
