...
public class CronetEngineBuilderTest {
    ...
    public void testProviderOrdering() {
        final CronetProvider[] availableProviders = new CronetProvider[] {
                new FakeProvider(InstrumentationRegistry.getContext(), PROVIDER_NAME_APP_PACKAGED,
                        "99.77", true),
                new FakeProvider(InstrumentationRegistry.getContext(), PROVIDER_NAME_FALLBACK,
                        "99.99", true),
                new FakeProvider(
                        InstrumentationRegistry.getContext(), "Some other provider", "99.88", true),
        };
        ...
        List<CronetProvider> orderedProviders = CronetEngine.Builder.getEnabledCronetProviders(
                InstrumentationRegistry.getContext(), providers);
    ...
    public void testThatDisabledProvidersAreExcluded() {
        final CronetProvider[] availableProviders = new CronetProvider[] {
                ...
                new FakeProvider(InstrumentationRegistry.getContext(), PROVIDER_NAME_APP_PACKAGED,
                        "99.77", true),
                new FakeProvider(InstrumentationRegistry.getContext(), "Some other provider",
                        "99.88", false),
        };
