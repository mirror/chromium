...
class CronetURLRequestAdapter : public CronetURLRequest::Callback {
 public:
  ...
  void OnStatus(int load_status) override;
 ...
 private:
  ...
  // Converts response headers to Java String Array.
  ...
  // Java object that listens for OnStatus() callback.
  // Only valid between GetStatus() call and OnStatus() callback.
  base::android::ScopedJavaGlobalRef<jobject> status_listener_ref_;
