...
void CronetLibraryLoader__CronetInitOnInitThread(JNIEnv* env, const JavaParamRef<jclass>& jcaller) {
#if !BUILDFLAG(USE_PLATFORM_ICU_ALTERNATIVES)
...
ScopedJavaLocalRef<jstring> CronetLibraryLoader__GetCronetVersion(
    JNIEnv* env,
