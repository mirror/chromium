...
TEST(URLURLRequestContextConfigTest, SetQuicClientConnectionOptions) {
  base::test::ScopedTaskEnvironment scoped_task_environment_(
      base::test::ScopedTaskEnvironment::MainThreadType::IO);
  ...
  EXPECT_EQ(connection_options, params_->quic_connection_options);
  ...
  EXPECT_EQ(client_connection_options, params_->quic_client_connection_options);
}
