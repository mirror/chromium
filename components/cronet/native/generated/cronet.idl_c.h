...
// Interface Cronet_Runnable methods.
// Abstract interface to be implemented by application.
...
// Interface Cronet_Executor methods.
// Abstract interface to be implemented by application.
...
// Interface Cronet_Engine methods.
...
// Interface Engine methods as custom functions.
...
// Interface Cronet_UrlRequestStatusListener methods.
// Abstract interface to be implemented by application.
...
// Interface Cronet_UrlRequestCallback methods.
// Abstract interface to be implemented by application.
...
// Interface Cronet_UploadDataSink methods.
...
// Interface Cronet_UploadDataProvider methods.
// Abstract interface to be implemented by application.
...
// Interface Cronet_UrlRequest methods.
...
void Cronet_Buffer_set_size(Cronet_BufferPtr self, uint32_t size);
void Cronet_Buffer_set_limit(Cronet_BufferPtr self, uint32_t limit);
void Cronet_Buffer_set_position(Cronet_BufferPtr self, uint32_t position);
...
uint32_t Cronet_Buffer_get_size(Cronet_BufferPtr self);
uint32_t Cronet_Buffer_get_limit(Cronet_BufferPtr self);
uint32_t Cronet_Buffer_get_position(Cronet_BufferPtr self);
