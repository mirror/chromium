...
BufferCallbackPtr BufferCallback_CreateInterface(
...
CronetExceptionPtr CronetException_CreateInterface();
...
RunnablePtr Runnable_CreateInterface(Runnable_runFunc runFunc);
...
ExecutorPtr Executor_CreateInterface(Executor_executeFunc executeFunc);
...
CronetEnginePtr CronetEngine_CreateInterface(
...
UrlStatusListenerPtr UrlStatusListener_CreateInterface(
...
UrlRequestCallbackPtr UrlRequestCallback_CreateInterface(
...
UploadDataSinkPtr UploadDataSink_CreateInterface(
...
UploadDataProviderPtr UploadDataProvider_CreateInterface(
...
UrlRequestPtr UrlRequest_CreateInterface(
