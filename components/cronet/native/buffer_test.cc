...
TEST_F(BufferTest, TestCronetBuffer) {
  ...
  // TODO(mef): Figure out why this doesn't seem to block reliably until
  // TestCronet_BufferCallback_OnDestroy is called. Once done, change
  // executor to Cronet_Executor_CreateTaskScheduler();
