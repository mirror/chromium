...
// C functions of CronetException that forward calls to C++ implementation.
...
// Implementation of CronetException that forwards calls to C functions
// implemented by the app.
class CronetExceptionStub : public CronetException {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CronetExceptionStub);
};
...
// C functions of UrlStatusListener that forward calls to C++ implementation.
...
// Implementation of UrlStatusListener that forwards calls to C functions
// implemented by the app.
class UrlStatusListenerStub : public UrlStatusListener {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(UrlStatusListenerStub);
};
