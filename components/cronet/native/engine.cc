...
void Cronet_EngineImpl::OnInitNetworkThread() {}

void Cronet_EngineImpl::OnDestroyNetworkThread() {
  main_context_.reset();
}
...
void Cronet_EngineImpl::OnSaveCertVerifierData(
    net::CertVerifier* cert_verifier) {}
