...
CharString Cronet_EngineImpl::GetDefaultUserAgent(CharString partialUserAgent) {
  static std::string default_user_agent =
      cronet::CreateDefaultUserAgent(partialUserAgent);
  return default_user_agent.c_str();
}
