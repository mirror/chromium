...
#ifndef COMPONENTS_CRONET_NATIVE_CRONET_IDL_IMPL_INTERFACE_H_
#define COMPONENTS_CRONET_NATIVE_CRONET_IDL_IMPL_INTERFACE_H_
...
#endif  // COMPONENTS_CRONET_NATIVE_CRONET_IDL_IMPL_INTERFACE_H_
