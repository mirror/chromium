...
CronetURLRequestContext::CronetURLRequestContext(
    ...
    : network_tasks_(new NetworkTasks(std::move(callback))),
...
CronetURLRequestContext::NetworkTasks::NetworkTasks(
    ...
    : is_context_initialized_(false), callback_(std::move(callback)) {
...
void CronetURLRequestContext::InitRequestContextOnInitThread() {
  ...
  GetNetworkTaskRunner()->PostTask(
      ...
      base::Bind(&CronetURLRequestContext::NetworkTasks::Initialize,
                 ...
                 GetFileThread()->task_runner(), base::Passed(&context_config_),
