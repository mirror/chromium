...
// Manages the PrefService, JsonPrefStore and all associates persistence
...
class CronetPrefsManager {
 public:
  ...
  // Commits all pending writes to the preference store.
  void CommitPendingWrites();

  // Shuts down all managers on PrefSequence.
  void ShutdownManagersOnPrefSequence();
