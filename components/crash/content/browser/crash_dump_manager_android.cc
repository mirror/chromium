...
namespace {
base::LazyInstance<CrashDumpManager>::DestructorAtExit g_instance =
...
base::PlatformFile CrashDumpManager::CreateMinidumpForChild(
  ...
  return minidump_file.TakePlatformFile();
}

void CrashDumpManager::ProcessMinidumpFromChild(
