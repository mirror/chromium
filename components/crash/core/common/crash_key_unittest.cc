...
class CrashKeyStringTest : public testing::Test {
 public:
  void SetUp() override { ASSERT_TRUE(internal::GetCrashKeyStorage()); }
...
TEST_F(CrashKeyStringTest, ConstantAssertions) {
...
TEST_F(CrashKeyStringTest, Allocation) {
...
TEST_F(CrashKeyStringTest, SetClearSingle) {
...
TEST_F(CrashKeyStringTest, SetChunked) {
...
TEST_F(CrashKeyStringTest, SetTwoChunked) {
