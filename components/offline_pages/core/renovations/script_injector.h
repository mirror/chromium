...
#ifndef COMPONENTS_OFFLINE_PAGES_CORE_SCRIPT_INJECTOR_H_
#define COMPONENTS_OFFLINE_PAGES_CORE_SCRIPT_INJECTOR_H_
...
#endif  // COMPONENTS_OFFLINE_PAGES_CORE_SCRIPT_INJECTOR_H_
