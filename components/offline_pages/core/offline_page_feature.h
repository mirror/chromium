...
extern const base::Feature kOfflinePagesPendingDownloadFeature;
...
// Returns true if descriptive pending download status texts should be used for
// notifications and Download Home.
bool IsOfflinePagesPendingDownloadEnabled();
