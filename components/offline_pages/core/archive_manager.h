...
class ArchiveManager {
 public:
  ...
  // Lists all archive files in the temporary archive directories.
  // Since this is only used for consistency check right now, it will return
  // both temporary and persistent archives.
