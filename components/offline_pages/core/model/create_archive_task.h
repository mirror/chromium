...
// order to allow multiple archiver to work in parallel.
...
// task gets destroyed.
// TODO(romax): Make sure if we need to keep this task in case we need to do any
// database interaction before archive creation. If not, this task can simply be
// a method in OfflinePageModelImpl after taskification.
