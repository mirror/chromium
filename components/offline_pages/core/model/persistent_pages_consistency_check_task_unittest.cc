...
TEST_F(PersistentPagesConsistencyCheckTaskTest,
  ...
  histogram_tester()->ExpectTotalCount(
      "OfflinePages.Consistency.Persistent.PagesMissingArchiveFileCount", 0);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Persistent.PagesMissingDbEntryCount", 1, 1);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Persistent.Result",
...
TEST_F(PersistentPagesConsistencyCheckTaskTest,
  ...
  EXPECT_TRUE(IsPageRemovedFromBothPlaces(page2));
  histogram_tester()->ExpectTotalCount(
      "OfflinePages.Consistency.Persistent.PagesMissingDbEntryCount", 0);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Persistent.PagesMissingArchiveFileCount", 1, 1);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Persistent.Result",
      static_cast<int>(SyncOperationResult::SUCCESS), 1);
}
