...
#if defined(OS_POSIX)
  base::FilePath::StringType suggested_path = suggested_name;
#elif defined(OS_WIN)
  base::FilePath::StringType suggested_path = base::UTF8ToUTF16(suggested_name);
#endif

  base::FilePath path_to_check(
      target_dir.Append(suggested_path).AddExtension(kMHTMLExtenstion));
