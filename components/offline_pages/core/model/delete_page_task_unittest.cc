...
class DeletePageTaskTest : public testing::Test,
 ...
 public:
  ...
  void OnDeletePageDone(const std::vector<DeletedPageInfo>& deleted_page_infos,
...
TEST_F(DeletePageTaskTest, DeletePageByOfflineId) {
  ...
  std::unique_ptr<DeletePageTask> task(DeletePageTask::CreateTaskWithOfflineIds(
      store(), offline_ids,
...
TEST_F(DeletePageTaskTest, DeletePageByClientId) {
  ...
  std::unique_ptr<DeletePageTask> task(DeletePageTask::CreateTaskWithClientIds(
      store(), client_ids,
      base::Bind(&DeletePageTaskTest::OnDeletePageDone, AsWeakPtr())));
  task->Run();
  PumpLoop();
...
TEST_F(DeletePageTaskTest, DeletePageByUrlPredicate) {
  ...
  std::unique_ptr<DeletePageTask> task(
      DeletePageTask::CreateTaskWithUrlPredicate(
          store(), predicate,
          base::Bind(&DeletePageTaskTest::OnDeletePageDone, AsWeakPtr())));
  task->Run();
  PumpLoop();
