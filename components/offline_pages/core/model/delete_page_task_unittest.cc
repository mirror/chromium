...
TEST_F(DeletePageTaskTest, DeletePageByOfflineId) {
  ...
  histogram_tester()->ExpectTotalCount(
      page1.client_id.AppendToHistogramName("OfflinePages.PageLifetime"), 2);
  histogram_tester()->ExpectTotalCount(
      page1.client_id.AppendToHistogramName("OfflinePages.AccessCount"), 2);
  histogram_tester()->ExpectBucketCount(
      page1.client_id.AppendToHistogramName("OfflinePages.AccessCount"), 0, 1);
  histogram_tester()->ExpectBucketCount(
      page1.client_id.AppendToHistogramName("OfflinePages.AccessCount"), 200,
      1);
}
...
TEST_F(DeletePageTaskTest, DeletePageByOfflineIdNotFound) {
  ...
  histogram_tester()->ExpectTotalCount(
      page1.client_id.AppendToHistogramName("OfflinePages.PageLifetime"), 0);
  histogram_tester()->ExpectTotalCount(
      page1.client_id.AppendToHistogramName("OfflinePages.AccessCount"), 0);
}
...
TEST_F(DeletePageTaskTest, DeletePageForPageLimit) {
  ...
  EXPECT_FALSE(CheckPageDeleted(page3));
  histogram_tester()->ExpectTotalCount(
      page1.client_id.AppendToHistogramName("OfflinePages.PageLifetime"), 1);
