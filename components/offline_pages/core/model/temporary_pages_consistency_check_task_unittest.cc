...
TEST_F(TemporaryPagesConsistencyCheckTaskTest,
  ...
  histogram_tester()->ExpectTotalCount(
      "OfflinePages.Consistency.Temporary.PagesMissingArchiveFileCount", 0);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Temporary.PagesMissingDbEntryCount", 1, 1);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Temporary.Result",
...
TEST_F(TemporaryPagesConsistencyCheckTaskTest,
  ...
  EXPECT_TRUE(IsPageRemovedFromBothPlaces(page2));
  histogram_tester()->ExpectTotalCount(
      "OfflinePages.Consistency.Temporary.PagesMissingDbEntryCount", 0);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Temporary.PagesMissingArchiveFileCount", 1, 1);
  histogram_tester()->ExpectUniqueSample(
      "OfflinePages.Consistency.Temporary.Result",
      static_cast<int>(SyncOperationResult::SUCCESS), 1);
}
