...
TEST_F(GetPagesTaskTest, GetAllPages) {
  ...
  runner()->RunTask(
      GetPagesTask::CreateTaskForAllPages(store(), get_pages_callback()));
...
TEST_F(GetPagesTaskTest, GetPagesForSingleClientId) {
  ...
  runner()->RunTask(GetPagesTask::CreateTaskForClientIds(
...
TEST_F(GetPagesTaskTest, GetPagesByRequestOrigin) {
  ...
  runner()->RunTask(GetPagesTask::CreateTaskForRequestOrigin(
...
TEST_F(GetPagesTaskTest, GetPagesByUrl) {
  ...
  runner()->RunTask(
      GetPagesTask::CreateTaskForUrl(store(), get_pages_callback(), kUrl1));
...
TEST_F(GetPagesTaskTest, GetPageByOfflineId) {
  ...
  runner()->RunTask(GetPagesTask::CreateTaskForOfflineId(
