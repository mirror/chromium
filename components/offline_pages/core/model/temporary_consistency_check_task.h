...
#ifndef COMPONENTS_OFFINE_PAGES_CORE_MODEL_TEMPORARY_CONSISTENCY_CHECK_TASK_H_
#define COMPONENTS_OFFINE_PAGES_CORE_MODEL_TEMPORARY_CONSISTENCY_CHECK_TASK_H_
...
// executed.
class TemporaryConsistencyCheckTask : public Task {
 public:
  TemporaryConsistencyCheckTask(OfflinePageMetadataStoreSQL* store,
                                ClientPolicyController* policy_controller,
                                const base::FilePath& archives_dir,
                                const base::FilePath& abandoned_dir);
  ~TemporaryConsistencyCheckTask() override;
 ...
 private:
  ...
  base::FilePath abandoned_dir_;

  base::WeakPtrFactory<TemporaryConsistencyCheckTask> weak_ptr_factory_;
  DISALLOW_COPY_AND_ASSIGN(TemporaryConsistencyCheckTask);
};

}  // namespace offline_pages

#endif  // COMPONENTS_OFFLINE_PAGES_CORE_MODEL_TEMPORARY_CONSISTENCY_CHECK_TASK_H_
