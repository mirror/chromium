...
void ReportPageHistogramAfterSuccessfulSaving(
  ...
  base::UmaHistogramCustomTimes(
      offline_page.client_id.AppendToHistogramName("OfflinePages.SavePageTime"),
      save_time - offline_page.creation_time,
      base::TimeDelta::FromMilliseconds(1), base::TimeDelta::FromSeconds(10),
      50);

  base::UmaHistogramCustomCounts(
      offline_page.client_id.AppendToHistogramName("OfflinePages.PageSize"),
...
void OfflinePageModelTaskified::InformSavePageDone(
  ...
  base::UmaHistogramEnumeration(
      page.client_id.AppendToHistogramName("OfflinePages.SavePageResult"),
...
void OfflinePageModelTaskified::OnDeleteDone(
  ...
  base::UmaHistogramEnumeration("OfflinePages.DeletePageResult", result,
