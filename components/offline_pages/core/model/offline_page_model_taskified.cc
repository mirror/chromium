...
// before we split |kInitializingTaskDelay| and |kInitialUpgradeSelectionDelay|
// further apart, than 20 seconds.
const base::TimeDelta kInitializingTaskDelay = base::TimeDelta::FromSeconds(30);
