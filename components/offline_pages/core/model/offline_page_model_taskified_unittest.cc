...
TEST_F(OfflinePageModelTaskifiedTest, SavePageSuccessful) {
  ...
  histogram_tester()->ExpectUniqueSample(
      test_utils::AddHistogramSuffix("OfflinePages.SavePageResult",
                                     kTestClientId1.name_space),
      static_cast<int>(SavePageResult::SUCCESS), 1);
  histogram_tester()->ExpectUniqueSample(
      test_utils::AddHistogramSuffix("OfflinePages.PageSize",
                                     kTestClientId1.name_space),
      kTestFileSize / 1024, 1);
  histogram_tester()->ExpectTotalCount(
      test_utils::AddHistogramSuffix("OfflinePages.SavePageTime",
                                     kTestClientId1.name_space),
      1);
}
...
TEST_F(OfflinePageModelTaskifiedTest, DeletePagesByOfflineId) {
  ...
  histogram_tester()->ExpectTotalCount(
      test_utils::AddHistogramSuffix("OfflinePages.PageLifetime",
                                     kDefaultNamespace),
      1);
  histogram_tester()->ExpectTotalCount(
      test_utils::AddHistogramSuffix("OfflinePages.DeletePage.AccessCount",
                                     kDefaultNamespace),
      1);
}
