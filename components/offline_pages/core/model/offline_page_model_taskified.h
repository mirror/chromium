...
class OfflinePageModelTaskified : public OfflinePageModel,
 ...
 private:
  ...
  void PostClearCachedPagesTask(bool is_delayed);
  ...
  void OnEnsureArchivesDirCreatedDone(base::TimeTicks start_time);
  void RemovePagesWithSameUrlInSameNamespace(const OfflinePageItem& page);
