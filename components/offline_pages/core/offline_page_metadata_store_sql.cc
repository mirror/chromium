...
ItemActionStatus AddOfflinePageSync(const OfflinePageItem& item,
  ...
  statement.BindString(
      4, OfflinePageStoreUtils::ToDatabaseFilePath(item.file_path));
  statement.BindInt64(5, item.file_size);
  statement.BindInt64(
      6, OfflinePageStoreUtils::ToDatabaseTime(item.creation_time));
  statement.BindInt64(
      7, OfflinePageStoreUtils::ToDatabaseTime(item.last_access_time));
  ...
  statement.BindInt64(
      13, OfflinePageStoreUtils::ToDatabaseTime(item.file_missing_time));
...
bool Update(sql::Connection* db, const OfflinePageItem& item) {
  ...
  statement.BindString(
      3, OfflinePageStoreUtils::ToDatabaseFilePath(item.file_path));
  statement.BindInt64(4, item.file_size);
  statement.BindInt64(
      5, OfflinePageStoreUtils::ToDatabaseTime(item.creation_time));
  statement.BindInt64(
      6, OfflinePageStoreUtils::ToDatabaseTime(item.last_access_time));
  ...
  statement.BindInt64(
      12, OfflinePageStoreUtils::ToDatabaseTime(item.file_missing_time));
