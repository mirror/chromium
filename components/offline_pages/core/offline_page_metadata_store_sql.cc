...
OfflinePageItem MakeOfflinePageItem(sql::Statement* statement) {
  ...
  int64_t system_download_id = statement->ColumnInt64(12);
  base::Time file_missing_time = FromDatabaseTime(statement->ColumnInt64(13));
  int upgrade_attempt = statement->ColumnInt(14);
