...
void OfflinePageStorageManagerTest::CheckTotalCountForAllStorageUsageHistograms(
  ...
  for (const std::string name_space : policy_controller_->GetAllNamespaces()) {
    ...
    if (count != samples->TotalCount()) {
      FAIL() << "Histogram " << histogram_name << " total count of "
             << samples->TotalCount() << " != " << count;
    }
  }
}
...
TEST_F(OfflinePageStorageManagerTest, TestClearPagesLessThanLimit) {
  ...
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneWeekNamespace), 1, 1);
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneDayNamespace), 1, 1);
...
TEST_F(OfflinePageStorageManagerTest, TestClearPagesMoreThanLimit) {
  ...
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneWeekNamespace), 12, 1);
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneDayNamespace), 17, 1);
  CheckTotalCountForAllStorageUsageHistograms(1);
}
...
TEST_F(OfflinePageStorageManagerTest, TestClearPagesMoreFreshPages) {
  ...
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneWeekNamespace), 15, 1);
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneDayNamespace), 50, 1);
  CheckTotalCountForAllStorageUsageHistograms(1);
}
...
TEST_F(OfflinePageStorageManagerTest, TestDeletionFailed) {
  ...
  EXPECT_EQ(0, static_cast<int>(model()->GetRemovedPages().size()));
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneWeekNamespace), 10, 1);
  histogram_tester()->ExpectUniqueSample(
      GetStorageUsageHistogramName(kOneDayNamespace), 10, 1);
  CheckTotalCountForAllStorageUsageHistograms(1);
}
...
TEST_F(OfflinePageStorageManagerTest, TestClearMultipleTimes) {
  ...
  // Scopes are being used to limit the reach of each SCOPED_TRACE message.
  {
    ...
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kOneDayNamespace), 50, 1);
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kPersistentNamespace), 20, 1);
    CheckTotalCountForAllStorageUsageHistograms(1);
  }

  {
    ...
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kOneWeekNamespace), 15, 2);
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kOneDayNamespace), 50, 2);
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kPersistentNamespace), 20, 2);
...

  {
    ...
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneWeekNamespace), 15, 2);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneWeekNamespace), 215, 1);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneDayNamespace), 50, 2);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneDayNamespace), 0, 1);
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kPersistentNamespace), 20, 3);
...

  {
    ...
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneWeekNamespace), 215, 1);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneWeekNamespace), 51, 1);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneDayNamespace), 50, 2);
    histogram_tester()->ExpectBucketCount(
        GetStorageUsageHistogramName(kOneDayNamespace), 0, 2);
    histogram_tester()->ExpectUniqueSample(
        GetStorageUsageHistogramName(kPersistentNamespace), 20, 4);
