...
class ClientPolicyControllerTest : public testing::Test {
 ...
 protected:
  ...
  void ExpectUserGeneratedDownloadSupport(std::string name_space,
                                          bool expectation);
...
void ClientPolicyControllerTest::ExpectUserGeneratedDownloadSupport(
    std::string name_space,
    bool expectation) {
  std::vector<std::string> cache =
      controller()->GetNamespacesForUserGeneratedDownload();
  auto result = std::find(cache.begin(), cache.end(), name_space);
  EXPECT_EQ(expectation, result != cache.end())
      << "Namespace " << name_space
      << " had incorrect user generated download support when getting"
         " namespaces supported by user generaged download.";
  EXPECT_EQ(expectation, controller()->IsUserGeneratedDownload(name_space))
      << "Namespace " << name_space
...
TEST_F(ClientPolicyControllerTest, FallbackTest) {
  ...
  ExpectUserGeneratedDownloadSupport(kUndefinedNamespace, false);
...
TEST_F(ClientPolicyControllerTest, CheckBookmarkDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kBookmarkNamespace, false);
...
TEST_F(ClientPolicyControllerTest, CheckLastNDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kLastNNamespace, false);
...
TEST_F(ClientPolicyControllerTest, CheckAsyncDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kAsyncNamespace, true);
...
TEST_F(ClientPolicyControllerTest, CheckCCTDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kCCTNamespace, false);
...
TEST_F(ClientPolicyControllerTest, CheckDownloadDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kDownloadNamespace, true);
...
TEST_F(ClientPolicyControllerTest, CheckNTPSuggestionsDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kNTPSuggestionsNamespace, false);
...
TEST_F(ClientPolicyControllerTest, CheckSuggestedArticlesDefined) {
  ...
  ExpectUserGeneratedDownloadSupport(kSuggestedArticlesNamespace, false);
