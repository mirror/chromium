...
class OfflinePageArchiver {
 public:
  ...
  struct CreateArchiveParams {
    ...
    // User random GUIDs as file names rather than a 'meaningful' file name in
    // the format of {hostname}-{title}.mhtml.
    bool use_random_guid_names;
  };
