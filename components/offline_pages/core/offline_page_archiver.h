...
using PublishArchiveDoneCallback = base::OnceCallback<
    void(const SavePageCallback&, OfflinePageItem, PublishArchiveResult*)>;
...
class OfflinePageArchiver {
 ...
 private:
  ...
  static void MoveAndRegisterArchive(const OfflinePageItem& offline_page,
