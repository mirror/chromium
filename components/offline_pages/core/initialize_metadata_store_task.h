...
#ifndef COMPONENTS_OFFLINE_PAGES_CORE_INITIALIZE_METADATA_STORE_TASK_H_
#define COMPONENTS_OFFLINE_PAGES_CORE_INITIALIZE_METADATA_STORE_TASK_H_
...
#endif  // COMPONENTS_OFFLINE_PAGES_CORE_INITIALIZE_METADATA_STORE_TASK_H_
