...
TEST_F(OfflineItemConversionsTest, OfflinePageItemConversion) {
  ...
  base::FilePath file_path("/tmp/example_file_path");
...
TEST_F(OfflineItemConversionsTest, SavePageRequestConversion) {
  GURL url("example_url");
  std::string name_space = "test_namespace";
  std::string guid = "test_guid";
  ClientId client_id(name_space, guid);
