...
class PrefetchDownloader {
 public:
  ...
  // downloads.
  void OnDownloadServiceReady(download::DownloadService* download_service);
 ...
 private:
  ...
  // Unowned. It is valid from when OnDownloadServiceReady is called to |this|
  // instance is destructed when PrefetchService is shutting down.
