...
#ifndef COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_OFFLINE_METRICS_COLLECTOR_STUB_H_
#define COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_OFFLINE_METRICS_COLLECTOR_STUB_H_
...
class OfflineMetricsCollectorStub : public OfflineMetricsCollector {
 public:
  OfflineMetricsCollectorStub() = default;
  ~OfflineMetricsCollectorStub() override = default;
...
#endif  // COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_OFFLINE_METRICS_COLLECTOR_STUB_H_
