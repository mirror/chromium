...
#ifndef COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_DISPATCHER_STUB_H_
#define COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_DISPATCHER_STUB_H_
...
class PrefetchDispatcherStub : public PrefetchDispatcher {
 public:
  PrefetchDispatcherStub();
  ~PrefetchDispatcherStub() override;
...
#endif  // COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_DISPATCHER_STUB_H_
