...
std::set<PrefetchItem> PrefetchStoreTestUtil::FilterItemsByState(const std::set<PrefetchItem>& items, PrefetchItemState state) {
  std::set<PrefetchItem> filtered_items;
...
std::set<PrefetchItem> PrefetchStoreTestUtil::ItemsIntersection(const std::set<PrefetchItem>& items1, const std::set<PrefetchItem>& items2) {
  std::set<PrefetchItem> intersection;
  for (const PrefetchItem& item : items1) {
...
std::set<PrefetchItem> PrefetchStoreTestUtil::ItemsDifference(const std::set<PrefetchItem>& items1, const std::set<PrefetchItem>& items2) {
  std::set<PrefetchItem> difference;
  for (const PrefetchItem& item : items1) {
    if (!items2.count(item))
