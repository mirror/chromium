...
void CreateV1TablesWithSampleRows(sql::Connection* db) {
...
void CheckSampleRowsAtCurrentSchemaVersion(sql::Connection* db) {
...
TEST_F(PrefetchStoreSchemaTest, TestMigrationFromV0) {
  ...
  CreateV1TablesWithSampleRows(db_.get());
  ...
  CheckSampleRowsAtCurrentSchemaVersion(db_.get());
