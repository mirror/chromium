...
#ifndef COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_SERVICE_STUB_TACO_H_
#define COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_SERVICE_STUB_TACO_H_
...
//
// Default types of objects held by the stub service:
// * OfflineMetricsCollectorStub
// * PrefetchDispatcherImpl
// * PrefetchGCMHandlerStub
// * |nullptr| SuggestedArticlesObserver, since this is default just a lifetime
//   arrangement.
class PrefetchServiceStubTaco {
 public:
  PrefetchServiceStubTaco();
  ~PrefetchServiceStubTaco();
...
#endif  // COMPONENTS_OFFLINE_PAGES_CORE_PREFETCH_PREFETCH_SERVICE_STUB_TACO_H_
