...
TEST_F(DownloadArchivesTaskTest, NoArchivesToDownload) {
  ...
  histogram_tester.ExpectTotalCount("OfflinePages.Prefetching.ExpectedFileSize",
                                    0);
}
...
TEST_F(DownloadArchivesTaskTest, SingleArchiveToDownload) {
  ...
  histogram_tester.ExpectUniqueSample(
      "OfflinePages.Prefetching.ExpectedFileSize", kLargeArchiveSize / 1024, 1);
}
...
TEST_F(DownloadArchivesTaskTest, MultipleArchivesToDownload) {
  ...
  histogram_tester.ExpectUniqueSample(
      "OfflinePages.Prefetching.ExpectedFileSize", kSmallArchiveSize / 1024, 2);
}
...
TEST_F(DownloadArchivesTaskTest, SingleArchiveSecondAttempt) {
  ...
  histogram_tester.ExpectUniqueSample(
      "OfflinePages.Prefetching.ExpectedFileSize",
