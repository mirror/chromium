...
// The browser- and platform-dependent impl of this class is injected by
// PrefetchServiceFactory into PrefetchService.
class OfflineMetricsCollector {
 public:
  ...
  DISALLOW_COPY_AND_ASSIGN(OfflineMetricsCollector);
};
