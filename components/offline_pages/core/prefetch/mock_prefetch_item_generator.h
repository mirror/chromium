...
class MockPrefetchItemGenerator {
 public:
  ...
  static const std::string kGuidPrefix;
  ...
  void set_guid_prefix(std::string guid_prefix) { guid_prefix_ = guid_prefix; }
 ...
 private:
  // These prefixes must always be set.
  std::string client_namespace_ = kClientNamespace;
  std::string guid_prefix_ = kGuidPrefix;
