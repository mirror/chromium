...
class OfflinePageModelQuery {
 public:
  ...
  std::tuple<Requirement, std::set<GURL>, URLSearchMode> GetRestrictedToUrls()
      const;
 ...
 private:
  ...
  std::tuple<Requirement, std::set<GURL>, URLSearchMode> urls_;
...
class OfflinePageModelQueryBuilder {
 ...
 private:
  ...
  std::tuple<Requirement, std::vector<GURL>, URLSearchMode> urls_;
