...
const char kCheckUnfoldBlockScript[] =
    "document.getElementById('unfold-block1').classList.contains('open-block') && "
    "document.getElementById('unfold-block2').classList.contains('open-block')";
const char kCheckUnfoldHeadingScript[] =
    "document.getElementById('unfold-heading1').classList.contains('open-block') && "
    "document.getElementById('unfold-heading2').classList.contains('open-block')";
