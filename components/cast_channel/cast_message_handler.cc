    ...
    net::DefineNetworkTrafficAnnotation("cast_message_handler", R"(
        semantics {
          ...
          trigger:
            ...
            "Cast device."
          data:
            "A serialized protobuf message representing the request. No user "
            "data."
          destination: OTHER
          destination_other:
...
constexpr net::NetworkTrafficAnnotationTag kMessageTrafficAnnotation =
    net::DefineNetworkTrafficAnnotation("cast_message_handler", R"(
        semantics {
          ...
          data:
            "A serialized protobuf message. Application-level messages may "
            "contain data specific to the Cast application."
          destination: OTHER
          destination_other:
            "Data will be sent to a Cast device in local network."
        }
