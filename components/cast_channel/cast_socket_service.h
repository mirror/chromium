...
class CastSocketService {
 public:
  ...
  // If |open_params.ip_address| is not a valid private IP address, no socket
  // will be opened, and |open_cb| will be invoked with |nullptr|.
  // |open_params|: Parameters necessary to open a Cast channel.
  // TODO(imcheng): Consider returning an error value with |open_cb|.
