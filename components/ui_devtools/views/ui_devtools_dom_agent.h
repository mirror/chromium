...
class UIDevToolsDOMAgent : public ui_devtools::UiDevToolsBaseAgent<
 ...
 public:
  ...
  void DrawR1HorizontalFullLeftR2(const gfx::RectF& pinned_rectF,
                                  ...
                                  const cc::PaintFlags& flags,
                                  gfx::Canvas* canvas_);
  void DrawR1TopFullLeftR2(const gfx::RectF& pinned_rectF,
                           const gfx::RectF& hovered_rectF,
                           const cc::PaintFlags& flags,
                           gfx::Canvas* canvas_);
  void DrawR1BottomFullLeftR2(const gfx::RectF& pinned_rectF,
                              const gfx::RectF& hovered_rectF,
                              const cc::PaintFlags& flags,
                              gfx::Canvas* canvas_);
  void DrawR1TopPartialLeftR2(const gfx::RectF& pinned_rectF,
                              ...
                              const cc::PaintFlags& flags,
                              gfx::Canvas* canvas_);
  void DrawR1BottomPartialLeftR2(const gfx::RectF& pinned_rectF,
                                 const gfx::RectF& hovered_rectF,
                                 const cc::PaintFlags& flags,
                                 gfx::Canvas* canvas_);
  void DrawR1IntersectsR2(gfx::RectF& pinned_rectF,
