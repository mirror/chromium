...
class UIDevToolsDOMAgent : public ui_devtools::UiDevToolsBaseAgent<
 ...
 public:
  ...
  // Return element id under cursor location |p|. First by looking for the
  // closest window, then looking for the closest widget if exists, then looking
  // for the closest view if exists.
