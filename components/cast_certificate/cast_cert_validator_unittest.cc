...
void RunTest(TestResult expected_result,
  ...
  bool success = VerifyDeviceCertUsingCustomTrustStore(
      certs, time, &context, &policy, nullptr, CRLPolicy::CRL_OPTIONAL,
      trust_store.get(), &result);
...
TEST(VerifyCastDeviceCertTest, ChromecastGen1) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "2ZZBG9 FA8FCA3EF91A",
          CastDeviceCertPolicy::NONE, "certificates/chromecast_gen1.pem",
...
TEST(VerifyCastDeviceCertTest, ChromecastGen2) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "3ZZAK6 FA8FCA3F0D35",
          CastDeviceCertPolicy::NONE, "certificates/chromecast_gen2.pem",
          AprilFirst2016(), TRUST_STORE_BUILTIN, "");
}
...
TEST(VerifyCastDeviceCertTest, Fugu) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "-6394818897508095075",
          CastDeviceCertPolicy::NONE, "certificates/fugu.pem", AprilFirst2016(),
          TRUST_STORE_BUILTIN, "");
}
...
TEST(VerifyCastDeviceCertTest, Unchained) {
  RunTest(RESULT_FAIL, CastCertError::ERR_CERTS_UNTRUSTED, "",
...
TEST(VerifyCastDeviceCertTest, CastRootCa) {
  RunTest(RESULT_FAIL, CastCertError::ERR_CERTS_VERIFY_GENERIC, "",
...
TEST(VerifyCastDeviceCertTest, ChromecastAudio) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "4ZZDZJ FA8FCA7EFE3C",
...
TEST(VerifyCastDeviceCertTest, MtkAudioDev) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "MediaTek Audio Dev Test",
...
TEST(VerifyCastDeviceCertTest, Vizio) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "9V0000VB FA8FCA784D01",
...
TEST(VerifyCastDeviceCertTest, ChromecastGen2InvalidTime) {
  ...
  RunTest(RESULT_SUCCESS, CastCertError::OK, "3ZZAK6 FA8FCA3F0D35",
          CastDeviceCertPolicy::NONE, kCertsFile, AprilFirst2016(),
          TRUST_STORE_BUILTIN, "");

  // Use a time before notBefore.
  RunTest(RESULT_FAIL, CastCertError::ERR_CERTS_DATE_INVALID, "",
          CastDeviceCertPolicy::NONE, kCertsFile, JanuaryFirst2015(),
          TRUST_STORE_BUILTIN, "");

  // Use a time after notAfter.
  RunTest(RESULT_FAIL, CastCertError::ERR_CERTS_DATE_INVALID, "",
          CastDeviceCertPolicy::NONE, kCertsFile, MarchFirst2037(),
          TRUST_STORE_BUILTIN, "");
}
...
TEST(VerifyCastDeviceCertTest, AudioRefDevTestChain3) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "Audio Reference Dev Test",
...
TEST(VerifyCastDeviceCertTest, IntermediateSerialNumberTooLong) {
  RunTest(RESULT_SUCCESS, CastCertError::OK,
          "8C579B806FFC8A9DFFFF F8:8F:CA:6B:E6:DA",
          CastDeviceCertPolicy::AUDIO_ONLY,
...
TEST(VerifyCastDeviceCertTest, ExpiredTrustAnchor) {
  ...
  RunTest(RESULT_SUCCESS, CastCertError::OK, "CastDevice",
          CastDeviceCertPolicy::NONE, "certificates/expired_root.pem",
...
TEST(VerifyCastDeviceCertTest, ViolatesPathlenTrustAnchorConstraint) {
  ...
  RunTest(RESULT_SUCCESS, CastCertError::OK, "Target",
          CastDeviceCertPolicy::NONE,
  ...
  RunTest(RESULT_FAIL, CastCertError::ERR_CERTS_VERIFY_GENERIC, "Target",
          CastDeviceCertPolicy::NONE,
          "certificates/violates_root_pathlen_constraint.pem", AprilFirst2016(),
          TRUST_STORE_FROM_TEST_FILE, "");
}
...
TEST(VerifyCastDeviceCertTest, PoliciesIcaAnypolicyLeafAnypolicy) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "Leaf", CastDeviceCertPolicy::NONE,
...
TEST(VerifyCastDeviceCertTest, PoliciesIcaAnypolicyLeafAudioonly) {
  RunTest(RESULT_SUCCESS, CastCertError::OK, "Leaf",
          CastDeviceCertPolicy::AUDIO_ONLY,
