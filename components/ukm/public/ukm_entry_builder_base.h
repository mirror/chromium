...
#ifndef COMPONENTS_UKM_UKM_ENTRY_BUILDER_BASE_H
#define COMPONENTS_UKM_UKM_ENTRY_BUILDER_BASE_H
...
class UKM_EXPORT UkmEntryBuilderBase {
 public:
...
#endif  // COMPONENTS_UKM_UKM_ENTRY_BUILDER_BASE_H
