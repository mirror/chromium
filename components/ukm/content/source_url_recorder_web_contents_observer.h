...
// URLs, for all main frame navigations in a given
// WebContents. SourceUrlRecorderWebContentsObserver records both the final URL
// for a navigation, and, if the navigation was redirected, the initial URL as
// well.
class SourceUrlRecorderWebContentsObserver
 ...
 private:
  SourceUrlRecorderWebContentsObserver(content::WebContents* web_contents,
                                       UkmRecorder* ukm_recorder);
  ...
  UkmRecorder* const ukm_recorder_;
