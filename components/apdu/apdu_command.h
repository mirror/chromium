...
class APDU_EXPORT APDUCommand {
 public:
  // TODO(hongjunchoi): Move U2F protocol specific static functions and
  // constants to U2FRegisterParam and U2FSignParam in device/u2f. See:
  // https://crbug.com/807836
