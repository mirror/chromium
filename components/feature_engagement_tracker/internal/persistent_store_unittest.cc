...
TEST_F(PersistentStoreTest, SuccessfulInitAndLoadEmptyStore) {
  ...
  // Verify histograms.
  histogram_tester.ExpectBucketCount("InProductHelp.Db.Init", 1, 1);
  histogram_tester.ExpectBucketCount("InProductHelp.Db.Load", 1, 1);
...
TEST_F(PersistentStoreTest, SuccessfulInitBadLoad) {
  ...
  // Histograms.
  histogram_tester.ExpectBucketCount("InProductHelp.Db.Init", 1, 1);
  histogram_tester.ExpectBucketCount("InProductHelp.Db.Load", 0, 1);
...
TEST_F(PersistentStoreTest, BadInit) {
  ...
  // Histograms.
  histogram_tester.ExpectBucketCount("InProductHelp.Db.Init", 0, 1);
  histogram_tester.ExpectTotalCount("InProductHelp.Db.Load", 0);
  histogram_tester.ExpectTotalCount("InProductHelp.Db.TotalEvents", 0);
}
