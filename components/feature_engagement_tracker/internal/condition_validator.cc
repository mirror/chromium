...
bool ConditionValidator::Result::NoErrors() {
  VLOG(0) << "nyquist: Result:"
          << "  model_ready_ok = " << model_ready_ok
          << ", currently_showing_ok = " << currently_showing_ok
          << ", config_ok = " << config_ok << ", used_ok = " << used_ok
          << ", trigger_ok = " << trigger_ok
          << ", preconditions_ok = " << preconditions_ok
          << ", session_rate_ok = " << session_rate_ok;
