...
const char kConfigParseEventName[] = "FeatureEngagement.Config.ParsingEvent";

// Helper function to cast a ConfigParsingEvent to int.
int ConfigParsingEventToInt(stats::ConfigParsingEvent event) {
...
TEST_F(ChromeVariationsConfigurationTest, ParseSingleFeature) {
  ...
  histogram_tester.ExpectBucketCount(
      kConfigParseEventName,
      ConfigParsingEventToInt(stats::ConfigParsingEvent::SUCCESS), 1);
  histogram_tester.ExpectTotalCount(kConfigParseEventName, 1);
...
TEST_F(ChromeVariationsConfigurationTest, MissingUsedIsInvalid) {
  ...
  histogram_tester.ExpectBucketCount(
      kConfigParseEventName,
      ConfigParsingEventToInt(stats::ConfigParsingEvent::FAILURE), 1);
