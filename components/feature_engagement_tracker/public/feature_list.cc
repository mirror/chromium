...
// UI to be able to select them alone for demo-mode.
// Note: When changing the number of entries inthis array, the constant
// kIPHDemoModeChoiceVariationsLen in feature_list.h must also be updated to
