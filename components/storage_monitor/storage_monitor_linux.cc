...
// Runs |callback| with |new_mtab| parameter on |storage_monitor_task_runner|.
void UpdateMtabOnTaskRunner(
...
MtabWatcherLinux* CreateMtabWatcherLinuxOnTaskRunner(
  ...
  return new MtabWatcherLinux(
      mtab_path, base::Bind(&UpdateMtabOnTaskRunner,
                            storage_monitor_task_runner, callback));
}

StorageMonitor::EjectStatus EjectPathOnBackgroundThread(
...
void StorageMonitorLinux::Init() {
  ...
  base::PostTaskAndReplyWithResult(
      ...
      base::Bind(&CreateMtabWatcherLinuxOnTaskRunner, mtab_path_,
...
void StorageMonitorLinux::EjectDevice(
  ...
  base::PostTaskWithTraitsAndReplyWithResult(
      ...
      base::Bind(&EjectPathOnBackgroundThread, path, device), callback);
}
