...
device::mojom::MtpStorageInfo* GetFakeMtpStorageInfo(
  ...
  if (fake_storage_info_map.empty()) {
    ...
    fake_storage_info_map.insert(std::make_pair(
        ...
        device::mojom::MtpStorageInfo(
            ...
            kStorageDeviceFlags,
            kStorageType,
            kStorageFilesystemType,
            kStorageAccessCapability,
            kStorageMaxCapacity,
            kStorageFreeSpaceInBytes,
            kStorageFreeSpaceInObjects,
            kStorageDescription,
