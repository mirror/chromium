...
const base::flat_set<std::string> kContextualSearchFeatureWhitelist {
  "DidOptIn", "DurationAfterScrollMs", "IsEntity", "IsLongWord", "IsShortWord",
      "IsWordEdge", "OutcomeWasCardsDataShown", "OutcomeWasPanelOpened",
      "OutcomeWasQuickActionClicked", "OutcomeWasQuickAnswerSeen",
      "Previous28DayCtrPercent", "Previous28DayImpressionsCount",
      "PreviousWeekCtrPercent", "PreviousWeekImpressionsCount", "ScreenTopDps",
      "TapDuration", "WasScreenBottom"
}
...
const PredictorConfig kContextualSearchPredictorConfig{
    ...
    LOG_UKM,
    &kContextualSearchFeatureWhitelist,
    &chrome::android::kContextualSearchRankerQuery,
