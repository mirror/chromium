...
// Contextual Search externally visible constants.
extern const base::FeatureParam<std::string> kContextualSearchRankerUrl;
extern const PredictorConfig kContextualSearchPredictorConfig;
