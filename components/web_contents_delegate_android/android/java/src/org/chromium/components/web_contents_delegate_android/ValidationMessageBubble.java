...
class ValidationMessageBubble {
     ...
     * @param contentOffsetYPx Top content y offset.
    ...
    private static ValidationMessageBubble createAndShowIfApplicable(View containerView,
            int viewportWidthPx, int viewportHeightPx, float contentOffsetYPx, int anchorXPx,
            int anchorYPx, int anchorWidthPx, int anchorHeightPx, String mainText, String subText) {
        if (!canShowBubble(containerView)) return null;

        RectF anchorPixInScreen = makeRectInScreen(containerView, contentOffsetYPx, anchorXPx,
                anchorYPx, anchorWidthPx, anchorHeightPx);
        ValidationMessageBubble bubble = new ValidationMessageBubble(containerView, viewportWidthPx,
                viewportHeightPx, contentOffsetYPx, anchorPixInScreen, mainText, subText);
        bubble.setPositionRelativeToAnchor(viewportWidthPx, viewportHeightPx, contentOffsetYPx,
                anchorXPx, anchorYPx, anchorWidthPx, anchorHeightPx);
        return bubble;
    }
    ...
    private ValidationMessageBubble(View containerView, int viewportWidthPx, int viewportHeightPx,
            float contentOffsetYPx, RectF anchor, String mainText, String subText) {
        mView = containerView;
     ...
     * @param viewportWidthPx Viewport width.
     * @param viewportHeightPx Viewport height.
     * @param contentOffsetYPx Content y offset from the top.
     * @param anchorXPx Anchor x position.
     * @param anchorYPx Anchor y position.
     * @param anchorWidthPx Anchor width.
     * @param anchorHeightPx Anchor height.
     */
    @CalledByNative
    private void setPositionRelativeToAnchor(int viewportWidthPx, int viewportHeightPx,
