...
class ValidationMessageBubble {
     ...
     * @param contentOffsetYPx Offset of the content from the top.
    ...
    private static ValidationMessageBubble createIfApplicable(
            View containerView, float contentOffsetYPx, String mainText, String subText) {
        if (!canShowBubble(containerView)) return null;
        return new ValidationMessageBubble(containerView, contentOffsetYPx, mainText, subText);
    }
