...
CdmMessageFilterAndroid::CdmMessageFilterAndroid(bool can_persist_data,
                                                 bool can_use_secure_codecs)
...
void CdmMessageFilterAndroid::OnQueryKeySystemSupport(
  ...
  // |can_persist_data_| is false, and MediaDrm still persists data on the
  // Android system, we are somewhat violating the incognito assumption.
  // This cannot be used detect incognito mode because the result is the same
  // when |can_persist_data_| is false, and when user blocks the "protected
