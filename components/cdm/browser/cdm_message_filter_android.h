...
class CdmMessageFilterAndroid
 ...
 private:
  ...
  // Whether hardware secure codecs are supported, e.g. the decoded output can
  // be renderered correctly.
  // TODO(xhwang): Instead of a hardcoded value, check whether AndroidOverlay
  // is supported. See http://crbug.com/459414
  const bool can_use_hw_secure_codecs_;
