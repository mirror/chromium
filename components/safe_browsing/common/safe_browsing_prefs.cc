...
const char kPasswordProtectionEmailDomains[] =
    "safe_browsing.password_protection_email_domains";
...
void RegisterProfilePrefs(PrefRegistrySimple* registry) {
  ...
  registry->RegisterListPref(prefs::kPasswordProtectionEmailDomains);
...
void GetSafeBrowsingWhitelistDomainsPref(
  ...
  auto* pref_value = prefs.GetList(prefs::kSafeBrowsingWhitelistDomains);
