...
//
// To be considered "safe", a URL must not appear in the
...
// displayed. In that case, the user can click "proceed" on the warning page if
// he/she decides to procced with loading the URL anyway.
