...
const int kSamplerFrequencyDisabled = 0;

namespace {

int GetSamplerFrequencyDenominator() {
...
bool DetectGoogleAd(content::NavigationHandle* navigation_handle) {
  // TODO(jkarlin): TODO(lpz): This function is temporarily copied from
...
bool ShouldCheckForAd(const int frequency_denominator) {
