...
int GetDailyQuotaForTrigger(const SafeBrowsingTriggerType trigger_type) {
  switch (trigger_type) {
...
bool TriggerThrottler::TriggerCanFire(
    const SafeBrowsingTriggerType trigger_type) const {
...
void TriggerThrottler::TriggerFired(
