...
const base::Feature kPasswordProtectionModalWarning{
    "PasswordProtectionModalWarning", base::FEATURE_DISABLED_BY_DEFAULT};
...
void PasswordProtectionService::RequestFinished(
  ...
  if (response) {
    ...
    if (request->trigger_type() ==
        ...
        base::FeatureList::IsEnabled(kPasswordProtectionModalWarning)) {
