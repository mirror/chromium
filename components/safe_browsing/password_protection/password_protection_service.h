...
class PasswordProtectionService : public history::HistoryServiceObserver {
 public:
  ...
  virtual bool IsEventLoggingEnabled();

  // Returns the value of prefs::kPasswordProtectionWarningTrigger.
  virtual PasswordProtectionTrigger GetPasswordProtectionWarningTriggerPref()
      const = 0;

  // Returns the value of prefs::kPasswordProtectionRiskTrigger.
