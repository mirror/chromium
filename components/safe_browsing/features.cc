...
// If set to true, SafeBrowsing URL checks don't defer starting requests or
...
// SafeBrowsingParallelUrlCheck is ignored in that case.
const base::Feature kParallelUrlCheck{"SafeBrowsingParallelUrlCheck",
                                      base::FEATURE_DISABLED_BY_DEFAULT};
