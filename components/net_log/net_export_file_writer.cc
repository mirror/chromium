...
// TODO(eroman): This duplicates net::FileNetLogObserver::kNoLimit in order to
// avoid adding a static initializer. Use a different strategy to share these.
const size_t NetExportFileWriter::kNoLimit = std::numeric_limits<size_t>::max();
