...
public class CrashFileManagerTest {
    ...
    public void testGetCrashDirectory() {
        ...
        Assert.assertEquals(mCrashDir, actualFile);
    }
    ...
    public void testAttemptNumberRename() {
        ...
        Assert.assertEquals("f.dmp.try2",
        ...
        Assert.assertEquals("f.try2.dmp",
    ...
    public void testFilenameWithForcedUploadState() {
        ...
        Assert.assertEquals("file.forced", CrashFileManager.filenameWithForcedUploadState("file.dmp"));
        ...
        Assert.assertEquals("file.forced", CrashFileManager.filenameWithForcedUploadState("file.skipped"));
        Assert.assertEquals("file.forced0.try0",
    ...
    public void testMarkUploadSuccess() {
        ...
        Assert.assertTrue(new File(mCrashDir, "123_abc.up.try0").exists());

        CrashFileManager.markUploadSuccess(mDmpFile2);
        Assert.assertFalse(mDmpFile2.exists());
        Assert.assertTrue(new File(mCrashDir, "chromium-renderer_abc.up" + TEST_PID + ".try1").exists());
    }
    ...
    public void testMarkUploadSuccess_ForcedUpload() throws IOException {
        ...
        Assert.assertTrue(new File(mCrashDir, "123_abc.up" + TEST_PID + ".try0").exists());
    }
    ...
    public void testMarkUploadSkipped() {
        ...
        Assert.assertFalse(mDmpFile1.exists());
        Assert.assertTrue(new File(mCrashDir, "123_abc.skipped.try0").exists());
