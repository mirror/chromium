...
enum PersistedWindowShowState {
  ...
  PERSISTED_SHOW_STATE_LEFT_SNAPPED = 8,
  PERSISTED_SHOW_STATE_RIGHT_SNAPPED = 9,
  PERSISTED_SHOW_STATE_END = 10,
};
...
PersistedWindowShowState ShowStateToPersistedShowState(
  ...
  switch (state) {
    ...
    case ui::SHOW_STATE_LEFT_SNAPPED:
      return PERSISTED_SHOW_STATE_LEFT_SNAPPED;
    case ui::SHOW_STATE_RIGHT_SNAPPED:
      return PERSISTED_SHOW_STATE_RIGHT_SNAPPED;
...
ui::WindowShowState PersistedShowStateToShowState(int state) {
  switch (state) {
    ...
    case PERSISTED_SHOW_STATE_DOCKED_DEPRECATED:
      return ui::SHOW_STATE_NORMAL;
    case PERSISTED_SHOW_STATE_LEFT_SNAPPED:
      return ui::SHOW_STATE_LEFT_SNAPPED;
    case PERSISTED_SHOW_STATE_RIGHT_SNAPPED:
      return ui::SHOW_STATE_RIGHT_SNAPPED;
  }
  NOTREACHED();
  return ui::SHOW_STATE_NORMAL;
}
