...
Runner.prototype = {
 ...
 {
 this.popupCanvasCtx.clearRect(0, 0, this.dimensions.WIDTH, this.dimensions.HEIGHT);
 ...
 this.popupCanvasCtx.drawImage(Runner.imageSprite,
                               this.popup_dino_sx + (this.popup_dino_real_frame * this.popup_dino_swidth), this.popup_dino_sy,
  ...
  startGame: function() {
    ...
    w.document.body.innerHTML='<div class="popup-container" style="margin-left: -8px; margin-top:-11px;"></div>';
