...
Runner.prototype = {
 ...
 this.popupCanvasCtx.drawImage(Runner.imageSprite,
  ...
  startGame: function() {
    ...
    w.document.body.innerHTML='<div class="popup-container" style="margin-left: -8px; margin-top:-11px;"><button type="button" id="dinobutton">Dino Button</button></div>';
    //w.addEventListener("click", this.displayTest, true);
