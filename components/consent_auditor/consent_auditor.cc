...
ConsentAuditor::ConsentAuditor(PrefService* pref_service,
    ...
    : pref_service_(pref_service),
      ...
      product_version_(version_info::GetVersionNumber()) {
...
void ConsentAuditor::RecordLocalConsent(const std::string& feature,
  ...
  record->SetString(kLocalConsentVersionInfoKey, product_version_);

  // TODO(crbug.com/781765): Record the user language.
