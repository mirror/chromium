...
DeviceSyncImpl::DeviceSyncImpl(
  ...
  identity_manager_->GetPrimaryAccountWhenAvailable(
      OnPrimaryAccountAvailableCallback(
          GenerateKeyPairCallback(ConstructRemoteDeviceProviderCallback(
...
base::Closure DeviceSyncImpl::GenerateKeyPairCallback(
    base::Closure OnKeyPairGenerated) {
  return base::Bind(&DeviceSyncImpl::GenerateKeyPair,
                    weak_ptr_factory_.GetWeakPtr(), OnKeyPairGenerated);
}

base::Closure DeviceSyncImpl::ConstructRemoteDeviceProviderCallback(
    base::Closure OnRemoteDeviceProviderConstructed) {
  return base::Bind(&DeviceSyncImpl::ContructRemoteDeviceProvider,
                    weak_ptr_factory_.GetWeakPtr(),
                    OnRemoteDeviceProviderConstructed);
}

base::Closure DeviceSyncImpl::ForceEnrollmentNowCallback() {
  return base::Bind(&DeviceSyncImpl::ForceEnrollmentNow,
                    weak_ptr_factory_.GetWeakPtr());
}
