...
bool FakeDeviceSync::should_sync_successfully() {
  return should_sync_successfully_;
}

bool FakeDeviceSync::should_enroll_successfully() {
  return should_enroll_successfully_;
}
