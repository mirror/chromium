...
// These StrucTraits map native data structures used by the Device Sync Service to the Mojo generated data structures.  Each StructTrait represents a set of rules that the service uses to automatically convert a native data structure to a mojo based one and vice versa.
