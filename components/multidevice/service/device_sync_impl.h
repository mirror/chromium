...
class DeviceSyncImpl : public device_sync::mojom::DeviceSync,
 ...
 public:
  ...
  // TODO(hsuregan): Eliminate when MultiDeviceService is done.
 ...
 private:
  ...
  void Initialize();
  void SetStateReadyAndEnroll();
  void SetStateReadyAndSync();
  void BranchGenerateKeyOrSync();
