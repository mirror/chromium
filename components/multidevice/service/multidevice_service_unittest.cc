...
class MultiDeviceServiceTest : public service_manager::test::ServiceTest {
 ...
 protected:
  ...
  // DeviceSyncImpl device_sync_impl_;
...
TEST_F(MultiDeviceServiceTest, ForceEnrollmentNowSyncTest) {
  ...
  //                base::Unretained(service_manager::context()))));

  //  std::unique_ptr<service_manager::ServiceContextRef>
  //  service_context_ref_impl;
  // service_manager::ServiceContextRefImpl hello =
  // service_manager::ServiceContextRefImpl();
  //  service_context_ref_impl.reset(new
  //  service_manager::ServiceContextRefImpl());
  //    = base::MakeUnique<service_manager::ServiceContextRefImpl>();

  //  DeviceSyncImpl device_sync(service_context_ref_impl.get());
