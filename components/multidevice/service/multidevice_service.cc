...
MultiDeviceService::MultiDeviceService(
    ...
    std::unique_ptr<cryptauth::RemoteDeviceProviderImpl::Factory>
    ...
    : identity_manager_(std::move(identity_manager)),
      ...
      remote_device_provider_factory_(
          std::move(remote_device_provider_factory)),
...
void MultiDeviceService::CreateDeviceSyncImpl(
  ...
  mojo::MakeStrongBinding(
      base::MakeUnique<DeviceSyncImpl>(
          ref_factory->CreateRef(), identity_manager_.get(),
          std::move(pref_connector_), gcm_manager_.get(), device_manager_.get(),
          enrollment_manager_.get(), remote_device_provider_factory_.get(),
