...
void ZoomController::SkipMetricsDelaysForTesting() {
  metrics_recorder_.SkipDelaysForTesting();
}

void ZoomController::CollectionDoneNotificationForTesting(
    base::OnceClosure done) {
  metrics_recorder_.CollectionDoneNotificationForTesting(std::move(done));
}
