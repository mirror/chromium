...
const base::TimeDelta ZoomMetricsRecorder::kStyleRequestDelay =
    base::TimeDelta::FromSeconds(3);  // TODO 10 seconds
...
void ZoomMetricsRecorder::OnUserZoom(double zoom_factor, bool browser_handled) {
  // TODO Do we want to put this behind a feature flag, so we can
  // enable/disable?
