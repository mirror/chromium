...
constexpr std::array<IconTypeAndName, 4> kIconTypesAndNames{{
    ...
    {favicon_base::IconType::kTouchIcon, "TOUCH_ICON"},
    {favicon_base::IconType::kTouchPrecomposedIcon, "TOUCH_PRECOMPOSED_ICON"},
    {favicon_base::IconType::kWebManifestIcon, "WEB_MANIFEST_ICON"},
}};
