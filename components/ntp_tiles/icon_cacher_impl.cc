...
constexpr int kTileIconMinSizePx = 0;
constexpr int kTileIconDesiredSizePx = 96;

constexpr char kTileIconMinSizePxParam[] = "min_size";
constexpr char kTileIconDesiredSizePxParam[] = "desired_size";
...
int GetMinimumFetchingSizeForMostLikelyFaviconsFromServer() {
  return base::GetFieldTrialParamByFeatureAsInt(
      kNtpMostLikelyFaviconsFromServerFeature, kTileIconMinSizePxParam,
      kTileIconMinSizePx);
}

int GetDesiredFetchingSizeForMostLikelyFaviconsFromServer() {
  return base::GetFieldTrialParamByFeatureAsInt(
      kNtpMostLikelyFaviconsFromServerFeature, kTileIconDesiredSizePxParam,
      kTileIconDesiredSizePx);
}
...
void IconCacherImpl::StartFetchMostLikely(const GURL& page_url,
  ...
  large_icon_service_->GetLargeIconOrFallbackStyle(
      page_url, GetMinimumFetchingSizeForMostLikelyFaviconsFromServer(),
...
void IconCacherImpl::OnGetLargeIconOrFallbackStyleFinished(
  ...
  large_icon_service_
      ->GetLargeIconOrFallbackStyleFromGoogleServerSkippingLocalCache(
          page_url, GetMinimumFetchingSizeForMostLikelyFaviconsFromServer(),
          GetDesiredFetchingSizeForMostLikelyFaviconsFromServer(),
