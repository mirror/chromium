...
TEST(RecordTileImpressionTest, ShouldRecordUmaForIcons) {
  ...
  RecordTileImpression(1, TileSource::TOP_SITES, ICON_REAL,
                       /*rappor_service=*/nullptr);
  RecordTileImpression(2, TileSource::TOP_SITES, ICON_REAL,
                       /*rappor_service=*/nullptr);
  RecordTileImpression(3, TileSource::TOP_SITES, ICON_COLOR,
                       /*rappor_service=*/nullptr);
  RecordTileImpression(4, TileSource::TOP_SITES, ICON_COLOR,
                       /*rappor_service=*/nullptr);
  ...
  RecordTileImpression(6, TileSource::SUGGESTIONS_SERVICE, ICON_DEFAULT,
                       /*rappor_service=*/nullptr);
  RecordTileImpression(7, TileSource::POPULAR, ICON_COLOR,
                       /*rappor_service=*/nullptr);
