...
const int kUnknownNameSource = static_cast<int>(TileNameSource::UNKNOWN);
const int kTitleTagNameSource = static_cast<int>(TileNameSource::TITLE_TAG);
const int kManifestNameSource = static_cast<int>(TileNameSource::MANIFEST);
const int kMetaTagNameSource = static_cast<int>(TileNameSource::META_TAG);
...
TEST(RecordTileImpressionTest, ShouldRecordUmaForIcons) {
  ...
  RecordTileImpression(6, TileNameSource::UNKNOWN,
                       ...
                       /*rappor_service=*/nullptr);
  RecordTileImpression(7, TileNameSource::TITLE_TAG, TileSource::POPULAR,
                       ICON_COLOR, GURL(), /*rappor_service=*/nullptr);
...
TEST(RecordTileImpressionTest, ShouldRecordUmaForThumbnails) {
  ...
  RecordTileImpression(1, TileNameSource::UNKNOWN,
                       ...
                       /*rappor_service=*/nullptr);
  RecordTileImpression(2, TileNameSource::TITLE_TAG, TileSource::POPULAR,
...
TEST(RecordTileImpressionTest, ShouldRecordImpressionsForTileNameSource) {
  ...
  RecordTileImpression(3, TileNameSource::MANIFEST, TileSource::POPULAR,
                       ICON_REAL, GURL(), /*rappor_service=*/nullptr);
  RecordTileImpression(4, TileNameSource::TITLE_TAG,
  ...
  EXPECT_THAT(histogram_tester.GetAllSamples("NewTabPage.TileName.client"),
              ElementsAre(base::Bucket(kUnknownNameSource, /*count=*/1)));
  ...
  EXPECT_THAT(
      ...
      ElementsAre(base::Bucket(kTitleTagNameSource, /*count=*/1),
                  base::Bucket(kManifestNameSource, /*count=*/1)));
  EXPECT_THAT(
      histogram_tester.GetAllSamples("NewTabPage.TileName.popular_baked_in"),
      ElementsAre(base::Bucket(kTitleTagNameSource, /*count=*/1),
                  base::Bucket(kMetaTagNameSource, /*count=*/1)));
  EXPECT_THAT(histogram_tester.GetAllSamples("NewTabPage.TileName"),
              ElementsAre(base::Bucket(kUnknownNameSource, /*count=*/2),
                          base::Bucket(kTitleTagNameSource, /*count=*/2),
                          base::Bucket(kManifestNameSource, /*count=*/1),
                          base::Bucket(kMetaTagNameSource, /*count=*/1)));
}
...
TEST(RecordTileClickTest, ShouldRecordClicksForTileNameSource) {
  ...
  RecordTileClick(1, TileNameSource::UNKNOWN, TileSource::SUGGESTIONS_SERVICE,
                  ICON_REAL);
  RecordTileClick(2, TileNameSource::TITLE_TAG, TileSource::POPULAR, ICON_REAL);
  RecordTileClick(3, TileNameSource::MANIFEST, TileSource::POPULAR, ICON_REAL);
  RecordTileClick(4, TileNameSource::TITLE_TAG, TileSource::POPULAR_BAKED_IN,
                  ICON_REAL);
