...
TEST(RecordTileImpressionTest, ShouldRecordUmaForIcons) {
  ...
  EXPECT_THAT(histogram_tester.GetAllSamples(
                  "NewTabPage.SuggestionsImpression.fetched_popular"),
  ...
  EXPECT_THAT(
      histogram_tester.GetAllSamples("NewTabPage.TileType.fetched_popular"),
...
TEST(RecordTileClickTest, ShouldRecordUmaForIcon) {
  ...
  EXPECT_THAT(histogram_tester.GetAllSamples("NewTabPage.MostVisited.server"),
              IsEmpty());
  EXPECT_THAT(
      histogram_tester.GetAllSamples("NewTabPage.MostVisited.fetched_popular"),
      IsEmpty());
  EXPECT_THAT(
