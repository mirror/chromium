...
const int kUnknownTitleSource = static_cast<int>(TileTitleSource::UNKNOWN);
const int kManifestTitleSource = static_cast<int>(TileTitleSource::MANIFEST);
const int kMetaTagTitleSource = static_cast<int>(TileTitleSource::META_TAG);
const int kTitleTagTitleSource = static_cast<int>(TileTitleSource::TITLE_TAG);
const int kInferredTitleSource = static_cast<int>(TileTitleSource::INFERRED);
