...
class ServiceWorkerPaymentInstrument : public PaymentInstrument {
 public:
  // This constructor is used for a payment app has been installed in Chrome.
  ...
  // This contructor is used for a payment app has not been installed in Chrome
  // but can be installed when paying with it.
  ServiceWorkerPaymentInstrument(
