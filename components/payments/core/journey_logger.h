...
class JourneyLogger {
 public:
  ...
  // Records the requested payment methods. A value should be true if at least
  // one in the category (basic-card, google payment method or other payment
  // method, respectively) is requested.
  void SetRequestedPaymentMethods(bool requested_basic_card,
