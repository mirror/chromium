...
base::string16 GetShippingAddressLabelFormAutofillProfile(
  ...
  // label.
  static constexpr autofill::ServerFieldType label_fields[] = {
  ...
  return profile.ConstructInferredLabel(label_fields, arraysize(label_fields),
                                        arraysize(label_fields), locale);
}
