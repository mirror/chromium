...
bool JourneyLogger::WasCanMakePaymentUsed() {
  return events_ & EVENT_CAN_MAKE_PAYMENT_FALSE ||
         events_ & EVENT_CAN_MAKE_PAYMENT_TRUE;
}

bool JourneyLogger::CouldMakePayment() {
  return events_ & EVENT_CAN_MAKE_PAYMENT_TRUE;
}

bool JourneyLogger::WasPaymentRequestTriggered() {
  return events_ & EVENT_SHOWN || events_ & EVENT_SKIPPED_SHOW;
}
