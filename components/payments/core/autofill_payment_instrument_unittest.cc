 ...
 public:
  ...
  void CompleteFullCardRequest() {
    full_card_result_delegate_->OnFullCardRequestSucceeded(
        FullCardRequest(), full_card_request_card_, base::ASCIIToUTF16("123"));
  }
...
TEST_F(AutofillPaymentInstrumentTest,
  ...
  PersonalDataManager* personal_data_manager = new PersonalDataManager("en-US");
  TestPaymentRequestDelegate delegate(personal_data_manager);
