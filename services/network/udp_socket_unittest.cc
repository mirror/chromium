...
TEST_F(UDPSocketTest, MAYBE_JoinMulticastGroup) {
  ...
  net::AddressFamily family = socket_address.GetFamily();
  ...
  ASSERT_EQ(net::OK, helper.OpenWithOptionsSync(family, std::move(options)));
  ...
  ASSERT_EQ(net::OK, second_socket_helper.OpenWithOptionsSync(family, nullptr));
