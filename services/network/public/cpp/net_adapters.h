...
class COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) NetToMojoPendingBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) NetToMojoIOBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) MojoToNetPendingBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) MojoToNetIOBuffer
    : public net::WrappedIOBuffer {
 public:
