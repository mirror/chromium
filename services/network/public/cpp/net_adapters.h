...
class COMPONENT_EXPORT(SERVICES_NETWORK) NetToMojoPendingBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK) NetToMojoIOBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK) MojoToNetPendingBuffer
...
class COMPONENT_EXPORT(SERVICES_NETWORK) MojoToNetIOBuffer
    : public net::WrappedIOBuffer {
 public:
