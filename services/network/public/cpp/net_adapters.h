...
class SERVICES_NETWORK_EXPORT NetToMojoPendingBuffer
...
class SERVICES_NETWORK_EXPORT NetToMojoIOBuffer : public net::WrappedIOBuffer {
 public:
...
class SERVICES_NETWORK_EXPORT MojoToNetPendingBuffer
...
class SERVICES_NETWORK_EXPORT MojoToNetIOBuffer : public net::WrappedIOBuffer {
 public:
