...
#ifndef SERVICES_NETWORK_PUBLIC_CPP_RESOURCE_SCHEDULER_H_
#define SERVICES_NETWORK_PUBLIC_CPP_RESOURCE_SCHEDULER_H_
...
// the URLRequest.
// TODO(yhirano): Move this class to /services/network once the network service
// is launched.
class COMPONENT_EXPORT(NETWORK_CPP) ResourceScheduler {
 public:
...
#endif  // SERVICES_NETWORK_PUBLIC_CPP_RESOURCE_SCHEDULER_H_
