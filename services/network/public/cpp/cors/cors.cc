...
// TODO(toyoshim): Consider to move following method to //net/base/mime_util,
// and expose to Blink platform/network in order to replace an existing
// equivalent method in HTTPPraser.
std::string ExtractMIMETypeFromMediaType(std::string media_type) {
