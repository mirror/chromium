...
COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP)
extern const char kHostResolverRules[];
COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) extern const char kLogNetLog[];
COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP) extern const char kNoReferrers[];
