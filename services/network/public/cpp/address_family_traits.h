...
#ifndef SERVICES_NETWORK_PUBLIC_CPP_ADDRESS_FAMILY_TRAITS_H_
#define SERVICES_NETWORK_PUBLIC_CPP_ADDRESS_FAMILY_TRAITS_H_
...
#endif  // SERVICES_NETWORK_PUBLIC_CPP_ADDRESS_FAMILY_TRAITS_H_
