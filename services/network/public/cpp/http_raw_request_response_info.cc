...
// Attempt at auto-detecting changes to the structure not reflected in
// HttpRawRequestResponseInfo::DeepCopy().
static_assert(232 == sizeof(HttpRawRequestResponseInfo),
              "HttpRawRequestResposneInfo changed without updating DeepCopy()");
