...
struct COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP_BASE) ResourceResponseHead
...
struct COMPONENT_EXPORT(SERVICES_NETWORK_PUBLIC_CPP_BASE) ResourceResponse
