...
#define IPC_MESSAGE_EXPORT COMPONENT_EXPORT(SERVICES_NETWORK_TYPES)
...
template <>
struct COMPONENT_EXPORT(SERVICES_NETWORK_TYPES) ParamTraits<net::HashValue> {
...
template <>
struct COMPONENT_EXPORT(SERVICES_NETWORK_TYPES) ParamTraits<net::HostPortPair> {
...
template <>
struct COMPONENT_EXPORT(SERVICES_NETWORK_TYPES) ParamTraits<net::SSLInfo> {
...
template <>
struct COMPONENT_EXPORT(SERVICES_NETWORK_TYPES)
    ParamTraits<network::DataElement> {
...
template <>
struct COMPONENT_EXPORT(SERVICES_NETWORK_TYPES) ParamTraits<url::Origin> {
