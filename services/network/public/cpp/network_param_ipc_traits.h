...
#define IPC_MESSAGE_EXPORT SERVICES_NETWORK_TYPES_EXPORT
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::CertVerifyResult> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::HashValue> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::HostPortPair> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::HttpRequestHeaders> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::OCSPVerifyResult> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::SSLInfo> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<net::LoadTimingInfo> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<network::DataElement> {
...
template <>
struct SERVICES_NETWORK_TYPES_EXPORT ParamTraits<url::Origin> {
