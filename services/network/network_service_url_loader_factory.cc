...
NetworkServiceURLLoaderFactory::NetworkServiceURLLoaderFactory(
  ...
  network_context_->RegisterURLLoaderFactory(this);
}
...
NetworkServiceURLLoaderFactory::~NetworkServiceURLLoaderFactory() {
  ...
  network_context_->DeregisterURLLoaderFactory(this);
}
...
void NetworkServiceURLLoaderFactory::CreateLoaderAndStart(
  ...
  if (url_request.report_raw_headers) {
    const NetworkServiceImpl* service = network_context_->network_service();
  ...
  new URLLoader(
      this, std::move(request), options, url_request, report_raw_headers,
      std::move(client),
