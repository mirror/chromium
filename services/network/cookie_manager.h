...
#ifndef SERVICES_NETWORK_PUBLIC_CPP_COOKIE_MANAGER_H_
#define SERVICES_NETWORK_PUBLIC_CPP_COOKIE_MANAGER_H_
...
#endif  // SERVICES_NETWORK_PUBLIC_CPP_COOKIE_MANAGER_H_
