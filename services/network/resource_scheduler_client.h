...
// the associated NetworkContext. Failing to keep the contract will be detected
// by a DCHECK in ResourceScheduler's destructor which checks if all clients are
// removed.
class ResourceSchedulerClient final
