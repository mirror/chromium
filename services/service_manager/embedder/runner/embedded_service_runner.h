...
#ifndef SERVICES_SERVICE_MANAGER_EMBEDDER_RUNNER_EMBEDDED_SERVICE_RUNNER_H_
#define SERVICES_SERVICE_MANAGER_EMBEDDER_RUNNER_EMBEDDED_SERVICE_RUNNER_H_
...
class SERVICE_MANAGER_EMBEDDER_RUNNER_EXPORT EmbeddedServiceRunner {
 public:
...
#endif  // SERVICES_SERVICE_MANAGER_EMBEDDER_RUNNER_EMBEDDED_SERVICE_RUNNER_H_
