...
class SERVICE_MANAGER_EMBEDDER_EXPORT EmbeddedInstanceManager
 ...
 private:
  ...
  void DecreaseServiceRequestCount(std::unique_ptr<base::Thread> thread);
  void SetServiceRequestCountToZero(std::unique_ptr<base::Thread> thread);
  void OnServiceRequestCountChangedToZero(std::unique_ptr<base::Thread> thread);
