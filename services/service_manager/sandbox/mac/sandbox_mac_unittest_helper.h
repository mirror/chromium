...
#ifndef SERVICES_SERVICE_MANAGER_SANDBOX_SANDBOX_MAC_UNITTEST_HELPER_H_
#define SERVICES_SERVICE_MANAGER_SANDBOX_SANDBOX_MAC_UNITTEST_HELPER_H_
...
#endif  // SERVICES_SERVICE_MANAGER_SANDBOX_SANDBOX_MAC_UNITTEST_HELPER_H_
