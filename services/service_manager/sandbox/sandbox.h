...
// TODO(tsepez): move linux code here.
  ...
  // directory specified by |allowed_dir| if non-empty. Runs |pre_sandbox_hook|
  // if non-empty immediately before engaging the sandbox. Return true on
  // success, false otherwise.
  static bool Initialize(service_manager::SandboxType sandbox_type,
                         const base::FilePath& allowed_dir,
                         base::OnceClosure pre_sandbox_hook);
#endif  // defined(OS_MACOSX)
