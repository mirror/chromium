...
// testing.
// Note that when using CreateForUniqueService(), the factory ignores the target
// service name in BindInterface calls: interface requests are always routed to
// a single target Service instance.
...
class TestConnectorFactory {
 public:
  ...
  // Construtcs a new TestConnectorFactory which creates Connectors whose
  // requests are routed directly to |services| based on the name associated
  // with them.
