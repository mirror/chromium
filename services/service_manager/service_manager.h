...
class ServiceManager {
 ...
 private:
  ...
  // various identities.
  enum InstanceType {
    DEFAULT,    // Unique for each user and each instance name.
    ALL_USERS,  // Same instance for all users. Unique for each instance name.
    SINGLETON   // Same instance for all users and all instance names.
  };
  ...
  // and this function returns that instance.
