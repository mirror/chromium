...
class SerialIoHandlerImplTest : public DeviceServiceTestBase {
 ...
 protected:
  void SetUp() override {
    ...
    connector()->BindInterface(mojom::kServiceName, &io_handler_);
  }

  void TearDown() override { io_handler_.reset(); }

  mojom::SerialIoHandlerPtr io_handler_;
