...
#ifndef SERVICES_DEVICE_GENERIC_SENSOR_TRAITS_H_
#define SERVICES_DEVICE_GENERIC_SENSOR_TRAITS_H_
...
struct SensorTraits {
  static constexpr double kMaxAllowedFrequency =
...
#endif  // SERVICES_DEVICE_GENERIC_SENSOR_TRAITS_H_
