 ...
 protected:
  ...
  void CreateLinearAccelerationFusionSensor() {
    ...
    PlatformSensorFusion::Create(
        std::move(shared_buffer_), provider_.get(),
        std::move(linear_acceleration_fusion_algorithm_), callback);
  ...
  scoped_refptr<PlatformSensor> accelerometer_ = nullptr;
  bool magnetometer_callback_called_ = false;
  scoped_refptr<PlatformSensor> magnetometer_ = nullptr;
