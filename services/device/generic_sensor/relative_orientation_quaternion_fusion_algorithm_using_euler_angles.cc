...
RelativeOrientationQuaternionFusionAlgorithmUsingEulerAngles::
    ~RelativeOrientationQuaternionFusionAlgorithmUsingEulerAngles() = default;

void RelativeOrientationQuaternionFusionAlgorithmUsingEulerAngles::GetFusedData(
    const std::vector<SensorReading>& readings,
    SensorReading* fused_reading) {
  // Transform the RELATIVE_ORIENTATION_EULER_ANGLES values to
