...
class HidServiceTest : public DeviceServiceTestBase {
 public:
  ...
  void SetUp() override {
    ...
    mock_hid_service_ = base::MakeUnique<device::MockHidService>();
    HidService::SetHidServiceForTesting(mock_hid_service_.get());
  ...
  std::unique_ptr<device::MockHidService> mock_hid_service_;
