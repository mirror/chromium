...
class HidManagerTest : public DeviceServiceTestBase {
 public:
  ...
  void SetUp() override {
    ...
    mock_hid_service_ = new device::MockHidService();
    // Transfer the ownership of the new created MockHidService instance to
    // HidManagerImpl. It is safe to use the |mock_hid_service_| in this test.
    HidManagerImpl::SetHidServiceForTesting(mock_hid_service_);
