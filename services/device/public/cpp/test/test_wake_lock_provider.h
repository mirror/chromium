...
class TestWakeLockProvider : public mojom::WakeLockProvider,
 ...
 public:
  ...
  void set_wake_lock_requested_callback(const base::Closure& cb) {
    wake_lock_requested_callback_ = cb;
  }
  void set_wake_lock_canceled_callback(const base::Closure& cb) {
 ...
 private:
  ...
  base::Closure wake_lock_requested_callback_;
  base::Closure wake_lock_canceled_callback_;
