...
struct SensorReading {
  ...
  //
  // ACCELEROMETER:
  // values[0]: acceleration minus Gx on the x-axis in SI meter per second
  // squared (m/s^2) units.
  // values[1]: acceleration minus Gy on the y-axis in SI meter per second
  // squared (m/s^2) units.
  // values[2]: acceleration minus Gz on the z-axis in SI meter per second
  // squared (m/s^2) units.
  //
  // LINEAR_ACCELERATION:
  // values[0]: acceleration on the x-axis in SI meter per second squared
  // (m/s^2) units.
  // values[1]: acceleration on the y-axis in SI meter per second squared
  // (m/s^2) units.
  // values[2]: acceleration on the z-axis in SI meter per second squared
  // (m/s^2) units.
  //
  // GYROSCOPE:
