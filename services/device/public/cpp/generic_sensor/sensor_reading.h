...
// the device in 3D space. orientation_quat.y: y value of a quaternion
// representing the orientation of the device in 3D space. orientation_quat.z: z
// value of a quaternion representing the orientation of the device in 3D space.
