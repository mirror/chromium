...
class PublicIpAddressLocationNotifier
 ...
 public:
  ...
  // * If no position change is detected later than |timestamp|, |callback| will
  //   not be invoked.
  //
  // * Example usage:
  //   First, call this method with a zero-initialized timestamp to get
  //   the latest position.
  //   Subsequently, call this method with the timestamp of the
  //   returned Geoposition.
