...
class PublicIpAddressLocationNotifier
 ...
 public:
  ...
  // Add partial network traffic annotation for a new client.
  void AddClientPartialNetworkTrafficAnnotationTag(
      const net::PartialNetworkTrafficAnnotationTag);

  // Remove the partial network traffic annotation for the client.
  // This should be called only once per client.
  void RemoveClientPartialNetworkTrafficAnnotationTag(
      const net::PartialNetworkTrafficAnnotationTag);
 ...
 private:
  ...
  struct AnnotationTagComparer {
    bool operator()(
        const net::PartialNetworkTrafficAnnotationTag& first,
        const net::PartialNetworkTrafficAnnotationTag& second) const {
      return first.unique_id_hash_code > second.unique_id_hash_code;
    }
  };

  // Client-side partial network annotations.
  std::multiset<net::PartialNetworkTrafficAnnotationTag, AnnotationTagComparer>
      client_partial_network_annotation_tags_;
