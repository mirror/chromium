...
PublicIpAddressGeolocator::PublicIpAddressGeolocator(
  ...
  notifier_destruction_subscription_ = notifier_->AddDestructionCallback(
      base::Bind(&PublicIpAddressGeolocator::OnNotifierDestruction,
...
void PublicIpAddressGeolocator::OnNotifierDestruction() {
  delete this;
}
