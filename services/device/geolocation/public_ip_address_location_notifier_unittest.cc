...
TEST_F(PublicIpAddressLocationNotifierTest, SingleQueryReturns) {
  ...
  notifier_.QueryNextPositionAfterTimestamp(
      base::Time::Now(), PARTIAL_TRAFFIC_ANNOTATION_FOR_TESTS,
      query.MakeCallback());
  ...
  RespondToFetchWithLatitude(fetcher, 1.0f, false);
...
TEST_F(PublicIpAddressLocationNotifierTest, OlderQueryReturnsCached) {
  ...
  notifier_.QueryNextPositionAfterTimestamp(
      time, PARTIAL_TRAFFIC_ANNOTATION_FOR_TESTS, query_1.MakeCallback());
  net::TestURLFetcher* const fetcher = GetTestUrlFetcher();
  EXPECT_THAT(fetcher, testing::NotNull());
  RespondToFetchWithLatitude(fetcher, 1.0f, false);
  ...
  notifier_.QueryNextPositionAfterTimestamp(
      ...
      PARTIAL_TRAFFIC_ANNOTATION_FOR_TESTS, query_2.MakeCallback());
...
TEST_F(PublicIpAddressLocationNotifierTest,
  ...
  TestPositionQuery query_2;
  notifier_.QueryNextPositionAfterTimestamp(
      query_1.position()->timestamp, PARTIAL_TRAFFIC_ANNOTATION_FOR_TESTS,
  ...
  RespondToFetchWithLatitude(fetcher_2, 2.0f, false);
...
TEST_F(PublicIpAddressLocationNotifierTest, ServerError) {
  ...
  net::TestURLFetcher* const fetcher = GetTestUrlFetcher();
  EXPECT_THAT(fetcher, testing::NotNull());
  RespondToFetchWithLatitude(fetcher, 1.0f, true);
  // Expect the query to return.
