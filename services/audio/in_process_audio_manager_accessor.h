...
// main thread.
class InProcessAudioManagerAccessor
    : public AudioService::AudioManagerAccessor {
 public:
  explicit InProcessAudioManagerAccessor(media::AudioManager* audio_manager);
  ~InProcessAudioManagerAccessor() override;

  media::AudioManager* GetAudioManager() override;
