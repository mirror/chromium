...
#ifndef SERVICES_AUDIO_TEST_SERVICE_QUIT_TEST_TEMPLATE_H_
#define SERVICES_AUDIO_TEST_SERVICE_QUIT_TEST_TEMPLATE_H_
...
// Template for Audio service lifetime tests reguarding client
...
#endif  // SERVICES_AUDIO_TEST_SERVICE_QUIT_TEST_TEMPLATE_H_
