...
class AudioSystemToMojoAdapterTest : public testing::Test {
 ...
 protected:
  ...
  // Called upon AudioSystem bind request success/filure.
  NiceMock<MockFunction<void(bool success)>> audio_system_info_bind_success_;

  // If set to true, AudioSystem bind request will fail.
...
// TODO(olka): when reviewers are happy, add connection lost and binding fail
// tests for each AudioSystemInfo method. DO NOT COMMIT BEFORE THAT.
