...
// [Lazily] creates AudioManager using provided factory callback and controls
// its lifetime. Threading model of a created AudioManager is enforced: its
// main thread is the thread OwningAudioManagerAccessor lives on.
class OwningAudioManagerAccessor : public AudioService::AudioManagerAccessor {
 public:
