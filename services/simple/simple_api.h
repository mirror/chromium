...
SIMPLE_EXPORT simple::Math* createMath();
SIMPLE_EXPORT simple::Echo* createEcho();

// This returns a small one-line string describing the implementation.
SIMPLE_EXPORT const char* createAbstract();
