...
// Implementation of the simple:: classes using a std::function<> instance.
// This shall have similar performance to the base::Callback version but
...
const char* createAbstract() {
  return "Invoke same std::function<> instance on each method call.";
}
