...
#ifndef SERVICES_UI_PUBLIC_CPP_GPU_CONTEXT_PROVIDER_COMMAND_BUFFER_BASE_H_
#define SERVICES_UI_PUBLIC_CPP_GPU_CONTEXT_PROVIDER_COMMAND_BUFFER_BASE_H_
...
class ContextProviderCommandBufferBase
 ...
 public:
  ContextProviderCommandBufferBase(
 ...
 protected:
  ~ContextProviderCommandBufferBase() override;
 ...
 private:
  struct SharedProviders : public base::RefCountedThreadSafe<SharedProviders> {
    base::Lock lock;
    std::vector<ContextProviderCommandBufferBase*> list;
...
#endif  // SERVICES_UI_PUBLIC_CPP_GPU_CONTEXT_PROVIDER_COMMAND_BUFFER_BASE_H_
