...
struct StructTraits<ui::mojom::ImeTextSpanDataView, ui::ImeTextSpan> {
  ...
  static ui::ImeTextSpanThickness thickness(const ui::ImeTextSpan& i) {
    return i.thickness;
  }
...
template <>
struct EnumTraits<ui::mojom::ImeTextSpanThickness, ui::ImeTextSpanThickness> {
