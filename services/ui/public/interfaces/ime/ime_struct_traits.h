...
struct StructTraits<ui::mojom::CompositionTextDataView, ui::CompositionText> {
  ...
  static ui::ImeSpans ime_spans(const ui::CompositionText& c) {
    return c.ime_spans;
  }
...
template <>
struct StructTraits<ui::mojom::ImeSpanDataView, ui::ImeSpan> {
  static uint32_t start_offset(const ui::ImeSpan& c) { return c.start_offset; }
  static uint32_t end_offset(const ui::ImeSpan& c) { return c.end_offset; }
  static uint32_t color(const ui::ImeSpan& c) { return c.color; }
  static uint32_t thick(const ui::ImeSpan& c) { return c.thick; }
  static uint32_t background_color(const ui::ImeSpan& c) {
    return c.background_color;
  }
  static bool Read(ui::mojom::ImeSpanDataView data, ui::ImeSpan* out);
};
