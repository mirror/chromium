...
class WindowTreeClientTest2 : public WindowServerServiceTestBase {
 ...
 protected:
  ...
  void SetUp() override {
    ...
    // XXX: figure out better way to isolate this!
...
TEST_F(WindowTreeClientTest2, CantAccessChildrenOfEmbeddedWindow) {
  ...
  // Client 1 should only see window_1_.
  {
    std::vector<TestWindow> windows;
...
TEST_F(WindowTreeClientTest2, WindowHierarchyChangedAddingKnownToUnknown) {
...
TEST_F(WindowTreeClientTest2, ReorderWindow) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
...
TEST_F(WindowTreeClientTest2, DeleteWindow) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
  Id window_2_1 = wt_client2()->NewWindow(1);
  ASSERT_TRUE(window_2_1);
...
// properly notified.
TEST_F(WindowTreeClientTest2, ReuseDeletedWindowId) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
  Id window_2_1 = wt_client2()->NewWindow(1);
  ASSERT_TRUE(window_2_1);
...
TEST_F(WindowTreeClientTest2, GetWindowTree) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
...
TEST_F(WindowTreeClientTest2, SetWindowBounds) {
  Id window_1_1 = wt_client1()->NewWindow(1);
  ASSERT_TRUE(window_1_1);
  ASSERT_TRUE(wt_client1()->AddWindow(root_window_id(), window_1_1));
...
TEST_F(WindowTreeClientTest2, EmbedWithSameWindowId) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  changes2()->clear();
...
TEST_F(WindowTreeClientTest2, EmbedWithSameWindowId2) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
  changes2()->clear();
...
TEST_F(WindowTreeClientTest2, SetWindowVisibility) {
  // Create 1 and 2 in the first client and parent both to the root.
  Id window_1_1 = wt_client1()->NewWindow(1);
  Id window_1_2 = wt_client1()->NewWindow(2);
  ASSERT_TRUE(window_1_1);
...
TEST_F(WindowTreeClientTest2, SetCursor) {
...
TEST_F(WindowTreeClientTest2, SetWindowVisibilityNotifications) {
...
// Assertions for SetWindowVisibility sending notifications.
TEST_F(WindowTreeClientTest2, SetWindowVisibilityNotifications2) {
  // Create client_id_1(),1 and client_id_1(),2. client_id_1(),2 is made a child
  // of client_id_1(),1 and client_id_1(),1 a child of the root.
  Id window_1_1 = wt_client1()->NewWindow(1);
  ASSERT_TRUE(window_1_1);
...
// Assertions for SetWindowVisibility sending notifications.
TEST_F(WindowTreeClientTest2, SetWindowVisibilityNotifications3) {
  // Create client_id_1(),1 and client_id_1(),2. client_id_1(),2 is made a child
  // of client_id_1(),1 and client_id_1(),1 a child of the root.
  Id window_1_1 = wt_client1()->NewWindow(1);
  ASSERT_TRUE(window_1_1);
...
TEST_F(WindowTreeClientTest2, SetOpacityNotifications) {
  Id window_1_1 = wt_client1()->NewWindow(1);
  ASSERT_TRUE(window_1_1);
...
TEST_F(WindowTreeClientTest2, SetWindowProperty) {
  Id window_1_1 = wt_client1()->NewWindow(1);
  ASSERT_TRUE(window_1_1);
...
TEST_F(WindowTreeClientTest2, OnEmbeddedAppDisconnected) {
...
TEST_F(WindowTreeClientTest2, OnParentOfEmbedDisconnects) {
  // Create client 2 and 3.
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
  ASSERT_TRUE(wt_client1()->AddWindow(root_window_id(), window_1_1));
...
TEST_F(WindowTreeClientTest2, DontCleanMapOnDestroy) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
...
TEST_F(WindowTreeClientTest2, EmbedUsingToken) {
  // Embed client2.
  ASSERT_TRUE(wt_client1()->NewWindow(1));
  TestWindowTreeClient client2;
  mojom::WindowTreeClientPtr client2_ptr;
...
TEST_F(WindowTreeClientTest2, EmbedUsingTokenFailsWithInvalidWindow) {
  // Embed client2.
  ASSERT_TRUE(wt_client1()->NewWindow(1));
  TestWindowTreeClient client2;
  mojom::WindowTreeClientPtr client2_ptr;
...
TEST_F(WindowTreeClientTest2, EmbedFromOtherClient) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
...
TEST_F(WindowTreeClientTest2, CantEmbedFromClientRoot) {
...
TEST_F(WindowTreeClientTest2, TransientWindowTracksTransientParentLifetime) {
  ASSERT_NO_FATAL_FAILURE(EstablishSecondClient(true));
  Id window_1_1 = BuildWindowId(client_id_1(), 1);
...
TEST_F(WindowTreeClientTest2, Ids) {
...
TEST_F(WindowTreeClientTest2, SurfaceIdPropagation) {
  const Id window_1_100 = wt_client1()->NewWindow(100);
  ASSERT_TRUE(window_1_100);
  ASSERT_TRUE(wt_client1()->AddWindow(root_window_id(), window_1_100));
...
TEST_F(WindowTreeClientTest2, AddUnknownWindowKnownParent) {
  const Id window_1_100 = wt_client1()->NewWindow(100);
  ASSERT_TRUE(window_1_100);
  ASSERT_TRUE(wt_client1()->AddWindow(root_window_id(), window_1_100));
...
TEST_F(WindowTreeClientTest2, Transform) {
