...
// also create a WindowTreeFactory to handle the incoming WindowTreeFactory
// requests.
//
// TODO: maybe this should internally manage WindowTreeFactory?
class COMPONENT_EXPORT(WINDOW_SERVICE) WindowService {
 public:
  ...
  WindowData* GetWindowDataForWindow(aura::Window* window);
 ...
 private:
  ...
  // Id used for the next window created locally that is exposed to another
  // client.
