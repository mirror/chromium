...
void SetImageCursorsOnResourceThread(
...
// |image_cursors_holder_weak_ptr|, and then schedules a task on
...
ThreadedImageCursors::ThreadedImageCursors(
  ...
  // |image_cursors_holder_weak_ptr_|. Note that it is essential to initialize
  ...
  resource_task_runner_->PostTask(
      FROM_HERE, base::Bind(&SetImageCursorsOnResourceThread,
                            image_cursors_holder_weak_ptr_,
