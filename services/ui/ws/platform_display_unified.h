...
// PlatformDisplay implementation that connects to 2+ PlatformWindows and
...
class PlatformDisplayUnified : public PlatformDisplay,
 ...
 public:
  ...
  bool SetMirrors(const std::vector<display::Display>& mirrors);
 ...
 private:
  ...
  // The virtual unified platform window.
