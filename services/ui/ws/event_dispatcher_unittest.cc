...
TEST_P(EventDispatcherVizTargeterTest, ProcessEvent) {
  ...
  auto root_hit_test_rect = viz::mojom::HitTestRect::New();
  root_hit_test_rect->flags = viz::mojom::kHitTestMouse;
  root_hit_test_rect->rect = root_window()->bounds();
  aggregated_hit_test_region_list[0].rects.push_back(
      std::move(root_hit_test_rect));
  ...
  auto child_hit_test_rect = viz::mojom::HitTestRect::New();
  child_hit_test_rect->flags = viz::mojom::kHitTestMouse;
  child_hit_test_rect->rect = child->bounds();
  aggregated_hit_test_region_list[1].rects.push_back(
      std::move(child_hit_test_rect));
