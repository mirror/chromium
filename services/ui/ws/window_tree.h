...
class WindowTree : public mojom::WindowTree,
 ...
 private:
  ...
  // Returns the WindowTreeClient previously scheduled for an embed by way of
  // ScheduleEmbed(). If this client is the result of an Embed(), then it
  // recurses to the parent WindowTree.
