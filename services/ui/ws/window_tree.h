...
class WindowTree : public mojom::WindowTree,
 ...
 private:
  ...
  // Returns the ClientWindowId from a transport id or ClientWindowId. Uses id_
  // as the ClientWindowId::client_id part if it was invalid. These functions
  ...
  ClientWindowId MakeClientWindowId(const ClientWindowId& id) const;
