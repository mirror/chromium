...
TabMetricsCollector::UkmCollector::UkmCollector()
...
void TabMetricsCollector::UkmCollector::CollectCPUUsage(double cpu_usage) {
...
bool TabMetricsCollector::UkmCollector::IsCollectingCPUUsage() const {
  return ukm_entry_builder_ &&
         num_cpu_usage_measurements_ < max_cpu_usage_measurements_;
}

void TabMetricsCollector::UkmCollector::ResetUkmEntryBuilder(
...
void TabMetricsCollector::UkmCollector::UpdateWithFieldTrialParams() {
...
void TabMetricsCollector::OnTabPropertyChanged(
    ...
    const mojom::PropertyType property_type,
    const base::Value& value) {
  UkmCollector& tab_cpu_usage_collector =
