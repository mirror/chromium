...
//   CoordinationUnitID frame1_cu_id(CoordinationUnitType::kFrame,
//   std::string()); CoordinationUnitID
//   frame2_cu_id(CoordinationUnitType::kFrame, std::string());
//   CoordinationUnitID frame3_cu_id(CoordinationUnitType::kFrame,
//   std::string());
