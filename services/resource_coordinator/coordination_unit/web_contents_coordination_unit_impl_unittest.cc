...
TEST_F(WebContentsCoordinationUnitImplTest,
  ...
  cu_graph.process->SetProperty(mojom::Property::New(
      mojom::PropertyType::kCPUUsage, base::MakeUnique<base::Value>(40.0)));
...
TEST_F(WebContentsCoordinationUnitImplTest,
  ...
  cu_graph.process->SetProperty(mojom::Property::New(
      mojom::PropertyType::kCPUUsage, base::MakeUnique<base::Value>(40.0)));
  cu_graph.other_process->SetProperty(mojom::Property::New(
      mojom::PropertyType::kCPUUsage, base::MakeUnique<base::Value>(30.0)));
