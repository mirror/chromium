 ...
 public:
  class AgentEntry {
   public:
    ...
    void AddDisconnectClosure(const std::string& closure_name,
                              base::OnceClosure closure);
    bool RemoveDisconnectClosure(const std::string& closure_name);
    bool HasDisconnectClosure(const std::string& closure_name);
   ...
   private:
    ...
    std::map<std::string, base::OnceClosure> closures_;
