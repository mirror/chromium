...
class Coordinator : public mojom::Coordinator {
 ...
 private:
  ...
  // serialized eventually. This is set when tracing is started.
  ...
  bool stream_header_written_;
  bool json_field_name_written_;
  size_t pending_start_tracing_count_;
  ...
  size_t pending_get_categories_count_;
