...
class SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_EXPORT FrameResourceCoordinator {
 public:
  ...
  void AddBinding(mojom::FrameCoordinationUnitRequest request);
  ...
  const mojom::FrameCoordinationUnitPtr& service() const { return service_; }
 ...
 private:
  ...
  mojom::FrameCoordinationUnitPtr service_;
