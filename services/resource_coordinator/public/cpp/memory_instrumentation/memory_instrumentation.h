...
class SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_EXPORT MemoryInstrumentation {
 public:
  ...
  using RequestGlobalDumpForPidCallback =
      base::RepeatingCallback<void(mojom::GlobalMemoryDumpPtr)>;
  ...
  void RequestGlobalDumpForPid(base::ProcessId pid,
                               RequestGlobalDumpForPidCallback);
