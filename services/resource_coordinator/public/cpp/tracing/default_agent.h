...
#ifndef SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_TRACING_DEFAULT_AGENT_H_
#define SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_TRACING_DEFAULT_AGENT_H_
...
namespace tracing {
class SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_EXPORT DefaultAgent
    : public mojom::Agent {
 protected:
  DefaultAgent();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DefaultAgent);
};

}  // namespace tracing

#endif  // SERVICES_RESOURCE_COORDINATOR_PUBLIC_CPP_TRACING_DEFAULT_AGENT_H_
