...
void TabSignalGeneratorImpl::OnFramePropertyChanged(
  ...
  if (property_type == mojom::PropertyType::kLongTaskIdle ||
      property_type == mojom::PropertyType::kNetworkAlmostIdle) {
...
bool TabSignalGeneratorImpl::IsIdle(const FrameCoordinationUnitImpl* frame_cu) {
  ...
  return is_long_task_idle && is_network_almost_idle;
}
