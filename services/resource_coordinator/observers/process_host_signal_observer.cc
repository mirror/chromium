...
class ProcessHostSignalsUserData : public base::SupportsUserData::Data {
 public:
  explicit ProcessHostSignalsUserData(CoordinationUnitBase* coordination_unit,
  ...
  static ProcessHostSignalsUserData* Get(
    ...
    std::set<CoordinationUnitBase*> units =
 ...
 private:
  ...
  CoordinationUnitBase* coordination_unit_;
...
void ProcessHostSignalsObserver::AddProcessHostSignalObserver(
  ...
  CoordinationUnitBase* coordination_unit =
      CoordinationUnitBase::GetCoordinationUnit(id);
