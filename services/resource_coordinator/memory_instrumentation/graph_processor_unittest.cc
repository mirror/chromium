...
TEST_F(GraphProcessorTest, RemoveWeakNodesRecursivelyBetweenGraphs) {
  ...
  // Make only the child node weak.
  Node* parent = f_process->CreateNode(kEmptyGuid, "parent", false);
  Node* child = f_process->CreateNode(kEmptyGuid, "parent/c", true);
  f_process->CreateNode(kEmptyGuid, "parent/c/c", false);
  ...
  ASSERT_EQ(f_process->root()->children()->size(), 1ul);
...
TEST_F(GraphProcessorTest, AggregateNumericWithNameForNode) {
  ...
  Node* parent = process->CreateNode(kEmptyGuid, "parent", false);
  Node* c1 = process->CreateNode(kEmptyGuid, "parent/c1", false);
  Node* c2 = process->CreateNode(kEmptyGuid, "parent/c2", false);
  Node* c3 = process->CreateNode(kEmptyGuid, "parent/c3", false);
  ...
  Node::Entry entry = AggregateNumericWithNameForNode(parent, "random_numeric");
...
TEST_F(GraphProcessorTest, AggregateNumericsRecursively) {
  ...
  Node* c1 = process->CreateNode(kEmptyGuid, "parent/c1", false);
  Node* c2 = process->CreateNode(kEmptyGuid, "parent/c2", false);
  Node* c2_c1 = process->CreateNode(kEmptyGuid, "parent/c2/c1", false);
  Node* c2_c2 = process->CreateNode(kEmptyGuid, "parent/c2/c2", false);
  Node* c3_c1 = process->CreateNode(kEmptyGuid, "parent/c3/c1", false);
  Node* c3_c2 = process->CreateNode(kEmptyGuid, "parent/c3/c2", false);
