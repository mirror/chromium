...
mojom::ChromeMemDumpPtr CreateDumpSummary(
  ...
  result->number_of_documents =
      GetDumpsSum("blink_objects/Document", process_memory_dump);
  result->number_of_frames =
      GetDumpsSum("blink_objects/Frame", process_memory_dump);
  result->number_of_layout_objects =
      GetDumpsSum("blink_objects/LayoutObject", process_memory_dump);
  result->number_of_nodes =
      GetDumpsSum("blink_objects/Node", process_memory_dump);
  return result;
}
