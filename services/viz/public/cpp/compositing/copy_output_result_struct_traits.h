...
struct StructTraits<viz::mojom::CopyOutputResultDataView,
  ...
  static const SkBitmap& bitmap(
    ...
    if (result->format() != viz::CopyOutputResult::Format::RGBA_BITMAP)
      return SkBitmap();  // SkBitmap is a nullable mojo type.
  ...
  static base::Optional<gpu::Mailbox> mailbox(
    ...
    if (result->format() != viz::CopyOutputResult::Format::RGBA_TEXTURE)
      return base::nullopt;
    return result->GetTextureMailbox()->mailbox;
  }
  ...
  static base::Optional<gpu::SyncToken> sync_token(
    ...
    if (result->format() != viz::CopyOutputResult::Format::RGBA_TEXTURE)
      return base::nullopt;
    return result->GetTextureMailbox()->sync_token;
  }
  ...
  static base::Optional<gfx::ColorSpace> color_space(
    ...
    if (result->format() != viz::CopyOutputResult::Format::RGBA_TEXTURE)
      return base::nullopt;
    return result->GetTextureMailbox()->color_space;
  }
