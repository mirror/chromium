...
// process.  In order to capture any UKM data, the current process should
// have a UkmService object created and configured, so this is should
// currently only be called in the browser process.
