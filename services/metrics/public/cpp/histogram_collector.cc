...
HistogramCollector::MetricsServiceHistorgramProvider::
...
void HistogramCollector::MetricsServiceHistorgramProvider::RegisterAllocator(
    int id,
...
void HistogramCollector::MetricsServiceHistorgramProvider::DeregisterAllocator(
    int id) {
...
void HistogramCollector::MetricsServiceHistorgramProvider::
    MergeHistogramDeltasFromAllocator(
        int id,
