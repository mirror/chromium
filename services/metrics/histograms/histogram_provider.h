...
#ifndef SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_PROVIDER_H_
#define SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_PROVIDER_H_
...
#endif  // SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_PROVIDER_H_
