...
#ifndef SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_COLLECTOR_H_
#define SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_COLLECTOR_H_
...
class HistogramCollector : public mojom::HistogramCollector {
 ...
 private:
  ...
  MetricsServiceHistogramProvider histogram_provider_;
...
#endif  // SERVICES_METRICS_HISTOGRAMS_HISTOGRAM_COLLECTOR_H_
