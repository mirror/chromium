...
MetricsServiceHistogramProvider::MetricsServiceHistogramProvider()
...
void MetricsServiceHistogramProvider::RegisterAllocator(
    int id,
...
void MetricsServiceHistogramProvider::DeregisterAllocator(int id) {
...
void MetricsServiceHistogramProvider::MergeHistogramDeltasFromAllocator(
    int id,
...
void MetricsServiceHistogramProvider::MergeHistogramDeltas() {
