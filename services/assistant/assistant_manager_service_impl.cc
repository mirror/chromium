...
#include "services/assistant/assistant_manager_service_impl.h"
...
AssistantManagerServiceImpl::AssistantManagerServiceImpl(
    ...
    : auth_token_provider_(auth_token_provider),
      platform_api_(chromeos::assistant::kDefaultConfigStr),
      assistant_manager_(assistant_client::AssistantManager::Create(
          &platform_api_,
          chromeos::assistant::kDefaultConfigStr)),
...
void AssistantManagerServiceImpl::Start() {
  ...
  chromeos::assistant::SetAssistantOptions(internal_options);
