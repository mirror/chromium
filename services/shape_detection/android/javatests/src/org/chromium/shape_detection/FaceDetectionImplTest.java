...
public class FaceDetectionImplTest extends InstrumentationTestCase {
    ...
    public static final double BOX_ERR_THRESHOLD = 5.0;
    public static final double POS_ERR_THRESHOLD = 10.0;
    ...
    public void testDetectSucceedsOnValidImage() {
        ...
        assertEquals(40.0, results[0].boundingBox.width, BOX_ERR_THRESHOLD);
        assertEquals(40.0, results[0].boundingBox.height, BOX_ERR_THRESHOLD);
        assertEquals(24.0, results[0].boundingBox.x, POS_ERR_THRESHOLD);
        assertEquals(20.0, results[0].boundingBox.y, POS_ERR_THRESHOLD);
    }
}
