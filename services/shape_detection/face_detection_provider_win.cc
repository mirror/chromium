...
bool IsBitmapPixelFormatSupported(IFaceDetectorStatics* factory,
                                  BitmapPixelFormat* pixel_format) {
  static constexpr BitmapPixelFormat kFormats[] = {BitmapPixelFormat_Gray8,
...
void FaceDetectionProviderWin::CreateFaceDetection(
  ...
  BitmapPixelFormat pixel_format;
  if (!IsBitmapPixelFormatSupported(factory.Get(), &pixel_format))
    return;
