...
// TODO(junwei.fu): https://bugs.chromium.org/p/chromium/issues/detail?id=791371
// Consider moving the implementation of AsyncOperation to .cc file.
...
class AsyncOperation {
 ...
 private:
  ...
  Callback callback_;
  // TODO(junwei.fu):
  // https://bugs.chromium.org/p/chromium/issues/detail?id=790843 guarantee
  // |callback_| will be called instead of canceling the callback if this object
  // is freed.
