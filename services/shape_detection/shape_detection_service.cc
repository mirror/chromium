...
#elif defined(OS_WIN)
  registry_.AddInterface(base::BindOnce(&BarcodeDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&TextDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&FaceDetectionProviderWin::Create));
#elif defined(OS_MACOSX)
  registry_.AddInterface(base::BindOnce(&BarcodeDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&TextDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&FaceDetectionProviderMac::Create));
#else
  registry_.AddInterface(base::BindOnce(&BarcodeDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&TextDetectionImpl::Create));
  registry_.AddInterface(base::BindOnce(&FaceDetectionProviderImpl::Create));
#endif
}
