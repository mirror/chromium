...
// Makes the primary account available with the given values, resulting in the
// firing of the IdentityManager and SigninManager callbacks for signin success.
// Blocks until the primary account is available.  Note: Using this method
// directly is discouraged, but sometimes necessary during conversion. Use
// IdentityTestEnvironment if possible (and
...
// Clears the primary account, resulting in the firing of the IdentityManager
// and SigninManager callbacks for signout.  Blocks until the primary account is
// cleared. The caveats about direct usage given on
// MakePrimaryAccountAvailable() apply here as well.
