...
class PrimaryAccountTokenFetcherTest : public testing::Test {
 public:
  using TestTokenCallback =
      StrictMock<MockCallback<PrimaryAccountTokenFetcher::TokenCallback>>;

  PrimaryAccountTokenFetcherTest() : signin_client_(&pref_service_) {
  ...
  ~PrimaryAccountTokenFetcherTest() override {}

  std::unique_ptr<PrimaryAccountTokenFetcher> CreateFetcher(
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldReturnAccessToken) {
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldNotReplyIfDestroyed) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldNotReturnWhenSignedOut) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldWaitForSignIn) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldWaitForSignInInProgress) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldWaitForFailedSignIn) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldWaitForRefreshToken) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest,
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldRetryCanceledAccessTokenRequest) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountTokenFetcherTest, ShouldNotRetryFailedAccessTokenRequest) {
  TestTokenCallback callback;
