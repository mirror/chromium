...
class PrimaryAccountAccessTokenFetcherTest
 ...
 public:
  ...
  std::unique_ptr<PrimaryAccountAccessTokenFetcher> CreateFetcher(
      ...
      PrimaryAccountAccessTokenFetcher::Mode type) {
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, OneShotShouldReturnAccessToken) {
  ...
  auto fetcher = CreateFetcher(
      callback.Get(), PrimaryAccountAccessTokenFetcher::Mode::kOneShot);
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, OneShotCallsBackWhenSignedOut) {
  ...
  auto fetcher = CreateFetcher(
      base::BindOnce(&OnAccessTokenFetchComplete, run_loop.QuitClosure(),
                     ...
                     ""),
      PrimaryAccountAccessTokenFetcher::Mode::kOneShot);
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, WaitForSignIn) {
  base::RunLoop run_loop;
  set_on_access_token_request_callback(run_loop.QuitClosure());
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, WaitForSignInInProgress) {
  base::RunLoop run_loop;
  set_on_access_token_request_callback(run_loop.QuitClosure());
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, WaitForFailedSignIn) {
  TestTokenCallback callback;
...
TEST_F(PrimaryAccountAccessTokenFetcherTest, WaitForRefreshToken) {
  base::RunLoop run_loop;
  set_on_access_token_request_callback(run_loop.QuitClosure());
