...
#endif
{
  ...
  signin_manager_.SetAuthenticatedAccountInfo(kDefaultGaiaId, kDefaultEmail);
  token_service_.UpdateCredentials(signin_manager_.GetAuthenticatedAccountId(),
                                   kDefaultRefreshToken);
