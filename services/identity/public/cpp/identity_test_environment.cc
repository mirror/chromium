...
// TODO(blundell): How should I generalize this? On CrOS, the primary account
// is going to need to be set. Should I just have it always set?
#if defined(OS_CHROMEOS)
  signin_manager_.SignIn(kAccountId);
#else
  // TODO(blundell): What should I do about gaia/password values here?
  signin_manager_.SignIn(kAccountId, kAccountId, "password");
#endif
...
void IdentityTestEnvironment::AutomaticallyGrantAccessTokenRequests(
    bool grant) {
...
void IdentityTestEnvironment::IssueErrorForAllPendingAccessTokenRequests(
