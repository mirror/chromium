...
#ifndef SERVICES_IDENTITY_PUBLIC_CPP_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
#define SERVICES_IDENTITY_PUBLIC_CPP_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
...
#endif  // SERVICES_IDENTITY_PUBLIC_CPP_PRIMARY_ACCOUNT_TOKEN_FETCHER_H_
