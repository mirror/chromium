...
class PDFEngine {
 public:
  ...
  virtual void SetSelectionLeftCoordinates(const pp::Point& point) = 0;
  virtual void SetSelectionRightCoordinates(const pp::Point& point) = 0;
  virtual void SetSelectionCoordinates(const pp::Point& left,
                                       const pp::Point& right) = 0;
};
