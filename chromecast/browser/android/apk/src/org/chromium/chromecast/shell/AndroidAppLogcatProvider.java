 ...
 */
class AndroidAppLogcatProvider implements LogcatProvider{
    private static final String TAG = "LogcatProvider";
    private static final long HALF_SECOND = 500;

    @Override
    public void getLogcat(LogcatCallback callback) throws IOException, InterruptedException {
        ...
        try {
            ...
            String elidedLogcat = LogcatProvider.elideLogcat(rawLogcat);
            Log.i(TAG, "Got logs of length: " + elidedLogcat.length());

            callback.onLogsDone(elidedLogcat);
