...
public final class CastCrashUploaderFactory {
  ...
  public static CastCrashUploader createCastCrashUploader(String crashDumpPath, boolean uploadCrashToStaging) {
  	if (mExecutorService == null) {
      mExecutorService = Executors.newScheduledThreadPool(1);
    }
    return new CastCrashUploader(mExecutorService, crashDumpPath, uploadCrashToStaging);
  }
}
