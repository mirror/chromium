...
public class LogcatExtractorUnitTest {
    ...
    @Test
    public void testLogTagNotElided2() {
        String original =
                "09-08 11:52:12.569  4406  4406 I chromium: Cast.Discovery.Mdns.Request.AppId.In=25";
        assertEquals(original, LogcatExtractor.elideUrl(original));
    }

    @Test
    public void testLogTagNotElided3() {
        String original =
                "09-08 11:54:38.053  4406  4406 D cr_AvSettingsAndroid: [AvSettingsAndroid.java:180] HDMI plug update: action=android.media.action.HDMI_AUDIO_PLUG, plug=1";
        assertEquals(original, LogcatExtractor.elideUrl(original));
    }

    @Test
    public void testLogTagNotElided4() {
        String original =
                "09-08 11:54:38.053  4406  4406 D cr_AvSettingsAndroid: [AvSettingsAndroid.java:187] Max channel count = 8";
        assertEquals(original, LogcatExtractor.elideUrl(original));
    }
}