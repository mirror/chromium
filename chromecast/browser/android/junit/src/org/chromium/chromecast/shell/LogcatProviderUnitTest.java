...
public class LogcatProviderUnitTest {
    @Test
    public void testEmptyLogcat() {
        List<String> lines = new ArrayList<String>();
        assertEquals("", LogcatProvider.elideLogcat(lines));
    }

    @Test
    public void testLogcatOfEmptyString() {
        List<String> lines = Arrays.asList("");
        assertEquals("\n", LogcatProvider.elideLogcat(lines));
    }
    ...
    public void testElidesPii() {
        ...
        String elided = LogcatProvider.elideLogcat(lines);
