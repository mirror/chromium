...
#ifndef CHROMECAST_BROWSER_CAST_CONTENT_MANAGER_H_
#define CHROMECAST_BROWSER_CAST_CONTENT_MANAGER_H_
...
class CastWebContentsManager {
 ...
 private:
  ...
  std::list<std::unique_ptr<content::WebContents>> expiring_web_contents_;
...
#endif  // CHROMECAST_BROWSER_CAST_CONTENT_MANAGER_H_
