...
#ifndef CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_HOST_DELEGATE_H_
#define CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_HOST_DELEGATE_H_
...
#endif  // CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_HOST_DELEGATE_H_
