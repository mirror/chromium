...
#ifndef CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_SYSTEM_H_
#define CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_SYSTEM_H_
...
#endif  // CHROMECAST_BROWSER_EXTENSIONS_SHELL_EXTENSION_SYSTEM_H_
