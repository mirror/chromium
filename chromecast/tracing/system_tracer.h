...
class SystemTracer : public base::MessagePumpLibevent::Watcher {
 public:
  SystemTracer();
  ~SystemTracer() override;
  ...
  // Stop system tracing.
  //
  // This will call |callback| on the current thread with the trace data.
  // |status| is Status::KEEP_GOING, another call will be made with
  // additional data.
 ...
 private:
  ...
  base::MessagePumpLibevent::FileDescriptorWatcher trace_pipe_watcher_;
