...
#ifndef CHROMECAST_COMMON_SHELL_EXTENSIONS_CLIENT_H_
#define CHROMECAST_COMMON_SHELL_EXTENSIONS_CLIENT_H_
...
#endif  // CHROMECAST_COMMON_SHELL_EXTENSIONS_CLIENT_H_
