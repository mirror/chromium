...
public class StateMachineTest {
    ...
    public void testNoStateTransitionAfterRegisteringWithInactiveController() {
        ...
        State.of(controller, report(result, "a"));
    ...
    public void testStateObservingState() {
        ...
        Controller<String> controller = new Controller<>();
        List<String> result = new ArrayList<>();
        State<String> state = State.of(controller, report(result, "a"));
        State<String> metastate = State.of(state, report(result, "b"));
    ...
    public void testMultipleStatesObservingSingleController() {
        ...
        Controller<String> controller = new Controller<>();
        List<String> result = new ArrayList<>();
        State<String> a = State.of(controller, report(result, "a"));
        State<String> b = State.of(controller, report(result, "b"));
        // Activate the controller, which should propagate a state transition to both states.
        // Both states should be updated, so we should get two enter events.
        controller.set("neat");
        controller.reset();
    ...
    public void testClosedStateNoLongerReceivesUpdates() {
        Controller<String> controller = new Controller<>();
        List<String> result = new ArrayList<>();
        State.of(controller, report(result, "a")).close();
    ...
    public void testClosedStateDoesNotNotifyObservers() {
        Controller<String> controller = new Controller<>();
        List<String> result = new ArrayList<>();
        State<String> closed = State.of(controller, report(result, "closed"));
        State<String> watchClosed = State.of(closed, report(result, "unexpected"));
        closed.close();
    ...
    public void testCloseStateWhileActivatedImplicitlyDeactivatesState() {
        Controller<String> controller = new Controller<>();
        List<String> result = new ArrayList<>();
        State<String> state = State.of(controller, report(result, "state"));
        controller.set("boom");
        state.close();
    ...
    public void testCloseControllerImplicitlyDeactivatesListeningStates() {
        ...
        List<String> result = new ArrayList<>();
        State.of(controller, report(result, "a"));
        State.of(controller, report(result, "b"));
        controller.set("yes");
        controller.close();
    ...
    public void testBothState_activateFirstDoesNotTrigger() {
        ...
        List<String> result = new ArrayList<>();
        State.ofBoth(a, b, report(result, "both"));
        a.set("A");
        assertThat(result, emptyIterable());
    }
    ...
    public void testEitherState_isNotActivatedRightAway() {
        ...
        Controller<String> b = new Controller<>();
        List<String> result = new ArrayList<>();
        State.ofEither(a, b, report(result, "either"));
        assertThat(result, emptyIterable());
    }
    ...
    public void testComposeBoth() {
        ...
        List<String> result = new ArrayList<>();
        State.of(State.ofBoth(a, State.ofBoth(b, State.ofBoth(c, d))), report(result, "all four"));
        a.set("A");
        b.set("B");
        c.set("C");
        d.set("D");
    ...
    public void testPowerUnlimitedPower() {
        ...
        Controller<String> d = new Controller<>();
        List<String> result = new ArrayList<>();
        State.of(State.ofEither(State.ofBoth(a, b), State.ofBoth(c, d)), report(result, "pair"));
        a.set("a");
        b.set("b");
        c.set("c");
        d.set("d");
