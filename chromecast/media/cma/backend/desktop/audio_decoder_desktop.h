...
#ifndef CHROMECAST_MEDIA_CMA_BACKEND_AUDIO_DECODER_DESKTOP_H_
#define CHROMECAST_MEDIA_CMA_BACKEND_AUDIO_DECODER_DESKTOP_H_
...
#endif  // CHROMECAST_MEDIA_CMA_BACKEND_AUDIO_DECODER_DESKTOP_H_
