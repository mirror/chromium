...
package com.google.cast.cma.backend.android;
...
class AudioSinkAudioTrackImpl {
    ...
    private static AudioSinkAudioTrackImpl createAudioSinkAudioTrackImpl(
            Context context, long nativeAudioSinkAudioTrackImpl) {
        Log.i(TAG, "Creating new AudioSinkAudioTrackImpl instance");
        return new AudioSinkAudioTrackImpl(context, nativeAudioSinkAudioTrackImpl);
    }

    private AudioSinkAudioTrackImpl(Context context, long nativeAudioSinkAudioTrackImpl) {
