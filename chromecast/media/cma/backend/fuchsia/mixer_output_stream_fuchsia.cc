...
bool MixerOutputStreamFuchsia::Start(int requested_sample_rate, int channels) {
  ...
  // Current implementation of media_client ignores this parameter. StreamMixer
  // by default writes chunks of 768 frames.
  fuchsia_params.buffer_size = 768;
...
bool MixerOutputStreamFuchsia::UpdatePresentatioDelay() {
