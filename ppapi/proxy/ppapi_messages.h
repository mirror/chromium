...
IPC_ENUM_TRAITS_MAX_VALUE(PP_FlashSetting, PP_FLASHSETTING_LAST)
...
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_InputEvent_MouseButton, -1,
                          PP_INPUTEVENT_MOUSEBUTTON_LAST)
IPC_ENUM_TRAITS_MAX_VALUE(PP_InputEvent_Type, PP_INPUTEVENT_TYPE_LAST)
...
IPC_ENUM_TRAITS_MAX_VALUE(PP_PrintOutputFormat_Dev, PP_PRINTOUTPUTFORMAT_LAST)
...
IPC_ENUM_TRAITS_MAX_VALUE(PP_TrueTypeFontWeight_Dev, PP_TRUETYPEFONTWEIGHT_LAST)
...
IPC_ENUM_TRAITS_MIN_MAX_VALUE(PP_VideoDecodeError_Dev, 1, PP_VIDEODECODERERROR_LAST)
IPC_ENUM_TRAITS_MAX_VALUE(PP_VideoDecoder_Profile, PP_VIDEODECODER_PROFILE_LAST)
