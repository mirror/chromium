...
class MojoDecryptor : public Decryptor {
 ...
 private:
  ...
  using DecryptOnceCB =
      base::OnceCallback<void(Status, const scoped_refptr<DecoderBuffer>&)>;
  using DecoderInitOnceCB = base::OnceCallback<void(bool)>;
  using AudioDecodeOnceCB =
      base::OnceCallback<void(Status, const AudioFrames&)>;
  using VideoDecodeOnceCB =
      base::OnceCallback<void(Status, const scoped_refptr<VideoFrame>&)>;
