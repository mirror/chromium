...
class MojoVideoFrameHandleReleaser
 ...
 public:
  ...
  MojoVideoFrameHandleReleaser(
      mojom::VideoFrameHandleReleaserAssociatedPtrInfo
    ...
    video_frame_handle_releaser_ =
        mojom::ThreadSafeVideoFrameHandleReleaserAssociatedPtr::Create(
  ...
  VideoFrame::ReleaseMailboxCB CreateReleaseMailboxCB(
    ...
    return base::Bind(&MojoVideoFrameHandleReleaser::ReleaseVideoFrame, this,
                      release_token);
  }
 ...
 private:
  ...
  scoped_refptr<mojom::ThreadSafeVideoFrameHandleReleaserAssociatedPtr>
      video_frame_handle_releaser_;
