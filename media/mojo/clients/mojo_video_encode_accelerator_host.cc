...
void MojoVideoEncodeAcceleratorHost::Encode(
  ...
  // This takes ownership of the |frame|'s internal base::SharedMemory
  mojo::ScopedSharedBufferHandle handle = mojo::WrapSharedMemoryHandle(
      frame->shared_memory_handle(), allocation_size, false /* read_only */);
  ...
  vea_->Encode(0, mojo_frame, force_keyframe);
}
