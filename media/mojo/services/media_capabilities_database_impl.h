...
class MEDIA_MOJO_EXPORT MediaCapabilitiesDatabaseImpl
 ...
 public:
  ...
  void AppendInfoToEntry(const Entry& entry,
                         const Info& info,
                         AppendInfoToEntryCB callback) override;
 ...
 private:
  ...
  void ReadDatabaseAndUpdateWithInfo(const Entry& entry,
                                     const Info& info,
                                     AppendInfoToEntryCB callback);
  ...
  void UpdateDatabase(const std::string& serialized_entry,
                      std::unique_ptr<CapabilitiesInfo> capabilities_info_proto,
                      AppendInfoToEntryCB callback);
  ...
  // state.
  void OnDatabaseUpdated(AppendInfoToEntryCB callback, bool success);
