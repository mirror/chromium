...
class MojoVideoEncodeAccelerator : public mojom::VideoEncodeAccelerator,
 ...
 public:
  ...
  void OverrideCreateVideoEncodeAcceleratorCallbackForTesting(
      const CreateVideoEncodeAcceleratorCallback& function) {
    create_vea_function_ = function;
  }

 private:
  friend class MojoVideoEncodeAcceleratorTest;
  CreateVideoEncodeAcceleratorCallback create_vea_function_;
