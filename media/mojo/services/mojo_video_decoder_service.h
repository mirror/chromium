...
class MEDIA_MOJO_EXPORT MojoVideoDecoderService final
 ...
 private:
  ...
  // Holds VideoFrame references on behalf of the client. Owned by |this| until
  // |this| is destructed, at which point we call Destroy() to pass ownership
  // to the VideoFrameHandleReleaserImpl (it continues to live as long as there
  // are outstanding VideoFrames).
