...
class MIDI_EXPORT MidiManagerMac final : public MidiManager {
 ...
 private:
  ...
  // Following members except for |midi_client_| can be accessed without taking
  // any lock on kClientTaskRunner, or on I/O thread before calling
  // BindInstance() or after calling UnbindInstance().
