...
// Do not destruct MidiManager on macOS to avoid a Core MIDI issue that it
// start failing on MIDIClientCreate with the OSStatus -50 after repeated
// calls of MIDIClientDispose. It rarely happens, but once it starts, it never
