...
cdm::Status FFmpegCdmVideoDecoder::DecodeFrame(
  ...
  // more frames.
  return did_decode_frame ? cdm::kSuccess : cdm::kNeedMoreData;
}

bool FFmpegCdmVideoDecoder::OnNewFrame(bool* did_decode_frame,
                                       cdm::VideoFrame* decoded_frame,
                                       AVFrame* frame) {
