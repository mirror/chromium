...
class MEDIA_EXPORT CdmHostFiles {
 public:
  ...
  enum class Status {
    ...
    kStatusMax = kInitVerificationFailed
  };
 ...
 private:
  ...
  // |cdm_adapter_path|.
  void OpenCdmFilesWithAdapter(const base::FilePath& cdm_adapter_path);

  // Opens CDM specific files for the CDM at |cdm_path|.
  void OpenCdmFiles(const base::FilePath& cdm_path);
