...
// libyuv doesn't support 9- nor 12-bit video frames yet. This function creates
// a regular 8-bit video frame which we can give to libyuv.
...
void PaintCanvasVideoRenderer::ConvertVideoFrameToRGBPixels(
  ...
  DVLOG(1) << __func__ << " bit depth: " << video_frame->bit_depth();
