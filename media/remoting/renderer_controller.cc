...
// The maximum ratio of the transmission capacity that can be used by Media
// Remoting to deliver the media contents.
...
void RendererController::OnDelayedStartTimerFired(
  ...
  double kilobits_per_second =
      (client_->VideoDecodedByteCount() + client_->AudioDecodedByteCount() -
