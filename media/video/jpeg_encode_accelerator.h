 ...
 public:
  ...
  class MEDIA_EXPORT Client {
   public:
    ...
    // Parameters:
    //  |bitstream_buffer| is the output buffer that contains encoded image. It
    //  is the same buffer provided through Encode() call.
    //  |encoded_picture_size| is the actual size of encoded JPEG image in
    //  the BitstreamBuffer provided through encode().
    virtual void VideoFrameReady(BitstreamBuffer* bitstream_buffer,
    ...
    //  |video_frame_id| is the |unique_id_| of the input VideoFrame that
