...
class MEDIA_EXPORT JpegEncodeAccelerator {
 public:
  ...
  //  |error| will be filled with the error that causes Initialize() failed.
  //  If it succeeds, the value |error| pointing to will not be changed.
  // Returns false if JPEG encode is not supported by the underlying hardware,
  // or some errors occur during initialization.
  virtual bool Initialize(Client* client, Error* error) = 0;
