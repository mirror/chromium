...
#ifndef MEDIA_BASE_CDM_PLATFORM_VERIFICATION_H_
#define MEDIA_BASE_CDM_PLATFORM_VERIFICATION_H_
...
class MEDIA_EXPORT CdmPlatformVerification {
 public:
  CdmPlatformVerification() = default;
  virtual ~CdmPlatformVerification();
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(CdmPlatformVerification);
};

}  // namespace media

#endif  // MEDIA_BASE_CDM_PLATFORM_VERIFICATION_H_
