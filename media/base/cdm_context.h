...
class MEDIA_EXPORT CdmContext {
 public:
  ...
  // TODO(rkuroiwa): Finalize this method.
  // TODO(xhwang): Put this in a conditional build flag.
  virtual bool GetDecryptContext();
...
// |this| is alive. Typically |this| will holds a reference (directly or
// indirectly) to the host, e.g. a ContentDecryptionModule or a CdmProxy.
// This class must be held on the same thread where the host the lives. The raw
