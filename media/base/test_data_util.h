...
// Common test results.
MEDIA_EXPORT extern const char kFailed[];
MEDIA_EXPORT extern const char kEnded[];
MEDIA_EXPORT extern const char kErrorEvent[];
MEDIA_EXPORT extern const char kError[];
