...
class SequencedWeakPtr : public InternalWeakRefHolder,
 ...
 public:
  ...
  // TODO(liberato): allow casts.
  explicit SequencedWeakPtr(const SequencedScopedRefPtr<T>& thiz) :
  SequencedWeakPtr(thiz.GetInternalWeakRef()) {}
  */
  ...
  // TODO(liberato): enforce that these are derived classes.
  template <typename U>
