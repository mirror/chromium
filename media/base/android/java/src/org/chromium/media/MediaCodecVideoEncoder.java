 ...
 */
@JNINamespace("media")
class MediaCodecVideoEncoder extends MediaCodecBridge {
    ...
    private MediaCodecVideoEncoder(MediaCodec mediaCodec, String mime,
    ...
    @CalledByNative
    public static MediaCodecVideoEncoder create(String mime) {
