...
// static
void AudioDeviceInfoHelper::GetInputStreamParameters(
...
// static
void AudioDeviceInfoHelper::GetOutputStreamParameters(
    AudioManager* audio_manager,
    const std::string& device_id,
    OnAudioParamsCallback on_params_cb) {
  DCHECK(audio_manager);
...
// static
void AudioDeviceInfoHelper::HasInputDevices(AudioManager* audio_manager,
...
// static
void AudioDeviceInfoHelper::HasOutputDevices(AudioManager* audio_manager,
                                             OnBoolCallback on_has_devices_cb) {
  DCHECK(audio_manager);
  DCHECK(audio_manager->GetTaskRunner()->BelongsToCurrentThread());
...
// static
void AudioDeviceInfoHelper::GetDeviceDescriptions(
    AudioManager* audio_manager,
    bool for_input,
...
// static
void AudioDeviceInfoHelper::GetAssociatedOutputDeviceID(
    AudioManager* audio_manager,
...
// static
void AudioDeviceInfoHelper::GetInputDeviceInfo(
    AudioManager* audio_manager,
    const std::string& input_device_id,
...
// static
AudioParameters AudioDeviceInfoHelper::ComputeInputParameters(
    AudioManager* audio_manager,
    const std::string& device_id) {
  DCHECK(audio_manager);
  DCHECK(audio_manager->GetTaskRunner()->BelongsToCurrentThread());
...
// static
AudioParameters AudioDeviceInfoHelper::ComputeOutputParameters(
    AudioManager* audio_manager,
    const std::string& device_id) {
  DCHECK(audio_manager);
  DCHECK(audio_manager->GetTaskRunner()->BelongsToCurrentThread());
