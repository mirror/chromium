...
enum OpenStreamResult {
  ...
  OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_FAKE_FAIL = 4,
  OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_FAKE_SUCCESS = 5,
  OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_LINEAR_FAIL = 6,
  OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_LINEAR_SUCCESS = 7,
...
OpenStreamResult GetSubsequentStreamCreationResultBucket(
  ...
  switch (current_params.format()) {
    ...
    case AudioParameters::AUDIO_PCM_LINEAR:
      return success ? OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_LINEAR_SUCCESS
                     : OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_LINEAR_FAIL;
    case AudioParameters::AUDIO_FAKE:
      return success ? OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_FAKE_SUCCESS
                     : OPEN_STREAM_SUBSEQUENT_FALLBAK_TO_FAKE_FAIL;
    default:
      NOTREACHED();
    ...
    if (original_output_params_.format() ==
      ...
      if (first_stream) {
        ...
        UMA_HISTOGRAM_ENUMERATION(
            ...
            OPEN_STREAM_SUCCESS, OPEN_STREAM_MAX + 1);
      } else {
        UMA_HISTOGRAM_ENUMERATION(
            "Media.AudioOutputResampler.OpenLowLatencyStream",
