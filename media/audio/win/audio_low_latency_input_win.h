...
class MEDIA_EXPORT WASAPIAudioInputStream
 ...
 private:
  ...
  // Returns true if successful and false otherwise. Writes the result of the
  // failing system call to |*hr|, or S_OK if successful. If this function fails
  // with |*hr| == S_FALSE, the OS supports a closest match but we don't support
  // conversion to it.
