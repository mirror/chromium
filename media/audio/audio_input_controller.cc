...
void AudioInputController::DoClose() {
  ...
  const char* log_string_prefix = "AIC::DoClose:";
  ...
  if (audio_callback_) {
    ...
    log_string = base::StringPrintf(
        "%s stream duration=%" PRId64 " seconds%s", log_string_prefix,
        duration.InSeconds(),
    ...
    log_string =
        base::StringPrintf("%s recording never started", log_string_prefix);
  }
