...
AudioDebugRecordingManager* AudioManagerBase::GetDebugRecordingManager() {
  DCHECK(GetTaskRunner()->BelongsToCurrentThread());
  DCHECK(debug_recording_manager_) << "InitializeDebugRecording() must be "
                                      "called before getting debug recording "
                                      "manager";
