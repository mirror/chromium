...
class AudioDebugFileWriterTest
 ...
 public:
  AudioDebugFileWriterTest(bool single_thread)
  ...
  AudioDebugFileWriterTest() : AudioDebugFileWriterTest(false) {}
...
class AudioDebugFileWriterSingleThreadTest : public AudioDebugFileWriterTest {
 public:
  AudioDebugFileWriterSingleThreadTest() : AudioDebugFileWriterTest(true) {}
};
