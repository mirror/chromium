...
class MEDIA_EXPORT AudioManager {
 public:
  ...
  // Get debug recording manager. InitializeDebugRecording() must be called
  // before this function.
  virtual AudioDebugRecordingManager* GetDebugRecordingManager() = 0;
 ...
 protected:
  ...
  // Initializes debug recording. Can be called on any thread; will post
