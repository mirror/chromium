...
#ifndef MEDIA_AUDIO_AUDIO_DEVICE_INFO_HELPER_H_
#define MEDIA_AUDIO_AUDIO_DEVICE_INFO_HELPER_H_
...
class MEDIA_EXPORT AudioDeviceInfoHelper {
 private:
...
#endif  // MEDIA_AUDIO_AUDIO_DEVICE_INFO_HELPER_H_
