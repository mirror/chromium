...
// TODO move callback in mojo client
// Callback for creating file with |file_name|, posted on a background
// task_runner
/*
base::File CreateFileOnBackgroudThread(const base::FilePath& file_name) {
