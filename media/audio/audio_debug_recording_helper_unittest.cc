...
// The input/output and id file name extensions.
const base::FilePath::CharType kFileNameExtensions[] =
...
void CreateFile(const base::FilePath& extensions,
  ...
  base::FilePath file_path = base_file_path.AddExtension(extensions.value());
...
class AudioDebugRecordingHelperTest : public ::testing::Test {
 public:
  AudioDebugRecordingHelperTest()
      : file_name_extensions_(
            base::FilePath(kFileNameExtensions).AddExtension(kFileExtension)) {}
 ...
 protected:
  base::FilePath file_name_extensions_;
...
TEST_F(AudioDebugRecordingHelperTest, EnableDisable) {
  ...
  recording_helper->EnableDebugRecording(file_name_extensions_,
