...
// Function bound and passed to AudioDebugRecordingHelper::EnableDebugRecording.
...
// used (MockAudioDebugFileWriter::Start is mocked), so the file can be removed
// right away because the call to MockAudioDebugFileWriter::Start is
// synchronous.
