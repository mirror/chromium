...
class MEDIA_EXPORT AliveChecker {
 public:
  // Factory method to create a PowerObserverHelper that can be injected. Can be
  // used by tests to provide a mock.
  ...
  AliveChecker(
      ...
      CreatePowerObserverHelperCallback create_power_observer_callback);
