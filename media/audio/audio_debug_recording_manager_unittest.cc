...
// as AudioDebugRecordingManager::CreateFileRepeatingCallback.
...
class MockAudioDebugRecordingHelper : public AudioDebugRecordingHelper {
 public:
  ...
  void EnableDebugRecording(
      ...
      AudioDebugRecordingHelper::CreateFileOnceCallback create_file_callback) {
...
// Shouldn't do anything but store the CreateFileRepeatingCallback, i.e. no
// calls to recorders.
