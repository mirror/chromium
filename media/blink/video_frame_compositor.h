...
class MEDIA_BLINK_EXPORT VideoFrameCompositor : public VideoRendererSink,
 ...
 public:
  ...
  scoped_refptr<VideoFrame> GetCurrentFrame_Locked();
  ...
  // If no |client_| and |callback_| is set, and |is_background_rendering_| is
  // true, it requests a new frame from |callback_|, using the elapsed time
