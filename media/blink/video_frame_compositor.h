...
class MEDIA_BLINK_EXPORT VideoFrameCompositor : public VideoRendererSink,
 ...
 public:
  ...
  // Provide a callback that we'll call the first time any frame is consumed
  // (probably, drawn) after the callback is set.
  void SetFirstFrameConsumedCallback(base::OnceClosure first_frame_consumed_cb);
 ...
 private:
  ...
  base::OnceClosure first_frame_consumed_cb_;
