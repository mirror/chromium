...
class WebMediaPlayerDelegate {
 public:
  ...
  virtual void PictureInPicture(int delegate_id, viz::FrameSinkId frame_sink_id,
                                const gfx::Size& size) = 0;

  virtual void PictureInPictureSurfaceIdUpdated(int delegate_id, viz::FrameSinkId frame_sink_id,
                                                uint32_t parent_id,
