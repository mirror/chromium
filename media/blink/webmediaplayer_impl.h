...
class MEDIA_BLINK_EXPORT WebMediaPlayerImpl
 ...
 private:
  ...
  std::unique_ptr<blink::WebVideoFrameSubmitter> submitter_; // Deleted on |vfc_task_runner_|.
  base::Callback<blink::WebVideoFrameSubmitter*(
      cc::VideoFrameProvider*, const viz::FrameSinkId&)> submitter_creation_callback_;
