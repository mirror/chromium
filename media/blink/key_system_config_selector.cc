...
// The rejection message when the key system is not supported and when none of
// the requested configurations is supported should be the same to help avoid
// leaking information unnecessarily. See https://crbug.com/760720 for details.
