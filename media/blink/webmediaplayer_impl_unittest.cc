...
mojom::MediaCapabilitiesRecorderPtr CreateCapabilitiesRecorder() {
  mojom::MediaCapabilitiesRecorderPtr recorder;
  MediaCapabilitiesRecorder::Create(mojo::MakeRequest(&recorder));
  return recorder;
}
