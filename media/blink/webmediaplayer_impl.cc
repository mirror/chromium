...
blink::WebLocalizedString::Name GetWebLocalizedStringName(
  ...
  switch (reason) {
    ...
    case MediaObserverClient::ReasonToSwitchToLocal::ERROR:
...
void WebMediaPlayerImpl::SwitchToLocalRenderer(
  ...
  ScheduleRestart();
  if (client_)
    client_->MediaRemotingStopped(GetWebLocalizedStringName(reason));
}
