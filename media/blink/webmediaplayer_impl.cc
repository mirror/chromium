...
WebMediaPlayerImpl::WebMediaPlayerImpl(
  ...
  if (defer_load_cb_.is_null()) {
    defer_load_cb_ = base::BindRepeating(
...
void WebMediaPlayerImpl::Load(LoadType load_type,
  ...
  main_task_runner_->PostTask(
      FROM_HERE, base::BindOnce(defer_load_cb_,
                                base::BindRepeating(&WebMediaPlayerImpl::DoLoad,
                                                    AsWeakPtr(), load_type, url,
                                                    cors_mode)));
}
...
void WebMediaPlayerImpl::DoLoad(LoadType load_type,
  ...
  ResourceSchedulerMetrics::GetInstance()->OnPlayerLoadStarted(this, client_);
