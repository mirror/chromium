...
void WebMediaPlayerImpl::PictureInPicture() {
  ...
  // TRIGGER PIP
  // delegate_->PictureInPicture(frame_sink_id_);
  delegate_->PictureInPictureSurfaceIdUpdated(frame_sink_id_,
                                              parent_id_, nonce_, pipeline_metadata_.natural_size);
