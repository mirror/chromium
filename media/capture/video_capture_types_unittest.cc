...
TEST(VideoCaptureTypesTest, SuggestsConstraints) {
  ...
  // For empty/invalid VideoCaptureParams, just return a default suggestion of
  // fixed 640x360 size.
  ASSERT_EQ(gfx::Size(), params.requested_format.frame_size);
  ExpectEqualConstraints(
      SuggestedConstraints({gfx::Size(640, 360), gfx::Size(640, 360), false}),
