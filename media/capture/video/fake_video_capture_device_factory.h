...
class CAPTURE_EXPORT FakeVideoCaptureDeviceFactory
 ...
 public:
  static constexpr char kDeviceConfigForGetPhotoCapabilitiesFails[] =
      "GetPhotoCapabilitiesFails";
  static constexpr char kDeviceConfigForSetPhotoOptionsFails[] =
      "SetPhotoOptionsFails";
  static constexpr char kDeviceConfigForTakePhotoFails[] = "TakePhotoFails";
