...
void VideoCaptureDeviceClient::OnIncomingCapturedData(
  ...
  uint8_t *y_plane_data = buffer_access->data(VideoFrame::kYPlane, dimensions),
          *u_plane_data = buffer_access->data(VideoFrame::kUPlane, dimensions),
          *v_plane_data = buffer_access->data(VideoFrame::kVPlane, dimensions);
