...
using JpegDecodeAcceleratorMojoFactoryCB =
    base::Callback<void(media::mojom::JpegDecodeAcceleratorRequest)>;
...
class CAPTURE_EXPORT VideoCaptureDeviceFactory {
 public:
  static std::unique_ptr<VideoCaptureDeviceFactory> CreateFactory(
      ...
      JpegDecodeAcceleratorMojoFactoryCB jpeg_decoder_factory);
