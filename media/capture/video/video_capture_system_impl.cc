...
// by with, and then by _largest_ frame_rate. Used to order a
// VideoCaptureFormats vector so that
// the first entry for a given resolution has the largest frame rate.
