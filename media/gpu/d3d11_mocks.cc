...
void InstantiateMocks() {
  D3D11Texture2DMock texture_mock;
  D3D11DeviceMock device_mock;
  D3D11VideoDeviceMock video_device_mock;
  D3D11VideoContextMock video_context_mock;
  D3D11VideoContext1Mock video_context1_mock;
  D3D11VideoDecoderMock video_decoder_mock;
  D3D11CryptoSessionMock crypto_session_mock;
  D3D11DeviceContextMock device_context_mock;
}
}  // namespace media