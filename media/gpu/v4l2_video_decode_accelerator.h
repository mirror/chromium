...
class MEDIA_GPU_EXPORT V4L2VideoDecodeAccelerator
 ...
 private:
  ...
  // and it is an initial resolution change.
  bool StartInitialResolutionChange();
  ...
  // True if an initial resolution change is done.
  // This can be set false again if Reset() is called.
