...
std::unique_ptr<MediaCodecBridge> CreateMediaCodecInternal(
  ...
  // TODO(xhwang): Rename |is_secure| to |requires_secure_codec| in MediaCodec
  // classes. Also, |requires_secure_codec| and |require_software_codec|
  // contradicts each other. We should clarify and fix this.
