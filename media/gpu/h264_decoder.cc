...
H264Decoder::MetadataResult H264Decoder::StartNewFrame(
    const H264SliceHeader* slice_hdr) {
      ...
      case H264NALU::kIDRSlice: {
        ...
        if (!curr_pic_) {
          ...
          switch (StartNewFrame(curr_slice_hdr_.get())) {
            case MetadataResult::kOk:
              break;
            case MetadataResult::kTryAgain:
