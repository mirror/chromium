...
class GpuVideoDecodeAccelerator
 ...
 public:
  ...
  // done. filter_ is passed to gpu::GLES2CommandBufferStub channel only if the
 ...
 private:
  ...
  // Unowned pointer to the underlying gpu::GLES2CommandBufferStub.  |this| is
  // registered as a DestuctionObserver of |stub_| and will self-delete when
  // |stub_| is destroyed.
  gpu::GLES2CommandBufferStub* const stub_;
