...
class GpuVideoDecodeAccelerator
 ...
 public:
  ...
  // done. filter_ is passed to gpu::CommandBufferStubCommon channel only if the
 ...
 private:
  ...
  // Unowned pointer to the underlying gpu::CommandBufferStubCommon.  |this| is
  // registered as a DestuctionObserver of |stub_| and will self-delete when
  // |stub_| is destroyed.
  gpu::CommandBufferStubCommon* const stub_;
