...
// static
void GpuJpegDecodeAcceleratorMojo::Create(
    mojom::GpuJpegDecodeAcceleratorRequest request) {
  auto* jpeg_decoder = new GpuJpegDecodeAcceleratorMojo();
  mojo::MakeStrongBinding(base::WrapUnique(jpeg_decoder), std::move(request));
}

GpuJpegDecodeAcceleratorMojo::GpuJpegDecodeAcceleratorMojo()
...
void GpuJpegDecodeAcceleratorMojo::VideoFrameReady(
...
void GpuJpegDecodeAcceleratorMojo::NotifyError(
    int32_t bitstream_buffer_id,
...
void GpuJpegDecodeAcceleratorMojo::Initialize(InitializeCallback callback) {
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
...
void GpuJpegDecodeAcceleratorMojo::Decode(
  ...
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
  TRACE_EVENT0("jpeg", "GpuJpegDecodeAcceleratorMojo::Decode");
...
void GpuJpegDecodeAcceleratorMojo::DecodeWithFD(
    int32_t buffer_id,
...
void GpuJpegDecodeAcceleratorMojo::Uninitialize() {
  // TODO(c.padhi): see http://crbug.com/699255.
  NOTIMPLEMENTED();
}

void GpuJpegDecodeAcceleratorMojo::NotifyDecodeStatus(
    int32_t bitstream_buffer_id,
    JpegDecodeAccelerator::Error error) {
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
  DCHECK(decode_cb_);
