...
#ifndef MEDIA_GPU_IPC_SERVICE_GPU_JPEG_DECODE_ACCELERATOR_MOJO_H_
#define MEDIA_GPU_IPC_SERVICE_GPU_JPEG_DECODE_ACCELERATOR_MOJO_H_
...
// TODO(c.padhi): Move GpuJpegDecodeAcceleratorMojo to media/gpu/mojo, see
...
class GpuJpegDecodeAcceleratorMojo : public mojom::GpuJpegDecodeAccelerator,
                                     public JpegDecodeAccelerator::Client {
 public:
  static void Create(mojom::GpuJpegDecodeAcceleratorRequest request);

  ~GpuJpegDecodeAcceleratorMojo() override;
 ...
 private:
  ...
  GpuJpegDecodeAcceleratorMojo();

  // mojom::GpuJpegDecodeAcceleratorMojo implementation.
  ...
  DISALLOW_COPY_AND_ASSIGN(GpuJpegDecodeAcceleratorMojo);
};
