...
static gl::GLContext* GetGLContext(
    const base::WeakPtr<gpu::GLES2CommandBufferStub>& stub) {
  if (!stub) {
...
static bool BindImage(const base::WeakPtr<gpu::GLES2CommandBufferStub>& stub,
...
GpuVideoDecodeAccelerator::GpuVideoDecodeAccelerator(
    ...
    gpu::GLES2CommandBufferStub* stub,
