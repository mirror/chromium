...
static const VAConfigAttrib kJpegEncodeVAConfigAttribs[] = {
...
static std::vector<VAConfigAttrib> GetRequiredAttribs(
  ...
  /*else if (mode == VaapiWrapper::kEncodeJpeg) {
    required_attribs.insert(
        required_attribs.end(), kJpegEncodeVAConfigAttribs,
        kJpegEncodeVAConfigAttribs + arraysize(kJpegEncodeVAConfigAttribs));
  }*/
...
bool VaapiWrapper::IsJpegEncodeSupported() {
  return GetProfileInfos()->IsProfileSupported(
      kEncodeJpeg, VAProfileJPEGBaseline);
}
