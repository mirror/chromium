...
class MEDIA_GPU_EXPORT SurfaceTextureGLOwner : public gl::SurfaceTexture {
 public:
  ...
  // Start or stop expecting a new frame because a buffer was just released to
  // this surface. These update
  ...
  // released. This must only be called if IsExpectingOnFrameAvailable().
