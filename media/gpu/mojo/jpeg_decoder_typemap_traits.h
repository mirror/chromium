...
template <>
struct EnumTraits<media::mojom::Error, media::JpegDecodeAccelerator::Error> {
  static media::mojom::Error ToMojom(media::JpegDecodeAccelerator::Error error);

  static bool FromMojom(media::mojom::Error input,
