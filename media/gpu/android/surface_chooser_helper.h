...
#ifndef MEDIA_GPU_ANDROID_PROMOTION_HINT_HELPER_H_
#define MEDIA_GPU_ANDROID_PROMOTION_HINT_HELPER_H_
...
// complicated and standalong enough not to be part of SurfaceChooser itself.
...
#endif  // MEDIA_GPU_ANDROID_PROMOTION_HINT_HELPER_H_
