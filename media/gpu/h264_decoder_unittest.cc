...
class MockH264Accelerator : public H264Decoder::H264Accelerator {
 public:
  ...
  MOCK_METHOD1(SubmitDecode, bool(H264Picture* pic));
  MOCK_METHOD1(OutputPicture, bool(H264Picture* pic));
...
class WithPocMatcher : public MatcherInterface<H264Picture*> {
 public:
  explicit WithPocMatcher(int expected_poc) : expected_poc_(expected_poc) {}

  bool MatchAndExplain(H264Picture* p,
...
inline Matcher<H264Picture*> WithPoc(int expected_poc) {
