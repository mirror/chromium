...
STATIC_ASSERT_ENUM_MATCH(AV1PROFILE_PROFILE1);
STATIC_ASSERT_ENUM_MATCH(AV1PROFILE_PROFILE2);
STATIC_ASSERT_ENUM_MATCH(AV1PROFILE_PROFILE3);
STATIC_ASSERT_ENUM_MATCH(AV1PROFILE_PROFILE4);
