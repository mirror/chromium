...
#ifndef MEDIA_GPU_D3D11_PICTURE_BUFFER_H_
#define MEDIA_GPU_D3D11_PICTURE_BUFFER_H_
...
class MEDIA_GPU_EXPORT D3D11PictureBuffer
 ...
 public:
  ...
  bool Init(base::Callback<gpu::GpuCommandBufferStub*()> get_stub_cb,
  ...
  base::win::ScopedComPtr<ID3D11Texture2D> texture() const { return texture_; }
  ...
  const base::win::ScopedComPtr<ID3D11VideoDecoderOutputView>& output_view()
      const {
    return output_view_;
  }
...
#endif  // MEDIA_GPU_D3D11_PICTURE_BUFFER_H_
