...
// Tests usual startup conditions: a BitstreamBuffer is enqueued for decode,
// the decoder asks for PictureBuffers, Decode() is tried again, and this time
// succeeds.
TEST_P(VaapiVideoDecodeAcceleratorTest,
       QueueInputBufferAndAsignPictureBuffersAndDecode) {
