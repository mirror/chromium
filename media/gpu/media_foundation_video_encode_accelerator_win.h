...
class MEDIA_GPU_EXPORT MediaFoundationVideoEncodeAccelerator
 ...
 public:
  // If |compatible_with_old_os| is true, MediaFoundationVideoEncoderAccelerator
  ...
  explicit MediaFoundationVideoEncodeAccelerator(bool compatible_with_old_os);
 ...
 private:
  ...
  const bool compatible_with_old_os_;
