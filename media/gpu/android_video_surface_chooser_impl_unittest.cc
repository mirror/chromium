...
enum class IsOverlayRequired { No, Yes };
...
TEST_P(AndroidVideoSurfaceChooserImplTest, OverlayIsUsedOrNotBasedOnState) {
  ...
  chooser_state_.is_overlay_required = IsYes(IsOverlayRequired, 2);
