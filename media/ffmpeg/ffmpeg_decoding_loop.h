...
class MEDIA_EXPORT FFmpegDecodingLoop {
 public:
  ...
  // decoder will be returned. |context| will not be usable for decoding after
  // this until avcodec_flush_buffers() is called on the context. The decoding
  // loop will does handle this.
