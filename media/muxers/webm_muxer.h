...
// Trailer.
// Clients will push encoded VPx video frames and Opus or PCM audio frames one
// by one via OnEncoded{Video|Audio}(). libwebm will eventually ping the
// WriteDataCB passed on contructor with the wrapped encoded data.
