...
// Helper to shorten "base::TimeDelta::FromMicroseconds(...)" in these test
// cases for integer microseconds.
constexpr base::TimeDelta Microseconds(int64_t microseconds) {
...
TEST_P(FrameProcessorTest,
  ...
  frame_duration_ = Microseconds(0);
  EXPECT_CALL(callbacks_, PossibleDurationIncrease(Milliseconds(10)));
  ...
  EXPECT_CALL(callbacks_, PossibleDurationIncrease(Microseconds(6001)));
  frame_duration_ = Microseconds(1);
