...
// |milliseconds| can be floating point; it's converted to microseconds before
// using ::FromMicroseconds.
#define MILLISECONDS(milliseconds) \
  base::TimeDelta::FromMicroseconds((milliseconds)*1000)
