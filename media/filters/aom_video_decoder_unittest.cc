...
class AomVideoDecoderTest : public testing::Test {
 public:
  ...
  // Decodes the single compressed frame in |buffer| and writes the uncompressed
  // output to |video_frame|. This method works with single and multithreaded
  // decoders. End of stream buffers are used to trigger the frame to be
  // returned in the multithreaded decoder case.
