...
// Coefficients extracted from "VP9 Bitstream & Decoding Process Specification"
// Version 0.6 [1], Sec 8.6.1 Dequantization functions.
// [1] https://www.webmproject.org/vp9/#draft-vp9-bitstream-and-decoding-process-specification
static constexpr size_t kQIndexRange = 256;
...
static size_t ClampQ(size_t q) {
  static_assert(std::is_unsigned<size_t>::value, "size_t must be unsigned");
