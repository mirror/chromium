...
// BIG TODO: how is this method used? We don't want to truncate badly an
// out-of-order GOP...
...
bool SourceBufferRangeByPts::TruncateAt(DecodeTimestamp timestamp,
  ...
  BufferQueue::iterator starting_point =
      // BIG TODO...
      GetBufferItrAt(timestamp, is_exclusive);    // BIG TODO continue here -- I'm not sure this helper does what we want..
