...
void GpuVideoDecoder::PutSharedMemory(
  ...
  if (last_bitstream_buffer_id < bitstream_buffer_id_of_last_gc_ ||
      last_bitstream_buffer_id - bitstream_buffer_id_of_last_gc_ >
    ...
    bitstream_buffer_id_of_last_gc_ = last_bitstream_buffer_id;
  }
}
