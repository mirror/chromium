...
"""Packages a tar.gz archive of binary along with its dependencies. This
...
from runner_common import BuildTarImage, ReadRuntimeDeps
...
def main():
  ...
  BuildTarImage(
      ...
      dry_run=False, bootdata=None, summary_output=None, shutdown_machine=False,
      target_cpu=args.target_cpu, use_device=False, wait_for_network=False,
      use_autorun=False)
