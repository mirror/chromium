...
__SSH_PATH = "/usr/bin/ssh"
__SCP_PATH = "/usr/bin/scp"
__SSH_TEMPLATE = "/usr/bin/ssh -F {ssh_config} {host} -p {port} " +
                 "\"{escaped_command}\""
__SCP_TEMPLATE = "/usr/bin/scp -F {ssh_config} -p {port} {source} {dest}"
