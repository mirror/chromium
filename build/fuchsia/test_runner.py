...
def ParallelSymbolizeBacktrace(backtrace):
  # Only allow the parent process to handle SIGINT (ie. ctrl-C).
  # Disable signal handling during Pool creation/forking to keep the child
  # processes from competing for the signal.
