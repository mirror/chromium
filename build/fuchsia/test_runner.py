...
def main():
  ...
  parser.add_argument('--gtest-argument', type=str, action='append',
                      help='Add test arguments for the test process.')
  ...
  if args.gtest_argument:
    gtest_args.extend(args.gtest_argument)
