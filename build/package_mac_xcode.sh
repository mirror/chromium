...
sudo installer \
     -package "${PKG_PATH}/XcodeSystemResources.pkg" \
     -target "${VOLUME_PATH}"
sudo installer -package "${PKG_PATH}/MobileDeviceDevelopment.pkg" \
     -target "${VOLUME_PATH}"
sudo installer -package "${PKG_PATH}/MobileDevice.pkg" \
     -target "${VOLUME_PATH}"
sudo installer -package "${PKG_PATH}/XcodeExtensionSupport.pkg" \
     -target "${VOLUME_PATH}"
