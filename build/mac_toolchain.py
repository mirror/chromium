...
# This can be changed after running `mac_toolchain upload path/to/Xcode.app`.
MAC_TOOLCHAIN_VERSION = '9C40b'
...
class MacToolchainNotFoundError(Exception):
...
def InstallXcode(xcode_build_version, installer_cmd, xcode_app_path, target_os):
  ...
  if not installer_cmd:
    raise MacToolchainNotFoundError(installer_cmd)
