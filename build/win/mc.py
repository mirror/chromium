...
for provider in events:
  ...
  keywords = '0x8000000000000000'  # FIXME: one bit per event?
...
ETW_INLINE ULONG Template_%s(
  ...
  for event in events:
    ...
    print >> out, 'EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR %s = {%s, %s, %s, %s, %s, %s, 0x8000000000000000};' % (symbol, value, version, channel, level, opcode, task)
