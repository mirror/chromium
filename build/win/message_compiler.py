    ...
    if header_dir:
      ...
      with open(header_file, 'rb') as f:
        ...
        for line in f.readlines():
          ...
          # block.
          for define in sorted(define_block, key=lambda s: s.split()[-1]):
            header_contents.append(define)
          define_block = []

          header_contents.append(line)

        # .h files always end in a blank line which should flush #defines.
        assert not define_block
