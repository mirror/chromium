...
public abstract class BuildHooks {
     ...
     */
    public interface ReportAssertionCallback<T> { void run(T arg); }

    private static ReportAssertionCallback<AssertionError> sReportAssertionCallback;
     ...
     */
    public static void setReportAssertionCallback(
            ReportAssertionCallback<AssertionError> callback) {
        if (!BuildHooksConfig.REPORT_JAVA_ASSERT) {
