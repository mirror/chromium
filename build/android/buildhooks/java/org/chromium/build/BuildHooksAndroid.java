...
public abstract class BuildHooksAndroid {
    ...
    public static void setTheme(int theme, Context context) {
        sInstance.setThemeImpl(theme, context);
    }

    protected void setThemeImpl(int theme, Context context) {}

    public static Context createConfigurationContext(Configuration configuration) {
        return sInstance.createConfigurationContextImpl(configuration);
    }

    protected Context createConfigurationContextImpl(Configuration configuration) {
        return null;
    }

    public static Resources getContextThemeWrapperResources(Context context) {
        return sInstance.getContextThemeWrapperResourcesImpl(context);
    }

    protected Resources getContextThemeWrapperResourcesImpl(Context context) {
        return null;
    }
