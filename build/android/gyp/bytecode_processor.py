...
def main(argv):
  ...
  all_args = [args.script, args.input_jar, args.output_jar, args.enable_assert,
              args.enable_custom_resources] + extra_classpath_jars

  build_utils.CheckOutput(all_args)

  all_args.remove(args.output_jar)
  if args.depfile:
    build_utils.WriteDepfile(args.depfile, args.output_jar, all_args)
