...
class ByteCodeProcessor {
    ...
    private static void enableAssertionInJar(String inputJarPath, String outputJarPath,
            boolean shouldAssert, boolean shouldUseCustomResources,
        ...
        try (ZipInputStream inputStream = new ZipInputStream(
            ...
            while ((entry = inputStream.getNextEntry()) != null) {
                ...
                ClassWriter writer = new CustomClassLoaderClassWriter(
    ...
    public static void main(String[] args) {
        if (args.length < 4) {
            ...
            System.out.println("Example usage: java_bytecode_rewriter <input.jar> <output.jar> "
                    + "<--[enable-]assert> <--[enable-]custom-resources> "
                    + "[extra_classpath_jar] ...");
            System.exit(-1);
        }
        ...
        enableAssertionInJar(inputJarPath, outputJarPath, shouldAssert, shouldUseCustomResources,
