...
class TypeUtils {
    ...
    static String getMethodSignature(
            String methodName, @Types String returnType, @Types String... argumentTypes) {
     ...
     */
    static String getMethodDescriptor(@Types String returnType, @Types String... argumentTypes) {
     ...
     */
    private static Type convert(@Types String type) {
    ...
    @StringDef({ASSERTION_ERROR, ASSET_MANAGER, BASE_CHROMIUM_APPLICATION, BUILD_HOOKS,
            BUILD_HOOKS_ANDROID, CONFIGURATION, CONTEXT, CONTEXT_WRAPPER, DISPLAY_LEAK_ACTIVITY,
            RESOURCES, THEME, BOOLEAN, INT, VOID})
    @interface Types {}
}
