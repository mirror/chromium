...
public class InstrumentClass {
    public static class InstrumentationMethodVisitor extends AdviceAdapter {
        ...
        protected void onMethodEnter() {
            visitTraceBegin(this.methodName);
        }
    ...
    public static class InstrumentationClassAdapter extends ClassVisitor {
