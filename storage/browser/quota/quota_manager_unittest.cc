...
using blink::QuotaStatusCode::kErrorAbort;
using blink::QuotaStatusCode::kErrorInvalidModification;
using blink::QuotaStatusCode::kErrorNotSupported;
using blink::QuotaStatusCode::kOk;
using blink::QuotaStatusCode::kUnknown;
