...
class STORAGE_EXPORT BlobTransportStrategy {
 public:
  ...
  // outlive the BlobTransportStrategy instance. If |bytes| has no
  // |embedded_data| then |data| is a valid BytesProvider interface which can be
  // used to acquire the byte data asynchronously.
