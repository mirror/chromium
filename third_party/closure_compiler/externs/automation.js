...
/**
 * @enum {string}
 * @see https://developer.chrome.com/extensions/automation#type-Restrictions
 */
chrome.automation.Restrictions = {
  DISABLED: 'disabled',
  READ_ONLY: 'readOnly',
};
...
/**
 * State describing input restrictions associated with an object: undefined - enabled control or other object that is not disabled  'disabled' - a control or group of controls that does not take input 'readOnly' - an edit field that allows focus and selection but not input
 * @type {(string|undefined)}
 * @see https://developer.chrome.com/extensions/automation#type-restrictions
 */
chrome.automation.AutomationNode.prototype.restrictions;
