...
/**
 * State describing a control if it is one: 'enabled' - a control that takes input 'disabled' - a control or group of controls that does not take input 'readOnly' - an edit field that allows focus and selection but not input undefined - not a control
 * @type {(string|undefined)}
 * @see https://developer.chrome.com/extensions/automation#type-controlMode
 */
