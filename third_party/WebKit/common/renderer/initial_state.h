...
#ifndef THIRD_PARTY_WEBKIT_COMMON_MESSAGE_RENDERER_INITIAL_BACKGROUND_STATE_H_
#define THIRD_PARTY_WEBKIT_COMMON_MESSAGE_RENDERER_INITIAL_BACKGROUND_STATE_H_
...
#endif  // THIRD_PARTY_WEBKIT_COMMON_MESSAGE_RENDERER_INITIAL_BACKGROUND_STATE_H_
