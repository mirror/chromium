...
// WebFeaturePolicyFeature, declared in |WebFeaturePolicy.h|.
//
// Whitelists
// ----------
...
class BLINK_COMMON_EXPORT FeaturePolicy : public WebFeaturePolicy {
 public:
  ...
  bool IsFeatureEnabled(WebFeaturePolicyFeature feature) const override;
  ...
  // This should only be used in unittest.
  url::Origin GetOriginForTest() { return origin_; }
