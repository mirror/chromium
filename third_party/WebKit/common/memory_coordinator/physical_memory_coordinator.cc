...
// static
float PhysicalMemoryCoordinator::approximated_device_memory_gb_ = 0.0;
int64_t PhysicalMemoryCoordinator::physical_memory_mb_ = 0;

// static
void PhysicalMemoryCoordinator::Initialize() {
...
// static
float PhysicalMemoryCoordinator::GetApproximatedDeviceMemory() {
  return approximated_device_memory_gb_;
}

// static
void PhysicalMemoryCoordinator::CalculateAndSetApproximatedDeviceMemory() {
...
// static
void PhysicalMemoryCoordinator::SetPhysicalMemoryMBForTesting(
