...
bool SamplingNativeHeapProfiler::deterministic_ = false;
...
#else
    CHECK(false) << "Can't enable native sampling heap profiler without the shim.";
...
void SamplingNativeHeapProfiler::SetSamplingInterval(
  ...
  // TODO(alph): Update the threshold.
