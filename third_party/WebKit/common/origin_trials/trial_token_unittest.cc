...
// Valid token JSON. The feature name is 100 characters, and
...
// Valid token JSON, over 4KB in size. The feature name is 100 characters, and
// the origin is 3929 chars.
