...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_COMMON_COMMON_EXPORT_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_COMMON_COMMON_EXPORT_H_
//
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_COMMON_COMMON_EXPORT_H_
