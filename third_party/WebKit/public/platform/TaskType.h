...
enum class TaskType : unsigned {
  ...
  // This task type should be used for tasks that should be prioritized during
  // the loading phase, for example notifying some component that loading has
  // been finished. Tasks with this task type are typically posted at:
  ...
  // Tasks that are related to ServiceManager e.g. calling a callback on
  // connection lost.
  ...
  // Tasks that are related to workers e.g. initializing worker clients
