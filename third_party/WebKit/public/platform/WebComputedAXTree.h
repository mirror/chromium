...
enum WebAOMIntAttribute {
  WEB_AOM_INT_ATTRIBUTE_NONE,
  WEB_AOM_ATTR_COLUMN_COUNT,
  WEB_AOM_ATTR_COLUMN_INDEX,
  WEB_AOM_ATTR_COLUMN_SPAN,
  WEB_AOM_ATTR_HIERARCHICAL_LEVEL,
  WEB_AOM_ATTR_POS_IN_SET,
  WEB_AOM_ATTR_ROW_COUNT,
  WEB_AOM_ATTR_ROW_INDEX,
  WEB_AOM_ATTR_ROW_SPAN,
  WEB_AOM_ATTR_SET_SIZE,
};
