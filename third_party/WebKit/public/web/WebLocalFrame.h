...
class WebLocalFrame : public WebFrame {
 public:
  ...
  // SpellCheck panel support -----------------------------------------------
  virtual void SetSpellCheckPanelClient(WebSpellCheckPanelClient*) = 0;
  virtual WebSpellCheckPanelClient* SpellCheckPanelClient() const = 0;
