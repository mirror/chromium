...
class TestRepaintOverlay(unittest.TestCase):
    ...
    def test_generate_repaint_overlay_html(self):
        test_name = 'paint/invalidation/layers-with-offset-and-transform.html'
        host = Host()
        ...
        overlay_html_test_name = 'paint/invalidation/layers-with-offset-and-transform-overlay.html'
