...
from webkitpy.w3c.common import CHROMIUM_WPT_DIR, is_file_synced
...
class GerritCL(object):
    ...
    def is_exportable(self):
        ...
        exportable_files = [f for f in files_in_wpt if is_file_synced(f)]
    ...
    def filter_transform_patch(self, patch):
        ...
        for line in patch.splitlines():
            ...
            if CHROMIUM_WPT_DIR in new_file and is_file_synced(new_file):
                in_exportable_diff = True
                filtered_patch.append(line)
            else:
