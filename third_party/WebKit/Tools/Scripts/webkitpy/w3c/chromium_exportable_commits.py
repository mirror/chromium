...
def exportable_commits_over_last_n_commits(
    ...
    Args:
        ...
        verify_merged_pr: Whether to verify merged PRs can be found in local
            WPT checkout. If True, a Chromium commit whose export PR is merged
            but cannot be found in local WPT checkout will still be exportable.
...
def get_commit_export_state(chromium_commit, local_wpt, wpt_github, verify_merged_pr=False):
    ...
    # A closed Ps can either be merged or abandoned:
