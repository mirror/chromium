...
class TestImporter(object):
    ...
    def apply_exportable_commits_locally(self, local_wpt):
        ...
        for commit in commits:
            ...
            # at all any more, although this information could still be
            ...
            if not applied:
                return None
            # XXX: Test that this works and uses the right dir.
            self._commit_changes('Applying patch %s' % commit.sha)
        return commits
