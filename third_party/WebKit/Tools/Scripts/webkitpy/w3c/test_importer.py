...
from webkitpy.w3c.common import WPT_REPO_URL, WPT_DEST_NAME, get_credentials, exportable_commits_over_last_n_commits
...
class TestImporter(object):
    ...
    def main(self, argv=None):
        ...
        credentials = get_credentials(self.host, options)
    ...
    def parse_args(self, argv):
        ...
        parser.add_argument('--gh-user',
                            help='GitHub user name. Can also be provided using '
                                 'the GH_USER environment variable.')
        parser.add_argument('--gh-token',
                            help='GitHub token or password. Can also be '
                                 'provided using the GH_TOKEN variable.')
