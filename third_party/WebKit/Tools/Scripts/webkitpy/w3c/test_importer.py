...
from webkitpy.w3c.common import read_credentials, is_testharness_baseline, is_file_synced
...
class TestImporter(object):
    ...
    def _clear_out_dest_path(self):
        ...
        should_remove = lambda fs, dirname, basename: (
            is_file_synced(fs.relpath(fs.join(dirname, basename), self.finder.chromium_base())))
