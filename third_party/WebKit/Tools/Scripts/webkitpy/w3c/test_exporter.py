...
class TestExporter(object):
    ...
    def create_or_update_pr_from_landed_commit(self, commit, pull_request=None):
        ...
        if pull_request:
            ...
            self.create_or_update_pr_from_commit(commit, False, pr_branch_name=branch_name)
    ...
    def create_or_update_pr_from_inflight_cl(self, cl, pull_request=None):
        ...
        if pull_request:
            self.create_or_update_pr_from_commit(commit, True, pr_number=pull_request.number, pr_footnote=footnote)
            ...
            pr_number = self.create_or_update_pr_from_commit(commit, True, pr_footnote=footnote, pr_branch_name=branch_name)
    ...
    def create_or_update_pr_from_commit(self, commit, provisional, pr_number=None, pr_footnote='', pr_branch_name=None):
        ...
        Args:
            ...
            pr_number: Optional, a PR issue number.
                If specified, updates the PR instead of creating one.
            pr_footnote: Optional, additional text to be appended to PR
