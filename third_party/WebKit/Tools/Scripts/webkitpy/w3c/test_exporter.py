...
class TestExporter(object):
    ...
    def get_exportable_commits(self):
        """Returns a list of exportable commits that can apply cleanly and
        independently, and a list of error messages for other exportable commits
        that fail to apply cleanly."""
