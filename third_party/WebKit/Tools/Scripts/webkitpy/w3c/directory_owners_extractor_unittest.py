...
class DirectoryOwnersExtractorTest(unittest.TestCase):
    ...
    def test_find_owners_file_takes_four_kinds_of_paths(self):
        ...
        self.assertEqual(self.extractor.find_owners_file(ABS_WPT_BASE + '/foo/bar.html'), ABS_WPT_BASE + '/foo/OWNERS')
        # Relative paths of files.
        self.assertEqual(self.extractor.find_owners_file(REL_WPT_BASE + '/foo/bar.html'), ABS_WPT_BASE + '/foo/OWNERS')
