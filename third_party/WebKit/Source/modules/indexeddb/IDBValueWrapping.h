...
class MODULES_EXPORT IDBValueWrapper {
 ...
 private:
  ...
  void WriteBundleItem(const SerializedScriptValue::Bundle::Item&,
                       Vector<char>& output);
  void WriteBundle(const SerializedScriptValue::Bundle&, Vector<char>& output);
