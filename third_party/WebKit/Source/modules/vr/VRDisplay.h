...
class VRDisplay final : public EventTargetWithInlineData,
 ...
 private:
  ...
  void OnPresentingVSync(
      ...
      const WTF::Optional<gfx::GpuMemoryBufferHandle>& buffer);
  ...
  int ahb_texture_index_ = -1;
  int ahb_width_;
  int ahb_height_;
  GLuint ahb_fbo_;
  GLuint ahb_current_fbo_ = 0;
  GLuint ahb_depthbuffer_;
  GLuint ahb_textures_[AHB_TEXTURE_COUNT];
  GLuint ahb_eglimages_[AHB_TEXTURE_COUNT];
