...
class VRDisplay final : public EventTargetWithInlineData,
 ...
 private:
  ...
  // Metrics data - indicates that we've already measured this data so we don't
  // do it every frame.
  bool already_logged_getFrameData_ = false;
  bool already_logged_requestPresent_ = false;
