...
class VRFrameProviderRequestCallback
 ...
 public:
  ...
  void Invoke(double high_res_time_ms) override {
    // TODO: Eventually exclusive vsyncs won't be handled via this method.
...
void VRFrameProvider::BeginExclusiveSession(VRSession* session,
  ...
  // TODO: Request a VRPresentationProviderPtr to use for presenting frames,
  // delay call to OnPresentComplete till the connection is established.
...
void VRFrameProvider::EndExclusiveSession() {
  ...
  // TODO: Call device_->vrDisplayHostPtr()->ExitPresent();
...
void VRFrameProvider::ScheduleExclusiveFrame() {
  ...
  // TODO: This should acquire frames through a VRPresentationProvider instead
  // of duplicating the non-exclusive path.
