...
VRView::VRView(VRSession* session, Eye eye)
    : eye_(eye),
      session_(session),
...
void VRView::UpdateProjectionMatrixFromFoV(float up_rad,
  ...
  out[10] = (near + far) * inv_nf;
  out[11] = -1.0f;
  out[12] = 0.0f;
  out[13] = 0.0f;
  out[14] = (2.0f * far * near) * inv_nf;
  out[15] = 0.0f;
}
...
void VRView::Trace(blink::Visitor* visitor) {
