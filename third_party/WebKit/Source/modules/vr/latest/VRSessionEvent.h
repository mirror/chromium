...
class VRSessionEvent final : public Event {
 ...
 public:
  ...
  static VRSessionEvent* Create(const AtomicString& type,
                                ...
                                bool cancelable,
                                VRSession* session) {
    return new VRSessionEvent(type, can_bubble, cancelable, session);
  }
 ...
 private:
  VRSessionEvent();
  VRSessionEvent(const AtomicString& type,
                 bool can_bubble,
                 bool cancelable,
                 VRSession*);
  VRSessionEvent(const AtomicString&, const VRSessionEventInit&);
