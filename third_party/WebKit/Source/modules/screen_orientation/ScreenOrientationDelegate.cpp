...
void ScreenOrientationDelegate::EnsureScreenOrientationService() {
  if (provider_ && !screen_orientation_)
    provider_->GetInterface(&screen_orientation_);
}
...
void ScreenOrientationDelegate::SetScreenOrientationForTests(
