...
class NetworkInformation final
 ...
 private:
  ...
  // Rounds |rtt_msec| as per the NetInfo spec and to improve privacy.
  ...
  // noise to the network quality estimates. This makes it difficult for the
  // origin to remove noise from the network quality estimates.
  const size_t salt_;
