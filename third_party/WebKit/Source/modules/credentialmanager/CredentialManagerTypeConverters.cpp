...
TypeConverter<CredentialManagerError, AuthenticatorStatus>::Convert(
  ...
  switch (status) {
    ...
    case webauth::mojom::blink::AuthenticatorStatus::INSECURE_ORIGIN:
      return CredentialManagerError::INSECURE_ORIGIN;
    case webauth::mojom::blink::AuthenticatorStatus::INVALID_DOMAIN:
      return CredentialManagerError::INVALID_DOMAIN;
    case webauth::mojom::blink::AuthenticatorStatus::TIMEOUT:
      return CredentialManagerError::TIMEOUT;
