...
struct EnumTraits<
  ...
  static credential_manager::mojom::blink::CredentialMediationRequirement
...
template <>
struct EnumTraits<credential_manager::mojom::blink::CredentialManagerError,
                  blink::WebCredentialManagerError> {
  static credential_manager::mojom::blink::CredentialManagerError ToMojom(
      blink::WebCredentialManagerError input);
  static bool FromMojom(
      credential_manager::mojom::blink::CredentialManagerError input,
      blink::WebCredentialManagerError* output);
};

template <>
struct UnionTraits<credential_manager::mojom::blink::Credential::DataView,
  ...
  static credential_manager::mojom::blink::Credential::DataView::Tag GetTag(
      const blink::Persistent<blink::Credential>& input) {
    if (input->GetPlatformCredential()->IsPassword()) {
      return credential_manager::mojom::blink::Credential::Tag::
          PASSWORD_CREDENTIAL;
    } else {
      DCHECK(input->GetPlatformCredential()->IsFederated());
      return credential_manager::mojom::blink::Credential::Tag::
  ...
  static bool Read(credential_manager::mojom::blink::Credential::DataView,
