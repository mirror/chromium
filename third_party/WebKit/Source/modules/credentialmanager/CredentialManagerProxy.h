...
// API call must still be serviced in the browsing context responsible for
// actually calling the API method, as opposed to the context whose global
...
class MODULES_EXPORT CredentialManagerProxy
 ...
 public:
  ...
  // Both will DCHECK unless called for an attached Document-type context.
