...
#include "public/platform/modules/credentialmanager/credential_manager_v2.mojom-blink.h"
...
class RequestCallbacks : public CredentialManagerClient::RequestCallbacks {
 ...
 public:
  ...
  void OnSuccess(Credential* credential) override {
    ...
    DCHECK(credential->GetPlatformCredential()->IsPassword() ||
           credential->GetPlatformCredential()->IsFederated());
...
ScriptPromise CredentialsContainer::store(ScriptState* script_state,
  ...
  ::credential_manager::mojom::blink::CredentialManager::StoreCallback c;
  ::credential_manager::mojom::blink::CredentialManagerPtr cm;
