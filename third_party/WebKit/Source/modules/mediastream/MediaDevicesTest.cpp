...
class MockMediaDevicesDispatcherHost
 ...
 public:
  MockMediaDevicesDispatcherHost(MediaDevicesTest* test)
      : test_(test), binding_(this) {}
  ...
  void AddMediaDevicesListener(mojom::blink::MediaDevicesListenerPtr) override;
...
class MediaDevicesTest : public ::testing::Test {
 public:
  ...
  MediaDevicesTest() {
    dispatcher_host_ = std::make_unique<MockMediaDevicesDispatcherHost>(this);
  }
  ...
  void AddMediaDevicesListener(mojom::blink::MediaDevicesListenerPtr listener) {
    listener_ = std::move(listener);
    listener_.set_connection_error_handler(WTF::Bind(
  ...
  const mojom::blink::MediaDevicesListenerPtr& listener() const {
    return listener_;
  }
...
void MockMediaDevicesDispatcherHost::AddMediaDevicesListener(
    mojom::blink::MediaDevicesListenerPtr listener) {
  test_->AddMediaDevicesListener(std::move(listener));
}
