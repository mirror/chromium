...
class MediaDevicesTest : public ::testing::Test {
 public:
  ...
  void SetMediaDevicesListener(mojom::blink::MediaDevicesListenerPtr listener) {
...
void MockMediaDevicesDispatcherHost::SetMediaDevicesListener(
    mojom::blink::MediaDevicesListenerPtr listener) {
  test_->SetMediaDevicesListener(std::move(listener));
}
