...
#include "modules/media_controls/elements/MediaControlSegmentedTrackElement.h"
...
MediaControlSegmentedTrackElement::MediaControlSegmentedTrackElement(
...
void MediaControlSegmentedTrackElement::SetupBarSegments() {
  if (!segment_highlight_before_) {
...
void MediaControlSegmentedTrackElement::SetBeforeSegmentPosition(int left,
                                                                 int width) {
  DCHECK(segment_highlight_before_);
  SetSegmentDivPosition(segment_highlight_before_, left, width);
}

void MediaControlSegmentedTrackElement::SetAfterSegmentPosition(int left,
                                                                int width) {
  DCHECK(segment_highlight_after_);
  SetSegmentDivPosition(segment_highlight_after_, left, width);
}

DEFINE_TRACE(MediaControlSegmentedTrackElement) {
