...
// Builds the UA stylesheet for the Media Controls based
// on feature flags and platform. There is an Android
// specific stylesheet that we will include on Android
// or if devtools has enable mobile emulation.
class MediaControlsResourceLoader
 ...
 private:
  ...
  String GetMediaControlsAndroidCSS();
