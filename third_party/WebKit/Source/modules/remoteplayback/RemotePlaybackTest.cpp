...
class MockPresentationController : public PresentationController {
 public:
  ...
  MOCK_METHOD1(StartListeningForAvailability,
               void(PresentationAvailabilityObserver*));
  MOCK_METHOD1(StopListeningForAvailability,
               void(PresentationAvailabilityObserver*));
};
...
TEST_F(RemotePlaybackTest, IsListening) {
  ...
  EXPECT_CALL(*mock_controller,
              StartListeningForAvailability(::testing::Eq(remote_playback)))
      .Times(2);
  EXPECT_CALL(*mock_controller,
              StopListeningForAvailability(::testing::Eq(remote_playback)))
      .Times(2);
