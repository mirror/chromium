...
class MockPresentationReceiverEventListener : public EventListener {
 public:
  MockPresentationReceiverEventListener()
...
TEST_F(PresentationReceiverTest, NoConnectionUnresolvedConnectionList) {
  ...
  auto event_handler = new StrictMock<MockPresentationReceiverEventListener>();
...
TEST_F(PresentationReceiverTest, TwoConnectionsFireOnconnectionavailableEvent) {
  ...
  StrictMock<MockPresentationReceiverEventListener>* event_handler =
      new StrictMock<MockPresentationReceiverEventListener>();
  AddConnectionavailableEventListener(event_handler, receiver);
