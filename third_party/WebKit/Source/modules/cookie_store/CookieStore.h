...
class CookieStore final
    : public EventTargetWithInlineData,
      ...
      public network::mojom::blink::RestrictedCookieChangeListener {
 ...
 public:
  ...
  void OnCookiesChanged(WTF::Vector<::network::mojom::blink::CanonicalCookiePtr>
                            cookies) override;
 ...
 private:
  ...
  // is torn down.
  mojo::Binding<network::mojom::blink::RestrictedCookieChangeListener>
