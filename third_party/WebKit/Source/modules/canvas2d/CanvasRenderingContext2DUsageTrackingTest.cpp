...
TEST_F(CanvasRenderingContextUsageTrackingTest, FillTracking) {
  ...
  EXPECT_EQ(
      num_reps * 2,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kFillPath]);
  EXPECT_EQ(
      num_reps * 2,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kFillRect]);
  EXPECT_EQ(num_reps, Context2d()->GetUsage().num_non_convex_fill_path_calls);
  EXPECT_EQ(
      num_reps * 2,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kFillText]);

  // areas
  EXPECT_NEAR(static_cast<double>(num_reps * (100 * 100) * 2),
              Context2d()
                  ->GetUsage()
  ...
  EXPECT_NEAR(static_cast<double>(num_reps * (3 * 3) * 2),
              Context2d()
                  ->GetUsage()
  ...
  EXPECT_TRUE(
      Context2d()
          ->GetUsage()
          .bounding_box_perimeter_draw_calls[BaseRenderingContext2D::kFillText] >
      0.0);
  EXPECT_TRUE(
      Context2d()
          ->GetUsage()
          .bounding_box_perimeter_draw_calls[BaseRenderingContext2D::kStrokeText] ==
      0.0);
  ...
  EXPECT_NEAR(100 * 20, Context2d()->GetUsage().bounding_box_area_fill_type
  ...
  EXPECT_NEAR(
      ...
      Context2d()
          ->GetUsage()
          .bounding_box_area_fill_type[BaseRenderingContext2D::kPatternFillType],
      1.0);
  ...
  EXPECT_EQ(
      0,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kStrokePath]);
  EXPECT_EQ(
      0,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kStrokeText]);
...
TEST_F(CanvasRenderingContextUsageTrackingTest, StrokeTracking) {
  ...
  EXPECT_EQ(
      num_reps * 2,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kStrokeRect]);
  EXPECT_EQ(
      num_reps * 2,
      Context2d()->GetUsage().num_draw_calls[BaseRenderingContext2D::kStrokeText]);
  ...
  EXPECT_NEAR(
      ...
      Context2d()
          ->GetUsage()
          .bounding_box_perimeter_draw_calls[BaseRenderingContext2D::kStrokeRect],
      1.0);
  EXPECT_NEAR(static_cast<double>(num_reps * (3 * 3)),
              Context2d()
                  ->GetUsage()
                  .bounding_box_area_draw_calls[BaseRenderingContext2D::kStrokePath],
              1.0);
  EXPECT_NEAR(
      static_cast<double>(num_reps * (2 * 3 + 2 * 3)),
      Context2d()
          ->GetUsage()
          .bounding_box_perimeter_draw_calls[BaseRenderingContext2D::kStrokePath],
      1.0);
  ...
  Context2d()->strokeRect(10, 10, 100, 100);
  EXPECT_EQ(1, Context2d()->GetUsage().num_linear_gradients);
  EXPECT_NEAR(100 * 100, Context2d()->GetUsage().bounding_box_area_fill_type
                             [BaseRenderingContext2D::kLinearGradientFillType],
              1.0);
...
TEST_F(CanvasRenderingContextUsageTrackingTest, ImageTracking) {
  ...
  EXPECT_NEAR(
      num_reps * img_width * img_height,
      Context2d()
          ->GetUsage()
          .bounding_box_area_draw_calls[BaseRenderingContext2D::kDrawBitmapImage],
      0.1);
  ...
  EXPECT_NEAR(
      ...
      Context2d()
          ->GetUsage()
          .bounding_box_area_draw_calls[BaseRenderingContext2D::kDrawVectorImage],
      0.1);
  EXPECT_NEAR(0.0, Context2d()->GetUsage().bounding_box_perimeter_draw_calls
  ...
  EXPECT_NEAR(num_reps * 10 * 100, Context2d()->GetUsage().area_get_image_data_calls,
              0.1);
...
TEST_F(CanvasRenderingContextUsageTrackingTest, ShadowsTracking) {
  ...
  EXPECT_NEAR(
      0.0, Context2d()->GetUsage().bounding_box_area_times_shadow_blur_squared, 0.1);
  EXPECT_NEAR(
      0.0, Context2d()->GetUsage().bounding_box_perimeter_times_shadow_blur_squared,
      0.1);
  ...
  EXPECT_NEAR(area_times_shadow_blur_squared,
              Context2d()->GetUsage().bounding_box_area_times_shadow_blur_squared,
              0.1);
  EXPECT_NEAR(
      perimeter_times_shadow_blur_squared,
      Context2d()->GetUsage().bounding_box_perimeter_times_shadow_blur_squared, 0.1);
