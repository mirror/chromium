...
void AudioWorkletObjectProxy::EvaluateScript(const String& source,
  ...
  // TODO: Extract/build the information for synchronization and send it to
  // the associated AudioWorkletMessagingProxy.
  GetParentFrameTaskRunners()->Get(TaskType::kUnthrottled)
       ->PostTask(
           BLINK_FROM_HERE,
           CrossThreadBind(
                &AudioWorkletMessagingProxy::SynchronizeProcessorData,
