...
class AudioWorkletGlobalScopeTest : public ::testing::Test {
 ...
 private:
  ScriptModuleState EvaluateScriptModule(AudioWorkletGlobalScope* global_scope,
    ...
    return module.Status(script_state);
  }
  ...
  void RunBasicTestOnWorkletThread(WorkerThread* thread,
    ...
    ASSERT_EQ(ScriptModuleState::kEvaluated,
              EvaluateScriptModule(global_scope, source_code));
