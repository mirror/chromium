...
class MODULES_EXPORT AudioWorklet final : public Worklet {
 ...
 public:
  ...
  // Notifies |context_| when AudioWorkletGlobalScope finishes the first script
  // evaluation and is ready for the worklet operation. Can be used for other
  // post-evaluation tasks in AudioWorklet or BaseAudioContext.
  void DidGlobalScopeUpdate();
