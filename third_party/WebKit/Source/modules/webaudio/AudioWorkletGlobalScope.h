...
// The temporary storage for the construction of AudioWorkletProcessor, stores
// the processor name and MessageChannelPort object.
class MODULES_EXPORT ProcessorCreationParams final
    : public GarbageCollectedFinalized<ProcessorCreationParams> {
 public:
...
class MODULES_EXPORT AudioWorkletGlobalScope final
 ...
 private:
  ...
  // Stores parameters upon the processor constructor call, and clears data
  // out immediately after the construction.
  Member<ProcessorCreationParams> processor_creation_params_;
