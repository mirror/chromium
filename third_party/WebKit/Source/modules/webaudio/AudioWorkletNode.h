...
enum AudioWorkletProcessorState { kPending, kRunning, kStopped, kError };
...
class AudioWorkletHandler final : public AudioHandler {
 public:
  ...
  // Sets |AudioWorkletProcessor| and change the state of the processor. MUST be
  // called from the render thread.
  void SetProcessorOnRenderThread(AudioWorkletProcessor*);

  // Finish |AudioWorkletProcessor| and set the tail time to zero, when the
  // user-supplied |process()| method returns false.
