...
void AudioWorkletGlobalScope::registerProcessor(
  ...
  if (!V8ObjectParser::ParsePrototype(isolate, context, constructor, &prototype,
                                      &exception_state))
    return;

  v8::Local<v8::Function> process;
  if (!V8ObjectParser::ParseFunction(isolate, context, prototype, "process",
                                     &process, &exception_state))
    return;
