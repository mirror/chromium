...
void AudioWorkletHandler::Process(size_t frames_to_process) {
  // TODO(hongchan): Until BaseAudioContext and
  // AudioWorklet{GlobalScope,MessagingProxy} is ready, the actual process
...
AudioWorkletNode* AudioWorkletNode::Create(
  ...
  // TODO: The getter |GetProcessorDefinition| isn't implemented in
  // BaseAudioContext yet. (thus won't compile)
...
void AudioWorkletNode::InitializeAudioParamMap(
  ...
  // be thread-safe. Instead, access the cloned |definition| in |AudioWorklet|.
