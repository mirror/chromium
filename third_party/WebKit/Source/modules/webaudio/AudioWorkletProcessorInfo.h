...
class AudioParamInfo {
 ...
 public:
  ...
  float DefaultValue() { return default_value_; }
  float MaxValue() { return max_value_; }
  float MinValue() { return min_value_; }
...
class AudioWorkletProcessorInfo {
 ...
 public:
  ...
  const String& Name() { return name_; }
  Vector<AudioParamInfo> ParamInfoList() { return param_info_list_; }
