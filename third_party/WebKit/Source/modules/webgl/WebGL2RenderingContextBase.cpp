...
void WebGL2RenderingContextBase::bufferData(GLenum target,
  ...
  if (!ValidateSubSourceAndGetData(src_data, src_offset, length, &sub_base_address,
                                   &sub_byte_length)) {
...
void WebGL2RenderingContextBase::getBufferSubData(GLenum target,
  ...
  void* mapped_data =
      ContextGL()->MapBufferRange(target, static_cast<GLintptr>(src_byte_offset),
                                  destination_byte_length, GL_MAP_READ_BIT);
...
void WebGL2RenderingContextBase::blitFramebuffer(GLint src_x0,
  ...
  ContextGL()->BlitFramebufferCHROMIUM(src_x0, src_y0, src_x1, src_y1, dst_x0, dst_y0,
  ...
  switch (pname) {
    case GL_SAMPLES: {
      ...
      ContextGL()->GetInternalformativ(target, internalformat, GL_SAMPLES,
                                       length, values.get());
      return WebGLAny(script_state, DOMInt32Array::Create(values.get(), length));
    }
    default:
      SynthesizeGLError(GL_INVALID_ENUM, "getInternalformatParameter",
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
  ...
  if (!ValidateTexFunc("texSubImage2D", kTexSubImage, kSourceUnpackBuffer, target,
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
  ...
  TexImageHelperHTMLImageElement(
      kTexSubImage2D, target, level, 0, format, type, xoffset, yoffset, 0, image,
      GetTextureSourceSubRectangle(width, height), 1, 0, exception_state);
}
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
  ...
  TexImageHelperHTMLCanvasElement(kTexSubImage2D, target, level, 0, format, type,
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
  ...
  TexImageHelperHTMLVideoElement(
      kTexSubImage2D, target, level, 0, format, type, xoffset, yoffset, 0, video,
      GetTextureSourceSubRectangle(width, height), 1, 0, exception_state);
}
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
  ...
  WebGLRenderingContextBase::texSubImage2D(target, level, xoffset, yoffset,
                                           format, type, image, exception_state);
}
...
void WebGL2RenderingContextBase::texSubImage2D(GLenum target,
                                               ...
                                               ExceptionState& exception_state) {
  WebGLRenderingContextBase::texSubImage2D(target, level, xoffset, yoffset,
                                           format, type, video, exception_state);
}
...
void WebGL2RenderingContextBase::texImage3D(GLenum target,
  ...
  source_image_rect.SetLocation(IntPoint(unpack_skip_pixels_, unpack_skip_rows_));
...
void WebGL2RenderingContextBase::texSubImage3D(GLenum target,
  ...
  if (!ValidateTexFunc("texSubImage3D", kTexSubImage, kSourceUnpackBuffer, target,
...
void WebGL2RenderingContextBase::texSubImage3D(GLenum target,
  ...
  TexImageHelperHTMLCanvasElement(kTexSubImage3D, target, level, 0, format, type,
...
void WebGL2RenderingContextBase::compressedTexSubImage2D(
  ...
  ContextGL()->CompressedTexSubImage2D(
      target, level, xoffset, yoffset, width, height, format, src_length_override,
      static_cast<uint8_t*>(data->BaseAddress()) + src_offset);
}
...
void WebGL2RenderingContextBase::uniformMatrix2x4fv(
  ...
  if (isContextLost() ||
      !ValidateUniformMatrixParameters("uniformMatrix2x4fv", location,
                                       transpose, value, 8, src_offset,
                                       src_length))
    return;
  ContextGL()->UniformMatrix2x4fv(
      location->Location(),
      (src_length ? src_length : (value->length() - src_offset)) >> 3, transpose,
      value->Data() + src_offset);
}
...
bool WebGL2RenderingContextBase::ValidateClearBuffer(const char* function_name,
  ...
  switch (buffer) {
    case GL_COLOR:
      if (size < 4) {
        SynthesizeGLError(GL_INVALID_VALUE, function_name, "invalid array size");
        return false;
      }
      break;
    case GL_DEPTH:
...
void WebGL2RenderingContextBase::transformFeedbackVaryings(
  ...
  Vector<CString>
      keep_alive;  // Must keep these instances alive while looking at their data
...
WebGLActiveInfo* WebGL2RenderingContextBase::getTransformFeedbackVarying(
  ...
  ContextGL()->GetTransformFeedbackVarying(ObjectOrZero(program), index,
                                           max_name_length, &length, &size, &type,
                                           name.get());
...
ScriptValue WebGL2RenderingContextBase::getActiveUniforms(
  ...
  ContextGL()->GetActiveUniformsiv(ObjectOrZero(program), uniform_indices.size(),
                                   uniform_indices.Data(), pname, result.Data());
  switch (return_type) {
    case kEnumType: {
  ...
  switch (pname) {
    ...
    case GL_UNIFORM_BLOCK_ACTIVE_UNIFORMS: {
      ...
      ContextGL()->GetActiveUniformBlockiv(ObjectOrZero(program),
                                           uniform_block_index, pname, &int_value);
...
bool WebGL2RenderingContextBase::IsBufferBoundToTransformFeedback(
  ...
  for (size_t i = 0; i < bound_indexed_transform_feedback_buffers_.size(); ++i) {
...
bool WebGL2RenderingContextBase::IsBufferBoundToNonTransformFeedback(
  ...
  if (bound_array_buffer_ == buffer ||
      ...
      bound_pixel_pack_buffer_ == buffer || bound_pixel_unpack_buffer_ == buffer ||
