...
void WebGL2RenderingContext::RegisterContextExtensions() {
  ...
  RegisterExtension<EXTTextureFilterAnisotropic>(ext_texture_filter_anisotropic_);
  ...
  RegisterExtension<WebGLCompressedTexturePVRTC>(webgl_compressed_texture_pvrtc_);
  ...
  RegisterExtension<WebGLGetBufferSubDataAsync>(webgl_get_buffer_sub_data_async_,
                                                kDraftExtension);
