...
// require the tab to be focussed to be allowed.
...
void ClipboardPromise::RequestReadPermission(
  ...
  // See b/795929 for moving this check into the Browser process.
...
void ClipboardPromise::HandleRead() {
  RequestReadPermission(WTF::Bind(
      &ClipboardPromise::HandleReadWithPermission, WrapPersistent(this)));
}
