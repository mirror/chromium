...
CString ServiceWorkerCacheErrorString(ServiceWorkerCacheError error) {
  switch (error) {
...
class RequestCacheNames
 ...
 public:
  ...
  void OnError(ServiceWorkerCacheError error) override {
