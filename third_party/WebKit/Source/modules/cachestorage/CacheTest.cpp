...
TEST_F(CacheStorageTest, MatchResponseTest) {
  ...
  web_response.SetURLList(url_list);
  web_response.SetResponseType(mojom::ServiceWorkerResponseType::kDefault);
...
TEST_F(CacheStorageTest, MatchAllAndBatchResponseTest) {
  ...
  web_responses[0].SetResponseType(mojom::ServiceWorkerResponseType::kDefault);
  web_responses[1].SetURLList(
      std::vector<KURL>({KURL(kParsedURLString, url2)}));
  web_responses[1].SetResponseType(mojom::ServiceWorkerResponseType::kDefault);
