...
// static
mojom::blink::LocksService::LockMode Lock::StringToMode(const String& string) {
  if (string == kLockModeNameShared)
    return mojom::blink::LocksService::LockMode::SHARED;
  if (string == kLockModeNameExclusive)
    return mojom::blink::LocksService::LockMode::EXCLUSIVE;
  NOTREACHED();
  return mojom::blink::LocksService::LockMode::SHARED;
}

// static
String Lock::ModeToString(mojom::blink::LocksService::LockMode mode) {
  switch (mode) {
    case mojom::blink::LocksService::LockMode::SHARED:
      return kLockModeNameShared;
    case mojom::blink::LocksService::LockMode::EXCLUSIVE:
