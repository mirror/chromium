...
class Lock final : public ScriptWrappable, public PausableObject {
 ...
 public:
  static Lock* Create(ScriptState*,
                      ...
                      mojom::blink::LocksService::LockMode,
  ...
  static mojom::blink::LocksService::LockMode StringToMode(const String&);
  static String ModeToString(mojom::blink::LocksService::LockMode);
 ...
 private:
  ...
  const mojom::blink::LocksService::LockMode mode_;
