...
// A document paint definition is a struct which describes the finromation
...
class DocumentPaintDefinition final
 ...
 public:
  ...
  int GetRegisteredDefinitionCount() const {
    return registered_definitions_count_;
  }
  void IncrementRegisteredDefinitionCount() { registered_definitions_count_++; }
