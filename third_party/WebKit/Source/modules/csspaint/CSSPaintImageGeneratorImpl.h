...
class CSSPaintImageGeneratorImpl final : public CSSPaintImageGenerator {
 ...
 private:
  ...
  // This function first check whether the document definition with |name_|
  // exists or not. If it does exist, the function fetches the document
  // definition and check if it is null. The function returns true when the
  // document definition exists and is not null.
