...
size_t PaintWorklet::SelectGlobalScope() {
  ...
  if (frame_changed) {
    paints_before_switching_global_scope_ = SetPaintsBeforeSwitching();
...
size_t PaintWorklet::SetActiveGlobalScope() {
