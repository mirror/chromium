...
TEST_F(DeferredLoadingTest, Visible) {
  ...
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad1ScreenAway, 1);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad2ScreensAway, 1);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad3ScreensAway, 1);
...
TEST_F(DeferredLoadingTest, DisplayNoneIn2ScreensBelow) {
  ...
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoadVisible, 1);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad1ScreenAway, 1);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad2ScreensAway, 2);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad3ScreensAway, 2);
...
TEST_F(DeferredLoadingTest, LeftNestedInBelow) {
  ...
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kCreated, 2);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad1ScreenAway, 2);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad2ScreensAway, 2);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad3ScreensAway, 2);
...
TEST_F(DeferredLoadingTest, NestedFramesOfVariousSizes) {
  ...
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad1ScreenAway, 1);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad2ScreensAway, 2);
  histogram_tester.ExpectBucketCount(g_k_histogram_name, kWouldLoad3ScreensAway, 3);
