...
TEST_F(ScrollMetricsTest, SmallScrollerPercentageHistogramTest) {
  ...
  // 800 * 600) = 6.4%.
  histogram_tester.ExpectBucketCount(
      "Event.Scroll.ScrollerSize.SmallScrollerPercentage", 6, 1);
}

TEST_F(ScrollMetricsTest,
       SmallScrollerPercentageHistogramTestCompositedScrollerOnly) {
  HistogramTester histogram_tester;
  SetUpHtml(
      "<!DOCTYPE html>"
      "<style>"
  ...
  // = 9.4%.
  histogram_tester.ExpectBucketCount(
      "Event.Scroll.ScrollerSize.SmallScrollerPercentage", 9, 1);
}
...
TEST_F(ScrollMetricsTest,
       SmallScrollerPercentageHistogramTestNonCompositedSmallScroller) {
  HistogramTester histogram_tester;
  SetUpHtml(
      "<!DOCTYPE html>"
      "<style>"
