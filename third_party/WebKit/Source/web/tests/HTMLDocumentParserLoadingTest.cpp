...
TEST_P(HTMLDocumentParserLoadingTest,
  ...
  SimRequest main_resource("https://example.com/test.html", "text/html");
  SimRequest css_head_resource("https://example.com/testHead.css", "text/css");
  SimRequest css_body_resource1("https://example.com/testBody1.css", "text/css");
  SimRequest css_body_resource2("https://example.com/testBody2.css", "text/css");
  SimRequest css_body_resource3("https://example.com/testBody3.css", "text/css");
...
TEST_P(HTMLDocumentParserLoadingTest,
  ...
  SimRequest main_resource("https://example.com/test.html", "text/html");
  SimRequest css_async_resource("https://example.com/testAsync.css", "text/css");
