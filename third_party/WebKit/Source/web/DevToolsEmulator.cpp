...
void DevToolsEmulator::SetMainFrameResizesAreOrientationChanges(bool value) {
  ...
  bool emulate_mobile_enabled = device_metrics_enabled_ && emulate_mobile_enabled_;
  if (!emulate_mobile_enabled)
    web_view_impl_->GetPage()->GetSettings().SetMainFrameResizesAreOrientationChanges(
        value);
}
...
void DevToolsEmulator::SetPrimaryPointerType(PointerType pointer_type) {
  ...
  bool emulate_mobile_enabled = device_metrics_enabled_ && emulate_mobile_enabled_;
  if (!emulate_mobile_enabled)
    web_view_impl_->GetPage()->GetSettings().SetPrimaryPointerType(pointer_type);
}
...
void DevToolsEmulator::EnableMobileEmulation() {
  ...
  web_view_impl_->GetPage()->GetSettings().SetViewportStyle(WebViewportStyle::kMobile);
  ...
  web_view_impl_->GetPage()->GetSettings().SetPreferCompositingToLCDTextEnabled(true);
  web_view_impl_->GetPage()->GetSettings().SetPluginsEnabled(false);
  web_view_impl_->GetPage()->GetSettings().SetAvailablePointerTypes(kPointerTypeCoarse);
  web_view_impl_->GetPage()->GetSettings().SetPrimaryPointerType(kPointerTypeCoarse);
  web_view_impl_->GetPage()->GetSettings().SetAvailableHoverTypes(kHoverTypeNone);
...
void DevToolsEmulator::DisableMobileEmulation() {
  ...
  web_view_impl_->GetPage()->GetSettings().SetPreferCompositingToLCDTextEnabled(
      embedder_prefer_compositing_to_lcd_text_enabled_);
  web_view_impl_->GetPage()->GetSettings().SetViewportStyle(embedder_viewport_style_);
  web_view_impl_->GetPage()->GetSettings().SetPluginsEnabled(embedder_plugins_enabled_);
