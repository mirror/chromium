...
void OomInterventionImpl::OnNearOomDetected(
  ...
  mojom::blink::OomInterventionStatus status =
      pauser_ ? mojom::blink::OomInterventionStatus::ACTIVE
              : mojom::blink::OomInterventionStatus::INACTIVE;
...
void OomInterventionImpl::OnInterventionDeclined(
  ...
  pauser_.reset();
  std::move(callback).Run(mojom::blink::OomInterventionStatus::INACTIVE);
}
