...
#include "controller/LeakDetector.h"

#include "bindings/core/v8/V8BindingForCore.h"
#include "bindings/core/v8/V8GCController.h"
#include "controller/LeakDetectorClient.h"
...
LeakDetector::LeakDetector(LeakDetectorClient* client, LocalFrame* frame)
    : delayed_gc_timer_(TaskRunnerHelper::Get(TaskType::kUnspecedTimer, frame),
                        this,
                        &LeakDetector::TimerFiredGC),
...
void LeakDetector::PrepareForLeakDetection() {
...
void LeakDetector::TimerFiredGC(TimerBase*) {
