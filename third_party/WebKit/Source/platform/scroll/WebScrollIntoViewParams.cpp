...
WebScrollIntoViewParams::WebScrollIntoViewParams(
    ...
    bool zoom_into_final_rect,
    FloatRect relative_rect_of_interest)
    : align_x(scroll_alignment_x),
      ...
      zoom_into_final_rect(zoom_into_final_rect),
      relative_rect_of_interest(relative_rect_of_interest) {}
