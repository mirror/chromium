...
TEST_F(TextBreakIteratorTest, Basic) {
  ...
  MatchLineBreaks(LineBreakType::kNormal, {1, 3, 4, 6}, BreakSpaceType::kBeforeSpace);
...
TEST_F(TextBreakIteratorTest, Newline) {
  SetTestString("a\nb\n\nc");
  MatchLineBreaks(LineBreakType::kNormal, {1, 3, 4, 6});
  MatchLineBreaks(LineBreakType::kNormal, {2, 5, 6}, BreakSpaceType::kBeforeSpace);
  MatchLineBreaks(LineBreakType::kNormal, {2, 5, 6}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, LatinPunctuation) {
  ...
  MatchLineBreaks(LineBreakType::kBreakAll, {2, 5, 6, 8}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, Chinese) {
  ...
  MatchLineBreaks(LineBreakType::kNormal, {1, 2, 3, 4, 5}, BreakSpaceType::kAfter);
  MatchLineBreaks(LineBreakType::kBreakAll, {1, 2, 3, 4, 5}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, ChineseMixed) {
  ...
  MatchLineBreaks(LineBreakType::kNormal, {1, 4, 5, 7, 9, 10}, BreakSpaceType::kAfter);
  MatchLineBreaks(LineBreakType::kBreakAll, {1, 4, 5, 6, 7, 9, 10}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, ChineseSpaces) {
  ...
  MatchLineBreaks(LineBreakType::kNormal, {3, 6, 9, 10}, BreakSpaceType::kAfter);
  MatchLineBreaks(LineBreakType::kBreakAll, {3, 6, 9, 10}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, KeepEmojiZWJSequence) {
  ...
  MatchLineBreaks(LineBreakType::kBreakAll, {1, 2, 4, 16, 17, 18, 19}, BreakSpaceType::kAfter);
}
...
TEST_F(TextBreakIteratorTest, KeepEmojiModifierSequence) {
  ...
  MatchLineBreaks(LineBreakType::kBreakAll, {1, 2, 4, 8, 9, 10, 11}, BreakSpaceType::kAfter);
}
