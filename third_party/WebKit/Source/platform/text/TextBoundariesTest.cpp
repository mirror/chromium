...
TEST_F(TextBoundariesTest, AppendTrailingWhitespace) {
  EXPECT_EQ(
      "^abc  |def",
      TryFindWordForward("a|bc  def", AppendTrailingWhitespace::kShouldAppend));
  EXPECT_EQ("^abc\n |def",
            TryFindWordForward("a|bc\n def",
                               AppendTrailingWhitespace::kShouldAppend));
  EXPECT_EQ("^abc \n|def",
            TryFindWordForward("a|bc \ndef",
                               AppendTrailingWhitespace::kShouldAppend));
  EXPECT_EQ("^abc\xC2\xA0 |def",
            TryFindWordForward("a|bc\xC2\xA0 def",
                               AppendTrailingWhitespace::kShouldAppend))
