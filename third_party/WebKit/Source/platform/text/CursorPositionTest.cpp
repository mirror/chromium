...
TEST_F(CursorPositionTest, LTRMouse) {
  ...
  EXPECT_EQ(GetCharacter(ahem, "XXX", true, 125, true), 1);
  EXPECT_EQ(GetCharacter(ahem, "XXX", true, 150, false), 1);
  EXPECT_EQ(GetCharacter(ahem, "XXX", true, 150, true), 2);
...
TEST_F(CursorPositionTest, RTLMouse) {
  ...
  EXPECT_EQ(GetCharacter(ahem, "X", false, 10, false), 1);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 10, true), 1);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 49, false), 1);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 49, true), 1);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 51, false), 1);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 51, true), 0);
  EXPECT_EQ(GetCharacter(ahem, "X", false, 60, false), 1);
  ...
  EXPECT_EQ(GetCharacter(amiri, u"ت", false, kAloneTaWidth / 4, false), 1);
  EXPECT_EQ(GetCharacter(amiri, u"ت", false, kAloneTaWidth / 4, true), 1);
  EXPECT_EQ(GetCharacter(amiri, u"ت", false, kAloneTaWidth * 2 / 3, false), 1);
  ...
  EXPECT_EQ(GetCharacter(amiri, u"تخ", false, kAboveTaWidth / 4, false), 2);
  EXPECT_EQ(GetCharacter(amiri, u"تخ", false, kAboveTaWidth / 4, true), 2);
  EXPECT_EQ(GetCharacter(amiri, u"تخ", false, kAboveTaWidth * 2 / 3, false), 2);
  EXPECT_EQ(GetCharacter(amiri, u"تخ", false, kAboveTaWidth * 2 / 3, true), 1);
  EXPECT_EQ(GetCharacter(amiri, u"تخ", false, kAboveTaWidth + 1, false), 1);
...
TEST_F(CursorPositionTest, RTLLigatureMouse) {
  ...
  EXPECT_EQ(
      GetCharacter(megalopolis, "ARUF", false, kFUWidth * 3 / 4 - 1, false), 3);
  EXPECT_EQ(
  ...
  EXPECT_EQ(GetCharacter(megalopolis, "ARUF", false, kFUWidth - 1, false), 3);
...
TEST_F(CursorPositionTest, X) {
  DVLOG(1) << GetCharacter(ahem, "XXX", true, 299.9997253418, false);
}
