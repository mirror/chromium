...
TEST_F(QueueingTimeEstimatorTest, SplitEQT) {
  ...
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 0, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 36, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 100, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 800, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Default", 900, 1);
  ...
  EXPECT_THAT(client.GetValueFor(QueueingTimeEstimator::SplitCalculator::
              ...
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.DefaultLoading", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.DefaultLoading", 0, 2);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.DefaultLoading", 36, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.DefaultLoading", 800, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.DefaultLoading", 900, 1);
  ...
  EXPECT_THAT(client.GetValueFor(TaskQueueType::kFrameLoading),
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameLoading", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameLoading", 0, 3);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameLoading", 36, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameLoading", 100, 1);
  ...
  EXPECT_THAT(client.GetValueFor(QueueingTimeEstimator::SplitCalculator::
              ...
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameThrottleable", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameThrottleable", 0, 3);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameThrottleable", 36, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FrameThrottleable", 100, 1);
  ...
  EXPECT_THAT(client.GetValueFor(QueueingTimeEstimator::SplitCalculator::
              ...
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.FramePausable", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FramePausable", 0, 4);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.FramePausable", 36, 1);
  ...
  EXPECT_THAT(client.GetValueFor(TaskQueueType::kUnthrottled),
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.Unthrottled", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Unthrottled", 0, 3);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Unthrottled", 36, 1);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Unthrottled", 100, 1);
  ...
  EXPECT_THAT(client.GetValueFor(TaskQueueType::kCompositor),
              ::testing::ElementsAre(base::TimeDelta::FromMilliseconds(0),
                                     ...
                                     base::TimeDelta::FromMilliseconds(36)));
  histogram_tester.ExpectTotalCount(
      "ExpectedQueueingTimeByTaskQueueType.Compositor", 5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Compositor", 0, 4);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Compositor", 36, 1);
  ...
  histogram_tester.ExpectTotalCount("ExpectedQueueingTimeByTaskQueueType.Other",
                                    5);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Other", 0, 4);
  histogram_tester.ExpectBucketCount(
      "ExpectedQueueingTimeByTaskQueueType.Other", 22, 1);
