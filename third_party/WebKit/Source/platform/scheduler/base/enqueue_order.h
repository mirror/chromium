...
static_assert(sizeof(EnqueueOrderValueType) == 4,
              "A word on 32bit platform is assumed to be 4 bytes and therefore "
              "require overflow support in this class.");
...
// operators (see above).
struct EnqueueOrder {
  EnqueueOrder(EnqueueOrderValueType value) : value_(value) {}
