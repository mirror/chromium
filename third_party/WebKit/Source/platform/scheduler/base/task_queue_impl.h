...
class PLATFORM_EXPORT TaskQueueImpl {
 public:
  ...
  // Disables requiring timing for tests even when having an
  // OnTaskStartedHandler or OnTaskCompletedHandler.
  void ForceSkipRequireTimingForTest(bool force_skip);
 ...
 private:
  ...
  struct MainThreadOnly {
    ...
    // If true, TaskQueueImpl will not require timing for tasks. Used only for
    // tests.
    bool force_skip_require_timing_for_test_ = false;
  };
