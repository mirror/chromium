...
// These strings used for the
// RendererScheduler.ExpectedTaskQueueingDuration.*Queue histograms and should
// match with the corresponding names in
// tools/metrics/histograms/histograms.xml.
constexpr char kCompositorString[] = "CompositorQueue";
constexpr char kDefaultString[] = "DefaultQueue";
constexpr char kDefaultLoadingString[] = "DefaultLoadingQueue";
constexpr char kFrameLoadingString[] = "FrameLoadingQueue";
constexpr char kFramePausableString[] = "FramePausableQueue";
constexpr char kFrameThrottleableString[] = "FrameThrottleableQueue";
constexpr char kUnthrottledString[] = "UnthrottledQueue";
constexpr char kOtherString[] = "OtherQueue";
