...
// These strings used for the ExpectedQueueingTimeByTaskQueueType.* histograms
// and should match with the corresponding names in
// tools/metrics/histograms/histograms.xml.
constexpr char kCompositorString[] =
    "ExpectedQueueingTimeByTaskQueueType.Compositor";
constexpr char kDefaultString[] = "ExpectedQueueingTimeByTaskQueueType.Default";
constexpr char kDefaultLoadingString[] =
    "ExpectedQueueingTimeByTaskQueueType.DefaultLoading";
constexpr char kFrameLoadingString[] =
    "ExpectedQueueingTimeByTaskQueueType.FrameLoading";
constexpr char kFramePausableString[] =
    "ExpectedQueueingTimeByTaskQueueType.FramePausable";
constexpr char kFrameThrottleableString[] =
    "ExpectedQueueingTimeByTaskQueueType.FrameThrottleable";
constexpr char kUnthrottledString[] =
    "ExpectedQueueingTimeByTaskQueueType.Unthrottled";
constexpr char kOtherString[] = "ExpectedQueueingTimeByTaskQueueType.Other";
...
void QueueingTimeEstimator::OnTopLevelTaskStarted(
  ...
  state_.OnTopLevelTaskStarted(client_, task_start_time, task_type_index);
}
...
QueueingTimeEstimator::SplitCalculator::GetReportingMessageFromIndex(
    size_t idx) {
  switch (idx) {
    case TaskQueueType::kDefault:
      return kDefaultString;
    case TaskQueueType::kDefaultLoading:
      return kDefaultLoadingString;
    case TaskQueueType::kFrameLoading:
      return kFrameLoadingString;
    case TaskQueueType::kFrameThrottleable:
      return kFrameThrottleableString;
    case TaskQueueType::kFramePausable:
      return kFramePausableString;
    case TaskQueueType::kUnthrottled:
      return kUnthrottledString;
    case TaskQueueType::kCompositor:
      return kCompositorString;
    case TaskQueueType::kOther:
      return kOtherString;
    default:
      NOTREACHED();
      return "";
...
void QueueingTimeEstimator::State::OnTopLevelTaskStarted(
  ...
  split_calculator_.UpdateSplitIndex(task_type_index);
}
...
base::TimeDelta QueueingTimeEstimator::EstimateQueueingTimeIncludingCurrentTask(
  ...
  if (temporary_queueing_time_estimator_state.current_task_start_time
    ...
    temporary_queueing_time_estimator_state.OnTopLevelTaskStarted(
        &record_queueing_time_client, now, SplitCalculator::kOther);
  }
