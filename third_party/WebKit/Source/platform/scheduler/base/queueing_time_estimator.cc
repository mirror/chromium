...
constexpr char kCompositorString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.Compositor";
constexpr char kDefaultString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.Default";
...
constexpr char kFrameLoadingString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.FrameLoading";
constexpr char kFramePausableString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.FramePausable";
...
constexpr char kUnthrottledString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.Unthrottled";
constexpr char kOtherString[] =
    "RendererScheduler.ExpectedQueueingTimeByTaskQueueType.Other";
