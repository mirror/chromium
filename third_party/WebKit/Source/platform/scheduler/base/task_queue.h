...
class PLATFORM_EXPORT TaskQueue : public base::SingleThreadTaskRunner {
 ...
 protected:
  explicit TaskQueue(internal::TaskQueueImpl* impl);
  ~TaskQueue() override;

  internal::TaskQueueImpl* GetTaskQueueImpl() const { return impl_; }
 ...
 private:
  ...
  void OnTaskQueueImplUnregistered(internal::TaskQueueImpl* impl);

  const base::PlatformThreadId thread_id_;

  // TaskQueueImpl is owned by TaskQueueManager. TaskQueue should subscribe to
  // notification about TaskQueueImpl going away via
  // TaskQueueImpl::SetOnQueueUnregisteredCallback.
  internal::TaskQueueImpl* impl_;  // NOT OWNED
