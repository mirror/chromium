...
class PLATFORM_EXPORT TaskQueue : public base::SingleThreadTaskRunner {
 ...
 protected:
  ...
  friend class AutoAdvancingVirtualTimeDomainTest;
  friend class IdleTimeEstimatorTest;
  friend class TaskQueueManagerTest;

  TaskQueue(internal::TaskQueueImpl* impl);
  ~TaskQueue() override;
