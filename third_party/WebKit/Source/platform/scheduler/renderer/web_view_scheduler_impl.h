...
class PLATFORM_EXPORT WebViewSchedulerImpl : public WebViewScheduler {
 public:
  ...
  void OnNavigation();
  void OnNavigateBackForwardSoon(WebFrameSchedulerImpl* web_frame_scheduler);
  void DidBeginProvisionalLoad(WebFrameSchedulerImpl* web_frame_scheduler);
  void DidEndProvisionalLoad(WebFrameSchedulerImpl* web_frame_scheduler);
