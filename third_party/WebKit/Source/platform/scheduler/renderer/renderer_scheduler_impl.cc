...
RendererSchedulerImpl::MainThreadOnly::MainThreadOnly(
    ...
    : loading_task_cost_estimator(time_source,
      ...
      hidden_music_task_duration_reporter(TASK_DURATION_METRIC_NAME
                                          ".HiddenMusic"),
      process_type(RendererProcessType::kUnknown) {
...
void RendererSchedulerImpl::SetRendererProcessType(RendererProcessType type) {
  DCHECK_NE(RendererProcessType::kUnknown, type);
  DCHECK_EQ(RendererProcessType::kUnknown, main_thread_only().process_type);
...
void RendererSchedulerImpl::RecordForegroundMainThreadTaskLoad(
  ...
  switch (main_thread_only().process_type) {
    ...
    case RendererProcessType::kRenderer:
      ...
      break;
    case RendererProcessType::kUnknown:
      break;
  }
