...
RendererSchedulerImpl::MainThreadOnly::MainThreadOnly(
    ...
    : loading_task_cost_estimator(time_source,
      ...
      was_shutdown(false),
      loading_tasks_estimated_cost(
          base::TimeDelta(),
          "RendererScheduler.LoadingTasksCostEstimation",
          renderer_scheduler_impl,
          TimeDeltaToMilliseconds),
      timer_tasks_estimated_cost(
          base::TimeDelta(),
          "RendererScheduler.TimerTasksCostEstimation",
          renderer_scheduler_impl,
          TimeDeltaToMilliseconds),
...
void RendererSchedulerImpl::OnTraceLogEnabled() {
  ...
  main_thread_only().loading_tasks_estimated_cost.Trace();
  main_thread_only().timer_tasks_estimated_cost.Trace();
