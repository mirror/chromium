...
void RendererSchedulerImpl::RecordMainThreadTaskLoad(base::TimeTicks time,
  ...
  UMA_HISTOGRAM_PERCENTAGE(
      base::StringPrintf("RendererScheduler.RendererMainThreadLoad4.%s",
...
void RendererSchedulerImpl::RecordForegroundMainThreadTaskLoad(
  ...
  UMA_HISTOGRAM_PERCENTAGE(
      base::StringPrintf(
          "RendererScheduler.RendererMainThreadLoad4.%s.Foreground",
          main_thread_only().process_type->c_str()),
      load_percentage);
...
void RendererSchedulerImpl::RecordBackgroundMainThreadTaskLoad(
  ...
  UMA_HISTOGRAM_PERCENTAGE(
      base::StringPrintf(
          "RendererScheduler.RendererMainThreadLoad4.%s.Background",
          main_thread_only().process_type->c_str()),
      load_percentage);
