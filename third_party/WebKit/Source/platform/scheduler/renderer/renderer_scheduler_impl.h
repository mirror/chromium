...
class PLATFORM_EXPORT RendererSchedulerImpl
 ...
 private:
  ...
  void NotifyPendingIndexDbTransactions(bool pending_index_db_transactions);
  ...
  struct MainThreadOnly {
    ...
    std::map<std::string, int> pending_local_storage_message_count;
  ...
  struct AnyThread {
    ...
    bool use_virtual_time;
    int pending_index_db_transaction_count;
  };
