...
scoped_refptr<blink::WebTaskRunner> WebFrameSchedulerImpl::GetTaskRunner(
  ...
  switch (type) {
    case TaskType::kJavascriptTimer:
      return ThrottleableTaskRunner(type);
    case TaskType::kUnspecedLoading:
    case TaskType::kNetworking:
      return LoadingTaskRunner(type);
    case TaskType::kNetworkingControl:
      return LoadingControlTaskRunner(type);
    ...
    case TaskType::kMiscPlatformAPI:
      ...
      return DeferrableTaskRunner(type);
    ...
    case TaskType::kMediaElementEvent:
      return PausableTaskRunner(type);
    case TaskType::kUnthrottled:
      return UnpausableTaskRunner(type);
  }
  NOTREACHED();
  return nullptr;
}
...
scoped_refptr<blink::WebTaskRunner> WebFrameSchedulerImpl::LoadingTaskRunner(
  ...
  return WebTaskRunnerImpl::Create(loading_task_queue_, task_type);
}
...
WebFrameSchedulerImpl::LoadingControlTaskRunner(
  ...
  return WebTaskRunnerImpl::Create(loading_control_task_queue_, task_type);
}
...
WebFrameSchedulerImpl::ThrottleableTaskRunner(
  ...
  return WebTaskRunnerImpl::Create(throttleable_task_queue_, task_type);
}

scoped_refptr<blink::WebTaskRunner> WebFrameSchedulerImpl::DeferrableTaskRunner(
    base::Optional<TaskType> task_type) {
  DCHECK(parent_web_view_scheduler_);
  ...
  return WebTaskRunnerImpl::Create(deferrable_task_queue_, task_type);
}

scoped_refptr<blink::WebTaskRunner> WebFrameSchedulerImpl::PausableTaskRunner(
    base::Optional<TaskType> task_type) {
  DCHECK(parent_web_view_scheduler_);
  ...
  return WebTaskRunnerImpl::Create(pausable_task_queue_, task_type);
}

scoped_refptr<blink::WebTaskRunner> WebFrameSchedulerImpl::UnpausableTaskRunner(
    base::Optional<TaskType> task_type) {
  DCHECK(parent_web_view_scheduler_);
  ...
  return WebTaskRunnerImpl::Create(unpausable_task_queue_, task_type);
}
