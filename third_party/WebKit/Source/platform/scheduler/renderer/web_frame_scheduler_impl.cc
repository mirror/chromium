...
void WebFrameSchedulerImpl::SetIsFrameMain(bool is_frame_main) {
  is_frame_main_ = is_frame_main;
}

bool WebFrameSchedulerImpl::IsFrameMain() {
  return is_frame_main_;
}
...
void WebFrameSchedulerImpl::AsValueInto(
  ...
  state->SetBoolean("is_frame_main", is_frame_main_);
