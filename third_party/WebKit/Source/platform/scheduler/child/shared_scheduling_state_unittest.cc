...
class WebThreadImplForWorkerSchedulerForTest
 ...
 private:
  scoped_refptr<internal::SharedSchedulingState> proxy_;
...
class SharedSchedulingStateTest : public ::testing::Test {
 public:
  SharedSchedulingStateTest()
...
TEST_F(SharedSchedulingStateTest, VisibilitySignalReceived) {
  WaitableEvent visibility_changed;

  std::unique_ptr<SharedSchedulingStateHandle> proxy_handle =
      frame_scheduler_->CreateSharedSchedulingStateHandle();
...
TEST_F(SharedSchedulingStateTest, ProxyHandleDestroyed) {
  WaitableEvent visibility_changed;
...
TEST_F(SharedSchedulingStateTest, FrameSchedulerDestroyed) {
  WaitableEvent visibility_changed;
...
TEST_F(SharedSchedulingStateTest, ThreadDestroyed) {
  WaitableEvent visibility_changed;
