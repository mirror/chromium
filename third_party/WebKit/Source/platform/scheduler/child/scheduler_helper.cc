...
void SchedulerHelper::SetDefaultTaskRunner(
    scoped_refptr<base::SingleThreadTaskRunner> task_runner) {
  task_queue_manager_->SetDefaultTaskRunner(std::move(task_runner));
}

void SchedulerHelper::RestoreDefaultTaskRunner() {
  task_queue_manager_->RestoreDefaultTaskRunner();
}
