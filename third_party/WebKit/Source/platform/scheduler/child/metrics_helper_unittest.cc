...
TEST(MetricsHelperTest, TaskDurationPerThreadType) {
  ...
  MetricsHelperForTest worker_metrics(ThreadType::kWorkerThread);
  ...
  EXPECT_THAT(
      ...
      testing::UnorderedElementsAre(
          ...
          base::Bucket(static_cast<int>(ThreadType::kWorkerThread), 115)));
  ...
  EXPECT_THAT(
      ...
      testing::UnorderedElementsAre(
          ...
          base::Bucket(static_cast<int>(ThreadType::kWorkerThread), 25)));
}
