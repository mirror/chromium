...
class PLATFORM_EXPORT TransformOperation
 ...
 public:
  ...
  bool Is3DOperation() const {
    ...
    return op_type == kScaleZ || op_type == kScale3D || op_type == kTranslateZ ||
           op_type == kTranslate3D || op_type == kRotateX || op_type == kRotateY ||
           op_type == kRotate3D || op_type == kMatrix3D || op_type == kPerspective ||
