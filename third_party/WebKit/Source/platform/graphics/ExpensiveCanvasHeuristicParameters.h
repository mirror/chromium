...
const float kFillNonConvexPathVariableCostPerArea[kNumRenderingModesCostIndexes] =
...
const float kPutImageDataFixedCost[kNumRenderingModesCostIndexes] = {1.209e-03f,
                                                                   1.885e-02f};
const float kPutImageDataVariableCostPerArea[kNumRenderingModesCostIndexes] = {
    6.231e-06f, 4.116e-06f};

const float kDrawSVGImageFixedCost[kNumRenderingModesCostIndexes] = {1.431e-01f,
                                                                   2.958e-01f};
const float kDrawPNGImageFixedCost[kNumRenderingModesCostIndexes] = {1.278e-02f,
                                                                   1.306e-02f};
