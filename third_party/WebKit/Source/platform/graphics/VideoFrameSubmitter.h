...
// stack and mojo, providing commpositor frames containing video frames to the
...
class PLATFORM_EXPORT VideoFrameSubmitter
 ...
 private:
  ...
  // VideoFrameSubmitter has dependencies on classes that use the media\
  // thread's OpenGL ContextProvider.
