...
const uint64_t kCompositingReasonTransformWithCompositedDescendants = UINT64_C(1)
                                                                     << 19;
...
const uint64_t kCompositingReasonBlendingWithCompositedDescendants = UINT64_C(1)
                                                                    << 24;
const uint64_t kCompositingReasonClipsCompositingDescendants = UINT64_C(1) << 25;
const uint64_t kCompositingReasonPerspectiveWith3DDescendants = UINT64_C(1)
                                                               << 26;
const uint64_t kCompositingReasonPreserve3DWith3DDescendants = UINT64_C(1) << 27;
...
const uint64_t kCompositingReasonLayerForHorizontalScrollbar = UINT64_C(1) << 35;
...
const uint64_t kCompositingReasonComboReasonsThatRequireOwnBacking =
    ...
    kCompositingReasonAssumedOverlap | kCompositingReasonNegativeZIndexChildren |
    ...
    kCompositingReasonBlendingWithCompositedDescendants |
    kCompositingReasonIsolateCompositedDescendants |
    kCompositingReasonPreserve3DWith3DDescendants |  // preserve-3d has to create
