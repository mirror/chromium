...
TEST_F(DecodingImageGeneratorTest, CreateWithNullImageDecoder) {
  ...
  // due to data being too short for a signature of any sort.
  EXPECT_EQ(
      nullptr,
      DecodingImageGenerator::Create(
...
// same for ImageDecoder, above, to reduce fragility of knowing a
// short signature will produce a null ImageDecoder).
