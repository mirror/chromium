...
//
// This class has two competing notions of the bounds around the content
// that was recorded and will be produced by the item. The first is the
// |record_bounds| which describes the bounds of all content in the |record|
// in the space of the record. The second is the |visual_rect| which should
// describe the same thing, tho may be more cleverly computed, but in the space
// of the DisplayItemList, so that the visual_rect may be compared between
// DrawingDisplayItems.
