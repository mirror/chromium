...
class PLATFORM_EXPORT DisplayItem {
 ...
 public:
  ...
  // Visual rect can change without invalidation of the client, e.g. when
  // ancestor clip changes. This is called from PaintController::
  // UseCachedDrawingIfPossible() to update the visual rect.
