...
// transform node which also has a reference to the associated scroll node. The
// scroll hit test display item should be in the non-scrolled transform space
// and therefore should not be scrolled by not be scrolled by the associated
