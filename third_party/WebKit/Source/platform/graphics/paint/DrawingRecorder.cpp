...
#endif
{
  ...
  cull_rect_ = EnclosingIntRect(float_cull_rect);
  context.BeginRecording(cull_rect_);
...
DrawingRecorder::~DrawingRecorder() {
  ...
  context_.GetPaintController().CreateAndAppend<DrawingDisplayItem>(
      display_item_client_, display_item_type_, picture, cull_rect_,
      known_to_be_opaque_);
}
