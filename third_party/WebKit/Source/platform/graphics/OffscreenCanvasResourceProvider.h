...
class PLATFORM_EXPORT OffscreenCanvasResourceProvider {
 public:
  ...
  void TransferResource(cc::TransferableResource*);
  ...
  void ReclaimResources(const WTF::Vector<cc::ReturnedResource>& resources);

  void IncNextResourceId() { next_resource_id_++; }

  unsigned NextResourceId() { return next_resource_id_; }
