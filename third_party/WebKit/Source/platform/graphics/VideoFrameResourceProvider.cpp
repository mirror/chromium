...
void VideoFrameResourceProvider::Initialize(
  ...
  resource_provider_ = std::make_unique<cc::ResourceProvider>(
      media_context_provider, shared_bitmap_manager_, nullptr, false, false,
      resource_settings_);
  ...
  switch (external_resources.type) {
    case cc::VideoFrameExternalResources::YUV_RESOURCE: {
      ...
      yuv_video_quad->SetNew(
          shared_quad_state, visible_rect, visible_rect, needs_blending,
