...
void DestroySkImageOnOriginalThread(sk_sp<SkImage> image) {
  // In case texture was used by compositor, which may have change params.
  ...
  if (original_skia_image_) {
    if (original_skia_image_thread_id_ !=
      ...
      original_skia_image_task_runner_->PostTask(
          BLINK_FROM_HERE, CrossThreadBind(&DestroySkImageOnOriginalThread,
