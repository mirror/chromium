...
template <typename T, typename TIndex>
void Im2ColVALID(const int32_t* __restrict input_shape,
                 const T* __restrict input_values,
                 const int32_t* __restrict kernel_shape,
                 int32_t stride_y,
                 int32_t stride_x,
  ...
  const auto out_size =
      GetConvOutputSizeVALID(input_shape, kernel_shape, stride_y, stride_x);
  Im2Col<T>(input_shape, input_values, kernel_shape, stride_y, stride_x,
            std::get<0>(out_size), std::get<1>(out_size), output_shape,
            output_values);
}

template <typename T, typename TIndex>
void Im2ColSAME(const int32_t* __restrict input_shape,
                const T* __restrict input_values,
                const int32_t* __restrict kernel_shape,
                int32_t stride_y,
                int32_t stride_x,
...
template <typename T>
void MaxPoolVALID(const int32_t* __restrict input_shape,
                  const T* __restrict input_values,
                  int32_t stride_y,
                  int32_t stride_x,
                  int32_t kernel_height,
  ...
  const auto out_size =
      GetConvOutputSizeVALID(input_shape, kernel_shape, stride_y, stride_x);
  MaxPool<T>(input_shape, input_values, stride_y, stride_x, kernel_height,
             kernel_width, std::get<0>(out_size), std::get<1>(out_size),
             output_values);
}

template <typename T>
void MaxPoolSAME(const int32_t* __restrict input_shape,
                 const T* __restrict input_values,
                 int32_t stride_y,
                 int32_t stride_x,
                 int32_t kernel_height,
