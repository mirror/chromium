...
class PLATFORM_EXPORT HighContrastImageClassifier {
 ...
 private:
  ...
  // Given a |bitmap|, extracts a sample set of pixels (|sampled_pixels|),
  ...
  // Gets the |required_samples_count| for a given |block| of a |bitmap|,
  // and returns |sampled_pixels| and |transparent_pixels_count|.
