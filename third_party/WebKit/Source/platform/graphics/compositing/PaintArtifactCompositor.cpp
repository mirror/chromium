...
PaintArtifactCompositor::ScrollHitTestLayerForPaintChunk(
  ...
  scroll_layer->SetScrollable(scroll_node->ContainerBounds());
  scroll_layer->SetBounds(scroll_node->Bounds());
...
void PaintArtifactCompositor::Update(
  ...
  for (const PendingLayer& pending_layer : pending_layers) {
    ...
    int scroll_id = property_tree_manager.CompositorScrollNode(scroll_node);
    int clip_id =
