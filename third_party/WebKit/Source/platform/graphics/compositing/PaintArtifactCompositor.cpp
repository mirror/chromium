...
void PaintArtifactCompositor::Update(
  ...
  // TODO(wangxianzhu): This will be unnecessary if this method is no longer
  // called on unchanged paint artifacts.
  for (auto& chunk : const_cast<PaintArtifact&>(paint_artifact).PaintChunks()) {
