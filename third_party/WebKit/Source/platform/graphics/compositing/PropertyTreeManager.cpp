...
void PropertyTreeManager::CreateCompositorScrollNode(
  ...
  // The compositor transform nodes up to this scroll_offset_translation must
  // exist. Scrolling uses the transform tree for scroll offsets so this means
  // all ancestor scroll nodes must also exist.
