...
class WebServiceWorkerResponsePrivate
 ...
 public:
  WebServiceWorkerResponsePrivate()
      : status(0),
        response_type(mojom::ServiceWorkerResponseType::kDefault),
        error(kWebServiceWorkerResponseErrorUnknown) {}
  WebVector<WebURL> url_list;
  unsigned short status;
  WebString status_text;
  mojom::ServiceWorkerResponseType response_type;
...
mojom::ServiceWorkerResponseType WebServiceWorkerResponse::ResponseType()
    const {
