...
void WebServiceWorkerRequest::SetIsMainResourceLoad(bool is_main_resource_load) {
...
WebURLRequest::RequestContext WebServiceWorkerRequest::GetRequestContext() const {
  return private_->request_context_;
}

void WebServiceWorkerRequest::SetFrameType(WebURLRequest::FrameType frame_type) {
