...
bool SubresourceIntegrity::CheckSubresourceIntegrity(
  ...
  // constraint.
  typedef bool (*CheckFunction)(const IntegrityMetadata&, const char*, size_t,
                                const String&);
  ...
  switch (strongest_algorithm) {
    ...
    case IntegrityAlgorithm::kSha512:
      checker = SubresourceIntegrity::CheckSubresourceIntegrityDigest;
      break;
    case IntegrityAlgorithm::kEd25519:
      checker = SubresourceIntegrity::CheckSubresourceIntegritySignature;
      break;
  }
