...
TEST_F(ResourceLoadSchedulerTest, Bypass) {
  ...
  scheduler()->Request(
      client1, ResourceLoadScheduler::ThrottleOption::kCanNotBeThrottled,
      ResourceLoadPriority::kMedium, 0, &id1);
  ...
  scheduler()->Request(
      client2, ResourceLoadScheduler::ThrottleOption::kCanNotBeThrottled,
...
TEST_F(ResourceLoadSchedulerTest, Throttled) {
  ...
  scheduler()->Request(client3,
                       ResourceLoadScheduler::ThrottleOption::kCanBeThrottled,
                       ResourceLoadPriority::kMedium, 0, &id3);
  ...
  scheduler()->Request(client4,
                       ResourceLoadScheduler::ThrottleOption::kCanBeThrottled,
                       ResourceLoadPriority::kMedium, 0, &id4);
...
TEST_F(RendererSideResourceSchedulerTest, CanBeThrottled) {
  EXPECT_EQ(
      ResourceLoadScheduler::ThrottleOption::kCanBeThrottled,
      scheduler()->CanThrottle(CreateRequest(ResourceLoadPriority::kVeryLow),
                               kRequestAsynchronously));

  EXPECT_EQ(ResourceLoadScheduler::ThrottleOption::kCanBeThrottled,
            scheduler()->CanThrottle(CreateRequest(ResourceLoadPriority::kLow),
                                     kRequestAsynchronously));

  EXPECT_EQ(
      ResourceLoadScheduler::ThrottleOption::kCanNotBeThrottled,
      scheduler()->CanThrottle(CreateRequest(ResourceLoadPriority::kMedium),
                               kRequestAsynchronously));

  EXPECT_EQ(ResourceLoadScheduler::ThrottleOption::kCanNotBeThrottled,
            scheduler()->CanThrottle(CreateRequest(ResourceLoadPriority::kHigh),
                                     kRequestAsynchronously));

  EXPECT_EQ(
      ResourceLoadScheduler::ThrottleOption::kCanNotBeThrottled,
      scheduler()->CanThrottle(CreateRequest(ResourceLoadPriority::kVeryHigh),
                               kRequestAsynchronously));
}
