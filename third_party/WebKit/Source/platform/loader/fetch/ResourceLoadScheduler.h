 ...
 public:
  ...
  class TrafficReportHints {
   ...
   private:
    ...
    TrafficReportHints()
        : valid_(false), encoded_data_length_(0), decoded_body_length_(0) {}

    bool valid_;
    int64_t encoded_data_length_;
    int64_t decoded_body_length_;
  };
  ...
  // TrafficRportHints are for reporting histograms.
