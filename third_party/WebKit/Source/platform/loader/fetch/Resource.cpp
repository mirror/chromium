...
bool Resource::CanReuse(const FetchParameters& params) const {
  ...
  switch (new_mode) {
    case kFetchRequestModeNoCORS:
    case kFetchRequestModeNoNavigate:
      break;

    case kFetchRequestCORS:
    case kFetchRequestModeSameOrigin:
    case kFetchRequestModeCORSWithForcedPreflight:
