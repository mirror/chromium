...
TEST(ResourceRequestTest, CrossThreadResourceRequestData) {
  ...
  original.SetServiceWorkerMode(network::mojom::ServiceWorkerMode::kAll);
  ...
  EXPECT_EQ(network::mojom::ServiceWorkerMode::kAll,
  ...
  copy1.SetServiceWorkerMode(network::mojom::ServiceWorkerMode::kNone);
  ...
  EXPECT_EQ(network::mojom::ServiceWorkerMode::kNone,
