    ...
    switch (e.type_) {
      ...
      case FormDataElement::kEncodedFile:
        form_data->elements_.UncheckedAppend(
            FormDataElement(e.filename_.IsolatedCopy(), e.file_start_,
                            e.file_length_, e.expected_file_modification_time_));
        break;
      ...
      case FormDataElement::kEncodedFileSystemURL:
        form_data->elements_.UncheckedAppend(
            FormDataElement(e.file_system_url_.Copy(), e.file_start_,
                            e.file_length_, e.expected_file_modification_time_));
        break;
    }
  }
