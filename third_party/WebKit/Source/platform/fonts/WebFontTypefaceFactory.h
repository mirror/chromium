...
// Decided which Skia Fontmanager to use for instantiating a web font. In the
// regular case, this would be default font manager used for the platform.
// However, for variable font, color bitmap font formats and CFF2 fonts we want
...
class WebFontTypefaceFactory {
 ...
 private:
  ...
  enum WebFontInstantiationResult {
    ...
    kSuccessCff2Font = 4,
    kMaxWebFontInstantiationResult = 5
  };
