...
struct HarfBuzzFontData {
 ...
 public:
  ...
  // Must be called only after updating paint_! The vertical origin and vertical
  // advance functions in HarfBuzzFace require the ascent and height metrics as
  // fallback in case no specific vertical layout information is found from the
  // font.
