...
TEST_F(HarfBuzzShaperTest, MutableUnique) {
  RefPtr<ShapeResult> result = ShapeResult::Create(&font, 0, TextDirection::kLtr);
  EXPECT_EQ(1u, result->RefCount());
