...
class PLATFORM_EXPORT ShapingLineBreaker final {
 ...
 public:
  ...
  // Disable break at soft hyphens U+00AD.
  bool IsSoftHyphenDisabled() const { return is_soft_hyphen_disabled_; }
  void DisableSoftHyphen() { is_soft_hyphen_disabled_ = true; }
