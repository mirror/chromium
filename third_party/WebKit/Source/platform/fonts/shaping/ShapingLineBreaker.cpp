...
inline scoped_refptr<ShapeResult> ShapingLineBreaker::Shape(
  ...
  scoped_refptr<ShapeResult> result =
      shaper_->Shape(font_, direction, start, end);
...
scoped_refptr<ShapeResult> ShapingLineBreaker::ShapeLine(
  ...
  scoped_refptr<ShapeResult> line_result =
      ShapeResult::Create(font_, 0, direction);
...
scoped_refptr<ShapeResult> ShapingLineBreaker::ShapeToEnd(
    unsigned start,
