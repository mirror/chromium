...
class PLATFORM_EXPORT SimpleFontData : public FontData {
 public:
  ...
  bool IsTextOrientationFallback() const { return is_text_orientation_fallback_; }
  ...
  void SetMaxCharWidth(float max_char_width) { max_char_width_ = max_char_width; }

  float AvgCharWidth() const { return avg_char_width_; }
  void SetAvgCharWidth(float avg_char_width) { avg_char_width_ = avg_char_width; }
