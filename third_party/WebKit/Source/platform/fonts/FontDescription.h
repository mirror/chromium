...
class PLATFORM_EXPORT FontDescription {
 ...
 public:
  ...
  struct FamilyDescription {
    ...
    FamilyDescription(GenericFamilyType generic_family, const FontFamily& family)
  ...
  FontWeight Weight() const {
    return static_cast<FontWeight>(fields_.weight_);
  }
  ...
  Kerning GetKerning() const {
    return static_cast<Kerning>(fields_.kerning_);
  }
  ...
  unsigned AuxiliaryBitmapFields() const { return fields_as_unsigned_.parts[1]; }
