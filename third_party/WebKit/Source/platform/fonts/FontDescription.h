...
class PLATFORM_EXPORT FontDescription {
 ...
 public:
  ...
  PLATFORM_EXPORT static String ToString(GenericFamilyType);

  enum Kerning { kAutoKerning, kNormalKerning, kNoneKerning };
  PLATFORM_EXPORT static String ToString(Kerning);
  ...
  PLATFORM_EXPORT static String ToString(LigaturesState);
  ...
  PLATFORM_EXPORT static String ToString(FontVariantCaps);
