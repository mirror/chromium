...
// Helper class that streams all the bytes from a vector of RawData
// scoped_refptrs to a mojo data pipe. Instances will delete themselves when all
// data has been written, or when the data pipe is disconnected.
