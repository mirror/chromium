...
template <>
struct EnumTraits<blink::mojom::CacheError, blink::WebServiceWorkerCacheError> {
  static blink::mojom::CacheError ToMojom(
      blink::WebServiceWorkerCacheError input);

  static bool FromMojom(blink::mojom::CacheError input,
