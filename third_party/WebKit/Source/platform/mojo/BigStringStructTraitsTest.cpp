...
#include "third_party/WebKit/Source/platform/mojo/BigStringStructTraits.h"
#include "third_party/WebKit/Source/platform/wtf/text/WTFString.h"

namespace blink {

TEST(BigStringStructTraitsTest, BigString_Null) {
  String str;
  String output;

  ASSERT_TRUE(mojo::test::SerializeAndDeserialize<
              mojo::common::mojom::blink::BigString>(&str, &output));
  ASSERT_EQ(str, output);
}

TEST(BigStringStructTraitsTest, BigString_Empty) {
...
TEST(BigStringStructTraitsTest, BigString_Short) {
...
TEST(BigStringStructTraitsTest, BigString_Long) {
