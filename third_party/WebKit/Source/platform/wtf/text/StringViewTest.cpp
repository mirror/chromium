...
TEST(StringViewTest, ConstructionStringImpl8) {
  ...
  EXPECT_EQ(impl8_bit->Characters8(), StringView(impl8_bit.Get()).Characters8());
...
TEST(StringViewTest, ConstructionStringImpl16) {
  ...
  EXPECT_STREQ(g_k_chars, StringView(impl16_bit.Get()).ToString().Utf8().Data());
  ...
  EXPECT_STREQ("3", StringView(impl16_bit.Get(), 2, 1).ToString().Utf8().Data());
}
...
TEST(StringViewTest, ConstructionString16) {
  ...
  EXPECT_EQ(string16_bit.Characters16(), StringView(string16_bit).Characters16());
...
TEST(StringViewTest, ConstructionAtomicString8) {
  ...
  EXPECT_EQ(atom8_bit.Characters8() + 2, StringView(atom8_bit, 2).Characters8());
...
TEST(StringViewTest, ConstructionStringView8) {
  ...
  EXPECT_EQ(view8_bit.Characters8() + 2, StringView(view8_bit, 2).Characters8());
...
TEST(StringViewTest, ConstructionLiteral16) {
  ...
  EXPECT_EQ(String(g_k_chars16), StringView(g_k_chars16).ToString().Utf8().Data());
...
TEST(StringViewTest, EqualIgnoringASCIICase) {
  ...
  EXPECT_FALSE(EqualIgnoringASCIICase(StringView(non_ascii8), non_ascii_invalid8));
  EXPECT_FALSE(
