...
// overflow.
// TODO(tkent): Update other functions so that they return |ok| flag. Typically,
// it makes callsites simpler.
WTF_EXPORT NumberParsingState CharactersToUIntStrict(const LChar*,
                                                     size_t,
                                                     unsigned* value);
WTF_EXPORT NumberParsingState CharactersToUIntStrict(const UChar*,
                                                     size_t,
                                                     unsigned* value);
