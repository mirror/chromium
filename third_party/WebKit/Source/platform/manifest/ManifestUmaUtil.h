...
#ifndef THIRD_PARTY_WEBKIT_SOURCE_PLATFORM_MANIFEST_MANIFESTUMAUTIL_H_
#define THIRD_PARTY_WEBKIT_SOURCE_PLATFORM_MANIFEST_MANIFESTUMAUTIL_H_
...
#endif  // THIRD_PARTY_WEBKIT_SOURCE_PLATFORM_MANIFEST_MANIFESTUMAUTIL_H_
