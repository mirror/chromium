 ...
 public:
  ...
  static T* AllocateInlineVectorBacking(size_t size) {
    ...
    return reinterpret_cast<T*>(ThreadHeap::AllocateOnArenaIndex(
        state, size, BlinkGC::kInlineVectorArenaIndex, gc_info_index, type_name));
  }
  ...
  static T* AllocateHashTableBacking(size_t size) {
    size_t gc_info_index = GCInfoTrait<HeapHashTableBacking<HashTable>>::Index();
    ThreadState* state = ThreadStateFor<ThreadingTrait<T>::kAffinity>::GetState();
  ...
  static void Trace(VisitorDispatcher visitor, T& t) {
    TraceCollectionIfEnabled<WTF::IsTraceableInCollectionTrait<Traits>::value,
                             Traits::kWeakHandlingFlag, WTF::kWeakPointersActWeak,
  ...
  static void RegisterBackingStoreCallback(VisitorDispatcher visitor,
                                           ...
                                           void* callback_data) {
    visitor->RegisterBackingStoreCallback(backing_store, callback, callback_data);
  }
