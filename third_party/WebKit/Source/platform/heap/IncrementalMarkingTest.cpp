...
TEST(IncrementalMarkingTest, WriteBarrierOnMarkedObject) {
...
TEST(IncrementalMarkingTest, NoWriteBarrierOnUnmarkedObject) {
  Dummy* parent = Dummy::Create();
  Dummy* child = Dummy::Create();
  HeapObjectHeader* child_header = HeapObjectHeader::FromPayload(child);
...
TEST(IncrementalMarkingTest, WriteBarrierOnMarkedMixinApplication) {
...
TEST(IncrementalMarkingTest, NoWriteBarrierOnUnmarkedMixinApplication) {
  ParentWithMixinPointer* parent = ParentWithMixinPointer::Create();
  Child* child = Child::Create();
  HeapObjectHeader* child_header = HeapObjectHeader::FromPayload(child);
