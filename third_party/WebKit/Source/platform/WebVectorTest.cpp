...
TEST(WebVectorTest, CapacityConstructor) {
  WebVector<int> vector(10, WebVector<int>::empty_with_capacity);

  EXPECT_EQ(10U, vector.capacity());
}

TEST(WebVectorTest, EmplaceBackArgumentForwarding) {
  WebVector<WebString> vector(1, WebVector<WebString>::empty_with_capacity);
