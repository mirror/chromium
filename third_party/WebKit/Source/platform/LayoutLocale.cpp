...
const LayoutLocale* LayoutLocale::LocaleForHan(
  ...
  const LayoutLocale* default_for_han =
      FontGlobalContext::GetDefaultLocaleForHan();
  if (!default_for_han) {
...
const LayoutLocale& LayoutLocale::GetDefault() {
  if (!FontGlobalContext::GetDefaultLayoutLocale()) {
    AtomicString locale = DefaultLanguage();
    FontGlobalContext::SetDefaultLayoutLocale(
        LayoutLocale::Get(!locale.IsEmpty() ? locale : "en"));
  }
  return *FontGlobalContext::GetDefaultLayoutLocale();
}

const LayoutLocale& LayoutLocale::GetSystem() {
  if (!FontGlobalContext::GetSystemLayoutLocale()) {
    ...
    FontGlobalContext::SetSystemLayoutLocale(
        LayoutLocale::Get(AtomicString(name.Replace('_', '-'))));
  }
  return *FontGlobalContext::GetSystemLayoutLocale();
}
