...
################################################################################
# Information (main container class)
################################################################################
...
class IdlInformation(object):
    ...
    def update(self, other):
        ...
        check_conflicts(self.namespaces, other.namespaces, 'Namespace')
        ...
        self.partial_namespaces.extend(other.partial_namespaces)

    def resolve(self):
        # Resolve partial types
        # TODO(peria): Resolve also partial interfaces and partial namespaces
    ...
    def component(self):
        for component in KNOWN_COMPONENTS:
            if self.file_name.find(component) >= 0:
                return component
        return 'Unknown'
