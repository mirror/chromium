...
class IdlInterface(object):
    def __init__(self, node=None, idl_file=''):
        self.attributes = []
        self.constants = []
        self.constructors = []
...
class IdlException(IdlInterface):
    ...
    def __init__(self, node, idl_file=''):
        ...
        IdlInterface.__init__(self, idl_file=idl_file)
