...
class CollectorTest(unittest.TestCase):
    ...
    def test_definition_filters(self):
        ...
        self.assertEqual(2, len(collection.find_partial_namespaces('MyNamespace2')))
    ...
    def test_interface(self):
        ...
        partial_interfaces = collection.find_partial_interfaces('PartialInterface')
    ...
    def test_extended_attributes(self):
        ...
        self.assertEqual(NamedConstructor, type(constructors[4]))
        self.assertEqual(NamedConstructor, type(constructors[5]))
