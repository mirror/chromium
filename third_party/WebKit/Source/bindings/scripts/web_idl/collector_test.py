...
class CollectorTest(unittest.TestCase):
    ...
    def test_interface(self):
        ...
        self.assertEqual('InheritedInterface', interface.inherit)
    ...
    def test_extended_attributes(self):
        ...
        self.assertEqual('Constructor', constructors[0].type)
        self.assertEqual('Constructor', constructors[1].type)
        self.assertEqual('CustomConstructor', constructors[2].type)
        self.assertEqual('CustomConstructor', constructors[3].type)
        self.assertEqual('NamedConstructor', constructors[4].type)
        self.assertEqual('NamedConstructor', constructors[5].type)
