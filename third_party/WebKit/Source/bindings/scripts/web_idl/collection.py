...
from enumeration import EnumerationBuilder
from callback_function import CallbackFunctionBuilder
from typedef import TypedefBuilder
from implements import ImplementsBuilder
...
class Collection(object):
    ...
    def load_idl_file(self, file_name, parser=blink_idl_parser.BlinkIDLParser()):
        ...
        try:
            ...
            raise Exception('Failed to analyze an IDL file "%s":\n%s' % (file_name, e))
    ...
    def _parse_ast(self, node):
        ...
        for child in node.GetChildren():
            ...
            if child_class == 'Interface':
                ...
                interface = InterfaceBuilder.create_interface(child)
                ...
                namespace = NamespaceBuilder.create_namespace(child)
                ...
                dictionary = DictionaryBuilder.create_dictionary(child)
                ...
                implements = ImplementsBuilder.create_implements(child)
