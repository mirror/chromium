...
class Collection(object):
    ...
    def __init__(self, component=None):
        ...
        self._implements = []
        # These members are not in spec., but can be useful. e.g. For code generators.
