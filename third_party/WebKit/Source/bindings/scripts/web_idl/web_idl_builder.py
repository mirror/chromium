...
from .out_spec_types import JSPrimitiveType
...
class WebIdlBuilder(object):
    ...
    def create_interface(node):
        ...
        # Convert ECMAScript specific extended attirubtes applicable on interface.
        constructors = extended_attributes.pop('Constructors', [])
        exposures = extended_attributes.pop('Exposures', [])
        ...
        return Interface(identifier=identifier, attributes=attributes, operations=operations, constants=constants,
                         ...
                         constructors=constructors, exposures=exposures, extended_attributes=extended_attributes)
    ...
    def create_namespace(node):
        ...
        # Convert ECMAScript specific extended attirubtes applicable on namespace.
        exposures = extended_attributes.pop('Exposures', [])

        return Namespace(identifier=identifier, attributes=attributes, operations=operations,
                         is_partial=is_partial, exposures=exposures, extended_attributes=extended_attributes)
