...
class Serializer(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._attribute_identifiers = kwargs.pop('attribute_identifiers', None)
        ...
        if (self.attribute_identifiers or self.has_attribute or self.has_getter or self.has_inherit) and not map_or_list:
            raise ValueError('attribute_identifiers, has_attribute, has_getter, and has_inherit must be set with ' +
    ...
    def attribute_identifiers(self):
        return self._attribute_identifiers
