...
class Container(object):
    """Container stores IDL definitions. Non partial named definitions are stored in dictionary style,
    ...
    def _parse_ast(self, node):
        ...
        for child in node.GetChildren():
            ...
            if child_class == 'Interface':
                ...
                interface = Interface.create(child)
                ...
                namespace = Namespace.create(child)
                ...
                dictionary = Dictionary.create(child)
                ...
                implement = Implements.create(child)
                self._register_metadata(implement, filename)
