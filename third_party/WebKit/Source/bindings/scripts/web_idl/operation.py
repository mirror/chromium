...
_SPECIAL_KEYWORDS = ['deleter', 'getter', 'legacycaller', 'setter', 'stringifier', 'serializer']
...
class Operation(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._special_keywords = kwargs.pop('special_keywords', [])
        ...
        if any(keyword not in _SPECIAL_KEYWORDS for keyword in self._special_keywords):
            raise ValueError('Unknown keyword is specified in special keyword')
