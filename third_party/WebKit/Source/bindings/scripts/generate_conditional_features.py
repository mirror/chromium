...
def conditional_features_info(info_provider, reader, idl_filenames, target_component):
    ...
    for idl_filename in idl_filenames:
        ...
        for implement in implements:
            ...
            implement_info = info_provider.interfaces_info[implement.right_interface]
            implement_interface, _ = read_idl_file(reader, implement_info.get('full_path'))
            feature_names |= get_conditional_feature_names_from_interface(implement_interface)
