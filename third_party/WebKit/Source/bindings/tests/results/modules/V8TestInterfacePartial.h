...
class V8TestInterfacePartial {
 ...
 public:
  ...
  static void InstallConditionalFeaturesOnObject(v8::Local<v8::Context>, const DOMWrapperWorld&, v8::Local<v8::Object>, v8::Local<v8::Function>, v8::Local<v8::FunctionTemplate>);
