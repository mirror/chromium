...
void V8TestInterfacePartial::InstallConditionalFeaturesOnObjects(
  ...
  V8TestInterface::InstallConditionalFeaturesOnObjects(
...
void V8TestInterfacePartial::initialize() {
  ...
  V8TestInterface::UpdateWrapperTypeInfo(
      ...
      nullptr,
      &V8TestInterfacePartial::InstallRuntimeEnabledFeaturesOnTemplate,
      V8TestInterfacePartial::InstallConditionalFeaturesOnObjects);
