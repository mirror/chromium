...
static const int kV8TestNotEnumerableNamedGetterTemplateForMainWorldIndex = 76;
static const int kV8TestNotEnumerableNamedGetterTemplateForNonMainWorldIndex = 77;
static_assert(
    kV8TestNotEnumerableNamedGetterTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestNotEnumerableNamedGetter::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestNotEnumerableNamedGetterTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestNotEnumerableNamedGetterTemplateForMainWorldIndex
                            : kV8TestNotEnumerableNamedGetterTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestNotEnumerableNamedGetter::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestNotEnumerableNamedGetterTemplateForMainWorldIndex) ||
         matches_template(kV8TestNotEnumerableNamedGetterTemplateForNonMainWorldIndex);
}
