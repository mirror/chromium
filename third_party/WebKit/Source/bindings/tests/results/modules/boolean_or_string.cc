...
BooleanOrString::BooleanOrString() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const BooleanOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case BooleanOrString::SpecificTypes::kNone:
      return v8::Null(isolate);
    case BooleanOrString::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case BooleanOrString::SpecificTypes::kString:
