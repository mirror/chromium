...
TestInterface2OrUint8Array::TestInterface2OrUint8Array() : type_(SpecificTypes::kNone) {}
...
void TestInterface2OrUint8Array::SetTestInterface2(TestInterface2* value) {
  ...
  type_ = SpecificTypes::kTestInterface2;
}
...
void TestInterface2OrUint8Array::SetUint8Array(NotShared<DOMUint8Array> value) {
  ...
  type_ = SpecificTypes::kUint8Array;
}
...
v8::Local<v8::Value> ToV8(const TestInterface2OrUint8Array& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case TestInterface2OrUint8Array::SpecificTypes::kNone:
      return v8::Null(isolate);
    case TestInterface2OrUint8Array::SpecificTypes::kTestInterface2:
      return ToV8(impl.GetAsTestInterface2(), creationContext, isolate);
    case TestInterface2OrUint8Array::SpecificTypes::kUint8Array:
