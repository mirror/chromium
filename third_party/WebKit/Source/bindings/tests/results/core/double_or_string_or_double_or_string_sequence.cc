...
DoubleOrStringOrDoubleOrStringSequence::DoubleOrStringOrDoubleOrStringSequence() : type_(SpecificTypes::kNone) {}
...
void DoubleOrStringOrDoubleOrStringSequence::SetDoubleOrStringSequence(const HeapVector<DoubleOrString>& value) {
  ...
  type_ = SpecificTypes::kDoubleOrStringSequence;
}
...
v8::Local<v8::Value> ToV8(const DoubleOrStringOrDoubleOrStringSequence& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case DoubleOrStringOrDoubleOrStringSequence::SpecificTypes::kNone:
      return v8::Null(isolate);
    case DoubleOrStringOrDoubleOrStringSequence::SpecificTypes::kDouble:
      return v8::Number::New(isolate, impl.GetAsDouble());
    case DoubleOrStringOrDoubleOrStringSequence::SpecificTypes::kDoubleOrStringSequence:
      return ToV8(impl.GetAsDoubleOrStringSequence(), creationContext, isolate);
    case DoubleOrStringOrDoubleOrStringSequence::SpecificTypes::kString:
