...
static void V8TestInterfaceNamedConstructor2ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceNamedConstructor2_ConstructorCallback");
...
void V8TestInterfaceNamedConstructor2Constructor::NamedConstructorAttributeGetter(
  ...
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceNamedConstructor2_NamedConstructorAttributeGetter");
