...
DoubleOrString::DoubleOrString() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const DoubleOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case DoubleOrString::SpecificTypes::kNone:
      return v8::Null(isolate);
    case DoubleOrString::SpecificTypes::kDouble:
      return v8::Number::New(isolate, impl.GetAsDouble());
    case DoubleOrString::SpecificTypes::kString:
