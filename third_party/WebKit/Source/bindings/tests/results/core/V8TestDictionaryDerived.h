...
class V8TestDictionaryDerivedImplementedAs {
 public:
  CORE_EXPORT_N320 static void toImpl(v8::Isolate*, v8::Local<v8::Value>, TestDictionaryDerivedImplementedAs&, ExceptionState&);
};

CORE_EXPORT_N321 bool toV8TestDictionaryDerivedImplementedAs(const TestDictionaryDerivedImplementedAs&, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate*);
...
struct NativeValueTraits<TestDictionaryDerivedImplementedAs> : public NativeValueTraitsBase<TestDictionaryDerivedImplementedAs> {
  CORE_EXPORT_N322 static TestDictionaryDerivedImplementedAs NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
