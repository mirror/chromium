...
TestInterfaceGarbageCollectedOrString::TestInterfaceGarbageCollectedOrString() : type_(SpecificTypes::kNone) {}
...
void TestInterfaceGarbageCollectedOrString::SetTestInterfaceGarbageCollected(TestInterfaceGarbageCollected* value) {
  ...
  type_ = SpecificTypes::kTestInterfaceGarbageCollected;
}
...
v8::Local<v8::Value> ToV8(const TestInterfaceGarbageCollectedOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case TestInterfaceGarbageCollectedOrString::SpecificTypes::kNone:
      return v8::Null(isolate);
    case TestInterfaceGarbageCollectedOrString::SpecificTypes::kString:
      return V8String(isolate, impl.GetAsString());
    case TestInterfaceGarbageCollectedOrString::SpecificTypes::kTestInterfaceGarbageCollected:
