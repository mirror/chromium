...
static void ceReactionsMethodMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  TestObject* impl = V8TestObject::ToImpl(info.Holder());

  impl->ceReactionsMethod();
}
...
void V8TestObject::ceReactionsMethodMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TestObject_ceReactionsMethod");

  TestObjectV8Internal::ceReactionsMethodMethod(info);
}
...
static const V8DOMConfiguration::MethodConfiguration V8TestObjectMethods[] = {
    ...
    {"ceReactionsMethod", V8TestObject::ceReactionsMethodMethodCallback, 0, v8::None, V8DOMConfiguration::kOnPrototype, V8DOMConfiguration::kCheckHolder, V8DOMConfiguration::kDoNotCheckAccess, V8DOMConfiguration::kAllWorlds},
