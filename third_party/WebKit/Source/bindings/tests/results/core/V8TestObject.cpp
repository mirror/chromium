...
static const int kV8TestObjectTemplateForMainWorldIndex = 62;
static const int kV8TestObjectTemplateForNonMainWorldIndex = 63;
static_assert(
    kV8TestObjectTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestObject::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestObjectTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestObjectTemplateForMainWorldIndex
                            : kV8TestObjectTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestObject::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestObjectTemplateForMainWorldIndex) ||
         matches_template(kV8TestObjectTemplateForNonMainWorldIndex);
}
