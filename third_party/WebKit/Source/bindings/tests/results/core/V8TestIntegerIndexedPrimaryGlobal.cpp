...
static const int kV8TestIntegerIndexedPrimaryGlobalTemplateForMainWorldIndex = 20;
static const int kV8TestIntegerIndexedPrimaryGlobalTemplateForNonMainWorldIndex = 21;
static_assert(
    kV8TestIntegerIndexedPrimaryGlobalTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestIntegerIndexedPrimaryGlobal::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestIntegerIndexedPrimaryGlobalTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestIntegerIndexedPrimaryGlobalTemplateForMainWorldIndex
                            : kV8TestIntegerIndexedPrimaryGlobalTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestIntegerIndexedPrimaryGlobal::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestIntegerIndexedPrimaryGlobalTemplateForMainWorldIndex) ||
         matches_template(kV8TestIntegerIndexedPrimaryGlobalTemplateForNonMainWorldIndex);
}
