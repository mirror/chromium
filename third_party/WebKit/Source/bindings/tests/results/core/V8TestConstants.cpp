...
static const int kV8TestConstantsTemplateForMainWorldIndex = 10;
static const int kV8TestConstantsTemplateForNonMainWorldIndex = 11;
static_assert(
    kV8TestConstantsTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestConstants::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestConstantsTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestConstantsTemplateForMainWorldIndex
                            : kV8TestConstantsTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestConstants::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestConstantsTemplateForMainWorldIndex) ||
         matches_template(kV8TestConstantsTemplateForNonMainWorldIndex);
}
