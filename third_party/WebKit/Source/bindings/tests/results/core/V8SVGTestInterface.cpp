...
static const int kV8SVGTestInterfaceTemplateForMainWorldIndex = 0;
static const int kV8SVGTestInterfaceTemplateForNonMainWorldIndex = 1;
static_assert(
    kV8SVGTestInterfaceTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8SVGTestInterface::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8SVGTestInterfaceTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8SVGTestInterfaceTemplateForMainWorldIndex
                            : kV8SVGTestInterfaceTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8SVGTestInterface::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8SVGTestInterfaceTemplateForMainWorldIndex) ||
         matches_template(kV8SVGTestInterfaceTemplateForNonMainWorldIndex);
}
