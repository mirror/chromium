...
ByteStringSequenceSequenceOrByteStringByteStringRecord::ByteStringSequenceSequenceOrByteStringByteStringRecord() : type_(SpecificTypes::kNone) {}
...
void ByteStringSequenceSequenceOrByteStringByteStringRecord::SetByteStringByteStringRecord(const Vector<std::pair<String, String>>& value) {
  ...
  type_ = SpecificTypes::kByteStringByteStringRecord;
}
...
void ByteStringSequenceSequenceOrByteStringByteStringRecord::SetByteStringSequenceSequence(const Vector<Vector<String>>& value) {
  ...
  type_ = SpecificTypes::kByteStringSequenceSequence;
}
...
v8::Local<v8::Value> ToV8(const ByteStringSequenceSequenceOrByteStringByteStringRecord& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case ByteStringSequenceSequenceOrByteStringByteStringRecord::SpecificTypes::kNone:
      return v8::Null(isolate);
    case ByteStringSequenceSequenceOrByteStringByteStringRecord::SpecificTypes::kByteStringByteStringRecord:
      return ToV8(impl.GetAsByteStringByteStringRecord(), creationContext, isolate);
    case ByteStringSequenceSequenceOrByteStringByteStringRecord::SpecificTypes::kByteStringSequenceSequence:
