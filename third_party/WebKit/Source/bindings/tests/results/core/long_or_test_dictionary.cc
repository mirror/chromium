...
LongOrTestDictionary::LongOrTestDictionary() : type_(SpecificTypes::kNone) {}
...
void LongOrTestDictionary::SetTestDictionary(const TestDictionary& value) {
  ...
  type_ = SpecificTypes::kTestDictionary;
}
...
v8::Local<v8::Value> ToV8(const LongOrTestDictionary& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case LongOrTestDictionary::SpecificTypes::kNone:
      return v8::Null(isolate);
    case LongOrTestDictionary::SpecificTypes::kLong:
      return v8::Integer::New(isolate, impl.GetAsLong());
    case LongOrTestDictionary::SpecificTypes::kTestDictionary:
