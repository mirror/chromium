...
static const int kV8TestInterfaceNamedConstructorTemplateForMainWorldIndex = 50;
static const int kV8TestInterfaceNamedConstructorTemplateForNonMainWorldIndex = 51;
static_assert(
    kV8TestInterfaceNamedConstructorTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceNamedConstructor::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceNamedConstructorTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceNamedConstructorTemplateForMainWorldIndex
                            : kV8TestInterfaceNamedConstructorTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceNamedConstructor::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceNamedConstructorTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceNamedConstructorTemplateForNonMainWorldIndex);
}
