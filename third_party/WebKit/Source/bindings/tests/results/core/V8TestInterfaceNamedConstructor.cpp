...
static void V8TestInterfaceNamedConstructorConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceNamedConstructor_ConstructorCallback");
...
void V8TestInterfaceNamedConstructorConstructor::NamedConstructorAttributeGetter(
  ...
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceNamedConstructor_NamedConstructorAttributeGetter");
