...
LongSequenceOrEvent::LongSequenceOrEvent() : type_(SpecificTypes::kNone) {}
...
void LongSequenceOrEvent::SetLongSequence(const Vector<int32_t>& value) {
  ...
  type_ = SpecificTypes::kLongSequence;
}
...
v8::Local<v8::Value> ToV8(const LongSequenceOrEvent& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case LongSequenceOrEvent::SpecificTypes::kNone:
      return v8::Null(isolate);
    case LongSequenceOrEvent::SpecificTypes::kEvent:
      return ToV8(impl.GetAsEvent(), creationContext, isolate);
    case LongSequenceOrEvent::SpecificTypes::kLongSequence:
