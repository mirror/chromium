...
class CORE_EXPORT_N181 LongCallbackFunction final : public GarbageCollectedFinalized<LongCallbackFunction>, public TraceWrapperBase {
 public:
...
struct NativeValueTraits<LongCallbackFunction> : public NativeValueTraitsBase<LongCallbackFunction> {
  CORE_EXPORT_N182 static LongCallbackFunction* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
