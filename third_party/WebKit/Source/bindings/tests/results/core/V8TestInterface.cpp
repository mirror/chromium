...
void V8TestInterface::InstallConditionalFeaturesOnObjects(
...
void V8TestInterface::UpdateWrapperTypeInfo(
    ...
    InstallConditionalFeaturesOnObjectsFunction install_conditional_features_on_objects_function) {
  ...
  if (install_conditional_features_on_objects_function) {
    V8TestInterface::wrapperTypeInfo.install_conditional_features_on_objects_function =
