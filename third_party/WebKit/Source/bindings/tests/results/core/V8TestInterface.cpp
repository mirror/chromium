...
static const int kV8TestInterfaceTemplateForMainWorldIndex = 48;
static const int kV8TestInterfaceTemplateForNonMainWorldIndex = 49;
static_assert(
    kV8TestInterfaceTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterface::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), V8TestInterface::installV8TestInterfaceTemplateFunction);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceTemplateForMainWorldIndex
                            : kV8TestInterfaceTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterface::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceTemplateForNonMainWorldIndex);
}
