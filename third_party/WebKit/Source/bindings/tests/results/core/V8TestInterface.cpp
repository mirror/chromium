...
InstallRuntimeEnabledOnTemplateFunction V8TestInterface::install_runtime_enabled_on_template_function_ =
    &V8TestInterface::InstallRuntimeEnabledFeaturesOnTemplate;
...
void V8TestInterface::UpdateWrapperTypeInfo(
  ...
  CHECK(install_runtime_enabled_on_template_function);
  V8TestInterface::install_runtime_enabled_on_template_function_ =
      install_runtime_enabled_on_template_function;
