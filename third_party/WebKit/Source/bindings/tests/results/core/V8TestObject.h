...
class V8TestObject {
 ...
 public:
  ...
  CORE_EXPORT static void runtimeStatsCounterAttributeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void runtimeStatsCounterAttributeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT static void runtimeStatsCounterReadOnlyAttributeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  ...
  CORE_EXPORT static void runtimeStatsCounterMethodMethodCallback(const v8::FunctionCallbackInfo<v8::Value>&);
