...
ByteStringOrNodeList::ByteStringOrNodeList() : type_(SpecificTypes::kNone) {}
...
void ByteStringOrNodeList::SetByteString(const String& value) {
  DCHECK(IsNull());
  byte_string_ = value;
  type_ = SpecificTypes::kByteString;
}
...
v8::Local<v8::Value> ToV8(const ByteStringOrNodeList& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case ByteStringOrNodeList::SpecificTypes::kNone:
      return v8::Null(isolate);
    case ByteStringOrNodeList::SpecificTypes::kByteString:
      return V8String(isolate, impl.GetAsByteString());
    case ByteStringOrNodeList::SpecificTypes::kNodeList:
