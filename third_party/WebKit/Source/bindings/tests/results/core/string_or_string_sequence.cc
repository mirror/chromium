...
StringOrStringSequence::StringOrStringSequence() : type_(SpecificTypes::kNone) {}
...
void StringOrStringSequence::SetStringSequence(const Vector<String>& value) {
  ...
  type_ = SpecificTypes::kStringSequence;
}
...
v8::Local<v8::Value> ToV8(const StringOrStringSequence& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case StringOrStringSequence::SpecificTypes::kNone:
      return v8::Null(isolate);
    case StringOrStringSequence::SpecificTypes::kString:
      return V8String(isolate, impl.GetAsString());
    case StringOrStringSequence::SpecificTypes::kStringSequence:
