...
TestInterfaceOrLong::TestInterfaceOrLong() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const TestInterfaceOrLong& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case TestInterfaceOrLong::SpecificTypes::kNone:
      return v8::Null(isolate);
    case TestInterfaceOrLong::SpecificTypes::kLong:
      return v8::Integer::New(isolate, impl.GetAsLong());
    case TestInterfaceOrLong::SpecificTypes::kTestInterface:
