...
static const int kV8TestIntegerIndexedGlobalTemplateForMainWorldIndex = 18;
static const int kV8TestIntegerIndexedGlobalTemplateForNonMainWorldIndex = 19;
static_assert(
    kV8TestIntegerIndexedGlobalTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestIntegerIndexedGlobal::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestIntegerIndexedGlobalTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestIntegerIndexedGlobalTemplateForMainWorldIndex
                            : kV8TestIntegerIndexedGlobalTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestIntegerIndexedGlobal::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestIntegerIndexedGlobalTemplateForMainWorldIndex) ||
         matches_template(kV8TestIntegerIndexedGlobalTemplateForNonMainWorldIndex);
}
