...
static const int kV8TestInterfaceConstructorTemplateForMainWorldIndex = 28;
static const int kV8TestInterfaceConstructorTemplateForNonMainWorldIndex = 29;
static_assert(
    kV8TestInterfaceConstructorTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceConstructor::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceConstructorTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceConstructorTemplateForMainWorldIndex
                            : kV8TestInterfaceConstructorTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceConstructor::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceConstructorTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceConstructorTemplateForNonMainWorldIndex);
}
