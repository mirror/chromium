...
static void constructor1(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceConstructor_ConstructorCallback");
...
void V8TestInterfaceConstructorConstructor::NamedConstructorAttributeGetter(
  ...
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceConstructor_NamedConstructorAttributeGetter");
...
void V8TestInterfaceConstructor::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceConstructor_Constructor");
