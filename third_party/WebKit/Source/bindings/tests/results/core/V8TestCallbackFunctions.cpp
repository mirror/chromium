...
static const int kV8TestCallbackFunctionsTemplateForMainWorldIndex = 8;
static const int kV8TestCallbackFunctionsTemplateForNonMainWorldIndex = 9;
static_assert(
    kV8TestCallbackFunctionsTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestCallbackFunctions::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestCallbackFunctionsTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestCallbackFunctionsTemplateForMainWorldIndex
                            : kV8TestCallbackFunctionsTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestCallbackFunctions::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestCallbackFunctionsTemplateForMainWorldIndex) ||
         matches_template(kV8TestCallbackFunctionsTemplateForNonMainWorldIndex);
}
