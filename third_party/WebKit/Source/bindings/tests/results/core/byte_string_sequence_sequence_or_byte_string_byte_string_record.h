...
class CORE_EXPORT ByteStringSequenceSequenceOrByteStringByteStringRecord final {
 ...
 public:
  ...
  bool IsByteStringByteStringRecord() const { return type_ == SpecificTypes::kByteStringByteStringRecord; }
  ...
  bool IsByteStringSequenceSequence() const { return type_ == SpecificTypes::kByteStringSequenceSequence; }
