...
BooleanOrTestCallbackInterface::BooleanOrTestCallbackInterface() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const BooleanOrTestCallbackInterface& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case BooleanOrTestCallbackInterface::SpecificTypes::kNone:
      return v8::Null(isolate);
    case BooleanOrTestCallbackInterface::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case BooleanOrTestCallbackInterface::SpecificTypes::kTestCallbackInterface:
