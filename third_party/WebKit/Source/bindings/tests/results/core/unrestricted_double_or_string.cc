...
UnrestrictedDoubleOrString::UnrestrictedDoubleOrString() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const UnrestrictedDoubleOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case UnrestrictedDoubleOrString::SpecificTypes::kNone:
      return v8::Null(isolate);
    case UnrestrictedDoubleOrString::SpecificTypes::kString:
      return V8String(isolate, impl.GetAsString());
    case UnrestrictedDoubleOrString::SpecificTypes::kUnrestrictedDouble:
