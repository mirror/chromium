...
LongOrBoolean::LongOrBoolean() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const LongOrBoolean& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case LongOrBoolean::SpecificTypes::kNone:
      return v8::Null(isolate);
    case LongOrBoolean::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case LongOrBoolean::SpecificTypes::kLong:
