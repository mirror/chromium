...
BooleanOrStringOrUnrestrictedDouble::BooleanOrStringOrUnrestrictedDouble() : type_(SpecificTypes::kNone) {}
...
void BooleanOrStringOrUnrestrictedDouble::SetUnrestrictedDouble(double value) {
  ...
  type_ = SpecificTypes::kUnrestrictedDouble;
}
...
v8::Local<v8::Value> ToV8(const BooleanOrStringOrUnrestrictedDouble& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case BooleanOrStringOrUnrestrictedDouble::SpecificTypes::kNone:
      return v8::Null(isolate);
    case BooleanOrStringOrUnrestrictedDouble::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case BooleanOrStringOrUnrestrictedDouble::SpecificTypes::kString:
      return V8String(isolate, impl.GetAsString());
    case BooleanOrStringOrUnrestrictedDouble::SpecificTypes::kUnrestrictedDouble:
