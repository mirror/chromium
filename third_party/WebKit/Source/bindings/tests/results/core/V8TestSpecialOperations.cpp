...
static const int kV8TestSpecialOperationsTemplateForMainWorldIndex = 64;
static const int kV8TestSpecialOperationsTemplateForNonMainWorldIndex = 65;
static_assert(
    kV8TestSpecialOperationsTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestSpecialOperations::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestSpecialOperationsTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestSpecialOperationsTemplateForMainWorldIndex
                            : kV8TestSpecialOperationsTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestSpecialOperations::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestSpecialOperationsTemplateForMainWorldIndex) ||
         matches_template(kV8TestSpecialOperationsTemplateForNonMainWorldIndex);
}
