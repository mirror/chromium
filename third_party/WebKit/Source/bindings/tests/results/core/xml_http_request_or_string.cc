...
XMLHttpRequestOrString::XMLHttpRequestOrString() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const XMLHttpRequestOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case XMLHttpRequestOrString::SpecificTypes::kNone:
      return v8::Null(isolate);
    case XMLHttpRequestOrString::SpecificTypes::kString:
      return V8String(isolate, impl.GetAsString());
    case XMLHttpRequestOrString::SpecificTypes::kXMLHttpRequest:
