...
BooleanOrElementSequence::BooleanOrElementSequence() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const BooleanOrElementSequence& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case BooleanOrElementSequence::SpecificTypes::kNone:
      return v8::Null(isolate);
    case BooleanOrElementSequence::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case BooleanOrElementSequence::SpecificTypes::kElementSequence:
