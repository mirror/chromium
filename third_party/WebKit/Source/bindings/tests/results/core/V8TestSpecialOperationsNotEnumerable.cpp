...
static const int kV8TestSpecialOperationsNotEnumerableTemplateForMainWorldIndex = 66;
static const int kV8TestSpecialOperationsNotEnumerableTemplateForNonMainWorldIndex = 67;
static_assert(
    kV8TestSpecialOperationsNotEnumerableTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestSpecialOperationsNotEnumerable::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestSpecialOperationsNotEnumerableTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestSpecialOperationsNotEnumerableTemplateForMainWorldIndex
                            : kV8TestSpecialOperationsNotEnumerableTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestSpecialOperationsNotEnumerable::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestSpecialOperationsNotEnumerableTemplateForMainWorldIndex) ||
         matches_template(kV8TestSpecialOperationsNotEnumerableTemplateForNonMainWorldIndex);
}
