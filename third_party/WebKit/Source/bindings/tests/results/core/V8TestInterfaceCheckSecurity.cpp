...
static const int kV8TestInterfaceCheckSecurityTemplateForMainWorldIndex = 26;
static const int kV8TestInterfaceCheckSecurityTemplateForNonMainWorldIndex = 27;
static_assert(
    kV8TestInterfaceCheckSecurityTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceCheckSecurity::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceCheckSecurityTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceCheckSecurityTemplateForMainWorldIndex
                            : kV8TestInterfaceCheckSecurityTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceCheckSecurity::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceCheckSecurityTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceCheckSecurityTemplateForNonMainWorldIndex);
}
