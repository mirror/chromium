...
StringOrDouble::StringOrDouble() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const StringOrDouble& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case StringOrDouble::SpecificTypes::kNone:
      return v8::Null(isolate);
    case StringOrDouble::SpecificTypes::kDouble:
      return v8::Number::New(isolate, impl.GetAsDouble());
    case StringOrDouble::SpecificTypes::kString:
