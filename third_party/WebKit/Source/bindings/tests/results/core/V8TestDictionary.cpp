...
void V8TestDictionary::ToImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, TestDictionary& impl, ExceptionState& exceptionState) {
  ...
  if (!v8Object->Get(context, keys[10].Get(isolate)).ToLocal(&doubleOrNullSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[11].Get(isolate)).ToLocal(&doubleOrStringMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[12].Get(isolate)).ToLocal(&doubleOrStringSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[13].Get(isolate)).ToLocal(&elementOrNullMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[14].Get(isolate)).ToLocal(&elementOrNullSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[15].Get(isolate)).ToLocal(&enumMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[16].Get(isolate)).ToLocal(&enumSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[17].Get(isolate)).ToLocal(&eventTargetMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[18].Get(isolate)).ToLocal(&garbageCollectedRecordMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[19].Get(isolate)).ToLocal(&internalDictionarySequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[20].Get(isolate)).ToLocal(&longMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[22].Get(isolate)).ToLocal(&objectOrNullMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[25].Get(isolate)).ToLocal(&otherDoubleOrStringMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[26].Get(isolate)).ToLocal(&publicValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[27].Get(isolate)).ToLocal(&recordMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[28].Get(isolate)).ToLocal(&restrictedDoubleMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[31].Get(isolate)).ToLocal(&stringMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[32].Get(isolate)).ToLocal(&stringOrNullMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[33].Get(isolate)).ToLocal(&stringSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[34].Get(isolate)).ToLocal(&testEnumOrTestEnumSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[35].Get(isolate)).ToLocal(&testInterface2OrUint8ArrayMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[36].Get(isolate)).ToLocal(&testInterfaceGarbageCollectedMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[37].Get(isolate)).ToLocal(&testInterfaceGarbageCollectedOrNullMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[38].Get(isolate)).ToLocal(&testInterfaceGarbageCollectedSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[39].Get(isolate)).ToLocal(&testInterfaceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[40].Get(isolate)).ToLocal(&testInterfaceOrNullMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[41].Get(isolate)).ToLocal(&testInterfaceSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[42].Get(isolate)).ToLocal(&testObjectSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[43].Get(isolate)).ToLocal(&treatNullAsStringSequenceMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[44].Get(isolate)).ToLocal(&uint8ArrayMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[45].Get(isolate)).ToLocal(&unionInRecordMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[46].Get(isolate)).ToLocal(&unionMemberWithSequenceDefaultValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[47].Get(isolate)).ToLocal(&unionWithTypedefsValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (!v8Object->Get(context, keys[48].Get(isolate)).ToLocal(&unrestrictedDoubleMemberValue)) {
    exceptionState.RethrowV8Exception(block.Exception());
    return;
  }
  ...
  if (RuntimeEnabledFeatures::RuntimeFeatureEnabled()) {
    ...
    if (!v8Object->Get(context, keys[29].Get(isolate)).ToLocal(&runtimeMemberValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
    ...
    if (!v8Object->Get(context, keys[30].Get(isolate)).ToLocal(&runtimeSecondMemberValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (OriginTrials::featureNameEnabled(executionContext)) {
    ...
    if (!v8Object->Get(context, keys[23].Get(isolate)).ToLocal(&originTrialMemberValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
  ...
  if (OriginTrials::featureName1Enabled(executionContext)) {
    ...
    if (!v8Object->Get(context, keys[24].Get(isolate)).ToLocal(&originTrialSecondMemberValue)) {
      exceptionState.RethrowV8Exception(block.Exception());
      return;
    }
...
bool toV8TestDictionary(const TestDictionary& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  ...
  if (doubleOrNullSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[10].Get(isolate), doubleOrNullSequenceMemberValue))) {
    return false;
  }
  ...
  if (doubleOrStringMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[11].Get(isolate), doubleOrStringMemberValue))) {
    return false;
  }
  ...
  if (doubleOrStringSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[12].Get(isolate), doubleOrStringSequenceMemberValue))) {
    return false;
  }
  ...
  if (elementOrNullMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[13].Get(isolate), elementOrNullMemberValue))) {
    return false;
  }
  ...
  if (elementOrNullSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[14].Get(isolate), elementOrNullSequenceMemberValue))) {
    return false;
  }
  ...
  if (enumMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[15].Get(isolate), enumMemberValue))) {
    return false;
  }
  ...
  if (enumSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[16].Get(isolate), enumSequenceMemberValue))) {
    return false;
  }
  ...
  if (eventTargetMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[17].Get(isolate), eventTargetMemberValue))) {
    return false;
  }
  ...
  if (garbageCollectedRecordMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[18].Get(isolate), garbageCollectedRecordMemberValue))) {
    return false;
  }
  ...
  if (internalDictionarySequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[19].Get(isolate), internalDictionarySequenceMemberValue))) {
    return false;
  }
  ...
  if (longMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[20].Get(isolate), longMemberValue))) {
    return false;
  }
  ...
  if (objectOrNullMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[22].Get(isolate), objectOrNullMemberValue))) {
    return false;
  }
  ...
  if (otherDoubleOrStringMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[25].Get(isolate), otherDoubleOrStringMemberValue))) {
    return false;
  }
  ...
  if (publicHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[26].Get(isolate), publicValue))) {
    return false;
  }
  ...
  if (recordMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[27].Get(isolate), recordMemberValue))) {
    return false;
  }
  ...
  if (restrictedDoubleMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[28].Get(isolate), restrictedDoubleMemberValue))) {
    return false;
  }
  ...
  if (stringMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[31].Get(isolate), stringMemberValue))) {
    return false;
  }
  ...
  if (stringOrNullMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[32].Get(isolate), stringOrNullMemberValue))) {
    return false;
  }
  ...
  if (stringSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[33].Get(isolate), stringSequenceMemberValue))) {
    return false;
  }
  ...
  if (testEnumOrTestEnumSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[34].Get(isolate), testEnumOrTestEnumSequenceMemberValue))) {
    return false;
  }
  ...
  if (testInterface2OrUint8ArrayMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[35].Get(isolate), testInterface2OrUint8ArrayMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceGarbageCollectedMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[36].Get(isolate), testInterfaceGarbageCollectedMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceGarbageCollectedOrNullMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[37].Get(isolate), testInterfaceGarbageCollectedOrNullMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceGarbageCollectedSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[38].Get(isolate), testInterfaceGarbageCollectedSequenceMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[39].Get(isolate), testInterfaceMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceOrNullMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[40].Get(isolate), testInterfaceOrNullMemberValue))) {
    return false;
  }
  ...
  if (testInterfaceSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[41].Get(isolate), testInterfaceSequenceMemberValue))) {
    return false;
  }
  ...
  if (testObjectSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[42].Get(isolate), testObjectSequenceMemberValue))) {
    return false;
  }
  ...
  if (treatNullAsStringSequenceMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[43].Get(isolate), treatNullAsStringSequenceMemberValue))) {
    return false;
  }
  ...
  if (uint8ArrayMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[44].Get(isolate), uint8ArrayMemberValue))) {
    return false;
  }
  ...
  if (unionInRecordMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[45].Get(isolate), unionInRecordMemberValue))) {
    return false;
  }
  ...
  if (unionMemberWithSequenceDefaultHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[46].Get(isolate), unionMemberWithSequenceDefaultValue))) {
    return false;
  }
  ...
  if (unionWithTypedefsHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[47].Get(isolate), unionWithTypedefsValue))) {
    return false;
  }
  ...
  if (unrestrictedDoubleMemberHasValueOrDefault &&
      !V8CallBoolean(dictionary->CreateDataProperty(context, keys[48].Get(isolate), unrestrictedDoubleMemberValue))) {
    return false;
  }
  ...
  if (RuntimeEnabledFeatures::RuntimeFeatureEnabled()) {
    ...
    if (runtimeMemberHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[29].Get(isolate), runtimeMemberValue))) {
      return false;
    }
    ...
    if (runtimeSecondMemberHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[30].Get(isolate), runtimeSecondMemberValue))) {
      return false;
    }
  }
  ...
  if (OriginTrials::featureNameEnabled(executionContext)) {
    ...
    if (originTrialMemberHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[23].Get(isolate), originTrialMemberValue))) {
      return false;
    }
  }
  ...
  if (OriginTrials::featureName1Enabled(executionContext)) {
    ...
    if (originTrialSecondMemberHasValueOrDefault &&
        !V8CallBoolean(dictionary->CreateDataProperty(context, keys[24].Get(isolate), originTrialSecondMemberValue))) {
      return false;
    }
  }
