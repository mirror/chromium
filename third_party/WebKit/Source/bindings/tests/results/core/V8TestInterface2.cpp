...
static const int kV8TestInterface2TemplateForMainWorldIndex = 22;
static const int kV8TestInterface2TemplateForNonMainWorldIndex = 23;
static_assert(
    kV8TestInterface2TemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterface2::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), V8TestInterface2::installV8TestInterface2TemplateFunction);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterface2TemplateForMainWorldIndex
                            : kV8TestInterface2TemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterface2::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterface2TemplateForMainWorldIndex) ||
         matches_template(kV8TestInterface2TemplateForNonMainWorldIndex);
}
