...
DoubleOrLongOrBooleanSequence::DoubleOrLongOrBooleanSequence() : type_(SpecificTypes::kNone) {}
...
void DoubleOrLongOrBooleanSequence::SetLongOrBooleanSequence(const HeapVector<LongOrBoolean>& value) {
  ...
  type_ = SpecificTypes::kLongOrBooleanSequence;
}
...
v8::Local<v8::Value> ToV8(const DoubleOrLongOrBooleanSequence& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case DoubleOrLongOrBooleanSequence::SpecificTypes::kNone:
      return v8::Null(isolate);
    case DoubleOrLongOrBooleanSequence::SpecificTypes::kDouble:
      return v8::Number::New(isolate, impl.GetAsDouble());
    case DoubleOrLongOrBooleanSequence::SpecificTypes::kLongOrBooleanSequence:
