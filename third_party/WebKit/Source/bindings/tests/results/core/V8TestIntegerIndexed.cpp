...
static const int kV8TestIntegerIndexedTemplateForMainWorldIndex = 16;
static const int kV8TestIntegerIndexedTemplateForNonMainWorldIndex = 17;
static_assert(
    kV8TestIntegerIndexedTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestIntegerIndexed::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestIntegerIndexedTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestIntegerIndexedTemplateForMainWorldIndex
                            : kV8TestIntegerIndexedTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestIntegerIndexed::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestIntegerIndexedTemplateForMainWorldIndex) ||
         matches_template(kV8TestIntegerIndexedTemplateForNonMainWorldIndex);
}
