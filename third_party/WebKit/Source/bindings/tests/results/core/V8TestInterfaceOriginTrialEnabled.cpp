...
static const int kV8TestInterfaceOriginTrialEnabledTemplateForMainWorldIndex = 56;
static const int kV8TestInterfaceOriginTrialEnabledTemplateForNonMainWorldIndex = 57;
static_assert(
    kV8TestInterfaceOriginTrialEnabledTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceOriginTrialEnabled::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceOriginTrialEnabledTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceOriginTrialEnabledTemplateForMainWorldIndex
                            : kV8TestInterfaceOriginTrialEnabledTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceOriginTrialEnabled::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceOriginTrialEnabledTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceOriginTrialEnabledTemplateForNonMainWorldIndex);
}
