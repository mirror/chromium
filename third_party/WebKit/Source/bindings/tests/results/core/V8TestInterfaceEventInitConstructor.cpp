...
static const int kV8TestInterfaceEventInitConstructorTemplateForMainWorldIndex = 42;
static const int kV8TestInterfaceEventInitConstructorTemplateForNonMainWorldIndex = 43;
static_assert(
    kV8TestInterfaceEventInitConstructorTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceEventInitConstructor::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceEventInitConstructorTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceEventInitConstructorTemplateForMainWorldIndex
                            : kV8TestInterfaceEventInitConstructorTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceEventInitConstructor::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceEventInitConstructorTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceEventInitConstructorTemplateForNonMainWorldIndex);
}
