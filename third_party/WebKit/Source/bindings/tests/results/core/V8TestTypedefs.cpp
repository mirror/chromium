...
static const int kV8TestTypedefsTemplateForMainWorldIndex = 68;
static const int kV8TestTypedefsTemplateForNonMainWorldIndex = 69;
static_assert(
    kV8TestTypedefsTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestTypedefs::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestTypedefsTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestTypedefsTemplateForMainWorldIndex
                            : kV8TestTypedefsTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestTypedefs::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestTypedefsTemplateForMainWorldIndex) ||
         matches_template(kV8TestTypedefsTemplateForNonMainWorldIndex);
}
