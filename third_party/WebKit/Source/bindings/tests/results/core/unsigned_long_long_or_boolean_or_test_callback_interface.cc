...
UnsignedLongLongOrBooleanOrTestCallbackInterface::UnsignedLongLongOrBooleanOrTestCallbackInterface() : type_(SpecificTypes::kNone) {}
...
void UnsignedLongLongOrBooleanOrTestCallbackInterface::SetTestCallbackInterface(TestCallbackInterface* value) {
  ...
  type_ = SpecificTypes::kTestCallbackInterface;
}
...
void UnsignedLongLongOrBooleanOrTestCallbackInterface::SetUnsignedLongLong(uint64_t value) {
  ...
  type_ = SpecificTypes::kUnsignedLongLong;
}
...
v8::Local<v8::Value> ToV8(const UnsignedLongLongOrBooleanOrTestCallbackInterface& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case UnsignedLongLongOrBooleanOrTestCallbackInterface::SpecificTypes::kNone:
      return v8::Null(isolate);
    case UnsignedLongLongOrBooleanOrTestCallbackInterface::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case UnsignedLongLongOrBooleanOrTestCallbackInterface::SpecificTypes::kTestCallbackInterface:
      return ToV8(impl.GetAsTestCallbackInterface(), creationContext, isolate);
    case UnsignedLongLongOrBooleanOrTestCallbackInterface::SpecificTypes::kUnsignedLongLong:
