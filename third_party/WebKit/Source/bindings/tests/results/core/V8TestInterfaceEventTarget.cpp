...
static void V8TestInterfaceEventTargetConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE(info.GetIsolate(), "Blink_TestInterfaceEventTarget_ConstructorCallback");
...
void V8TestInterfaceEventTargetConstructor::NamedConstructorAttributeGetter(
  ...
  RUNTIME_CALL_TIMER_SCOPE(info.GetIsolate(), "Blink_TestInterfaceEventTarget_NamedConstructorAttributeGetter");
