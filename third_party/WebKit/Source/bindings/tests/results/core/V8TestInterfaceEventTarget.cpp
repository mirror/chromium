...
static const int kV8TestInterfaceEventTargetTemplateForMainWorldIndex = 44;
static const int kV8TestInterfaceEventTargetTemplateForNonMainWorldIndex = 45;
static_assert(
    kV8TestInterfaceEventTargetTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceEventTarget::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceEventTargetTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceEventTargetTemplateForMainWorldIndex
                            : kV8TestInterfaceEventTargetTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceEventTarget::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceEventTargetTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceEventTargetTemplateForNonMainWorldIndex);
}
