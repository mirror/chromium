...
static const int kV8TestInterfaceConstructor3TemplateForMainWorldIndex = 32;
static const int kV8TestInterfaceConstructor3TemplateForNonMainWorldIndex = 33;
static_assert(
    kV8TestInterfaceConstructor3TemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceConstructor3::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceConstructor3Template);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceConstructor3TemplateForMainWorldIndex
                            : kV8TestInterfaceConstructor3TemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceConstructor3::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceConstructor3TemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceConstructor3TemplateForNonMainWorldIndex);
}
