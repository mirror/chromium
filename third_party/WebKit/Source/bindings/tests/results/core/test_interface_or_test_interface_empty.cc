...
TestInterfaceOrTestInterfaceEmpty::TestInterfaceOrTestInterfaceEmpty() : type_(SpecificTypes::kNone) {}
...
void TestInterfaceOrTestInterfaceEmpty::SetTestInterface(TestInterfaceImplementation* value) {
  ...
  type_ = SpecificTypes::kTestInterface;
}
...
void TestInterfaceOrTestInterfaceEmpty::SetTestInterfaceEmpty(TestInterfaceEmpty* value) {
  ...
  type_ = SpecificTypes::kTestInterfaceEmpty;
}
...
v8::Local<v8::Value> ToV8(const TestInterfaceOrTestInterfaceEmpty& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case TestInterfaceOrTestInterfaceEmpty::SpecificTypes::kNone:
      return v8::Null(isolate);
    case TestInterfaceOrTestInterfaceEmpty::SpecificTypes::kTestInterface:
      return ToV8(impl.GetAsTestInterface(), creationContext, isolate);
    case TestInterfaceOrTestInterfaceEmpty::SpecificTypes::kTestInterfaceEmpty:
