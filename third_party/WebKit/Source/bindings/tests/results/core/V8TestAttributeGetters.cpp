...
static const int kV8TestAttributeGettersTemplateForMainWorldIndex = 6;
static const int kV8TestAttributeGettersTemplateForNonMainWorldIndex = 7;
static_assert(
    kV8TestAttributeGettersTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestAttributeGetters::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestAttributeGettersTemplateForMainWorldIndex
                            : kV8TestAttributeGettersTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestAttributeGetters::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestAttributeGettersTemplateForMainWorldIndex) ||
         matches_template(kV8TestAttributeGettersTemplateForNonMainWorldIndex);
}
