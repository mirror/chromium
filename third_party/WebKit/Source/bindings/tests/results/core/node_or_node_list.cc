...
NodeOrNodeList::NodeOrNodeList() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const NodeOrNodeList& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case NodeOrNodeList::SpecificTypes::kNone:
      return v8::Null(isolate);
    case NodeOrNodeList::SpecificTypes::kNode:
      return ToV8(impl.GetAsNode(), creationContext, isolate);
    case NodeOrNodeList::SpecificTypes::kNodeList:
