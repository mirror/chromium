...
static const int kV8TestInterface3TemplateForMainWorldIndex = 24;
static const int kV8TestInterface3TemplateForNonMainWorldIndex = 25;
static_assert(
    kV8TestInterface3TemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterface3::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterface3Template);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterface3TemplateForMainWorldIndex
                            : kV8TestInterface3TemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterface3::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterface3TemplateForMainWorldIndex) ||
         matches_template(kV8TestInterface3TemplateForNonMainWorldIndex);
}
