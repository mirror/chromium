...
static const int kV8TestInterfaceNodeTemplateForMainWorldIndex = 54;
static const int kV8TestInterfaceNodeTemplateForNonMainWorldIndex = 55;
static_assert(
    kV8TestInterfaceNodeTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceNode::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceNodeTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceNodeTemplateForMainWorldIndex
                            : kV8TestInterfaceNodeTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceNode::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceNodeTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceNodeTemplateForNonMainWorldIndex);
}
