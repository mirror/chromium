...
TestEnumOrDouble::TestEnumOrDouble() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const TestEnumOrDouble& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case TestEnumOrDouble::SpecificTypes::kNone:
      return v8::Null(isolate);
    case TestEnumOrDouble::SpecificTypes::kDouble:
      return v8::Number::New(isolate, impl.GetAsDouble());
    case TestEnumOrDouble::SpecificTypes::kTestEnum:
