...
static const int kV8TestInterfaceConstructor4TemplateForMainWorldIndex = 34;
static const int kV8TestInterfaceConstructor4TemplateForNonMainWorldIndex = 35;
static_assert(
    kV8TestInterfaceConstructor4TemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceConstructor4::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceConstructor4Template);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceConstructor4TemplateForMainWorldIndex
                            : kV8TestInterfaceConstructor4TemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceConstructor4::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceConstructor4TemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceConstructor4TemplateForNonMainWorldIndex);
}
