...
static void constructor1(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceConstructor4_ConstructorCallback");
...
void V8TestInterfaceConstructor4::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_USING_MAP(info.GetIsolate(), "Blink_TestInterfaceConstructor4_Constructor");
