...
static const int kV8TestInterfaceEmptyTemplateForMainWorldIndex = 40;
static const int kV8TestInterfaceEmptyTemplateForNonMainWorldIndex = 41;
static_assert(
    kV8TestInterfaceEmptyTemplateForNonMainWorldIndex < V8PerIsolateData::kInterfaceTemplateArraySize,
...
v8::Local<v8::FunctionTemplate> V8TestInterfaceEmpty::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world) {
  v8::Local<v8::FunctionTemplate> templ = V8DOMConfiguration::DomClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8TestInterfaceEmptyTemplate);
  ...
  if (per_isolate_data->GetV8ContextSnapshotMode() != V8PerIsolateData::V8ContextSnapshotMode::kTakeSnapshot) {
    per_isolate_data->SetInterfaceTemplateByIndex(
        world.IsMainWorld() ? kV8TestInterfaceEmptyTemplateForMainWorldIndex
                            : kV8TestInterfaceEmptyTemplateForNonMainWorldIndex,
        templ);
  }
  return templ;
}
...
bool V8TestInterfaceEmpty::hasInstance(v8::Local<v8::Value> v8Value, v8::Isolate* isolate) {
  ...
  return matches_template(kV8TestInterfaceEmptyTemplateForMainWorldIndex) ||
         matches_template(kV8TestInterfaceEmptyTemplateForNonMainWorldIndex);
}
