...
FloatOrBoolean::FloatOrBoolean() : type_(SpecificTypes::kNone) {}
...
v8::Local<v8::Value> ToV8(const FloatOrBoolean& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  switch (impl.type_) {
    case FloatOrBoolean::SpecificTypes::kNone:
      return v8::Null(isolate);
    case FloatOrBoolean::SpecificTypes::kBoolean:
      return v8::Boolean::New(isolate, impl.GetAsBoolean());
    case FloatOrBoolean::SpecificTypes::kFloat:
