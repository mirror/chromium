...
class V8TestInterfaceDocument {
 ...
 public:
  CORE_EXPORT_N662 static bool hasInstance(v8::Local<v8::Value>, v8::Isolate*);
  static v8::Local<v8::Object> findInstanceInPrototypeChain(v8::Local<v8::Value>, v8::Isolate*);
  CORE_EXPORT_N663 static v8::Local<v8::FunctionTemplate> domTemplate(v8::Isolate*, const DOMWrapperWorld&);
  ...
  CORE_EXPORT_N664 static TestInterfaceDocument* toImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
  CORE_EXPORT_N665 static const WrapperTypeInfo wrapperTypeInfo;
  ...
  CORE_EXPORT_N666 static void locationAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  CORE_EXPORT_N667 static void locationAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
};

template <>
struct NativeValueTraits<TestInterfaceDocument> : public NativeValueTraitsBase<TestInterfaceDocument> {
  CORE_EXPORT_N668 static TestInterfaceDocument* NativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
