...
void V8ContextSnapshot::InstallConditionalFeaturesOnObjects(
    v8::Local<v8::Context> context,
    Document* document) {
  ...
  v8::Local<v8::Object> global_proxy = context->Global();
  {
    ...
    type->InstallConditionalFeaturesOnObjects(
        context, world, window_wrapper, prototype, interface,
        type->domTemplate(isolate, world));
  ...
  }
  {
    ...
    type->InstallConditionalFeaturesOnObjects(
        context, world, v8::Local<v8::Object>(), prototype, interface,
        type->domTemplate(isolate, world));
    InstallConditionalFeatures(type, script_state, prototype, interface);
  }
  ...
  // The below code handles window.document on the main world.
  {
    ...
    type->InstallConditionalFeaturesOnObjects(
        context, world, document_wrapper, prototype, interface,
        type->domTemplate(isolate, world));
    InstallConditionalFeatures(type, script_state, prototype, interface);
  }
  {
