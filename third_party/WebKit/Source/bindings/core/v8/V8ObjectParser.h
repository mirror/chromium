...
class CORE_EXPORT V8ObjectParser final {
 ...
 public:
  ...
  static bool ParsePrototype(v8::Isolate*,
                             v8::Local<v8::Context>,
  ...
  static bool ParseFunction(v8::Isolate*,
                            v8::Local<v8::Context>,
                            v8::Local<v8::Object> prototype,
  ...
  static bool ParseGeneratorFunction(v8::Isolate*,
                                     v8::Local<v8::Context>,
                                     v8::Local<v8::Object> prototype,
                                     const AtomicString function_name,
                                     v8::Local<v8::Function>*,
  ...
  static bool ParseCSSPropertyList(v8::Isolate*,
                                   v8::Local<v8::Context>,
                                   v8::Local<v8::Function> constructor,
