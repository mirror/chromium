...
bool V8ScriptValueSerializer::WriteDOMObject(ScriptWrappable* wrappable,
  ...
  if (wrapper_type_info == &V8ImageBitmap::wrapperTypeInfo) {
    ...
    WriteUint32Enum<SerializedColorSpace>(
        color_params.GetSerializedColorSpace());
    WriteUint32Enum<ImageSerializationTag>(
        ImageSerializationTag::kCanvasPixelFormatTag);
    WriteUint32Enum<SerializedPixelFormat>(
        color_params.GetSerializedPixelFormat());
    WriteUint32Enum<ImageSerializationTag>(ImageSerializationTag::kOriginClean);
    WriteUint32(image_bitmap->OriginClean());
    WriteUint32Enum<ImageSerializationTag>(
        ImageSerializationTag::kIsPremultiplied);
    WriteUint32(image_bitmap->IsPremultiplied());
    WriteUint32Enum<ImageSerializationTag>(ImageSerializationTag::kEndTag);
  ...
  if (wrapper_type_info == &V8ImageData::wrapperTypeInfo) {
    ...
    WriteUint32Enum<SerializedImageDataStorageFormat>(
        color_params.GetSerializedImageDataStorageFormat());
    WriteUint32Enum<ImageSerializationTag>(ImageSerializationTag::kEndTag);
