...
TEST(NativeValueTraitsImplTest, IDLRecord) {
  ...
  }
  {
    ...
    EXPECT_TRUE(V8CallBoolean(
        v8_object->Set(scope.GetContext(), ToV8(&scope, "foo"), ToV8(&scope, 34))));
    EXPECT_TRUE(V8CallBoolean(v8_object->Set(
        scope.GetContext(), ToV8(&scope, "bar"), ToV8(&scope, -1024))));
    EXPECT_TRUE(V8CallBoolean(
        v8_object->Set(scope.GetContext(), ToV8(&scope, "foo"), ToV8(&scope, 42))));
  ...
  }
  {
    ...
    EXPECT_TRUE(V8CallBoolean(v8_object->DefineOwnProperty(
        scope.GetContext(), V8String(scope.GetIsolate(), "bar"), ToV8(&scope, -1024),
        v8::PropertyAttribute::DontEnum)));
    EXPECT_TRUE(V8CallBoolean(
        v8_object->Set(scope.GetContext(), ToV8(&scope, "baz"), ToV8(&scope, 42))));
  ...
  }
  {
    ...
    EXPECT_TRUE(
        V8String(scope.GetIsolate(), "bogus!")
            ->Equals(v8_exception->ToString(scope.GetContext()).ToLocalChecked()));
  }
  {
    v8::Local<v8::Object> v8_object = v8::Object::New(scope.GetIsolate());
    EXPECT_TRUE(V8CallBoolean(
        v8_object->Set(scope.GetContext(), ToV8(&scope, "foo"), ToV8(&scope, 42))));
    EXPECT_TRUE(V8CallBoolean(
        v8_object->Set(scope.GetContext(), ToV8(&scope, "bar"), ToV8(&scope, 0))));
    EXPECT_TRUE(V8CallBoolean(v8_object->Set(scope.GetContext(), ToV8(&scope, "xx"),
                                            ToV8(&scope, true))));
    EXPECT_TRUE(V8CallBoolean(v8_object->Set(
  ...
  {
    v8::Local<v8::Object> v8_parent_object = v8::Object::New(scope.GetIsolate());
    ...
    v8::Local<v8::Object> v8_object = v8::Object::New(scope.GetIsolate());
    EXPECT_TRUE(
        V8CallBoolean(v8_object->SetPrototype(scope.GetContext(), v8_parent_object)));
  ...
  }
  {
    ...
    v8::Local<v8::Object> v8_object = v8::Object::New(scope.GetIsolate());
    EXPECT_TRUE(V8CallBoolean(v8_object->Set(
        scope.GetContext(), ToV8(&scope, "foo"), ToV8(&scope, v8_string_array))));
