...
V8IntersectionObserverCallback::V8IntersectionObserverCallback(
    ...
    : callback_(script_state->GetIsolate(), callback), script_state_(script_state) {
...
void V8IntersectionObserverCallback::HandleEvent(
  ...
  v8::Local<v8::Value> observer_handle = ToV8(
      &observer, script_state_->GetContext()->Global(), script_state_->GetIsolate());
  ...
  v8::Local<v8::Value> entries_handle = ToV8(
      entries, script_state_->GetContext()->Global(), script_state_->GetIsolate());
  ...
  V8ScriptRunner::CallFunction(callback_.NewLocal(script_state_->GetIsolate()),
                               script_state_->GetExecutionContext(), this_object,
                               2, argv, script_state_->GetIsolate());
}
