...
TEST(V8BindingTest, toImplSequence) {
  ...
  {
    v8::Local<v8::Array> v8_string_array = v8::Array::New(scope.GetIsolate(), 2);
    v8_string_array
        ->Set(scope.GetContext(), ToV8(&scope, 0), ToV8(&scope, "Hello, World!"))
        .ToChecked();
    v8_string_array
...
TEST(V8BindingTest, toImplArray) {
  ...
  {
    v8::Local<v8::Array> v8_unsigned_array = v8::Array::New(scope.GetIsolate(), 3);
  ...
  }
  {
    ...
    EXPECT_TRUE(V8CallBoolean(v8_real_array->Set(scope.GetContext(), ToV8(&scope, 0),
                                               ToV8(&scope, kDoublePi))));
  ...
  }
  {
    ...
    EXPECT_TRUE(V8CallBoolean(v8_array->Set(scope.GetContext(), ToV8(&scope, 0),
    ...
    Vector<v8::Local<v8::Value>> v8_handle_vector =
        ToImplArray<Vector<v8::Local<v8::Value>>>(v8_array, 0, scope.GetIsolate(),
                                                  exception_state);
    ...
    EXPECT_EQ(65535U, ToUInt32(scope.GetIsolate(), script_value_vector[1].V8Value(),
                               kNormalConversion, exception_state));
  }
  {
    v8::Local<v8::Array> v8_string_array1 = v8::Array::New(scope.GetIsolate(), 2);
    ...
    v8::Local<v8::Array> v8_string_array2 = v8::Array::New(scope.GetIsolate(), 3);
    ...
    Vector<Vector<String>> string_vector_vector =
        ToImplArray<Vector<Vector<String>>>(v8_string_array_array, 0,
                                            scope.GetIsolate(), exception_state);
