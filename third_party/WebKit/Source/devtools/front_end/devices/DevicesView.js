...
Devices.DevicesView = class extends UI.VBox {
        ...
        <div class='vbox' style='align-items: stretch; flex: 0 0 150px; padding-top: 15px;'}>
          ...
          <div class='vbox' style='align-items:stretch; flex: none;'>
            ...
            <div ${{discoveryListItem: 0,
                 click: event => this._selectSidebarListItem(event.currentTarget, this._discoveryView)}}
  ...
  _createSidebarListItem(view) {
    return html`
      <div class='devices-sidebar-item' ${{click: event => this._selectSidebarListItem(event.currentTarget, view)}}>
        <div class='devices-sidebar-item-title'>${{title: ''}}</div>
        <div class='devices-sidebar-item-status'>${{status: ''}}</div>
      </div>
    `;
  }
