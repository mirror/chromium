...
Devices.NodeConnectionsPanel = class extends UI.Panel {
  constructor() {
    super('node-connection');
    this.registerRequiredCSS('devices/nodeConnectionsPanel.css');
    ...
    this._networkDiscoveryView = new Devices.NodeConnectionsView(config => {
 ...
 */
Devices.NodeConnectionsView = class extends UI.VBox {
  /**
  ...
  constructor(callback) {
    ...
    this._list.registerRequiredCSS('devices/nodeConnectionsPanel.css');
