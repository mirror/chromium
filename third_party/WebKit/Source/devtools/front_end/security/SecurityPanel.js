...
Security.SecurityPanel = class extends UI.PanelWithSidebar {
  ...
  static addHighlightedUrl(parent, url, schemeCssId, schemeSeparatorCssId) {
    var schemeSeparator = '://';
    ...
    parent.createChild('span', schemeCssId).textContent = scheme;
    parent.createChild('span', schemeSeparatorCssId).textContent = schemeSeparator;
    parent.createChild('span').textContent  = content;
  }
...
Security.SecurityOriginView = class extends UI.VBox {
  ...
  constructor(panel, origin, originState) {
    ...
    titleSection.createChild('div', 'title-section-header').textContent =
        'Origin';
    ...
    Security.SecurityPanel.addHighlightedUrl(originDisplay, origin,
        'origin-' + originState.securityState, 'origin-scheme-separator');

    var originNetworkLink = titleSection.createChild('div', 'view-network-button');
    originNetworkLink.appendChild(
      UI.createTextButton('View requests in Network Panel', async e => {
        e.consume();
