...
TimelineModel.TimelineJSProfileProcessor = class {
  ...
  static nativeGroup(nativeName) {
    ...
    if (map.has(nativeName))
      return map.get(nativeName);
    var group = null;
    if (nativeName.startsWith('Parse'))
      group = TimelineModel.TimelineJSProfileProcessor.NativeGroups.Parse;
    else if (nativeName.startsWith('Compile') || nativeName.startsWith('Recompile'))
      group = TimelineModel.TimelineJSProfileProcessor.NativeGroups.Compile;
    map.set(nativeName, group);
    return group;
  }
