...
ColorPicker.ContrastDetails = class {
  ...
  constructor(contrastInfo, contentElement, toggleMainColorPickerCallback, expandedChangedCallback) {
    ...
    /** @type {!Element} */
    this._contrastDetails = contentElement.createChild('div', 'spectrum-contrast-details collapsed');
  ...
  _update() {
    ...
    this._contrastDetails.classList.toggle('contrast-fail', !this._passesAA);
  ...
  setVisible(visible) {
    this._visible = visible;
    this._contrastDetails.classList.toggle('hidden', !visible);
  }
