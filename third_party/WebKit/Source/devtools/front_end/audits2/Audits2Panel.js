...
Audits2.Audits2Panel = class extends UI.Panel {
  ...
  _start() {
    ...
    return Promise.resolve()
        ...
        .then(_ => this._protocolService.startLighthouse(this._inspectedURL, categoryIDs, Host.isUnderTest()))
...
Audits2.ProtocolService = class extends Common.Object {
   ...
   */
  startLighthouse(inspectedURL, categoryIDs, disableLogging = false) {
    return this._send('start', {url: inspectedURL, categoryIDs, disableLogging});
  }
