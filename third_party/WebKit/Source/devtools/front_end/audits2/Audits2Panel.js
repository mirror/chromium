...
Audits2.Audits2Panel = class extends UI.Panel {
  constructor() {
    ...
    var downloadButton = new UI.ToolbarButton(Common.UIString('Download report'), 'largeicon-step-in');
    ...
    toolbar.appendToolbarItem(this._reportSelector);
  ...
  _buildReportUI(lighthouseResult) {
    ...
    var optionElement = new Audits2.ReportSelector.Item(lighthouseResult, this._auditResultsElement, this._showLandingPage.bind(this));
...
Audits2.ReportSelector = class extends UI.ToolbarComboBox {
  constructor() {
    super(/** {!Common.Event} */ event => {
    ...
    this.selectElement().style.minWidth = '200px';
