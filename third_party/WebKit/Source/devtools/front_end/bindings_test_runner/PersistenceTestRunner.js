...
class TestMapping {
  ...
  async addBinding(urlSuffix) {
    ...
    var networkUISourceCode = await SourcesTestRunner.waitForUISourceCode(urlSuffix, Workspace.projectTypes.Network);
    var fileSystemUISourceCode = await SourcesTestRunner.waitForUISourceCode(urlSuffix, Workspace.projectTypes.FileSystem);
