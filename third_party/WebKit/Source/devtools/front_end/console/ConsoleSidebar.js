...
Console.ConsoleSidebar = class extends UI.VBox {
  constructor() {
    ...
    /** @type {?Console.ConsoleSidebar.URLGroupTreeElement} */
    ...
    for (var filter of filters) {
      var group = new Console.ConsoleSidebar.FilterTreeElement(filter);
      this._tree.appendChild(group);
  ...
  _selectionChanged(event) {
    this._selectedTreeElement = /** @type {!Console.ConsoleSidebar.URLGroupTreeElement} */ (event.data);
