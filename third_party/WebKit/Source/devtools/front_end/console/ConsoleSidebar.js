...
Console.ConsoleSidebar = class extends UI.VBox {
  constructor() {
    ...
    this._defaultFilter = new Console.ConsoleFilter(
        Common.UIString('Default'), null, Console.ConsoleViewFilter.defaultLevelsFilterValue());
  ...
  onMessageAdded(message) {
    ...
    if (context) {
      ...
      if (!item) {
        var filter = {key: Console.ConsoleViewFilter.FilterType.Context, text: context, negative: false};
