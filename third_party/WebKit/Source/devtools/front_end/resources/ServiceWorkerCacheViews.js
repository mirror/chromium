...
Resources.ServiceWorkerCacheView = class extends UI.SimpleView {
  ...
  _sortingChanged() {
    ...
    var children = this._dataGrid.rootNode().children;
  ...
  _createRequest(entry) {
    var request = new SDK.NetworkRequest('har-' + entry.requestURL, entry.requestURL, '', '', '', null);
    ...
    request.resourceSize = header ? (header.value | 0) || 0 : 0;
