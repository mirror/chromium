...
Resources.ServiceWorkerCacheView = class extends UI.SimpleView {
  ...
  constructor(model, cache) {
    ...
    /** @type {!Array<!Resources._Response>} */
  ...
  _responseForUrl(url) {
    ...
    if (index >= 0) {
      ...
      response = new Resources._Response(this._cache, url);
    }
...
Resources._Response = class {
  ...
  async _innerPreview(cache) {
    ...
    var provider = new Resources._ResponseContentProvider(this.url, resourceType, body);
 ...
 */
Resources._ResponseContentProvider = class {
  /**
   * @param {string} url
