...
NodeOnly.NodePanel = class extends UI.Panel {
  constructor() {
    super('node-connection');
    this.registerRequiredCSS('node_only/nodePanel.css');
    ...
    this._networkDiscoveryView = new NodeOnly.NodePanel.DiscoveryView((config) => {
 ...
 */
NodeOnly.NodePanel.DiscoveryView = class extends UI.VBox {
  /**
  ...
  constructor(callback) {
    ...
    this._list.registerRequiredCSS('node_only/nodePanel.css');
