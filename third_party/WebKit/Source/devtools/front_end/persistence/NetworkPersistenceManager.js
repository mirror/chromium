...
Persistence.NetworkPersistenceManager = class extends Common.Object {
  ...
  removeFileSystemProject(project) {
    ...
    var settingData = /** @type {!Array<!Array<string>>} */ ([]);
    for (fileSystemPath of this._domainPathForFileSystemMap.keys())
      settingData.push([fileSystemPath, this._domainPathForFileSystemMap.get(fileSystemPath)]);
    this._domainPathForFileSystemPathSetting.set(settingData);
