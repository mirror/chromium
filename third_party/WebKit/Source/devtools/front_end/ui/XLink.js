...
UI.XLink.ContextMenuProvider = class {
  ...
  appendApplicableItems(event, contextMenu, target) {
    var href = (/** @type {!UI.XLink} */ (target))._href;
    if (!href)
      return;
    contextMenu.revealSection().appendItem(
        UI.openLinkExternallyLabel(), () => InspectorFrontendHost.openInNewTab(/** @type {string} */ (href)));
    contextMenu.revealSection().appendItem(
        UI.copyLinkAddressLabel(), () => InspectorFrontendHost.copyText(/** @type {string} */ (href)));
  }
};
