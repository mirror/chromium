...
ElementsTestRunner.accessibilitySidebarPane = function() {
  return self.runtime.sharedInstance(Accessibility.AccessibilitySidebarView);
};

ElementsTestRunner.selectNodeAndWaitForAccessibility = function(idValue) {
...
ElementsTestRunner.dumpSelectedElementAccessibilityNode = function() {
  var sidebarPane = ElementsTestRunner.accessibilitySidebarPane();
  ...
  ElementsTestRunner.dumpAccessibilityNode(sidebarPane._axNodeSubPane._axNode);
};

ElementsTestRunner.dumpAccessibilityNode = function(accessibilityNode) {
...
ElementsTestRunner.findARIAAttributeTreeElement = function(attribute) {
  var sidebarPane = ElementsTestRunner.accessibilitySidebarPane();
