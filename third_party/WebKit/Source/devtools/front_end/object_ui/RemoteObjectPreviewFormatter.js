...
ObjectUI.RemoteObjectPreviewFormatter = class {
  ...
  static _objectPropertyComparator(a, b) {
    ...
    function sortValue(property) {
      if (property.name === ObjectUI.RemoteObjectPreviewFormatter._internalName.PromiseStatus)
        return 1;
      else if (property.name === ObjectUI.RemoteObjectPreviewFormatter._internalName.PromiseValue)
        return 2;
