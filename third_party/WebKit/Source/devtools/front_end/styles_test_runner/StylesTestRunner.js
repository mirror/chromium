...
StylesTestRunner.sassSourceMapFactory = function() {
...
StylesTestRunner.parseSCSS = function(url, text) {
  return Sass.SASSSupport.parseSCSS(url, text);
};

StylesTestRunner.parseCSS = StylesTestRunner.parseSCSS;

StylesTestRunner.loadASTMapping = function(header, callback) {
...
StylesTestRunner.dumpAST = function(ast) {
...
StylesTestRunner.dumpASTDiff = function(diff) {
...
StylesTestRunner.validateASTRanges = function(ast) {
  var invalidNodes = [];
...
StylesTestRunner.validateMapping = function(mapping) {
...
StylesTestRunner.updateCSSText = function(url, newText) {
...
StylesTestRunner.updateSASSText = function(url, newText) {
  var uiSourceCode = Workspace.workspace.uiSourceCodeForURL(url);
  uiSourceCode.addRevision(newText);
};

StylesTestRunner.runCSSEditTests = function(header, tests) {
  var astSourceMap;
  StylesTestRunner.loadASTMapping(header, onMapping);
...
StylesTestRunner.createEdit = function(source, pattern, newText, matchNumber) {
