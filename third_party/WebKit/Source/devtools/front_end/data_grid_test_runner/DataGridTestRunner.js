 ...
 */
TestRunner.dumpDataGrid = function(dataGrid) {
  TestRunner.addResult(TestRunner.dumpDataGridIntoString(dataGrid));
};
 ...
 * @return {string}
 */
TestRunner.dumpDataGridIntoString = function(dataGrid) {
