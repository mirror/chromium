...
Network.NetworkLogViewColumns = class {
  ...
  _configureTimeDividers() {
    // TODO(allada) Add timing info into column header.
    var dividersData = PerfUI.TimelineGrid.calculateDividerOffsets(this._networkLogView.calculator());
  ...
  _updateColumns() {
    ...
    if (!visibleColumns['waterfall'] && this._waterfallInnerContainer) {
