...
Network.NetworkWaterfallColumn = class extends UI.VBox {
  ...
  _draw() {
    ...
    PerfUI.TimelineGrid.drawCanvasGrid(context, this._calculator, this._fontSize, 0, freeZoneAtLeft);
    context.clearRect(this._offsetWidth - freeZoneAtRight, 0, freeZoneAtRight, 0);
