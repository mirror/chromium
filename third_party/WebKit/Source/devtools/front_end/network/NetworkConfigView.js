...
Network.NetworkConfigView = class extends UI.VBox {
  ...
  _createFileServingSection() {
    ...
    var header = section.createChild('div', 'mapping-list-header');
    header.createChild('div', 'mapping-list-header-url').textContent = Common.UIString('URL');
    header.createChild('div', 'mapping-list-header-file').textContent = Common.UIString('File');
