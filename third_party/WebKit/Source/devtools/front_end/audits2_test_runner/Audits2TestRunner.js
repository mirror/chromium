...
Audits2TestRunner.getResultsElement = function() {
  return Audits2TestRunner._panel()._getAuditResultsElementForTest();
};
...
Audits2TestRunner.getDialogElement = function() {
  return Audits2TestRunner._panel()._getDialogForTest().contentElement.shadowRoot.querySelector('.audits2-view');
};
...
Audits2TestRunner.dumpDialogState = function() {
  ...
  var dialog = Audits2TestRunner._panel()._getDialogForTest();
