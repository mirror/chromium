...
Profiler.SamplingHeapProfileType = class extends Profiler.SamplingHeapProfileTypeBase {
  ...
  get description() {
    return ls`Record memory allocations using sampling method.
              This has minimal performance overhead and can be used for long running operations.
              This profile type provides good approximation of allocations broken down
              by JavaScript execution stack.`;
  }
