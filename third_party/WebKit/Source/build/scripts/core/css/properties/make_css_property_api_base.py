...
class ApiClassData(
        namedtuple('ApiClassData', 'enum_value,property_id,classname,namespace')):
    pass
...
class CSSPropertyWriter(json5_generator.Writer):
    def __init__(self, json5_file_paths):
        ...
        self._outputs = {
            'CSSProperty.h': self.generate_property_api_header,
            'CSSProperty.cpp': self.generate_property_api_implementation,
        }
