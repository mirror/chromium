...
class CSSPropertyHeadersWriter(CSSPropertyWriter):
    def __init__(self, json5_file_paths):
        ...
        for property_ in properties:
            ...
            self.resolve_style_builder_settings(property_)
    ...
    def resolve_style_builder_settings(self, property_):
        ...
        if property_['custom_apply_functions_all']:
            if property_['upper_camel_name'] in ['Clip', 'ColumnCount', 'ColumnWidth', 'ZIndex']:
