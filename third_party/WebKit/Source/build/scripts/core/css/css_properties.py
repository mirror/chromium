...
from core.css.field_alias_helper import FieldAliasHelper
...
class CSSProperties(json5_generator.Writer):
    def __init__(self, file_paths):
        ...
        field_alias_helper = FieldAliasHelper(file_paths[1])
        for offset, property_ in enumerate(properties):
            ...
            self.expand_parameters(property_, field_alias_helper)
    ...
    def expand_parameters(self, property_, field_alias_helper):
        ...
        field_alias_helper.expand_field_alias(property_)
