...
ALIGNMENT_ORDER = [
    ...
    # Aligns like char
    'StyleSelfAlignmentData', 'StyleContentAlignmentData', 'TextEmphasisPosition', 'uint8_t', 'char',
    # Aligns like bool
    'bool'
]
...
class Field(object):
    ...
    def __init__(self, field_role, name_for_methods, property_name, type_name, wrapper_pointer_name,
                 ...
                 getter_method_name, setter_method_name, initial_method_name, custom_functions, **kwargs):
        """Creates a new field."""
...
def _create_property_field(property_):
    ...
    return Field(
        ...
        custom_functions=property_['custom_functions'],
    )
