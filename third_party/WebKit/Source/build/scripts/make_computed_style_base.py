...
class ComputedStyleBaseWriter(css_property_field_writer.CSSPropertyFieldWriter):
    def __init__(self, json5_file_paths):
        # Read CSSProperties.json5
        super(ComputedStyleBaseWriter, self).__init__(json5_file_paths[0], json5_file_paths[1],
                                                      json5_file_paths[3], json5_file_paths[5], json5_file_paths[4])

        self._generated_enums = _create_enums(self._all_fields)
        ...
        self._root_group = _create_groups(self._all_fields, alias_dictionary)
        ...
        self._include_paths = _get_include_paths(self._all_fields)
        self._outputs = {
