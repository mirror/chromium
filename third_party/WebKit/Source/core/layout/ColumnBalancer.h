...
class ColumnBalancer {
 protected:
  ...
  LayoutUnit OffsetFromColumnLogicalTop(LayoutUnit offset_in_flow_thread) const {
  ...
  bool IsLogicalBottomWithinBounds(LayoutUnit logical_bottom_in_flow_thread) const {
...
class InitialColumnHeightFinder final : public ColumnBalancer {
 ...
 private:
  ...
  void ExamineBoxBeforeLeaving(const LayoutBox&, LayoutUnit child_logical_height);
  ...
  void RecordStrutBeforeOffset(LayoutUnit offset_in_flow_thread, LayoutUnit strut);
