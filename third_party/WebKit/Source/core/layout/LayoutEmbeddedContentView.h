...
#ifndef LayoutEmbeddedContentView_h
#define LayoutEmbeddedContentView_h
...
class CORE_EXPORT LayoutEmbeddedContentView : public LayoutReplaced {
 public:
  explicit LayoutEmbeddedContentView(Element*);
  ~LayoutEmbeddedContentView() override;
  ...
  // LayoutEmbeddedContentView::ChildFrameView returns the LocalFrameView
  ...
  bool IsLayoutEmbeddedContentView() const final { return true; }
...
DEFINE_LAYOUT_OBJECT_TYPE_CASTS(LayoutEmbeddedContentView,
                                IsLayoutEmbeddedContentView());

}  // namespace blink

#endif  // LayoutEmbeddedContentView_h
