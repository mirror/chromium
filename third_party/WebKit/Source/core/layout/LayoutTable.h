...
class CORE_EXPORT LayoutTable final : public LayoutBlock {
 public:
  ...
  bool IsAbsoluteColumnCollapsed(unsigned absolute_column_index);

  bool IsAnyColumnEverCollapsed() { return is_any_column_ever_collapsed_; }

  void SetIsAnyColumnEverCollapsed(bool isAnyColumnEverCollapsed) {
    is_any_column_ever_collapsed_ = isAnyColumnEverCollapsed;
  }
