...
TEST_P(ScrollAnchorTest, UMAMetricUpdated) {
  ...
  SerializedAnchor bad_anchor("#bl", LayoutPoint(0, 0));
  ...
  histogram_tester.ExpectTotalCount("Layout.ScrollAnchor.RestorationSuccess",
                                    2);
  histogram_tester.ExpectTotalCount("Layout.ScrollAnchor.TimeToRestoreAnchor",
                                    2);
  histogram_tester.ExpectBucketCount("Layout.ScrollAnchor.RestorationSuccess",
                                     0, 1);
}
