...
// TODO(crbug.com/409155, crbug.com/736072): For now the logical directions
// (start, end, before, after) are in table direction which may be different
// from the cell's direction if we support mixed writing-mode/direction at the
// cell level.
