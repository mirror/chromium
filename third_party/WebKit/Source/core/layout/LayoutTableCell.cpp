...
void LayoutTableCell::AddLayerHitTestRects(
  ...
  LayoutBox::AddLayerHitTestRects(layer_rects, current_layer, adjusted_layer_offset,
                                  container_rect);
}
...
void LayoutTableCell::ComputeIntrinsicPadding(int row_height,
  ...
  switch (vertical_align) {
    ...
    case EVerticalAlign::kBottom:
      intrinsic_padding_before = row_height - logical_height_without_intrinsic_padding;
      break;
    case EVerticalAlign::kBaselineMiddle:
      break;
  }

  int intrinsic_padding_after =
      row_height - logical_height_without_intrinsic_padding - intrinsic_padding_before;
...
LayoutRect LayoutTableCell::LocalVisualRect() const {
  ...
  LayoutPoint location(std::max(LayoutUnit(left), -self_visual_overflow_rect.X()),
...
CollapsedBorderValue LayoutTableCell::ComputeCollapsedStartBorder(
  ...
  if (start_border_adjoins_table) {
    ...
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? Parent()->ResolveColor(start_color_property) : Color(),
    ...
    result = ChooseBorder(
        result, CollapsedBorderValue(
                    ...
                    include_color ? Section()->ResolveColor(start_color_property)
                                 : Color(),
  ...
  if (col_and_col_group.colgroup && col_and_col_group.adjoins_start_border_of_col_group) {
  ...
  if (col_and_col_group.col) {
    ...
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? col_and_col_group.col->ResolveColor(start_color_property)
                         : Color(),
  ...
  if (cell_before) {
    ...
    // Only apply the colgroup's border if this cell touches the colgroup edge.
    if (col_and_col_group.colgroup && col_and_col_group.adjoins_end_border_of_col_group) {
      result = ChooseBorder(
          CollapsedBorderValue(
    ...
    if (col_and_col_group.col) {
      result = ChooseBorder(
          CollapsedBorderValue(
              ...
              include_color ? col_and_col_group.col->ResolveColor(end_color_property)
                           : Color(),
              kBorderPrecedenceColumn),
          result);
      if (!result.Exists())
  ...
  if (!is_end_column) {
    if (LayoutTableCell* cell_after = table->CellAfter(this)) {
      CollapsedBorderValue cell_after_adjoining_border = CollapsedBorderValue(
          ...
          include_color ? cell_after->ResolveColor(start_color_property) : Color(),
          kBorderPrecedenceCell);
  ...
  if (end_border_adjoins_table) {
    ...
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? Parent()->ResolveColor(end_color_property) : Color(),
            kBorderPrecedenceRow));
    if (!result.Exists())
      return result;
    ...
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? Section()->ResolveColor(end_color_property) : Color(),
            kBorderPrecedenceRowGroup));
    if (!result.Exists())
      return result;
  }
...
CollapsedBorderValue LayoutTableCell::ComputeCollapsedBeforeBorder(
  ...
  if (prev_cell) {
    ...
    result = ChooseBorder(
        CollapsedBorderValue(
            prev_cell->Style()->BorderAfter(),
            include_color ? prev_cell->ResolveColor(after_color_property) : Color(),
            kBorderPrecedenceCell),
        result);
    if (!result.Exists())
      return result;
  ...
  result = ChooseBorder(
      ...
      CollapsedBorderValue(
          ...
          include_color ? Parent()->ResolveColor(before_color_property) : Color(),
          kBorderPrecedenceRow));
  if (!result.Exists())
    return result;
  ...
  if (!curr_section) {
    ...
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? table->ResolveColor(before_color_property) : Color(),
            kBorderPrecedenceTable));
    if (!result.Exists())
      return result;
  }
...
CollapsedBorderValue LayoutTableCell::ComputeCollapsedAfterBorder(
  ...
  if (next_cell) {
    ...
    result = ChooseBorder(
        result, CollapsedBorderValue(
                    next_cell->Style()->BorderBefore(),
                    include_color ? next_cell->ResolveColor(before_color_property)
                                 : Color(),
                    kBorderPrecedenceCell));
    if (!result.Exists())
      return result;
  ...
  result = ChooseBorder(
      ...
      CollapsedBorderValue(
          ...
          include_color ? Parent()->ResolveColor(after_color_property) : Color(),
          kBorderPrecedenceRow));
  if (!result.Exists())
    return result;
  ...
  if (next_cell) {
    result = ChooseBorder(
        ...
        CollapsedBorderValue(
            ...
            include_color ? next_cell->Parent()->ResolveColor(before_color_property)
                         : Color(),
            kBorderPrecedenceRow));
    if (!result.Exists())
      return result;
  ...
  if (!curr_section) {
    ...
    if (col_elt) {
      result = ChooseBorder(
          result,
          CollapsedBorderValue(
              col_elt->Style()->BorderAfter(),
              include_color ? col_elt->ResolveColor(after_color_property) : Color(),
              kBorderPrecedenceColumn));
      if (!result.Exists())
        return result;
      if (LayoutTableCol* enclosing_column_group =
...
LayoutUnit LayoutTableCell::BorderHalfRight(bool outer) const {
  ...
  return style_for_cell_flow.IsFlippedBlocksWritingMode() ? BorderHalfBefore(outer)
                                                       : BorderHalfAfter(outer);
}
...
void LayoutTableCell::PaintBoxDecorationBackground(
    ...
    const LayoutPoint& paint_offset) const {
  TableCellPainter(*this).PaintBoxDecorationBackground(paint_info, paint_offset);
}
