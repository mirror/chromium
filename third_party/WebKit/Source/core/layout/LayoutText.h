...
class CORE_EXPORT LayoutText : public LayoutObject {
 public:
  ...
  // Returns true if the offset (0-based in the Text() string)is next to a non-
  // collapsed non-linebreak character, or before a forced linebreak (<br>, or
  // segment break in node with style white-space: pre/pre-line/pre-wrap).
