...
class CORE_EXPORT NGFragmentBuilder final : public NGContainerFragmentBuilder {
 ...
 public:
  ...
  struct FragmentPair {
    ...
    // Offset of start_fragment wrt start_linebox_fragment
    NGPhysicalOffset start_fragment_offset;
    // Union of sizes of all fragments generated by same Element as
    // start_fragment
    NGPhysicalSize start_fragment_union_size;
    ...
    NGPhysicalSize end_fragment_union_size;
  };
