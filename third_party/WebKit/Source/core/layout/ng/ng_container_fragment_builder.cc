...
void NGContainerFragmentBuilder::GetAndClearOutOfFlowDescendantCandidates(
  ...
  for (NGOutOfFlowPositionedCandidate& candidate : oof_positioned_candidates_) {
    ...
    // if (candidate.is_inline_rtl) {
    //   switch (candidate.descendant.static_position.type) {
    //     case NGStaticPosition::kTopLeft:
    //       builder_relative_position.type = NGStaticPosition::kTopRight;
    //       break;
    //     case NGStaticPosition::kTopRight:
    //       builder_relative_position.type = NGStaticPosition::kTopLeft;
    //       break;
    //     case NGStaticPosition::kBottomLeft:
    //       builder_relative_position.type = NGStaticPosition::kBottomRight;
    //       break;
    //     case NGStaticPosition::kBottomRight:
    //       builder_relative_position.type = NGStaticPosition::kBottomLeft;
    //       break;
    //   };
    // } else {
