...
void NGLineBreaker::SetLineEndFragment(
  ...
  bool is_horizontal = IsHorizontalWritingMode(constraint_space_.GetWritingMode());
...
void NGLineBreaker::AppendHyphen(const NGInlineItem& item,
  ...
  builder.SetText(item.GetLayoutObject(), hyphen_string, &style, std::move(hyphen_result));
