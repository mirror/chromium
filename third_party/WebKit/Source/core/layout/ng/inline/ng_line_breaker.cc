...
NGLineBreaker::LineBreakState NGLineBreaker::HandleAtomicInline(
  ...
  // TODO(kojii): The block layout needs to use :first-line style for
  // inline-block. We can pass UseFirstLineStyle() or style through constraint
  // space, though it doesn't solve nested case. Revisit after discussion on
  // nested case.
