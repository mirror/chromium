...
// CSS-defined white space charcters, excluding the newline character.
...
// @return Whether the line can break after the last item.
...
NGLineBreaker::LineBreakState NGLineBreaker::HandleControlItem(
  ...
  switch (character) {
    ...
    case kTabulationCharacter: {
      ...
      line_.position += item_result->inline_size;
      item_result->is_trailing_spaces = state == LineBreakState::kTrailing;
      ComputeCanBreakAfter(item_result);
      break;
    }
