...
TEST_F(NGOffsetMappingTest, FirstLetterInDifferentBlock) {
  ...
  const NGOffsetMappingResult* mapping0 = GetNGOffsetMappingFor(*text_node, 0);
  const NGOffsetMappingResult* mapping1 = GetNGOffsetMappingFor(*text_node, 1);
  const NGOffsetMappingResult* mapping2 = GetNGOffsetMappingFor(*text_node, 2);
  const NGOffsetMappingResult* mapping3 = GetNGOffsetMappingFor(*text_node, 3);
  ...
  const NGOffsetMappingResult& first_letter_result = *mapping0;
  ...
  const NGOffsetMappingResult& remaining_text_result = *mapping1;
