...
void NGLineBoxFragmentBuilder::SetChildInlineOffset(unsigned index,
...
NGLineBoxFragmentBuilder::ToLineBoxFragment() {
  ...
  for (auto& child : children_) {
    ...
    if (child.layout_result) {
      // TODO(kojii): We have the final offset relative to the line box. Need to
      // handle OutOfFlowDescendants etc. in NGLayoutResult.
