...
NGLineBoxFragmentBuilder& NGLineBoxFragmentBuilder::AddChild(
    ...
    const NGLogicalOffset& child_offset) {
  // TODO(kojii): Keep a copy of oof_positioned_candidates_ as we do with
  // NGFragmentBuilder. Does Ian's WIP do this?
  // Make NGContainerFragmentBuilder to share the code?
