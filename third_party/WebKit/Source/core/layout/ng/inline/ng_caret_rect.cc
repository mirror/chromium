...
// TODO(xiaochengh): Find a clean way to move this function as a member of
// NGPhysicalFragment, without passing the seemingly redundant line boxes.
...
// TODO(xiaochengh): Find a clean way to move this function as a member of
// NGPhysicalFragment, without passing the seemingly redundant line box.
