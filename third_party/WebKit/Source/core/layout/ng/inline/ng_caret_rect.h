...
// Given an inline formatting context and a position in the context, return the
...
// Converts the PositionInFlatTree into Position (in DOM) and then call the
...
// An NGCaretPosition indicate a caret position relative to an inline
// NGPhysicalFragment:
// - When |fragment| is box, |position_type| is either |kBeforeBox| or
// |kAfterBox|, indicating the two caret positions by the box sides;
