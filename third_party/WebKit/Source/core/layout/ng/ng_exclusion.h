...
struct CORE_EXPORT NGExclusions {
  ...
  // This member is used for implmenting the "top edge alignment rule" for
  ...
  // type of float. This is used for implmenting float clearance.
  Optional<LayoutUnit> clear_float_left_offset;
  Optional<LayoutUnit> clear_float_right_offset;
