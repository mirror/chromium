...
RefPtr<NGLayoutResult> NGBlockLayoutAlgorithm::Layout() {
  ...
  // The end margin strut of an in-flow box contribute to the size of the
  // current fragment if:
  //  - There is end border/scrollbar/padding.
  //  - There was an empty block affected by clearance.
