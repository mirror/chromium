...
bool NGBlockLayoutAlgorithm::BreakBeforeChild(
  ...
  BreakType break_type = BreakTypeBeforeChild(child, layout_result,
                                              block_offset, pushed_by_floats);
  ...
  if (!has_processed_first_child_ && !pushed_by_floats) {
...
bool NGBlockLayoutAlgorithm::MaybeUpdateFragmentBfcOffset(
  ...
  if (bfc_offset.block_offset > bfc_block_offset)
