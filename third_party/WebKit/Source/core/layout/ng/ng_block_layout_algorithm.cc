...
bool NGBlockLayoutAlgorithm::HandleNewFormattingContext(
  ...
  // the exclusion space.
  if (opportunity.rect.offset.block_offset != child_bfc_offset_estimate ||
  ...
  NGBfcOffset child_bfc_offset(
      opportunity.rect.offset.line_offset + auto_margins.LineLeft(direction),
      opportunity.rect.offset.block_offset);
