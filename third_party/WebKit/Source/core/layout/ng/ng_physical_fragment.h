...
class NGPhisicalFragment;

struct NGPhisicalFragmentTraits {
  static void Destruct(const NGPhisicalFragment*);
};
...
class CORE_EXPORT NGPhysicalFragment
    : public RefCounted<NGPhysicalFragment, NGPhisicalFragmentTraits>,
