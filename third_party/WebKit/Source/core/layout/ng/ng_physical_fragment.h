...
class CORE_EXPORT NGPhysicalFragment
 ...
 public:
  ...
  // parent. When the parent is not LayoutNG and this fragment was produced by
  // |LayoutNGBlockFlow::UpdateBlockLayout|, the parent may move the
  // |LayoutObject| after this fragment was placed. crbug.com/788590
