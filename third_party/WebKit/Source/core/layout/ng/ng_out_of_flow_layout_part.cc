...
void NGOutOfFlowLayoutPart::ComputeInlineContainingBlocks(
  ...
  for (auto& block_info : inline_container_fragments) {
    ...
    scoped_refptr<const NGPhysicalFragment> start_fragment =
        block_info.value.start_fragment;
    scoped_refptr<const NGPhysicalFragment> start_linebox_fragment =
    ...
    // Step 2
    scoped_refptr<const NGPhysicalFragment> end_linebox_fragment =
        block_info.value.end_linebox_fragment;
    scoped_refptr<const NGPhysicalFragment> end_fragment =
