...
TEST(NGExclusionSpaceTest, SolidEdges) {
  ...
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(), LayoutUnit()),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(15)),
                                EFloat::kLeft));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(65), LayoutUnit()),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(15)),
                                EFloat::kRight));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(10), LayoutUnit(25)),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(15)),
                                EFloat::kLeft));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(50), LayoutUnit(25)),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(10)),
                                EFloat::kRight));
...
TEST(NGExclusionSpaceTest, OverlappingWithShelf) {
  ...
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(65), LayoutUnit()),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(15)),
                                EFloat::kRight));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(70), LayoutUnit(25)),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(10)),
                                EFloat::kRight));
...
TEST(NGExclusionSpaceTest, InsertBetweenShelves) {
  ...
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(), LayoutUnit()),
                                NGLogicalSize(LayoutUnit(30), LayoutUnit(10)),
                                EFloat::kLeft));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(65), LayoutUnit()),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(35)),
                                EFloat::kRight));
  exclusion_space.Add(EXCLUSION(NGBfcOffset(LayoutUnit(10), LayoutUnit(15)),
                                NGLogicalSize(LayoutUnit(20), LayoutUnit(10)),
                                EFloat::kLeft));
