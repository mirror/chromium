...
class InlineFlowBox : public InlineBox {
 public:
  ...
  LayoutUnit ComputeUnderAnnotationAdjustment(LayoutUnit allowed_position) const;
  ...
  LayoutUnit LogicalRightVisualOverflow() const {
    return overflow_
               ? (IsHorizontal() ? overflow_->VisualOverflowRect().MaxX()
  ...
  // box.
  void OverrideOverflowFromLogicalRects(const LayoutRect& logical_layout_overflow,
 ...
 protected:
  ...
  InlineFlowBox* next_line_box_;  // The next box that also uses our LayoutObject
