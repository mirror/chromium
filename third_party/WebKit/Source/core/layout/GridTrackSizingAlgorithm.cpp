...
class IndefiniteSizeStrategy final : public GridTrackSizingAlgorithmStrategy {
 ...
 private:
  ...
  LayoutUnit FreeSpaceForStretchAutoTracksStep(
      GridTrackSizingDirection) const override;
};
...
class DefiniteSizeStrategy final : public GridTrackSizingAlgorithmStrategy {
 ...
 private:
  ...
  LayoutUnit FreeSpaceForStretchAutoTracksStep(
      GridTrackSizingDirection direction) const override {
...
LayoutUnit IndefiniteSizeStrategy::FreeSpaceForStretchAutoTracksStep(
    GridTrackSizingDirection direction) const {
  DCHECK(!algorithm_.FreeSpace(direction));
...
void GridTrackSizingAlgorithm::StretchAutoTracks() {
  LayoutUnit free_space =
      strategy_->FreeSpaceForStretchAutoTracksStep(direction_);
