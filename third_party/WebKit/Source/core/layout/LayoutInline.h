...
class CORE_EXPORT LayoutInline : public LayoutBoxModelObject {
 public:
  ...
  Element* GetNode() const { return ToElement(LayoutBoxModelObject::GetNode()); }
  ...
  LayoutUnit MarginAfter(const ComputedStyle* other_style = nullptr) const final;
  LayoutUnit MarginStart(const ComputedStyle* other_style = nullptr) const final;
