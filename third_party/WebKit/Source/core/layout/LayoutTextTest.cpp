...
TEST_F(LayoutTextTest, ContainsOnlyWhitespace) {
  ...
  EXPECT_EQ(OnlyWhitespace::kYes, GetBasicText()->ContainsOnlyWhitespace());

  SetBasicBody("   \t\t\n \n\t &nbsp \n\t&nbsp\n \t");
  EXPECT_EQ(OnlyWhitespace::kUnknown, GetBasicText()->ContainsOnlyWhitespace());
  ...
  EXPECT_EQ(OnlyWhitespace::kNo, GetBasicText()->ContainsOnlyWhitespace());
