...
enum LinePositionMode { kPositionOnContainingLine, kPositionOfInteriorLineBoxes };
...
class CORE_EXPORT LayoutBoxModelObject : public LayoutObject {
 ...
 public:
  ...
  void MoveChildrenTo(LayoutBoxModelObject* to_box_model_object,
                      ...
                      bool full_remove_insert = false) {
    MoveChildrenTo(to_box_model_object, start_child, end_child, 0, full_remove_insert);
  }
