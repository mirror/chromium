...
class LineLayoutBlockFlow : public LineLayoutBox {
 public:
  ...
  void PositionAndLayoutFloat(FloatingObject& floating_object,
    ...
    ToBlockFlow()->PositionAndLayoutFloat(floating_object, logical_top_margin_edge);
  }
  ...
  LayoutUnit LogicalBottomForFloat(const FloatingObject& floating_object) const {
 ...
 private:
  LayoutBlockFlow* ToBlockFlow() { return ToLayoutBlockFlow(GetLayoutObject()); };
