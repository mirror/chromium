...
void LayoutBoxModelObject::StyleWillChange(StyleDifference diff,
  ...
  // For SPv2, change of stacked/stacking context status may cause change of the
  // PaintLayer's CompositingContainer, we need to eagerly invalidate the
  // current compositing container which may have painted a cached subsequence
