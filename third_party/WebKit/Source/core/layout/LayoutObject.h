...
class CORE_EXPORT LayoutObject : public ImageResourceObserver,
 ...
 public:
  ...
  bool IsPseudoElement() const { return GetNode() && GetNode()->IsPseudoElement(); }
  ...
  bool IsEmbeddedObject() const { return IsOfType(kLayoutObjectEmbeddedObject); }
  ...
  bool IsLayoutNGBlockFlow() const { return IsOfType(kLayoutObjectNGBlockFlow); }
  ...
  bool IsLayoutReplaced() const { return IsOfType(kLayoutObjectLayoutReplaced); }
  ...
  bool IsFixedPositioned() const {
    return IsOutOfFlowPositioned() && Style()->GetPosition() == EPosition::kFixed;
  }
  ...
  bool HasHiddenBackface() const {
    return Style() && Style()->BackfaceVisibility() == kBackfaceVisibilityHidden;
  }
  ...
  Node* NonPseudoNode() const { return IsPseudoElement() ? nullptr : GetNode(); }
