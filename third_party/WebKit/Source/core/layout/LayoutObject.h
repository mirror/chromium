...
class CORE_EXPORT LayoutObject : public ImageResourceObserver,
 ...
 public:
  ...
  virtual bool IsLayoutEmbeddedContentView() const { return false; }
  ...
  // LayoutEmbeddedContentView overrides destroy() for this purpose).
 ...
 protected:
  enum LayoutObjectType {
    ...
    kLayoutObjectLayoutEmbeddedContentView,
