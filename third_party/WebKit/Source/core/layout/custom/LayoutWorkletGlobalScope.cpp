...
void LayoutWorkletGlobalScope::registerLayout(const String& name,
  ...
  if (!V8ObjectParser::ParseCSSPropertyList(
          isolate, context, constructor, "inputProperties",
  ...
  if (!V8ObjectParser::ParseCSSPropertyList(
          isolate, context, constructor, "childInputProperties",
  ...
  if (!V8ObjectParser::ParseGeneratorFunction(
          isolate, context, prototype, "intrinsicSizes", &intrinsic_sizes,
          &exception_state))
    return;

  v8::Local<v8::Function> layout;
  if (!V8ObjectParser::ParseGeneratorFunction(
          isolate, context, prototype, "layout", &layout, &exception_state))
    return;
