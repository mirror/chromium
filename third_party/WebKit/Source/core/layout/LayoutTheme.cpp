...
void LayoutTheme::AdjustStyle(ComputedStyle& style, Element* e) {
  ...
  switch (style.Appearance()) {
    ...
    case kAssistButtonPart:
      return AdjustAssistButtonStyle(style);
    default:
      break;
  }
}
...
bool LayoutTheme::ShouldHaveAssistButton(
    HTMLInputElement* input_element) const {
  return input_element->IsTextField();
}
...
void LayoutTheme::AdjustAssistButtonStyle(ComputedStyle&) const {}
