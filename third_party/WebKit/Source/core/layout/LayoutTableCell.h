...
class CORE_EXPORT LayoutTableCell final : public LayoutBlockFlow {
 public:
  ...
  // Cell order is determined by table's style.
  ...
  // are all in tables inline and block directions.
 ...
 private:
  ...
  // 'before', 'after' directions are all in tables inline and block directions.
