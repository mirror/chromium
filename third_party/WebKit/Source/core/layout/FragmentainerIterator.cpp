...
LayoutSize FragmentainerIterator::PaginationOffset() const {
  ...
  return group.FlowThreadTranslationAtOffset(
      fragmentainer_logical_top_in_flow_thread, LayoutBox::kAssociateWithLatterPage,
...
bool FragmentainerIterator::SetFragmentainersOfInterest() {
  ...
  if (HasClipRect()) {
    ...
    group.ColumnIntervalForVisualRect(clip_rect, first_fragmentainer_in_clip_rect,
