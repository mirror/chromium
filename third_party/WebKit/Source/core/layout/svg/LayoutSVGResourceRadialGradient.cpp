...
bool LayoutSVGResourceRadialGradient::CollectGradientAttributes() {
  ...
  return toSVGRadialGradientElement(GetElement())->CollectGradientAttributes(
      MutableAttributes());
}

FloatPoint LayoutSVGResourceRadialGradient::CenterPoint(
    const RadialGradientAttributes& attributes) const {
  return SVGLengthContext::ResolvePoint(GetElement(), attributes.GradientUnits(),
...
float LayoutSVGResourceRadialGradient::Radius(
    const RadialGradientAttributes& attributes) const {
  return SVGLengthContext::ResolveLength(GetElement(), attributes.GradientUnits(),
                                         *attributes.R());
}
