...
void LayoutSVGResourceContainer::WillBeDestroyed() {
  ...
  SvgTreeScopeResourcesFromElement(GetElement()).RemoveResource(
      GetElement()->GetIdAttribute(), this);
...
void LayoutSVGResourceContainer::StyleDidChange(StyleDifference diff,
  ...
  SvgTreeScopeResourcesFromElement(GetElement()).UpdateResource(
      GetElement()->GetIdAttribute(), this);
}
...
void LayoutSVGResourceContainer::IdChanged(const AtomicString& old_id,
  ...
  SvgTreeScopeResourcesFromElement(GetElement()).UpdateResource(old_id, new_id,
                                                             this);
}
