...
bool LayoutSVGImage::UpdateBoundingBox() {
  ...
  object_bounding_box_ =
      FloatRect(length_context.ValueForLength(StyleRef().SvgStyle().X(),
                                             StyleRef(), SVGLengthMode::kWidth),
                length_context.ValueForLength(StyleRef().SvgStyle().Y(),
                                             StyleRef(), SVGLengthMode::kHeight),
...
void LayoutSVGImage::GetLayout() {
  ...
  if (needs_transform_update_) {
    local_transform_ = toSVGImageElement(GetElement())->CalculateTransform(
