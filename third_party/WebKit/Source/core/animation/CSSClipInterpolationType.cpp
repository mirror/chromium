...
struct ClipAutos {
  ...
  bool operator==(const ClipAutos& other) const {
    return is_auto == other.is_auto && is_top_auto == other.is_top_auto &&
           ...
           is_bottom_auto == other.is_bottom_auto && is_left_auto == other.is_left_auto;
  }
...
class InheritedAutosChecker : public InterpolationType::ConversionChecker {
 ...
 private:
  ...
  bool IsValid(const InterpolationEnvironment& environment,
    ...
    return inherited_autos_ == GetClipAutos(*environment.GetState().ParentStyle());
  }
...
InterpolationValue CSSClipInterpolationType::MaybeConvertNeutral(
  ...
  conversion_checkers.push_back(UnderlyingAutosChecker::Create(underlying_autos));
...
PairwiseInterpolationValue CSSClipInterpolationType::MaybeMergeSingles(
  ...
  const ClipAutos& start_autos =
      ToCSSClipNonInterpolableValue(*start.non_interpolable_value).GetClipAutos();
...
void CSSClipInterpolationType::Composite(
  ...
  const ClipAutos& autos =
      ToCSSClipNonInterpolableValue(*value.non_interpolable_value).GetClipAutos();
...
void CSSClipInterpolationType::ApplyStandardPropertyValue(
  ...
  state.Style()->SetClip(LengthBox(convert_index(autos.is_top_auto, kClipTop),
