...
const BorderImageLengthBox& GetBorderImageLengthBox(CSSPropertyID,
                                                    const ComputedStyle&);

const BorderImageLengthBox& GetInitialBorderImageLengthBox(
...
CSSBorderImageLengthBoxInterpolationType::MaybeConvertInitial(
  ...
  return ConvertBorderImageLengthBox(
      GetInitialBorderImageLengthBox(CssProperty()), 1);
}
