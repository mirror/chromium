...
class InheritedStyleOffsetRotationChecker
    : public CSSInterpolationType::CSSConversionChecker {
 public:
  static std::unique_ptr<InheritedStyleOffsetRotationChecker> Create(
      StyleOffsetRotation inherited_rotation) {
    return WTF::WrapUnique(
        new InheritedStyleOffsetRotationChecker(inherited_rotation));
  }
 ...
 private:
  InheritedStyleOffsetRotationChecker(StyleOffsetRotation inherited_rotation)
...
InterpolationValue CSSOffsetRotateInterpolationType::MaybeConvertInherit(
  ...
  conversion_checkers.push_back(
      InheritedStyleOffsetRotationChecker::Create(inherited_rotation));
