...
FontWeight DoubleToFontWeight(double value) {
  static const FontWeight kFontWeights[] = {
      kFontWeight100, kFontWeight200, kFontWeight300, kFontWeight400, kFontWeight500,
      kFontWeight600, kFontWeight700, kFontWeight800, kFontWeight900,
  };

  int index = round(value / 100 - 1);
  int clamped_index = clampTo<int>(index, 0, WTF_ARRAY_LENGTH(kFontWeights) - 1);
