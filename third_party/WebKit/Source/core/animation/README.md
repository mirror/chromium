...
of animation effects can be defined later by other specs (for example Javascript
...
*   __[KeyframeEffect][]__ represents the effect an animation has (without any
    ...
    *   A __[KeyframeEffectModel][]__ that holds a sequence of keyframes to
        specify the properties being animated and what values they pass through.
        Example:  
        ```javascript
        [
          ...
          {color: 'green'},
          {color: 'blue'},
          {color: 'red', transform: 'rotate(350deg)'},
        ]
        ```
...
[UpdateInheritedTime]: https://cs.chromium.org/search/?q=function:AnimationEffectReadOnly::UpdateInheritedTime
