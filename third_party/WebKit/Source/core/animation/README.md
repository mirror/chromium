...
Currently all animations use [KeyframeEffect][]s. The more generic
[AnimationEffect][]s are an extention point in Web Animations where other kinds
of animations can be defined later by other specs (e.g. Javascript callback
based effects).
