...
*   ### Javascript
    ...
    Interfaces:
    *   [Animation.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/Animation.idl): an animation has several properties, and several function such as cancel(), finish(), play(), pause(), reverse().
    *   [AnimationEffectReadOnly.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/AnimationEffectReadOnly.idl) contains a read only timing attribute
    *   [AnimationEffectTiming.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/AnimationEffectTiming.idl)
    *   [AnimationEffectTimingProperties.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/AnimationEffectTimingProperties.idl): dictionary that contains the timing properties of of an AnimationEffectReadOnly.
    *   [AnimationEffectTimingReadOnly.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/AnimationEffectTimingReadOnly.idl)
    *   [AnimationTimeline.idl] (https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/AnimationTimeline.idl) keeps a read only current time for an animation.
    *   [BaseKeyFrame.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/BaseKeyframe.idl)
    *   [BasePropertyIndexedKeyFrame.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/BaseKeyframe.idl)
    *   [ComputedTimingProperties.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/ComputedTimingProperties.idl)
    *   [DocumentAnimation.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/DocumentAnimation.idl)
    *   [DocumentTimeline.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/DocumentTimeline.idl)
    *   [DocumentTimelineOptions.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/DocumentTimelineOptions.idl)
    *   [ElementAnimation.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/DocumentTimelineOptions.idl)
    *   [KeyframeAnimationOptions.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/KeyframeAnimationOptions.idl)
    *   [KeyframeEffect.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/KeyframeEffect.idl)
    *   [KeyframeEffectOptions.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/KeyframeEffectOptions.idl)
    *   [KeyframeEffectReadOnly.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/KeyframeEffectReadOnly.idl)
    *   [ScrollTimeline.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/ScrollTimeline.idl): the time value of the scroll timeline is determined by the scroll position of the scroll container.
    *   [ScrollTimelineOptions.idl](https://cs.chromium.org/chromium/src/third_party/WebKit/Source/core/animation/ScrollTimelineOptions.idl)
