...
TEST_F(AnimationKeyframeEffectV8Test, KeyframeCompositeOverridesEffect) {
  ...
  V8ObjectBuilder keyframe1(script_state);
  keyframe1.AddString("width", "100px");
  keyframe1.AddString("composite", "replace");
