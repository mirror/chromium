...
TEST_F(AnimationKeyframeEffectV8Test, CanCreateAnAnimation) {
  ...
  js_keyframes.push_back(Dictionary(scope.GetIsolate(), keyframe1, exception_state));
  js_keyframes.push_back(Dictionary(scope.GetIsolate(), keyframe2, exception_state));
...
TEST_F(AnimationKeyframeEffectV8Test, SpecifiedGetters) {
  ...
  SetV8ObjectPropertyAsString(scope.GetIsolate(), timing_input, "fill",
                              "backwards");
  SetV8ObjectPropertyAsNumber(scope.GetIsolate(), timing_input, "iterationStart",
                              2);
...
TEST_F(AnimationKeyframeEffectV8Test, SpecifiedDurationGetter) {
  ...
  DummyExceptionStateForTesting exception_state;
  V8KeyframeEffectOptions::toImpl(scope.GetIsolate(), timing_input_with_duration,
  ...
  AnimationEffectTiming* specified_no_duration = animation_no_duration->timing();
