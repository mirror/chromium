...
bool LengthPropertyFunctions::GetInitialLength(CSSPropertyID property,
  ...
  switch (property) {
    ...
    case CSSPropertyBorderRightWidth:
    case CSSPropertyBorderTopWidth:
      result = LengthFromUnsigned(ComputedStyleInitialFunctions::InitialBorderWidth());
      return true;
    case CSSPropertyOutlineWidth:
      result = LengthFromUnsigned(ComputedStyleInitialFunctions::InitialOutlineWidth());
      return true;
    case CSSPropertyColumnRuleWidth:
      result = LengthFromUnsigned(ComputedStyleInitialFunctions::InitialColumnRuleWidth());
      return true;
