...
InterpolationValue PathInterpolationFunctions::ConvertValue(
  ...
  std::unique_ptr<InterpolableList> path_args = InterpolableList::Create(length);
  ...
  return InterpolationValue(std::move(result),
                            SVGPathNonInterpolableValue::Create(path_seg_types));
}
...
PairwiseInterpolationValue PathInterpolationFunctions::MaybeMergeSingles(
  ...
  const Vector<SVGPathSegType>& start_types =
      ToSVGPathNonInterpolableValue(*start.non_interpolable_value).PathSegTypes();
