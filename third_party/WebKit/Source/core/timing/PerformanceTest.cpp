...
TEST_F(PerformanceTest, ParameterHistogramForMeasure) {
  ...
  performance_->measure(scope.GetScriptState(), "testMark",
                        StringOrDouble::FromString("unloadEventStart"),
                        StringOrDouble::FromString("unloadEventEnd"),
                        exception_state);
  ...
  performance_->measure(scope.GetScriptState(), "testMark",
                        StringOrDouble::FromString("domInteractive"),
                        StringOrDouble::FromString("[object Object]"),
                        exception_state);
