...
// The elementtiming attributes are queued during the AttachLayout() process,
// and entries are created for any pending |element_timing_entry_names_| when
// the subsequent frame commits.
