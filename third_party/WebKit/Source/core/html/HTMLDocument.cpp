...
static HashSet<StringImpl*>* CreateHtmlCaseInsensitiveAttributesSet() {
  ...
  attr_set->ReserveCapacityForSize(WTF_ARRAY_LENGTH(case_insensitive_attributes));
...
bool HTMLDocument::IsCaseSensitiveAttribute(
  ...
  bool is_possible_html_attr =
      !attribute_name.HasPrefix() && (attribute_name.NamespaceURI() == g_null_atom);
