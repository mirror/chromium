...
TEST_F(HTMLSelectElementTest, SaveRestoreSelectSingleFormControlState) {
  ...
  HTMLOptionElement* opt0 = toHTMLOptionElement(GetDocument().GetElementById("0"));
  HTMLOptionElement* opt2 = toHTMLOptionElement(GetDocument().GetElementById("2"));
...
TEST_F(HTMLSelectElementTest, SaveRestoreSelectMultipleFormControlState) {
  ...
  HTMLOptionElement* opt0 = toHTMLOptionElement(GetDocument().GetElementById("0"));
  HTMLOptionElement* opt2 = toHTMLOptionElement(GetDocument().GetElementById("2"));
  HTMLOptionElement* opt3 = toHTMLOptionElement(GetDocument().GetElementById("3"));
