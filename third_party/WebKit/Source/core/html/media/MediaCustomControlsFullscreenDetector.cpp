...
void MediaCustomControlsFullscreenDetector::Attach() {
  ...
  VideoElement().GetDocument().addEventListener(EventTypeNames::fullscreenchange,
                                             this, true);
}
...
void MediaCustomControlsFullscreenDetector::handleEvent(
  ...
  check_viewport_intersection_timer_.StartOneShot(kCheckFullscreenIntervalSeconds,
                                                BLINK_FROM_HERE);
}
