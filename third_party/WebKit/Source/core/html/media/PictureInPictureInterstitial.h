...
// |    (-internal-picture-in-picture-cast-text-message)
class PictureInPictureInterstitial final : public HTMLDivElement {
 ...
 private:
  ...
  TaskRunnerTimer<PictureInPictureInterstitial> insterstitial_timer_;
  Member<HTMLVideoElement> video_element_;
  Member<HTMLImageElement> background_image_;
  Member<PictureInPictureMessageElement> message_element_;
};
