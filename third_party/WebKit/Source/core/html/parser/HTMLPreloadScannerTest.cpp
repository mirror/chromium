...
TEST_F(HTMLPreloadScannerTest, testMetaAcceptCH) {
  ...
  dpr.SetShouldSend(kWebClientHintsTypeDPR, true);
  all.SetShouldSend(kWebClientHintsTypeDPR, true);
  resource_width.SetShouldSend(kWebClientHintsTypeResourceWidth, true);
  all.SetShouldSend(kWebClientHintsTypeResourceWidth, true);
  viewport_width.SetShouldSend(kWebClientHintsTypeViewportWidth, true);
  all.SetShouldSend(kWebClientHintsTypeViewportWidth, true);
  TestCase test_cases[] = {
      {"http://example.test",
