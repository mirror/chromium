...
HTMLObjectElement::ExistingLayoutEmbeddedContentView() const {
  // This will return 0 if the layoutObject is not a LayoutEmbeddedContentView.
  return GetLayoutEmbeddedContentView();
}
