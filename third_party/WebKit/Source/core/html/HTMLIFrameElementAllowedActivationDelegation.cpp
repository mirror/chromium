...
#include "core/html/HTMLIFrameElementAllowedActivationDelegation.h"
...
HTMLIFrameElementAllowedActivationDelegation::
    HTMLIFrameElementAllowedActivationDelegation(HTMLIFrameElement* element)
    : DOMTokenList(*element, HTMLNames::allowedactivationdelegationAttr) {}

ActivationDelegationFlags
HTMLIFrameElementAllowedActivationDelegation::GetFlags(
...
bool HTMLIFrameElementAllowedActivationDelegation::ValidateTokenValue(
