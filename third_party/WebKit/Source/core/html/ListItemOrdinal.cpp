...
void ListItemOrdinal::InvalidateOrdinalAfter(bool is_reversed, const Node* list_node, const Node* item_node) {
...
void ListItemOrdinal::ItemInsertedOrRemoved(const LayoutListItem* layout_list_item) {
  ...
  InvalidateOrdinalAfter(is_list_reversed, list_node, item_node);
}
