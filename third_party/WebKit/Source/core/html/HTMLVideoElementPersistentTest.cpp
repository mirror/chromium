...
class VideoMockChromeClient : public EmptyChromeClient {
 public:
...
class HTMLVideoElementPersistentTest : public ::testing::Test {
 protected:
  void SetUp() override {
    chrome_client_ = new VideoMockChromeClient();
  ...
  VideoMockChromeClient& GetMockChromeClient() { return *chrome_client_; }
 ...
 private:
  ...
  Persistent<VideoMockChromeClient> chrome_client_;
};
