...
// Implementatin of the Worker interface defined in the WebWorker spec:
...
class CORE_EXPORT DedicatedWorker final
 ...
 public:
  ...
  // Implements ScriptWrappable via AbstractWorker.
 ...
 private:
  ...
  // Implements EventTarget via AbstractWorker.
