...
#ifndef GlobalScopeStartupData_h
#define GlobalScopeStartupData_h
...
// A GlobalScopeStartupData carries parameters for initializing a global scope.
struct CORE_EXPORT GlobalScopeStartupData final {
  WTF_MAKE_NONCOPYABLE(GlobalScopeStartupData);
  USING_FAST_MALLOC(GlobalScopeStartupData);

 public:
  GlobalScopeStartupData(
  ...
  ~GlobalScopeStartupData() = default;
  ...
  // a new worker context, but ownership of it and this GlobalScopeStartupData
...
#endif  // GlobalScopeStartupData_h
