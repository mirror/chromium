...
class CORE_EXPORT WorkerSettings {
 public:
  ...
  void DeepCopyGenericFontFamilySettings() {
    GenericFontFamilySettings local_settings;
    generic_font_family_settings_.DeepThreadSafeCopyTo(local_settings);
    generic_font_family_settings_.Reset();
    generic_font_family_settings_ = local_settings;
  }
