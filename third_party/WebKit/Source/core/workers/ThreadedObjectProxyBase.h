...
// The base proxy class to talk to Worker/Worklet object on the main thread via
// the ThreadedMessagingProxyBase from a worker thread. This is created and
// destroyed on the main thread, and used on the worker thread.
