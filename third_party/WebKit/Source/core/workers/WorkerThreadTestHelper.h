...
class WorkerThreadForTest : public WorkerThread {
 public:
  WorkerThreadForTest(WorkerLoaderProxyProvider* mock_worker_loader_proxy_provider,
                      WorkerReportingProxy& mock_worker_reporting_proxy)
      : WorkerThread(WorkerLoaderProxy::Create(mock_worker_loader_proxy_provider),
