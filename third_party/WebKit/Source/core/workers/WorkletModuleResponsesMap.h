...
//
// This works as a cacher and fetcher mechanism for module scripts. Scripts are
// added and retrieved using ReadEntry(). If a module script for a given URL has
// already been fetched, ReadEntry() returns the cached script. Otherwise,
// ReadEntry() internally creates ModuleScriptFetcher with the ResourceFetcher
// that is given to its ctor. Once the module script is fetched, it's cached and
// ReadEntry() returns it.
