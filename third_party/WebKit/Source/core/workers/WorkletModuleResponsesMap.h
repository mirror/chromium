...
//
// This works as a kind of memory caches for module scripts. If a module script
// for a given URL has already been fetched, ReadEntry() returns the cached
// script. Otherwise, ReadEntry() internally creates ModuleScriptFetcher with
// the ResourceFetcher that is given to its ctor. Once the module script is
