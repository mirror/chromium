...
class SharedWorkerContentSettingsProxy : public WebContentSettingsClient {
 ...
 private:
  ...
  // Created on the browser process, SharedWorkerContentSettingsProxy is passed
  // to renderer process in the form of mojo::ScopedMessagePipeHandle.
  // Then it is bound to this PtrInfo and used in GetService().
