...
// This has a unique lifetime: this is mainly owned by the parent object (e.g.,
// InProcessWorkerBase, AnimationWorklet), but also owned by itself via
// |keep_alive_| member. This is because the parent object can be destroyed
// before this proxy complete worker thread termination.
