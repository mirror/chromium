 ...
 public:
  ...
  WorkerOrWorkletGlobalScope* CreateWorkerGlobalScope(
    ...
    return new DedicatedWorkerGlobalScope(
        startup_data->script_url_, startup_data->user_agent_, this, time_origin_,
...
class InProcessWorkerMessagingProxyForTest
 ...
 public:
  InProcessWorkerMessagingProxyForTest(ExecutionContext* execution_context)
    ...
    mock_worker_thread_lifecycle_observer_ = new MockWorkerThreadLifecycleObserver(
  ...
  unsigned UnconfirmedMessageCount() const { return unconfirmed_message_count_; }
