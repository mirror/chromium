...
WorkerInspectorProxy::WaitMode
WorkerInspectorProxy::ShouldWaitForDebuggerOnWorkerStart(
    ExecutionContext* execution_context) {
  bool result = false;
  probe::shouldWaitForDebuggerOnWorkerStart(execution_context, &result);
  return result ? kWaitForDebugger : kDontWaitForDebugger;
}
...
void WorkerInspectorProxy::WorkerThreadCreated(
  ...
  // ShouldWaitForDebuggerOnWorkerStart() right before.
