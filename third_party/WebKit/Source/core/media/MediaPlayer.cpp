...
MediaPlayer::MediaPlayer(ExecutionContext* context, EventTarget* owner)
    : ContextLifecycleObserver(context),
      ...
      played_time_ranges_(),
      async_event_queue_(GenericEventQueue::Create(owner)),
      playback_rate_(1.0f),
...
void MediaPlayer::StartPlayerLoad() {
  ...
  // TODO(alokp): frame->Client()->CreateWebMediaPlayer(*this, source, this);
