...
RefPtr<SimpleFontData> LocalFontFaceSource::CreateFontData(
  ...
  // should only look for the postscript or full font name.  However,
  // when passing a style-neutral FontDescription we can't match Roboto
  // Bold and Thin anymore on Android given the CSS Google Fonts sends,
  // compare crbug.com/765980. So for now, we continue to pass
  // font_description to avoid breaking Google Fonts.
