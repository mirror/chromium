...
bool ConsumeBorder(bool important,
  ...
  while (!width || !style || !color) {
    ...
    if (!style) {
      style = CSSPropertyAPI::Get(CSSPropertyBorderLeftStyle)
                  .ParseSingleValue(
                      CSSPropertyBorderLeftStyle, range, context,
                      CSSParserLocalContext(false /* use_alias_parsing */,
                                            CSSPropertyBorder));
      if (style)
        continue;
    }
...
bool ConsumePlaceContentShorthand(bool important,
  ...
  CSSValue* align_content_value =
      CSSPropertyAlignmentUtils::ConsumeSimplifiedContentPosition(range);
  ...
  AddProperty(CSSPropertyAlignContent, CSSPropertyPlaceContent,
              *align_content_value, important, IsImplicitProperty::kNotImplicit,
              properties);
...
bool ConsumePlaceItemsShorthand(bool important,
  ...
  CSSValue* align_items_value =
      CSSPropertyAlignmentUtils::ConsumeSimplifiedItemPosition(range);
  ...
  AddProperty(CSSPropertyJustifyItems, CSSPropertyPlaceItems,
              *justify_items_value, important, IsImplicitProperty::kNotImplicit,
              properties);
  return true;
}
