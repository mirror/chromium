...
bool CSSPropertyAPI::ParseShorthand(
  ...
  switch (property) {
    ...
    case CSSPropertyPlaceContent:
      return ConsumePlaceContentShorthand(important, range, context,
                                          properties);
    case CSSPropertyPlaceItems:
      return ConsumePlaceItemsShorthand(important, range, context, properties);
    case CSSPropertyPlaceSelf:
      return ConsumePlaceSelfShorthand(important, range, context, properties);
    default:
      return false;
  }
}
