...
const CSSValue* CSSPropertyAPI::ParseSingleValue(CSSPropertyID property,
  ...
  switch (property) {
    ...
    case CSSPropertyTransitionDelay:
      return ConsumeCommaSeparatedList(ConsumeTime, range, kValueRangeAll);
    case CSSPropertyAnimationDuration:
    case CSSPropertyTransitionDuration:
      return ConsumeCommaSeparatedList(ConsumeTime, range,
    ...
    case CSSPropertyGridRowGap:
      return ConsumeLengthOrPercent(range, context.Mode(),
                                    kValueRangeNonNegative);
    ...
    case CSSPropertyBackgroundAttachment:
      return ConsumeCommaSeparatedList(ConsumeBackgroundAttachment, range);
    case CSSPropertyBackgroundBlendMode:
      return ConsumeCommaSeparatedList(ConsumeBackgroundBlendMode, range);
    ...
    case CSSPropertyMaskSourceType:
      return ConsumeCommaSeparatedList(ConsumeMaskSourceType, range);
    ...
    case CSSPropertyWebkitMaskComposite:
      return ConsumeCommaSeparatedList(ConsumeBackgroundComposite, range);
