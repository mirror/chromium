...
#include "core/css/properties/CSSPropertyAPIWebkitBorderEndWidth.h"
...
CSSPropertyAPIWebkitBorderEndWidth::ResolveDirectionAwareProperty(
    TextDirection direction,
    WritingMode writing_mode) const {
  return CSSProperty::ResolveToPhysicalPropertyAPI(
      direction, writing_mode, kEndSide, borderWidthShorthand());
}
}  // namespace blink
