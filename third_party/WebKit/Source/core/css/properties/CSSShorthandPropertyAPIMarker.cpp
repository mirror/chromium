...
bool CSSShorthandPropertyAPIMarker::parseShorthand(
  ...
  // CSSPropertyInvalid was used as the "current_shorthand" in the old/non-API
  // parsing method because it's not used. Below we use CSSPropertyMarker just
  // to avoid confusion. There is no real difference.
