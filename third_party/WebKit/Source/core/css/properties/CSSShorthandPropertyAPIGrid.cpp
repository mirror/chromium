...
bool CSSShorthandPropertyAPIGrid::parseShorthand(
  ...
  if (CSSPropertyGridUtils::ConsumeGridTemplateShorthand(
    ...
    CSSPropertyParserHelpers::AddMultipleProperties<
        CSSPropertyGridTemplateRows, CSSPropertyGridTemplateColumns,
        CSSPropertyGridTemplateAreas>(
        CSSPropertyGrid, important,
        CSSPropertyParserHelpers::IsImplicitProperty::kNotImplicit, properties,
        *template_rows, *template_columns, *template_areas);
    ...
    CSSPropertyParserHelpers::AddMultipleProperties<
        CSSPropertyGridAutoFlow, CSSPropertyGridAutoColumns,
        CSSPropertyGridAutoRows, CSSPropertyGridColumnGap,
