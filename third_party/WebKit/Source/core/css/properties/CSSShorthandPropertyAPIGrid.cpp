...
bool CSSShorthandPropertyAPIGrid::parseShorthand(
  ...
  if (CSSPropertyGridUtils::ConsumeGridTemplateShorthand(
    ...
    CSSPropertyParserHelpers::AddMultiProperties(
        CSSPropertyGrid, important,
        CSSPropertyParserHelpers::IsImplicitProperty::kNotImplicit, properties,
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridTemplateRows, template_rows),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridTemplateColumns, template_columns),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridTemplateAreas, template_areas));
    ...
    CSSPropertyParserHelpers::AddMultiProperties(
        ...
        CSSPropertyParserHelpers::IsImplicitProperty::kNotImplicit, properties,
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridAutoFlow, CSSInitialValue::Create()),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridAutoColumns, CSSInitialValue::Create()),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridAutoRows, CSSInitialValue::Create()),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridColumnGap, CSSInitialValue::Create()),
        std::make_pair<CSSPropertyID, const CSSValue*>(
            CSSPropertyGridRowGap, CSSInitialValue::Create()));
    return true;
  }
