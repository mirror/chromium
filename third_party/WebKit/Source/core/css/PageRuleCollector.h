...
class PageRuleCollector {
 ...
 private:
  bool IsLeftPage(const ComputedStyle* root_element_style, int page_index) const;
  bool IsRightPage(const ComputedStyle* root_element_style, int page_index) const {
