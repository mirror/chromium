  ...
  switch (resolved_property.PropertyID()) {
    ...
    case CSSPropertyWebkitMaskRepeat: {
      ...
      for (; curr_layer; curr_layer = curr_layer->Next()) {
        list->Append(*ComputedStyleUtils::ValueForFillRepeat(
            curr_layer->RepeatX(), curr_layer->RepeatY()));
      }
      return list;
    }
    ...
    case CSSPropertyWebkitMaskPosition: {
      ...
      const FillLayer* curr_layer =
          resolved_property.IDEquals(CSSPropertyWebkitMaskPosition)
              ...
              : &style.BackgroundLayers();
      for (; curr_layer; curr_layer = curr_layer->Next()) {
        list->Append(*ComputedStyleUtils::CreatePositionListForLayer(
            resolved_property, *curr_layer, style));
      }
      return list;
    }
