...
CSSValue* ComputedStyleCSSValueMapping::ValueForOffset(
  ...
  if (RuntimeEnabledFeatures::CSSOffsetPositionAnchorEnabled()) {
    CSSValue* position =
        ComputedStyleUtils::ValueForPosition(style.OffsetPosition(), style);
  ...
  if (RuntimeEnabledFeatures::CSSOffsetPositionAnchorEnabled()) {
    CSSValue* anchor =
        ComputedStyleUtils::ValueForPosition(style.OffsetAnchor(), style);
...
const CSSValue* ComputedStyleCSSValueMapping::Get(
  ...
  switch (resolved_property.PropertyID()) {
    ...
    case CSSPropertyOffsetPosition:
      return ComputedStyleUtils::ValueForPosition(style.OffsetPosition(),
                                                  style);
