...
CSSStyleSheet* CSSStyleSheet::Create(Document& document,
  ...
  // https://tabatkins.github.io/specs/construct-stylesheets/#dom-cssstylesheet-cssstylesheet
...
#endif
  if (owner_node.IsElementNode() && ToElement(owner_node)
                                        .getAttribute(HTMLNames::relAttr)
                                        .Contains("alternate"))
    alternate_ = true;
  contents_->RegisterClient(this);
}
