...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  const static blink::CSSParserMode parser_mode_map[] = {
    blink::kHTMLStandardMode,
    blink::kHTMLQuirksMode,
    blink::kSVGAttributeMode,
    blink::kCSSViewportRuleMode,
  ...
  blink::CSSParserMode mode = parser_mode_map[data[0] % 6];
