...
class CORE_EXPORT CSSParserTokenStream {
 ...
 public:
  ...
  // above the expected number of tokens in the prelude of an at rule.
  ...
  // Invalidates any ranges created by previous calls to ConsumeUntilLookAheadIs
  template <CSSParserTokenType... Types>
  CSSParserTokenRange ConsumeUntilLookAheadIs() {
    EnsureLookAhead();
