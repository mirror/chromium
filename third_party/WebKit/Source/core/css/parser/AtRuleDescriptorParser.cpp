...
CSSValue* AtRuleDescriptorParser::ParseFontFaceDescriptor(
    ...
    const String& string,
    const CSSParserContext& context) {
  CSSParserTokenRange range = ToCSSParserTokenRange(string);
...
bool AtRuleDescriptorParser::ParseAtRule(
    ...
    CSSParserTokenRange& range,
    const CSSParserContext& context,
    HeapVector<CSSPropertyValue, numAtRuleDescriptors> parsed_descriptors) {
  ...
  // TODO(crbug.com/752745): Refactor CSSParserImp to avoid using
  // the CSSPropertyID.
