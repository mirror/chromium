...
void AddMultiProperties(CSSPropertyID current_shorthand,
                        bool important,
                        IsImplicitProperty implicit,
                        HeapVector<CSSProperty, 256>& properties,
                        const Args&... args) {}

template <typename FirstProperty, typename... OtherProperties>
void AddMultiProperties(
    CSSPropertyID current_shorthand,
    bool important,
    IsImplicitProperty implicit,
    HeapVector<CSSProperty, 256>& properties,
    const std::pair<CSSPropertyID, const FirstProperty*>& first,
    const OtherProperties&... others) {
  AddProperty(first.first, current_shorthand, *first.second, important,
              implicit, properties);
  AddMultiProperties(current_shorthand, important, implicit, properties,
                     others...);
}
