    ...
    switch (property) {
      ...
      case CSSPropertyWebkitBoxReflect: {
        if (StyleReflection* reflection = style->BoxReflect()) {
          ...
          if (mask_image.GetImage() && mask_image.GetImage()->IsPendingImage()) {
            StyleImage* loaded_image =
                LoadPendingImage(style, ToStylePendingImage(mask_image.GetImage()));
      ...
      case CSSPropertyWebkitMaskImage: {
        for (FillLayer* mask_layer = &style->AccessMaskLayers(); mask_layer;
          ...
          if (mask_layer->GetImage() && mask_layer->GetImage()->IsPendingImage())
