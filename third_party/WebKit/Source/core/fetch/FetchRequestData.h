...
class FetchRequestData final
 ...
 public:
  ...
  network::mojom::blink::URLLoaderFactory* BlobURLLoaderFactory() const {
    return blob_url_loader_factory_.get();
  }
  void SetBlobURLLoaderFactory(
      network::mojom::blink::URLLoaderFactoryPtr factory) {
 ...
 private:
  ...
  String integrity_;
  bool keepalive_;
  // URLLoaderFactory if this is a request for a blob: URL.
