...
enum EFillBox { kBorderFillBox, kPaddingFillBox, kContentFillBox, kTextFillBox };
...
enum EFlexDirection { kFlowRow, kFlowRowReverse, kFlowColumn, kFlowColumnReverse };
...
enum GridAutoFlow {
  kAutoFlowRow = kInternalAutoFlowAlgorithmSparse | kInternalAutoFlowDirectionRow,
  kAutoFlowColumn =
...
enum ItemPosition {
  kItemPositionAuto,  // It will mean 'normal' after running the StyleAdjuster to
