...
void ComputedStyle::InvalidateInitialStyle() {
  MutableInitialStyle().SetTapHighlightColor(ComputedStyleInitialFunctions::InitialTapHighlightColor());
}
...
void ComputedStyle::ClearMultiCol() {
  SetColumnGapInternal(ComputedStyleInitialFunctions::InitialColumnGap());
  SetColumnWidthInternal(ComputedStyleInitialFunctions::InitialColumnWidth());
  SetColumnRuleStyle(ComputedStyleInitialFunctions::InitialColumnRuleStyle());
  SetColumnRuleWidthInternal(LayoutUnit(ComputedStyleInitialFunctions::InitialColumnRuleWidth()));
  SetColumnRuleColorInternal(ComputedStyleInitialFunctions::InitialColumnRuleColor());
  SetColumnRuleColorIsCurrentColor(ComputedStyleInitialFunctions::InitialColumnRuleColorIsCurrentColor());
  SetVisitedLinkColumnRuleColorInternal(ComputedStyleInitialFunctions::InitialVisitedLinkColumnRuleColor());
  SetColumnCountInternal(ComputedStyleInitialFunctions::InitialColumnCount());
  SetHasAutoColumnCountInternal(ComputedStyleInitialFunctions::InitialHasAutoColumnCount());
  SetHasAutoColumnWidthInternal(ComputedStyleInitialFunctions::InitialHasAutoColumnWidth());
  ResetColumnFill();
  SetHasNormalColumnGapInternal(ComputedStyleInitialFunctions::InitialHasNormalColumnGap());
  ResetColumnSpan();
}
