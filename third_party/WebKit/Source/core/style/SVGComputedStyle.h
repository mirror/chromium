...
class CORE_EXPORT SVGComputedStyle : public RefCounted<SVGComputedStyle> {
 public:
  ...
  static const AtomicString& InitialMarkerStartResource() { return g_null_atom; }
  ...
  LineJoin JoinStyle() const { return (LineJoin)svg_inherited_flags.join_style; }
  ...
  const Length& BaselineShiftValue() const { return misc->baseline_shift_value; }
  ...
  struct InheritedFlags {
    bool operator==(const InheritedFlags& other) const {
      return (color_rendering == other.color_rendering) &&
             ...
             (cap_style == other.cap_style) && (join_style == other.join_style) &&
             (text_anchor == other.text_anchor) &&
             (color_interpolation == other.color_interpolation) &&
             (color_interpolation_filters == other.color_interpolation_filters) &&
