...
class CORE_EXPORT ComputedStyle : public ComputedStyleBase,
 ...
 public:
  ...
  void SetBackdropFilter(const FilterOperations& ops) {
    SET_NESTED_VAR(rare_non_inherited_data_, backdrop_filter_, operations_, ops);
  }
  ...
  float BorderLeftWidth() const {
    return surround_->border_.BorderLeftWidth();
  }
  ...
  void SetFlexBasis(const Length& length) {
    SET_NESTED_VAR(rare_non_inherited_data_, flexible_box_, flex_basis_, length);
  }
  ...
  void SetBoxFlexGroup(unsigned fg) {
    SET_NESTED_VAR(rare_non_inherited_data_, deprecated_flexible_box_, flex_group,
                   fg);
  }
  ...
  void SetBoxAlign(EBoxAlignment a) {
    SET_NESTED_VAR(rare_non_inherited_data_, deprecated_flexible_box_, align, a);
  }
  ...
  void SetBoxOrient(EBoxOrient o) {
    SET_NESTED_VAR(rare_non_inherited_data_, deprecated_flexible_box_, orient, o);
  }
  ...
  void SetGridTemplateRows(const Vector<GridTrackSize>& lengths) {
    SET_NESTED_VAR(rare_non_inherited_data_, grid_, grid_template_rows_, lengths);
  }
  ...
  void SetMarginLeft(const Length& v) {
    SET_VAR(surround_, margin_.left_, v);
  }
  ...
  void SetPaddingTop(const Length& v) {
    SET_VAR(surround_, padding_.top_, v);
  }
  ...
  TextOrientation GetTextOrientation() const {
    return static_cast<TextOrientation>(rare_inherited_data_->text_orientation_);
  }
  ...
  void SetLineBreak(LineBreak b) { SET_VAR(rare_inherited_data_, line_break, b); }
  ...
  TextEmphasisFill GetTextEmphasisFill() const {
    return static_cast<TextEmphasisFill>(rare_inherited_data_->text_emphasis_fill);
  }
  ...
  float TextStrokeWidth() const { return rare_inherited_data_->text_stroke_width; }
  ...
  void SetHasAuthorBackground(bool author_background) {
    SET_VAR(rare_non_inherited_data_, has_author_background_, author_background);
  }
  ...
  void SetHasCurrentBackdropFilterAnimation(bool b = true) {
    SET_VAR(rare_non_inherited_data_, has_current_backdrop_filter_animation_, b);
  }
  ...
  void SetIsRunningOpacityAnimationOnCompositor(bool b = true) {
    SET_VAR(rare_non_inherited_data_, running_opacity_animation_on_compositor_, b);
  }
  ...
  void SetIsRunningTransformAnimationOnCompositor(bool b = true) {
    SET_VAR(rare_non_inherited_data_, running_transform_animation_on_compositor_, b);
  }
  ...
  void SetIsRunningFilterAnimationOnCompositor(bool b = true) {
    SET_VAR(rare_non_inherited_data_, running_filter_animation_on_compositor_, b);
  }

  bool IsRunningBackdropFilterAnimationOnCompositor() const {
    return rare_non_inherited_data_->running_backdrop_filter_animation_on_compositor_;
  }
  ...
  const FillLayer& MaskLayers() const { return rare_non_inherited_data_->mask_; }
  ...
  size_t GridAutoRepeatColumnsInsertionPoint() const {
    return rare_non_inherited_data_->grid_->auto_repeat_columns_insertion_point_;
  }
  ...
  const NamedGridLinesMap& AutoRepeatNamedGridColumnLines() const {
    return rare_non_inherited_data_->grid_->auto_repeat_named_grid_column_lines_;
  }
  ...
  const OrderedNamedGridLines& AutoRepeatOrderedNamedGridRowLines() const {
    return rare_non_inherited_data_->grid_->auto_repeat_ordered_named_grid_row_lines_;
  }
  ...
  void SetNamedGridColumnLines(const NamedGridLinesMap& named_grid_column_lines) {
  ...
  void SetNamedGridAreaColumnCount(size_t column_count) {
    SET_NESTED_VAR(rare_non_inherited_data_, grid_, named_grid_area_column_count_,
                   column_count);
  }
  ...
  const BorderValue& BorderRight() const {
    return surround_->border_.Right();
  }
  ...
  bool HasBorderRadius() const {
    return surround_->border_.HasBorderRadius();
  }
  ...
  void ResetBorderRight() {
    SET_VAR(surround_, border_.right_, BorderValue());
  }
  void ResetBorderBottom() {
    SET_VAR(surround_, border_.bottom_, BorderValue());
  }
  void ResetBorderLeft() {
    SET_VAR(surround_, border_.left_, BorderValue());
  }
  ...
  FloatRoundedRect GetRoundedInnerBorderFor(
      ...
      bool include_logical_left_edge = true,
      bool include_logical_right_edge = true) const;
  FloatRoundedRect GetRoundedInnerBorderFor(const LayoutRect& border_rect,
  ...
  bool HasViewportConstrainedPosition() const {
    return GetPosition() == EPosition::kFixed || GetPosition() == EPosition::kSticky;
  }
  ...
  CursorList* Cursors() const { return rare_inherited_data_->cursor_data.Get(); }
 ...
 private:
  ...
  StyleColor VisitedLinkColumnRuleColor() const {
    return rare_non_inherited_data_->multi_col_->visited_link_column_rule_color_;
  }
...
inline float AdjustScrollForAbsoluteZoom(float scroll_offset, float zoom_factor) {
...
inline bool ComputedStyle::SetEffectiveZoom(float f) {
  ...
  if (compareEqual(rare_inherited_data_->effective_zoom_, clamped_effective_zoom))
    return false;
...
inline bool ComputedStyle::SetTextOrientation(TextOrientation text_orientation) {
