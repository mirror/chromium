 ...
 private:
  ...
  PhysicalToLogical<const Length&> PhysicalMarginToLogical(
    ...
    return PhysicalToLogical<const Length&>(
        other.GetWritingMode(), other.Direction(), MarginTop(), MarginLeft(),
  ...
  PhysicalToLogical<const BorderValue&> PhysicalBorderToLogical(
      const ComputedStyle& other) const {
    return PhysicalToLogical<const BorderValue&>(
        other.GetWritingMode(), other.Direction(), BorderTop(), BorderLeft(),
  ...
  PhysicalToLogical<EBorderStyle> PhysicalBorderStyleToLogical() const {
    return PhysicalToLogical<EBorderStyle>(
        GetWritingMode(), Direction(), BorderTopStyle(), BorderLeftStyle(),
