...
bool SVGComputedStyle::DiffNeedsLayoutAndPaintInvalidation(
  ...
  if (svg_inherited_flags.text_anchor != other->svg_inherited_flags.text_anchor ||
  ...
  if (stroke.Get() != other->stroke.Get()) {
    if (stroke->width != other->stroke->width ||
        ...
        *stroke->dash_array != *other->stroke->dash_array ||
        ...
        stroke->visited_link_paint_color != other->stroke->visited_link_paint_color ||
        stroke->visited_link_paint_uri != other->stroke->visited_link_paint_uri ||
        stroke->visited_link_paint_type != other->stroke->visited_link_paint_type)
      return true;
  }
