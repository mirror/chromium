...
class CORE_EXPORT PrintContext
 ...
 public:
  ...
  // second parameter.
  virtual void ComputePageRectsWithPageSize(const FloatSize& page_size_in_pixels);
 ...
 private:
  void ComputePageRectsWithPageSizeInternal(const FloatSize& page_size_in_pixels);
