...
class CORE_EXPORT Page final : public GarbageCollectedFinalized<Page>,
 ...
 public:
  ...
  void SetSpellCheckStatus(SpellCheckStatus status) {
    spell_check_this_field_status_ = status;
  }
  SpellCheckStatus GetSpellCheckStatus() {
    return spell_check_this_field_status_;
  }
 ...
 private:
  ...
  SpellCheckStatus spell_check_this_field_status_ =
      SpellCheckStatus::kAutomatic;
