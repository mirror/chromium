...
static ScrollOffset FindSnapOffsetOnX(ScrollOffset current_offset,
...
static ScrollOffset FindSnapOffsetOnY(ScrollOffset current_offset,
                                      const SnapContainerData& data) {
...
static ScrollOffset FindSnapOffsetOnBoth(ScrollOffset current_offset,
                                         const SnapContainerData& data) {
