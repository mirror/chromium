...
TEST_P(SnapCoordinatorTest, StartAlignmentCalculation) {
  ...
  SnapContainerData expected_container(
      ScrollSnapType(false, kSnapAxisBoth, SnapStrictness::kMandatory),
      gfx::ScrollOffset(scrollable_x, scrollable_y));
  SnapAreaData expected_area(kSnapAxisBoth,
...
TEST_P(SnapCoordinatorTest, FindsClosestSnapOffsetOnX) {
  SnapContainerData container_data(
      ScrollSnapType(false, kSnapAxisX, SnapStrictness::kMandatory),
      gfx::ScrollOffset(360, 380));
  ScrollOffset current_offset(100, 20);
  SnapAreaData snap_y_only(
      kSnapAxisY, gfx::ScrollOffset(SnapAreaData::kInvalidScrollOffset, 40),
      false);
  SnapAreaData distance_20(kSnapAxisBoth, gfx::ScrollOffset(120, 30), false);
  SnapAreaData distance_30(kSnapAxisX, gfx::ScrollOffset(70, 20), false);
...
TEST_P(SnapCoordinatorTest, FindsClosestSnapOffsetOnY) {
  SnapContainerData container_data(
      ScrollSnapType(false, kSnapAxisY, SnapStrictness::kMandatory),
      gfx::ScrollOffset(380, 360));
  ScrollOffset current_offset(20, 100);
  SnapAreaData snap_x_only(
      kSnapAxisX, gfx::ScrollOffset(40, SnapAreaData::kInvalidScrollOffset),
      false);
  SnapAreaData distance_20(kSnapAxisBoth, gfx::ScrollOffset(30, 120), false);
  SnapAreaData distance_30(kSnapAxisY, gfx::ScrollOffset(20, 70), false);
...
TEST_P(SnapCoordinatorTest, FindsClosestSnapOffsetOnBoth) {
  SnapContainerData container_data(
      ScrollSnapType(false, kSnapAxisBoth, SnapStrictness::kMandatory),
      gfx::ScrollOffset(360, 380));
  ScrollOffset current_offset(100, 100);
  SnapAreaData snap_x_only(
      kSnapAxisX, gfx::ScrollOffset(80, SnapAreaData::kInvalidScrollOffset),
      false);
  SnapAreaData snap_y_only(
      kSnapAxisY, gfx::ScrollOffset(SnapAreaData::kInvalidScrollOffset, 70),
      false);
  SnapAreaData snap_on_both(kSnapAxisBoth, gfx::ScrollOffset(50, 150), false);
  container_data.AddSnapAreaData(snap_x_only);
  container_data.AddSnapAreaData(snap_y_only);
