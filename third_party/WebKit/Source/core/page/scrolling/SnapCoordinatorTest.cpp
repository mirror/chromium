...
TEST_P(SnapCoordinatorTest, FindsClosestSnapOffsetOnX) {
  ...
  SnapAreaData snap_y_only(
      SnapAxis::kY, gfx::ScrollOffset(SnapAreaData::kInvalidScrollOffset, 40),
      false);
  SnapAreaData distance_20(SnapAxis::kBoth, gfx::ScrollOffset(120, 30), false);
  SnapAreaData distance_30(SnapAxis::kX, gfx::ScrollOffset(70, 20), false);
...
TEST_P(SnapCoordinatorTest, FindsClosestSnapOffsetOnY) {
  ...
  SnapAreaData snap_x_only(
      SnapAxis::kX, gfx::ScrollOffset(40, SnapAreaData::kInvalidScrollOffset),
      false);
  SnapAreaData distance_20(SnapAxis::kBoth, gfx::ScrollOffset(30, 120), false);
  SnapAreaData distance_30(SnapAxis::kY, gfx::ScrollOffset(20, 70), false);
