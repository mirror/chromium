...
OverscrollController::OverscrollController(const VisualViewport& visual_viewport,
...
void OverscrollController::HandleOverscroll(
  ...
  FloatSize delta_in_viewport = unused_delta.ScaledBy(visual_viewport_->Scale());
  ...
  if (delta_in_viewport != FloatSize()) {
    ...
    chrome_client_->DidOverscroll(delta_in_viewport, accumulated_root_overscroll_,
