...
class CORE_EXPORT SnapCoordinator final
 ...
 public:
  ...
  // Get the SnapContainerData for the specific snap container.
  SnapContainerData GetSnapContainerData(LayoutBox*);

  // Get the SnapAreaData for the specific snap area in its snap container.
  SnapAreaData GetSnapAreaData(const LayoutBox&, const LayoutBox&);
