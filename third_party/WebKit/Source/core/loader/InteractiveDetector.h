...
// TODO(dproy): This class currently only detects Consistently Interactive.
// Implement FirstInteractive.
class CORE_EXPORT InteractiveDetector
 ...
 private:
  ...
  // FindFirstConsistentlyInteractiveCandidate.
  ...
  void UpdateNetworkQuiescenceState(double request_count,
                                    double opt_current_time);
