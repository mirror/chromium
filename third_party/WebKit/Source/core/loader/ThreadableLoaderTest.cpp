...
class ThreadableLoaderTest
 ...
 public:
  ...
  void ServeRequests() {
    ...
    loader_factory->ServeAsynchronousRequests();
  }
 ...
 private:
  ...
  void SetUpSuccessURL() {
    URLTestHelpers::RegisterMockedURLLoad(SuccessURL(),
                                          ...
                                          loader_factory, "text/html");
  }

  void SetUpErrorURL() {
    URLTestHelpers::RegisterMockedErrorURLLoad(ErrorURL(), loader_factory);
  }
  ...
  void SetUpRedirectURL() {
    ...
    URLTestHelpers::RegisterMockedURLLoadWithCustomResponse(
        url, testing::CoreTestDataPath(kFileName), response, loader_factory);
  }
