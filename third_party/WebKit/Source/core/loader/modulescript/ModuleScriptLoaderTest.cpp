...
TEST_F(ModuleScriptLoaderTest, FetchDataURL) {
  ...
  EXPECT_FALSE(client->GetModuleScript()->HasParseErrorForTest());
}
...
TEST_F(ModuleScriptLoaderTest, FetchDataURL_OnWorklet) {
  ...
  EXPECT_FALSE(client1->GetModuleScript()->HasParseErrorForTest());
  ...
  EXPECT_FALSE(client2->GetModuleScript()->HasParseErrorForTest());
}
...
TEST_F(ModuleScriptLoaderTest, InvalidSpecifier) {
  ...
  EXPECT_TRUE(client->GetModuleScript()->HasParseErrorForTest());
}
