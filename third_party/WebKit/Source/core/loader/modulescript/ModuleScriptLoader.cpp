...
void ModuleScriptLoader::NotifyFinished(Resource*) {
  ...
  AccessControlStatus access_control_status =
      GetResource()->CalculateAccessControlStatus(modulator_->GetSecurityOrigin());
  ...
  module_script_ = CreateModuleScript(
      ...
      parser_state_, GetResource()->GetResourceRequest().GetFetchCredentialsMode(),
...
ModuleScript* ModuleScriptLoader::CreateModuleScript(
  ...
  return ModuleScript::Create(result, url, nonce, parser_state, credentials_mode);
}
