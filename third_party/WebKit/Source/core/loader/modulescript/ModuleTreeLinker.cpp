...
void ModuleTreeLinker::AdvanceState(State new_state) {
  ...
  if (state_ == State::kFinished) {
    ...
    // Step 7. When the fetch the descendants of and instantiate a module script
    // algorithm asynchronously completes with final result, asynchronously
    // complete this algorithm with final result.
