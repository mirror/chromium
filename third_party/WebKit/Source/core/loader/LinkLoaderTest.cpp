...
struct ModulePreloadTestParams {
  ...
  bool expecting_load;
  WebURLRequest::FetchCredentialsMode expected_credentials_mode;
};
...
constexpr ModulePreloadTestParams kModulePreloadTestParams[] = {
    ...
    {"http://example.test/cat.js", nullptr, kCrossOriginAttributeNotSet,
     kReferrerPolicyDefault, true, WebURLRequest::kFetchCredentialsModeOmit},
    ...
    {"http://example.test/cat.js", "nonce", kCrossOriginAttributeNotSet,
     kReferrerPolicyNever, true, WebURLRequest::kFetchCredentialsModeOmit}};
