...
TEST(MixedContentCheckerTest, ContextTypeForInspector) {
  ...
  blockable_mixed_content.SetRequestContext(WebURLRequest::kRequestContextScript);
  ...
  blockable_mixed_content.SetFrameType(WebURLRequest::kFrameTypeAuxiliary);
  blockable_mixed_content.SetRequestContext(WebURLRequest::kRequestContextImage);
