...
void InteractiveDetector::CheckTimeToInteractiveReached() {
  ...
  if (current_time - page_event_times_.fmp < kTimeToInteractiveWindowSeconds) {
  ...
  const double interactive_candidate =
      FindInteractiveCandidate(page_event_times_.fmp);
  ...
  interactive_time_ =
      std::max({interactive_candidate, page_event_times_.dcl_end});
