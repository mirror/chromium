...
void DictionaryTest::get(InternalDictionary& result) {
  ...
  if (long_or_null_member_with_default_)
    result.setLongOrNullMemberWithDefault(long_or_null_member_with_default_.Get());
  if (boolean_member_)
  ...
  result.setStringSequenceMemberWithDefault(string_sequence_member_with_default_);
...
void DictionaryTest::setDerived(const InternalDictionaryDerived& derived) {
  ...
  derived_string_member_with_default_ = derived.derivedStringMemberWithDefault();
