...
class CORE_EXPORT WebDevToolsAgentBase
    : public GarbageCollectedFinalized<WebDevToolsAgentBase>,
      ...
      NON_EXPORTED_BASE(public InspectorTracingAgent::Client),
      NON_EXPORTED_BASE(public InspectorPageAgent::Client),
      NON_EXPORTED_BASE(public InspectorSession::Client),
