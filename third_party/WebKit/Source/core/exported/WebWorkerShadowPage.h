...
// WebWorkerShadowPage implements the 'shadow page' concept.
//
...
// loading on such the workers, this class provides a virtual frame (a.k.a,
// shadow page) to them.
//
// WebWorkerShadowPage lives on the main thread.
