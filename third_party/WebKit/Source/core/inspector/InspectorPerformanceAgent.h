...
class CORE_EXPORT InspectorPerformanceAgent final
 ...
 public:
  ...
  static InspectorPerformanceAgent* Create(PerformanceMonitor*) {
    return new InspectorPerformanceAgent(performance_monitor);
  }
  ~InspectorPerformanceAgent() override;

  protocol::Response enableMetrics(
 ...
 private:
  InspectorPerformanceAgent(PerformanceMonitor*);

  Member<PerformanceMonitor> performance_monitor_;
  std::unordered_set<PerformanceMonitor::MetricsType> enabled_metrics_;
  std::unordered_map<String, PerformanceMonitor::MetricsType> metric_names_map_;
