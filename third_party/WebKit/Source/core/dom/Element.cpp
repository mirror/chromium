...
ShadowRoot& Element::CreateUserAgentShadowRoot() {
  ...
  return EnsureShadow().AddShadowRoot(*this, ShadowRootType::kUserAgentV0);
}
...
ShadowRoot& Element::EnsureUserAgentShadowRootV0() {
  if (ShadowRoot* shadow_root = UserAgentShadowRoot()) {
    DCHECK(shadow_root->GetType() == ShadowRootType::kUserAgentV0);
    return *shadow_root;
  }
  ShadowRoot& shadow_root =
      EnsureShadow().AddShadowRoot(*this, ShadowRootType::kUserAgentV0);
