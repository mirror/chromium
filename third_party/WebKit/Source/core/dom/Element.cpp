...
void Element::CallDistributeScroll(ScrollState& scroll_state) {
  ...
  bool should_consider_scroll_customization =
      !RuntimeEnabledFeatures::ScrollCustomizationEnabled() ||
      RootScrollerUtil::IsGlobal(this);

  if (!callback || disable_custom_callbacks ||
      (should_consider_scroll_customization &&
       !ShouldCallScrollCustomizationHandlers(scroll_state))) {
...
bool Element::ShouldCallScrollCustomizationHandlers(
  ...
  if (scroll_state.isBeginning()) {
    ...
    if (scroll_customization == ScrollCustomizationEnabledDirection::kAuto ||
      ...
      GetScrollCustomizationCallbacks().SetHasCustomizedScroll(this, true);
    }
  }
