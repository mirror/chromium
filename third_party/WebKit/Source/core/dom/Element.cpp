...
void Element::RecalcContainedStyleForReattach() {
  ...
  RecalcPseudoStylesForReattach(kPseudoIdAfter);
  RecalcShadowRootStylesForReattach();
  RecalcDescendantStylesForReattach();
  RecalcPseudoStylesForReattach(kPseudoIdBefore);
  RecalcPseudoStylesForReattach(kPseudoIdBackdrop);
  RecalcPseudoStylesForReattach(kPseudoIdFirstLetter);
}
...
void Element::RecalcPseudoStylesForReattach(PseudoId pseudo_id) {
