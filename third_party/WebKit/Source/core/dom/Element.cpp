...
int Element::OffsetLeft() {
  ...
  if (LayoutBoxModelObject* layout_object = GetLayoutBoxModelObject())
    return AdjustForAbsoluteZoom::AdjustLayoutUnitForAbsoluteZoom(
               LayoutUnit(
...
int Element::clientLeft() {
  ...
  if (LayoutBox* layout_object = GetLayoutBox())
    return AdjustForAbsoluteZoom::AdjustLayoutUnitForAbsoluteZoom(
               layout_object->ClientLeft(), layout_object->StyleRef())
        .Round();
  return 0;
}
...
int Element::clientTop() {
  ...
  if (LayoutBox* layout_object = GetLayoutBox())
    return AdjustForAbsoluteZoom::AdjustLayoutUnitForAbsoluteZoom(
               layout_object->ClientTop(), layout_object->StyleRef())
        .Round();
  return 0;
}
...
double Element::scrollLeft() {
  ...
  if (LayoutBox* box = GetLayoutBox()) {
    return AdjustForAbsoluteZoom::AdjustScrollForAbsoluteZoom(box->ScrollLeft(),
                                                              *box);
  }
...
double Element::scrollTop() {
  ...
  if (LayoutBox* box = GetLayoutBox()) {
    return AdjustForAbsoluteZoom::AdjustScrollForAbsoluteZoom(box->ScrollTop(),
                                                              *box);
  }
...
int Element::scrollWidth() {
  ...
  if (GetDocument().ScrollingElementNoLayout() == this) {
    if (GetDocument().View()) {
      return AdjustForAbsoluteZoom::AdjustIntForAbsoluteZoom(
          GetDocument()
              .View()
  ...
  if (LayoutBox* box = GetLayoutBox()) {
    return AdjustForAbsoluteZoom::AdjustIntForAbsoluteZoom(
        box->PixelSnappedScrollWidth(), box);
  }
  return 0;
}
...
int Element::scrollHeight() {
  ...
  if (LayoutBox* box = GetLayoutBox()) {
    return AdjustForAbsoluteZoom::AdjustIntForAbsoluteZoom(
        box->PixelSnappedScrollHeight(), box);
  }
  return 0;
}
