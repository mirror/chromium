...
// RequestFullscreenScope allocated at the top of |RequestFullscreen()| and used
// to avoid synchronously changing any state within that method, by defering
// changes in |DidEnterFullscreen()|.
