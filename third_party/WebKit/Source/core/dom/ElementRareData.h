...
class ElementRareData : public NodeRareData {
 public:
  ...
  LayoutSize MinimumSizeForResizing() const { return minimum_size_for_resizing_; }
  ...
  ElementAnimations* GetElementAnimations() { return element_animations_.Get(); }
...
inline PseudoElement* ElementRareData::GetPseudoElement(PseudoId pseudo_id) const {
  if (!pseudo_element_data_)
    return nullptr;
