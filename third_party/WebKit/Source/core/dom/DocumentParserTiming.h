...
class DocumentParserTiming final
 ...
 private:
  ...
  double parser_blocked_on_script_load_duration_;
  double parser_blocked_on_script_load_from_document_write_duration_;
  double parser_blocked_on_script_execution_duration_;
  double parser_blocked_on_script_execution_from_document_write_duration_;
