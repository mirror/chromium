...
class CORE_EXPORT DocumentPaintDefinition final
    : public GarbageCollectedFinalized<DocumentPaintDefinition>,
      public TraceWrapperBase {
 public:
  static DocumentPaintDefinition* Create(Vector<CSSPropertyID>&,
                                         Vector<AtomicString>&,
                                         Vector<CSSSyntaxDescriptor>&,
                                         bool has_alpha);
 ...
 private:
  DocumentPaintDefinition(Vector<CSSPropertyID>&,
                          Vector<AtomicString>&,
                          Vector<CSSSyntaxDescriptor>&,
                          bool has_alpha);
