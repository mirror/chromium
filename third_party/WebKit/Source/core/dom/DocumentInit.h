...
class CORE_EXPORT DocumentInit final {
 ...
 public:
  DocumentInit();
  static DocumentInit FromFrame(LocalFrame*, const KURL&, Document*);
  static DocumentInit FromContext(Document*, const KURL&);
  static DocumentInit FromURL(const KURL&);
  static DocumentInit FromImportsController(HTMLImportsController*,
                                            Document*,
                                            const KURL&);
