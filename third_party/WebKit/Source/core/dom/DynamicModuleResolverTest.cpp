...
class DynamicModuleResolverTestModulator final : public DummyModulator {
 ...
 private:
  ...
  void ExecuteModule(const ModuleScript* module_script) final {
...
TEST(DynamicModuleResolverTest, ResolveSuccess) {
  ...
  resolver->ResolveDynamically("./dependency.js",
                               "https://example.com/referrer.js",
...
TEST(DynamicModuleResolverTest, ResolveSpecifierFailure) {
  ...
  DynamicModuleResolver* resolver = DynamicModuleResolver::Create(modulator);
  resolver->ResolveDynamically("invalid-specifier",
                               "https://example.com/referrer.js",
                               ReferrerScriptInfo(), promise_resolver);
