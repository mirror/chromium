...
class CORE_EXPORT TrustedHTML final : public GarbageCollectedFinalized<TrustedHTML>,
                                   public ScriptWrappable {
  DEFINE_WRAPPERTYPEINFO();

 public:
  static TrustedHTML* Create(const String& html) { return new TrustedHTML(html); }
