...
TEST_F(ElementTest, GetBoundingClientRectForSVG) {
  ...
  SetBodyContent(
      ...
      "      stroke-width='7'/>"
      "  <rect id='stroke_transformed' x='10' y='100' width='100' height='100' "
      ...
      "    <rect width='100' height='100' stroke-width='7'/>"
      "  </svg>"
      "</svg>");
  ...
  EXPECT_EQ(IntRect(10, 100, 100, 100), rect->BoundsInViewport());
  ...
  EXPECT_EQ(IntRect(10, 100, 100, 100), stroke->BoundsInViewport());
  ...
  EXPECT_EQ(100, stroke_transformedbounding_client_rect->height());
  // TODO(pdr): BoundsInViewport is not web exposed and should include stroke.
  EXPECT_EQ(IntRect(13, 105, 100, 100), stroke_transformed->BoundsInViewport());
  ...
  EXPECT_EQ(IntRect(10, 100, 100, 100), foreign->BoundsInViewport());
  ...
  EXPECT_EQ(100, foreign_transformed_bounding_client_rect->height());
  EXPECT_EQ(IntRect(13, 105, 100, 100),
  ...
  EXPECT_EQ(100, svg_bounding_client_rect->height());
  EXPECT_EQ(IntRect(10, 100, 100, 100), svg->BoundsInViewport());
  ...
  EXPECT_EQ(100, svg_stroke_bounding_client_rect->height());
  // TODO(pdr): BoundsInViewport is not web exposed and should include stroke.
  EXPECT_EQ(IntRect(10, 100, 100, 100), svg_stroke->BoundsInViewport());
}
