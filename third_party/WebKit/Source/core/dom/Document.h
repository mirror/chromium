...
class CORE_EXPORT Document : public ContainerNode,
 ...
 public:
  ...
  // document.open() opens a new window when called with three argements
  Document* open(LocalDOMWindow* calling_window,
                 const AtomicString& type,
                 const AtomicString& replace,
                 ExceptionState&);
  DOMWindow* open(LocalDOMWindow* calling_window,
