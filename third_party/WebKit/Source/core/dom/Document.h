...
enum ShadowCascadeOrder { kShadowCascadeNone, kShadowCascadeV0, kShadowCascadeV1 };
...
class CORE_EXPORT Document : public ContainerNode,
 ...
 public:
  ...
  TransformSource* GetTransformSource() const { return transform_source_.get(); }
  ...
  void SetContainsValidityStyleRules() { contains_validity_style_rules_ = true; }
  ...
  ShadowCascadeOrder GetShadowCascadeOrder() const { return shadow_cascade_order_; }
 ...
 private:
  ...
  KURL base_url_override_;  // An alternative base URL that takes precedence over
