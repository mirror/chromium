...
class CORE_EXPORT ScriptedIdleTaskController
 ...
 public:
  ...
  // IdleTask is the parent class for classes which used to inherit
  // IdleRequestCallback.
  ...
  // V8IdleTask is the adapter class for the conversion of V8IdleRequestCallback
  // to IdleTask.
  ...
  int RegisterIdleCallback(IdleTask*, const IdleRequestOptions&);
