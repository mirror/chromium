...
class CORE_EXPORT ScriptedIdleTaskController
 ...
 public:
  ...
  // IdleTask is an interface type which represents tasks that you want to
  // register. RegisterCallback is used for registering tasks, and |invoke| is
  // called back in an idle moment.
