...
// TODO(xidachen): the ParsedOptions structure should be in the private field,
// and make all the functions using it as private util function.
...
class CORE_EXPORT ImageBitmap final
 ...
 private:
  ...
  void CropImageAndApplyColorSpaceConversion(
      RefPtr<Image>,
      ParsedOptions&,
      AlphaDisposition,
