...
void BoxPainter::PaintBoxDecorationBackground(const PaintInfo& paint_info,
  ...
  if (IsPaintingBackgroundOfPaintContainerIntoScrollingContentsLayer(
    ...
    if (RootScrollerUtil::IsGlobal(layout_box_))
      paint_rect.Unite(RootScrollerUtil::ViewportPaintRect(layout_box_));
    ...
    paint_rect = RootScrollerUtil::IsGlobal(layout_box_)
                     ? RootScrollerUtil::ViewportPaintRect(layout_box_)
...
LayoutRect BoxPainter::BoundsForDrawingRecorder(
  ...
  if (IsPaintingBackgroundOfPaintContainerIntoScrollingContentsLayer(
    ...
    if (RootScrollerUtil::IsGlobal(layout_box_))
      bounds.Unite(RootScrollerUtil::ViewportPaintRect(layout_box_));
  } else {
