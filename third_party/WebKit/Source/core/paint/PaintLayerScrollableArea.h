...
class CORE_EXPORT PaintLayerScrollableArea final
 ...
 private:
  ...
  // If the content fits entirely in the area without auto scrollbars, remove
  // the scrollbars and return true. This is a heuristic and can be incorrect if
  // the content size depends on the scrollbar size (e.g., percentage sizing).
  bool TryRemovingAutoScrollbars(bool& needs_horizontal_scrollbar,
                                 bool& needs_vertical_scrollbar);
