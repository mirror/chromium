...
BoxReflection BoxReflectionForPaintLayer(const PaintLayer& layer,
  ...
  LayoutRect frame_layout_rect = ToLayoutBox(layer.GetLayoutObject()).FrameRect();
  ...
  switch (reflect_style->Direction()) {
    case kReflectionAbove:
      ...
      offset = -FloatValueForLength(reflect_style->Offset(), frame_rect.Height());
      break;
    case kReflectionBelow:
      direction = BoxReflection::kVerticalReflection;
      offset = 2 * frame_rect.Height() +
    ...
    case kReflectionLeft:
      ...
      offset = -FloatValueForLength(reflect_style->Offset(), frame_rect.Width());
      break;
