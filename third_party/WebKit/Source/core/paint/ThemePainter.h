...
class ThemePainter {
 ...
 public:
  ...
  bool PaintBorderOnly(Node*,
                       const ComputedStyle&,
                       const PaintInfo&,
                       const IntRect&);
  bool PaintDecorations(Node*,
                        const ComputedStyle&,
                        const PaintInfo&,
                        const IntRect&);
 ...
 protected:
  virtual bool PaintCheckbox(Node*,
                             const ComputedStyle&,
                             const PaintInfo&,
                             const IntRect&) {
    return true;
  }
  virtual bool PaintRadio(Node*,
                          const ComputedStyle&,
                          const PaintInfo&,
                          const IntRect&) {
    return true;
  }
  virtual bool PaintButton(Node*,
                           const ComputedStyle&,
                           const PaintInfo&,
                           const IntRect&) {
    return true;
  }
  virtual bool PaintInnerSpinButton(Node*,
                                    const ComputedStyle&,
                                    const PaintInfo&,
                                    const IntRect&) {
    return true;
  }
  virtual bool PaintTextField(Node*,
                              const ComputedStyle&,
                              const PaintInfo&,
                              const IntRect&) {
    return true;
  }
  virtual bool PaintTextArea(Node*,
                             const ComputedStyle&,
                             const PaintInfo&,
                             const IntRect&) {
    return true;
  }
  virtual bool PaintMenuList(Node*,
                             const ComputedStyle&,
                             const PaintInfo&,
                             const IntRect&) {
    return true;
  }
  virtual bool PaintMenuListButton(Node* node,
                                   const ComputedStyle&,
                                   const PaintInfo&,
                                   const IntRect&) {
    return true;
  ...
  virtual bool PaintSliderThumb(Node*,
                                const ComputedStyle&,
                                const PaintInfo&,
                                const IntRect&) {
    return true;
  }
  virtual bool PaintSearchField(Node*,
                                const ComputedStyle&,
                                const PaintInfo&,
                                const IntRect&) {
    return true;
  ...
  bool PaintUsingFallbackTheme(Node*,
                               const ComputedStyle&,
                               const PaintInfo&,
                               const IntRect&);
  bool PaintCheckboxUsingFallbackTheme(Node*,
                                       const ComputedStyle&,
                                       const PaintInfo&,
                                       const IntRect&);
  bool PaintRadioUsingFallbackTheme(Node*,
                                    const ComputedStyle&,
                                    const PaintInfo&,
                                    const IntRect&);
};
