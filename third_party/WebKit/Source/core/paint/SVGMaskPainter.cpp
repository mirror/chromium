  ...
  FloatRect visual_rect = object.VisualRectInLocalSVGCoordinates();
  {
    ColorFilter mask_layer_filter =
        mask_.Style()->SvgStyle().MaskType() == MT_LUMINANCE
            ...
            : kColorFilterNone;
    CompositingRecorder mask_compositing(context, object, SkBlendMode::kDstIn, 1,
                                        &visual_rect, mask_layer_filter);
    ...
    if (RuntimeEnabledFeatures::slimmingPaintV2Enabled()) {
      ...
      scoped_paint_chunk_properties.emplace(context.GetPaintController(), object,
                                         properties);
    }
