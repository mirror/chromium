...
WebThemeEngine::State GetWebThemeState(Node* node) {
...
bool ThemePainterDefault::PaintCheckbox(Node* node,
...
bool ThemePainterDefault::PaintRadio(Node* node,
                                     const ComputedStyle&,
                                     const PaintInfo& paint_info,
                                     const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintButton(Node* node,
                                      const ComputedStyle& style,
                                      const PaintInfo& paint_info,
                                      const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintTextField(Node* node,
                                         const ComputedStyle& style,
                                         const PaintInfo& paint_info,
                                         const IntRect& rect) {
...
bool ThemePainterDefault::PaintMenuList(Node* node,
                                        const ComputedStyle& style,
                                        const PaintInfo& i,
                                        const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintMenuListButton(Node* node,
                                              const ComputedStyle& style,
                                              const PaintInfo& paint_info,
                                              const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintSliderThumb(Node* node,
                                           const ComputedStyle& style,
                                           const PaintInfo& paint_info,
                                           const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintInnerSpinButton(Node* node,
                                               const ComputedStyle& style,
                                               const PaintInfo& paint_info,
                                               const IntRect& rect) {
  WebThemeEngine::ExtraParams extra_params;
...
bool ThemePainterDefault::PaintTextArea(Node* node,
                                        const ComputedStyle& style,
                                        const PaintInfo& paint_info,
                                        const IntRect& rect) {
...
bool ThemePainterDefault::PaintSearchField(Node* node,
                                           const ComputedStyle& style,
                                           const PaintInfo& paint_info,
                                           const IntRect& rect) {
  return PaintTextField(node, style, paint_info, rect);
