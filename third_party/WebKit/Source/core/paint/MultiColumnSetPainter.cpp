...
void MultiColumnSetPainter::PaintColumnRules(const PaintInfo& paint_info,
  ...
  bool left_to_right = layout_multi_column_set_.Style()->IsLeftToRightDirection();
  ...
  for (auto& bound : column_rule_bounds) {
    ...
    ObjectPainter::DrawLineForBoxSide(
        paint_info.context, pixel_snapped_rule_rect.X(), pixel_snapped_rule_rect.Y(),
        pixel_snapped_rule_rect.MaxX(), pixel_snapped_rule_rect.MaxY(), box_side,
