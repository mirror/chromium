...
void SVGImagePainter::Paint(const PaintInfo& paint_info) {
  ...
  {
    SVGPaintContext paint_context(layout_svg_image_, paint_info_before_filtering);
...
void SVGImagePainter::PaintForeground(const PaintInfo& paint_info) {
  ...
  SVGImageElement* image_element = toSVGImageElement(layout_svg_image_.GetElement());
  ...
  paint_info.context.SetImageInterpolationQuality(previous_interpolation_quality);
}
