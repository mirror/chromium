...
void TableRowPainter::PaintOutline(const PaintInfo& paint_info,
  ...
  LayoutPoint adjusted_paint_offset = paint_offset + layout_table_row_.Location();
  ObjectPainter(layout_table_row_).PaintOutline(paint_info, adjusted_paint_offset);
}
