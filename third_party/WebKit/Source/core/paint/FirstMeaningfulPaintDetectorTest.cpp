...
TEST_F(FirstMeaningfulPaintDetectorTest, NoFirstPaint) {
  ...
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(), 0.0);
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), 0.0);
}
...
TEST_F(FirstMeaningfulPaintDetectorTest, OneLayout) {
  ...
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), 0.0);
  SimulateNetworkStable();
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            GetPaintTiming().FirstPaintRendered().InSecondsF());
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF());
  EXPECT_LT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            after_paint);
  EXPECT_LT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), after_paint);
}
...
TEST_F(FirstMeaningfulPaintDetectorTest, TwoLayoutsSignificantSecond) {
  ...
  EXPECT_LT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            after_layout2);
  EXPECT_LT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            after_layout2);
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF());
}
...
TEST_F(FirstMeaningfulPaintDetectorTest, FirstMeaningfulPaintCandidate) {
  MarkFirstContentfulPaintAndClearSwapPromise();
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintCandidate().InSecondsF(), 0.0);
  SimulateLayoutAndPaint(1);
  EXPECT_EQ(OutstandingDetectorSwapPromiseCount(), 1U);
  ClearProvisionalFirstMeaningfulPaintSwapPromise();
  double after_paint = AdvanceClockAndGetTime();
  ...
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaintCandidate().InSecondsF(),
            after_paint);
  double candidate =
      GetPaintTiming().FirstMeaningfulPaintCandidate().InSecondsF();
  // The third candidate gets ignored since we already saw the first candidate.
  SimulateLayoutAndPaint(20);
  EXPECT_EQ(OutstandingDetectorSwapPromiseCount(), 1U);
  ClearProvisionalFirstMeaningfulPaintSwapPromise();
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintCandidate().InSecondsF(),
            candidate);
}
...
TEST_F(FirstMeaningfulPaintDetectorTest,
  ...
  MarkFirstContentfulPaintAndClearSwapPromise();
  SimulateNetworkStable();
  EXPECT_NE(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(), 0.0);
  EXPECT_NE(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), 0.0);
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF());
}
...
TEST_F(FirstMeaningfulPaintDetectorTest,
  ...
  MarkFirstContentfulPaintAndClearSwapPromise();
  SimulateNetworkStable();
  EXPECT_GE(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            GetPaintTiming().FirstContentfulPaintRendered().InSecondsF());
  EXPECT_GE(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstContentfulPaint().InSecondsF());
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF());
}
...
TEST_F(FirstMeaningfulPaintDetectorTest, Network2QuietThen0Quiet) {
  ...
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(), 0.0);
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), 0.0);
  EXPECT_LT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            after_first_paint);
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            after_first_paint);
...
TEST_F(FirstMeaningfulPaintDetectorTest,
  ...
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(), 0.0);
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(), 0.0);
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
            GetPaintTiming().FirstContentfulPaintRendered().InSecondsF());
  EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaint().InSecondsF(),
            GetPaintTiming().FirstContentfulPaint().InSecondsF());
  EXPECT_GT(GetPaintTiming().FirstMeaningfulPaintRendered().InSecondsF(),
