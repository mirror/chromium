 ...
 public:
  PaintInfo(GraphicsContext& new_context,
      ...
      : context(new_context),
        ...
        use_pixel_snapping_(use_pixel_snapping) {}
  ...
  PaintInfo(GraphicsContext& new_context,
      ...
      : context(new_context),
        ...
        use_pixel_snapping_(copy_other_fields_from.use_pixel_snapping_) {}
  ...
  bool UsePixelSnapping() const { return use_pixel_snapping_; }
