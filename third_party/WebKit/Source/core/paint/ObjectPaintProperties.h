...
// object owns each of the property nodes directly and scoped_refptrs are only
// used to harden against use-after-free bugs. These paint properties are
// built/updated by PaintPropertyTreeBuilder during the PrePaint lifecycle step.
//
