...
class ObjectPaintPropertyTreeBuilder {
 ...
 private:
  ...
  void CalculateRepeatingPaintOffsetAdjustment(const FragmentData&, LayoutUnit);
  void UpdateRepeatingTableHeaderPaintOffsetAdjustment();
  void UpdateRepeatingTableFooterPaintOffsetAdjustment();
