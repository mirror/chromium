...
struct PaintPropertyTreeBuilderFragmentContext {
 ...
 public:
  ...
  // each fragment. Each of the repeated painting needs to add an adjustment to
  // the calculated paint offset to paint at the desired place.
  LayoutSize paint_offset_adjustment_for_repeating;
};
...
class ObjectPaintPropertyTreeBuilder {
 ...
 private:
  ...
  ALWAYS_INLINE void UpdatePaintOffsetAdjustmentForRepeating();
