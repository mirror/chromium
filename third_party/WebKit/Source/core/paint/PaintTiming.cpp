...
#include "public/platform/performance_timing.mojom-blink.h"
...
void PaintTiming::SetFirstPaint(double stamp) {
  ...
  mojom::blink::PerformanceTimingPtr performance_timing;
  GetFrame()->GetInterfaceProvider()->GetInterface(
      mojo::MakeRequest(&performance_timing));
  performance_timing->OnFirstPaint(
