...
bool ThemePainter::Paint(const LayoutObject& o,
  ...
  switch (part) {
    ...
    case kMediaOverlayPlayButtonPart:
      return MediaControlsPainter::PaintMediaOverlayPlayButton(o, paint_info, r);
    ...
    case kMediaVolumeSliderThumbPart:
      return MediaControlsPainter::PaintMediaVolumeSliderThumb(o, paint_info, r);
...
void ThemePainter::PaintSliderTicks(const LayoutObject& o,
  ...
  if (is_horizontal) {
    ...
    tick_rect.SetY(floor(rect.Y() + rect.Height() / 2.0 +
    ...
    tick_rect.SetX(floor(rect.X() + rect.Width() / 2.0 +
                        LayoutTheme::GetTheme().SliderTickOffsetFromTrackCenter() *
                            zoom_factor));
    tick_region_side_margin =
        track_bounds.Y() +
...
bool ThemePainter::PaintCheckboxUsingFallbackTheme(const LayoutObject& o,
  ...
  Platform::Current()->FallbackThemeEngine()->Paint(
      canvas, WebFallbackThemeEngine::kPartCheckbox, GetWebFallbackThemeState(o),
