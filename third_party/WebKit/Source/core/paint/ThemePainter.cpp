...
static WebFallbackThemeEngine::State GetWebFallbackThemeState(Node* node) {
...
bool ThemePainter::PaintBorderOnly(Node* node,
...
bool ThemePainter::PaintDecorations(Node* node,
                                    const ComputedStyle& style,
                                    const PaintInfo& paint_info,
                                    const IntRect& r) {
  // Call the appropriate paint method based off the appearance value.
...
bool ThemePainter::PaintUsingFallbackTheme(Node* node,
                                           const ComputedStyle& style,
                                           const PaintInfo& paint_info,
...
bool ThemePainter::PaintCheckboxUsingFallbackTheme(Node* node,
                                                   const ComputedStyle& style,
                                                   const PaintInfo& paint_info,
                                                   const IntRect& paint_rect) {
...
bool ThemePainter::PaintRadioUsingFallbackTheme(Node* node,
                                                const ComputedStyle& style,
                                                const PaintInfo& paint_info,
                                                const IntRect& paint_rect) {
  WebFallbackThemeEngine::ExtraParams extra_params;
