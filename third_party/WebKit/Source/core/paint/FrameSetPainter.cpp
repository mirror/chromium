...
void FrameSetPainter::PaintBorders(const PaintInfo& paint_info,
  ...
  LayoutRect adjusted_frame_rect(adjusted_paint_offset, layout_frame_set_.size());
      ...
      if (ShouldPaintBorderAfter(layout_frame_set_.Columns(), c)) {
        PaintColumnBorder(
            ...
            PixelSnappedIntRect(LayoutRect(
                adjusted_paint_offset.X() + x_pos, adjusted_paint_offset.Y() + y_pos,
...
void FrameSetPainter::Paint(const PaintInfo& paint_info,
  ...
  LayoutPoint adjusted_paint_offset = paint_offset + layout_frame_set_.Location();
