...
class TextPainterTest : public RenderingTest {
 ...
 protected:
  ...
  PaintInfo CreatePaintInfo(bool uses_text_as_clip, bool is_printing) {
    return PaintInfo(
        context_, IntRect(),
        uses_text_as_clip ? kPaintPhaseTextClip : kPaintPhaseSelfBlockBackgroundOnly,
...
TEST_F(TextPainterTest, TextPaintingStyle_AllProperties) {
  ...
  GetDocument().body()->SetInlineStyleProperty(CSSPropertyWebkitTextStrokeColor,
                                            CSSValueLime);
  GetDocument().body()->SetInlineStyleProperty(CSSPropertyWebkitTextEmphasisColor,
                                            CSSValueBlue);
  GetDocument().body()->SetInlineStyleProperty(
      CSSPropertyWebkitTextStrokeWidth, 4, CSSPrimitiveValue::UnitType::kPixels);
...
TEST_F(TextPainterTest,
  ...
  GetDocument().body()->SetInlineStyleProperty(CSSPropertyWebkitTextEmphasisColor,
                                            CSSValueBlue);
  GetDocument().body()->SetInlineStyleProperty(CSSPropertyWebkitPrintColorAdjust,
                                            CSSValueEconomy);
