...
bool ThemePainterMac::PaintTextField(Node* node,
...
bool ThemePainterMac::PaintTextArea(Node* node,
                                    const ComputedStyle& style,
                                    const PaintInfo& paint_info,
                                    const IntRect& r) {
  LocalCurrentGraphicsContext local_context(paint_info.context, r);
...
bool ThemePainterMac::PaintMenuList(Node* node,
                                    const ComputedStyle& style,
                                    const PaintInfo& paint_info,
                                    const IntRect& r) {
...
bool ThemePainterMac::PaintMenuListButton(Node* node,
                                          const ComputedStyle& style,
                                          const PaintInfo& paint_info,
                                          const IntRect& r) {
  IntRect bounds =
...
bool ThemePainterMac::PaintSliderThumb(Node* node,
                                       const ComputedStyle& style,
                                       const PaintInfo& paint_info,
                                       const IntRect& r) {
  GraphicsContextStateSaver state_saver(paint_info.context);
...
bool ThemePainterMac::PaintSearchField(Node* node,
                                       const ComputedStyle& style,
                                       const PaintInfo& paint_info,
                                       const IntRect& r) {
  LocalCurrentGraphicsContext local_context(paint_info.context, r);
...
bool ThemePainterMac::PaintCheckbox(Node* node,
                                    const ComputedStyle& style,
                                    const PaintInfo& paint_info,
...
bool ThemePainterMac::PaintRadio(Node* node,
                                 const ComputedStyle& style,
                                 const PaintInfo& paint_info,
                                 const IntRect& zoomed_rect) {
  ControlStates states = LayoutTheme::ControlStatesForNode(node, style);
...
bool ThemePainterMac::PaintButton(Node* node,
                                  const ComputedStyle& style,
                                  const PaintInfo& paint_info,
                                  const IntRect& zoomed_rect) {
  BEGIN_BLOCK_OBJC_EXCEPTIONS
...
bool ThemePainterMac::PaintInnerSpinButton(Node* node,
                                           const ComputedStyle& style,
                                           const PaintInfo& paint_info,
                                           const IntRect& zoomed_rect) {
  ControlStates states = LayoutTheme::ControlStatesForNode(node, style);
