...
class CORE_EXPORT PaintTiming final
 ...
 public:
  ...
  // after |first_text_paint_| is set, which occurs the first time that text
  // content was painted.
  ...
  // after |first_image_paint_| is set, which occurs the first time that image
  // content was painted.
  ...
  void ReportDidSwapHistorgram(bool did_swap);
