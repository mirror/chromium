...
FloatRect ExpandSelectionRectIfLineWrap(
  ...
  // Selection wrapping line break occurs when selection is not ending within//
  // this fragment and this fragment is at the end of line.
  if (!selection_status.is_forward_contiguous)
    return rect;
