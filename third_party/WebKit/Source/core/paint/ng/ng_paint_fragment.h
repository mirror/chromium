...
class CORE_EXPORT NGPaintFragment : public DisplayItemClient,
 ...
 public:
  ...
  LayoutRect VisualRect() const override {
    DCHECK(is_visual_rect_set_) << PhysicalFragment().ToString();
    return visual_rect_;
  }
  void SetVisualRect(const LayoutRect& rect) {
    visual_rect_ = rect;
#if DCHECK_IS_ON()
    is_visual_rect_set_ = true;
#endif
  }
  ...
  static NGPaintFragment* GetForInline(const LayoutObject*);
...
#if DCHECK_IS_ON()
  unsigned is_visual_rect_set_ : 1;
#endif
};
