...
void NGBoxFragmentPainter::Paint(const PaintInfo& paint_info,
  ...
  // TODO(layout-dev): Figure out where this long belongs.
...
void NGBoxFragmentPainter::PaintChildren(const PaintInfo& paint_info,
  ...
  // TODO(layout-dev): We might want to merge this with PaintLineBox and call
  // it recursively.
...
void NGBoxFragmentPainter::PaintLineBox(
  ...
  for (const auto& child : fragment.Children()) {
    ...
    if (child->Type() == NGPhysicalBoxFragment::kFragmentText) {
      PaintText(*ToNGPhysicalTextFragment(child.Get()), paint_info,
                paint_offset);
    } else if (child->Type() == NGPhysicalBoxFragment::kFragmentBox) {
