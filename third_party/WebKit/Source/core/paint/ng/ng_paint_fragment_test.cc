...
TEST_F(NGPaintFragmentTest, InlineBlock) {
  ...
  SetBodyInnerHTML(R"HTML(
    ...
    <body>
      <div id="container">12345 <span id="box">X<span></div>
    </body>
  )HTML");
