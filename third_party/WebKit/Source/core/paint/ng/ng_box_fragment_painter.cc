...
void NGBoxFragmentPainter::Paint(const PaintInfo& paint_info,
  ...
  // TODO(kojii): fragment.Offset() is not the same as LayoutBox::Location() for
  // LayoutNGTableCell or Flexbox. Use fragment.Offset() to adjust once this is
  // figured out. crbug.com/788590
