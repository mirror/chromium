...
LayoutRect PaintLayerScrollableArea::ScrollIntoView(
  ...
  // Represent the rect in the container's padding-box coordinate.
  ...
  // Represent the rect in the container's border-box coordinate.
  intersect.Move(GetLayoutBox()->BorderLeft(), GetLayoutBox()->BorderTop());
