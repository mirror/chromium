...
void PaintLayerScrollableArea::DidScroll(float x, float y) {
  ScrollableArea::DidScroll(x, y);
  // This scrollable area should be alive if it receives composited scroll
  // callbacks.
