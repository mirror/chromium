...
void SVGAnimateElement::CalculateAnimatedValue(float percentage,
  ...
  SVGPropertyBase* to_at_end_of_duration_value =
      to_at_end_of_duration_property_ ? to_at_end_of_duration_property_ : to_property_;
  SVGPropertyBase* from_value =
      GetAnimationMode() == kToAnimation ? animated_value : from_property_.Get();
  ...
  animated_value->CalculateAnimatedValue(this, percentage, repeat_count,
                                        from_value, to_value,
