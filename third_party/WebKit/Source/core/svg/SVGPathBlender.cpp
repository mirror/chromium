  ...
  switch (to_seg.command) {
    ...
    case kPathSegLineToHorizontalAbs:
      blended_segment.target_point.SetX(BlendAnimatedDimensonalFloat(
          from_seg.target_point.X(), to_seg.target_point.X(), kBlendHorizontal));
      break;
    case kPathSegLineToVerticalRel:
    case kPathSegLineToVerticalAbs:
    ...
    case kPathSegArcAbs:
      ...
      blended_segment.point2 =
          BlendAnimatedFloatPointSameCoordinates(from_seg.point2, to_seg.point2);
      if (add_types_count_) {
        ...
        blended_segment.arc_large =
            is_in_first_half_of_animation_ ? from_seg.arc_large : to_seg.arc_large;
        blended_segment.arc_sweep =
            is_in_first_half_of_animation_ ? from_seg.arc_sweep : to_seg.arc_sweep;
      }
      break;
    default:
      NOTREACHED();
