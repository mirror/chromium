...
void SVGComponentTransferFunctionElement::SvgAttributeChanged(
  ...
  if (attr_name == SVGNames::typeAttr || attr_name == SVGNames::tableValuesAttr ||
      attr_name == SVGNames::slopeAttr || attr_name == SVGNames::interceptAttr ||
      attr_name == SVGNames::amplitudeAttr ||
      attr_name == SVGNames::exponentAttr || attr_name == SVGNames::offsetAttr) {
