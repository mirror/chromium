...
ImeSpan::ImeSpan(unsigned start_offset,
                 unsigned end_offset,
                 const Color& color,
                 bool thick,
...
ImeSpan::ImeSpan(const WebImeSpan& ime_span)
    : ImeSpan(ime_span.start_offset,
              ime_span.end_offset,
              Color(ime_span.color),
              ime_span.thick,
              Color(ime_span.background_color)) {}
