...
class CORE_EXPORT TextIteratorBehavior final {
 public:
  ...
  bool DoesRespectUserSelectStyleOption() const {
    return values_.bits.respect_user_select_style_option;
  }
 ...
 private:
  union {
    ...
    struct {
      ...
      bool respect_user_select_style_option : 1;
    } bits;
  } values_;
};
...
class CORE_EXPORT TextIteratorBehavior::Builder final {
 public:
  ...
  Builder& SetDoesRespectUserSelectStyleOption(bool);
