...
TEST_F(UnsortedDocumentMarkerListEditorTest,
  ...
  UnsortedDocumentMarkerListEditor::MarkerList marker_list_intersecting_range =
      UnsortedDocumentMarkerListEditor::MarkersIntersectingRange(marker_list_,
                                                                 0, 1);

  EXPECT_EQ(2u, marker_list_intersecting_range.size());

  EXPECT_EQ(0u, marker_list_intersecting_range[0]->StartOffset());
  EXPECT_EQ(9u, marker_list_intersecting_range[0]->EndOffset());

  EXPECT_EQ(0u, marker_list_intersecting_range[1]->StartOffset());
  EXPECT_EQ(10u, marker_list_intersecting_range[1]->EndOffset());
}
...
TEST_F(UnsortedDocumentMarkerListEditorTest,
  ...
  EXPECT_EQ(0u, marker_list_intersecting_range[0]->StartOffset());
  EXPECT_EQ(10u, marker_list_intersecting_range[0]->EndOffset());

  EXPECT_EQ(1u, marker_list_intersecting_range[1]->StartOffset());
  EXPECT_EQ(10u, marker_list_intersecting_range[1]->EndOffset());
}
