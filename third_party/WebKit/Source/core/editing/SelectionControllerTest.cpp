...
void SelectionControllerTest::SetNonDirectionalSelectionIfNeeded(
  ...
  GetFrame()
      ...
      .SetNonDirectionalSelectionIfNeeded(
          new_selection, granularity, SelectionController::kDoNotAdjustEndpoints,
...
TEST_F(SelectionControllerTest, setNonDirectionalSelectionIfNeeded) {
  ...
  EXPECT_EQ(PositionInFlatTree(top, 1), GetVisibleSelectionInFlatTree().Start());
  EXPECT_EQ(PositionInFlatTree(bottom, 3), GetVisibleSelectionInFlatTree().end());
  ...
  EXPECT_EQ(PositionInFlatTree(bottom, 3), GetVisibleSelectionInFlatTree().Base());
  EXPECT_EQ(PositionInFlatTree(top, 1), GetVisibleSelectionInFlatTree().Extent());
  EXPECT_EQ(PositionInFlatTree(top, 1), GetVisibleSelectionInFlatTree().Start());
  EXPECT_EQ(PositionInFlatTree(bottom, 3), GetVisibleSelectionInFlatTree().end());
}
