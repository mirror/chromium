...
Vector<TextSuggestionInfo> ComputeSuggestionInfos(
...
void TextSuggestionController::ShowSuggestionMenu(
  ...
  Vector<TextSuggestionInfo> suggestion_infos = ComputeSuggestionInfos(
      node_suggestion_marker_pairs_sorted_by_length, max_number_of_suggestions);
  ...
  const String& misspelled_word = PlainText(marker_range);
  CallMojoShowTextSuggestionMenu(suggestion_infos, misspelled_word);
}
