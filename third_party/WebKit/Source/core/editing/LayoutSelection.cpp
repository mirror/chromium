...
SelectionInFlatTree LayoutSelection::CalcVisibleSelection(
  ...
  const VisiblePositionInFlatTree visible_end =
      CreateVisiblePosition(end, selection_type == SelectionType::kRangeSelection
...
void LayoutSelection::Commit(LayoutView& layout_view) {
  ...
  layout_view.SetSelection(start_layout_object, start_pos.ComputeEditingOffset(),
