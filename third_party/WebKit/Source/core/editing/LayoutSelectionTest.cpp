...
TEST_F(NGLayoutSelectionTest, SelectOnOneText) {
  ...
  EXPECT_EQ(
      LayoutSelectionStatus(0u, 0u, false),
  ...
  LayoutObject* const bar = GetDocument()
                                ...
                                ->GetLayoutObject();
  EXPECT_EQ(
      LayoutSelectionStatus(4u, 5u, false),
...
TEST_F(NGLayoutSelectionTest, FirstLetterInAnotherBlockFlow) {
  ...
  EXPECT_EQ(LayoutSelectionStatus(0u, 1u, true),
  ...
  EXPECT_EQ(LayoutSelectionStatus(1u, 2u, false),
            Selection().LayoutSelectionStartEndForNG(
...
TEST_F(NGLayoutSelectionTest, TwoNGBlockFlows) {
  ...
  EXPECT_EQ(
      LayoutSelectionStatus(1u, 3u, true),
      Selection().LayoutSelectionStartEndForNG(GetNGPhysicalTextFragment(foo)));
  LayoutObject* const bar = GetDocument()
                                .body()
                                ->firstChild()
                                ...
                                ->GetLayoutObject();
  EXPECT_EQ(
      LayoutSelectionStatus(0u, 2u, false),
      Selection().LayoutSelectionStartEndForNG(GetNGPhysicalTextFragment(bar)));
}
