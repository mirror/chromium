...
TEST_F(InputMethodControllerTest, SetCompositionFromExistingText) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 5, Color(255, 0, 0), false, 0));
  Controller().SetCompositionFromExistingText(ime_spans, 0, 5);
...
TEST_F(InputMethodControllerTest, SetCompositionAfterEmoji) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 2, Color(255, 0, 0), false, 0));
  ...
  Controller().SetComposition(String("a"), ime_spans, 1, 1);
  EXPECT_STREQ("\xF0\x9F\x8F\x86\x61", div->innerText().Utf8().data());

  Controller().SetComposition(String("ab"), ime_spans, 2, 2);
...
TEST_F(InputMethodControllerTest, SetCompositionWithGraphemeCluster) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(6, 6, Color(255, 0, 0), false, 0));
  GetDocument().UpdateStyleAndLayout();
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(12, 12, Color(255, 0, 0), false, 0));
  GetDocument().UpdateStyleAndLayout();
  ...
  Controller().CommitText(
      ...
      ime_spans, 1);
  Controller().CommitText("\nab ", ime_spans, 1);
  Controller().SetComposition(String("c"), ime_spans, 1, 1);
  EXPECT_STREQ(
  ...
  Controller().SetComposition(String("cd"), ime_spans, 2, 2);
  EXPECT_STREQ(
      "\xE0\xA4\xB9\xE0\xA5\x87\xE0\xA4\xB2\xE0\xA5\x8D\xE0\xA4\xB2\xE0\xA5"
      "\x8B\nab cd",
      div->innerText().Utf8().data());
...
TEST_F(InputMethodControllerTest, SetCompositionKeepingStyle) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(3, 12, Color(255, 0, 0), false, 0));
  Controller().SetCompositionFromExistingText(ime_spans, 3, 12);

  // Subtract a character.
  Controller().SetComposition(String("12345789"), ime_spans, 8, 8);
  ...
  // Append a character.
  Controller().SetComposition(String("123456789"), ime_spans, 9, 9);
  ...
  Controller().SetComposition(String("123hello789"), ime_spans, 11, 11);
...
TEST_F(InputMethodControllerTest, SetCompositionWithEmojiKeepingStyle) {
  ...
  Controller().SetCompositionFromExistingText(ime_spans, 0, 2);

  // 0xF0 0x9F 0x8F 0xAB is also an emoji character, with the same leading
  // surrogate pair to the previous one.
  Controller().SetComposition(String::FromUTF8("\xF0\x9F\x8F\xAB"), ime_spans,
                              2, 2);
  EXPECT_STREQ("<b>\xF0\x9F\x8F\xAB</b>", div->innerHTML().Utf8().data());

  Controller().SetComposition(String::FromUTF8("\xF0\x9F\x8F\xA0"), ime_spans,
                              2, 2);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 2, Color(255, 0, 0), false, 0));
  Controller().SetCompositionFromExistingText(ime_spans, 0, 1);
  ...
  Controller().SetComposition(String::FromUTF8("\xE0\xB0\x83"), ime_spans, 1,
                              1);
...
TEST_F(InputMethodControllerTest, CommitTextKeepingStyle) {
  ...
  Controller().CommitText(String("123789"), ime_spans, 0);
...
TEST_F(InputMethodControllerTest, InsertTextWithNewLine) {
  Element* div =
      InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 11, Color(255, 0, 0), false, 0));
...
TEST_F(InputMethodControllerTest, InsertTextWithNewLineIncrementally) {
  ...
  Vector<ImeSpan> ime_spans;
  Controller().CommitText("a", ime_spans, 0);
  Controller().SetComposition("bcd", ime_spans, 0, 2);
...
TEST_F(InputMethodControllerTest, DeleteBySettingEmptyComposition) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 3, Color(255, 0, 0), false, 0));
  Controller().SetCompositionFromExistingText(ime_spans, 0, 3);

  Controller().SetComposition(String(""), ime_spans, 0, 3);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(7, 8, Color(255, 0, 0), false, 0));
  Controller().SetCompositionFromExistingText(ime_spans, 7, 8);
...
TEST_F(InputMethodControllerTest, ConfirmPasswordComposition) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 5, Color(255, 0, 0), false, 0));
  Controller().SetComposition("foo", ime_spans, 0, 3);
  Controller().FinishComposingText(InputMethodController::kKeepSelection);
...
TEST_F(InputMethodControllerTest, SetCompositionForInputWithNewCaretPositions) {
  ...
  Controller().SetComposition("AB", ime_spans, -100, -100);
  ...
  // "*heABllo".
  Controller().SetComposition("AB", ime_spans, -2, -2);
  EXPECT_STREQ("heABllo", input->value().Utf8().data());
  EXPECT_EQ(0u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(0u, Controller().GetSelectionOffsets().End());
  ...
  // "he*ABllo".
  Controller().SetComposition("AB", ime_spans, 0, 0);
  EXPECT_STREQ("heABllo", input->value().Utf8().data());
  EXPECT_EQ(2u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(2u, Controller().GetSelectionOffsets().End());
  ...
  // "heABllo*".
  Controller().SetComposition("AB", ime_spans, 5, 5);
  EXPECT_STREQ("heABllo", input->value().Utf8().data());
  EXPECT_EQ(7u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(7u, Controller().GetSelectionOffsets().End());
...
TEST_F(InputMethodControllerTest,
  ...
  // The caret is on left boundary.
  // "*hello\nworld\n01234AB56789".
  Controller().SetComposition("AB", ime_spans, -17, -17);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
  EXPECT_EQ(0u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(0u, Controller().GetSelectionOffsets().End());
  ...
  // "he*llo\nworld\n01234AB56789".
  Controller().SetComposition("AB", ime_spans, -15, -15);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
  EXPECT_EQ(2u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(2u, Controller().GetSelectionOffsets().End());
  ...
  // "hello*\nworld\n01234AB56789".
  Controller().SetComposition("AB", ime_spans, -12, -12);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
  ...
  // "hello\n*world\n01234AB56789".
  Controller().SetComposition("AB", ime_spans, -11, -11);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
  EXPECT_EQ(6u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(6u, Controller().GetSelectionOffsets().End());
  ...
  // "hello\nworld*\n01234AB56789".
  Controller().SetComposition("AB", ime_spans, -6, -6);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
  EXPECT_EQ(11u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(11u, Controller().GetSelectionOffsets().End());
  ...
  // The caret is on right boundary.
  // "hello\nworld\n01234AB56789*".
  Controller().SetComposition("AB", ime_spans, 7, 7);
  EXPECT_STREQ("hello\nworld\n01234AB56789", div->innerText().Utf8().data());
...
TEST_F(InputMethodControllerTest, SetCompositionWithEmptyText) {
  ...
  Vector<ImeSpan> ime_spans0;
  ime_spans0.push_back(ImeSpan(0, 0, Color(255, 0, 0), false, 0));
  Vector<ImeSpan> ime_spans2;
  ime_spans2.push_back(ImeSpan(0, 2, Color(255, 0, 0), false, 0));

  Controller().SetComposition("AB", ime_spans2, 2, 2);
  // With previous composition.
  Controller().SetComposition("", ime_spans0, 2, 2);
  EXPECT_STREQ("hello", div->innerText().Utf8().data());
  EXPECT_EQ(4u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(4u, Controller().GetSelectionOffsets().End());

  // Without previous composition.
  Controller().SetComposition("", ime_spans0, -1, -1);
  EXPECT_STREQ("hello", div->innerText().Utf8().data());
  EXPECT_EQ(3u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(3u, Controller().GetSelectionOffsets().End());
}
...
TEST_F(InputMethodControllerTest, InsertLineBreakWhileComposingText) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 5, Color(255, 0, 0), false, 0));
  Controller().SetComposition("hello", ime_spans, 5, 5);
  EXPECT_STREQ("hello", div->innerText().Utf8().data());
  EXPECT_EQ(5u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(5u, Controller().GetSelectionOffsets().End());
...
TEST_F(InputMethodControllerTest, InsertLineBreakAfterConfirmingText) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 2, Color(255, 0, 0), false, 0));
  Controller().CommitText("hello", ime_spans, 0);
  EXPECT_STREQ("hello", div->innerText().Utf8().data());
...
TEST_F(InputMethodControllerTest, CompositionInputEventIsComposing) {
  ...
  GetDocument().setTitle(g_empty_string);
  Controller().CommitText("bar", ime_spans, 0);
...
TEST_F(InputMethodControllerTest, CompositionInputEventForReplace) {
  ...
  GetDocument().setTitle(g_empty_string);
  Controller().SetComposition("hell", ime_spans, 4, 4);
  EXPECT_STREQ("beforeinput.data:hell;input.data:hell;",
               GetDocument().title().Utf8().data());

  // Replace the existing composition.
  GetDocument().setTitle(g_empty_string);
  Controller().SetComposition("hello", ime_spans, 0, 0);
...
TEST_F(InputMethodControllerTest, CompositionInputEventForDelete) {
  ...
  GetDocument().setTitle(g_empty_string);
  Controller().SetComposition("", ime_spans, 0, 0);
...
TEST_F(InputMethodControllerTest, CompositionInputEventForInsert) {
  ...
  GetDocument().setTitle(g_empty_string);
  Controller().SetComposition("n", ime_spans, 1, 1);
  ...
  GetDocument().setTitle(g_empty_string);
  GetDocument().UpdateStyleAndLayout();
  Controller().CommitText("hello", ime_spans, 1);
  EXPECT_STREQ(
...
TEST_F(InputMethodControllerTest, CompositionInputEventForInsertEmptyText) {
  ...
  GetDocument().setTitle(g_empty_string);
  GetDocument().UpdateStyleAndLayout();
  Controller().CommitText("", ime_spans, 0);
  ...
  GetDocument().setTitle(g_empty_string);
  GetDocument().UpdateStyleAndLayout();
  Controller().CommitText("", ime_spans, 1);
  EXPECT_STREQ("beforeinput.data:;input.data:null;compositionend.data:;",
               GetDocument().title().Utf8().data());
}
...
TEST_F(InputMethodControllerTest, CompositionEndEventWithNoSelection) {
  ...
  Controller().SetComposition("hello", ime_spans, 1, 1);
  GetDocument().UpdateStyleAndLayout();
  EXPECT_EQ(1u, Controller().GetSelectionOffsets().Start());
  EXPECT_EQ(1u, Controller().GetSelectionOffsets().End());
...
TEST_F(InputMethodControllerTest, FinishCompositionRemovedRange) {
  ...
  Controller().SetComposition("hello", Vector<ImeSpan>(), 5, 5);
  EXPECT_EQ(kWebTextInputTypeText, Controller().TextInputType());
...
TEST_F(InputMethodControllerTest, ReflectsSpaceWithoutNbspMangling) {
  ...
  Vector<ImeSpan> ime_spans;
  Controller().CommitText(String("  "), ime_spans, 0);
...
TEST_F(InputMethodControllerTest, SetCompositionPlainTextWithIme_Span) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 1, Color(255, 0, 0), false, 0));

  Controller().SetComposition(" ", ime_spans, 1, 1);
...
TEST_F(InputMethodControllerTest, CommitPlainTextWithIme_SpanInsert) {
  ...
  ime_spans.push_back(ImeSpan(1, 11, Color(255, 0, 0), false, 0));

  Controller().CommitText(String("ime_spand"), ime_spans, 0);
...
TEST_F(InputMethodControllerTest, CommitPlainTextWithIme_SpanReplace) {
  ...
  Controller().SetCompositionFromExistingText(ime_spans, 8, 12);

  ime_spans.push_back(ImeSpan(1, 11, Color(255, 0, 0), false, 0));

  Controller().CommitText(String("string"), ime_spans, 0);
...
TEST_F(InputMethodControllerTest, ImeSpanAppearsCorrectlyAfterNewline) {
  Element* div =
      InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");

  Vector<ImeSpan> ime_spans;
  Controller().SetComposition(String("hello"), ime_spans, 6, 6);
  Controller().FinishComposingText(InputMethodController::kKeepSelection);
  GetFrame().GetEditor().InsertLineBreak();

  Controller().SetCompositionFromExistingText(ime_spans, 8, 8);

  ime_spans.push_back(ImeSpan(0, 5, Color(255, 0, 0), false, 0));
  Controller().SetComposition(String("world"), ime_spans, 0, 0);
  ASSERT_EQ(1u, GetDocument().Markers().Markers().size());
...
TEST_F(InputMethodControllerTest, SelectionWhenFocusChangeFinishesComposition) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 5, Color(255, 0, 0), false, 0));
  Controller().SetComposition("foo", ime_spans, 3, 3);
...
TEST_F(InputMethodControllerTest, SetEmptyCompositionShouldNotMoveCaret) {
  ...
  Vector<ImeSpan> ime_spans;
  ime_spans.push_back(ImeSpan(0, 3, Color(255, 0, 0), false, 0));
  Controller().SetComposition(String("def"), ime_spans, 0, 3);
  Controller().SetComposition(String(""), ime_spans, 0, 3);
  Controller().CommitText(String("def"), ime_spans, 0);
...
TEST_F(InputMethodControllerTest, WhitespaceFixup) {
  ...
  Controller().SetCompositionFromExistingText(empty_ime_spans, 0, 7);
  Controller().CommitText(String(""), empty_ime_spans, 0);
  ...
  // Delete "blah"
  Controller().SetCompositionFromExistingText(empty_ime_spans, 6, 10);
  Controller().CommitText(String(""), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest, CommitEmptyTextDeletesSelection) {
  ...
  Controller().CommitText(String("1"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceStartOfMarker) {
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 0, 7);
  Controller().CommitText(String("Original"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 8, 20);
  Controller().CommitText(String("boring"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceEndOfMarker) {
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 8, 12);
  Controller().CommitText(String("string"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 13, 25);
  Controller().CommitText(String("content"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 0, 12);
  Controller().CommitText(String("New string"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_Deletions) {
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 8, 17);
  Controller().CommitText(String(""), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 5, 10);
  Controller().CommitText(String(""), empty_ime_spans, 0);
  EXPECT_EQ(0u, GetDocument().Markers().Markers().size());
}
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_DeleteMiddleOfMarker) {
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetCompositionFromExistingText(empty_ime_spans, 6, 9);
  Controller().CommitText(String(""), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest,
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetComposition("", empty_ime_spans, 7, 7);
  Controller().CommitText(String("66666"), empty_ime_spans, -7);
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_InsertBetweenMarkers) {
  ...
  Vector<ImeSpan> empty_ime_spans;
  Controller().SetComposition("", empty_ime_spans, 5, 5);
  Controller().CommitText(String("77777"), empty_ime_spans, 0);
...
TEST_F(InputMethodControllerTest, MaxLength) {
  ...
  Controller().SetComposition("abcde", Vector<ImeSpan>(), 4, 4);
