...
SetSelectionData::SetSelectionData(const SetSelectionData& other)
    : selection_(other.selection_),
      cursor_align_on_scroll_(other.cursor_align_on_scroll_),
      do_not_set_focus_(other.do_not_set_focus_),
      do_not_clear_strategy_(other.do_not_clear_strategy_),
      should_close_typing_(other.should_close_typing_),
      should_clear_typing_style_(other.should_clear_typing_style_) {}

SetSelectionData::SetSelectionData() = default;

SetSelectionData::Builder::Builder() = default;

SetSelectionData::Builder::Builder(const SelectionInDOMTree& selection) {
...
SetSelectionData::Builder& SetSelectionData::Builder::SetSelection(
    const SelectionInDOMTree& new_selection) {
  data_.selection_ = new_selection;
  return *this;
}
