...
class SelectionInUndoStep final
    : public GarbageCollectedFinalized<SelectionInUndoStep> {
 public:
  ...
  // TODO(editing-dev): We should move following funcitons out side
 ...
 private:
  ...
  mutable bool should_compute_is_base_first_ = false;
};
