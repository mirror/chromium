...
TEST_F(VisibleSelectionTest, FirstEphemeralRangeOfInFlatTree) {
  ...
  VisibleSelectionInFlatTree selection =
      CreateVisibleSelection(SelectionInFlatTree::Builder()
                                 .Collapse(PositionInFlatTree::BeforeNode(*two))
                                 .Extend(PositionInFlatTree::AfterNode(*three))
                                 .Build());
  ...
  VisibleSelectionInFlatTree selectionInSameDOM =
      CreateVisibleSelection(SelectionInFlatTree::Builder()
                                 .Collapse(PositionInFlatTree::BeforeNode(*two))
                                 .Extend(PositionInFlatTree::AfterNode(*one))
                                 .Build());
  ...
  VisibleSelectionInFlatTree selectionOverMultipleDOM =
      CreateVisibleSelection(SelectionInFlatTree::Builder()
                                 .Collapse(PositionInFlatTree::BeforeNode(*one))
                                 .Extend(PositionInFlatTree::AfterNode(*four))
                                 .Build());
