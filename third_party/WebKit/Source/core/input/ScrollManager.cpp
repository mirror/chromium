...
void ScrollManager::SnapAtGestureScrollEnd() {
  ...
  ScrollOrientation scroll_orientation = kNoScroll;
  if (did_scroll_x_for_scroll_gesture_) {
    scroll_orientation =
        ScrollOrientation(scroll_orientation | kHorizontalScroll);
  }
  if (did_scroll_y_for_scroll_gesture_) {
    scroll_orientation =
        ScrollOrientation(scroll_orientation | kVerticalScroll);
  }
  ScrollOffset snap_offset;
  if (snap_coordinator->GetSnapPosition(*layout_box, scroll_orientation,
                                        &snap_offset)) {
