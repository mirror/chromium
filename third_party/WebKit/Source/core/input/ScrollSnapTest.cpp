...
void ScrollSnapTest::SetUp() {
  ...
  request.Complete(R"HTML(
    <div id='scroller' style='height: 160px; width: 140px; overflow: scroll;
    scroll-snap-type: both mandatory; padding: 0px;'>
      <div id='container' style='height: 500px; width: 500px; margin: 0px;
      padding: 0px;'>
        <div id='area' style='position: relative; top: 200px; left: 200px;
