...
class SubresourceIntegrityTest : public ::testing::Test {
 ...
 protected:
  ...
  void CheckExpectedIntegrity(const char* integrity,
    ...
    EXPECT_EQ(expectation == kIntegrity,
...
TEST_F(SubresourceIntegrityTest, OriginIntegrity) {
  TestCase cases[] = {
      ...
      {sec_url, insec_url, &sec_url, kNoServiceWorker, kIntegrity},
      {sec_url, insec_url, &sec_url, kSWClearResponse, kIntegrity},
      {sec_url, insec_url, nullptr, kSWClearResponse, kIntegrity},
