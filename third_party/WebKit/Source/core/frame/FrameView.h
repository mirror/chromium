...
class CORE_EXPORT FrameView final
 ...
 public:
  ...
  void ProcessUrlFragment(const KURL&, UrlFragmentBehavior = kUrlFragmentScroll);
  ...
  IntSize VisibleContentSize(IncludeScrollbarsInRect = kExcludeScrollbars) const;
 ...
 private:
  ...
  DocumentLifecycle::LifecycleState current_update_lifecycle_phases_target_state_;
