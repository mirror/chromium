...
class CORE_EXPORT LocalFrameView final
  ...
  friend class LayoutEmbeddedContentView;  // for invalidateTreeIfNeeded
 ...
 public:
  ...
  void AddPart(LayoutEmbeddedContentView*);
  void RemovePart(LayoutEmbeddedContentView*);
 ...
 protected:
  ...
  // Only for LayoutEmbeddedContentView to traverse into sub frames during paint
  // invalidation.
 ...
 private:
  ...
  HashSet<RefPtr<LayoutEmbeddedContentView>> parts_;
