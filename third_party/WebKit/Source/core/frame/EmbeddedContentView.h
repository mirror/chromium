...
class CORE_EXPORT EmbeddedContentView : public GarbageCollectedMixin {
 public:
  ...
  // UpdateGeometry is called when frame is resized and layout is required.
  // Subtypes must call LayoutEmbeddedContent::UpdateGeometry.  Having View call
  // to Layout allows LocalFrameView and PluginView to cleanly provide
  // additional logic when geometry changes.
