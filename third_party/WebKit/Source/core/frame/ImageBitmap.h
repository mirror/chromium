...
class CORE_EXPORT ImageBitmap final
 ...
 private:
  ...
  void CropImageAndApplyColorSpaceConversion(ScriptPromiseResolver*,
                                             ...
                                             ColorBehavior);
  void DecodeImageOnBackground(WebTaskRunner*,
                               std::unique_ptr<CropImageInfo>,
                               ScriptPromiseResolver*);
  void PostProcessImage(WebTaskRunner*,
                        ParsedOptions&,
                        bool origin_clean,
                        bool source_lazy_decoded,
                        bool premultiply_alpha_reverted,
                        ScriptPromiseResolver*,
                        RejectPromiseErrorType);
  void ManuallyTriggerDecoding(ParsedOptions&);
  void ManuallyRevertAlpha(ParsedOptions&);
