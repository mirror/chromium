...
bool ContentSettingsClient::AllowClientHintFromSource(bool enabled_per_settings,
...
void ContentSettingsClient::SetAllowClientHintsFromSource(
    const bool enabled_types[kWebClientHintsTypeNumValues],
    int64_t duration_seconds,
    const KURL& url) {
  if (client_) {
    return client_->SetAllowClientHintsFromSource(enabled_types,
