...
bool RemoteFrameClientImpl::WasCreatedWithOpener() {
  return web_frame_->WasCreatedWithOpener();
}

void RemoteFrameClientImpl::SetWasCreatedWithOpener(
    bool was_created_with_opener) {
  web_frame_->SetWasCreatedWithOpener(was_created_with_opener);
}
