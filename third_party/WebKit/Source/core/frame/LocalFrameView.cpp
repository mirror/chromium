...
IntPoint LocalFrameView::ConvertToContainingEmbeddedContentView(
  ...
  return RoundedIntPoint(ConvertToContainingEmbeddedContentView, FloatPoint(local_point);
}
...
IntPoint LocalFrameView::ViewportToContents(
  ...
  return ViewportToContents(FloatPoint(point_in_viewport));
}
...
IntPoint LocalFrameView::ContentsToViewport(
  ...
  return ContentsToViewport(FloatPoint(point_in_contents));
}
...
IntPoint LocalFrameView::ConvertToRootFrame(const IntPoint& local_point) const {
  return ConvertToRootFrame(FloatPoint(local_point));
}
