...
void LocalFrameView::InvalidateRect(const IntRect& rect) {
  LayoutEmbeddedContentViewItem layout_item = frame_->OwnerLayoutItem();
...
inline void LocalFrameView::ForceLayoutParentViewIfNeeded() {
  LayoutEmbeddedContentViewItem owner_layout_item = frame_->OwnerLayoutItem();
...
void LocalFrameView::AddPart(LayoutEmbeddedContentView* object) {
  parts_.insert(object);
}

void LocalFrameView::RemovePart(LayoutEmbeddedContentView* object) {
  parts_.erase(object);
}

void LocalFrameView::UpdateGeometries() {
  Vector<RefPtr<LayoutEmbeddedContentView>> parts;
...
void LocalFrameView::ScrollContentsSlowPath() {
  ...
  LayoutEmbeddedContentViewItem frame_layout_item = frame_->OwnerLayoutItem();
...
IntRect LocalFrameView::ScrollableAreaBoundingBox() const {
  LayoutEmbeddedContentViewItem owner_layout_item =
