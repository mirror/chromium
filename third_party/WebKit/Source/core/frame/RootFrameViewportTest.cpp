...
TEST_F(RootFrameViewportTest, TestScrollAnimatorUpdatedBeforeScroll) {
  ...
  EXPECT_SIZE_EQ(ScrollOffset(100, 150), root_frame_viewport->GetScrollOffset());
...
TEST_F(RootFrameViewportTest, VisibleContentRect) {
  ...
  root_frame_viewport->SetScrollOffset(ScrollOffset(100, 75), kProgrammaticScroll);
...
TEST_F(RootFrameViewportTest, ViewportScrollOrder) {
  ...
  root_frame_viewport->SetScrollOffset(ScrollOffset(60, 60), kProgrammaticScroll);
...
TEST_F(RootFrameViewportTest, SetAlternateLayoutViewport) {
  ...
  EXPECT_SIZE_EQ(ScrollOffset(50, 50), visual_viewport->GetScrollOffset());
  EXPECT_SIZE_EQ(ScrollOffset(50, 50), layout_viewport->GetScrollOffset());
  EXPECT_SIZE_EQ(ScrollOffset(100, 100), root_frame_viewport->GetScrollOffset());
  ...
  EXPECT_SIZE_EQ(ScrollOffset(200, 200), root_frame_viewport->GetScrollOffset());
  EXPECT_SIZE_EQ(ScrollOffset(50, 50), layout_viewport->GetScrollOffset());
