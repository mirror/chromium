(async function(testRunner) {
  ...
  let r = await dp.Target.setAutoAttach({autoAttach: true, waitForDebuggerOnStart: false});
  testRunner.log(r);
  testRunner.log(testRunner.url('../resources/worker.js'));
