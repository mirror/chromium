 ...
 */
function selectionTest(inputText, tester, expectedText, opt_options, opt_description) {
  const description = typeof(opt_options) === 'string' ? opt_options : opt_description;
