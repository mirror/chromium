var TestUtils = (function() {
  ...
  /**
   * A convenience getter for the cookies datatype.
   * @returns Datatype The cookies datatype.
   */
  TestUtils.COOKIES = (function() {
    if (TestUtils.DATATYPES[0].name != "cookies")
      throw "Cookies should be first in the list.";
    return TestUtils.DATATYPES[0];
  })();
  ...
  TestUtils.getPageWithResourceUrl = function(page_scheme, resource_scheme) {
      ...
      return page_scheme + "://web-platform.test:" +
          (page_scheme == "https" ? 8444 : 8001) + "/clear-site-data/support/" +
          "page_with_resource.html?scheme=" + resource_scheme;
  }
