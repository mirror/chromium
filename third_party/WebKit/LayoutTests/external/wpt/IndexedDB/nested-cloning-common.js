...
function cloningTestInternal(label, valueDescriptors, useKeyGenerator) {
...
function cloningTest(label, valueDescriptors) {
  cloningTestInternal(label, valueDescriptors, false);
}
...
function cloningTestWithKeyGenerator(label, valueDescriptors) {
  cloningTestInternal(label, valueDescriptors, false);
  cloningTestInternal(label + " with key generator", valueDescriptors, true);
}
