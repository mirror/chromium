...
function runImportTests(worklet_type) {
    ...
    }, 'Importing a script from a page that has "no-referrer" referrer ' +
       'policy should not send referrer.');
    ...
    }, 'Importing a script from a page that has "origin" referrer policy ' +
       'should send only an origin as referrer.');
