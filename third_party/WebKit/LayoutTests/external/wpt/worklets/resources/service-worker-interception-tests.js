...
function runServiceWorkerInterceptionTests(worklet_type) {
    ...
    // Tests that a worklet should be controlled by owner document's service
    // worker.
    //
