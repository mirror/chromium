...
function runContentSecurityPolicyTests(worklet_type) {
    ...
    }, 'Importing a remote-origin script should be blocked by the script-src ' +
       '\'self\' directive.');
    ...
    }, 'Importing a remote-origin script should not be blocked because the ' +
       'script-src * directive allows it.');
    ...
    // TODO(nhiroki): Test descendent module fetch (static import).
}
