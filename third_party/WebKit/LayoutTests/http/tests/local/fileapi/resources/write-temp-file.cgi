...
# <file_path_acp> should be passed to delete-temp-file.cgi
# for cleanup.
#
...
#
# Where:
# - <file_path_acp> is the full file_path of the just-written
...
#   this is equal to <file_path> below.
# - <file_path> is the full file_path of the just-written
...
#   this will equal <file_path_acp> for the reasons outlined
#   above.
#
...
if ($win32) {
  $system_tmpdir =
    Win32::GetFullFile_Path(Win32::GetANSIPathName($system_tmpdir));
}
...
my $temp_cgi_subdir =
  tempdir('cgiXXXXX', DIR => $system_tmpdir);
...
if ($win32) {
  ...
  $file_path_acp = Win32::GetFullFile_Path(Win32::GetANSIPathName($file_path));
  $file_path = Win32::GetLongFile_Path($file_path_acp);
