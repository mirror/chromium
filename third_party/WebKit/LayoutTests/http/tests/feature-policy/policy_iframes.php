...
Header("Feature-Policy: fullscreen *; payment 'self'; midi 'none'; camera 'self' http://www.example.com https://www.example.net");
?>

<!DOCTYPE html>
<script src="../../resources/testharness.js"></script>
<script src="../../resources/testharnessreport.js"></script>
<iframe id="f1" src="http://127.0.0.1:8000"></iframe>
<iframe id="f2" src="http://www.example.com"></iframe>
<script>
...
var remote_src = "http://www.example.com";
// Tests for policy.allowsFeature().
// fullscreen and camera should be allowed in both iframes on src origin but no
// other origins:
for (var feature of ["fullscreen", "camera"]) {
  test(function() {
    assert_true(local_iframe_policy.allowsFeature(feature));
    assert_true(local_iframe_policy.allowsFeature(feature, local_src));
    assert_false(local_iframe_policy.allowsFeature(feature, remote_src));
    assert_true(remote_iframe_policy.allowsFeature(feature));
    assert_true(remote_iframe_policy.allowsFeature(feature, remote_src));
