...
// This test tests that the JavaScript exposure of feature policy works via the
// following methods:
//     allowsFeature(feature)
//         -- if |feature| is allowed on the origin of the document / iframe.
...
assert_array_equals(
  policy_iframe.getAllowlistForFeature("fullscreen"), ["*"],
...
assert_array_equals(
  policy_iframe.getAllowlistForFeature("payment"), ["http://127.0.0.1:8000"],
  "payment is allowed for self");
assert_array_equals(
...
assert_array_equals(
  policy_iframe.getAllowlistForFeature("camera"),
  ["http://127.0.0.1:8000", "https://www.example.com", "https://www.example.net"],
  "camera is allowed for multiple origins");
assert_array_equals(
  policy_main.getAllowlistForFeature("midi"), [],
  "midi is disallowed for all");
assert_array_equals(
  policy_iframe.getAllowlistForFeature("midi"), [],
  "midi is disallowed for all");
</script>
