...
// This test ensures that intrinsically sized images are rendered by default
// dimension when unsized-image is disabled by feature policy.

Header("Feature-Policy: unsized-image 'none'");
?>
...
var iframe_srcs = [
  "resources/feature-policy-image.html",
  "http://localhost:8000/feature-policy-experimental-features/resources/feature-policy-image.html"];
