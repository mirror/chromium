...
(async function() {
  ...
  var colors = [
    ...
    'rgba(0,0,0,0.5)', 'rgb(0,0,0,50%)', 'rgb( 0  0   0   /   50%  )', 'hsl(-120, 100%, 50%)', 'hsl(-120deg, 100%, 50%)',
  ...
  var invalidColors = [
    ...
    'rgba(0 0, 0)', 'hsl(0,0,0)', 'hsl(0%, 0%, 0%)', 'hsla(0,,0,1)', 'hsl(0, 0%, 0)', 'hsl(a,b,c)', 'hsla(0,0,0,0)',
    'hsla(0 0% 0% 0)', 'hsla(0 turn, 0, 0, 0)', 'hsla'
  ];
