...
(async function() {
  ...
  testExtractExtension('c:\\some\\folder\\file.js');
  testExtractExtension('c:\\some\\folder\\file');
  testExtractExtension('c:\\some\\folder\\folder.js\\file');
  testExtractExtension('c:\\some\\folder\\folder.js\\file.png');
  testExtractExtension('c:\\some\\folder\\folder.js\\');
  ...
  testExtractExtension('c:\\some\\folder\\file.js%20');
  testExtractExtension('c:\\some\\folder\\file%20');
  testExtractExtension('c:\\some\\folder\\fo%20lder.js\\file');
  testExtractExtension('c:\\some\\folder\\folder.js%20\\file.png');
  testExtractExtension('c:\\some\\folder\\folder.js\\file.png%20');
