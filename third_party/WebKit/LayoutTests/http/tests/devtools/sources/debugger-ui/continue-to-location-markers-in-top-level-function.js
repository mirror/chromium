...
(async function() {
  ...
  function step1() {
    TestRunner.addSnifferPromise(Sources.DebuggerPlugin.prototype, '_continueToLocationRenderedForTest')
        .then(step2);
    TestRunner.addSniffer(Sources.DebuggerPlugin.prototype, '_executionLineChanged', function() {
      SourcesTestRunner.showUISourceCodePromise(this._uiSourceCode).then(() => {
