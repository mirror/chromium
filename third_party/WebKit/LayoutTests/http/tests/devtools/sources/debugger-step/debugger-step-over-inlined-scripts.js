...
(async function() {
  TestRunner.addResult(`Tests that debugger StepOver will step through inlined scripts.\n`);
  await TestRunner.loadModule('sources_test_runner');
  await TestRunner.showPanel('sources');
  await TestRunner.navigatePromise('resources/debugger-step-over-inlined-scripts.html');
