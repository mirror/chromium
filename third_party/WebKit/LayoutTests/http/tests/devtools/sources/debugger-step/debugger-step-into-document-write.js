...
(async function() {
  TestRunner.addResult(`Tests that debugger StepInto will step into inlined scripts created by document.write().\n`);
  await TestRunner.loadModule('sources_test_runner');
  await TestRunner.showPanel('sources');
  await TestRunner.navigatePromise('resources/debugger-step-into-document-write.html')
  ...
  function step1() {
    SourcesTestRunner.showScriptSource('debugger-step-into-document-write.html', step2);
  }
