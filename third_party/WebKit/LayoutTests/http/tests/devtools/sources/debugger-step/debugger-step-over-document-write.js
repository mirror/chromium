...
(async function() {
  TestRunner.addResult(`Tests that debugger StepOver will skip inlined scripts created by document.write().\n`);
  await TestRunner.loadModule('sources_test_runner');
  await TestRunner.showPanel('sources');
  await TestRunner.navigatePromise('resources/debugger-step-over-document-write.html');
