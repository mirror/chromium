...
//# sourceURL=foo.js`);
  ...
  SourcesTestRunner.dumpBreakpointSidebarPane();
  stopRequest();
  sourceFrame = await new Promise(resolve => SourcesTestRunner.showScriptSource('foo.js', resolve));
  // Set another breakpoint to always force waitBreakpointSidebarPane resolving.
