  ...
  TestRunner.runTestSuite([
    function testPermissionGranted(next) {
      ...
      async function savePositionBeforeOverride() {
        positionBeforeOverride = await TestRunner.evaluateInPageAsync('getPostitionPromise()');
        Console.ConsoleView.clearConsole();
        next();
      }
    },
    ...
    async function testNoOverride(next) {
      ...
      var positionString = await TestRunner.evaluateInPageAsync('getPostitionPromise()');
