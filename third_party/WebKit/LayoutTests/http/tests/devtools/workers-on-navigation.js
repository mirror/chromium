...
(async function() {
  ...
  var observer = {
    targetAdded(target) {
      ...
      if (navigated) {
        TestRunner.addResult('=== Error messages from console ====');
  ...
  // Print error messages after reload is complete to avoid a race between
  // the "Page reloaded." and protocol error console messages.
  var messages = [];
