...
(async function() {
  ...
  await TestRunner.evaluateInPagePromise(`
    ...
    function loadFirstImage() {
        ...
        image.src = normalizePath("resources/resource.php?type=image&random=1&size=400");
    };
    ...
    function loadSecondImage() {
        ...
        image.src = normalizePath("resources/resource.php?type=image&random=1&size=200");
    };
