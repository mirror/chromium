...
window.onerror = function(msg, url, line, column, error) {
  ...
  assert_equals(
    ...
    'throw=true&ACAOrigin=http-so://foobar.127.0.0.1:8000')
...
<script crossorigin src="/security/resources/cors-script.php?throw=true&ACAOrigin=http-so://foobar.127.0.0.1:8000"></script>
</body>
</html>
