...
(class InterceptionHelper {
  ...
  async startInterceptionTest(requestInterceptedDict, numConsoleLogsToWaitFor) {
    ...
    await this._session.protocol.Network.setRequestInterceptionPatterns({patterns: Object.keys(requestInterceptedDict)});
  ...
  disableRequestInterception(event) {
    ...
    this._session.protocol.Network.setRequestInterceptionPatterns();
  }
