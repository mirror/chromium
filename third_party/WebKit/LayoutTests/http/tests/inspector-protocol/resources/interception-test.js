...
(class InterceptionHelper {
  ...
  async startInterceptionTest(requestInterceptedDict, numConsoleLogsToWaitFor, shouldInterceptResponse) {
    ...
    await this._session.protocol.Network.setRequestInterception({patterns: [{urlPattern: "*", interceptionStage: shouldInterceptResponse ? 'HeadersReceived' : undefined}]});
