// TODO(509038): FakeAdapter is the test API that Bluetooth test allows user
...
// This is a temporary file that will allow bluetooth-helpers.js to be migrated
// into the wpt/ directory while allowing the tests that still use FakeAdapter
// to continue working until they are converted to the new testing API.
'use strict';
