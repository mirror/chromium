...
promise_test(() => getMeasurementIntervalCharacteristic()
  ...
  .then(() => fake_characteristic.setNextReadResponse(GATT_INVALID_HANDLE))
  .then(() => fake_characteristic.setNextWriteResponse(GATT_INVALID_HANDLE))
  .then(() => fake_characteristic.setNextSubscribeToNotificationsResponse(
      GATT_INVALID_HANDLE))
  .then(() => {
