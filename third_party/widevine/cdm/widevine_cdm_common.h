...
// for the Widevine CDM. This is used to store persistent files, so modifying
// this will result in any existing saved files becoming inaccesssible. As the
// files were initially used by the CDM running as a pepper plugin, this ID
// is based on the pepper plugin MIME type.
