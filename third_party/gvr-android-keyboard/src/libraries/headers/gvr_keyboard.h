...
#ifndef CHROME_BROWSER_ANDROID_VR_SHELL_GVR_KEYBOARD_H_
#define CHROME_BROWSER_ANDROID_VR_SHELL_GVR_KEYBOARD_H_
...
#endif  // CHROME_BROWSER_ANDROID_VR_SHELL_GVR_KEYBOARD_H_
