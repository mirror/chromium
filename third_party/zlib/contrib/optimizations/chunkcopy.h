...
static inline z_vec128i_t v_load64_dup(const void* src) {
  ...
  const int64_t v64[2] = { i64, i64 }; // 2
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, v64, sizeof(v64));
  return vec;
}
...
static inline z_vec128i_t v_load32_dup(const void* src) {
  ...
  const int32_t v32[4] = { i32, i32, i32, i32 }; // 4
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, v32, sizeof(v32));
  return vec;
}
...
static inline z_vec128i_t v_load16_dup(const void* src) {
  ...
  const int16_t v16[8] = { i16, i16, i16, i16, i16, i16, i16, i16 }; // 8
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, v16, sizeof(v16));
  return vec;
}
...
static inline z_vec128i_t v_load8_dup(const void* src) {
  ...
  const z_vec128i_t vec = { {
    i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 // 16
  } };
  return vec;
}
