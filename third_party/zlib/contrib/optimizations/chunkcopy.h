...
/*
 * chunk copy type: the z_vec128i_t type size should be exactly 128-bits wide
 * and equal to CHUNKCOPY_CHUNK_SIZE.
 */
typedef struct z_chunk_copy_t {
  int8_t i8[16]; // 128-bits
} z_vec128i_t;
...
static inline z_vec128i_t v_load64_dup(const void* src) {
  ...
  const int64_t s[2] = { i64, i64 };
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, s, sizeof(s));
  return vec;
}
...
static inline z_vec128i_t v_load32_dup(const void* src) {
  ...
  const int32_t s[4] = { i32, i32, i32, i32 };
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, s, sizeof(s));
  return vec;
}
...
static inline z_vec128i_t v_load16_dup(const void* src) {
  ...
  const int16_t s[8] = { i16, i16, i16, i16, i16, i16, i16, i16 };
  z_vec128i_t vec;
  Z_BUILTIN_MEMCPY(&vec, s, sizeof(s));
  return vec;
}
