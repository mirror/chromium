...
TEST_F(ZipTest, Zip) {
  ...
  base::CopyFile(zip_file, base::FilePath("/tmp/out.zip"));
...
//   zip::ZipParams params(base::FilePath(FILE_PATH_LITERAL("/test")),
//   zip_file); params.set_file_accessor(std::make_unique<VirtualFileSystem>());
