...
class ExtractSqliteApiUnittest(unittest.TestCase):
  ...
  def testExportedSymbolLine(self):
    self.assertEqual(
        '#define sqlite3_sleep chromium_sqlite3_sleep  // Line 42',
        self.extractor.ExportedSymbolLine(
            'chromium_', 'sqlite3_sleep',
            (42, 42, 'SQLITE_API int chromium_sqlite3_sleep(int ms)')))
    self.assertEqual(
        '#define sqlite3_sleep chromium_sqlite3_sleep  // Lines 42-44',
        self.extractor.ExportedSymbolLine(
            'chromium_', 'sqlite3_sleep',
            (42, 44, 'SQLITE_API int chromium_sqlite3_sleep(int ms)')))
  ...
  def testProcessSource(self):
    ...
    golden_output = [
      '// Auto-generated',
      '#define sqlite3_sleep chromium_sqlite3_sleep  // Line 5',
      '// TODO: Lines 6-6 -- Unsupported keyword struct',
      '#define sqlite3_expired chromium_sqlite3_expired  // Line 7',
    ]
    self.assertEqual(
        golden_output,
        self.extractor.ProcessSource('SQLITE_API', 'chromium_',
                                     '// Auto-generated', file_content))
  ...
  def testProcessSourceFile(self):
    ...
    self.extractor.ProcessSourceFile(
        'SQLITE_API', 'chromium_', '// Auto-generated', input_file, output_file)
