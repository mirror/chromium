...
For example, the following renaming macro is produced for sqlite3_initialize().
    ...
    #define sqlite3_initialize chromium_sqlite3_initialize
'''
...
def ProcessSource(api_export_macro, symbol_prefix, header_line, file_content):
...
def ProcessSourceFile(api_export_macro, symbol_prefix, header_line, input_file,
                      output_file):
...
if __name__ == '__main__':
  ProcessSourceFile(api_export_macro='SQLITE_API', symbol_prefix='chromium_',
                    header_line='// Generated by extract_sqlite_api.py',
