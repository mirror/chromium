...
openIcuConverter(const char* name, int toUnicode)
{
  ...
  conv->pivot_buf = xmlMalloc(ICU_PIVOT_BUF_SIZE * sizeof(UChar));
  if (conv->pivot_buf == NULL)
    goto error;
