...
public class ApkSignatureSchemeV2Verifier {
    ...
    private static X509Certificate[] verifySigner(ByteBuffer signerBlock,
        ...
        if ((previousSignerDigest != null)
            ...
            throw new SecurityException(getContentDigestAlgorithmJcaDigestAlgorithm(digestAlgorithm)
    ...
    private static void verifyIntegrity(Map<Integer, byte[]> expectedDigests,
            ...
            long eocdOffset, ByteBuffer eocdBuf) throws SecurityException {
    ...
    private static final class MemoryMappedFileDataSource implements DataSource {
        ...
        public void feedIntoMessageDigests(MessageDigest[] mds, long offset, int size)
            ...
            try {
                ...
                //                mmapPtr = OS.mmap(
                //                        0, // let the OS choose the start address of the region in
                //                        memory mmapRegionSize, OsConstants.PROT_READ,
                //                        OsConstants.MAP_SHARED | OsConstants.MAP_POPULATE, //
                //                        "prefault" all pages mFd, mmapFilePosition);
                //                // Feeding a memory region into MessageDigest requires the region
                //                to be represented
                ...
                //                        null, // no need to clean up -- it's taken care of by the
                //                        finally block true  // read only buffer
                //                );
                ...
                //                throw new IOException("Failed to mmap " + mmapRegionSize + "
                //                bytes", e);
            } finally {
                //                if (mmapPtr != 0) {
                //                    try {
